    ...
    <script>
        ...
        function translateServerEx() {
            ...
            xdr.onload = function () {
                ...
                if (x.response == 'ok') {
                    var text = "The server translation process is now running.<br />Please allow up to 5 minutes for completion.<br /><br />";
                    text += "If this is your <b>first translation</b>,<br />Please restart your MeshCentral server after the 5 minutes.<br /></br />";
                    text += "If you are <b>updating a translation</b>,<br />Please refresh your MeshCentral web browser tabs after the 5 minutes.<br /><br />";
                    text += "To submit your work, please email the generated <b>translate.json</b> file (located in <code>meshcentral-data/</code>) to one of the developers.";
                    messagebox("Server Translation", text);
                } else {
