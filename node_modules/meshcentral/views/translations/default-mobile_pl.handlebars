<!DOCTYPE html><html lang="pl" dir="ltr" xmlns="http://www.w3.org/1999/xhtml"><head>
    <meta charset="utf-8">
    ...
    </head><body id="body" onload="if (typeof(startup) !== 'undefined') startup();" style="overflow-y:hidden;margin:0;padding:0;border:0;font-size:13px;font-family:\'Trebuchet MS\', Arial, Helvetica, sans-serif">{{{customCSSTags}}}
    ...
    <div id="container">
        ...
        <div id="masthead" style="background:url(logo.png) 0px 0px;background-size:341px 50px;background-color:#036;background-repeat:no-repeat;height:50px;width:100%;overflow:hidden">
            ...
            <div id="notificationCount" onclick="clickNotificationIcon()" class="unselectable" style="position:absolute;right:50px;top:0px;font-size:28px;width:50px;height:50px;cursor:pointer;display:none" title="Kliknij, aby wyświetlić bieżące powiadomienia"><div id="notificationCount2" style="padding-top:8px">0</div></div>
            ...
            <div id="column_l" style="width:100%;padding:0;position:absolute;bottom:0px;top:0px">
                <div id="p0" style="display:none;width:100%;height:100%">
                    <div style="display:flex;align-items:center;width:100%;height:100%">
                        <div id="p0message" style="text-align:center;width:100%"><span id="p0span">Serwer rozłączony</span>, <href onclick="reload()" style="cursor:pointer"><u>kliknij by połączyć</u></href>.</div>
                    </div>
                </div>
                ...
                <div id="p2" style="display:none;position:absolute;top:0;left:0;right:0;bottom:0">
                    ...
                    <div id="xdevicesBar" style="position:absolute;overflow-y:auto;height:34px;left:0;right:0;bottom:0px;background-color:#aaa;color:black">
                        <div style="margin:4px">
                            ...
                            <input id="SearchInput" autocomplete="off" type="search" placeholder="Filtr" onchange="onDeviceSearchChanged(event)" onclick="onDeviceSearchChanged(event)" onkeyup="onDeviceSearchChanged(event)" style="padding:2px;margin:0;height:20px;background-color:#FFF">&nbsp;
                            <label class="noselect"><input type="checkbox" id="RealNameCheckBox" onclick="onRealNameCheckBox()">Nazwa w OS</label>
                        ...
                        <div style="margin-left:8px">
                            <div id="p3AccountActions">
                                <div id="p2AccountSecurity" style="display:none">
                                    <p><strong>Bezpieczeństwo Konta</strong></p>
                                    <div style="margin-left:9px;margin-bottom:8px">
                                        <div id="managePhoneNumber1" style="margin-top:5px;display:none"><a onclick="account_managePhone()" style="cursor:pointer">Zarządzaj numerem telefonu</a> <span id="authPhoneNumberCheck"><strong>✓</strong></span></div>
                                        <div id="manageEmail2FA" style="margin-top:5px;display:none"><a onclick="account_manageAuthEmail()" style="cursor:pointer">Zarządzaj uwierzytelnianiem przez email</a> <span id="authEmailSetupCheck"><strong>✓</strong></span></div>
                                        <div style="margin-top:5px"><a href="#" onclick="account_showLocalizationSettings()">Ustawienia Lokalizacji</a></div>
                                        <div id="manageAuthApp" style="margin-top:5px;display:none"><a onclick="account_manageAuthApp()" style="cursor:pointer">Zarządzaj aplikacją uwierzytelniającą</a> <span id="authAppSetupCheck"><strong>✓</strong></span></div>
                                        <div id="manageOtp" style="margin-top:5px;display:none"><a onclick="account_manageOtp(0)" style="cursor:pointer">Zarządzaj kopią zapasową kodów</a> <span id="authCodesSetupCheck"><strong>✓</strong></span></div>
                                    </div>
                                </div>
                                <div id="p2AccountActions" style="display:none">
                                    <p><strong>Akcje Konta</strong></p>
                                    <div style="margin-left:9px;margin-bottom:8px">
                                        <div style="margin-top:5px"><span id="viewPreviousLogins"><a onclick="return account_viewPreviousLogins()" style="cursor:pointer">Wyświetl poprzednie logowania</a></span></div>
                                        <div style="margin-top:5px"><span id="managePhoneNumber2" style="display:none"><a onclick="account_managePhone()" style="cursor:pointer">Zarządzaj numerem telefonu</a></span></div>
                                        <div style="margin-top:5px"><span id="verifyEmailId" style="display:none"><a onclick="account_showVerifyEmail()" style="cursor:pointer">Weryfikuj email</a></span></div>
                                        <span id="p2AccountPassActions">
                                            <div style="margin-top:5px"><span id="changeEmailId" style="display:none"><a onclick="account_showChangeEmail()" style="cursor:pointer">Zmień adres email</a></span></div>
                                            <div style="margin-top:5px"><a onclick="account_showChangePassword()" style="cursor:pointer">Zmień hasło</a><span id="p2nextPasswordUpdateTime"></span></div>
                                            <div style="margin-top:5px"><a onclick="account_showDeleteAccount()" style="cursor:pointer">Usuń konto</a></div>
                                        </span>
                                        <div style="margin-top:5px" id="setDarkModeLink"><a onclick="toggleNightMode()" style="cursor:pointer">Ustaw tryb ciemny</a></div>
                                        <div style="margin-top:5px"><a onclick="showNotes(false)" style="cursor:pointer">Notatki prywatne</a></div>
                                    </div>
                                <br style="clear:both">
                                </div>
                            </div>
                            <strong>Grupy Urządzeń</strong>
                            <span id="p3createMeshLink1">( <a onclick="account_createMesh()" style="cursor:pointer"><img src="images/icon-addnew.png" width="12" height="12" border="0"> Nowy</a> )</span>
                            <br><br>
                            <div id="p3meshes"></div>
                            <div id="p3noMeshFound" style="margin-left:9px;display:none">Brak grup urządzeń.<span id="p3createMeshLink2"> <a onclick="account_createMesh()" style="cursor:pointer"><strong>Zacznij tutaj!</strong></a></span></div>
                            <br style="clear:both">
                        </div>
                    </div>
                </div>
                <div id="p5" style="display:none">
                    <table cellspacing="0" style="margin:0;padding:0;border-spacing:0;border:0;">
                        <tbody><tr style="padding:0">
                            ...
                            <td>
                                <div style="margin-left:5px">
                                    <strong style="font-size:large">Moje Pliki</strong><br>
                                </div>
                            </td>
                        </tr>
                    </tbody></table>
                            ...
                            <tbody><tr>
                                <td style="width:100%;background-color:#d3d9d6;text-align:left;padding:4px" valign="bottom">
                                    <div style="width:100%;text-align:center">
                                        <input type="button" style="width:calc(100%/5 - 5px)" id="p5FolderUp" disabled="disabled" onclick="p5folderup()" value="Góra">
                                        <input type="button" style="width:calc(100%/5 - 5px)" id="p5SelectAllButton" disabled="disabled" onclick="p5selectallfile()" value="Zaznacz wszystko" onkeypress="return false" onkeydown="return false">
                                        <input type="button" style="width:calc(100%/5 - 5px)" id="p5RenameFileButton" disabled="disabled" value="Zmień nazwę" onclick="p5renamefile()" onkeypress="return false" onkeydown="return false">
                                        <input type="button" style="width:calc(100%/5 - 5px)" id="p5DeleteFileButton" disabled="disabled" value="Usuń" onclick="p5deletefile()" onkeypress="return false" onkeydown="return false">
                                    ...
                                    <div style="width:100%;text-align:center">
                                        <input type="button" style="width:calc(100%/5 - 5px)" id="p5UploadButton" disabled="disabled" value="Prześlij" onclick="p5uploadFile()" onkeypress="return false" onkeydown="return false">
                                        <input type="button" style="width:calc(100%/5 - 5px)" id="p5CutButton" disabled="disabled" value="Wytnij" onclick="p5copyFile(1)" onkeypress="return false" onkeydown="return false">
                                        <input type="button" style="width:calc(100%/5 - 5px)" id="p5CopyButton" disabled="disabled" value="Kopiuj" onclick="p5copyFile(0)" onkeypress="return false" onkeydown="return false">
                                        <input type="button" style="width:calc(100%/5 - 5px)" id="p5PasteButton" disabled="disabled" value="Wklej" onclick="p5pasteFile()" onkeypress="return false" onkeydown="return false">
                                        <input type="button" style="width:calc(100%/5 - 5px)" id="p5RefreshButton" value="Odśwież" onclick="p5refreshFiles()" onkeypress="return false" onkeydown="return false">
                                    </div>
                                </td>
                            </tr>
                            <tr>
                                        ...
                                        <tbody><tr>
                                            ...
                                            <td style="text-align:right;padding-right:4px">
                                                <select id="p5sortdropdown" onchange="updateFiles()">
                                                    <option value="1" selected="selected">Sortuj po nazwie</option>
                                                    <option value="2">Sortuj po rozmiarze</option>
                                                    <option value="3">Sortuj po dacie</option>
                                                    <option value="4">Sortuj w dół według nazwy</option>
                                                    <option value="5">Sortuj w dół według rozmiaru</option>
                                                    <option value="6">Sortuj w dół według daty</option>
                                                </select>
                                            </td>
                                        </tr>
                                    </tbody></table>
                ...
                <div id="p10" style="display:none;position:absolute;bottom:0;top:0;width:100%;overflow:hidden">
                    ...
                    <div id="p10dialog" style="z-index:1000;background-color:#EEE;box-shadow:0px 0px 15px #666;font-family:Arial,Helvetica,sans-serif;border-radius:5px;position:fixed;top:30px;width:300px;left:30px;display:none">
                        <div style="width:100%;background-color:#003366;color:#FFF;border-radius:5px 5px 0 0">
                            <div style="padding:5px">Konfiguracja Skrótów Klawiatury</div>
                    ...
                    <div id="p10desktop" style="overflow:hidden;position:absolute;top:55px;bottom:0px;width:100%;display:none">
                        <div id="deskarea1" style="position:absolute;top:0px;width:100%;height:32px">
                            <div style="padding-top:2px;padding-bottom:2px;background:#C0C0C0;height:32px">
                                <div style="float:right;text-align:right">
                                    ...
                                    <input type="button" id="deskFullScreen" value="Pełny Ekran" onclick="deskToggleFull(event)" onkeypress="return false" onkeydown="return false" disabled="disabled" style="height:28px;margin-right:3px;">
                                </div>
                                <div style="margin-left:3px">
                                    <input type="button" id="connectbutton1" value="Połącz" onclick="connectDesktop(event,3)" onkeypress="return false" onkeydown="return false" disabled="disabled" style="height:28px">
                                    <input type="button" id="connectbutton1h" value="Połączenie HW" onclick="connectDesktop(event,2)" onkeypress="return false" onkeydown="return false" disabled="disabled" style="height:28px">
                                    <input type="button" id="disconnectbutton1" value="Rozłącz" onclick="connectDesktop(event,0)" onkeypress="return false" onkeydown="return false" style="height:28px">
                                    <span id="deskstatus" style="color:black">Rozłączony</span>
                                </div>
                            </div>
                        </div>
                        ...
                        <div id="deskarea4" style="position:absolute;bottom:0px;width:100%;height:32px">
                            <div style="padding-top:2px;padding-bottom:2px;background:#C0C0C0">
                                ...
                                <div>
                                    <input id="deskActionsBtn" type="button" style="margin-left:3px;height:28px" onkeypress="return false" onkeydown="return false" value="Akcje" onclick="deviceActionFunction()">
                                    <input type="button" value="Ustawienia" onkeypress="return false" onkeydown="return false" onclick="showDesktopSettings()" style="height:28px">
                                    <input type="button" onkeypress="return false" onkeydown="return false" value="Akcje Zasilania..." onclick="showPowerActionDlg()" style="display:none;height:28px">
                                    ...
                                    <input type="button" id="DeskScreens" value="Ekrany" onkeypress="return false" onkeydown="return false" onclick="deskSelectScreens()" style="display:none;height:28px">
                                    <label><span id="DeskControlSpan" style="display:none"><input id="DeskControl" type="checkbox" onkeypress="return false" onkeydown="return false">Sterowanie</span></label>
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div id="termTable" style="position:absolute;top:0;bottom:0;left:0;right:0">
                            <div id="termarea1">
                                <div class="areaHead" style="line-height:24px">
                                    <div class="toright2">
                                        <input type="button" id="termFullScreen" value="Pełny Ekran" onclick="deskToggleFull(event)" onkeypress="return false" onkeydown="return false" disabled="disabled" style="height:28px;margin-right:3px;">
                                        <div id="terminalCustomUpperRight" style="float:left;margin-right:6px"></div>
                                    </div>
                                    <div>
                                        <span id="connectbutton2span" style="margin-left:3px"><input type="button" id="connectbutton2" value="Połącz" style="height:28px" onclick="connectTerminal(event,1)" onkeypress="return false" onkeydown="return false" disabled="disabled"></span>
                                        <span id="connectbutton2sspan" style="margin-right:4px"><input type="button" id="connectbutton2s" value="Połącz z SSH" style="height:28px" onclick="connectTerminal(event,3)" onkeypress="return false" onkeydown="return false" disabled="disabled"></span>
                                        <span id="disconnectbutton2span" style="margin-left:3px"><input type="button" id="disconnectbutton2" value="Rozłącz" style="height:28px" onclick="connectTerminal(event,0)" onkeypress="return false" onkeydown="return false"></span>
                                        <span id="termstatus" style="line-height:22px">Rozłączony</span><span id="termtitle"></span>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div id="termarea4" style="position:relative;height:32px;">
                                <div class="areaFoot">
                                    ...
                                    <div style="height:28px">
                                        <input id="termActionsBtn" style="margin-left:3px;height:28px" type="button" title="Wykonaj akcje zasilania na urządzeniu" onkeypress="return false" onkeydown="return false" value="Akcje" onclick="deviceActionFunction()">
                    ...
                    <div id="p10files" style="position:absolute;top:55px;bottom:0px;width:100%;display:none">
                        <table id="p13toolbar" style="width:100%;height:111px" cellpadding="0" cellspacing="0">
                            <tbody><tr>
                                <td style="background-color:#C0C0C0;border-bottom:2px solid black;padding:2px;line-height:24px">
                                    <div style="float:right;text-align:right">
                                        <input id="filesActionsBtn" type="button" onkeypress="return false" onkeydown="return false" value="Akcje" onclick="deviceActionFunction()" style="margin-right:2px">
                                        <div id="filesCustomUpperRight" style="float:left;margin-right:6px"></div>
                                    </div>
                                    <div style="margin-left:2px">
                                        <input id="p13AutoConnect" value="AutoPołączenie" onclick="autoConnectFiles(event)" onkeypress="return false" onkeydown="return false" type="button" style="display:none">
                                        <input id="p13Connect" value="Połącz" onclick="connectFiles(event,1)" onkeypress="return false" onkeydown="return false" type="button">
                                        <input id="p13Connects" value="Połącz z SFTP" onclick="connectFiles(event,2)" onkeypress="return false" onkeydown="return false" type="button">
                                        <input id="p13Disconnect" value="Rozłącz" onclick="connectFiles(event)" onkeypress="return false" onkeydown="return false" type="button">
                                        <span class="textOverGray" id="p13Status">Rozłączony</span>
                                    </div>
                                </td>
                            </tr>
                            <tr>
                                <td style="width:100%;background-color:#d3d9d6;text-align:left;padding:4px" valign="bottom">
                                    <div style="width:100%;text-align:center">
                                        <input type="button" style="width:calc(100%/5 - 5px)" id="p13FolderUp" disabled="disabled" onclick="p13folderup()" value="Góra">
                                        <input type="button" style="width:calc(100%/5 - 5px)" id="p13SelectAllButton" disabled="disabled" onclick="p13selectallfile()" value="Zaznacz wszystko" onkeypress="return false" onkeydown="return false">
                                        <input type="button" style="width:calc(100%/5 - 5px)" id="p13RenameFileButton" disabled="disabled" value="Zmień nazwę" onclick="p13renamefile()" onkeypress="return false" onkeydown="return false">
                                        <input type="button" style="width:calc(100%/5 - 5px)" id="p13DeleteFileButton" disabled="disabled" value="Usuń" onclick="p13deletefile()" onkeypress="return false" onkeydown="return false">
                                    ...
                                    <div style="width:100%;text-align:center">
                                        <input type="button" style="width:calc(100%/5 - 5px)" id="p13UploadButton" disabled="disabled" value="Prześlij" onclick="p13uploadFile()" onkeypress="return false" onkeydown="return false">
                                        <input type="button" style="width:calc(100%/5 - 5px)" id="p13CutButton" disabled="disabled" value="Wytnij" onclick="p13copyFile(1)" onkeypress="return false" onkeydown="return false">
                                        <input type="button" style="width:calc(100%/5 - 5px)" id="p13CopyButton" disabled="disabled" value="Kopiuj" onclick="p13copyFile(0)" onkeypress="return false" onkeydown="return false">
                                        <input type="button" style="width:calc(100%/5 - 5px)" id="p13PasteButton" disabled="disabled" value="Wklej" onclick="p13pasteFile()" onkeypress="return false" onkeydown="return false">
                                        <input type="button" style="width:calc(100%/5 - 5px)" id="p13RefreshButton" disabled="disabled" value="Odśwież" onclick="p13folderup(9999)" onkeypress="return false" onkeydown="return false">
                                    </div>
                                </td>
                            </tr>
                            <tr>
                        ...
                        <table id="p13toolbarBottom" style="width:100%;height:22px;position:absolute;bottom:0px" cellpadding="0" cellspacing="0">
                            <tbody><tr><td style="text-align:left;padding:3px;text-align:center;background-color:#D3D9D6;color:black">&nbsp;<span id="p13bottomstatus"></span></td></tr>
                        </tbody></table>
                    </div>
                            ...
                            <tbody><tr style="height:28px">
                                <td class="areaHead">
                                    <div class="toright2">
                                        ...
                                        <input type="button" id="p15uploadCore" value="Akcja Agenta" onclick="p15uploadCore(event)">
                                    </div>
                                ...
                                <td class="areaFoot">
                                    <table style="width:100%">
                                        <tbody><tr>
                                            ...
                                            <td style="width:1%"><input id="id_p15consoleClear" type="button" class="bottombutton" value="Wyczyść" onclick="p15consoleClear()"></td>
                                        </tr>
                                    </tbody></table>
                                </td>
                            </tr>
    ...
    <div id="dialog" style="display:none">
        ...
        <div style="margin-right:16px;margin-left:8px">
            ...
            <div id="dialog3" style="margin:auto;margin:3px">
                <select id="deskkeys" style="width:100%">
                    ...
                    <option value="0">Win+Dół</option>
                    <option value="1">Win+Góra</option>
            ...
            <div id="dialog4" style="margin:auto;margin:3px">
                <div id="d3upload">
                    ...
                    <select id="d3uploadMode" onchange="d3modechange()">
                        <option value="1">Lokalne przesyłanie plików</option>
                        <option value="2">Wybór pliku serwera</option>
                    </select>
                </div>
                ...
                <div id="d3servermode">
                    <div id="d3serveraction" valign="bottom">
                        <input type="button" id="p3FolderUp" disabled="disabled" onclick="d3folderup()" value="Góra">&nbsp;<span id="p3CurrentFolder"></span>
                    </div>
            ...
            <div id="dialog7" style="margin:auto;margin:3px">
                <div id="d7meshkvm">
                    <h4 style="width:100%;border-bottom:1px solid gray">Agent Pulpitu Zdalnego</h4>
                    <table style="width:100%">
                        <tbody><tr>
                            <td>
                                Jakość
                        ...
                        <tr>
                            ...
                            <td style="width:100px">
                                <select id="d7framelimiter" style="float:right;width:200px" dir="rtl">
                                    <option selected="selected" value="50">Duża</option>
                                    <option value="100">Średnia</option>
                                    <option value="400">Mała</option>
                                    <option value="1000">Bardzo mała</option>
                                </select>
                            </td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                            <td></td>
                            <td>
                                <label style="display:block" id="d7deskAutoLockLabel"><input type="checkbox" id="d7deskAutoLock">Zablokuj po Odłączeniu</label>
                            </td>
                        </tr>
                    </tbody></table>
                </div>
                <div id="d7amtkvm">
                    <h4 style="width:100%;border-bottom:1px solid gray">Intel® AMT Sprzętowy KVM</h4>
                    <table style="width:100%">
                        <tbody><tr>
                            <td>Kodowanie</td>
                            <td style="width:100px">
                                <select id="d7desktopmode" style="float:right;width:200px">
                                    <option value="1">RLE8, Najszybciej</option>
                                    <option value="2">RLE16, Zalecane</option>
                                    <option value="3">RAW8, Powoli</option>
                                    <option value="4">RAW16, Bardzo Powoli</option>
                                </select>
                            </td>
                        </tr>
                    </tbody></table>
        ...
        <div id="idx_dlgButtonBar" style="padding:10px;margin-bottom:20px">
            <input id="idx_dlgCancelButton" type="button" value="Anuluj" style="float:right;width:80px;margin-left:5px" onclick="dialogclose(0)">
            <input id="idx_dlgOkButton" type="button" value="OK" style="float:right;width:80px" onclick="dialogclose(1)">
            <div><input id="idx_dlgDeleteButton" type="button" value="Usuń" style="display:none" onclick="dialogclose(2)"></div>
        </div>
    </div>
    <div id="topMenu" style="z-index:1000;background-color:#EEE;box-shadow:0px 0px 15px #666;font-family:Arial,Helvetica,sans-serif;border-radius:0px 0px 5px 5px;position:fixed;top:50px;right:5px;width:170px;display:none">
        <div style="padding:12px;border-top:1px solid gray;color:black;cursor:pointer" onclick="topMenu(2)">Moje Pliki</div>
        <div style="padding:12px;border-top:1px solid gray;color:black;cursor:pointer" onclick="topMenu(1)">Moje konto</div>
        <div id="logoutMenuOption"><a id="logoutMenuOptionRef" href="/logout"><div style="padding:12px;border-top:1px solid gray;color:black;cursor:pointer">Wyloguj</div></a></div>
    </div>
    ...
    <script>
        ...
        var StatusStrs = ["Rozłączony", "Łączenie...", "Instalacja...", "Połączono", "Intel&reg; AMT Połączono"];
        var agentsStr = ["Nieznany", "Windows 32bit konsola", "Windows 64bit konsola", "Windows 32bit - usługa", "Windows 64bit - usługa", "32-bitowy system Linux", "64-bitowy system Linux", "MIPS", "XENx86", "Android", "Linux ARM", "macOS x86-32bit", "Android x86", "PogoPlug ARM", "Android", "Linux Poky x86-32bit", "macOS x86-64bit", "ChromeOS", "Linux Poky x86-64bit", "Linux BezKVM x86-32bit", "Linux BezKVM x86-64bit", "konsola Windows MinCore", "Usługa Windows MinCore", "NodeJS", "ARM-Linaro", "ARMv6l / ARMv7l", "ARMv8 64bit", "ARMv6l / ARMv7l / NoKVM", "MIPS24KC (OpenWRT)", "Krzem Apple", "FreeBSD x86-64", "Nieznany", "Linux ARM 64 bit (glibc/2.24 NOKVM)", "Alpine Linux x86 64 Bit (MUSL)", "Asystent (Windows)", "Armada370 - ARM32/HF (libc/2.26)", "OpenWRT x86-64", "OpenBSD x86-64", "Nieznany", "Nieznany", "MIPSEL24KC (OpenWRT)", "ARMADA/CORTEX-A53/MUSL (OpenWRT)", "Konsola Windows ARM 64bit", "Usługa Windows ARM 64bit", "ARMVIRT32 (OpenWRT)", "RISC-V x86-64"];
        var files;
        var terminal;
        ...
        function onStateChanged(server, state, prevState, errorCode) {
            if (state == 0) {
                ...
                if (errorCode == 'noauth') { QH('p0span', "Nie można przeprowadzić uwierzytelniania"); return; }
                if (prevState == 2) { setTimeout(serverPoll, 5000); } else { QH('p0span', "Nie można połączyć się z gniazdem web"); }
                // Clean up here
        ...
        function updateSelf() {
            ...
            if (typeof userinfo.passchange == 'number') {
                if (userinfo.passchange == -1) { QH('p2nextPasswordUpdateTime', " - Reset przy następnym logowaniu."); }
                    ...
                    if (seconds < 0) { QH('p2nextPasswordUpdateTime', " - Reset przy następnym logowaniu."); }
                    else if (seconds < 3600) { var secs = Math.floor(seconds / 60); QH('p2nextPasswordUpdateTime',format((secs == 1)?" - Reset za 1 minutę.":" - Reset za {0} minut.", secs)); }
                    else if (seconds < 86400) { var hours = Math.floor(seconds / 3600); QH('p2nextPasswordUpdateTime', format((hours == 1) ? " - Reset za 1 godzinę." : " - Reset za {0} godzin.", hours)); }
                    else { var days = Math.floor(seconds / 86400); QH('p2nextPasswordUpdateTime', format((hours == 1) ? " - Reset za 1 dzień." : " - Reset za {0} dni.", days)); }
                }
            }
        }
            ...
            switch (message.action) {
                case 'serverinfo': {
                    ...
                    if (serverinfo.certExpire != null) {
                        ...
                        if ((days >= 0) && (days < 20)) {
                            addNotification({ text: format("Certyfikat wygasa w {0} dni", days) });
                        }
                    }
                ...
                case 'otpauth-request': {
                    if ((xxdialogMode == 2) && (xxdialogTag == 'otpauth-request')) {
                        if (message.err != null) {
                            var otpauthErrors = ['', "2FA jest zablokowane", "Kody zapasowe są zablokowane", "Używany token logowania", "OTP 2FA niedozwolone", "Konto zablokowane", "Nie mogę załadować OTPLIB"];
                            if ((message.err > 0) && (message.err < otpauthErrors.length)) { QH('d2optinfo', otpauthErrors[message.err]); } else { QH('d2optinfo', format("Błąd #{0}", message.err)); }
                        } else {
                            ...
                            QH('d2optinfo', format("Zainstaluj" + ' <a href="https://play.google.com/store/apps/details?id=com.google.android.apps.authenticator2" rel="noreferrer noopener" target=_blank>' + "Google Authenticator" + '</a> ' + "lub kompatybilną aplikację, użyj <a href=\"{0}\" rel=\"noreferrer noopener\" target=_blank> tego linka</a> lub wpisz klucz poniżej. Następnie wprowadź aktualny 6-cyfrowy token, aby aktywować logowanie dwuetapowe.", message.url) + '<br /><br /><div style=width:100%;text-align:center><tt id=d2optsecret secret="' + message.secret + '" style=font-size:15px>' + secret + '</tt><br /><br />Token: <input type=text autocomplete="one-time-code" inputmode="numeric" pattern="[0-9]*" onkeypress=\"return (event.keyCode == 8) || (event.charCode >= 48 && event.charCode <= 57)\" onkeyup=account_addOtpCheck(event) onkeydown=account_addOtpCheck() maxlength=6 id=d2otpauthinput type=text></div>');
                            QV('idx_dlgOkButton', true);
                ...
                case 'otpauth-setup': {
                    ...
                    setDialogMode(2, "Aplikacja Authenticator", 1, null, message.success ? ('<b style=color:green>' + "Aplikacja uwierzytelniania aktywowana prawidłowo." + '</b> ' + "You will now need a valid token to login again.") : ('<b style=color:red>' + "2-stopniowe aktywacja logowania nieudana." + '</b> ' + "Wyczyść klucz z aplikacji i spróbuj ponownie. Masz tylko kilka minut na wprowadzenie poprawnego kodu."));
                    break;
                }
                case 'otpauth-clear': {
                    if (xxdialogMode) return;
                    setDialogMode(2, "Aplikacja Authenticator", 1, null, message.success ? ('<b>' + "Usunięto aplikację Authenticator." + '</b> ' + "Funkcję tę można ponownie aktywować w dowolnym momencie.") : ('<b style=color:red>' + "usuwanie 2-stopniowej aktywacji logowania nieudana." + '</b> ' + "Spróbuj ponownie."));
                    break;
                }
                case 'otpauth-getpasswords': {
                    if (xxdialogMode) return;
                    var x = "Jednorazowe tokeny mogą być używane jako dodatkowe uwierzytelnienie. Wygeneruj zestaw, wydrukuj je i przechowuj w bezpiecznym miejscu.";
                    ...
                    if (message.passwords) {
                        ...
                        x += '<tr><td>' + "Brak Aktywnych Tokenów";
                    }
                    x += '</table></div></div><br />';
                    x += '<div><input type=button value=\'' + "Zamknij" + '\' onclick=setDialogMode(0) style=float:right></input>';
                    x += '<input type=button value=\'' + "Nowe Tokeny" + '\' onclick=\'account_manageOtp(1);\'></input>';
                    if (message.passwords != null) { x += '<input type=button value=\'' + "Wyczyść" + '\' onclick=\'account_manageOtp(2);\'></input>'; }
                    x += '</div><br />';
                    setDialogMode(2, "Zarządzaj Kopią Zapasową Kodów", 8, null, x, 'otpauth-manage');
                    break;
                }
                case 'verifyPhone': {
                    ...
                    x += '<br /><br /><div style=width:100%;text-align:center>' + "Kod weryfikacyjny:" + ' <input type=tel pattern="[0-9]" inputmode="number" maxlength=6 id=d2phoneCodeInput onKeyUp=account_managePhoneCodeValidate() onkeypress="if (event.key==\'Enter\') account_managePhoneCodeValidate(1)"></div></table>';
                    setDialogMode(2, "Powiadomienia na Telefon", 3, account_managePhoneConfirm, x, message.cookie);
                    ...
                    if ((xxdialogMode == 2) && (xxdialogTag == 'previousLogins')) {
                        ...
                        if (message.events.length == 0) {
                            ...
                            for (var i in message.events) {
                                ...
                                if (m == 107) { m = "Poprawnie zalogowano"; c = 'BBD1BB'; xx = ''; }
                                else if (m == 108) { m = "Nieprawidłowy 2FA"; c = 'DD9DC3'; xx = 'x'; }
                                else if (m == 109) { m = "Konto zablokowane"; c = 'E1BBBB'; xx = 'x'; }
                                else if (m == 110) { m = "Błędne hasło"; c = 'E1BBBB'; xx = 'x'; }
                        ...
                        setDialogMode(2, "Poprzednie Logowania", 1, null, x);
                    }
                    break;
                }
                case 'event': {
        ...
        function goStack() {
            ...
            if (idtype == 'files') {
                ...
                if ((features & 0x00040000) && !((userinfo.otpsecret == 1) || (userinfo.otphkeys > 0) || (userinfo.otpkeys > 0) || (userinfo.otpduo > 0) || (userinfo.otpdev > 0) || ((features & 0x00800000) && (userinfo.otpekey == 1)))) { setDialogMode(2, "Bezpieczeństwo Konta", 1, null, "Unable to access this feature until two-factor authentication is enabled. This is required for extra security. Go to the \"My Account\" and look at the \"Account Security\" section."); return; }  
                go(5);
            }
        }
        ...
        function account_viewPreviousLogins() {
            if (xxdialogMode) return;
            setDialogMode(2, "Poprzednie Logowania", 1, null, "Ładowanie...", 'previousLogins');
        ...
        function account_manageImage(mode) {
            ...
            setDialogMode(2, "Zarządzaj Obrazem Konta", 7, account_manageImageEx2, x, user._id);
        ...
        function toggleNightMode() {
            ...
            var x = '<input type=radio id=night0 name=nightmoderadio value=0 ' + ((cNightMode == 0) ? 'checked' : '') + '><label for=night0>' + "Domyślnie jak w przeglądarce" + '</label><br>';
            x += '<input type=radio id=night2 name=nightmoderadio value=2 ' + ((cNightMode == 2) ? 'checked' : '') + '><label for=night2>' + "Tryb jasny" + '</label><br>';
            x += '<input type=radio id=night1 name=nightmoderadio value=1 ' + ((cNightMode == 1) ? 'checked' : '') + '><label for=night1>' + "Tryb ciemny" + '</label><br>';
            setDialogMode(2, "Tryb Nocny", 3, toggleNightModeEx, x);
            QV('uiMenu', false);
        }
        ...
        function account_managePhone() {
            ...
            if (userinfo.phone != null) {
                ...
                x += '<td style=text-align:center><div style=padding:6px>' + "Zweryfikowany numer telefonu" + '</div><div style=font-size:20px>' + userinfo.phone + '</div>';
                x += '<div style=margin:10px><label><input id=d2delPhone type=checkbox onclick=account_managePhoneRemoveValidate() />' + "Usuń numer telefonu" + '</label></div>';
                setDialogMode(2, "Powiadomienia na Telefon", 3, account_managePhoneRemove, x);
                ...
                x += '<br /><br /><div style=width:100%;text-align:center>' + "Numer telefonu:" + ' <input type=tel pattern="[0-9]" autocomplete="tel" inputmode="tel" maxlength=18 id=d2phoneinput onKeyUp=account_managePhoneValidate() onkeypress="if (event.key==\'Enter\') account_managePhoneValidate(1)"></div></table>';
                setDialogMode(2, "Powiadomienia na Telefon", 3, account_managePhoneAdd, x, 'verifyPhone');
        ...
        function account_manageAuthEmail() {
            ...
            setDialogMode(2, "Uwierzytelnianie Email", 1, function () {
                if (emailU2Fenabled != Q('email2facheck').checked) { meshserver.send({ action: 'otpemail', enabled: Q('email2facheck').checked }); }
            }, "Po włączeniu tej opcji, przy każdym logowaniu, będziesz miał możliwość otrzymania tokena logowania na swoje konto e-mail w celu zwiększenia bezpieczeństwa." + '<br /><br /><label><input id=email2facheck type=checkbox ' + (emailU2Fenabled ? 'checked' : '') + '/>' + "Włącz dwuskładnikowe uwierzytelnianie email." + '</label>');
        }

        var loclist = { 'af': "Afrykański", 'sq': "albański", 'ar': "arabski (standardowy)", 'ar-dz': "arabski (Algieria)", 'ar-bh': "arabski (Bahrajn)", 'ar-eg': "arabski (Egipt)", 'ar-iq': "arabski (Irak)", 'ar-jo': "arabski (Jordania)", 'ar-kw': "arabski (Kuwejt)", 'ar-lb': "Arabski (Liban)", 'ar-ly': "arabski (Libia)", 'ar-ma': "arabski (Maroko)", 'ar-om': "arabski (Oman)", 'ar-qa': "arabski (Katar)", 'ar-sa': "arabski (Arabia Saudyjska)", 'ar-sy': "arabski (Syria)", 'ar-tn': "arabski (Tunezja)", 'ar-ae': "arabski (ZEA)", 'ar-ye': "arabski (Jemen)", 'an': "Aragoński", 'hy': "ormiański", 'as': "Assamski", 'ast': "Asturyjski", 'az': "azerbejdżański", 'eu': "baskijski", 'bg': "bułgarski", 'be': "białoruski", 'bn': "bengalski", 'bs': "bośniacki", 'br': "Bretoński", 'my': "Birmańczyk", 'ca': "Kataloński", 'ch': "Czamorrski", 'ce': "czeczeński", 'zh': "Chiński", 'zh-hk': "Chiński (Hong Kong)", 'zh-cn': "Chiński (ChRL)", 'zh-sg': "Chiński (Singapur)", 'zh-tw': "Chiński (Tajwan)", 'cv': "Czuwaski", 'co': "Korsykański", 'cr': "Cree", 'hr': "Chorwacki", 'cs': "Czeski", 'da': "Duński", 'nl': "Holenderski (Standard)", 'nl-be': "Holenderski (Belgia)", 'en': "Angielski", 'en-au': "Angielski (Australia)", 'en-bz': "Angielski (Belize)", 'en-ca': "Angielski (Kanada)", 'en-ie': "Angielski (Irlandia)", 'en-jm': "Angielski (Jamajka)", 'en-nz': "Angielski (Nowa Zelandia)", 'en-ph': "Angielski (Filipiny)", 'en-za': "Angielski (RPA)", 'en-tt': "Angielski (Trynidad i Tobago)", 'en-gb': "Angielski (Zjednoczone Królestwo)", 'en-us': "Angielski (Stany Zjednoczone)", 'en-zw': "Angielski (Zimbabwe)", 'eo': "esperanto", 'et': "estoński", 'fo': "Farerski", 'fa': "perski (perski)", 'fj': "Fidżi", 'fi': "Fiński", 'fr': "Francuski (Standard)", 'fr-be': "Francuski (Belgia)", 'fr-ca': "Francuski (Kanada)", 'fr-fr': "Francuski (Francja)", 'fr-lu': "Francuski (Luksemburg)", 'fr-mc': "Francuski (Monako)", 'fr-ch': "Francuski (Szwajcaria)", 'fy': "fryzyjski", 'fur': "friuliański", 'gd': "gaelicki (szkocki)", 'gd-ie': "gaelicki (irlandzki)", 'gl': "galacyjski", 'ka': "gruziński", 'de': "Niemiecki (Standard)", 'de-at': "Niemiecki (Austria)", 'de-de': "Niemiecki (Niemcy)", 'de-li': "Niemiecki (Liechtenstein)", 'de-lu': "Niemiecki (Luksemburg)", 'de-ch': "Niemiecki (Szwajcaria)", 'el': "Grecki", 'gu': "Gudziurati", 'ht': "haitański", 'he': "hebrajski", 'hi': "Hindi", 'hu': "język węgierski", 'is': "islandzki", 'id': "indonezyjski", 'iu': "Inuktitut", 'ga': "Irlandczyk", 'it': "Włoski (Standard)", 'it-ch': "Włoski (Szwajcaria)", 'ja': "Japoński", 'kn': "Kannada", 'ks': "kaszmirski", 'kk': "kazachski", 'km': "khmerski", 'ky': "Kirgiz", 'tlh': "klingoński", 'ko': "Koreański", 'ko-kp': "Koreański (Korea Północna)", 'ko-kr': "Koreański (Korea Południowa)", 'la': "łacina", 'lv': "łotewski", 'lt': "litewski", 'lb': "Luksemburski", 'mk': "FYRO Macedoński", 'ms': "Malajski", 'ml': "Malajalamski", 'mt': "Maltański", 'mi': "Maoryski", 'mr': "Marathi", 'mo': "Mołdawski", 'nv': "Nawaho", 'ng': "Ndonga", 'ne': "Nepalski", 'no': "norweski", 'nb': "norweski (bokmal)", 'nn': "norweski (nynorsk)", 'oc': "Prowansalski", 'or': "orija", 'om': "Oromo", 'fa-ir': "perski/Iran", 'pl': "Polski", 'pt': "Portugalski", 'pt-br': "Portugalski (Brazylia)", 'pa': "pendżabski", 'pa-in': "pendżabski (Indie)", 'pa-pk': "pendżabski (Pakistan)", 'qu': "keczua", 'rm': "retoromański", 'ro': "rumuński", 'ro-mo': "rumuński (Mołdawia)", 'ru': "Rosyjski", 'ru-mo': "Rosyjski (Mołdawia)", 'sz': "lapoński (lapoński)", 'sg': "Sango", 'sa': "sanskryt", 'sc': "sardyński", 'sd': "Sindhi", 'si': "cejloński", 'sr': "serbski", 'sk': "Słowacki", 'sl': "Słoweński", 'so': "Somani", 'sb': "łużycki", 'es': "Hiszpański", 'es-ar': "hiszpański (Argentyna)", 'es-bo': "hiszpański (Boliwia)", 'es-cl': "Hiszpański (Chile)", 'es-co': "hiszpański (Kolumbia)", 'es-cr': "hiszpański (Kostaryka)", 'es-do': "hiszpański (Dominikana)", 'es-ec': "hiszpański (Ekwador)", 'es-sv': "hiszpański (Salwador)", 'es-gt': "hiszpański (Gwatemala)", 'es-hn': "hiszpański (Honduras)", 'es-mx': "hiszpański (Meksyk)", 'es-ni': "hiszpański (Nikaragua)", 'es-pa': "hiszpański (panama)", 'es-py': "hiszpański (Paragwaj)", 'es-pe': "hiszpański (Peru)", 'es-pr': "hiszpański (Portoryko)", 'es-es': "hiszpański (Hiszpania)", 'es-uy': "hiszpański (Urugwaj)", 'es-ve': "hiszpański (Wenezuela)", 'sx': "Sutu", 'sw': "suahili", 'sv': "Szwedzki", 'sv-fi': "Szwedzki (Finlandia)", 'sv-sv': "Szwedzki (Szwecja)", 'ta': "Tamil", 'tt': "Tatar", 'te': "Teluga", 'th': "Tajski", 'tig': "Tigre", 'ts': "Tsonga", 'tn': "Tswana", 'tr': "Turecki", 'tk': "turkmeński", 'uk': "Ukraiński", 'hsb': "górnołużycki", 'ur': "Urdu", 've': "Venda", 'vi': "wietnamski", 'vo': "Volapuk", 'wa': "Waloński", 'cy': "Walijski", 'xh': "Xhosa", 'ji': "jidysz", 'zu': "Zulus" };
        var loclistex = { 'zh-chs': "Chiński (Uproszczony)", 'zh-cht': "Chiński (Tradycyjny)" };
        function account_showLocalizationSettings() {
            if (xxdialogMode) return false;
            var n = getstore('loctag', 0), y = '';
            var x = '<select id=d2locselect style=width:180px><option value="*">' + "Użyj ustawień przeglądarki" + '</option>';
            ...
            if (serverinfo.languages && serverinfo.languages.length > 0) {
                y += "Zmiana języka będzie wymagała odświeżenia strony." + '<br /><br />';
                var z = '<select id=d2langselect style=width:180px><option value="*">' + "Użyj ustawień przeglądarki" + '</option>';
                ...
                z += '</select>';
                y += addHtmlValue("Język", z);
            }
            y += addHtmlValue("Data & Czas", x);

            if ((userinfo.siteadmin == 0xFFFFFFFF) && (domain == '')) {
                y += '<br /><a rel="noreferrer noopener" target="_blank" href="translator.htm">' + "Pomóż tłumaczyć MeshCentral" + '</a>';
            }

            setDialogMode(2, "Ustawienia Lokalizacji", 3, account_showLocalizationSettingsEx, y);
            return false;
        }
        ...
        function account_addOtp() {
            ...
            setDialogMode(2, "Aplikacja Authenticator", 2, function () { meshserver.send({ action: 'otpauth-setup', secret: Q('d2optsecret').attributes.secret.value, token: Q('d2otpauthinput').value }); }, '<div id=d2optinfo>' + "Ładowanie..." + '</div>', 'otpauth-request');
        ...
        function account_removeOtp() {
            if (xxdialogMode || (userinfo.otpsecret != 1) || ((features & 4096) == 0)) return;
            setDialogMode(2, "Aplikacja Authenticator", 3, function () { meshserver.send({ action: 'otpauth-clear' }); }, "Potwierdzasz usunięcie aplikacji dwuetapowego logowania?");
        }
        ...
        function account_showVerifyEmail() {
            ...
            var x = "Kliknij ok, aby wysłać wiadomość weryfikacyjną do:" + '<br /><div style=padding:8px><b>' + EscapeHtml(userinfo.email) + '</b></div>' + "Proszę poczekać kilka minut na otrzymanie weryfikacji.";
            setDialogMode(2, "Weryfikacja Email", 3, account_showVerifyEmailEx, x);
        }
        ...
        function account_showChangeEmail() {
            if (xxdialogMode) return;
            var x = addHtmlValue("E-mail", '<input id=dp3email style=width:170px maxlength=256 onchange=account_validateEmail() onkeyup=account_validateEmail(event) />');
            setDialogMode(2, "Zmiana Adresu Email", 3, account_changeEmail, x);
        ...
        function account_showDeleteAccount() {
            ...
            x += '<td align=right>' + "Hasło:" + '</td><td><input id=apassword1 type=password name=apassword1 autocomplete=off onchange=account_validateDeleteAccount() onkeyup=account_validateDeleteAccount() /></td>';
            x += '</tr><tr><td align=right>' + "Hasło:" + '</td><td><input id=apassword2 type=password name=apassword2 autocomplete=off onchange=account_validateDeleteAccount() onkeyup=account_validateDeleteAccount() /></td>';
            x += '</tr></table><div style=padding:10px;margin-bottom:4px>';
            x += '<input id=account_dlgCancelButton type=button value="' + "Anuluj" + '" style=float:right;width:80px;margin-left:5px onclick=dialogclose(0)>';
            x += '<input id=account_dlgOkButton type=submit value="' + "OK" + '" style="float:right;width:80px" onclick=dialogclose(1)>';
            x += '</div><br /></form>';
            setDialogMode(2, "Usuń Konto", 0, null, x);
        ...
        function account_showChangePassword() {
            ...
            x += '<tr><td align=right>' + nobreak("Stare hasło:") + '</td><td><input id=apassword0 type=password name=apassword0 autocomplete=off onchange=account_validateNewPassword() onkeyup=account_validateNewPassword() onkeydown=account_validateNewPassword() /> <b></b></td></tr>';
            x += '<tr><td align=right>' + nobreak("Nowe hasło:") + '</td><td><input id=apassword1 type=password name=apassword1 autocomplete=off onchange=account_validateNewPassword() onkeyup=account_validateNewPassword() onkeydown=account_validateNewPassword() /> <b><span id=dxPassWarn></span></b></td></tr>';
            x += '<tr><td align=right>' + nobreak("Nowe hasło:") + '</td><td><input id=apassword2 type=password name=apassword2 autocomplete=off onchange=account_validateNewPassword() onkeyup=account_validateNewPassword() onkeydown=account_validateNewPassword() /></td></tr>';
            if (features & 0x00010000) { x += '<tr><td align=right>' + "Podpowiedź do hasła:" + '</td><td><input id=apasswordhint name=apasswordhint maxlength=250 type=text autocomplete=off onchange=account_validateNewPassword() onkeyup=account_validateNewPassword() onkeydown=account_validateNewPassword() /></td></tr>'; }
            x += '</table>'
            if (passRequirements) {
                var r = [], rc = 0;
                for (var i in passRequirements) { if ((i != 'reset') && (i != 'hint')) { r.push(i + ':' + passRequirements[i]); rc++; } }
                if (rc > 0) { x += '<br /><span style=font-size:x-small>' + format("Wymagania: {0}.", r.join(', ')) + '</span>'; }
            }
            x += '<br />';
            setDialogMode(2, "Zmień Hasło", 3, account_showChangePasswordEx, x);
            Q('apassword0').focus();
        ...
        function account_createMesh() {
            ...
            if ((userinfo.siteadmin != 0xFFFFFFFF) && ((userinfo.siteadmin & 64) != 0)) { setDialogMode(2, "Nowa Grupa Urządzeń", 1, null, "To konto nie ma uprawnień do tworzenia nowej grupy urządzeń."); return; }

            // Remind the user to verify the email address
            if ((userinfo.emailVerified !== true) && (serverinfo.emailcheck == true) && (userinfo.siteadmin != 0xFFFFFFFF)) { setDialogMode(2, "Bezpieczeństwo Konta", 1, null, "Nie można uzyskać dostępu do urządzenia, dopóki nie zostanie zweryfikowany adres e-mail. Jest to wymagane do odzyskania hasła. Przejdź do strony \"Moje Konto\", aby zmienić i zweryfikować adres e-mail."); return; }

            // Remind the user to add two factor authentication
            if ((features & 0x00040000) && !((userinfo.otpsecret == 1) || (userinfo.otphkeys > 0) || (userinfo.otpkeys > 0) || (userinfo.otpduo > 0) || (userinfo.otpdev > 0) || ((features & 0x00800000) && (userinfo.otpekey == 1)))) { setDialogMode(2, "Bezpieczeństwo Konta", 1, null, "Nie można uzyskać dostępu do urządzenia, dopóki nie zostanie włączone uwierzytelnianie dwuskładnikowe. Jest to wymagane dla dodatkowego bezpieczeństwa. Przejdź do sekcji \"Moje Konto\"  i zapoznaj się z sekcją \"Bezpieczeństwo Konta\"."); return; }

            // We are allowed, let's prompt to information
            var x = addHtmlValue("Nazwa", '<input id=dp3meshname style=width:170px maxlength=64 onchange=account_validateMeshCreate() onkeyup=account_validateMeshCreate() />');
            x += addHtmlValue("Typ", '<div style=width:170px;margin:0;padding:0><select id=dp3meshtype style=width:100% onchange=account_validateMeshCreate() ><option value=2>' + "Grupa Agenta Oprogramowania" + '</option><option value=1>' + "Tylko Intel&reg; AMT" + '</option></select></div>');
            x += addHtmlValue("Opis", '<div style=width:170px;margin:0;padding:0><textarea id=dp3meshdesc maxlength=1024 style=width:100%;resize:none></textarea></div>');
            setDialogMode(2, "Utwórz Grupę Urządzeń", 3, account_createMeshEx, x);
        ...
        function account_validateNewPassword() {
            ...
            if (Q('apassword1').value != '') {
                if (passRequirements == null || passRequirements == '') {
                    ...
                    if (passReq == false) { ok = false; r = '<span style=color:red>' + "Polityka" + '<span>' }
                }
            }
            QH('dxPassWarn', r);
        ...
        function updateMeshes() {
            ...
            for (i in meshes) {
                ...
                var rights = "Częściowe Uprawnienia";
                if (meshrights == 0xFFFFFFFF) rights = "Pełnoprawny Administrator"; else if (meshrights == 0) rights = "Brak Uprawnień";
        ...
        function getNiceSize(bytes) {
            if (bytes <= 0) return "Przestrzeń przekracza";
            if (bytes < 2048) return format("{0}b pozostało", bytes);
            if (bytes < 2097152) return format("{0}k pozostało", Math.round(bytes / 1024));
            if (bytes < 2147483648) return format("{0}m pozostało", Math.round(bytes / 1024 / 1024));
            return format("{0}g pozostało", Math.round(bytes / 1024 / 1024 / 1024));
        }
        ...
        function p5showPublicLink(u) { setDialogMode(2, "Publiczny Link", 1, null, '<input type=text style=width:100% value="' + u + '" readonly />'); }
        ...
        function p5setActions() {
            ...
            Q('p5SelectAllButton').value = (cc > 0 ? "Brak" : "Wszystkie");
        ...
        function getFileSizeStr(size) { if (size == 1) return "1 bajt"; return format("{0} bajtów", size); }
        ...
        function p5createfolder() { setDialogMode(2, "Nowy Folder", 3, p5createfolderEx, '<input type=text id=p5renameinput maxlength=64 onkeyup=p5fileNameCheck(event) style=width:100% />'); focusTextBox('p5renameinput'); p5fileNameCheck(); }
        ...
        function p5deletefile() { var cc = getFileSelCount(), rec = (getFileSelDirCount() > 0) ? '<br /><br /><label><input type=checkbox id=p5recdeleteinput>' + "Usuwanie Rekursywne" + '</label><br>' : '<input type=checkbox id=p5recdeleteinput style=\'display:none\'>'; setDialogMode(2, "Usuń", 3, p5deletefileEx, (cc > 1) ? (format("Usunąć {0} wybrane pozycje?", cc) + rec) : ("Usunąć wybraną pozycję?" + rec)); }
        ...
        function p5pasteFile() { var x = ''; if ((p5clipboard != null) && (p5clipboard.length > 0)) { x = format("Potwierdzasz {0} z {1} pozycja{2} do tej lokalizacji?", (p5clipboardCut == 0 ? 'copy' : 'move'), p5clipboard.length, ((p5clipboard.length > 1) ? 's' : '')) } setDialogMode(2, "Wklej", 3, p5pasteFileEx, x); }
        ...
        function p5updateClipview() { var x = ''; if ((p5clipboard != null) && (p5clipboard.length > 0)) { x = format("Utrzymaj {0} pozycji{1} dla {2}", p5clipboard.length, ((p5clipboard.length > 1) ? 's' : ''), (p5clipboardCut == 0 ? "kopiuj" : "przenieś")) + ', <a href=# onclick="return p5clearClip()" style=cursor:pointer>' + "Wyczyść" + '</a>.' } QH('p5bottomstatus', x); p5setActions(); }
        ...
        function updateDevices() {
            ...
            for (var i in nodes) {
                ...
                if (sort == 0) {
                    ...
                    if (((meshes[nodes[i].meshid]?nodes[i].meshid:'*') != current)) {
                        deviceHeaderSet();
                        var extra = '';
                        if ((meshes[nodes[i].meshid] != null) && (meshes[nodes[i].meshid].mtype == 1)) { extra = '<span style=color:lightgray>' + ", tylko Intel&reg; AMT" + '</span>'; }
                        ...
                        if (meshes[nodes[i].meshid]) {
                            ...
                            r += '</span><span id=MxMESH><i>' + "Poszczególne Urządzenia" + '</i></span><span id=DevxHeader' + deviceHeaderId + ' style=color:lightgray></span></div>';
                            current = '*';
                        }
            ...
            if ((r == '') && (nodes.length > 0) && (Q('SearchInput').value != '')) {
                viewNothing = true;
                r = '<div style="margin:30px">' + "Brak urządzeń pasujących do wyszukiwania." + '</div>';
            }
            ...
            if ((sort == 0) && (Q('SearchInput').value == '')) {
                for (var i in meshes) {
                    ...
                    if ((displayedMeshes[mesh._id] == null) && (IsMeshViewable(mesh))) {
                        ...
                        if (mesh.mtype == 1) { r += '<div style=padding:10px><i>' + "Brak urządzeń Intel&reg; AMT w tej grupie"; }
                        if (mesh.mtype > 1) { r += '<div style=padding:10px><i>' + "Brak urządzeń w tej grupie"; }
                        r += '.</i></div></div>';
                        current = mesh._id;
                        count++;
                    }
            ...
            if (count == 0) {
                if ((Q('SearchInput').value != '') || (Q('OnlineCheckBox').checked)) {
                    QH('xdevices', '<div style="margin-top:50px;text-align:center"><span style="font-size:30px">' + "Brak urządzeń" + '</span><br /><br />' + "Brak urządzeń pasujących do wyszukiwania." + ' <a onclick=clearSearchInput() style=cursor:pointer>' + "Wyczyść filtr szukania" + '</a></div>');
                } else {
                    QH('xdevices', '<div style="margin-top:50px;text-align:center"><span style="font-size:30px">' + "Brak urządzeń" + '</span><br /><br />' + "Aby dodać urządzenia, skorzystaj z desktopowej wersji tej strony." + '</div>');
                }
            } else {
                QH('xdevices', r);
            }
        ...
        function updateDeviceViewHtml(div, node) {
            ...
            if ((div.offsetTop >= visibleTop) && (div.offsetTop < visibleBottom)) {
                ...
                if (title.length == 0) { title = '<i>' + "Brak" + '</i>'; }
                ...
                if (name.length == 0) { name = '<i>' + "Brak" + '</i>'; }
                ...
                if (node.sessions != null) {
                    ...
                    if (node.sessions.battery != null) {
                        ...
                        var statestr = '';
                        if (bat.state == 'ac') { statestr = "Urządzenie jest podłączone"; }
                        else if (bat.state == 'dc') { statestr = "Urządzenie na zasilaniu bateryjnym"; }
        ...
        function showDeviceHelpRequests(nodeid, force, e) {
            ...
            if (x != '') { setDialogMode(2, "Prośby Pomocy" + ' - ' + EscapeHtml(node.name), 1, null, x, 'HELPREQ-' + node._id); } else { setDialogMode(0); }
            return false;
        }
                ...
                if ((i == 'kvm') && (node.sessions.multidesk == null)) {
                    ...
                    for (var j in node.sessions.kvm) {
                        if (j.startsWith('user/')) {
                            var trash = '';
                            if ((j == userinfo._id) || (GetNodeRights(node) == 0xFFFFFFFF)) { trash = ' <a href=# onclick=\'return endDeviceSession("kvm", "' + encodeURIComponentEx(node._id) + '", "' + encodeURIComponentEx(j) + '")\' title="' + "Rozłącz tą sesję" + '" style=cursor:pointer><img src=images/trash.png border=0 height=10 width=10></a>'; }
                            x += addHtmlValue4(getUserName(j), ((node.sessions.kvm[j] == 1) ? "1 sesja" : nobreak(format("{0} sesje", node.sessions.kvm[j]))) + trash);
                        } else if (j == 'busy') {
                            x += addHtmlValue2("Urządzenie jest zajęte", ((node.sessions.kvm[j] == 1) ? "1 sesja" : nobreak(format("{0} sesje", node.sessions.kvm[j]))));
                        }
                    }
                } else if (i == 'multidesk') {
                    x += '<u>' + "Zdalny Pulpit" + '</u>';
                    for (var j in node.sessions.multidesk) {
                        var trash = '';
                        if ((j == userinfo._id) || (GetNodeRights(node) == 0xFFFFFFFF)) { trash = ' <a href=# onclick=\'return endDeviceSession("multidesk", "' + encodeURIComponentEx(node._id) + '", "' + encodeURIComponentEx(j) + '")\' title="' + "Rozłącz tą sesję" + '" style=cursor:pointer><img src=images/trash.png border=0 height=10 width=10></a>'; }
                        x += addHtmlValue4(getUserName(j), ((node.sessions.multidesk[j] == 1) ? "1 sesja" : nobreak(format("{0} sesje", node.sessions.multidesk[j]))) + trash);
                    }
                } else if (i == 'terminal') {
                    x += '<u>' + "Terminal" + '</u>';
                    for (var j in node.sessions.terminal) {
                        var trash = '';
                        if ((j == userinfo._id) || (GetNodeRights(node) == 0xFFFFFFFF)) { trash = ' <a href=# onclick=\'return endDeviceSession("terminal", "' + encodeURIComponentEx(node._id) + '", "' + encodeURIComponentEx(j) + '")\' title="' + "Rozłącz tą sesję" + '" style=cursor:pointer><img src=images/trash.png border=0 height=10 width=10></a>'; }
                        x += addHtmlValue4(getUserName(j), ((node.sessions.terminal[j] == 1) ? "1 sesja" : nobreak(format("{0} sesje", node.sessions.terminal[j]))) + trash);
                    }
                } else if (i == 'files') {
                    x += '<u>' + "Pliki" + '</u>';
                    for (var j in node.sessions.files) {
                        var trash = '';
                        if ((j == userinfo._id) || (GetNodeRights(node) == 0xFFFFFFFF)) { trash = ' <a href=# onclick=\'return endDeviceSession("files", "' + encodeURIComponentEx(node._id) + '", "' + encodeURIComponentEx(j) + '")\' title="' + "Rozłącz tą sesję" + '" style=cursor:pointer><img src=images/trash.png border=0 height=10 width=10></a>'; }
                        x += addHtmlValue4(getUserName(j), ((node.sessions.files[j] == 1) ? "1 sesja" : nobreak(format("{0} sesje", node.sessions.files[j]))) + trash);
                    }
                } else if (i == 'tcp') {
                    x += '<u>' + "TCP Routing" + '</u>';
                    for (var j in node.sessions.tcp) {
                        var trash = '';
                        if ((j == userinfo._id) || (GetNodeRights(node) == 0xFFFFFFFF)) { trash = ' <a href=# onclick=\'return endDeviceSession("tcp", "' + encodeURIComponentEx(node._id) + '", "' + encodeURIComponentEx(j) + '")\' title="' + "Rozłącz tą sesję" + '" style=cursor:pointer><img src=images/trash.png border=0 height=10 width=10></a>'; }
                        x += addHtmlValue4(getUserName(j), ((node.sessions.tcp[j] == 1) ? "1 sesja" : nobreak(format("{0} sesje", node.sessions.tcp[j]))) + trash);
                    }
                } else if (i == 'udp') {
                    x += '<u>' + "Routing UDP" + '</u>';
                    for (var j in node.sessions.udp) {
                        var trash = '';
                        if ((j == userinfo._id) || (GetNodeRights(node) == 0xFFFFFFFF)) { trash = ' <a href=# onclick=\'return endDeviceSession("udp", "' + encodeURIComponentEx(node._id) + '", "' + encodeURIComponentEx(j) + '")\' title="' + "Rozłącz tą sesję" + '" style=cursor:pointer><img src=images/trash.png border=0 height=10 width=10></a>'; }
                        x += addHtmlValue4(getUserName(j), ((node.sessions.udp[j] == 1) ? "1 sesja" : nobreak(format("{0} sesje", node.sessions.udp[j]))) + trash);
                    }
                }
            }
            if (x != '') { setDialogMode(2, "Sesje" + ' - ' + EscapeHtml(node.name), 1, null, x, 'SESSIONS-' + node._id); } else { setDialogMode(0); }
        }
        ...
        function showDeviceMessages(nodeid, force, e) {
            ...
            x += '</div>';
            if (count > 0) setDialogMode(2, "Wiadomości Agenta" + ' - ' + EscapeHtml(node.name), 1, null, x, 'MESSAGES-' + node._id);
            return false;
        }

        var powerStatetable = ['', "Uruchomiony", "Uśpij", "Uśpij", "Uśpij", "Hibernacja", "Wyłącz", "Obecny", "Wyłącz"];
        var powerStateStrings = ['', "Uruchomiony", "W uśpieniu", "W uśpieniu", "Głębokie Uśpienie", "Hibernacja", "Miękkie-Wyłączenie", "Obecny", "Wyłącz"];
        var powerStateStrings2 = ['', "Urządzenie ma zasilanie", "Urządzenie jest w stanie uśpienia (S1)", "Urządzenie jest w stanie uśpienia (S2)", "Urządzenie jest w stanie głębokiego uśpienia (S3)", "Urządzenie jest hibernowane (S4)", "Urządzenie jest w stanie miękkiego wyłączenia (S5)", "Urządzenie jest obecne, ale nie można określić stanu zasilania", "To urządzenie jest wyłączone"];
        ...
        function NodeStateStr(node) {
            ...
            if (node.conn) {
                if ((node.conn & 1) != 0) { states.push('<span>' + ((node.mtype == 4) ? ((node.porttype == 'PDU') ? "Przełącz" : "IP-KVM") : "Agent") + '</span>'); }
                if ((node.conn & 2) != 0) { states.push('<span>' + "CIRA" + '</span>'); }
                else if ((node.conn & 4) != 0) { states.push('<span>' + "Intel&reg; AMT" + '</span>'); }
                if ((node.conn & 8) != 0) { states.push('<span>' + "Przekierowanie" + '</span>'); }
        ...
        function deviceHeaderSet() {
            ...
            deviceHeaders['DevxHeader' + deviceHeaderId] = ', ' + deviceHeaderTotal + ((deviceHeaderTotal == 1) ? " instanacja" : " instanacje");
            var title = '';
        ...
        */
        ...
        function gotoDevice(nodeid, panel, refresh) {
            ...
            if (!currentNode || currentNode._id != node._id || refresh == true) {
                ...
                if ((currentNode.sessions != null) && (currentNode.sessions.battery != null)) {
                    ...
                    var statestr = '';
                    if (bat.state == 'ac') { statestr = "Urządzenie jest podłączone"; }
                    if (bat.state == 'dc') { statestr = "Urządzenie na zasilaniu bateryjnym"; }
                ...
                if (nname.length == 0) { nname = '<i>' + "Brak" + '</i>'; }
                ...
                // Attribute: Mesh
                if (mesh) { x += addDeviceAttribute('<span>' + "Grupa" + '</span>', '<a onclick=goForward("' + node.meshid + '") style=cursor:pointer>' + EscapeHtml(meshes[node.meshid].name) + '</a>'); }

                // Attribute: Name
                if (node.rname != null) { x += addDeviceAttribute('<span>' + "Nazwa" + '</span>', '<span>' + EscapeHtml(node.rname) + '</span>'); }

                // Attribute: Host
                if ((((features & 1) == 0) && (node.mtype != 4)) || (node.mtype == 3)) { // If not WAN-only, local hostname is in use
                    if ((meshrights & 4) != 0) {
                        if (node.host) {
                            x += addDeviceAttribute("Nazwa hosta", '<span onclick=showEditNodeValueDialog(1) style=cursor:pointer>' + EscapeHtml(node.host) + '</span>');
                        } else {
                            x += addDeviceAttribute("Nazwa hosta", '<span onclick=showEditNodeValueDialog(1) style=cursor:pointer><i>' + "Brak" + '</i></span>');
                        }
                    } else {
                        x += addDeviceAttribute("Nazwa hosta", EscapeHtml(node.host));
                    }
                }

                // Attribute: Description
                var description = node.desc ? EscapeHtml(node.desc) : '<i>' + "Brak" + '</i>';
                if ((meshrights & 4) != 0) {
                    x += addDeviceAttribute("Opis", '<span onclick=showEditNodeValueDialog(2) style=cursor:pointer>' + description + '</span>');
                } else {
                    x += addDeviceAttribute("Opis", description);
                }

                // IP-KVM information
                if (node.mtype == 4) {
                    if (node.portnum != null) { x += addDeviceAttribute("Numer Portu", node.portnum); }
                    if (node.porttype != null) { x += addDeviceAttribute("Typ Portu", node.porttype); }
                }

                // Attribute: Mesh Agent
                if ((node.agent != null) && (node.agent.id != null) && (node.mtype == 3)) {
                    if (node.agent.id == 4) { x += addDeviceAttribute("Typ Urządzenia", "Windows"); }
                    if (node.agent.id == 6) { x += addDeviceAttribute("Typ Urządzenia", "Linux"); }
                    if (node.agent.id == 29) { x += addDeviceAttribute("Typ Urządzenia", "System operacyjny Mac"); }
                    ...
                    if ((node.agent.root === false) && ((node.conn & 1) != 0)) { str += ', ' + "Ograniczone"; }
                ...
                if (node.intelamt != null) {
                    var str = '';
                    var provisioningStates = { 0: nobreak("Nie aktywowany (Przed)"), 1: nobreak("Nie aktywowany (W)"), 2: nobreak("Aktywowano") };
                    if (node.intelamt.ver != null && node.intelamt.state == null) { str += '<i>' + nobreak("Nieznany Stan") + '</i>, v' + EscapeHtml(node.intelamt.ver); }
                    else if ((node.intelamt.ver == null) && (node.intelamt.state == 2)) { str += '<i>' + "Aktywowano" + '</i>'; }
                    else if ((node.intelamt.ver == null) || (node.intelamt.state == null)) { str += '<i>' + "Nieznana Wersja i Stan" + '</i>'; }
                    else {
                    ...
                    if (node.intelamt.state == 2) {
                        if (node.intelamt.tls == 1) { str += ', <span title="' + "Intel&reg; AMT jest skonfigurowany z zabezpieczeniem sieciowym TLS." + '">' + "TLS" + '</span>'; }
                        ...
                        if (node.intelamt.user == null || node.intelamt.user == '') { // If credentials are not set, allow setting them.
                            if ((meshrights & 4) != 0) {
                                str += ', <i style=color:#FF0000;cursor:pointer title="' + "Edycja poświadczeń Intel&reg; AMT" + '" onclick=editDeviceAmtSettings("' + node._id + '")>' + "Brak Poświadczeń" + '</i>';
                                editUserCredentialsIcon = true;
                            } else {
                                str += ', <i style=color:#FF0000>' + "Brak Poświadczeń" + '</i>';
                            }
                            ...
                            var warn = null;
                            if ((node.intelamt.warn & 1) != 0) { warn = "Nieprawidłowe Poświadczenia"; }
                            if ((node.intelamt.warn & 8) != 0) { warn = "Sprawdzanie Poświadczeń"; }
                            if (warn != null) {
                                if ((meshrights & 4) != 0) {
                                    str += ', <i style=color:#FF0000;cursor:pointer title="' + "Edycja poświadczeń Intel&reg; AMT" + '" onclick=editDeviceAmtSettings("' + node._id + '")>' + warn + '</i>';
                                    editUserCredentialsIcon = true;
                                } else {
                        ...
                        if (editUserCredentialsIcon) {
                            str += '<img src=images/link4.png height=10 width=10 title="' + "Edycja poświadczeń Intel&reg; AMT" + '" style=cursor:pointer onclick=editDeviceAmtSettings("' + node._id + '")>';
                        }
                    }
                ...
                if ((node.agent != null) && (node.agent.tag != null) && (node.agent.tag != 'mailto:')) {
                    ...
                    x += addDeviceAttribute("Tag Agenta", tag);
                }
                ...
                if (connectivity && connectivity > 1) {
                    var cstate = [];
                    if ((node.conn & 1) != 0) cstate.push('<span>' + ((node.mtype == 4) ? ((node.porttype == 'PDU') ? "Przełącz" : "IP-KVM") : "Agent") + '</span>');
                    if ((node.conn & 2) != 0) cstate.push('<span>' + "Intel&reg; AMT CIRA" + '</span>');
                    else if ((node.conn & 4) != 0) cstate.push('<span>' + "Intel&reg; AMT" + '</span>');
                    if ((node.conn & 8) != 0) cstate.push('<span>' + "Przekierowanie Agenta" + '</span>');
                    if ((node.conn & 16) != 0) cstate.push('<span>' + "MQTT" + '</span>');
                    x += addDeviceAttribute("Łączność", cstate.join(', '));
                }

                // Node tags
                var groupingTags = '<i>' + "Brak" + '</i>';
                if (node.tags != null) { groupingTags = ''; for (var i in node.tags) { groupingTags += '<span class=tagSpan>' + EscapeHtml(node.tags[i]) + '</span> '; } }
                if ((meshrights & 4) != 0) {
                    x += addDeviceAttribute("Tagi", '<span onclick=showEditNodeValueDialog(3) style=cursor:pointer;color:black>' + groupingTags + '</span>');
                } else {
                    x += addDeviceAttribute("Tagi", '<span style=line-height:26px;color:black>' + groupingTags + '</span>');
                }
                ...
                if ((node.ssh != null) || (node.rdp != null)) {
                    var y = [];
                    if ((meshrights & 4) != 0) {
                        if (node.ssh != null) { y.push('<span onclick=showClearSshDialog(3) style=cursor:pointer>' + ((node.ssh == 1) ? "SSH-Uużytkownik+Hasło" : ((node.ssh == 2) ? "SSH-Uużytkownik+Klucz+Hasło" : "SSH-Uużytkownik+Klucz")) + ' <img class=hoverButton src="images/link5.png" width=10 height=10 /></span>'); }
                        ...
                        if (node.ssh != null) { y.push(((node.ssh == 1) ? "SSH-Uużytkownik+Hasło" : ((node.ssh == 2) ? "SSH-Uużytkownik+Klucz+Hasło" : "SSH-Uużytkownik+Klucz"))); }
                        if (node.rdp != null) { y.push("RDP"); }
                    }
                    x += addDeviceAttribute("Poświadczenia", y.join(', '));
                }

                x += '</table><br />';
                // Show action button, only show if we have permissions 4, 8, 64
                if (((meshrights & (4 + 8 + 64 + 262144)) != 0) && (node.mtype < 3)) { x += '<input type=button value="' + "Akcje" + '" onclick=deviceActionFunction() />'; }
                x += '<input type=button value="' + "Notatki" + '" onclick=showNotes(' + ((meshrights & 128) == 0) + ',"' + encodeURIComponent(node._id) + '") />';
                ...
                if ((node.mtype == 4) && (connectivity & 1)) {
                    if (node.porttype == 'PDU') {
                        if (node.pwr == 1) {
                            if (meshrights & 0x40000) { x += '<input type=button value="' + "Wyłącz" + '" title="' + "Wyłącz" + '" onclick=setIpPduState(0) />'; }
                        } else if (node.pwr == 8) {
                            if (meshrights & 0x40) { x += '<input type=button value="' + "Włącz" + '" title="' + "Włącz" + '" onclick=setIpPduState(1) />'; }
                        }
                    } else {
                        if (meshrights & 8) { x += '<input type=button value="' + "Zdalne Sterowanie." + '" title="' + "Zdalne Sterowanie." + '" onclick=openIpKvmRemoteControl("' + encodeURIComponentEx(node._id) + '") />'; }x
                    }
                }
                ...
                if ((meshrights & 0x8000) != 0) { x += '<a style=cursor:pointer onclick=p10showDeleteNodeDialog("' + node._id + '")>' + "Usuń Urządzenie" + '</a>'; }
                ...
                if ((connectivity & 1) != 0) { if (powerstate.length > 0) { powerstate += ', '; } powerstate += ((node.mtype == 4) ? ((node.porttype == 'PDU') ? "Przełącz" : "IP-KVM") : "Agent"); }
                if ((connectivity & 2) != 0) { if (powerstate.length > 0) { powerstate += ', '; } powerstate += "Intel&reg; AMT połączono"; }
                else if ((connectivity & 4) != 0) { if (powerstate.length > 0) { powerstate += ', '; } powerstate += "Intel&reg; AMT wykryto"; }
                if ((connectivity & 16) != 0) { if (powerstate.length > 0) { powerstate += ', '; } powerstate += "Połączony kanał MQTT"; }
        ...
        function setIpPduState(op) {
            if (op == 0) {
                setDialogMode(2, "Operacja Zasilania", 3, function () { meshserver.send({ action: 'poweraction', nodeids: [currentNode._id], actiontype: 2 }); }, "Czy wykonać wyłączenie?"); // Turn off
            } else {
                setDialogMode(2, "Operacja Zasilania", 3, function () { meshserver.send({ action: 'wakedevices', nodeids: [currentNode._id] }); }, "Czy wykonać uruchomienie?"); // Turn on
            }
        }
        ...
        function deviceToastFunction() {
            if (xxdialogMode) return;
            setDialogMode(2, "Wysuwane Powiadomienie Urządzenia", 3, deviceToastFunctionEx, '<textarea id=d2devToast style=width:100%;height:80px;resize:none;overflow-y:scroll></textarea>');
        }
        ...
        function setupDeviceMenu(op, obj) {
            ...
            var menus = [];
            if (currentDevicePanel != 0) { menus.push({ n: "Ogólne", f: 'setupDeviceMenu(0)' }); }
            ...
            ) { menus.push({ n: "Pulpit", f: 'setupDeviceMenu(1)' }); }
            ...
            if ((currentDevicePanel != 2) && (currentNode != null) && (meshrights & 8) && ((meshrights == 0xFFFFFFFF) || ((meshrights & 1024) == 0)) && ((currentNode.mtype != 1) && (currentNode.agent) && (currentNode.agent.caps & 4))) { menus.push({ n: "Pliki", f: 'setupDeviceMenu(2)' }); }
            if ((currentDevicePanel != 3) && (currentNode != null) && (currentNode.mtype < 3) && ((meshrights & 1048576) != 0)) { menus.push({ n: "Szczegóły", f: 'setupDeviceMenu(3)' }); }
            if ((currentDevicePanel != 4) && (currentNode != null) && (meshrights & 0x00000010) && (currentNode.mtype == 2)) { menus.push({ n: "Konsola", f: 'setupDeviceMenu(4)' }); }
        ...
        function deviceActionFunction() {
            ...
            var x = "Wybierz operację, która ma być wykonana na tym urządzeniu." + '<br /><br />';
            ...
            if ((currentNode.agent != null) && (currentNode.agent.id == 14)) {
                if (((currentNode.conn & 1) != 0) && ((rights & 8) != 0)) {
                    ...
                    y += '<option value=401>' + "Wibracja" + '</option>';
                    z += '<div id=d2devicetimediv>' + addHtmlValue("Czas", '<select id=d2devicetime style=float:right;width:170px><option value=1000>' + "1 sekunda" + '</option><option value=5000>' + "5 sekund" + '</option><option value=10000>' + "10 sekund" + '</option></select>') + '</div>';
                }
            } else {
                if ((rights & 64) != 0) { count++; y += '<option value=100>' + "Wybudzenie" + '</option>'; } // Wake-up permission
                //if (((currentNode.conn & 1) != 0) && ((rights & 131072) != 0)) { count++; y += '<option value=106>' + "Run Commands" + '</option>'; } // Remote command permission
                if ((currentNode.conn != 0) && ((rights & 262144) != 0)) { count++; y += '<option value=4>' + "Uśpij" + '</option><option value=3>' + "Reset" + '</option><option value=2>' + "Wyłącz" + '</option>'; }
                ...
                if ((currentNode.intelamt != null) && (currentNode.intelamt.state == 2) && ((currentNode.conn & 6) != 0) && ((rights & 262144) != 0)) {
                    ...
                    y += '<option value=308>' + "Intel&reg; AMT Wyłączenie" + '</option>';
                }
                if ((currentNode.intelamt != null) && (currentNode.intelamt.state == 2) && ((currentNode.conn & 6) != 0) && ((rights & 64) != 0)) {
                    count++;
                    y += '<option value=302>' + "Intel&reg; AMT Włączenie" + '</option>';
                }
            ...
            y += '</select>';
            x += addHtmlValue("Operacja", y);
            if (count == 0) { x = "Dla tego urządzenia nie są obecnie dostępne żadne akcje."; }
            setDialogMode(2, "Akcje Urządzenia", (count == 0) ? 2 : 3, deviceActionFunctionEx, x + z);
        ...
        function deviceActionFunctionEx() {
            ...
            if (op == 100) {
                ...
                */
                ...
                setDialogMode(2, "Intel&reg; AMT Operacje Zasilania", 3, function () { meshserver.send({ action: 'poweraction', nodeids: [currentNode._id], actiontype: parseInt(op) }); }, "Wykonać Intel&reg; AMT włączenie?");
            } else if (op == 308) { // Intel AMT power off
                setDialogMode(2, "Intel&reg; AMT Operacje Zasilania", 3, function () { meshserver.send({ action: 'poweraction', nodeids: [currentNode._id], actiontype: parseInt(op) }); }, "Wykonać wyłączenie poprzez Intel&reg; AMT?<br><br><b>UWAGA: Jeśli istnieje aktywna sesja AMT, polecenie wyłączenia zasilania zostanie odrzucone, musisz więc wcześniej rozłączyć sesje AMT!</b>");
            } else if (op == 310) { // Intel AMT reset
                setDialogMode(2, "Intel&reg; AMT Operacje Zasilania", 3, function () { meshserver.send({ action: 'poweraction', nodeids: [currentNode._id], actiontype: parseInt(op) }); }, "Przeprowadzić reset Intel&reg; AMT?");
        ...
        function showNotes(readonly, noteid) {
            ...
            if (noteid.startsWith('node%2F%2F')) { x += '<span style=font-size:10px>' + "Uwagi dotyczące grupy urządzeń mogą być przeglądane i zmieniane przez innych administratorów grupy urządzeń." + '<span>'; }
            setDialogMode(2, "Notatki", 3, showNotesEx, x, noteid);
        ...
        function deviceLockFunction() {
            if ((xxdialogMode != null || xxdialogMode == 0) && (desktop != null) && (desktop.contype == 1)) { setDialogMode(2, "Zablokuj Pulpit", 3, function() { if ((desktop != null) && (desktop.contype == 1)) { desktop.sendCtrlMsg('{"ctrlChannel":"102938","type":"lock"}'); } }, "Zablokować pulpit użytkownika?"); }
        }

        function deviceChat(e) {
            if (xxdialogMode) return;
            setDialogMode(2, "Akcje Urządzenia", 3, function () {
            ...
            }, "Uruchomić sesję chatu?");
        }

        function deviceUrlFunction() {
            if (xxdialogMode) return;
            setDialogMode(2, "Otwórz Stronę na Urządzeniu", 3, deviceUrlFunctionEx, '<input id=d2devurl placeholder="http://server.com" style=width:100%;overflow-y:scroll onkeyup=deviceUrlFunctionValidate() onchange=deviceUrlFunctionValidate()></input>');
            Q('d2devurl').focus();
        ...
        function d2runCommandDialog(options) {
            ...
            if ((wintype == true) || (linuxtype == true) || (agenttype == true)) {
                ...
                if (wintype == true) { x += '<option value=1' + ((runopt.type == 1)?' selected':'') + '>' + "Linia Komend Windows" + '</option><option value=2' + ((runopt.type == 2)?' selected':'') + '>' + "Windows PowerShell" + '</option>'; }
                if (linuxtype == true) { x += '<option value=3' + ((runopt.type == 3)?' selected':'') + '>' + "Powłoka Shell Linux/BSD/macOS" + '</option>'; }
                if (agenttype == true) { x += '<option value=4' + ((runopt.type == 4)?' selected':'') + '>' + "Konsola Agenta" + '</option>'; } // MESHRIGHT_REMOTECONTROL & MESHRIGHT_AGENTCONSOLE are needed
                x += '</select>';
                x += '<select id=d2cmduser style=width:100%;margin-bottom:4px><option value=0' + ((runopt.runAs == 0)?' selected':'') + '>' + "Uruchom jako agent" + '</option><option value=1' + ((runopt.runAs == 1)?' selected':'') + '>' + "Uruchom jako użytkownik, agent jeśli nie ma użytkownika" + '</option><option value=2' + ((runopt.runAs == 2)?' selected':'') + '>' + "Musi być uruchomiony jako użytkownik" + '</option></select>';
                if (options.selectedFile == null) {
                    x += '<select id=d2cmdsource onclick=d2runCommandValidate() style=width:100%;margin-bottom:4px><option value=0' + ((runopt.source == 0)?' selected':'') + '>' + "Komendy z okienka tekstowego" + '</option><option value=1' + ((runopt.source == 1)?' selected':'') + '>' + "Komendy z pliku" + '</option>';
                    if (userinfo.siteadmin & 8) { x += '<option value=2' + ((runopt.source == 2)?' selected':'') + '>' + "Komendy z pliku na serwerze" + '</option>'; }
                ...
                setDialogMode(2, "Wykonaj Komendy", 3, d2groupActionFunctionRunCommands, x, options);
                if (options.selectedFile == null) {
                    Q('d2runcmd').focus();
        ...
        function editDeviceAmtSettings(nodeid, func) {
            ...
            x += addHtmlValue("Nazwa użytkownika", '<input id=dp10username style=width:170px maxlength=32 autocomplete=nope placeholder="admin" onchange=validateDeviceAmtSettings() onkeyup=validateDeviceAmtSettings() />');
            x += addHtmlValue("Hasło", '<input id=dp10password type=password style=width:170px autocomplete=nope maxlength=32 onchange=validateDeviceAmtSettings() onkeyup=validateDeviceAmtSettings() />');
            // Only display the TLS setting if the Intel AMT manager is not running on the server. With the manager TLS is auto-detected.
            if ((features2 & 1) == 0) { x += addHtmlValue("Bezpieczeństwo", '<select id=dp10tls style=width:176px><option value=0>' + "Brak zabezpieczeń TLS" + '</option><option value=1>' + "Wymagane zabezpieczenie TLS" + '</option></select>'); }
            if ((node.intelamt.user != null) && (node.intelamt.user != '')) { buttons = 7; }
            setDialogMode(2, "Edycja poświadczeń Intel&reg; AMT", buttons, editDeviceAmtSettingsEx, x, { node: node, func: func });
        ...
        function p10showDeleteNodeDialog(nodeid) {
            if (xxdialogMode) return;
            setDialogMode(2, "Usuń Instancję", 3, p10showDeleteNodeDialogEx, format("Usunąć {0}?", EscapeHtml(currentNode.name)) + '<br /><br /><label><input id=p10check type=checkbox onchange=p10validateDeleteNodeDialog() />' + "Potwierdź" + '</label>', nodeid);
        ...
        function p10showiconselector() {
            ...
            setDialogMode(2, "Wybór ikony", 0, null, x);
        ...
        function showClearSshDialog() { setDialogMode(2, "Edytuj Urządzenie", 3, showClearSshDialogEx, "Wyczyścić dane uwierzytelniające SSH?"); }
        function showClearSshDialogEx(button, mode) { meshserver.send({ action: 'changedevice', nodeid: currentNode._id, ssh: 0 }); }
        function showClearRdpDialog() { setDialogMode(2, "Edytuj Urządzenie", 3, showClearRdpDialogEx, "Wyczyścić poświadczenia RDP?"); }
        function showClearRdpDialogEx(button, mode) { meshserver.send({ action: 'changedevice', nodeid: currentNode._id, rdp: 0 }); }

        var showEditNodeValueDialog_modes = ["Nazwa Urządzenia", "Nazwa hosta", "Opis", "Tagi"];
        var showEditNodeValueDialog_modes2 = ['name', 'host', 'desc', 'tags'];
        var showEditNodeValueDialog_modes3 = ['', '', '', "Grupa1, Grupa2, Grupa3"];
        function showEditNodeValueDialog(mode) {
            ...
            setDialogMode(2, "Edytuj Urządzenie", 3, showEditNodeValueDialogEx, x, mode);
        ...
        var agentConsoleMessages = ['', "Oczekiwanie na przyznanie dostępu przez użytkownika...", "Zabronione", "Nie udało się uruchomić sesji zdalnego terminala, {0} ({1})", "Czas minął", "Odebrano nieprawidłowe dane sieciowe"];
        ...
        function showDesktopSettings() {
            ...
            applyDesktopSettings();
            updateDesktopButtons();
            setDialogMode(7, "Ustawienia Pulpitu Zdalnego", 3, showDesktopSettingsChanged);
        }
        ...
        function updateDeskShortcutKeys() {
            var x = '<div class="menuButton" onclick="deskMenuButton(-1)">' + "Dostosuj" + '</div>';
        ...
        var keyStrings = { 8: "BackSpace", 9: "Tab", 13: "Enter", 27: "Escape", 32: "Przestrzeń", 44: "Print Screen", 45: "Wstaw", 46: "Del", 36: "Home", 35: "End", 32: "Przestrzeń", 33: "Page Up", 34: "Page Down", 37: "Lewo", 38: "Góra", 39: "Prawo", 40: "Dół", 0: "Brak" }
        ...
        function deskCustomizeKeys() {
            ...
            x += '</select> <input type=button value=' + "Dodaj" + ' onclick=addDeskCustomizeKey() /></div>';
            QH('p10dialog2', x);
            xxdialogMode = 2;
            QV('p10dialog', true);
        ...
        function deskUpdateShortcutList() {
            ...
            if (x == '') { x = '<i>' + "Brak zdefiniowanych skrótów klawiatury." + '</i>'; }
            QH('d2shortcuts', x);
        }
        ...
        function sendSpecialKeys() {
            if (xxdialogMode || desktop == null || desktop.State != 3) return;
            setDialogMode(3, "Klawisze Specjalne", 3, deskSendKeys);
        }
        ...
        function deskSelectScreens() {
            ...
            setDialogMode(2, "Wybór Ekranu", 3, deskSelectScreensEx, x);
        }
        ...
        function cmsshportaction(action) {
            if (xxdialogMode) return;
            var x = "Port zdalnego połączenia SSH:" + '<br /><br /><input type=text placeholder="22" inputmode="numeric" pattern="[0-9]*" onkeypress="return (event.keyCode == 8) || (event.charCode >= 48 && event.charCode <= 57)" maxlength=5 id=d10sshport type=text>';
            setDialogMode(2, "Połączenie SSH", 3, function () {
        ...
        function sshTunnelAuthDialog(j, func) {
            var x = '';
            if (j.askkeypass) {
                x += addHtmlValue("Uwierzytelnianie", '<select id=dp2authmethod style=width:150px onchange=sshAuthUpdate(event)><option value=3 selected>' + "Przechowywany Klucz" + '</option><option value=1>' + "Nazwa użytkownika Hasło" + '</option><option value=2>' + "Nazwa użytkownika i klucz" + '</option></select>');
            } else {
                x += addHtmlValue("Uwierzytelnianie", '<select id=dp2authmethod style=width:150px onchange=sshAuthUpdate(event)><option value=1 selected>' + "Nazwa użytkownika Hasło" + '</option><option value=2>' + "Nazwa użytkownika i klucz" + '</option></select>');
            }
            x += '<div id=d2userauth style=display:none>';
            x += addHtmlValue("Nazwa użytkownika", '<input id=dp2user style=width:150px maxlength=64 autocomplete=off onkeyup=sshAuthUpdate(event) />');
            x += '</div>';
            x += '<div id=d2passauth style=display:none>';
            x += addHtmlValue("Hasło", '<input type=password id=dp2pass style=width:150px maxlength=64 autocomplete=off onkeyup=sshAuthUpdate(event) />');
            if ((features2 & 0x00400000) == 0) { x += '<label><input id=dp2keep type=checkbox>' + "Zapamiętaj poświadczenia" + '</label>'; }
            x += '</div><div id=d2keyauth style=display:none>';
            x += addHtmlValue("Plik klucza", '<input type=file id=dp2key style=width:150px maxlength=64 autocomplete=off onchange=sshAuthUpdate(event) />' + '<div id=d2badkey style=font-size:x-small>' + "Plik klucza musi być w formacie OpenSSH." + '</div>');
            x += addHtmlValue("Hasło klucza", '<input type=password id=dp2keypass style=width:150px maxlength=64 autocomplete=off onkeyup=sshAuthUpdate(event) />');
            if ((features2 & 0x00400000) == 0) {
                x += '<label><input id=dp2keep1 type=checkbox onchange=sshAuthUpdate(event)>' + "Zapamiętaj użytkownika i klucz" + '</label><br/>';
                x += '<label><input id=dp2keep2 type=checkbox>' + "Zapamiętaj hasło" + '</label>';
            }
            x += '</div>';
            if (j.askkeypass) {
                x += '<div id=d2keyauth2 style=display:none>';
                x += addHtmlValue("Hasło", '<input type=password id=dp2keypass2 style=width:150px maxlength=64 autocomplete=off onkeyup=sshAuthUpdate(event) />');
                x += '</div>';
            }
            setDialogMode(2, "Uwierzytelnianie", 11, func, x, 'ssh');
            Q('dp2user').focus();
            sshAuthUpdate();
            ...
            if (typeof data == 'string') {
                if (data[0] == '{') {
                    ...
                    switch (j.action) {
                        ...
                        case 'autherror': { p12setConsoleMsg("Błąd Uwierzytelniania", 5000); break; }
                        case 'sessionerror': { p12setConsoleMsg("Sesja wygasła", 5000); break; }
                        case 'sessiontimeout': { p12setConsoleMsg("Przekroczony czas Sesji", 5000); break; }
                    }
                } else if (data[0] == '~') {
        ...
        */
        ...
        function p13gotFiles(data) {
            ...
            switch (data.action) {
                ...
                case 'autherror': { p13setConsoleMsg("Błąd Uwierzytelniania", 5000); return; }
                case 'connectionerror': { p13setConsoleMsg("Błąd Połączenia", 5000); return; }
                case 'sessionerror': { p13setConsoleMsg("Sesja wygasła", 5000); return; }
                case 'sessiontimeout': { p13setConsoleMsg("Przekroczony czas Sesji", 5000); return; }
            }
        ...
        function p13setActions() {
            ...
            if (p13filetree == null) {
                ...
                Q('p13SelectAllButton').value = "Wszystkie";
                ...
                Q('p13SelectAllButton').value = (cc > 0 ? "Brak" : "Wszystkie");
        ...
        function p13createfolder() { setDialogMode(2, "Nowy Folder", 3, p13createfolderEx, '<input type=text id=p13renameinput maxlength=64 onkeyup=p13fileNameCheck(event) style=width:100% />'); focusTextBox('p13renameinput'); p13fileNameCheck(); }
        ...
        function p13deletefile() { var cc = p13getFileSelCount(), rec = (p13getFileSelDirCount() > 0) ? '<br /><br /><label><input type=checkbox id=p13recdeleteinput>' + "Usuwanie Rekursywne" + '</label><br>' : '<input type=checkbox id=p13recdeleteinput style=\'display:none\'>'; setDialogMode(2, "Usuń", 3, p13deletefileEx, (cc > 1) ? (format("Usunąć {0} wybrane pozycje?", cc) + rec) : ("Usunąć wybraną pozycję?" + rec)); }
        ...
        function p13renamefile() { var renamefile, checkboxes = document.getElementsByName('fd'); for (var i = 0; i < checkboxes.length; i++) { if (checkboxes[i].checked) { renamefile = p13filetree.dir[checkboxes[i].value].n; } } setDialogMode(2, "Zmień nazwę", 3, p13renamefileEx, '<input type=text id=p13renameinput maxlength=64 onkeyup=p13fileNameCheck(event) style=width:100% value="' + renamefile + '" />', { action: 'rename', path: p13filetreelocation.join('/'), oldname: renamefile }); focusTextBox('p13renameinput'); p13fileNameCheck(); }
        ...
        function p13uploadFile() { setDialogMode(2, "Prześlij Plik", 3, p13uploadFileEx, '<input type=file name=files id=p13uploadinput style=width:100% multiple=multiple onchange="updateUploadDialogOk(\'p13uploadinput\')" />'); updateUploadDialogOk('p13uploadinput'); }
        ...
        function p13viewfile() {
            ...
            for (var i = 0; i < checkboxes.length; i++) {
                if (checkboxes[i].checked) {
                    ...
                    } else { messagebox("Edytor Plików", "Tylko pliki mniejsze niż 200k mogą być edytowane."); }
                    break;
                }
            }
        }
        ...
        function p13pasteFile() {
            ...
            if ((p13clipboard != null) && (p13clipboard.length > 0)) {
                if (p13clipboardCut == 0) {
                    if (p13clipboard.length > 1) { x = format("Potwierdzić kopię {0} pozycji do tej lokalizacji?", p13clipboard.length); } else { x = format("Potwierdzić kopię 1 pozycji do tej lokalizacji?"); }
                } else {
                    if (p13clipboard.length > 1) { x = format("Potwierdzasz przeniesienie {0} pozycji do tej lokalizacji?", p13clipboard.length); } else { x = format("Potwierdzasz przeniesienie 1 obiektu do tej lokalizacji?"); }
                }
            }
            setDialogMode(2, "Wklej", 3, p13pasteFileEx, x);
        }
            ...
            if ((p13clipboard != null) && (p13clipboard.length > 0)) {
                if (p13clipboardCut == 0) {
                    if (p13clipboard.length > 1) {
                        x = format("Przechowywanie {0} pozycji do skopiowania" + ', <a href=# onclick="return p13clearClip()" style=cursor:pointer>' + "Wyczyść" + '</a>.', p13clipboard.length);
                    } else {
                        x = format("Przechowywanie 1 pozycji do skopiowania" + ', <a href=# onclick="return p13clearClip()" style=cursor:pointer>' + "Wyczyść" + '</a>.');
                    }
                } else {
                    if (p13clipboard.length > 1) {
                        x = format("Podtrzymuję {0} elementów do przeniesienia" + ', <a href=# onclick="return p13clearClip()" style=cursor:pointer>' + "Wyczyść" + '</a>.', p13clipboard.length);
                    } else {
                        x = format("Podtrzymuję 1 element do przeniesienia" + ', <a href=# onclick="return p13clearClip()" style=cursor:pointer>' + "Wyczyść" + '</a>.');
                    }
                }
            }
        ...
        function p13downloadfile(x, y, z) {
            ...
            setDialogMode(2, "Pobierz Plik", 10, p13downloadFileCancel, '<div>' + EscapeHtml(downloadFile.file) + '</div><br /><progress id=d2progressBar style=width:100% value=0 max=' + z + ' />');
        }
        ...
        */
        ...
        function p13doUploadFiles(files) {
            ...
            if (overWriteCount == 0) {
                ...
                setDialogMode(2, "Prześlij Plik", 3, p13uploadFileContinue, format((overWriteCount == 1) ? "Przesłanie pliku spowoduje nadpisanie 1 pliku. Kontynuować?" : "Przesyłanie nadpisze {0} plików. Kontynuować?", overWriteCount), files);
            }
        }
        ...
        function p13uploadFileContinue(b, files) {
            ...
            setDialogMode(2, "Prześlij Plik", 10, p13uploadFileCancel, '<div id=p13dfileName>' + "Łączenie..." + '</div><br /><progress id=d2progressBar style=width:100% value=0 max=0 />');
            p13uploadNextFile();
        }
        ...
        function updateDeviceDetails(node, hardware, network) {
            ...
            // Operating System
            var x = '';
            if (node.rname) { x += addDetailItem("Nazwa", EscapeHtml(node.rname), s); }
            if (hardware.windows && hardware.windows.osinfo && hardware.windows.osinfo.Description) { x += addDetailItem("Opis", EscapeHtml(hardware.windows.osinfo.Description), s); }
            if (node.osdesc) { x += addDetailItem("Wersja", EscapeHtml(node.osdesc), s); }
            if (hardware.windows && hardware.windows.osinfo) {
                var m = hardware.windows.osinfo;
                if (m.OSArchitecture) {
                    if (m.OSArchitecture.startsWith('32')) { x += addDetailItem("Architektura", "32-bitowy", s); }
                    else if (m.OSArchitecture.startsWith('64')) { x += addDetailItem("Architektura", "64-bitowy", s); }
                ...
                if(m.LastBootUpTime){
                    ...
                    x += addDetailItem("Czas Ostatniego Uruchomienia", date);
                }
                if(m.Domain){ x += addDetailItem((m.PartOfDomain ? "Domena" : "Grupa robocza"), EscapeHtml(m.Domain), s); }
            }
            ...
            if (node.wsc) {
                var y = [];
                if (node.wsc.antiVirus != null) { if (node.wsc.antiVirus == 'OK') { y.push("AV" + ' - <span style=color:green>' + "OK" + '</span>'); } else { y.push("AV" + ' - <span style=color:red>' + "PROBLEM" + '</span>'); } }
                if (node.wsc.autoUpdate != null) { if (node.wsc.autoUpdate == 'OK') { y.push("Aktualizacja" + ' - <span style=color:green>' + "OK" + '</span>'); } else { y.push("Aktualizacja" + ' - <span style=color:red>' + "PROBLEM" + '</span>'); } }
                if (node.wsc.firewall != null) { if (node.wsc.firewall == 'OK') { y.push("Firewall" + ' - <span style=color:green>' + "OK" + '</span>'); } else { y.push("Firewall" + ' - <span style=color:red>' + "PROBLEM" + '</span>'); } }
                x += addDetailItem("Bezpieczeństwo Windows", y.join(', '));
            }

            // Defender for Windows Server
            if(node.defender) {
                var y = [];
                if (node.defender.RealTimeProtection != null) { if (node.defender.RealTimeProtection == true) { y.push("Ochrona W Czasie Rzeczywistym" + ' - <span style=color:green>' + "Włącz" + '</span>'); } else { y.push("Ochrona W Czasie Rzeczywistym" + ' - <span style=color:red>' + "Wyłącz" + '</span>'); } }
                if (node.defender.TamperProtected != null) { if (node.defender.TamperProtected == true) { y.push("OchronaPrzedManipulacją" + ' - <span style=color:green>' + "Włącz" + '</span>'); } else { y.push("OchronaPrzedManipulacją" + ' - <span style=color:red>' + "Wyłącz" + '</span>'); } }
                if (node.defender.AntivirusSignatureVersion != null) { y.push("Wersja podpisu" + ' - <span style=color:green>' + EscapeHtml(node.defender.AntivirusSignatureVersion) + '</span>'); }
            ...
            if (node.av && node.av.length > 0) {
                ...
                for (var i in node.av) {
                    if (node.av[i].product) {
                        ...
                        if (node.av[i].enabled !== true) { avx += ' - <span style=color:red>' + "Wyłączone" + '</span>'; }
                        if (node.av[i].updated !== true) { avx += ' - <span style=color:red>' + "Nieaktualne" + '</span>'; }
                        if ((node.av[i].enabled == true) && (node.av[i].updated == true)) { avx += ' - <span style=color:green>' + "OK" + '</span>'; }
                        y.push(avx);
                    }
                }
                x += addDetailItem("Antywirus", y.join('<br />'));
            }

            // Active Users
           if (node.users && node.users.length > 0) {
                var u = node.users.map(function(user) {
                    return addKeyLinkConditional(EscapeHtml(user), "Zablokowane", (node.lusers && node.lusers.indexOf(user) >= 0));
                }).join(', ');
                x += addDetailItem((node.users.length > 1 ? "Aktywni użytkownicy" : "Aktywny użytkownik"), u);
            }

            if (x != '') { sections.push({ name: "System Operacyjny", html: x, img: 'software' }); }
            ...
            if (node.agent) {
                ...
                if ((node.agent != null) && (node.agent.id != null) && (node.agent.ver != null)) {
                    ...
                    if (node.agent.ver != 0) { str += ' v' + node.agent.ver; }
                    if (node.agent.id == 14) { str = node.agent.core; }
                    x += addDetailItem("Agent", str);
                }
                if (node.firstconnect) { x += addDetailItem("Pierwsze połączenie agenta", printDateTime(new Date(node.firstconnect))); }
                if ((node.conn & 1) != 0) {
                    x += addDetailItem("Ostatnie połączenie agenta", "Połączono teraz");
                } else {
                    if (node.lastconnect) { x += addDetailItem("Ostatnie połączenie agenta", printDateTime(new Date(node.lastconnect))); }
                }
                if (node.lastaddr) {
                    var splitip = node.lastaddr.split(':');
                    if (splitip.length > 2) {
                        // IPv6
                        x += addDetailItem("Ostatni adres agenta", node.lastaddr);
                    } else {
                        // IPv4
                        if (isPrivateIP(node.lastaddr)) {
                            x += addDetailItem("Ostatni adres agenta", splitip[0]);
                        } else {
                            x += addDetailItem("Ostatni adres agenta", '<a href="https://iplocation.com/?ip=' + splitip[0] + '" rel="noreferrer noopener" target="MeshIPLoopup">' + splitip[0] + '</a>');
                        }
                    }
                }
                if (hardware.agentvers != null) {
                    if (hardware.agentvers.compileTime) {
                        try {
                            ...
                            x += addDetailItem("Data kompilacji", printDateTime(new Date(d)));
                        } catch (ex) { }
                    }
                }
                if (hardware.time != null) {
                    x += addDetailItem("Ostatnia aktualizacja szczegółów", printDateTime(new Date(hardware.time)));
                }
                if (x != '') { sections.push({ name: "Agent", html: x, img: 'meshagent' }); }
            }
            ...
            if (hardware.mobile) {
                ...
                if (hardware.mobile.device) { x += addDetailItem("Urządzenie", EscapeHtml(hardware.mobile.device), s); }
                if (hardware.mobile.bootloader) { x += addDetailItem("Bootloader", EscapeHtml(hardware.mobile.bootloader), s); }
                if (hardware.mobile.id) { x += addDetailItem("Identyfikator", EscapeHtml(hardware.mobile.id), s); }
                if (hardware.mobile.host) { x += addDetailItem("Nazwa hosta", EscapeHtml(hardware.mobile.host), s); }
                ...
                if (x != '') { sections.push({ name: "Urządzenie Mobilne", html: x, img: 'mobile' }); }
            }
            ...
            if (network.netif2 != null) {
                ...
                for (var i in network.netif2) {
                    ...
                    if (m.desc) { x += addDetailItem("Opis", EscapeHtml(m.desc).split('(R)').join('&reg;')); }
                    //if (m.dnssuffix) { x += addDetailItem("DNS Suffix", m.dnssuffix); }
                    if (typeof m[0].mac == 'string') {
                        if (m[0].gatewaymac) {
                            x += addDetailItem("Adres MAC", format("MAC: {0}, Brama: {1}", EscapeHtml(m[0].mac), EscapeHtml(m[0].gatewaymac)));
                        } else {
                            x += addDetailItem("Adres MAC", format("MAC: {0}", EscapeHtml(m[0].mac)));
                        }
                    }
                    if (typeof m[0].speed == 'number' && (m[0].speed != 9223372036854775807 && m[0].speed > 0)) {
                        x += addDetailItem("Szybkość interfejsu", format("{0}", getNetworkSpeed(m[0].speed)));
                    }
                    for (var j = 0; j < m.length; j++) {
                        ...
                        if (iplayer.gateway) { items.push(format("Brama: {0}", EscapeHtml(iplayer.gateway))); }
                        if (items.length > 0) {
                            if (iplayer.family == 'IPv4') { x += addDetailItem("Adres IPv4", items.join(", ")); }
                            if (iplayer.family == 'IPv6') { x += addDetailItem("Adres IPv6", items.join(", ")); }
                        }
                    }
                    x += '</div></td></tr>';
                }
                if (hardware.network && hardware.network.dns) {
                    x += '<tr><td><div class=style10 style=border-radius:5px;padding:8px>';
                    x += addDetailItem('<b>' + "Serwery DNS" + '</b>', hardware.network.dns.join(", "));
                    x += '</div></td></tr>';
                }
                x += '</table>';
                if (x != '') { sections.push({ name: "Sieć", html: x, img: 'networking' }); }
            }

            // Attribute: Intel AMT
            if (node.intelamt != null) {
                var x = '';
                x += addDetailItem("Wersja", (node.intelamt.ver) ? ('v' + EscapeHtml(node.intelamt.ver)) : ('<i>' + "Nieznany" + '</i>'), s);
                x += addDetailItem("Identyfikator", (node.intelamt.uuid) ? (EscapeHtml(node.intelamt.uuid)) : ('<i>' + "Nieznany" + '</i>'), s);
                var provisioningStates = { 0: nobreak("Nie aktywowany (Przed)"), 1: nobreak("Nie aktywowany (W)"), 2: nobreak("Aktywowano") };
                ...
                x += addDetailItem("Stan Podłączenia", ((node.intelamt.state) ? (provisioningStates[node.intelamt.state]) : ('<i>' + "Nieznany" + '</i>')) + provisioningMode, s);
                x += addDetailItem("Bezpieczeństwo", (node.intelamt.tls == 1) ? "Zabezpieczone używając TLS" : "TLS nie jest skonfigurowany", s);
                // Check that the Intel AMT user is setup and there is no warnings (1 = invalid credentials, 8 = trying)
                x += addDetailItem("Poświadczenia Administratora", ((node.intelamt.user) == null || (node.intelamt.user == '') || ((node.intelamt.warn != null) && ((node.intelamt.warn & 9) != 0))) ? "Nieznany" : "Znane", s);
                if (x != '') {
            ...
            if (hardware.identifiers) {
                ...
                // BIOS
                if (ident.bios_vendor) { x += addDetailItem("Dostawca", EscapeHtml(ident.bios_vendor), s); }
                if (ident.bios_version) { x += addDetailItem("Wersja", EscapeHtml(ident.bios_version), s); }
                if (ident.bios_serial) { x += addDetailItem("Numer", EscapeHtml(ident.bios_serial), s); }
                if (ident.bios_mode) { x += addDetailItem("Tryb", EscapeHtml(ident.bios_mode), s); }
                if (x != '') { sections.push({ name: "BIOS", html: x, img: 'chip' }); }

                // Motherboard
                x = '';
                if (ident.board_vendor) { x += addDetailItem("Dostawca", EscapeHtml(ident.board_vendor), s); }
                if (ident.board_name) { x += addDetailItem("Nazwa", EscapeHtml(ident.board_name), s); }
                if (ident.board_serial && (ident.board_serial != '')) { x += addDetailItem("Numer", EscapeHtml(ident.board_serial), s); }
                if (ident.board_version) { x += addDetailItem("Wersja", EscapeHtml(ident.board_version), s); }
                if (ident.product_uuid) { x += addDetailItem("Identyfikator", EscapeHtml(ident.product_uuid), s); }
                ...
                if (x != '') { sections.push({ name: "Płyta główna", html: x, img: 'motherboard' }); }
            }

            // TPM
            if (hardware.tpm) {
                var x = '', tpm = hardware.tpm;
                if (tpm.SpecVersion) { x += addDetailItem("Wersja", parseFloat(EscapeHtml(tpm.SpecVersion)).toFixed(1), s); }
                if (tpm.ManufacturerId) { x += addDetailItem("Identyfikator", EscapeHtml(tpm.ManufacturerId), s); }
                if (tpm.ManufacturerVersion) { x += addDetailItem("Wersja", EscapeHtml(tpm.ManufacturerVersion), s); }
                if (tpm.IsActivated != null) { x += addDetailItem("Aktywowano", (tpm.IsActivated ? "Yes" : "No"), s); }
                if (tpm.IsEnabled != null) { x += addDetailItem("Włączono", (tpm.IsEnabled ? "Yes" : "No"), s); }
                if (tpm.IsOwned != null) { x += addDetailItem("Posiadany", (tpm.IsOwned ? "Yes" : "No"), s); }
            ...
            if (hardware.battery) {
                ...
                for (var i in hardware.battery) {
                    ...
                    x += '<tr><td><div class=style10 style=border-radius:5px;padding:8px>';
                    x += '<div style=margin-bottom:3px><b>' + EscapeHtml(battery.DeviceName ? battery.DeviceName : "Nieznany") + '</b></div>';
                    if (battery.CycleCount) { x += addDetailItem("Liczba cykli", EscapeHtml(battery.CycleCount), s); }
                    if (battery.FullChargedCapacity) { x += addDetailItem("Pełna naładowana pojemność", format("{0} mWh", battery.FullChargedCapacity), s); }
                    if (battery.EstimatedRuntime) { x += addDetailItem("Szacowany czas działania", format("{0} minut", Math.floor((battery.EstimatedRuntime / 60))), s); }
                    if (battery.Chemistry) { x += addDetailItem("Chemia", EscapeHtml(battery.Chemistry), s); }
                    if (battery.DesignedCapacity) { x += addDetailItem("Pojemność projektowa", format("{0} mWh", battery.DesignedCapacity), s); }
                    if (battery.ManufactureDate) { x += addDetailItem("Data produkcji", EscapeHtml(battery.ManufactureDate), s); }
                    if (battery.ManufactureName) { x += addDetailItem("Nazwa producenta", EscapeHtml(battery.ManufactureName), s); }
                    if (battery.SerialNumber) { x += addDetailItem("Numer seryjny", EscapeHtml(battery.SerialNumber), s); }
                    if (battery.ChargeRate) { x += addDetailItem("Szybkość ładowania", format("{0} mW", battery.ChargeRate), s); }
                    if (battery.Charging != null) { x += addDetailItem("Ładowanie", (battery.Charging ? "Yes" : "No"), s); }
                    if (battery.DischargeRate) { x += addDetailItem("Szybkość rozładowania", format("{0} mW", battery.DischargeRate), s); }
                    if (battery.Discharging != null) { x += addDetailItem("Rozładowanie", (battery.Discharging ? "Yes" : "No"), s); }
                    if (battery.RemainingCapacity) { x += addDetailItem("Pozostała pojemność", format("{0} mWh", battery.RemainingCapacity), s); }
                    if (battery.Voltage) { x += addDetailItem("Woltaż", format("{0} V", (battery.Voltage / 1000)), s); }
                    if (battery.Health) { x += addDetailItem("Zdrowie", format("{0} %", battery.Health), s); }
                    if (battery.BatteryCharge) { x += addDetailItem("Ładowanie baterii", format("{0} %", battery.BatteryCharge), s); }   
                    x += '</div>';
                }
                x += '</table>';
                if (x != '') { sections.push({ name: "Bateria", html: x, img: 'battery'}); }
            }
            ...
            if (hardware.windows) {
                if (hardware.windows.memory && (hardware.windows.memory.length > 0)) {
                    ...
                    for (var i in hardware.windows.memory) {
                        ...
                        if (m.Capacity && m.Speed) { x += addDetailItem("Objętość / Szybkość", format("{0} Mb, {1} Mhz", (m.Capacity / 1024 / 1024), m.Speed), s); }
                        else if (m.Capacity) { x += addDetailItem("Objętość", format("{0} Mb", (m.Capacity / 1024 / 1024)), s); }
                        if (m.PartNumber) { x += addDetailItem("Numer Partii", EscapeHtml((m.Manufacturer && m.Manufacturer != 'Undefined') ? (m.Manufacturer + ', ') : '') + EscapeHtml(m.PartNumber), s); }
                        x += '</div>';
                    }
                    x += '</table>';

                    if (x != '') { sections.push({ name: "Pamięć", html: x, img: 'ram' }); }
                }
            }
            ...
            if (hardware.linux) {
                if (hardware.linux.memory && (hardware.linux.memory.Memory_Device.length > 0)) {
                    ...
                    for (var i in hardware.linux.memory.Memory_Device) {
                        ...
                        if (m.Size && m.Speed) { x += addDetailItem("Objętość / Szybkość", format("{0}, {1}", m.Size, m.Speed), s); }
                        else if (m.Size) { x += addDetailItem("Objętość", format("{0}", (m.Size)), s); }
                        if (m.PartNumber) { x += addDetailItem("Numer Partii", EscapeHtml((m.Manufacturer && m.Manufacturer != 'Undefined')?(m.Manufacturer + ', '):'') + EscapeHtml(m.PartNumber), s); }
                        x += '</div>';
                    }
                    x += '</table>';
            ...
            if (hardware.darwin) {
                if (hardware.darwin.memory && (hardware.darwin.memory.length > 0)) {
                    ...
                    for (var i in hardware.darwin.memory) {
                        ...
                        if (m.PartNumber) { x += addDetailItem("Numer Partii", EscapeHtml((m.Manufacturer && m.Manufacturer != '')?(m.Manufacturer + ', '):'') + EscapeHtml(m.PartNumber), s); }
                        x += '</div>';
                    }
                    x += '</table>';
                    if (x != '') { sections.push({ name: "Pamięć", html: x, img: 'ram'}); }
            ...
            if (hardware.identifiers && ident.storage_devices) {
                ...
                for (var i in ident.storage_devices) {
                    ...
                    if (m.Size) {
                        ...
                        if (m.Size) {
                            ...
                            if (typeof m.Size == 'number') { x += addDetailItem("Objętość", format("{0} Mb", Math.floor(m.Size / 1024 / 1024)), s); }
                            if (typeof m.Size == 'string') { x += addDetailItem("Objętość", EscapeHtml(m.Size), s); }
                        }
                ...
                if (x != '') { sections.push({ name: "Magazyn danych", html: x, img: 'storage' }); }
            }
            ...
            if (hardware.windows && hardware.windows.volumes) {
                ...
                for (var i in hardware.windows.volumes) {
                    ...
                    if (m.size) {
                        ...
                        x += addDetailItem("Objętość", EscapeHtml(fsize), s);
                    }
                    if (m.sizeremaining) {
                        var sizes = ['Bytes', 'KB', 'MB', 'GB', 'TB'];
                        ...
                        x += addDetailItem("Pozostała pojemność", EscapeHtml(fsize), s);
                    }
                    if (m.type) {
                        var type = (m.removable == true ? "Wyjmowane" : (m.cdrom == true ? "CD-ROM" : ''));
                        x += addDetailItem("System Plików", (type != '' ? (type + ' / ') : '') + (m.type == 'Unknown' ? "Nieznany" : EscapeHtml(m.type)), s);
                    }

                    if (m.protectionStatus || m.volumeStatus) {
                        var bitlockerState = [];
                        if (m.protectionStatus) bitlockerState.push("Włączono");
                ...
                if (x != '') { sections.push({ name: "Woluminy Pamięci", html: '<table style=width:100%>' + x + '</table>', img: 'storage'}); }
            }
            ...
            if (hardware.darwin && hardware.darwin.volumes) {
                ...
                for (var i in hardware.darwin.volumes) {
                    ...
                    x += '<div style=margin-bottom:3px><b>' + m.mount_point + '</b></div>';
                    if (m.size) {
                        x += addDetailItem("Objętość", EscapeHtml(m.size), s);
                    }
                    if (m.available) {
                        x += addDetailItem("Pozostała pojemność", EscapeHtml(m.available), s);
                    }
                    if (m.type) {
                        var type = (m.removable == true ? "Wyjmowane" : (m.cdrom == true ? "CD-ROM" : ''));
                        x += addDetailItem("System Plików", (type != '' ? (type + ' / ') : '') + (m.type == 'Unknown' ? "Nieznany" : EscapeHtml(m.type)), s);
            ...
            if (x == '') {
                QH('p10detailshtml', "Brak informacji dla tego urządzenia.");
            } else {
                QH('p10detailshtml', x);
            }
        }
        ...
        function deviceDetailsShowBitlockerInfo(drive, identifier, password) {
            if (xxdialogMode) return false;
            var x = '<div><p>' + "Identyfikator" + '</p><p style=user-select:text;font-weight:bold>' + (identifier ? decodeURIComponent(identifier) : "Nieznany") + '</p>';
            x += '<p>' + "Hasło Odzyskiwania" + '</p><p style=user-select:text;font-weight:bold>' + (password ? decodeURIComponent(password) : "Nieznany") + '</p></div>';
            setDialogMode(2, decodeURIComponent(drive) + ': ' + "Informacje o BitLocker", 1, null, x, '');
        }
        ...
        */
        ...
        function setupConsole() {
            ...
            if ((rights & 16) != 0) {
                ...
                var onlineText = ((consoleNode.conn & 1) != 0) ? "Agent jest online" : "Agent jest offline"
                if ((consoleNode.conn & 16) != 0) { onlineText += ", MQTT jest online" }
                ...
                QH('p15statetext', "Dostęp Zabroniony");
        ...
        function p15uploadCore(e) {
            ...
            if (e.shiftKey == true) { meshserver.send({ action: 'uploadagentcore', nodeid: consoleNode._id, type: 'default' }); } // Upload default core
                ...
                var htmlValue = '<select id=d3coreMode style=width:230px>' +
                    '<option value=1>' + "Prześlij domyślne jądro serwera" + '</option>' +
                    '<option value=2>' + "Wyczyść jądro" + '</option>' +
                    '<option value=3>' + "Prześlij plik jądra" + '</option>' +
                    '<option value=4>' + "Miękkie odłączenie agenta" + '</option>' +
                    '<option value=5>' + "Twarde odłączenie agenta" + '</option>' +
                    '<option value=6>' + "Prześlij jądro odzyskiwania" + '</option>' +
                    '<option value=7>' + "Prześlij uproszczone (małe) jądro" + '</option>' +
                    '<option value=8>' + "Restart agent service" + '</option>' +
                    '<option value=9>' + "Wymuś aktualizację agenta" + '</option></select>';
                setDialogMode(2, "Wykonaj Działanie Agenta", 3, p15uploadCoreEx, addHtmlValue("Akcja", htmlValue));
            }
        }
        ...
        function p15uploadCore2() {
            ...
            Q('d3auth').value = authCookie;
            Q('d3attrib').value = currentNode._id;
            setDialogMode(4, "Prześlij Jądro Agenta", 3, p15uploadCoreEx2);
            d3init();
        }
        ...
        function p20updateMesh() {
            ...
            var meshtype = format("Nieznany #{0}", currentMesh.mtype);
            var meshrights = GetMeshRights(currentMesh);
            if (currentMesh.mtype == 1) meshtype = "Tylko Intel&reg; AMT, bez agenta";
            if (currentMesh.mtype == 2) meshtype = "Zarządzane za pomocą agenta programowego";
            if (currentMesh.mtype == 3) { if (currentMesh.relayid == null) { meshtype = "Urządzenia lokalne, bez agenta"; } else { meshtype = "Brak przekierowanych urządzeń przez agenta"; } }
            if (currentMesh.mtype == 4) { if (currentMesh.relayid == null) { meshtype = "Urządzenie IP-KVM"; } else { meshtype = "Urządzenie IP-KVM przekierowane przzez agenta"; } if (currentMesh.kvm.model == 1) { meshtype += ', ' + 'Raritan KX III'; } }

            var x = '';
            x += addHtmlValue("Nazwa", addLinkConditional(EscapeHtml(currentMesh.name), 'p20editmesh(1)', (meshrights & 1) != 0));
            x += addHtmlValue("Opis", addLinkConditional(((currentMesh.desc && currentMesh.desc != '') ? EscapeHtml(currentMesh.desc) : ('<i>' + "Brak" + '</i>')), 'p20editmesh(2)', (meshrights & 1) != 0));
            ...
            if (((currentMesh.mtype == 3) || (currentMesh.mtype == 4)) && (currentMesh.relayid != null)) {
                var relayName = '<i>' + "Nieznany" + '</i>';
                var relayNode = getNodeFromId(currentMesh.relayid);
                if (relayNode != null) { relayName = EscapeHtml(relayNode.name); }
                x += addHtmlValue("Przekieruj Urządzenie", addLinkConditional(relayName, 'p20editmeshrelay()', (meshrights & 1) != 0));
            }

            // Display IP-KVM information if needed
            if (currentMesh.mtype == 4) {
                x += addHtmlValue("Nazwa hosta", currentMesh.kvm.host);
                x += addHtmlValue("Nazwa użytkownika", currentMesh.kvm.user);
            }

            x += '<br><input type=button value="' + "Notatki" + '" onclick=showNotes(false,"' + encodeURIComponent(currentMesh._id) + '") />';

            x += '<br style=clear:both><br>';
            var currentMeshLinks = currentMesh.links[userinfo._id];
            if (currentMeshLinks && ((currentMeshLinks.rights & 2) != 0)) { x += '<div style=margin-bottom:6px;float:left;margin-right:10px><a onclick=p20showAddMeshUserDialog() style=cursor:pointer><img src=images/icon-addnew.png border=0 height=12 width=12> ' + "Dodaj Użytkownika" + '</a></div>'; }

            if (navigator.userAgent.toLowerCase().indexOf('android') >= 0) {
                x += '<div style=margin-bottom:6px;float:left;margin-right:10px><a onclick=p20installAndroidDialog() style=cursor:pointer><img src=images/icon-addnew.png border=0 height=12 width=12> ' + "Zainstaluj na tym urządzeniu" + '</a></div>';
            }
            ...
            */
            ...
            for (var i in sortedusers) {
                var trash = '', rights = "Częściowe Uprawnienia", r = sortedusers[i].rights, icon = 2;
                if (r == 0xFFFFFFFF) rights = "Pełnoprawny Administrator"; else if (r == 0) rights = "Brak Uprawnień";
            ...
            if (meshrights == 0xFFFFFFFF) { x += '<div style=font-size:small;text-align:right;margin-top:6px><span><a onclick=p20showDeleteMeshDialog() style=cursor:pointer>' + "Usuń Grupę" + '</a></span></div>'; }
        ...
        function p20showDeleteMeshDialog() {
            if (xxdialogMode) return false;
            var x = format("Czy na pewno chcesz usunąć grupę {0}? Usunięcie grupy urządzeń spowoduje również usunięcie wszystkich informacji o urządzeniach należących do tej grupy.", EscapeHtml(currentMesh.name)) + '<br /><br />';
            x += '<label><input id=p20check type=checkbox onchange=p20validateDeleteMeshDialog() />' + "Potwierdź" + '</label>';
            setDialogMode(2, "Usuń Grupę", 3, p20showDeleteMeshDialogEx, x);
        ...
        function p20editmeshrelay() {
            ...
            if (relayDevices.length == 0) {
                ...
                setDialogMode(2, "Edytuj Grupę Urządzeń", 1, null, "Brak urządzeń do przekierowań.");
            } else {
                var relayDevices2 = [];
                ...
                var x = addHtmlValue("Przekieruj Urządzenie", '<div style=width:170px><select id=d2devrelay style=width:100%>' + relayDevices2.join('') + '</select></div>');
                setDialogMode(2, "Edytuj Grupę Urządzeń", 3, p20editmeshrelayEx, x);
            }
        }
        ...
        function p20editmesh(focus) {
            if (xxdialogMode) return;
            var x = addHtmlValue("Nazwa", '<input id=dp20meshname style=width:170px maxlength=32 onchange=p20editmeshValidate() onkeyup=p20editmeshValidate() />');
            x += addHtmlValue("Opis", '<input id=dp20meshdesc style=width:170px maxlength=1024 onkeyup=p20editmeshValidate() />');
            setDialogMode(2, "Edytuj Grupę Urządzeń", 3, p20editmeshEx, x);
        ...
        function p20installAndroidDialog() {
            if (xxdialogMode) return;
            var x = '<div style=text-align:center><p>' + "Zainstaluj MeshCentral Agent na swoim urządzeniu z systemem Android. Po zainstalowaniu kliknij link parowania, aby połączyć swoje urządzenie z serwerem." + '</p>';
            ...
            x += '<p><a rel=\"noreferrer noopener\" target=_blank href="meshagents?id=14' + (urlargs.key?('&key=' + urlargs.key):'') + '" title="' + "Wersja APK MeshAgent" + '">' + "Android APK" + '</a></p>';
            x += '<p><a href="' + serverinfo.magenturl + ',' + serverinfo.agentCertHash + ',' + currentMesh._id.split('/')[2] + '"><b>' + "Link Parowania Urządzeń" + '</b></a></p></div>';
            setDialogMode(2, "Instalacja w systemie Android", 1, null, x);
        }
        ...
        function p20showAddMeshUserDialog() {
            ...
            x += '<label><input type=checkbox onchange=p20validateAddMeshUserDialog() id=p20fulladmin>' + "Pełnoprawny Administrator" + '</label><br>';
            x += '<label><input type=checkbox onchange=p20validateAddMeshUserDialog() id=p20editmesh>' + "Edytuj Grupę Urządzeń" + '</label><br>';
            x += '<label><input type=checkbox onchange=p20validateAddMeshUserDialog() id=p20manageusers>' + "Zarządzaj Użytkownikami Grupy Urządzeń" + '</label><br>';
            x += '<label><input type=checkbox onchange=p20validateAddMeshUserDialog() id=p20managecomputers>' + "Zarządzaj Komputerami Grupy Urządzeń" + '</label><br>';
            x += '<label><input type=checkbox onchange=p20validateAddMeshUserDialog() id=p20remotecontrol>' + "Zdalne Sterowanie." + '</label><br>';
            x += '<label><input type=checkbox onchange=p20validateAddMeshUserDialog() id=p20remoteview style=margin-left:12px>' + "Tylko Podgląd Zdalny" + '</label><br>';
            x += '<label><input type=checkbox onchange=p20validateAddMeshUserDialog() id=p20remotelimitedinput style=margin-left:12px>' + "Tylko Limitowane Wejście" + '</label><br>';
            x += '<label><input type=checkbox onchange=p20validateAddMeshUserDialog() id=p20noterminal style=margin-left:12px>' + "Brak Dostępu do Terminala" + '</label><br>';
            x += '<label><input type=checkbox onchange=p20validateAddMeshUserDialog() id=p20nofiles style=margin-left:12px>' + "Brak Dostępu do Plików" + '</label><br>';
            x += '<label><input type=checkbox onchange=p20validateAddMeshUserDialog() id=p20noamt style=margin-left:12px>' + "Brak Intel&reg; AMT" + '</label><br>';
            x += '<label><input type=checkbox onchange=p20validateAddMeshUserDialog() id=p20meshagentconsole>' + "Konsola Mesh Agent" + '</label><br>';
            x += '<label><input type=checkbox onchange=p20validateAddMeshUserDialog() id=p20meshserverfiles>' + "Pliki Serwera" + '</label><br>';
            x += '<label><input type=checkbox onchange=p20validateAddMeshUserDialog() id=p20wakedevices>' + "Wybudź Urządzenia" + '</label><br>';
            x += '<label><input type=checkbox onchange=p20validateAddMeshUserDialog() id=p20editnotes>' + "Edycja Notatki Urządzenia" + '</label><br>';
            x += '<label><input type=checkbox onchange=p20validateAddMeshUserDialog() id=p20limitevents>' + "Pokaż Tylko Własne Zdarzenia" + '</label><br>';
            x += '<label><input type=checkbox onchange=p20validateAddMeshUserDialog() id=p20chatnotify>' + "Chat i Powiadomienia" + '</label><br>';
            x += '<label><input type=checkbox onchange=p20validateAddMeshUserDialog() id=p20uninstall>' + "Odinstaluj Agenta" + '</label><br>';
            x += '<label><input type=checkbox onchange=p20validateAddMeshUserDialog() id=p20commands>' + "Komendy Zdalne" + '</label><br>';
            x += '<label><input type=checkbox onchange=p20validateAddMeshUserDialog() id=p20resetoff>' + "Resetuj / Wyłącz" + '</label><br>';
            x += '</div>';
            setDialogMode(2, "Dodaj Użytkownika do Grupy Urządzeń", 3, p20showAddMeshUserDialogEx, x);
        ...
        function p20viewuser(userid) {
            ...
            if (meshrights == 0xFFFFFFFF) r.push("Pełnoprawny Administrator"); else {
                if ((meshrights & 1) != 0) r.push("Edytuj Grupę Urządzeń");
                if ((meshrights & 2) != 0) r.push("Zarządzaj Użytkownikami Grupy Urządzeń");
                if ((meshrights & 4) != 0) r.push("Zarządzaj Komputerami Grupy Urządzeń");
                if ((meshrights & 8) != 0) r.push("Zdalne Sterowanie.");
                if ((meshrights & 16) != 0) r.push("Konsola Agenta");
                if ((meshrights & 32) != 0) r.push("Pliki Serwera");
                if ((meshrights & 64) != 0) r.push("Wybudź Urządzenia");
                if ((meshrights & 128) != 0) r.push("Edytuj Notatki");
                if ((meshrights & 256) != 0) r.push("Tylko Podgląd Zdalny");
                if ((meshrights & 512) != 0) r.push("Brak Terminala");
                if ((meshrights & 1024) != 0) r.push("Brak Plików");
                if ((meshrights & 2048) != 0) r.push("Brak Intel&reg; AMT");
                if (((meshrights & 8) != 0) && ((meshrights & 4096) != 0) && ((meshrights & 256) == 0)) r.push("Limitowane Wejście");
                if ((meshrights & 8192) != 0) r.push("Tylko Własne Zdarzenia");
                if ((meshrights & 16384) != 0) r.push("Chat i Powiadomienia");
                if ((meshrights & 32768) != 0) r.push("Odinstaluj");
                if ((meshrights & 131072) != 0) r.push("Komendy");
                if ((meshrights & 262144) != 0) r.push("Reset/Wyłącz");
            }
            if (r.length == 0) { r.push("Brak Uprawnień"); }
            var buttons = 1, uname = userid.split('/')[2];
            if (currentMesh.links[userid].name) { uname = currentMesh.links[userid].name; }
            var x = addHtmlValue("Nazwa Użytkownika", EscapeHtml(uname));
            if (uname != userid.split('/')[2]) { x += addHtmlValue("ID Użytkownika", EscapeHtml(userid.split('/')[2])); }
            x += addHtmlValue("Uprawnienia", r.join(", "));
            if (((userinfo._id) != userid) && (cmeshrights == 0xFFFFFFFF || (((cmeshrights & 2) != 0) && (meshrights != 0xFFFFFFFF)))) buttons += 4;
            setDialogMode(2, "Użytkownik Grupy Urządzń", buttons, p20viewuserEx, x, userid);
        }
        ...
        function p20viewuserEx(button, userid) {
            ...
            setDialogMode(2, "Zdalny Użytkownik Mesh", 3, p20viewuserEx2, format("Potwierdzasz usunięcie użytkownika {0}?", uname), userid);
        }
        ...
        function drawNotifications() {
            ...
            if (notifications.length == 0) {
                r = '<div style=margin:5px>' + "Obecnie nie ma żadnych powiadomień" + '</div>';
            } else {
                for (var i in notifications) {
                    ...
                    r += '<div title="' + format("Wydarzyło się w {0}", printDateTime(d)) + '" id="notifyx' + n.id + '" class=notification style="cursor:pointer;border-top:1px solid ' + ((r == '') ? 'transparent' : 'orange') + '">';
                    if (icon) { r += '<div class=j' + icon + ' onclick="notificationSelected(' + n.id + ')" style=margin:5px;float:left></div>'; }
                    r += '<div onclick="notificationDelete(' + n.id + ')" class=unselectable title="' + "Wyczyść to powiadomienie" + '" style=margin:5px;float:right;color:orange><b>X</b></div><div onclick="notificationSelected(' + n.id + ')" style=margin:5px>' + t + EscapeHtml(n.text) + '</div><div style=margin-left:5px;margin-bottom:5px;color:gray;font-size:10px>' + printDateTime(d) + '</div></div>';
                }
            }
            var deleteall = '';
            if (notifications.length > 1) { deleteall = '<div id="notifyRemoveAll" onclick="deleteAllNotifications()" style="cursor:pointer;border-top:1px solid orange;margin:5px;color:orange;text-align:right;padding-right:3px">' + "Wyczyść wszystko" + '</div>'; }
        ...
        function addNotification(n) {
            ...
            var translatedMessages = [
                ...
                "Błędne uprawnienia strony",
                "Użytkownik już istnieje",
                "Nie można dodać użytkownika w tym trybie",
                "Wyjątek walidacji",
                "Osiągnięto limit konta.", // 10
                "Prośba o Chat, Kliknij tutaj, aby zaakceptować.",
                "Od ostatniego logowania na tym koncie było {0} nieudanych prób logowania.",
                "Nie udało się zmienić adresu e-mail, inne konto już używa: {0}.",
                "Email wysłano.",
                "Użytkownik {0} nie znaleziony.",
                "Użytkowników {0} nie znaleziono.",
                "Błąd, nie można zmienić hasła na poprzednio używane.",
                "Błąd, nie można zmienić hasła na powszechnie używane.",
                "Błąd, hasło nie zostało zmienione.",
                "Hasło zostało zmienione.", // 20
                "Obecne hasło jest nieprawidłowe.",
                "Błąd, kod zaproszenia \"{0}\" jest już w użyciu.",
                "Bramka SMS nie włączona",
                "Brak uprawnień zarządzania użytkownikami",
                "Nieprawidłowa wiadomość SMS",
                "Brak numeru telefonu dla tego użytkownika",
                "Sukces wysyłania SMS.",
                "Błąd SMS",
                "Błąd SMS: {0}",
                "Domena email \"{0}\" jest niedozwolona. Tylko ({1}) jest dopuszczona" // 30
            ];
        ...
        function getFileSizeStr(size) { if (typeof size != 'number') { size = 0; } if (size == 1) return "1 bajt"; return format('{0} bytes', size); }
