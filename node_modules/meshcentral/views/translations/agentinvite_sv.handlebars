<!DOCTYPE html><html lang="sv"><head>
    ...
    <div id="container">
        ...
        <div id="column_l" style="overflow-y:auto">
            <h1><span id="groupname">Installation av fjärragent</span></h1>
            <p>
            ...
            <div>
                ...
                <div id="wintab64" class="tabcontent" style="background-color:white;color:black">
                    ...
                    <p><a id="win64url">Ladda ner programvaran här</a>, kör den och tryck på "Installera" eller "Anslut".</p>
                ...
                <div id="wintab32" class="tabcontent" style="background-color:white;color:black">
                    ...
                    <p><a id="win32url">Ladda ner programvaran här</a>, kör den och tryck på "Installera" eller "Anslut".</p>
                    <div style="text-align:center">
                ...
                <div id="wintabarm64" class="tabcontent" style="background-color:white;color:black">
                    ...
                    <p><a id="winarm64url">Ladda ner programvaran här</a>, kör den och tryck på "Installera" eller "Anslut".</p>
                    <div style="text-align:center">
                ...
                <div id="linuxtab" class="tabcontent" style="background-color:white;color:black">
                    <h3>Linux</h3>
                    <p>För att installera, klipp och klistra in följande kommando i en root-terminal.</p>
                    <div id="linuxinstall" style="font-family:courier,'courier new',monospace;margin-left:30px"></div>
                    <input type="button" value="Kopiera till Urklipp" style="margin-left:30px;margin-top:4px" onclick="copyToClipLinuxInstall()">
                    <p>För att avinstallera, klipp och klistra in följande kommando som root.</p>
                    <div id="unlinuxinstall" style="font-family:courier,'courier new',monospace;margin-left:30px"></div>
                    <input type="button" value="Kopiera till Urklipp" style="margin-left:30px;margin-top:4px" onclick="copyToClipLinuxUnInstall()">
                    <br><br>
                </div>
                ...
                <div id="macostab64" class="tabcontent" style="background-color:white;color:black">
                    ...
                    <p><a id="macos64url">Ladda ner installationsprogrammet här</a>, högerklicka på den eller tryck på "kontroll" och klicka på filen. Välj sedan "Öppna" och följ instruktionerna.</p>
                    <div style="text-align:center">
                ...
                <div id="macostabarm64" class="tabcontent" style="background-color:white;color:black">
                    ...
                    <p><a id="macosarm64url">Ladda ner installationsprogrammet här</a>, högerklicka på den eller tryck på "kontroll" och klicka på filen. Välj sedan "Öppna" och följ instruktionerna.</p>
                    <div style="text-align:center">
                ...
                <div id="macostab" class="tabcontent" style="background-color:white;color:black">
                    ...
                    <p><a id="macosurl">Ladda ner installationsprogrammet här</a>, högerklicka på den eller tryck på "kontroll" och klicka på filen. Välj sedan "Öppna" och följ instruktionerna.</p>
                    <div style="text-align:center">
                ...
                <div id="androtab" class="tabcontent" style="background-color:white;color:black">
                    ...
                    <div style="min-height:220px">
                        <p>Ladda ner agentprogramvaran med Google Play-butiken eller APK-filen, installera den och använd QR-koden till höger eller parningslänken nedan för att ställa in din enhet på den här servern.</p>
                        <p>
                        ...
                        <p>
                            <a id="androidurl">Android APK-nedladdning</a>
                        </p>
                        <p>
                            <a rel="noreferrer noopener" target="_blank" href="{{{magenturl}}}">Koppling för serverpar</a>
                        </p>
                    </div>
                </div>
                ...
                <div id="assistab" class="tabcontent" style="background-color:white;color:black">
                    ...
                    <div style="min-height:220px">
                        ...
                        <p>Assistant är ett verktyg för verktygsfältet i Windows som kan användas när fjärrdatorn behöver hjälp. Detta är inte en agent som körs i bakgrunden på fjärrdatorn, utan det är ett verktyg som bara ansluter till servern på begäran.</p>
                        <p>
                            <a id="assisturl" rel="noreferrer noopener" target="_blank">Ladda ner assistent för Windows</a>
                        </p>
                    </div>
                    <br style="clear:both">
                </div>
    ...
    <script>
        ...
        function startup() {
            ...
            if (groupName != '') {
                QH('groupname', format("Installation av fjärragent för {0}", escapeHtml(groupName)));
                document.title = format("{0} - Agentinstallation", groupName);
            } else {
                document.title = "Agentinstallation";
            }
        ...
        function linuxBinarySetup() {
            ...
            x += addHtmlValue("Installationstyp", '<select id=aginsType onchange=addAgentToMeshClick() style=width:236px><option value=0>' + "Bakgrund och interaktiv" + '</option><option value=2>' + "Endast bakgrund" + '</option><option value=1>' + "Endast interaktiv" + '</option></select>');
            x += '</div><hr>';
            ...
            x += addHtmlValue("Mesh Agent", '<a id=aginsbinlnk name="meshagents?id=' + meshid + '&installflags=0' + (urlargs.key?('&key=' + urlargs.key):'') + '">' + "meshagent" + '</a> <img src=images/link4.png height=10 width=10 title="' + "Kopiera agentens URL till Urklipp" + '" style=cursor:pointer onclick=copyAgentUrl("meshagents?id=' + meshid + '&installflags=",1)>');
            x += addHtmlValue("Kommando", '<input id=aginsbincmd type=text style="width:216px" readonly value=\'wget -O meshagent ' + ((serverNoProxy != 0) ?'--no-proxy':'') + ' --no-check-certificate \"https://' + servername + portStr + domainUrl + 'meshagents?id=' + meshid.split('$').join('%24').split('@').join('%40') + '\' /> <img src=images/link4.png height=10 width=10 title="' + "Kopiera agentens URL till Urklipp" + '" style=cursor:pointer onclick=copyAgentIdValue("aginsbincmd")>');
            x += '</div>';
            QH('linuxbinarytab', x);
            addAgentToMeshClick();
        }
