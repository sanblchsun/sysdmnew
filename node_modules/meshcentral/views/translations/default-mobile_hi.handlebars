<!DOCTYPE html><html lang="hi" dir="ltr" xmlns="http://www.w3.org/1999/xhtml"><head>
    <meta charset="utf-8">
    ...
    <div id="container">
        ...
        <div id="masthead" style="background:url(logo.png) 0px 0px;background-size:341px 50px;background-color:#036;background-repeat:no-repeat;height:50px;width:100%;overflow:hidden">
            ...
            <div id="notificationCount" onclick="clickNotificationIcon()" class="unselectable" style="position:absolute;right:50px;top:0px;font-size:28px;width:50px;height:50px;cursor:pointer;display:none" title="करेंट नोटिफिकेशन देखने के लिए क्लिक करें"><div id="notificationCount2" style="padding-top:8px">0</div></div>
            ...
            <div id="column_l" style="width:100%;padding:0;position:absolute;bottom:0px;top:0px">
                <div id="p0" style="display:none;width:100%;height:100%">
                    <div style="display:flex;align-items:center;width:100%;height:100%">
                        <div id="p0message" style="text-align:center;width:100%"><span id="p0span">सर्वर काट दिया गया</span>, <href onclick="reload()" style="cursor:pointer"><u>पुन: कनेक्ट करने के लिए क्लिक करें</u></href>.</div>
                    </div>
                </div>
                ...
                <div id="p2" style="display:none;position:absolute;top:0;left:0;right:0;bottom:0">
                    ...
                    <div id="xdevicesBar" style="position:absolute;overflow-y:auto;height:34px;left:0;right:0;bottom:0px;background-color:#aaa;color:black">
                        <div style="margin:4px">
                            ...
                            <input id="SearchInput" autocomplete="off" type="search" placeholder="फ़िल्टर" onchange="onDeviceSearchChanged(event)" onclick="onDeviceSearchChanged(event)" onkeyup="onDeviceSearchChanged(event)" style="padding:2px;margin:0;height:20px;background-color:#FFF">&nbsp;
                            <label class="noselect"><input type="checkbox" id="RealNameCheckBox" onclick="onRealNameCheckBox()">OS का नाम</label>
                            <label class="noselect"><input type="checkbox" id="OnlineCheckBox" onclick="onOnlineCheckBox(event)">ऑनलाइन</label>
                        </div>
                    </div>
                </div>
                        ...
                        <div style="margin-left:8px">
                            <div id="p3AccountActions">
                                <div id="p2AccountSecurity" style="display:none">
                                    <p><strong>खाते की सुरक्षा</strong></p>
                                    <div style="margin-left:9px;margin-bottom:8px">
                                        <div id="managePhoneNumber1" style="margin-top:5px;display:none"><a onclick="account_managePhone()" style="cursor:pointer">फ़ोन नंबर प्रबंधित करें</a> <span id="authPhoneNumberCheck"><strong>✓</strong></span></div>
                                        <div id="manageEmail2FA" style="margin-top:5px;display:none"><a onclick="account_manageAuthEmail()" style="cursor:pointer">ईमेल प्रमाणीकरण प्रबंधित करें</a> <span id="authEmailSetupCheck"><strong>✓</strong></span></div>
                                        <div style="margin-top:5px"><a href="#" onclick="account_showLocalizationSettings()">स्थानीयकरण सेटिंग्स</a></div>
                                        <div id="manageAuthApp" style="margin-top:5px;display:none"><a onclick="account_manageAuthApp()" style="cursor:pointer">प्रमाणक ऐप प्रबंधित करें</a> <span id="authAppSetupCheck"><strong>✓</strong></span></div>
                                        <div id="manageOtp" style="margin-top:5px;display:none"><a onclick="account_manageOtp(0)" style="cursor:pointer">बैकअप कोड प्रबंधित करें</a> <span id="authCodesSetupCheck"><strong>✓</strong></span></div>
                                    </div>
                                </div>
                                <div id="p2AccountActions" style="display:none">
                                    <p><strong>खाता क्रिया</strong></p>
                                    <div style="margin-left:9px;margin-bottom:8px">
                                        <div style="margin-top:5px"><span id="viewPreviousLogins"><a onclick="return account_viewPreviousLogins()" style="cursor:pointer">पिछले लॉगिन देखें</a></span></div>
                                        <div style="margin-top:5px"><span id="managePhoneNumber2" style="display:none"><a onclick="account_managePhone()" style="cursor:pointer">फ़ोन नंबर प्रबंधित करें</a></span></div>
                                        <div style="margin-top:5px"><span id="verifyEmailId" style="display:none"><a onclick="account_showVerifyEmail()" style="cursor:pointer">ईमेल सत्यापित करें</a></span></div>
                                        <span id="p2AccountPassActions">
                                            <div style="margin-top:5px"><span id="changeEmailId" style="display:none"><a onclick="account_showChangeEmail()" style="cursor:pointer">ईमेल पता बदलें</a></span></div>
                                            <div style="margin-top:5px"><a onclick="account_showChangePassword()" style="cursor:pointer">पासवर्ड बदलें</a><span id="p2nextPasswordUpdateTime"></span></div>
                                            <div style="margin-top:5px"><a onclick="account_showDeleteAccount()" style="cursor:pointer">खाता हटा दो</a></div>
                                        </span>
                                        <div style="margin-top:5px" id="setDarkModeLink"><a onclick="toggleNightMode()" style="cursor:pointer">डार्क मोड सेट करें</a></div>
                                        <div style="margin-top:5px"><a onclick="showNotes(false)" style="cursor:pointer">व्यक्तिगत नोट्स</a></div>
                                    </div>
                                <br style="clear:both">
                                </div>
                            </div>
                            <strong>डिवाइस समूह</strong>
                            <span id="p3createMeshLink1">( <a onclick="account_createMesh()" style="cursor:pointer"><img src="images/icon-addnew.png" width="12" height="12" border="0"> नया</a> )</span>
                            <br><br>
                            <div id="p3meshes"></div>
                            <div id="p3noMeshFound" style="margin-left:9px;display:none">कोई उपकरण समूह नहीं।<span id="p3createMeshLink2"> <a onclick="account_createMesh()" style="cursor:pointer"><strong>यहाँ से शुरुआत करें!</strong></a></span></div>
                            <br style="clear:both">
                        </div>
                    </div>
                </div>
                <div id="p5" style="display:none">
                    <table cellspacing="0" style="margin:0;padding:0;border-spacing:0;border:0;">
                        <tbody><tr style="padding:0">
                            ...
                            <td>
                                <div style="margin-left:5px">
                                    <strong style="font-size:large">मेरी फ़ाइलें</strong><br>
                                </div>
                            </td>
                        </tr>
                    </tbody></table>
                            ...
                            <tbody><tr>
                                <td style="width:100%;background-color:#d3d9d6;text-align:left;padding:4px" valign="bottom">
                                    <div style="width:100%;text-align:center">
                                        <input type="button" style="width:calc(100%/5 - 5px)" id="p5FolderUp" disabled="disabled" onclick="p5folderup()" value="यूपी">
                                        <input type="button" style="width:calc(100%/5 - 5px)" id="p5SelectAllButton" disabled="disabled" onclick="p5selectallfile()" value="सभी का चयन करे" onkeypress="return false" onkeydown="return false">
                                        <input type="button" style="width:calc(100%/5 - 5px)" id="p5RenameFileButton" disabled="disabled" value="नाम बदलें" onclick="p5renamefile()" onkeypress="return false" onkeydown="return false">
                                        <input type="button" style="width:calc(100%/5 - 5px)" id="p5DeleteFileButton" disabled="disabled" value="हटाएं" onclick="p5deletefile()" onkeypress="return false" onkeydown="return false">
                                        <input type="button" style="width:calc(100%/5 - 5px)" id="p5NewFolderButton" disabled="disabled" value="फ़ोल्डर" onclick="p5createfolder()" onkeypress="return false" onkeydown="return false">
                                    </div>
                                    <div style="width:100%;text-align:center">
                                        <input type="button" style="width:calc(100%/5 - 5px)" id="p5UploadButton" disabled="disabled" value="डालना" onclick="p5uploadFile()" onkeypress="return false" onkeydown="return false">
                                        <input type="button" style="width:calc(100%/5 - 5px)" id="p5CutButton" disabled="disabled" value="कट गया" onclick="p5copyFile(1)" onkeypress="return false" onkeydown="return false">
                                        <input type="button" style="width:calc(100%/5 - 5px)" id="p5CopyButton" disabled="disabled" value="प्रतिलिपि" onclick="p5copyFile(0)" onkeypress="return false" onkeydown="return false">
                                        <input type="button" style="width:calc(100%/5 - 5px)" id="p5PasteButton" disabled="disabled" value="पेस्ट करें" onclick="p5pasteFile()" onkeypress="return false" onkeydown="return false">
                                        <input type="button" style="width:calc(100%/5 - 5px)" id="p5RefreshButton" value="ताज़ा करना" onclick="p5refreshFiles()" onkeypress="return false" onkeydown="return false">
                                    </div>
                                </td>
                            </tr>
                            <tr>
                                        ...
                                        <tbody><tr>
                                            ...
                                            <td style="text-align:right;padding-right:4px">
                                                <select id="p5sortdropdown" onchange="updateFiles()">
                                                    <option value="1" selected="selected">नाम द्वारा क्रमबद्ध करें</option>
                                                    <option value="2">आकारानुसार सजाओ</option>
                                                    <option value="3">दिनांक के हिसाब से अलग करे</option>
                                                    <option value="4">नाम से उतरना</option>
                                                    <option value="5">आकार द्वारा उतरना</option>
                                                    <option value="6">तिथि के अनुसार उतरना</option>
                                                </select>
                                            </td>
                                        </tr>
                                    </tbody></table>
                ...
                <div id="p10" style="display:none;position:absolute;bottom:0;top:0;width:100%;overflow:hidden">
                    ...
                    <div id="p10dialog" style="z-index:1000;background-color:#EEE;box-shadow:0px 0px 15px #666;font-family:Arial,Helvetica,sans-serif;border-radius:5px;position:fixed;top:30px;width:300px;left:30px;display:none">
                        <div style="width:100%;background-color:#003366;color:#FFF;border-radius:5px 5px 0 0">
                            <div style="padding:5px">कीबोर्ड शॉर्टकट अनुकूलन</div>
                        ...
                        <div style="padding:10px;margin-bottom:20px"><input type="button" value="ठीक" style="float:right;width:80px" onclick="deskCustomizeKeysEx()"></div>
                    </div>
                    ...
                    <div id="p10desktop" style="overflow:hidden;position:absolute;top:55px;bottom:0px;width:100%;display:none">
                        <div id="deskarea1" style="position:absolute;top:0px;width:100%;height:32px">
                            <div style="padding-top:2px;padding-bottom:2px;background:#C0C0C0;height:32px">
                                <div style="float:right;text-align:right">
                                    ...
                                    <input type="button" id="deskFullScreen" value="पूर्ण स्क्रीन" onclick="deskToggleFull(event)" onkeypress="return false" onkeydown="return false" disabled="disabled" style="height:28px;margin-right:3px;">
                                </div>
                                <div style="margin-left:3px">
                                    <input type="button" id="connectbutton1" value="जुडिये" onclick="connectDesktop(event,3)" onkeypress="return false" onkeydown="return false" disabled="disabled" style="height:28px">
                                    <input type="button" id="connectbutton1h" value="एचडब्ल्यू कनेक्ट" onclick="connectDesktop(event,2)" onkeypress="return false" onkeydown="return false" disabled="disabled" style="height:28px">
                                    <input type="button" id="disconnectbutton1" value="डिस्कनेक्ट" onclick="connectDesktop(event,0)" onkeypress="return false" onkeydown="return false" style="height:28px">
                                    <span id="deskstatus" style="color:black">डिस्कनेक्ट किया गया</span>
                                </div>
                            </div>
                        </div>
                        ...
                        <div id="deskarea4" style="position:absolute;bottom:0px;width:100%;height:32px">
                            <div style="padding-top:2px;padding-bottom:2px;background:#C0C0C0">
                                ...
                                <div>
                                    <input id="deskActionsBtn" type="button" style="margin-left:3px;height:28px" onkeypress="return false" onkeydown="return false" value="क्रिया" onclick="deviceActionFunction()">
                                    <input type="button" value="समायोजन" onkeypress="return false" onkeydown="return false" onclick="showDesktopSettings()" style="height:28px">
                                    <input type="button" onkeypress="return false" onkeydown="return false" value="पावर एक्शन ..." onclick="showPowerActionDlg()" style="display:none;height:28px">
                                    ...
                                    <input type="button" id="DeskScreens" value="स्क्रीन" onkeypress="return false" onkeydown="return false" onclick="deskSelectScreens()" style="display:none;height:28px">
                                    <label><span id="DeskControlSpan" style="display:none"><input id="DeskControl" type="checkbox" onkeypress="return false" onkeydown="return false">इनपुट</span></label>
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div id="termTable" style="position:absolute;top:0;bottom:0;left:0;right:0">
                            <div id="termarea1">
                                <div class="areaHead" style="line-height:24px">
                                    <div class="toright2">
                                        <input type="button" id="termFullScreen" value="पूर्ण स्क्रीन" onclick="deskToggleFull(event)" onkeypress="return false" onkeydown="return false" disabled="disabled" style="height:28px;margin-right:3px;">
                                        <div id="terminalCustomUpperRight" style="float:left;margin-right:6px"></div>
                                    </div>
                                    <div>
                                        <span id="connectbutton2span" style="margin-left:3px"><input type="button" id="connectbutton2" value="जुडिये" style="height:28px" onclick="connectTerminal(event,1)" onkeypress="return false" onkeydown="return false" disabled="disabled"></span>
                                        <span id="connectbutton2sspan" style="margin-right:4px"><input type="button" id="connectbutton2s" value="एसएसएच कनेक्ट" style="height:28px" onclick="connectTerminal(event,3)" onkeypress="return false" onkeydown="return false" disabled="disabled"></span>
                                        <span id="disconnectbutton2span" style="margin-left:3px"><input type="button" id="disconnectbutton2" value="डिस्कनेक्ट" style="height:28px" onclick="connectTerminal(event,0)" onkeypress="return false" onkeydown="return false"></span>
                                        <span id="termstatus" style="line-height:22px">डिस्कनेक्ट किया गया</span><span id="termtitle"></span>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div id="termarea4" style="position:relative;height:32px;">
                                <div class="areaFoot">
                                    ...
                                    <div style="height:28px">
                                        <input id="termActionsBtn" style="margin-left:3px;height:28px" type="button" title="डिवाइस पर पावर क्रियाएं करें" onkeypress="return false" onkeydown="return false" value="क्रिया" onclick="deviceActionFunction()">
                                        <input id="ctrlcbutton" style="margin-left:3px;height:28px" type="button" onkeypress="return false" onkeydown="return false" value="सीटीएल-सी" onclick="termSendKey(3,'ctrlcbutton')">
                                        <input id="ctrlxbutton" style="margin-left:3px;height:28px" type="button" onkeypress="return false" onkeydown="return false" value="सीटीएल एक्स" onclick="termSendKey(24,'ctrlxbutton')">
                        ...
                        <table id="p13toolbar" style="width:100%;height:111px" cellpadding="0" cellspacing="0">
                            <tbody><tr>
                                <td style="background-color:#C0C0C0;border-bottom:2px solid black;padding:2px;line-height:24px">
                                    <div style="float:right;text-align:right">
                                        <input id="filesActionsBtn" type="button" onkeypress="return false" onkeydown="return false" value="क्रिया" onclick="deviceActionFunction()" style="margin-right:2px">
                                        <div id="filesCustomUpperRight" style="float:left;margin-right:6px"></div>
                                    </div>
                                    <div style="margin-left:2px">
                                        <input id="p13AutoConnect" value="स्वतः जुड़ना" onclick="autoConnectFiles(event)" onkeypress="return false" onkeydown="return false" type="button" style="display:none">
                                        <input id="p13Connect" value="जुडिये" onclick="connectFiles(event,1)" onkeypress="return false" onkeydown="return false" type="button">
                                        <input id="p13Connects" value="एसएफटीपी कनेक्ट" onclick="connectFiles(event,2)" onkeypress="return false" onkeydown="return false" type="button">
                                        <input id="p13Disconnect" value="डिस्कनेक्ट" onclick="connectFiles(event)" onkeypress="return false" onkeydown="return false" type="button">
                                        <span class="textOverGray" id="p13Status">डिस्कनेक्ट किया गया</span>
                                    </div>
                                </td>
                            </tr>
                            <tr>
                                <td style="width:100%;background-color:#d3d9d6;text-align:left;padding:4px" valign="bottom">
                                    <div style="width:100%;text-align:center">
                                        <input type="button" style="width:calc(100%/5 - 5px)" id="p13FolderUp" disabled="disabled" onclick="p13folderup()" value="यूपी">
                                        <input type="button" style="width:calc(100%/5 - 5px)" id="p13SelectAllButton" disabled="disabled" onclick="p13selectallfile()" value="सभी का चयन करे" onkeypress="return false" onkeydown="return false">
                                        <input type="button" style="width:calc(100%/5 - 5px)" id="p13RenameFileButton" disabled="disabled" value="नाम बदलें" onclick="p13renamefile()" onkeypress="return false" onkeydown="return false">
                                        <input type="button" style="width:calc(100%/5 - 5px)" id="p13DeleteFileButton" disabled="disabled" value="हटाएं" onclick="p13deletefile()" onkeypress="return false" onkeydown="return false">
                                        <input type="button" style="width:calc(100%/5 - 5px)" id="p13NewFolderButton" disabled="disabled" value="फ़ोल्डर" onclick="p13createfolder()" onkeypress="return false" onkeydown="return false">
                                    </div>
                                    <div style="width:100%;text-align:center">
                                        <input type="button" style="width:calc(100%/5 - 5px)" id="p13UploadButton" disabled="disabled" value="डालना" onclick="p13uploadFile()" onkeypress="return false" onkeydown="return false">
                                        <input type="button" style="width:calc(100%/5 - 5px)" id="p13CutButton" disabled="disabled" value="कट गया" onclick="p13copyFile(1)" onkeypress="return false" onkeydown="return false">
                                        <input type="button" style="width:calc(100%/5 - 5px)" id="p13CopyButton" disabled="disabled" value="प्रतिलिपि" onclick="p13copyFile(0)" onkeypress="return false" onkeydown="return false">
                                        <input type="button" style="width:calc(100%/5 - 5px)" id="p13PasteButton" disabled="disabled" value="पेस्ट करें" onclick="p13pasteFile()" onkeypress="return false" onkeydown="return false">
                                        <input type="button" style="width:calc(100%/5 - 5px)" id="p13RefreshButton" disabled="disabled" value="ताज़ा करना" onclick="p13folderup(9999)" onkeypress="return false" onkeydown="return false">
                                    </div>
                                </td>
                            </tr>
                            <tr>
                            ...
                            <tbody><tr style="height:28px">
                                <td class="areaHead">
                                    <div class="toright2">
                                        ...
                                        <input type="button" id="p15uploadCore" value="एजेंट कार्रवाई" onclick="p15uploadCore(event)">
                                    </div>
                                        ...
                                        <tbody><tr>
                                            ...
                                            <td id="p15outputselecttd">
                                                <select id="p15outputselect" onchange="setupConsole()">
                                                    <option id="p15outputselect1" value="1">एजेंट</option>
                                                    <option id="p15outputselect3" value="3">धक्का दें</option>
                                                    <option id="p15outputselect2" value="2">MQTT</option>
                                                </select>
                                            </td>
                                            <td style="width:1%"><input id="id_p15consoleClear" type="button" class="bottombutton" value="स्पष्ट" onclick="p15consoleClear()"></td>
                                        </tr>
                                    </tbody></table>
                                </td>
                            </tr>
    ...
    <div id="dialog" style="display:none">
        ...
        <div style="margin-right:16px;margin-left:8px">
            ...
            <div id="dialog3" style="margin:auto;margin:3px">
                <select id="deskkeys" style="width:100%">
                    ...
                    <option value="11">टैब</option>
                    <option value="5">जीत</option>
                    <option value="0">जीत + नीचे</option>
                    <option value="1">जीत + ऊपर</option>
                    <option value="2">जीत + L</option>
                    <option value="3">जीत + M</option>
                    <option value="4">Shift + विन + M</option>
                    <option value="6">जीत + आर</option>
                    <option value="7">Alt-F4</option>
                    <option value="8">Ctrl-W</option>
                    <option value="9">Alt-टैब</option>
            ...
            <div id="dialog4" style="margin:auto;margin:3px">
                <div id="d3upload">
                    ...
                    <select id="d3uploadMode" onchange="d3modechange()">
                        <option value="1">स्थानीय फ़ाइल अपलोड</option>
                        <option value="2">सर्वर फ़ाइल चयन</option>
                    </select>
                </div>
                <div id="d3localmode" style="display:none">
                    <div>दस्तावेज अपलोड करें</div>
                ...
                <div id="d3servermode">
                    <div id="d3serveraction" valign="bottom">
                        <input type="button" id="p3FolderUp" disabled="disabled" onclick="d3folderup()" value="यूपी">&nbsp;<span id="p3CurrentFolder"></span>
                    </div>
            ...
            <div id="dialog7" style="margin:auto;margin:3px">
                <div id="d7meshkvm">
                    <h4 style="width:100%;border-bottom:1px solid gray">एजेंट दूरस्थ डेस्कटॉप</h4>
                    <table style="width:100%">
                        <tbody><tr>
                            <td>
                                गुणवत्ता
                        ...
                        <tr>
                            ...
                            <td style="width:100px">
                                <select id="d7framelimiter" style="float:right;width:200px" dir="rtl">
                                    <option selected="selected" value="50">तेज</option>
                                    <option value="100">मध्यम</option>
                                    <option value="400">धीरे</option>
                                    <option value="1000">बहुत धीमी गति से</option>
                                </select>
                            </td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                            <td></td>
                            <td>
                                <label style="display:block" id="d7deskAutoLockLabel"><input type="checkbox" id="d7deskAutoLock">डिस्कनेक्ट पर लॉक करें</label>
                            </td>
                        </tr>
                    </tbody></table>
                </div>
                <div id="d7amtkvm">
                    <h4 style="width:100%;border-bottom:1px solid gray">Intel® AMT हार्डवेयर KVM</h4>
                    <table style="width:100%">
                        <tbody><tr>
                            <td>एन्कोडिंग</td>
                            <td style="width:100px">
                                <select id="d7desktopmode" style="float:right;width:200px">
                                    <option value="1">RLE8, सबसे तेज</option>
                                    <option value="2">RLE16, अनुशंसित</option>
                                    <option value="3">RAW8, धीमा</option>
                                    <option value="4">RAW16, बहुत धीमा</option>
                                </select>
                            </td>
                        </tr>
                    </tbody></table>
        ...
        <div id="idx_dlgButtonBar" style="padding:10px;margin-bottom:20px">
            <input id="idx_dlgCancelButton" type="button" value="रद्द करना" style="float:right;width:80px;margin-left:5px" onclick="dialogclose(0)">
            <input id="idx_dlgOkButton" type="button" value="ठीक" style="float:right;width:80px" onclick="dialogclose(1)">
            <div><input id="idx_dlgDeleteButton" type="button" value="हटाएं" style="display:none" onclick="dialogclose(2)"></div>
        </div>
    </div>
    <div id="topMenu" style="z-index:1000;background-color:#EEE;box-shadow:0px 0px 15px #666;font-family:Arial,Helvetica,sans-serif;border-radius:0px 0px 5px 5px;position:fixed;top:50px;right:5px;width:170px;display:none">
        <div style="padding:12px;border-top:1px solid gray;color:black;cursor:pointer" onclick="topMenu(2)">मेरी फ़ाइलें</div>
        <div style="padding:12px;border-top:1px solid gray;color:black;cursor:pointer" onclick="topMenu(1)">मेरा खाता</div>
        <div id="logoutMenuOption"><a id="logoutMenuOptionRef" href="/logout"><div style="padding:12px;border-top:1px solid gray;color:black;cursor:pointer">लॉग आउट</div></a></div>
    </div>
    ...
    <script>
        ...
        function onStateChanged(server, state, prevState, errorCode) {
            if (state == 0) {
                ...
                if (errorCode == 'noauth') { QH('p0span', "प्रमाणीकरण करने में असमर्थ"); return; }
                if (prevState == 2) { setTimeout(serverPoll, 5000); } else { QH('p0span', "वेब सॉकेट कनेक्ट करने में असमर्थ"); }
                // Clean up here
        ...
        function updateSelf() {
            ...
            if (typeof userinfo.passchange == 'number') {
                if (userinfo.passchange == -1) { QH('p2nextPasswordUpdateTime', " - अगले लॉगिन पर रीसेट करें।"); }
                    ...
                    if (seconds < 0) { QH('p2nextPasswordUpdateTime', " - अगले लॉगिन पर रीसेट करें।"); }
                    else if (seconds < 3600) { var secs = Math.floor(seconds / 60); QH('p2nextPasswordUpdateTime',format((secs == 1)?" - 1 मिनट में रीसेट करें।":" - {0} मिनट में रीसेट करें।", secs)); }
                    else if (seconds < 86400) { var hours = Math.floor(seconds / 3600); QH('p2nextPasswordUpdateTime', format((hours == 1) ? " - 1 घंटे में रीसेट करें।" : " - {0} घंटे में रीसेट करें।", hours)); }
                    else { var days = Math.floor(seconds / 86400); QH('p2nextPasswordUpdateTime', format((hours == 1) ? " - 1 दिन में रीसेट करें।" : " - {0} दिनों में रीसेट करें।", days)); }
                }
            }
        }
            ...
            switch (message.action) {
                case 'serverinfo': {
                    ...
                    if (serverinfo.certExpire != null) {
                        ...
                        if ((days >= 0) && (days < 20)) {
                            addNotification({ text: format("प्रमाणपत्र की समय-सीमा {0} दिन (दिनों) में समाप्त हो जाती है", days) });
                        }
                    }
                ...
                case 'otpauth-request': {
                    if ((xxdialogMode == 2) && (xxdialogTag == 'otpauth-request')) {
                        if (message.err != null) {
                            var otpauthErrors = ['', "2FA बंद है", "बैकअप कोड लॉक हैं", "लॉगिन टोकन उपयोग में है", "OTP 2FA की अनुमति नहीं है", "खाता बंद है", "ओटीपीएलआईबी लोड करने में असमर्थ"];
                            if ((message.err > 0) && (message.err < otpauthErrors.length)) { QH('d2optinfo', otpauthErrors[message.err]); } else { QH('d2optinfo', format("त्रुटि #{0}", message.err)); }
                        } else {
                ...
                case 'otpauth-setup': {
                    ...
                    setDialogMode(2, "प्रमाणक ऐप", 1, null, message.success ? ('<b style=color:green>' + "प्रमाणक अनुप्रयोग सक्रियण सफल।" + '</b> ' + "अब आपको फिर से लॉगिन करने के लिए वैध टोकन की आवश्यकता होगी।") : ('<b style=color:red>' + "2-चरण लॉगिन सक्रियण विफल।" + '</b> ' + "एप्लिकेशन से रहस्य साफ़ करें और पुनः प्रयास करें। आपके पास उचित कोड दर्ज करने के लिए केवल कुछ मिनट हैं।"));
                    break;
                }
                case 'otpauth-clear': {
                    if (xxdialogMode) return;
                    setDialogMode(2, "प्रमाणक ऐप", 1, null, message.success ? ('<b>' + "प्रमाणीकरणकर्ता का आवेदन हटा दिया गया।" + '</b> ' + "आप किसी भी समय इस सुविधा को पुनः सक्रिय कर सकते हैं।") : ('<b style=color:red>' + "2-चरण लॉगिन सक्रियण निष्कासन विफल।" + '</b> ' + "पुनः प्रयास करें।"));
                    break;
                }
                case 'otpauth-getpasswords': {
                    if (xxdialogMode) return;
                    var x = "एक समय के टोकन को माध्यमिक प्रमाणीकरण के रूप में उपयोग किया जा सकता है। एक सेट बनाएं, उन्हें प्रिंट करें और उन्हें सुरक्षित स्थान पर रखें।";
                    ...
                    if (message.passwords) {
                        ...
                        x += '<tr><td>' + "कोई सक्रिय टोकन नहीं";
                    }
                    x += '</table></div></div><br />';
                    x += '<div><input type=button value=\'' + "बंद करे" + '\' onclick=setDialogMode(0) style=float:right></input>';
                    x += '<input type=button value=\'' + "नए स्तन" + '\' onclick=\'account_manageOtp(1);\'></input>';
                    if (message.passwords != null) { x += '<input type=button value=\'' + "स्पष्ट" + '\' onclick=\'account_manageOtp(2);\'></input>'; }
                    x += '</div><br />';
                    setDialogMode(2, "बैकअप कोड प्रबंधित करें", 8, null, x, 'otpauth-manage');
                    break;
                }
                case 'verifyPhone': {
                    ...
                    x += '<br /><br /><div style=width:100%;text-align:center>' + "पुष्टि संख्या:" + ' <input type=tel pattern="[0-9]" inputmode="number" maxlength=6 id=d2phoneCodeInput onKeyUp=account_managePhoneCodeValidate() onkeypress="if (event.key==\'Enter\') account_managePhoneCodeValidate(1)"></div></table>';
                    setDialogMode(2, "फोन सूचनाएं", 3, account_managePhoneConfirm, x, message.cookie);
                    ...
                    if ((xxdialogMode == 2) && (xxdialogTag == 'previousLogins')) {
                        ...
                        if (message.events.length == 0) {
                            ...
                            for (var i in message.events) {
                                ...
                                if (m == 107) { m = "वैध लॉगिन"; c = 'BBD1BB'; xx = ''; }
                                else if (m == 108) { m = "अमान्य 2FA"; c = 'DD9DC3'; xx = 'x'; }
                                else if (m == 109) { m = "बंद खाता"; c = 'E1BBBB'; xx = 'x'; }
                                else if (m == 110) { m = "अवैध पासवर्ड"; c = 'E1BBBB'; xx = 'x'; }
                        ...
                        setDialogMode(2, "पिछला लॉगिन", 1, null, x);
                    }
                    break;
                }
                case 'event': {
        ...
        function goStack() {
            ...
            if (idtype == 'files') {
                ...
                if ((features & 0x00040000) && !((userinfo.otpsecret == 1) || (userinfo.otphkeys > 0) || (userinfo.otpkeys > 0) || (userinfo.otpduo > 0) || (userinfo.otpdev > 0) || ((features & 0x00800000) && (userinfo.otpekey == 1)))) { setDialogMode(2, "खाते की सुरक्षा", 1, null, "Unable to access this feature until two-factor authentication is enabled. This is required for extra security. Go to the \"My Account\" and look at the \"Account Security\" section."); return; }  
                go(5);
            }
        }
        ...
        function account_viewPreviousLogins() {
            if (xxdialogMode) return;
            setDialogMode(2, "पिछला लॉगिन", 1, null, "लोड हो रहा है...", 'previousLogins');
        ...
        function account_manageImage(mode) {
            ...
            setDialogMode(2, "खाता छवि प्रबंधित करें", 7, account_manageImageEx2, x, user._id);
        ...
        function toggleNightMode() {
            ...
            var x = '<input type=radio id=night0 name=nightmoderadio value=0 ' + ((cNightMode == 0) ? 'checked' : '') + '><label for=night0>' + "ब्राउज़र डिफ़ॉल्ट" + '</label><br>';
            x += '<input type=radio id=night2 name=nightmoderadio value=2 ' + ((cNightMode == 2) ? 'checked' : '') + '><label for=night2>' + "लाइट मोड" + '</label><br>';
            x += '<input type=radio id=night1 name=nightmoderadio value=1 ' + ((cNightMode == 1) ? 'checked' : '') + '><label for=night1>' + "डार्क मोड" + '</label><br>';
            setDialogMode(2, "रात का मोड", 3, toggleNightModeEx, x);
            QV('uiMenu', false);
        }
        ...
        function account_managePhone() {
            ...
            if (userinfo.phone != null) {
                ...
                x += '<td style=text-align:center><div style=padding:6px>' + "सत्यापित फ़ोन नंबर" + '</div><div style=font-size:20px>' + userinfo.phone + '</div>';
                x += '<div style=margin:10px><label><input id=d2delPhone type=checkbox onclick=account_managePhoneRemoveValidate() />' + "फ़ोन नंबर हटा दें" + '</label></div>';
                setDialogMode(2, "फोन सूचनाएं", 3, account_managePhoneRemove, x);
                ...
                x += '<br /><br /><div style=width:100%;text-align:center>' + "फ़ोन नंबर:" + ' <input type=tel pattern="[0-9]" autocomplete="tel" inputmode="tel" maxlength=18 id=d2phoneinput onKeyUp=account_managePhoneValidate() onkeypress="if (event.key==\'Enter\') account_managePhoneValidate(1)"></div></table>';
                setDialogMode(2, "फोन सूचनाएं", 3, account_managePhoneAdd, x, 'verifyPhone');
        ...
        function account_showLocalizationSettings() {
            ...
            if (serverinfo.languages && serverinfo.languages.length > 0) {
                y += "भाषा बदलने पर पेज को रिफ्रेश करना होगा।" + '<br /><br />';
                var z = '<select id=d2langselect style=width:180px><option value="*">' + "उपयोगकर्ता ब्राउज़र मान" + '</option>';
                ...
                z += '</select>';
                y += addHtmlValue("भाषा: हिन्दी", z);
            }
            y += addHtmlValue("दिनांक और समय", x);

            if ((userinfo.siteadmin == 0xFFFFFFFF) && (domain == '')) {
                y += '<br /><a rel="noreferrer noopener" target="_blank" href="translator.htm">' + "मदद" + '</a>';
            }

            setDialogMode(2, "स्थानीयकरण सेटिंग्स", 3, account_showLocalizationSettingsEx, y);
            return false;
        }
        ...
        function account_addOtp() {
            ...
            setDialogMode(2, "प्रमाणक ऐप", 2, function () { meshserver.send({ action: 'otpauth-setup', secret: Q('d2optsecret').attributes.secret.value, token: Q('d2otpauthinput').value }); }, '<div id=d2optinfo>' + "लोड हो रहा है..." + '</div>', 'otpauth-request');
        ...
        function account_removeOtp() {
            if (xxdialogMode || (userinfo.otpsecret != 1) || ((features & 4096) == 0)) return;
            setDialogMode(2, "प्रमाणक ऐप", 3, function () { meshserver.send({ action: 'otpauth-clear' }); }, "प्रामाणिकता एप्लिकेशन 2-चरण लॉगिन को हटाने की पुष्टि करें?");
        }
        ...
        function account_showVerifyEmail() {
            ...
            var x = "सत्यापन मेल भेजने के लिए ठीक क्लिक करें:" + '<br /><div style=padding:8px><b>' + EscapeHtml(userinfo.email) + '</b></div>' + "कृपया सत्यापन प्राप्त करने के लिए कुछ मिनट प्रतीक्षा करें।";
            setDialogMode(2, "ई - मेल सत्यापन", 3, account_showVerifyEmailEx, x);
        }
        ...
        function account_showChangeEmail() {
            if (xxdialogMode) return;
            var x = addHtmlValue("ईमेल", '<input id=dp3email style=width:170px maxlength=256 onchange=account_validateEmail() onkeyup=account_validateEmail(event) />');
            setDialogMode(2, "ईमेल पता बदलें", 3, account_changeEmail, x);
        ...
        function account_showDeleteAccount() {
            ...
            x += '<td align=right>' + "कुंजिका:" + '</td><td><input id=apassword1 type=password name=apassword1 autocomplete=off onchange=account_validateDeleteAccount() onkeyup=account_validateDeleteAccount() /></td>';
            x += '</tr><tr><td align=right>' + "कुंजिका:" + '</td><td><input id=apassword2 type=password name=apassword2 autocomplete=off onchange=account_validateDeleteAccount() onkeyup=account_validateDeleteAccount() /></td>';
            x += '</tr></table><div style=padding:10px;margin-bottom:4px>';
            x += '<input id=account_dlgCancelButton type=button value="' + "रद्द करना" + '" style=float:right;width:80px;margin-left:5px onclick=dialogclose(0)>';
            x += '<input id=account_dlgOkButton type=submit value="' + "ठीक" + '" style="float:right;width:80px" onclick=dialogclose(1)>';
            x += '</div><br /></form>';
            setDialogMode(2, "खाता हटा दो", 0, null, x);
        ...
        function account_showChangePassword() {
            ...
            x += '<tr><td align=right>' + nobreak("पुराना पासवर्ड:") + '</td><td><input id=apassword0 type=password name=apassword0 autocomplete=off onchange=account_validateNewPassword() onkeyup=account_validateNewPassword() onkeydown=account_validateNewPassword() /> <b></b></td></tr>';
            x += '<tr><td align=right>' + nobreak("नया पासवर्ड:") + '</td><td><input id=apassword1 type=password name=apassword1 autocomplete=off onchange=account_validateNewPassword() onkeyup=account_validateNewPassword() onkeydown=account_validateNewPassword() /> <b><span id=dxPassWarn></span></b></td></tr>';
            x += '<tr><td align=right>' + nobreak("नया पासवर्ड:") + '</td><td><input id=apassword2 type=password name=apassword2 autocomplete=off onchange=account_validateNewPassword() onkeyup=account_validateNewPassword() onkeydown=account_validateNewPassword() /></td></tr>';
            if (features & 0x00010000) { x += '<tr><td align=right>' + "पासवर्ड संकेत:" + '</td><td><input id=apasswordhint name=apasswordhint maxlength=250 type=text autocomplete=off onchange=account_validateNewPassword() onkeyup=account_validateNewPassword() onkeydown=account_validateNewPassword() /></td></tr>'; }
            x += '</table>'
            if (passRequirements) {
                var r = [], rc = 0;
                for (var i in passRequirements) { if ((i != 'reset') && (i != 'hint')) { r.push(i + ':' + passRequirements[i]); rc++; } }
                if (rc > 0) { x += '<br /><span style=font-size:x-small>' + format("आवश्यकताएँ: {0}।", r.join(', ')) + '</span>'; }
            }
            x += '<br />';
            setDialogMode(2, "पासवर्ड बदलें", 3, account_showChangePasswordEx, x);
            Q('apassword0').focus();
        ...
        function account_createMesh() {
            ...
            if ((userinfo.siteadmin != 0xFFFFFFFF) && ((userinfo.siteadmin & 64) != 0)) { setDialogMode(2, "नया डिवाइस ग्रुप", 1, null, "इस खाते में नया उपकरण समूह बनाने के अधिकार नहीं हैं।"); return; }

            // Remind the user to verify the email address
            if ((userinfo.emailVerified !== true) && (serverinfo.emailcheck == true) && (userinfo.siteadmin != 0xFFFFFFFF)) { setDialogMode(2, "खाते की सुरक्षा", 1, null, "ईमेल पता सत्यापित होने तक डिवाइस तक पहुंचने में असमर्थ। पासवर्ड रिकवरी के लिए यह आवश्यक है। ईमेल पता बदलने और सत्यापित करने के लिए \"मेरा खाता \" पर जाएं।"); return; }

            // Remind the user to add two factor authentication
            if ((features & 0x00040000) && !((userinfo.otpsecret == 1) || (userinfo.otphkeys > 0) || (userinfo.otpkeys > 0) || (userinfo.otpduo > 0) || (userinfo.otpdev > 0) || ((features & 0x00800000) && (userinfo.otpekey == 1)))) { setDialogMode(2, "खाते की सुरक्षा", 1, null, "दो-कारक प्रमाणीकरण सक्षम होने तक डिवाइस तक पहुंचने में असमर्थ। अतिरिक्त सुरक्षा के लिए यह आवश्यक है। \"मेरा खाता \" पर जाएं और \"खाता सुरक्षा \" अनुभाग देखें।"); return; }

            // We are allowed, let's prompt to information
            var x = addHtmlValue("नाम", '<input id=dp3meshname style=width:170px maxlength=64 onchange=account_validateMeshCreate() onkeyup=account_validateMeshCreate() />');
            x += addHtmlValue("प्रकार", '<div style=width:170px;margin:0;padding:0><select id=dp3meshtype style=width:100% onchange=account_validateMeshCreate() ><option value=2>' + "सॉफ्टवेयर एजेंट समूह" + '</option><option value=1>' + "केवल Intel&reg; AMT" + '</option></select></div>');
            x += addHtmlValue("विवरण", '<div style=width:170px;margin:0;padding:0><textarea id=dp3meshdesc maxlength=1024 style=width:100%;resize:none></textarea></div>');
            setDialogMode(2, "डिवाइस ग्रुप बनाएं", 3, account_createMeshEx, x);
        ...
        function account_validateNewPassword() {
            ...
            if (Q('apassword1').value != '') {
                if (passRequirements == null || passRequirements == '') {
                    ...
                    if (passReq == false) { ok = false; r = '<span style=color:red>' + "नीति" + '<span>' }
                }
            }
            QH('dxPassWarn', r);
        ...
        function updateMeshes() {
            ...
            for (i in meshes) {
                ...
                var rights = "आंशिक अधिकार";
                if (meshrights == 0xFFFFFFFF) rights = "पूर्ण प्रशासक"; else if (meshrights == 0) rights = "कोई अधिकार नहीं";
        ...
        function updateFiles() {
            ...
            var html1 = '', html2 = '', displayPath = '<a style=cursor:pointer;color:black onclick=p5folderup(0)>' + "जड़" + '</a>', fullPath = 'Root', publicPath, filetreex = filetree, folderdepth = 1;
            ...
            for (var i in filetreexx) {
                ...
                if (f.t < 3 || f.t == 4) {
                    ...
                    var link = shortname;
                    var publiclink = '';
                    if (publicfolder) { publiclink = ' (<a style=cursor:pointer onclick=\'p5showPublicLink("' + publicPath + '/' + f.nx + '")\'>' + "संपर्क" + '</a>)'; }
        ...
        function getNiceSize(bytes) {
            if (bytes <= 0) return "भंडारण से अधिक है";
            if (bytes < 2048) return format("{0} b बचा", bytes);
            if (bytes < 2097152) return format("{0} k बचा", Math.round(bytes / 1024));
            if (bytes < 2147483648) return format("{0} m बचा हुआ", Math.round(bytes / 1024 / 1024));
            return format("{0} जी बचा", Math.round(bytes / 1024 / 1024 / 1024));
        }
        ...
        function p5showPublicLink(u) { setDialogMode(2, "सार्वजनिक लिंक", 1, null, '<input type=text style=width:100% value="' + u + '" readonly />'); }
        ...
        function p5setActions() {
            ...
            Q('p5SelectAllButton').value = (cc > 0 ? "कोई नहीं" : "सब");
        ...
        function getFileSizeStr(size) { if (size == 1) return "1 बाइट"; return format("{0} बाइट्स", size); }
        ...
        function p5createfolder() { setDialogMode(2, "नया फोल्डर", 3, p5createfolderEx, '<input type=text id=p5renameinput maxlength=64 onkeyup=p5fileNameCheck(event) style=width:100% />'); focusTextBox('p5renameinput'); p5fileNameCheck(); }
        ...
        function p5deletefile() { var cc = getFileSelCount(), rec = (getFileSelDirCount() > 0) ? '<br /><br /><label><input type=checkbox id=p5recdeleteinput>' + "रिकर्सिव डिलीट" + '</label><br>' : '<input type=checkbox id=p5recdeleteinput style=\'display:none\'>'; setDialogMode(2, "हटाएं", 3, p5deletefileEx, (cc > 1) ? (format("{0} चयनित आइटम हटाएं?", cc) + rec) : ("चयनित आइटम हटाएं?" + rec)); }
        ...
        function p5pasteFile() { var x = ''; if ((p5clipboard != null) && (p5clipboard.length > 0)) { x = format("{1} के {0} की पुष्टि करें {2} इस स्थान पर?", (p5clipboardCut == 0 ? 'copy' : 'move'), p5clipboard.length, ((p5clipboard.length > 1) ? 's' : '')) } setDialogMode(2, "पेस्ट करें", 3, p5pasteFileEx, x); }
        ...
        function p5updateClipview() { var x = ''; if ((p5clipboard != null) && (p5clipboard.length > 0)) { x = format("{2} के लिए {0} entrie {1} पकड़े", p5clipboard.length, ((p5clipboard.length > 1) ? 's' : ''), (p5clipboardCut == 0 ? "प्रतिलिपि" : "चाल")) + ', <a href=# onclick="return p5clearClip()" style=cursor:pointer>' + "स्पष्ट" + '</a>.' } QH('p5bottomstatus', x); p5setActions(); }
        ...
        function updateDevices() {
            ...
            for (var i in nodes) {
                ...
                if (sort == 0) {
                    ...
                    if (((meshes[nodes[i].meshid]?nodes[i].meshid:'*') != current)) {
                        deviceHeaderSet();
                        var extra = '';
                        if ((meshes[nodes[i].meshid] != null) && (meshes[nodes[i].meshid].mtype == 1)) { extra = '<span style=color:lightgray>' + ", Intel&reg; AMT केवल" + '</span>'; }
                        ...
                        if (meshes[nodes[i].meshid]) {
                            ...
                            r += '</span><span id=MxMESH><i>' + "व्यक्तिगत उपकरण" + '</i></span><span id=DevxHeader' + deviceHeaderId + ' style=color:lightgray></span></div>';
                            current = '*';
                        }
            ...
            if ((r == '') && (nodes.length > 0) && (Q('SearchInput').value != '')) {
                viewNothing = true;
                r = '<div style="margin:30px">' + "इस खोज से मेल खाने वाला कोई उपकरण नहीं है।" + '</div>';
            }
            ...
            if ((sort == 0) && (Q('SearchInput').value == '')) {
                for (var i in meshes) {
                    ...
                    if ((displayedMeshes[mesh._id] == null) && (IsMeshViewable(mesh))) {
                        ...
                        if (mesh.mtype == 1) { r += '<div style=padding:10px><i>' + "इस समूह में कोई Intel&reg; AMT डिवाइस नहीं है"; }
                        if (mesh.mtype > 1) { r += '<div style=padding:10px><i>' + "इस समूह में कोई उपकरण नहीं है"; }
                        r += '.</i></div></div>';
                        current = mesh._id;
                        count++;
                    }
            ...
            if (count == 0) {
                if ((Q('SearchInput').value != '') || (Q('OnlineCheckBox').checked)) {
                    QH('xdevices', '<div style="margin-top:50px;text-align:center"><span style="font-size:30px">' + "कोई उपकरण नहीं" + '</span><br /><br />' + "इस खोज से मेल खाने वाला कोई उपकरण नहीं है।" + ' <a onclick=clearSearchInput() style=cursor:pointer>' + "खोज फ़िल्टर साफ़ करें" + '</a></div>');
                } else {
                    QH('xdevices', '<div style="margin-top:50px;text-align:center"><span style="font-size:30px">' + "कोई उपकरण नहीं" + '</span><br /><br />' + "उपकरणों को जोड़ने के लिए इस वेबसाइट के डेस्कटॉप संस्करण का उपयोग करें।" + '</div>');
                }
            } else {
                QH('xdevices', r);
            }
        ...
        function updateDeviceViewHtml(div, node) {
            ...
            if ((div.offsetTop >= visibleTop) && (div.offsetTop < visibleBottom)) {
                ...
                if (title.length == 0) { title = '<i>' + "कोई नहीं" + '</i>'; }
                ...
                if (name.length == 0) { name = '<i>' + "कोई नहीं" + '</i>'; }
                ...
                if (node.sessions != null) {
                    ...
                    if (node.sessions.battery != null) {
                        ...
                        var statestr = '';
                        if (bat.state == 'ac') { statestr = "डिवाइस प्लग-इन है"; }
                        else if (bat.state == 'dc') { statestr = "डिवाइस बैटरी चालित है"; }
        ...
        function showDeviceHelpRequests(nodeid, force, e) {
            ...
            if (x != '') { setDialogMode(2, "मदद अनुरोध" + ' - ' + EscapeHtml(node.name), 1, null, x, 'HELPREQ-' + node._id); } else { setDialogMode(0); }
            return false;
        }
        ...
        function showDeviceSessions(nodeid, force, e) {
            ...
            for (var i in node.sessions) {
                if ((i == 'kvm') && (node.sessions.multidesk == null)) {
                    x += '<u>' + "रिमोट डेस्कटॉप" + '</u>';
                    for (var j in node.sessions.kvm) {
                        if (j.startsWith('user/')) {
                            var trash = '';
                            if ((j == userinfo._id) || (GetNodeRights(node) == 0xFFFFFFFF)) { trash = ' <a href=# onclick=\'return endDeviceSession("kvm", "' + encodeURIComponentEx(node._id) + '", "' + encodeURIComponentEx(j) + '")\' title="' + "इस सत्र को डिस्कनेक्ट करें" + '" style=cursor:pointer><img src=images/trash.png border=0 height=10 width=10></a>'; }
                            x += addHtmlValue4(getUserName(j), ((node.sessions.kvm[j] == 1) ? "1 सत्र" : nobreak(format("{0} सत्र", node.sessions.kvm[j]))) + trash);
                        } else if (j == 'busy') {
                            x += addHtmlValue2("डिवाइस व्यस्त है", ((node.sessions.kvm[j] == 1) ? "1 सत्र" : nobreak(format("{0} सत्र", node.sessions.kvm[j]))));
                        }
                    }
                } else if (i == 'multidesk') {
                    x += '<u>' + "रिमोट डेस्कटॉप" + '</u>';
                    for (var j in node.sessions.multidesk) {
                        var trash = '';
                        if ((j == userinfo._id) || (GetNodeRights(node) == 0xFFFFFFFF)) { trash = ' <a href=# onclick=\'return endDeviceSession("multidesk", "' + encodeURIComponentEx(node._id) + '", "' + encodeURIComponentEx(j) + '")\' title="' + "इस सत्र को डिस्कनेक्ट करें" + '" style=cursor:pointer><img src=images/trash.png border=0 height=10 width=10></a>'; }
                        x += addHtmlValue4(getUserName(j), ((node.sessions.multidesk[j] == 1) ? "1 सत्र" : nobreak(format("{0} सत्र", node.sessions.multidesk[j]))) + trash);
                    }
                } else if (i == 'terminal') {
                    x += '<u>' + "टर्मिनल" + '</u>';
                    for (var j in node.sessions.terminal) {
                        var trash = '';
                        if ((j == userinfo._id) || (GetNodeRights(node) == 0xFFFFFFFF)) { trash = ' <a href=# onclick=\'return endDeviceSession("terminal", "' + encodeURIComponentEx(node._id) + '", "' + encodeURIComponentEx(j) + '")\' title="' + "इस सत्र को डिस्कनेक्ट करें" + '" style=cursor:pointer><img src=images/trash.png border=0 height=10 width=10></a>'; }
                        x += addHtmlValue4(getUserName(j), ((node.sessions.terminal[j] == 1) ? "1 सत्र" : nobreak(format("{0} सत्र", node.sessions.terminal[j]))) + trash);
                    }
                } else if (i == 'files') {
                    x += '<u>' + "फ़ाइलें" + '</u>';
                    for (var j in node.sessions.files) {
                        var trash = '';
                        if ((j == userinfo._id) || (GetNodeRights(node) == 0xFFFFFFFF)) { trash = ' <a href=# onclick=\'return endDeviceSession("files", "' + encodeURIComponentEx(node._id) + '", "' + encodeURIComponentEx(j) + '")\' title="' + "इस सत्र को डिस्कनेक्ट करें" + '" style=cursor:pointer><img src=images/trash.png border=0 height=10 width=10></a>'; }
                        x += addHtmlValue4(getUserName(j), ((node.sessions.files[j] == 1) ? "1 सत्र" : nobreak(format("{0} सत्र", node.sessions.files[j]))) + trash);
                    }
                } else if (i == 'tcp') {
                    x += '<u>' + "टीसीपी रूटिंग" + '</u>';
                    for (var j in node.sessions.tcp) {
                        var trash = '';
                        if ((j == userinfo._id) || (GetNodeRights(node) == 0xFFFFFFFF)) { trash = ' <a href=# onclick=\'return endDeviceSession("tcp", "' + encodeURIComponentEx(node._id) + '", "' + encodeURIComponentEx(j) + '")\' title="' + "इस सत्र को डिस्कनेक्ट करें" + '" style=cursor:pointer><img src=images/trash.png border=0 height=10 width=10></a>'; }
                        x += addHtmlValue4(getUserName(j), ((node.sessions.tcp[j] == 1) ? "1 सत्र" : nobreak(format("{0} सत्र", node.sessions.tcp[j]))) + trash);
                    }
                } else if (i == 'udp') {
                    x += '<u>' + "यूडीपी रूटिंग" + '</u>';
                    for (var j in node.sessions.udp) {
                        var trash = '';
                        if ((j == userinfo._id) || (GetNodeRights(node) == 0xFFFFFFFF)) { trash = ' <a href=# onclick=\'return endDeviceSession("udp", "' + encodeURIComponentEx(node._id) + '", "' + encodeURIComponentEx(j) + '")\' title="' + "इस सत्र को डिस्कनेक्ट करें" + '" style=cursor:pointer><img src=images/trash.png border=0 height=10 width=10></a>'; }
                        x += addHtmlValue4(getUserName(j), ((node.sessions.udp[j] == 1) ? "1 सत्र" : nobreak(format("{0} सत्र", node.sessions.udp[j]))) + trash);
                    }
                }
            }
            if (x != '') { setDialogMode(2, "सत्र" + ' - ' + EscapeHtml(node.name), 1, null, x, 'SESSIONS-' + node._id); } else { setDialogMode(0); }
        }
        ...
        function showDeviceMessages(nodeid, force, e) {
            ...
            x += '</div>';
            if (count > 0) setDialogMode(2, "एजेंट संदेश" + ' - ' + EscapeHtml(node.name), 1, null, x, 'MESSAGES-' + node._id);
            return false;
        }

        var powerStatetable = ['', "संचालित", "नींद", "नींद", "नींद", "सुप्तावस्था", "बिजली बंद", "वर्तमान", "बंद"];
        var powerStateStrings = ['', "संचालित", "सोया हुआ", "सोया हुआ", "गहरी नींद", "सुप्तावस्था", "शीतल-ऑफ", "वर्तमान", "बंद"];
        var powerStateStrings2 = ['', "डिवाइस संचालित है", "डिवाइस स्लीप अवस्था में है (S1)", "डिवाइस स्लीप अवस्था में है (S2)", "डिवाइस गहरी नींद की स्थिति में है (S3)", "डिवाइस हाइबरनेट कर रहा है (S4)", "डिवाइस नरम-बंद स्थिति (S5) में है", "डिवाइस मौजूद है, लेकिन पावर स्टेट निर्धारित नहीं किया जा सकता है", "डिवाइस बंद है"];
        ...
        function NodeStateStr(node) {
            ...
            if (node.conn) {
                if ((node.conn & 1) != 0) { states.push('<span>' + ((node.mtype == 4) ? ((node.porttype == 'PDU') ? "स्विच" : "आईपी-केवीएम") : "एजेंट") + '</span>'); }
                if ((node.conn & 2) != 0) { states.push('<span>' + "सीआईआरए" + '</span>'); }
                else if ((node.conn & 4) != 0) { states.push('<span>' + "इंटेल&reg; एएमटी" + '</span>'); }
                if ((node.conn & 8) != 0) { states.push('<span>' + "रिले" + '</span>'); }
        ...
        function deviceHeaderSet() {
            ...
            deviceHeaders['DevxHeader' + deviceHeaderId] = ', ' + deviceHeaderTotal + ((deviceHeaderTotal == 1) ? " नोड" : " नोड्स");
            var title = '';
        ...
        */
        ...
        function gotoDevice(nodeid, panel, refresh) {
            ...
            if (!currentNode || currentNode._id != node._id || refresh == true) {
                ...
                if ((currentNode.sessions != null) && (currentNode.sessions.battery != null)) {
                    ...
                    var statestr = '';
                    if (bat.state == 'ac') { statestr = "डिवाइस प्लग-इन है"; }
                    if (bat.state == 'dc') { statestr = "डिवाइस बैटरी चालित है"; }
                ...
                if (nname.length == 0) { nname = '<i>' + "कोई नहीं" + '</i>'; }
                ...
                // Attribute: Mesh
                if (mesh) { x += addDeviceAttribute('<span>' + "समूह" + '</span>', '<a onclick=goForward("' + node.meshid + '") style=cursor:pointer>' + EscapeHtml(meshes[node.meshid].name) + '</a>'); }

                // Attribute: Name
                if (node.rname != null) { x += addDeviceAttribute('<span>' + "नाम" + '</span>', '<span>' + EscapeHtml(node.rname) + '</span>'); }

                // Attribute: Host
                if ((((features & 1) == 0) && (node.mtype != 4)) || (node.mtype == 3)) { // If not WAN-only, local hostname is in use
                    if ((meshrights & 4) != 0) {
                        if (node.host) {
                            x += addDeviceAttribute("होस्ट का नाम", '<span onclick=showEditNodeValueDialog(1) style=cursor:pointer>' + EscapeHtml(node.host) + '</span>');
                        } else {
                            x += addDeviceAttribute("होस्ट का नाम", '<span onclick=showEditNodeValueDialog(1) style=cursor:pointer><i>' + "कोई नहीं" + '</i></span>');
                        }
                    } else {
                        x += addDeviceAttribute("होस्ट का नाम", EscapeHtml(node.host));
                    }
                }

                // Attribute: Description
                var description = node.desc ? EscapeHtml(node.desc) : '<i>' + "कोई नहीं" + '</i>';
                if ((meshrights & 4) != 0) {
                    x += addDeviceAttribute("विवरण", '<span onclick=showEditNodeValueDialog(2) style=cursor:pointer>' + description + '</span>');
                } else {
                    x += addDeviceAttribute("विवरण", description);
                }

                // IP-KVM information
                if (node.mtype == 4) {
                    if (node.portnum != null) { x += addDeviceAttribute("पोर्ट नंबर", node.portnum); }
                    if (node.porttype != null) { x += addDeviceAttribute("पोर्ट प्रकार", node.porttype); }
                }

                // Attribute: Mesh Agent
                if ((node.agent != null) && (node.agent.id != null) && (node.mtype == 3)) {
                    if (node.agent.id == 4) { x += addDeviceAttribute("उपकरण का प्रकार", "खिड़कियाँ"); }
                    if (node.agent.id == 6) { x += addDeviceAttribute("उपकरण का प्रकार", "लिनक्स"); }
                    if (node.agent.id == 29) { x += addDeviceAttribute("उपकरण का प्रकार", "मैकओएस"); }
                    ...
                    if ((node.agent.root === false) && ((node.conn & 1) != 0)) { str += ', ' + "वर्जित"; }
                    x += addDeviceAttribute("मेष एजेंट", str);
                }

                // Attribute: Intel AMT
                if (node.intelamt != null) {
                    var str = '';
                    var provisioningStates = { 0: nobreak("सक्रिय नहीं (पूर्व)"), 1: nobreak("सक्रिय नहीं (में)"), 2: nobreak("सक्रिय") };
                    if (node.intelamt.ver != null && node.intelamt.state == null) { str += '<i>' + nobreak("अज्ञात राज्य") + '</i>, v' + EscapeHtml(node.intelamt.ver); }
                    else if ((node.intelamt.ver == null) && (node.intelamt.state == 2)) { str += '<i>' + "सक्रिय" + '</i>'; }
                    else if ((node.intelamt.ver == null) || (node.intelamt.state == null)) { str += '<i>' + "अज्ञात संस्करण और राज्य" + '</i>'; }
                    else {
                        str += provisioningStates[node.intelamt.state];
                        if (node.intelamt.flags) { if (node.intelamt.flags & 2) { str = ' <span>' + "सीसीएम" + '</span>'; } else if (node.intelamt.flags & 4) { str = ' <span>' + "ACM" + '</span>'; } }
                        str += (', v' + EscapeHtml(node.intelamt.ver));
                    }

                    // If Intel AMT is activated, show additional options
                    if (node.intelamt.state == 2) {
                        if (node.intelamt.tls == 1) { str += ', <span title="' + "इंटेल एएमटी टीएलएस नेटवर्क सुरक्षा के साथ सेटअप है" + '">' + "टीएलएस" + '</span>'; }
                        ...
                        if (node.intelamt.user == null || node.intelamt.user == '') { // If credentials are not set, allow setting them.
                            if ((meshrights & 4) != 0) {
                                str += ', <i style=color:#FF0000;cursor:pointer title="' + "Intel&reg; AMT क्रेडेंशियल संपादित करें" + '" onclick=editDeviceAmtSettings("' + node._id + '")>' + "कोई साख नहीं" + '</i>';
                                editUserCredentialsIcon = true;
                            } else {
                                str += ', <i style=color:#FF0000>' + "कोई साख नहीं" + '</i>';
                            }
                            ...
                            var warn = null;
                            if ((node.intelamt.warn & 1) != 0) { warn = "अवैध प्रत्यय पत्र"; }
                            if ((node.intelamt.warn & 8) != 0) { warn = "साख की कोशिश कर रहा है"; }
                            if (warn != null) {
                                if ((meshrights & 4) != 0) {
                                    str += ', <i style=color:#FF0000;cursor:pointer title="' + "Intel&reg; AMT क्रेडेंशियल संपादित करें" + '" onclick=editDeviceAmtSettings("' + node._id + '")>' + warn + '</i>';
                                    editUserCredentialsIcon = true;
                                } else {
                        ...
                        if (editUserCredentialsIcon) {
                            str += '<img src=images/link4.png height=10 width=10 title="' + "Intel&reg; AMT क्रेडेंशियल संपादित करें" + '" style=cursor:pointer onclick=editDeviceAmtSettings("' + node._id + '")>';
                        }
                    }
                    ...
                    */
                    ...
                    if (typeof node.intelamt.sku == 'number') {
                        if ((node.intelamt.sku & 8) != 0) { meName = "इंटेल&reg; एएमटी"; }
                        else if ((node.intelamt.sku & 16) != 0) { meName = "इंटेल&reg; एस.एम."; }
                    }
                ...
                if ((node.agent != null) && (node.agent.tag != null) && (node.agent.tag != 'mailto:')) {
                    ...
                    x += addDeviceAttribute("एजेंट टैग", tag);
                }
                ...
                if (connectivity && connectivity > 1) {
                    var cstate = [];
                    if ((node.conn & 1) != 0) cstate.push('<span>' + ((node.mtype == 4) ? ((node.porttype == 'PDU') ? "स्विच" : "आईपी-केवीएम") : "एजेंट") + '</span>');
                    if ((node.conn & 2) != 0) cstate.push('<span>' + "इंटेल&reg; AMT CIRA" + '</span>');
                    else if ((node.conn & 4) != 0) cstate.push('<span>' + "इंटेल&reg; एएमटी" + '</span>');
                    if ((node.conn & 8) != 0) cstate.push('<span>' + "एजेंट रिले" + '</span>');
                    if ((node.conn & 16) != 0) cstate.push('<span>' + "MQTT" + '</span>');
                    x += addDeviceAttribute("कनेक्टिविटी", cstate.join(', '));
                }

                // Node tags
                var groupingTags = '<i>' + "कोई नहीं" + '</i>';
                if (node.tags != null) { groupingTags = ''; for (var i in node.tags) { groupingTags += '<span class=tagSpan>' + EscapeHtml(node.tags[i]) + '</span> '; } }
                if ((meshrights & 4) != 0) {
                    x += addDeviceAttribute("टैग", '<span onclick=showEditNodeValueDialog(3) style=cursor:pointer;color:black>' + groupingTags + '</span>');
                } else {
                    x += addDeviceAttribute("टैग", '<span style=line-height:26px;color:black>' + groupingTags + '</span>');
                }
                ...
                if ((node.ssh != null) || (node.rdp != null)) {
                    var y = [];
                    if ((meshrights & 4) != 0) {
                        if (node.ssh != null) { y.push('<span onclick=showClearSshDialog(3) style=cursor:pointer>' + ((node.ssh == 1) ? "एसएसएच-उपयोगकर्ता+पास" : ((node.ssh == 2) ? "SSH-उपयोगकर्ता+कुंजी+पास" : "SSH-उपयोगकर्ता+कुंजी")) + ' <img class=hoverButton src="images/link5.png" width=10 height=10 /></span>'); }
                        if (node.rdp != null) { y.push('<span onclick=showClearRdpDialog(3) style=cursor:pointer>' + "आरडीपी" + ' <img class=hoverButton src="images/link5.png" width=10 height=10 /></span>'); }
                    } else {
                        if (node.ssh != null) { y.push(((node.ssh == 1) ? "एसएसएच-उपयोगकर्ता+पास" : ((node.ssh == 2) ? "SSH-उपयोगकर्ता+कुंजी+पास" : "SSH-उपयोगकर्ता+कुंजी"))); }
                        if (node.rdp != null) { y.push("आरडीपी"); }
                    }
                    x += addDeviceAttribute("साख", y.join(', '));
                }

                x += '</table><br />';
                // Show action button, only show if we have permissions 4, 8, 64
                if (((meshrights & (4 + 8 + 64 + 262144)) != 0) && (node.mtype < 3)) { x += '<input type=button value="' + "क्रिया" + '" onclick=deviceActionFunction() />'; }
                x += '<input type=button value="' + "टिप्पणियाँ" + '" onclick=showNotes(' + ((meshrights & 128) == 0) + ',"' + encodeURIComponent(node._id) + '") />';
                ...
                if ((node.mtype == 4) && (connectivity & 1)) {
                    if (node.porttype == 'PDU') {
                        if (node.pwr == 1) {
                            if (meshrights & 0x40000) { x += '<input type=button value="' + "बंद करें" + '" title="' + "बंद करें" + '" onclick=setIpPduState(0) />'; }
                        } else if (node.pwr == 8) {
                            if (meshrights & 0x40) { x += '<input type=button value="' + "चालू करो" + '" title="' + "चालू करो" + '" onclick=setIpPduState(1) />'; }
                        }
                    } else {
                        if (meshrights & 8) { x += '<input type=button value="' + "रिमोट कंट्रोल" + '" title="' + "रिमोट कंट्रोल" + '" onclick=openIpKvmRemoteControl("' + encodeURIComponentEx(node._id) + '") />'; }x
                    }
                }
                ...
                if ((meshrights & 0x8000) != 0) { x += '<a style=cursor:pointer onclick=p10showDeleteNodeDialog("' + node._id + '")>' + "डिवाइस हटाएं" + '</a>'; }
                x += '</div><div style=font-size:x-small>';
                if (webRelayPort != 0) {
                    x += '<a onclick=p10WebRouter("' + node._id + '",1,' + (node.httpport ? node.httpport : 80) + ')>' + "एचटीटीपी" + ((node.httpport && (node.httpport != 80)) ? '/' + node.httpport : '') + '</a>&nbsp;';
                    x += '<a onclick=p10WebRouter("' + node._id + '",2,' + (node.httpsport ? node.httpsport : 443) + ')>' + "HTTPS के" + ((node.httpsport && (node.httpsport != 443)) ? '/' + node.httpsport : '') + '</a>&nbsp;';
                }

                // noVNC link
                if ((((connectivity & 1) != 0) || (node.mtype == 3)) && (node.agent) && ((meshrights & 8) != 0) && ((features & 0x20000000) == 0)) {
                    x += '<a id=rfbLink onclick=p10rfb("' + node._id + '")>' + "वेब-वीएनसी" + '</a>&nbsp;';
                }

                // MSTSC.js link
                if ((((connectivity & 1) != 0) || (node.mtype == 3)) && (node.agent) && ((meshrights & 8) != 0) && ((features & 0x40000000) == 0)) {
                    x += '<a id=mstscLink onclick=p10mstsc("' + node._id + '")>' + "वेब आरडीपी" + '</a>&nbsp;';
                }

                // SSH link
                if ((features2 & 0x200) && (((connectivity & 1) != 0) || (node.mtype == 3)) && (node.agent) && ((meshrights & 8) != 0)) {
                    x += '<a id=sshLink onclick=p10ssh("' + node._id + '")>' + "वेब-एसएसएच" + '</a>&nbsp;';
                }
                ...
                if ((connectivity & 1) != 0) { if (powerstate.length > 0) { powerstate += ', '; } powerstate += ((node.mtype == 4) ? ((node.porttype == 'PDU') ? "स्विच" : "आईपी-केवीएम") : "मेष एजेंट"); }
                if ((connectivity & 2) != 0) { if (powerstate.length > 0) { powerstate += ', '; } powerstate += "Intel&reg; AMT जुड़ा हुआ है"; }
                else if ((connectivity & 4) != 0) { if (powerstate.length > 0) { powerstate += ', '; } powerstate += "Intel&reg; AMT का पता चला"; }
                if ((connectivity & 16) != 0) { if (powerstate.length > 0) { powerstate += ', '; } powerstate += "MQTT चैनल जुड़ा"; }
        ...
        function setIpPduState(op) {
            if (op == 0) {
                setDialogMode(2, "पावर ऑपरेशन", 3, function () { meshserver.send({ action: 'poweraction', nodeids: [currentNode._id], actiontype: 2 }); }, "बिजली बंद करें?"); // Turn off
            } else {
                setDialogMode(2, "पावर ऑपरेशन", 3, function () { meshserver.send({ action: 'wakedevices', nodeids: [currentNode._id] }); }, "पावर चालू करें?"); // Turn on
            }
        }
        ...
        function deviceToastFunction() {
            if (xxdialogMode) return;
            setDialogMode(2, "डिवाइस टोस्ट", 3, deviceToastFunctionEx, '<textarea id=d2devToast style=width:100%;height:80px;resize:none;overflow-y:scroll></textarea>');
        }
        ...
        function setupDeviceMenu(op, obj) {
            ...
            var menus = [];
            if (currentDevicePanel != 0) { menus.push({ n: "सामान्य", f: 'setupDeviceMenu(0)' }); }
            ...
            ) { menus.push({ n: "डेस्कटॉप", f: 'setupDeviceMenu(1)' }); }
            ...
            ) { menus.push({ n: "टर्मिनल", f: 'setupDeviceMenu(5)' }); }

            if ((currentDevicePanel != 2) && (currentNode != null) && (meshrights & 8) && ((meshrights == 0xFFFFFFFF) || ((meshrights & 1024) == 0)) && ((currentNode.mtype != 1) && (currentNode.agent) && (currentNode.agent.caps & 4))) { menus.push({ n: "फ़ाइलें", f: 'setupDeviceMenu(2)' }); }
            if ((currentDevicePanel != 3) && (currentNode != null) && (currentNode.mtype < 3) && ((meshrights & 1048576) != 0)) { menus.push({ n: "विवरण", f: 'setupDeviceMenu(3)' }); }
            if ((currentDevicePanel != 4) && (currentNode != null) && (meshrights & 0x00000010) && (currentNode.mtype == 2)) { menus.push({ n: "कंसोल", f: 'setupDeviceMenu(4)' }); }
        ...
        function deviceActionFunction() {
            ...
            var x = "इस डिवाइस पर प्रदर्शन करने के लिए एक ऑपरेशन का चयन करें।" + '<br /><br />';
            ...
            if ((currentNode.agent != null) && (currentNode.agent.id == 14)) {
                if (((currentNode.conn & 1) != 0) && ((rights & 8) != 0)) {
                    count++;
                    y += '<option value=400>' + "Chamak" + '</option>';
                    y += '<option value=401>' + "कंपन" + '</option>';
                    z += '<div id=d2devicetimediv>' + addHtmlValue("समय", '<select id=d2devicetime style=float:right;width:170px><option value=1000>' + "1 सेकंड" + '</option><option value=5000>' + "5 सेकंड" + '</option><option value=10000>' + "दस पल" + '</option></select>') + '</div>';
                }
            } else {
                if ((rights & 64) != 0) { count++; y += '<option value=100>' + "उठो" + '</option>'; } // Wake-up permission
                //if (((currentNode.conn & 1) != 0) && ((rights & 131072) != 0)) { count++; y += '<option value=106>' + "Run Commands" + '</option>'; } // Remote command permission
                if ((currentNode.conn != 0) && ((rights & 262144) != 0)) { count++; y += '<option value=4>' + "नींद" + '</option><option value=3>' + "रीसेट" + '</option><option value=2>' + "बिजली बंद" + '</option>'; }
                ...
                if ((currentNode.intelamt != null) && (currentNode.intelamt.state == 2) && ((currentNode.conn & 6) != 0) && ((rights & 262144) != 0)) {
                    count++;
                    y += '<option value=310>' + "इंटेल&reg; एएमटी रीसेट" + '</option>';
                    y += '<option value=308>' + "इंटेल&reg; एएमटी पावर ऑफ" + '</option>';
                }
                if ((currentNode.intelamt != null) && (currentNode.intelamt.state == 2) && ((currentNode.conn & 6) != 0) && ((rights & 64) != 0)) {
                    count++;
                    y += '<option value=302>' + "इंटेल&reg; एएमटी पावर ऑन" + '</option>';
                }
            ...
            y += '</select>';
            x += addHtmlValue("ऑपरेशन", y);
            if (count == 0) { x = "वर्तमान में इस उपकरण के लिए कोई क्रिया उपलब्ध नहीं है।"; }
            setDialogMode(2, "डिवाइस एक्शन", (count == 0) ? 2 : 3, deviceActionFunctionEx, x + z);
        ...
        function deviceActionFunctionEx() {
            ...
            if (op == 100) {
                ...
                */
                ...
                setDialogMode(2, "इंटेल&reg; एएमटी पावर ऑपरेशन", 3, function () { meshserver.send({ action: 'poweraction', nodeids: [currentNode._id], actiontype: parseInt(op) }); }, "Intel&reg; AMT पावर चालू करें?");
            } else if (op == 308) { // Intel AMT power off
                setDialogMode(2, "इंटेल&reg; एएमटी पावर ऑपरेशन", 3, function () { meshserver.send({ action: 'poweraction', nodeids: [currentNode._id], actiontype: parseInt(op) }); }, "Perform Intel&reg; AMT power off?<br><br><b>NOTE: If there is an active AMT session, then power off command will be rejected, so you must disconnect from the AMT session first!</b>");
            } else if (op == 310) { // Intel AMT reset
                setDialogMode(2, "इंटेल&reg; एएमटी पावर ऑपरेशन", 3, function () { meshserver.send({ action: 'poweraction', nodeids: [currentNode._id], actiontype: parseInt(op) }); }, "Intel&reg; AMT रीसेट करें?");
        ...
        function showNotes(readonly, noteid) {
            ...
            if (noteid.startsWith('node%2F%2F')) { x += '<span style=font-size:10px>' + "डिवाइस समूह नोटों को अन्य डिवाइस ग्रुप एडमिनिस्ट्रेटर द्वारा देखा और बदला जा सकता है।" + '<span>'; }
            setDialogMode(2, "टिप्पणियाँ", 3, showNotesEx, x, noteid);
        ...
        function deviceLockFunction() {
            if ((xxdialogMode != null || xxdialogMode == 0) && (desktop != null) && (desktop.contype == 1)) { setDialogMode(2, "डेस्कटॉप लॉक करें", 3, function() { if ((desktop != null) && (desktop.contype == 1)) { desktop.sendCtrlMsg('{"ctrlChannel":"102938","type":"lock"}'); } }, "उपयोगकर्ता डेस्कटॉप लॉक करें?"); }
        }

        function deviceChat(e) {
            if (xxdialogMode) return;
            setDialogMode(2, "डिवाइस एक्शन", 3, function () {
            ...
            }, "चैट सत्र प्रारंभ करें?");
        }

        function deviceUrlFunction() {
            if (xxdialogMode) return;
            setDialogMode(2, "डिवाइस पर पेज खोलें", 3, deviceUrlFunctionEx, '<input id=d2devurl placeholder="http://server.com" style=width:100%;overflow-y:scroll onkeyup=deviceUrlFunctionValidate() onchange=deviceUrlFunctionValidate()></input>');
            Q('d2devurl').focus();
        ...
        function d2runCommandDialog(options) {
            ...
            if ((wintype == true) || (linuxtype == true) || (agenttype == true)) {
                ...
                if (wintype == true) { x += '<option value=1' + ((runopt.type == 1)?' selected':'') + '>' + "विंडोज कमांड प्रॉम्प्ट" + '</option><option value=2' + ((runopt.type == 2)?' selected':'') + '>' + "विंडोज पॉवरशेल" + '</option>'; }
                if (linuxtype == true) { x += '<option value=3' + ((runopt.type == 3)?' selected':'') + '>' + "Linux / BSD / macOS कमांड शेल" + '</option>'; }
                if (agenttype == true) { x += '<option value=4' + ((runopt.type == 4)?' selected':'') + '>' + "एजेंट कंसोल" + '</option>'; } // MESHRIGHT_REMOTECONTROL & MESHRIGHT_AGENTCONSOLE are needed
                x += '</select>';
                x += '<select id=d2cmduser style=width:100%;margin-bottom:4px><option value=0' + ((runopt.runAs == 0)?' selected':'') + '>' + "एजेंट के रूप में चलाएं" + '</option><option value=1' + ((runopt.runAs == 1)?' selected':'') + '>' + "यदि कोई उपयोगकर्ता नहीं, तो उपयोगकर्ता, एजेंट के रूप में चलाएँ" + '</option><option value=2' + ((runopt.runAs == 2)?' selected':'') + '>' + "उपयोगकर्ता के रूप में चलाना चाहिए" + '</option></select>';
                ...
                setDialogMode(2, "कमांड चलाएं", 3, d2groupActionFunctionRunCommands, x, options);
                if (options.selectedFile == null) {
                    Q('d2runcmd').focus();
        ...
        function editDeviceAmtSettings(nodeid, func) {
            ...
            x += addHtmlValue("उपयोगकर्ता नाम", '<input id=dp10username style=width:170px maxlength=32 autocomplete=nope placeholder="admin" onchange=validateDeviceAmtSettings() onkeyup=validateDeviceAmtSettings() />');
            x += addHtmlValue("कुंजिका", '<input id=dp10password type=password style=width:170px autocomplete=nope maxlength=32 onchange=validateDeviceAmtSettings() onkeyup=validateDeviceAmtSettings() />');
            // Only display the TLS setting if the Intel AMT manager is not running on the server. With the manager TLS is auto-detected.
            if ((features2 & 1) == 0) { x += addHtmlValue("सुरक्षा", '<select id=dp10tls style=width:176px><option value=0>' + "कोई टीएलएस सुरक्षा नहीं" + '</option><option value=1>' + "TLS सुरक्षा की आवश्यकता है" + '</option></select>'); }
            if ((node.intelamt.user != null) && (node.intelamt.user != '')) { buttons = 7; }
            setDialogMode(2, "Intel&reg; AMT क्रेडेंशियल संपादित करें", buttons, editDeviceAmtSettingsEx, x, { node: node, func: func });
        ...
        function p10showDeleteNodeDialog(nodeid) {
            if (xxdialogMode) return;
            setDialogMode(2, "नोड हटाएं", 3, p10showDeleteNodeDialogEx, format("{0} हटाएं?", EscapeHtml(currentNode.name)) + '<br /><br /><label><input id=p10check type=checkbox onchange=p10validateDeleteNodeDialog() />' + "पुष्टि करें" + '</label>', nodeid);
        ...
        function p10showiconselector() {
            ...
            setDialogMode(2, "आइकन चयन", 0, null, x);
        ...
        function showClearSshDialog() { setDialogMode(2, "उपकरण संपादित करें", 3, showClearSshDialogEx, "SSH क्रेडेंशियल साफ़ करें?"); }
        function showClearSshDialogEx(button, mode) { meshserver.send({ action: 'changedevice', nodeid: currentNode._id, ssh: 0 }); }
        function showClearRdpDialog() { setDialogMode(2, "उपकरण संपादित करें", 3, showClearRdpDialogEx, "RDP क्रेडेंशियल साफ़ करें?"); }
        function showClearRdpDialogEx(button, mode) { meshserver.send({ action: 'changedevice', nodeid: currentNode._id, rdp: 0 }); }

        var showEditNodeValueDialog_modes = ["यन्त्र का नाम", "होस्ट का नाम", "विवरण", "टैग"];
        var showEditNodeValueDialog_modes2 = ['name', 'host', 'desc', 'tags'];
        var showEditNodeValueDialog_modes3 = ['', '', '', "ग्रुप 1, ग्रुप 2, ग्रूव"];
        function showEditNodeValueDialog(mode) {
            ...
            setDialogMode(2, "उपकरण संपादित करें", 3, showEditNodeValueDialogEx, x, mode);
        ...
        var agentConsoleMessages = ['', "उपयोगकर्ता की पहुँच की प्रतीक्षा कर रहा है ...", "निषेध", "दूरस्थ टर्मिनल सत्र शुरू करने में विफल, {0} ({1})", "समय समाप्त", "अमान्य नेटवर्क डेटा प्राप्त किया"];
        ...
        function showDesktopSettings() {
            ...
            applyDesktopSettings();
            updateDesktopButtons();
            setDialogMode(7, "दूरस्थ डेस्कटॉप सेटिंग्स", 3, showDesktopSettingsChanged);
        }
        ...
        function updateDeskShortcutKeys() {
            var x = '<div class="menuButton" onclick="deskMenuButton(-1)">' + "अनुकूलित करें" + '</div>';
        ...
        var keyStrings = { 8: "बैकस्पेस", 9: "टैब", 13: "दर्ज", 27: "पलायन", 32: "Space", 44: "प्रिंट स्क्रीन", 45: "डालने", 46: "डेल", 36: "घर", 35: "समाप्त", 32: "Espace", 33: "पेज अप", 34: "पन्ना निचे", 37: "बाएं", 38: "यूपी", 39: "सही", 40: "नीचे", 0: "कोई नहीं" }

        function keyShortcutTotext(n) {
            var x = [];
            if (n & 0x010000) { x.push("खिसक जाना"); }
            if (n & 0x020000) { x.push("Alt"); }
            if (n & 0x080000) { x.push("Ctrl"); }
            if (n & 0x100000) { x.push("जीत"); }
            n = (n & 0xFFFF);
        ...
        function deskCustomizeKeys() {
            ...
            x += '<label><input id=d1kshift type=checkbox /> ' + "खिसक जाना" + '</label><label> <input id=d1kalt type=checkbox /> ' + "Alt" + '</label><label> <input id=d1kctrl type=checkbox /> ' + "Ctrl" + '</label> <input id=d1kwin type=checkbox /> ' + "जीत" + '</label>';
            ...
            x += '</select> <input type=button value=' + "जोड़ना" + ' onclick=addDeskCustomizeKey() /></div>';
            QH('p10dialog2', x);
            xxdialogMode = 2;
            QV('p10dialog', true);
        ...
        function deskUpdateShortcutList() {
            ...
            if (x == '') { x = '<i>' + "कोई कीबोर्ड शॉर्टकट परिभाषित नहीं है" + '</i>'; }
            QH('d2shortcuts', x);
        }
        ...
        function sendSpecialKeys() {
            if (xxdialogMode || desktop == null || desktop.State != 3) return;
            setDialogMode(3, "विशेष कुंजी", 3, deskSendKeys);
        }
        ...
        function deskSelectScreens() {
            ...
            x = addHtmlValue4("स्क्रीन", '<select style=width:100% id=deskdisplays>' + x + '</select>');
            setDialogMode(2, "स्क्रीन का चयन", 3, deskSelectScreensEx, x);
        }
        ...
        function updateTerminalButtons() {
            ...
            if (((termState == true) && (terminal.contype != 3)) || (terminalNode.agent == null) || (terminalNode.agent.id == 3) || (terminalNode.agent.id == 4)) {
                ...
                QH('terminalCustomUpperRight', '<a style=cursor:pointer onclick=cmsshportaction(1,event)>' + format("एसएसएच पोर्ट {0}", (terminalNode.sshport ? terminalNode.sshport : 22)) + '</a>');
            }
        }

        function cmsshportaction(action) {
            if (xxdialogMode) return;
            var x = "SSH रिमोट कनेक्शन पोर्ट:" + '<br /><br /><input type=text placeholder="22" inputmode="numeric" pattern="[0-9]*" onkeypress="return (event.keyCode == 8) || (event.charCode >= 48 && event.charCode <= 57)" maxlength=5 id=d10sshport type=text>';
            setDialogMode(2, "एसएसएच कनेक्शन", 3, function () {
        ...
        function sshTunnelAuthDialog(j, func) {
            var x = '';
            if (j.askkeypass) {
                x += addHtmlValue("प्रमाणीकरण", '<select id=dp2authmethod style=width:150px onchange=sshAuthUpdate(event)><option value=3 selected>' + "संग्रहीत कुंजी" + '</option><option value=1>' + "प्रयोक्ता नाम पासवर्ड" + '</option><option value=2>' + "उपयोगकर्ता नाम और कुंजी" + '</option></select>');
            } else {
                x += addHtmlValue("प्रमाणीकरण", '<select id=dp2authmethod style=width:150px onchange=sshAuthUpdate(event)><option value=1 selected>' + "प्रयोक्ता नाम पासवर्ड" + '</option><option value=2>' + "उपयोगकर्ता नाम और कुंजी" + '</option></select>');
            }
            x += '<div id=d2userauth style=display:none>';
            x += addHtmlValue("उपयोगकर्ता नाम", '<input id=dp2user style=width:150px maxlength=64 autocomplete=off onkeyup=sshAuthUpdate(event) />');
            x += '</div>';
            x += '<div id=d2passauth style=display:none>';
            x += addHtmlValue("कुंजिका", '<input type=password id=dp2pass style=width:150px maxlength=64 autocomplete=off onkeyup=sshAuthUpdate(event) />');
            if ((features2 & 0x00400000) == 0) { x += '<label><input id=dp2keep type=checkbox>' + "क्रेडेंशियल याद रखें" + '</label>'; }
            x += '</div><div id=d2keyauth style=display:none>';
            x += addHtmlValue("कुंजी फ़ाइल", '<input type=file id=dp2key style=width:150px maxlength=64 autocomplete=off onchange=sshAuthUpdate(event) />' + '<div id=d2badkey style=font-size:x-small>' + "कुंजी फ़ाइल ओपनएसएसएच प्रारूप में होनी चाहिए।" + '</div>');
            x += addHtmlValue("कुंजी पासवर्ड", '<input type=password id=dp2keypass style=width:150px maxlength=64 autocomplete=off onkeyup=sshAuthUpdate(event) />');
            if ((features2 & 0x00400000) == 0) {
                x += '<label><input id=dp2keep1 type=checkbox onchange=sshAuthUpdate(event)>' + "उपयोगकर्ता और कुंजी याद रखें" + '</label><br/>';
                x += '<label><input id=dp2keep2 type=checkbox>' + "पासवर्ड याद" + '</label>';
            }
            x += '</div>';
            if (j.askkeypass) {
                x += '<div id=d2keyauth2 style=display:none>';
                x += addHtmlValue("कुंजिका", '<input type=password id=dp2keypass2 style=width:150px maxlength=64 autocomplete=off onkeyup=sshAuthUpdate(event) />');
                x += '</div>';
            }
            setDialogMode(2, "प्रमाणीकरण", 11, func, x, 'ssh');
            Q('dp2user').focus();
            sshAuthUpdate();
            ...
            if (typeof data == 'string') {
                if (data[0] == '{') {
                    ...
                    switch (j.action) {
                        ...
                        case 'autherror': { p12setConsoleMsg("प्रमाणीकरण त्रुटि", 5000); break; }
                        case 'sessionerror': { p12setConsoleMsg("सत्र समाप्त हुआ", 5000); break; }
                        case 'sessiontimeout': { p12setConsoleMsg("सत्र मध्यांतर", 5000); break; }
                    }
                } else if (data[0] == '~') {
        ...
        */
        ...
        function onFilesStateChange(xfiles, state) {
            ...
            if (state == 3) {
                if (files.contype == 2) { str += ", एसएफटीपी"; }
        ...
        function p13gotFiles(data) {
            ...
            switch (data.action) {
                ...
                case 'autherror': { p13setConsoleMsg("प्रमाणीकरण त्रुटि", 5000); return; }
                case 'connectionerror': { p13setConsoleMsg("संपर्क त्रुटि", 5000); return; }
                case 'sessionerror': { p13setConsoleMsg("सत्र समाप्त हुआ", 5000); return; }
                case 'sessiontimeout': { p13setConsoleMsg("सत्र मध्यांतर", 5000); return; }
            }
        ...
        function p13updateFiles(checkedNames) {
            var html1 = '', html2 = '', displayPath = '<a style=cursor:pointer;color:black onclick=p13folderup(0)>' + "जड़" + '</a>', fullPath = 'Root';
        ...
        function p13setActions() {
            ...
            if (p13filetree == null) {
                ...
                Q('p13SelectAllButton').value = (cc > 0 ? "कोई नहीं" : "सब");
            ...
            if (((filesState == true) && (files.contype != 2)) || (filesNode.agent == null) || (filesNode.agent.id == 3) || (filesNode.agent.id == 4)) {
                ...
                QH('filesCustomUpperRight', '<a style=cursor:pointer onclick=cmsshportaction(1,event)>' + format("एसएसएच पोर्ट {0}", (filesNode.sshport ? filesNode.sshport : 22)) + '</a>');
            }
        ...
        function p13createfolder() { setDialogMode(2, "नया फोल्डर", 3, p13createfolderEx, '<input type=text id=p13renameinput maxlength=64 onkeyup=p13fileNameCheck(event) style=width:100% />'); focusTextBox('p13renameinput'); p13fileNameCheck(); }
        ...
        function p13deletefile() { var cc = p13getFileSelCount(), rec = (p13getFileSelDirCount() > 0) ? '<br /><br /><label><input type=checkbox id=p13recdeleteinput>' + "रिकर्सिव डिलीट" + '</label><br>' : '<input type=checkbox id=p13recdeleteinput style=\'display:none\'>'; setDialogMode(2, "हटाएं", 3, p13deletefileEx, (cc > 1) ? (format("{0} चयनित आइटम हटाएं?", cc) + rec) : ("चयनित आइटम हटाएं?" + rec)); }
        ...
        function p13renamefile() { var renamefile, checkboxes = document.getElementsByName('fd'); for (var i = 0; i < checkboxes.length; i++) { if (checkboxes[i].checked) { renamefile = p13filetree.dir[checkboxes[i].value].n; } } setDialogMode(2, "नाम बदलें", 3, p13renamefileEx, '<input type=text id=p13renameinput maxlength=64 onkeyup=p13fileNameCheck(event) style=width:100% value="' + renamefile + '" />', { action: 'rename', path: p13filetreelocation.join('/'), oldname: renamefile }); focusTextBox('p13renameinput'); p13fileNameCheck(); }
        ...
        function p13uploadFile() { setDialogMode(2, "दस्तावेज अपलोड करें", 3, p13uploadFileEx, '<input type=file name=files id=p13uploadinput style=width:100% multiple=multiple onchange="updateUploadDialogOk(\'p13uploadinput\')" />'); updateUploadDialogOk('p13uploadinput'); }
        ...
        function p13viewfile() {
            ...
            for (var i = 0; i < checkboxes.length; i++) {
                if (checkboxes[i].checked) {
                    ...
                    } else { messagebox("फ़ाइल संपादक", "केवल 200k से कम फ़ाइलों को ही संपादित किया जा सकता है।"); }
                    break;
                }
            }
        }
        ...
        function p13pasteFile() {
            ...
            if ((p13clipboard != null) && (p13clipboard.length > 0)) {
                if (p13clipboardCut == 0) {
                    if (p13clipboard.length > 1) { x = format("इस स्थान पर {0} प्रविष्टियों की प्रतिलिपि की पुष्टि करें?", p13clipboard.length); } else { x = format("इस स्थान पर 1 एन्ट्री की प्रतिलिपि की पुष्टि करें?"); }
                } else {
                    if (p13clipboard.length > 1) { x = format("इस स्थान पर {0} प्रविष्टियों की चाल की पुष्टि करें?", p13clipboard.length); } else { x = format("इस स्थान पर 1 एंट्री की पुष्टि करें?"); }
                }
            }
            setDialogMode(2, "पेस्ट करें", 3, p13pasteFileEx, x);
        }
            ...
            if ((p13clipboard != null) && (p13clipboard.length > 0)) {
                if (p13clipboardCut == 0) {
                    if (p13clipboard.length > 1) {
                        x = format("कॉपी के लिए {0} प्रविष्टियाँ रखना" + ', <a href=# onclick="return p13clearClip()" style=cursor:pointer>' + "स्पष्ट" + '</a>.', p13clipboard.length);
                    } else {
                        x = format("नकल के लिए 1 एंट्री पकड़ना" + ', <a href=# onclick="return p13clearClip()" style=cursor:pointer>' + "स्पष्ट" + '</a>.');
                    }
                } else {
                    if (p13clipboard.length > 1) {
                        x = format("चाल के लिए {0} प्रविष्टियाँ रखना" + ', <a href=# onclick="return p13clearClip()" style=cursor:pointer>' + "स्पष्ट" + '</a>.', p13clipboard.length);
                    } else {
                        x = format("मूव के लिए 1 एंट्री पकड़ना" + ', <a href=# onclick="return p13clearClip()" style=cursor:pointer>' + "स्पष्ट" + '</a>.');
                    }
                }
            }
        ...
        function p13downloadfile(x, y, z) {
            ...
            setDialogMode(2, "फ़ाइल डाउनलोड करें", 10, p13downloadFileCancel, '<div>' + EscapeHtml(downloadFile.file) + '</div><br /><progress id=d2progressBar style=width:100% value=0 max=' + z + ' />');
        }
        ...
        */
        ...
        function p13doUploadFiles(files) {
            ...
            if (overWriteCount == 0) {
                ...
                setDialogMode(2, "दस्तावेज अपलोड करें", 3, p13uploadFileContinue, format((overWriteCount == 1) ? "अपलोड 1 फ़ाइल को अधिलेखित कर देगा। जारी रखें?" : "अपलोड {0} फ़ाइलों को अधिलेखित कर देगा। जारी रखें?", overWriteCount), files);
            }
        }
        ...
        function p13uploadFileContinue(b, files) {
            ...
            setDialogMode(2, "दस्तावेज अपलोड करें", 10, p13uploadFileCancel, '<div id=p13dfileName>' + "कनेक्ट ..." + '</div><br /><progress id=d2progressBar style=width:100% value=0 max=0 />');
            p13uploadNextFile();
        }
        ...
        function updateDeviceDetails(node, hardware, network) {
            ...
            // Operating System
            var x = '';
            if (node.rname) { x += addDetailItem("नाम", EscapeHtml(node.rname), s); }
            if (hardware.windows && hardware.windows.osinfo && hardware.windows.osinfo.Description) { x += addDetailItem("विवरण", EscapeHtml(hardware.windows.osinfo.Description), s); }
            if (node.osdesc) { x += addDetailItem("संस्करण", EscapeHtml(node.osdesc), s); }
            if (hardware.windows && hardware.windows.osinfo) {
                var m = hardware.windows.osinfo;
                if (m.OSArchitecture) {
                    if (m.OSArchitecture.startsWith('32')) { x += addDetailItem("आर्किटेक्चर", "32-बिट", s); }
                    else if (m.OSArchitecture.startsWith('64')) { x += addDetailItem("आर्किटेक्चर", "64-बिट", s); }
                    else { x += addDetailItem("आर्किटेक्चर", EscapeHtml(m.OSArchitecture), s); }
                }
                if(m.LastBootUpTime){
                    var thedate = {
                ...
                if(m.Domain){ x += addDetailItem((m.PartOfDomain ? "डोमेन" : "वर्कग्रुप"), EscapeHtml(m.Domain), s); }
            }
            ...
            if (node.wsc) {
                var y = [];
                if (node.wsc.antiVirus != null) { if (node.wsc.antiVirus == 'OK') { y.push("ए वी" + ' - <span style=color:green>' + "ठीक" + '</span>'); } else { y.push("ए वी" + ' - <span style=color:red>' + "खराब" + '</span>'); } }
                if (node.wsc.autoUpdate != null) { if (node.wsc.autoUpdate == 'OK') { y.push("अपडेट करें" + ' - <span style=color:green>' + "ठीक" + '</span>'); } else { y.push("अपडेट करें" + ' - <span style=color:red>' + "खराब" + '</span>'); } }
                if (node.wsc.firewall != null) { if (node.wsc.firewall == 'OK') { y.push("फ़ायरवॉल" + ' - <span style=color:green>' + "ठीक" + '</span>'); } else { y.push("फ़ायरवॉल" + ' - <span style=color:red>' + "खराब" + '</span>'); } }
                x += addDetailItem("विंडोज सुरक्षा", y.join(', '));
            }

            // Defender for Windows Server
            if(node.defender) {
                var y = [];
                if (node.defender.RealTimeProtection != null) { if (node.defender.RealTimeProtection == true) { y.push("RealTimeProtection" + ' - <span style=color:green>' + "On" + '</span>'); } else { y.push("RealTimeProtection" + ' - <span style=color:red>' + "बंद" + '</span>'); } }
                if (node.defender.TamperProtected != null) { if (node.defender.TamperProtected == true) { y.push("TamperProtection" + ' - <span style=color:green>' + "On" + '</span>'); } else { y.push("TamperProtection" + ' - <span style=color:red>' + "बंद" + '</span>'); } }
                if (node.defender.AntivirusSignatureVersion != null) { y.push("सिग्नेचर संस्करण" + ' - <span style=color:green>' + EscapeHtml(node.defender.AntivirusSignatureVersion) + '</span>'); }
            ...
            if (node.av && node.av.length > 0) {
                ...
                for (var i in node.av) {
                    if (node.av[i].product) {
                        ...
                        if (node.av[i].enabled !== true) { avx += ' - <span style=color:red>' + "विकलांग" + '</span>'; }
                        if (node.av[i].updated !== true) { avx += ' - <span style=color:red>' + "तारीख से बहार" + '</span>'; }
                        if ((node.av[i].enabled == true) && (node.av[i].updated == true)) { avx += ' - <span style=color:green>' + "ठीक" + '</span>'; }
                        y.push(avx);
                    }
                }
                x += addDetailItem("एंटीवायरस", y.join('<br />'));
            }

            // Active Users
           if (node.users && node.users.length > 0) {
                var u = node.users.map(function(user) {
                    return addKeyLinkConditional(EscapeHtml(user), "बंद", (node.lusers && node.lusers.indexOf(user) >= 0));
                }).join(', ');
                x += addDetailItem((node.users.length > 1 ? "सक्रिय उपयोगकर्ता" : "सक्रिय उपयोगकर्ता"), u);
            }

            if (x != '') { sections.push({ name: "ऑपरेटिंग सिस्टम", html: x, img: 'software' }); }
            ...
            if (node.agent) {
                ...
                if ((node.agent != null) && (node.agent.id != null) && (node.agent.ver != null)) {
                    ...
                    if (node.agent.ver != 0) { str += ' v' + node.agent.ver; }
                    if (node.agent.id == 14) { str = node.agent.core; }
                    x += addDetailItem("मेष एजेंट", str);
                }
                if (node.firstconnect) { x += addDetailItem("पहला एजेंट कनेक्शन", printDateTime(new Date(node.firstconnect))); }
                if ((node.conn & 1) != 0) {
                    x += addDetailItem("अंतिम एजेंट कनेक्शन", "अभी जुड़े हुए हैं");
                } else {
                    if (node.lastconnect) { x += addDetailItem("अंतिम एजेंट कनेक्शन", printDateTime(new Date(node.lastconnect))); }
                }
                if (node.lastaddr) {
                    var splitip = node.lastaddr.split(':');
                    if (splitip.length > 2) {
                        // IPv6
                        x += addDetailItem("अंतिम एजेंट का पता", node.lastaddr);
                    } else {
                        // IPv4
                        if (isPrivateIP(node.lastaddr)) {
                            x += addDetailItem("अंतिम एजेंट का पता", splitip[0]);
                        } else {
                            x += addDetailItem("अंतिम एजेंट का पता", '<a href="https://iplocation.com/?ip=' + splitip[0] + '" rel="noreferrer noopener" target="MeshIPLoopup">' + splitip[0] + '</a>');
                        }
                    }
                }
                if (hardware.agentvers != null) {
                    if (hardware.agentvers.compileTime) {
                        try {
                            ...
                            x += addDetailItem("संकलन समय", printDateTime(new Date(d)));
                        } catch (ex) { }
                    }
                }
                if (hardware.time != null) {
                    x += addDetailItem("अंतिम विवरण अद्यतन", printDateTime(new Date(hardware.time)));
                }
                if (x != '') { sections.push({ name: "मेष एजेंट", html: x, img: 'meshagent' }); }
            }

            // Mobile
            if (hardware.mobile) {
                var x = '';
                if (hardware.mobile.brand && hardware.mobile.model) { x += addDetailItem("नमूना", EscapeHtml(hardware.mobile.brand + ', ' + hardware.mobile.model), s); }
                if (hardware.mobile.device) { x += addDetailItem("युक्ति", EscapeHtml(hardware.mobile.device), s); }
                if (hardware.mobile.bootloader) { x += addDetailItem("बूटलोडर", EscapeHtml(hardware.mobile.bootloader), s); }
                if (hardware.mobile.id) { x += addDetailItem("पहचानकर्ता", EscapeHtml(hardware.mobile.id), s); }
                if (hardware.mobile.host) { x += addDetailItem("होस्ट का नाम", EscapeHtml(hardware.mobile.host), s); }
                ...
                if (x != '') { sections.push({ name: "मोबाइल डिवाइस", html: x, img: 'mobile' }); }
            }
            ...
            if (network.netif2 != null) {
                ...
                for (var i in network.netif2) {
                    ...
                    if (m.desc) { x += addDetailItem("विवरण", EscapeHtml(m.desc).split('(R)').join('&reg;')); }
                    //if (m.dnssuffix) { x += addDetailItem("DNS Suffix", m.dnssuffix); }
                    if (typeof m[0].mac == 'string') {
                        if (m[0].gatewaymac) {
                            x += addDetailItem("मैक परत", format("मैक: {0}, गेटवे: {1}", EscapeHtml(m[0].mac), EscapeHtml(m[0].gatewaymac)));
                        } else {
                            x += addDetailItem("मैक परत", format("मैक: {0}", EscapeHtml(m[0].mac)));
                        }
                    }
                    if (typeof m[0].speed == 'number' && (m[0].speed != 9223372036854775807 && m[0].speed > 0)) {
                        x += addDetailItem("इंटरफ़ेस गति", format("{0}", getNetworkSpeed(m[0].speed)));
                    }
                    for (var j = 0; j < m.length; j++) {
                        var iplayer = m[j], items = [];
                        if (iplayer.address) { items.push(format("आईपी: {0}", EscapeHtml(iplayer.address))); }
                        if (iplayer.netmask) { items.push(format("मुखौटा: {0}", EscapeHtml(iplayer.netmask))); }
                        if (iplayer.gateway) { items.push(format("गेटवे: {0}", EscapeHtml(iplayer.gateway))); }
                        if (items.length > 0) {
                            if (iplayer.family == 'IPv4') { x += addDetailItem("IPv4 लेयर", items.join(", ")); }
                            if (iplayer.family == 'IPv6') { x += addDetailItem("IPv6 लेयर", items.join(", ")); }
                        }
                    }
                    x += '</div></td></tr>';
                }
                ...
                x += '</table>';
                if (x != '') { sections.push({ name: "नेटवर्किंग", html: x, img: 'networking' }); }
            }

            // Attribute: Intel AMT
            if (node.intelamt != null) {
                var x = '';
                x += addDetailItem("संस्करण", (node.intelamt.ver) ? ('v' + EscapeHtml(node.intelamt.ver)) : ('<i>' + "अनजान" + '</i>'), s);
                x += addDetailItem("पहचानकर्ता", (node.intelamt.uuid) ? (EscapeHtml(node.intelamt.uuid)) : ('<i>' + "अनजान" + '</i>'), s);
                var provisioningStates = { 0: nobreak("सक्रिय नहीं (पूर्व)"), 1: nobreak("सक्रिय नहीं (में)"), 2: nobreak("सक्रिय") };
                var provisioningMode = '';
                if ((node.intelamt.state == 2) && node.intelamt.flags) { if (node.intelamt.flags & 2) { provisioningMode = (', ' + "ग्राहक नियंत्रण मोड (CCM)"); } else if (node.intelamt.flags & 4) { provisioningMode = (', ' + "व्यवस्थापक नियंत्रण मोड (ACM)"); } }
                x += addDetailItem("प्रावधान राज्य", ((node.intelamt.state) ? (provisioningStates[node.intelamt.state]) : ('<i>' + "अनजान" + '</i>')) + provisioningMode, s);
                x += addDetailItem("सुरक्षा", (node.intelamt.tls == 1) ? "TLS का उपयोग करके सुरक्षित" : "टीएलएस सेटअप नहीं है", s);
                // Check that the Intel AMT user is setup and there is no warnings (1 = invalid credentials, 8 = trying)
                x += addDetailItem("व्यवस्थापक क्रेडेंशियल", ((node.intelamt.user) == null || (node.intelamt.user == '') || ((node.intelamt.warn != null) && ((node.intelamt.warn & 9) != 0))) ? "ज्ञात नहीं है" : "मालूम", s);
                if (x != '') {
                    if ((typeof node.intelamt.sku == 'number') && ((node.intelamt.sku & 16) != 0)) {
                        sections.push({ name: "Intel&reg; मानक प्रबंधनीयता (Intel&reg; SM)", html: x, img: 'amt' });
                    } else {
                        sections.push({ name: "Intel&reg; सक्रिय प्रबंधन प्रौद्योगिकी (Intel&reg; AMT)", html: x, img: 'amt' });
                    }
                }
            }
            ...
            if (hardware.identifiers) {
                ...
                // BIOS
                if (ident.bios_vendor) { x += addDetailItem("विक्रेता", EscapeHtml(ident.bios_vendor), s); }
                if (ident.bios_version) { x += addDetailItem("संस्करण", EscapeHtml(ident.bios_version), s); }
                if (ident.bios_serial) { x += addDetailItem("धारावाहिक", EscapeHtml(ident.bios_serial), s); }
                if (ident.bios_mode) { x += addDetailItem("Mode", EscapeHtml(ident.bios_mode), s); }
                if (x != '') { sections.push({ name: "BIOS", html: x, img: 'chip' }); }

                // Motherboard
                x = '';
                if (ident.board_vendor) { x += addDetailItem("विक्रेता", EscapeHtml(ident.board_vendor), s); }
                if (ident.board_name) { x += addDetailItem("नाम", EscapeHtml(ident.board_name), s); }
                if (ident.board_serial && (ident.board_serial != '')) { x += addDetailItem("धारावाहिक", EscapeHtml(ident.board_serial), s); }
                if (ident.board_version) { x += addDetailItem("संस्करण", EscapeHtml(ident.board_version), s); }
                if (ident.product_uuid) { x += addDetailItem("पहचानकर्ता", EscapeHtml(ident.product_uuid), s); }
                if (ident.cpu_name) { x += addDetailItem("सी पी यू", EscapeHtml(ident.cpu_name).split('(TM)').join('&trade;').split('(R)').join('&reg;'), s); }
                ...
                if (x != '') { sections.push({ name: "मदरबोर्ड", html: x, img: 'motherboard' }); }
            }
            ...
            if (hardware.tpm) {
                ...
                if (tpm.ManufacturerId) { x += addDetailItem("पहचानकर्ता", EscapeHtml(tpm.ManufacturerId), s); }
                if (tpm.ManufacturerVersion) { x += addDetailItem("संस्करण", EscapeHtml(tpm.ManufacturerVersion), s); }
                if (tpm.IsActivated != null) { x += addDetailItem("सक्रिय", (tpm.IsActivated ? "Yes" : "No"), s); }
                if (tpm.IsEnabled != null) { x += addDetailItem("सक्रिय", (tpm.IsEnabled ? "Yes" : "No"), s); }
                if (tpm.IsOwned != null) { x += addDetailItem("स्वामित्व", (tpm.IsOwned ? "Yes" : "No"), s); }
            ...
            if (hardware.battery) {
                ...
                for (var i in hardware.battery) {
                    ...
                    x += '<tr><td><div class=style10 style=border-radius:5px;padding:8px>';
                    x += '<div style=margin-bottom:3px><b>' + EscapeHtml(battery.DeviceName ? battery.DeviceName : "अनजान") + '</b></div>';
                    if (battery.CycleCount) { x += addDetailItem("चक्र गणना", EscapeHtml(battery.CycleCount), s); }
                    if (battery.FullChargedCapacity) { x += addDetailItem("पूर्ण चार्ज क्षमता", format("{0} mWh", battery.FullChargedCapacity), s); }
                    if (battery.EstimatedRuntime) { x += addDetailItem("अनुमानित रनटाइम", format("{0} मिनट", Math.floor((battery.EstimatedRuntime / 60))), s); }
                    if (battery.Chemistry) { x += addDetailItem("रसायन विज्ञान", EscapeHtml(battery.Chemistry), s); }
                    if (battery.DesignedCapacity) { x += addDetailItem("डिज़ाइन क्षमता", format("{0} mWh", battery.DesignedCapacity), s); }
                    if (battery.ManufactureDate) { x += addDetailItem("निर्माण दिनांक", EscapeHtml(battery.ManufactureDate), s); }
                    if (battery.ManufactureName) { x += addDetailItem("निर्माण का नाम", EscapeHtml(battery.ManufactureName), s); }
                    if (battery.SerialNumber) { x += addDetailItem("क्रम संख्या", EscapeHtml(battery.SerialNumber), s); }
                    if (battery.ChargeRate) { x += addDetailItem("शुल्क दर", format("{0} mW", battery.ChargeRate), s); }
                    if (battery.Charging != null) { x += addDetailItem("चार्ज", (battery.Charging ? "Yes" : "No"), s); }
                    if (battery.DischargeRate) { x += addDetailItem("डिस्चार्ज दर", format("{0} mW", battery.DischargeRate), s); }
                    if (battery.Discharging != null) { x += addDetailItem("निर्वहन", (battery.Discharging ? "Yes" : "No"), s); }
                    if (battery.RemainingCapacity) { x += addDetailItem("शेष क्षमता", format("{0} mWh", battery.RemainingCapacity), s); }
                    if (battery.Voltage) { x += addDetailItem("वोल्टेज", format("{0} V", (battery.Voltage / 1000)), s); }
                    if (battery.Health) { x += addDetailItem("स्वास्थ्य", format("{0} %", battery.Health), s); }
                    if (battery.BatteryCharge) { x += addDetailItem("बैटरी चार्ज", format("{0} %", battery.BatteryCharge), s); }   
                    x += '</div>';
                }
                x += '</table>';
                if (x != '') { sections.push({ name: "बैटरी", html: x, img: 'battery'}); }
            }
            ...
            if (hardware.windows) {
                if (hardware.windows.memory && (hardware.windows.memory.length > 0)) {
                    ...
                    for (var i in hardware.windows.memory) {
                        ...
                        if (m.Capacity && m.Speed) { x += addDetailItem("क्षमता / गति", format("{0} एमबी, {1} Mhz", (m.Capacity / 1024 / 1024), m.Speed), s); }
                        else if (m.Capacity) { x += addDetailItem("क्षमता", format("{0} एमबी", (m.Capacity / 1024 / 1024)), s); }
                        if (m.PartNumber) { x += addDetailItem("भाग संख्या", EscapeHtml((m.Manufacturer && m.Manufacturer != 'Undefined') ? (m.Manufacturer + ', ') : '') + EscapeHtml(m.PartNumber), s); }
                        x += '</div>';
                    }
                    x += '</table>';

                    if (x != '') { sections.push({ name: "स्मृति", html: x, img: 'ram' }); }
                }
            }
            ...
            if (hardware.linux) {
                if (hardware.linux.memory && (hardware.linux.memory.Memory_Device.length > 0)) {
                    ...
                    for (var i in hardware.linux.memory.Memory_Device) {
                        ...
                        if (m.Size && m.Speed) { x += addDetailItem("क्षमता / गति", format("{0}, {1}", m.Size, m.Speed), s); }
                        else if (m.Size) { x += addDetailItem("क्षमता", format("{0}", (m.Size)), s); }
                        if (m.PartNumber) { x += addDetailItem("भाग संख्या", EscapeHtml((m.Manufacturer && m.Manufacturer != 'Undefined')?(m.Manufacturer + ', '):'') + EscapeHtml(m.PartNumber), s); }
                        x += '</div>';
                    }
                    x += '</table>';
            ...
            if (hardware.darwin) {
                if (hardware.darwin.memory && (hardware.darwin.memory.length > 0)) {
                    ...
                    for (var i in hardware.darwin.memory) {
                        ...
                        if (m.PartNumber) { x += addDetailItem("भाग संख्या", EscapeHtml((m.Manufacturer && m.Manufacturer != '')?(m.Manufacturer + ', '):'') + EscapeHtml(m.PartNumber), s); }
                        x += '</div>';
                    }
                    x += '</table>';
                    if (x != '') { sections.push({ name: "स्मृति", html: x, img: 'ram'}); }
            ...
            if (hardware.identifiers && ident.storage_devices) {
                ...
                for (var i in ident.storage_devices) {
                    ...
                    if (m.Size) {
                        ...
                        if (m.Model && (m.Model != m.Caption)) { x += addDetailItem("नमूना", EscapeHtml(m.Model), s); }
                        if (m.Size) {
                            if ((typeof m.Size == 'string') && (parseInt(m.Size) == m.Size)) { m.Size = parseInt(m.Size); }
                            if (typeof m.Size == 'number') { x += addDetailItem("क्षमता", format("{0} एमबी", Math.floor(m.Size / 1024 / 1024)), s); }
                            if (typeof m.Size == 'string') { x += addDetailItem("क्षमता", EscapeHtml(m.Size), s); }
                        }
                        if(hardware.windows && hardware.windows.drives && m.Model){
                            const foundObject = hardware.windows.drives.find(obj => obj['Model'] === m.Model);
                            if(foundObject) x += addDetailItem("स्थिति", EscapeHtml(foundObject.Status), s);
                        }
                        x += '</div>';
                    }
                }
                ...
                if (x != '') { sections.push({ name: "भंडारण", html: x, img: 'storage' }); }
            }
            ...
            if (hardware.windows && hardware.windows.volumes) {
                ...
                for (var i in hardware.windows.volumes) {
                    ...
                    if (m.size) {
                        ...
                        x += addDetailItem("क्षमता", EscapeHtml(fsize), s);
                    }
                    if (m.sizeremaining) {
                        var sizes = ['Bytes', 'KB', 'MB', 'GB', 'TB'];
                        ...
                        x += addDetailItem("क्षमता शेष", EscapeHtml(fsize), s);
                    }
                    if (m.type) {
                        var type = (m.removable == true ? "Removable" : (m.cdrom == true ? "CD-ROM" : ''));
                        x += addDetailItem("File System", (type != '' ? (type + ' / ') : '') + (m.type == 'Unknown' ? "अनजान" : EscapeHtml(m.type)), s);
                    }

                    if (m.protectionStatus || m.volumeStatus) {
                        var bitlockerState = [];
                        if (m.protectionStatus) bitlockerState.push("सक्रिय");
            ...
            if (hardware.darwin && hardware.darwin.volumes) {
                ...
                for (var i in hardware.darwin.volumes) {
                    ...
                    x += '<div style=margin-bottom:3px><b>' + m.mount_point + '</b></div>';
                    if (m.size) {
                        x += addDetailItem("क्षमता", EscapeHtml(m.size), s);
                    }
                    if (m.available) {
                        x += addDetailItem("क्षमता शेष", EscapeHtml(m.available), s);
                    }
                    if (m.type) {
                        var type = (m.removable == true ? "Removable" : (m.cdrom == true ? "CD-ROM" : ''));
                        x += addDetailItem("File System", (type != '' ? (type + ' / ') : '') + (m.type == 'Unknown' ? "अनजान" : EscapeHtml(m.type)), s);
            ...
            if (x == '') {
                QH('p10detailshtml', "इस उपकरण के लिए कोई जानकारी नहीं।");
            } else {
                QH('p10detailshtml', x);
            }
        }
        ...
        function deviceDetailsShowBitlockerInfo(drive, identifier, password) {
            if (xxdialogMode) return false;
            var x = '<div><p>' + "पहचानकर्ता" + '</p><p style=user-select:text;font-weight:bold>' + (identifier ? decodeURIComponent(identifier) : "अनजान") + '</p>';
            x += '<p>' + "Recovery Password" + '</p><p style=user-select:text;font-weight:bold>' + (password ? decodeURIComponent(password) : "अनजान") + '</p></div>';
        ...
        */
        ...
        function setupConsole() {
            ...
            if ((rights & 16) != 0) {
                ...
                var onlineText = ((consoleNode.conn & 1) != 0) ? "एजेंट ऑनलाइन है" : "एजेंट ऑफ़लाइन है"
                if ((consoleNode.conn & 16) != 0) { onlineText += ", MQTT ऑनलाइन है" }
                ...
                QH('p15statetext', "पहुंच अस्वीकृत");
        ...
        function p15consoleSend(e) {
            ...
            if (((consoleNode.conn & 16) != 0) && (Q('p15outputselect').value == 2)) {
                ...
                t = '<div style=color:violet>' + "धक्का दें" + '&gt; ' + EscapeHtml(v) + '<br/></div>';
                consoleNode.consoleText += t;
        ...
        function p15uploadCore(e) {
            ...
            if (e.shiftKey == true) { meshserver.send({ action: 'uploadagentcore', nodeid: consoleNode._id, type: 'default' }); } // Upload default core
                ...
                var htmlValue = '<select id=d3coreMode style=width:230px>' +
                    '<option value=1>' + "डिफ़ॉल्ट सर्वर कोर अपलोड करें" + '</option>' +
                    '<option value=2>' + "कोर साफ़ करें" + '</option>' +
                    '<option value=3>' + "एक कोर फ़ाइल अपलोड करें" + '</option>' +
                    '<option value=4>' + "नरम डिस्कनेक्ट एजेंट" + '</option>' +
                    '<option value=5>' + "हार्ड डिस्कनेक्ट एजेंट" + '</option>' +
                    '<option value=6>' + "रिकवरी कोर अपलोड करें" + '</option>' +
                    '<option value=7>' + "छोटा कोर अपलोड करें" + '</option>' +
                    '<option value=8>' + "Restart agent service" + '</option>' +
                    '<option value=9>' + "बल एजेंट अद्यतन" + '</option></select>';
                setDialogMode(2, "एजेंट एक्शन करें", 3, p15uploadCoreEx, addHtmlValue("कार्य", htmlValue));
            }
        }
        ...
        function p15uploadCore2() {
            ...
            Q('d3auth').value = authCookie;
            Q('d3attrib').value = currentNode._id;
            setDialogMode(4, "मेष एजेंट कोर अपलोड करें", 3, p15uploadCoreEx2);
            d3init();
        }
        ...
        function p20updateMesh() {
            ...
            var meshtype = format("अज्ञात # {0}", currentMesh.mtype);
            var meshrights = GetMeshRights(currentMesh);
            if (currentMesh.mtype == 1) meshtype = "Intel&reg; AMT केवल, कोई एजेंट नहीं";
            if (currentMesh.mtype == 2) meshtype = "एक सॉफ्टवेयर एजेंट का उपयोग कर प्रबंधित";
            if (currentMesh.mtype == 3) { if (currentMesh.relayid == null) { meshtype = "स्थानीय उपकरण, कोई एजेंट नहीं"; } else { meshtype = "एजेंट के माध्यम से कोई एजेंट उपकरण रिले नहीं किया गया"; } }
            if (currentMesh.mtype == 4) { if (currentMesh.relayid == null) { meshtype = "आईपी-केवीएम डिवाइस"; } else { meshtype = "IP-KVM डिवाइस एजेंट के माध्यम से रिले किया गया"; } if (currentMesh.kvm.model == 1) { meshtype += ', ' + 'Raritan KX III'; } }

            var x = '';
            x += addHtmlValue("नाम", addLinkConditional(EscapeHtml(currentMesh.name), 'p20editmesh(1)', (meshrights & 1) != 0));
            x += addHtmlValue("विवरण", addLinkConditional(((currentMesh.desc && currentMesh.desc != '') ? EscapeHtml(currentMesh.desc) : ('<i>' + "कोई नहीं" + '</i>')), 'p20editmesh(2)', (meshrights & 1) != 0));
            x += addHtmlValue("प्रकार", meshtype);
            //x += addHtmlValue('Identifier', currentMesh._id.split('/')[2]);

            // Display the relay device if applicable
            if (((currentMesh.mtype == 3) || (currentMesh.mtype == 4)) && (currentMesh.relayid != null)) {
                var relayName = '<i>' + "अनजान" + '</i>';
                var relayNode = getNodeFromId(currentMesh.relayid);
                if (relayNode != null) { relayName = EscapeHtml(relayNode.name); }
                x += addHtmlValue("रिले डिवाइस", addLinkConditional(relayName, 'p20editmeshrelay()', (meshrights & 1) != 0));
            }

            // Display IP-KVM information if needed
            if (currentMesh.mtype == 4) {
                x += addHtmlValue("होस्ट का नाम", currentMesh.kvm.host);
                x += addHtmlValue("उपयोगकर्ता नाम", currentMesh.kvm.user);
            }

            x += '<br><input type=button value="' + "टिप्पणियाँ" + '" onclick=showNotes(false,"' + encodeURIComponent(currentMesh._id) + '") />';

            x += '<br style=clear:both><br>';
            var currentMeshLinks = currentMesh.links[userinfo._id];
            if (currentMeshLinks && ((currentMeshLinks.rights & 2) != 0)) { x += '<div style=margin-bottom:6px;float:left;margin-right:10px><a onclick=p20showAddMeshUserDialog() style=cursor:pointer><img src=images/icon-addnew.png border=0 height=12 width=12> ' + "उपयोगकर्ता जोड़ें" + '</a></div>'; }

            if (navigator.userAgent.toLowerCase().indexOf('android') >= 0) {
                x += '<div style=margin-bottom:6px;float:left;margin-right:10px><a onclick=p20installAndroidDialog() style=cursor:pointer><img src=images/icon-addnew.png border=0 height=12 width=12> ' + "इस डिवाइस पर इंस्टॉल करें" + '</a></div>';
            }
            ...
            */
            ...
            for (var i in sortedusers) {
                var trash = '', rights = "आंशिक अधिकार", r = sortedusers[i].rights, icon = 2;
                if (r == 0xFFFFFFFF) rights = "पूर्ण प्रशासक"; else if (r == 0) rights = "कोई अधिकार नहीं";
            ...
            if (meshrights == 0xFFFFFFFF) { x += '<div style=font-size:small;text-align:right;margin-top:6px><span><a onclick=p20showDeleteMeshDialog() style=cursor:pointer>' + "समूह हटाएँ" + '</a></span></div>'; }
        ...
        function p20showDeleteMeshDialog() {
            if (xxdialogMode) return false;
            var x = format("क्या आप वाकई {0} समूह को हटाना चाहते हैं? डिवाइस समूह को हटाने से इस समूह के भीतर डिवाइस के बारे में सभी जानकारी भी हट जाएगी।", EscapeHtml(currentMesh.name)) + '<br /><br />';
            x += '<label><input id=p20check type=checkbox onchange=p20validateDeleteMeshDialog() />' + "पुष्टि करें" + '</label>';
            setDialogMode(2, "समूह हटाएँ", 3, p20showDeleteMeshDialogEx, x);
        ...
        function p20editmeshrelay() {
            ...
            if (relayDevices.length == 0) {
                ...
                setDialogMode(2, "उपकरण समूह संपादित करें", 1, null, "कोई रिले डिवाइस उपलब्ध नहीं है।");
            } else {
                var relayDevices2 = [];
                ...
                var x = addHtmlValue("रिले डिवाइस", '<div style=width:170px><select id=d2devrelay style=width:100%>' + relayDevices2.join('') + '</select></div>');
                setDialogMode(2, "उपकरण समूह संपादित करें", 3, p20editmeshrelayEx, x);
            }
        }
        ...
        function p20editmesh(focus) {
            if (xxdialogMode) return;
            var x = addHtmlValue("नाम", '<input id=dp20meshname style=width:170px maxlength=32 onchange=p20editmeshValidate() onkeyup=p20editmeshValidate() />');
            x += addHtmlValue("विवरण", '<input id=dp20meshdesc style=width:170px maxlength=1024 onkeyup=p20editmeshValidate() />');
            setDialogMode(2, "उपकरण समूह संपादित करें", 3, p20editmeshEx, x);
        ...
        function p20installAndroidDialog() {
            if (xxdialogMode) return;
            var x = '<div style=text-align:center><p>' + "अपने Android डिवाइस पर MeshCentral Agent इंस्टॉल करें। एक बार इंस्टॉल हो जाने पर, अपने डिवाइस को इस सर्वर से कनेक्ट करने के लिए पेयरिंग लिंक पर क्लिक करें।" + '</p>';
            ...
            x += '<p><a href="' + serverinfo.magenturl + ',' + serverinfo.agentCertHash + ',' + currentMesh._id.split('/')[2] + '"><b>' + "डिवाइस पेयरिंग लिंक" + '</b></a></p></div>';
            setDialogMode(2, "एंड्रॉइड इंस्टॉलेशन", 1, null, x);
        }
        ...
        function p20showAddMeshUserDialog() {
            ...
            x += '<label><input type=checkbox onchange=p20validateAddMeshUserDialog() id=p20fulladmin>' + "पूर्ण प्रशासक" + '</label><br>';
            x += '<label><input type=checkbox onchange=p20validateAddMeshUserDialog() id=p20editmesh>' + "उपकरण समूह संपादित करें" + '</label><br>';
            x += '<label><input type=checkbox onchange=p20validateAddMeshUserDialog() id=p20manageusers>' + "डिवाइस समूह उपयोगकर्ताओं को प्रबंधित करें" + '</label><br>';
            x += '<label><input type=checkbox onchange=p20validateAddMeshUserDialog() id=p20managecomputers>' + "डिवाइस ग्रुप कंप्यूटर प्रबंधित करें" + '</label><br>';
            x += '<label><input type=checkbox onchange=p20validateAddMeshUserDialog() id=p20remotecontrol>' + "रिमोट कंट्रोल" + '</label><br>';
            x += '<label><input type=checkbox onchange=p20validateAddMeshUserDialog() id=p20remoteview style=margin-left:12px>' + "केवल रिमोट देखें" + '</label><br>';
            x += '<label><input type=checkbox onchange=p20validateAddMeshUserDialog() id=p20remotelimitedinput style=margin-left:12px>' + "लिमिटेड इनपुट केवल" + '</label><br>';
            x += '<label><input type=checkbox onchange=p20validateAddMeshUserDialog() id=p20noterminal style=margin-left:12px>' + "कोई टर्मिनल एक्सेस नहीं" + '</label><br>';
            x += '<label><input type=checkbox onchange=p20validateAddMeshUserDialog() id=p20nofiles style=margin-left:12px>' + "कोई फ़ाइल एक्सेस नहीं" + '</label><br>';
            x += '<label><input type=checkbox onchange=p20validateAddMeshUserDialog() id=p20noamt style=margin-left:12px>' + "कोई Intel&reg; AMT नहीं" + '</label><br>';
            x += '<label><input type=checkbox onchange=p20validateAddMeshUserDialog() id=p20meshagentconsole>' + "मेष एजेंट कंसोल" + '</label><br>';
            x += '<label><input type=checkbox onchange=p20validateAddMeshUserDialog() id=p20meshserverfiles>' + "सर्वर फ़ाइलें" + '</label><br>';
            x += '<label><input type=checkbox onchange=p20validateAddMeshUserDialog() id=p20wakedevices>' + "जागो यंत्र" + '</label><br>';
            x += '<label><input type=checkbox onchange=p20validateAddMeshUserDialog() id=p20editnotes>' + "डिवाइस नोट्स संपादित करें" + '</label><br>';
            x += '<label><input type=checkbox onchange=p20validateAddMeshUserDialog() id=p20limitevents>' + "केवल स्वयं ईवेंट दिखाएं" + '</label><br>';
            x += '<label><input type=checkbox onchange=p20validateAddMeshUserDialog() id=p20chatnotify>' + "चैट करें और सूचित करें" + '</label><br>';
            x += '<label><input type=checkbox onchange=p20validateAddMeshUserDialog() id=p20uninstall>' + "एजेंट को अनइंस्टॉल करें" + '</label><br>';
            x += '<label><input type=checkbox onchange=p20validateAddMeshUserDialog() id=p20commands>' + "रिमोट कमांड" + '</label><br>';
            x += '<label><input type=checkbox onchange=p20validateAddMeshUserDialog() id=p20resetoff>' + "रीसेट / पावर ऑफ" + '</label><br>';
            x += '</div>';
            setDialogMode(2, "उपकरण समूह में उपयोगकर्ता जोड़ें", 3, p20showAddMeshUserDialogEx, x);
        ...
        function p20viewuser(userid) {
            ...
            if (meshrights == 0xFFFFFFFF) r.push("पूर्ण प्रशासक"); else {
                if ((meshrights & 1) != 0) r.push("उपकरण समूह संपादित करें");
                if ((meshrights & 2) != 0) r.push("डिवाइस समूह उपयोगकर्ताओं को प्रबंधित करें");
                if ((meshrights & 4) != 0) r.push("डिवाइस ग्रुप कंप्यूटर प्रबंधित करें");
                if ((meshrights & 8) != 0) r.push("रिमोट कंट्रोल");
                if ((meshrights & 16) != 0) r.push("एजेंट कंसोल");
                if ((meshrights & 32) != 0) r.push("सर्वर फ़ाइलें");
                if ((meshrights & 64) != 0) r.push("जागो यंत्र");
                if ((meshrights & 128) != 0) r.push("नोट्स संपादित करें");
                if ((meshrights & 256) != 0) r.push("केवल रिमोट देखें");
                if ((meshrights & 512) != 0) r.push("कोई टर्मिनल नहीं");
                if ((meshrights & 1024) != 0) r.push("फ़ाइल नहीं");
                if ((meshrights & 2048) != 0) r.push("कोई Intel&reg; AMT नहीं");
                if (((meshrights & 8) != 0) && ((meshrights & 4096) != 0) && ((meshrights & 256) == 0)) r.push("सीमित इनपुट");
                if ((meshrights & 8192) != 0) r.push("सेल्फ इवेंट्स ओनली");
                if ((meshrights & 16384) != 0) r.push("चैट करें और सूचित करें");
                if ((meshrights & 32768) != 0) r.push("स्थापना रद्द करें");
                if ((meshrights & 131072) != 0) r.push("आदेश");
                if ((meshrights & 262144) != 0) r.push("रीसेट / बंद");
            }
            if (r.length == 0) { r.push("कोई अधिकार नहीं"); }
            var buttons = 1, uname = userid.split('/')[2];
            if (currentMesh.links[userid].name) { uname = currentMesh.links[userid].name; }
            var x = addHtmlValue("उपयोगकर्ता नाम", EscapeHtml(uname));
            if (uname != userid.split('/')[2]) { x += addHtmlValue("यूज़र आईडी", EscapeHtml(userid.split('/')[2])); }
            x += addHtmlValue("अनुमतियां", r.join(", "));
            if (((userinfo._id) != userid) && (cmeshrights == 0xFFFFFFFF || (((cmeshrights & 2) != 0) && (meshrights != 0xFFFFFFFF)))) buttons += 4;
            setDialogMode(2, "डिवाइस समूह उपयोगकर्ता", buttons, p20viewuserEx, x, userid);
        }
        ...
        function p20viewuserEx(button, userid) {
            ...
            setDialogMode(2, "रिमोट मेष उपयोगकर्ता", 3, p20viewuserEx2, format("उपयोगकर्ता को हटाने की पुष्टि {0}?", uname), userid);
        }
        ...
        function drawNotifications() {
            ...
            if (notifications.length == 0) {
                r = '<div style=margin:5px>' + "वर्तमान में कोई सूचना नहीं है" + '</div>';
            } else {
                for (var i in notifications) {
                    ...
                    r += '<div title="' + format("{0} पर हुआ", printDateTime(d)) + '" id="notifyx' + n.id + '" class=notification style="cursor:pointer;border-top:1px solid ' + ((r == '') ? 'transparent' : 'orange') + '">';
                    if (icon) { r += '<div class=j' + icon + ' onclick="notificationSelected(' + n.id + ')" style=margin:5px;float:left></div>'; }
                    r += '<div onclick="notificationDelete(' + n.id + ')" class=unselectable title="' + "इस अधिसूचना को साफ़ करें" + '" style=margin:5px;float:right;color:orange><b>X</b></div><div onclick="notificationSelected(' + n.id + ')" style=margin:5px>' + t + EscapeHtml(n.text) + '</div><div style=margin-left:5px;margin-bottom:5px;color:gray;font-size:10px>' + printDateTime(d) + '</div></div>';
                }
            }
            var deleteall = '';
            if (notifications.length > 1) { deleteall = '<div id="notifyRemoveAll" onclick="deleteAllNotifications()" style="cursor:pointer;border-top:1px solid orange;margin:5px;color:orange;text-align:right;padding-right:3px">' + "सभी साफ करें" + '</div>'; }
        ...
        function addNotification(n) {
            ...
            var translatedMessages = [
                ...
                "अवैध ईमेल",
                "अमान्य डोमेन",
                "अमान्य साइट अनुमतियाँ",
                "उपयोगकर्ता पहले से मौजूद है",
                "इस मोड में उपयोगकर्ता जोड़ने में असमर्थ",
                "सत्यापन अपवाद",
                "खाता सीमा तक पहुंच गया।", // 10
                "चैट अनुरोध, स्वीकार करने के लिए यहां क्लिक करें।",
                "पिछले लॉगिन के बाद से इस खाते पर {0} असफल लॉगिन प्रयास हुए हैं।",
                "ईमेल पता बदलने में विफल, एक अन्य खाता जो पहले से उपयोग कर रहा है: {0}।",
                "ईमेल भेजा।",
                "उपयोगकर्ता {0} नहीं मिला।",
                "उपयोगकर्ता {0} नहीं मिले.",
                "त्रुटि, पहले उपयोग किए गए पासवर्ड में बदलने में असमर्थ।",
                "त्रुटि, आमतौर पर उपयोग किए जाने वाले पासवर्ड में बदलने में असमर्थ।",
                "त्रुटि, पासवर्ड नहीं बदला।",
                "पासवर्ड बदला गया।", // 20
                "वर्तमान पासवर्ड सही नहीं है।",
                "त्रुटि, आमंत्रण कोड \"{0}\" पहले से प्रयोग में है।",
                "एसएमएस गेटवे सक्षम नहीं है",
                "कोई उपयोगकर्ता प्रबंधन अधिकार नहीं",
                "अमान्य एसएमएस संदेश",
                "इस उपयोगकर्ता के लिए कोई फ़ोन नंबर नहीं",
                "एसएमएस सफलतापूर्वक भेजा गया।",
                "एसएमएस त्रुटि",
                "एसएमएस त्रुटि: {0}",
                "ईमेल डोमेन \"{0}\" की अनुमति नहीं है। केवल ({1}) की अनुमति है" // 30
            ];
        ...
        function getFileSizeStr(size) { if (typeof size != 'number') { size = 0; } if (size == 1) return "1 बाइट"; return format('{0} bytes', size); }
