<!DOCTYPE html><html lang="uk"><head>
    ...
    </head><body id="body" onload="if (typeof(startup) !== 'undefined') startup();" style="display:none;overflow:hidden">{{{customCSSTags}}}
    <link rel="apple-touch-icon" href="/favicon-303x303.png">
    <script type="text/javascript" src="scripts/common-0.0.1{{min}}.js"></script>
    <script type="text/javascript" src="scripts/qrcode.min.js"></script>
    {{{customJSTags}}}
    <title>Інсталяція Агента</title>
    <style>
        .tab {
            overflow: hidden;
    ...
    <div id="container">
        ...
        <div id="column_l" style="overflow-y:auto">
            <h1><span id="groupname">Віддалена інсталяція агента</span></h1>
            <p>
                Вам запропонували встановити програму, яка дозволить віддаленому оператору отримати безпечний доступ до вашого комп’ютера, включаючи робочий стіл, файли та термінал (командний рядок). Дотримуйтесь наступних інструкцій ЛИШЕ в тому випадку, якщо ви очікували це запрошення та знаєте, хто матиме доступ до вашого комп’ютера. Виберіть свою операційну систему та дійте за вказівками, наведеними нижче.
            </p>
            <div>
                <div class="tab">
                    ...
                    <button id="tlinuxtab" class="tablinks" onclick="openTab(event, 'linuxtab')">Linux / BSD Скрипти</button>
                    <button id="tlinuxbinarytab" class="tablinks" onclick="openTab(event, 'linuxbinarytab')">Бінарний Інсталятор Linux / BSD / macOS</button>
                    <button id="tmacostab64" class="tablinks" onclick="openTab(event, 'macostab64')">macOS x86-64</button>
                    <button id="tmacostabarm64" class="tablinks" onclick="openTab(event, 'macostabarm64')">macOS ARM (64-біт)</button>
                    ...
                    <button id="tassistab" class="tablinks" onclick="openTab(event, 'assistab')">Асистент</button>
                </div>

                <div id="wintab64" class="tabcontent" style="background-color:white;color:black">
                    <h3>Microsoft™ Windows 64-бітна</h3>
                    <p><a id="win64url">Завантажте програму натиснувши сюди</a>, запустіть її та натисніть "Встановити" або "Підключитися". Після інсталяції агент працютиме у фоновому режимі, що дозволить віддаленому оператору керувати вашим комп'ютером. Підключення ж надасть тимчасовий доступ поки вікно програми буде відкрите.</p>
                ...
                <div id="wintab32" class="tabcontent" style="background-color:white;color:black">
                    <h3>Microsoft™ Windows 32-бітна</h3>
                    <p><a id="win32url">Завантажте програму натиснувши сюди</a>, запустіть її та натисніть "Встановити" або "Підключитися". Після інсталяції агент працютиме у фоновому режимі, що дозволить віддаленому оператору керувати вашим комп'ютером. Підключення ж надасть тимчасовий доступ поки вікно програми буде відкрите.</p>
                    <div style="text-align:center">
                ...
                <div id="wintabarm64" class="tabcontent" style="background-color:white;color:black">
                    <h3>Microsoft™ Windows ARM 64-біт</h3>
                    <p><a id="winarm64url">Завантажте програму натиснувши сюди</a>, запустіть її та натисніть "Встановити" або "Підключитися". Після інсталяції агент працютиме у фоновому режимі, що дозволить віддаленому оператору керувати вашим комп'ютером. Підключення ж надасть тимчасовий доступ поки вікно програми буде відкрите.</p>
                    <div style="text-align:center">
                ...
                <div id="linuxtab" class="tabcontent" style="background-color:white;color:black">
                    <h3>Linux</h3>
                    <p>Щоб інсталювати, скопіюйте наступну команду в термінал із root правами.</p>
                    <div id="linuxinstall" style="font-family:courier,'courier new',monospace;margin-left:30px"></div>
                    <input type="button" value="Копіювати до буфера обміну" style="margin-left:30px;margin-top:4px" onclick="copyToClipLinuxInstall()">
                    <p>Щоб видалити, скопіюйте та вставте наступну команду як root.</p>
                    <div id="unlinuxinstall" style="font-family:courier,'courier new',monospace;margin-left:30px"></div>
                    <input type="button" value="Копіювати до буфера обміну" style="margin-left:30px;margin-top:4px" onclick="copyToClipLinuxUnInstall()">
                    <br><br>
                </div>
                ...
                <div id="macostab64" class="tabcontent" style="background-color:white;color:black">
                    <h3>Apple™ MacOS x86-64bit</h3>
                    <p><a id="macos64url">Завантажте інсталятор натиснувши сюди</a>, клікніть на файл правою кнопкою або натисніть "Ctrl" та клікніть по ньому. Потім виберіть "Відкрити" та дотримуйтесь подальших інструкцій.</p>
                    <div style="text-align:center">
                ...
                <div id="macostabarm64" class="tabcontent" style="background-color:white;color:black">
                    <h3>Apple™ MacOS ARM 64bit</h3>
                    <p><a id="macosarm64url">Завантажте інсталятор натиснувши сюди</a>, клікніть на файл правою кнопкою або натисніть "Ctrl" та клікніть по ньому. Потім виберіть "Відкрити" та дотримуйтесь подальших інструкцій.</p>
                    <div style="text-align:center">
                ...
                <div id="macostab" class="tabcontent" style="background-color:white;color:black">
                    <h3>Apple™ MacOS Universal</h3>
                    <p><a id="macosurl">Завантажте інсталятор натиснувши сюди</a>, клікніть на файл правою кнопкою або натисніть "Ctrl" та клікніть по ньому. Потім виберіть "Відкрити" та дотримуйтесь подальших інструкцій.</p>
                    <div style="text-align:center">
                ...
                <div id="androtab" class="tabcontent" style="background-color:white;color:black">
                    ...
                    <div style="min-height:220px">
                        <p>Завантажте застосунок агента за допомогою Google Play Store або файлу APK, після інсталяції скористуйтеся QR-кодом праворуч або посиланням для створення пари, щоб налаштувати свій пристрій на цьому сервері.</p>
                        <p>
                        ...
                        <p>
                            <a id="androidurl">Завантажити Android APK</a>
                        </p>
                        <p>
                            <a rel="noreferrer noopener" target="_blank" href="{{{magenturl}}}">Посилання для спарювання із сервером</a>
                        </p>
                    </div>
                </div>
                ...
                <div id="assistab" class="tabcontent" style="background-color:white;color:black">
                    ...
                    <div style="min-height:220px">
                        ...
                        <p>Помічник — це засіб системного трея Windows, який можна використовувати лише коли потрібна допомога. На противагу фоновому агенту, цей інструмент з'єднується з сервером лише у разі запиту користувача на віддалену допомогу.</p>
                        <p>
                            <a id="assisturl" rel="noreferrer noopener" target="_blank">Помічник Завантажень для Windows</a>
                        </p>
                    </div>
                    <br style="clear:both">
                </div>
    ...
    <script>
        ...
        function startup() {
            ...
            if (groupName != '') {
                QH('groupname', format("Інсталяція віддаленого агента для {0}", escapeHtml(groupName)));
                document.title = format("{0} – Встановлення Агенту", groupName);
            } else {
                document.title = "Інсталяція Агента";
            }
        ...
        function linuxBinarySetup() {
            var x = '<h3>' + "Бінарний Інсталятор Linux / BSD / macOS" + '</h3>', moreoptions = '';
            var opts = '<select id=aginsSelect onchange=addAgentToMeshClick() style=width:236px>';
            opts += '<option value=5 selected>' + "Бінарний Інсталятор Linux / BSD / macOS" + '</option>';
            opts += '</select>';
            ...
            x += addHtmlValue("Тип системи", '<select id=aginsSysType onchange=addAgentToMeshClick() style=width:236px>' + moreoptions + '</select>');
            x += '</div>';
            x += '<div id=aginsTypeDiv>';
            x += addHtmlValue("Тип Інсталяції", '<select id=aginsType onchange=addAgentToMeshClick() style=width:236px><option value=0>' + "Фоновий та Інтерактивний" + '</option><option value=2>' + "Лише фоновий" + '</option><option value=1>' + "Лише інтерактивний" + '</option></select>');
            x += '</div><hr>';
            x += '<div id=agins_linux_inst style=display:none>' + "Це виконуваний файл для ОС із графічним інтерфейсом" + '<br /><br />' + "Для запуску виконувані файли Apple macOS потрібно буде вилучити з карантину запустивши 'xattr -r -d com.apple.quarantine meshagent'" + '<br /><br />' + "Потрібно виконати 'chmod +x meshagent', та потім запустити цей файл" + '<br /><br />';
            x += addHtmlValue("Mesh Agent", '<a id=aginsbinlnk name="meshagents?id=' + meshid + '&installflags=0' + (urlargs.key?('&key=' + urlargs.key):'') + '">' + "MeshAgent" + '</a> <img src=images/link4.png height=10 width=10 title="' + "Скопіювати URL-адресу агента до буфера обміну" + '" style=cursor:pointer onclick=copyAgentUrl("meshagents?id=' + meshid + '&installflags=",1)>');
            x += addHtmlValue("Команда", '<input id=aginsbincmd type=text style="width:216px" readonly value=\'wget -O meshagent ' + ((serverNoProxy != 0) ?'--no-proxy':'') + ' --no-check-certificate \"https://' + servername + portStr + domainUrl + 'meshagents?id=' + meshid.split('$').join('%24').split('@').join('%40') + '\' /> <img src=images/link4.png height=10 width=10 title="' + "Скопіювати URL-адресу агента до буфера обміну" + '" style=cursor:pointer onclick=copyAgentIdValue("aginsbincmd")>');
            x += '</div>';
            QH('linuxbinarytab', x);
            addAgentToMeshClick();
        }
