<!DOCTYPE html><html lang="pt" dir="ltr" xmlns="http://www.w3.org/1999/xhtml"><head>
    ...
    <script>
        ...
        var keyStrings = { 8: "BackSpace", 9: "Tab", 13: "Entrar", 27: "Fuga", 44 : "Captura de tela", 45: "Inserir", 46: "Del", 36: "Casa", 35: "Fim", 33: "Subir página", 34: "Page Down", 37: "Deixou", 38: "Acima", 39: "Direito", 40: "Baixa", 0: "Nenhum" }
                ...
                if (data[0] == '{') {
                    ...
                    switch (j.action) {
                        case 'sshauth': {
                            ...
                            x += addHtmlValue("Arquivo-chave", '<input type=file id=dp2key style=width:150px maxlength=64 autocomplete=off onchange=sshAuthUpdate(event) />');
                            ...
                            x += '</div>';
                            x += '<label><input id=dp2keep type=checkbox>' + "Lembre-se de credenciais" + '</label>';
                            x += '<div id=d2keyauth2 style=font-size:x-small><br />' + "O arquivo da chave deve estar no formato OpenSSH." + '</div>';
