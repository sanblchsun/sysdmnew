<!DOCTYPE html><html lang="nl"><head>
        ...
        <div id="column_l" style="overflow-y:auto">
            ...
            <div>
                <div class="tab">
                    ...
                    <button id="tlinuxbinarytab" class="tablinks" onclick="openTab(event, 'linuxbinarytab')">Linux / BSD / macOS Binair installatieprogramma</button>
                    ...
                    <button id="tmacostab" class="tablinks" onclick="openTab(event, 'macostab')">macOS (Universeel)</button>
                ...
                <div id="wintabarm64" class="tabcontent" style="background-color:white;color:black">
                    ...
                    <p><a id="winarm64url">Download de software hier</a>, open het en klik op "installeren" of "verbinden".</p>
                    <div style="text-align:center">
                ...
                <div id="linuxtab" class="tabcontent" style="background-color:white;color:black">
                    <h3>Linux</h3>
                    <p>Om te installeren, knip en plak de volgende opdracht in de terminal (root).</p>
                ...
                <div id="macostab64" class="tabcontent" style="background-color:white;color:black">
                    ...
                    <p><a id="macos64url">Download het installatieprogramma hier</a>, klik er met de rechtermuisknop op of druk op "beheer" en klik op het bestand. Daarna op "open" en volg de instructies.</p>
                    <div style="text-align:center">
                ...
                <div id="macostabarm64" class="tabcontent" style="background-color:white;color:black">
                    ...
                    <p><a id="macosarm64url">Download het installatieprogramma hier</a>, klik er met de rechtermuisknop op of druk op "beheer" en klik op het bestand. Daarna op "open" en volg de instructies.</p>
                    <div style="text-align:center">
                ...
                <div id="androtab" class="tabcontent" style="background-color:white;color:black">
                    ...
                    <div style="min-height:220px">
                        <p>Download de agentsoftware via de Google Play Store of APK-bestand, installeer het en gebruik de QR-code aan de rechterkant of de koppelingslink hieronder om uw apparaat aan deze server te koppelen.</p>
                        <p>
                        ...
                        <p>
                            <a rel="noreferrer noopener" target="_blank" href="{{{magenturl}}}">Server koppelingslink</a>
                        </p>
                    </div>
                </div>
                ...
                <div id="assistab" class="tabcontent" style="background-color:white;color:black">
                    ...
                    <div style="min-height:220px">
                        ...
                        <p>Assistant is een Windows-tool in het systeemvak die kan worden gebruikt als er hulp nodig is. Dit is geen agent die op de achtergrond van de beheerde computer draait, maar een tool die alleen verbinding maakt met de server wanneer daarom wordt gevraagd.</p>
                        <p>
                            <a id="assisturl" rel="noreferrer noopener" target="_blank">Download Assistant voor Windows</a>
                        </p>
                    </div>
                    <br style="clear:both">
                </div>
    ...
    <script>
        ...
        function startup() {
            ...
            if (groupName != '') {
                QH('groupname', format("Externe agent installatie voor {0}", escapeHtml(groupName)));
                document.title = format("{0} - Agent Installatie", groupName);
            } else {
                document.title = "Agent Installatie";
            }
        ...
        function linuxBinarySetup() {
            var x = '<h3>' + "Linux / BSD / macOS Binair installatieprogramma" + '</h3>', moreoptions = '';
            var opts = '<select id=aginsSelect onchange=addAgentToMeshClick() style=width:236px>';
            opts += '<option value=5 selected>' + "Linux / BSD / macOS Binair installatieprogramma" + '</option>';
            opts += '</select>';
            ...
            x += addHtmlValue("Systeem type", '<select id=aginsSysType onchange=addAgentToMeshClick() style=width:236px>' + moreoptions + '</select>');
            x += '</div>';
            x += '<div id=aginsTypeDiv>';
            x += addHtmlValue("Installatie type", '<select id=aginsType onchange=addAgentToMeshClick() style=width:236px><option value=0>' + "Achtergrond & interactief" + '</option><option value=2>' + "Alleen achtergrond" + '</option><option value=1>' + "Alleen interactief" + '</option></select>');
            x += '</div><hr>';
            x += '<div id=agins_linux_inst style=display:none>' + "Dit is een uitvoerbaar bestand op besturingssystemen met grafische gebruikersinterfaces" + '<br /><br />' + "Apple macOS uitvoerbare bestanden moeten uit quarantaine worden verwijderd om 'xattr -r -d com.apple.quarantine meshagent' te kunnen starten" + '<br /><br />' + "U moet 'chmod +x meshagent' gebruiken en dit bestand uitvoeren." + '<br /><br />';
            x += addHtmlValue("Mesh Agent", '<a id=aginsbinlnk name="meshagents?id=' + meshid + '&installflags=0' + (urlargs.key?('&key=' + urlargs.key):'') + '">' + "MeshAgent" + '</a> <img src=images/link4.png height=10 width=10 title="' + "Kopieer de agent URL naar het klembord" + '" style=cursor:pointer onclick=copyAgentUrl("meshagents?id=' + meshid + '&installflags=",1)>');
            x += addHtmlValue("Opdracht", '<input id=aginsbincmd type=text style="width:216px" readonly value=\'wget -O meshagent ' + ((serverNoProxy != 0) ?'--no-proxy':'') + ' --no-check-certificate \"https://' + servername + portStr + domainUrl + 'meshagents?id=' + meshid.split('$').join('%24').split('@').join('%40') + '\' /> <img src=images/link4.png height=10 width=10 title="' + "Kopieer de agent URL naar het klembord" + '" style=cursor:pointer onclick=copyAgentIdValue("aginsbincmd")>');
            x += '</div>';
            QH('linuxbinarytab', x);
            addAgentToMeshClick();
        }
