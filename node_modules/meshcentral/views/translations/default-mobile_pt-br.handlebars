<!DOCTYPE html><html lang="pt-br" dir="ltr" xmlns="http://www.w3.org/1999/xhtml"><head>
    <meta charset="utf-8">
    ...
    <div id="container">
        ...
        <div id="masthead" style="background:url(logo.png) 0px 0px;background-size:341px 50px;background-color:#036;background-repeat:no-repeat;height:50px;width:100%;overflow:hidden">
            ...
            <div id="notificationCount" onclick="clickNotificationIcon()" class="unselectable" style="position:absolute;right:50px;top:0px;font-size:28px;width:50px;height:50px;cursor:pointer;display:none" title="Clique para ver as notificações atuais"><div id="notificationCount2" style="padding-top:8px">0</div></div>
            ...
            <div id="column_l" style="width:100%;padding:0;position:absolute;bottom:0px;top:0px">
                <div id="p0" style="display:none;width:100%;height:100%">
                    <div style="display:flex;align-items:center;width:100%;height:100%">
                        <div id="p0message" style="text-align:center;width:100%"><span id="p0span">Servidor desconectado</span>, <href onclick="reload()" style="cursor:pointer"><u>Clique para reconectar</u></href>.</div>
                    </div>
                </div>
                ...
                <div id="p2" style="display:none;position:absolute;top:0;left:0;right:0;bottom:0">
                    ...
                    <div id="xdevicesBar" style="position:absolute;overflow-y:auto;height:34px;left:0;right:0;bottom:0px;background-color:#aaa;color:black">
                        <div style="margin:4px">
                            ...
                            <label class="noselect"><input type="checkbox" id="RealNameCheckBox" onclick="onRealNameCheckBox()">Nome do SO</label>
                            <label class="noselect"><input type="checkbox" id="OnlineCheckBox" onclick="onOnlineCheckBox(event)">On-line</label>
                        </div>
                    </div>
                </div>
                <div id="p3" style="display:none;position:absolute;bottom:0;top:0;width:100%">
                    ...
                    <div id="p3info" style="overflow-y:auto;position:absolute;top:55px;bottom:0px;width:100%">
                        ...
                        <div style="margin-left:8px">
                            <div id="p3AccountActions">
                                <div id="p2AccountSecurity" style="display:none">
                                    ...
                                    <div style="margin-left:9px;margin-bottom:8px">
                                        <div id="managePhoneNumber1" style="margin-top:5px;display:none"><a onclick="account_managePhone()" style="cursor:pointer">Gerenciar número de telefone</a> <span id="authPhoneNumberCheck"><strong>✓</strong></span></div>
                                        <div id="manageEmail2FA" style="margin-top:5px;display:none"><a onclick="account_manageAuthEmail()" style="cursor:pointer">Gerenciar autenticação de e-mail</a> <span id="authEmailSetupCheck"><strong>✓</strong></span></div>
                                        <div style="margin-top:5px"><a href="#" onclick="account_showLocalizationSettings()">Configurações de idioma</a></div>
                                        <div id="manageAuthApp" style="margin-top:5px;display:none"><a onclick="account_manageAuthApp()" style="cursor:pointer">Gerenciar aplicativo autenticador</a> <span id="authAppSetupCheck"><strong>✓</strong></span></div>
                                        <div id="manageOtp" style="margin-top:5px;display:none"><a onclick="account_manageOtp(0)" style="cursor:pointer">Gerenciar códigos de backup</a> <span id="authCodesSetupCheck"><strong>✓</strong></span></div>
                                    </div>
                                </div>
                                <div id="p2AccountActions" style="display:none">
                                    <p><strong>Ações da conta</strong></p>
                                    <div style="margin-left:9px;margin-bottom:8px">
                                        <div style="margin-top:5px"><span id="viewPreviousLogins"><a onclick="return account_viewPreviousLogins()" style="cursor:pointer">Ver logins anteriores</a></span></div>
                                        <div style="margin-top:5px"><span id="managePhoneNumber2" style="display:none"><a onclick="account_managePhone()" style="cursor:pointer">Gerenciar número de telefone</a></span></div>
                                        <div style="margin-top:5px"><span id="verifyEmailId" style="display:none"><a onclick="account_showVerifyEmail()" style="cursor:pointer">Verificar e-mail</a></span></div>
                                        <span id="p2AccountPassActions">
                                            <div style="margin-top:5px"><span id="changeEmailId" style="display:none"><a onclick="account_showChangeEmail()" style="cursor:pointer">Altere o endereço de email</a></span></div>
                                            <div style="margin-top:5px"><a onclick="account_showChangePassword()" style="cursor:pointer">Alterar senha</a><span id="p2nextPasswordUpdateTime"></span></div>
                                            <div style="margin-top:5px"><a onclick="account_showDeleteAccount()" style="cursor:pointer">Deletar conta</a></div>
                                        </span>
                                        <div style="margin-top:5px" id="setDarkModeLink"><a onclick="toggleNightMode()" style="cursor:pointer">Definir modo escuro</a></div>
                                        <div style="margin-top:5px"><a onclick="showNotes(false)" style="cursor:pointer">Notas pessoais</a></div>
                                    </div>
                                <br style="clear:both">
                                </div>
                            </div>
                            ...
                            <br><br>
                            <div id="p3meshes"></div>
                            <div id="p3noMeshFound" style="margin-left:9px;display:none">Nenhum grupo de dispositivos.<span id="p3createMeshLink2"> <a onclick="account_createMesh()" style="cursor:pointer"><strong>Comece aqui!</strong></a></span></div>
                            <br style="clear:both">
                        </div>
                    </div>
                </div>
                <div id="p5" style="display:none">
                    <table cellspacing="0" style="margin:0;padding:0;border-spacing:0;border:0;">
                        <tbody><tr style="padding:0">
                            ...
                            <td>
                                <div style="margin-left:5px">
                                    <strong style="font-size:large">Meus Arquivos</strong><br>
                                </div>
                            </td>
                        </tr>
                    </tbody></table>
                            ...
                            <tbody><tr>
                                <td style="width:100%;background-color:#d3d9d6;text-align:left;padding:4px" valign="bottom">
                                    <div style="width:100%;text-align:center">
                                        <input type="button" style="width:calc(100%/5 - 5px)" id="p5FolderUp" disabled="disabled" onclick="p5folderup()" value="Cima">
                                        <input type="button" style="width:calc(100%/5 - 5px)" id="p5SelectAllButton" disabled="disabled" onclick="p5selectallfile()" value="Selecionar tudo" onkeypress="return false" onkeydown="return false">
                                        <input type="button" style="width:calc(100%/5 - 5px)" id="p5RenameFileButton" disabled="disabled" value="Renomear" onclick="p5renamefile()" onkeypress="return false" onkeydown="return false">
                                        <input type="button" style="width:calc(100%/5 - 5px)" id="p5DeleteFileButton" disabled="disabled" value="Excluir" onclick="p5deletefile()" onkeypress="return false" onkeydown="return false">
                                        <input type="button" style="width:calc(100%/5 - 5px)" id="p5NewFolderButton" disabled="disabled" value="Pasta" onclick="p5createfolder()" onkeypress="return false" onkeydown="return false">
                                    </div>
                                    <div style="width:100%;text-align:center">
                                        <input type="button" style="width:calc(100%/5 - 5px)" id="p5UploadButton" disabled="disabled" value="Carregar" onclick="p5uploadFile()" onkeypress="return false" onkeydown="return false">
                                        <input type="button" style="width:calc(100%/5 - 5px)" id="p5CutButton" disabled="disabled" value="Recortar" onclick="p5copyFile(1)" onkeypress="return false" onkeydown="return false">
                                        ...
                                        <input type="button" style="width:calc(100%/5 - 5px)" id="p5PasteButton" disabled="disabled" value="Colar" onclick="p5pasteFile()" onkeypress="return false" onkeydown="return false">
                                        <input type="button" style="width:calc(100%/5 - 5px)" id="p5RefreshButton" value="Atualizar" onclick="p5refreshFiles()" onkeypress="return false" onkeydown="return false">
                                    </div>
                                </td>
                            </tr>
                            <tr>
                                        ...
                                        <tbody><tr>
                                            ...
                                            <td style="text-align:right;padding-right:4px">
                                                <select id="p5sortdropdown" onchange="updateFiles()">
                                                    ...
                                                    <option value="2">Ordenar por tamanho</option>
                                                    <option value="3">Classificar por data</option>
                                                    <option value="4">Decrescente pelo nome</option>
                                                    <option value="5">Decrescente por tamanho</option>
                                                    <option value="6">Decrescente por data</option>
                                                </select>
                                            </td>
                                        </tr>
                                    </tbody></table>
                ...
                <div id="p10" style="display:none;position:absolute;bottom:0;top:0;width:100%;overflow:hidden">
                    ...
                    <div id="p10dialog" style="z-index:1000;background-color:#EEE;box-shadow:0px 0px 15px #666;font-family:Arial,Helvetica,sans-serif;border-radius:5px;position:fixed;top:30px;width:300px;left:30px;display:none">
                        <div style="width:100%;background-color:#003366;color:#FFF;border-radius:5px 5px 0 0">
                            <div style="padding:5px">Personalização de atalhos de teclado</div>
                    ...
                    <div id="p10desktop" style="overflow:hidden;position:absolute;top:55px;bottom:0px;width:100%;display:none">
                        <div id="deskarea1" style="position:absolute;top:0px;width:100%;height:32px">
                            <div style="padding-top:2px;padding-bottom:2px;background:#C0C0C0;height:32px">
                                <div style="float:right;text-align:right">
                                    ...
                                    <input type="button" id="deskFullScreen" value="Tela cheia" onclick="deskToggleFull(event)" onkeypress="return false" onkeydown="return false" disabled="disabled" style="height:28px;margin-right:3px;">
                                </div>
                        ...
                        <div id="deskarea4" style="position:absolute;bottom:0px;width:100%;height:32px">
                            <div style="padding-top:2px;padding-bottom:2px;background:#C0C0C0">
                                ...
                                <div>
                                    <input id="deskActionsBtn" type="button" style="margin-left:3px;height:28px" onkeypress="return false" onkeydown="return false" value="Ações" onclick="deviceActionFunction()">
                                    <input type="button" value="Configurações" onkeypress="return false" onkeydown="return false" onclick="showDesktopSettings()" style="height:28px">
                                    <input type="button" onkeypress="return false" onkeydown="return false" value="Ações de energia ..." onclick="showPowerActionDlg()" style="display:none;height:28px">
                                    ...
                                    <input type="button" id="DeskScreens" value="Telas" onkeypress="return false" onkeydown="return false" onclick="deskSelectScreens()" style="display:none;height:28px">
                                    <label><span id="DeskControlSpan" style="display:none"><input id="DeskControl" type="checkbox" onkeypress="return false" onkeydown="return false">Entrada</span></label>
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div id="termTable" style="position:absolute;top:0;bottom:0;left:0;right:0">
                            <div id="termarea1">
                                <div class="areaHead" style="line-height:24px">
                                    <div class="toright2">
                                        <input type="button" id="termFullScreen" value="Tela cheia" onclick="deskToggleFull(event)" onkeypress="return false" onkeydown="return false" disabled="disabled" style="height:28px;margin-right:3px;">
                                    ...
                                    <div>
                                        ...
                                        <span id="connectbutton2sspan" style="margin-right:4px"><input type="button" id="connectbutton2s" value="Conexão SSH" style="height:28px" onclick="connectTerminal(event,3)" onkeypress="return false" onkeydown="return false" disabled="disabled"></span>
                            ...
                            <div id="termarea4" style="position:relative;height:32px;">
                                <div class="areaFoot">
                                    ...
                                    <div style="height:28px">
                                        <input id="termActionsBtn" style="margin-left:3px;height:28px" type="button" title="Execute ações de energia no dispositivo" onkeypress="return false" onkeydown="return false" value="Ações" onclick="deviceActionFunction()">
                                        ...
                                        <input id="ctrlxbutton" style="margin-left:3px;height:28px" type="button" onkeypress="return false" onkeydown="return false" value="Ctrl-X" onclick="termSendKey(24,'ctrlxbutton')">
                        ...
                        <table id="p13toolbar" style="width:100%;height:111px" cellpadding="0" cellspacing="0">
                            <tbody><tr>
                                <td style="background-color:#C0C0C0;border-bottom:2px solid black;padding:2px;line-height:24px">
                                    <div style="float:right;text-align:right">
                                        <input id="filesActionsBtn" type="button" onkeypress="return false" onkeydown="return false" value="Ações" onclick="deviceActionFunction()" style="margin-right:2px">
                                    ...
                                    <div style="margin-left:2px">
                                        ...
                                        <input id="p13Connects" value="Conexão SFTP" onclick="connectFiles(event,2)" onkeypress="return false" onkeydown="return false" type="button">
                            ...
                            <tr>
                                <td style="width:100%;background-color:#d3d9d6;text-align:left;padding:4px" valign="bottom">
                                    <div style="width:100%;text-align:center">
                                        <input type="button" style="width:calc(100%/5 - 5px)" id="p13FolderUp" disabled="disabled" onclick="p13folderup()" value="Cima">
                                        <input type="button" style="width:calc(100%/5 - 5px)" id="p13SelectAllButton" disabled="disabled" onclick="p13selectallfile()" value="Selecionar tudo" onkeypress="return false" onkeydown="return false">
                                        <input type="button" style="width:calc(100%/5 - 5px)" id="p13RenameFileButton" disabled="disabled" value="Renomear" onclick="p13renamefile()" onkeypress="return false" onkeydown="return false">
                                        <input type="button" style="width:calc(100%/5 - 5px)" id="p13DeleteFileButton" disabled="disabled" value="Excluir" onclick="p13deletefile()" onkeypress="return false" onkeydown="return false">
                                        <input type="button" style="width:calc(100%/5 - 5px)" id="p13NewFolderButton" disabled="disabled" value="Pasta" onclick="p13createfolder()" onkeypress="return false" onkeydown="return false">
                                    </div>
                                    <div style="width:100%;text-align:center">
                                        <input type="button" style="width:calc(100%/5 - 5px)" id="p13UploadButton" disabled="disabled" value="Carregar" onclick="p13uploadFile()" onkeypress="return false" onkeydown="return false">
                                        <input type="button" style="width:calc(100%/5 - 5px)" id="p13CutButton" disabled="disabled" value="Recortar" onclick="p13copyFile(1)" onkeypress="return false" onkeydown="return false">
                                        ...
                                        <input type="button" style="width:calc(100%/5 - 5px)" id="p13PasteButton" disabled="disabled" value="Colar" onclick="p13pasteFile()" onkeypress="return false" onkeydown="return false">
                                        <input type="button" style="width:calc(100%/5 - 5px)" id="p13RefreshButton" disabled="disabled" value="Atualizar" onclick="p13folderup(9999)" onkeypress="return false" onkeydown="return false">
                                    </div>
                                </td>
                            </tr>
                            <tr>
                            ...
                            <tbody><tr style="height:28px">
                                <td class="areaHead">
                                    <div class="toright2">
                                        ...
                                        <input type="button" id="p15uploadCore" value="Ação do Agente" onclick="p15uploadCore(event)">
                                    </div>
                                ...
                                <td class="areaFoot">
                                    <table style="width:100%">
                                        <tbody><tr>
                                            ...
                                            <td style="width:1%"><input id="id_p15consoleClear" type="button" class="bottombutton" value="Apagar" onclick="p15consoleClear()"></td>
                                        </tr>
                                    </tbody></table>
                                </td>
                            </tr>
    ...
    <div id="dialog" style="display:none">
        ...
        <div style="margin-right:16px;margin-left:8px">
            ...
            <div id="dialog3" style="margin:auto;margin:3px">
                <select id="deskkeys" style="width:100%">
                    ...
                    <option value="0">Win + Baixo</option>
                    <option value="1">Win + Esquerda</option>
            ...
            <div id="dialog4" style="margin:auto;margin:3px">
                ...
                <div id="d3servermode">
                    <div id="d3serveraction" valign="bottom">
                        <input type="button" id="p3FolderUp" disabled="disabled" onclick="d3folderup()" value="Cima">&nbsp;<span id="p3CurrentFolder"></span>
                    </div>
            ...
            <div id="dialog7" style="margin:auto;margin:3px">
                <div id="d7meshkvm">
                    <h4 style="width:100%;border-bottom:1px solid gray">Agente de Desktop Remoto</h4>
                    <table style="width:100%">
                        <tbody><tr>
                            <td>
                                Qualidade
                        ...
                        <tr>
                            ...
                            <td style="width:100px">
                                <select id="d7framelimiter" style="float:right;width:200px" dir="rtl">
                                    ...
                                    <option value="1000">Muito lento</option>
                                </select>
                            </td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                            <td></td>
                            <td>
                                <label style="display:block" id="d7deskAutoLockLabel"><input type="checkbox" id="d7deskAutoLock">Bloquear ao Desconectar</label>
                            </td>
                        </tr>
                    </tbody></table>
                </div>
                <div id="d7amtkvm">
                    <h4 style="width:100%;border-bottom:1px solid gray">Hardware KVM Intel® AMT</h4>
                    <table style="width:100%">
                        <tbody><tr>
                            <td>Codificação</td>
                            <td style="width:100px">
        ...
        <div id="idx_dlgButtonBar" style="padding:10px;margin-bottom:20px">
            ...
            <div><input id="idx_dlgDeleteButton" type="button" value="Excluir" style="display:none" onclick="dialogclose(2)"></div>
        </div>
    </div>
    <div id="topMenu" style="z-index:1000;background-color:#EEE;box-shadow:0px 0px 15px #666;font-family:Arial,Helvetica,sans-serif;border-radius:0px 0px 5px 5px;position:fixed;top:50px;right:5px;width:170px;display:none">
        <div style="padding:12px;border-top:1px solid gray;color:black;cursor:pointer" onclick="topMenu(2)">Meus Arquivos</div>
        <div style="padding:12px;border-top:1px solid gray;color:black;cursor:pointer" onclick="topMenu(1)">Minha conta</div>
        <div id="logoutMenuOption"><a id="logoutMenuOptionRef" href="/logout"><div style="padding:12px;border-top:1px solid gray;color:black;cursor:pointer">Sair</div></a></div>
    </div>
    ...
    <script>
        ...
        function onStateChanged(server, state, prevState, errorCode) {
            if (state == 0) {
                ...
                if (errorCode == 'noauth') { QH('p0span', "Não foi possível realizar autenticação"); return; }
                if (prevState == 2) { setTimeout(serverPoll, 5000); } else { QH('p0span', "Não foi possível conectar web socket"); }
                // Clean up here
        ...
        function updateSelf() {
            ...
            if (typeof userinfo.passchange == 'number') {
                if (userinfo.passchange == -1) { QH('p2nextPasswordUpdateTime', " - Reinicie no próximo login."); }
                    ...
                    if (seconds < 0) { QH('p2nextPasswordUpdateTime', " - Reinicie no próximo login."); }
                    else if (seconds < 3600) { var secs = Math.floor(seconds / 60); QH('p2nextPasswordUpdateTime',format((secs == 1)?" - Reinicie em 1 minuto.":" - Reinicie em {0} minutos.", secs)); }
                    else if (seconds < 86400) { var hours = Math.floor(seconds / 3600); QH('p2nextPasswordUpdateTime', format((hours == 1) ? " - Reinicie em 1 hora." : " - Reinicie em {0} horas.", hours)); }
                    else { var days = Math.floor(seconds / 86400); QH('p2nextPasswordUpdateTime', format((hours == 1) ? " - Reinicie em 1 dia." : " - Reinicie em {0} dias.", days)); }
                }
            }
        }
            ...
            switch (message.action) {
                case 'serverinfo': {
                    ...
                    if (serverinfo.certExpire != null) {
                        ...
                        if ((days >= 0) && (days < 20)) {
                            addNotification({ text: format("O certificado expira em {0} dia (s)", days) });
                        }
                    }
                ...
                case 'otpauth-request': {
                    if ((xxdialogMode == 2) && (xxdialogTag == 'otpauth-request')) {
                        if (message.err != null) {
                            var otpauthErrors = ['', "2FA está bloqueado", "Os códigos de backup estão bloqueados", "Token de login em uso", "OTP 2FA não permitido", "Esta conta está bloqueada", "Não foi possível carregar o OTPLIB"];
                            if ((message.err > 0) && (message.err < otpauthErrors.length)) { QH('d2optinfo', otpauthErrors[message.err]); } else { QH('d2optinfo', format("Erro #{0}", message.err)); }
                        } else {
                ...
                case 'otpauth-setup': {
                    ...
                    setDialogMode(2, "App autenticador", 1, null, message.success ? ('<b style=color:green>' + "A ativação do aplicativo Authenticator foi bem-sucedida." + '</b> ' + "Agora você precisará de um token válido para fazer o login novamente.") : ('<b style=color:red>' + "Falha na ativação do login em 2 etapas." + '</b> ' + "Apague o segredo do aplicativo e tente novamente. Você tem apenas alguns minutos para inserir o código adequado."));
                    break;
                }
                case 'otpauth-clear': {
                    if (xxdialogMode) return;
                    setDialogMode(2, "App autenticador", 1, null, message.success ? ('<b>' + "O aplicativo do autenticador foi removido." + '</b> ' + "Você pode reativar esse recurso a qualquer momento.") : ('<b style=color:red>' + "Falha na remoção da ativação do login em 2 etapas." + '</b> ' + "Tente novamente."));
                    break;
                }
                case 'otpauth-getpasswords': {
                    if (xxdialogMode) return;
                    var x = "Os tokens únicos podem ser usados ​​como autenticação secundária. Gere um conjunto, imprima-os e guarde-os em local seguro.";
                    ...
                    if (message.passwords) {
                        ...
                        x += '<tr><td>' + "Sem Tokens Ativos";
                    }
                    x += '</table></div></div><br />';
                    x += '<div><input type=button value=\'' + "Fechar" + '\' onclick=setDialogMode(0) style=float:right></input>';
                    x += '<input type=button value=\'' + "Novos Tokens" + '\' onclick=\'account_manageOtp(1);\'></input>';
                    if (message.passwords != null) { x += '<input type=button value=\'' + "Apagar" + '\' onclick=\'account_manageOtp(2);\'></input>'; }
                    x += '</div><br />';
                ...
                case 'verifyPhone': {
                    ...
                    x += '<br /><br /><div style=width:100%;text-align:center>' + "Código de verificação:" + ' <input type=tel pattern="[0-9]" inputmode="number" maxlength=6 id=d2phoneCodeInput onKeyUp=account_managePhoneCodeValidate() onkeypress="if (event.key==\'Enter\') account_managePhoneCodeValidate(1)"></div></table>';
                    setDialogMode(2, "Notificações por telefone", 3, account_managePhoneConfirm, x, message.cookie);
                    ...
                    if ((xxdialogMode == 2) && (xxdialogTag == 'previousLogins')) {
                        ...
                        if (message.events.length == 0) {
                            ...
                            for (var i in message.events) {
                                ...
                                if (m == 107) { m = "Login válido"; c = 'BBD1BB'; xx = ''; }
                                else if (m == 108) { m = "2FA inválido"; c = 'DD9DC3'; xx = 'x'; }
                                else if (m == 109) { m = "Conta bloqueada"; c = 'E1BBBB'; xx = 'x'; }
                                else if (m == 110) { m = "Senha inválida"; c = 'E1BBBB'; xx = 'x'; }
                        ...
                        setDialogMode(2, "Logins anteriores", 1, null, x);
                    }
                    break;
                }
                case 'event': {
        ...
        function goStack() {
            ...
            if (idtype == 'files') {
                ...
                if ((features & 0x00040000) && !((userinfo.otpsecret == 1) || (userinfo.otphkeys > 0) || (userinfo.otpkeys > 0) || (userinfo.otpduo > 0) || (userinfo.otpdev > 0) || ((features & 0x00800000) && (userinfo.otpekey == 1)))) { setDialogMode(2, "Segurança da conta", 1, null, "Unable to access this feature until two-factor authentication is enabled. This is required for extra security. Go to the \"My Account\" and look at the \"Account Security\" section."); return; }  
                go(5);
            }
        }
        ...
        function account_viewPreviousLogins() {
            if (xxdialogMode) return;
            setDialogMode(2, "Logins anteriores", 1, null, "Carregando...", 'previousLogins');
        ...
        function account_manageImage(mode) {
            ...
            setDialogMode(2, "Gerenciar imagem da conta", 7, account_manageImageEx2, x, user._id);
        ...
        function toggleNightMode() {
            ...
            var x = '<input type=radio id=night0 name=nightmoderadio value=0 ' + ((cNightMode == 0) ? 'checked' : '') + '><label for=night0>' + "Navegador padrão" + '</label><br>';
            x += '<input type=radio id=night2 name=nightmoderadio value=2 ' + ((cNightMode == 2) ? 'checked' : '') + '><label for=night2>' + "Modo claro" + '</label><br>';
            x += '<input type=radio id=night1 name=nightmoderadio value=1 ' + ((cNightMode == 1) ? 'checked' : '') + '><label for=night1>' + "Modo escuro" + '</label><br>';
            setDialogMode(2, "Modo noturno", 3, toggleNightModeEx, x);
            QV('uiMenu', false);
        }
        ...
        function account_managePhone() {
            ...
            if (userinfo.phone != null) {
                ...
                x += '<td style=text-align:center><div style=padding:6px>' + "Número de telefone verificado" + '</div><div style=font-size:20px>' + userinfo.phone + '</div>';
                x += '<div style=margin:10px><label><input id=d2delPhone type=checkbox onclick=account_managePhoneRemoveValidate() />' + "Remover número de telefone" + '</label></div>';
                setDialogMode(2, "Notificações por telefone", 3, account_managePhoneRemove, x);
                ...
                x += '<br /><br /><div style=width:100%;text-align:center>' + "Número de telefone:" + ' <input type=tel pattern="[0-9]" autocomplete="tel" inputmode="tel" maxlength=18 id=d2phoneinput onKeyUp=account_managePhoneValidate() onkeypress="if (event.key==\'Enter\') account_managePhoneValidate(1)"></div></table>';
                setDialogMode(2, "Notificações por telefone", 3, account_managePhoneAdd, x, 'verifyPhone');
        ...
        function account_showLocalizationSettings() {
            ...
            if (serverinfo.languages && serverinfo.languages.length > 0) {
                ...
                var z = '<select id=d2langselect style=width:180px><option value="*">' + "Valor do navegador do usuário" + '</option>';
                ...
                z += '</select>';
                y += addHtmlValue("Idiomas", z);
            }
            y += addHtmlValue("Datas e Horários", x);

            if ((userinfo.siteadmin == 0xFFFFFFFF) && (domain == '')) {
                y += '<br /><a rel="noreferrer noopener" target="_blank" href="translator.htm">' + "Ajude a traduzir o MeshCentral" + '</a>';
            }

            setDialogMode(2, "Configurações de idioma", 3, account_showLocalizationSettingsEx, y);
            return false;
        }
        ...
        function account_addOtp() {
            ...
            setDialogMode(2, "App autenticador", 2, function () { meshserver.send({ action: 'otpauth-setup', secret: Q('d2optsecret').attributes.secret.value, token: Q('d2otpauthinput').value }); }, '<div id=d2optinfo>' + "Carregando..." + '</div>', 'otpauth-request');
        ...
        function account_removeOtp() {
            if (xxdialogMode || (userinfo.otpsecret != 1) || ((features & 4096) == 0)) return;
            setDialogMode(2, "App autenticador", 3, function () { meshserver.send({ action: 'otpauth-clear' }); }, "Confirma a remoção do login em 2 etapas do aplicativo autenticador?");
        }
        ...
        function account_showVerifyEmail() {
            ...
            var x = "Clique em ok para enviar um e-mail de verificação para:" + '<br /><div style=padding:8px><b>' + EscapeHtml(userinfo.email) + '</b></div>' + "Aguarde alguns minutos para receber a verificação.";
        ...
        function account_showChangeEmail() {
            ...
            setDialogMode(2, "Mudança de endereço de email", 3, account_changeEmail, x);
        ...
        function account_showChangePassword() {
            ...
            if (passRequirements) {
                ...
                if (rc > 0) { x += '<br /><span style=font-size:x-small>' + format("Requisitos: {0}.", r.join(', ')) + '</span>'; }
            }
            x += '<br />';
            setDialogMode(2, "Alterar senha", 3, account_showChangePasswordEx, x);
            Q('apassword0').focus();
        ...
        function account_createMesh() {
            ...
            if ((userinfo.siteadmin != 0xFFFFFFFF) && ((userinfo.siteadmin & 64) != 0)) { setDialogMode(2, "Novo Grupo de Dispositivos", 1, null, "Esta conta não tem direitos para criar um novo grupo de dispositivos."); return; }

            // Remind the user to verify the email address
            if ((userinfo.emailVerified !== true) && (serverinfo.emailcheck == true) && (userinfo.siteadmin != 0xFFFFFFFF)) { setDialogMode(2, "Segurança da conta", 1, null, "Incapaz de acessar um dispositivo até que um endereço de e-mail seja verificado. Isso é necessário para recuperação de senha. Vá para \"Minha conta\" para alterar e verificar um endereço de e-mail."); return; }

            // Remind the user to add two factor authentication
            if ((features & 0x00040000) && !((userinfo.otpsecret == 1) || (userinfo.otphkeys > 0) || (userinfo.otpkeys > 0) || (userinfo.otpduo > 0) || (userinfo.otpdev > 0) || ((features & 0x00800000) && (userinfo.otpekey == 1)))) { setDialogMode(2, "Segurança da conta", 1, null, "Incapaz de acessar um dispositivo até que a autenticação de dois fatores seja ativada. Isso é necessário para segurança extra. Vá para \"Minha conta\" e verifique a seção \"Segurança da conta\"."); return; }
            ...
            x += addHtmlValue("Tipo", '<div style=width:170px;margin:0;padding:0><select id=dp3meshtype style=width:100% onchange=account_validateMeshCreate() ><option value=2>' + "Grupo de Software Agente" + '</option><option value=1>' + "Intel&reg;Apenas AMT" + '</option></select></div>');
            x += addHtmlValue("Descrição", '<div style=width:170px;margin:0;padding:0><textarea id=dp3meshdesc maxlength=1024 style=width:100%;resize:none></textarea></div>');
            setDialogMode(2, "Criar Grupo de Dispositivos", 3, account_createMeshEx, x);
        ...
        function updateFiles() {
            ...
            var html1 = '', html2 = '', displayPath = '<a style=cursor:pointer;color:black onclick=p5folderup(0)>' + "Raiz" + '</a>', fullPath = 'Root', publicPath, filetreex = filetree, folderdepth = 1;
        ...
        function getNiceSize(bytes) {
            if (bytes <= 0) return "Armazenamento excedido";
        ...
        function p5showPublicLink(u) { setDialogMode(2, "Link Público", 1, null, '<input type=text style=width:100% value="' + u + '" readonly />'); }
        ...
        function p5setActions() {
            ...
            Q('p5SelectAllButton').value = (cc > 0 ? "Nenhum" : "Tudo");
        ...
        function p5deletefile() { var cc = getFileSelCount(), rec = (getFileSelDirCount() > 0) ? '<br /><br /><label><input type=checkbox id=p5recdeleteinput>' + "Exclusão recursiva" + '</label><br>' : '<input type=checkbox id=p5recdeleteinput style=\'display:none\'>'; setDialogMode(2, "Excluir", 3, p5deletefileEx, (cc > 1) ? (format("Excluir {0} itens selecionados?", cc) + rec) : ("Excluir o item selecionado?" + rec)); }
        ...
        function p5pasteFile() { var x = ''; if ((p5clipboard != null) && (p5clipboard.length > 0)) { x = format("Confirma {0} de {1} entrada {2} neste local?", (p5clipboardCut == 0 ? 'copy' : 'move'), p5clipboard.length, ((p5clipboard.length > 1) ? 's' : '')) } setDialogMode(2, "Colar", 3, p5pasteFileEx, x); }
        ...
        function p5updateClipview() { var x = ''; if ((p5clipboard != null) && (p5clipboard.length > 0)) { x = format("Segurando {0} entrie {1} para {2}", p5clipboard.length, ((p5clipboard.length > 1) ? 's' : ''), (p5clipboardCut == 0 ? "Copiar" : "Mover")) + ', <a href=# onclick="return p5clearClip()" style=cursor:pointer>' + "Apagar" + '</a>.' } QH('p5bottomstatus', x); p5setActions(); }
        ...
        function updateDevices() {
            ...
            for (var i in nodes) {
                ...
                if (sort == 0) {
                    ...
                    if (((meshes[nodes[i].meshid]?nodes[i].meshid:'*') != current)) {
                        deviceHeaderSet();
                        var extra = '';
                        if ((meshes[nodes[i].meshid] != null) && (meshes[nodes[i].meshid].mtype == 1)) { extra = '<span style=color:lightgray>' + ", Intel&reg; apenas AMT" + '</span>'; }
                        ...
                        if (meshes[nodes[i].meshid]) {
                            ...
                            r += '</span><span id=MxMESH><i>' + "Dispositivos Individuais" + '</i></span><span id=DevxHeader' + deviceHeaderId + ' style=color:lightgray></span></div>';
                            current = '*';
                        }
            ...
            if ((r == '') && (nodes.length > 0) && (Q('SearchInput').value != '')) {
                viewNothing = true;
                r = '<div style="margin:30px">' + "Nenhum dispositivo corresponde a esta pesquisa." + '</div>';
            }
            ...
            if ((sort == 0) && (Q('SearchInput').value == '')) {
                for (var i in meshes) {
                    ...
                    if ((displayedMeshes[mesh._id] == null) && (IsMeshViewable(mesh))) {
                        ...
                        if (mesh.mtype == 1) { r += '<div style=padding:10px><i>' + "Nenhum dispositivo Intel&reg; AMT neste grupo"; }
                        if (mesh.mtype > 1) { r += '<div style=padding:10px><i>' + "Nenhum dispositivo neste grupo"; }
                        r += '.</i></div></div>';
                        current = mesh._id;
                        count++;
                    }
            ...
            if (count == 0) {
                if ((Q('SearchInput').value != '') || (Q('OnlineCheckBox').checked)) {
                    QH('xdevices', '<div style="margin-top:50px;text-align:center"><span style="font-size:30px">' + "Sem dispositivos" + '</span><br /><br />' + "Nenhum dispositivo corresponde a esta pesquisa." + ' <a onclick=clearSearchInput() style=cursor:pointer>' + "Apagar filtro de pesquisa" + '</a></div>');
                } else {
                    QH('xdevices', '<div style="margin-top:50px;text-align:center"><span style="font-size:30px">' + "Sem dispositivos" + '</span><br /><br />' + "Use a versão desktop deste site para adicionar dispositivos." + '</div>');
                }
            } else {
                QH('xdevices', r);
            }
            ...
            if ((div.offsetTop >= visibleTop) && (div.offsetTop < visibleBottom)) {
                ...
                if (node.sessions != null) {
                    ...
                    if (node.sessions.battery != null) {
                        ...
                        var statestr = '';
                        if (bat.state == 'ac') { statestr = "O dispositivo está conectado"; }
                        else if (bat.state == 'dc') { statestr = "O dispositivo é alimentado por bateria"; }
        ...
        function showDeviceHelpRequests(nodeid, force, e) {
            ...
            if (x != '') { setDialogMode(2, "Pedidos de ajuda" + ' - ' + EscapeHtml(node.name), 1, null, x, 'HELPREQ-' + node._id); } else { setDialogMode(0); }
            return false;
        }
        ...
        function showDeviceSessions(nodeid, force, e) {
            ...
            for (var i in node.sessions) {
                if ((i == 'kvm') && (node.sessions.multidesk == null)) {
                    x += '<u>' + "Área de trabalho remota" + '</u>';
                    for (var j in node.sessions.kvm) {
                        if (j.startsWith('user/')) {
                            var trash = '';
                            if ((j == userinfo._id) || (GetNodeRights(node) == 0xFFFFFFFF)) { trash = ' <a href=# onclick=\'return endDeviceSession("kvm", "' + encodeURIComponentEx(node._id) + '", "' + encodeURIComponentEx(j) + '")\' title="' + "Desconectar esta sessão" + '" style=cursor:pointer><img src=images/trash.png border=0 height=10 width=10></a>'; }
                            x += addHtmlValue4(getUserName(j), ((node.sessions.kvm[j] == 1) ? "1 sessão" : nobreak(format("{0} sessões", node.sessions.kvm[j]))) + trash);
                        } else if (j == 'busy') {
                            x += addHtmlValue2("O dispositivo esta ocupado", ((node.sessions.kvm[j] == 1) ? "1 sessão" : nobreak(format("{0} sessões", node.sessions.kvm[j]))));
                        }
                    }
                } else if (i == 'multidesk') {
                    x += '<u>' + "Área de trabalho remota" + '</u>';
                    for (var j in node.sessions.multidesk) {
                        var trash = '';
                        if ((j == userinfo._id) || (GetNodeRights(node) == 0xFFFFFFFF)) { trash = ' <a href=# onclick=\'return endDeviceSession("multidesk", "' + encodeURIComponentEx(node._id) + '", "' + encodeURIComponentEx(j) + '")\' title="' + "Desconectar esta sessão" + '" style=cursor:pointer><img src=images/trash.png border=0 height=10 width=10></a>'; }
                        x += addHtmlValue4(getUserName(j), ((node.sessions.multidesk[j] == 1) ? "1 sessão" : nobreak(format("{0} sessões", node.sessions.multidesk[j]))) + trash);
                    }
                } else if (i == 'terminal') {
                    x += '<u>' + "Terminal" + '</u>';
                    for (var j in node.sessions.terminal) {
                        var trash = '';
                        if ((j == userinfo._id) || (GetNodeRights(node) == 0xFFFFFFFF)) { trash = ' <a href=# onclick=\'return endDeviceSession("terminal", "' + encodeURIComponentEx(node._id) + '", "' + encodeURIComponentEx(j) + '")\' title="' + "Desconectar esta sessão" + '" style=cursor:pointer><img src=images/trash.png border=0 height=10 width=10></a>'; }
                        x += addHtmlValue4(getUserName(j), ((node.sessions.terminal[j] == 1) ? "1 sessão" : nobreak(format("{0} sessões", node.sessions.terminal[j]))) + trash);
                    }
                } else if (i == 'files') {
                    x += '<u>' + "Arquivos" + '</u>';
                    for (var j in node.sessions.files) {
                        var trash = '';
                        if ((j == userinfo._id) || (GetNodeRights(node) == 0xFFFFFFFF)) { trash = ' <a href=# onclick=\'return endDeviceSession("files", "' + encodeURIComponentEx(node._id) + '", "' + encodeURIComponentEx(j) + '")\' title="' + "Desconectar esta sessão" + '" style=cursor:pointer><img src=images/trash.png border=0 height=10 width=10></a>'; }
                        x += addHtmlValue4(getUserName(j), ((node.sessions.files[j] == 1) ? "1 sessão" : nobreak(format("{0} sessões", node.sessions.files[j]))) + trash);
                    }
                } else if (i == 'tcp') {
                    x += '<u>' + "Roteamento TCP" + '</u>';
                    for (var j in node.sessions.tcp) {
                        var trash = '';
                        if ((j == userinfo._id) || (GetNodeRights(node) == 0xFFFFFFFF)) { trash = ' <a href=# onclick=\'return endDeviceSession("tcp", "' + encodeURIComponentEx(node._id) + '", "' + encodeURIComponentEx(j) + '")\' title="' + "Desconectar esta sessão" + '" style=cursor:pointer><img src=images/trash.png border=0 height=10 width=10></a>'; }
                        x += addHtmlValue4(getUserName(j), ((node.sessions.tcp[j] == 1) ? "1 sessão" : nobreak(format("{0} sessões", node.sessions.tcp[j]))) + trash);
                    }
                } else if (i == 'udp') {
                    x += '<u>' + "Roteamento UDP" + '</u>';
                    for (var j in node.sessions.udp) {
                        var trash = '';
                        if ((j == userinfo._id) || (GetNodeRights(node) == 0xFFFFFFFF)) { trash = ' <a href=# onclick=\'return endDeviceSession("udp", "' + encodeURIComponentEx(node._id) + '", "' + encodeURIComponentEx(j) + '")\' title="' + "Desconectar esta sessão" + '" style=cursor:pointer><img src=images/trash.png border=0 height=10 width=10></a>'; }
                        x += addHtmlValue4(getUserName(j), ((node.sessions.udp[j] == 1) ? "1 sessão" : nobreak(format("{0} sessões", node.sessions.udp[j]))) + trash);
                    }
                }
            }
            if (x != '') { setDialogMode(2, "Sessões" + ' - ' + EscapeHtml(node.name), 1, null, x, 'SESSIONS-' + node._id); } else { setDialogMode(0); }
        }
        ...
        function showDeviceMessages(nodeid, force, e) {
            ...
            x += '</div>';
            if (count > 0) setDialogMode(2, "Mensagens do Agente" + ' - ' + EscapeHtml(node.name), 1, null, x, 'MESSAGES-' + node._id);
            return false;
        }

        var powerStatetable = ['', "Ligado", "Hibernar", "Hibernar", "Hibernar", "Hibernando", "Desligar", "Presente", "Desligado"];
        var powerStateStrings = ['', "Ligado", "Hibernando", "Hibernando", "Sono profundo", "Hibernando", "Soft-Off", "Presente", "Desligado"];
        var powerStateStrings2 = ['', "O dispositivo está ligado", "O dispositivo está em estado de suspensão (S1)", "O dispositivo está em estado de suspensão (S2)", "O dispositivo está em estado de sono profundo (S3)", "O dispositivo está hibernando (S4) ", "O dispositivo está em estado soft-off (S5)", "O dispositivo está presente, mas o estado de energia não pode ser determinado", "O dispositivo está desligado"];
        ...
        function NodeStateStr(node) {
            ...
            if (node.conn) {
                if ((node.conn & 1) != 0) { states.push('<span>' + ((node.mtype == 4) ? ((node.porttype == 'PDU') ? "Trocar" : "IP-KVM") : "Agente") + '</span>'); }
                if ((node.conn & 2) != 0) { states.push('<span>' + "CIRA" + '</span>'); }
                else if ((node.conn & 4) != 0) { states.push('<span>' + "Intel&reg; AMT" + '</span>'); }
                if ((node.conn & 8) != 0) { states.push('<span>' + "Retransmissão" + '</span>'); }
        ...
        */
        ...
        function gotoDevice(nodeid, panel, refresh) {
            ...
            if (!currentNode || currentNode._id != node._id || refresh == true) {
                ...
                if ((currentNode.sessions != null) && (currentNode.sessions.battery != null)) {
                    ...
                    var statestr = '';
                    if (bat.state == 'ac') { statestr = "O dispositivo está conectado"; }
                    if (bat.state == 'dc') { statestr = "O dispositivo é alimentado por bateria"; }
                ...
                if ((((features & 1) == 0) && (node.mtype != 4)) || (node.mtype == 3)) { // If not WAN-only, local hostname is in use
                    if ((meshrights & 4) != 0) {
                        if (node.host) {
                            x += addDeviceAttribute("Nome do Host", '<span onclick=showEditNodeValueDialog(1) style=cursor:pointer>' + EscapeHtml(node.host) + '</span>');
                        } else {
                            x += addDeviceAttribute("Nome do Host", '<span onclick=showEditNodeValueDialog(1) style=cursor:pointer><i>' + "Nenhum" + '</i></span>');
                        }
                    } else {
                        x += addDeviceAttribute("Nome do Host", EscapeHtml(node.host));
                    }
                }
                ...
                if ((meshrights & 4) != 0) {
                    x += addDeviceAttribute("Descrição", '<span onclick=showEditNodeValueDialog(2) style=cursor:pointer>' + description + '</span>');
                } else {
                ...
                // IP-KVM information
                if (node.mtype == 4) {
                    if (node.portnum != null) { x += addDeviceAttribute("Número da Porta", node.portnum); }
                    if (node.porttype != null) { x += addDeviceAttribute("Tipo de Porta", node.porttype); }
                }
                ...
                if ((node.agent != null) && (node.agent.id != null) && (node.mtype == 3)) {
                    ...
                    if (node.agent.id == 29) { x += addDeviceAttribute("Tipo de dispositivo", "Mac OS"); }
                    ...
                    if ((node.agent.root === false) && ((node.conn & 1) != 0)) { str += ', ' + "Restrito"; }
                ...
                if (node.intelamt != null) {
                    var str = '';
                    var provisioningStates = { 0: nobreak("Não ativado (pré)"), 1: nobreak("Não ativado (In)"), 2: nobreak("ativado") };
                    if (node.intelamt.ver != null && node.intelamt.state == null) { str += '<i>' + nobreak("Estado Desconhecido") + '</i>, v' + EscapeHtml(node.intelamt.ver); }
                    else if ((node.intelamt.ver == null) && (node.intelamt.state == 2)) { str += '<i>' + "ativado" + '</i>'; }
                    else if ((node.intelamt.ver == null) || (node.intelamt.state == null)) { str += '<i>' + "Versão e estado desconhecidos" + '</i>'; }
                    else {
                    ...
                    if (node.intelamt.state == 2) {
                        if (node.intelamt.tls == 1) { str += ', <span title="' + "Intel&reg; AMT está configurado com segurança de rede TLS" + '">' + "TLS" + '</span>'; }
                        ...
                        if (node.intelamt.user == null || node.intelamt.user == '') { // If credentials are not set, allow setting them.
                            if ((meshrights & 4) != 0) {
                                str += ', <i style=color:#FF0000;cursor:pointer title="' + "Editar credenciais Intel&reg; AMT" + '" onclick=editDeviceAmtSettings("' + node._id + '")>' + "Sem credenciais" + '</i>';
                            ...
                            var warn = null;
                            if ((node.intelamt.warn & 1) != 0) { warn = "Credenciais inválidas"; }
                            if ((node.intelamt.warn & 8) != 0) { warn = "Tentando credenciais"; }
                            if (warn != null) {
                                if ((meshrights & 4) != 0) {
                                    str += ', <i style=color:#FF0000;cursor:pointer title="' + "Editar credenciais Intel&reg; AMT" + '" onclick=editDeviceAmtSettings("' + node._id + '")>' + warn + '</i>';
                                    editUserCredentialsIcon = true;
                                } else {
                        ...
                        if (editUserCredentialsIcon) {
                            str += '<img src=images/link4.png height=10 width=10 title="' + "Editar credenciais Intel&reg; AMT" + '" style=cursor:pointer onclick=editDeviceAmtSettings("' + node._id + '")>';
                        }
                    }
                ...
                if ((node.agent != null) && (node.agent.tag != null) && (node.agent.tag != 'mailto:')) {
                    ...
                    x += addDeviceAttribute("Tags do Agente", tag);
                }
                ...
                if (connectivity && connectivity > 1) {
                    var cstate = [];
                    if ((node.conn & 1) != 0) cstate.push('<span>' + ((node.mtype == 4) ? ((node.porttype == 'PDU') ? "Trocar" : "IP-KVM") : "Agente") + '</span>');
                    if ((node.conn & 2) != 0) cstate.push('<span>' + "Intel&reg; AMT CIRA" + '</span>');
                    else if ((node.conn & 4) != 0) cstate.push('<span>' + "Intel&reg; AMT" + '</span>');
                    if ((node.conn & 8) != 0) cstate.push('<span>' + "Agente de Retransmissão" + '</span>');
                ...
                if ((meshrights & 4) != 0) {
                    x += addDeviceAttribute("Etiqueta", '<span onclick=showEditNodeValueDialog(3) style=cursor:pointer;color:black>' + groupingTags + '</span>');
                } else {
                    x += addDeviceAttribute("Etiqueta", '<span style=line-height:26px;color:black>' + groupingTags + '</span>');
                }
                ...
                if ((node.ssh != null) || (node.rdp != null)) {
                    var y = [];
                    if ((meshrights & 4) != 0) {
                        if (node.ssh != null) { y.push('<span onclick=showClearSshDialog(3) style=cursor:pointer>' + ((node.ssh == 1) ? "SSH-Usuário+Pass" : ((node.ssh == 2) ? "SSH-Usuário+Chave+Pass" : "SSH-Usuário+Chave")) + ' <img class=hoverButton src="images/link5.png" width=10 height=10 /></span>'); }
                        ...
                        if (node.ssh != null) { y.push(((node.ssh == 1) ? "SSH-Usuário+Pass" : ((node.ssh == 2) ? "SSH-Usuário+Chave+Pass" : "SSH-Usuário+Chave"))); }
                        if (node.rdp != null) { y.push("RDP"); }
                    }
                    x += addDeviceAttribute("Credenciais", y.join(', '));
                }

                x += '</table><br />';
                // Show action button, only show if we have permissions 4, 8, 64
                if (((meshrights & (4 + 8 + 64 + 262144)) != 0) && (node.mtype < 3)) { x += '<input type=button value="' + "Ações" + '" onclick=deviceActionFunction() />'; }
                ...
                if ((node.mtype == 4) && (connectivity & 1)) {
                    if (node.porttype == 'PDU') {
                        if (node.pwr == 1) {
                            if (meshrights & 0x40000) { x += '<input type=button value="' + "Desligar" + '" title="' + "Desligar" + '" onclick=setIpPduState(0) />'; }
                        } else if (node.pwr == 8) {
                            if (meshrights & 0x40) { x += '<input type=button value="' + "Ligar" + '" title="' + "Ligar" + '" onclick=setIpPduState(1) />'; }
                        }
                    } else {
                        if (meshrights & 8) { x += '<input type=button value="' + "Controle remoto" + '" title="' + "Controle remoto" + '" onclick=openIpKvmRemoteControl("' + encodeURIComponentEx(node._id) + '") />'; }x
                    }
                }
                ...
                if ((meshrights & 0x8000) != 0) { x += '<a style=cursor:pointer onclick=p10showDeleteNodeDialog("' + node._id + '")>' + "Apagar Dispositivo" + '</a>'; }
                ...
                if ((connectivity & 1) != 0) { if (powerstate.length > 0) { powerstate += ', '; } powerstate += ((node.mtype == 4) ? ((node.porttype == 'PDU') ? "Trocar" : "IP-KVM") : "Agente Mesh"); }
        ...
        function setIpPduState(op) {
            if (op == 0) {
                setDialogMode(2, "Operação de energia", 3, function () { meshserver.send({ action: 'poweraction', nodeids: [currentNode._id], actiontype: 2 }); }, "Desligar?"); // Turn off
            } else {
                setDialogMode(2, "Operação de energia", 3, function () { meshserver.send({ action: 'wakedevices', nodeids: [currentNode._id] }); }, "Ligar"); // Turn on
            }
        }
        ...
        function deviceToastFunction() {
            if (xxdialogMode) return;
            setDialogMode(2, "Brinde do dispositivo", 3, deviceToastFunctionEx, '<textarea id=d2devToast style=width:100%;height:80px;resize:none;overflow-y:scroll></textarea>');
        }
        ...
        function setupDeviceMenu(op, obj) {
            ...
            var menus = [];
            if (currentDevicePanel != 0) { menus.push({ n: "Geral", f: 'setupDeviceMenu(0)' }); }
            ...
            ) { menus.push({ n: "Área de Trabalho", f: 'setupDeviceMenu(1)' }); }
            ...
            if ((currentDevicePanel != 2) && (currentNode != null) && (meshrights & 8) && ((meshrights == 0xFFFFFFFF) || ((meshrights & 1024) == 0)) && ((currentNode.mtype != 1) && (currentNode.agent) && (currentNode.agent.caps & 4))) { menus.push({ n: "Arquivos", f: 'setupDeviceMenu(2)' }); }
            if ((currentDevicePanel != 3) && (currentNode != null) && (currentNode.mtype < 3) && ((meshrights & 1048576) != 0)) { menus.push({ n: "Detalhes", f: 'setupDeviceMenu(3)' }); }
        ...
        function deviceActionFunction() {
            ...
            if ((currentNode.agent != null) && (currentNode.agent.id == 14)) {
                if (((currentNode.conn & 1) != 0) && ((rights & 8) != 0)) {
                    count++;
                    y += '<option value=400>' + "Clarão" + '</option>';
                    y += '<option value=401>' + "Vibrar" + '</option>';
                    z += '<div id=d2devicetimediv>' + addHtmlValue("Tempo", '<select id=d2devicetime style=float:right;width:170px><option value=1000>' + "1 segundo" + '</option><option value=5000>' + "5 segundos" + '</option><option value=10000>' + "10 segundos" + '</option></select>') + '</div>';
                }
            } else {
                if ((rights & 64) != 0) { count++; y += '<option value=100>' + "Acordar (Wake-up)" + '</option>'; } // Wake-up permission
                //if (((currentNode.conn & 1) != 0) && ((rights & 131072) != 0)) { count++; y += '<option value=106>' + "Run Commands" + '</option>'; } // Remote command permission
                if ((currentNode.conn != 0) && ((rights & 262144) != 0)) { count++; y += '<option value=4>' + "Hibernar" + '</option><option value=3>' + "Reiniciar" + '</option><option value=2>' + "Desligar" + '</option>'; }
                ...
                if ((currentNode.intelamt != null) && (currentNode.intelamt.state == 2) && ((currentNode.conn & 6) != 0) && ((rights & 262144) != 0)) {
                    count++;
                    y += '<option value=310>' + "Reinicialização Intel&reg; AMT" + '</option>';
            ...
            if (count == 0) { x = "Nenhuma ação disponível atualmente para este dispositivo."; }
            setDialogMode(2, "Ação do dispositivo", (count == 0) ? 2 : 3, deviceActionFunctionEx, x + z);
        ...
        function deviceActionFunctionEx() {
            ...
            if (op == 100) {
                ...
                */
                ...
                setDialogMode(2, "Operação de energia Intel&reg; AMT", 3, function () { meshserver.send({ action: 'poweraction', nodeids: [currentNode._id], actiontype: parseInt(op) }); }, "Ligar o Intel&reg; AMT?");
            } else if (op == 308) { // Intel AMT power off
                setDialogMode(2, "Operação de energia Intel&reg; AMT", 3, function () { meshserver.send({ action: 'poweraction', nodeids: [currentNode._id], actiontype: parseInt(op) }); }, "Perform Intel&reg; AMT power off?<br><br><b>NOTE: If there is an active AMT session, then power off command will be rejected, so you must disconnect from the AMT session first!</b>");
            } else if (op == 310) { // Intel AMT reset
                setDialogMode(2, "Operação de energia Intel&reg; AMT", 3, function () { meshserver.send({ action: 'poweraction', nodeids: [currentNode._id], actiontype: parseInt(op) }); }, "Realizar redefinição do Intel&reg; AMT?");
        ...
        function showNotes(readonly, noteid) {
            ...
            if (noteid.startsWith('node%2F%2F')) { x += '<span style=font-size:10px>' + "As notas de grupos de dispositivos podem ser visualizadas e alteradas por outros administradores de grupos de dispositivos." + '<span>'; }
        ...
        function deviceLockFunction() {
            if ((xxdialogMode != null || xxdialogMode == 0) && (desktop != null) && (desktop.contype == 1)) { setDialogMode(2, "Bloquear Desktop", 3, function() { if ((desktop != null) && (desktop.contype == 1)) { desktop.sendCtrlMsg('{"ctrlChannel":"102938","type":"lock"}'); } }, "Bloquear a área de trabalho do usuário?"); }
        }

        function deviceChat(e) {
            if (xxdialogMode) return;
            setDialogMode(2, "Ação do dispositivo", 3, function () {
        ...
        function deviceUrlFunction() {
            if (xxdialogMode) return;
            setDialogMode(2, "Abrir página no dispositivo", 3, deviceUrlFunctionEx, '<input id=d2devurl placeholder="http://server.com" style=width:100%;overflow-y:scroll onkeyup=deviceUrlFunctionValidate() onchange=deviceUrlFunctionValidate()></input>');
            Q('d2devurl').focus();
        ...
        function d2runCommandDialog(options) {
            ...
            if ((wintype == true) || (linuxtype == true) || (agenttype == true)) {
                ...
                if (wintype == true) { x += '<option value=1' + ((runopt.type == 1)?' selected':'') + '>' + "Prompt de comando do Windows" + '</option><option value=2' + ((runopt.type == 2)?' selected':'') + '>' + "Windows PowerShell" + '</option>'; }
                if (linuxtype == true) { x += '<option value=3' + ((runopt.type == 3)?' selected':'') + '>' + "Shell de comando Linux / BSD / macOS" + '</option>'; }
                if (agenttype == true) { x += '<option value=4' + ((runopt.type == 4)?' selected':'') + '>' + "Console do Agente" + '</option>'; } // MESHRIGHT_REMOTECONTROL & MESHRIGHT_AGENTCONSOLE are needed
                x += '</select>';
                x += '<select id=d2cmduser style=width:100%;margin-bottom:4px><option value=0' + ((runopt.runAs == 0)?' selected':'') + '>' + "Executar como agente" + '</option><option value=1' + ((runopt.runAs == 1)?' selected':'') + '>' + "Executar como usuário, agente se nenhum usuário" + '</option><option value=2' + ((runopt.runAs == 2)?' selected':'') + '>' + "Deve ser executado como usuário" + '</option></select>';
                ...
                setDialogMode(2, "Executar comandos", 3, d2groupActionFunctionRunCommands, x, options);
                if (options.selectedFile == null) {
                    Q('d2runcmd').focus();
        ...
        function editDeviceAmtSettings(nodeid, func) {
            ...
            x += addHtmlValue("Nome do usuário", '<input id=dp10username style=width:170px maxlength=32 autocomplete=nope placeholder="admin" onchange=validateDeviceAmtSettings() onkeyup=validateDeviceAmtSettings() />');
            x += addHtmlValue("Senha", '<input id=dp10password type=password style=width:170px autocomplete=nope maxlength=32 onchange=validateDeviceAmtSettings() onkeyup=validateDeviceAmtSettings() />');
            // Only display the TLS setting if the Intel AMT manager is not running on the server. With the manager TLS is auto-detected.
            if ((features2 & 1) == 0) { x += addHtmlValue("Segurança", '<select id=dp10tls style=width:176px><option value=0>' + "Sem segurança TLS" + '</option><option value=1>' + "Segurança TLS necessária" + '</option></select>'); }
            if ((node.intelamt.user != null) && (node.intelamt.user != '')) { buttons = 7; }
            setDialogMode(2, "Editar credenciais Intel&reg; AMT", buttons, editDeviceAmtSettingsEx, x, { node: node, func: func });
        ...
        function p10showDeleteNodeDialog(nodeid) {
            if (xxdialogMode) return;
            setDialogMode(2, "Excluir Nó", 3, p10showDeleteNodeDialogEx, format("Excluir {0}?", EscapeHtml(currentNode.name)) + '<br /><br /><label><input id=p10check type=checkbox onchange=p10validateDeleteNodeDialog() />' + "confirme" + '</label>', nodeid);
        ...
        function showClearSshDialog() { setDialogMode(2, "Editar Dispositivo", 3, showClearSshDialogEx, "Apagar credenciais SSH?"); }
        function showClearSshDialogEx(button, mode) { meshserver.send({ action: 'changedevice', nodeid: currentNode._id, ssh: 0 }); }
        function showClearRdpDialog() { setDialogMode(2, "Editar Dispositivo", 3, showClearRdpDialogEx, "Apagar credenciais RDP?"); }
        function showClearRdpDialogEx(button, mode) { meshserver.send({ action: 'changedevice', nodeid: currentNode._id, rdp: 0 }); }

        var showEditNodeValueDialog_modes = ["Nome do dispositivo", "Nome do Host", "Descrição", "Etiqueta"];
        ...
        var agentConsoleMessages = ['', "Esperando que o usuário conceda acesso ...", "Negado", "Falha ao iniciar sessão de terminal remoto, {0} ({1})", "Tempo esgotado", "Dados de rede inválidos recebidos"];
        ...
        function showDesktopSettings() {
            ...
            applyDesktopSettings();
            updateDesktopButtons();
            setDialogMode(7, "Configurações de área de trabalho remota", 3, showDesktopSettingsChanged);
        }
        ...
        function updateDeskShortcutKeys() {
            var x = '<div class="menuButton" onclick="deskMenuButton(-1)">' + "Customizar" + '</div>';
        ...
        var keyStrings = { 8: "BackSpace", 9: "Tab", 13: "Entrar", 27: "Escape", 32: "Space", 44: "Captura de tela", 45: "Inserir", 46: "Del", 36: "Home", 35: "Fim", 32: "Espace", 33: "Subir página", 34: "Descer Página", 37: "Esquerda", 38: "Cima", 39: "Direita", 40: "Baixo", 0: "Nenhum" }
        ...
        function deskCustomizeKeys() {
            ...
            x += '</select> <input type=button value=' + "Adicionar" + ' onclick=addDeskCustomizeKey() /></div>';
            QH('p10dialog2', x);
            xxdialogMode = 2;
            QV('p10dialog', true);
        ...
        function deskUpdateShortcutList() {
            ...
            if (x == '') { x = '<i>' + "Nenhum atalho de teclado definido" + '</i>'; }
            QH('d2shortcuts', x);
        }
        ...
        function sendSpecialKeys() {
            if (xxdialogMode || desktop == null || desktop.State != 3) return;
            setDialogMode(3, "Chaves Especiais", 3, deskSendKeys);
        }
        ...
        function deskSelectScreens() {
            ...
            x = addHtmlValue4("Tela", '<select style=width:100% id=deskdisplays>' + x + '</select>');
            setDialogMode(2, "Seleção de tela", 3, deskSelectScreensEx, x);
        }
        ...
        function cmsshportaction(action) {
            if (xxdialogMode) return;
            var x = "Porta de conexão remota SSH:" + '<br /><br /><input type=text placeholder="22" inputmode="numeric" pattern="[0-9]*" onkeypress="return (event.keyCode == 8) || (event.charCode >= 48 && event.charCode <= 57)" maxlength=5 id=d10sshport type=text>';
            setDialogMode(2, "Conexão SSH", 3, function () {
        ...
        function sshTunnelAuthDialog(j, func) {
            var x = '';
            if (j.askkeypass) {
                x += addHtmlValue("Autenticação", '<select id=dp2authmethod style=width:150px onchange=sshAuthUpdate(event)><option value=3 selected>' + "Chave Armazenada" + '</option><option value=1>' + "Usuario Contraseña" + '</option><option value=2>' + "Nombre de usuario y clave" + '</option></select>');
            } else {
                x += addHtmlValue("Autenticação", '<select id=dp2authmethod style=width:150px onchange=sshAuthUpdate(event)><option value=1 selected>' + "Usuario Contraseña" + '</option><option value=2>' + "Nombre de usuario y clave" + '</option></select>');
            }
            x += '<div id=d2userauth style=display:none>';
            x += addHtmlValue("Nome do usuário", '<input id=dp2user style=width:150px maxlength=64 autocomplete=off onkeyup=sshAuthUpdate(event) />');
            x += '</div>';
            x += '<div id=d2passauth style=display:none>';
            x += addHtmlValue("Senha", '<input type=password id=dp2pass style=width:150px maxlength=64 autocomplete=off onkeyup=sshAuthUpdate(event) />');
            if ((features2 & 0x00400000) == 0) { x += '<label><input id=dp2keep type=checkbox>' + "Lembrar credenciais" + '</label>'; }
            ...
            if ((features2 & 0x00400000) == 0) {
                x += '<label><input id=dp2keep1 type=checkbox onchange=sshAuthUpdate(event)>' + "Lembrar usuário e chave" + '</label><br/>';
                x += '<label><input id=dp2keep2 type=checkbox>' + "Lembrar senha" + '</label>';
            }
            x += '</div>';
            if (j.askkeypass) {
                x += '<div id=d2keyauth2 style=display:none>';
                x += addHtmlValue("Senha", '<input type=password id=dp2keypass2 style=width:150px maxlength=64 autocomplete=off onkeyup=sshAuthUpdate(event) />');
                x += '</div>';
            }
            setDialogMode(2, "Autenticação", 11, func, x, 'ssh');
            Q('dp2user').focus();
            sshAuthUpdate();
            ...
            if (typeof data == 'string') {
                if (data[0] == '{') {
                    ...
                    switch (j.action) {
                        ...
                        case 'autherror': { p12setConsoleMsg("Erro de autenticação", 5000); break; }
                        case 'sessionerror': { p12setConsoleMsg("Sessão expirada", 5000); break; }
                        case 'sessiontimeout': { p12setConsoleMsg("Sessão expirada", 5000); break; }
                    }
                } else if (data[0] == '~') {
        ...
        */
        ...
        function p13gotFiles(data) {
            ...
            switch (data.action) {
                ...
                case 'autherror': { p13setConsoleMsg("Erro de autenticação", 5000); return; }
                case 'connectionerror': { p13setConsoleMsg("Erro de conexão", 5000); return; }
                case 'sessionerror': { p13setConsoleMsg("Sessão expirada", 5000); return; }
                case 'sessiontimeout': { p13setConsoleMsg("Sessão expirada", 5000); return; }
            }
        ...
        function p13updateFiles(checkedNames) {
            var html1 = '', html2 = '', displayPath = '<a style=cursor:pointer;color:black onclick=p13folderup(0)>' + "Raiz" + '</a>', fullPath = 'Root';
        ...
        function p13setActions() {
            ...
            if (p13filetree == null) {
                ...
                Q('p13SelectAllButton').value = "Tudo";
                ...
                Q('p13SelectAllButton').value = (cc > 0 ? "Nenhum" : "Tudo");
        ...
        function p13deletefile() { var cc = p13getFileSelCount(), rec = (p13getFileSelDirCount() > 0) ? '<br /><br /><label><input type=checkbox id=p13recdeleteinput>' + "Exclusão recursiva" + '</label><br>' : '<input type=checkbox id=p13recdeleteinput style=\'display:none\'>'; setDialogMode(2, "Excluir", 3, p13deletefileEx, (cc > 1) ? (format("Excluir {0} itens selecionados?", cc) + rec) : ("Excluir o item selecionado?" + rec)); }
        ...
        function p13uploadFile() { setDialogMode(2, "Carregar Arquivo", 3, p13uploadFileEx, '<input type=file name=files id=p13uploadinput style=width:100% multiple=multiple onchange="updateUploadDialogOk(\'p13uploadinput\')" />'); updateUploadDialogOk('p13uploadinput'); }
        ...
        function p13viewfile() {
            ...
            for (var i = 0; i < checkboxes.length; i++) {
                if (checkboxes[i].checked) {
                    ...
                    } else { messagebox("Editor de Arquivo", "Somente arquivos com menos de 200k podem ser editados."); }
                    break;
                }
            }
        }
        ...
        function p13pasteFile() {
            ...
            if ((p13clipboard != null) && (p13clipboard.length > 0)) {
                if (p13clipboardCut == 0) {
                    if (p13clipboard.length > 1) { x = format("Confirma a cópia de {0} entradas para este local?", p13clipboard.length); } else { x = format("Confirmar cópia de 1 entrada para este local?"); }
                } else {
                    if (p13clipboard.length > 1) { x = format("Confirma a movimentação de {0} entradas para este local?", p13clipboard.length); } else { x = format("Confirma a mudança de 1 entrada para este local?"); }
                }
            }
            ...
            if ((p13clipboard != null) && (p13clipboard.length > 0)) {
                if (p13clipboardCut == 0) {
                    if (p13clipboard.length > 1) {
                        x = format("Retendo {0} entradas para cópia" + ', <a href=# onclick="return p13clearClip()" style=cursor:pointer>' + "Apagar" + '</a>.', p13clipboard.length);
                    } else {
                        x = format("Segurando 1 entrada para cópia" + ', <a href=# onclick="return p13clearClip()" style=cursor:pointer>' + "Apagar" + '</a>.');
                    }
                } else {
                    if (p13clipboard.length > 1) {
                        x = format("Retendo {0} entradas para mover" + ', <a href=# onclick="return p13clearClip()" style=cursor:pointer>' + "Apagar" + '</a>.', p13clipboard.length);
                    } else {
                        x = format("Segurando 1 entrada para o movimento" + ', <a href=# onclick="return p13clearClip()" style=cursor:pointer>' + "Apagar" + '</a>.');
                    }
                }
            }
        ...
        function p13downloadfile(x, y, z) {
            ...
            setDialogMode(2, "Fazer download do arquivo", 10, p13downloadFileCancel, '<div>' + EscapeHtml(downloadFile.file) + '</div><br /><progress id=d2progressBar style=width:100% value=0 max=' + z + ' />');
        }
        ...
        */
        ...
        function p13doUploadFiles(files) {
            ...
            if (overWriteCount == 0) {
                ...
                setDialogMode(2, "Carregar Arquivo", 3, p13uploadFileContinue, format((overWriteCount == 1) ? "O upload substituirá 1 arquivo. Continuar?" : "O upload substituirá {0} arquivos. Continuar?", overWriteCount), files);
            }
        }
        ...
        function p13uploadFileContinue(b, files) {
            ...
            setDialogMode(2, "Carregar Arquivo", 10, p13uploadFileCancel, '<div id=p13dfileName>' + "Conectando ..." + '</div><br /><progress id=d2progressBar style=width:100% value=0 max=0 />');
            p13uploadNextFile();
        }
        ...
        function updateDeviceDetails(node, hardware, network) {
            ...
            if (hardware.windows && hardware.windows.osinfo && hardware.windows.osinfo.Description) { x += addDetailItem("Descrição", EscapeHtml(hardware.windows.osinfo.Description), s); }
            if (node.osdesc) { x += addDetailItem("Versão", EscapeHtml(node.osdesc), s); }
            if (hardware.windows && hardware.windows.osinfo) {
                var m = hardware.windows.osinfo;
                if (m.OSArchitecture) {
                    if (m.OSArchitecture.startsWith('32')) { x += addDetailItem("Arquitetura", "32 bits", s); }
                    else if (m.OSArchitecture.startsWith('64')) { x += addDetailItem("Arquitetura", "64 bits", s); }
                    else { x += addDetailItem("Arquitetura", EscapeHtml(m.OSArchitecture), s); }
                }
                if(m.LastBootUpTime){
                    var thedate = {
                ...
                if(m.Domain){ x += addDetailItem((m.PartOfDomain ? "Domínio" : "Grupo de trabalho"), EscapeHtml(m.Domain), s); }
            }
            ...
            if (node.wsc) {
                var y = [];
                if (node.wsc.antiVirus != null) { if (node.wsc.antiVirus == 'OK') { y.push("AV" + ' - <span style=color:green>' + "OK" + '</span>'); } else { y.push("AV" + ' - <span style=color:red>' + "Ruim" + '</span>'); } }
                if (node.wsc.autoUpdate != null) { if (node.wsc.autoUpdate == 'OK') { y.push("Atualizar" + ' - <span style=color:green>' + "OK" + '</span>'); } else { y.push("Atualizar" + ' - <span style=color:red>' + "Ruim" + '</span>'); } }
                if (node.wsc.firewall != null) { if (node.wsc.firewall == 'OK') { y.push("Firewall" + ' - <span style=color:green>' + "OK" + '</span>'); } else { y.push("Firewall" + ' - <span style=color:red>' + "Ruim" + '</span>'); } }
                x += addDetailItem("Segurança do Windows", y.join(', '));
            }

            // Defender for Windows Server
            if(node.defender) {
                var y = [];
                if (node.defender.RealTimeProtection != null) { if (node.defender.RealTimeProtection == true) { y.push("RealTimeProtection" + ' - <span style=color:green>' + "On" + '</span>'); } else { y.push("RealTimeProtection" + ' - <span style=color:red>' + "Desligado" + '</span>'); } }
                if (node.defender.TamperProtected != null) { if (node.defender.TamperProtected == true) { y.push("TamperProtection" + ' - <span style=color:green>' + "On" + '</span>'); } else { y.push("TamperProtection" + ' - <span style=color:red>' + "Desligado" + '</span>'); } }
                if (node.defender.AntivirusSignatureVersion != null) { y.push("Versão da assinatura" + ' - <span style=color:green>' + EscapeHtml(node.defender.AntivirusSignatureVersion) + '</span>'); }
            ...
            if (node.av && node.av.length > 0) {
                ...
                for (var i in node.av) {
                    if (node.av[i].product) {
                        ...
                        if (node.av[i].enabled !== true) { avx += ' - <span style=color:red>' + "Desabilitado" + '</span>'; }
           ...
           if (node.users && node.users.length > 0) {
                var u = node.users.map(function(user) {
                    return addKeyLinkConditional(EscapeHtml(user), "Bloqueado", (node.lusers && node.lusers.indexOf(user) >= 0));
                }).join(', ');
                x += addDetailItem((node.users.length > 1 ? "Usuarios activos" : "Usuario activo"), u);
            }

            if (x != '') { sections.push({ name: "Sistema operacional", html: x, img: 'software' }); }
            ...
            if (node.agent) {
                ...
                if (node.firstconnect) { x += addDetailItem("Primeira conexão do agente", printDateTime(new Date(node.firstconnect))); }
                if ((node.conn & 1) != 0) {
                    x += addDetailItem("Última conexão do agente", "Conectado agora");
                } else {
                    if (node.lastconnect) { x += addDetailItem("Última conexão do agente", printDateTime(new Date(node.lastconnect))); }
                }
                if (node.lastaddr) {
                    var splitip = node.lastaddr.split(':');
                    if (splitip.length > 2) {
                        // IPv6
                        x += addDetailItem("Último endereço do agente", node.lastaddr);
                    } else {
                        // IPv4
                        if (isPrivateIP(node.lastaddr)) {
                            x += addDetailItem("Último endereço do agente", splitip[0]);
                        } else {
                            x += addDetailItem("Último endereço do agente", '<a href="https://iplocation.com/?ip=' + splitip[0] + '" rel="noreferrer noopener" target="MeshIPLoopup">' + splitip[0] + '</a>');
                        }
                    }
                }
                if (hardware.agentvers != null) {
                    if (hardware.agentvers.compileTime) {
                        try {
                            ...
                            x += addDetailItem("Tempo de compilação", printDateTime(new Date(d)));
                        } catch (ex) { }
                    }
                }
                if (hardware.time != null) {
                    x += addDetailItem("Última atualização de detalhes", printDateTime(new Date(hardware.time)));
                }
            ...
            if (hardware.mobile) {
                ...
                if (hardware.mobile.host) { x += addDetailItem("Nome do Host", EscapeHtml(hardware.mobile.host), s); }
                ...
                if (x != '') { sections.push({ name: "Dispositivo móvel", html: x, img: 'mobile' }); }
            }
            ...
            if (network.netif2 != null) {
                ...
                for (var i in network.netif2) {
                    ...
                    if (m.desc) { x += addDetailItem("Descrição", EscapeHtml(m.desc).split('(R)').join('&reg;')); }
                    //if (m.dnssuffix) { x += addDetailItem("DNS Suffix", m.dnssuffix); }
                    if (typeof m[0].mac == 'string') {
                        if (m[0].gatewaymac) {
                            x += addDetailItem("Camada MAC", format("MAC: {0}, Gateway: {1}", EscapeHtml(m[0].mac), EscapeHtml(m[0].gatewaymac)));
                        } else {
                            x += addDetailItem("Camada MAC", format("MAC: {0}", EscapeHtml(m[0].mac)));
                        }
                    }
                    if (typeof m[0].speed == 'number' && (m[0].speed != 9223372036854775807 && m[0].speed > 0)) {
                        x += addDetailItem("Velocidade da interface", format("{0}", getNetworkSpeed(m[0].speed)));
                    }
                    for (var j = 0; j < m.length; j++) {
                        ...
                        if (items.length > 0) {
                            if (iplayer.family == 'IPv4') { x += addDetailItem("Camada IPv4", items.join(",")); }
                            if (iplayer.family == 'IPv6') { x += addDetailItem("Camada IPv6", items.join(",")); }
                        }
                    }
                    x += '</div></td></tr>';
                }
            ...
            if (node.intelamt != null) {
                var x = '';
                x += addDetailItem("Versão", (node.intelamt.ver) ? ('v' + EscapeHtml(node.intelamt.ver)) : ('<i>' + "Desconhecido" + '</i>'), s);
                x += addDetailItem("Identificador", (node.intelamt.uuid) ? (EscapeHtml(node.intelamt.uuid)) : ('<i>' + "Desconhecido" + '</i>'), s);
                var provisioningStates = { 0: nobreak("Não ativado (pré)"), 1: nobreak("Não ativado (In)"), 2: nobreak("ativado") };
                var provisioningMode = '';
                if ((node.intelamt.state == 2) && node.intelamt.flags) { if (node.intelamt.flags & 2) { provisioningMode = (', ' + "Modo de controle do cliente (CCM)"); } else if (node.intelamt.flags & 4) { provisioningMode = (', ' + "Modo de controle de administrador (ACM)"); } }
                x += addDetailItem("Estado de Provisionamento", ((node.intelamt.state) ? (provisioningStates[node.intelamt.state]) : ('<i>' + "Desconhecido" + '</i>')) + provisioningMode, s);
                x += addDetailItem("Segurança", (node.intelamt.tls == 1) ? "Protegido usando TLS" : "TLS não está configurado", s);
                // Check that the Intel AMT user is setup and there is no warnings (1 = invalid credentials, 8 = trying)
                x += addDetailItem("Credenciais de administrador", ((node.intelamt.user) == null || (node.intelamt.user == '') || ((node.intelamt.warn != null) && ((node.intelamt.warn & 9) != 0))) ? "Não conhecido" : "Conhecido", s);
                if (x != '') {
                    if ((typeof node.intelamt.sku == 'number') && ((node.intelamt.sku & 16) != 0)) {
                        sections.push({ name: "Capacidade de gerenciamento padrão Intel&reg; (Intel&reg; SM)", html: x, img: 'amt' });
                    } else {
            ...
            if (hardware.identifiers) {
                ...
                // BIOS
                if (ident.bios_vendor) { x += addDetailItem("Fornecedor", EscapeHtml(ident.bios_vendor), s); }
                if (ident.bios_version) { x += addDetailItem("Versão", EscapeHtml(ident.bios_version), s); }
                ...
                // Motherboard
                x = '';
                if (ident.board_vendor) { x += addDetailItem("Fornecedor", EscapeHtml(ident.board_vendor), s); }
                ...
                if (ident.board_version) { x += addDetailItem("Versão", EscapeHtml(ident.board_version), s); }
                ...
                if (x != '') { sections.push({ name: "Placa-mãe", html: x, img: 'motherboard' }); }
            }
            ...
            if (hardware.tpm) {
                ...
                if (tpm.ManufacturerVersion) { x += addDetailItem("Versão", EscapeHtml(tpm.ManufacturerVersion), s); }
                if (tpm.IsActivated != null) { x += addDetailItem("ativado", (tpm.IsActivated ? "Yes" : "No"), s); }
                if (tpm.IsEnabled != null) { x += addDetailItem("Habilitado ", (tpm.IsEnabled ? "Yes" : "No"), s); }
                if (tpm.IsOwned != null) { x += addDetailItem("Controlado", (tpm.IsOwned ? "Yes" : "No"), s); }
            ...
            if (hardware.battery) {
                ...
                for (var i in hardware.battery) {
                    ...
                    x += '<tr><td><div class=style10 style=border-radius:5px;padding:8px>';
                    x += '<div style=margin-bottom:3px><b>' + EscapeHtml(battery.DeviceName ? battery.DeviceName : "Desconhecido") + '</b></div>';
                    if (battery.CycleCount) { x += addDetailItem("Contagem de ciclos", EscapeHtml(battery.CycleCount), s); }
                    if (battery.FullChargedCapacity) { x += addDetailItem("Capacidade total carregada", format("{0} mWh", battery.FullChargedCapacity), s); }
                    if (battery.EstimatedRuntime) { x += addDetailItem("Tempo de execução estimado", format("{0} minutos", Math.floor((battery.EstimatedRuntime / 60))), s); }
                    if (battery.Chemistry) { x += addDetailItem("Química", EscapeHtml(battery.Chemistry), s); }
                    if (battery.DesignedCapacity) { x += addDetailItem("Capacidade de projeto", format("{0} mWh", battery.DesignedCapacity), s); }
                    if (battery.ManufactureDate) { x += addDetailItem("Data de Fabricação", EscapeHtml(battery.ManufactureDate), s); }
                    if (battery.ManufactureName) { x += addDetailItem("Nome do fabricante", EscapeHtml(battery.ManufactureName), s); }
                    if (battery.SerialNumber) { x += addDetailItem("Número de série", EscapeHtml(battery.SerialNumber), s); }
                    if (battery.ChargeRate) { x += addDetailItem("Taxa de cobrança", format("{0} mW", battery.ChargeRate), s); }
                    if (battery.Charging != null) { x += addDetailItem("Carregando", (battery.Charging ? "Yes" : "No"), s); }
                    if (battery.DischargeRate) { x += addDetailItem("Taxa de descarga", format("{0} mW", battery.DischargeRate), s); }
                    if (battery.Discharging != null) { x += addDetailItem("Descarregando", (battery.Discharging ? "Yes" : "No"), s); }
                    if (battery.RemainingCapacity) { x += addDetailItem("Capacidade restante", format("{0} mWh", battery.RemainingCapacity), s); }
                    if (battery.Voltage) { x += addDetailItem("Tensão", format("{0} V", (battery.Voltage / 1000)), s); }
                    if (battery.Health) { x += addDetailItem("Saúde", format("{0} %", battery.Health), s); }
                    if (battery.BatteryCharge) { x += addDetailItem("Carga da bateria", format("{0} %", battery.BatteryCharge), s); }   
                    x += '</div>';
                }
                x += '</table>';
            ...
            if (hardware.windows) {
                if (hardware.windows.memory && (hardware.windows.memory.length > 0)) {
                    ...
                    for (var i in hardware.windows.memory) {
                        ...
                        if (m.Capacity && m.Speed) { x += addDetailItem("Capacidade / Velocidade", format("{0} Mb, {1} Mhz", (m.Capacity / 1024 / 1024), m.Speed), s); }
                        else if (m.Capacity) { x += addDetailItem("Capacidade", format("{0} Mb", (m.Capacity / 1024 / 1024)), s); }
            ...
            if (hardware.linux) {
                if (hardware.linux.memory && (hardware.linux.memory.Memory_Device.length > 0)) {
                    ...
                    for (var i in hardware.linux.memory.Memory_Device) {
                        ...
                        if (m.Size && m.Speed) { x += addDetailItem("Capacidade / Velocidade", format("{0}, {1}", m.Size, m.Speed), s); }
                        else if (m.Size) { x += addDetailItem("Capacidade", format("{0}", (m.Size)), s); }
                        if (m.PartNumber) { x += addDetailItem("Part Number", EscapeHtml((m.Manufacturer && m.Manufacturer != 'Undefined')?(m.Manufacturer + ', '):'') + EscapeHtml(m.PartNumber), s); }
                        x += '</div>';
                    }
                    x += '</table>';
            ...
            if (hardware.identifiers && ident.storage_devices) {
                ...
                for (var i in ident.storage_devices) {
                    ...
                    if (m.Size) {
                        ...
                        if (m.Size) {
                            ...
                            if (typeof m.Size == 'number') { x += addDetailItem("Capacidade", format("{0} Mb", Math.floor(m.Size / 1024 / 1024)), s); }
                            if (typeof m.Size == 'string') { x += addDetailItem("Capacidade", EscapeHtml(m.Size), s); }
                        }
                ...
                if (x != '') { sections.push({ name: "Armazenar", html: x, img: 'storage' }); }
            }
            ...
            if (hardware.windows && hardware.windows.volumes) {
                ...
                for (var i in hardware.windows.volumes) {
                    ...
                    if (m.size) {
                        ...
                        x += addDetailItem("Capacidade", EscapeHtml(fsize), s);
                    }
                    if (m.sizeremaining) {
                        var sizes = ['Bytes', 'KB', 'MB', 'GB', 'TB'];
                        ...
                        x += addDetailItem("Capacidade restante", EscapeHtml(fsize), s);
                    }
                    if (m.type) {
                        var type = (m.removable == true ? "Removable" : (m.cdrom == true ? "CD-ROM" : ''));
                        x += addDetailItem("File System", (type != '' ? (type + ' / ') : '') + (m.type == 'Unknown' ? "Desconhecido" : EscapeHtml(m.type)), s);
                    }
            ...
            if (hardware.darwin && hardware.darwin.volumes) {
                ...
                for (var i in hardware.darwin.volumes) {
                    ...
                    x += '<div style=margin-bottom:3px><b>' + m.mount_point + '</b></div>';
                    if (m.size) {
                        x += addDetailItem("Capacidade", EscapeHtml(m.size), s);
                    }
                    if (m.available) {
                        x += addDetailItem("Capacidade restante", EscapeHtml(m.available), s);
                    }
                    if (m.type) {
                        var type = (m.removable == true ? "Removable" : (m.cdrom == true ? "CD-ROM" : ''));
                        x += addDetailItem("File System", (type != '' ? (type + ' / ') : '') + (m.type == 'Unknown' ? "Desconhecido" : EscapeHtml(m.type)), s);
            ...
            if (x == '') {
                QH('p10detailshtml', "Nenhuma informação para este dispositivo.");
            } else {
                QH('p10detailshtml', x);
            }
        }
        ...
        function deviceDetailsShowBitlockerInfo(drive, identifier, password) {
            if (xxdialogMode) return false;
            var x = '<div><p>' + "Identificador" + '</p><p style=user-select:text;font-weight:bold>' + (identifier ? decodeURIComponent(identifier) : "Desconhecido") + '</p>';
            x += '<p>' + "Recovery Password" + '</p><p style=user-select:text;font-weight:bold>' + (password ? decodeURIComponent(password) : "Desconhecido") + '</p></div>';
        ...
        */
        ...
        function setupConsole() {
            ...
            if ((rights & 16) != 0) {
                ...
                var onlineText = ((consoleNode.conn & 1) != 0) ? "Agente está online" : "Agente está offline"
        ...
        function p15uploadCore(e) {
            ...
            if (e.shiftKey == true) { meshserver.send({ action: 'uploadagentcore', nodeid: consoleNode._id, type: 'default' }); } // Upload default core
                ...
                var htmlValue = '<select id=d3coreMode style=width:230px>' +
                    '<option value=1>' + "Carregar o \"Core\" Padrão do Servidor" + '</option>' +
                    '<option value=2>' + "Apagar \"Core\"" + '</option>' +
                    '<option value=3>' + "Carregar um Arquivo de \"Core\"" + '</option>' +
                    '<option value=4>' + "Desconectar Agente" + '</option>' +
                    '<option value=5>' + "Forçar desconexão do Agente " + '</option>' +
                    '<option value=6>' + "Carregar \"Core\" de Recuperação" + '</option>' +
                    '<option value=7>' + "Carregar \"Core\" Mínimo" + '</option>' +
                    '<option value=8>' + "Restart agent service" + '</option>' +
                    '<option value=9>' + "Forçar atualização do agente" + '</option></select>';
                setDialogMode(2, "Executar ação do agente", 3, p15uploadCoreEx, addHtmlValue("Açao", htmlValue));
            }
        }
        ...
        function p15uploadCore2() {
            ...
            Q('d3auth').value = authCookie;
            Q('d3attrib').value = currentNode._id;
            setDialogMode(4, "Carregar \"Core\" do Agente Mesh", 3, p15uploadCoreEx2);
            d3init();
        }
        ...
        function p20updateMesh() {
            ...
            var meshtype = format("Número desconhecido {0}", currentMesh.mtype);
            var meshrights = GetMeshRights(currentMesh);
            if (currentMesh.mtype == 1) meshtype = "Intel&reg; AMT apenas, sem agente";
            if (currentMesh.mtype == 2) meshtype = "Gerenciar usando um software agente";
            if (currentMesh.mtype == 3) { if (currentMesh.relayid == null) { meshtype = "Dispositivos locais, sem agente"; } else { meshtype = "Nenhum dispositivo de agente retransmitido através do agente"; } }
            if (currentMesh.mtype == 4) { if (currentMesh.relayid == null) { meshtype = "Dispositivo IP-KVM "; } else { meshtype = "Dispositivo IP-KVM retransmitido através do agente"; } if (currentMesh.kvm.model == 1) { meshtype += ', ' + 'Raritan KX III'; } }
            ...
            if (((currentMesh.mtype == 3) || (currentMesh.mtype == 4)) && (currentMesh.relayid != null)) {
                var relayName = '<i>' + "Desconhecido" + '</i>';
                var relayNode = getNodeFromId(currentMesh.relayid);
                if (relayNode != null) { relayName = EscapeHtml(relayNode.name); }
                x += addHtmlValue("Dispositivo de Retransmissão", addLinkConditional(relayName, 'p20editmeshrelay()', (meshrights & 1) != 0));
            }

            // Display IP-KVM information if needed
            if (currentMesh.mtype == 4) {
                x += addHtmlValue("Nome do Host", currentMesh.kvm.host);
                x += addHtmlValue("Nome do usuário", currentMesh.kvm.user);
            }
            ...
            if (currentMeshLinks && ((currentMeshLinks.rights & 2) != 0)) { x += '<div style=margin-bottom:6px;float:left;margin-right:10px><a onclick=p20showAddMeshUserDialog() style=cursor:pointer><img src=images/icon-addnew.png border=0 height=12 width=12> ' + "Adicionar usuário" + '</a></div>'; }

            if (navigator.userAgent.toLowerCase().indexOf('android') >= 0) {
                x += '<div style=margin-bottom:6px;float:left;margin-right:10px><a onclick=p20installAndroidDialog() style=cursor:pointer><img src=images/icon-addnew.png border=0 height=12 width=12> ' + "Instale neste dispositivo" + '</a></div>';
            }
            ...
            */
            ...
            for (var i in sortedusers) {
                var trash = '', rights = "Direitos parciais", r = sortedusers[i].rights, icon = 2;
            ...
            if (meshrights == 0xFFFFFFFF) { x += '<div style=font-size:small;text-align:right;margin-top:6px><span><a onclick=p20showDeleteMeshDialog() style=cursor:pointer>' + "Excluir Grupo" + '</a></span></div>'; }
        ...
        function p20showDeleteMeshDialog() {
            if (xxdialogMode) return false;
            var x = format("Tem certeza que deseja excluir o grupo {0}? Excluir o grupo de dispositivos também excluirá todas as informações sobre os dispositivos desse grupo.", EscapeHtml(currentMesh.name)) + '<br /><br />';
        ...
        function p20editmeshrelay() {
            ...
            if (relayDevices.length == 0) {
                ...
                setDialogMode(2, "Editar Grupo de Dispositivos", 1, null, "Nenhum dispositivo de relé disponível.");
            } else {
                var relayDevices2 = [];
                ...
                var x = addHtmlValue("Dispositivo de Retransmissão", '<div style=width:170px><select id=d2devrelay style=width:100%>' + relayDevices2.join('') + '</select></div>');
        ...
        function p20editmesh(focus) {
            ...
            x += addHtmlValue("Descrição", '<input id=dp20meshdesc style=width:170px maxlength=1024 onkeyup=p20editmeshValidate() />');
        ...
        function p20installAndroidDialog() {
            if (xxdialogMode) return;
            var x = '<div style=text-align:center><p>' + "Instale o Agente MeshCentral em seu dispositivo Android. Depois de instalado, clique no link de emparelhamento para conectar seu dispositivo a este servidor." + '</p>';
            ...
            x += '<p><a rel=\"noreferrer noopener\" target=_blank href="meshagents?id=14' + (urlargs.key?('&key=' + urlargs.key):'') + '" title="' + "APK version of the MeshAgent" + '">' + "APK Android" + '</a></p>';
            x += '<p><a href="' + serverinfo.magenturl + ',' + serverinfo.agentCertHash + ',' + currentMesh._id.split('/')[2] + '"><b>' + "Link de emparelhamento de dispositivo" + '</b></a></p></div>';
            setDialogMode(2, "Instalação Android", 1, null, x);
        }
        ...
        function p20showAddMeshUserDialog() {
            ...
            x += '<label><input type=checkbox onchange=p20validateAddMeshUserDialog() id=p20remotelimitedinput style=margin-left:12px>' + "Apenas entrada limitada" + '</label><br>';
            ...
            x += '<label><input type=checkbox onchange=p20validateAddMeshUserDialog() id=p20nofiles style=margin-left:12px>' + "Sem acesso ao arquivo" + '</label><br>';
            x += '<label><input type=checkbox onchange=p20validateAddMeshUserDialog() id=p20noamt style=margin-left:12px>' + "Sem Intel&reg; AMT" + '</label><br>';
            ...
            x += '<label><input type=checkbox onchange=p20validateAddMeshUserDialog() id=p20wakedevices>' + "Acordar (Wake) Dispositivos" + '</label><br>';
            x += '<label><input type=checkbox onchange=p20validateAddMeshUserDialog() id=p20editnotes>' + "Editar notas do dispositivo" + '</label><br>';
            x += '<label><input type=checkbox onchange=p20validateAddMeshUserDialog() id=p20limitevents>' + "Mostrar apenas os próprios eventos" + '</label><br>';
            x += '<label><input type=checkbox onchange=p20validateAddMeshUserDialog() id=p20chatnotify>' + "Converse e notifique" + '</label><br>';
            ...
            x += '<label><input type=checkbox onchange=p20validateAddMeshUserDialog() id=p20resetoff>' + "Reiniciar / Desligar" + '</label><br>';
            x += '</div>';
            setDialogMode(2, "Adicionar usuário ao grupo de dispositivos", 3, p20showAddMeshUserDialogEx, x);
        ...
        function p20viewuser(userid) {
            ...
            if (meshrights == 0xFFFFFFFF) r.push("Administrador Completo"); else {
                ...
                if ((meshrights & 64) != 0) r.push("Acordar (Wake) Dispositivos");
                if ((meshrights & 128) != 0) r.push("Editar notas");
                if ((meshrights & 256) != 0) r.push("Somente Visualização Remota");
                if ((meshrights & 512) != 0) r.push("Sem Terminal");
                if ((meshrights & 1024) != 0) r.push("Sem arquivos");
                if ((meshrights & 2048) != 0) r.push("Sem Intel&reg; AMT");
                ...
                if ((meshrights & 16384) != 0) r.push("Converse e notifique");
                if ((meshrights & 32768) != 0) r.push("Desinstalar");
                if ((meshrights & 131072) != 0) r.push("Comandos");
                if ((meshrights & 262144) != 0) r.push("Reiniciar / Desligar");
            }
            ...
            var x = addHtmlValue("Nome do usuário", EscapeHtml(uname));
            if (uname != userid.split('/')[2]) { x += addHtmlValue("ID do usuário", EscapeHtml(userid.split('/')[2])); }
        ...
        function p20viewuserEx(button, userid) {
            ...
            setDialogMode(2, "Usuário remoto Mesh", 3, p20viewuserEx2, format("Confirma a remoção do usuário {0}?", uname), userid);
        }
        ...
        function drawNotifications() {
            ...
            if (notifications.length == 0) {
                ...
                for (var i in notifications) {
                    ...
                    r += '<div onclick="notificationDelete(' + n.id + ')" class=unselectable title="' + "Apagar esta notificação" + '" style=margin:5px;float:right;color:orange><b>X</b></div><div onclick="notificationSelected(' + n.id + ')" style=margin:5px>' + t + EscapeHtml(n.text) + '</div><div style=margin-left:5px;margin-bottom:5px;color:gray;font-size:10px>' + printDateTime(d) + '</div></div>';
                }
            }
            var deleteall = '';
            if (notifications.length > 1) { deleteall = '<div id="notifyRemoveAll" onclick="deleteAllNotifications()" style="cursor:pointer;border-top:1px solid orange;margin:5px;color:orange;text-align:right;padding-right:3px">' + "Apagar tudo" + '</div>'; }
        ...
        function addNotification(n) {
            ...
            var translatedMessages = [
                ...
                "E-mail inválido",
                "Domínio inválido",
                "Permissões de site inválidas",
                "Usuário já existe",
                "Não foi possível adicionar usuário neste modo",
                "Exceção de validação",
                "Limite da conta atingido.", // 10
                "Solicitação de bate-papo, clique aqui para aceitar.",
                "Ocorreram {0} tentativas de login malsucedidas nesta conta desde o último login.",
                "Falha ao alterar o endereço de e-mail, outra conta já usa: {0}.",
                "Email enviado.",
                "Usuário {0} não encontrado.",
                "Usuários {0} não encontrados.",
                "Erro, não foi possível alterar a senha usada anteriormente.",
                "Erro, não foi possível alterar a senha comumente usada.",
                "Erro, senha não alterada.",
                "Senha alterada.", // 20
                "A senha atual não está correta.",
                "Erro, código de convite \"{0}\" já em uso.",
                "Gateway de SMS não habilitado",
                "Sem direitos de gerenciamento de usuário",
                "Mensagem SMS inválida",
                "Nenhum número de telefone para este usuário",
                "SMS enviado com sucesso.",
                "Erro de SMS",
                "Erro de SMS: {0}",
                "O domínio de e-mail \"{0}\" não é permitido. Somente ({1}) são permitidos" // 30
            ];
