<!DOCTYPE html><html lang="pt-br" dir="ltr" xmlns="http://www.w3.org/1999/xhtml"><head>
    ...
    <div id="LeftSideToolBar" style="display:none;position:absolute;left:0;bottom:0;width:52px;top:0;background:#113962;background:linear-gradient(to bottom, #104893 0%,#113962 100%);color:white;border-right: 5px solid #BBB;">
        <div id="LeftMenuDesktop" class="slbbutton slbbuttonsel2" title="Área de Trabalho" onclick="go(11)">
        ...
        <div id="LeftMenuFiles" class="slbbutton" title="Arquivos" onclick="go(13)">
        ...
        <div id="deskarea0">
            <div id="deskarea1" class="areaHead" style="line-height:24px">
                <div class="toright2">
                    ...
                    <div class="deskareaicon" title="Alternar modo de visualização" onclick="toggleAspectRatio(1)">⇲</div>
                    <div class="deskareaicon" title="Gire para esquerda" onclick="drotate(-1)">↺</div>
                    <div class="deskareaicon" title="Gire para direita" onclick="drotate(1)">↻</div>
                    <input id="deskActionsSettings" type="button" value="Configurações..." title="Editar configurações de área de trabalho remota" onkeypress="return false" onkeydown="return false" onclick="showDesktopSettings()" class="mR">
                ...
                <div>
                    ...
                    <span id="connectbutton1hspan">&nbsp;<input type="button" id="connectbutton1h" value="HW Connect" title="Conecte usando KVM de hardware Intel AMT " onclick="connectDesktop(event,2)" onkeypress="return false" onkeydown="return false" disabled="disabled"></span>
            ...
            <div id="deskarea4" class="areaFoot" style="min-height:24px">
                <div class="toright2">
                    <span id="DeskLatency" style="line-height:22px;width:50px" title="Latência da sessão da área de trabalho"></span>
                    <span id="DeskTimer" style="line-height:22px" title="Tempo de sessão"></span>&nbsp;
                    ...
                    <span id="DeskSaveImageButton" title="Salve uma captura de tela da área de trabalho remota"><img src="images/icon-camera.png" onclick="deskSaveImage()" height="16" width="16" style="padding-top:2px"></span>
                </div>
                <div style="height:22px">
                    <select id="deskkeys">
                        ...
                        <option value="11">Win+Esquerda</option>
                        <option value="12">Win + Direita</option>
                    </select>
    ...
    <div id="p12" class="noselect" style="overflow:hidden;position:absolute;left:54px;top:0;right:0;bottom:0;display:none;background-color:black">
        <div id="p12warning" onclick="showFeaturesDlg()">
            <div class="icon2"></div>
            <div class="warningbox">Porta de redirecionamento Intel® AMT ou recurso KVM desativado<span id="p12warninga">, clique aqui para habilitar.</span></div>
        </div>
        <div id="p12warning2" onclick="showPowerActionDlg()">
            <div class="icon2"></div>
            <div class="warningbox">O computador remoto não está ligado, clique aqui para emitir um comando de ligar.</div>
        </div>
        ...
        <div class="areaFoot" style="position:absolute;bottom:0;left:0;right:0;height:24px">
            <div class="toright2">
                <span id="TermLatency" title="Latência da Sessão Terminal"></span>
                <span id="TermTimer" title="Tempo de sessão"></span>&nbsp;
                <span id="terminalSettingsButtons" style="display:none">
                    <input id="id_tcrbutton" type="button" onkeypress="return false" onkeydown="return false" class="bottombutton" value="CR + LF" title="Alterne o que a tecla de retorno enviará" onclick="termToggleCr()">
                    <input id="id_tfxkeysbutton" type="button" onkeypress="return false" onkeydown="return false" class="bottombutton" value="Intel (F10 = ESC + [OM)" title="Alternar o tipo de emulação das teclas F1 a F10" onclick="termToggleFx()">
                ...
                <span id="specialKeyDropDown">
                    ...
                    <input id="specialkeylistinput" type="button" onkeypress="return false" class="bottombutton" value="Enviar" title="Envie a chave especial selecionada" onclick="sendSpecialKey()">
                </span>
            </div>
            <div>
                &nbsp;
                ...
                <input type="button" onkeypress="return false" onkeydown="return false" class="bottombutton" id="pastebutton" value="Colar" title="Cole o texto no terminal" onclick="showTermPasteDialog()" style="display:none">
            </div>
        </div>
    ...
    <div id="p13" class="noselect" style="overflow:hidden;position:absolute;left:54px;top:0;right:0;bottom:0;display:none;background-color:white">
        <div id="p13toolbar" style="position:absolute;left:0;top:0;right:0;bottom:28px">
            ...
            <div id="fileArea2" class="areaHead2" valign="bottom">
                ...
                <div>
                    <input type="button" id="p13FolderUp" disabled="disabled" onclick="p13folderup()" value="Cima">&nbsp;
                    ...
                    <input type="button" id="p13DeleteFileButton" disabled="disabled" value="Excluir" onclick="p13deletefile()">&nbsp;
                    ...
                    <input type="button" id="p13UploadButton" disabled="disabled" value="Carregar" onclick="p13uploadFile()">&nbsp;
                    <input type="button" id="p13CutButton" disabled="disabled" value="Recortar" onclick="p13copyFile(1)">&nbsp;
    ...
    <div id="dialog" class="noselect" style="display:none">
        ...
        <div id="dialogBody">
            ...
            <div id="dialog4" style="">
                <input id="d4WrapButton" type="button" value="Embrulhar" onclick="d4ToggleWrap()">
                <input id="d4SizeButton" type="button" value="Pequeno" onclick="d4ToggleSize()">
                <input id="d4EncodingButton" type="button" value="Cru" onclick="d4ToggleEncoding()">
            ...
            <div id="dialog7" style="">
                <div id="d7meshkvm">
                    <h4>Agente de Desktop Remoto</h4>
                    <div>
                        <div>Qualidade</div>
                    ...
                    <div id="d7desktopOtherSettings">
                        ...
                        <div id="d7otherset2" style="display:block">
                            <label style="display:block"><input type="checkbox" id="d7deskSwapMouse">Trocar botões do mouse</label>
                            <label style="display:block"><input type="checkbox" id="d7deskRemoteKeyMap">Use o mapa do teclado remoto</label>
                        </div>
                    </div>
                </div>
                <div id="d7amtkvm">
                    <h4>Hardware KVM Intel® AMT</h4>
                    <div>
                    ...
                    <div>
                        ...
                        <div id="d7otherset" style="display:block">
                            ...
                            <label style="display:block"><input type="checkbox" id="d7showcursor">Mostrar o cursor do mouse local</label>
    ...
    <script>
        ...
        function updateMetadata(conn, elementid) {
            ...
            if (conn && (conn.State == 3)) {
                ...
                if (viewerCount > 1) { str = '<span onclick=showSessionMetadata(1) style=cursor:pointer>' + format(", {0} assistindo", viewerCount) + '</span>'; }
            }
            QH('deskmetadata', str);
        ...
        function showSessionMetadata(cid) {
            ...
            if (conn && conn.metadata) {
                var x = '';
                if (conn.metadata.startTime) { x += addHtmlValue4("Hora de início", printDateTime(new Date(conn.metadata.startTime))); }
                if (conn.metadata.users) {
                    for (var i in conn.metadata.users) {
                        var val = (conn.metadata.users[i] == 1) ? "1 conexão" : format("{0} conexões", conn.metadata.users[i]);
                        var username = i.split('/')[2];
                        if ((users != null) && (users[i] != null)) { username = users[i].name; }
                        x += addHtmlValue4(format("Usuário \"{0}\"", username), val);
                    }
                }
                setDialogMode(2, "Informação da Sessão", 1, null, x, 'sessionMetadata' + cid);
            }
        }
        ...
        function showDeskType() {
            if (xxdialogMode || desktop == null || desktop.State != 3) return;
            Q('DeskType').blur();
            var x = '<div>' + "Insira o texto e clique em OK para digitá-lo remotamente usando um teclado em inglês dos EUA. Certifique-se de colocar o cursor remoto na posição correta antes de prosseguir." + '<div>';
            x += '<textarea id=d2typeText style="margin-top:5px;width:100%;height:184px;resize:none" maxlength=2000></textarea>';
            setDialogMode(2, "Entrada de teclado remoto", 3, showDeskTypeEx, x);
            Q('d2typeText').focus();
        }
        ...
        */
        ...
        function deskSaveImage() {
            if (xxdialogMode || desktop == null || desktop.State != 3) return;
            var d = new Date(), n = "Área de Trabalho" + '-' + d.getFullYear() + '-' + ('0' + (d.getMonth() + 1)).slice(-2) + '-' + ('0' + d.getDate()).slice(-2) + '-' + ('0' + d.getHours()).slice(-2) + '-' + ('0' + d.getMinutes()).slice(-2);
        ...
        function p13gotFiles(data) {
            ...
            if (data.action == 'findfile') {
                if (xxdialogTag == data.reqid) {
                    if (data.r == null) {
                        ...
                        xxdialogTag = null;
                        if (Q('d2findResults').innerHTML == '') { QH('d2findResults', '<div style=text-align:center;margin:10px><i>' + "Nenhum arquivo encontrado" + '</i></div>'); }
                    } else {
            ...
            if (data.action == 'dialogmessage') {
                if ((data.msg == null) && (xxdialogTag == 'fileMsgDialog')) {
                    ...
                    setDialogMode(2, "Operação de arquivo", 10, p13fileOperationDialogEx, '<div style=margin:10px>' + "Compactando arquivos ..." + '<div>', 'fileMsgDialog');
                } else if ((data.msg == 'zippingFile') && ((!xxdialogMode) || (xxdialogTag == 'fileMsgDialog'))) {
                    // Show the dialog box message
                    setDialogMode(2, "Operação de arquivo", 10, p13fileOperationDialogEx, '<div style=margin:10px>' + EscapeHtml(data.file) + '<div><br /><progress value=' + EscapeHtml(data.progress) + ' style=width:100% max=100 />', 'fileMsgDialog');
                }
                return;
            }
        ...
        function p13findfile() {
            ...
            x += '<div style=margin-top:8px><input id=filefind_dlgCancelButton type=button value=' + "Fechar" + ' style=float:right;width:80px;margin-left:5px onclick=p13findfileCancel()>';
            x += '<input id=filefind_dlgOkButton type=submit value=' + "Procurar" + ' style=float:right;width:80px onclick=p13findfileEx()><br /><br /></div>';
            setDialogMode(2, "Encontrar arquivos", 0, null, x);
            p13findfileValidate();
            Q('d2findFilter').focus();
        }

        function p13findfileDown(e) { if (e.code == "Entrar") { p13findfileEx(); } }
        ...
        function p13zipFiles() {
            ...
            setDialogMode(2, "Nome do arquivo zip", 3, p13zipFilesEx, '<input type=text id=p13renameinput maxlength=64 onkeyup=p13fileNameCheck(event) style=width:100% value="" />', { action: 'zip', path: p13filetreelocation.join('/'), files: inputFiles });
        ...
        function p13downloadfile(x, y, z, tag) {
            ...
            setDialogMode(2, "Fazer download do arquivo", 10, p13downloadFileCancel, '<div>' + gdownloadFile.file + '</div><br /><progress id=d2progressBar style=width:100% value=0 max=' + z + ' />');
        }
        ...
        function d4ToggleSize(update) {
            ...
            Q('d4SizeButton').value = ["Tamanho: 100%", "Tamanho: 125%", "Tamanho: 150%", "Tamanho: 200%"][d4EditSizeVal];
        ...
        function d4ToggleEncoding(update) {
            ...
            Q('d4EncodingButton').value = ["Codificação: RAW","Codificação: UTF8"][d4EditEncodingVal];
        ...
        function printFlexDateTime(d) { if (printDate(new Date()) == printDate(d)) { return format("Expira em {0}", printTime(d)); } else { return format("Expira em {0}", printDateTime(d)); } }
