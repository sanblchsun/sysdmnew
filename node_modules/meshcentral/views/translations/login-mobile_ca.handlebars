<!DOCTYPE html><html dir="ltr" xmlns="http://www.w3.org/1999/xhtml"><head lang="en">
    ...
    </head><body onload="if (typeof(startup) !== 'undefined') startup();" style="overflow-y:hidden;margin:0;padding:0;border:0;color:black;font-size:13px;font-family:\'Trebuchet MS\', Arial, Helvetica, sans-serif">{{{customCSSTags}}}
                                ...
                                <form method="post">
                                    ...
                                    <table>
                                        ...
                                        <tr>
                                            ...
                                            <td><input id="password" type="password" autocomplete="current-password" maxlength="256" name="password" required="" onchange="validateLogin(2)" onkeyup="validateLogin(2,event)"></td>
                                        </tr>
                                        <tr>
                                            <td><div id="showPassHintLink" style="display:none"><a onclick="showPassHint()" style="cursor:pointer">Mostra la pista</a></div></td>
                                    ...
                                    <div id="resetAccountDiv" style="display:none;padding:2px">
                                        <span id="resetAccountSpan">Heu oblidat l'usuari/la contrasenya?</span> <a onclick="xgo(3)" style="cursor:pointer">Restableix el compte</a>.
                                    </div>
                                    <div id="newAccountDiv" style="display:none;padding:2px">
                                        No tens un compte? <a onclick="xgo(2)" style="cursor:pointer">Crea'n un</a>.
                                    </div>
                                    ...
                                    <div id="authStrategies" style="display:none">
                                        ...
                                        <a id="auth-twitter" href="auth-twitter" style="display:none"><img src="images/login/twitter32.png" width="32" height="32" style="margin-left:3px;margin-right:3px;border-radius:3px;box-shadow:2px 2px 5px black;cursor:pointer" title="Inicieu la sessió mitjançant Twitter"></a>
                                        <a id="auth-google" href="auth-google" style="display:none"><img src="images/login/google32.png" width="32" height="32" style="margin-left:3px;margin-right:3px;border-radius:3px;box-shadow:2px 2px 5px black;cursor:pointer" title="Inicieu la sessió amb Google"></a>
                                        <a id="auth-github" href="auth-github" style="display:none"><img src="images/login/github32.png" width="32" height="32" style="margin-left:3px;margin-right:3px;border-radius:3px;box-shadow:2px 2px 5px black;cursor:pointer" title="Inicieu la sessió amb GitHub"></a>
                                        <a id="auth-azure" href="auth-azure" style="display:none"><img src="images/login/azure32.png" width="32" height="32" style="margin-left:3px;margin-right:3px;border-radius:3px;box-shadow:2px 2px 5px black;cursor:pointer" title="Inicieu la sessió amb Azure"></a>
                                        ...
                                        <a id="auth-jumpcloud" href="auth-jumpcloud" style="display:none"><img src="images/login/jumpcloud32.png" width="32" height="32" style="margin-left:3px;margin-right:3px;border-radius:3px;box-shadow:2px 2px 5px black;cursor:pointer" title="Inicieu la sessió amb JumpCloud"></a>
                                        <a id="auth-intel" href="auth-intel" style="display:none"><img src="images/login/intel32.png" width="32" height="32" style="margin-left:3px;margin-right:3px;border-radius:3px;box-shadow:2px 2px 5px black;cursor:pointer" title="Inicieu la sessió amb Intel"></a>
                                        <a id="auth-saml" href="auth-saml" style="display:none"><img src="images/login/generic32.png" width="32" height="32" style="margin-left:3px;margin-right:3px;border-radius:3px;box-shadow:2px 2px 5px black;cursor:pointer" title="Inici de sessió únic"></a>
                                    </div>
                                </form>
                            </div>
                                    ...
                                    <form method="post">
                                        ...
                                        <table>
                                            <tbody><tr id="nuUserRow">
                                                <td align="right" width="100">Nom d'usuari:</td>
                                            ...
                                            <tr id="createPanelHint" style="display:none">
                                                <td align="right">Pista de passar:</td>
                                            ...
                                            <tr id="newAccountPass" title="Introduïu el testimoni de creació del compte">
                                                <td align="right">Fitxa de creació:</td>
                                        ...
                                        <hr><a onclick="xgo(1)" style="cursor:pointer">Torna a iniciar sessió</a>
                                        ...
                                        <tr>
                                            <td colspan="2">
                                                ...
                                                <div style="float:right">
                                                    <input style="display:none;float:right" id="securityKeyButton" type="button" value="Utilitza la clau de seguretat" onclick="useSecurityKey()">
                                                    <input style="display:none;float:right" id="emailKeyButton" type="button" value="Correu electrònic" onclick="useEmailToken()">
        ...
        <div id="footer" style="height:32px;width:100%;text-align:center;background-color:#113962;position:absolute;bottom:0px">
            <table cellpadding="0" cellspacing="6" style="width:100%">
                <tbody><tr>
                    ...
                    <td style="text-align:right">{{{rootCertLink}}}&nbsp;<a href="terms">Condicions i privadesa</a></td>
                </tr>
            </tbody></table>
        </div>
    </div>
    ...
    <script>
        ...
        var okmessages = ['', "Si és vàlid, restabliu el correu enviat.", "Email enviat.", "Cal verificar el correu electrònic, comproveu la vostra bústia de correu i feu clic a l'enllaç de confirmació.", "SMS enviat."];
        ...
        function useEmailToken() {
            ...
            setDialogMode(1, "Inici de sessió segur", 3, useEmailKeyEx, "Envieu el testimoni a l'adreça electrònica registrada?");
        }
        ...
        function useSMSToken() {
            ...
            setDialogMode(1, "Inici de sessió segur", 3, useSMSTokenEx, "Envieu el testimoni al número de telèfon registrat?");
        }
        ...
        function showPassHint() {
            if (passRequirements.hint === true) { messagebox("Pista de contrasenya", passhint); }
        }
            ...
            if (Q('apassword1').value == '') {
                ...
                if (!passRequirementsEx) {
                    ...
                    if (passReq == false) {
                        ...
                        QH('passWarning', '<span style=color:red><b>' + "Política de contrasenyes" + '</b><span>'); // TODO: Display problem hint
