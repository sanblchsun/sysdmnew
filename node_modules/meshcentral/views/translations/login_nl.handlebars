<!DOCTYPE html><html dir="ltr" xmlns="http://www.w3.org/1999/xhtml"><head lang="en">
    ...
    <div id="container">
        ...
        <div id="topbar" class="noselect style3" style="height:24px">
            <div id="uiMenuButton" title="Wissel gebruikersinterface" onclick="showUserInterfaceSelectMenu()">
                ♦
                <div id="uiMenu" style="display:none">
                    ...
                    <div id="uiViewButton4" class="uiSelector" onclick="toggleNightMode()" title="Wissel dag/nachtmodus"><div class="uiSelector4"></div></div>
                </div>
            </div>
        </div>
        <div id="column_l">
            <h1>Welkom</h1>
            <div id="welcomeText" style="display:none">Maak overal ter wereld verbinding met uw thuis- of kantoorapparatuur via MeshCentral, realtime, open source externe monitoring- en managementwebsite. U moet een management agent downloaden en op uw computers installeren. Na installatie verschijnen computers in het gedeelte "Mijn apparaten" van deze website en kunt u ze volgen en de controle over hen nemen.</div>
                    ...
                    <td id="logincell">
                        <div id="loginpanel" style="display:none">
                            <form method="post">
                                ...
                                <div id="loginuserpassdiv" style="display:none">
                                    ...
                                    <table>
                                        <tbody><tr>
                                            <td id="loginusername" align="right" width="100">Gebruikersnaam:</td>
                                        ...
                                        <tr>
                                            <td><div id="showPassHintLink" style="display:none"><a onclick="return showPassHint(event);" href="#" style="cursor:pointer">Toon hint</a></div></td>
                                            <td align="right"><input id="loginButton" type="submit" value="Inloggen"></td>
                                        </tr>
                                    </tbody></table>
                        ...
                        <div id="createpanel" style="display:none;position:relative">
                            <form method="post">
                                ...
                                <table>
                                    ...
                                    <tr>
                                        <td colspan="2">
                                            <div style="float:right"><input id="createButton" type="submit" value="Account aanmaken" disabled="disabled"></div>
                        ...
                        <div id="resetpanel" style="display:none">
                            <form method="post">
                                ...
                                <table>
                                    ...
                                    <tr>
                                        <td colspan="2">
                                            <div style="float:right"><input id="eresetButton" type="submit" value="Account opnieuw instellen" disabled="disabled"></div>
                                            <div id="passWarning" style="padding-top:6px"></div>
                                        </td>
                                    </tr>
                                </tbody></table>
                        ...
                        <div id="tokenpanel" style="display:none">
                            <form method="post" {{{autocomplete}}}="off">
                                ...
                                <table>
                                    <tbody><tr>
                                        <td align="right" width="100">Inlog token:</td>
                                        <td>
                                    ...
                                    <tr>
                                        <td colspan="2">
                                            <div style="float:right"><input id="tokenOkButton" type="submit" value="Inloggen" disabled="disabled"></div>
                                            <div style="float:right">
                                                <input style="display:none;float:right" id="securityKeyButton" type="button" value="Gebruik beveiligingssleutel" onclick="useSecurityKey(1)">
                                                ...
                                                <input style="display:none;float:right" id="msgKeyButton" type="button" value="Berichten" onclick="useMsgToken(1)">
                        ...
                        <div id="resettokenpanel" style="display:none">
                            <form method="post">
                                ...
                                <table>
                                    ...
                                    <tr>
                                        <td colspan="2">
                                            <div style="float:right"><input id="resetTokenOkButton" type="submit" value="Inloggen" disabled="disabled"></div>
                                            <div style="float:right">
                                                <input style="display:none;float:right" id="securityKeyButton2" type="button" value="Gebruik beveiligingssleutel" onclick="useSecurityKey(2)">
                                                ...
                                                <input style="display:none;float:right" id="msgKeyButton2" type="button" value="Berichten" onclick="useMsgToken(2)">
                        ...
                        <div id="resetpasswordpanel" style="display:none;position:relative">
                            <form method="post">
                                ...
                                <table>
                                    ...
                                    <tr>
                                        <td colspan="2">
                                            <div style="float:right"><input id="resetPassButton" type="submit" value="Reset wachtwoord" disabled="disabled"></div>
        ...
        <div id="footer">
            ...
            <div class="footer2">
                {{{rootCertLink}}}
                &nbsp;<a id="termsLinkFooter" href="terms">Voorwaarden &amp; Privacy</a>
            </div>
        </div>
