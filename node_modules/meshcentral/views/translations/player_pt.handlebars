    ...
    <script>
        ...
        function processFirstBlock(type, flags, time, data) {
            ...
            if (recFileMetadata.protocol) {
                ...
                else if (p == 9) { p = "Usuário PowerShell"; }
                else if (p == 100) { p = "Intel&reg; AMT WSMAN"; }
                else if (p == 101) { p = "Intel&reg; Redirecionamento AMT"; }
            ...
            if (recFileMetadata.indexInterval) {
                ...
                x += addInfoNoEsc("Procurando", format("Indexado a cada {0} segundos", recFileMetadata.indexInterval));
