<!DOCTYPE html><html dir="ltr" xmlns="http://www.w3.org/1999/xhtml"><head lang="en">
    ...
    <div id="termShellContextMenu" class="contextMenu noselect" style="display:none;min-width:0px">
        <div id="cxtermnorm" class="cmtext" onclick="cmtermaction(1,event)"><b>Shell de administração</b></div>
        ...
        <div id="cxtermups" class="cmtext" onclick="cmtermaction(9,event)">Usuário PowerShell</div>
    </div>
