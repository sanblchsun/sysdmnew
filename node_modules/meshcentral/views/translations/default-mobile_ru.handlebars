<!DOCTYPE html><html lang="ru" dir="ltr" xmlns="http://www.w3.org/1999/xhtml"><head>
    <meta charset="utf-8">
    ...
    <div id="container">
        ...
        <div id="masthead" style="background:url(logo.png) 0px 0px;background-size:341px 50px;background-color:#036;background-repeat:no-repeat;height:50px;width:100%;overflow:hidden">
            ...
            <div id="notificationCount" onclick="clickNotificationIcon()" class="unselectable" style="position:absolute;right:50px;top:0px;font-size:28px;width:50px;height:50px;cursor:pointer;display:none" title="Нажмите для просмотра текущий уведомлений"><div id="notificationCount2" style="padding-top:8px">0</div></div>
            ...
            <div id="column_l" style="width:100%;padding:0;position:absolute;bottom:0px;top:0px">
                <div id="p0" style="display:none;width:100%;height:100%">
                    <div style="display:flex;align-items:center;width:100%;height:100%">
                        <div id="p0message" style="text-align:center;width:100%"><span id="p0span">Сервер отключен</span>, <href onclick="reload()" style="cursor:pointer"><u>нажмите для переподключения</u></href>.</div>
                    </div>
                </div>
                ...
                <div id="p2" style="display:none;position:absolute;top:0;left:0;right:0;bottom:0">
                    ...
                    <div id="xdevicesBar" style="position:absolute;overflow-y:auto;height:34px;left:0;right:0;bottom:0px;background-color:#aaa;color:black">
                        <div style="margin:4px">
                            ...
                            <input id="SearchInput" autocomplete="off" type="search" placeholder="Фильтр" onchange="onDeviceSearchChanged(event)" onclick="onDeviceSearchChanged(event)" onkeyup="onDeviceSearchChanged(event)" style="padding:2px;margin:0;height:20px;background-color:#FFF">&nbsp;
                            <label class="noselect"><input type="checkbox" id="RealNameCheckBox" onclick="onRealNameCheckBox()">Имя из ОС</label>
                            <label class="noselect"><input type="checkbox" id="OnlineCheckBox" onclick="onOnlineCheckBox(event)">В сети</label>
                        </div>
                    </div>
                </div>
                        ...
                        <div style="margin-left:8px">
                            <div id="p3AccountActions">
                                <div id="p2AccountSecurity" style="display:none">
                                    <p><strong>Безопасность учетной записи</strong></p>
                                    <div style="margin-left:9px;margin-bottom:8px">
                                        <div id="managePhoneNumber1" style="margin-top:5px;display:none"><a onclick="account_managePhone()" style="cursor:pointer">Управление номером телефона</a> <span id="authPhoneNumberCheck"><strong>✓</strong></span></div>
                                        <div id="manageEmail2FA" style="margin-top:5px;display:none"><a onclick="account_manageAuthEmail()" style="cursor:pointer">Управление аутентификацией электронной почты</a> <span id="authEmailSetupCheck"><strong>✓</strong></span></div>
                                        <div style="margin-top:5px"><a href="#" onclick="account_showLocalizationSettings()">Настройки локализации</a></div>
                                        <div id="manageAuthApp" style="margin-top:5px;display:none"><a onclick="account_manageAuthApp()" style="cursor:pointer">Управление приложением для проверки подлинности</a> <span id="authAppSetupCheck"><strong>✓</strong></span></div>
                                        <div id="manageOtp" style="margin-top:5px;display:none"><a onclick="account_manageOtp(0)" style="cursor:pointer">Управление резервными кодами</a> <span id="authCodesSetupCheck"><strong>✓</strong></span></div>
                                    </div>
                                </div>
                                <div id="p2AccountActions" style="display:none">
                                    <p><strong>Действия учетной записи</strong></p>
                                    <div style="margin-left:9px;margin-bottom:8px">
                                        <div style="margin-top:5px"><span id="viewPreviousLogins"><a onclick="return account_viewPreviousLogins()" style="cursor:pointer">Посмотреть предыдущие входы в систему </a></span></div>
                                        <div style="margin-top:5px"><span id="managePhoneNumber2" style="display:none"><a onclick="account_managePhone()" style="cursor:pointer">Управление номером телефона</a></span></div>
                                        <div style="margin-top:5px"><span id="verifyEmailId" style="display:none"><a onclick="account_showVerifyEmail()" style="cursor:pointer">Подтвердить email</a></span></div>
                                        <span id="p2AccountPassActions">
                                            <div style="margin-top:5px"><span id="changeEmailId" style="display:none"><a onclick="account_showChangeEmail()" style="cursor:pointer">Смена email</a></span></div>
                                            <div style="margin-top:5px"><a onclick="account_showChangePassword()" style="cursor:pointer">Смена пароля</a><span id="p2nextPasswordUpdateTime"></span></div>
                                            <div style="margin-top:5px"><a onclick="account_showDeleteAccount()" style="cursor:pointer">Удалить учетную запись</a></div>
                                        </span>
                                        <div style="margin-top:5px" id="setDarkModeLink"><a onclick="toggleNightMode()" style="cursor:pointer">Установить темный режим</a></div>
                                        <div style="margin-top:5px"><a onclick="showNotes(false)" style="cursor:pointer">Личные заметки</a></div>
                                    </div>
                                <br style="clear:both">
                                </div>
                            </div>
                            <strong>Группы устройств</strong>
                            <span id="p3createMeshLink1">( <a onclick="account_createMesh()" style="cursor:pointer"><img src="images/icon-addnew.png" width="12" height="12" border="0"> Создать</a> )</span>
                            <br><br>
                            <div id="p3meshes"></div>
                            <div id="p3noMeshFound" style="margin-left:9px;display:none">Нет групп устройств.<span id="p3createMeshLink2"> <a onclick="account_createMesh()" style="cursor:pointer"><strong>Начните здесь!</strong></a></span></div>
                            <br style="clear:both">
                        </div>
                    </div>
                </div>
                <div id="p5" style="display:none">
                    <table cellspacing="0" style="margin:0;padding:0;border-spacing:0;border:0;">
                        <tbody><tr style="padding:0">
                            ...
                            <td>
                                <div style="margin-left:5px">
                                    <strong style="font-size:large">Мои файлы</strong><br>
                                </div>
                            </td>
                        </tr>
                    </tbody></table>
                            ...
                            <tbody><tr>
                                <td style="width:100%;background-color:#d3d9d6;text-align:left;padding:4px" valign="bottom">
                                    <div style="width:100%;text-align:center">
                                        ...
                                        <input type="button" style="width:calc(100%/5 - 5px)" id="p5SelectAllButton" disabled="disabled" onclick="p5selectallfile()" value="Выбрать все" onkeypress="return false" onkeydown="return false">
                                        <input type="button" style="width:calc(100%/5 - 5px)" id="p5RenameFileButton" disabled="disabled" value="Переименовать" onclick="p5renamefile()" onkeypress="return false" onkeydown="return false">
                                        <input type="button" style="width:calc(100%/5 - 5px)" id="p5DeleteFileButton" disabled="disabled" value="Удалить" onclick="p5deletefile()" onkeypress="return false" onkeydown="return false">
                                        <input type="button" style="width:calc(100%/5 - 5px)" id="p5NewFolderButton" disabled="disabled" value="Папка" onclick="p5createfolder()" onkeypress="return false" onkeydown="return false">
                                    </div>
                                    <div style="width:100%;text-align:center">
                                        <input type="button" style="width:calc(100%/5 - 5px)" id="p5UploadButton" disabled="disabled" value="Загрузить" onclick="p5uploadFile()" onkeypress="return false" onkeydown="return false">
                                        <input type="button" style="width:calc(100%/5 - 5px)" id="p5CutButton" disabled="disabled" value="Вырезать" onclick="p5copyFile(1)" onkeypress="return false" onkeydown="return false">
                                        <input type="button" style="width:calc(100%/5 - 5px)" id="p5CopyButton" disabled="disabled" value="Копировать" onclick="p5copyFile(0)" onkeypress="return false" onkeydown="return false">
                                        <input type="button" style="width:calc(100%/5 - 5px)" id="p5PasteButton" disabled="disabled" value="Вставить" onclick="p5pasteFile()" onkeypress="return false" onkeydown="return false">
                                        <input type="button" style="width:calc(100%/5 - 5px)" id="p5RefreshButton" value="Обновить" onclick="p5refreshFiles()" onkeypress="return false" onkeydown="return false">
                                    </div>
                                </td>
                            </tr>
                            <tr>
                                        ...
                                        <tbody><tr>
                                            ...
                                            <td style="text-align:right;padding-right:4px">
                                                <select id="p5sortdropdown" onchange="updateFiles()">
                                                    <option value="1" selected="selected">Сортировать по имени</option>
                                                    <option value="2">Сортировать по размеру</option>
                                                    <option value="3">Сортировать по дате</option>
                                                    <option value="4">По имени по убыванию</option>
                                                    <option value="5">По размеру по убыванию</option>
                                                    <option value="6">По дате по убыванию</option>
                                                </select>
                                            </td>
                                        </tr>
                                    </tbody></table>
                ...
                <div id="p10" style="display:none;position:absolute;bottom:0;top:0;width:100%;overflow:hidden">
                    ...
                    <div id="p10dialog" style="z-index:1000;background-color:#EEE;box-shadow:0px 0px 15px #666;font-family:Arial,Helvetica,sans-serif;border-radius:5px;position:fixed;top:30px;width:300px;left:30px;display:none">
                        <div style="width:100%;background-color:#003366;color:#FFF;border-radius:5px 5px 0 0">
                            <div style="padding:5px">Настройка сочетаний клавиш</div>
                    ...
                    <div id="p10desktop" style="overflow:hidden;position:absolute;top:55px;bottom:0px;width:100%;display:none">
                        <div id="deskarea1" style="position:absolute;top:0px;width:100%;height:32px">
                            <div style="padding-top:2px;padding-bottom:2px;background:#C0C0C0;height:32px">
                                <div style="float:right;text-align:right">
                                    ...
                                    <input type="button" id="deskFullScreen" value="Полноэкранный" onclick="deskToggleFull(event)" onkeypress="return false" onkeydown="return false" disabled="disabled" style="height:28px;margin-right:3px;">
                                </div>
                                <div style="margin-left:3px">
                                    <input type="button" id="connectbutton1" value="Подключиться" onclick="connectDesktop(event,3)" onkeypress="return false" onkeydown="return false" disabled="disabled" style="height:28px">
                                    <input type="button" id="connectbutton1h" value="Аппаратное соединение" onclick="connectDesktop(event,2)" onkeypress="return false" onkeydown="return false" disabled="disabled" style="height:28px">
                                    <input type="button" id="disconnectbutton1" value="Разъединить" onclick="connectDesktop(event,0)" onkeypress="return false" onkeydown="return false" style="height:28px">
                                    <span id="deskstatus" style="color:black">Отключен</span>
                                </div>
                            </div>
                        </div>
                        ...
                        <div id="deskarea4" style="position:absolute;bottom:0px;width:100%;height:32px">
                            <div style="padding-top:2px;padding-bottom:2px;background:#C0C0C0">
                                ...
                                <div>
                                    <input id="deskActionsBtn" type="button" style="margin-left:3px;height:28px" onkeypress="return false" onkeydown="return false" value="Действия" onclick="deviceActionFunction()">
                                    <input type="button" value="Настройки" onkeypress="return false" onkeydown="return false" onclick="showDesktopSettings()" style="height:28px">
                                    <input type="button" onkeypress="return false" onkeydown="return false" value="Управление питанием..." onclick="showPowerActionDlg()" style="display:none;height:28px">
                                    ...
                                    <input type="button" id="DeskScreens" value="Экраны" onkeypress="return false" onkeydown="return false" onclick="deskSelectScreens()" style="display:none;height:28px">
                                    <label><span id="DeskControlSpan" style="display:none"><input id="DeskControl" type="checkbox" onkeypress="return false" onkeydown="return false">Ввод</span></label>
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div id="termTable" style="position:absolute;top:0;bottom:0;left:0;right:0">
                            <div id="termarea1">
                                <div class="areaHead" style="line-height:24px">
                                    <div class="toright2">
                                        <input type="button" id="termFullScreen" value="Полноэкранный" onclick="deskToggleFull(event)" onkeypress="return false" onkeydown="return false" disabled="disabled" style="height:28px;margin-right:3px;">
                                        <div id="terminalCustomUpperRight" style="float:left;margin-right:6px"></div>
                                    </div>
                                    <div>
                                        <span id="connectbutton2span" style="margin-left:3px"><input type="button" id="connectbutton2" value="Подключиться" style="height:28px" onclick="connectTerminal(event,1)" onkeypress="return false" onkeydown="return false" disabled="disabled"></span>
                                        <span id="connectbutton2sspan" style="margin-right:4px"><input type="button" id="connectbutton2s" value="Подключиться по SSH" style="height:28px" onclick="connectTerminal(event,3)" onkeypress="return false" onkeydown="return false" disabled="disabled"></span>
                                        <span id="disconnectbutton2span" style="margin-left:3px"><input type="button" id="disconnectbutton2" value="Разъединить" style="height:28px" onclick="connectTerminal(event,0)" onkeypress="return false" onkeydown="return false"></span>
                                        <span id="termstatus" style="line-height:22px">Отключен</span><span id="termtitle"></span>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div id="termarea4" style="position:relative;height:32px;">
                                <div class="areaFoot">
                                    ...
                                    <div style="height:28px">
                                        <input id="termActionsBtn" style="margin-left:3px;height:28px" type="button" title="Управление питанием устройства" onkeypress="return false" onkeydown="return false" value="Действия" onclick="deviceActionFunction()">
                        ...
                        <table id="p13toolbar" style="width:100%;height:111px" cellpadding="0" cellspacing="0">
                            <tbody><tr>
                                <td style="background-color:#C0C0C0;border-bottom:2px solid black;padding:2px;line-height:24px">
                                    <div style="float:right;text-align:right">
                                        <input id="filesActionsBtn" type="button" onkeypress="return false" onkeydown="return false" value="Действия" onclick="deviceActionFunction()" style="margin-right:2px">
                                        <div id="filesCustomUpperRight" style="float:left;margin-right:6px"></div>
                                    </div>
                                    <div style="margin-left:2px">
                                        <input id="p13AutoConnect" value="Автоподключение" onclick="autoConnectFiles(event)" onkeypress="return false" onkeydown="return false" type="button" style="display:none">
                                        <input id="p13Connect" value="Подключиться" onclick="connectFiles(event,1)" onkeypress="return false" onkeydown="return false" type="button">
                                        <input id="p13Connects" value="Подключиться по SFTP" onclick="connectFiles(event,2)" onkeypress="return false" onkeydown="return false" type="button">
                                        <input id="p13Disconnect" value="Разъединить" onclick="connectFiles(event)" onkeypress="return false" onkeydown="return false" type="button">
                                        <span class="textOverGray" id="p13Status">Отключен</span>
                                    </div>
                                </td>
                            </tr>
                            <tr>
                                <td style="width:100%;background-color:#d3d9d6;text-align:left;padding:4px" valign="bottom">
                                    <div style="width:100%;text-align:center">
                                        ...
                                        <input type="button" style="width:calc(100%/5 - 5px)" id="p13SelectAllButton" disabled="disabled" onclick="p13selectallfile()" value="Выбрать все" onkeypress="return false" onkeydown="return false">
                                        <input type="button" style="width:calc(100%/5 - 5px)" id="p13RenameFileButton" disabled="disabled" value="Переименовать" onclick="p13renamefile()" onkeypress="return false" onkeydown="return false">
                                        <input type="button" style="width:calc(100%/5 - 5px)" id="p13DeleteFileButton" disabled="disabled" value="Удалить" onclick="p13deletefile()" onkeypress="return false" onkeydown="return false">
                                        <input type="button" style="width:calc(100%/5 - 5px)" id="p13NewFolderButton" disabled="disabled" value="Папка" onclick="p13createfolder()" onkeypress="return false" onkeydown="return false">
                                    </div>
                                    <div style="width:100%;text-align:center">
                                        <input type="button" style="width:calc(100%/5 - 5px)" id="p13UploadButton" disabled="disabled" value="Загрузить" onclick="p13uploadFile()" onkeypress="return false" onkeydown="return false">
                                        <input type="button" style="width:calc(100%/5 - 5px)" id="p13CutButton" disabled="disabled" value="Вырезать" onclick="p13copyFile(1)" onkeypress="return false" onkeydown="return false">
                                        <input type="button" style="width:calc(100%/5 - 5px)" id="p13CopyButton" disabled="disabled" value="Копировать" onclick="p13copyFile(0)" onkeypress="return false" onkeydown="return false">
                                        <input type="button" style="width:calc(100%/5 - 5px)" id="p13PasteButton" disabled="disabled" value="Вставить" onclick="p13pasteFile()" onkeypress="return false" onkeydown="return false">
                                        <input type="button" style="width:calc(100%/5 - 5px)" id="p13RefreshButton" disabled="disabled" value="Обновить" onclick="p13folderup(9999)" onkeypress="return false" onkeydown="return false">
                                    </div>
                                </td>
                            </tr>
                            <tr>
                            ...
                            <tbody><tr style="height:28px">
                                <td class="areaHead">
                                    <div class="toright2">
                                        ...
                                        <input type="button" id="p15uploadCore" value="Управление агентом" onclick="p15uploadCore(event)">
                                    </div>
                                        ...
                                        <tbody><tr>
                                            ...
                                            <td id="p15outputselecttd">
                                                <select id="p15outputselect" onchange="setupConsole()">
                                                    <option id="p15outputselect1" value="1">Агент</option>
                                                    <option id="p15outputselect3" value="3">Push</option>
                                                    <option id="p15outputselect2" value="2">MQTT</option>
                                                </select>
                                            </td>
                                            <td style="width:1%"><input id="id_p15consoleClear" type="button" class="bottombutton" value="Очистить" onclick="p15consoleClear()"></td>
                                        </tr>
                                    </tbody></table>
                                </td>
                            </tr>
    ...
    <div id="dialog" style="display:none">
        ...
        <div style="margin-right:16px;margin-left:8px">
            ...
            <div id="dialog3" style="margin:auto;margin:3px">
                <select id="deskkeys" style="width:100%">
                    ...
                    <option value="0">Win+Вниз</option>
                    <option value="1">Win+Вверх</option>
            ...
            <div id="dialog4" style="margin:auto;margin:3px">
                <div id="d3upload">
                    ...
                    <select id="d3uploadMode" onchange="d3modechange()">
                        <option value="1">Локальная загрузка файлов</option>
                        <option value="2">Выбрать файл с сервера</option>
                    </select>
                </div>
            ...
            <div id="dialog7" style="margin:auto;margin:3px">
                <div id="d7meshkvm">
                    <h4 style="width:100%;border-bottom:1px solid gray">Агент удаленного рабочего стола</h4>
                    <table style="width:100%">
                        <tbody><tr>
                            <td>
                                Качество
                        ...
                        <tr>
                            ...
                            <td style="width:100px">
                                <select id="d7framelimiter" style="float:right;width:200px" dir="rtl">
                                    <option selected="selected" value="50">Быстро</option>
                        ...
                        <tr>
                            <td></td>
                            <td>
                                <label style="display:block" id="d7deskAutoLockLabel"><input type="checkbox" id="d7deskAutoLock">Заблокировать при отключении</label>
                            </td>
                        </tr>
                    </tbody></table>
                </div>
                        ...
                        <tbody><tr>
                            ...
                            <td style="width:100px">
                                <select id="d7desktopmode" style="float:right;width:200px">
                                    <option value="1">RLE8, самая быстрая</option>
                                    <option value="2">RLE16, рекомендуется</option>
                                    <option value="3">RAW8, медленно</option>
                                    <option value="4">RAW16, очень медленно</option>
                                </select>
                            </td>
                        </tr>
                    </tbody></table>
        ...
        <div id="idx_dlgButtonBar" style="padding:10px;margin-bottom:20px">
            <input id="idx_dlgCancelButton" type="button" value="Отмена" style="float:right;width:80px;margin-left:5px" onclick="dialogclose(0)">
            <input id="idx_dlgOkButton" type="button" value="OK" style="float:right;width:80px" onclick="dialogclose(1)">
            <div><input id="idx_dlgDeleteButton" type="button" value="Удалить" style="display:none" onclick="dialogclose(2)"></div>
        </div>
    </div>
    <div id="topMenu" style="z-index:1000;background-color:#EEE;box-shadow:0px 0px 15px #666;font-family:Arial,Helvetica,sans-serif;border-radius:0px 0px 5px 5px;position:fixed;top:50px;right:5px;width:170px;display:none">
        <div style="padding:12px;border-top:1px solid gray;color:black;cursor:pointer" onclick="topMenu(2)">Мои файлы</div>
        <div style="padding:12px;border-top:1px solid gray;color:black;cursor:pointer" onclick="topMenu(1)">Моя учетная запись</div>
        <div id="logoutMenuOption"><a id="logoutMenuOptionRef" href="/logout"><div style="padding:12px;border-top:1px solid gray;color:black;cursor:pointer">Выйти</div></a></div>
    </div>
    ...
    <script>
        ...
        function onStateChanged(server, state, prevState, errorCode) {
            if (state == 0) {
                ...
                if (errorCode == 'noauth') { QH('p0span', "Невозможно выполнить аутентификацию"); return; }
                if (prevState == 2) { setTimeout(serverPoll, 5000); } else { QH('p0span', "Невозможно подключить веб-сокет"); }
                // Clean up here
        ...
        function updateSelf() {
            ...
            if (typeof userinfo.passchange == 'number') {
                if (userinfo.passchange == -1) { QH('p2nextPasswordUpdateTime', " - Сброс при следующем входе."); }
                    ...
                    if (seconds < 0) { QH('p2nextPasswordUpdateTime', " - Сброс при следующем входе."); }
                    else if (seconds < 3600) { var secs = Math.floor(seconds / 60); QH('p2nextPasswordUpdateTime',format((secs == 1)?" - Сброс через 1 минуту.":" - Сброс через {0} минут.", secs)); }
                    else if (seconds < 86400) { var hours = Math.floor(seconds / 3600); QH('p2nextPasswordUpdateTime', format((hours == 1) ? " - Сброс через 1 час." : " - Сброс через {0} часов.", hours)); }
                    else { var days = Math.floor(seconds / 86400); QH('p2nextPasswordUpdateTime', format((hours == 1) ? " - Сброс через 1 день." : " - Сброс через {0} дней.", days)); }
                }
            }
        }
            ...
            switch (message.action) {
                case 'serverinfo': {
                    ...
                    if (serverinfo.certExpire != null) {
                        ...
                        if ((days >= 0) && (days < 20)) {
                            addNotification({ text: format("Срок действия сертификата истекает через {0} дн.", days) });
                        }
                    }
                ...
                case 'otpauth-request': {
                    if ((xxdialogMode == 2) && (xxdialogTag == 'otpauth-request')) {
                        if (message.err != null) {
                            var otpauthErrors = ['', "2FA заблокирована", "Резервные коды заблокированы", "Токен входа используется", "Двухфакторная аутентификация одноразовым паролем не разрешена", "Аккаунт заблокирован", "Не удалось загрузить OTPLIB"];
                            if ((message.err > 0) && (message.err < otpauthErrors.length)) { QH('d2optinfo', otpauthErrors[message.err]); } else { QH('d2optinfo', format("Ошибка  #{0}", message.err)); }
                        } else {
                            ...
                            QH('d2optinfo', format("Установка" + ' <a href="https://play.google.com/store/apps/details?id=com.google.android.apps.authenticator2" rel="noreferrer noopener" target=_blank>' + "Google Authenticator" + '</a> ' + "или совместимое приложение, используйте <a href=\"{0}\" rel=\"noreferrer noopener\" target=_blank>эту ссылку</a> или введите ключ ниже. Затем введите ниже текущий токен из 6 цифр для активации двухфакторной авторизации.", message.url) + '<br /><br /><div style=width:100%;text-align:center><tt id=d2optsecret secret="' + message.secret + '" style=font-size:15px>' + secret + '</tt><br /><br />Token: <input type=text autocomplete="one-time-code" inputmode="numeric" pattern="[0-9]*" onkeypress=\"return (event.keyCode == 8) || (event.charCode >= 48 && event.charCode <= 57)\" onkeyup=account_addOtpCheck(event) onkeydown=account_addOtpCheck() maxlength=6 id=d2otpauthinput type=text></div>');
                            QV('idx_dlgOkButton', true);
                ...
                case 'otpauth-setup': {
                    ...
                    setDialogMode(2, "Приложение-аутентификатор", 1, null, message.success ? ('<b style=color:green>' + "Приложение для аутентификации активированно успешно." + '</b> ' + "Теперь вам понадобится действительный токен, чтобы снова войти в систему.") : ('<b style=color:red>' + "Активация двухэтапного входа не удалась." + '</b> ' + "Удалите ключ из приложения и попробуйте еще раз. У вас есть всего несколько минут, чтобы ввести правильный код."));
                    break;
                }
                case 'otpauth-clear': {
                    if (xxdialogMode) return;
                    setDialogMode(2, "Приложение-аутентификатор", 1, null, message.success ? ('<b>' + "Приложение для аутентификации удалено." + '</b> ' + "Вы можете возобновить эту функцию в любое время.") : ('<b style=color:red>' + "Удаление активации двухэтапного входа не удалось." + '</b> ' + "Попытайтесь снова."));
                    break;
                }
                case 'otpauth-getpasswords': {
                    if (xxdialogMode) return;
                    var x = "Однократные токены можно использовать как вторичную аутентификацию. Сгенерируйте, распечатайте и храните их в надежном месте.";
                    ...
                    if (message.passwords) {
                        ...
                        x += '<tr><td>' + "Активных токенов нет";
                    }
                    x += '</table></div></div><br />';
                    x += '<div><input type=button value=\'' + "Закрыть" + '\' onclick=setDialogMode(0) style=float:right></input>';
                    x += '<input type=button value=\'' + "Новые токены" + '\' onclick=\'account_manageOtp(1);\'></input>';
                    if (message.passwords != null) { x += '<input type=button value=\'' + "Очистить" + '\' onclick=\'account_manageOtp(2);\'></input>'; }
                    x += '</div><br />';
                    setDialogMode(2, "Управление резервными кодами", 8, null, x, 'otpauth-manage');
                    break;
                }
                case 'verifyPhone': {
                    ...
                    x += '<br /><br /><div style=width:100%;text-align:center>' + "Код подтверждения:" + ' <input type=tel pattern="[0-9]" inputmode="number" maxlength=6 id=d2phoneCodeInput onKeyUp=account_managePhoneCodeValidate() onkeypress="if (event.key==\'Enter\') account_managePhoneCodeValidate(1)"></div></table>';
                    setDialogMode(2, "Уведомления по телефону", 3, account_managePhoneConfirm, x, message.cookie);
                    ...
                    if ((xxdialogMode == 2) && (xxdialogTag == 'previousLogins')) {
                        ...
                        if (message.events.length == 0) {
                            ...
                            for (var i in message.events) {
                                ...
                                if (m == 107) { m = "Удачный вход"; c = 'BBD1BB'; xx = ''; }
                                else if (m == 108) { m = "Неверный 2FA"; c = 'DD9DC3'; xx = 'x'; }
                                else if (m == 109) { m = "Заблокированная учетная запись"; c = 'E1BBBB'; xx = 'x'; }
                                else if (m == 110) { m = "Неверный пароль"; c = 'E1BBBB'; xx = 'x'; }
                        ...
                        setDialogMode(2, "Предыдущие входы", 1, null, x);
                    }
                    break;
                }
                case 'event': {
        ...
        function goStack() {
            ...
            if (idtype == 'files') {
                ...
                if ((features & 0x00040000) && !((userinfo.otpsecret == 1) || (userinfo.otphkeys > 0) || (userinfo.otpkeys > 0) || (userinfo.otpduo > 0) || (userinfo.otpdev > 0) || ((features & 0x00800000) && (userinfo.otpekey == 1)))) { setDialogMode(2, "Безопасность учетной записи", 1, null, "Unable to access this feature until two-factor authentication is enabled. This is required for extra security. Go to the \"My Account\" and look at the \"Account Security\" section."); return; }  
                go(5);
            }
        }
        ...
        function account_viewPreviousLogins() {
            if (xxdialogMode) return;
            setDialogMode(2, "Предыдущие входы", 1, null, "Загрузка...", 'previousLogins');
        ...
        function account_manageImage(mode) {
            ...
            setDialogMode(2, "Управление изображением учетной записи", 7, account_manageImageEx2, x, user._id);
        ...
        function toggleNightMode() {
            ...
            var x = '<input type=radio id=night0 name=nightmoderadio value=0 ' + ((cNightMode == 0) ? 'checked' : '') + '><label for=night0>' + "Использовать предпочтения браузера" + '</label><br>';
            x += '<input type=radio id=night2 name=nightmoderadio value=2 ' + ((cNightMode == 2) ? 'checked' : '') + '><label for=night2>' + "Легкий режим" + '</label><br>';
            x += '<input type=radio id=night1 name=nightmoderadio value=1 ' + ((cNightMode == 1) ? 'checked' : '') + '><label for=night1>' + "Темный режим" + '</label><br>';
            setDialogMode(2, "Ночной режим", 3, toggleNightModeEx, x);
            QV('uiMenu', false);
        }
        ...
        function account_managePhone() {
            ...
            if (userinfo.phone != null) {
                ...
                x += '<td style=text-align:center><div style=padding:6px>' + "Проверенный номер телефона" + '</div><div style=font-size:20px>' + userinfo.phone + '</div>';
                x += '<div style=margin:10px><label><input id=d2delPhone type=checkbox onclick=account_managePhoneRemoveValidate() />' + "Удалить номер телефона" + '</label></div>';
                setDialogMode(2, "Уведомления по телефону", 3, account_managePhoneRemove, x);
                ...
                x += '<br /><br /><div style=width:100%;text-align:center>' + "Телефонный номер:" + ' <input type=tel pattern="[0-9]" autocomplete="tel" inputmode="tel" maxlength=18 id=d2phoneinput onKeyUp=account_managePhoneValidate() onkeypress="if (event.key==\'Enter\') account_managePhoneValidate(1)"></div></table>';
                setDialogMode(2, "Уведомления по телефону", 3, account_managePhoneAdd, x, 'verifyPhone');
        ...
        function account_showLocalizationSettings() {
            ...
            if (serverinfo.languages && serverinfo.languages.length > 0) {
                y += "Изменение языка потребует перезагрузить страницу." + '<br /><br />';
                var z = '<select id=d2langselect style=width:180px><option value="*">' + "Использовать настройки браузера" + '</option>';
                ...
                z += '</select>';
                y += addHtmlValue("Язык", z);
            }
            y += addHtmlValue("Дата и время", x);

            if ((userinfo.siteadmin == 0xFFFFFFFF) && (domain == '')) {
                y += '<br /><a rel="noreferrer noopener" target="_blank" href="translator.htm">' + "Помочь перевести MeshCentral" + '</a>';
            }

            setDialogMode(2, "Настройки локализации", 3, account_showLocalizationSettingsEx, y);
            return false;
        }
        ...
        function account_addOtp() {
            ...
            setDialogMode(2, "Приложение-аутентификатор", 2, function () { meshserver.send({ action: 'otpauth-setup', secret: Q('d2optsecret').attributes.secret.value, token: Q('d2otpauthinput').value }); }, '<div id=d2optinfo>' + "Загрузка..." + '</div>', 'otpauth-request');
        ...
        function account_removeOtp() {
            if (xxdialogMode || (userinfo.otpsecret != 1) || ((features & 4096) == 0)) return;
            setDialogMode(2, "Приложение-аутентификатор", 3, function () { meshserver.send({ action: 'otpauth-clear' }); }, "Подтвердить удаление приложения аутентификации двухэтапного входа в систему?");
        }
        ...
        function account_showVerifyEmail() {
            ...
            var x = "Нажмите ОК для отправки подтверждения по электронной почте:" + '<br /><div style=padding:8px><b>' + EscapeHtml(userinfo.email) + '</b></div>' + "Подождите пару минут для получения подтверждения.";
            setDialogMode(2, "Подтверждение email", 3, account_showVerifyEmailEx, x);
        }
        ...
        function account_showChangeEmail() {
            ...
            setDialogMode(2, "Изменение адреса email", 3, account_changeEmail, x);
        ...
        function account_showDeleteAccount() {
            ...
            x += '<input id=account_dlgCancelButton type=button value="' + "Отмена" + '" style=float:right;width:80px;margin-left:5px onclick=dialogclose(0)>';
            x += '<input id=account_dlgOkButton type=submit value="' + "OK" + '" style="float:right;width:80px" onclick=dialogclose(1)>';
            x += '</div><br /></form>';
            setDialogMode(2, "Удалить учетную запись", 0, null, x);
        ...
        function account_showChangePassword() {
            ...
            x += '<tr><td align=right>' + nobreak("Старый пароль:") + '</td><td><input id=apassword0 type=password name=apassword0 autocomplete=off onchange=account_validateNewPassword() onkeyup=account_validateNewPassword() onkeydown=account_validateNewPassword() /> <b></b></td></tr>';
            x += '<tr><td align=right>' + nobreak("Новый пароль:") + '</td><td><input id=apassword1 type=password name=apassword1 autocomplete=off onchange=account_validateNewPassword() onkeyup=account_validateNewPassword() onkeydown=account_validateNewPassword() /> <b><span id=dxPassWarn></span></b></td></tr>';
            x += '<tr><td align=right>' + nobreak("Новый пароль:") + '</td><td><input id=apassword2 type=password name=apassword2 autocomplete=off onchange=account_validateNewPassword() onkeyup=account_validateNewPassword() onkeydown=account_validateNewPassword() /></td></tr>';
            if (features & 0x00010000) { x += '<tr><td align=right>' + "Подсказка пароля:" + '</td><td><input id=apasswordhint name=apasswordhint maxlength=250 type=text autocomplete=off onchange=account_validateNewPassword() onkeyup=account_validateNewPassword() onkeydown=account_validateNewPassword() /></td></tr>'; }
            x += '</table>'
            if (passRequirements) {
                var r = [], rc = 0;
                for (var i in passRequirements) { if ((i != 'reset') && (i != 'hint')) { r.push(i + ':' + passRequirements[i]); rc++; } }
                if (rc > 0) { x += '<br /><span style=font-size:x-small>' + format("Требования: {0}.", r.join(', ')) + '</span>'; }
            }
            x += '<br />';
            setDialogMode(2, "Смена пароля", 3, account_showChangePasswordEx, x);
            Q('apassword0').focus();
        ...
        function account_createMesh() {
            ...
            if ((userinfo.siteadmin != 0xFFFFFFFF) && ((userinfo.siteadmin & 64) != 0)) { setDialogMode(2, "Новая группа устройств", 1, null, "Эта учетная запись не имеет прав для создания новой группы устройств."); return; }

            // Remind the user to verify the email address
            if ((userinfo.emailVerified !== true) && (serverinfo.emailcheck == true) && (userinfo.siteadmin != 0xFFFFFFFF)) { setDialogMode(2, "Безопасность учетной записи", 1, null, "Невозможно получить доступ к устройству, пока адрес email не подтвержден. Это необходимо для восстановления пароля. Перейдите в раздел \"Моя учетная запись\", чтобы изменить и подтвердить адрес email."); return; }

            // Remind the user to add two factor authentication
            if ((features & 0x00040000) && !((userinfo.otpsecret == 1) || (userinfo.otphkeys > 0) || (userinfo.otpkeys > 0) || (userinfo.otpduo > 0) || (userinfo.otpdev > 0) || ((features & 0x00800000) && (userinfo.otpekey == 1)))) { setDialogMode(2, "Безопасность учетной записи", 1, null, "Невозможно получить доступ к устройству, пока не включена двухфакторная аутентификация. Это требуется для дополнительной безопасности. Перейдите в раздел \"Моя учетная запись\" и посмотрите \"Безопасность учетной записи\"."); return; }

            // We are allowed, let's prompt to information
            var x = addHtmlValue("Имя", '<input id=dp3meshname style=width:170px maxlength=64 onchange=account_validateMeshCreate() onkeyup=account_validateMeshCreate() />');
            x += addHtmlValue("Тип", '<div style=width:170px;margin:0;padding:0><select id=dp3meshtype style=width:100% onchange=account_validateMeshCreate() ><option value=2>' + "Группа программных агентов" + '</option><option value=1>' + "Только Intel&reg; AMT" + '</option></select></div>');
            x += addHtmlValue("Описание", '<div style=width:170px;margin:0;padding:0><textarea id=dp3meshdesc maxlength=1024 style=width:100%;resize:none></textarea></div>');
            setDialogMode(2, "Создать группу устройств", 3, account_createMeshEx, x);
        ...
        function account_validateNewPassword() {
            ...
            if (Q('apassword1').value != '') {
                if (passRequirements == null || passRequirements == '') {
                    ...
                    if (passReq == false) { ok = false; r = '<span style=color:red>' + "Политика" + '<span>' }
                }
            }
            QH('dxPassWarn', r);
        ...
        function updateMeshes() {
            ...
            for (i in meshes) {
                ...
                var rights = "Частичные права";
                if (meshrights == 0xFFFFFFFF) rights = "Администратор с полным доступом"; else if (meshrights == 0) rights = "Нет прав";
        ...
        function updateFiles() {
            ...
            var html1 = '', html2 = '', displayPath = '<a style=cursor:pointer;color:black onclick=p5folderup(0)>' + "Root/Корень" + '</a>', fullPath = 'Root', publicPath, filetreex = filetree, folderdepth = 1;
            ...
            for (var i in filetreexx) {
                ...
                if (f.t < 3 || f.t == 4) {
                    ...
                    var link = shortname;
                    var publiclink = '';
                    if (publicfolder) { publiclink = ' (<a style=cursor:pointer onclick=\'p5showPublicLink("' + publicPath + '/' + f.nx + '")\'>' + "Ссылка" + '</a>)'; }
        ...
        function getNiceSize(bytes) {
            if (bytes <= 0) return "Место для хранения превышено";
            if (bytes < 2048) return format("{0} байт осталось", bytes);
            if (bytes < 2097152) return format("{0} килобайт осталось", Math.round(bytes / 1024));
            if (bytes < 2147483648) return format("{0} мегабайт осталось", Math.round(bytes / 1024 / 1024));
            return format("{0} гигабайт осталось", Math.round(bytes / 1024 / 1024 / 1024));
        }
        ...
        function p5showPublicLink(u) { setDialogMode(2, "Публичная ссылка", 1, null, '<input type=text style=width:100% value="' + u + '" readonly />'); }
        ...
        function p5setActions() {
            ...
            Q('p5SelectAllButton').value = (cc > 0 ? "Пусто" : "Все");
        ...
        function p5createfolder() { setDialogMode(2, "Новая папка", 3, p5createfolderEx, '<input type=text id=p5renameinput maxlength=64 onkeyup=p5fileNameCheck(event) style=width:100% />'); focusTextBox('p5renameinput'); p5fileNameCheck(); }
        ...
        function p5deletefile() { var cc = getFileSelCount(), rec = (getFileSelDirCount() > 0) ? '<br /><br /><label><input type=checkbox id=p5recdeleteinput>' + "Рекурсивное удаление" + '</label><br>' : '<input type=checkbox id=p5recdeleteinput style=\'display:none\'>'; setDialogMode(2, "Удалить", 3, p5deletefileEx, (cc > 1) ? (format("Удалить {0} выбранных элементов?", cc) + rec) : ("Удалить выбранные элементы?" + rec)); }
        ...
        function p5pasteFile() { var x = ''; if ((p5clipboard != null) && (p5clipboard.length > 0)) { x = format("Подтвердить {0} из {1} записей в это расположение?", (p5clipboardCut == 0 ? 'copy' : 'move'), p5clipboard.length, ((p5clipboard.length > 1) ? 's' : '')) } setDialogMode(2, "Вставить", 3, p5pasteFileEx, x); }
        ...
        function p5updateClipview() { var x = ''; if ((p5clipboard != null) && (p5clipboard.length > 0)) { x = format("Задержано {0} записей для {2}", p5clipboard.length, ((p5clipboard.length > 1) ? 's' : ''), (p5clipboardCut == 0 ? "копировать" : "переместить")) + ', <a href=# onclick="return p5clearClip()" style=cursor:pointer>' + "Очистить" + '</a>.' } QH('p5bottomstatus', x); p5setActions(); }
        ...
        function updateDevices() {
            ...
            for (var i in nodes) {
                ...
                if (sort == 0) {
                    ...
                    if (((meshes[nodes[i].meshid]?nodes[i].meshid:'*') != current)) {
                        deviceHeaderSet();
                        var extra = '';
                        if ((meshes[nodes[i].meshid] != null) && (meshes[nodes[i].meshid].mtype == 1)) { extra = '<span style=color:lightgray>' + ", только для Intel&reg; AMT" + '</span>'; }
                        ...
                        if (meshes[nodes[i].meshid]) {
                            ...
                            r += '</span><span id=MxMESH><i>' + "Индивидуальные устройства" + '</i></span><span id=DevxHeader' + deviceHeaderId + ' style=color:lightgray></span></div>';
                            current = '*';
                        }
            ...
            if ((r == '') && (nodes.length > 0) && (Q('SearchInput').value != '')) {
                viewNothing = true;
                r = '<div style="margin:30px">' + "Нет устройств, соответствующих этому запросу." + '</div>';
            }
            ...
            if ((sort == 0) && (Q('SearchInput').value == '')) {
                for (var i in meshes) {
                    ...
                    if ((displayedMeshes[mesh._id] == null) && (IsMeshViewable(mesh))) {
                        ...
                        if (mesh.mtype == 1) { r += '<div style=padding:10px><i>' + "Intel&reg; AMT устройств в этой группе нет"; }
                        if (mesh.mtype > 1) { r += '<div style=padding:10px><i>' + "В этой группе нет устройств"; }
                        r += '.</i></div></div>';
                        current = mesh._id;
                        count++;
                    }
            ...
            if (count == 0) {
                if ((Q('SearchInput').value != '') || (Q('OnlineCheckBox').checked)) {
                    QH('xdevices', '<div style="margin-top:50px;text-align:center"><span style="font-size:30px">' + "Устройств нет" + '</span><br /><br />' + "Нет устройств, соответствующих этому запросу." + ' <a onclick=clearSearchInput() style=cursor:pointer>' + "Очистить фильтр поиска" + '</a></div>');
                } else {
                    QH('xdevices', '<div style="margin-top:50px;text-align:center"><span style="font-size:30px">' + "Устройств нет" + '</span><br /><br />' + "Чтобы добавить устройства, используйте настольную версию этого сайта." + '</div>');
                }
            } else {
                QH('xdevices', r);
            }
        ...
        function updateDeviceViewHtml(div, node) {
            ...
            if ((div.offsetTop >= visibleTop) && (div.offsetTop < visibleBottom)) {
                ...
                if (title.length == 0) { title = '<i>' + "Пусто" + '</i>'; }
                ...
                if (name.length == 0) { name = '<i>' + "Пусто" + '</i>'; }
                ...
                if (node.sessions != null) {
                    ...
                    if (node.sessions.battery != null) {
                        ...
                        var statestr = '';
                        if (bat.state == 'ac') { statestr = "Устройство подключено"; }
                        else if (bat.state == 'dc') { statestr = "Устройство работает от аккумулятора"; }
        ...
        function showDeviceHelpRequests(nodeid, force, e) {
            ...
            if (x != '') { setDialogMode(2, "Запросы на помощь" + ' - ' + EscapeHtml(node.name), 1, null, x, 'HELPREQ-' + node._id); } else { setDialogMode(0); }
            return false;
        }
        ...
        function showDeviceSessions(nodeid, force, e) {
            ...
            for (var i in node.sessions) {
                if ((i == 'kvm') && (node.sessions.multidesk == null)) {
                    x += '<u>' + "Удаленного рабочего стола" + '</u>';
                    for (var j in node.sessions.kvm) {
                        if (j.startsWith('user/')) {
                            var trash = '';
                            if ((j == userinfo._id) || (GetNodeRights(node) == 0xFFFFFFFF)) { trash = ' <a href=# onclick=\'return endDeviceSession("kvm", "' + encodeURIComponentEx(node._id) + '", "' + encodeURIComponentEx(j) + '")\' title="' + "Отключить этот сеанс" + '" style=cursor:pointer><img src=images/trash.png border=0 height=10 width=10></a>'; }
                            x += addHtmlValue4(getUserName(j), ((node.sessions.kvm[j] == 1) ? "1 сессия" : nobreak(format("{0} сессий", node.sessions.kvm[j]))) + trash);
                        } else if (j == 'busy') {
                            x += addHtmlValue2("Устройство занято", ((node.sessions.kvm[j] == 1) ? "1 сессия" : nobreak(format("{0} сессий", node.sessions.kvm[j]))));
                        }
                    }
                } else if (i == 'multidesk') {
                    x += '<u>' + "Удаленного рабочего стола" + '</u>';
                    for (var j in node.sessions.multidesk) {
                        var trash = '';
                        if ((j == userinfo._id) || (GetNodeRights(node) == 0xFFFFFFFF)) { trash = ' <a href=# onclick=\'return endDeviceSession("multidesk", "' + encodeURIComponentEx(node._id) + '", "' + encodeURIComponentEx(j) + '")\' title="' + "Отключить этот сеанс" + '" style=cursor:pointer><img src=images/trash.png border=0 height=10 width=10></a>'; }
                        x += addHtmlValue4(getUserName(j), ((node.sessions.multidesk[j] == 1) ? "1 сессия" : nobreak(format("{0} сессий", node.sessions.multidesk[j]))) + trash);
                    }
                } else if (i == 'terminal') {
                    x += '<u>' + "Терминал" + '</u>';
                    for (var j in node.sessions.terminal) {
                        var trash = '';
                        if ((j == userinfo._id) || (GetNodeRights(node) == 0xFFFFFFFF)) { trash = ' <a href=# onclick=\'return endDeviceSession("terminal", "' + encodeURIComponentEx(node._id) + '", "' + encodeURIComponentEx(j) + '")\' title="' + "Отключить этот сеанс" + '" style=cursor:pointer><img src=images/trash.png border=0 height=10 width=10></a>'; }
                        x += addHtmlValue4(getUserName(j), ((node.sessions.terminal[j] == 1) ? "1 сессия" : nobreak(format("{0} сессий", node.sessions.terminal[j]))) + trash);
                    }
                } else if (i == 'files') {
                    x += '<u>' + "Файлы" + '</u>';
                    for (var j in node.sessions.files) {
                        var trash = '';
                        if ((j == userinfo._id) || (GetNodeRights(node) == 0xFFFFFFFF)) { trash = ' <a href=# onclick=\'return endDeviceSession("files", "' + encodeURIComponentEx(node._id) + '", "' + encodeURIComponentEx(j) + '")\' title="' + "Отключить этот сеанс" + '" style=cursor:pointer><img src=images/trash.png border=0 height=10 width=10></a>'; }
                        x += addHtmlValue4(getUserName(j), ((node.sessions.files[j] == 1) ? "1 сессия" : nobreak(format("{0} сессий", node.sessions.files[j]))) + trash);
                    }
                } else if (i == 'tcp') {
                    x += '<u>' + "TCP-маршрутизация" + '</u>';
                    for (var j in node.sessions.tcp) {
                        var trash = '';
                        if ((j == userinfo._id) || (GetNodeRights(node) == 0xFFFFFFFF)) { trash = ' <a href=# onclick=\'return endDeviceSession("tcp", "' + encodeURIComponentEx(node._id) + '", "' + encodeURIComponentEx(j) + '")\' title="' + "Отключить этот сеанс" + '" style=cursor:pointer><img src=images/trash.png border=0 height=10 width=10></a>'; }
                        x += addHtmlValue4(getUserName(j), ((node.sessions.tcp[j] == 1) ? "1 сессия" : nobreak(format("{0} сессий", node.sessions.tcp[j]))) + trash);
                    }
                } else if (i == 'udp') {
                    x += '<u>' + "UDP-маршрутизация" + '</u>';
                    for (var j in node.sessions.udp) {
                        var trash = '';
                        if ((j == userinfo._id) || (GetNodeRights(node) == 0xFFFFFFFF)) { trash = ' <a href=# onclick=\'return endDeviceSession("udp", "' + encodeURIComponentEx(node._id) + '", "' + encodeURIComponentEx(j) + '")\' title="' + "Отключить этот сеанс" + '" style=cursor:pointer><img src=images/trash.png border=0 height=10 width=10></a>'; }
                        x += addHtmlValue4(getUserName(j), ((node.sessions.udp[j] == 1) ? "1 сессия" : nobreak(format("{0} сессий", node.sessions.udp[j]))) + trash);
                    }
                }
            }
            if (x != '') { setDialogMode(2, "Сессии" + ' - ' + EscapeHtml(node.name), 1, null, x, 'SESSIONS-' + node._id); } else { setDialogMode(0); }
        }
        ...
        function showDeviceMessages(nodeid, force, e) {
            ...
            x += '</div>';
            if (count > 0) setDialogMode(2, "Сообщения агента" + ' - ' + EscapeHtml(node.name), 1, null, x, 'MESSAGES-' + node._id);
            return false;
        }

        var powerStatetable = ['', "Включено", "Отправить в сон", "Отправить в сон", "Отправить в сон", "Гибернация", "Выключить", "Текущее состояние", "Выключено"];
        var powerStateStrings = ['', "Включено", "В режиме сна", "В режиме сна", "Глубокий сон", "Гибернация", "Soft-Off", "Текущее состояние", "Выключено"];
        var powerStateStrings2 = ['', "Устройство включено", "Устройство находится в спящем режиме (S1)", "Устройство находится в спящем режиме (S2)", "Устройство находится в состоянии глубокого сна (S3)", "Устройство находится в режиме гибернации (S4)", "Устройство находится в выключенном состоянии (S5)", "Устройство присутствует, но состояние питания не может быть определено", "Устройство выключено"];
        ...
        function NodeStateStr(node) {
            ...
            if (node.conn) {
                if ((node.conn & 1) != 0) { states.push('<span>' + ((node.mtype == 4) ? ((node.porttype == 'PDU') ? "Свитч" : "IP-KVM") : "Агент") + '</span>'); }
                if ((node.conn & 2) != 0) { states.push('<span>' + "CIRA" + '</span>'); }
                else if ((node.conn & 4) != 0) { states.push('<span>' + "Intel&reg; AMT" + '</span>'); }
                if ((node.conn & 8) != 0) { states.push('<span>' + "Ретранслятор" + '</span>'); }
        ...
        function deviceHeaderSet() {
            ...
            deviceHeaders['DevxHeader' + deviceHeaderId] = ', ' + deviceHeaderTotal + ((deviceHeaderTotal == 1) ? " устройство" : " устройства");
            var title = '';
        ...
        */
        ...
        function gotoDevice(nodeid, panel, refresh) {
            ...
            if (!currentNode || currentNode._id != node._id || refresh == true) {
                ...
                if ((currentNode.sessions != null) && (currentNode.sessions.battery != null)) {
                    ...
                    var statestr = '';
                    if (bat.state == 'ac') { statestr = "Устройство подключено"; }
                    if (bat.state == 'dc') { statestr = "Устройство работает от аккумулятора"; }
                ...
                if (nname.length == 0) { nname = '<i>' + "Пусто" + '</i>'; }
                ...
                // Attribute: Mesh
                if (mesh) { x += addDeviceAttribute('<span>' + "Группа" + '</span>', '<a onclick=goForward("' + node.meshid + '") style=cursor:pointer>' + EscapeHtml(meshes[node.meshid].name) + '</a>'); }

                // Attribute: Name
                if (node.rname != null) { x += addDeviceAttribute('<span>' + "Имя" + '</span>', '<span>' + EscapeHtml(node.rname) + '</span>'); }

                // Attribute: Host
                if ((((features & 1) == 0) && (node.mtype != 4)) || (node.mtype == 3)) { // If not WAN-only, local hostname is in use
                    if ((meshrights & 4) != 0) {
                        if (node.host) {
                            x += addDeviceAttribute("Имя хоста", '<span onclick=showEditNodeValueDialog(1) style=cursor:pointer>' + EscapeHtml(node.host) + '</span>');
                        } else {
                            x += addDeviceAttribute("Имя хоста", '<span onclick=showEditNodeValueDialog(1) style=cursor:pointer><i>' + "Пусто" + '</i></span>');
                        }
                    } else {
                        x += addDeviceAttribute("Имя хоста", EscapeHtml(node.host));
                    }
                }

                // Attribute: Description
                var description = node.desc ? EscapeHtml(node.desc) : '<i>' + "Пусто" + '</i>';
                if ((meshrights & 4) != 0) {
                    x += addDeviceAttribute("Описание", '<span onclick=showEditNodeValueDialog(2) style=cursor:pointer>' + description + '</span>');
                } else {
                    x += addDeviceAttribute("Описание", description);
                }

                // IP-KVM information
                if (node.mtype == 4) {
                    if (node.portnum != null) { x += addDeviceAttribute("Номер порта", node.portnum); }
                    if (node.porttype != null) { x += addDeviceAttribute("Тип порта", node.porttype); }
                }

                // Attribute: Mesh Agent
                if ((node.agent != null) && (node.agent.id != null) && (node.mtype == 3)) {
                    if (node.agent.id == 4) { x += addDeviceAttribute("Тип устройства", "Windows"); }
                    if (node.agent.id == 6) { x += addDeviceAttribute("Тип устройства", "Linux"); }
                    if (node.agent.id == 29) { x += addDeviceAttribute("Тип устройства", "macOS"); }
                    ...
                    if ((node.agent.root === false) && ((node.conn & 1) != 0)) { str += ', ' + "Ограниченный"; }
                ...
                if (node.intelamt != null) {
                    var str = '';
                    var provisioningStates = { 0: nobreak("Не активированно (Pre)"), 1: nobreak("Не активированно (In)"), 2: nobreak("Активировано") };
                    if (node.intelamt.ver != null && node.intelamt.state == null) { str += '<i>' + nobreak("Состояние неизвестно") + '</i>, v' + EscapeHtml(node.intelamt.ver); }
                    else if ((node.intelamt.ver == null) && (node.intelamt.state == 2)) { str += '<i>' + "Активировано" + '</i>'; }
                    else if ((node.intelamt.ver == null) || (node.intelamt.state == null)) { str += '<i>' + "Версия и состояние неизвестны" + '</i>'; }
                    else {
                    ...
                    if (node.intelamt.state == 2) {
                        if (node.intelamt.tls == 1) { str += ', <span title="' + "Intel&reg; AMT настроен с TLS безопасностью сети" + '">' + "TLS" + '</span>'; }
                        ...
                        if (node.intelamt.user == null || node.intelamt.user == '') { // If credentials are not set, allow setting them.
                            if ((meshrights & 4) != 0) {
                                str += ', <i style=color:#FF0000;cursor:pointer title="' + "Редактировать учетные данные Intel&reg; AMT" + '" onclick=editDeviceAmtSettings("' + node._id + '")>' + "Учетных данных нет" + '</i>';
                                editUserCredentialsIcon = true;
                            } else {
                                str += ', <i style=color:#FF0000>' + "Учетных данных нет" + '</i>';
                            }
                            ...
                            var warn = null;
                            if ((node.intelamt.warn & 1) != 0) { warn = "Неверные учетные данные"; }
                            if ((node.intelamt.warn & 8) != 0) { warn = "Проверка учетных данных"; }
                            if (warn != null) {
                                if ((meshrights & 4) != 0) {
                                    str += ', <i style=color:#FF0000;cursor:pointer title="' + "Редактировать учетные данные Intel&reg; AMT" + '" onclick=editDeviceAmtSettings("' + node._id + '")>' + warn + '</i>';
                                    editUserCredentialsIcon = true;
                                } else {
                        ...
                        if (editUserCredentialsIcon) {
                            str += '<img src=images/link4.png height=10 width=10 title="' + "Редактировать учетные данные Intel&reg; AMT" + '" style=cursor:pointer onclick=editDeviceAmtSettings("' + node._id + '")>';
                        }
                    }
                ...
                if (connectivity && connectivity > 1) {
                    var cstate = [];
                    if ((node.conn & 1) != 0) cstate.push('<span>' + ((node.mtype == 4) ? ((node.porttype == 'PDU') ? "Свитч" : "IP-KVM") : "Агент") + '</span>');
                    ...
                    x += addDeviceAttribute("Соединение", cstate.join(', '));
                }

                // Node tags
                var groupingTags = '<i>' + "Пусто" + '</i>';
                ...
                if ((node.ssh != null) || (node.rdp != null)) {
                    var y = [];
                    if ((meshrights & 4) != 0) {
                        if (node.ssh != null) { y.push('<span onclick=showClearSshDialog(3) style=cursor:pointer>' + ((node.ssh == 1) ? "SSH-Пользователь+Пароль" : ((node.ssh == 2) ? "SSH-Пользователь+Ключ+Пароль" : "SSH-Пользователь+Ключ")) + ' <img class=hoverButton src="images/link5.png" width=10 height=10 /></span>'); }
                        ...
                        if (node.ssh != null) { y.push(((node.ssh == 1) ? "SSH-Пользователь+Пароль" : ((node.ssh == 2) ? "SSH-Пользователь+Ключ+Пароль" : "SSH-Пользователь+Ключ"))); }
                        if (node.rdp != null) { y.push("RDP"); }
                    }
                    x += addDeviceAttribute("Учетные данные", y.join(', '));
                }

                x += '</table><br />';
                // Show action button, only show if we have permissions 4, 8, 64
                if (((meshrights & (4 + 8 + 64 + 262144)) != 0) && (node.mtype < 3)) { x += '<input type=button value="' + "Действия" + '" onclick=deviceActionFunction() />'; }
                x += '<input type=button value="' + "Примечания" + '" onclick=showNotes(' + ((meshrights & 128) == 0) + ',"' + encodeURIComponent(node._id) + '") />';
                ...
                if ((node.mtype == 4) && (connectivity & 1)) {
                    if (node.porttype == 'PDU') {
                        if (node.pwr == 1) {
                            if (meshrights & 0x40000) { x += '<input type=button value="' + "Выключить" + '" title="' + "Выключить" + '" onclick=setIpPduState(0) />'; }
                        } else if (node.pwr == 8) {
                            if (meshrights & 0x40) { x += '<input type=button value="' + "Включить" + '" title="' + "Включить" + '" onclick=setIpPduState(1) />'; }
                        }
                    } else {
                        if (meshrights & 8) { x += '<input type=button value="' + "Удаленное управление" + '" title="' + "Удаленное управление" + '" onclick=openIpKvmRemoteControl("' + encodeURIComponentEx(node._id) + '") />'; }x
                    }
                }
                ...
                if ((meshrights & 0x8000) != 0) { x += '<a style=cursor:pointer onclick=p10showDeleteNodeDialog("' + node._id + '")>' + "Удалить устройство" + '</a>'; }
                ...
                if ((connectivity & 1) != 0) { if (powerstate.length > 0) { powerstate += ', '; } powerstate += ((node.mtype == 4) ? ((node.porttype == 'PDU') ? "Свитч" : "IP-KVM") : "Mesh Agent"); }
                if ((connectivity & 2) != 0) { if (powerstate.length > 0) { powerstate += ', '; } powerstate += "Intel&reg; AMT подключен"; }
                else if ((connectivity & 4) != 0) { if (powerstate.length > 0) { powerstate += ', '; } powerstate += "Intel&reg; AMT обнаружен"; }
                if ((connectivity & 16) != 0) { if (powerstate.length > 0) { powerstate += ', '; } powerstate += "Подключен MQTT канал"; }
        ...
        function setIpPduState(op) {
            if (op == 0) {
                setDialogMode(2, "Работа с питанием", 3, function () { meshserver.send({ action: 'poweraction', nodeids: [currentNode._id], actiontype: 2 }); }, "Выключить питание?"); // Turn off
            } else {
                setDialogMode(2, "Работа с питанием", 3, function () { meshserver.send({ action: 'wakedevices', nodeids: [currentNode._id] }); }, "Включить питание?"); // Turn on
            }
        }
        ...
        function deviceToastFunction() {
            if (xxdialogMode) return;
            setDialogMode(2, "Уведомление устройства в трее", 3, deviceToastFunctionEx, '<textarea id=d2devToast style=width:100%;height:80px;resize:none;overflow-y:scroll></textarea>');
        }
        ...
        function setupDeviceMenu(op, obj) {
            ...
            var menus = [];
            if (currentDevicePanel != 0) { menus.push({ n: "Сводка", f: 'setupDeviceMenu(0)' }); }
            ...
            ) { menus.push({ n: "Рабочий стол", f: 'setupDeviceMenu(1)' }); }
            ...
            ) { menus.push({ n: "Терминал", f: 'setupDeviceMenu(5)' }); }

            if ((currentDevicePanel != 2) && (currentNode != null) && (meshrights & 8) && ((meshrights == 0xFFFFFFFF) || ((meshrights & 1024) == 0)) && ((currentNode.mtype != 1) && (currentNode.agent) && (currentNode.agent.caps & 4))) { menus.push({ n: "Файлы", f: 'setupDeviceMenu(2)' }); }
            if ((currentDevicePanel != 3) && (currentNode != null) && (currentNode.mtype < 3) && ((meshrights & 1048576) != 0)) { menus.push({ n: "Детали", f: 'setupDeviceMenu(3)' }); }
        ...
        function deviceActionFunction() {
            ...
            var x = "Выберите действие для осуществления на этом устройстве." + '<br /><br />';
            ...
            if ((currentNode.agent != null) && (currentNode.agent.id == 14)) {
                if (((currentNode.conn & 1) != 0) && ((rights & 8) != 0)) {
                    count++;
                    y += '<option value=400>' + "Вспышка" + '</option>';
                    y += '<option value=401>' + "Вибрировать" + '</option>';
                    z += '<div id=d2devicetimediv>' + addHtmlValue("Время", '<select id=d2devicetime style=float:right;width:170px><option value=1000>' + "1 секунда" + '</option><option value=5000>' + "5 секунд" + '</option><option value=10000>' + "10 секунд" + '</option></select>') + '</div>';
                }
            } else {
                if ((rights & 64) != 0) { count++; y += '<option value=100>' + "Разбудить" + '</option>'; } // Wake-up permission
                //if (((currentNode.conn & 1) != 0) && ((rights & 131072) != 0)) { count++; y += '<option value=106>' + "Run Commands" + '</option>'; } // Remote command permission
                if ((currentNode.conn != 0) && ((rights & 262144) != 0)) { count++; y += '<option value=4>' + "Отправить в сон" + '</option><option value=3>' + "Перезагрузить" + '</option><option value=2>' + "Выключить" + '</option>'; }
                ...
                if ((currentNode.intelamt != null) && (currentNode.intelamt.state == 2) && ((currentNode.conn & 6) != 0) && ((rights & 262144) != 0)) {
                    count++;
                    y += '<option value=310>' + "Сброс Intel&reg; AMT" + '</option>';
            ...
            y += '</select>';
            x += addHtmlValue("Операция", y);
            if (count == 0) { x = "В настоящее время для этого устройства нет доступных действий."; }
            setDialogMode(2, "Управление устройством", (count == 0) ? 2 : 3, deviceActionFunctionEx, x + z);
        ...
        function deviceActionFunctionEx() {
            ...
            if (op == 100) {
                ...
                */
                ...
                setDialogMode(2, "Intel&reg; AMT Power Operation", 3, function () { meshserver.send({ action: 'poweraction', nodeids: [currentNode._id], actiontype: parseInt(op) }); }, "Включить питание Intel&reg; AMT?");
                ...
                setDialogMode(2, "Intel&reg; AMT Power Operation", 3, function () { meshserver.send({ action: 'poweraction', nodeids: [currentNode._id], actiontype: parseInt(op) }); }, "Выполнить сброс Intel&reg; AMT?");
        ...
        function showNotes(readonly, noteid) {
            ...
            if (noteid.startsWith('node%2F%2F')) { x += '<span style=font-size:10px>' + "Примечания могут быть просмотрены и изменены другими администраторами." + '<span>'; }
            setDialogMode(2, "Примечания", 3, showNotesEx, x, noteid);
        ...
        function deviceLockFunction() {
            if ((xxdialogMode != null || xxdialogMode == 0) && (desktop != null) && (desktop.contype == 1)) { setDialogMode(2, "Заблокировать рабочий стол", 3, function() { if ((desktop != null) && (desktop.contype == 1)) { desktop.sendCtrlMsg('{"ctrlChannel":"102938","type":"lock"}'); } }, "Заблокировать рабочий стол пользователя?"); }
        }

        function deviceChat(e) {
            if (xxdialogMode) return;
            setDialogMode(2, "Управление устройством", 3, function () {
        ...
        function deviceUrlFunction() {
            if (xxdialogMode) return;
            setDialogMode(2, "Открыть страницу на устройстве", 3, deviceUrlFunctionEx, '<input id=d2devurl placeholder="http://server.com" style=width:100%;overflow-y:scroll onkeyup=deviceUrlFunctionValidate() onchange=deviceUrlFunctionValidate()></input>');
            Q('d2devurl').focus();
        ...
        function d2runCommandDialog(options) {
            ...
            if ((wintype == true) || (linuxtype == true) || (agenttype == true)) {
                ...
                if (wintype == true) { x += '<option value=1' + ((runopt.type == 1)?' selected':'') + '>' + "Командная строка Windows" + '</option><option value=2' + ((runopt.type == 2)?' selected':'') + '>' + "Windows PowerShell" + '</option>'; }
                if (linuxtype == true) { x += '<option value=3' + ((runopt.type == 3)?' selected':'') + '>' + "Командная оболочка Linux/BSD/macOS" + '</option>'; }
                ...
                x += '</select>';
                x += '<select id=d2cmduser style=width:100%;margin-bottom:4px><option value=0' + ((runopt.runAs == 0)?' selected':'') + '>' + "Запуск от имени агента" + '</option><option value=1' + ((runopt.runAs == 1)?' selected':'') + '>' + "Запуск от имени пользователя, если нет пользователя, то от агента" + '</option><option value=2' + ((runopt.runAs == 2)?' selected':'') + '>' + "Запуск только от имени пользователя" + '</option></select>';
                ...
                setDialogMode(2, "Выполнить команды", 3, d2groupActionFunctionRunCommands, x, options);
                if (options.selectedFile == null) {
                    Q('d2runcmd').focus();
        ...
        function editDeviceAmtSettings(nodeid, func) {
            ...
            x += addHtmlValue("Имя пользователя", '<input id=dp10username style=width:170px maxlength=32 autocomplete=nope placeholder="admin" onchange=validateDeviceAmtSettings() onkeyup=validateDeviceAmtSettings() />');
            ...
            if ((features2 & 1) == 0) { x += addHtmlValue("Защита", '<select id=dp10tls style=width:176px><option value=0>' + "Нет безопасности TLS" + '</option><option value=1>' + "Требуется безопасность TLS" + '</option></select>'); }
            if ((node.intelamt.user != null) && (node.intelamt.user != '')) { buttons = 7; }
            setDialogMode(2, "Редактировать учетные данные Intel&reg; AMT", buttons, editDeviceAmtSettingsEx, x, { node: node, func: func });
        ...
        function p10showDeleteNodeDialog(nodeid) {
            if (xxdialogMode) return;
            setDialogMode(2, "Удалить устройство", 3, p10showDeleteNodeDialogEx, format("Удалить {0}?", EscapeHtml(currentNode.name)) + '<br /><br /><label><input id=p10check type=checkbox onchange=p10validateDeleteNodeDialog() />' + "Подтвердить" + '</label>', nodeid);
        ...
        function p10showiconselector() {
            ...
            setDialogMode(2, "Выбор иконки", 0, null, x);
        ...
        function showClearSshDialog() { setDialogMode(2, "Редактировать устройство", 3, showClearSshDialogEx, "Очистить учетные данные SSH?"); }
        function showClearSshDialogEx(button, mode) { meshserver.send({ action: 'changedevice', nodeid: currentNode._id, ssh: 0 }); }
        function showClearRdpDialog() { setDialogMode(2, "Редактировать устройство", 3, showClearRdpDialogEx, "Очистить учетные данные RDP?"); }
        function showClearRdpDialogEx(button, mode) { meshserver.send({ action: 'changedevice', nodeid: currentNode._id, rdp: 0 }); }

        var showEditNodeValueDialog_modes = ["Имя устройства", "Имя хоста", "Описание", "Теги"];
        var showEditNodeValueDialog_modes2 = ['name', 'host', 'desc', 'tags'];
        var showEditNodeValueDialog_modes3 = ['', '', '', "Группа1, Группа2, Группа3"];
        function showEditNodeValueDialog(mode) {
            ...
            setDialogMode(2, "Редактировать устройство", 3, showEditNodeValueDialogEx, x, mode);
        ...
        var agentConsoleMessages = ['', "Ожидание предоставления доступа пользователем ...", "Отказано", "Не удалось запустить сеанс удаленного терминала, {0} ({1})", "Тайм-аут", "Получены неверные сетевые данные"];
        ...
        function showDesktopSettings() {
            ...
            applyDesktopSettings();
            updateDesktopButtons();
            setDialogMode(7, "Настройки удаленного рабочего стола", 3, showDesktopSettingsChanged);
        }
        ...
        function updateDeskShortcutKeys() {
            var x = '<div class="menuButton" onclick="deskMenuButton(-1)">' + "Настроить" + '</div>';
        ...
        var keyStrings = { 8: "Backspace", 9: "Tab", 13: "Ввод", 27: "Escape", 32: "Space", 44: "Print Screen", 45: "Insert", 46: "Del", 36: "Home", 35: "Конец", 32: "Espace", 33: "Page Up", 34: "Page Down", 37: "Left", 38: "Up", 39: "Right", 40: "Down", 0: "Пусто" }
        ...
        function deskCustomizeKeys() {
            ...
            x += '</select> <input type=button value=' + "Добавить" + ' onclick=addDeskCustomizeKey() /></div>';
            QH('p10dialog2', x);
            xxdialogMode = 2;
            QV('p10dialog', true);
        ...
        function deskUpdateShortcutList() {
            ...
            if (x == '') { x = '<i>' + "Сочетания клавиш не заданны" + '</i>'; }
            QH('d2shortcuts', x);
        }
        ...
        function sendSpecialKeys() {
            if (xxdialogMode || desktop == null || desktop.State != 3) return;
            setDialogMode(3, "Специальные клавиши", 3, deskSendKeys);
        }
        ...
        function deskSelectScreens() {
            ...
            x = addHtmlValue4("Экран", '<select style=width:100% id=deskdisplays>' + x + '</select>');
            setDialogMode(2, "Выбор экрана", 3, deskSelectScreensEx, x);
        }
        ...
        function cmsshportaction(action) {
            if (xxdialogMode) return;
            var x = "Порт удаленного подключения SSH:" + '<br /><br /><input type=text placeholder="22" inputmode="numeric" pattern="[0-9]*" onkeypress="return (event.keyCode == 8) || (event.charCode >= 48 && event.charCode <= 57)" maxlength=5 id=d10sshport type=text>';
            setDialogMode(2, "SSH соединение", 3, function () {
        ...
        function sshTunnelAuthDialog(j, func) {
            var x = '';
            if (j.askkeypass) {
                x += addHtmlValue("Аутентификация", '<select id=dp2authmethod style=width:150px onchange=sshAuthUpdate(event)><option value=3 selected>' + "Сохраненный ключ" + '</option><option value=1>' + "Имя пользователя и пароль" + '</option><option value=2>' + "Имя пользователя и ключ" + '</option></select>');
            } else {
                x += addHtmlValue("Аутентификация", '<select id=dp2authmethod style=width:150px onchange=sshAuthUpdate(event)><option value=1 selected>' + "Имя пользователя и пароль" + '</option><option value=2>' + "Имя пользователя и ключ" + '</option></select>');
            }
            x += '<div id=d2userauth style=display:none>';
            x += addHtmlValue("Имя пользователя", '<input id=dp2user style=width:150px maxlength=64 autocomplete=off onkeyup=sshAuthUpdate(event) />');
            x += '</div>';
            ...
            if ((features2 & 0x00400000) == 0) { x += '<label><input id=dp2keep type=checkbox>' + "Запомнить учетные данные" + '</label>'; }
            x += '</div><div id=d2keyauth style=display:none>';
            x += addHtmlValue("Ключевой файл", '<input type=file id=dp2key style=width:150px maxlength=64 autocomplete=off onchange=sshAuthUpdate(event) />' + '<div id=d2badkey style=font-size:x-small>' + "Ключевой файл должен быть в формате OpenSSH." + '</div>');
            ...
            if ((features2 & 0x00400000) == 0) {
                x += '<label><input id=dp2keep1 type=checkbox onchange=sshAuthUpdate(event)>' + "Запомнить пользователя и ключ" + '</label><br/>';
                x += '<label><input id=dp2keep2 type=checkbox>' + "Запомнить пароль" + '</label>';
            }
            x += '</div>';
            if (j.askkeypass) {
            ...
            setDialogMode(2, "Аутентификация", 11, func, x, 'ssh');
            Q('dp2user').focus();
            sshAuthUpdate();
            ...
            if (typeof data == 'string') {
                if (data[0] == '{') {
                    ...
                    switch (j.action) {
                        ...
                        case 'autherror': { p12setConsoleMsg("Ошибка аутентификации", 5000); break; }
                        case 'sessionerror': { p12setConsoleMsg("Сессия истекла", 5000); break; }
                        case 'sessiontimeout': { p12setConsoleMsg("Тайм-аут сеанса", 5000); break; }
                    }
                } else if (data[0] == '~') {
        ...
        */
        ...
        function p13gotFiles(data) {
            ...
            switch (data.action) {
                ...
                case 'autherror': { p13setConsoleMsg("Ошибка аутентификации", 5000); return; }
                case 'connectionerror': { p13setConsoleMsg("Ошибка соединения", 5000); return; }
                case 'sessionerror': { p13setConsoleMsg("Сессия истекла", 5000); return; }
                case 'sessiontimeout': { p13setConsoleMsg("Тайм-аут сеанса", 5000); return; }
            }
        ...
        function p13updateFiles(checkedNames) {
            var html1 = '', html2 = '', displayPath = '<a style=cursor:pointer;color:black onclick=p13folderup(0)>' + "Root/Корень" + '</a>', fullPath = 'Root';
        ...
        function p13setActions() {
            ...
            if (p13filetree == null) {
                ...
                Q('p13SelectAllButton').value = "Все";
                ...
                Q('p13SelectAllButton').value = (cc > 0 ? "Пусто" : "Все");
        ...
        function p13createfolder() { setDialogMode(2, "Новая папка", 3, p13createfolderEx, '<input type=text id=p13renameinput maxlength=64 onkeyup=p13fileNameCheck(event) style=width:100% />'); focusTextBox('p13renameinput'); p13fileNameCheck(); }
        ...
        function p13deletefile() { var cc = p13getFileSelCount(), rec = (p13getFileSelDirCount() > 0) ? '<br /><br /><label><input type=checkbox id=p13recdeleteinput>' + "Рекурсивное удаление" + '</label><br>' : '<input type=checkbox id=p13recdeleteinput style=\'display:none\'>'; setDialogMode(2, "Удалить", 3, p13deletefileEx, (cc > 1) ? (format("Удалить {0} выбранных элементов?", cc) + rec) : ("Удалить выбранные элементы?" + rec)); }
        ...
        function p13renamefile() { var renamefile, checkboxes = document.getElementsByName('fd'); for (var i = 0; i < checkboxes.length; i++) { if (checkboxes[i].checked) { renamefile = p13filetree.dir[checkboxes[i].value].n; } } setDialogMode(2, "Переименовать", 3, p13renamefileEx, '<input type=text id=p13renameinput maxlength=64 onkeyup=p13fileNameCheck(event) style=width:100% value="' + renamefile + '" />', { action: 'rename', path: p13filetreelocation.join('/'), oldname: renamefile }); focusTextBox('p13renameinput'); p13fileNameCheck(); }
        ...
        function p13uploadFile() { setDialogMode(2, "Загрузить файл", 3, p13uploadFileEx, '<input type=file name=files id=p13uploadinput style=width:100% multiple=multiple onchange="updateUploadDialogOk(\'p13uploadinput\')" />'); updateUploadDialogOk('p13uploadinput'); }
        ...
        function p13viewfile() {
            ...
            for (var i = 0; i < checkboxes.length; i++) {
                if (checkboxes[i].checked) {
                    ...
                    } else { messagebox("Редактор файлов", "Редактировать можно только файлы размером менее 200КБ."); }
                    break;
                }
            }
        }
        ...
        function p13pasteFile() {
            ...
            if ((p13clipboard != null) && (p13clipboard.length > 0)) {
                if (p13clipboardCut == 0) {
                    if (p13clipboard.length > 1) { x = format("Подтвердить копию {0} записей в этом месте?", p13clipboard.length); } else { x = format("Подтвердить копирование 1 записи в это расположение?"); }
                } else {
                    if (p13clipboard.length > 1) { x = format("Подтвердить перемещение {0} записей в это место?", p13clipboard.length); } else { x = format("Подтвердить перемещение 1 записи в это расположение?"); }
                }
            }
            setDialogMode(2, "Вставить", 3, p13pasteFileEx, x);
        }
            ...
            if ((p13clipboard != null) && (p13clipboard.length > 0)) {
                if (p13clipboardCut == 0) {
                    if (p13clipboard.length > 1) {
                        x = format("Задержано {0} записей для копирования" + ', <a href=# onclick="return p13clearClip()" style=cursor:pointer>' + "Очистить" + '</a>.', p13clipboard.length);
                    } else {
                        x = format("Задержана 1 запись для копирования" + ', <a href=# onclick="return p13clearClip()" style=cursor:pointer>' + "Очистить" + '</a>.');
                    }
                } else {
                    if (p13clipboard.length > 1) {
                        x = format("Задержано {0} записей для перемещения" + ', <a href=# onclick="return p13clearClip()" style=cursor:pointer>' + "Очистить" + '</a>.', p13clipboard.length);
                    } else {
                        x = format("Задержана 1 запись для перемещения" + ', <a href=# onclick="return p13clearClip()" style=cursor:pointer>' + "Очистить" + '</a>.');
                    }
                }
            }
        ...
        function p13downloadfile(x, y, z) {
            ...
            setDialogMode(2, "Скачать файл", 10, p13downloadFileCancel, '<div>' + EscapeHtml(downloadFile.file) + '</div><br /><progress id=d2progressBar style=width:100% value=0 max=' + z + ' />');
        }
        ...
        */
        ...
        function p13doUploadFiles(files) {
            ...
            if (overWriteCount == 0) {
                ...
                setDialogMode(2, "Загрузить файл", 3, p13uploadFileContinue, format((overWriteCount == 1) ? "Загрузка перезапишет 1 файл. Продолжить?" : "Загрузка перезапишет {0} файлов. Продолжить?", overWriteCount), files);
            }
        }
        ...
        function p13uploadFileContinue(b, files) {
            ...
            setDialogMode(2, "Загрузить файл", 10, p13uploadFileCancel, '<div id=p13dfileName>' + "Подключение..." + '</div><br /><progress id=d2progressBar style=width:100% value=0 max=0 />');
            p13uploadNextFile();
        }
        ...
        function updateDeviceDetails(node, hardware, network) {
            ...
            // Operating System
            var x = '';
            if (node.rname) { x += addDetailItem("Имя", EscapeHtml(node.rname), s); }
            if (hardware.windows && hardware.windows.osinfo && hardware.windows.osinfo.Description) { x += addDetailItem("Описание", EscapeHtml(hardware.windows.osinfo.Description), s); }
            if (node.osdesc) { x += addDetailItem("Версия", EscapeHtml(node.osdesc), s); }
            if (hardware.windows && hardware.windows.osinfo) {
                var m = hardware.windows.osinfo;
                if (m.OSArchitecture) {
                    if (m.OSArchitecture.startsWith('32')) { x += addDetailItem("Архитектура", "32-битный", s); }
                    else if (m.OSArchitecture.startsWith('64')) { x += addDetailItem("Архитектура", "64-битный", s); }
                    else { x += addDetailItem("Архитектура", EscapeHtml(m.OSArchitecture), s); }
                }
                if(m.LastBootUpTime){
                    var thedate = {
                ...
                if(m.Domain){ x += addDetailItem((m.PartOfDomain ? "Домен" : "Рабочая группа"), EscapeHtml(m.Domain), s); }
            }
            ...
            if (node.wsc) {
                var y = [];
                if (node.wsc.antiVirus != null) { if (node.wsc.antiVirus == 'OK') { y.push("Антивирус" + ' - <span style=color:green>' + "OK" + '</span>'); } else { y.push("Антивирус" + ' - <span style=color:red>' + "BAD" + '</span>'); } }
                if (node.wsc.autoUpdate != null) { if (node.wsc.autoUpdate == 'OK') { y.push("Обновить" + ' - <span style=color:green>' + "OK" + '</span>'); } else { y.push("Обновить" + ' - <span style=color:red>' + "BAD" + '</span>'); } }
                if (node.wsc.firewall != null) { if (node.wsc.firewall == 'OK') { y.push("Брандмауэр" + ' - <span style=color:green>' + "OK" + '</span>'); } else { y.push("Брандмауэр" + ' - <span style=color:red>' + "BAD" + '</span>'); } }
                x += addDetailItem("Безопасность Windows", y.join(', '));
            }

            // Defender for Windows Server
            if(node.defender) {
                var y = [];
                if (node.defender.RealTimeProtection != null) { if (node.defender.RealTimeProtection == true) { y.push("RealTimeProtection" + ' - <span style=color:green>' + "On" + '</span>'); } else { y.push("RealTimeProtection" + ' - <span style=color:red>' + "Выключено" + '</span>'); } }
                if (node.defender.TamperProtected != null) { if (node.defender.TamperProtected == true) { y.push("TamperProtection" + ' - <span style=color:green>' + "On" + '</span>'); } else { y.push("TamperProtection" + ' - <span style=color:red>' + "Выключено" + '</span>'); } }
                if (node.defender.AntivirusSignatureVersion != null) { y.push("Версия подписи" + ' - <span style=color:green>' + EscapeHtml(node.defender.AntivirusSignatureVersion) + '</span>'); }
            ...
            if (node.av && node.av.length > 0) {
                ...
                for (var i in node.av) {
                    if (node.av[i].product) {
                        ...
                        if (node.av[i].enabled !== true) { avx += ' - <span style=color:red>' + "Отключено" + '</span>'; }
                        if (node.av[i].updated !== true) { avx += ' - <span style=color:red>' + "Устаревший" + '</span>'; }
                        if ((node.av[i].enabled == true) && (node.av[i].updated == true)) { avx += ' - <span style=color:green>' + "OK" + '</span>'; }
                        y.push(avx);
                    }
                }
                x += addDetailItem("Антивирус", y.join('<br />'));
            }

            // Active Users
           if (node.users && node.users.length > 0) {
                var u = node.users.map(function(user) {
                    return addKeyLinkConditional(EscapeHtml(user), "Заблокирован", (node.lusers && node.lusers.indexOf(user) >= 0));
                }).join(', ');
                x += addDetailItem((node.users.length > 1 ? "Активные пользователи" : "Активный пользователь"), u);
            }

            if (x != '') { sections.push({ name: "Операционная система", html: x, img: 'software' }); }
            ...
            if (node.agent) {
                ...
                if (node.firstconnect) { x += addDetailItem("Первое подключение агента", printDateTime(new Date(node.firstconnect))); }
                if ((node.conn & 1) != 0) {
                    x += addDetailItem("Последнее подключение агента", "Подключено сейчас");
                } else {
                    if (node.lastconnect) { x += addDetailItem("Последнее подключение агента", printDateTime(new Date(node.lastconnect))); }
                }
                if (node.lastaddr) {
                    var splitip = node.lastaddr.split(':');
                    if (splitip.length > 2) {
                        // IPv6
                        x += addDetailItem("Последний адрес агента", node.lastaddr);
                    } else {
                        // IPv4
                        if (isPrivateIP(node.lastaddr)) {
                            x += addDetailItem("Последний адрес агента", splitip[0]);
                        } else {
                            x += addDetailItem("Последний адрес агента", '<a href="https://iplocation.com/?ip=' + splitip[0] + '" rel="noreferrer noopener" target="MeshIPLoopup">' + splitip[0] + '</a>');
                        }
                    }
                }
                if (hardware.agentvers != null) {
                    if (hardware.agentvers.compileTime) {
                        try {
                            ...
                            x += addDetailItem("Время компиляции", printDateTime(new Date(d)));
                        } catch (ex) { }
                    }
                }
                if (hardware.time != null) {
                    x += addDetailItem("Последнее обновление деталей", printDateTime(new Date(hardware.time)));
                }
            ...
            if (hardware.mobile) {
                ...
                if (hardware.mobile.device) { x += addDetailItem("Устройство", EscapeHtml(hardware.mobile.device), s); }
                if (hardware.mobile.bootloader) { x += addDetailItem("Загрузчик", EscapeHtml(hardware.mobile.bootloader), s); }
                if (hardware.mobile.id) { x += addDetailItem("Идентификатор", EscapeHtml(hardware.mobile.id), s); }
                if (hardware.mobile.host) { x += addDetailItem("Имя хоста", EscapeHtml(hardware.mobile.host), s); }
                ...
                if (x != '') { sections.push({ name: "Мобильное устройство", html: x, img: 'mobile' }); }
            }
            ...
            if (network.netif2 != null) {
                ...
                for (var i in network.netif2) {
                    ...
                    if (m.desc) { x += addDetailItem("Описание", EscapeHtml(m.desc).split('(R)').join('&reg;')); }
                    //if (m.dnssuffix) { x += addDetailItem("DNS Suffix", m.dnssuffix); }
                    if (typeof m[0].mac == 'string') {
                        if (m[0].gatewaymac) {
                            x += addDetailItem("MAC-уровень", format("MAC: {0}, шлюз: {1}", EscapeHtml(m[0].mac), EscapeHtml(m[0].gatewaymac)));
                        } else {
                            x += addDetailItem("MAC-уровень", format("MAC: {0}", EscapeHtml(m[0].mac)));
                        }
                    }
                    if (typeof m[0].speed == 'number' && (m[0].speed != 9223372036854775807 && m[0].speed > 0)) {
                        x += addDetailItem("Скорость интерфейса", format("{0}", getNetworkSpeed(m[0].speed)));
                    }
                    for (var j = 0; j < m.length; j++) {
                        ...
                        if (items.length > 0) {
                            if (iplayer.family == 'IPv4') { x += addDetailItem("Уровень IPv4", items.join(", ")); }
                            if (iplayer.family == 'IPv6') { x += addDetailItem("Уровень IPv6", items.join(", ")); }
                        }
                    }
                    x += '</div></td></tr>';
                }
                ...
                x += '</table>';
                if (x != '') { sections.push({ name: "Сеть", html: x, img: 'networking' }); }
            }

            // Attribute: Intel AMT
            if (node.intelamt != null) {
                var x = '';
                x += addDetailItem("Версия", (node.intelamt.ver) ? ('v' + EscapeHtml(node.intelamt.ver)) : ('<i>' + "Неизвестно" + '</i>'), s);
                x += addDetailItem("Идентификатор", (node.intelamt.uuid) ? (EscapeHtml(node.intelamt.uuid)) : ('<i>' + "Неизвестно" + '</i>'), s);
                var provisioningStates = { 0: nobreak("Не активированно (Pre)"), 1: nobreak("Не активированно (In)"), 2: nobreak("Активировано") };
                var provisioningMode = '';
                if ((node.intelamt.state == 2) && node.intelamt.flags) { if (node.intelamt.flags & 2) { provisioningMode = (', ' + "Режим управления клиентом (CCM)"); } else if (node.intelamt.flags & 4) { provisioningMode = (', ' + "Режим управления администратора (ACM)"); } }
                x += addDetailItem("Состояние инициализации", ((node.intelamt.state) ? (provisioningStates[node.intelamt.state]) : ('<i>' + "Неизвестно" + '</i>')) + provisioningMode, s);
                x += addDetailItem("Защита", (node.intelamt.tls == 1) ? "Защищено с помощью TLS" : "TLS не настроен", s);
                // Check that the Intel AMT user is setup and there is no warnings (1 = invalid credentials, 8 = trying)
                x += addDetailItem("Учетные данные администратора", ((node.intelamt.user) == null || (node.intelamt.user == '') || ((node.intelamt.warn != null) && ((node.intelamt.warn & 9) != 0))) ? "Неизвестный" : "Известный", s);
                if (x != '') {
            ...
            if (hardware.identifiers) {
                ...
                // BIOS
                if (ident.bios_vendor) { x += addDetailItem("Вендор", EscapeHtml(ident.bios_vendor), s); }
                if (ident.bios_version) { x += addDetailItem("Версия", EscapeHtml(ident.bios_version), s); }
                if (ident.bios_serial) { x += addDetailItem("Серийный номер", EscapeHtml(ident.bios_serial), s); }
                if (ident.bios_mode) { x += addDetailItem("Mode", EscapeHtml(ident.bios_mode), s); }
                if (x != '') { sections.push({ name: "BIOS", html: x, img: 'chip' }); }

                // Motherboard
                x = '';
                if (ident.board_vendor) { x += addDetailItem("Вендор", EscapeHtml(ident.board_vendor), s); }
                if (ident.board_name) { x += addDetailItem("Имя", EscapeHtml(ident.board_name), s); }
                if (ident.board_serial && (ident.board_serial != '')) { x += addDetailItem("Серийный номер", EscapeHtml(ident.board_serial), s); }
                if (ident.board_version) { x += addDetailItem("Версия", EscapeHtml(ident.board_version), s); }
                if (ident.product_uuid) { x += addDetailItem("Идентификатор", EscapeHtml(ident.product_uuid), s); }
                ...
                if (x != '') { sections.push({ name: "Материнская плата", html: x, img: 'motherboard' }); }
            }
            ...
            if (hardware.tpm) {
                ...
                if (tpm.ManufacturerId) { x += addDetailItem("Идентификатор", EscapeHtml(tpm.ManufacturerId), s); }
                if (tpm.ManufacturerVersion) { x += addDetailItem("Версия", EscapeHtml(tpm.ManufacturerVersion), s); }
                if (tpm.IsActivated != null) { x += addDetailItem("Активировано", (tpm.IsActivated ? "Yes" : "No"), s); }
                if (tpm.IsEnabled != null) { x += addDetailItem("Включено", (tpm.IsEnabled ? "Yes" : "No"), s); }
                if (tpm.IsOwned != null) { x += addDetailItem("В собственности", (tpm.IsOwned ? "Yes" : "No"), s); }
            ...
            if (hardware.battery) {
                ...
                for (var i in hardware.battery) {
                    ...
                    x += '<tr><td><div class=style10 style=border-radius:5px;padding:8px>';
                    x += '<div style=margin-bottom:3px><b>' + EscapeHtml(battery.DeviceName ? battery.DeviceName : "Неизвестно") + '</b></div>';
                    if (battery.CycleCount) { x += addDetailItem("Количество циклов", EscapeHtml(battery.CycleCount), s); }
                    if (battery.FullChargedCapacity) { x += addDetailItem("Полная заряженная емкость", format("{0} mWh", battery.FullChargedCapacity), s); }
                    if (battery.EstimatedRuntime) { x += addDetailItem("Расчетное время работы", format("{0} минут", Math.floor((battery.EstimatedRuntime / 60))), s); }
                    if (battery.Chemistry) { x += addDetailItem("Химия", EscapeHtml(battery.Chemistry), s); }
                    if (battery.DesignedCapacity) { x += addDetailItem("Проектная мощность", format("{0} mWh", battery.DesignedCapacity), s); }
                    if (battery.ManufactureDate) { x += addDetailItem("Дата изготовления", EscapeHtml(battery.ManufactureDate), s); }
                    if (battery.ManufactureName) { x += addDetailItem("Название производителя", EscapeHtml(battery.ManufactureName), s); }
                    if (battery.SerialNumber) { x += addDetailItem("Серийный номер", EscapeHtml(battery.SerialNumber), s); }
                    if (battery.ChargeRate) { x += addDetailItem("Ставка заряда", format("{0} mW", battery.ChargeRate), s); }
                    if (battery.Charging != null) { x += addDetailItem("Зарядка", (battery.Charging ? "Yes" : "No"), s); }
                    if (battery.DischargeRate) { x += addDetailItem("Скорость разряда", format("{0} mW", battery.DischargeRate), s); }
                    if (battery.Discharging != null) { x += addDetailItem("Разгрузка", (battery.Discharging ? "Yes" : "No"), s); }
                    if (battery.RemainingCapacity) { x += addDetailItem("Оставшаяся емкость", format("{0} mWh", battery.RemainingCapacity), s); }
                    if (battery.Voltage) { x += addDetailItem("Напряжение", format("{0} V", (battery.Voltage / 1000)), s); }
                    if (battery.Health) { x += addDetailItem("Здоровье", format("{0} %", battery.Health), s); }
                    if (battery.BatteryCharge) { x += addDetailItem("Заряд батареи", format("{0} %", battery.BatteryCharge), s); }   
                    x += '</div>';
                }
                x += '</table>';
                if (x != '') { sections.push({ name: "Батарея", html: x, img: 'battery'}); }
            }
            ...
            if (hardware.windows) {
                if (hardware.windows.memory && (hardware.windows.memory.length > 0)) {
                    ...
                    for (var i in hardware.windows.memory) {
                        ...
                        if (m.Capacity && m.Speed) { x += addDetailItem("Объем / Скорость", format("{0} Мб, {1} Мгц", (m.Capacity / 1024 / 1024), m.Speed), s); }
                        else if (m.Capacity) { x += addDetailItem("Объем", format("{0} Mб", (m.Capacity / 1024 / 1024)), s); }
                    ...
                    if (x != '') { sections.push({ name: "ОЗУ", html: x, img: 'ram' }); }
                }
            }
            ...
            if (hardware.linux) {
                if (hardware.linux.memory && (hardware.linux.memory.Memory_Device.length > 0)) {
                    ...
                    for (var i in hardware.linux.memory.Memory_Device) {
                        ...
                        if (m.Size && m.Speed) { x += addDetailItem("Объем / Скорость", format("{0}, {1}", m.Size, m.Speed), s); }
                        else if (m.Size) { x += addDetailItem("Объем", format("{0}", (m.Size)), s); }
                        if (m.PartNumber) { x += addDetailItem("Part Number", EscapeHtml((m.Manufacturer && m.Manufacturer != 'Undefined')?(m.Manufacturer + ', '):'') + EscapeHtml(m.PartNumber), s); }
                        x += '</div>';
                    }
                    x += '</table>';
            ...
            if (hardware.identifiers && ident.storage_devices) {
                ...
                for (var i in ident.storage_devices) {
                    ...
                    if (m.Size) {
                        ...
                        if (m.Size) {
                            ...
                            if (typeof m.Size == 'number') { x += addDetailItem("Объем", format("{0} Mб", Math.floor(m.Size / 1024 / 1024)), s); }
                            if (typeof m.Size == 'string') { x += addDetailItem("Объем", EscapeHtml(m.Size), s); }
                        }
                        if(hardware.windows && hardware.windows.drives && m.Model){
                            const foundObject = hardware.windows.drives.find(obj => obj['Model'] === m.Model);
                            if(foundObject) x += addDetailItem("Статус", EscapeHtml(foundObject.Status), s);
                        }
                        x += '</div>';
                    }
                }
                ...
                if (x != '') { sections.push({ name: "Хранилище", html: x, img: 'storage' }); }
            }
            ...
            if (hardware.windows && hardware.windows.volumes) {
                ...
                for (var i in hardware.windows.volumes) {
                    ...
                    if (m.size) {
                        ...
                        x += addDetailItem("Объем", EscapeHtml(fsize), s);
                    }
                    if (m.sizeremaining) {
                        var sizes = ['Bytes', 'KB', 'MB', 'GB', 'TB'];
                        ...
                        x += addDetailItem("Оставшаяся емкость", EscapeHtml(fsize), s);
                    }
                    if (m.type) {
                        var type = (m.removable == true ? "Removable" : (m.cdrom == true ? "CD-ROM" : ''));
                        x += addDetailItem("File System", (type != '' ? (type + ' / ') : '') + (m.type == 'Unknown' ? "Неизвестно" : EscapeHtml(m.type)), s);
                    }

                    if (m.protectionStatus || m.volumeStatus) {
                        var bitlockerState = [];
                        if (m.protectionStatus) bitlockerState.push("Включено");
            ...
            if (hardware.darwin && hardware.darwin.volumes) {
                ...
                for (var i in hardware.darwin.volumes) {
                    ...
                    x += '<div style=margin-bottom:3px><b>' + m.mount_point + '</b></div>';
                    if (m.size) {
                        x += addDetailItem("Объем", EscapeHtml(m.size), s);
                    }
                    if (m.available) {
                        x += addDetailItem("Оставшаяся емкость", EscapeHtml(m.available), s);
                    }
                    if (m.type) {
                        var type = (m.removable == true ? "Removable" : (m.cdrom == true ? "CD-ROM" : ''));
                        x += addDetailItem("File System", (type != '' ? (type + ' / ') : '') + (m.type == 'Unknown' ? "Неизвестно" : EscapeHtml(m.type)), s);
            ...
            if (x == '') {
                QH('p10detailshtml', "Информации об этом устройстве нет");
            } else {
                QH('p10detailshtml', x);
            }
        }
        ...
        function deviceDetailsShowBitlockerInfo(drive, identifier, password) {
            if (xxdialogMode) return false;
            var x = '<div><p>' + "Идентификатор" + '</p><p style=user-select:text;font-weight:bold>' + (identifier ? decodeURIComponent(identifier) : "Неизвестно") + '</p>';
            x += '<p>' + "Recovery Password" + '</p><p style=user-select:text;font-weight:bold>' + (password ? decodeURIComponent(password) : "Неизвестно") + '</p></div>';
        ...
        */
        ...
        function setupConsole() {
            ...
            if ((rights & 16) != 0) {
                ...
                var onlineText = ((consoleNode.conn & 1) != 0) ? "Агент онлайн" : "Агент оффлайн"
                if ((consoleNode.conn & 16) != 0) { onlineText += ", MQTT онлайн" }
                ...
                QH('p15statetext', "Отказано в доступе");
        ...
        function p15uploadCore(e) {
            ...
            if (e.shiftKey == true) { meshserver.send({ action: 'uploadagentcore', nodeid: consoleNode._id, type: 'default' }); } // Upload default core
                ...
                var htmlValue = '<select id=d3coreMode style=width:230px>' +
                    '<option value=1>' + "Загрузить ядро по умолчанию с сервера " + '</option>' +
                    '<option value=2>' + "Очистить ядро" + '</option>' +
                    '<option value=3>' + "Загрузить файл ядра" + '</option>' +
                    '<option value=4>' + "Програмное отключение агента" + '</option>' +
                    '<option value=5>' + "Жесткое отключение агента" + '</option>' +
                    '<option value=6>' + "Загрузить ядро восстановления" + '</option>' +
                    '<option value=7>' + "Загрузить крошечное ядро" + '</option>' +
                    '<option value=8>' + "Restart agent service" + '</option>' +
                    '<option value=9>' + "Принудительно обновить агент" + '</option></select>';
                setDialogMode(2, "Произвести действие агента", 3, p15uploadCoreEx, addHtmlValue("Действиe", htmlValue));
            }
        }
        ...
        function p15uploadCore2() {
            ...
            Q('d3auth').value = authCookie;
            Q('d3attrib').value = currentNode._id;
            setDialogMode(4, "Загрузить ядро Mesh Agent", 3, p15uploadCoreEx2);
            d3init();
        }
        ...
        function p20updateMesh() {
            ...
            var meshtype = format("Неизвестно #{0}", currentMesh.mtype);
            var meshrights = GetMeshRights(currentMesh);
            if (currentMesh.mtype == 1) meshtype = "Только Intel&reg; AMT, без агента";
            if (currentMesh.mtype == 2) meshtype = "Управляется с помощью программного агента";
            if (currentMesh.mtype == 3) { if (currentMesh.relayid == null) { meshtype = "Локальные устройства, без агентов"; } else { meshtype = "Устройства без агента, ретранслируемые через агент"; } }
            if (currentMesh.mtype == 4) { if (currentMesh.relayid == null) { meshtype = "IP-KVM-устройство"; } else { meshtype = "Устройство IP-KVM ретранслируемое через агента"; } if (currentMesh.kvm.model == 1) { meshtype += ', ' + 'Raritan KX III'; } }

            var x = '';
            x += addHtmlValue("Имя", addLinkConditional(EscapeHtml(currentMesh.name), 'p20editmesh(1)', (meshrights & 1) != 0));
            x += addHtmlValue("Описание", addLinkConditional(((currentMesh.desc && currentMesh.desc != '') ? EscapeHtml(currentMesh.desc) : ('<i>' + "Пусто" + '</i>')), 'p20editmesh(2)', (meshrights & 1) != 0));
            ...
            if (((currentMesh.mtype == 3) || (currentMesh.mtype == 4)) && (currentMesh.relayid != null)) {
                var relayName = '<i>' + "Неизвестно" + '</i>';
                var relayNode = getNodeFromId(currentMesh.relayid);
                if (relayNode != null) { relayName = EscapeHtml(relayNode.name); }
                x += addHtmlValue("Устройство-релей", addLinkConditional(relayName, 'p20editmeshrelay()', (meshrights & 1) != 0));
            }

            // Display IP-KVM information if needed
            if (currentMesh.mtype == 4) {
                x += addHtmlValue("Имя хоста", currentMesh.kvm.host);
                x += addHtmlValue("Имя пользователя", currentMesh.kvm.user);
            }

            x += '<br><input type=button value="' + "Примечания" + '" onclick=showNotes(false,"' + encodeURIComponent(currentMesh._id) + '") />';

            x += '<br style=clear:both><br>';
            var currentMeshLinks = currentMesh.links[userinfo._id];
            if (currentMeshLinks && ((currentMeshLinks.rights & 2) != 0)) { x += '<div style=margin-bottom:6px;float:left;margin-right:10px><a onclick=p20showAddMeshUserDialog() style=cursor:pointer><img src=images/icon-addnew.png border=0 height=12 width=12> ' + "Добавить пользователя" + '</a></div>'; }

            if (navigator.userAgent.toLowerCase().indexOf('android') >= 0) {
                x += '<div style=margin-bottom:6px;float:left;margin-right:10px><a onclick=p20installAndroidDialog() style=cursor:pointer><img src=images/icon-addnew.png border=0 height=12 width=12> ' + "Установить на это устройство" + '</a></div>';
            }
            ...
            */
            ...
            x += '<table style="color:black;background-color:#EEE;border-color:#AAA;border-width:1px;border-style:solid;border-collapse:collapse" border=0 cellpadding=2 cellspacing=0 width=100%><tbody><tr style=background-color:#AAAAAA;font-weight:bold><th scope=col style=text-align:left;width:430px>' + "Права пользователей" + '</th></tr>';
            ...
            for (var i in sortedusers) {
                var trash = '', rights = "Частичные права", r = sortedusers[i].rights, icon = 2;
                if (r == 0xFFFFFFFF) rights = "Администратор с полным доступом"; else if (r == 0) rights = "Нет прав";
            ...
            if (meshrights == 0xFFFFFFFF) { x += '<div style=font-size:small;text-align:right;margin-top:6px><span><a onclick=p20showDeleteMeshDialog() style=cursor:pointer>' + "Удалить группу" + '</a></span></div>'; }
        ...
        function p20showDeleteMeshDialog() {
            if (xxdialogMode) return false;
            var x = format("Вы действительно хотите удалить группу \"{0}\"? Удаление группы приведет к удалению всей информации связанной с устройствами в этой группе.", EscapeHtml(currentMesh.name)) + '<br /><br />';
            x += '<label><input id=p20check type=checkbox onchange=p20validateDeleteMeshDialog() />' + "Подтвердить" + '</label>';
            setDialogMode(2, "Удалить группу", 3, p20showDeleteMeshDialogEx, x);
        ...
        function p20editmeshrelay() {
            ...
            if (relayDevices.length == 0) {
                ...
                setDialogMode(2, "Редактирование группы устройств", 1, null, "Нет доступных устройств-релеев.");
            } else {
                var relayDevices2 = [];
                ...
                var x = addHtmlValue("Устройство-релей", '<div style=width:170px><select id=d2devrelay style=width:100%>' + relayDevices2.join('') + '</select></div>');
                setDialogMode(2, "Редактирование группы устройств", 3, p20editmeshrelayEx, x);
            }
        }
        ...
        function p20editmesh(focus) {
            if (xxdialogMode) return;
            var x = addHtmlValue("Имя", '<input id=dp20meshname style=width:170px maxlength=32 onchange=p20editmeshValidate() onkeyup=p20editmeshValidate() />');
            x += addHtmlValue("Описание", '<input id=dp20meshdesc style=width:170px maxlength=1024 onkeyup=p20editmeshValidate() />');
            setDialogMode(2, "Редактирование группы устройств", 3, p20editmeshEx, x);
        ...
        function p20installAndroidDialog() {
            if (xxdialogMode) return;
            var x = '<div style=text-align:center><p>' + "Установите MeshCentral Agent на свое устройство Android..После установки щелкните ссылку сопряжения, чтобы подключить ваше устройство к этому серверу.." + '</p>';
            ...
            x += '<p><a href="' + serverinfo.magenturl + ',' + serverinfo.agentCertHash + ',' + currentMesh._id.split('/')[2] + '"><b>' + "Ссылка для сопряжения устройства" + '</b></a></p></div>';
            setDialogMode(2, "Установка Android", 1, null, x);
        }
        ...
        function p20showAddMeshUserDialog() {
            ...
            x += '<label><input type=checkbox onchange=p20validateAddMeshUserDialog() id=p20fulladmin>' + "Администратор с полным доступом" + '</label><br>';
            x += '<label><input type=checkbox onchange=p20validateAddMeshUserDialog() id=p20editmesh>' + "Редактирование группы устройств" + '</label><br>';
            x += '<label><input type=checkbox onchange=p20validateAddMeshUserDialog() id=p20manageusers>' + "Управление пользователями группы устройств" + '</label><br>';
            x += '<label><input type=checkbox onchange=p20validateAddMeshUserDialog() id=p20managecomputers>' + "Управление компьютерами группы устройств" + '</label><br>';
            x += '<label><input type=checkbox onchange=p20validateAddMeshUserDialog() id=p20remotecontrol>' + "Удаленное управление" + '</label><br>';
            x += '<label><input type=checkbox onchange=p20validateAddMeshUserDialog() id=p20remoteview style=margin-left:12px>' + "Только просмотр экрана без ввода" + '</label><br>';
            x += '<label><input type=checkbox onchange=p20validateAddMeshUserDialog() id=p20remotelimitedinput style=margin-left:12px>' + "Ограничить элементы ввода" + '</label><br>';
            x += '<label><input type=checkbox onchange=p20validateAddMeshUserDialog() id=p20noterminal style=margin-left:12px>' + "Нет доступа к терминалу" + '</label><br>';
            x += '<label><input type=checkbox onchange=p20validateAddMeshUserDialog() id=p20nofiles style=margin-left:12px>' + "Нет доступа к файлам" + '</label><br>';
            x += '<label><input type=checkbox onchange=p20validateAddMeshUserDialog() id=p20noamt style=margin-left:12px>' + "Нет доступа к Intel&reg; AMT" + '</label><br>';
            x += '<label><input type=checkbox onchange=p20validateAddMeshUserDialog() id=p20meshagentconsole>' + "Консоль Mesh Agent" + '</label><br>';
            x += '<label><input type=checkbox onchange=p20validateAddMeshUserDialog() id=p20meshserverfiles>' + "Серверные файлы" + '</label><br>';
            x += '<label><input type=checkbox onchange=p20validateAddMeshUserDialog() id=p20wakedevices>' + "Разбудить устройства" + '</label><br>';
            x += '<label><input type=checkbox onchange=p20validateAddMeshUserDialog() id=p20editnotes>' + "Редактировать примечания устройства" + '</label><br>';
            x += '<label><input type=checkbox onchange=p20validateAddMeshUserDialog() id=p20limitevents>' + "Показывать только собственные события" + '</label><br>';
            x += '<label><input type=checkbox onchange=p20validateAddMeshUserDialog() id=p20chatnotify>' + "Чаты и уведомления" + '</label><br>';
            x += '<label><input type=checkbox onchange=p20validateAddMeshUserDialog() id=p20uninstall>' + "Удаление агента" + '</label><br>';
            x += '<label><input type=checkbox onchange=p20validateAddMeshUserDialog() id=p20commands>' + "Удаленные команды" + '</label><br>';
            x += '<label><input type=checkbox onchange=p20validateAddMeshUserDialog() id=p20resetoff>' + "Перезагрузка / Выключение" + '</label><br>';
            x += '</div>';
            setDialogMode(2, "Добавить пользователя в группу устройств", 3, p20showAddMeshUserDialogEx, x);
        ...
        function p20viewuser(userid) {
            ...
            if (meshrights == 0xFFFFFFFF) r.push("Администратор с полным доступом"); else {
                if ((meshrights & 1) != 0) r.push("Редактирование группы устройств");
                if ((meshrights & 2) != 0) r.push("Управление пользователями группы устройств");
                if ((meshrights & 4) != 0) r.push("Управление компьютерами группы устройств");
                if ((meshrights & 8) != 0) r.push("Удаленное управление");
                if ((meshrights & 16) != 0) r.push("Консоль агента");
                if ((meshrights & 32) != 0) r.push("Серверные файлы");
                if ((meshrights & 64) != 0) r.push("Разбудить устройства");
                if ((meshrights & 128) != 0) r.push("Редактировать примечания");
                if ((meshrights & 256) != 0) r.push("Только просмотр экрана без ввода");
                if ((meshrights & 512) != 0) r.push("Нет терминала");
                if ((meshrights & 1024) != 0) r.push("Файлов нет");
                if ((meshrights & 2048) != 0) r.push("Нет доступа к Intel&reg; AMT");
                if (((meshrights & 8) != 0) && ((meshrights & 4096) != 0) && ((meshrights & 256) == 0)) r.push("Ограниченный ввод");
                if ((meshrights & 8192) != 0) r.push("Только собственные события");
                if ((meshrights & 16384) != 0) r.push("Чаты и уведомления");
                if ((meshrights & 32768) != 0) r.push("Удаление");
                if ((meshrights & 131072) != 0) r.push("Команды");
                if ((meshrights & 262144) != 0) r.push("Сброс / Выкл.");
            }
            if (r.length == 0) { r.push("Нет прав"); }
            var buttons = 1, uname = userid.split('/')[2];
            if (currentMesh.links[userid].name) { uname = currentMesh.links[userid].name; }
            var x = addHtmlValue("Имя пользователя", EscapeHtml(uname));
            if (uname != userid.split('/')[2]) { x += addHtmlValue("Логин пользователя", EscapeHtml(userid.split('/')[2])); }
            x += addHtmlValue("Права", r.join(", "));
            if (((userinfo._id) != userid) && (cmeshrights == 0xFFFFFFFF || (((cmeshrights & 2) != 0) && (meshrights != 0xFFFFFFFF)))) buttons += 4;
            setDialogMode(2, "Пользователь группы устройств", buttons, p20viewuserEx, x, userid);
        }
        ...
        function p20viewuserEx(button, userid) {
            ...
            setDialogMode(2, "Удаленный пользователь Mesh", 3, p20viewuserEx2, format("Подтвердить удаление пользователя {0}?", uname), userid);
        }
        ...
        function drawNotifications() {
            ...
            if (notifications.length == 0) {
                r = '<div style=margin:5px>' + "На данный момент уведомлений нет" + '</div>';
            } else {
                for (var i in notifications) {
                    ...
                    r += '<div title="' + format("Произошло в {0}", printDateTime(d)) + '" id="notifyx' + n.id + '" class=notification style="cursor:pointer;border-top:1px solid ' + ((r == '') ? 'transparent' : 'orange') + '">';
                    if (icon) { r += '<div class=j' + icon + ' onclick="notificationSelected(' + n.id + ')" style=margin:5px;float:left></div>'; }
                    r += '<div onclick="notificationDelete(' + n.id + ')" class=unselectable title="' + "Очистить это уведомление" + '" style=margin:5px;float:right;color:orange><b>X</b></div><div onclick="notificationSelected(' + n.id + ')" style=margin:5px>' + t + EscapeHtml(n.text) + '</div><div style=margin-left:5px;margin-bottom:5px;color:gray;font-size:10px>' + printDateTime(d) + '</div></div>';
                }
            }
            var deleteall = '';
            if (notifications.length > 1) { deleteall = '<div id="notifyRemoveAll" onclick="deleteAllNotifications()" style="cursor:pointer;border-top:1px solid orange;margin:5px;color:orange;text-align:right;padding-right:3px">' + "Очистить все" + '</div>'; }
        ...
        function addNotification(n) {
            ...
            var translatedMessages = [
                null,
                "В доступе отказано", // 1
                "Неверное имя пользователя",
                "Неверный пароль",
                "Неверный адрес электронной почты",
                "Неверный домен",
                "Недействительные разрешения сайта",
                "Пользователь уже существует",
                "Невозможно добавить пользователя в этом режиме",
                "Исключение проверки",
                "Достигнуто ограничение учетных записей.", // 10
                "Запрос чата, Нажмите здесь, чтобы принять.",
                "С момента последнего входа в этот аккаунт было {0} неудачных попыток входа..",
                "Не удалось изменить адрес электронной почты, другой аккаунт уже использует: {0}.",
                "Письмо отправлено.",
                "Пользователь {0} не найден.",
                "Пользователи {0} не найдены.",
                "Ошибка: невозможно изменить на ранее использованный пароль.",
                "Ошибка: невозможно изменить на часто используемый пароль.",
                "Ошибка, пароль не изменен.",
                "Пароль изменен.", // 20
                "Текущий пароль неверен.",
                "Ошибка, пригласительный код \"{0}\" уже используется.",
                "SMS-шлюз не включен",
                "Нет прав на управление пользователями",
                "Неверное SMS-сообщение",
                "У этого пользователя нет номера телефона",
                "SMS успешно отправлено.",
                "Ошибка SMS",
                "Ошибка SMS: {0}",
                "Домен почты \"{0}\" не разрешен. Разрешены только ({1})" // 30
            ];
