<!DOCTYPE html><html dir="ltr" xmlns="http://www.w3.org/1999/xhtml"><head lang="en">
                            ...
                            <div id="loginpanel" style="background-color:#979797;border-radius:16px;width:260px;padding:16px;text-align:center;clear:both;display:none">
                                <form method="post">
                                    ...
                                    <table>
                                        ...
                                        <tr>
                                            <td><div id="showPassHintLink" style="display:none"><a onclick="showPassHint()" style="cursor:pointer">Mostra suggerimento</a></div></td>
                                    ...
                                    <div id="resetAccountDiv" style="display:none;padding:2px">
                                        <span id="resetAccountSpan">Hai dimenticato utente / password?</span> <a onclick="xgo(3)" style="cursor:pointer">Ripristina account</a>.
                                    </div>
                                    <div id="newAccountDiv" style="display:none;padding:2px">
                                        Non hai un account? <a onclick="xgo(2)" style="cursor:pointer">Crearne uno</a>.
                                    </div>
                                    ...
                                    <div id="authStrategies" style="display:none">
                                        ...
                                        <a id="auth-twitter" href="auth-twitter" style="display:none"><img src="images/login/twitter32.png" width="32" height="32" style="margin-left:3px;margin-right:3px;border-radius:3px;box-shadow:2px 2px 5px black;cursor:pointer" title="Accedi utilizzando Twitter"></a>
                                        <a id="auth-google" href="auth-google" style="display:none"><img src="images/login/google32.png" width="32" height="32" style="margin-left:3px;margin-right:3px;border-radius:3px;box-shadow:2px 2px 5px black;cursor:pointer" title="Accedi utilizzando Google"></a>
                                        <a id="auth-github" href="auth-github" style="display:none"><img src="images/login/github32.png" width="32" height="32" style="margin-left:3px;margin-right:3px;border-radius:3px;box-shadow:2px 2px 5px black;cursor:pointer" title="Accedi utilizzando GitHub"></a>
                                        <a id="auth-azure" href="auth-azure" style="display:none"><img src="images/login/azure32.png" width="32" height="32" style="margin-left:3px;margin-right:3px;border-radius:3px;box-shadow:2px 2px 5px black;cursor:pointer" title="Accedi con Azure"></a>
                                        ...
                                        <a id="auth-jumpcloud" href="auth-jumpcloud" style="display:none"><img src="images/login/jumpcloud32.png" width="32" height="32" style="margin-left:3px;margin-right:3px;border-radius:3px;box-shadow:2px 2px 5px black;cursor:pointer" title="Accedi utilizzando JumpCloud"></a>
                                        <a id="auth-intel" href="auth-intel" style="display:none"><img src="images/login/intel32.png" width="32" height="32" style="margin-left:3px;margin-right:3px;border-radius:3px;box-shadow:2px 2px 5px black;cursor:pointer" title="Accedi utilizzando Intel"></a>
                                    ...
                                    <form method="post">
                                        ...
                                        <table>
                                            <tbody><tr id="nuUserRow">
                                                <td align="right" width="100">Nome utente: </td>
                                            ...
                                            <tr id="createPanelHint" style="display:none">
                                                <td align="right">Suggerimento per la password: </td>
                                            ...
                                            <tr id="newAccountPass" title="Immettere il token di creazione dell'account">
                                                <td align="right">Token di creazione:</td>
                                        ...
                                        <hr><a onclick="xgo(1)" style="cursor:pointer">Torna al login</a>
                                        ...
                                        <tr>
                                            <td colspan="2">
                                                ...
                                                <div style="float:right">
                                                    <input style="display:none;float:right" id="securityKeyButton" type="button" value="Usa chiave di sicurezza " onclick="useSecurityKey()">
        ...
        <div id="footer" style="height:32px;width:100%;text-align:center;background-color:#113962;position:absolute;bottom:0px">
            <table cellpadding="0" cellspacing="6" style="width:100%">
                <tbody><tr>
                    ...
                    <td style="text-align:right">{{{rootCertLink}}}&nbsp;<a href="terms">Termini e privacy</a></td>
                </tr>
            </tbody></table>
        </div>
    </div>
    ...
    <script>
        ...
        var okmessages = ['', "Se valido, reimposta la posta inviata.", "Email inviata.", "Verifica e-mail richiesta, controlla la tua casella di posta e fai clic sul link di conferma.", "SMS inviato."];
        ...
        function useEmailToken() {
            ...
            setDialogMode(1, "Accesso sicuro", 3, useEmailKeyEx, "Invia token all'indirizzo email registrato?");
        }
        ...
        function useSMSToken() {
            ...
            setDialogMode(1, "Accesso sicuro", 3, useSMSTokenEx, "Invia token al numero di telefono registrato?");
        }
        ...
        function showPassHint() {
            if (passRequirements.hint === true) { messagebox("Suggerimento password", passhint); }
        }
            ...
            if (Q('apassword1').value == '') {
                ...
                if (!passRequirementsEx) {
                    ...
                    if (passReq == false) {
                        ...
                        QH('passWarning', '<span style=color:red><b>' + "Politica sulle password " + '</b><span>'); // TODO: Display problem hint
