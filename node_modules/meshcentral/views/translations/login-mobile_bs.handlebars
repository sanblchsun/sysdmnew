<!DOCTYPE html><html dir="ltr" xmlns="http://www.w3.org/1999/xhtml"><head lang="en">
                        ...
                        <td align="center">
                            <div id="loginpanel" style="background-color:#979797;border-radius:16px;width:260px;padding:16px;text-align:center;clear:both;display:none">
                                <form method="post">
                                    ...
                                    <table>
                                        <tbody><tr>
                                            <td id="loginusername" align="right" width="100">Korisničko ime:</td>
                                        ...
                                        <tr>
                                            ...
                                            <td align="right"><input id="loginButton" type="submit" value="Ulogovati se"></td>
                                        </tr>
                                    </tbody></table>
                                    <div id="hrAccountDiv" style="display:none"><hr></div>
                                    <div id="resetAccountDiv" style="display:none;padding:2px">
                                        <span id="resetAccountSpan">Zaboravili ste korisnika/lozinku?</span> <a onclick="xgo(3)" style="cursor:pointer">Resetujte nalog</a>.
                                    </div>
                                    <div id="newAccountDiv" style="display:none;padding:2px">
                                        Nemate račun? <a onclick="xgo(2)" style="cursor:pointer">Napravite jedan</a>.
                                    </div>
                                    ...
                                    <div id="authStrategies" style="display:none">
                                        ...
                                        <a id="auth-twitter" href="auth-twitter" style="display:none"><img src="images/login/twitter32.png" width="32" height="32" style="margin-left:3px;margin-right:3px;border-radius:3px;box-shadow:2px 2px 5px black;cursor:pointer" title="Prijavite se koristeći Twitter"></a>
                                        <a id="auth-google" href="auth-google" style="display:none"><img src="images/login/google32.png" width="32" height="32" style="margin-left:3px;margin-right:3px;border-radius:3px;box-shadow:2px 2px 5px black;cursor:pointer" title="Prijavite se koristeći Google"></a>
                                        <a id="auth-github" href="auth-github" style="display:none"><img src="images/login/github32.png" width="32" height="32" style="margin-left:3px;margin-right:3px;border-radius:3px;box-shadow:2px 2px 5px black;cursor:pointer" title="Prijavite se koristeći GitHub"></a>
                                        <a id="auth-azure" href="auth-azure" style="display:none"><img src="images/login/azure32.png" width="32" height="32" style="margin-left:3px;margin-right:3px;border-radius:3px;box-shadow:2px 2px 5px black;cursor:pointer" title="Prijavite se koristeći Azure"></a>
                                        <a id="auth-oidc" href="auth-oidc" style="display:none"><img src="images/login/oidc32.png" srcset="images/login/oidc64.png 2x" width="32" height="32" style="margin-left:3px;margin-right:3px;border-radius:3px;box-shadow:2px 2px 5px black;cursor:pointer" title="Prijavite se koristeći OpenID Connect"></a>
                                        ...
                                        <a id="auth-jumpcloud" href="auth-jumpcloud" style="display:none"><img src="images/login/jumpcloud32.png" width="32" height="32" style="margin-left:3px;margin-right:3px;border-radius:3px;box-shadow:2px 2px 5px black;cursor:pointer" title="Prijavite se koristeći JumpCloud"></a>
                                        <a id="auth-intel" href="auth-intel" style="display:none"><img src="images/login/intel32.png" width="32" height="32" style="margin-left:3px;margin-right:3px;border-radius:3px;box-shadow:2px 2px 5px black;cursor:pointer" title="Prijavite se koristeći Intel"></a>
                                        <a id="auth-saml" href="auth-saml" style="display:none"><img src="images/login/generic32.png" width="32" height="32" style="margin-left:3px;margin-right:3px;border-radius:3px;box-shadow:2px 2px 5px black;cursor:pointer" title="Jedinstvena prijava"></a>
                                    </div>
                                </form>
                            </div>
                                    ...
                                    <form method="post">
                                        ...
                                        <table>
                                            <tbody><tr id="nuUserRow">
                                                <td align="right" width="100">Korisničko ime:</td>
                                            ...
                                            <tr id="createPanelHint" style="display:none">
                                                <td align="right">Savjet za prolaz:</td>
                                            ...
                                            <tr id="newAccountPass" title="Unesite token za kreiranje naloga">
                                                <td align="right">Token za kreiranje:</td>
                                            ...
                                            <tr>
                                                <td colspan="2">
                                                    <div style="float:right"><input id="createButton" type="submit" value="Kreirajte nalog" disabled="disabled"></div>
                                                    <div id="passWarning" style="padding-top:6px"></div>
                                                </td>
                                            </tr>
                                        </tbody></table>
                                        <hr><a onclick="xgo(1)" style="cursor:pointer">Povratak na prijavu</a>
                            ...
                            <div id="resetpanel" style="background-color:#979797;border-radius:16px;width:260px;padding:16px;text-align:center;display:none;clear:both">
                                <form method="post">
                                    ...
                                    <table>
                                        ...
                                        <tr>
                                            <td colspan="2">
                                                <div style="float:right"><input id="eresetButton" type="submit" value="Resetujte nalog" disabled="disabled"></div>
                                                <div id="passWarning" style="padding-top:6px"></div>
                                            </td>
                                        </tr>
                                    </tbody></table>
                            ...
                            <div id="tokenpanel" style="background-color:#979797;border-radius:16px;width:260px;padding:16px;text-align:center;display:none;clear:both">
                                <form method="post" autocomplete="off">
                                    ...
                                    <table>
                                        <tbody><tr>
                                            <td align="right" width="100">Token za prijavu:</td>
                                            <td>
                                        ...
                                        <tr>
                                            <td colspan="2">
                                                <div style="float:right"><input id="tokenOkButton" type="submit" value="Ulogovati se" disabled="disabled"></div>
                                                <div style="float:right">
                                                    <input style="display:none;float:right" id="securityKeyButton" type="button" value="Koristite sigurnosni ključ" onclick="useSecurityKey()">
                            ...
                            <div id="resettokenpanel" style="background-color:#979797;border-radius:16px;width:260px;padding:16px;text-align:center;display:none;clear:both">
                                <form method="post" autocomplete="off">
                                    ...
                                    <table>
                                        ...
                                        <tr>
                                            <td colspan="2">
                                                <div style="float:right"><input id="resetTokenOkButton" type="submit" value="Ulogovati se" disabled="disabled"></div>
                                            </td>
                                        </tr>
                                    </tbody></table>
                                    <hr><a onclick="xgo(1)" style="cursor:pointer">Povratak na prijavu</a>
                            ...
                            <div id="resetpasswordpanel" style="position:relative;background-color:#979797;border-radius:16px;width:300px;padding:16px;text-align:center;display:none">
                                <form method="post">
                                    ...
                                    <table>
                                        ...
                                        <tr>
                                            <td colspan="2">
                                                <div style="float:right"><input id="resetPassButton" type="submit" value="Reset lozinke" disabled="disabled"></div>
        ...
        <div id="footer" style="height:32px;width:100%;text-align:center;background-color:#113962;position:absolute;bottom:0px">
            <table cellpadding="0" cellspacing="6" style="width:100%">
                <tbody><tr>
                    ...
                    <td style="text-align:right">{{{rootCertLink}}}&nbsp;<a href="terms">Uslovi i privatnost</a></td>
                </tr>
            </tbody></table>
        </div>
    </div>
    ...
    <script>
        ...
        var okmessages = ['', "Ako je važeća, resetirajte poslanu poštu.", "Email poslan.", "Potrebna je verifikacija e-pošte, provjerite svoje poštansko sanduče i kliknite na vezu za potvrdu.", "SMS poslan."];
        ...
        function useEmailToken() {
            ...
            setDialogMode(1, "Sigurna prijava", 3, useEmailKeyEx, "Poslati token na registriranu adresu e-pošte?");
        }
        ...
        function useSMSToken() {
            ...
            setDialogMode(1, "Sigurna prijava", 3, useSMSTokenEx, "Poslati token na registrirani broj telefona?");
        }
        ...
        function showPassHint() {
            if (passRequirements.hint === true) { messagebox("Podsjetnik lozinke", passhint); }
        }
            ...
            if (Q('apassword1').value == '') {
                ...
                if (!passRequirementsEx) {
                    ...
                    if (passReq == false) {
                        ...
                        QH('passWarning', '<span style=color:red><b>' + "Politika lozinke" + '</b><span>'); // TODO: Display problem hint
