<!DOCTYPE html><html lang="pt" dir="ltr" xmlns="http://www.w3.org/1999/xhtml"><head>
    ...
    <div id="container">
        ...
        <div id="masthead" style="background:url(logo.png) 0px 0px;background-size:341px 50px;background-color:#036;background-repeat:no-repeat;height:50px;width:100%;overflow:hidden">
            ...
            <div id="notificationCount" onclick="clickNotificationIcon()" class="unselectable" style="position:absolute;right:50px;top:0px;font-size:28px;width:50px;height:50px;cursor:pointer;display:none" title="Clique para visualizar as notificações atuais"><div id="notificationCount2" style="padding-top:8px">0</div></div>
                ...
                <div id="p2" style="display:none;position:absolute;top:0;left:0;right:0;bottom:0">
                    ...
                    <div id="xdevicesBar" style="position:absolute;overflow-y:auto;height:34px;left:0;right:0;bottom:0px;background-color:#aaa;color:black">
                        <div style="margin:4px">
                            ...
                            <label class="noselect"><input type="checkbox" id="OnlineCheckBox" onclick="onOnlineCheckBox(event)">Conectados</label>
                        </div>
                    </div>
                </div>
                            ...
                            <div id="p3AccountActions">
                                <div id="p2AccountSecurity" style="display:none">
                                    ...
                                    <div style="margin-left:9px;margin-bottom:8px">
                                        ...
                                        <div id="manageEmail2FA" style="margin-top:5px;display:none"><a onclick="account_manageAuthEmail()" style="cursor:pointer">Gerenciar autenticação de email</a> <span id="authEmailSetupCheck"><strong>✓</strong></span></div>
                                        <div style="margin-top:5px"><a href="#" onclick="account_showLocalizationSettings()">Configurações de localização</a></div>
                                ...
                                <div id="p2AccountActions" style="display:none">
                                    ...
                                    <div style="margin-left:9px;margin-bottom:8px">
                                        ...
                                        <div style="margin-top:5px"><span id="verifyEmailId" style="display:none"><a onclick="account_showVerifyEmail()" style="cursor:pointer">Verificar email</a></span></div>
                                        <span id="p2AccountPassActions">
                                            <div style="margin-top:5px"><span id="changeEmailId" style="display:none"><a onclick="account_showChangeEmail()" style="cursor:pointer">Mude o endereço de email</a></span></div>
                                            <div style="margin-top:5px"><a onclick="account_showChangePassword()" style="cursor:pointer">Mudar senha</a><span id="p2nextPasswordUpdateTime"></span></div>
                            ...
                            <tbody><tr>
                                <td style="width:100%;background-color:#d3d9d6;text-align:left;padding:4px" valign="bottom">
                                    <div style="width:100%;text-align:center">
                                        <input type="button" style="width:calc(100%/5 - 5px)" id="p5FolderUp" disabled="disabled" onclick="p5folderup()" value="Acima">
                                        ...
                                        <input type="button" style="width:calc(100%/5 - 5px)" id="p5DeleteFileButton" disabled="disabled" value="Deletar" onclick="p5deletefile()" onkeypress="return false" onkeydown="return false">
                                    ...
                                    <div style="width:100%;text-align:center">
                                        <input type="button" style="width:calc(100%/5 - 5px)" id="p5UploadButton" disabled="disabled" value="Envio" onclick="p5uploadFile()" onkeypress="return false" onkeydown="return false">
                        ...
                        <div id="deskarea1" style="position:absolute;top:0px;width:100%;height:32px">
                            <div style="padding-top:2px;padding-bottom:2px;background:#C0C0C0;height:32px">
                                ...
                                <div style="margin-left:3px">
                                    ...
                                    <input type="button" id="connectbutton1h" value="Conectar HW" onclick="connectDesktop(event,2)" onkeypress="return false" onkeydown="return false" disabled="disabled" style="height:28px">
                        ...
                        <div id="deskarea4" style="position:absolute;bottom:0px;width:100%;height:32px">
                            <div style="padding-top:2px;padding-bottom:2px;background:#C0C0C0">
                                ...
                                <div>
                                    ...
                                    <input type="button" onkeypress="return false" onkeydown="return false" value="Ações de energia (Ligar/Desligar)" onclick="showPowerActionDlg()" style="display:none;height:28px">
                            ...
                            <div id="termarea4" style="position:relative;height:32px;">
                                <div class="areaFoot">
                                    ...
                                    <div style="height:28px">
                                        ...
                                        <input id="ctrlcbutton" style="margin-left:3px;height:28px" type="button" onkeypress="return false" onkeydown="return false" value="CTRL-C" onclick="termSendKey(3,'ctrlcbutton')">
                    ...
                    <div id="p10files" style="position:absolute;top:55px;bottom:0px;width:100%;display:none">
                        <table id="p13toolbar" style="width:100%;height:111px" cellpadding="0" cellspacing="0">
                            <tbody><tr>
                                <td style="background-color:#C0C0C0;border-bottom:2px solid black;padding:2px;line-height:24px">
                                    ...
                                    <div style="margin-left:2px">
                                        <input id="p13AutoConnect" value="Conexão automática" onclick="autoConnectFiles(event)" onkeypress="return false" onkeydown="return false" type="button" style="display:none">
                            ...
                            <tr>
                                <td style="width:100%;background-color:#d3d9d6;text-align:left;padding:4px" valign="bottom">
                                    <div style="width:100%;text-align:center">
                                        <input type="button" style="width:calc(100%/5 - 5px)" id="p13FolderUp" disabled="disabled" onclick="p13folderup()" value="Acima">
                                        ...
                                        <input type="button" style="width:calc(100%/5 - 5px)" id="p13DeleteFileButton" disabled="disabled" value="Deletar" onclick="p13deletefile()" onkeypress="return false" onkeydown="return false">
                                    ...
                                    <div style="width:100%;text-align:center">
                                        <input type="button" style="width:calc(100%/5 - 5px)" id="p13UploadButton" disabled="disabled" value="Envio" onclick="p13uploadFile()" onkeypress="return false" onkeydown="return false">
                                        ...
                                        <tbody><tr>
                                            ...
                                            <td id="p15outputselecttd">
                                                <select id="p15outputselect" onchange="setupConsole()">
                                                    ...
                                                    <option id="p15outputselect3" value="3">Empurre</option>
    ...
    <div id="dialog" style="display:none">
        ...
        <div style="margin-right:16px;margin-left:8px">
            ...
            <div id="dialog4" style="margin:auto;margin:3px">
                ...
                <div id="d3servermode">
                    <div id="d3serveraction" valign="bottom">
                        <input type="button" id="p3FolderUp" disabled="disabled" onclick="d3folderup()" value="Acima">&nbsp;<span id="p3CurrentFolder"></span>
                    </div>
            ...
            <div id="dialog7" style="margin:auto;margin:3px">
                <div id="d7meshkvm">
                    <h4 style="width:100%;border-bottom:1px solid gray">Área de trabalho remota do agente</h4>
                    <table style="width:100%">
                        <tbody><tr>
                            <td>
                                Qualidade
    ...
    <script>
        ...
        function onStateChanged(server, state, prevState, errorCode) {
            if (state == 0) {
                ...
                if (prevState == 2) { setTimeout(serverPoll, 5000); } else { QH('p0span', "Não foi possível conectar o soquete da web"); }
                // Clean up here
        ...
        function updateSelf() {
            ...
            if (typeof userinfo.passchange == 'number') {
                if (userinfo.passchange == -1) { QH('p2nextPasswordUpdateTime', " - Redefinir no próximo login."); }
                    ...
                    else if (seconds < 3600) { var secs = Math.floor(seconds / 60); QH('p2nextPasswordUpdateTime',format((secs == 1)?" - Reinicie em 1 minuto.":" - Redefina em {0} minutos.", secs)); }
                    else if (seconds < 86400) { var hours = Math.floor(seconds / 3600); QH('p2nextPasswordUpdateTime', format((hours == 1) ? " - Reinicie em 1 hora." : " - Redefina em {0} horas.", hours)); }
                    else { var days = Math.floor(seconds / 86400); QH('p2nextPasswordUpdateTime', format((hours == 1) ? " - Redefinir em 1 dia." : " - Redefina em {0} dias.", days)); }
                }
            }
        }
            ...
            switch (message.action) {
                ...
                case 'otpauth-request': {
                    if ((xxdialogMode == 2) && (xxdialogTag == 'otpauth-request')) {
                        if (message.err != null) {
                            var otpauthErrors = ['', "2FA está bloqueado", "Os códigos de backup estão bloqueados", "Token de login em uso", "OTP 2FA não permitido", "Conta está bloqueada", "Não foi possível carregar o OTPLIB"];
                ...
                case 'otpauth-getpasswords': {
                    ...
                    if (message.passwords != null) { x += '<input type=button value=\'' + "Limpo" + '\' onclick=\'account_manageOtp(2);\'></input>'; }
                    x += '</div><br />';
        ...
        function toggleNightMode() {
            ...
            var x = '<input type=radio id=night0 name=nightmoderadio value=0 ' + ((cNightMode == 0) ? 'checked' : '') + '><label for=night0>' + "Padrão do navegador" + '</label><br>';
        ...
        function account_manageAuthEmail() {
            ...
            }, "Quando ativado, em cada login, você terá a opção de receber um token de login na sua conta de email para aumentar a segurança." + '<br /><br /><label><input id=email2facheck type=checkbox ' + (emailU2Fenabled ? 'checked' : '') + '/>' + "Habilite a autenticação de dois fatores por email." + '</label>');
        }
        ...
        function account_createMesh() {
            ...
            x += addHtmlValue("Tipo", '<div style=width:170px;margin:0;padding:0><select id=dp3meshtype style=width:100% onchange=account_validateMeshCreate() ><option value=2>' + "Grupo de agentes de software" + '</option><option value=1>' + "Intel&reg; Apenas AMT" + '</option></select></div>');
            ...
            setDialogMode(2, "Criar grupo de dispositivo", 3, account_createMeshEx, x);
        ...
        function updateFiles() {
            ...
            for (var i in filetreexx) {
                ...
                if (f.t < 3 || f.t == 4) {
                    ...
                    var link = shortname;
                    var publiclink = '';
                    if (publicfolder) { publiclink = ' (<a style=cursor:pointer onclick=\'p5showPublicLink("' + publicPath + '/' + f.nx + '")\'>' + "Ligação" + '</a>)'; }
        ...
        function getNiceSize(bytes) {
            ...
            if (bytes < 2048) return format("{0}b restante", bytes);
            if (bytes < 2097152) return format("{0}k restante", Math.round(bytes / 1024));
            if (bytes < 2147483648) return format("{0}m restante", Math.round(bytes / 1024 / 1024));
            return format("{0}g restante", Math.round(bytes / 1024 / 1024 / 1024));
        }
        ...
        function p5setActions() {
            ...
            Q('p5SelectAllButton').value = (cc > 0 ? "Nenhum" : "Todos");
        ...
        function updateDevices() {
            ...
            for (var i in nodes) {
                ...
                if (sort == 0) {
                    ...
                    if (((meshes[nodes[i].meshid]?nodes[i].meshid:'*') != current)) {
                        deviceHeaderSet();
                        var extra = '';
                        if ((meshes[nodes[i].meshid] != null) && (meshes[nodes[i].meshid].mtype == 1)) { extra = '<span style=color:lightgray>' + ", Apenas Intel&reg; AMT" + '</span>'; }
            ...
            if ((sort == 0) && (Q('SearchInput').value == '')) {
                for (var i in meshes) {
                    ...
                    if ((displayedMeshes[mesh._id] == null) && (IsMeshViewable(mesh))) {
                        ...
                        if (mesh.mtype == 1) { r += '<div style=padding:10px><i>' + "Nenhum Intel&reg; AMT devices in this group"; }
            ...
            if (count == 0) {
                if ((Q('SearchInput').value != '') || (Q('OnlineCheckBox').checked)) {
                    QH('xdevices', '<div style="margin-top:50px;text-align:center"><span style="font-size:30px">' + "Nenhum dispositivo" + '</span><br /><br />' + "Nenhum dispositivo correspondente a esta pesquisa." + ' <a onclick=clearSearchInput() style=cursor:pointer>' + "Limpar filtro de pesquisa" + '</a></div>');
                } else {
                    QH('xdevices', '<div style="margin-top:50px;text-align:center"><span style="font-size:30px">' + "Nenhum dispositivo" + '</span><br /><br />' + "Use a versão desktop deste site para adicionar dispositivos." + '</div>');
                }
            } else {
                QH('xdevices', r);
            }
                ...
                if ((i == 'kvm') && (node.sessions.multidesk == null)) {
                    ...
                    for (var j in node.sessions.kvm) {
                        if (j.startsWith('user/')) {
                            ...
                            x += addHtmlValue2("Dispositivo está ocupado", ((node.sessions.kvm[j] == 1) ? "1 sessão" : nobreak(format("{0} sessões", node.sessions.kvm[j]))));
                        }
                    }
                } else if (i == 'multidesk') {
                    x += '<u>' + "Área de trabalho remota" + '</u>';
        ...
        var powerStateStrings = ['', "Ligado", "Hibernando", "Hibernando", "Deep Sleep", "Hibernando", "Soft-Off", "Presente", "Desligado"];
        ...
        */
            ...
            if (!currentNode || currentNode._id != node._id || refresh == true) {
                ...
                if (node.intelamt != null) {
                    ...
                    if (node.intelamt.state == 2) {
                        if (node.intelamt.tls == 1) { str += ', <span title="' + "O Intel&reg; AMT está configurado com segurança de rede TLS" + '">' + "TLS" + '</span>'; }
                        ...
                        if (node.intelamt.user == null || node.intelamt.user == '') { // If credentials are not set, allow setting them.
                            ...
                            if (warn != null) {
                                if ((meshrights & 4) != 0) {
                                    str += ', <i style=color:#FF0000;cursor:pointer title="' + "Editar Intel&reg; Credenciais AMT" + '" onclick=editDeviceAmtSettings("' + node._id + '")>' + warn + '</i>';
                                    editUserCredentialsIcon = true;
                                } else {
                ...
                if (connectivity && connectivity > 1) {
                    ...
                    if ((node.conn & 8) != 0) cstate.push('<span>' + "Retransmissão do agente" + '</span>');
                ...
                if ((meshrights & 0x8000) != 0) { x += '<a style=cursor:pointer onclick=p10showDeleteNodeDialog("' + node._id + '")>' + "Excluir dispositivo" + '</a>'; }
                ...
                if ((connectivity & 1) != 0) { if (powerstate.length > 0) { powerstate += ', '; } powerstate += ((node.mtype == 4) ? ((node.porttype == 'PDU') ? "Trocar" : "IP-KVM") : "Mesh Agent"); }
        ...
        function setIpPduState(op) {
            if (op == 0) {
                ...
                setDialogMode(2, "Operação de energia", 3, function () { meshserver.send({ action: 'wakedevices', nodeids: [currentNode._id] }); }, "Executar a alimentação?"); // Turn on
            }
        }
        ...
        function deviceActionFunction() {
            ...
            if ((currentNode.agent != null) && (currentNode.agent.id == 14)) {
                ...
                if ((rights & 64) != 0) { count++; y += '<option value=100>' + "Ligar" + '</option>'; } // Wake-up permission
                //if (((currentNode.conn & 1) != 0) && ((rights & 131072) != 0)) { count++; y += '<option value=106>' + "Run Commands" + '</option>'; } // Remote command permission
                if ((currentNode.conn != 0) && ((rights & 262144) != 0)) { count++; y += '<option value=4>' + "Hibernar" + '</option><option value=3>' + "Redefinir" + '</option><option value=2>' + "Desligar" + '</option>'; }
        ...
        function showNotes(readonly, noteid) {
            ...
            if (noteid.startsWith('node%2F%2F')) { x += '<span style=font-size:10px>' + "As notas do grupo de dispositivos podem ser visualizadas e alteradas por outros administradores do grupo de dispositivos." + '<span>'; }
        ...
        function deviceLockFunction() {
            if ((xxdialogMode != null || xxdialogMode == 0) && (desktop != null) && (desktop.contype == 1)) { setDialogMode(2, "Lock Desktop", 3, function() { if ((desktop != null) && (desktop.contype == 1)) { desktop.sendCtrlMsg('{"ctrlChannel":"102938","type":"lock"}'); } }, "Bloquear a área de trabalho do usuário?"); }
        }
        ...
        function d2runCommandDialog(options) {
            ...
            if ((wintype == true) || (linuxtype == true) || (agenttype == true)) {
                ...
                x += '</select>';
                x += '<select id=d2cmduser style=width:100%;margin-bottom:4px><option value=0' + ((runopt.runAs == 0)?' selected':'') + '>' + "Executar como agente" + '</option><option value=1' + ((runopt.runAs == 1)?' selected':'') + '>' + "Executar como usuário, agente se não houver usuário" + '</option><option value=2' + ((runopt.runAs == 2)?' selected':'') + '>' + "Deve ser executado como usuário" + '</option></select>';
        ...
        function editDeviceAmtSettings(nodeid, func) {
            ...
            x += addHtmlValue("Nome de usuário", '<input id=dp10username style=width:170px maxlength=32 autocomplete=nope placeholder="admin" onchange=validateDeviceAmtSettings() onkeyup=validateDeviceAmtSettings() />');
            ...
            setDialogMode(2, "Editar Intel&reg; Credenciais AMT", buttons, editDeviceAmtSettingsEx, x, { node: node, func: func });
        ...
        function showClearSshDialog() { setDialogMode(2, "Editar dispositivo", 3, showClearSshDialogEx, "Limpar credenciais SSH?"); }
        function showClearSshDialogEx(button, mode) { meshserver.send({ action: 'changedevice', nodeid: currentNode._id, ssh: 0 }); }
        function showClearRdpDialog() { setDialogMode(2, "Editar dispositivo", 3, showClearRdpDialogEx, "Limpar credenciais RDP?"); }
        ...
        var keyStrings = { 8: "BackSpace", 9: "Tab", 13: "Entrar", 27: "Fuga", 32: "Space", 44: "Captura de tela", 45: "Inserir", 46: "Del", 36: "Casa", 35: "Fim", 32: "Espace", 33: "Subir página", 34: "Page Down", 37: "Deixou", 38: "Acima", 39: "Direito", 40: "Baixa", 0: "Nenhum" }

        function keyShortcutTotext(n) {
            var x = [];
            if (n & 0x010000) { x.push("Mudança"); }
        ...
        function deskCustomizeKeys() {
            ...
            x += '<label><input id=d1kshift type=checkbox /> ' + "Mudança" + '</label><label> <input id=d1kalt type=checkbox /> ' + "Alt" + '</label><label> <input id=d1kctrl type=checkbox /> ' + "CTRL" + '</label> <input id=d1kwin type=checkbox /> ' + "Win" + '</label>';
        ...
        function sshTunnelAuthDialog(j, func) {
            var x = '';
            if (j.askkeypass) {
                x += addHtmlValue("Autenticação", '<select id=dp2authmethod style=width:150px onchange=sshAuthUpdate(event)><option value=3 selected>' + "Chave Armazenada" + '</option><option value=1>' + "Usuário senha" + '</option><option value=2>' + "Nome de usuário e chave" + '</option></select>');
            } else {
                x += addHtmlValue("Autenticação", '<select id=dp2authmethod style=width:150px onchange=sshAuthUpdate(event)><option value=1 selected>' + "Usuário senha" + '</option><option value=2>' + "Nome de usuário e chave" + '</option></select>');
            }
            x += '<div id=d2userauth style=display:none>';
            x += addHtmlValue("Nome de usuário", '<input id=dp2user style=width:150px maxlength=64 autocomplete=off onkeyup=sshAuthUpdate(event) />');
            x += '</div>';
            ...
            if ((features2 & 0x00400000) == 0) { x += '<label><input id=dp2keep type=checkbox>' + "Lembre-se de credenciais" + '</label>'; }
            x += '</div><div id=d2keyauth style=display:none>';
            x += addHtmlValue("Arquivo-chave", '<input type=file id=dp2key style=width:150px maxlength=64 autocomplete=off onchange=sshAuthUpdate(event) />' + '<div id=d2badkey style=font-size:x-small>' + "O arquivo da chave deve estar no formato OpenSSH." + '</div>');
            x += addHtmlValue("Senha da chave", '<input type=password id=dp2keypass style=width:150px maxlength=64 autocomplete=off onkeyup=sshAuthUpdate(event) />');
        ...
        */
        ...
        function p13setActions() {
            ...
            if (p13filetree == null) {
                ...
                Q('p13SelectAllButton').value = (cc > 0 ? "Nenhum" : "Todos");
        ...
        function p13pasteFile() {
            ...
            if ((p13clipboard != null) && (p13clipboard.length > 0)) {
                if (p13clipboardCut == 0) {
                    if (p13clipboard.length > 1) { x = format("Confirma cópia de {0} entradas para este local?", p13clipboard.length); } else { x = format("Confirmar cópia de 1 entrada para este local?"); }
                } else {
                    if (p13clipboard.length > 1) { x = format("Confirma a movimentação de {0} entradas para este local?", p13clipboard.length); } else { x = format("Confirmar a movimentação de 1 entrada para este local?"); }
                }
            }
        ...
        */
        ...
        function p13doUploadFiles(files) {
            ...
            if (overWriteCount == 0) {
                ...
                setDialogMode(2, "Subir arquivo", 3, p13uploadFileContinue, format((overWriteCount == 1) ? "O upload substituirá 1 arquivo. Continuar?" : "O upload substituirá {0} arquivos. Continuar?", overWriteCount), files);
            }
        }
        ...
        function updateDeviceDetails(node, hardware, network) {
            ...
            if (node.wsc) {
                var y = [];
                if (node.wsc.antiVirus != null) { if (node.wsc.antiVirus == 'OK') { y.push("AV" + ' - <span style=color:green>' + "Ok" + '</span>'); } else { y.push("AV" + ' - <span style=color:red>' + "MAU" + '</span>'); } }
                if (node.wsc.autoUpdate != null) { if (node.wsc.autoUpdate == 'OK') { y.push("Atualizar" + ' - <span style=color:green>' + "Ok" + '</span>'); } else { y.push("Atualizar" + ' - <span style=color:red>' + "MAU" + '</span>'); } }
                if (node.wsc.firewall != null) { if (node.wsc.firewall == 'OK') { y.push("Firewall" + ' - <span style=color:green>' + "Ok" + '</span>'); } else { y.push("Firewall" + ' - <span style=color:red>' + "MAU" + '</span>'); } }
           ...
           if (node.users && node.users.length > 0) {
                ...
                x += addDetailItem((node.users.length > 1 ? "Utilizadores ativos" : "Utilizador ativo"), u);
            }
            ...
            if (network.netif2 != null) {
                ...
                x += '</table>';
                if (x != '') { sections.push({ name: "Trabalho em rede", html: x, img: 'networking' }); }
            }
            ...
            if (hardware.tpm) {
                ...
                if (tpm.IsEnabled != null) { x += addDetailItem("ativado", (tpm.IsEnabled ? "Yes" : "No"), s); }
            ...
            if (hardware.windows) {
                if (hardware.windows.memory && (hardware.windows.memory.length > 0)) {
                    ...
                    for (var i in hardware.windows.memory) {
                        ...
                        if (m.PartNumber) { x += addDetailItem("Número Parcial", EscapeHtml((m.Manufacturer && m.Manufacturer != 'Undefined') ? (m.Manufacturer + ', ') : '') + EscapeHtml(m.PartNumber), s); }
                        x += '</div>';
                    }
                    x += '</table>';
            ...
            if (hardware.darwin) {
                if (hardware.darwin.memory && (hardware.darwin.memory.length > 0)) {
                    ...
                    for (var i in hardware.darwin.memory) {
                        ...
                        if (m.PartNumber) { x += addDetailItem("Número Parcial", EscapeHtml((m.Manufacturer && m.Manufacturer != '')?(m.Manufacturer + ', '):'') + EscapeHtml(m.PartNumber), s); }
                        x += '</div>';
                    }
                    x += '</table>';
                    if (x != '') { sections.push({ name: "Memória", html: x, img: 'ram'}); }
            ...
            if (hardware.identifiers && ident.storage_devices) {
                ...
                if (x != '') { sections.push({ name: "Armazenamento", html: x, img: 'storage' }); }
            }
            ...
            if (hardware.windows && hardware.windows.volumes) {
                ...
                for (var i in hardware.windows.volumes) {
                    ...
                    if (m.protectionStatus || m.volumeStatus) {
                        var bitlockerState = [];
                        if (m.protectionStatus) bitlockerState.push("ativado");
        ...
        */
        ...
        function p15consoleSend(e) {
            ...
            if (((consoleNode.conn & 16) != 0) && (Q('p15outputselect').value == 2)) {
                ...
                t = '<div style=color:violet>' + "EMPURRE" + '&gt; ' + EscapeHtml(v) + '<br/></div>';
                consoleNode.consoleText += t;
        ...
        function p15uploadCore(e) {
            ...
            if (e.shiftKey == true) { meshserver.send({ action: 'uploadagentcore', nodeid: consoleNode._id, type: 'default' }); } // Upload default core
                ...
                var htmlValue = '<select id=d3coreMode style=width:230px>' +
                    '<option value=1>' + "Carregar núcleo do servidor padrão" + '</option>' +
                    '<option value=2>' + "Limpe o núcleo" + '</option>' +
                    '<option value=3>' + "Carregar um arquivo principal" + '</option>' +
                    '<option value=4>' + "Agente de desconexão suave" + '</option>' +
                    '<option value=5>' + "Forçar desconexão do agente" + '</option>' +
                    '<option value=6>' + "Carregar núcleo de recuperação" + '</option>' +
                    '<option value=7>' + "Faça upload de um núcleo minúsculo" + '</option>' +
                    '<option value=8>' + "Restart agent service" + '</option>' +
                    '<option value=9>' + "Forçar atualização do agente" + '</option></select>';
                setDialogMode(2, "Executar ação do agente", 3, p15uploadCoreEx, addHtmlValue("Ação", htmlValue));
            }
        }
        ...
        function p15uploadCore2() {
            ...
            Q('d3auth').value = authCookie;
            Q('d3attrib').value = currentNode._id;
            setDialogMode(4, "Carregar núcleo do agente de malha", 3, p15uploadCoreEx2);
            d3init();
        }
        ...
        function p20updateMesh() {
            ...
            if (currentMesh.mtype == 1) meshtype = "Intel&reg; Apenas AMT, nenhum agente";
            ...
            if (((currentMesh.mtype == 3) || (currentMesh.mtype == 4)) && (currentMesh.relayid != null)) {
                ...
                x += addHtmlValue("Dispositivo de Relé", addLinkConditional(relayName, 'p20editmeshrelay()', (meshrights & 1) != 0));
            }

            // Display IP-KVM information if needed
            if (currentMesh.mtype == 4) {
                x += addHtmlValue("Hostname", currentMesh.kvm.host);
                x += addHtmlValue("Nome de usuário", currentMesh.kvm.user);
            }
            ...
            if (currentMeshLinks && ((currentMeshLinks.rights & 2) != 0)) { x += '<div style=margin-bottom:6px;float:left;margin-right:10px><a onclick=p20showAddMeshUserDialog() style=cursor:pointer><img src=images/icon-addnew.png border=0 height=12 width=12> ' + "Adicionar utilizador" + '</a></div>'; }
        ...
        function p20editmeshrelay() {
            ...
            if (relayDevices.length == 0) {
                ...
                var x = addHtmlValue("Dispositivo de Relé", '<div style=width:170px><select id=d2devrelay style=width:100%>' + relayDevices2.join('') + '</select></div>');
        ...
        function p20showAddMeshUserDialog() {
            ...
            x += '<label><input type=checkbox onchange=p20validateAddMeshUserDialog() id=p20noamt style=margin-left:12px>' + "Nenhum Intel&reg; AMT" + '</label><br>';
        ...
        function p20viewuser(userid) {
            ...
            if (meshrights == 0xFFFFFFFF) r.push("Administrador completo"); else {
                ...
                if ((meshrights & 2048) != 0) r.push("Nenhum Intel&reg; AMT");
            ...
            var x = addHtmlValue("Nome de Usuário", EscapeHtml(uname));
        ...
        function p20viewuserEx(button, userid) {
            ...
            setDialogMode(2, "Usuário de malha remota", 3, p20viewuserEx2, format("Confirmar remoção do usuário {0}?", uname), userid);
        }
        ...
        function drawNotifications() {
            ...
            if (notifications.length == 0) {
                ...
                for (var i in notifications) {
                    ...
                    r += '<div onclick="notificationDelete(' + n.id + ')" class=unselectable title="' + "Apague esta notificação" + '" style=margin:5px;float:right;color:orange><b>X</b></div><div onclick="notificationSelected(' + n.id + ')" style=margin:5px>' + t + EscapeHtml(n.text) + '</div><div style=margin-left:5px;margin-bottom:5px;color:gray;font-size:10px>' + printDateTime(d) + '</div></div>';
                }
            }
            var deleteall = '';
            if (notifications.length > 1) { deleteall = '<div id="notifyRemoveAll" onclick="deleteAllNotifications()" style="cursor:pointer;border-top:1px solid orange;margin:5px;color:orange;text-align:right;padding-right:3px">' + "Limpar tudo" + '</div>'; }
        ...
        function addNotification(n) {
            ...
            var translatedMessages = [
                ...
                "Usuário já existe",
                "Não é possível adicionar usuário neste modo",
                ...
                "Erro de SMS",
                "Erro de SMS: {0}",
                "O domínio de e-mail \"{0}\" não é permitido. Apenas ({1}) são permitidos" // 30
            ];
