<!DOCTYPE html><html lang="es" dir="ltr" xmlns="http://www.w3.org/1999/xhtml"><head>
    ...
    <div id="LeftSideToolBar" style="display:none;position:absolute;left:0;bottom:0;width:52px;top:0;background:#113962;background:linear-gradient(to bottom, #104893 0%,#113962 100%);color:white;border-right: 5px solid #BBB;">
        <div id="LeftMenuDesktop" class="slbbutton slbbuttonsel2" title="Escritorio" onclick="go(11)">
        ...
        <div id="LeftMenuFiles" class="slbbutton" title="Archivos" onclick="go(13)">
        ...
        <div id="deskarea0">
            <div id="deskarea1" class="areaHead" style="line-height:24px">
                <div class="toright2">
                    ...
                    <div class="deskareaicon" title="Alternar Modo de Vista" onclick="toggleAspectRatio(1)">⇲</div>
                    <div class="deskareaicon" title="Girar a la Izquierda" onclick="drotate(-1)">↺</div>
                    <div class="deskareaicon" title="Gira a la Derecha" onclick="drotate(1)">↻</div>
                    <input id="deskActionsSettings" type="button" value="Opciones..." title="Editar configuraciones de escritorio remoto" onkeypress="return false" onkeydown="return false" onclick="showDesktopSettings()" class="mR">
                    <div id="desktopCustomUiButtons" style="float:left"></div>
                    <div id="deskRecordIcon" class="deskareaicon" title="El servidor está grabando esta sesión" style="display:none;background-color:red;width:12px;height:12px;border-radius:6px;margin-top:5px"></div>
                </div>
                <div>
                    <div id="idx_deskFullBtn2" onclick="deskToggleFull(event)">&nbsp;✖</div>
                    <input type="button" id="autoconnectbutton1" value="AutoConectar" onclick="autoConnectDesktop(event)" onkeypress="return false" onkeydown="return false" style="display:none">
                    <span id="connectbutton1span"><input type="button" id="connectbutton1" cmenu="deskConnectButton" value="Conectar" onclick="connectDesktop(event,3)" onkeypress="return false" onkeydown="return false" disabled="disabled"></span>
                    <span id="connectbutton1hspan">&nbsp;<input type="button" id="connectbutton1h" value="Conectar al HW" title="Conéctate mediante hardware KVM de Intel AMT" onclick="connectDesktop(event,2)" onkeypress="return false" onkeydown="return false" disabled="disabled"></span>
                    ...
                    &nbsp;<span id="deskstatus">Desconectado</span><span id="deskmetadata"></span>
                </div>
            </div>
            ...
            <div id="deskarea4" class="areaFoot" style="min-height:24px">
                <div class="toright2">
                    <span id="DeskLatency" style="line-height:22px;width:50px" title="Latencia de Sesión de Escritorio"></span>
                    <span id="DeskTimer" style="line-height:22px" title="Tiempo de sesión"></span>&nbsp;
                    ...
                    <span id="DeskSaveImageButton" title="Guardar una captura de pantalla del escritorio remoto"><img src="images/icon-camera.png" onclick="deskSaveImage()" height="16" width="16" style="padding-top:2px"></span>
                </div>
                <div style="height:22px">
                    <select id="deskkeys">
                        ...
                        <option value="11">Win+Izquierda</option>
                        <option value="12">Win+Derecha</option>
                    </select>
                    <input id="DeskWD" type="button" value="Enviar" onkeypress="return false" onkeydown="return false" onclick="deskSendKeys()">
                    <input id="DeskClip" style="" type="button" value="Portapapeles" onkeypress="return false" onkeydown="return false" onclick="showDeskClip()">
                    <input id="DeskType" style="" type="button" value="Tipo" onkeypress="return false" onkeydown="return false" onclick="showDeskType()">
                    <label><span id="DeskControlSpan" title="Alternar control de mouse y teclado de forma remota"><input id="DeskControl" type="checkbox" onkeypress="return false" onkeydown="return false" onclick="toggleKvmControl()">Controlar mouse y teclado de forma remota</span></label>&nbsp;
                </div>
            </div>
        </div>
    </div>
    <div id="p12" class="noselect" style="overflow:hidden;position:absolute;left:54px;top:0;right:0;bottom:0;display:none;background-color:black">
        <div id="p12warning" onclick="showFeaturesDlg()">
            <div class="icon2"></div>
            <div class="warningbox">El puerto de redirección de Intel® AMT o la función KVM están deshabilitados<span id="p12warninga">, haga click aquí para habilitarlo.</span></div>
        </div>
        <div id="p12warning2" onclick="showPowerActionDlg()">
            <div class="icon2"></div>
            <div class="warningbox">La computadora remota no está encendida, haz clic aquí para enviar el comando de encendido.</div>
        </div>
        <div class="areaHead" style="position:absolute;top:0;left:0;right:0;height:24px">
            <div class="toright2">
                <div id="termRecordIcon" class="deskareaicon" title="El servidor está grabando esta sesión" style="display:none;background-color:red;width:12px;height:12px;border-radius:6px;margin-top:5px;margin-left:5px"></div>
                <div id="p12power" style="margin-top:3px;margin-right:4px;float:right"></div>
            </div>
            <div>
                <span id="connectbutton2span"><input type="button" id="connectbutton2" cmenu="termConnectButton" value="Conectar" onclick="connectTerminal(event,1)" onkeypress="return false" onkeydown="return false" disabled="disabled"></span>
        ...
        <div class="areaFoot" style="position:absolute;bottom:0;left:0;right:0;height:24px">
            <div class="toright2">
                <span id="TermLatency" title="Latencia de sesión terminal"></span>
                <span id="TermTimer" title="Tiempo de sesión"></span>&nbsp;
                <span id="terminalSettingsButtons" style="display:none">
                    <input id="id_tcrbutton" type="button" onkeypress="return false" onkeydown="return false" class="bottombutton" value="CR+LF" title="Alternar lo que enviará la tecla Enter" onclick="termToggleCr()">
                    <input id="id_tfxkeysbutton" type="button" onkeypress="return false" onkeydown="return false" class="bottombutton" value="Intel (F10 = ESC+[OM)" title="Alternar el tipo de emulación con las teclas F1 a F10" onclick="termToggleFx()">
                    <input id="id_ttypebutton" type="button" onkeypress="return false" onkeydown="return false" class="bottombutton" value="Ascii extendido" title="Alternar el tipo de emulación de terminal" onclick="termToggleType()">
                </span>
                ...
                <span id="specialKeyDropDown">
                    ...
                    <input id="specialkeylistinput" type="button" onkeypress="return false" class="bottombutton" value="Enviar" title="Enviar la clave especial seleccionada" onclick="sendSpecialKey()">
                </span>
            </div>
            <div>
                &nbsp;
                ...
                <input type="button" onkeypress="return false" onkeydown="return false" class="bottombutton" id="bsbutton" value="Retroceso" onclick="termSendKey(8,'bsbutton')" style="display:none">
                <input type="button" onkeypress="return false" onkeydown="return false" class="bottombutton" id="pastebutton" value="Pegar" title="Pegar texto en la terminal" onclick="showTermPasteDialog()" style="display:none">
            </div>
        </div>
    ...
    <div id="p13" class="noselect" style="overflow:hidden;position:absolute;left:54px;top:0;right:0;bottom:0;display:none;background-color:white">
        <div id="p13toolbar" style="position:absolute;left:0;top:0;right:0;bottom:28px">
            <div class="areaHead">
                <div class="toright2">
                    <div id="filesRecordIcon" class="deskareaicon" title="El servidor está grabando esta sesión" style="display:none;background-color:red;width:12px;height:12px;border-radius:6px;margin-top:5px;margin-left:5px"></div>
            ...
            <div id="fileArea2" class="areaHead2" valign="bottom">
                ...
                <div>
                    <input type="button" id="p13FolderUp" disabled="disabled" onclick="p13folderup()" value="Subir">&nbsp;
                    <input type="button" id="p13SelectAllButton" disabled="disabled" onclick="p13selectallfile()" value="Seleccionar Todo">&nbsp;
                    <input type="button" id="p13RenameFileButton" disabled="disabled" value="Renombrar" onclick="p13renamefile()">&nbsp;
                    <input type="button" id="p13DeleteFileButton" disabled="disabled" value="Eliminar" onclick="p13deletefile()">&nbsp;
                    <input type="button" id="p13ViewFileButton" disabled="disabled" value="Editar" onclick="p13viewfile()">&nbsp;
                    <input type="button" id="p13NewFolderButton" disabled="disabled" value="Nueva Carpeta" onclick="p13createfolder()">&nbsp;
                    <input type="button" id="p13UploadButton" disabled="disabled" value="Subir Archivo" onclick="p13uploadFile()">&nbsp;
                    ...
                    <input type="button" id="p13PasteButton" disabled="disabled" value="Pegar" onclick="p13pasteFile()">&nbsp;
                    <input type="button" id="p13ZipButton" disabled="disabled" value="Comprimir en Zip" onclick="p13zipFiles()">&nbsp;
                    <input type="button" id="p13RefreshButton" disabled="disabled" value="Actualizar" onclick="p13folderup(9999)">&nbsp;
                    <input type="button" id="p13FindButton" disabled="disabled" value="Encontrar" onclick="p13findfile()">&nbsp;
                </div>
            </div>
    ...
    <div id="dialog" class="noselect" style="display:none">
        ...
        <div id="dialogBody">
            ...
            <div id="dialog4" style="">
                <input id="d4WrapButton" type="button" value="Envoltura" onclick="d4ToggleWrap()">
                <input id="d4SizeButton" type="button" value="Pequeño" onclick="d4ToggleSize()">
            ...
            <div id="dialog7" style="">
                <div id="d7meshkvm">
                    <h4>Escritorio Remoto del Agente</h4>
                    <div>
                        <div>Calidad</div>
                    ...
                    <div id="d7desktopOtherSettings">
                        <div>Otros Ajustes</div>
                        <div id="d7otherset2" style="display:block">
                            <label style="display:block"><input type="checkbox" id="d7deskSwapMouse">Cambiar Botones del Mouse</label>
                            <label style="display:block"><input type="checkbox" id="d7deskRemoteKeyMap">Usar Mapa de Teclado Remoto</label>
                        </div>
                    </div>
                </div>
                <div id="d7amtkvm">
                    ...
                    <div>
                        <div>Codificación de Imagen</div>
                    ...
                    <div>
                        ...
                        <div id="d7otherset" style="display:block">
                            <label style="display:block"><input type="checkbox" id="d7showfocus">Mostrar Herramienta de Enfoque</label>
                            <label style="display:block"><input type="checkbox" id="d7showcursor">Mostrar Cursor del Mouse Local</label>
                            <label style="display:block"><input type="checkbox" id="d7localKeyMap">Mapa de Teclado Local</label>
                        </div>
                    </div>
                </div>
            </div>
    ...
    <script>
                    ...
                    desktop.m.onKvmData = function (x) {
                        ...
                        if ((data != null) && (data.action != null)) {
                            if (data.action == 'restart') {
                                ...
                                webRtcDesktop.webchannel = webRtcDesktop.webrtc.createDataChannel("Canal de Datos", {}); // { ordered: false, maxRetransmits: 2 }
        ...
        function updateMetadata(conn, elementid) {
            ...
            if (conn && (conn.State == 3)) {
                ...
                if (viewerCount > 1) { str = '<span onclick=showSessionMetadata(1) style=cursor:pointer>' + format(", {0} viendo", viewerCount) + '</span>'; }
            }
            QH('deskmetadata', str);
        ...
        function showSessionMetadata(cid) {
            ...
            if (conn && conn.metadata) {
                var x = '';
                if (conn.metadata.startTime) { x += addHtmlValue4("Tiempo de Inicio", printDateTime(new Date(conn.metadata.startTime))); }
                if (conn.metadata.users) {
                    for (var i in conn.metadata.users) {
                        var val = (conn.metadata.users[i] == 1) ? "1 conexión" : format("{0} conexiones", conn.metadata.users[i]);
                        var username = i.split('/')[2];
                        if ((users != null) && (users[i] != null)) { username = users[i].name; }
                        x += addHtmlValue4(format("Usuario \"{0}\"", username), val);
                    }
                }
                setDialogMode(2, "Información de la Sesión", 1, null, x, 'sessionMetadata' + cid);
            }
        }
        ...
        function showDeskType() {
            if (xxdialogMode || desktop == null || desktop.State != 3) return;
            Q('DeskType').blur();
            var x = '<div>' + "Ingresa el texto y haz clic en Aceptar para escribirlo de forma remota con un teclado de inglés de EE. UU. Asegúrate de colocar el cursor remoto en la posición correcta antes de continuar." + '<div>';
            x += '<textarea id=d2typeText style="margin-top:5px;width:100%;height:184px;resize:none" maxlength=2000></textarea>';
            setDialogMode(2, "Entrada Remota de Teclado", 3, showDeskTypeEx, x);
            Q('d2typeText').focus();
        }
        ...
        */
        ...
        function deskSaveImage() {
            if (xxdialogMode || desktop == null || desktop.State != 3) return;
            var d = new Date(), n = "Escritorio" + '-' + d.getFullYear() + '-' + ('0' + (d.getMonth() + 1)).slice(-2) + '-' + ('0' + d.getDate()).slice(-2) + '-' + ('0' + d.getHours()).slice(-2) + '-' + ('0' + d.getMinutes()).slice(-2);
        ...
        var terminalEmulations = ["Terminal UTF8", "ASCII extendido", "Intel ASCII"];
        ...
        var fxEmulations = ["Intel (F10 = ESC+[OM)", "Alternar (F10 = ESC+0)", "VT100+ (F10 = ESC+[OY)"];
        ...
        function showTermPasteDialog() {
            if (!terminal || xxdialogMode) return;
            Q('pastebutton').blur();
            setDialogMode(2, "Pegar", 3, showTermPasteDialogEx, '<textarea id=d2pasteText style="width:100%;height:184px;resize:none"></textarea>');
            Q('d2pasteText').focus();
        }
        ...
        function p13gotFiles(data) {
            ...
            if (data.action == 'findfile') {
                if (xxdialogTag == data.reqid) {
                    if (data.r == null) {
                        ...
                        xxdialogTag = null;
                        if (Q('d2findResults').innerHTML == '') { QH('d2findResults', '<div style=text-align:center;margin:10px><i>' + "No se encontraron archivos" + '</i></div>'); }
                    } else {
            ...
            if (data.action == 'dialogmessage') {
                if ((data.msg == null) && (xxdialogTag == 'fileMsgDialog')) {
                    ...
                    setDialogMode(2, "Operación de Archivo", 10, p13fileOperationDialogEx, '<div style=margin:10px>' + "Comprimiendo archivos..." + '<div>', 'fileMsgDialog');
                } else if ((data.msg == 'zippingFile') && ((!xxdialogMode) || (xxdialogTag == 'fileMsgDialog'))) {
                    // Show the dialog box message
                    setDialogMode(2, "Operación de Archivo", 10, p13fileOperationDialogEx, '<div style=margin:10px>' + EscapeHtml(data.file) + '<div><br /><progress value=' + EscapeHtml(data.progress) + ' style=width:100% max=100 />', 'fileMsgDialog');
                }
                return;
            }
        ...
        function p13updateFiles(checkedNames) {
            var html1 = '', html2 = '', displayPath = '<a href=# style=cursor:pointer onclick="return p13folderup(0)">' + "Raíz" + '</a>', fullPath = 'Root';
        ...
        function p13findfile() {
            if (xxdialogMode) return;
            var x = addHtmlValue("Filtrar", '<input id=d2findFilter style="width:230px" onkeyup=p13findfileValidate() onkeydown=p13findfileDown(event) placeholder="*.txt"></input>');
            ...
            x += '<div style=margin-top:8px><input id=filefind_dlgCancelButton type=button value=' + "Cerrar" + ' style=float:right;width:80px;margin-left:5px onclick=p13findfileCancel()>';
            x += '<input id=filefind_dlgOkButton type=submit value=' + "Buscar" + ' style=float:right;width:80px onclick=p13findfileEx()><br /><br /></div>';
            setDialogMode(2, "Buscar Archivos", 0, null, x);
            p13findfileValidate();
        ...
        function p13setActions() {
            ...
            if (p13filetree == null) {
                ...
                Q('p13SelectAllButton').value = "Seleccionar Todo";
                ...
                Q('p13SelectAllButton').value = (cc > 0 ? "No seleccionar nada" : "Seleccionar Todo");
        ...
        function p13zipFiles() {
            ...
            setDialogMode(2, "Nombre de Archivo ZIP", 3, p13zipFilesEx, '<input type=text id=p13renameinput maxlength=64 onkeyup=p13fileNameCheck(event) style=width:100% value="" />', { action: 'zip', path: p13filetreelocation.join('/'), files: inputFiles });
        ...
        function p13pasteFile() {
            ...
            if ((p13clipboard != null) && (p13clipboard.length > 0)) {
                if (p13clipboardCut == 0) {
                    if (p13clipboard.length > 1) { x = format("¿Confirmar la copia de {1} entradas a esta ubicación?", p13clipboard.length); } else { x = format("¿Confirmar la copia de 1 entrada a esta ubicación?"); }
                } else {
                    if (p13clipboard.length > 1) { x = format("¿Confirmar el movimiento de {1} entradas a esta ubicación?", p13clipboard.length); } else { x = format("¿Confirmar el movimiento de 1 entrada a esta ubicación?"); }
                }
            }
        ...
        function p13downloadfile(x, y, z, tag) {
            ...
            setDialogMode(2, "Descargar Archivo", 10, p13downloadFileCancel, '<div>' + gdownloadFile.file + '</div><br /><progress id=d2progressBar style=width:100% value=0 max=' + z + ' />');
        }
        ...
        function d4ToggleWrap(update) {
            ...
            Q('d4WrapButton').value = ["Envoltura: ON", "Envoltura: OFF"][d4EditWrapVal];
        ...
        function d4ToggleSize(update) {
            ...
            Q('d4SizeButton').value = ["Tamaño: 100%", "Tamaño: 125%", "Tamaño: 150%", "Tamaño: 200%"][d4EditSizeVal];
        ...
        function d4ToggleEncoding(update) {
            ...
            Q('d4EncodingButton').value = ["Codificación: RAW","Codificación: UTF8"][d4EditEncodingVal];
        ...
        function printFlexDateTime(d) { if (printDate(new Date()) == printDate(d)) { return format("Expira el {0}", printTime(d)); } else { return format("Caduca el {0}", printDateTime(d)); } }
