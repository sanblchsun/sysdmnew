<!DOCTYPE html><html lang="es"><head>
    ...
    {{{customJSTags}}}
    <title>Instalación del Agente</title>
    <style>
        .tab {
            overflow: hidden;
        ...
        <div id="column_l" style="overflow-y:auto">
            ...
            <div>
                <div class="tab">
                    ...
                    <button id="tlinuxbinarytab" class="tablinks" onclick="openTab(event, 'linuxbinarytab')">Instalador Binario para Linux / BSD / macOS</button>
                    ...
                    <button id="tassistab" class="tablinks" onclick="openTab(event, 'assistab')">Asistente</button>
                </div>

                <div id="wintab64" class="tabcontent" style="background-color:white;color:black">
                    <h3>Microsoft™ Windows 64bits</h3>
                    <p><a id="win64url">Descargar el software aquí</a>, ejecútalo y presiona "Instalar" o "Conectar".</p>
                ...
                <div id="wintab32" class="tabcontent" style="background-color:white;color:black">
                    <h3>Microsoft™ Windows 32bits</h3>
                    <p><a id="win32url">Descargar el software aquí</a>, ejecútalo y presiona "Instalar" o "Conectar".</p>
                    <div style="text-align:center">
                ...
                <div id="wintabarm64" class="tabcontent" style="background-color:white;color:black">
                    ...
                    <p><a id="winarm64url">Descargar el software aquí</a>, ejecútalo y presiona "Instalar" o "Conectar".</p>
                    <div style="text-align:center">
                ...
                <div id="linuxtab" class="tabcontent" style="background-color:white;color:black">
                    <h3>Linux</h3>
                    <p>Para instalar, corta y pegua el siguiente comando en un terminal como root.</p>
                    <div id="linuxinstall" style="font-family:courier,'courier new',monospace;margin-left:30px"></div>
                    <input type="button" value="Copiar al portapapeles" style="margin-left:30px;margin-top:4px" onclick="copyToClipLinuxInstall()">
                    <p>Para desinstalar, corta y pegua el siguiente comando como root.</p>
                    <div id="unlinuxinstall" style="font-family:courier,'courier new',monospace;margin-left:30px"></div>
                    <input type="button" value="Copiar al portapapeles" style="margin-left:30px;margin-top:4px" onclick="copyToClipLinuxUnInstall()">
                    <br><br>
                </div>
                ...
                <div id="macostab64" class="tabcontent" style="background-color:white;color:black">
                    ...
                    <p><a id="macos64url">Descargar el instalador aquí</a>, haga click derecho o presione "Ctrl" y dé click en el archivo. Después seleccione "Abrir" y siga las instrucciones.</p>
                    <div style="text-align:center">
                ...
                <div id="macostabarm64" class="tabcontent" style="background-color:white;color:black">
                    ...
                    <p><a id="macosarm64url">Descargar el instalador aquí</a>, haga click derecho o presione "Ctrl" y dé click en el archivo. Después seleccione "Abrir" y siga las instrucciones.</p>
                    <div style="text-align:center">
                ...
                <div id="macostab" class="tabcontent" style="background-color:white;color:black">
                    ...
                    <p><a id="macosurl">Descargar el instalador aquí</a>, haga click derecho o presione "Ctrl" y dé click en el archivo. Después seleccione "Abrir" y siga las instrucciones.</p>
                    <div style="text-align:center">
                ...
                <div id="androtab" class="tabcontent" style="background-color:white;color:black">
                    ...
                    <div style="min-height:220px">
                        <p>Descarga el software del agente usando la tienda Google Play o el archivo APK, instálalo y usa el código QR a la derecha o el enlace de emparejamiento a continuación para configurar tu dispositivo en este servidor.</p>
                        <p>
                        ...
                        <p>
                            <a id="androidurl">Descargar APK de Android</a>
                        </p>
                        <p>
                            <a rel="noreferrer noopener" target="_blank" href="{{{magenturl}}}">Enlace de Emparejamiento del Servidor</a>
                        </p>
                    </div>
                </div>
                ...
                <div id="assistab" class="tabcontent" style="background-color:white;color:black">
                    ...
                    <div style="min-height:220px">
                        ...
                        <p>El asistente de MeshCentral para Windows es una herramienta de la bandeja del sistema que se puede utilizar para solicitar ayuda. No es un agente que se ejecuta en segundo plano en la computadora administrada; en su lugar, es una herramienta que se conecta al servidor solo cuando se solicita.</p>
                        <p>
                            <a id="assisturl" rel="noreferrer noopener" target="_blank">Descargar Asistente para Windows</a>
                        </p>
                    </div>
                    <br style="clear:both">
                </div>
    ...
    <script>
        ...
        function startup() {
            ...
            if (groupName != '') {
                QH('groupname', format("Instalación Remota de Agente para {0}", escapeHtml(groupName)));
                document.title = format("{0} - Instalación del Agente", groupName);
            } else {
                document.title = "Instalación del Agente";
            }
        ...
        function linuxBinarySetup() {
            var x = '<h3>' + "Instalador Binario para Linux / BSD / macOS" + '</h3>', moreoptions = '';
            var opts = '<select id=aginsSelect onchange=addAgentToMeshClick() style=width:236px>';
            opts += '<option value=5 selected>' + "Instalador Binario para Linux / BSD / macOS" + '</option>';
            opts += '</select>';
            ...
            x += addHtmlValue("Tipo de Instalación", '<select id=aginsType onchange=addAgentToMeshClick() style=width:236px><option value=0>' + "Segundo plano & interactivo" + '</option><option value=2>' + "Segundo plano solamente" + '</option><option value=1>' + "Sólo Interactivo" + '</option></select>');
            x += '</div><hr>';
            ...
            x += addHtmlValue("Agente Mesh", '<a id=aginsbinlnk name="meshagents?id=' + meshid + '&installflags=0' + (urlargs.key?('&key=' + urlargs.key):'') + '">' + "meshagent" + '</a> <img src=images/link4.png height=10 width=10 title="' + "Copiar la URL del agente en el portapapeles" + '" style=cursor:pointer onclick=copyAgentUrl("meshagents?id=' + meshid + '&installflags=",1)>');
            x += addHtmlValue("Comando", '<input id=aginsbincmd type=text style="width:216px" readonly value=\'wget -O meshagent ' + ((serverNoProxy != 0) ?'--no-proxy':'') + ' --no-check-certificate \"https://' + servername + portStr + domainUrl + 'meshagents?id=' + meshid.split('$').join('%24').split('@').join('%40') + '\' /> <img src=images/link4.png height=10 width=10 title="' + "Copiar la URL del agente en el portapapeles" + '" style=cursor:pointer onclick=copyAgentIdValue("aginsbincmd")>');
            x += '</div>';
            QH('linuxbinarytab', x);
            addAgentToMeshClick();
        }
