<!DOCTYPE html><html dir="ltr" xmlns="http://www.w3.org/1999/xhtml"><head lang="en">
    ...
    <div id="termShellContextMenu" class="contextMenu noselect" style="display:none;min-width:0px">
        <div id="cxtermnorm" class="cmtext" onclick="cmtermaction(1,event)"><b>Консоль від імені адміністратора</b></div>
        <div id="cxtermps" class="cmtext" onclick="cmtermaction(6,event)">PowerShell від імені адміністратора</div>
        <div id="cxtermunorm" class="cmtext" onclick="cmtermaction(8,event)">Консоль користувача</div>
        <div id="cxtermups" class="cmtext" onclick="cmtermaction(9,event)">PowerShell користувача</div>
    </div>
    <div id="termShellContextMenuLinux" class="contextMenu noselect" style="display:none;min-width:0px">
        <div id="cxtermnorm" class="cmtext" onclick="cmtermaction(1,event)"><b>Root Консоль</b></div>
        <div id="cxtermps" class="cmtext" onclick="cmtermaction(8,event)">Консоль користувача</div>
        <div id="cxtermps" class="cmtext" onclick="cmtermaction(100,event)">Оболонка входу</div>
    </div>
