<!DOCTYPE html><html dir="ltr" xmlns="http://www.w3.org/1999/xhtml"><head lang="en">
    ...
    <div id="termShellContextMenu" class="contextMenu noselect" style="display:none;min-width:0px">
        <div id="cxtermnorm" class="cmtext" onclick="cmtermaction(1,event)"><b>Powłoka Admina</b></div>
        <div id="cxtermps" class="cmtext" onclick="cmtermaction(6,event)">PowerShell jako Admin</div>
        <div id="cxtermunorm" class="cmtext" onclick="cmtermaction(8,event)">Powłoka Użytkownika</div>
        <div id="cxtermups" class="cmtext" onclick="cmtermaction(9,event)">Użyj PowerShell</div>
    </div>
    <div id="termShellContextMenuLinux" class="contextMenu noselect" style="display:none;min-width:0px">
        ...
        <div id="cxtermps" class="cmtext" onclick="cmtermaction(8,event)">Powłoka Użytkownika</div>
        <div id="cxtermps" class="cmtext" onclick="cmtermaction(100,event)">Logowanie Powłoki</div>
    </div>
