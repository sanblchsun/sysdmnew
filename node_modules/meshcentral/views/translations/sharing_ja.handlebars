<!DOCTYPE html><html lang="ja" dir="ltr" xmlns="http://www.w3.org/1999/xhtml"><head>
    ...
    <div id="LeftSideToolBar" style="display:none;position:absolute;left:0;bottom:0;width:52px;top:0;background:#113962;background:linear-gradient(to bottom, #104893 0%,#113962 100%);color:white;border-right: 5px solid #BBB;">
        <div id="LeftMenuDesktop" class="slbbutton slbbuttonsel2" title="デスクトップ" onclick="go(11)">
            <div class="slb1" style="position:absolute;top:6px;left:6px"></div>
        </div>
        <div id="LeftMenuTerminal" class="slbbutton" title="ターミナル" onclick="go(12)">
            <div class="slb2" style="position:absolute;top:6px;left:6px"></div>
        </div>
        <div id="LeftMenuFiles" class="slbbutton" title="ファイル" onclick="go(13)">
        ...
        <div id="deskarea0">
            <div id="deskarea1" class="areaHead" style="line-height:24px">
                ...
                <div>
                    ...
                    <span id="connectbutton1span"><input type="button" id="connectbutton1" cmenu="deskConnectButton" value="接続" onclick="connectDesktop(event,3)" onkeypress="return false" onkeydown="return false" disabled="disabled"></span>
                    ...
                    <span id="disconnectbutton1span">&nbsp;<input type="button" id="disconnectbutton1" value="切断" onclick="connectDesktop(event,0)" onkeypress="return false" onkeydown="return false"></span>
                    &nbsp;<span id="deskstatus">切断されました</span><span id="deskmetadata"></span>
                </div>
            </div>
            ...
            <div id="deskarea4" class="areaFoot" style="min-height:24px">
                <div class="toright2">
                    <span id="DeskLatency" style="line-height:22px;width:50px" title="デスクトップセッションの遅延"></span>
                    <span id="DeskTimer" style="line-height:22px" title="セッション時間"></span>&nbsp;
                    ...
                    <span id="DeskSaveImageButton" title="リモートデスクトップのスクリーンショットを保存する"><img src="images/icon-camera.png" onclick="deskSaveImage()" height="16" width="16" style="padding-top:2px"></span>
                </div>
    ...
    <div id="p12" class="noselect" style="overflow:hidden;position:absolute;left:54px;top:0;right:0;bottom:0;display:none;background-color:black">
        ...
        <div class="areaHead" style="position:absolute;top:0;left:0;right:0;height:24px">
            ...
            <div>
                <span id="connectbutton2span"><input type="button" id="connectbutton2" cmenu="termConnectButton" value="接続" onclick="connectTerminal(event,1)" onkeypress="return false" onkeydown="return false" disabled="disabled"></span>
                <span id="disconnectbutton2span">&nbsp;<input type="button" id="disconnectbutton2" value="切断" onclick="connectTerminal(event,0)" onkeypress="return false" onkeydown="return false"></span>
        ...
        <div class="areaFoot" style="position:absolute;bottom:0;left:0;right:0;height:24px">
            <div class="toright2">
                <span id="TermLatency" title="ターミナルセッションの待ち時間"></span>
                ...
                <span id="terminalSettingsButtons" style="display:none">
                    ...
                    <input id="id_tfxkeysbutton" type="button" onkeypress="return false" onkeydown="return false" class="bottombutton" value="Intel（F10 = ESC+[OM）" title="F1からF10キーのエミュレーションタイプを切り替えます" onclick="termToggleFx()">
            ...
            <div>
                ...
                <input type="button" onkeypress="return false" onkeydown="return false" class="bottombutton" id="bsbutton" value="バックスペース" onclick="termSendKey(8,'bsbutton')" style="display:none">
                <input type="button" onkeypress="return false" onkeydown="return false" class="bottombutton" id="pastebutton" value="ペースト" title="端末にテキストを貼り付けます" onclick="showTermPasteDialog()" style="display:none">
            </div>
        </div>
    ...
    <div id="p13" class="noselect" style="overflow:hidden;position:absolute;left:54px;top:0;right:0;bottom:0;display:none;background-color:white">
        <div id="p13toolbar" style="position:absolute;left:0;top:0;right:0;bottom:28px">
            <div class="areaHead">
                ...
                <div>
                    <input id="p13Connect" value="接続" onclick="connectFiles(event)" type="button">
            ...
            <div id="fileArea2" class="areaHead2" valign="bottom">
                ...
                <div>
                    ...
                    <input type="button" id="p13DeleteFileButton" disabled="disabled" value="削除" onclick="p13deletefile()">&nbsp;
                    ...
                    <input type="button" id="p13ZipButton" disabled="disabled" value="郵便番号" onclick="p13zipFiles()">&nbsp;
                    <input type="button" id="p13RefreshButton" disabled="disabled" value="リフレッシュ" onclick="p13folderup(9999)">&nbsp;
                    <input type="button" id="p13FindButton" disabled="disabled" value="検索" onclick="p13findfile()">&nbsp;
                </div>
            </div>
    ...
    <div id="dialog" class="noselect" style="display:none">
        ...
        <div id="dialogBody">
            ...
            <div id="dialog4" style="">
                <input id="d4WrapButton" type="button" value="ラップオン" onclick="d4ToggleWrap()">
                <input id="d4SizeButton" type="button" value="小さい" onclick="d4ToggleSize()">
                <input id="d4EncodingButton" type="button" value="生" onclick="d4ToggleEncoding()">
                ...
                <div id="d7meshkvm">
                    ...
                    <div id="d7desktopOtherSettings">
                        ...
                        <div id="d7otherset2" style="display:block">
                            <label style="display:block"><input type="checkbox" id="d7deskSwapMouse">マウスボタンを反転する</label>
                            <label style="display:block"><input type="checkbox" id="d7deskRemoteKeyMap">リモートキーボードマップを使用する</label>
                        </div>
                    </div>
                </div>
                <div id="d7amtkvm">
    ...
    <script>
        ...
        function updateMetadata(conn, elementid) {
            ...
            if (conn && (conn.State == 3)) {
                ...
                if (viewerCount > 1) { str = '<span onclick=showSessionMetadata(1) style=cursor:pointer>' + format("、{0}視聴", viewerCount) + '</span>'; }
            }
            QH('deskmetadata', str);
            ...
            if (conn && conn.metadata) {
                ...
                if (conn.metadata.users) {
                    for (var i in conn.metadata.users) {
                        var val = (conn.metadata.users[i] == 1) ? "1接続" : format("{0}接続", conn.metadata.users[i]);
                        var username = i.split('/')[2];
                        if ((users != null) && (users[i] != null)) { username = users[i].name; }
                        x += addHtmlValue4(format("ユーザー「{0}」", username), val);
                    }
                }
                setDialogMode(2, "セッション情報", 1, null, x, 'sessionMetadata' + cid);
            }
        }
        ...
        */
        ...
        function deskSaveImage() {
            if (xxdialogMode || desktop == null || desktop.State != 3) return;
            var d = new Date(), n = "デスクトップ" + '-' + d.getFullYear() + '-' + ('0' + (d.getMonth() + 1)).slice(-2) + '-' + ('0' + d.getDate()).slice(-2) + '-' + ('0' + d.getHours()).slice(-2) + '-' + ('0' + d.getMinutes()).slice(-2);
        ...
        function onFilesStateChange(xfiles, state) {
            p13Connect.value = (state == 0) ? "接続" : "切断";
        ...
        function p13gotFiles(data) {
            ...
            if (data.action == 'findfile') {
                if (xxdialogTag == data.reqid) {
                    if (data.r == null) {
                        ...
                        xxdialogTag = null;
                        if (Q('d2findResults').innerHTML == '') { QH('d2findResults', '<div style=text-align:center;margin:10px><i>' + "ファイルが見つかりません" + '</i></div>'); }
                    } else {
            ...
            if (data.action == 'dialogmessage') {
                if ((data.msg == null) && (xxdialogTag == 'fileMsgDialog')) {
                    ...
                    setDialogMode(2, "ファイル操作", 10, p13fileOperationDialogEx, '<div style=margin:10px>' + "ファイルを圧縮しています..." + '<div>', 'fileMsgDialog');
                } else if ((data.msg == 'zippingFile') && ((!xxdialogMode) || (xxdialogTag == 'fileMsgDialog'))) {
                    // Show the dialog box message
                    setDialogMode(2, "ファイル操作", 10, p13fileOperationDialogEx, '<div style=margin:10px>' + EscapeHtml(data.file) + '<div><br /><progress value=' + EscapeHtml(data.progress) + ' style=width:100% max=100 />', 'fileMsgDialog');
                }
                return;
            }
        ...
        function p13findfile() {
            if (xxdialogMode) return;
            var x = addHtmlValue("フィルタ", '<input id=d2findFilter style="width:230px" onkeyup=p13findfileValidate() onkeydown=p13findfileDown(event) placeholder="*.txt"></input>');
            ...
            x += '<div style=margin-top:8px><input id=filefind_dlgCancelButton type=button value=' + "閉じる" + ' style=float:right;width:80px;margin-left:5px onclick=p13findfileCancel()>';
            x += '<input id=filefind_dlgOkButton type=submit value=' + "サーチ" + ' style=float:right;width:80px onclick=p13findfileEx()><br /><br /></div>';
            setDialogMode(2, "ファイルの検索", 0, null, x);
            p13findfileValidate();
            Q('d2findFilter').focus();
        }

        function p13findfileDown(e) { if (e.code == "入る") { p13findfileEx(); } }
        ...
        function p13zipFiles() {
            ...
            setDialogMode(2, "Zipファイル名", 3, p13zipFilesEx, '<input type=text id=p13renameinput maxlength=64 onkeyup=p13fileNameCheck(event) style=width:100% value="" />', { action: 'zip', path: p13filetreelocation.join('/'), files: inputFiles });
        ...
        function p13pasteFile() {
            ...
            if ((p13clipboard != null) && (p13clipboard.length > 0)) {
                if (p13clipboardCut == 0) {
                    if (p13clipboard.length > 1) { x = format("この場所に{0}エントリをコピーして宜しいですか？", p13clipboard.length); } else { x = format("この場所へ1つのエントリをコピーして宜しいですか？"); }
                } else {
                    if (p13clipboard.length > 1) { x = format("{0}エントリをこの場所へ移動して宜しいですか？", p13clipboard.length); } else { x = format("1エントリをこの場所へ移動して宜しいですか？"); }
                }
            }
        ...
        function p13downloadfile(x, y, z, tag) {
            ...
            setDialogMode(2, "ダウンロードファイル", 10, p13downloadFileCancel, '<div>' + gdownloadFile.file + '</div><br /><progress id=d2progressBar style=width:100% value=0 max=' + z + ' />');
        }
        ...
        function d4ToggleWrap(update) {
            ...
            Q('d4WrapButton').value = ["ラップ：オン", "ラップ：オフ"][d4EditWrapVal];
        ...
        function d4ToggleSize(update) {
            ...
            Q('d4SizeButton').value = ["サイズ：100％", "サイズ：125％", "サイズ：150％", "サイズ：200％"][d4EditSizeVal];
        ...
        function d4ToggleEncoding(update) {
            ...
            Q('d4EncodingButton').value = ["エンコーディング：RAW","エンコーディング：UTF8"][d4EditEncodingVal];
        ...
        function printFlexDateTime(d) { if (printDate(new Date()) == printDate(d)) { return format("{0}に期限切れ", printTime(d)); } else { return format("期限切れ{0}", printDateTime(d)); } }
        function getFileSizeStr(size) { if (typeof size != 'number') { size = 0; } if (size == 1) return "1バイト"; return format("{0}バイト", size); }
