<!DOCTYPE html><html dir="ltr" xmlns="http://www.w3.org/1999/xhtml"><head lang="en">
                            ...
                            <div id="loginpanel" style="background-color:#979797;border-radius:16px;width:260px;padding:16px;text-align:center;clear:both;display:none">
                                <form method="post">
                                    ...
                                    <table>
                                        ...
                                        <tr>
                                            <td><div id="showPassHintLink" style="display:none"><a onclick="showPassHint()" style="cursor:pointer">संकेत दिखाएं</a></div></td>
                                    ...
                                    <div id="resetAccountDiv" style="display:none;padding:2px">
                                        <span id="resetAccountSpan">उपयोगकर्ता / पासवर्ड भूल गए?</span> <a onclick="xgo(3)" style="cursor:pointer">खाता रीसेट करें</a>.
                                    </div>
                                    <div id="newAccountDiv" style="display:none;padding:2px">
                                        खाता नहीं है? <a onclick="xgo(2)" style="cursor:pointer">एक बनाए</a>.
                                    </div>
                                    ...
                                    <div id="authStrategies" style="display:none">
                                        ...
                                        <a id="auth-twitter" href="auth-twitter" style="display:none"><img src="images/login/twitter32.png" width="32" height="32" style="margin-left:3px;margin-right:3px;border-radius:3px;box-shadow:2px 2px 5px black;cursor:pointer" title="ट्विटर का उपयोग कर साइन-इन करें"></a>
                                        <a id="auth-google" href="auth-google" style="display:none"><img src="images/login/google32.png" width="32" height="32" style="margin-left:3px;margin-right:3px;border-radius:3px;box-shadow:2px 2px 5px black;cursor:pointer" title="Google का उपयोग कर साइन-इन करें"></a>
                                        <a id="auth-github" href="auth-github" style="display:none"><img src="images/login/github32.png" width="32" height="32" style="margin-left:3px;margin-right:3px;border-radius:3px;box-shadow:2px 2px 5px black;cursor:pointer" title="GitHub का उपयोग कर साइन-इन करें"></a>
                                        <a id="auth-azure" href="auth-azure" style="display:none"><img src="images/login/azure32.png" width="32" height="32" style="margin-left:3px;margin-right:3px;border-radius:3px;box-shadow:2px 2px 5px black;cursor:pointer" title="साइन-इन एज़्योर का उपयोग करना"></a>
                                        ...
                                        <a id="auth-jumpcloud" href="auth-jumpcloud" style="display:none"><img src="images/login/jumpcloud32.png" width="32" height="32" style="margin-left:3px;margin-right:3px;border-radius:3px;box-shadow:2px 2px 5px black;cursor:pointer" title="जंपक्लाउड का उपयोग कर साइन-इन करें"></a>
                                        <a id="auth-intel" href="auth-intel" style="display:none"><img src="images/login/intel32.png" width="32" height="32" style="margin-left:3px;margin-right:3px;border-radius:3px;box-shadow:2px 2px 5px black;cursor:pointer" title="इंटेल का उपयोग कर साइन-इन करें"></a>
                                        <a id="auth-saml" href="auth-saml" style="display:none"><img src="images/login/generic32.png" width="32" height="32" style="margin-left:3px;margin-right:3px;border-radius:3px;box-shadow:2px 2px 5px black;cursor:pointer" title="सिंगल साइन-इन"></a>
                                    </div>
                                </form>
                            </div>
                                    ...
                                    <form method="post">
                                        ...
                                        <table>
                                            <tbody><tr id="nuUserRow">
                                                <td align="right" width="100">उपयोगकर्ता नाम:</td>
                                            ...
                                            <tr id="createPanelHint" style="display:none">
                                                <td align="right">पास का संकेत:</td>
                                            ...
                                            <tr id="newAccountPass" title="खाता निर्माण टोकन दर्ज करें">
                                                <td align="right">निर्माण टोकन:</td>
                                        ...
                                        <hr><a onclick="xgo(1)" style="cursor:pointer">लॉगिन पर वापस जाएं</a>
                                        ...
                                        <tr>
                                            <td colspan="2">
                                                ...
                                                <div style="float:right">
                                                    <input style="display:none;float:right" id="securityKeyButton" type="button" value="सुरक्षा कुंजी का उपयोग करें" onclick="useSecurityKey()">
                                                    <input style="display:none;float:right" id="emailKeyButton" type="button" value="ईमेल" onclick="useEmailToken()">
                                                    <input style="display:none;float:right" id="smsKeyButton" type="button" value="एसएमएस" onclick="useSMSToken()">
                                                </div>
                                            </td>
                                        </tr>
                                    </tbody></table>
        ...
        <div id="footer" style="height:32px;width:100%;text-align:center;background-color:#113962;position:absolute;bottom:0px">
            <table cellpadding="0" cellspacing="6" style="width:100%">
                <tbody><tr>
                    ...
                    <td style="text-align:right">{{{rootCertLink}}}&nbsp;<a href="terms">शर्तें और गोपनीयता</a></td>
                </tr>
            </tbody></table>
        </div>
    </div>
    ...
    <script>
        ...
        var okmessages = ['', "यदि मान्य है, तो भेजे गए मेल को रीसेट करें।", "ईमेल भेजा।", "ईमेल सत्यापन की आवश्यकता है, अपने मेलबॉक्स की जांच करें और पुष्टि लिंक पर क्लिक करें।", "एसएमएस भेजा गया।"];
        ...
        function useEmailToken() {
            ...
            setDialogMode(1, "सुरक्षित लॉगइन", 3, useEmailKeyEx, "ईमेल पते पर टोकन भेजें?");
        }
        ...
        function useSMSToken() {
            ...
            setDialogMode(1, "सुरक्षित लॉगइन", 3, useSMSTokenEx, "विनियमित फोन नंबर पर टोकन भेजें?");
        }
        ...
        function showPassHint() {
            if (passRequirements.hint === true) { messagebox("पासवर्ड संकेत", passhint); }
        }
            ...
            if (Q('apassword1').value == '') {
                ...
                if (!passRequirementsEx) {
                    ...
                    if (passReq == false) {
                        ...
                        QH('passWarning', '<span style=color:red><b>' + "पासवर्ड नीति" + '</b><span>'); // TODO: Display problem hint
