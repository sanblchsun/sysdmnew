<!DOCTYPE html><html lang="cs" dir="ltr" xmlns="http://www.w3.org/1999/xhtml"><head>
                        ...
                        <div id="termTable" style="position:absolute;top:0;bottom:0;left:0;right:0">
                            <div id="termarea1">
                                <div class="areaHead" style="line-height:24px">
                                    ...
                                    <div>
                                        <span id="connectbutton2span" style="margin-left:3px"><input type="button" id="connectbutton2" cmenu="termConnectButton" value="Připojit" style="height:28px" onclick="connectTerminal(event,1)" onkeypress="return false" onkeydown="return false" disabled="disabled"></span>
    ...
    <div id="topMenu" style="z-index:1000;background-color:#EEE;box-shadow:0px 0px 15px #666;font-family:Arial,Helvetica,sans-serif;border-radius:0px 0px 5px 5px;position:fixed;top:50px;right:5px;width:170px;display:none">
        ...
        <div id="logoutMenuOption"><a href="/logout"><div style="padding:12px;border-top:1px solid gray;color:black;cursor:pointer">Odhlásit se</div></a></div>
    </div>
    ...
    <script>
        ...
        function setupDeviceMenu(op, obj) {
            ...
            var menus = [];
            if (features & 2) { menus.push({ n: "Plocha", f: 'setupDeviceMenu(1)', s: (currentDevicePanel == 1) }); }
            if (features & 1) { menus.push({ n: "Terminál", f: 'setupDeviceMenu(5)', s: (currentDevicePanel == 5) }); }
            if (features & 4) { menus.push({ n: "Soubory", f: 'setupDeviceMenu(2)', s: (currentDevicePanel == 2) }); }
        ...
        var keyStrings = { 8: "BackSpace", 9: "Tab", 13: "Zadání", 27: "Uniknout", 44 : "Tisk obrazovky", 45: "Vložit", 46: "Del", 36: "Domov", 35: "Konec", 33: "Page Up", 34: "Page Down", 37: "Vlevo, odjet", 38: "Nahoru", 39: "Že jo", 40: "Dolů", 0: "Nic" }
                ...
                if (data[0] == '{') {
                    ...
                    switch (j.action) {
                        case 'sshauth': {
                            ...
                            x += addHtmlValue("Soubor klíče", '<input type=file id=dp2key style=width:150px maxlength=64 autocomplete=off onchange=sshAuthUpdate(event) />');
                            ...
                            x += '</div>';
                            x += '<label><input id=dp2keep type=checkbox>' + "Pamatujte si přihlašovací údaje" + '</label>';
                            x += '<div id=d2keyauth2 style=font-size:x-small><br />' + "Soubor klíče musí být ve formátu OpenSSH." + '</div>';
                            setDialogMode(2, "Ověření", 11, sshConnectEx, x, 'ssh');
        ...
        function p13gotFiles(data) {
            ...
            switch (data.action) {
                case 'sshauth': {
                    ...
                    x += '<label><input id=dp2keep type=checkbox>' + "Pamatujte si přihlašovací údaje" + '</label>';
                    x += '<div id=d2keyauth2 style=font-size:x-small><br />' + "Soubor klíče musí být ve formátu OpenSSH." + '</div>';
                    setDialogMode(2, "Ověření", 11, p13sshConnectEx, x, 'ssh');
                    setTimeout(sshAuthUpdate, 50);
                    break;
                }
