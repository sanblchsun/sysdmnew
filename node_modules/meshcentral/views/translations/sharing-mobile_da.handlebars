<!DOCTYPE html><html lang="da" dir="ltr" xmlns="http://www.w3.org/1999/xhtml"><head>
                        ...
                        <div id="termTable" style="position:absolute;top:0;bottom:0;left:0;right:0">
                            <div id="termarea1">
                                <div class="areaHead" style="line-height:24px">
                                    ...
                                    <div>
                                        <span id="connectbutton2span" style="margin-left:3px"><input type="button" id="connectbutton2" cmenu="termConnectButton" value="Forbind" style="height:28px" onclick="connectTerminal(event,1)" onkeypress="return false" onkeydown="return false" disabled="disabled"></span>
                            ...
                            <tbody><tr>
                                <td style="background-color:#C0C0C0;border-bottom:2px solid black;padding:2px;line-height:24px">
                                    ...
                                    <div style="margin-left:2px">
                                        ...
                                        <input id="p13Connect" value="Forbind" onclick="connectFiles(event)" onkeypress="return false" onkeydown="return false" type="button">
    ...
    <script>
        ...
        function setupDeviceMenu(op, obj) {
            ...
            var menus = [];
            if (features & 2) { menus.push({ n: "Skrivebord", f: 'setupDeviceMenu(1)', s: (currentDevicePanel == 1) }); }
        ...
        var keyStrings = { 8: "BackSpace", 9: "Tab", 13: "Enter", 27: "Escape", 44 : "Print Screen", 45: "Indsæt", 46: "Del", 36: "Hjem", 35: "Slut", 33: "Page Up", 34: "Page Down", 37: "Venstre", 38: "Op", 39: "Ret", 40: "Ned", 0: "Ingen" }
                ...
                if (data[0] == '{') {
                    ...
                    switch (j.action) {
                        case 'sshauth': {
                            ...
                            x += addHtmlValue("Nøglefil", '<input type=file id=dp2key style=width:150px maxlength=64 autocomplete=off onchange=sshAuthUpdate(event) />');
                            ...
                            x += '</div>';
                            x += '<label><input id=dp2keep type=checkbox>' + "Husk legitimationsoplysninger" + '</label>';
                            x += '<div id=d2keyauth2 style=font-size:x-small><br />' + "Nøglefilen skal være i OpenSSH format." + '</div>';
                            setDialogMode(2, "Godkendelse", 11, sshConnectEx, x, 'ssh');
        ...
        function p13gotFiles(data) {
            ...
            switch (data.action) {
                case 'sshauth': {
                    ...
                    x += '<label><input id=dp2keep type=checkbox>' + "Husk legitimationsoplysninger" + '</label>';
                    x += '<div id=d2keyauth2 style=font-size:x-small><br />' + "Nøglefilen skal være i OpenSSH format." + '</div>';
                    setDialogMode(2, "Godkendelse", 11, p13sshConnectEx, x, 'ssh');
                    setTimeout(sshAuthUpdate, 50);
                    break;
                }
        ...
        function p13downloadfile(x, y, z) {
            ...
            setDialogMode(2, "Download Fil", 10, p13downloadFileCancel, '<div>' + downloadFile.file + '</div><br /><progress id=d2progressBar style=width:100% value=0 max=' + z + ' />');
        }
