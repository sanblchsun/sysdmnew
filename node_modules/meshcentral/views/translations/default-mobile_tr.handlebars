<!DOCTYPE html><html lang="tr" dir="ltr" xmlns="http://www.w3.org/1999/xhtml"><head>
    ...
    <div id="container">
        ...
        <div id="masthead" style="background:url(logo.png) 0px 0px;background-size:341px 50px;background-color:#036;background-repeat:no-repeat;height:50px;width:100%;overflow:hidden">
            ...
            <div id="notificationCount" onclick="clickNotificationIcon()" class="unselectable" style="position:absolute;right:50px;top:0px;font-size:28px;width:50px;height:50px;cursor:pointer;display:none" title="Mevcut bildirimleri görüntülemek için tıklayın"><div id="notificationCount2" style="padding-top:8px">0</div></div>
                ...
                <div id="p2" style="display:none;position:absolute;top:0;left:0;right:0;bottom:0">
                    ...
                    <div id="xdevicesBar" style="position:absolute;overflow-y:auto;height:34px;left:0;right:0;bottom:0px;background-color:#aaa;color:black">
                        <div style="margin:4px">
                            ...
                            <input id="SearchInput" autocomplete="off" type="search" placeholder="Filtrele" onchange="onDeviceSearchChanged(event)" onclick="onDeviceSearchChanged(event)" onkeyup="onDeviceSearchChanged(event)" style="padding:2px;margin:0;height:20px;background-color:#FFF">&nbsp;
                            <label class="noselect"><input type="checkbox" id="RealNameCheckBox" onclick="onRealNameCheckBox()">İşletim Sistemi Adı</label>
                            <label class="noselect"><input type="checkbox" id="OnlineCheckBox" onclick="onOnlineCheckBox(event)">Çevrimiçi</label>
                        </div>
                    </div>
                </div>
                            ...
                            <div id="p3AccountActions">
                                <div id="p2AccountSecurity" style="display:none">
                                    ...
                                    <div style="margin-left:9px;margin-bottom:8px">
                                        ...
                                        <div style="margin-top:5px"><a href="#" onclick="account_showLocalizationSettings()">Yerelleştirme Ayarları</a></div>
                                ...
                                <div id="p2AccountActions" style="display:none">
                                    ...
                                    <div style="margin-left:9px;margin-bottom:8px">
                                        <div style="margin-top:5px"><span id="viewPreviousLogins"><a onclick="return account_viewPreviousLogins()" style="cursor:pointer">Önceki oturumları görüntüle</a></span></div>
                                        ...
                                        <div style="margin-top:5px" id="setDarkModeLink"><a onclick="toggleNightMode()" style="cursor:pointer">Karanlık modu ayarla</a></div>
                                        <div style="margin-top:5px"><a onclick="showNotes(false)" style="cursor:pointer">Kişisel notlar</a></div>
                                    </div>
                                <br style="clear:both">
                                </div>
                            </div>
                ...
                <div id="p5" style="display:none">
                    <table cellspacing="0" style="margin:0;padding:0;border-spacing:0;border:0;">
                        <tbody><tr style="padding:0">
                            ...
                            <td>
                                <div style="margin-left:5px">
                                    <strong style="font-size:large">Dosyalarım</strong><br>
                                </div>
                            </td>
                        </tr>
                    </tbody></table>
                            ...
                            <tbody><tr>
                                <td style="width:100%;background-color:#d3d9d6;text-align:left;padding:4px" valign="bottom">
                                    <div style="width:100%;text-align:center">
                                        <input type="button" style="width:calc(100%/5 - 5px)" id="p5FolderUp" disabled="disabled" onclick="p5folderup()" value="Yukarı">
                                        ...
                                        <input type="button" style="width:calc(100%/5 - 5px)" id="p5RenameFileButton" disabled="disabled" value="Yeniden adlandır" onclick="p5renamefile()" onkeypress="return false" onkeydown="return false">
                                    ...
                                    <div style="width:100%;text-align:center">
                                        <input type="button" style="width:calc(100%/5 - 5px)" id="p5UploadButton" disabled="disabled" value="Gönder" onclick="p5uploadFile()" onkeypress="return false" onkeydown="return false">
                                        <input type="button" style="width:calc(100%/5 - 5px)" id="p5CutButton" disabled="disabled" value="Kes" onclick="p5copyFile(1)" onkeypress="return false" onkeydown="return false">
                                        ...
                                        <input type="button" style="width:calc(100%/5 - 5px)" id="p5PasteButton" disabled="disabled" value="Yapıştır" onclick="p5pasteFile()" onkeypress="return false" onkeydown="return false">
                                        ...
                                        <tbody><tr>
                                            ...
                                            <td style="text-align:right;padding-right:4px">
                                                <select id="p5sortdropdown" onchange="updateFiles()">
                                                    ...
                                                    <option value="4">Ada göre ters</option>
                                                    <option value="5">Boyuta göre ters</option>
                                                    <option value="6">Tarihe göre ters</option>
                                                </select>
                                            </td>
                                        </tr>
                                    </tbody></table>
                ...
                <div id="p10" style="display:none;position:absolute;bottom:0;top:0;width:100%;overflow:hidden">
                    ...
                    <div id="p10dialog" style="z-index:1000;background-color:#EEE;box-shadow:0px 0px 15px #666;font-family:Arial,Helvetica,sans-serif;border-radius:5px;position:fixed;top:30px;width:300px;left:30px;display:none">
                        <div style="width:100%;background-color:#003366;color:#FFF;border-radius:5px 5px 0 0">
                            <div style="padding:5px">Klavye Kısayollarını Özelleştirme</div>
                        ...
                        <div style="padding:10px;margin-bottom:20px"><input type="button" value="Tamam" style="float:right;width:80px" onclick="deskCustomizeKeysEx()"></div>
                    </div>
                    ...
                    <div id="p10desktop" style="overflow:hidden;position:absolute;top:55px;bottom:0px;width:100%;display:none">
                        <div id="deskarea1" style="position:absolute;top:0px;width:100%;height:32px">
                            <div style="padding-top:2px;padding-bottom:2px;background:#C0C0C0;height:32px">
                                <div style="float:right;text-align:right">
                                    ...
                                    <input type="button" id="deskFullScreen" value="Tam ekran" onclick="deskToggleFull(event)" onkeypress="return false" onkeydown="return false" disabled="disabled" style="height:28px;margin-right:3px;">
                                </div>
                                <div style="margin-left:3px">
                                    <input type="button" id="connectbutton1" value="Bağlan" onclick="connectDesktop(event,3)" onkeypress="return false" onkeydown="return false" disabled="disabled" style="height:28px">
                                    ...
                                    <input type="button" id="disconnectbutton1" value="Bağlantıyı kes" onclick="connectDesktop(event,0)" onkeypress="return false" onkeydown="return false" style="height:28px">
                                    <span id="deskstatus" style="color:black">Bağlantı kesildi</span>
                                </div>
                            </div>
                        </div>
                        ...
                        <div id="deskarea4" style="position:absolute;bottom:0px;width:100%;height:32px">
                            <div style="padding-top:2px;padding-bottom:2px;background:#C0C0C0">
                                ...
                                <div>
                                    <input id="deskActionsBtn" type="button" style="margin-left:3px;height:28px" onkeypress="return false" onkeydown="return false" value="İşlemler" onclick="deviceActionFunction()">
                                    <input type="button" value="Ayarlar" onkeypress="return false" onkeydown="return false" onclick="showDesktopSettings()" style="height:28px">
                                    <input type="button" onkeypress="return false" onkeydown="return false" value="Açma/Kapatma İşlemleri ..." onclick="showPowerActionDlg()" style="display:none;height:28px">
                                    ...
                                    <input type="button" id="DeskScreens" value="Ekranlar" onkeypress="return false" onkeydown="return false" onclick="deskSelectScreens()" style="display:none;height:28px">
                        ...
                        <div id="termTable" style="position:absolute;top:0;bottom:0;left:0;right:0">
                            <div id="termarea1">
                                <div class="areaHead" style="line-height:24px">
                                    <div class="toright2">
                                        <input type="button" id="termFullScreen" value="Tam ekran" onclick="deskToggleFull(event)" onkeypress="return false" onkeydown="return false" disabled="disabled" style="height:28px;margin-right:3px;">
                                        <div id="terminalCustomUpperRight" style="float:left;margin-right:6px"></div>
                                    </div>
                                    <div>
                                        <span id="connectbutton2span" style="margin-left:3px"><input type="button" id="connectbutton2" value="Bağlan" style="height:28px" onclick="connectTerminal(event,1)" onkeypress="return false" onkeydown="return false" disabled="disabled"></span>
                                        <span id="connectbutton2sspan" style="margin-right:4px"><input type="button" id="connectbutton2s" value="SSH Bağlantısı" style="height:28px" onclick="connectTerminal(event,3)" onkeypress="return false" onkeydown="return false" disabled="disabled"></span>
                                        <span id="disconnectbutton2span" style="margin-left:3px"><input type="button" id="disconnectbutton2" value="Bağlantıyı kes" style="height:28px" onclick="connectTerminal(event,0)" onkeypress="return false" onkeydown="return false"></span>
                                        <span id="termstatus" style="line-height:22px">Bağlantı kesildi</span><span id="termtitle"></span>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div id="termarea4" style="position:relative;height:32px;">
                                <div class="areaFoot">
                                    ...
                                    <div style="height:28px">
                                        <input id="termActionsBtn" style="margin-left:3px;height:28px" type="button" title="Cihazda güç işlemleri gerçekleştirin" onkeypress="return false" onkeydown="return false" value="İşlemler" onclick="deviceActionFunction()">
                        ...
                        <table id="p13toolbar" style="width:100%;height:111px" cellpadding="0" cellspacing="0">
                            <tbody><tr>
                                <td style="background-color:#C0C0C0;border-bottom:2px solid black;padding:2px;line-height:24px">
                                    <div style="float:right;text-align:right">
                                        <input id="filesActionsBtn" type="button" onkeypress="return false" onkeydown="return false" value="İşlemler" onclick="deviceActionFunction()" style="margin-right:2px">
                                    ...
                                    <div style="margin-left:2px">
                                        ...
                                        <input id="p13Connect" value="Bağlan" onclick="connectFiles(event,1)" onkeypress="return false" onkeydown="return false" type="button">
                                        <input id="p13Connects" value="SFTP Bağlantısı" onclick="connectFiles(event,2)" onkeypress="return false" onkeydown="return false" type="button">
                                        <input id="p13Disconnect" value="Bağlantıyı kes" onclick="connectFiles(event)" onkeypress="return false" onkeydown="return false" type="button">
                                        <span class="textOverGray" id="p13Status">Bağlantı kesildi</span>
                                    </div>
                                </td>
                            </tr>
                            <tr>
                                <td style="width:100%;background-color:#d3d9d6;text-align:left;padding:4px" valign="bottom">
                                    <div style="width:100%;text-align:center">
                                        <input type="button" style="width:calc(100%/5 - 5px)" id="p13FolderUp" disabled="disabled" onclick="p13folderup()" value="Yukarı">
                                        ...
                                        <input type="button" style="width:calc(100%/5 - 5px)" id="p13RenameFileButton" disabled="disabled" value="Yeniden adlandır" onclick="p13renamefile()" onkeypress="return false" onkeydown="return false">
                                    ...
                                    <div style="width:100%;text-align:center">
                                        <input type="button" style="width:calc(100%/5 - 5px)" id="p13UploadButton" disabled="disabled" value="Gönder" onclick="p13uploadFile()" onkeypress="return false" onkeydown="return false">
                                        <input type="button" style="width:calc(100%/5 - 5px)" id="p13CutButton" disabled="disabled" value="Kes" onclick="p13copyFile(1)" onkeypress="return false" onkeydown="return false">
                                        ...
                                        <input type="button" style="width:calc(100%/5 - 5px)" id="p13PasteButton" disabled="disabled" value="Yapıştır" onclick="p13pasteFile()" onkeypress="return false" onkeydown="return false">
                            ...
                            <tbody><tr style="height:28px">
                                <td class="areaHead">
                                    <div class="toright2">
                                        ...
                                        <input type="button" id="p15uploadCore" value="Agent İşlemleri" onclick="p15uploadCore(event)">
                                    </div>
                                        ...
                                        <tbody><tr>
                                            ...
                                            <td id="p15outputselecttd">
                                                <select id="p15outputselect" onchange="setupConsole()">
                                                    ...
                                                    <option id="p15outputselect3" value="3">İtmek</option>
                                                    <option id="p15outputselect2" value="2">MQTT</option>
                                                </select>
                                            </td>
                                            <td style="width:1%"><input id="id_p15consoleClear" type="button" class="bottombutton" value="Açık" onclick="p15consoleClear()"></td>
                                        </tr>
                                    </tbody></table>
                                </td>
                            </tr>
    ...
    <div id="dialog" style="display:none">
        ...
        <div style="margin-right:16px;margin-left:8px">
            ...
            <div id="dialog3" style="margin:auto;margin:3px">
                <select id="deskkeys" style="width:100%">
                    ...
                    <option value="1">Win + Yukarı</option>
            ...
            <div id="dialog4" style="margin:auto;margin:3px">
                <div id="d3upload">
                    <div>Dosya Seçimi</div>
                    <select id="d3uploadMode" onchange="d3modechange()">
                        <option value="1">Yerel dosya gönderme</option>
                        <option value="2">Sunucu dosyası seçimi</option>
                    </select>
                </div>
                <div id="d3localmode" style="display:none">
                    <div>Dosya gönder</div>
                ...
                <div id="d3servermode">
                    <div id="d3serveraction" valign="bottom">
                        <input type="button" id="p3FolderUp" disabled="disabled" onclick="d3folderup()" value="Yukarı">&nbsp;<span id="p3CurrentFolder"></span>
                    </div>
            ...
            <div id="dialog7" style="margin:auto;margin:3px">
                <div id="d7meshkvm">
                    <h4 style="width:100%;border-bottom:1px solid gray">Agent Uzak Masaüstü</h4>
                    <table style="width:100%">
                        <tbody><tr>
                            <td>
                                Kalite
                        ...
                        <tr>
                            <td></td>
                            <td>
                                <label style="display:block" id="d7deskAutoLockLabel"><input type="checkbox" id="d7deskAutoLock">Bağlantıyı Keste Kilitle</label>
                            </td>
                        </tr>
                    </tbody></table>
                </div>
        ...
        <div id="idx_dlgButtonBar" style="padding:10px;margin-bottom:20px">
            <input id="idx_dlgCancelButton" type="button" value="İptal" style="float:right;width:80px;margin-left:5px" onclick="dialogclose(0)">
            <input id="idx_dlgOkButton" type="button" value="Tamam" style="float:right;width:80px" onclick="dialogclose(1)">
            <div><input id="idx_dlgDeleteButton" type="button" value="Sil" style="display:none" onclick="dialogclose(2)"></div>
        </div>
    </div>
    <div id="topMenu" style="z-index:1000;background-color:#EEE;box-shadow:0px 0px 15px #666;font-family:Arial,Helvetica,sans-serif;border-radius:0px 0px 5px 5px;position:fixed;top:50px;right:5px;width:170px;display:none">
        <div style="padding:12px;border-top:1px solid gray;color:black;cursor:pointer" onclick="topMenu(2)">Dosyalarım</div>
        <div style="padding:12px;border-top:1px solid gray;color:black;cursor:pointer" onclick="topMenu(1)">Hesabım</div>
        <div id="logoutMenuOption"><a id="logoutMenuOptionRef" href="/logout"><div style="padding:12px;border-top:1px solid gray;color:black;cursor:pointer">Çıkış Yap</div></a></div>
    </div>
    ...
    <script>
        ...
        var agentsStr = ["Bilinmeyen", "Windows 32bit komut satırı", "Windows 64bit komut satırı", "Windows 32bit hizmeti", "Windows 64bit hizmeti", "Linux 32bit", "Linux 64bit", "MIPS", "XENx86", "Android", "Linux ARM", "macOS x86-32bit", "Android x86", "PogoPlug KOLU", "Android", "Linux Poky x86-32bit", "macOS x86-64bit", "ChromeOS", "Linux Poky x86-64bit", "Linux NoKVM x86-32bit", "Linux NoKVM x86-64bit", "Windows MinCore komut satırı", "Windows MinCore hizmeti", "NodeJS", "ARM-Linaro", "ARMv6l / ARMv7l", "ARMv8 64bit", "ARMv6l / ARMv7l / NoKVM", "MIPS24KC (OpenWRT)", "Apple Silicon", "FreeBSD x86-64", "Bilinmeyen", "Linux ARM 64 bit (glibc/2.24 NOKVM)", "Alpine Linux x86 64 Bit (MUSL)", "Asistan (Windows)", "Armada370 - ARM32/HF (libc/2.26)", "OpenWRT x86-64", "OpenBSD x86-64", "Bilinmeyen", "Bilinmeyen", "MIPSEL24KC (OpenWRT)", "ARMADA/CORTEX-A53/MUSL (OpenWRT)", "Windows ARM 64bit console", "Windows ARM 64bit service", "ARMVIRT32 (OpenWRT)", "RISC-V x86-64"];
        var files;
        var terminal;
            ...
            switch (message.action) {
                case 'serverinfo': {
                    ...
                    if (serverinfo.certExpire != null) {
                        ...
                        if ((days >= 0) && (days < 20)) {
                            addNotification({ text: format("Sertifikanın süresi {0} gün içinde dolacak", days) });
                        }
                    }
                ...
                case 'otpauth-request': {
                    if ((xxdialogMode == 2) && (xxdialogTag == 'otpauth-request')) {
                        if (message.err != null) {
                            var otpauthErrors = ['', "2FA kilitlendi", "Yedek kodlar kilitli", "Giriş belirteci kullanımda", "OTP 2FA'ya izin verilmiyor", "Hesap kilitlendi", "OTPLIB yüklenemiyor"];
                            if ((message.err > 0) && (message.err < otpauthErrors.length)) { QH('d2optinfo', otpauthErrors[message.err]); } else { QH('d2optinfo', format("Hata #{0}", message.err)); }
                        } else {
                            ...
                            QH('d2optinfo', format("Yüklemek" + ' <a href="https://play.google.com/store/apps/details?id=com.google.android.apps.authenticator2" rel="noreferrer noopener" target=_blank>' + "Google Authenticator'ı yükleyin " + '</a> ' + "veya uyumlu bir uygulama için <a href=\"{0}\" rel=\"noreferrer noopener\" target=_blank> bu bağlantıyı </a> kullanın veya aşağıdaki şifreyi girin. Ardından, 2 Adımlı oturum açma özelliğini etkinleştirmek için mevcut 6 basamaklı anahtarı girin.", message.url) + '<br /><br /><div style=width:100%;text-align:center><tt id=d2optsecret secret="' + message.secret + '" style=font-size:15px>' + secret + '</tt><br /><br />Token: <input type=text autocomplete="one-time-code" inputmode="numeric" pattern="[0-9]*" onkeypress=\"return (event.keyCode == 8) || (event.charCode >= 48 && event.charCode <= 57)\" onkeyup=account_addOtpCheck(event) onkeydown=account_addOtpCheck() maxlength=6 id=d2otpauthinput type=text></div>');
                            QV('idx_dlgOkButton', true);
                ...
                case 'otpauth-getpasswords': {
                    ...
                    if (message.passwords) {
                        ...
                        x += '<tr><td>' + "Aktif Anahtar Yok";
                    }
                    x += '</table></div></div><br />';
                    x += '<div><input type=button value=\'' + "Kapat" + '\' onclick=setDialogMode(0) style=float:right></input>';
                    x += '<input type=button value=\'' + "Yeni Anahtarlar" + '\' onclick=\'account_manageOtp(1);\'></input>';
                    ...
                    if ((xxdialogMode == 2) && (xxdialogTag == 'previousLogins')) {
                        ...
                        if (message.events.length == 0) {
                            ...
                            for (var i in message.events) {
                                ...
                                if (m == 107) { m = "Geçerli giriş"; c = 'BBD1BB'; xx = ''; }
                                else if (m == 108) { m = "Geçersiz 2FA"; c = 'DD9DC3'; xx = 'x'; }
                                else if (m == 109) { m = "Kilitli hesap"; c = 'E1BBBB'; xx = 'x'; }
                                else if (m == 110) { m = "Geçersiz şifre"; c = 'E1BBBB'; xx = 'x'; }
                        ...
                        setDialogMode(2, "Önceki Girişler", 1, null, x);
                    }
                    break;
                }
                case 'event': {
        ...
        function goStack() {
            ...
            if (idtype == 'files') {
                ...
                if ((features & 0x00040000) && !((userinfo.otpsecret == 1) || (userinfo.otphkeys > 0) || (userinfo.otpkeys > 0) || (userinfo.otpduo > 0) || (userinfo.otpdev > 0) || ((features & 0x00800000) && (userinfo.otpekey == 1)))) { setDialogMode(2, "Hesap Güvenliği", 1, null, "Unable to access this feature until two-factor authentication is enabled. This is required for extra security. Go to the \"My Account\" and look at the \"Account Security\" section."); return; }  
                go(5);
            }
        }
        ...
        function account_viewPreviousLogins() {
            if (xxdialogMode) return;
            setDialogMode(2, "Önceki Girişler", 1, null, "Yükleniyor...", 'previousLogins');
        ...
        function account_manageImage(mode) {
            ...
            setDialogMode(2, "Hesap Resmini Yönet", 7, account_manageImageEx2, x, user._id);
        ...
        function toggleNightMode() {
            ...
            var x = '<input type=radio id=night0 name=nightmoderadio value=0 ' + ((cNightMode == 0) ? 'checked' : '') + '><label for=night0>' + "tarayıcı varsayılanı" + '</label><br>';
            x += '<input type=radio id=night2 name=nightmoderadio value=2 ' + ((cNightMode == 2) ? 'checked' : '') + '><label for=night2>' + "Işık modu" + '</label><br>';
            x += '<input type=radio id=night1 name=nightmoderadio value=1 ' + ((cNightMode == 1) ? 'checked' : '') + '><label for=night1>' + "Karanlık mod" + '</label><br>';
            setDialogMode(2, "Gece modu", 3, toggleNightModeEx, x);
            QV('uiMenu', false);
        }
        ...
        function account_showLocalizationSettings() {
            ...
            if (serverinfo.languages && serverinfo.languages.length > 0) {
                y += "Dilin değiştirilmesi, sayfanın yenilenmesini gerektirir." + '<br /><br />';
                var z = '<select id=d2langselect style=width:180px><option value="*">' + "Kullanıcı tarayıcı değeri" + '</option>';
                ...
                z += '</select>';
                y += addHtmlValue("Dil", z);
            }
            y += addHtmlValue("Tarihler ve Saat", x);

            if ((userinfo.siteadmin == 0xFFFFFFFF) && (domain == '')) {
                y += '<br /><a rel="noreferrer noopener" target="_blank" href="translator.htm">' + "MeshCentral'ı çevirmeye yardım et" + '</a>';
            }

            setDialogMode(2, "Yerelleştirme Ayarları", 3, account_showLocalizationSettingsEx, y);
            return false;
        }
        ...
        function account_addOtp() {
            ...
            setDialogMode(2, "Kimlik Doğrulama Uygulaması", 2, function () { meshserver.send({ action: 'otpauth-setup', secret: Q('d2optsecret').attributes.secret.value, token: Q('d2otpauthinput').value }); }, '<div id=d2optinfo>' + "Yükleniyor..." + '</div>', 'otpauth-request');
        ...
        function account_removeOtp() {
            if (xxdialogMode || (userinfo.otpsecret != 1) || ((features & 4096) == 0)) return;
            setDialogMode(2, "Kimlik Doğrulama Uygulaması", 3, function () { meshserver.send({ action: 'otpauth-clear' }); }, "Kimlik doğrulayıcı uygulamasının 2 adımlı oturum açma işleminin kaldırılmasını onaylıyor musunuz?");
        }
        ...
        function account_showDeleteAccount() {
            ...
            x += '<input id=account_dlgCancelButton type=button value="' + "İptal" + '" style=float:right;width:80px;margin-left:5px onclick=dialogclose(0)>';
        ...
        function account_createMesh() {
            ...
            // Remind the user to add two factor authentication
            if ((features & 0x00040000) && !((userinfo.otpsecret == 1) || (userinfo.otphkeys > 0) || (userinfo.otpkeys > 0) || (userinfo.otpduo > 0) || (userinfo.otpdev > 0) || ((features & 0x00800000) && (userinfo.otpekey == 1)))) { setDialogMode(2, "Hesap Güvenliği", 1, null, "İki faktörlü kimlik doğrulama etkinleştirilene kadar bir cihaza erişilemez. Bu, ekstra güvenlik için gereklidir. \"Hesabım\" a gidin ve \"Hesap Güvenliği\" bölümüne bakın."); return; }
            ...
            x += addHtmlValue("Yazı", '<div style=width:170px;margin:0;padding:0><select id=dp3meshtype style=width:100% onchange=account_validateMeshCreate() ><option value=2>' + "Agent Grubu" + '</option><option value=1>' + "Yalnızca Intel&reg; AMT" + '</option></select></div>');
        ...
        function updateFiles() {
            ...
            var html1 = '', html2 = '', displayPath = '<a style=cursor:pointer;color:black onclick=p5folderup(0)>' + "Kök" + '</a>', fullPath = 'Root', publicPath, filetreex = filetree, folderdepth = 1;
        ...
        function p5setActions() {
            ...
            Q('p5SelectAllButton').value = (cc > 0 ? "Yok" : "Hepsi");
        ...
        function p5pasteFile() { var x = ''; if ((p5clipboard != null) && (p5clipboard.length > 0)) { x = format("Bu konuma {0} / {1} giriş {2} konulsun mu?", (p5clipboardCut == 0 ? 'copy' : 'move'), p5clipboard.length, ((p5clipboard.length > 1) ? 's' : '')) } setDialogMode(2, "Yapıştır", 3, p5pasteFileEx, x); }
        ...
        function p5updateClipview() { var x = ''; if ((p5clipboard != null) && (p5clipboard.length > 0)) { x = format("{2} için {0} giriş {1} tutuluyor", p5clipboard.length, ((p5clipboard.length > 1) ? 's' : ''), (p5clipboardCut == 0 ? "kopya" : "taşı")) + ', <a href=# onclick="return p5clearClip()" style=cursor:pointer>' + "Açık" + '</a>.' } QH('p5bottomstatus', x); p5setActions(); }
        ...
        function updateDevices() {
            ...
            if ((sort == 0) && (Q('SearchInput').value == '')) {
                for (var i in meshes) {
                    ...
                    if ((displayedMeshes[mesh._id] == null) && (IsMeshViewable(mesh))) {
                        ...
                        if (mesh.mtype > 1) { r += '<div style=padding:10px><i>' + "Bu grupta cihaz yok"; }
                        r += '.</i></div></div>';
                        current = mesh._id;
                        count++;
                    }
            ...
            if (count == 0) {
                if ((Q('SearchInput').value != '') || (Q('OnlineCheckBox').checked)) {
                    QH('xdevices', '<div style="margin-top:50px;text-align:center"><span style="font-size:30px">' + "Cihaz yok" + '</span><br /><br />' + "Bu aramayla eşleşen cihaz yok." + ' <a onclick=clearSearchInput() style=cursor:pointer>' + "Arama filtresini temizle" + '</a></div>');
                } else {
        ...
        function showDeviceHelpRequests(nodeid, force, e) {
            ...
            if (x != '') { setDialogMode(2, "Yardım talepleri" + ' - ' + EscapeHtml(node.name), 1, null, x, 'HELPREQ-' + node._id); } else { setDialogMode(0); }
            return false;
        }
                ...
                if ((i == 'kvm') && (node.sessions.multidesk == null)) {
                    ...
                    for (var j in node.sessions.kvm) {
                        if (j.startsWith('user/')) {
                            var trash = '';
                            if ((j == userinfo._id) || (GetNodeRights(node) == 0xFFFFFFFF)) { trash = ' <a href=# onclick=\'return endDeviceSession("kvm", "' + encodeURIComponentEx(node._id) + '", "' + encodeURIComponentEx(j) + '")\' title="' + "Bu oturumun bağlantısını kes" + '" style=cursor:pointer><img src=images/trash.png border=0 height=10 width=10></a>'; }
                            x += addHtmlValue4(getUserName(j), ((node.sessions.kvm[j] == 1) ? "1 oturum" : nobreak(format("{0} oturum", node.sessions.kvm[j]))) + trash);
                        } else if (j == 'busy') {
                            x += addHtmlValue2("Aygıt meşgul", ((node.sessions.kvm[j] == 1) ? "1 oturum" : nobreak(format("{0} oturum", node.sessions.kvm[j]))));
                        }
                    }
                } else if (i == 'multidesk') {
                    x += '<u>' + "Uzak Masaüstü" + '</u>';
                    for (var j in node.sessions.multidesk) {
                        var trash = '';
                        if ((j == userinfo._id) || (GetNodeRights(node) == 0xFFFFFFFF)) { trash = ' <a href=# onclick=\'return endDeviceSession("multidesk", "' + encodeURIComponentEx(node._id) + '", "' + encodeURIComponentEx(j) + '")\' title="' + "Bu oturumun bağlantısını kes" + '" style=cursor:pointer><img src=images/trash.png border=0 height=10 width=10></a>'; }
                        x += addHtmlValue4(getUserName(j), ((node.sessions.multidesk[j] == 1) ? "1 oturum" : nobreak(format("{0} oturum", node.sessions.multidesk[j]))) + trash);
                    }
                } else if (i == 'terminal') {
                    x += '<u>' + "Komut Satırı" + '</u>';
                    for (var j in node.sessions.terminal) {
                        var trash = '';
                        if ((j == userinfo._id) || (GetNodeRights(node) == 0xFFFFFFFF)) { trash = ' <a href=# onclick=\'return endDeviceSession("terminal", "' + encodeURIComponentEx(node._id) + '", "' + encodeURIComponentEx(j) + '")\' title="' + "Bu oturumun bağlantısını kes" + '" style=cursor:pointer><img src=images/trash.png border=0 height=10 width=10></a>'; }
                        x += addHtmlValue4(getUserName(j), ((node.sessions.terminal[j] == 1) ? "1 oturum" : nobreak(format("{0} oturum", node.sessions.terminal[j]))) + trash);
                    }
                } else if (i == 'files') {
                    x += '<u>' + "Dosyalar" + '</u>';
                    for (var j in node.sessions.files) {
                        var trash = '';
                        if ((j == userinfo._id) || (GetNodeRights(node) == 0xFFFFFFFF)) { trash = ' <a href=# onclick=\'return endDeviceSession("files", "' + encodeURIComponentEx(node._id) + '", "' + encodeURIComponentEx(j) + '")\' title="' + "Bu oturumun bağlantısını kes" + '" style=cursor:pointer><img src=images/trash.png border=0 height=10 width=10></a>'; }
                        x += addHtmlValue4(getUserName(j), ((node.sessions.files[j] == 1) ? "1 oturum" : nobreak(format("{0} oturum", node.sessions.files[j]))) + trash);
                    }
                } else if (i == 'tcp') {
                    x += '<u>' + "TCP Yönlendirme" + '</u>';
                    for (var j in node.sessions.tcp) {
                        var trash = '';
                        if ((j == userinfo._id) || (GetNodeRights(node) == 0xFFFFFFFF)) { trash = ' <a href=# onclick=\'return endDeviceSession("tcp", "' + encodeURIComponentEx(node._id) + '", "' + encodeURIComponentEx(j) + '")\' title="' + "Bu oturumun bağlantısını kes" + '" style=cursor:pointer><img src=images/trash.png border=0 height=10 width=10></a>'; }
                        x += addHtmlValue4(getUserName(j), ((node.sessions.tcp[j] == 1) ? "1 oturum" : nobreak(format("{0} oturum", node.sessions.tcp[j]))) + trash);
                    }
                } else if (i == 'udp') {
                    x += '<u>' + "UDP Yönlendirme" + '</u>';
                    for (var j in node.sessions.udp) {
                        var trash = '';
                        if ((j == userinfo._id) || (GetNodeRights(node) == 0xFFFFFFFF)) { trash = ' <a href=# onclick=\'return endDeviceSession("udp", "' + encodeURIComponentEx(node._id) + '", "' + encodeURIComponentEx(j) + '")\' title="' + "Bu oturumun bağlantısını kes" + '" style=cursor:pointer><img src=images/trash.png border=0 height=10 width=10></a>'; }
                        x += addHtmlValue4(getUserName(j), ((node.sessions.udp[j] == 1) ? "1 oturum" : nobreak(format("{0} oturum", node.sessions.udp[j]))) + trash);
                    }
                }
            }
            if (x != '') { setDialogMode(2, "Oturumlar" + ' - ' + EscapeHtml(node.name), 1, null, x, 'SESSIONS-' + node._id); } else { setDialogMode(0); }
        }
        ...
        function showDeviceMessages(nodeid, force, e) {
            ...
            x += '</div>';
            if (count > 0) setDialogMode(2, "Agent Mesajları" + ' - ' + EscapeHtml(node.name), 1, null, x, 'MESSAGES-' + node._id);
            return false;
        }

        var powerStatetable = ['', "Açık", "Uyku", "Uyku", "Uyku", "Hazırda bekletme", "Kapat", "Mevcut", "Kapalı"];
        var powerStateStrings = ['', "Açık", "Uyuyor", "Uyuyor", "Derin uyku", "Hazırda bekletme", "Soft-Off", "Mevcut", "Kapalı"];
        var powerStateStrings2 = ['', "Cihaz çalışıyor", "Cihaz uyku durumunda (S1)", "Cihaz uyku durumunda (S2)", "Cihaz derin uyku durumunda (S3)", "Cihaz hazırda bekletme modunda (S4)", "Cihaz yumuşak kapalı durumda (S5)", "Cihaz mevcut, ancak güç durumu belirlenemiyor", "Cihaz kapalı"];
        ...
        function NodeStateStr(node) {
            ...
            if (node.conn) {
                if ((node.conn & 1) != 0) { states.push('<span>' + ((node.mtype == 4) ? ((node.porttype == 'PDU') ? "Değiştirmek" : "IP-KVM") : "Agent") + '</span>'); }
                if ((node.conn & 2) != 0) { states.push('<span>' + "CIRA" + '</span>'); }
                else if ((node.conn & 4) != 0) { states.push('<span>' + "Intel&reg; AMT" + '</span>'); }
                if ((node.conn & 8) != 0) { states.push('<span>' + "Yayın" + '</span>'); }
        ...
        function deviceHeaderSet() {
            ...
            deviceHeaders['DevxHeader' + deviceHeaderId] = ', ' + deviceHeaderTotal + ((deviceHeaderTotal == 1) ? " cihaz" : " cihaz");
            var title = '';
        ...
        */
        ...
        function gotoDevice(nodeid, panel, refresh) {
            ...
            if (!currentNode || currentNode._id != node._id || refresh == true) {
                ...
                // IP-KVM information
                if (node.mtype == 4) {
                    if (node.portnum != null) { x += addDeviceAttribute("Port numarası", node.portnum); }
                    if (node.porttype != null) { x += addDeviceAttribute("Bağlantı Noktası Türü", node.porttype); }
                }

                // Attribute: Mesh Agent
                if ((node.agent != null) && (node.agent.id != null) && (node.mtype == 3)) {
                    if (node.agent.id == 4) { x += addDeviceAttribute("Cihaz tipi", "pencereler"); }
                    if (node.agent.id == 6) { x += addDeviceAttribute("Cihaz tipi", "Linux"); }
                    if (node.agent.id == 29) { x += addDeviceAttribute("Cihaz tipi", "macOS"); }
                    ...
                    if ((node.agent.root === false) && ((node.conn & 1) != 0)) { str += ', ' + "Kısıtlı"; }
                    x += addDeviceAttribute("Mesh Ajan", str);
                }
                ...
                if (node.intelamt != null) {
                    ...
                    if (node.intelamt.ver != null && node.intelamt.state == null) { str += '<i>' + nobreak("Bilinmeyen Durum") + '</i>, v' + EscapeHtml(node.intelamt.ver); }
                    else if ((node.intelamt.ver == null) && (node.intelamt.state == 2)) { str += '<i>' + "Aktif" + '</i>'; }
                    ...
                    if (node.intelamt.state == 2) {
                        if (node.intelamt.tls == 1) { str += ', <span title="' + "Intel&reg; AMT, TLS ağ güvenliğiyle kuruldu" + '">' + "TLS" + '</span>'; }
                        ...
                        if (node.intelamt.user == null || node.intelamt.user == '') { // If credentials are not set, allow setting them.
                            if ((meshrights & 4) != 0) {
                                str += ', <i style=color:#FF0000;cursor:pointer title="' + "Intel&reg; AMT kimlik bilgilerini düzenleyin" + '" onclick=editDeviceAmtSettings("' + node._id + '")>' + "Kimlik Bilgisi Yok" + '</i>';
                            ...
                            var warn = null;
                            if ((node.intelamt.warn & 1) != 0) { warn = "Geçersiz kimlik bilgileri"; }
                            if ((node.intelamt.warn & 8) != 0) { warn = "Kimlik Bilgilerini Denemek"; }
                            if (warn != null) {
                                if ((meshrights & 4) != 0) {
                                    str += ', <i style=color:#FF0000;cursor:pointer title="' + "Intel&reg; AMT kimlik bilgilerini düzenleyin" + '" onclick=editDeviceAmtSettings("' + node._id + '")>' + warn + '</i>';
                                    editUserCredentialsIcon = true;
                                } else {
                        ...
                        if (editUserCredentialsIcon) {
                            str += '<img src=images/link4.png height=10 width=10 title="' + "Intel&reg; AMT kimlik bilgilerini düzenleyin" + '" style=cursor:pointer onclick=editDeviceAmtSettings("' + node._id + '")>';
                        }
                    }
                ...
                if ((node.agent != null) && (node.agent.tag != null) && (node.agent.tag != 'mailto:')) {
                    ...
                    x += addDeviceAttribute("Agent Etiketi", tag);
                }
                ...
                if (connectivity && connectivity > 1) {
                    var cstate = [];
                    if ((node.conn & 1) != 0) cstate.push('<span>' + ((node.mtype == 4) ? ((node.porttype == 'PDU') ? "Değiştirmek" : "IP-KVM") : "Agent") + '</span>');
                    if ((node.conn & 2) != 0) cstate.push('<span>' + "Intel&reg; AMT CIRA" + '</span>');
                    else if ((node.conn & 4) != 0) cstate.push('<span>' + "Intel&reg; AMT" + '</span>');
                    if ((node.conn & 8) != 0) cstate.push('<span>' + "Agent Yayını" + '</span>');
                ...
                if ((meshrights & 4) != 0) {
                    x += addDeviceAttribute("Etiketler", '<span onclick=showEditNodeValueDialog(3) style=cursor:pointer;color:black>' + groupingTags + '</span>');
                } else {
                    x += addDeviceAttribute("Etiketler", '<span style=line-height:26px;color:black>' + groupingTags + '</span>');
                }
                ...
                if ((node.ssh != null) || (node.rdp != null)) {
                    var y = [];
                    if ((meshrights & 4) != 0) {
                        if (node.ssh != null) { y.push('<span onclick=showClearSshDialog(3) style=cursor:pointer>' + ((node.ssh == 1) ? "SSH-Kullanıcı+Pass" : ((node.ssh == 2) ? "SSH-Kullanıcı+Anahtarı+Pass" : "SSH-Kullanıcı+Anahtarı")) + ' <img class=hoverButton src="images/link5.png" width=10 height=10 /></span>'); }
                        ...
                        if (node.ssh != null) { y.push(((node.ssh == 1) ? "SSH-Kullanıcı+Pass" : ((node.ssh == 2) ? "SSH-Kullanıcı+Anahtarı+Pass" : "SSH-Kullanıcı+Anahtarı"))); }
                        if (node.rdp != null) { y.push("RDP"); }
                    }
                    x += addDeviceAttribute("Kimlik bilgileri", y.join(', '));
                }

                x += '</table><br />';
                // Show action button, only show if we have permissions 4, 8, 64
                if (((meshrights & (4 + 8 + 64 + 262144)) != 0) && (node.mtype < 3)) { x += '<input type=button value="' + "İşlemler" + '" onclick=deviceActionFunction() />'; }
                x += '<input type=button value="' + "Notlar" + '" onclick=showNotes(' + ((meshrights & 128) == 0) + ',"' + encodeURIComponent(node._id) + '") />';
                ...
                if ((node.mtype == 4) && (connectivity & 1)) {
                    if (node.porttype == 'PDU') {
                        if (node.pwr == 1) {
                            if (meshrights & 0x40000) { x += '<input type=button value="' + "Kapat" + '" title="' + "Kapat" + '" onclick=setIpPduState(0) />'; }
                        } else if (node.pwr == 8) {
                            if (meshrights & 0x40) { x += '<input type=button value="' + "Aç" + '" title="' + "Aç" + '" onclick=setIpPduState(1) />'; }
                        }
                    } else {
                        if (meshrights & 8) { x += '<input type=button value="' + "Uzaktan kumanda" + '" title="' + "Uzaktan kumanda" + '" onclick=openIpKvmRemoteControl("' + encodeURIComponentEx(node._id) + '") />'; }x
                    }
                }
                ...
                if ((connectivity & 1) != 0) { if (powerstate.length > 0) { powerstate += ', '; } powerstate += ((node.mtype == 4) ? ((node.porttype == 'PDU') ? "Değiştirmek" : "IP-KVM") : "Mesh Ajan"); }
                if ((connectivity & 2) != 0) { if (powerstate.length > 0) { powerstate += ', '; } powerstate += "Intel&reg; AMT bağlandı"; }
                else if ((connectivity & 4) != 0) { if (powerstate.length > 0) { powerstate += ', '; } powerstate += "Intel&reg; AMT algılandı"; }
                if ((connectivity & 16) != 0) { if (powerstate.length > 0) { powerstate += ', '; } powerstate += "MQTT kanalı bağlı"; }
        ...
        function setIpPduState(op) {
            if (op == 0) {
                setDialogMode(2, "Güç Çalışması", 3, function () { meshserver.send({ action: 'poweraction', nodeids: [currentNode._id], actiontype: 2 }); }, "Güç kapatılsın mı?"); // Turn off
            } else {
                setDialogMode(2, "Güç Çalışması", 3, function () { meshserver.send({ action: 'wakedevices', nodeids: [currentNode._id] }); }, "Güç açık mı?"); // Turn on
            }
        }
        ...
        function setupDeviceMenu(op, obj) {
            ...
            ) { menus.push({ n: "Masaüstü", f: 'setupDeviceMenu(1)' }); }
            ...
            ) { menus.push({ n: "Komut Satırı", f: 'setupDeviceMenu(5)' }); }

            if ((currentDevicePanel != 2) && (currentNode != null) && (meshrights & 8) && ((meshrights == 0xFFFFFFFF) || ((meshrights & 1024) == 0)) && ((currentNode.mtype != 1) && (currentNode.agent) && (currentNode.agent.caps & 4))) { menus.push({ n: "Dosyalar", f: 'setupDeviceMenu(2)' }); }
            if ((currentDevicePanel != 3) && (currentNode != null) && (currentNode.mtype < 3) && ((meshrights & 1048576) != 0)) { menus.push({ n: "Ayrıntılar", f: 'setupDeviceMenu(3)' }); }
            if ((currentDevicePanel != 4) && (currentNode != null) && (meshrights & 0x00000010) && (currentNode.mtype == 2)) { menus.push({ n: "Agent Komut Satırı", f: 'setupDeviceMenu(4)' }); }
        ...
        function deviceActionFunction() {
            ...
            if ((currentNode.agent != null) && (currentNode.agent.id == 14)) {
                if (((currentNode.conn & 1) != 0) && ((rights & 8) != 0)) {
                    count++;
                    y += '<option value=400>' + "flaş" + '</option>';
                    y += '<option value=401>' + "Titreşim" + '</option>';
                    z += '<div id=d2devicetimediv>' + addHtmlValue("Zaman", '<select id=d2devicetime style=float:right;width:170px><option value=1000>' + "1 saniye" + '</option><option value=5000>' + "5 saniye" + '</option><option value=10000>' + "10 saniye" + '</option></select>') + '</div>';
                }
            } else {
                if ((rights & 64) != 0) { count++; y += '<option value=100>' + "Uyandır" + '</option>'; } // Wake-up permission
                //if (((currentNode.conn & 1) != 0) && ((rights & 131072) != 0)) { count++; y += '<option value=106>' + "Run Commands" + '</option>'; } // Remote command permission
                if ((currentNode.conn != 0) && ((rights & 262144) != 0)) { count++; y += '<option value=4>' + "Uyku" + '</option><option value=3>' + "Sıfırla" + '</option><option value=2>' + "Kapat" + '</option>'; }
                ...
                if ((currentNode.intelamt != null) && (currentNode.intelamt.state == 2) && ((currentNode.conn & 6) != 0) && ((rights & 262144) != 0)) {
                    count++;
                    y += '<option value=310>' + "Intel&reg; AMT Sıfırlama" + '</option>';
                    y += '<option value=308>' + "Intel&reg; AMT Kapatma" + '</option>';
                }
                if ((currentNode.intelamt != null) && (currentNode.intelamt.state == 2) && ((currentNode.conn & 6) != 0) && ((rights & 64) != 0)) {
                    count++;
                    y += '<option value=302>' + "Intel&reg; AMT Gücü açık" + '</option>';
                }
            ...
            y += '</select>';
            x += addHtmlValue("İşlem", y);
            if (count == 0) { x = "Bu cihaz için şu anda kullanılabilir eylem yok."; }
            setDialogMode(2, "Cihaz İşlemi", (count == 0) ? 2 : 3, deviceActionFunctionEx, x + z);
        ...
        function deviceActionFunctionEx() {
            ...
            if (op == 100) {
                ...
                */
                ...
                setDialogMode(2, "Intel&reg; AMT Güç Çalışması", 3, function () { meshserver.send({ action: 'poweraction', nodeids: [currentNode._id], actiontype: parseInt(op) }); }, "Intel&reg; AMT gücü açık mı?");
            } else if (op == 308) { // Intel AMT power off
                setDialogMode(2, "Intel&reg; AMT Güç Çalışması", 3, function () { meshserver.send({ action: 'poweraction', nodeids: [currentNode._id], actiontype: parseInt(op) }); }, "Perform Intel&reg; AMT power off?<br><br><b>NOTE: If there is an active AMT session, then power off command will be rejected, so you must disconnect from the AMT session first!</b>");
            } else if (op == 310) { // Intel AMT reset
                setDialogMode(2, "Intel&reg; AMT Güç Çalışması", 3, function () { meshserver.send({ action: 'poweraction', nodeids: [currentNode._id], actiontype: parseInt(op) }); }, "Intel&reg; AMT sıfırlaması gerçekleştirilsin mi?");
        ...
        function showNotes(readonly, noteid) {
            ...
            if (noteid.startsWith('node%2F%2F')) { x += '<span style=font-size:10px>' + "Cihaz grubu notları, diğer cihaz grubu yöneticileri tarafından görüntülenebilir ve değiştirilebilir." + '<span>'; }
            setDialogMode(2, "Notlar", 3, showNotesEx, x, noteid);
        ...
        function deviceLockFunction() {
            if ((xxdialogMode != null || xxdialogMode == 0) && (desktop != null) && (desktop.contype == 1)) { setDialogMode(2, "Masaüstünü Kilitle", 3, function() { if ((desktop != null) && (desktop.contype == 1)) { desktop.sendCtrlMsg('{"ctrlChannel":"102938","type":"lock"}'); } }, "Kullanıcı masaüstü kilitlensin mi?"); }
        }

        function deviceChat(e) {
            if (xxdialogMode) return;
            setDialogMode(2, "Cihaz İşlemi", 3, function () {
            ...
            }, "Sohbet oturumu başlatılsın mı?");
        }

        function deviceUrlFunction() {
            if (xxdialogMode) return;
            setDialogMode(2, "Cihazda Sayfayı Aç", 3, deviceUrlFunctionEx, '<input id=d2devurl placeholder="http://server.com" style=width:100%;overflow-y:scroll onkeyup=deviceUrlFunctionValidate() onchange=deviceUrlFunctionValidate()></input>');
            Q('d2devurl').focus();
        ...
        function d2runCommandDialog(options) {
            ...
            if ((wintype == true) || (linuxtype == true) || (agenttype == true)) {
                ...
                if (wintype == true) { x += '<option value=1' + ((runopt.type == 1)?' selected':'') + '>' + "Windows Komut İstemi" + '</option><option value=2' + ((runopt.type == 2)?' selected':'') + '>' + "Windows PowerShell" + '</option>'; }
                if (linuxtype == true) { x += '<option value=3' + ((runopt.type == 3)?' selected':'') + '>' + "Linux / BSD / macOS Komut Kabuğu" + '</option>'; }
                if (agenttype == true) { x += '<option value=4' + ((runopt.type == 4)?' selected':'') + '>' + "Agent Komut Satırı" + '</option>'; } // MESHRIGHT_REMOTECONTROL & MESHRIGHT_AGENTCONSOLE are needed
                x += '</select>';
                x += '<select id=d2cmduser style=width:100%;margin-bottom:4px><option value=0' + ((runopt.runAs == 0)?' selected':'') + '>' + "Agent olarak çalıştır" + '</option><option value=1' + ((runopt.runAs == 1)?' selected':'') + '>' + "Kullanıcı yoksa aracı olarak çalıştır" + '</option><option value=2' + ((runopt.runAs == 2)?' selected':'') + '>' + "Kullanıcı olarak çalıştırılmalıdır" + '</option></select>';
                ...
                setDialogMode(2, "Komutları Çalıştır", 3, d2groupActionFunctionRunCommands, x, options);
                if (options.selectedFile == null) {
                    Q('d2runcmd').focus();
        ...
        function editDeviceAmtSettings(nodeid, func) {
            ...
            if ((features2 & 1) == 0) { x += addHtmlValue("Güvenlik", '<select id=dp10tls style=width:176px><option value=0>' + "TLS güvenliği yok" + '</option><option value=1>' + "TLS güvenliği gerekli" + '</option></select>'); }
        ...
        function p10showDeleteNodeDialog(nodeid) {
            if (xxdialogMode) return;
            setDialogMode(2, "Cihazı Sil", 3, p10showDeleteNodeDialogEx, format("{0} silinsin mi?", EscapeHtml(currentNode.name)) + '<br /><br /><label><input id=p10check type=checkbox onchange=p10validateDeleteNodeDialog() />' + "Onayla" + '</label>', nodeid);
        ...
        function showClearSshDialog() { setDialogMode(2, "Cihazı Düzenle", 3, showClearSshDialogEx, "SSH kimlik bilgileri temizlensin mi?"); }
        function showClearSshDialogEx(button, mode) { meshserver.send({ action: 'changedevice', nodeid: currentNode._id, ssh: 0 }); }
        function showClearRdpDialog() { setDialogMode(2, "Cihazı Düzenle", 3, showClearRdpDialogEx, "RDP kimlik bilgileri temizlensin mi?"); }
        ...
        var agentConsoleMessages = ['', "Kullanıcının erişim izni vermesi bekleniyor ...", "Reddedildi", "Uzak terminal oturumu başlatılamadı, {0} ({1})", "Zaman aşımı", "Geçersiz ağ verileri alındı"];
        ...
        function updateDeskShortcutKeys() {
            var x = '<div class="menuButton" onclick="deskMenuButton(-1)">' + "Özelleştirme" + '</div>';
        ...
        var keyStrings = { 8: "Silme", 9: "Sekme", 13: "Giriş", 27: "Kaçmak", 32: "Space", 44: "Ekran görüntüsü", 45: "Sokmak", 46: "del", 36: "Ev", 35: "Son", 32: "Espace", 33: "Sayfa yukarı", 34: "Sayfa Aşağı", 37: "Sol", 38: "Yukarı", 39: "Doğru", 40: "Aşağı", 0: "Yok" }

        function keyShortcutTotext(n) {
            var x = [];
            if (n & 0x010000) { x.push("Vardiya"); }
            if (n & 0x020000) { x.push("Alt"); }
            if (n & 0x080000) { x.push("Ctrl"); }
            if (n & 0x100000) { x.push("Galibiyet"); }
            n = (n & 0xFFFF);
        ...
        function deskCustomizeKeys() {
            ...
            x += '<label><input id=d1kshift type=checkbox /> ' + "Vardiya" + '</label><label> <input id=d1kalt type=checkbox /> ' + "Alt" + '</label><label> <input id=d1kctrl type=checkbox /> ' + "Ctrl" + '</label> <input id=d1kwin type=checkbox /> ' + "Galibiyet" + '</label>';
            ...
            x += '</select> <input type=button value=' + "Ekle" + ' onclick=addDeskCustomizeKey() /></div>';
            QH('p10dialog2', x);
            xxdialogMode = 2;
            QV('p10dialog', true);
        ...
        function deskUpdateShortcutList() {
            ...
            if (x == '') { x = '<i>' + "Tanımlanmış klavye kısayolu yok" + '</i>'; }
            QH('d2shortcuts', x);
        }
        ...
        function updateTerminalButtons() {
            ...
            if (((termState == true) && (terminal.contype != 3)) || (terminalNode.agent == null) || (terminalNode.agent.id == 3) || (terminalNode.agent.id == 4)) {
                ...
                QH('terminalCustomUpperRight', '<a style=cursor:pointer onclick=cmsshportaction(1,event)>' + format("SSH Bağlantı Noktası {0}", (terminalNode.sshport ? terminalNode.sshport : 22)) + '</a>');
            }
        }

        function cmsshportaction(action) {
            if (xxdialogMode) return;
            var x = "SSH uzak bağlantı noktası:" + '<br /><br /><input type=text placeholder="22" inputmode="numeric" pattern="[0-9]*" onkeypress="return (event.keyCode == 8) || (event.charCode >= 48 && event.charCode <= 57)" maxlength=5 id=d10sshport type=text>';
            setDialogMode(2, "SSH Bağlantısı", 3, function () {
        ...
        function sshTunnelAuthDialog(j, func) {
            var x = '';
            if (j.askkeypass) {
                x += addHtmlValue("Kimlik doğrulama", '<select id=dp2authmethod style=width:150px onchange=sshAuthUpdate(event)><option value=3 selected>' + "Saklanan Anahtar" + '</option><option value=1>' + "Kullanıcı adı Şifre" + '</option><option value=2>' + "Kullanıcı adı ve Anahtar" + '</option></select>');
            } else {
                x += addHtmlValue("Kimlik doğrulama", '<select id=dp2authmethod style=width:150px onchange=sshAuthUpdate(event)><option value=1 selected>' + "Kullanıcı adı Şifre" + '</option><option value=2>' + "Kullanıcı adı ve Anahtar" + '</option></select>');
            }
            x += '<div id=d2userauth style=display:none>';
            x += addHtmlValue("Kullanıcı adı", '<input id=dp2user style=width:150px maxlength=64 autocomplete=off onkeyup=sshAuthUpdate(event) />');
            x += '</div>';
            x += '<div id=d2passauth style=display:none>';
            x += addHtmlValue("Parola", '<input type=password id=dp2pass style=width:150px maxlength=64 autocomplete=off onkeyup=sshAuthUpdate(event) />');
            if ((features2 & 0x00400000) == 0) { x += '<label><input id=dp2keep type=checkbox>' + "Kimlik bilgilerini hatırla" + '</label>'; }
            x += '</div><div id=d2keyauth style=display:none>';
            x += addHtmlValue("Anahtar dosya", '<input type=file id=dp2key style=width:150px maxlength=64 autocomplete=off onchange=sshAuthUpdate(event) />' + '<div id=d2badkey style=font-size:x-small>' + "Anahtar dosyası OpenSSH formatında olmalıdır." + '</div>');
            x += addHtmlValue("Anahtar Parola", '<input type=password id=dp2keypass style=width:150px maxlength=64 autocomplete=off onkeyup=sshAuthUpdate(event) />');
            if ((features2 & 0x00400000) == 0) {
                x += '<label><input id=dp2keep1 type=checkbox onchange=sshAuthUpdate(event)>' + "Kullanıcıyı ve anahtarı hatırla" + '</label><br/>';
                x += '<label><input id=dp2keep2 type=checkbox>' + "Şifre hatırlamak" + '</label>';
            }
            x += '</div>';
            if (j.askkeypass) {
                x += '<div id=d2keyauth2 style=display:none>';
                x += addHtmlValue("Parola", '<input type=password id=dp2keypass2 style=width:150px maxlength=64 autocomplete=off onkeyup=sshAuthUpdate(event) />');
                x += '</div>';
            }
            setDialogMode(2, "Kimlik doğrulama", 11, func, x, 'ssh');
            Q('dp2user').focus();
            sshAuthUpdate();
            ...
            if (typeof data == 'string') {
                if (data[0] == '{') {
                    ...
                    switch (j.action) {
                        ...
                        case 'autherror': { p12setConsoleMsg("Kimlik Doğrulama Hatası", 5000); break; }
                        case 'sessionerror': { p12setConsoleMsg("Oturum süresi doldu", 5000); break; }
                        case 'sessiontimeout': { p12setConsoleMsg("Oturum zaman aşımına uğradı", 5000); break; }
                    }
                } else if (data[0] == '~') {
        ...
        */
        ...
        function p13gotFiles(data) {
            ...
            switch (data.action) {
                ...
                case 'autherror': { p13setConsoleMsg("Kimlik Doğrulama Hatası", 5000); return; }
                case 'connectionerror': { p13setConsoleMsg("Bağlantı hatası", 5000); return; }
                case 'sessionerror': { p13setConsoleMsg("Oturum süresi doldu", 5000); return; }
                case 'sessiontimeout': { p13setConsoleMsg("Oturum zaman aşımına uğradı", 5000); return; }
            }
        ...
        function p13updateFiles(checkedNames) {
            var html1 = '', html2 = '', displayPath = '<a style=cursor:pointer;color:black onclick=p13folderup(0)>' + "Kök" + '</a>', fullPath = 'Root';
        ...
        function p13setActions() {
            ...
            if (p13filetree == null) {
                ...
                Q('p13SelectAllButton').value = "Hepsi";
                ...
                Q('p13SelectAllButton').value = (cc > 0 ? "Yok" : "Hepsi");
            ...
            if (((filesState == true) && (files.contype != 2)) || (filesNode.agent == null) || (filesNode.agent.id == 3) || (filesNode.agent.id == 4)) {
                ...
                QH('filesCustomUpperRight', '<a style=cursor:pointer onclick=cmsshportaction(1,event)>' + format("SSH Bağlantı Noktası {0}", (filesNode.sshport ? filesNode.sshport : 22)) + '</a>');
            }
        ...
        function p13renamefile() { var renamefile, checkboxes = document.getElementsByName('fd'); for (var i = 0; i < checkboxes.length; i++) { if (checkboxes[i].checked) { renamefile = p13filetree.dir[checkboxes[i].value].n; } } setDialogMode(2, "Yeniden adlandır", 3, p13renamefileEx, '<input type=text id=p13renameinput maxlength=64 onkeyup=p13fileNameCheck(event) style=width:100% value="' + renamefile + '" />', { action: 'rename', path: p13filetreelocation.join('/'), oldname: renamefile }); focusTextBox('p13renameinput'); p13fileNameCheck(); }
        ...
        function p13uploadFile() { setDialogMode(2, "Dosya gönder", 3, p13uploadFileEx, '<input type=file name=files id=p13uploadinput style=width:100% multiple=multiple onchange="updateUploadDialogOk(\'p13uploadinput\')" />'); updateUploadDialogOk('p13uploadinput'); }
        ...
        function p13pasteFile() {
            ...
            setDialogMode(2, "Yapıştır", 3, p13pasteFileEx, x);
        }
        ...
        function p13downloadfile(x, y, z) {
            ...
            setDialogMode(2, "Dosyayı indir", 10, p13downloadFileCancel, '<div>' + EscapeHtml(downloadFile.file) + '</div><br /><progress id=d2progressBar style=width:100% value=0 max=' + z + ' />');
        }
        ...
        */
        ...
        function p13doUploadFiles(files) {
            ...
            if (overWriteCount == 0) {
                ...
                setDialogMode(2, "Dosya gönder", 3, p13uploadFileContinue, format((overWriteCount == 1) ? "Yükleme 1 dosyanın üzerine yazacak. Devam et?" : "Gönderme işlemi {0} dosyanın üzerine yazsın mı?", overWriteCount), files);
            }
        }
        ...
        function p13uploadFileContinue(b, files) {
            ...
            setDialogMode(2, "Dosya gönder", 10, p13uploadFileCancel, '<div id=p13dfileName>' + "Bağlanıyor..." + '</div><br /><progress id=d2progressBar style=width:100% value=0 max=0 />');
            p13uploadNextFile();
        }
        ...
        function updateDeviceDetails(node, hardware, network) {
            ...
            if (hardware.windows && hardware.windows.osinfo && hardware.windows.osinfo.Description) { x += addDetailItem("Açıklama", EscapeHtml(hardware.windows.osinfo.Description), s); }
            ...
            if (hardware.windows && hardware.windows.osinfo) {
                ...
                if (m.OSArchitecture) {
                    if (m.OSArchitecture.startsWith('32')) { x += addDetailItem("Mimari", "32-bit", s); }
                    else if (m.OSArchitecture.startsWith('64')) { x += addDetailItem("Mimari", "64-bit", s); }
                    else { x += addDetailItem("Mimari", EscapeHtml(m.OSArchitecture), s); }
                }
                if(m.LastBootUpTime){
                    var thedate = {
                ...
                if(m.Domain){ x += addDetailItem((m.PartOfDomain ? "Alan adı" : "Çalışma Grubu"), EscapeHtml(m.Domain), s); }
            }
            ...
            if (node.wsc) {
                var y = [];
                if (node.wsc.antiVirus != null) { if (node.wsc.antiVirus == 'OK') { y.push("AV" + ' - <span style=color:green>' + "Tamam" + '</span>'); } else { y.push("AV" + ' - <span style=color:red>' + "KÖTÜ" + '</span>'); } }
                if (node.wsc.autoUpdate != null) { if (node.wsc.autoUpdate == 'OK') { y.push("Güncelleme" + ' - <span style=color:green>' + "Tamam" + '</span>'); } else { y.push("Güncelleme" + ' - <span style=color:red>' + "KÖTÜ" + '</span>'); } }
                if (node.wsc.firewall != null) { if (node.wsc.firewall == 'OK') { y.push("güvenlik duvarı" + ' - <span style=color:green>' + "Tamam" + '</span>'); } else { y.push("güvenlik duvarı" + ' - <span style=color:red>' + "KÖTÜ" + '</span>'); } }
                x += addDetailItem("Windows Güvenliği", y.join(', '));
            }

            // Defender for Windows Server
            if(node.defender) {
                var y = [];
                if (node.defender.RealTimeProtection != null) { if (node.defender.RealTimeProtection == true) { y.push("RealTimeProtection" + ' - <span style=color:green>' + "On" + '</span>'); } else { y.push("RealTimeProtection" + ' - <span style=color:red>' + "Kapalı" + '</span>'); } }
                if (node.defender.TamperProtected != null) { if (node.defender.TamperProtected == true) { y.push("TamperProtection" + ' - <span style=color:green>' + "On" + '</span>'); } else { y.push("TamperProtection" + ' - <span style=color:red>' + "Kapalı" + '</span>'); } }
                if (node.defender.AntivirusSignatureVersion != null) { y.push("İmza Sürümü" + ' - <span style=color:green>' + EscapeHtml(node.defender.AntivirusSignatureVersion) + '</span>'); }
            ...
            if (node.av && node.av.length > 0) {
                ...
                for (var i in node.av) {
                    if (node.av[i].product) {
                        ...
                        if (node.av[i].enabled !== true) { avx += ' - <span style=color:red>' + "Devre dışı" + '</span>'; }
                        if (node.av[i].updated !== true) { avx += ' - <span style=color:red>' + "Tarihi geçmiş" + '</span>'; }
                        if ((node.av[i].enabled == true) && (node.av[i].updated == true)) { avx += ' - <span style=color:green>' + "Tamam" + '</span>'; }
                        y.push(avx);
                    }
                }
                x += addDetailItem("Antivirüs", y.join('<br />'));
            }

            // Active Users
           if (node.users && node.users.length > 0) {
                var u = node.users.map(function(user) {
                    return addKeyLinkConditional(EscapeHtml(user), "Kilitli", (node.lusers && node.lusers.indexOf(user) >= 0));
                }).join(', ');
                x += addDetailItem((node.users.length > 1 ? "Aktif Kullanıcılar" : "Aktif Kullanıcı"), u);
            }

            if (x != '') { sections.push({ name: "İşletim sistemi", html: x, img: 'software' }); }
            ...
            if (node.agent) {
                ...
                if (node.firstconnect) { x += addDetailItem("İlk temsilci bağlantısı", printDateTime(new Date(node.firstconnect))); }
                if ((node.conn & 1) != 0) {
                    x += addDetailItem("Son agent bağlantısı", "Şimdi bağlandı");
                } else {
                    if (node.lastconnect) { x += addDetailItem("Son agent bağlantısı", printDateTime(new Date(node.lastconnect))); }
                }
                if (node.lastaddr) {
                    var splitip = node.lastaddr.split(':');
                    if (splitip.length > 2) {
                        // IPv6
                        x += addDetailItem("Son agent adresi", node.lastaddr);
                    } else {
                        // IPv4
                        if (isPrivateIP(node.lastaddr)) {
                            x += addDetailItem("Son agent adresi", splitip[0]);
                        } else {
                            x += addDetailItem("Son agent adresi", '<a href="https://iplocation.com/?ip=' + splitip[0] + '" rel="noreferrer noopener" target="MeshIPLoopup">' + splitip[0] + '</a>');
                        }
                    }
                }
                if (hardware.agentvers != null) {
                    if (hardware.agentvers.compileTime) {
                        try {
                            ...
                            x += addDetailItem("Derleme zamanı", printDateTime(new Date(d)));
                        } catch (ex) { }
                    }
                }
                if (hardware.time != null) {
                    x += addDetailItem("Son detay güncellemesi", printDateTime(new Date(hardware.time)));
                }
                if (x != '') { sections.push({ name: "Mesh Ajan", html: x, img: 'meshagent' }); }
            }

            // Mobile
            if (hardware.mobile) {
                var x = '';
                if (hardware.mobile.brand && hardware.mobile.model) { x += addDetailItem("Modeli", EscapeHtml(hardware.mobile.brand + ', ' + hardware.mobile.model), s); }
                if (hardware.mobile.device) { x += addDetailItem("Cihaz", EscapeHtml(hardware.mobile.device), s); }
                if (hardware.mobile.bootloader) { x += addDetailItem("önyükleyici", EscapeHtml(hardware.mobile.bootloader), s); }
                if (hardware.mobile.id) { x += addDetailItem("Tanımlayıcı", EscapeHtml(hardware.mobile.id), s); }
                if (hardware.mobile.host) { x += addDetailItem("Ana bilgisayar adı", EscapeHtml(hardware.mobile.host), s); }
                ...
                if (x != '') { sections.push({ name: "Mobil cihaz", html: x, img: 'mobile' }); }
            }
            ...
            if (network.netif2 != null) {
                ...
                for (var i in network.netif2) {
                    ...
                    if (typeof m[0].speed == 'number' && (m[0].speed != 9223372036854775807 && m[0].speed > 0)) {
                        x += addDetailItem("Arayüz Hızı", format("{0}", getNetworkSpeed(m[0].speed)));
                    }
                    for (var j = 0; j < m.length; j++) {
                        ...
                        if (iplayer.gateway) { items.push(format("Ağ geçidi: {0}", EscapeHtml(iplayer.gateway))); }
                        if (items.length > 0) {
                            if (iplayer.family == 'IPv4') { x += addDetailItem("IPv4 Katmanı", items.join(",")); }
                            if (iplayer.family == 'IPv6') { x += addDetailItem("IPv6 Katmanı", items.join(",")); }
                        }
                    }
                    x += '</div></td></tr>';
                }
                ...
                x += '</table>';
                if (x != '') { sections.push({ name: "Ağ oluşturma", html: x, img: 'networking' }); }
            }
            ...
            if (node.intelamt != null) {
                ...
                x += addDetailItem("Tanımlayıcı", (node.intelamt.uuid) ? (EscapeHtml(node.intelamt.uuid)) : ('<i>' + "Bilinmeyen" + '</i>'), s);
                var provisioningStates = { 0: nobreak("Etkinleştirilmedi (Ön)"), 1: nobreak("Etkinleştirilmedi (İçinde)"), 2: nobreak("Aktif") };
                ...
                x += addDetailItem("Yönetici Kimlik Bilgileri", ((node.intelamt.user) == null || (node.intelamt.user == '') || ((node.intelamt.warn != null) && ((node.intelamt.warn & 9) != 0))) ? "Bilinmeyen" : "Bilinen", s);
                if (x != '') {
                    if ((typeof node.intelamt.sku == 'number') && ((node.intelamt.sku & 16) != 0)) {
                        sections.push({ name: "Intel&reg; Standart Yönetilebilirlik (Intel&reg; SM)", html: x, img: 'amt' });
                    } else {
                        sections.push({ name: "Intel&reg; Aktif Yönetim Teknolojisi (Intel&reg; AMT)", html: x, img: 'amt' });
                    }
                }
            }
            ...
            if (hardware.identifiers) {
                ...
                // BIOS
                if (ident.bios_vendor) { x += addDetailItem("Üretici", EscapeHtml(ident.bios_vendor), s); }
                if (ident.bios_version) { x += addDetailItem("Sürüm", EscapeHtml(ident.bios_version), s); }
                if (ident.bios_serial) { x += addDetailItem("Seri", EscapeHtml(ident.bios_serial), s); }
                if (ident.bios_mode) { x += addDetailItem("Mode", EscapeHtml(ident.bios_mode), s); }
                if (x != '') { sections.push({ name: "BIOS", html: x, img: 'chip' }); }

                // Motherboard
                x = '';
                if (ident.board_vendor) { x += addDetailItem("Üretici", EscapeHtml(ident.board_vendor), s); }
                ...
                if (x != '') { sections.push({ name: "Anakart", html: x, img: 'motherboard' }); }
            }
            ...
            if (hardware.tpm) {
                ...
                if (tpm.ManufacturerId) { x += addDetailItem("Tanımlayıcı", EscapeHtml(tpm.ManufacturerId), s); }
                if (tpm.ManufacturerVersion) { x += addDetailItem("Sürüm", EscapeHtml(tpm.ManufacturerVersion), s); }
                if (tpm.IsActivated != null) { x += addDetailItem("Aktif", (tpm.IsActivated ? "Yes" : "No"), s); }
                if (tpm.IsEnabled != null) { x += addDetailItem("Etkin", (tpm.IsEnabled ? "Yes" : "No"), s); }
                if (tpm.IsOwned != null) { x += addDetailItem("Sahip olunan", (tpm.IsOwned ? "Yes" : "No"), s); }
            ...
            if (hardware.battery) {
                ...
                for (var i in hardware.battery) {
                    ...
                    x += '<tr><td><div class=style10 style=border-radius:5px;padding:8px>';
                    x += '<div style=margin-bottom:3px><b>' + EscapeHtml(battery.DeviceName ? battery.DeviceName : "Bilinmeyen") + '</b></div>';
                    if (battery.CycleCount) { x += addDetailItem("Döngü Sayısı", EscapeHtml(battery.CycleCount), s); }
                    if (battery.FullChargedCapacity) { x += addDetailItem("Tam Şarjlı Kapasite", format("{0} mWh", battery.FullChargedCapacity), s); }
                    if (battery.EstimatedRuntime) { x += addDetailItem("Tahmini Çalışma Süresi", format("{0} dakika", Math.floor((battery.EstimatedRuntime / 60))), s); }
                    if (battery.Chemistry) { x += addDetailItem("Kimya", EscapeHtml(battery.Chemistry), s); }
                    if (battery.DesignedCapacity) { x += addDetailItem("Tasarım Kapasitesi", format("{0} mWh", battery.DesignedCapacity), s); }
                    if (battery.ManufactureDate) { x += addDetailItem("Üretim Tarihi", EscapeHtml(battery.ManufactureDate), s); }
                    if (battery.ManufactureName) { x += addDetailItem("Üretim Adı", EscapeHtml(battery.ManufactureName), s); }
                    if (battery.SerialNumber) { x += addDetailItem("Seri numarası", EscapeHtml(battery.SerialNumber), s); }
                    if (battery.ChargeRate) { x += addDetailItem("Şarj Oranı", format("{0} mW", battery.ChargeRate), s); }
                    if (battery.Charging != null) { x += addDetailItem("Şarj etme", (battery.Charging ? "Yes" : "No"), s); }
                    if (battery.DischargeRate) { x += addDetailItem("Deşarj Hızı", format("{0} mW", battery.DischargeRate), s); }
                    if (battery.Discharging != null) { x += addDetailItem("Boşaltma", (battery.Discharging ? "Yes" : "No"), s); }
                    if (battery.RemainingCapacity) { x += addDetailItem("Kalan Kapasite", format("{0} mWh", battery.RemainingCapacity), s); }
                    if (battery.Voltage) { x += addDetailItem("Gerilim", format("{0} V", (battery.Voltage / 1000)), s); }
                    if (battery.Health) { x += addDetailItem("Sağlık", format("{0} %", battery.Health), s); }
                    if (battery.BatteryCharge) { x += addDetailItem("Pil Şarjı", format("{0} %", battery.BatteryCharge), s); }   
                    x += '</div>';
                }
                x += '</table>';
                if (x != '') { sections.push({ name: "Pil", html: x, img: 'battery'}); }
            }
            ...
            if (hardware.windows) {
                if (hardware.windows.memory && (hardware.windows.memory.length > 0)) {
                    ...
                    for (var i in hardware.windows.memory) {
                        ...
                        if (m.Capacity && m.Speed) { x += addDetailItem("Kapasite / Hız", format("{0} Mb, {1} Mhz", (m.Capacity / 1024 / 1024), m.Speed), s); }
                        else if (m.Capacity) { x += addDetailItem("Kapasite", format("{0} Mb", (m.Capacity / 1024 / 1024)), s); }
                    ...
                    if (x != '') { sections.push({ name: "Bellek", html: x, img: 'ram' }); }
                }
            }
            ...
            if (hardware.linux) {
                if (hardware.linux.memory && (hardware.linux.memory.Memory_Device.length > 0)) {
                    ...
                    for (var i in hardware.linux.memory.Memory_Device) {
                        ...
                        if (m.Size && m.Speed) { x += addDetailItem("Kapasite / Hız", format("{0}, {1}", m.Size, m.Speed), s); }
                        else if (m.Size) { x += addDetailItem("Kapasite", format("{0}", (m.Size)), s); }
                        if (m.PartNumber) { x += addDetailItem("Parça Numarası", EscapeHtml((m.Manufacturer && m.Manufacturer != 'Undefined')?(m.Manufacturer + ', '):'') + EscapeHtml(m.PartNumber), s); }
                        x += '</div>';
                    }
                    x += '</table>';
            ...
            if (hardware.darwin) {
                if (hardware.darwin.memory && (hardware.darwin.memory.length > 0)) {
                    ...
                    for (var i in hardware.darwin.memory) {
                        ...
                        if (m.PartNumber) { x += addDetailItem("Parça Numarası", EscapeHtml((m.Manufacturer && m.Manufacturer != '')?(m.Manufacturer + ', '):'') + EscapeHtml(m.PartNumber), s); }
                        x += '</div>';
                    }
                    x += '</table>';
                    if (x != '') { sections.push({ name: "Bellek", html: x, img: 'ram'}); }
            ...
            if (hardware.identifiers && ident.storage_devices) {
                ...
                for (var i in ident.storage_devices) {
                    ...
                    if (m.Size) {
                        ...
                        if(hardware.windows && hardware.windows.drives && m.Model){
                            ...
                            if(foundObject) x += addDetailItem("Durum", EscapeHtml(foundObject.Status), s);
                        }
                        x += '</div>';
                    }
                }
                ...
                if (x != '') { sections.push({ name: "Depolama", html: x, img: 'storage' }); }
            }
            ...
            if (hardware.windows && hardware.windows.volumes) {
                ...
                for (var i in hardware.windows.volumes) {
                    ...
                    if (m.size) {
                        ...
                        x += addDetailItem("Kapasite", EscapeHtml(fsize), s);
                    }
                    if (m.sizeremaining) {
                        var sizes = ['Bytes', 'KB', 'MB', 'GB', 'TB'];
                        ...
                        x += addDetailItem("Kalan Kapasite", EscapeHtml(fsize), s);
                    }
                    if (m.type) {
                        var type = (m.removable == true ? "Removable" : (m.cdrom == true ? "CD-ROM" : ''));
                        x += addDetailItem("File System", (type != '' ? (type + ' / ') : '') + (m.type == 'Unknown' ? "Bilinmeyen" : EscapeHtml(m.type)), s);
                    }

                    if (m.protectionStatus || m.volumeStatus) {
                        var bitlockerState = [];
                        if (m.protectionStatus) bitlockerState.push("Etkin");
            ...
            if (hardware.darwin && hardware.darwin.volumes) {
                ...
                for (var i in hardware.darwin.volumes) {
                    ...
                    x += '<div style=margin-bottom:3px><b>' + m.mount_point + '</b></div>';
                    if (m.size) {
                        x += addDetailItem("Kapasite", EscapeHtml(m.size), s);
                    }
                    if (m.available) {
                        x += addDetailItem("Kalan Kapasite", EscapeHtml(m.available), s);
                    }
                    if (m.type) {
                        var type = (m.removable == true ? "Removable" : (m.cdrom == true ? "CD-ROM" : ''));
                        x += addDetailItem("File System", (type != '' ? (type + ' / ') : '') + (m.type == 'Unknown' ? "Bilinmeyen" : EscapeHtml(m.type)), s);
        ...
        function deviceDetailsShowBitlockerInfo(drive, identifier, password) {
            if (xxdialogMode) return false;
            var x = '<div><p>' + "Tanımlayıcı" + '</p><p style=user-select:text;font-weight:bold>' + (identifier ? decodeURIComponent(identifier) : "Bilinmeyen") + '</p>';
            x += '<p>' + "Recovery Password" + '</p><p style=user-select:text;font-weight:bold>' + (password ? decodeURIComponent(password) : "Bilinmeyen") + '</p></div>';
        ...
        */
        ...
        function setupConsole() {
            ...
            if ((rights & 16) != 0) {
                ...
                var onlineText = ((consoleNode.conn & 1) != 0) ? "Agent çevrimiçi" : "Agent çevrimdışı"
                if ((consoleNode.conn & 16) != 0) { onlineText += ", MQTT çevrimiçi" }
                ...
                QH('p15statetext', "Erişim reddedildi");
        ...
        function p15consoleSend(e) {
            ...
            if (((consoleNode.conn & 16) != 0) && (Q('p15outputselect').value == 2)) {
                ...
                t = '<div style=color:violet>' + "İTMEK" + '&gt; ' + EscapeHtml(v) + '<br/></div>';
                consoleNode.consoleText += t;
        ...
        function p15uploadCore(e) {
            ...
            if (e.shiftKey == true) { meshserver.send({ action: 'uploadagentcore', nodeid: consoleNode._id, type: 'default' }); } // Upload default core
                ...
                var htmlValue = '<select id=d3coreMode style=width:230px>' +
                    '<option value=1>' + "Varsayılan sunucu çekirdeğini gönderin" + '</option>' +
                    '<option value=2>' + "Çekirdeği temizleyin" + '</option>' +
                    '<option value=3>' + "Çekirdek dosya gönder" + '</option>' +
                    '<option value=4>' + "Agent bağlantısını kes" + '</option>' +
                    '<option value=5>' + "Agent bağlantısını zorla kes" + '</option>' +
                    '<option value=6>' + "Kurtarma çekirdeğini gönder" + '</option>' +
                    '<option value=7>' + "Küçük çekirdek yükleyin" + '</option>' +
                    '<option value=8>' + "Restart agent service" + '</option>' +
                    '<option value=9>' + "Aracı güncellemesini zorla" + '</option></select>';
                setDialogMode(2, "Agent İşlemi Gerçekleştir", 3, p15uploadCoreEx, addHtmlValue("İşlem", htmlValue));
            }
        }
        ...
        function p15uploadCore2() {
            ...
            Q('d3auth').value = authCookie;
            Q('d3attrib').value = currentNode._id;
            setDialogMode(4, "Mesh Agent Çekirdeğini Gönder", 3, p15uploadCoreEx2);
            d3init();
        }
        ...
        function p20updateMesh() {
            ...
            if (currentMesh.mtype == 3) { if (currentMesh.relayid == null) { meshtype = "Yerel cihazlar, aracı yok"; } else { meshtype = "Aracı aracılığıyla aktarılan hiçbir aracı cihazı yok"; } }
            if (currentMesh.mtype == 4) { if (currentMesh.relayid == null) { meshtype = "IP-KVM cihazı"; } else { meshtype = "Aracı aracılığıyla aktarılan IP-KVM cihazı"; } if (currentMesh.kvm.model == 1) { meshtype += ', ' + 'Raritan KX III'; } }
            ...
            x += addHtmlValue("Yazı", meshtype);
            //x += addHtmlValue('Identifier', currentMesh._id.split('/')[2]);

            // Display the relay device if applicable
            if (((currentMesh.mtype == 3) || (currentMesh.mtype == 4)) && (currentMesh.relayid != null)) {
                var relayName = '<i>' + "Bilinmeyen" + '</i>';
                var relayNode = getNodeFromId(currentMesh.relayid);
                if (relayNode != null) { relayName = EscapeHtml(relayNode.name); }
                x += addHtmlValue("Röle Cihazı", addLinkConditional(relayName, 'p20editmeshrelay()', (meshrights & 1) != 0));
            }

            // Display IP-KVM information if needed
            if (currentMesh.mtype == 4) {
                x += addHtmlValue("Ana bilgisayar adı", currentMesh.kvm.host);
                x += addHtmlValue("Kullanıcı adı", currentMesh.kvm.user);
            }

            x += '<br><input type=button value="' + "Notlar" + '" onclick=showNotes(false,"' + encodeURIComponent(currentMesh._id) + '") />';

            x += '<br style=clear:both><br>';
            var currentMeshLinks = currentMesh.links[userinfo._id];
            if (currentMeshLinks && ((currentMeshLinks.rights & 2) != 0)) { x += '<div style=margin-bottom:6px;float:left;margin-right:10px><a onclick=p20showAddMeshUserDialog() style=cursor:pointer><img src=images/icon-addnew.png border=0 height=12 width=12> ' + "Kullanıcı Ekle" + '</a></div>'; }

            if (navigator.userAgent.toLowerCase().indexOf('android') >= 0) {
                x += '<div style=margin-bottom:6px;float:left;margin-right:10px><a onclick=p20installAndroidDialog() style=cursor:pointer><img src=images/icon-addnew.png border=0 height=12 width=12> ' + "Bu cihaza yükle" + '</a></div>';
            }
        ...
        function p20showDeleteMeshDialog() {
            if (xxdialogMode) return false;
            var x = format("{0} grubunu silmek istediğinizden emin misiniz? Cihaz grubunun silinmesi, bu grup içindeki cihazlar hakkındaki tüm bilgileri de silecektir.", EscapeHtml(currentMesh.name)) + '<br /><br />';
            x += '<label><input id=p20check type=checkbox onchange=p20validateDeleteMeshDialog() />' + "Onayla" + '</label>';
        ...
        function p20editmeshrelay() {
            ...
            if (relayDevices.length == 0) {
                ...
                setDialogMode(2, "Cihaz Grubunu Düzenle", 1, null, "Röle cihazı mevcut değil.");
            } else {
                var relayDevices2 = [];
                ...
                var x = addHtmlValue("Röle Cihazı", '<div style=width:170px><select id=d2devrelay style=width:100%>' + relayDevices2.join('') + '</select></div>');
                setDialogMode(2, "Cihaz Grubunu Düzenle", 3, p20editmeshrelayEx, x);
            }
        }
        ...
        function p20installAndroidDialog() {
            if (xxdialogMode) return;
            var x = '<div style=text-align:center><p>' + "MeshCentral Agent'ı Android cihazınıza yükleyin. Kurulduktan sonra, cihazınızı bu sunucuya bağlamak için eşleştirme bağlantısını tıklayın." + '</p>';
            ...
            x += '<p><a href="' + serverinfo.magenturl + ',' + serverinfo.agentCertHash + ',' + currentMesh._id.split('/')[2] + '"><b>' + "Cihaz Eşleştirme Bağlantısı" + '</b></a></p></div>';
            setDialogMode(2, "Android Kurulumu", 1, null, x);
        }
        ...
        function p20showAddMeshUserDialog() {
            ...
            x += '<label><input type=checkbox onchange=p20validateAddMeshUserDialog() id=p20managecomputers>' + "Cihaz Grubu Bilgisayarlarını Yönetin" + '</label><br>';
            ...
            x += '<label><input type=checkbox onchange=p20validateAddMeshUserDialog() id=p20meshagentconsole>' + "Mesh Aracı Komut Satırı" + '</label><br>';
            x += '<label><input type=checkbox onchange=p20validateAddMeshUserDialog() id=p20meshserverfiles>' + "Sunucu Dosyaları" + '</label><br>';
            x += '<label><input type=checkbox onchange=p20validateAddMeshUserDialog() id=p20wakedevices>' + "Cihazları Uyandır" + '</label><br>';
            ...
            x += '<label><input type=checkbox onchange=p20validateAddMeshUserDialog() id=p20uninstall>' + "Agent'ı Kaldır" + '</label><br>';
            x += '<label><input type=checkbox onchange=p20validateAddMeshUserDialog() id=p20commands>' + "Uzaktan Komutlar" + '</label><br>';
            x += '<label><input type=checkbox onchange=p20validateAddMeshUserDialog() id=p20resetoff>' + "Sıfırla / Kapat" + '</label><br>';
            x += '</div>';
        ...
        function p20viewuser(userid) {
            ...
            if (meshrights == 0xFFFFFFFF) r.push("Tam Yönetici"); else {
                ...
                if ((meshrights & 4) != 0) r.push("Cihaz Grubu Bilgisayarlarını Yönetin");
                if ((meshrights & 8) != 0) r.push("Uzaktan kumanda");
                if ((meshrights & 16) != 0) r.push("Agent Komut Satırı");
                if ((meshrights & 32) != 0) r.push("Sunucu Dosyaları");
                if ((meshrights & 64) != 0) r.push("Cihazları Uyandır");
                ...
                if ((meshrights & 131072) != 0) r.push("Komutlar");
                if ((meshrights & 262144) != 0) r.push("Sıfırla / Kapat");
            }
        ...
        function drawNotifications() {
            ...
            if (notifications.length == 0) {
                r = '<div style=margin:5px>' + "Şu anda bildirim yok" + '</div>';
            } else {
                for (var i in notifications) {
                    ...
                    r += '<div title="' + format("{0} tarihinde gerçekleşti", printDateTime(d)) + '" id="notifyx' + n.id + '" class=notification style="cursor:pointer;border-top:1px solid ' + ((r == '') ? 'transparent' : 'orange') + '">';
                    if (icon) { r += '<div class=j' + icon + ' onclick="notificationSelected(' + n.id + ')" style=margin:5px;float:left></div>'; }
                    r += '<div onclick="notificationDelete(' + n.id + ')" class=unselectable title="' + "Bu bildirimi temizle" + '" style=margin:5px;float:right;color:orange><b>X</b></div><div onclick="notificationSelected(' + n.id + ')" style=margin:5px>' + t + EscapeHtml(n.text) + '</div><div style=margin-left:5px;margin-bottom:5px;color:gray;font-size:10px>' + printDateTime(d) + '</div></div>';
                }
            }
            var deleteall = '';
            if (notifications.length > 1) { deleteall = '<div id="notifyRemoveAll" onclick="deleteAllNotifications()" style="cursor:pointer;border-top:1px solid orange;margin:5px;color:orange;text-align:right;padding-right:3px">' + "Hepsini temizle" + '</div>'; }
        ...
        function addNotification(n) {
            ...
            var translatedMessages = [
                ...
                "Geçersiz e-posta",
                "Geçersiz alan",
                "Geçersiz site izinleri",
                "Kullanıcı zaten var",
                "Bu modda kullanıcı eklenemiyor",
                "Doğrulama istisnası",
                "Hesap sınırına ulaşıldı.", // 10
                "Sohbet İsteği, Kabul etmek için buraya tıklayın.",
                "Son girişten bu yana bu hesapta {0} başarısız giriş denemesi oldu.",
                "E-posta adresi değiştirilemedi, başka bir hesap zaten kullanıyor: {0}.",
                "E-posta gönderildi.",
                "{0} kullanıcısı bulunamadı.",
                "{0} kullanıcıları bulunamadı.",
                "Hata, daha önce kullanılan parolaya geçilemiyor.",
                "Hata, yaygın olarak kullanılan parolaya geçilemiyor.",
                "Hata, şifre değiştirilmedi.",
                "Şifre değişti.", // 20
                "Mevcut şifre doğru değil.",
                "Hata, davet kodu \"{0}\" zaten kullanılıyor.",
                "SMS ağ geçidi etkinleştirilmedi",
                "Kullanıcı yönetimi hakları yok",
                "Geçersiz SMS mesajı",
                "Bu kullanıcı için telefon numarası yok",
                "SMS başarıyla gönderildi.",
                "SMS hatası",
                "SMS hatası: {0}",
                "E-posta alan adı \"{0}\" izin verilmez. Yalnızca ({1}) izin verilir" // 30
            ];
