<!DOCTYPE html><html lang="it" dir="ltr" xmlns="http://www.w3.org/1999/xhtml"><head>
    ...
    <div id="LeftSideToolBar" style="display:none;position:absolute;left:0;bottom:0;width:52px;top:0;background:#113962;background:linear-gradient(to bottom, #104893 0%,#113962 100%);color:white;border-right: 5px solid #BBB;">
        ...
        <div id="LeftMenuTerminal" class="slbbutton" title="Terminale" onclick="go(12)">
            <div class="slb2" style="position:absolute;top:6px;left:6px"></div>
        </div>
        <div id="LeftMenuFiles" class="slbbutton" title="File" onclick="go(13)">
        ...
        <div id="deskarea0">
            <div id="deskarea1" class="areaHead" style="line-height:24px">
                <div class="toright2">
                    ...
                    <div class="deskareaicon" title="Attiva/disattiva modalità di visualizzazione" onclick="toggleAspectRatio(1)">⇲</div>
                    <div class="deskareaicon" title="Ruota a sinistra" onclick="drotate(-1)">↺</div>
                    <div class="deskareaicon" title="Ruota a destra" onclick="drotate(1)">↻</div>
                    <input id="deskActionsSettings" type="button" value="impostazioni..." title="Modifica le impostazioni del desktop remoto" onkeypress="return false" onkeydown="return false" onclick="showDesktopSettings()" class="mR">
                    <div id="desktopCustomUiButtons" style="float:left"></div>
                    <div id="deskRecordIcon" class="deskareaicon" title="Il server sta registrando questa sessione" style="display:none;background-color:red;width:12px;height:12px;border-radius:6px;margin-top:5px"></div>
                </div>
                <div>
                    <div id="idx_deskFullBtn2" onclick="deskToggleFull(event)">&nbsp;✖</div>
                    <input type="button" id="autoconnectbutton1" value="Connessione automatica" onclick="autoConnectDesktop(event)" onkeypress="return false" onkeydown="return false" style="display:none">
                    <span id="connectbutton1span"><input type="button" id="connectbutton1" cmenu="deskConnectButton" value="Connetti" onclick="connectDesktop(event,3)" onkeypress="return false" onkeydown="return false" disabled="disabled"></span>
                    <span id="connectbutton1hspan">&nbsp;<input type="button" id="connectbutton1h" value="HW Connect" title="Connettiti utilizzando l'hardware Intel AMT KVM" onclick="connectDesktop(event,2)" onkeypress="return false" onkeydown="return false" disabled="disabled"></span>
                    <span id="disconnectbutton1span">&nbsp;<input type="button" id="disconnectbutton1" value="Disconnetti" onclick="connectDesktop(event,0)" onkeypress="return false" onkeydown="return false"></span>
                    &nbsp;<span id="deskstatus">Disconnesso</span><span id="deskmetadata"></span>
                </div>
            </div>
            ...
            <div id="deskarea4" class="areaFoot" style="min-height:24px">
                <div class="toright2">
                    <span id="DeskLatency" style="line-height:22px;width:50px" title="Latenza della sessione desktop"></span>
                    <span id="DeskTimer" style="line-height:22px" title="Orario della sessione"></span>&nbsp;
                    ...
                    <span id="DeskSaveImageButton" title="Salva uno screenshot del desktop remoto"><img src="images/icon-camera.png" onclick="deskSaveImage()" height="16" width="16" style="padding-top:2px"></span>
                </div>
                <div style="height:22px">
                    ...
                    <input id="DeskWD" type="button" value="Invia" onkeypress="return false" onkeydown="return false" onclick="deskSendKeys()">
                    <input id="DeskClip" style="" type="button" value="Appunti" onkeypress="return false" onkeydown="return false" onclick="showDeskClip()">
                    <input id="DeskType" style="" type="button" value="Digita" onkeypress="return false" onkeydown="return false" onclick="showDeskType()">
                    <label><span id="DeskControlSpan" title="Attiva/disattiva input da mouse e tastiera"><input id="DeskControl" type="checkbox" onkeypress="return false" onkeydown="return false" onclick="toggleKvmControl()">Ingresso</span></label>&nbsp;
                </div>
            </div>
        </div>
    </div>
    <div id="p12" class="noselect" style="overflow:hidden;position:absolute;left:54px;top:0;right:0;bottom:0;display:none;background-color:black">
        <div id="p12warning" onclick="showFeaturesDlg()">
            <div class="icon2"></div>
            <div class="warningbox">La porta di reindirizzamento Intel® AMT o la funzione KVM è disabilitata<span id="p12warninga">, fare clic qui per abilitarlo.</span></div>
        </div>
        <div id="p12warning2" onclick="showPowerActionDlg()">
            <div class="icon2"></div>
            <div class="warningbox">Il computer remoto non è acceso, fare clic qui per inviare un comando di alimentazione.</div>
        </div>
        <div class="areaHead" style="position:absolute;top:0;left:0;right:0;height:24px">
            <div class="toright2">
                <div id="termRecordIcon" class="deskareaicon" title="Il server sta registrando questa sessione" style="display:none;background-color:red;width:12px;height:12px;border-radius:6px;margin-top:5px;margin-left:5px"></div>
                <div id="p12power" style="margin-top:3px;margin-right:4px;float:right"></div>
            </div>
            <div>
                <span id="connectbutton2span"><input type="button" id="connectbutton2" cmenu="termConnectButton" value="Connetti" onclick="connectTerminal(event,1)" onkeypress="return false" onkeydown="return false" disabled="disabled"></span>
                <span id="disconnectbutton2span">&nbsp;<input type="button" id="disconnectbutton2" value="Disconnetti" onclick="connectTerminal(event,0)" onkeypress="return false" onkeydown="return false"></span>
                &nbsp;<span id="termstatus">Disconnesso</span><span id="termtitle"></span>
            </div>
        </div>
        ...
        <div class="areaFoot" style="position:absolute;bottom:0;left:0;right:0;height:24px">
            <div class="toright2">
                <span id="TermLatency" title="Latenza sessione terminale"></span>
                <span id="TermTimer" title="Orario della sessione"></span>&nbsp;
                <span id="terminalSettingsButtons" style="display:none">
                    <input id="id_tcrbutton" type="button" onkeypress="return false" onkeydown="return false" class="bottombutton" value="CR+LF" title="Attiva/disattiva ciò che invierà la chiave di ritorno" onclick="termToggleCr()">
                    <input id="id_tfxkeysbutton" type="button" onkeypress="return false" onkeydown="return false" class="bottombutton" value="Intel (F10 = ESC + [OM)" title="Commuta il tipo di emulazione dei tasti da F1 a F10" onclick="termToggleFx()">
                    <input id="id_ttypebutton" type="button" onkeypress="return false" onkeydown="return false" class="bottombutton" value="Ascii esteso" title="Attiva/disattiva il tipo di emulazione di terminale" onclick="termToggleType()">
                </span>
                ...
                <span id="specialKeyDropDown">
                    ...
                    <input id="specialkeylistinput" type="button" onkeypress="return false" class="bottombutton" value="Invia" title="Invia la chiave speciale selezionata" onclick="sendSpecialKey()">
                </span>
            </div>
            <div>
                &nbsp;
                ...
                <input type="button" onkeypress="return false" onkeydown="return false" class="bottombutton" id="bsbutton" value="Tornare  indietro" onclick="termSendKey(8,'bsbutton')" style="display:none">
                <input type="button" onkeypress="return false" onkeydown="return false" class="bottombutton" id="pastebutton" value="Incolla" title="Incolla il testo nel terminale" onclick="showTermPasteDialog()" style="display:none">
            </div>
        </div>
    ...
    <div id="p13" class="noselect" style="overflow:hidden;position:absolute;left:54px;top:0;right:0;bottom:0;display:none;background-color:white">
        <div id="p13toolbar" style="position:absolute;left:0;top:0;right:0;bottom:28px">
            <div class="areaHead">
                <div class="toright2">
                    <div id="filesRecordIcon" class="deskareaicon" title="Il server sta registrando questa sessione" style="display:none;background-color:red;width:12px;height:12px;border-radius:6px;margin-top:5px;margin-left:5px"></div>
                    <div id="p13power" style="margin-top:3px;margin-right:4px;float:right"></div>
                </div>
                <div>
                    <input id="p13Connect" value="Connetti" onclick="connectFiles(event)" type="button">
                    &nbsp;<span id="p13Status">Disconnesso</span>
                </div>
            </div>
            <div id="fileArea2" class="areaHead2" valign="bottom">
                <div id="p13rightOfButtons" class="toright2"></div>
                <div>
                    <input type="button" id="p13FolderUp" disabled="disabled" onclick="p13folderup()" value="Su">&nbsp;
                    <input type="button" id="p13SelectAllButton" disabled="disabled" onclick="p13selectallfile()" value="Seleziona tutto">&nbsp;
                    <input type="button" id="p13RenameFileButton" disabled="disabled" value="Rinominare" onclick="p13renamefile()">&nbsp;
                    <input type="button" id="p13DeleteFileButton" disabled="disabled" value="Elimina" onclick="p13deletefile()">&nbsp;
                    <input type="button" id="p13ViewFileButton" disabled="disabled" value="modificare" onclick="p13viewfile()">&nbsp;
                    <input type="button" id="p13NewFolderButton" disabled="disabled" value="Nuova cartella" onclick="p13createfolder()">&nbsp;
                    <input type="button" id="p13UploadButton" disabled="disabled" value="Caricare" onclick="p13uploadFile()">&nbsp;
                    <input type="button" id="p13CutButton" disabled="disabled" value="Taglia" onclick="p13copyFile(1)">&nbsp;
                    <input type="button" id="p13CopyButton" disabled="disabled" value="Copia" onclick="p13copyFile(0)">&nbsp;
                    <input type="button" id="p13PasteButton" disabled="disabled" value="Incolla" onclick="p13pasteFile()">&nbsp;
                    <input type="button" id="p13ZipButton" disabled="disabled" value="Zip" onclick="p13zipFiles()">&nbsp;
                    <input type="button" id="p13RefreshButton" disabled="disabled" value="ricaricare" onclick="p13folderup(9999)">&nbsp;
                    <input type="button" id="p13FindButton" disabled="disabled" value="Trova" onclick="p13findfile()">&nbsp;
                </div>
            </div>
    ...
    <div id="dialog" class="noselect" style="display:none">
        ...
        <div id="dialogBody">
            ...
            <div id="dialog4" style="">
                <input id="d4WrapButton" type="button" value="Avvolgere " onclick="d4ToggleWrap()">
                <input id="d4SizeButton" type="button" value="Piccolo" onclick="d4ToggleSize()">
                <input id="d4EncodingButton" type="button" value="Crudo" onclick="d4ToggleEncoding()">
            ...
            <div id="dialog7" style="">
                <div id="d7meshkvm">
                    <h4>Agente Desktop Remoto</h4>
                    <div>
                        <div>Qualità</div>
                        <select id="d7bitmapquality" dir="rtl"></select>
                    </div>
                    <div>
                        <div>Ridimensionamento</div>
                    ...
                    <div>
                        <div>Frequenza dei fotogrammi</div>
                    ...
                    <div id="d7desktopOtherSettings">
                        ...
                        <div id="d7otherset2" style="display:block">
                            <label style="display:block"><input type="checkbox" id="d7deskSwapMouse">Scambia i pulsanti del mouse</label>
                            <label style="display:block"><input type="checkbox" id="d7deskRemoteKeyMap">Usa mappa tastiera remota </label>
                        </div>
                    </div>
                </div>
                <div id="d7amtkvm">
                    ...
                    <div>
                        <div>Codifica delle immagini</div>
                    ...
                    <div>
                        ...
                        <div id="d7otherset" style="display:block">
                            <label style="display:block"><input type="checkbox" id="d7showfocus">Mostra strumento di messa a fuoco</label>
                            <label style="display:block"><input type="checkbox" id="d7showcursor">Mostra cursore del mouse locale</label>
                            <label style="display:block"><input type="checkbox" id="d7localKeyMap">Mappa della tastiera locale</label>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div id="idx_dlgButtonBar">
            <input id="idx_dlgCancelButton" type="button" value="Annulla" style="" onclick="dialogclose(0)">
    ...
    <script>
                    ...
                    desktop.m.onKvmData = function (x) {
                        ...
                        if ((data != null) && (data.action != null)) {
                            if (data.action == 'restart') {
                                ...
                                webRtcDesktop.webchannel = webRtcDesktop.webrtc.createDataChannel("Canale Dati", {}); // { ordered: false, maxRetransmits: 2 }
        ...
        function updateMetadata(conn, elementid) {
            ...
            if (conn && (conn.State == 3)) {
                ...
                if (viewerCount > 1) { str = '<span onclick=showSessionMetadata(1) style=cursor:pointer>' + format(", {0} guardando", viewerCount) + '</span>'; }
            }
            QH('deskmetadata', str);
        ...
        function showSessionMetadata(cid) {
            ...
            if (conn && conn.metadata) {
                var x = '';
                if (conn.metadata.startTime) { x += addHtmlValue4("Ora di inizio", printDateTime(new Date(conn.metadata.startTime))); }
                if (conn.metadata.users) {
                    for (var i in conn.metadata.users) {
                        var val = (conn.metadata.users[i] == 1) ? "1 connessione" : format("{0} connessioni", conn.metadata.users[i]);
                        var username = i.split('/')[2];
                        if ((users != null) && (users[i] != null)) { username = users[i].name; }
                        x += addHtmlValue4(format("Utente \"{0}\" ", username), val);
                    }
                }
                setDialogMode(2, "Informazioni sulla sessione", 1, null, x, 'sessionMetadata' + cid);
            }
        }
        ...
        function showDeskType() {
            if (xxdialogMode || desktop == null || desktop.State != 3) return;
            Q('DeskType').blur();
            var x = '<div>' + "Immettere il testo e fare clic su OK per digitarlo in remoto utilizzando una tastiera inglese americana. Assicurarsi di posizionare il cursore remoto nella posizione corretta prima di procedere." + '<div>';
            x += '<textarea id=d2typeText style="margin-top:5px;width:100%;height:184px;resize:none" maxlength=2000></textarea>';
            setDialogMode(2, "Immissione da tastiera remota", 3, showDeskTypeEx, x);
            Q('d2typeText').focus();
        }
        ...
        */
        ...
        function showTermPasteDialog() {
            if (!terminal || xxdialogMode) return;
            Q('pastebutton').blur();
            setDialogMode(2, "Incolla", 3, showTermPasteDialogEx, '<textarea id=d2pasteText style="width:100%;height:184px;resize:none"></textarea>');
            Q('d2pasteText').focus();
        }
        ...
        function onFilesStateChange(xfiles, state) {
            p13Connect.value = (state == 0) ? "Connetti" : "Disconnetti";
        ...
        function p13gotFiles(data) {
            ...
            if (data.action == 'findfile') {
                if (xxdialogTag == data.reqid) {
                    if (data.r == null) {
                        ...
                        xxdialogTag = null;
                        if (Q('d2findResults').innerHTML == '') { QH('d2findResults', '<div style=text-align:center;margin:10px><i>' + "Nessun file trovato " + '</i></div>'); }
                    } else {
            ...
            if (data.action == 'dialogmessage') {
                if ((data.msg == null) && (xxdialogTag == 'fileMsgDialog')) {
                    ...
                    setDialogMode(2, "Operazione sui file", 10, p13fileOperationDialogEx, '<div style=margin:10px>' + "Compressione dei file ..." + '<div>', 'fileMsgDialog');
                } else if ((data.msg == 'zippingFile') && ((!xxdialogMode) || (xxdialogTag == 'fileMsgDialog'))) {
                    // Show the dialog box message
                    setDialogMode(2, "Operazione sui file", 10, p13fileOperationDialogEx, '<div style=margin:10px>' + EscapeHtml(data.file) + '<div><br /><progress value=' + EscapeHtml(data.progress) + ' style=width:100% max=100 />', 'fileMsgDialog');
                }
                return;
            }
        ...
        function p13findfile() {
            if (xxdialogMode) return;
            var x = addHtmlValue("Filtro", '<input id=d2findFilter style="width:230px" onkeyup=p13findfileValidate() onkeydown=p13findfileDown(event) placeholder="*.txt"></input>');
            ...
            x += '<div style=margin-top:8px><input id=filefind_dlgCancelButton type=button value=' + "Chiudere" + ' style=float:right;width:80px;margin-left:5px onclick=p13findfileCancel()>';
            x += '<input id=filefind_dlgOkButton type=submit value=' + "Ricerca" + ' style=float:right;width:80px onclick=p13findfileEx()><br /><br /></div>';
            setDialogMode(2, "Trova file", 0, null, x);
            p13findfileValidate();
            Q('d2findFilter').focus();
        }

        function p13findfileDown(e) { if (e.code == "accedere") { p13findfileEx(); } }
        ...
        function p13setActions() {
            ...
            if (p13filetree == null) {
                ...
                Q('p13SelectAllButton').value = "Seleziona tutto";
                ...
                Q('p13SelectAllButton').value = (cc > 0 ? "Non selezionare niente" : "Seleziona tutto");
        ...
        function p13zipFiles() {
            ...
            setDialogMode(2, "Zip nome file ", 3, p13zipFilesEx, '<input type=text id=p13renameinput maxlength=64 onkeyup=p13fileNameCheck(event) style=width:100% value="" />', { action: 'zip', path: p13filetreelocation.join('/'), files: inputFiles });
        ...
        function p13downloadfile(x, y, z, tag) {
            ...
            setDialogMode(2, "Scarca  File", 10, p13downloadFileCancel, '<div>' + gdownloadFile.file + '</div><br /><progress id=d2progressBar style=width:100% value=0 max=' + z + ' />');
        }
        ...
        function d4ToggleWrap(update) {
            ...
            Q('d4WrapButton').value = ["Avvolgi: ON ", "Avvolgere: OFF "][d4EditWrapVal];
        ...
        function d4ToggleSize(update) {
            ...
            Q('d4SizeButton').value = ["Dimensione: 100%", "Dimensione: 125%", "Dimensione: 150%", "Dimensione: 200%"][d4EditSizeVal];
        ...
        function d4ToggleEncoding(update) {
            ...
            Q('d4EncodingButton').value = ["Codifica: RAW","Codifica: UTF8"][d4EditEncodingVal];
        ...
        function printFlexDateTime(d) { if (printDate(new Date()) == printDate(d)) { return format("Scade alle {0}", printTime(d)); } else { return format("Scade il {0}", printDateTime(d)); } }
        function getFileSizeStr(size) { if (typeof size != 'number') { size = 0; } if (size == 1) return "1 byte"; return format("{0} byte", size); }
