<!DOCTYPE html><html lang="bs"><head>
    ...
    {{{customJSTags}}}
    <title>Instalacija agenta</title>
    <style>
        .tab {
            overflow: hidden;
        ...
        <div id="column_l" style="overflow-y:auto">
            ...
            <div>
                <div class="tab">
                    ...
                    <button id="tlinuxbinarytab" class="tablinks" onclick="openTab(event, 'linuxbinarytab')">Linux / BSD / macOS binarni instalacijski program</button>
                    ...
                    <button id="tassistab" class="tablinks" onclick="openTab(event, 'assistab')">Asistent</button>
                </div>

                <div id="wintab64" class="tabcontent" style="background-color:white;color:black">
                    <h3>Microsoft™ Windows 64bit</h3>
                    <p><a id="win64url">Preuzmite softver ovdje</a>, pokrenite ga i pritisnite "Instaliraj" ili "Poveži".</p>
                ...
                <div id="wintab32" class="tabcontent" style="background-color:white;color:black">
                    ...
                    <p><a id="win32url">Preuzmite softver ovdje</a>, pokrenite ga i pritisnite "Instaliraj" ili "Poveži".</p>
                    <div style="text-align:center">
                ...
                <div id="wintabarm64" class="tabcontent" style="background-color:white;color:black">
                    ...
                    <p><a id="winarm64url">Preuzmite softver ovdje</a>, pokrenite ga i pritisnite "Instaliraj" ili "Poveži".</p>
                    <div style="text-align:center">
                ...
                <div id="linuxtab" class="tabcontent" style="background-color:white;color:black">
                    <h3>Linux</h3>
                    <p>Da biste instalirali, izrežite i zalijepite sljedeću naredbu u root terminal.</p>
                    <div id="linuxinstall" style="font-family:courier,'courier new',monospace;margin-left:30px"></div>
                    <input type="button" value="Kopirati u clipboard" style="margin-left:30px;margin-top:4px" onclick="copyToClipLinuxInstall()">
                    <p>Da biste deinstalirali, izrežite i zalijepite sljedeću naredbu kao root.</p>
                    <div id="unlinuxinstall" style="font-family:courier,'courier new',monospace;margin-left:30px"></div>
                    <input type="button" value="Kopirati u clipboard" style="margin-left:30px;margin-top:4px" onclick="copyToClipLinuxUnInstall()">
                    <br><br>
                </div>
                ...
                <div id="macostab64" class="tabcontent" style="background-color:white;color:black">
                    ...
                    <p><a id="macos64url">Preuzmite instalater ovdje</a>, kliknite desnim tasterom miša na njega ili pritisnite "control" i kliknite na datoteku. Zatim odaberite "Otvori" i slijedite upute.</p>
                    <div style="text-align:center">
                ...
                <div id="macostabarm64" class="tabcontent" style="background-color:white;color:black">
                    ...
                    <p><a id="macosarm64url">Preuzmite instalater ovdje</a>, kliknite desnim tasterom miša na njega ili pritisnite "control" i kliknite na datoteku. Zatim odaberite "Otvori" i slijedite upute.</p>
                    <div style="text-align:center">
                ...
                <div id="macostab" class="tabcontent" style="background-color:white;color:black">
                    ...
                    <p><a id="macosurl">Preuzmite instalater ovdje</a>, kliknite desnim tasterom miša na njega ili pritisnite "control" i kliknite na datoteku. Zatim odaberite "Otvori" i slijedite upute.</p>
                    <div style="text-align:center">
                ...
                <div id="androtab" class="tabcontent" style="background-color:white;color:black">
                    ...
                    <div style="min-height:220px">
                        <p>Preuzmite softver agenta koristeći Google Play prodavnicu ili APK datoteku, instalirajte ga i koristite QR kod s desne strane ili link za uparivanje ispod da postavite svoj uređaj na ovaj server.</p>
                        <p>
                        ...
                        <p>
                            <a rel="noreferrer noopener" target="_blank" href="{{{magenturl}}}">Link za uparivanje servera</a>
                        </p>
                    </div>
                </div>
                ...
                <div id="assistab" class="tabcontent" style="background-color:white;color:black">
                    ...
                    <div style="min-height:220px">
                        ...
                        <p>Asistent je alatka za Windows sistemsku paletu koja se može koristiti kada je pomoć potrebna. Ovo nije agent koji radi u pozadini upravljanog računara, već je alat koji se povezuje sa serverom samo kada se to zatraži.</p>
                        <p>
                            <a id="assisturl" rel="noreferrer noopener" target="_blank">Preuzmite Asistenta za Windows</a>
                        </p>
                    </div>
                    <br style="clear:both">
                </div>
    ...
    <script>
        ...
        function startup() {
            ...
            if (groupName != '') {
                QH('groupname', format("Instalacija udaljenog agenta za {0}", escapeHtml(groupName)));
                document.title = format("{0} - Instalacija agenta", groupName);
            } else {
                document.title = "Instalacija agenta";
            }
        ...
        function linuxBinarySetup() {
            var x = '<h3>' + "Linux / BSD / macOS binarni instalacijski program" + '</h3>', moreoptions = '';
            var opts = '<select id=aginsSelect onchange=addAgentToMeshClick() style=width:236px>';
            opts += '<option value=5 selected>' + "Linux / BSD / macOS binarni instalacijski program" + '</option>';
            opts += '</select>';
            ...
            x += addHtmlValue("Tip sistema", '<select id=aginsSysType onchange=addAgentToMeshClick() style=width:236px>' + moreoptions + '</select>');
            x += '</div>';
            x += '<div id=aginsTypeDiv>';
            x += addHtmlValue("Vrsta instalacije", '<select id=aginsType onchange=addAgentToMeshClick() style=width:236px><option value=0>' + "Pozadina i interaktivnost" + '</option><option value=2>' + "Samo pozadina" + '</option><option value=1>' + "Interaktivno samo" + '</option></select>');
            x += '</div><hr>';
            ...
            x += addHtmlValue("Mesh Agent", '<a id=aginsbinlnk name="meshagents?id=' + meshid + '&installflags=0' + (urlargs.key?('&key=' + urlargs.key):'') + '">' + "meshagent" + '</a> <img src=images/link4.png height=10 width=10 title="' + "Kopirajte URL agenta u međuspremnik" + '" style=cursor:pointer onclick=copyAgentUrl("meshagents?id=' + meshid + '&installflags=",1)>');
            x += addHtmlValue("Zapovjedi", '<input id=aginsbincmd type=text style="width:216px" readonly value=\'wget -O meshagent ' + ((serverNoProxy != 0) ?'--no-proxy':'') + ' --no-check-certificate \"https://' + servername + portStr + domainUrl + 'meshagents?id=' + meshid.split('$').join('%24').split('@').join('%40') + '\' /> <img src=images/link4.png height=10 width=10 title="' + "Kopirajte URL agenta u međuspremnik" + '" style=cursor:pointer onclick=copyAgentIdValue("aginsbincmd")>');
            x += '</div>';
            QH('linuxbinarytab', x);
            addAgentToMeshClick();
        }
