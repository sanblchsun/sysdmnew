<!DOCTYPE html><html lang="pl" dir="ltr" xmlns="http://www.w3.org/1999/xhtml"><head>
    ...
    <div id="LeftSideToolBar" style="display:none;position:absolute;left:0;bottom:0;width:52px;top:0;background:#113962;background:linear-gradient(to bottom, #104893 0%,#113962 100%);color:white;border-right: 5px solid #BBB;">
        <div id="LeftMenuDesktop" class="slbbutton slbbuttonsel2" title="Pulpit" onclick="go(11)">
        ...
        <div id="LeftMenuFiles" class="slbbutton" title="Pliki" onclick="go(13)">
        ...
        <div id="deskarea0">
            <div id="deskarea1" class="areaHead" style="line-height:24px">
                <div class="toright2">
                    ...
                    <div class="deskareaicon" title="Przełącznik Rozmieszczenia Podglądu" onclick="toggleAspectRatio(1)">⇲</div>
                    <div class="deskareaicon" title="Obróć w Lewo" onclick="drotate(-1)">↺</div>
                    <div class="deskareaicon" title="Obróć w Prawo" onclick="drotate(1)">↻</div>
                    <input id="deskActionsSettings" type="button" value="Ustawienia..." title="Edytuj ustawienia pulpitu zdalnego" onkeypress="return false" onkeydown="return false" onclick="showDesktopSettings()" class="mR">
                    <div id="desktopCustomUiButtons" style="float:left"></div>
                    <div id="deskRecordIcon" class="deskareaicon" title="Serwer nagrywa tę sesję" style="display:none;background-color:red;width:12px;height:12px;border-radius:6px;margin-top:5px"></div>
                </div>
                <div>
                    <div id="idx_deskFullBtn2" onclick="deskToggleFull(event)">&nbsp;✖</div>
                    <input type="button" id="autoconnectbutton1" value="AutoPołączenie" onclick="autoConnectDesktop(event)" onkeypress="return false" onkeydown="return false" style="display:none">
                    <span id="connectbutton1span"><input type="button" id="connectbutton1" cmenu="deskConnectButton" value="Połącz" onclick="connectDesktop(event,3)" onkeypress="return false" onkeydown="return false" disabled="disabled"></span>
                    <span id="connectbutton1hspan">&nbsp;<input type="button" id="connectbutton1h" value="Połączenie HW" title="Podłączenie za pomocą Intel AMT sprzętowym KVM" onclick="connectDesktop(event,2)" onkeypress="return false" onkeydown="return false" disabled="disabled"></span>
                    <span id="disconnectbutton1span">&nbsp;<input type="button" id="disconnectbutton1" value="Rozłącz" onclick="connectDesktop(event,0)" onkeypress="return false" onkeydown="return false"></span>
                    &nbsp;<span id="deskstatus">Rozłączony</span><span id="deskmetadata"></span>
                </div>
            </div>
            ...
            <div id="deskarea4" class="areaFoot" style="min-height:24px">
                <div class="toright2">
                    <span id="DeskLatency" style="line-height:22px;width:50px" title="Opóźnienie Sesji Pulpitu"></span>
                    <span id="DeskTimer" style="line-height:22px" title="Czas Sesji"></span>&nbsp;
                    ...
                    <span id="DeskSaveImageButton" title="Zapisz zrzut ekranu pulpitu zdalnego"><img src="images/icon-camera.png" onclick="deskSaveImage()" height="16" width="16" style="padding-top:2px"></span>
                </div>
                <div style="height:22px">
                    <select id="deskkeys">
                        ...
                        <option value="11">Win+Lewo</option>
                        <option value="12">Win+Prawo</option>
                    </select>
                    <input id="DeskWD" type="button" value="Wyślij" onkeypress="return false" onkeydown="return false" onclick="deskSendKeys()">
                    <input id="DeskClip" style="" type="button" value="Schowek" onkeypress="return false" onkeydown="return false" onclick="showDeskClip()">
                    <input id="DeskType" style="" type="button" value="Typ" onkeypress="return false" onkeydown="return false" onclick="showDeskType()">
                    <label><span id="DeskControlSpan" title="Przełącznik wejścia myszy i klawiatury"><input id="DeskControl" type="checkbox" onkeypress="return false" onkeydown="return false" onclick="toggleKvmControl()">Sterowanie</span></label>&nbsp;
                </div>
            </div>
        </div>
    </div>
    <div id="p12" class="noselect" style="overflow:hidden;position:absolute;left:54px;top:0;right:0;bottom:0;display:none;background-color:black">
        <div id="p12warning" onclick="showFeaturesDlg()">
            <div class="icon2"></div>
            <div class="warningbox">Funkcja Intel® AMT przekierowania portu lub funkcja KVM są wyłączone<span id="p12warninga">. kliknij tutaj, aby włączyć.</span></div>
        </div>
        <div id="p12warning2" onclick="showPowerActionDlg()">
            <div class="icon2"></div>
            <div class="warningbox">Komputer zdalny nie jest włączony, kliknij tutaj, aby wydać polecenie zasilania.</div>
        </div>
        <div class="areaHead" style="position:absolute;top:0;left:0;right:0;height:24px">
            <div class="toright2">
                <div id="termRecordIcon" class="deskareaicon" title="Serwer nagrywa tę sesję" style="display:none;background-color:red;width:12px;height:12px;border-radius:6px;margin-top:5px;margin-left:5px"></div>
                <div id="p12power" style="margin-top:3px;margin-right:4px;float:right"></div>
            </div>
            <div>
                <span id="connectbutton2span"><input type="button" id="connectbutton2" cmenu="termConnectButton" value="Połącz" onclick="connectTerminal(event,1)" onkeypress="return false" onkeydown="return false" disabled="disabled"></span>
                <span id="disconnectbutton2span">&nbsp;<input type="button" id="disconnectbutton2" value="Rozłącz" onclick="connectTerminal(event,0)" onkeypress="return false" onkeydown="return false"></span>
                &nbsp;<span id="termstatus">Rozłączony</span><span id="termtitle"></span>
            </div>
        </div>
        ...
        <div class="areaFoot" style="position:absolute;bottom:0;left:0;right:0;height:24px">
            <div class="toright2">
                <span id="TermLatency" title="Opóźnienie Sesji Terminala"></span>
                <span id="TermTimer" title="Czas Sesji"></span>&nbsp;
                <span id="terminalSettingsButtons" style="display:none">
                    <input id="id_tcrbutton" type="button" onkeypress="return false" onkeydown="return false" class="bottombutton" value="CR+LF" title="Przełączanie, co ma wysłać klawisz powrotu" onclick="termToggleCr()">
                    <input id="id_tfxkeysbutton" type="button" onkeypress="return false" onkeydown="return false" class="bottombutton" value="Intel (F10 = ESC+[OM)" title="Przełączanie typu emulacji klawiszy F1 do F10" onclick="termToggleFx()">
                    <input id="id_ttypebutton" type="button" onkeypress="return false" onkeydown="return false" class="bottombutton" value="Rozszerzone Ascii" title="Przełączanie typu emulacji terminala" onclick="termToggleType()">
                </span>
                ...
                <span id="specialKeyDropDown">
                    ...
                    <input id="specialkeylistinput" type="button" onkeypress="return false" class="bottombutton" value="Wyślij" title="Wyślij wybrany przycisk specjalny" onclick="sendSpecialKey()">
                </span>
            </div>
            <div>
                &nbsp;
                ...
                <input type="button" onkeypress="return false" onkeydown="return false" class="bottombutton" id="pastebutton" value="Wklej" title="Wklej tekst do terminala" onclick="showTermPasteDialog()" style="display:none">
            </div>
        </div>
    ...
    <div id="p13" class="noselect" style="overflow:hidden;position:absolute;left:54px;top:0;right:0;bottom:0;display:none;background-color:white">
        <div id="p13toolbar" style="position:absolute;left:0;top:0;right:0;bottom:28px">
            <div class="areaHead">
                <div class="toright2">
                    <div id="filesRecordIcon" class="deskareaicon" title="Serwer nagrywa tę sesję" style="display:none;background-color:red;width:12px;height:12px;border-radius:6px;margin-top:5px;margin-left:5px"></div>
                    <div id="p13power" style="margin-top:3px;margin-right:4px;float:right"></div>
                </div>
                <div>
                    <input id="p13Connect" value="Połącz" onclick="connectFiles(event)" type="button">
                    &nbsp;<span id="p13Status">Rozłączony</span>
                </div>
            </div>
            <div id="fileArea2" class="areaHead2" valign="bottom">
                <div id="p13rightOfButtons" class="toright2"></div>
                <div>
                    <input type="button" id="p13FolderUp" disabled="disabled" onclick="p13folderup()" value="Góra">&nbsp;
                    <input type="button" id="p13SelectAllButton" disabled="disabled" onclick="p13selectallfile()" value="Zaznacz Wszystko">&nbsp;
                    <input type="button" id="p13RenameFileButton" disabled="disabled" value="Zmień nazwę" onclick="p13renamefile()">&nbsp;
                    <input type="button" id="p13DeleteFileButton" disabled="disabled" value="Usuń" onclick="p13deletefile()">&nbsp;
                    <input type="button" id="p13ViewFileButton" disabled="disabled" value="Edycja" onclick="p13viewfile()">&nbsp;
                    <input type="button" id="p13NewFolderButton" disabled="disabled" value="Nowy Folder" onclick="p13createfolder()">&nbsp;
                    <input type="button" id="p13UploadButton" disabled="disabled" value="Prześlij" onclick="p13uploadFile()">&nbsp;
                    <input type="button" id="p13CutButton" disabled="disabled" value="Wytnij" onclick="p13copyFile(1)">&nbsp;
                    <input type="button" id="p13CopyButton" disabled="disabled" value="Kopiuj" onclick="p13copyFile(0)">&nbsp;
                    <input type="button" id="p13PasteButton" disabled="disabled" value="Wklej" onclick="p13pasteFile()">&nbsp;
                    <input type="button" id="p13ZipButton" disabled="disabled" value="Zip" onclick="p13zipFiles()">&nbsp;
                    <input type="button" id="p13RefreshButton" disabled="disabled" value="Odśwież" onclick="p13folderup(9999)">&nbsp;
                    <input type="button" id="p13FindButton" disabled="disabled" value="Znajdź" onclick="p13findfile()">&nbsp;
                </div>
            </div>
    ...
    <div id="dialog" class="noselect" style="display:none">
        ...
        <div id="dialogBody">
            ...
            <div id="dialog4" style="">
                <input id="d4WrapButton" type="button" value="Włącz zawijanie" onclick="d4ToggleWrap()">
                <input id="d4SizeButton" type="button" value="Małe" onclick="d4ToggleSize()">
                <input id="d4EncodingButton" type="button" value="Surowe" onclick="d4ToggleEncoding()">
            ...
            <div id="dialog7" style="">
                <div id="d7meshkvm">
                    ...
                    <div id="d7desktopOtherSettings">
                        <div>Inne Ustawienia</div>
                        <div id="d7otherset2" style="display:block">
                            <label style="display:block"><input type="checkbox" id="d7deskSwapMouse">Zamień Strony Przycisków Myszy</label>
                            <label style="display:block"><input type="checkbox" id="d7deskRemoteKeyMap">Użyj Mapy Klawiatury Zdalnego Urządzenia</label>
                        </div>
                    </div>
                </div>
                <div id="d7amtkvm">
                    <h4>Intel® AMT Sprzętowy KVM</h4>
                    <div>
                        <div>Kodowanie Obrazu</div>
                    ...
                    <div>
                        ...
                        <div id="d7otherset" style="display:block">
                            <label style="display:block"><input type="checkbox" id="d7showfocus">Pokaż Narzędzie Powiększania</label>
                            <label style="display:block"><input type="checkbox" id="d7showcursor">Pokazuj Lokalny Kursor Myszy</label>
                            <label style="display:block"><input type="checkbox" id="d7localKeyMap">Mapa Klawiatury Lokalnej</label>
                        </div>
                    </div>
                </div>
            </div>
    ...
    <script>
                    ...
                    desktop.m.onKvmData = function (x) {
                        ...
                        if ((data != null) && (data.action != null)) {
                            if (data.action == 'restart') {
                                ...
                                webRtcDesktop.webchannel = webRtcDesktop.webrtc.createDataChannel("Kanał danych", {}); // { ordered: false, maxRetransmits: 2 }
        ...
        function updateMetadata(conn, elementid) {
            ...
            if (conn && (conn.State == 3)) {
                ...
                if (viewerCount > 1) { str = '<span onclick=showSessionMetadata(1) style=cursor:pointer>' + format(", {0} oglądających", viewerCount) + '</span>'; }
            }
            QH('deskmetadata', str);
        ...
        function showSessionMetadata(cid) {
            ...
            if (conn && conn.metadata) {
                var x = '';
                if (conn.metadata.startTime) { x += addHtmlValue4("Czas Uruchomienia", printDateTime(new Date(conn.metadata.startTime))); }
                if (conn.metadata.users) {
                    for (var i in conn.metadata.users) {
                        var val = (conn.metadata.users[i] == 1) ? "1 połączenie" : format("{0} połączeń", conn.metadata.users[i]);
                        var username = i.split('/')[2];
                        if ((users != null) && (users[i] != null)) { username = users[i].name; }
                        x += addHtmlValue4(format("Użytkownik \"{0}\"", username), val);
                    }
                }
                setDialogMode(2, "Informacje o Sesji", 1, null, x, 'sessionMetadata' + cid);
            }
        }
        ...
        function showDeskType() {
            if (xxdialogMode || desktop == null || desktop.State != 3) return;
            Q('DeskType').blur();
            var x = '<div>' + "Wprowadź tekst i kliknij OK, aby zdalnie wpisać go za pomocą klawiatury (US English). Upewnij się, że zdalny kursor jest ustawiony we właściwej pozycji przed kontynuowaniem." + '<div>';
            x += '<textarea id=d2typeText style="margin-top:5px;width:100%;height:184px;resize:none" maxlength=2000></textarea>';
            setDialogMode(2, "Zdalne Wejście Klawiatury", 3, showDeskTypeEx, x);
            Q('d2typeText').focus();
        }
        ...
        */
        ...
        function deskSaveImage() {
            if (xxdialogMode || desktop == null || desktop.State != 3) return;
            var d = new Date(), n = "Pulpit" + '-' + d.getFullYear() + '-' + ('0' + (d.getMonth() + 1)).slice(-2) + '-' + ('0' + d.getDate()).slice(-2) + '-' + ('0' + d.getHours()).slice(-2) + '-' + ('0' + d.getMinutes()).slice(-2);
        ...
        var terminalEmulations = ["Terminal UTF8", "Rozszerzone ASCII", "Intel ASCII"];
        ...
        var fxEmulations = ["Intel (F10 = ESC+[OM)", "Podmień (F10 = ESC+0)", "VT100+ (F10 = ESC+[OY)"];
        ...
        function showTermPasteDialog() {
            if (!terminal || xxdialogMode) return;
            Q('pastebutton').blur();
            setDialogMode(2, "Wklej", 3, showTermPasteDialogEx, '<textarea id=d2pasteText style="width:100%;height:184px;resize:none"></textarea>');
            Q('d2pasteText').focus();
        }
        ...
        function onFilesStateChange(xfiles, state) {
            p13Connect.value = (state == 0) ? "Połącz" : "Rozłącz";
        ...
        function p13gotFiles(data) {
            ...
            if (data.action == 'findfile') {
                if (xxdialogTag == data.reqid) {
                    if (data.r == null) {
                        ...
                        xxdialogTag = null;
                        if (Q('d2findResults').innerHTML == '') { QH('d2findResults', '<div style=text-align:center;margin:10px><i>' + "Nie znaleziono plików" + '</i></div>'); }
                    } else {
            ...
            if (data.action == 'dialogmessage') {
                if ((data.msg == null) && (xxdialogTag == 'fileMsgDialog')) {
                    ...
                    setDialogMode(2, "Operacja na Pliku", 10, p13fileOperationDialogEx, '<div style=margin:10px>' + "Kompresuje pliki..." + '<div>', 'fileMsgDialog');
                } else if ((data.msg == 'zippingFile') && ((!xxdialogMode) || (xxdialogTag == 'fileMsgDialog'))) {
                    // Show the dialog box message
                    setDialogMode(2, "Operacja na Pliku", 10, p13fileOperationDialogEx, '<div style=margin:10px>' + EscapeHtml(data.file) + '<div><br /><progress value=' + EscapeHtml(data.progress) + ' style=width:100% max=100 />', 'fileMsgDialog');
                }
                return;
            }
        ...
        function p13findfile() {
            if (xxdialogMode) return;
            var x = addHtmlValue("Filtr", '<input id=d2findFilter style="width:230px" onkeyup=p13findfileValidate() onkeydown=p13findfileDown(event) placeholder="*.txt"></input>');
            ...
            x += '<div style=margin-top:8px><input id=filefind_dlgCancelButton type=button value=' + "Zamknij" + ' style=float:right;width:80px;margin-left:5px onclick=p13findfileCancel()>';
            x += '<input id=filefind_dlgOkButton type=submit value=' + "Szukaj" + ' style=float:right;width:80px onclick=p13findfileEx()><br /><br /></div>';
            setDialogMode(2, "Znajdź Pliki", 0, null, x);
            p13findfileValidate();
        ...
        function p13setActions() {
            ...
            if (p13filetree == null) {
                ...
                Q('p13SelectAllButton').value = "Zaznacz Wszystko";
                ...
                Q('p13SelectAllButton').value = (cc > 0 ? "Wyczyść Wybór" : "Zaznacz Wszystko");
        ...
        function p13zipFiles() {
            ...
            setDialogMode(2, "Nazwa pliku Zip", 3, p13zipFilesEx, '<input type=text id=p13renameinput maxlength=64 onkeyup=p13fileNameCheck(event) style=width:100% value="" />', { action: 'zip', path: p13filetreelocation.join('/'), files: inputFiles });
        ...
        function p13downloadfile(x, y, z, tag) {
            ...
            setDialogMode(2, "Pobierz Plik", 10, p13downloadFileCancel, '<div>' + gdownloadFile.file + '</div><br /><progress id=d2progressBar style=width:100% value=0 max=' + z + ' />');
        }
        ...
        function d4ToggleWrap(update) {
            ...
            Q('d4WrapButton').value = ["Zawijanie: WŁ.", "Zawijanie: WYŁ."][d4EditWrapVal];
        ...
        function d4ToggleSize(update) {
            ...
            Q('d4SizeButton').value = ["Rozmiar: 100%", "Rozmiar: 125%", "Rozmiar: 150%", "Rozmiar: 200%"][d4EditSizeVal];
        ...
        function d4ToggleEncoding(update) {
            ...
            Q('d4EncodingButton').value = ["Kodowanie: RAW","Kodowanie: UTF8"][d4EditEncodingVal];
        ...
        function printFlexDateTime(d) { if (printDate(new Date()) == printDate(d)) { return format("Wygaśnij o {0}", printTime(d)); } else { return format("Wygasa {0}", printDateTime(d)); } }
        function getFileSizeStr(size) { if (typeof size != 'number') { size = 0; } if (size == 1) return "1 bajt"; return format("{0} bajtów", size); }
