<!DOCTYPE html><html dir="ltr" xmlns="http://www.w3.org/1999/xhtml"><head lang="en">
                            ...
                            <div id="loginpanel" style="background-color:#979797;border-radius:16px;width:260px;padding:16px;text-align:center;clear:both;display:none">
                                <form method="post">
                                    ...
                                    <table>
                                        ...
                                        <tr>
                                            <td><div id="showPassHintLink" style="display:none"><a onclick="showPassHint()" style="cursor:pointer">Tipp megjelenítése</a></div></td>
                                    ...
                                    <div id="resetAccountDiv" style="display:none;padding:2px">
                                        <span id="resetAccountSpan">Elfelejtette a felhasználónevet/jelszót?</span> <a onclick="xgo(3)" style="cursor:pointer">Fiók visszaállítás</a>.
                                    </div>
                                    <div id="newAccountDiv" style="display:none;padding:2px">
                                        Nincs fiókja? <a onclick="xgo(2)" style="cursor:pointer">Hozzon létre egy újat!</a>.
                                    </div>
                                    ...
                                    <div id="authStrategies" style="display:none">
                                        ...
                                        <a id="auth-twitter" href="auth-twitter" style="display:none"><img src="images/login/twitter32.png" width="32" height="32" style="margin-left:3px;margin-right:3px;border-radius:3px;box-shadow:2px 2px 5px black;cursor:pointer" title="Bejelentkezés Twitter használatával"></a>
                                        <a id="auth-google" href="auth-google" style="display:none"><img src="images/login/google32.png" width="32" height="32" style="margin-left:3px;margin-right:3px;border-radius:3px;box-shadow:2px 2px 5px black;cursor:pointer" title="Bejelentkezés Google használatával"></a>
                                        <a id="auth-github" href="auth-github" style="display:none"><img src="images/login/github32.png" width="32" height="32" style="margin-left:3px;margin-right:3px;border-radius:3px;box-shadow:2px 2px 5px black;cursor:pointer" title="Bejelentkezés GitHub használatával"></a>
                                        <a id="auth-azure" href="auth-azure" style="display:none"><img src="images/login/azure32.png" width="32" height="32" style="margin-left:3px;margin-right:3px;border-radius:3px;box-shadow:2px 2px 5px black;cursor:pointer" title="Bejelentkezés Azure használatával"></a>
                                        ...
                                        <a id="auth-jumpcloud" href="auth-jumpcloud" style="display:none"><img src="images/login/jumpcloud32.png" width="32" height="32" style="margin-left:3px;margin-right:3px;border-radius:3px;box-shadow:2px 2px 5px black;cursor:pointer" title="Bejelentkezés JumpCloud használatával"></a>
                                        <a id="auth-intel" href="auth-intel" style="display:none"><img src="images/login/intel32.png" width="32" height="32" style="margin-left:3px;margin-right:3px;border-radius:3px;box-shadow:2px 2px 5px black;cursor:pointer" title="Bejelentkezés Intel használatával"></a>
                                        <a id="auth-saml" href="auth-saml" style="display:none"><img src="images/login/generic32.png" width="32" height="32" style="margin-left:3px;margin-right:3px;border-radius:3px;box-shadow:2px 2px 5px black;cursor:pointer" title="Egyszeri bejelentkezés (SSO)"></a>
                                    </div>
                                </form>
                            </div>
                                    ...
                                    <form method="post">
                                        ...
                                        <table>
                                            <tbody><tr id="nuUserRow">
                                                <td align="right" width="100">Felhasználó név:</td>
                                            ...
                                            <tr id="newAccountPass" title="Adja meg a fióklétrehozási tokent">
                                                <td align="right">Létrehozási token:</td>
                                        ...
                                        <hr><a onclick="xgo(1)" style="cursor:pointer">Vissza a bejelentkezéshez</a>
                                        ...
                                        <tr>
                                            <td colspan="2">
                                                ...
                                                <div style="float:right">
                                                    <input style="display:none;float:right" id="securityKeyButton" type="button" value="Biztonsági hardverkulcs használata" onclick="useSecurityKey()">
        ...
        <div id="footer" style="height:32px;width:100%;text-align:center;background-color:#113962;position:absolute;bottom:0px">
            <table cellpadding="0" cellspacing="6" style="width:100%">
                <tbody><tr>
                    ...
                    <td style="text-align:right">{{{rootCertLink}}}&nbsp;<a href="terms">Feltételek és adatvédelem</a></td>
                </tr>
            </tbody></table>
        </div>
    </div>
    ...
    <script>
        ...
        var okmessages = ['', "Ha az email cím hitelesített, a visszaállítással kapcsolatos levél elküldésre kerüllt.", "E-mail elküldve.", "E-mail megerősítés szükséges, ellenőrizze postafiókját, és kattintson a levélben található megerősítő linkre.", "SMS elküldve."];
        ...
        function useEmailToken() {
            ...
            setDialogMode(1, "Biztonságos bejelentkezés", 3, useEmailKeyEx, "Token küldése regisztrált e-mail címre?");
        }
        ...
        function useSMSToken() {
            ...
            setDialogMode(1, "Biztonságos bejelentkezés", 3, useSMSTokenEx, "Token küldése regisztrált telefonszámra?");
        }
        ...
        function showPassHint() {
            if (passRequirements.hint === true) { messagebox("Jelszó Tipp", passhint); }
        }
            ...
            if (Q('apassword1').value == '') {
                ...
                if (!passRequirementsEx) {
                    ...
                    if (passReq == false) {
                        ...
                        QH('passWarning', '<span style=color:red><b>' + "Jelszó házirend" + '</b><span>'); // TODO: Display problem hint
