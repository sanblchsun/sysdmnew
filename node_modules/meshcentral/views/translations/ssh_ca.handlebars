<!DOCTYPE html><html dir="ltr" xmlns="http://www.w3.org/1999/xhtml"><head lang="en">
    ...
    <script>
        ...
        var StatusStrs = ["Desconnectat", "Connectant...", "Configuració...", "Connectat"];
        var state = 0;
        var socket = null;
        var user = '';
        var pass = '';
        ...
        function sshTunnelAuthDialog(j, func) {
            ...
            if ((features & 1) == 0) { x += addHtmlValue('', '<label><input id=dp2keep type=checkbox>' + "Recordeu les credencials" + '</label>'); }
            ...
            socket.onmessage = function (data) {
                ...
                if (data.data[0] == '{') {
                    ...
                    switch (json.action) {
                        ...
                        case 'autherror': { setDialogMode(2, "Autenticació", 1, null, "No es pot autenticar."); break; }
                        case 'sessionerror': { setDialogMode(2, "Sessió", 1, null, "Sessió expirada."); break; }
                        case 'sessiontimeout': { setDialogMode(2, "Sessió", 1, null, "Temps d'espera de la sessió."); break; }
                    }
                } else if (data.data[0] == '~') {
