<!DOCTYPE html><html lang="it"><head>
    ...
    {{{customJSTags}}}
    <title>Installazione dell'agente</title>
    <style>
        .tab {
            overflow: hidden;
    ...
    <div id="container">
        ...
        <div id="column_l" style="overflow-y:auto">
            <h1><span id="groupname">Installazione dell'agente remoto</span></h1>
            <p>
                Sei stato invitato a installare un'applicazione che consentirà a un operatore remoto di accedere in modo sicuro al tuo computer, inclusi desktop e file. Segui le istruzioni di seguito solo se questo invito era previsto e sai chi accederà al tuo computer. Seleziona il tuo sistema operativo e segui le istruzioni di seguito per l'installazione. 
            </p>
            <div>
                <div class="tab">
                ...
                <div id="wintab64" class="tabcontent" style="background-color:white;color:black">
                    ...
                    <p><a id="win64url">Scarica il software qui</a>, eseguilo e premi "Installa" o "Connetti".</p>
                ...
                <div id="wintab32" class="tabcontent" style="background-color:white;color:black">
                    ...
                    <p><a id="win32url">Scarica il software qui</a>, eseguilo e premi "Installa" o "Connetti".</p>
                    <div style="text-align:center">
                ...
                <div id="wintabarm64" class="tabcontent" style="background-color:white;color:black">
                    ...
                    <p><a id="winarm64url">Scarica il software qui</a>, eseguilo e premi "Installa" o "Connetti".</p>
                    <div style="text-align:center">
                ...
                <div id="linuxtab" class="tabcontent" style="background-color:white;color:black">
                    <h3>Linux</h3>
                    <p>Per installare, taglia e incolla il seguente comando in un terminale di root.</p>
                    <div id="linuxinstall" style="font-family:courier,'courier new',monospace;margin-left:30px"></div>
                    <input type="button" value="Copia negli appunti" style="margin-left:30px;margin-top:4px" onclick="copyToClipLinuxInstall()">
                    <p>Per disinstallare, taglia e incolla il seguente comando come root.</p>
                    <div id="unlinuxinstall" style="font-family:courier,'courier new',monospace;margin-left:30px"></div>
                    <input type="button" value="Copia negli appunti" style="margin-left:30px;margin-top:4px" onclick="copyToClipLinuxUnInstall()">
                    <br><br>
                </div>
                ...
                <div id="macostab64" class="tabcontent" style="background-color:white;color:black">
                    ...
                    <p><a id="macos64url">Scarica il programma di installazione qui</a>, fai clic destro su di esso o premi "control" e fai clic sul file. Quindi seleziona "Apri" e segui le istruzioni.</p>
                    <div style="text-align:center">
                ...
                <div id="macostabarm64" class="tabcontent" style="background-color:white;color:black">
                    ...
                    <p><a id="macosarm64url">Scarica il programma di installazione qui</a>, fai clic destro su di esso o premi "control" e fai clic sul file. Quindi seleziona "Apri" e segui le istruzioni.</p>
                    <div style="text-align:center">
                ...
                <div id="macostab" class="tabcontent" style="background-color:white;color:black">
                    ...
                    <p><a id="macosurl">Scarica il programma di installazione qui</a>, fai clic destro su di esso o premi "control" e fai clic sul file. Quindi seleziona "Apri" e segui le istruzioni.</p>
                    <div style="text-align:center">
                ...
                <div id="androtab" class="tabcontent" style="background-color:white;color:black">
                    ...
                    <div style="min-height:220px">
                        <p>Scarica il software dell'agente utilizzando il Google Play Store o il file APK, installalo e utilizza il codice QR a destra o il link di accoppiamento in basso per configurare il tuo dispositivo su questo server.</p>
                        <p>
                        ...
                        <p>
                            <a id="androidurl">Download dell'APK Android</a>
                        </p>
                        <p>
                            <a rel="noreferrer noopener" target="_blank" href="{{{magenturl}}}">Collegamento di associazione del server</a>
                        </p>
                    </div>
                </div>
                ...
                <div id="assistab" class="tabcontent" style="background-color:white;color:black">
                    ...
                    <div style="min-height:220px">
                        ...
                        <p>Assistant è uno strumento della barra delle applicazioni di Windows che può essere utilizzato quando è necessario aiuto. Questo non è un agente che viene eseguito in background sul computer gestito, ma è uno strumento che si connette al server solo quando richiesto.</p>
                        <p>
                            <a id="assisturl" rel="noreferrer noopener" target="_blank">Scarica l'assistente per windows</a>
                        </p>
                    </div>
                    <br style="clear:both">
                </div>
    ...
    <script>
        ...
        function startup() {
            ...
            if (groupName != '') {
                QH('groupname', format("Installazione dell'agente remoto per {0}", escapeHtml(groupName)));
                document.title = format("{0} - Installazione dell'agente", groupName);
            } else {
                document.title = "Installazione dell'agente";
            }
        ...
        function linuxBinarySetup() {
            ...
            x += addHtmlValue("Tipo di sistema", '<select id=aginsSysType onchange=addAgentToMeshClick() style=width:236px>' + moreoptions + '</select>');
            x += '</div>';
            x += '<div id=aginsTypeDiv>';
            x += addHtmlValue("Tipo di installazione", '<select id=aginsType onchange=addAgentToMeshClick() style=width:236px><option value=0>' + "Servizio  & interattivo" + '</option><option value=2>' + "Solo Servizio" + '</option><option value=1>' + "Solo interattivo" + '</option></select>');
            x += '</div><hr>';
            ...
            x += addHtmlValue("Agente Mesh", '<a id=aginsbinlnk name="meshagents?id=' + meshid + '&installflags=0' + (urlargs.key?('&key=' + urlargs.key):'') + '">' + "meshagent" + '</a> <img src=images/link4.png height=10 width=10 title="' + "Copia l'URL dell'agente negli appunti" + '" style=cursor:pointer onclick=copyAgentUrl("meshagents?id=' + meshid + '&installflags=",1)>');
            x += addHtmlValue("Comando", '<input id=aginsbincmd type=text style="width:216px" readonly value=\'wget -O meshagent ' + ((serverNoProxy != 0) ?'--no-proxy':'') + ' --no-check-certificate \"https://' + servername + portStr + domainUrl + 'meshagents?id=' + meshid.split('$').join('%24').split('@').join('%40') + '\' /> <img src=images/link4.png height=10 width=10 title="' + "Copia l'URL dell'agente negli appunti" + '" style=cursor:pointer onclick=copyAgentIdValue("aginsbincmd")>');
            x += '</div>';
            QH('linuxbinarytab', x);
            addAgentToMeshClick();
        }
