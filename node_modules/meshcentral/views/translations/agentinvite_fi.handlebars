<!DOCTYPE html><html lang="fi"><head>
    ...
    <div id="container">
        ...
        <div id="column_l" style="overflow-y:auto">
            <h1><span id="groupname">Agentin etäasennus</span></h1>
            <p>
            ...
            <div>
                <div class="tab">
                    ...
                    <button id="tlinuxbinarytab" class="tablinks" onclick="openTab(event, 'linuxbinarytab')">Linux / BSD / macOS -binaariasennusohjelma</button>
                    <button id="tmacostab64" class="tablinks" onclick="openTab(event, 'macostab64')">macOS x86-64-bittinen</button>
                    <button id="tmacostabarm64" class="tablinks" onclick="openTab(event, 'macostabarm64')">macOS ARM (64-bittinen)</button>
                    ...
                    <button id="tassistab" class="tablinks" onclick="openTab(event, 'assistab')">Avustaja</button>
                </div>

                <div id="wintab64" class="tabcontent" style="background-color:white;color:black">
                    <h3>Microsoft™ Windows 64bit</h3>
                    <p><a id="win64url">Lataa ohjelmisto täältä</a>, suorita se ja paina "Asenna" tai "Yhdistä".</p>
                ...
                <div id="wintab32" class="tabcontent" style="background-color:white;color:black">
                    ...
                    <p><a id="win32url">Lataa ohjelmisto täältä</a>, suorita se ja paina "Asenna" tai "Yhdistä".</p>
                    <div style="text-align:center">
                ...
                <div id="wintabarm64" class="tabcontent" style="background-color:white;color:black">
                    ...
                    <p><a id="winarm64url">Lataa ohjelmisto täältä</a>, suorita se ja paina "Asenna" tai "Yhdistä".</p>
                    <div style="text-align:center">
                ...
                <div id="linuxtab" class="tabcontent" style="background-color:white;color:black">
                    <h3>Linux</h3>
                    <p>Asenna leikkaamalla ja liittämällä seuraava komento päätelaitteeseen.</p>
                    <div id="linuxinstall" style="font-family:courier,'courier new',monospace;margin-left:30px"></div>
                    <input type="button" value="Kopioi leikepöydälle" style="margin-left:30px;margin-top:4px" onclick="copyToClipLinuxInstall()">
                    <p>Poista asennus leikkaamalla ja liittämällä seuraava komento juureksi.</p>
                    <div id="unlinuxinstall" style="font-family:courier,'courier new',monospace;margin-left:30px"></div>
                    <input type="button" value="Kopioi leikepöydälle" style="margin-left:30px;margin-top:4px" onclick="copyToClipLinuxUnInstall()">
                    <br><br>
                </div>
                ...
                <div id="macostab64" class="tabcontent" style="background-color:white;color:black">
                    ...
                    <p><a id="macos64url">Lataa asennusohjelma tästä</a>, napsauta sitä hiiren kakkospainikkeella tai paina "control" ja napsauta tiedostoa. Valitse sitten "Avaa" ja seuraa ohjeita.</p>
                    <div style="text-align:center">
                ...
                <div id="macostabarm64" class="tabcontent" style="background-color:white;color:black">
                    ...
                    <p><a id="macosarm64url">Lataa asennusohjelma tästä</a>, napsauta sitä hiiren kakkospainikkeella tai paina "control" ja napsauta tiedostoa. Valitse sitten "Avaa" ja seuraa ohjeita.</p>
                    <div style="text-align:center">
                ...
                <div id="macostab" class="tabcontent" style="background-color:white;color:black">
                    ...
                    <p><a id="macosurl">Lataa asennusohjelma tästä</a>, napsauta sitä hiiren kakkospainikkeella tai paina "control" ja napsauta tiedostoa. Valitse sitten "Avaa" ja seuraa ohjeita.</p>
                    <div style="text-align:center">
                ...
                <div id="androtab" class="tabcontent" style="background-color:white;color:black">
                    ...
                    <div style="min-height:220px">
                        <p>Lataa agenttiohjelmisto Google Play -kaupasta tai APK -tiedostosta, asenna se ja käytä oikealla olevaa QR -koodia tai alla olevaa pariliitoslinkkiä laitteesi asettamiseen tälle palvelimelle.</p>
                        <p>
                        ...
                        <p>
                            <a id="androidurl">Lataa Android APK</a>
                        </p>
                        <p>
                            <a rel="noreferrer noopener" target="_blank" href="{{{magenturl}}}">Palvelimen pariliitoslinkki</a>
                        </p>
                    </div>
                </div>
                ...
                <div id="assistab" class="tabcontent" style="background-color:white;color:black">
                    ...
                    <div style="min-height:220px">
                        ...
                        <p>Assistant on Windowsin ilmaisinalue, jota voidaan käyttää tarvittaessa. Tämä ei ole agentti, joka toimii hallitun tietokoneen taustalla, vaan työkalu, joka muodostaa yhteyden palvelimeen vain pyydettäessä.</p>
                        <p>
                            <a id="assisturl" rel="noreferrer noopener" target="_blank">Lataa Assistant Windowsille</a>
                        </p>
                    </div>
                    <br style="clear:both">
                </div>
    ...
    <script>
        ...
        function startup() {
            ...
            if (groupName != '') {
                QH('groupname', format("Etäagentin asennus verkkotunnukselle {0}", escapeHtml(groupName)));
                document.title = format("{0} - Agentin asennus", groupName);
            } else {
                document.title = "Agentin asennus";
            }
        ...
        function linuxBinarySetup() {
            var x = '<h3>' + "Linux / BSD / macOS -binaariasennusohjelma" + '</h3>', moreoptions = '';
            var opts = '<select id=aginsSelect onchange=addAgentToMeshClick() style=width:236px>';
            opts += '<option value=5 selected>' + "Linux / BSD / macOS -binaariasennusohjelma" + '</option>';
            opts += '</select>';
            ...
            x += addHtmlValue("Järjestelmän tyyppi", '<select id=aginsSysType onchange=addAgentToMeshClick() style=width:236px>' + moreoptions + '</select>');
            x += '</div>';
            x += '<div id=aginsTypeDiv>';
            x += addHtmlValue("Asennustyyppi", '<select id=aginsType onchange=addAgentToMeshClick() style=width:236px><option value=0>' + "Tausta & vuorovaikutteinen" + '</option><option value=2>' + "Vain tausta" + '</option><option value=1>' + "Vain interaktiivinen" + '</option></select>');
            x += '</div><hr>';
            ...
            x += addHtmlValue("Mesh Agentti", '<a id=aginsbinlnk name="meshagents?id=' + meshid + '&installflags=0' + (urlargs.key?('&key=' + urlargs.key):'') + '">' + "meshagent" + '</a> <img src=images/link4.png height=10 width=10 title="' + "Kopioi agentin URL-osoite leikepöydälle" + '" style=cursor:pointer onclick=copyAgentUrl("meshagents?id=' + meshid + '&installflags=",1)>');
            x += addHtmlValue("Komento", '<input id=aginsbincmd type=text style="width:216px" readonly value=\'wget -O meshagent ' + ((serverNoProxy != 0) ?'--no-proxy':'') + ' --no-check-certificate \"https://' + servername + portStr + domainUrl + 'meshagents?id=' + meshid.split('$').join('%24').split('@').join('%40') + '\' /> <img src=images/link4.png height=10 width=10 title="' + "Kopioi agentin URL-osoite leikepöydälle" + '" style=cursor:pointer onclick=copyAgentIdValue("aginsbincmd")>');
            x += '</div>';
            QH('linuxbinarytab', x);
            addAgentToMeshClick();
        }
