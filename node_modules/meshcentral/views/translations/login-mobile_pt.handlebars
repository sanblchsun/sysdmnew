<!DOCTYPE html><html dir="ltr" xmlns="http://www.w3.org/1999/xhtml"><head lang="en">
                            ...
                            <div id="loginpanel" style="background-color:#979797;border-radius:16px;width:260px;padding:16px;text-align:center;clear:both;display:none">
                                <form method="post">
                                    ...
                                    <div id="resetAccountDiv" style="display:none;padding:2px">
                                        <span id="resetAccountSpan">Esqueceu usuário / senha?</span> <a onclick="xgo(3)" style="cursor:pointer">Redefinir conta</a>.
                                    </div>
                                    <div id="newAccountDiv" style="display:none;padding:2px">
                                        Não possui uma conta? <a onclick="xgo(2)" style="cursor:pointer">Crie um</a>.
                                    </div>
                                    ...
                                    <form method="post">
                                        ...
                                        <table>
                                            <tbody><tr id="nuUserRow">
                                                <td align="right" width="100">Nome de usuário:</td>
                                            ...
                                            <tr id="createPanelHint" style="display:none">
                                                <td align="right">Dica de passe:</td>
                                        ...
                                        <tr>
                                            <td colspan="2">
                                                ...
                                                <div style="float:right">
                                                    <input style="display:none;float:right" id="securityKeyButton" type="button" value="Usar chave de segurança" onclick="useSecurityKey()">
        ...
        <div id="footer" style="height:32px;width:100%;text-align:center;background-color:#113962;position:absolute;bottom:0px">
            <table cellpadding="0" cellspacing="6" style="width:100%">
                <tbody><tr>
                    ...
                    <td style="text-align:right">{{{rootCertLink}}}&nbsp;<a href="terms">Termos &amp; Privacidade</a></td>
                </tr>
            </tbody></table>
        </div>
    </div>
    ...
    <script>
        ...
        var okmessages = ['', "Se válido, redefina o e-mail enviado.", "Email enviado.", "É necessária verificação de e-mail, verifique sua caixa de correio e clique no link de confirmação.", "SMS enviado."];
