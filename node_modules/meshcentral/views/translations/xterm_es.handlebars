<!DOCTYPE html><html dir="ltr" xmlns="http://www.w3.org/1999/xhtml"><head lang="en">
    ...
    <div id="termShellContextMenu" class="contextMenu noselect" style="display:none;min-width:0px">
        <div id="cxtermnorm" class="cmtext" onclick="cmtermaction(1,event)"><b>Administrar Shell</b></div>
        <div id="cxtermps" class="cmtext" onclick="cmtermaction(6,event)">Administrar Powershell</div>
        <div id="cxtermunorm" class="cmtext" onclick="cmtermaction(8,event)">Shell del Usuario</div>
        <div id="cxtermups" class="cmtext" onclick="cmtermaction(9,event)">Usuario PowerShell</div>
    </div>
    <div id="termShellContextMenuLinux" class="contextMenu noselect" style="display:none;min-width:0px">
        <div id="cxtermnorm" class="cmtext" onclick="cmtermaction(1,event)"><b>Shell Root</b></div>
        <div id="cxtermps" class="cmtext" onclick="cmtermaction(8,event)">Shell del Usuario</div>
        <div id="cxtermps" class="cmtext" onclick="cmtermaction(100,event)">Shell de inicio de sesión</div>
    </div>
