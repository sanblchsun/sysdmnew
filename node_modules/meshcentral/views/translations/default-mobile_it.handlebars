<!DOCTYPE html><html lang="it" dir="ltr" xmlns="http://www.w3.org/1999/xhtml"><head>
    ...
    <div id="container">
        ...
        <div id="masthead" style="background:url(logo.png) 0px 0px;background-size:341px 50px;background-color:#036;background-repeat:no-repeat;height:50px;width:100%;overflow:hidden">
            ...
            <div id="notificationCount" onclick="clickNotificationIcon()" class="unselectable" style="position:absolute;right:50px;top:0px;font-size:28px;width:50px;height:50px;cursor:pointer;display:none" title="Fare clic per visualizzare le notifiche correnti"><div id="notificationCount2" style="padding-top:8px">0</div></div>
            ...
            <div id="column_l" style="width:100%;padding:0;position:absolute;bottom:0px;top:0px">
                <div id="p0" style="display:none;width:100%;height:100%">
                    <div style="display:flex;align-items:center;width:100%;height:100%">
                        <div id="p0message" style="text-align:center;width:100%"><span id="p0span">Server disconnesso</span>, <href onclick="reload()" style="cursor:pointer"><u>fare clic per riconnettersi</u></href>.</div>
                    </div>
                </div>
                ...
                <div id="p2" style="display:none;position:absolute;top:0;left:0;right:0;bottom:0">
                    ...
                    <div id="xdevicesBar" style="position:absolute;overflow-y:auto;height:34px;left:0;right:0;bottom:0px;background-color:#aaa;color:black">
                        <div style="margin:4px">
                            ...
                            <input id="SearchInput" autocomplete="off" type="search" placeholder="Filtro" onchange="onDeviceSearchChanged(event)" onclick="onDeviceSearchChanged(event)" onkeyup="onDeviceSearchChanged(event)" style="padding:2px;margin:0;height:20px;background-color:#FFF">&nbsp;
                            <label class="noselect"><input type="checkbox" id="RealNameCheckBox" onclick="onRealNameCheckBox()">Nome del sistema operativo </label>
                            <label class="noselect"><input type="checkbox" id="OnlineCheckBox" onclick="onOnlineCheckBox(event)">in linea </label>
                        </div>
                    </div>
                </div>
                        ...
                        <div style="margin-left:8px">
                            <div id="p3AccountActions">
                                <div id="p2AccountSecurity" style="display:none">
                                    <p><strong>Sicurezza dell 'Account</strong></p>
                                    <div style="margin-left:9px;margin-bottom:8px">
                                        <div id="managePhoneNumber1" style="margin-top:5px;display:none"><a onclick="account_managePhone()" style="cursor:pointer">Gestisci numero di telefono</a> <span id="authPhoneNumberCheck"><strong>✓</strong></span></div>
                                        <div id="manageEmail2FA" style="margin-top:5px;display:none"><a onclick="account_manageAuthEmail()" style="cursor:pointer">Gestisci l'autenticazione e-mail</a> <span id="authEmailSetupCheck"><strong>✓</strong></span></div>
                                        <div style="margin-top:5px"><a href="#" onclick="account_showLocalizationSettings()">Impostazioni di localizzazione</a></div>
                                        <div id="manageAuthApp" style="margin-top:5px;display:none"><a onclick="account_manageAuthApp()" style="cursor:pointer">Gestisci l'app di autenticazione</a> <span id="authAppSetupCheck"><strong>✓</strong></span></div>
                                        <div id="manageOtp" style="margin-top:5px;display:none"><a onclick="account_manageOtp(0)" style="cursor:pointer">Gestisci codici di backup</a> <span id="authCodesSetupCheck"><strong>✓</strong></span></div>
                                    </div>
                                </div>
                                <div id="p2AccountActions" style="display:none">
                                    <p><strong>Azioni sull'account</strong></p>
                                    <div style="margin-left:9px;margin-bottom:8px">
                                        <div style="margin-top:5px"><span id="viewPreviousLogins"><a onclick="return account_viewPreviousLogins()" style="cursor:pointer">Visualizza accessi precedenti</a></span></div>
                                        <div style="margin-top:5px"><span id="managePhoneNumber2" style="display:none"><a onclick="account_managePhone()" style="cursor:pointer">Gestisci numero di telefono</a></span></div>
                                        <div style="margin-top:5px"><span id="verifyEmailId" style="display:none"><a onclick="account_showVerifyEmail()" style="cursor:pointer">Verifica Email</a></span></div>
                                        <span id="p2AccountPassActions">
                                            <div style="margin-top:5px"><span id="changeEmailId" style="display:none"><a onclick="account_showChangeEmail()" style="cursor:pointer">Modifica indirizzo e-mail</a></span></div>
                                            <div style="margin-top:5px"><a onclick="account_showChangePassword()" style="cursor:pointer">Cambia la password</a><span id="p2nextPasswordUpdateTime"></span></div>
                                            <div style="margin-top:5px"><a onclick="account_showDeleteAccount()" style="cursor:pointer">Eliminare l'account</a></div>
                                        </span>
                                        <div style="margin-top:5px" id="setDarkModeLink"><a onclick="toggleNightMode()" style="cursor:pointer">Imposta la modalità scura</a></div>
                                        <div style="margin-top:5px"><a onclick="showNotes(false)" style="cursor:pointer">Note personali</a></div>
                                    </div>
                                <br style="clear:both">
                                </div>
                            </div>
                            <strong>Gruppi di dispositivi</strong>
                            <span id="p3createMeshLink1">( <a onclick="account_createMesh()" style="cursor:pointer"><img src="images/icon-addnew.png" width="12" height="12" border="0"> Nuovo</a> )</span>
                            <br><br>
                            <div id="p3meshes"></div>
                            <div id="p3noMeshFound" style="margin-left:9px;display:none">Nessun gruppo di dispositivi. <span id="p3createMeshLink2"> <a onclick="account_createMesh()" style="cursor:pointer"><strong>Inizia qui!</strong></a></span></div>
                            <br style="clear:both">
                        </div>
                    </div>
                </div>
                <div id="p5" style="display:none">
                    <table cellspacing="0" style="margin:0;padding:0;border-spacing:0;border:0;">
                        <tbody><tr style="padding:0">
                            ...
                            <td>
                                <div style="margin-left:5px">
                                    <strong style="font-size:large">I miei file </strong><br>
                                </div>
                            </td>
                        </tr>
                    </tbody></table>
                            ...
                            <tbody><tr>
                                <td style="width:100%;background-color:#d3d9d6;text-align:left;padding:4px" valign="bottom">
                                    <div style="width:100%;text-align:center">
                                        <input type="button" style="width:calc(100%/5 - 5px)" id="p5FolderUp" disabled="disabled" onclick="p5folderup()" value="Su">
                                        <input type="button" style="width:calc(100%/5 - 5px)" id="p5SelectAllButton" disabled="disabled" onclick="p5selectallfile()" value="Seleziona tutto" onkeypress="return false" onkeydown="return false">
                                        <input type="button" style="width:calc(100%/5 - 5px)" id="p5RenameFileButton" disabled="disabled" value="Rinominare" onclick="p5renamefile()" onkeypress="return false" onkeydown="return false">
                                        <input type="button" style="width:calc(100%/5 - 5px)" id="p5DeleteFileButton" disabled="disabled" value="Elimina" onclick="p5deletefile()" onkeypress="return false" onkeydown="return false">
                                        <input type="button" style="width:calc(100%/5 - 5px)" id="p5NewFolderButton" disabled="disabled" value="Cartella" onclick="p5createfolder()" onkeypress="return false" onkeydown="return false">
                                    </div>
                                    <div style="width:100%;text-align:center">
                                        <input type="button" style="width:calc(100%/5 - 5px)" id="p5UploadButton" disabled="disabled" value="Caricare" onclick="p5uploadFile()" onkeypress="return false" onkeydown="return false">
                                        <input type="button" style="width:calc(100%/5 - 5px)" id="p5CutButton" disabled="disabled" value="Taglia" onclick="p5copyFile(1)" onkeypress="return false" onkeydown="return false">
                                        <input type="button" style="width:calc(100%/5 - 5px)" id="p5CopyButton" disabled="disabled" value="Copia" onclick="p5copyFile(0)" onkeypress="return false" onkeydown="return false">
                                        <input type="button" style="width:calc(100%/5 - 5px)" id="p5PasteButton" disabled="disabled" value="Incolla" onclick="p5pasteFile()" onkeypress="return false" onkeydown="return false">
                                        <input type="button" style="width:calc(100%/5 - 5px)" id="p5RefreshButton" value="ricaricare" onclick="p5refreshFiles()" onkeypress="return false" onkeydown="return false">
                                    </div>
                                </td>
                            </tr>
                            <tr>
                                        ...
                                        <tbody><tr>
                                            ...
                                            <td style="text-align:right;padding-right:4px">
                                                <select id="p5sortdropdown" onchange="updateFiles()">
                                                    ...
                                                    <option value="2">Ordina per misura</option>
                ...
                <div id="p10" style="display:none;position:absolute;bottom:0;top:0;width:100%;overflow:hidden">
                    ...
                    <div id="p10dialog" style="z-index:1000;background-color:#EEE;box-shadow:0px 0px 15px #666;font-family:Arial,Helvetica,sans-serif;border-radius:5px;position:fixed;top:30px;width:300px;left:30px;display:none">
                        <div style="width:100%;background-color:#003366;color:#FFF;border-radius:5px 5px 0 0">
                            <div style="padding:5px">Personalizzazione delle scorciatoie da tastiera</div>
                    ...
                    <div id="p10desktop" style="overflow:hidden;position:absolute;top:55px;bottom:0px;width:100%;display:none">
                        <div id="deskarea1" style="position:absolute;top:0px;width:100%;height:32px">
                            <div style="padding-top:2px;padding-bottom:2px;background:#C0C0C0;height:32px">
                                <div style="float:right;text-align:right">
                                    ...
                                    <input type="button" id="deskFullScreen" value="A schermo intero" onclick="deskToggleFull(event)" onkeypress="return false" onkeydown="return false" disabled="disabled" style="height:28px;margin-right:3px;">
                                </div>
                                <div style="margin-left:3px">
                                    <input type="button" id="connectbutton1" value="Connetti" onclick="connectDesktop(event,3)" onkeypress="return false" onkeydown="return false" disabled="disabled" style="height:28px">
                                    ...
                                    <input type="button" id="disconnectbutton1" value="Disconnetti" onclick="connectDesktop(event,0)" onkeypress="return false" onkeydown="return false" style="height:28px">
                                    <span id="deskstatus" style="color:black">Disconnesso</span>
                                </div>
                            </div>
                        </div>
                        ...
                        <div id="deskarea4" style="position:absolute;bottom:0px;width:100%;height:32px">
                            <div style="padding-top:2px;padding-bottom:2px;background:#C0C0C0">
                                ...
                                <div>
                                    <input id="deskActionsBtn" type="button" style="margin-left:3px;height:28px" onkeypress="return false" onkeydown="return false" value="Azioni" onclick="deviceActionFunction()">
                                    <input type="button" value="impostazioni" onkeypress="return false" onkeydown="return false" onclick="showDesktopSettings()" style="height:28px">
                                    <input type="button" onkeypress="return false" onkeydown="return false" value="Azioni di accensione..." onclick="showPowerActionDlg()" style="display:none;height:28px">
                                    ...
                                    <input type="button" id="DeskScreens" value="Schermi" onkeypress="return false" onkeydown="return false" onclick="deskSelectScreens()" style="display:none;height:28px">
                                    <label><span id="DeskControlSpan" style="display:none"><input id="DeskControl" type="checkbox" onkeypress="return false" onkeydown="return false">Ingresso</span></label>
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div id="termTable" style="position:absolute;top:0;bottom:0;left:0;right:0">
                            <div id="termarea1">
                                <div class="areaHead" style="line-height:24px">
                                    <div class="toright2">
                                        <input type="button" id="termFullScreen" value="A schermo intero" onclick="deskToggleFull(event)" onkeypress="return false" onkeydown="return false" disabled="disabled" style="height:28px;margin-right:3px;">
                                        <div id="terminalCustomUpperRight" style="float:left;margin-right:6px"></div>
                                    </div>
                                    <div>
                                        <span id="connectbutton2span" style="margin-left:3px"><input type="button" id="connectbutton2" value="Connetti" style="height:28px" onclick="connectTerminal(event,1)" onkeypress="return false" onkeydown="return false" disabled="disabled"></span>
                                        <span id="connectbutton2sspan" style="margin-right:4px"><input type="button" id="connectbutton2s" value="Connessione SSH" style="height:28px" onclick="connectTerminal(event,3)" onkeypress="return false" onkeydown="return false" disabled="disabled"></span>
                                        <span id="disconnectbutton2span" style="margin-left:3px"><input type="button" id="disconnectbutton2" value="Disconnetti" style="height:28px" onclick="connectTerminal(event,0)" onkeypress="return false" onkeydown="return false"></span>
                                        <span id="termstatus" style="line-height:22px">Disconnesso</span><span id="termtitle"></span>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div id="termarea4" style="position:relative;height:32px;">
                                <div class="areaFoot">
                                    ...
                                    <div style="height:28px">
                                        <input id="termActionsBtn" style="margin-left:3px;height:28px" type="button" title="Esegui azioni di accensione sul dispositivo" onkeypress="return false" onkeydown="return false" value="Azioni" onclick="deviceActionFunction()">
                        ...
                        <table id="p13toolbar" style="width:100%;height:111px" cellpadding="0" cellspacing="0">
                            <tbody><tr>
                                <td style="background-color:#C0C0C0;border-bottom:2px solid black;padding:2px;line-height:24px">
                                    <div style="float:right;text-align:right">
                                        <input id="filesActionsBtn" type="button" onkeypress="return false" onkeydown="return false" value="Azioni" onclick="deviceActionFunction()" style="margin-right:2px">
                                        <div id="filesCustomUpperRight" style="float:left;margin-right:6px"></div>
                                    </div>
                                    <div style="margin-left:2px">
                                        <input id="p13AutoConnect" value="Connessione automatica" onclick="autoConnectFiles(event)" onkeypress="return false" onkeydown="return false" type="button" style="display:none">
                                        <input id="p13Connect" value="Connetti" onclick="connectFiles(event,1)" onkeypress="return false" onkeydown="return false" type="button">
                                        <input id="p13Connects" value="Connessione SFTP" onclick="connectFiles(event,2)" onkeypress="return false" onkeydown="return false" type="button">
                                        <input id="p13Disconnect" value="Disconnetti" onclick="connectFiles(event)" onkeypress="return false" onkeydown="return false" type="button">
                                        <span class="textOverGray" id="p13Status">Disconnesso</span>
                                    </div>
                                </td>
                            </tr>
                            <tr>
                                <td style="width:100%;background-color:#d3d9d6;text-align:left;padding:4px" valign="bottom">
                                    <div style="width:100%;text-align:center">
                                        <input type="button" style="width:calc(100%/5 - 5px)" id="p13FolderUp" disabled="disabled" onclick="p13folderup()" value="Su">
                                        <input type="button" style="width:calc(100%/5 - 5px)" id="p13SelectAllButton" disabled="disabled" onclick="p13selectallfile()" value="Seleziona tutto" onkeypress="return false" onkeydown="return false">
                                        <input type="button" style="width:calc(100%/5 - 5px)" id="p13RenameFileButton" disabled="disabled" value="Rinominare" onclick="p13renamefile()" onkeypress="return false" onkeydown="return false">
                                        <input type="button" style="width:calc(100%/5 - 5px)" id="p13DeleteFileButton" disabled="disabled" value="Elimina" onclick="p13deletefile()" onkeypress="return false" onkeydown="return false">
                                        <input type="button" style="width:calc(100%/5 - 5px)" id="p13NewFolderButton" disabled="disabled" value="Cartella" onclick="p13createfolder()" onkeypress="return false" onkeydown="return false">
                                    </div>
                                    <div style="width:100%;text-align:center">
                                        <input type="button" style="width:calc(100%/5 - 5px)" id="p13UploadButton" disabled="disabled" value="Caricare" onclick="p13uploadFile()" onkeypress="return false" onkeydown="return false">
                                        <input type="button" style="width:calc(100%/5 - 5px)" id="p13CutButton" disabled="disabled" value="Taglia" onclick="p13copyFile(1)" onkeypress="return false" onkeydown="return false">
                                        <input type="button" style="width:calc(100%/5 - 5px)" id="p13CopyButton" disabled="disabled" value="Copia" onclick="p13copyFile(0)" onkeypress="return false" onkeydown="return false">
                                        <input type="button" style="width:calc(100%/5 - 5px)" id="p13PasteButton" disabled="disabled" value="Incolla" onclick="p13pasteFile()" onkeypress="return false" onkeydown="return false">
                                        <input type="button" style="width:calc(100%/5 - 5px)" id="p13RefreshButton" disabled="disabled" value="ricaricare" onclick="p13folderup(9999)" onkeypress="return false" onkeydown="return false">
                                    </div>
                                </td>
                            </tr>
                            <tr>
                            ...
                            <tbody><tr style="height:28px">
                                <td class="areaHead">
                                    <div class="toright2">
                                        ...
                                        <input type="button" id="p15uploadCore" value="Azione dell'agente" onclick="p15uploadCore(event)">
                                    </div>
                                        ...
                                        <tbody><tr>
                                            ...
                                            <td id="p15outputselecttd">
                                                <select id="p15outputselect" onchange="setupConsole()">
                                                    ...
                                                    <option id="p15outputselect3" value="3">Spingere</option>
                                                    <option id="p15outputselect2" value="2">MQTT </option>
                                                </select>
                                            </td>
                                            <td style="width:1%"><input id="id_p15consoleClear" type="button" class="bottombutton" value="Pulire" onclick="p15consoleClear()"></td>
                                        </tr>
                                    </tbody></table>
                                </td>
                            </tr>
    ...
    <div id="dialog" style="display:none">
        ...
        <div style="margin-right:16px;margin-left:8px">
            ...
            <div id="dialog4" style="margin:auto;margin:3px">
                <div id="d3upload">
                    <div>Selezione dei file</div>
                    <select id="d3uploadMode" onchange="d3modechange()">
                        <option value="1">Caricamento file locale</option>
                        <option value="2">Selezione del file del server</option>
                    </select>
                </div>
                <div id="d3localmode" style="display:none">
                    <div>Caricare un file</div>
                ...
                <div id="d3servermode">
                    <div id="d3serveraction" valign="bottom">
                        <input type="button" id="p3FolderUp" disabled="disabled" onclick="d3folderup()" value="Su">&nbsp;<span id="p3CurrentFolder"></span>
                    </div>
            ...
            <div id="dialog7" style="margin:auto;margin:3px">
                <div id="d7meshkvm">
                    <h4 style="width:100%;border-bottom:1px solid gray">Agente Desktop Remoto</h4>
                    <table style="width:100%">
                        <tbody><tr>
                            <td>
                                Qualità
                        ...
                        <tr>
                            ...
                            <td style="width:100px">
                                <select id="d7framelimiter" style="float:right;width:200px" dir="rtl">
                                    <option selected="selected" value="50">Veloce</option>
                                    <option value="100">medio</option>
                                    <option value="400">Lento</option>
                                    <option value="1000">Molto lento</option>
                                </select>
                            </td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                            <td></td>
                            <td>
                                <label style="display:block" id="d7deskAutoLockLabel"><input type="checkbox" id="d7deskAutoLock">Blocca su Disconnessione</label>
                            </td>
                        </tr>
                    </tbody></table>
                </div>
                        ...
                        <tbody><tr>
                            ...
                            <td style="width:100px">
                                <select id="d7desktopmode" style="float:right;width:200px">
                                    <option value="1">RLE8, il più veloce</option>
                                    <option value="2">RLE16, consigliato</option>
                                    <option value="3">RAW8, lento</option>
                                    <option value="4">RAW16, molto lento</option>
                                </select>
                            </td>
                        </tr>
                    </tbody></table>
        ...
        <div id="idx_dlgButtonBar" style="padding:10px;margin-bottom:20px">
            ...
            <div><input id="idx_dlgDeleteButton" type="button" value="Elimina" style="display:none" onclick="dialogclose(2)"></div>
        </div>
    </div>
    <div id="topMenu" style="z-index:1000;background-color:#EEE;box-shadow:0px 0px 15px #666;font-family:Arial,Helvetica,sans-serif;border-radius:0px 0px 5px 5px;position:fixed;top:50px;right:5px;width:170px;display:none">
        <div style="padding:12px;border-top:1px solid gray;color:black;cursor:pointer" onclick="topMenu(2)">I miei file </div>
        <div style="padding:12px;border-top:1px solid gray;color:black;cursor:pointer" onclick="topMenu(1)">Il mio Account</div>
        <div id="logoutMenuOption"><a id="logoutMenuOptionRef" href="/logout"><div style="padding:12px;border-top:1px solid gray;color:black;cursor:pointer">Disconnettersi</div></a></div>
    </div>
    ...
    <script>
        ...
        var StatusStrs = ["Disconnesso", "Collegamento ...", "Impostare...", "Collegato", "Intel&reg; AMT Connected"];
        var agentsStr = ["Sconosciuto", "Windows 32bit console", "Windows 64bit console", "Servizio Windows a 32 bit ", "Servizio Windows a 64 bit", "Linux 32bit", "Linux 64bit", "MIPS", "XENx86", "Android", "Linux ARM", "macOS x86-32bit", "Android x86", "PogoPlug ARM", "Android", "Linux Poky x86-32bit", "macOS x86-64bit", "ChromeOS", "Linux Poky x86-64bit", "Linux NoKVM x86-32bit", "Linux NoKVM x86-64bit", "Windows MinCore console", "Servizio Windows MinCore ", "NodeJS", "ARM-Linaro", "ARMv6l / ARMv7l", "ARMv8 64bit", "ARMv6l / ARMv7l / NoKVM", "MIPS24KC (OpenWRT)", "Apple Silicon", "FreeBSD x86-64", "Sconosciuto", "Linux ARM 64 bit (glibc/2.24 NOKVM)", "Alpine Linux x86 64 Bit (MUSL)", "Assistente (Windows)", "Armada370 - ARM32/HF (libc/2.26)", "OpenWRT x86-64", "OpenBSD x86-64", "Sconosciuto", "Sconosciuto", "MIPSEL24KC (OpenWRT)", "ARMADA/CORTEX-A53/MUSL (OpenWRT)", "Windows ARM 64bit console", "Windows ARM 64bit service", "ARMVIRT32 (OpenWRT)", "RISC-V x86-64"];
        var files;
        var terminal;
        ...
        function onStateChanged(server, state, prevState, errorCode) {
            if (state == 0) {
                ...
                if (errorCode == 'noauth') { QH('p0span', "Impossibile eseguire l'autenticazione"); return; }
                if (prevState == 2) { setTimeout(serverPoll, 5000); } else { QH('p0span', "Impossibile connettere  web socket"); }
                // Clean up here
        ...
        function updateSelf() {
            ...
            if (typeof userinfo.passchange == 'number') {
                if (userinfo.passchange == -1) { QH('p2nextPasswordUpdateTime', " - Ripristino al prossimo accesso."); }
                    ...
                    if (seconds < 0) { QH('p2nextPasswordUpdateTime', " - Ripristino al prossimo accesso."); }
                    else if (seconds < 3600) { var secs = Math.floor(seconds / 60); QH('p2nextPasswordUpdateTime',format((secs == 1)?" - Reimpostazione in 1 minuto.":" - Reimpostazione in {0} minuti.", secs)); }
                    else if (seconds < 86400) { var hours = Math.floor(seconds / 3600); QH('p2nextPasswordUpdateTime', format((hours == 1) ? " - Reimpostazione in 1 ora." : " - Reimpostazione in {0} ore.", hours)); }
                    else { var days = Math.floor(seconds / 86400); QH('p2nextPasswordUpdateTime', format((hours == 1) ? " - Reimpostazione in 1 giorno." : " - Reimpostazione in {0} giorni.", days)); }
                }
            }
        }
            ...
            switch (message.action) {
                case 'serverinfo': {
                    ...
                    if (serverinfo.certExpire != null) {
                        ...
                        if ((days >= 0) && (days < 20)) {
                            addNotification({ text: format("Il certificato scade tra {0} giorno(i)", days) });
                        }
                    }
                ...
                case 'otpauth-request': {
                    if ((xxdialogMode == 2) && (xxdialogTag == 'otpauth-request')) {
                        if (message.err != null) {
                            var otpauthErrors = ['', "2FA è bloccato", "I codici di backup sono bloccati", "Token di accesso in uso", "OTP 2FA non consentito", "L'account è bloccato", "Impossibile caricare OTPLIB"];
                            if ((message.err > 0) && (message.err < otpauthErrors.length)) { QH('d2optinfo', otpauthErrors[message.err]); } else { QH('d2optinfo', format("Errore n.{0}", message.err)); }
                        } else {
                            ...
                            QH('d2optinfo', format("Installare" + ' <a href="https://play.google.com/store/apps/details?id=com.google.android.apps.authenticator2" rel="noreferrer noopener" target=_blank>' + "Google Authenticator" + '</a> ' + "o un'applicazione compatibile, utilizza <a href=\"{0}\" rel=\"noreferrer noopener\" target=_blank> questo link </a> o inserisci il segreto di seguito. Quindi, inserisci l'attuale token a 6 cifre per attivare l'accesso in 2 passaggi.", message.url) + '<br /><br /><div style=width:100%;text-align:center><tt id=d2optsecret secret="' + message.secret + '" style=font-size:15px>' + secret + '</tt><br /><br />Token: <input type=text autocomplete="one-time-code" inputmode="numeric" pattern="[0-9]*" onkeypress=\"return (event.keyCode == 8) || (event.charCode >= 48 && event.charCode <= 57)\" onkeyup=account_addOtpCheck(event) onkeydown=account_addOtpCheck() maxlength=6 id=d2otpauthinput type=text></div>');
                            QV('idx_dlgOkButton', true);
                ...
                case 'otpauth-setup': {
                    ...
                    setDialogMode(2, "App Autenticatrice", 1, null, message.success ? ('<b style=color:green>' + "Attivazione dell'app di autenticazionea 2 fattori  riuscita" + '</b> ' + "Ora avrai bisogno di un token valido per accedere di nuovo. ") : ('<b style=color:red>' + "Impossibile abilitare l'autenticazione a due fattori." + '</b> ' + "Cancella il segreto dall'applicazione e riprova. Hai solo pochi minuti per inserire il codice corretto."));
                    break;
                }
                case 'otpauth-clear': {
                    if (xxdialogMode) return;
                    setDialogMode(2, "App Autenticatrice", 1, null, message.success ? ('<b>' + "Applicazione di autenticazione  a 2 fattori  rimossa." + '</b> ' + "Puoi riattivare questa funzione in qualsiasi momento. ") : ('<b style=color:red>' + "Impossibile rimuovere l'autenticazione a due fattori." + '</b> ' + "Riprova."));
                    break;
                }
                case 'otpauth-getpasswords': {
                    if (xxdialogMode) return;
                    var x = "I token una tantum possono essere utilizzati come autenticazione secondaria. Genera un set, stampali e conservali in un luogo sicuro.";
                    ...
                    if (message.passwords) {
                        ...
                        x += '<tr><td>' + "Nessun token attivo";
                    }
                    x += '</table></div></div><br />';
                    x += '<div><input type=button value=\'' + "Chiudere" + '\' onclick=setDialogMode(0) style=float:right></input>';
                    x += '<input type=button value=\'' + "New Tokens" + '\' onclick=\'account_manageOtp(1);\'></input>';
                    if (message.passwords != null) { x += '<input type=button value=\'' + "Pulire" + '\' onclick=\'account_manageOtp(2);\'></input>'; }
                    x += '</div><br />';
                    setDialogMode(2, "Gestisci codici di backup", 8, null, x, 'otpauth-manage');
                    break;
                }
                case 'verifyPhone': {
                    ...
                    x += '<br /><br /><div style=width:100%;text-align:center>' + "Codice di verifica: " + ' <input type=tel pattern="[0-9]" inputmode="number" maxlength=6 id=d2phoneCodeInput onKeyUp=account_managePhoneCodeValidate() onkeypress="if (event.key==\'Enter\') account_managePhoneCodeValidate(1)"></div></table>';
                    setDialogMode(2, "Notifiche telefoniche", 3, account_managePhoneConfirm, x, message.cookie);
                    ...
                    if ((xxdialogMode == 2) && (xxdialogTag == 'previousLogins')) {
                        ...
                        if (message.events.length == 0) {
                            ...
                            for (var i in message.events) {
                                ...
                                if (m == 107) { m = "Accesso valido"; c = 'BBD1BB'; xx = ''; }
                                else if (m == 108) { m = "2FA non valido"; c = 'DD9DC3'; xx = 'x'; }
                                else if (m == 109) { m = "Account bloccato"; c = 'E1BBBB'; xx = 'x'; }
                                else if (m == 110) { m = "Password non valida"; c = 'E1BBBB'; xx = 'x'; }
                        ...
                        setDialogMode(2, "Login precedenti", 1, null, x);
                    }
                    break;
                }
                case 'event': {
        ...
        function goStack() {
            ...
            if (idtype == 'files') {
                ...
                if ((features & 0x00040000) && !((userinfo.otpsecret == 1) || (userinfo.otphkeys > 0) || (userinfo.otpkeys > 0) || (userinfo.otpduo > 0) || (userinfo.otpdev > 0) || ((features & 0x00800000) && (userinfo.otpekey == 1)))) { setDialogMode(2, "Sicurezza dell 'Account", 1, null, "Unable to access this feature until two-factor authentication is enabled. This is required for extra security. Go to the \"My Account\" and look at the \"Account Security\" section."); return; }  
                go(5);
            }
        }
        ...
        function account_viewPreviousLogins() {
            if (xxdialogMode) return;
            setDialogMode(2, "Login precedenti", 1, null, "Caricamento in corso...", 'previousLogins');
        ...
        function account_manageImage(mode) {
            ...
            setDialogMode(2, "Gestisci l'immagine dell'account", 7, account_manageImageEx2, x, user._id);
        ...
        function toggleNightMode() {
            ...
            var x = '<input type=radio id=night0 name=nightmoderadio value=0 ' + ((cNightMode == 0) ? 'checked' : '') + '><label for=night0>' + "Impostazioni predefinite del browser" + '</label><br>';
            x += '<input type=radio id=night2 name=nightmoderadio value=2 ' + ((cNightMode == 2) ? 'checked' : '') + '><label for=night2>' + "Modalità luce" + '</label><br>';
            x += '<input type=radio id=night1 name=nightmoderadio value=1 ' + ((cNightMode == 1) ? 'checked' : '') + '><label for=night1>' + "Modalità scura" + '</label><br>';
            setDialogMode(2, "Modalità notturna", 3, toggleNightModeEx, x);
            QV('uiMenu', false);
        }
        ...
        function account_managePhone() {
            ...
            if (userinfo.phone != null) {
                ...
                x += '<td style=text-align:center><div style=padding:6px>' + "Numero di telefono verificato" + '</div><div style=font-size:20px>' + userinfo.phone + '</div>';
                x += '<div style=margin:10px><label><input id=d2delPhone type=checkbox onclick=account_managePhoneRemoveValidate() />' + "Rimuovi il numero di telefono" + '</label></div>';
                setDialogMode(2, "Notifiche telefoniche", 3, account_managePhoneRemove, x);
                ...
                x += '<br /><br /><div style=width:100%;text-align:center>' + "Numero di telefono:" + ' <input type=tel pattern="[0-9]" autocomplete="tel" inputmode="tel" maxlength=18 id=d2phoneinput onKeyUp=account_managePhoneValidate() onkeypress="if (event.key==\'Enter\') account_managePhoneValidate(1)"></div></table>';
                setDialogMode(2, "Notifiche telefoniche", 3, account_managePhoneAdd, x, 'verifyPhone');
        ...
        function account_showLocalizationSettings() {
            ...
            if (serverinfo.languages && serverinfo.languages.length > 0) {
                y += "La modifica della lingua richiederà un aggiornamento della pagina." + '<br /><br />';
                var z = '<select id=d2langselect style=width:180px><option value="*">' + "Valore del browser dell'utente " + '</option>';
                ...
                z += '</select>';
                y += addHtmlValue("linguaggio", z);
            }
            y += addHtmlValue("Date e ora", x);

            if ((userinfo.siteadmin == 0xFFFFFFFF) && (domain == '')) {
                y += '<br /><a rel="noreferrer noopener" target="_blank" href="translator.htm">' + "Aiutaci a tradurre MeshCentral" + '</a>';
            }

            setDialogMode(2, "Impostazioni di localizzazione", 3, account_showLocalizationSettingsEx, y);
            return false;
        }
        ...
        function account_addOtp() {
            ...
            setDialogMode(2, "App Autenticatrice", 2, function () { meshserver.send({ action: 'otpauth-setup', secret: Q('d2optsecret').attributes.secret.value, token: Q('d2otpauthinput').value }); }, '<div id=d2optinfo>' + "Caricamento in corso..." + '</div>', 'otpauth-request');
        ...
        function account_removeOtp() {
            if (xxdialogMode || (userinfo.otpsecret != 1) || ((features & 4096) == 0)) return;
            setDialogMode(2, "App Autenticatrice", 3, function () { meshserver.send({ action: 'otpauth-clear' }); }, "Confermare la rimozione dell'applicazione di autenticazione accesso in 2 passaggi?");
        }
        ...
        function account_showVerifyEmail() {
            ...
            var x = "Fare clic su OK per inviare un'e-mail di verifica a:" + '<br /><div style=padding:8px><b>' + EscapeHtml(userinfo.email) + '</b></div>' + "Attendi qualche minuto per ricevere la verifica.";
            setDialogMode(2, "verifica email", 3, account_showVerifyEmailEx, x);
        }
        ...
        function account_showChangeEmail() {
            ...
            setDialogMode(2, "Modifica dell'indirizzo e-mail", 3, account_changeEmail, x);
        ...
        function account_showDeleteAccount() {
            ...
            x += '<input id=account_dlgCancelButton type=button value="' + "Annulla" + '" style=float:right;width:80px;margin-left:5px onclick=dialogclose(0)>';
            x += '<input id=account_dlgOkButton type=submit value="' + "OK" + '" style="float:right;width:80px" onclick=dialogclose(1)>';
            x += '</div><br /></form>';
            setDialogMode(2, "Eliminare l'account", 0, null, x);
        ...
        function account_showChangePassword() {
            ...
            x += '<tr><td align=right>' + nobreak("Vecchia password: ") + '</td><td><input id=apassword0 type=password name=apassword0 autocomplete=off onchange=account_validateNewPassword() onkeyup=account_validateNewPassword() onkeydown=account_validateNewPassword() /> <b></b></td></tr>';
            x += '<tr><td align=right>' + nobreak("Nuova password: ") + '</td><td><input id=apassword1 type=password name=apassword1 autocomplete=off onchange=account_validateNewPassword() onkeyup=account_validateNewPassword() onkeydown=account_validateNewPassword() /> <b><span id=dxPassWarn></span></b></td></tr>';
            x += '<tr><td align=right>' + nobreak("Nuova password: ") + '</td><td><input id=apassword2 type=password name=apassword2 autocomplete=off onchange=account_validateNewPassword() onkeyup=account_validateNewPassword() onkeydown=account_validateNewPassword() /></td></tr>';
            if (features & 0x00010000) { x += '<tr><td align=right>' + "Suggerimento password: " + '</td><td><input id=apasswordhint name=apasswordhint maxlength=250 type=text autocomplete=off onchange=account_validateNewPassword() onkeyup=account_validateNewPassword() onkeydown=account_validateNewPassword() /></td></tr>'; }
            x += '</table>'
            if (passRequirements) {
                var r = [], rc = 0;
                for (var i in passRequirements) { if ((i != 'reset') && (i != 'hint')) { r.push(i + ':' + passRequirements[i]); rc++; } }
                if (rc > 0) { x += '<br /><span style=font-size:x-small>' + format("Requisiti: {0}.", r.join(', ')) + '</span>'; }
            }
            x += '<br />';
            setDialogMode(2, "Cambia la password", 3, account_showChangePasswordEx, x);
            Q('apassword0').focus();
        ...
        function account_createMesh() {
            ...
            if ((userinfo.siteadmin != 0xFFFFFFFF) && ((userinfo.siteadmin & 64) != 0)) { setDialogMode(2, "Nuovo gruppo di dispositivi ", 1, null, "Questo account non ha i diritti per creare un nuovo gruppo di dispositivi."); return; }

            // Remind the user to verify the email address
            if ((userinfo.emailVerified !== true) && (serverinfo.emailcheck == true) && (userinfo.siteadmin != 0xFFFFFFFF)) { setDialogMode(2, "Sicurezza dell 'Account", 1, null, "Impossibile accedere a un dispositivo finché non viene verificato un indirizzo e-mail. Questo è necessario per il recupero della password. Vai a \"Il mio account\" per modificare e verificare un indirizzo email. "); return; }

            // Remind the user to add two factor authentication
            if ((features & 0x00040000) && !((userinfo.otpsecret == 1) || (userinfo.otphkeys > 0) || (userinfo.otpkeys > 0) || (userinfo.otpduo > 0) || (userinfo.otpdev > 0) || ((features & 0x00800000) && (userinfo.otpekey == 1)))) { setDialogMode(2, "Sicurezza dell 'Account", 1, null, "Impossibile accedere a un dispositivo finché non viene abilitata l'autenticazione a due fattori. Questo è necessario per una maggiore sicurezza. Vai a \"Il mio account\" e guarda la sezione \"Sicurezza dell'account\". "); return; }

            // We are allowed, let's prompt to information
            var x = addHtmlValue("Nome", '<input id=dp3meshname style=width:170px maxlength=64 onchange=account_validateMeshCreate() onkeyup=account_validateMeshCreate() />');
            x += addHtmlValue("Digita", '<div style=width:170px;margin:0;padding:0><select id=dp3meshtype style=width:100% onchange=account_validateMeshCreate() ><option value=2>' + "Gruppo di agenti software" + '</option><option value=1>' + "Intel&reg; Solo AMT" + '</option></select></div>');
            x += addHtmlValue("Descrizione", '<div style=width:170px;margin:0;padding:0><textarea id=dp3meshdesc maxlength=1024 style=width:100%;resize:none></textarea></div>');
            setDialogMode(2, "Crea gruppo di dispositivi", 3, account_createMeshEx, x);
        ...
        function account_validateNewPassword() {
            ...
            if (Q('apassword1').value != '') {
                if (passRequirements == null || passRequirements == '') {
                    ...
                    if (passReq == false) { ok = false; r = '<span style=color:red>' + "Politica" + '<span>' }
                }
            }
            QH('dxPassWarn', r);
        ...
        function updateMeshes() {
            ...
            for (i in meshes) {
                ...
                var rights = "Diritti parziali ";
                if (meshrights == 0xFFFFFFFF) rights = "Amministratore completo"; else if (meshrights == 0) rights = "Nessun diritto";
        ...
        function updateFiles() {
            ...
            for (var i in filetreexx) {
                ...
                if (f.t < 3 || f.t == 4) {
                    ...
                    var link = shortname;
                    var publiclink = '';
                    if (publicfolder) { publiclink = ' (<a style=cursor:pointer onclick=\'p5showPublicLink("' + publicPath + '/' + f.nx + '")\'>' + "Collegamento" + '</a>)'; }
        ...
        function getNiceSize(bytes) {
            if (bytes <= 0) return "Spazio di archiviazione superato";
            if (bytes < 2048) return format("{0} b rimanenti", bytes);
            if (bytes < 2097152) return format("{0} k rimanenti", Math.round(bytes / 1024));
            if (bytes < 2147483648) return format("{0} m rimanenti", Math.round(bytes / 1024 / 1024));
            return format("{0} g rimanenti", Math.round(bytes / 1024 / 1024 / 1024));
        }
        ...
        function p5setActions() {
            ...
            Q('p5SelectAllButton').value = (cc > 0 ? "Nessuna " : "Tutti");
        ...
        function p5createfolder() { setDialogMode(2, "Nuova cartella", 3, p5createfolderEx, '<input type=text id=p5renameinput maxlength=64 onkeyup=p5fileNameCheck(event) style=width:100% />'); focusTextBox('p5renameinput'); p5fileNameCheck(); }
        ...
        function p5deletefile() { var cc = getFileSelCount(), rec = (getFileSelDirCount() > 0) ? '<br /><br /><label><input type=checkbox id=p5recdeleteinput>' + "Eliminazione ricorsiva" + '</label><br>' : '<input type=checkbox id=p5recdeleteinput style=\'display:none\'>'; setDialogMode(2, "Elimina", 3, p5deletefileEx, (cc > 1) ? (format("Eliminare {0} elementi selezionati?", cc) + rec) : ("Eliminare l'elemento selezionato?" + rec)); }
        ...
        function p5pasteFile() { var x = ''; if ((p5clipboard != null) && (p5clipboard.length > 0)) { x = format("Confermare {0} di {1} voce {2} in questa posizione?", (p5clipboardCut == 0 ? 'copy' : 'move'), p5clipboard.length, ((p5clipboard.length > 1) ? 's' : '')) } setDialogMode(2, "Incolla", 3, p5pasteFileEx, x); }
        ...
        function p5updateClipview() { var x = ''; if ((p5clipboard != null) && (p5clipboard.length > 0)) { x = format("Trattenendo {0} entrie {1} per {2}", p5clipboard.length, ((p5clipboard.length > 1) ? 's' : ''), (p5clipboardCut == 0 ? "copia" : "sposta")) + ', <a href=# onclick="return p5clearClip()" style=cursor:pointer>' + "Pulire" + '</a>.' } QH('p5bottomstatus', x); p5setActions(); }
        ...
        function updateDevices() {
            ...
            for (var i in nodes) {
                ...
                if (sort == 0) {
                    ...
                    if (((meshes[nodes[i].meshid]?nodes[i].meshid:'*') != current)) {
                        deviceHeaderSet();
                        var extra = '';
                        if ((meshes[nodes[i].meshid] != null) && (meshes[nodes[i].meshid].mtype == 1)) { extra = '<span style=color:lightgray>' + ", Intel&reg; Solo AMT" + '</span>'; }
                        ...
                        if (meshes[nodes[i].meshid]) {
                            ...
                            r += '</span><span id=MxMESH><i>' + "Dispositivi individuali" + '</i></span><span id=DevxHeader' + deviceHeaderId + ' style=color:lightgray></span></div>';
                            current = '*';
                        }
            ...
            if ((r == '') && (nodes.length > 0) && (Q('SearchInput').value != '')) {
                viewNothing = true;
                r = '<div style="margin:30px">' + "Nessun dispositivo corrispondente a questa ricerca. " + '</div>';
            }
            ...
            if ((sort == 0) && (Q('SearchInput').value == '')) {
                for (var i in meshes) {
                    ...
                    if ((displayedMeshes[mesh._id] == null) && (IsMeshViewable(mesh))) {
                        ...
                        if (mesh.mtype == 1) { r += '<div style=padding:10px><i>' + "Nessun Intel&reg; Dispositivi AMT in questo gruppo "; }
                        if (mesh.mtype > 1) { r += '<div style=padding:10px><i>' + "Nessun dispositivo in questo gruppo "; }
                        r += '.</i></div></div>';
                        current = mesh._id;
                        count++;
                    }
            ...
            if (count == 0) {
                if ((Q('SearchInput').value != '') || (Q('OnlineCheckBox').checked)) {
                    QH('xdevices', '<div style="margin-top:50px;text-align:center"><span style="font-size:30px">' + "Nessun dispositivo" + '</span><br /><br />' + "Nessun dispositivo corrispondente a questa ricerca. " + ' <a onclick=clearSearchInput() style=cursor:pointer>' + "Cancella filtro di ricerca" + '</a></div>');
                } else {
                    QH('xdevices', '<div style="margin-top:50px;text-align:center"><span style="font-size:30px">' + "Nessun dispositivo" + '</span><br /><br />' + "Utilizza la versione desktop di questo sito Web per aggiungere dispositivi." + '</div>');
                }
            } else {
                QH('xdevices', r);
            }
        ...
        function updateDeviceViewHtml(div, node) {
            ...
            if ((div.offsetTop >= visibleTop) && (div.offsetTop < visibleBottom)) {
                ...
                if (title.length == 0) { title = '<i>' + "Nessuna " + '</i>'; }
                ...
                if (name.length == 0) { name = '<i>' + "Nessuna " + '</i>'; }
                ...
                if (node.sessions != null) {
                    ...
                    if (node.sessions.battery != null) {
                        ...
                        var statestr = '';
                        if (bat.state == 'ac') { statestr = "Il dispositivo è collegato"; }
                        else if (bat.state == 'dc') { statestr = "Il dispositivo è alimentato a batteria"; }
        ...
        function showDeviceHelpRequests(nodeid, force, e) {
            ...
            if (x != '') { setDialogMode(2, "Richieste di aiuto" + ' - ' + EscapeHtml(node.name), 1, null, x, 'HELPREQ-' + node._id); } else { setDialogMode(0); }
            return false;
        }
        ...
        function showDeviceSessions(nodeid, force, e) {
            ...
            for (var i in node.sessions) {
                if ((i == 'kvm') && (node.sessions.multidesk == null)) {
                    x += '<u>' + "Desktop remoto" + '</u>';
                    for (var j in node.sessions.kvm) {
                        if (j.startsWith('user/')) {
                            var trash = '';
                            if ((j == userinfo._id) || (GetNodeRights(node) == 0xFFFFFFFF)) { trash = ' <a href=# onclick=\'return endDeviceSession("kvm", "' + encodeURIComponentEx(node._id) + '", "' + encodeURIComponentEx(j) + '")\' title="' + "Disconnetti questa sessione" + '" style=cursor:pointer><img src=images/trash.png border=0 height=10 width=10></a>'; }
                            x += addHtmlValue4(getUserName(j), ((node.sessions.kvm[j] == 1) ? "1 sessione" : nobreak(format("{0} sessioni", node.sessions.kvm[j]))) + trash);
                        } else if (j == 'busy') {
                            x += addHtmlValue2("Il dispositivo è occupato", ((node.sessions.kvm[j] == 1) ? "1 sessione" : nobreak(format("{0} sessioni", node.sessions.kvm[j]))));
                        }
                    }
                } else if (i == 'multidesk') {
                    x += '<u>' + "Desktop remoto" + '</u>';
                    for (var j in node.sessions.multidesk) {
                        var trash = '';
                        if ((j == userinfo._id) || (GetNodeRights(node) == 0xFFFFFFFF)) { trash = ' <a href=# onclick=\'return endDeviceSession("multidesk", "' + encodeURIComponentEx(node._id) + '", "' + encodeURIComponentEx(j) + '")\' title="' + "Disconnetti questa sessione" + '" style=cursor:pointer><img src=images/trash.png border=0 height=10 width=10></a>'; }
                        x += addHtmlValue4(getUserName(j), ((node.sessions.multidesk[j] == 1) ? "1 sessione" : nobreak(format("{0} sessioni", node.sessions.multidesk[j]))) + trash);
                    }
                } else if (i == 'terminal') {
                    x += '<u>' + "Terminale" + '</u>';
                    for (var j in node.sessions.terminal) {
                        var trash = '';
                        if ((j == userinfo._id) || (GetNodeRights(node) == 0xFFFFFFFF)) { trash = ' <a href=# onclick=\'return endDeviceSession("terminal", "' + encodeURIComponentEx(node._id) + '", "' + encodeURIComponentEx(j) + '")\' title="' + "Disconnetti questa sessione" + '" style=cursor:pointer><img src=images/trash.png border=0 height=10 width=10></a>'; }
                        x += addHtmlValue4(getUserName(j), ((node.sessions.terminal[j] == 1) ? "1 sessione" : nobreak(format("{0} sessioni", node.sessions.terminal[j]))) + trash);
                    }
                } else if (i == 'files') {
                    x += '<u>' + "File" + '</u>';
                    for (var j in node.sessions.files) {
                        var trash = '';
                        if ((j == userinfo._id) || (GetNodeRights(node) == 0xFFFFFFFF)) { trash = ' <a href=# onclick=\'return endDeviceSession("files", "' + encodeURIComponentEx(node._id) + '", "' + encodeURIComponentEx(j) + '")\' title="' + "Disconnetti questa sessione" + '" style=cursor:pointer><img src=images/trash.png border=0 height=10 width=10></a>'; }
                        x += addHtmlValue4(getUserName(j), ((node.sessions.files[j] == 1) ? "1 sessione" : nobreak(format("{0} sessioni", node.sessions.files[j]))) + trash);
                    }
                } else if (i == 'tcp') {
                    x += '<u>' + "Instradamento TCP" + '</u>';
                    for (var j in node.sessions.tcp) {
                        var trash = '';
                        if ((j == userinfo._id) || (GetNodeRights(node) == 0xFFFFFFFF)) { trash = ' <a href=# onclick=\'return endDeviceSession("tcp", "' + encodeURIComponentEx(node._id) + '", "' + encodeURIComponentEx(j) + '")\' title="' + "Disconnetti questa sessione" + '" style=cursor:pointer><img src=images/trash.png border=0 height=10 width=10></a>'; }
                        x += addHtmlValue4(getUserName(j), ((node.sessions.tcp[j] == 1) ? "1 sessione" : nobreak(format("{0} sessioni", node.sessions.tcp[j]))) + trash);
                    }
                } else if (i == 'udp') {
                    x += '<u>' + "Instradamento UDP" + '</u>';
                    for (var j in node.sessions.udp) {
                        var trash = '';
                        if ((j == userinfo._id) || (GetNodeRights(node) == 0xFFFFFFFF)) { trash = ' <a href=# onclick=\'return endDeviceSession("udp", "' + encodeURIComponentEx(node._id) + '", "' + encodeURIComponentEx(j) + '")\' title="' + "Disconnetti questa sessione" + '" style=cursor:pointer><img src=images/trash.png border=0 height=10 width=10></a>'; }
                        x += addHtmlValue4(getUserName(j), ((node.sessions.udp[j] == 1) ? "1 sessione" : nobreak(format("{0} sessioni", node.sessions.udp[j]))) + trash);
                    }
                }
            }
            if (x != '') { setDialogMode(2, "sessioni" + ' - ' + EscapeHtml(node.name), 1, null, x, 'SESSIONS-' + node._id); } else { setDialogMode(0); }
        }
        ...
        function showDeviceMessages(nodeid, force, e) {
            ...
            x += '</div>';
            if (count > 0) setDialogMode(2, "Messaggi dell'agente" + ' - ' + EscapeHtml(node.name), 1, null, x, 'MESSAGES-' + node._id);
            return false;
        }

        var powerStatetable = ['', "Acceso", "Standby", "Standby", "Standby", "In ibernaziome", "Spegni", "Presente", "Spento"];
        var powerStateStrings = ['', "Acceso", "Standby", "Standby", "Deep Sleep", "In ibernaziome", "Soft-Off", "Presente", "Spento"];
        var powerStateStrings2 = ['', "Il dispositivo è alimentato", "Il dispositivo è in stato di sospensione (S1)", "Il dispositivo è in stato di sospensione (S2)", "Il dispositivo è in stato di sospensione profonda (S3)", "Il dispositivo è in ibernazione (S4)", "Il dispositivo è in stato di spegnimento graduale (S5)", "Il dispositivo è presente, ma non è possibile determinare lo stato di alimentazione", "Il dispositivo è spento"];
        ...
        function NodeStateStr(node) {
            ...
            if (node.conn) {
                if ((node.conn & 1) != 0) { states.push('<span>' + ((node.mtype == 4) ? ((node.porttype == 'PDU') ? "Interruttore" : "IP-KVM") : "Agente") + '</span>'); }
                if ((node.conn & 2) != 0) { states.push('<span>' + "CIRA" + '</span>'); }
                else if ((node.conn & 4) != 0) { states.push('<span>' + "Intel&reg; AMT" + '</span>'); }
                if ((node.conn & 8) != 0) { states.push('<span>' + "Ritrasmissioni" + '</span>'); }
        ...
        function deviceHeaderSet() {
            ...
            deviceHeaders['DevxHeader' + deviceHeaderId] = ', ' + deviceHeaderTotal + ((deviceHeaderTotal == 1) ? " nodo" : " nodi");
            var title = '';
        ...
        */
        ...
        function gotoDevice(nodeid, panel, refresh) {
            ...
            if (!currentNode || currentNode._id != node._id || refresh == true) {
                ...
                if ((currentNode.sessions != null) && (currentNode.sessions.battery != null)) {
                    ...
                    var statestr = '';
                    if (bat.state == 'ac') { statestr = "Il dispositivo è collegato"; }
                    if (bat.state == 'dc') { statestr = "Il dispositivo è alimentato a batteria"; }
                ...
                if (nname.length == 0) { nname = '<i>' + "Nessuna " + '</i>'; }
                ...
                // Attribute: Mesh
                if (mesh) { x += addDeviceAttribute('<span>' + "Gruppo" + '</span>', '<a onclick=goForward("' + node.meshid + '") style=cursor:pointer>' + EscapeHtml(meshes[node.meshid].name) + '</a>'); }

                // Attribute: Name
                if (node.rname != null) { x += addDeviceAttribute('<span>' + "Nome" + '</span>', '<span>' + EscapeHtml(node.rname) + '</span>'); }

                // Attribute: Host
                if ((((features & 1) == 0) && (node.mtype != 4)) || (node.mtype == 3)) { // If not WAN-only, local hostname is in use
                    if ((meshrights & 4) != 0) {
                        if (node.host) {
                            x += addDeviceAttribute("Nome host", '<span onclick=showEditNodeValueDialog(1) style=cursor:pointer>' + EscapeHtml(node.host) + '</span>');
                        } else {
                            x += addDeviceAttribute("Nome host", '<span onclick=showEditNodeValueDialog(1) style=cursor:pointer><i>' + "Nessuna " + '</i></span>');
                        }
                    } else {
                        x += addDeviceAttribute("Nome host", EscapeHtml(node.host));
                    }
                }

                // Attribute: Description
                var description = node.desc ? EscapeHtml(node.desc) : '<i>' + "Nessuna " + '</i>';
                if ((meshrights & 4) != 0) {
                    x += addDeviceAttribute("Descrizione", '<span onclick=showEditNodeValueDialog(2) style=cursor:pointer>' + description + '</span>');
                } else {
                    x += addDeviceAttribute("Descrizione", description);
                }

                // IP-KVM information
                if (node.mtype == 4) {
                    if (node.portnum != null) { x += addDeviceAttribute("Numero di porta", node.portnum); }
                    if (node.porttype != null) { x += addDeviceAttribute("Tipo di porta", node.porttype); }
                }

                // Attribute: Mesh Agent
                if ((node.agent != null) && (node.agent.id != null) && (node.mtype == 3)) {
                    if (node.agent.id == 4) { x += addDeviceAttribute("Tipo di dispositivo", "Windows"); }
                    if (node.agent.id == 6) { x += addDeviceAttribute("Tipo di dispositivo", "Linux"); }
                    if (node.agent.id == 29) { x += addDeviceAttribute("Tipo di dispositivo", "macOS"); }
                    ...
                    if ((node.agent.root === false) && ((node.conn & 1) != 0)) { str += ', ' + "Limitato"; }
                ...
                if (node.intelamt != null) {
                    var str = '';
                    var provisioningStates = { 0: nobreak("Non attivato (pre) "), 1: nobreak("Non attivato (in) "), 2: nobreak("Attivato") };
                    if (node.intelamt.ver != null && node.intelamt.state == null) { str += '<i>' + nobreak("Stato sconosciuto") + '</i>, v' + EscapeHtml(node.intelamt.ver); }
                    else if ((node.intelamt.ver == null) && (node.intelamt.state == 2)) { str += '<i>' + "Attivato" + '</i>'; }
                    else if ((node.intelamt.ver == null) || (node.intelamt.state == null)) { str += '<i>' + "Versione e stato sconosciuti " + '</i>'; }
                    else {
                    ...
                    if (node.intelamt.state == 2) {
                        if (node.intelamt.tls == 1) { str += ', <span title="' + "Intel&reg; AMT è configurato con la sicurezza di rete TLS" + '">' + "TLS" + '</span>'; }
                        ...
                        if (node.intelamt.user == null || node.intelamt.user == '') { // If credentials are not set, allow setting them.
                            if ((meshrights & 4) != 0) {
                                str += ', <i style=color:#FF0000;cursor:pointer title="' + "Modifica Intel&reg; Credenziali AMT" + '" onclick=editDeviceAmtSettings("' + node._id + '")>' + "Nessuna credenziale" + '</i>';
                                editUserCredentialsIcon = true;
                            } else {
                                str += ', <i style=color:#FF0000>' + "Nessuna credenziale" + '</i>';
                            }
                            ...
                            var warn = null;
                            if ((node.intelamt.warn & 1) != 0) { warn = "Credenziali non valide"; }
                            if ((node.intelamt.warn & 8) != 0) { warn = "Provare le credenziali"; }
                            if (warn != null) {
                                if ((meshrights & 4) != 0) {
                                    str += ', <i style=color:#FF0000;cursor:pointer title="' + "Modifica Intel&reg; Credenziali AMT" + '" onclick=editDeviceAmtSettings("' + node._id + '")>' + warn + '</i>';
                                    editUserCredentialsIcon = true;
                                } else {
                        ...
                        if (editUserCredentialsIcon) {
                            str += '<img src=images/link4.png height=10 width=10 title="' + "Modifica Intel&reg; Credenziali AMT" + '" style=cursor:pointer onclick=editDeviceAmtSettings("' + node._id + '")>';
                        }
                    }
                ...
                if ((node.agent != null) && (node.agent.tag != null) && (node.agent.tag != 'mailto:')) {
                    ...
                    x += addDeviceAttribute("Etichetta agente", tag);
                }
                ...
                if (connectivity && connectivity > 1) {
                    var cstate = [];
                    if ((node.conn & 1) != 0) cstate.push('<span>' + ((node.mtype == 4) ? ((node.porttype == 'PDU') ? "Interruttore" : "IP-KVM") : "Agente") + '</span>');
                    if ((node.conn & 2) != 0) cstate.push('<span>' + "Intel&reg; AMT CIRA" + '</span>');
                    else if ((node.conn & 4) != 0) cstate.push('<span>' + "Intel&reg; AMT" + '</span>');
                    if ((node.conn & 8) != 0) cstate.push('<span>' + "agente di ritrasmissione" + '</span>');
                    if ((node.conn & 16) != 0) cstate.push('<span>' + "MQTT " + '</span>');
                    x += addDeviceAttribute("Connettività", cstate.join(', '));
                }

                // Node tags
                var groupingTags = '<i>' + "Nessuna " + '</i>';
                ...
                if ((node.ssh != null) || (node.rdp != null)) {
                    var y = [];
                    if ((meshrights & 4) != 0) {
                        if (node.ssh != null) { y.push('<span onclick=showClearSshDialog(3) style=cursor:pointer>' + ((node.ssh == 1) ? "Utente SSH+Pass" : ((node.ssh == 2) ? "Utente SSH+Chiave+Pass" : "SSH-Utente+Chiave")) + ' <img class=hoverButton src="images/link5.png" width=10 height=10 /></span>'); }
                        ...
                        if (node.ssh != null) { y.push(((node.ssh == 1) ? "Utente SSH+Pass" : ((node.ssh == 2) ? "Utente SSH+Chiave+Pass" : "SSH-Utente+Chiave"))); }
                        if (node.rdp != null) { y.push("RDP"); }
                    }
                    x += addDeviceAttribute("Credenziali", y.join(', '));
                }

                x += '</table><br />';
                // Show action button, only show if we have permissions 4, 8, 64
                if (((meshrights & (4 + 8 + 64 + 262144)) != 0) && (node.mtype < 3)) { x += '<input type=button value="' + "Azioni" + '" onclick=deviceActionFunction() />'; }
                x += '<input type=button value="' + "Appunti " + '" onclick=showNotes(' + ((meshrights & 128) == 0) + ',"' + encodeURIComponent(node._id) + '") />';
                ...
                if ((node.mtype == 4) && (connectivity & 1)) {
                    if (node.porttype == 'PDU') {
                        if (node.pwr == 1) {
                            if (meshrights & 0x40000) { x += '<input type=button value="' + "Spegni" + '" title="' + "Spegni" + '" onclick=setIpPduState(0) />'; }
                        } else if (node.pwr == 8) {
                            if (meshrights & 0x40) { x += '<input type=button value="' + "Accendere" + '" title="' + "Accendere" + '" onclick=setIpPduState(1) />'; }
                        }
                    } else {
                        if (meshrights & 8) { x += '<input type=button value="' + "Controllo remoto" + '" title="' + "Controllo remoto" + '" onclick=openIpKvmRemoteControl("' + encodeURIComponentEx(node._id) + '") />'; }x
                    }
                }
                ...
                if ((meshrights & 0x8000) != 0) { x += '<a style=cursor:pointer onclick=p10showDeleteNodeDialog("' + node._id + '")>' + "Elimina dispositivo" + '</a>'; }
                ...
                if ((connectivity & 1) != 0) { if (powerstate.length > 0) { powerstate += ', '; } powerstate += ((node.mtype == 4) ? ((node.porttype == 'PDU') ? "Interruttore" : "IP-KVM") : "Agente Mesh"); }
                if ((connectivity & 2) != 0) { if (powerstate.length > 0) { powerstate += ', '; } powerstate += "Intel&reg; AMT connesso"; }
                else if ((connectivity & 4) != 0) { if (powerstate.length > 0) { powerstate += ', '; } powerstate += "Intel&reg; Rilevato AMT"; }
                if ((connectivity & 16) != 0) { if (powerstate.length > 0) { powerstate += ', '; } powerstate += "Canale MQTT collegato "; }
        ...
        function setIpPduState(op) {
            if (op == 0) {
                setDialogMode(2, "Operazione di potenza", 3, function () { meshserver.send({ action: 'poweraction', nodeids: [currentNode._id], actiontype: 2 }); }, "Eseguire lo spegnimento?"); // Turn off
            } else {
                setDialogMode(2, "Operazione di potenza", 3, function () { meshserver.send({ action: 'wakedevices', nodeids: [currentNode._id] }); }, "Eseguire l'accensione?"); // Turn on
            }
        }
        ...
        function deviceToastFunction() {
            if (xxdialogMode) return;
            setDialogMode(2, "Toast del dispositivo", 3, deviceToastFunctionEx, '<textarea id=d2devToast style=width:100%;height:80px;resize:none;overflow-y:scroll></textarea>');
        }
        ...
        function setupDeviceMenu(op, obj) {
            ...
            var menus = [];
            if (currentDevicePanel != 0) { menus.push({ n: "Generale", f: 'setupDeviceMenu(0)' }); }
            ...
            ) { menus.push({ n: "Terminale", f: 'setupDeviceMenu(5)' }); }

            if ((currentDevicePanel != 2) && (currentNode != null) && (meshrights & 8) && ((meshrights == 0xFFFFFFFF) || ((meshrights & 1024) == 0)) && ((currentNode.mtype != 1) && (currentNode.agent) && (currentNode.agent.caps & 4))) { menus.push({ n: "File", f: 'setupDeviceMenu(2)' }); }
            if ((currentDevicePanel != 3) && (currentNode != null) && (currentNode.mtype < 3) && ((meshrights & 1048576) != 0)) { menus.push({ n: "Dettagli", f: 'setupDeviceMenu(3)' }); }
        ...
        function deviceActionFunction() {
            ...
            var x = "Seleziona un'operazione da eseguire su questo dispositivo." + '<br /><br />';
            ...
            if ((currentNode.agent != null) && (currentNode.agent.id == 14)) {
                if (((currentNode.conn & 1) != 0) && ((rights & 8) != 0)) {
                    count++;
                    y += '<option value=400>' + "Lampeggia" + '</option>';
                    y += '<option value=401>' + "Vibrare" + '</option>';
                    z += '<div id=d2devicetimediv>' + addHtmlValue("Tempo", '<select id=d2devicetime style=float:right;width:170px><option value=1000>' + "1 secondo" + '</option><option value=5000>' + "5 secondi" + '</option><option value=10000>' + "10 secondi" + '</option></select>') + '</div>';
                }
            } else {
                if ((rights & 64) != 0) { count++; y += '<option value=100>' + "Risveglio" + '</option>'; } // Wake-up permission
                //if (((currentNode.conn & 1) != 0) && ((rights & 131072) != 0)) { count++; y += '<option value=106>' + "Run Commands" + '</option>'; } // Remote command permission
                if ((currentNode.conn != 0) && ((rights & 262144) != 0)) { count++; y += '<option value=4>' + "Standby" + '</option><option value=3>' + "Ripristina" + '</option><option value=2>' + "Spegni" + '</option>'; }
                ...
                if ((currentNode.intelamt != null) && (currentNode.intelamt.state == 2) && ((currentNode.conn & 6) != 0) && ((rights & 262144) != 0)) {
                    count++;
                    y += '<option value=310>' + "Intel&reg; Ripristino AMT" + '</option>';
                    y += '<option value=308>' + "Intel&reg; Spegnimento AMT" + '</option>';
                }
                if ((currentNode.intelamt != null) && (currentNode.intelamt.state == 2) && ((currentNode.conn & 6) != 0) && ((rights & 64) != 0)) {
                    count++;
                    y += '<option value=302>' + "Intel&reg; Accensione AMT" + '</option>';
                }
            ...
            y += '</select>';
            x += addHtmlValue("operazione", y);
            if (count == 0) { x = "Nessuna azione attualmente disponibile per questo dispositivo."; }
            setDialogMode(2, "Azione del dispositivo", (count == 0) ? 2 : 3, deviceActionFunctionEx, x + z);
        ...
        function deviceActionFunctionEx() {
            ...
            if (op == 100) {
                ...
                */
                ...
                setDialogMode(2, "Intel&reg; AMT Power Operation", 3, function () { meshserver.send({ action: 'poweraction', nodeids: [currentNode._id], actiontype: parseInt(op) }); }, "Esegui Intel&reg; AMT acceso?");
                ...
                setDialogMode(2, "Intel&reg; AMT Power Operation", 3, function () { meshserver.send({ action: 'poweraction', nodeids: [currentNode._id], actiontype: parseInt(op) }); }, "Esegui Intel&reg; AMT resettato?");
        ...
        function showNotes(readonly, noteid) {
            ...
            if (noteid.startsWith('node%2F%2F')) { x += '<span style=font-size:10px>' + "Le note del gruppo di dispositivi possono essere visualizzate e modificate da altri amministratori del gruppo di dispositivi." + '<span>'; }
            setDialogMode(2, "Appunti ", 3, showNotesEx, x, noteid);
        ...
        function deviceLockFunction() {
            if ((xxdialogMode != null || xxdialogMode == 0) && (desktop != null) && (desktop.contype == 1)) { setDialogMode(2, "Blocca desktop", 3, function() { if ((desktop != null) && (desktop.contype == 1)) { desktop.sendCtrlMsg('{"ctrlChannel":"102938","type":"lock"}'); } }, "Bloccare il desktop dell'utente?"); }
        }

        function deviceChat(e) {
            if (xxdialogMode) return;
            setDialogMode(2, "Azione del dispositivo", 3, function () {
        ...
        function deviceUrlFunction() {
            if (xxdialogMode) return;
            setDialogMode(2, "Apri pagina sul dispositivo ", 3, deviceUrlFunctionEx, '<input id=d2devurl placeholder="http://server.com" style=width:100%;overflow-y:scroll onkeyup=deviceUrlFunctionValidate() onchange=deviceUrlFunctionValidate()></input>');
            Q('d2devurl').focus();
        ...
        function d2runCommandDialog(options) {
            ...
            if ((wintype == true) || (linuxtype == true) || (agenttype == true)) {
                ...
                if (linuxtype == true) { x += '<option value=3' + ((runopt.type == 3)?' selected':'') + '>' + "Shell dei comandi Linux / BSD / macOS" + '</option>'; }
                if (agenttype == true) { x += '<option value=4' + ((runopt.type == 4)?' selected':'') + '>' + "Console Agente" + '</option>'; } // MESHRIGHT_REMOTECONTROL & MESHRIGHT_AGENTCONSOLE are needed
                x += '</select>';
                x += '<select id=d2cmduser style=width:100%;margin-bottom:4px><option value=0' + ((runopt.runAs == 0)?' selected':'') + '>' + "Esegui come agente" + '</option><option value=1' + ((runopt.runAs == 1)?' selected':'') + '>' + "Esegui come utente, agente se nessun utente" + '</option><option value=2' + ((runopt.runAs == 2)?' selected':'') + '>' + "Deve essere eseguito come utente " + '</option></select>';
                ...
                setDialogMode(2, "Esegui comandi", 3, d2groupActionFunctionRunCommands, x, options);
                if (options.selectedFile == null) {
                    Q('d2runcmd').focus();
        ...
        function editDeviceAmtSettings(nodeid, func) {
            ...
            x += addHtmlValue("Nome utente", '<input id=dp10username style=width:170px maxlength=32 autocomplete=nope placeholder="admin" onchange=validateDeviceAmtSettings() onkeyup=validateDeviceAmtSettings() />');
            ...
            if ((features2 & 1) == 0) { x += addHtmlValue("Sicurezza", '<select id=dp10tls style=width:176px><option value=0>' + "Nessuna sicurezza TLS " + '</option><option value=1>' + "Sicurezza TLS richiesta" + '</option></select>'); }
            if ((node.intelamt.user != null) && (node.intelamt.user != '')) { buttons = 7; }
            setDialogMode(2, "Modifica Intel&reg; Credenziali AMT", buttons, editDeviceAmtSettingsEx, x, { node: node, func: func });
        ...
        function p10showDeleteNodeDialog(nodeid) {
            if (xxdialogMode) return;
            setDialogMode(2, "Elimina nodo", 3, p10showDeleteNodeDialogEx, format("Eliminare {0}?", EscapeHtml(currentNode.name)) + '<br /><br /><label><input id=p10check type=checkbox onchange=p10validateDeleteNodeDialog() />' + "Confermare" + '</label>', nodeid);
        ...
        function p10showiconselector() {
            ...
            setDialogMode(2, "Selezione dell'icona", 0, null, x);
        ...
        function showClearSshDialog() { setDialogMode(2, "Modifica dispositivo", 3, showClearSshDialogEx, "Cancellare le credenziali SSH?"); }
        function showClearSshDialogEx(button, mode) { meshserver.send({ action: 'changedevice', nodeid: currentNode._id, ssh: 0 }); }
        function showClearRdpDialog() { setDialogMode(2, "Modifica dispositivo", 3, showClearRdpDialogEx, "Cancellare le credenziali RDP?"); }
        function showClearRdpDialogEx(button, mode) { meshserver.send({ action: 'changedevice', nodeid: currentNode._id, rdp: 0 }); }

        var showEditNodeValueDialog_modes = ["Nome del dispositivo", "Nome host", "Descrizione", "Tags"];
        var showEditNodeValueDialog_modes2 = ['name', 'host', 'desc', 'tags'];
        var showEditNodeValueDialog_modes3 = ['', '', '', "Gruppo1, Gruppo2, Gruppo3"];
        function showEditNodeValueDialog(mode) {
            ...
            setDialogMode(2, "Modifica dispositivo", 3, showEditNodeValueDialogEx, x, mode);
        ...
        var agentConsoleMessages = ['', "In attesa che l'utente conceda l'accesso... ", "Negato", "Impossibile avviare la sessione del terminale remoto, {0} ({1})", "Tempo scaduto", "Dati di rete non validi ricevuti"];
        ...
        function updateDeskShortcutKeys() {
            var x = '<div class="menuButton" onclick="deskMenuButton(-1)">' + "Personalizzare" + '</div>';
        ...
        var keyStrings = { 8: "Tornare  indietro", 9: "Tab", 13: "accedere", 27: "Escape", 32: "Space", 44: "Stampa schermo", 45: "Inserire", 46: "Canc", 36: "Home", 35: "Fine", 32: "Espace", 33: "Pagina su", 34: "Pagina giù", 37: "Sinistra", 38: "Su", 39: "Destro", 40: "Giù", 0: "Nessuna " }
        ...
        function deskCustomizeKeys() {
            ...
            x += '</select> <input type=button value=' + "Aggiungi" + ' onclick=addDeskCustomizeKey() /></div>';
            QH('p10dialog2', x);
            xxdialogMode = 2;
            QV('p10dialog', true);
        ...
        function deskUpdateShortcutList() {
            ...
            if (x == '') { x = '<i>' + "Nessuna scorciatoia da tastiera definita" + '</i>'; }
            QH('d2shortcuts', x);
        }
        ...
        function sendSpecialKeys() {
            if (xxdialogMode || desktop == null || desktop.State != 3) return;
            setDialogMode(3, "Tasti speciali", 3, deskSendKeys);
        }
        ...
        function deskSelectScreens() {
            ...
            x = addHtmlValue4("Schermo", '<select style=width:100% id=deskdisplays>' + x + '</select>');
            setDialogMode(2, "Selezione dello schermo", 3, deskSelectScreensEx, x);
        }
        ...
        function updateTerminalButtons() {
            ...
            if (((termState == true) && (terminal.contype != 3)) || (terminalNode.agent == null) || (terminalNode.agent.id == 3) || (terminalNode.agent.id == 4)) {
                ...
                QH('terminalCustomUpperRight', '<a style=cursor:pointer onclick=cmsshportaction(1,event)>' + format("Porta SSH {0}", (terminalNode.sshport ? terminalNode.sshport : 22)) + '</a>');
            }
        }

        function cmsshportaction(action) {
            if (xxdialogMode) return;
            var x = "Porta di connessione remota SSH:" + '<br /><br /><input type=text placeholder="22" inputmode="numeric" pattern="[0-9]*" onkeypress="return (event.keyCode == 8) || (event.charCode >= 48 && event.charCode <= 57)" maxlength=5 id=d10sshport type=text>';
            setDialogMode(2, "Connessione SSH", 3, function () {
        ...
        function sshTunnelAuthDialog(j, func) {
            var x = '';
            if (j.askkeypass) {
                x += addHtmlValue("Autenticazione", '<select id=dp2authmethod style=width:150px onchange=sshAuthUpdate(event)><option value=3 selected>' + "Chiave memorizzata" + '</option><option value=1>' + "Nome utente e password" + '</option><option value=2>' + "Nome utente e chiave" + '</option></select>');
            } else {
                x += addHtmlValue("Autenticazione", '<select id=dp2authmethod style=width:150px onchange=sshAuthUpdate(event)><option value=1 selected>' + "Nome utente e password" + '</option><option value=2>' + "Nome utente e chiave" + '</option></select>');
            }
            x += '<div id=d2userauth style=display:none>';
            x += addHtmlValue("Nome utente", '<input id=dp2user style=width:150px maxlength=64 autocomplete=off onkeyup=sshAuthUpdate(event) />');
            x += '</div>';
            ...
            if ((features2 & 0x00400000) == 0) { x += '<label><input id=dp2keep type=checkbox>' + "Ricorda le credenziali" + '</label>'; }
            x += '</div><div id=d2keyauth style=display:none>';
            x += addHtmlValue("File chiave", '<input type=file id=dp2key style=width:150px maxlength=64 autocomplete=off onchange=sshAuthUpdate(event) />' + '<div id=d2badkey style=font-size:x-small>' + "Il file chiave deve essere in formato OpenSSH." + '</div>');
            x += addHtmlValue("Password chiave", '<input type=password id=dp2keypass style=width:150px maxlength=64 autocomplete=off onkeyup=sshAuthUpdate(event) />');
            if ((features2 & 0x00400000) == 0) {
                x += '<label><input id=dp2keep1 type=checkbox onchange=sshAuthUpdate(event)>' + "Ricorda utente e chiave" + '</label><br/>';
                x += '<label><input id=dp2keep2 type=checkbox>' + "Ricordare la password" + '</label>';
            }
            x += '</div>';
            if (j.askkeypass) {
            ...
            setDialogMode(2, "Autenticazione", 11, func, x, 'ssh');
            Q('dp2user').focus();
            sshAuthUpdate();
            ...
            if (typeof data == 'string') {
                if (data[0] == '{') {
                    ...
                    switch (j.action) {
                        ...
                        case 'autherror': { p12setConsoleMsg("Errore di autenticazione", 5000); break; }
                        case 'sessionerror': { p12setConsoleMsg("Sessione scaduta", 5000); break; }
                        case 'sessiontimeout': { p12setConsoleMsg("Timeout della sessione", 5000); break; }
                    }
                } else if (data[0] == '~') {
        ...
        */
        ...
        function p13gotFiles(data) {
            ...
            switch (data.action) {
                ...
                case 'autherror': { p13setConsoleMsg("Errore di autenticazione", 5000); return; }
                case 'connectionerror': { p13setConsoleMsg("Errore di connessione", 5000); return; }
                case 'sessionerror': { p13setConsoleMsg("Sessione scaduta", 5000); return; }
                case 'sessiontimeout': { p13setConsoleMsg("Timeout della sessione", 5000); return; }
            }
        ...
        function p13setActions() {
            ...
            if (p13filetree == null) {
                ...
                Q('p13SelectAllButton').value = "Tutti";
                ...
                Q('p13SelectAllButton').value = (cc > 0 ? "Nessuna " : "Tutti");
            ...
            if (((filesState == true) && (files.contype != 2)) || (filesNode.agent == null) || (filesNode.agent.id == 3) || (filesNode.agent.id == 4)) {
                ...
                QH('filesCustomUpperRight', '<a style=cursor:pointer onclick=cmsshportaction(1,event)>' + format("Porta SSH {0}", (filesNode.sshport ? filesNode.sshport : 22)) + '</a>');
            }
        ...
        function p13createfolder() { setDialogMode(2, "Nuova cartella", 3, p13createfolderEx, '<input type=text id=p13renameinput maxlength=64 onkeyup=p13fileNameCheck(event) style=width:100% />'); focusTextBox('p13renameinput'); p13fileNameCheck(); }
        ...
        function p13deletefile() { var cc = p13getFileSelCount(), rec = (p13getFileSelDirCount() > 0) ? '<br /><br /><label><input type=checkbox id=p13recdeleteinput>' + "Eliminazione ricorsiva" + '</label><br>' : '<input type=checkbox id=p13recdeleteinput style=\'display:none\'>'; setDialogMode(2, "Elimina", 3, p13deletefileEx, (cc > 1) ? (format("Eliminare {0} elementi selezionati?", cc) + rec) : ("Eliminare l'elemento selezionato?" + rec)); }
        ...
        function p13renamefile() { var renamefile, checkboxes = document.getElementsByName('fd'); for (var i = 0; i < checkboxes.length; i++) { if (checkboxes[i].checked) { renamefile = p13filetree.dir[checkboxes[i].value].n; } } setDialogMode(2, "Rinominare", 3, p13renamefileEx, '<input type=text id=p13renameinput maxlength=64 onkeyup=p13fileNameCheck(event) style=width:100% value="' + renamefile + '" />', { action: 'rename', path: p13filetreelocation.join('/'), oldname: renamefile }); focusTextBox('p13renameinput'); p13fileNameCheck(); }
        ...
        function p13uploadFile() { setDialogMode(2, "Caricare un file", 3, p13uploadFileEx, '<input type=file name=files id=p13uploadinput style=width:100% multiple=multiple onchange="updateUploadDialogOk(\'p13uploadinput\')" />'); updateUploadDialogOk('p13uploadinput'); }
        ...
        function p13viewfile() {
            ...
            for (var i = 0; i < checkboxes.length; i++) {
                if (checkboxes[i].checked) {
                    ...
                    } else { messagebox("Editor di file", "È possibile modificare solo i file inferiori a 200k."); }
                    break;
                }
            }
        }
        ...
        function p13pasteFile() {
            ...
            if ((p13clipboard != null) && (p13clipboard.length > 0)) {
                if (p13clipboardCut == 0) {
                    if (p13clipboard.length > 1) { x = format("Confermare la copia di {0} voci in questa posizione?", p13clipboard.length); } else { x = format("Confermare la copia di 1 voce in questa posizione?"); }
                } else {
                    if (p13clipboard.length > 1) { x = format("Confermare lo spostamento di {0} voci in questa posizione?", p13clipboard.length); } else { x = format("Confermare lo spostamento di 1 voce in questa posizione?"); }
                }
            }
            setDialogMode(2, "Incolla", 3, p13pasteFileEx, x);
        }
            ...
            if ((p13clipboard != null) && (p13clipboard.length > 0)) {
                if (p13clipboardCut == 0) {
                    if (p13clipboard.length > 1) {
                        x = format("Conservazione di {0} voci per la copia" + ', <a href=# onclick="return p13clearClip()" style=cursor:pointer>' + "Pulire" + '</a>.', p13clipboard.length);
                    } else {
                        x = format("Tenendo 1 entrata per la copia" + ', <a href=# onclick="return p13clearClip()" style=cursor:pointer>' + "Pulire" + '</a>.');
                    }
                } else {
                    if (p13clipboard.length > 1) {
                        x = format("Trattenendo {0} voci per lo spostamento" + ', <a href=# onclick="return p13clearClip()" style=cursor:pointer>' + "Pulire" + '</a>.', p13clipboard.length);
                    } else {
                        x = format("Tenendo premuto 1 ingresso per il movimento" + ', <a href=# onclick="return p13clearClip()" style=cursor:pointer>' + "Pulire" + '</a>.');
                    }
                }
            }
        ...
        function p13downloadfile(x, y, z) {
            ...
            setDialogMode(2, "Scarca  File", 10, p13downloadFileCancel, '<div>' + EscapeHtml(downloadFile.file) + '</div><br /><progress id=d2progressBar style=width:100% value=0 max=' + z + ' />');
        }
        ...
        */
        ...
        function p13doUploadFiles(files) {
            ...
            if (overWriteCount == 0) {
                ...
                setDialogMode(2, "Caricare un file", 3, p13uploadFileContinue, format((overWriteCount == 1) ? "Il caricamento sovrascriverà 1 file. Continua? " : "Il caricamento sovrascriverà {0} file. Continua? ", overWriteCount), files);
            }
        }
        ...
        function p13uploadFileContinue(b, files) {
            ...
            setDialogMode(2, "Caricare un file", 10, p13uploadFileCancel, '<div id=p13dfileName>' + "Collegamento ..." + '</div><br /><progress id=d2progressBar style=width:100% value=0 max=0 />');
            p13uploadNextFile();
        }
        ...
        function updateDeviceDetails(node, hardware, network) {
            ...
            // Operating System
            var x = '';
            if (node.rname) { x += addDetailItem("Nome", EscapeHtml(node.rname), s); }
            if (hardware.windows && hardware.windows.osinfo && hardware.windows.osinfo.Description) { x += addDetailItem("Descrizione", EscapeHtml(hardware.windows.osinfo.Description), s); }
            if (node.osdesc) { x += addDetailItem("Versione ", EscapeHtml(node.osdesc), s); }
            if (hardware.windows && hardware.windows.osinfo) {
                var m = hardware.windows.osinfo;
                if (m.OSArchitecture) {
                    if (m.OSArchitecture.startsWith('32')) { x += addDetailItem("Architettura", "32 bit", s); }
                    else if (m.OSArchitecture.startsWith('64')) { x += addDetailItem("Architettura", "64 bit", s); }
                    else { x += addDetailItem("Architettura", EscapeHtml(m.OSArchitecture), s); }
                }
                if(m.LastBootUpTime){
                    var thedate = {
                ...
                if(m.Domain){ x += addDetailItem((m.PartOfDomain ? "Dominio" : "Gruppo di lavoro"), EscapeHtml(m.Domain), s); }
            }
            ...
            if (node.wsc) {
                var y = [];
                if (node.wsc.antiVirus != null) { if (node.wsc.antiVirus == 'OK') { y.push("AV" + ' - <span style=color:green>' + "OK" + '</span>'); } else { y.push("AV" + ' - <span style=color:red>' + "CATTIVO" + '</span>'); } }
                if (node.wsc.autoUpdate != null) { if (node.wsc.autoUpdate == 'OK') { y.push("Aggiornamenti" + ' - <span style=color:green>' + "OK" + '</span>'); } else { y.push("Aggiornamenti" + ' - <span style=color:red>' + "CATTIVO" + '</span>'); } }
                if (node.wsc.firewall != null) { if (node.wsc.firewall == 'OK') { y.push("Firewall" + ' - <span style=color:green>' + "OK" + '</span>'); } else { y.push("Firewall" + ' - <span style=color:red>' + "CATTIVO" + '</span>'); } }
                x += addDetailItem("Sicurezza di Windows", y.join(', '));
            }

            // Defender for Windows Server
            if(node.defender) {
                var y = [];
                if (node.defender.RealTimeProtection != null) { if (node.defender.RealTimeProtection == true) { y.push("RealTimeProtection" + ' - <span style=color:green>' + "On" + '</span>'); } else { y.push("RealTimeProtection" + ' - <span style=color:red>' + "Spento" + '</span>'); } }
                if (node.defender.TamperProtected != null) { if (node.defender.TamperProtected == true) { y.push("TamperProtection" + ' - <span style=color:green>' + "On" + '</span>'); } else { y.push("TamperProtection" + ' - <span style=color:red>' + "Spento" + '</span>'); } }
                if (node.defender.AntivirusSignatureVersion != null) { y.push("Versione della firma" + ' - <span style=color:green>' + EscapeHtml(node.defender.AntivirusSignatureVersion) + '</span>'); }
            ...
            if (node.av && node.av.length > 0) {
                ...
                for (var i in node.av) {
                    if (node.av[i].product) {
                        ...
                        if (node.av[i].enabled !== true) { avx += ' - <span style=color:red>' + "Disabilitato" + '</span>'; }
                        if (node.av[i].updated !== true) { avx += ' - <span style=color:red>' + "Scaduto" + '</span>'; }
           ...
           if (node.users && node.users.length > 0) {
                var u = node.users.map(function(user) {
                    return addKeyLinkConditional(EscapeHtml(user), "Bloccato", (node.lusers && node.lusers.indexOf(user) >= 0));
                }).join(', ');
                x += addDetailItem((node.users.length > 1 ? "Utenti attivi" : "Utente attivo"), u);
            }
            ...
            if (node.agent) {
                ...
                if (node.firstconnect) { x += addDetailItem("Prima connessione dell'agente", printDateTime(new Date(node.firstconnect))); }
                if ((node.conn & 1) != 0) {
                    x += addDetailItem("Ultimo collegamento dell'agente", "Connesso ora");
                } else {
                    if (node.lastconnect) { x += addDetailItem("Ultimo collegamento dell'agente", printDateTime(new Date(node.lastconnect))); }
                }
                if (node.lastaddr) {
                    var splitip = node.lastaddr.split(':');
                    if (splitip.length > 2) {
                        // IPv6
                        x += addDetailItem("Ultimo indirizzo dell'agente", node.lastaddr);
                    } else {
                        // IPv4
                        if (isPrivateIP(node.lastaddr)) {
                            x += addDetailItem("Ultimo indirizzo dell'agente", splitip[0]);
                        } else {
                            x += addDetailItem("Ultimo indirizzo dell'agente", '<a href="https://iplocation.com/?ip=' + splitip[0] + '" rel="noreferrer noopener" target="MeshIPLoopup">' + splitip[0] + '</a>');
                        }
                    }
                }
                if (hardware.agentvers != null) {
                    if (hardware.agentvers.compileTime) {
                        try {
                            ...
                            x += addDetailItem("Tempo di compilazione", printDateTime(new Date(d)));
                        } catch (ex) { }
                    }
                }
                if (hardware.time != null) {
                    x += addDetailItem("Ultimo aggiornamento dei dettagli", printDateTime(new Date(hardware.time)));
                }
            ...
            if (hardware.mobile) {
                var x = '';
                if (hardware.mobile.brand && hardware.mobile.model) { x += addDetailItem("Modello", EscapeHtml(hardware.mobile.brand + ', ' + hardware.mobile.model), s); }
                if (hardware.mobile.device) { x += addDetailItem("Dispositivo", EscapeHtml(hardware.mobile.device), s); }
                if (hardware.mobile.bootloader) { x += addDetailItem("Boot loader", EscapeHtml(hardware.mobile.bootloader), s); }
                if (hardware.mobile.id) { x += addDetailItem("Identificatore", EscapeHtml(hardware.mobile.id), s); }
                if (hardware.mobile.host) { x += addDetailItem("Nome host", EscapeHtml(hardware.mobile.host), s); }
                ...
                if (x != '') { sections.push({ name: "Dispositivo mobile", html: x, img: 'mobile' }); }
            }
            ...
            if (network.netif2 != null) {
                ...
                for (var i in network.netif2) {
                    ...
                    if (m.desc) { x += addDetailItem("Descrizione", EscapeHtml(m.desc).split('(R)').join('&reg;')); }
                    //if (m.dnssuffix) { x += addDetailItem("DNS Suffix", m.dnssuffix); }
                    if (typeof m[0].mac == 'string') {
                        if (m[0].gatewaymac) {
                            x += addDetailItem("Livello MAC", format("MAC: {0}, Gateway: {1}", EscapeHtml(m[0].mac), EscapeHtml(m[0].gatewaymac)));
                        } else {
                            x += addDetailItem("Livello MAC", format("MAC: {0}", EscapeHtml(m[0].mac)));
                        }
                    }
                    if (typeof m[0].speed == 'number' && (m[0].speed != 9223372036854775807 && m[0].speed > 0)) {
                        x += addDetailItem("Velocità dell'interfaccia", format("{0}", getNetworkSpeed(m[0].speed)));
                    }
                    for (var j = 0; j < m.length; j++) {
                        var iplayer = m[j], items = [];
                        if (iplayer.address) { items.push(format("IP: {0}", EscapeHtml(iplayer.address))); }
                        if (iplayer.netmask) { items.push(format("Maschera: {0}", EscapeHtml(iplayer.netmask))); }
                        if (iplayer.gateway) { items.push(format("Gateway: {0}", EscapeHtml(iplayer.gateway))); }
                        if (items.length > 0) {
                            if (iplayer.family == 'IPv4') { x += addDetailItem("Livello IPv4", items.join(", ")); }
                            if (iplayer.family == 'IPv6') { x += addDetailItem("Livello IPv6", items.join(", ")); }
                        }
                    }
                    x += '</div></td></tr>';
                }
                ...
                x += '</table>';
                if (x != '') { sections.push({ name: "Rete ", html: x, img: 'networking' }); }
            }

            // Attribute: Intel AMT
            if (node.intelamt != null) {
                var x = '';
                x += addDetailItem("Versione ", (node.intelamt.ver) ? ('v' + EscapeHtml(node.intelamt.ver)) : ('<i>' + "Sconosciuto" + '</i>'), s);
                x += addDetailItem("Identificatore", (node.intelamt.uuid) ? (EscapeHtml(node.intelamt.uuid)) : ('<i>' + "Sconosciuto" + '</i>'), s);
                var provisioningStates = { 0: nobreak("Non attivato (pre) "), 1: nobreak("Non attivato (in) "), 2: nobreak("Attivato") };
                var provisioningMode = '';
                if ((node.intelamt.state == 2) && node.intelamt.flags) { if (node.intelamt.flags & 2) { provisioningMode = (', ' + "Modalità di controllo client (CCM)"); } else if (node.intelamt.flags & 4) { provisioningMode = (', ' + "Modalità di controllo amministratore (ACM)"); } }
                x += addDetailItem("Stato di pprovvigionamento", ((node.intelamt.state) ? (provisioningStates[node.intelamt.state]) : ('<i>' + "Sconosciuto" + '</i>')) + provisioningMode, s);
                x += addDetailItem("Sicurezza", (node.intelamt.tls == 1) ? "Protetto tramite TLS" : "TLS non è configurato", s);
                // Check that the Intel AMT user is setup and there is no warnings (1 = invalid credentials, 8 = trying)
                x += addDetailItem("Credenziali di amministratore", ((node.intelamt.user) == null || (node.intelamt.user == '') || ((node.intelamt.warn != null) && ((node.intelamt.warn & 9) != 0))) ? "Non conosciuto" : "Conosciuto", s);
                if (x != '') {
                    if ((typeof node.intelamt.sku == 'number') && ((node.intelamt.sku & 16) != 0)) {
                        sections.push({ name: "Gestibilità standard Intel&reg; (Intel&reg; SM)", html: x, img: 'amt' });
                    } else {
            ...
            if (hardware.identifiers) {
                ...
                // BIOS
                if (ident.bios_vendor) { x += addDetailItem("Venditore", EscapeHtml(ident.bios_vendor), s); }
                if (ident.bios_version) { x += addDetailItem("Versione ", EscapeHtml(ident.bios_version), s); }
                if (ident.bios_serial) { x += addDetailItem("Seriale", EscapeHtml(ident.bios_serial), s); }
                if (ident.bios_mode) { x += addDetailItem("Mode", EscapeHtml(ident.bios_mode), s); }
                if (x != '') { sections.push({ name: "BIOS", html: x, img: 'chip' }); }

                // Motherboard
                x = '';
                if (ident.board_vendor) { x += addDetailItem("Venditore", EscapeHtml(ident.board_vendor), s); }
                if (ident.board_name) { x += addDetailItem("Nome", EscapeHtml(ident.board_name), s); }
                if (ident.board_serial && (ident.board_serial != '')) { x += addDetailItem("Seriale", EscapeHtml(ident.board_serial), s); }
                if (ident.board_version) { x += addDetailItem("Versione ", EscapeHtml(ident.board_version), s); }
                if (ident.product_uuid) { x += addDetailItem("Identificatore", EscapeHtml(ident.product_uuid), s); }
                ...
                if (x != '') { sections.push({ name: "Scheda madre ", html: x, img: 'motherboard' }); }
            }
            ...
            if (hardware.tpm) {
                ...
                if (tpm.ManufacturerId) { x += addDetailItem("Identificatore", EscapeHtml(tpm.ManufacturerId), s); }
                if (tpm.ManufacturerVersion) { x += addDetailItem("Versione ", EscapeHtml(tpm.ManufacturerVersion), s); }
                if (tpm.IsActivated != null) { x += addDetailItem("Attivato", (tpm.IsActivated ? "Yes" : "No"), s); }
                if (tpm.IsEnabled != null) { x += addDetailItem("Abilitato", (tpm.IsEnabled ? "Yes" : "No"), s); }
                if (tpm.IsOwned != null) { x += addDetailItem("Posseduto", (tpm.IsOwned ? "Yes" : "No"), s); }
            ...
            if (hardware.battery) {
                ...
                for (var i in hardware.battery) {
                    ...
                    x += '<tr><td><div class=style10 style=border-radius:5px;padding:8px>';
                    x += '<div style=margin-bottom:3px><b>' + EscapeHtml(battery.DeviceName ? battery.DeviceName : "Sconosciuto") + '</b></div>';
                    if (battery.CycleCount) { x += addDetailItem("Conteggio cicli", EscapeHtml(battery.CycleCount), s); }
                    if (battery.FullChargedCapacity) { x += addDetailItem("Capacità di carica completa", format("{0} mWh", battery.FullChargedCapacity), s); }
                    if (battery.EstimatedRuntime) { x += addDetailItem("Autonomia stimata", format("{0} minuti", Math.floor((battery.EstimatedRuntime / 60))), s); }
                    if (battery.Chemistry) { x += addDetailItem("Chimica", EscapeHtml(battery.Chemistry), s); }
                    if (battery.DesignedCapacity) { x += addDetailItem("Capacità di progettazione", format("{0} mWh", battery.DesignedCapacity), s); }
                    if (battery.ManufactureDate) { x += addDetailItem("Data di produzione", EscapeHtml(battery.ManufactureDate), s); }
                    if (battery.ManufactureName) { x += addDetailItem("Nome del produttore", EscapeHtml(battery.ManufactureName), s); }
                    if (battery.SerialNumber) { x += addDetailItem("Numero di serie", EscapeHtml(battery.SerialNumber), s); }
                    if (battery.ChargeRate) { x += addDetailItem("Tasso di addebito", format("{0} mW", battery.ChargeRate), s); }
                    if (battery.Charging != null) { x += addDetailItem("In carica", (battery.Charging ? "Yes" : "No"), s); }
                    if (battery.DischargeRate) { x += addDetailItem("Tasso di scarico", format("{0} mW", battery.DischargeRate), s); }
                    if (battery.Discharging != null) { x += addDetailItem("Scarica", (battery.Discharging ? "Yes" : "No"), s); }
                    if (battery.RemainingCapacity) { x += addDetailItem("Capacità rimanente", format("{0} mWh", battery.RemainingCapacity), s); }
                    if (battery.Voltage) { x += addDetailItem("Voltaggio", format("{0} V", (battery.Voltage / 1000)), s); }
                    if (battery.Health) { x += addDetailItem("Salute", format("{0} %", battery.Health), s); }
                    if (battery.BatteryCharge) { x += addDetailItem("Carica della batteria", format("{0} %", battery.BatteryCharge), s); }   
                    x += '</div>';
                }
                x += '</table>';
                if (x != '') { sections.push({ name: "Batteria", html: x, img: 'battery'}); }
            }
            ...
            if (hardware.windows) {
                if (hardware.windows.memory && (hardware.windows.memory.length > 0)) {
                    ...
                    for (var i in hardware.windows.memory) {
                        ...
                        if (m.Capacity && m.Speed) { x += addDetailItem("Capacità / velocità", format("{0} Mb, {1} Mhz", (m.Capacity / 1024 / 1024), m.Speed), s); }
                        else if (m.Capacity) { x += addDetailItem("Capacità", format("{0} Mb", (m.Capacity / 1024 / 1024)), s); }
                        if (m.PartNumber) { x += addDetailItem("Numero di parte ", EscapeHtml((m.Manufacturer && m.Manufacturer != 'Undefined') ? (m.Manufacturer + ', ') : '') + EscapeHtml(m.PartNumber), s); }
                        x += '</div>';
                    }
                    x += '</table>';
            ...
            if (hardware.linux) {
                if (hardware.linux.memory && (hardware.linux.memory.Memory_Device.length > 0)) {
                    ...
                    for (var i in hardware.linux.memory.Memory_Device) {
                        ...
                        if (m.Size && m.Speed) { x += addDetailItem("Capacità / velocità", format("{0}, {1}", m.Size, m.Speed), s); }
                        else if (m.Size) { x += addDetailItem("Capacità", format("{0}", (m.Size)), s); }
                        if (m.PartNumber) { x += addDetailItem("Numero di parte ", EscapeHtml((m.Manufacturer && m.Manufacturer != 'Undefined')?(m.Manufacturer + ', '):'') + EscapeHtml(m.PartNumber), s); }
                        x += '</div>';
                    }
                    x += '</table>';
            ...
            if (hardware.darwin) {
                if (hardware.darwin.memory && (hardware.darwin.memory.length > 0)) {
                    ...
                    for (var i in hardware.darwin.memory) {
                        ...
                        if (m.PartNumber) { x += addDetailItem("Numero di parte ", EscapeHtml((m.Manufacturer && m.Manufacturer != '')?(m.Manufacturer + ', '):'') + EscapeHtml(m.PartNumber), s); }
                        x += '</div>';
                    }
                    x += '</table>';
                    if (x != '') { sections.push({ name: "Memoria", html: x, img: 'ram'}); }
            ...
            if (hardware.identifiers && ident.storage_devices) {
                ...
                for (var i in ident.storage_devices) {
                    ...
                    if (m.Size) {
                        ...
                        if (m.Model && (m.Model != m.Caption)) { x += addDetailItem("Modello", EscapeHtml(m.Model), s); }
                        if (m.Size) {
                            if ((typeof m.Size == 'string') && (parseInt(m.Size) == m.Size)) { m.Size = parseInt(m.Size); }
                            if (typeof m.Size == 'number') { x += addDetailItem("Capacità", format("{0} Mb", Math.floor(m.Size / 1024 / 1024)), s); }
                            if (typeof m.Size == 'string') { x += addDetailItem("Capacità", EscapeHtml(m.Size), s); }
                        }
                        if(hardware.windows && hardware.windows.drives && m.Model){
                            const foundObject = hardware.windows.drives.find(obj => obj['Model'] === m.Model);
                            if(foundObject) x += addDetailItem("Stato", EscapeHtml(foundObject.Status), s);
                        }
                        x += '</div>';
                    }
                }
                ...
                if (x != '') { sections.push({ name: "Spazio di archiviazione", html: x, img: 'storage' }); }
            }
            ...
            if (hardware.windows && hardware.windows.volumes) {
                ...
                for (var i in hardware.windows.volumes) {
                    ...
                    if (m.size) {
                        ...
                        x += addDetailItem("Capacità", EscapeHtml(fsize), s);
                    }
                    if (m.sizeremaining) {
                        var sizes = ['Bytes', 'KB', 'MB', 'GB', 'TB'];
                        ...
                        x += addDetailItem("Capacità rimanente", EscapeHtml(fsize), s);
                    }
                    if (m.type) {
                        var type = (m.removable == true ? "Removable" : (m.cdrom == true ? "CD-ROM" : ''));
                        x += addDetailItem("File System", (type != '' ? (type + ' / ') : '') + (m.type == 'Unknown' ? "Sconosciuto" : EscapeHtml(m.type)), s);
                    }

                    if (m.protectionStatus || m.volumeStatus) {
                        var bitlockerState = [];
                        if (m.protectionStatus) bitlockerState.push("Abilitato");
            ...
            if (hardware.darwin && hardware.darwin.volumes) {
                ...
                for (var i in hardware.darwin.volumes) {
                    ...
                    x += '<div style=margin-bottom:3px><b>' + m.mount_point + '</b></div>';
                    if (m.size) {
                        x += addDetailItem("Capacità", EscapeHtml(m.size), s);
                    }
                    if (m.available) {
                        x += addDetailItem("Capacità rimanente", EscapeHtml(m.available), s);
                    }
                    if (m.type) {
                        var type = (m.removable == true ? "Removable" : (m.cdrom == true ? "CD-ROM" : ''));
                        x += addDetailItem("File System", (type != '' ? (type + ' / ') : '') + (m.type == 'Unknown' ? "Sconosciuto" : EscapeHtml(m.type)), s);
            ...
            if (x == '') {
                QH('p10detailshtml', "Nessuna informazione per questo dispositivo.");
            } else {
                QH('p10detailshtml', x);
            }
        }
        ...
        function deviceDetailsShowBitlockerInfo(drive, identifier, password) {
            if (xxdialogMode) return false;
            var x = '<div><p>' + "Identificatore" + '</p><p style=user-select:text;font-weight:bold>' + (identifier ? decodeURIComponent(identifier) : "Sconosciuto") + '</p>';
            x += '<p>' + "Recovery Password" + '</p><p style=user-select:text;font-weight:bold>' + (password ? decodeURIComponent(password) : "Sconosciuto") + '</p></div>';
        ...
        */
        ...
        function setupConsole() {
            ...
            if ((rights & 16) != 0) {
                ...
                var onlineText = ((consoleNode.conn & 1) != 0) ? "L'agente è online" : "L'agente è offline"
                if ((consoleNode.conn & 16) != 0) { onlineText += ", MQTT è online" }
                ...
                QH('p15statetext', "Accesso Negato");
        ...
        function p15consoleSend(e) {
            ...
            if (((consoleNode.conn & 16) != 0) && (Q('p15outputselect').value == 2)) {
                ...
                t = '<div style=color:violet>' + "SPINGERE" + '&gt; ' + EscapeHtml(v) + '<br/></div>';
                consoleNode.consoleText += t;
        ...
        function p15uploadCore(e) {
            ...
            if (e.shiftKey == true) { meshserver.send({ action: 'uploadagentcore', nodeid: consoleNode._id, type: 'default' }); } // Upload default core
                ...
                var htmlValue = '<select id=d3coreMode style=width:230px>' +
                    '<option value=1>' + "Carica il core del server predefinito" + '</option>' +
                    '<option value=2>' + "Cancella il core" + '</option>' +
                    '<option value=3>' + "Carica un file core" + '</option>' +
                    '<option value=4>' + "Disconnessione agente soft" + '</option>' +
                    '<option value=5>' + "Disconnessione forzata dell'agente" + '</option>' +
                    '<option value=6>' + "Carica core di ripristino " + '</option>' +
                    '<option value=7>' + "Carica un piccolo nucleo" + '</option>' +
                    '<option value=8>' + "Restart agent service" + '</option>' +
                    '<option value=9>' + "Forza l'aggiornamento dell'agente" + '</option></select>';
                setDialogMode(2, "Esegui azione agente ", 3, p15uploadCoreEx, addHtmlValue("Azione", htmlValue));
            }
        }
        ...
        function p15uploadCore2() {
            ...
            Q('d3auth').value = authCookie;
            Q('d3attrib').value = currentNode._id;
            setDialogMode(4, "Carica il core dell'agente mesh", 3, p15uploadCoreEx2);
            d3init();
        }
        ...
        function p20updateMesh() {
            ...
            var meshtype = format("Sconosciuto #{0}", currentMesh.mtype);
            var meshrights = GetMeshRights(currentMesh);
            if (currentMesh.mtype == 1) meshtype = "Intel&reg; AMT only, no agent";
            if (currentMesh.mtype == 2) meshtype = "Gestito tramite un agente software";
            if (currentMesh.mtype == 3) { if (currentMesh.relayid == null) { meshtype = "Dispositivi locali, nessun agente"; } else { meshtype = "Nessun dispositivo agente trasmesso tramite agente"; } }
            if (currentMesh.mtype == 4) { if (currentMesh.relayid == null) { meshtype = "Dispositivo IP-KVM"; } else { meshtype = "Dispositivo IP-KVM inoltrato tramite agente"; } if (currentMesh.kvm.model == 1) { meshtype += ', ' + 'Raritan KX III'; } }

            var x = '';
            x += addHtmlValue("Nome", addLinkConditional(EscapeHtml(currentMesh.name), 'p20editmesh(1)', (meshrights & 1) != 0));
            x += addHtmlValue("Descrizione", addLinkConditional(((currentMesh.desc && currentMesh.desc != '') ? EscapeHtml(currentMesh.desc) : ('<i>' + "Nessuna " + '</i>')), 'p20editmesh(2)', (meshrights & 1) != 0));
            x += addHtmlValue("Digita", meshtype);
            //x += addHtmlValue('Identifier', currentMesh._id.split('/')[2]);

            // Display the relay device if applicable
            if (((currentMesh.mtype == 3) || (currentMesh.mtype == 4)) && (currentMesh.relayid != null)) {
                var relayName = '<i>' + "Sconosciuto" + '</i>';
                var relayNode = getNodeFromId(currentMesh.relayid);
                if (relayNode != null) { relayName = EscapeHtml(relayNode.name); }
                x += addHtmlValue("Dispositivo ripetitore", addLinkConditional(relayName, 'p20editmeshrelay()', (meshrights & 1) != 0));
            }

            // Display IP-KVM information if needed
            if (currentMesh.mtype == 4) {
                x += addHtmlValue("Nome host", currentMesh.kvm.host);
                x += addHtmlValue("Nome utente", currentMesh.kvm.user);
            }

            x += '<br><input type=button value="' + "Appunti " + '" onclick=showNotes(false,"' + encodeURIComponent(currentMesh._id) + '") />';

            x += '<br style=clear:both><br>';
            var currentMeshLinks = currentMesh.links[userinfo._id];
            if (currentMeshLinks && ((currentMeshLinks.rights & 2) != 0)) { x += '<div style=margin-bottom:6px;float:left;margin-right:10px><a onclick=p20showAddMeshUserDialog() style=cursor:pointer><img src=images/icon-addnew.png border=0 height=12 width=12> ' + "Aggiungi utente" + '</a></div>'; }

            if (navigator.userAgent.toLowerCase().indexOf('android') >= 0) {
                x += '<div style=margin-bottom:6px;float:left;margin-right:10px><a onclick=p20installAndroidDialog() style=cursor:pointer><img src=images/icon-addnew.png border=0 height=12 width=12> ' + "Installa su questo dispositivo" + '</a></div>';
            }
            ...
            */
            ...
            for (var i in sortedusers) {
                var trash = '', rights = "Diritti parziali ", r = sortedusers[i].rights, icon = 2;
                if (r == 0xFFFFFFFF) rights = "Amministratore completo"; else if (r == 0) rights = "Nessun diritto";
            ...
            if (meshrights == 0xFFFFFFFF) { x += '<div style=font-size:small;text-align:right;margin-top:6px><span><a onclick=p20showDeleteMeshDialog() style=cursor:pointer>' + "Elimina Gruppo" + '</a></span></div>'; }
        ...
        function p20showDeleteMeshDialog() {
            if (xxdialogMode) return false;
            var x = format("Sei sicuro di voler eliminare il gruppo {0}? L'eliminazione del gruppo di dispositivi eliminerà anche tutte le informazioni sui dispositivi all'interno di questo gruppo.", EscapeHtml(currentMesh.name)) + '<br /><br />';
            x += '<label><input id=p20check type=checkbox onchange=p20validateDeleteMeshDialog() />' + "Confermare" + '</label>';
            setDialogMode(2, "Elimina Gruppo", 3, p20showDeleteMeshDialogEx, x);
        ...
        function p20editmeshrelay() {
            ...
            if (relayDevices.length == 0) {
                ...
                setDialogMode(2, "Modifica gruppo di dispositivi", 1, null, "Nessun dispositivo relè disponibile.");
            } else {
                var relayDevices2 = [];
                ...
                var x = addHtmlValue("Dispositivo ripetitore", '<div style=width:170px><select id=d2devrelay style=width:100%>' + relayDevices2.join('') + '</select></div>');
                setDialogMode(2, "Modifica gruppo di dispositivi", 3, p20editmeshrelayEx, x);
            }
        }
        ...
        function p20editmesh(focus) {
            if (xxdialogMode) return;
            var x = addHtmlValue("Nome", '<input id=dp20meshname style=width:170px maxlength=32 onchange=p20editmeshValidate() onkeyup=p20editmeshValidate() />');
            x += addHtmlValue("Descrizione", '<input id=dp20meshdesc style=width:170px maxlength=1024 onkeyup=p20editmeshValidate() />');
            setDialogMode(2, "Modifica gruppo di dispositivi", 3, p20editmeshEx, x);
        ...
        function p20installAndroidDialog() {
            if (xxdialogMode) return;
            var x = '<div style=text-align:center><p>' + "nstalla l'agente MeshCentral sul tuo dispositivo Android. Una volta installato, fai clic sul collegamento di associazione per connettere il tuo dispositivo a questo server." + '</p>';
            ...
            x += '<p><a href="' + serverinfo.magenturl + ',' + serverinfo.agentCertHash + ',' + currentMesh._id.split('/')[2] + '"><b>' + "Collegamento di accoppiamento del dispositivo" + '</b></a></p></div>';
            setDialogMode(2, "Installazione Android", 1, null, x);
        }
        ...
        function p20showAddMeshUserDialog() {
            ...
            x += '<label><input type=checkbox onchange=p20validateAddMeshUserDialog() id=p20fulladmin>' + "Amministratore completo" + '</label><br>';
            x += '<label><input type=checkbox onchange=p20validateAddMeshUserDialog() id=p20editmesh>' + "Modifica gruppo di dispositivi" + '</label><br>';
            x += '<label><input type=checkbox onchange=p20validateAddMeshUserDialog() id=p20manageusers>' + "Gestisci utenti del gruppo di dispositivi" + '</label><br>';
            x += '<label><input type=checkbox onchange=p20validateAddMeshUserDialog() id=p20managecomputers>' + "Gestisci computer del gruppo di dispositivi" + '</label><br>';
            x += '<label><input type=checkbox onchange=p20validateAddMeshUserDialog() id=p20remotecontrol>' + "Controllo remoto" + '</label><br>';
            x += '<label><input type=checkbox onchange=p20validateAddMeshUserDialog() id=p20remoteview style=margin-left:12px>' + "Solo visualizzazione remota" + '</label><br>';
            x += '<label><input type=checkbox onchange=p20validateAddMeshUserDialog() id=p20remotelimitedinput style=margin-left:12px>' + "Solo input limitato" + '</label><br>';
            x += '<label><input type=checkbox onchange=p20validateAddMeshUserDialog() id=p20noterminal style=margin-left:12px>' + "Nessun accesso al terminale " + '</label><br>';
            x += '<label><input type=checkbox onchange=p20validateAddMeshUserDialog() id=p20nofiles style=margin-left:12px>' + "Nessun accesso ai file " + '</label><br>';
            x += '<label><input type=checkbox onchange=p20validateAddMeshUserDialog() id=p20noamt style=margin-left:12px>' + "Nessun Intel&reg; AMT " + '</label><br>';
            x += '<label><input type=checkbox onchange=p20validateAddMeshUserDialog() id=p20meshagentconsole>' + "Console dell'agente mesh" + '</label><br>';
            x += '<label><input type=checkbox onchange=p20validateAddMeshUserDialog() id=p20meshserverfiles>' + "File del server" + '</label><br>';
            x += '<label><input type=checkbox onchange=p20validateAddMeshUserDialog() id=p20wakedevices>' + "Riattiva i dispositivi" + '</label><br>';
            x += '<label><input type=checkbox onchange=p20validateAddMeshUserDialog() id=p20editnotes>' + "Modifica note dispositivo" + '</label><br>';
            x += '<label><input type=checkbox onchange=p20validateAddMeshUserDialog() id=p20limitevents>' + "Mostra solo i propri eventi" + '</label><br>';
            x += '<label><input type=checkbox onchange=p20validateAddMeshUserDialog() id=p20chatnotify>' + "Chat e notifica" + '</label><br>';
            x += '<label><input type=checkbox onchange=p20validateAddMeshUserDialog() id=p20uninstall>' + "Disinstalla agente" + '</label><br>';
            x += '<label><input type=checkbox onchange=p20validateAddMeshUserDialog() id=p20commands>' + "Comandi remoti" + '</label><br>';
            x += '<label><input type=checkbox onchange=p20validateAddMeshUserDialog() id=p20resetoff>' + "Ripristino / Spegnimento" + '</label><br>';
            x += '</div>';
            setDialogMode(2, "Aggiungi utente al gruppo di dispositivi", 3, p20showAddMeshUserDialogEx, x);
        ...
        function p20viewuser(userid) {
            ...
            if (meshrights == 0xFFFFFFFF) r.push("Amministratore completo"); else {
                if ((meshrights & 1) != 0) r.push("Modifica gruppo di dispositivi");
                if ((meshrights & 2) != 0) r.push("Gestisci utenti del gruppo di dispositivi");
                if ((meshrights & 4) != 0) r.push("Gestisci computer del gruppo di dispositivi");
                if ((meshrights & 8) != 0) r.push("Controllo remoto");
                if ((meshrights & 16) != 0) r.push("Console Agente");
                if ((meshrights & 32) != 0) r.push("File del server");
                if ((meshrights & 64) != 0) r.push("Riattiva i dispositivi");
                if ((meshrights & 128) != 0) r.push("Modifica note");
                if ((meshrights & 256) != 0) r.push("Solo visualizzazione remota");
                if ((meshrights & 512) != 0) r.push("Nessun terminale ");
                if ((meshrights & 1024) != 0) r.push("Nessun file");
                if ((meshrights & 2048) != 0) r.push("Nessun Intel&reg; AMT ");
                if (((meshrights & 8) != 0) && ((meshrights & 4096) != 0) && ((meshrights & 256) == 0)) r.push("Input limitato");
                if ((meshrights & 8192) != 0) r.push("Solo eventi personali");
                if ((meshrights & 16384) != 0) r.push("Chat e notifica");
                if ((meshrights & 32768) != 0) r.push("Disinstalla");
                if ((meshrights & 131072) != 0) r.push("Comandi");
                if ((meshrights & 262144) != 0) r.push("Ripristina/Spento");
            }
            if (r.length == 0) { r.push("Nessun diritto"); }
            var buttons = 1, uname = userid.split('/')[2];
            if (currentMesh.links[userid].name) { uname = currentMesh.links[userid].name; }
            var x = addHtmlValue("Nome utente ", EscapeHtml(uname));
            if (uname != userid.split('/')[2]) { x += addHtmlValue("ID utente", EscapeHtml(userid.split('/')[2])); }
            x += addHtmlValue("permessi", r.join(", "));
            if (((userinfo._id) != userid) && (cmeshrights == 0xFFFFFFFF || (((cmeshrights & 2) != 0) && (meshrights != 0xFFFFFFFF)))) buttons += 4;
            setDialogMode(2, "Utente del gruppo di dispositivi", buttons, p20viewuserEx, x, userid);
        }
        ...
        function p20viewuserEx(button, userid) {
            ...
            setDialogMode(2, "Utente mesh remoto", 3, p20viewuserEx2, format("Confermare la rimozione dell'utente {0}?", uname), userid);
        }
        ...
        function drawNotifications() {
            ...
            if (notifications.length == 0) {
                r = '<div style=margin:5px>' + "Al momento non ci sono notifiche" + '</div>';
            } else {
                for (var i in notifications) {
                    ...
                    r += '<div title="' + format("Si è verificato alle {0} ", printDateTime(d)) + '" id="notifyx' + n.id + '" class=notification style="cursor:pointer;border-top:1px solid ' + ((r == '') ? 'transparent' : 'orange') + '">';
                    if (icon) { r += '<div class=j' + icon + ' onclick="notificationSelected(' + n.id + ')" style=margin:5px;float:left></div>'; }
                    r += '<div onclick="notificationDelete(' + n.id + ')" class=unselectable title="' + "Cancella questa notifica" + '" style=margin:5px;float:right;color:orange><b>X</b></div><div onclick="notificationSelected(' + n.id + ')" style=margin:5px>' + t + EscapeHtml(n.text) + '</div><div style=margin-left:5px;margin-bottom:5px;color:gray;font-size:10px>' + printDateTime(d) + '</div></div>';
                }
            }
            var deleteall = '';
            if (notifications.length > 1) { deleteall = '<div id="notifyRemoveAll" onclick="deleteAllNotifications()" style="cursor:pointer;border-top:1px solid orange;margin:5px;color:orange;text-align:right;padding-right:3px">' + "Cancella tutto" + '</div>'; }
        ...
        function addNotification(n) {
            ...
            var translatedMessages = [
                ...
                "E-mail non valido",
                "Dominio non valido",
                "Autorizzazioni del sito non valide",
                "L'utente esiste già",
                "Impossibile aggiungere l'utente in questa modalità",
                "Eccezione di convalida ",
                "Limite di account raggiunto.", // 10
                "Richiesta di chat, fare clic qui per accettare.",
                "Ci sono stati {0} tentativi di accesso falliti su questo account dall'ultimo accesso.",
                "Impossibile modificare l'indirizzo email, un altro account che già utilizza: {0}.",
                "Email inviata.",
                "Utente {0} non trovato. ",
                "Utenti {0} non trovati ",
                "Errore, impossibile modificare la password utilizzata in precedenza.",
                "Errore, impossibile modificare la password di uso comune.",
                "Errore, password non modificata.",
                "Password cambiata.", // 20
                "Password attuale non corretta.",
                "Errore, codice di invito \"{0}\" già in uso.",
                "Gateway SMS non abilitato",
                "Nessun diritto di gestione degli utenti ",
                "Messaggio SMS non valido",
                "Nessun numero di telefono per questo utente",
                "SMS inviato con successo.",
                "SMS error",
                "SMS error: {0}",
                "Il dominio email \"{0}\" non è consentito. Sono consentiti solo ({1})." // 30
            ];
