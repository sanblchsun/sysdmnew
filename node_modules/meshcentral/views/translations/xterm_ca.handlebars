<!DOCTYPE html><html dir="ltr" xmlns="http://www.w3.org/1999/xhtml"><head lang="en">
    ...
    <div id="termShellContextMenu" class="contextMenu noselect" style="display:none;min-width:0px">
        <div id="cxtermnorm" class="cmtext" onclick="cmtermaction(1,event)"><b>Shell d'administració</b></div>
        <div id="cxtermps" class="cmtext" onclick="cmtermaction(6,event)">Administrador PowerShell</div>
        <div id="cxtermunorm" class="cmtext" onclick="cmtermaction(8,event)">Shell d'usuari</div>
        <div id="cxtermups" class="cmtext" onclick="cmtermaction(9,event)">Usuari PowerShell</div>
    </div>
    <div id="termShellContextMenuLinux" class="contextMenu noselect" style="display:none;min-width:0px">
        <div id="cxtermnorm" class="cmtext" onclick="cmtermaction(1,event)"><b>Shell d'arrel</b></div>
        <div id="cxtermps" class="cmtext" onclick="cmtermaction(8,event)">Shell d'usuari</div>
        <div id="cxtermps" class="cmtext" onclick="cmtermaction(100,event)">Inici de sessió Shell</div>
    </div>
    <div id="p11" class="noselect" style="overflow:hidden">
        <div id="deskarea0" style="position:relative">
            <div id="deskarea1" class="areaHead">
                ...
                <div>
                    <input id="ConnectButton" style="display:none" type="button" value="Connecta't" onclick="connectButton()">
                    <input id="DisconnectButton" type="button" value="Desconnecta" onclick="connectButton()">
