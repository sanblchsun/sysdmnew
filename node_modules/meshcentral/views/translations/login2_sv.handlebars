<!DOCTYPE html><html dir="ltr" xmlns="http://www.w3.org/1999/xhtml"><head lang="en">
    ...
    </head><body id="body" onload="if (typeof(startup) !== 'undefined') startup();" class="arg_hide login">{{{customCSSTags}}}
    ...
    <table id="centralTable" class="container" style="height:100%;z-index:1">
            ...
            <td id="logincell">
                    ...
                    <form id="loginpanelform" method="post">
                        ...
                        <div id="loginuserpassdiv" style="display:none">
                            <table style="width:100%">
                                <tbody><tr>
                                    <td>
                                        <input id="username" title="Användarnamn" style="box-sizing:border-box;width:280px;border:0;border-radius:4px;padding:8px;background-color:#FFF8CC" {{{autocomplete}}}="username" placeholder="Användarnamn" type="text" maxlength="64" name="username" required="" onchange="validateLogin(1)" onkeyup="validateLogin(1,event)">
                                    </td>
                                </tr>
                                <tr>
                                    <td>
                                        <input id="password" title="Lösenord" style="box-sizing:border-box;width:280px;border:0;border-radius:4px;padding:8px;background-color:#FFF8CC" {{{autocomplete}}}="current-password" placeholder="Lösenord" type="password" maxlength="256" name="password" required="" onchange="validateLogin(2)" onkeyup="validateLogin(2,event)">
                                    </td>
                                </tr>
                                <tr>
                                    <td>
                                        <div id="showPassHintLink" title="Lösenordsledtråd" style="box-sizing:border-box;width:280px;border:0;border-radius:4px;padding:8px;background-color:#FFF8CC;display:none"><a onclick="return showPassHint(event);" href="#" style="cursor:pointer">Visa ledtråd</a></div>
                                    </td>
                                </tr>
                                <tr>
                                    <td>
                                        <input id="loginButton" style="box-sizing:border-box;width:280px;border:0;border-radius:4px;padding:6px" onclick="submitButtonClicked('loginpanelform')" type="button" value="Logga in">
                                    </td>
                                </tr>
                            ...
                            <div id="resetAccountDiv" style="display:none;padding:2px">
                                <span id="resetAccountSpan">Glömt användarnamn / lösenord?</span> <a onclick="return xgo(3,event);" href="#" style="cursor:pointer">Återställ konto</a>.
                            </div>
                            <div id="newAccountDiv" style="display:none;padding:2px;padding-top:10px">
                                Har du inget konto? <a onclick="return xgo(2,event);" href="#" style="cursor:pointer">Skapa en</a>.
                            </div>
                        </div>
                        ...
                        <div id="authStrategies" style="display:none">
                            ...
                            <div style="margin-bottom:8px">Logga in med ett befintligt konto</div>
                            <a id="auth-twitter" href="auth-twitter" style="display:none"><img src="images/login/twitter32.png" srcset="images/login/twitter64.png 2x" width="32" height="32" style="margin-left:3px;margin-right:3px;border-radius:3px;box-shadow:2px 2px 5px black;cursor:pointer" title="Logga in med Twitter"></a>
                            <a id="auth-google" href="auth-google" style="display:none"><img src="images/login/google32.png" srcset="images/login/google64.png 2x" width="32" height="32" style="margin-left:3px;margin-right:3px;border-radius:3px;box-shadow:2px 2px 5px black;cursor:pointer" title="Logga in med Google"></a>
                            <a id="auth-github" href="auth-github" style="display:none"><img src="images/login/github32.png" srcset="images/login/github64.png 2x" width="32" height="32" style="margin-left:3px;margin-right:3px;border-radius:3px;box-shadow:2px 2px 5px black;cursor:pointer" title="Logga in med GitHub"></a>
                            <a id="auth-azure" href="auth-azure" style="display:none"><img src="images/login/azure32.png" srcset="images/login/azure64.png 2x" width="32" height="32" style="margin-left:3px;margin-right:3px;border-radius:3px;box-shadow:2px 2px 5px black;cursor:pointer" title="Logga in med Azure"></a>
                            <a id="auth-oidc" href="auth-oidc" style="display:none"><img src="images/login/oidc32.png" srcset="images/login/oidc64.png 2x" width="32" height="32" style="margin-left:3px;margin-right:3px;border-radius:3px;box-shadow:2px 2px 5px black;cursor:pointer" title="Logga in med OpenID Connect"></a>
                            ...
                            <a id="auth-jumpcloud" href="auth-jumpcloud" style="display:none"><img src="images/login/jumpcloud32.png" srcset="images/login/jumpcloud64.png 2x" width="32" height="32" style="margin-left:3px;margin-right:3px;border-radius:3px;box-shadow:2px 2px 5px black;cursor:pointer" title="Logga in med JumpCloud"></a>
                            <a id="auth-intel" href="auth-intel" style="display:none"><img src="images/login/intel32.png" srcset="images/login/intel64.png 2x" width="32" height="32" style="margin-left:3px;margin-right:3px;border-radius:3px;box-shadow:2px 2px 5px black;cursor:pointer" title="Logga in med Intel"></a>
                            <a id="auth-saml" href="auth-saml" style="display:none"><img src="images/login/generic32.png" srcset="images/login/generic64.png 2x" width="32" height="32" style="margin-left:3px;margin-right:3px;border-radius:3px;box-shadow:2px 2px 5px black;cursor:pointer" title="Enkel inloggning"></a>
                        </div>
                    </form>
                </div>
                    ...
                    <form id="createpanelform" method="post">
                        ...
                        <table>
                            <tbody><tr id="nuUserRow">
                                <td id="nuUser" align="right" width="100">Användarnamn:</td>
                            ...
                            <tr>
                                <td id="nuEmail" align="right" width="100">E-post:</td>
                            ...
                            <tr>
                                <td id="nuPass1" align="right">Lösenord:</td>
                            ...
                            <tr>
                                <td id="nuPass2" align="right">Lösenord:</td>
                            ...
                            <tr id="createPanelHint" style="display:none">
                                <td id="nuHint" align="right">Lösenordsledtråd:</td>
                            ...
                            <tr id="newAccountPass" title="Ange kontot skapande token">
                                <td id="nuToken" align="right">Skapat token:</td>
                            ...
                            <tr>
                                <td colspan="2">
                                    <div style="float:right"><input id="createButton" type="button" onclick="submitButtonClicked('createpanelform')" value="Skapa konto" disabled="disabled"></div>
                                    <div id="passWarning" style="padding-top:6px"></div>
                                </td>
                            </tr>
                        </tbody></table>
                        <hr><a onclick="return xgo(1,event);" href="#" style="cursor:pointer">Tillbaka till login</a>
                ...
                <div id="resetpanel" style="display:none">
                    <form id="resetpanelform" method="post">
                        ...
                        <table style="width:100%;margin-top:4px;margin-bottom:4px">
                            <tbody><tr>
                                <td>
                                    <input id="remail" title="E-post" style="box-sizing:border-box;width:280px;border:0;border-radius:4px;padding:8px;background-color:#FFF8CC" {{{autocomplete}}}="username" placeholder="E-post" type="text" maxlength="256" name="email" onchange="validateReset()" onkeyup="validateReset(event)">
                                </td>
                            </tr>
                            <tr>
                                <td>
                                    <input id="eresetButton" style="box-sizing:border-box;width:280px;border:0;border-radius:4px;padding:6px" type="button" onclick="submitButtonClicked('resetpanelform')" value="Återställ konto" disabled="disabled">
                                </td>
                            </tr>
                        </tbody></table>
                        <hr><a onclick="return xgo(1,event);" href="#" style="cursor:pointer">Tillbaka till login</a>
                ...
                <div id="tokenpanel" style="display:none">
                    <form id="tokenpanelform" method="post" {{{autocomplete}}}="off">
                        ...
                        <table style="width:100%">
                            <tbody><tr>
                                <td>
                                    <input id="tokenInput" {{{autocomplete}}}="one-time-code" title="Tecken" style="box-sizing:border-box;width:280px;border:0;border-radius:4px;padding:8px;background-color:#FFF8CC" placeholder="Tecken" type="text" maxlength="50" name="token" onchange="checkToken(event)" onpaste="checkToken(event)" onkeyup="checkToken(event)" onkeydown="checkToken(event)"><br>
                            ...
                            <tr>
                                <td>
                                    <div>
                                        <input id="tokenOkButton" style="box-sizing:border-box;width:280px;border:0;border-radius:4px;padding:6px" type="button" onclick="submitButtonClicked('tokenpanelform')" value="Logga in" disabled="disabled">
                                    </div>
                                </td>
                            </tr>
                            <tr>
                            ...
                            <tr id="2farow">
                                <td>
                                    <hr>
                                    <div>
                                        <img id="securityKeyButton" src="images/login/2fa-key-48.png" srcset="images/login/2fa-key-96.png 2x" title="Använd säkerhetsnyckel" width="48" height="48" style="display:none;margin-left:3px;margin-right:3px;border-radius:3px;box-shadow:2px 2px 5px black;cursor:pointer;background-color:#FFF" onclick="useSecurityKey(1)">
                                        ...
                                        <img id="emailKeyButton" src="images/login/2fa-mail-48.png" srcset="images/login/2fa-mail-96.png 2x" title="E-post" width="48" height="48" style="display:none;margin-left:3px;margin-right:3px;border-radius:3px;box-shadow:2px 2px 5px black;cursor:pointer;background-color:#FFF" onclick="useEmailToken(1)">
                                        <img id="pushKeyButton" src="images/login/2fa-push-48.png" srcset="images/login/2fa-push-96.png 2x" title="Enhetsautentisering" width="48" height="48" style="display:none;margin-left:3px;margin-right:3px;border-radius:3px;box-shadow:2px 2px 5px black;cursor:pointer;background-color:#FFF" onclick="usePushToken(1)">
                ...
                <div id="resettokenpanel" style="display:none">
                    <form id="resettokenpanelform" method="post">
                        ...
                        <table style="width:100%">
                            <tbody><tr>
                                <td>
                                    <input id="resetTokenInput" {{{autocomplete}}}="one-time-code" title="Tecken" style="box-sizing:border-box;width:280px;border:0;border-radius:4px;padding:8px;background-color:#FFF8CC" placeholder="Tecken" type="text" maxlength="50" name="token" onchange="resetCheckToken(event)" onpaste="resetCheckToken(event)" onkeyup="resetCheckToken(event)" onkeydown="resetCheckToken(event)"><br>
                            ...
                            <tr>
                                <td>
                                    <div>
                                        <input id="resetTokenOkButton" style="box-sizing:border-box;width:280px;border:0;border-radius:4px;padding:6px" type="button" onclick="submitButtonClicked('resettokenpanelform')" value="Logga in" disabled="disabled">
                                    </div>
                                </td>
                            </tr>
                            <tr id="2farow2">
                                <td colspan="2">
                                    <hr>
                                    <div>
                                        <img id="securityKeyButton2" src="images/login/2fa-key-48.png" srcset="images/login/2fa-key-96.png 2x" title="Använd säkerhetsnyckel" width="48" height="48" style="display:none;margin-left:3px;margin-right:3px;border-radius:3px;box-shadow:2px 2px 5px black;cursor:pointer;background-color:#FFF" onclick="useSecurityKey(2)">
                                        ...
                                        <img id="emailKeyButton2" src="images/login/2fa-mail-48.png" srcset="images/login/2fa-mail-96.png 2x" title="E-post" width="48" height="48" style="display:none;margin-left:3px;margin-right:3px;border-radius:3px;box-shadow:2px 2px 5px black;cursor:pointer;background-color:#FFF" onclick="useEmailToken(2)">
                                        <img id="pushKeyButton2" src="images/login/2fa-push-48.png" srcset="images/login/2fa-push-96.png 2x" title="Enhetsautentisering" width="48" height="48" style="display:none;margin-left:3px;margin-right:3px;border-radius:3px;box-shadow:2px 2px 5px black;cursor:pointer;background-color:#FFF" onclick="usePushToken(2)">
                ...
                <div id="resetpasswordpanel" style="display:none;position:relative">
                    <form id="resetpasswordpanelform" method="post">
                        ...
                        <table>
                            <tbody><tr>
                                <td id="rnuPass1" width="100" align="right">Lösenord:</td>
                            ...
                            <tr>
                                <td id="rnuPass2" align="right">Lösenord:</td>
                            ...
                            <tr id="resetpasswordpanelHint" style="display:none">
                                <td id="rnuHint" align="right">Lösenordsledtråd:</td>
                            ...
                            <tr>
                                <td colspan="2">
                                    <div style="float:right"><input id="resetPassButton" type="button" onclick="submitButtonClicked('resetpasswordpanelform')" value="Återställ lösenord" disabled="disabled"></div>
                    ...
                    <form id="checkemailpanelform" method="post">
                        ...
                        <table id="checkCheckOperations" style="width:100%;display:none">
                            ...
                            <tr>
                                <td>
                                    <div>
                                        <input id="changeEmailButton" type="button" value="Ändra e-postadress" onclick="changeEmailAddress()">
                                        <input id="checkEmailButton2" type="button" value="Skicka om e-postbekräftelse" onclick="resentEmailConfirmation()">
        ...
        <tr style="height:20px">
            <td>
                <div>
                    <div id="flink" style="float:right;margin-right:4px;color:#c8c8c8">{{{rootCertLink}}}&nbsp;<a href="terms">Villkor &amp; integritet</a></div>
    ...
    <div id="dialog" style="display:none">
        ...
        <div id="idx_dlgButtonBar" style="">
            <input id="idx_dlgCancelButton" type="button" value="Avbryt" style="" onclick="dialogclose(0)">
    ...
    <script>
        ...
        function startup() {
            ...
            var okmessages = ['', "Om giltigt, återställ e-post skickad.", "Email skickat.", "Verifiering av e-post krävs, kontrollera din brevlåda och klicka på bekräftelselänken.", "SMS skickat.", "Skickar avisering ...", "Message sent."];
            var failmessages = ["Det gick inte att skapa konto.", "Kontogränsen har uppnåtts.", "Befintligt konto med den här e-postadressen.", "Ogiltigt konto skapande token.", "Användarnamnet finns redan.", "Lösenord avvisas, använd ett annat.", "Ogiltig e-postadress.", "Kontot finns inte.", "Ogiltig token, försök igen.", "Det gick inte att skicka e-post.", "Kontot är låst.", "Tillträde beviljas ej.", "Inloggningen misslyckades, kontrollera användarnamn och lösenord.", "Lösenordsbyte begärs.", "IP-adress blockerad, försök igen senare.", "Server under underhåll.", "Det går inte att skicka enhetsavisering.", "Invalid security check."];
            if (messageid > 0) {
                var msg = '';
            ...
            if (twoFactorCookieDays > 0) {
                ...
                QH('tokenInputRememberSpan', format("Kom ihåg den här enheten i {0} dagar.", twoFactorCookieDays));
                QV('tokenInputRememberLabel2', true);
                QH('tokenInputRememberSpan2', format("Kom ihåg den här enheten i {0} dagar.", twoFactorCookieDays));
            } else {
            ...
            if (features & 0x200000) { // Email is username
                Q('username').placeholder = "E-post";
                QH('resetAccountSpan', "Glömt ditt lösenord?");
                QV('nuUserRow', false);
            }
            ...
            if (loginMode == '8') {
                ...
                websocket.onmessage = function (e) {
                    ...
                    if (r.sent === true) {
                        // Request was sent
                        QH('message8', '<span class="msg success"><b>' + format("Begäran skickad, {0}.", r.code) + '</b></span><br /><br />');
                    } else if (r.sent === false) {
                        // Request failed to send
                        QH('message8', '<span class="msg error"><b style=color:#8C001A>' + "Det gick inte att skicka begäran." + '<b></span><br /><br />');
                        QV('tokenInputRememberLabel2', false);
                        this.close();
                        ...
                        this.close();
                        QV('tokenInputRememberLabel2', false);
                        QH('message8', '<span class="msg success"><b>' + "Begäran accepterad." + '</b></span><br /><br />');
                        Q('pushtokenInput').value = r.token;
                        Q('pushOkButton').click();
                    } else {
                        // Request rejected
                        QH('message8', '<span class="msg error"><b style=color:#8C001A>' + "Åtkomst nekad." + '<b></span><br /><br />');
                        QV('tokenInputRememberLabel2', false);
                        this.close();
                    }
                }
                ...
                websocket.onerror = function (e) {
                    QH('message8', '<span class="msg error"><b style=color:#8C001A>' + "Anslutningsfel" + '<b></span><br /><br />');
        ...
        function useEmailToken(panelAction) {
            ...
            setDialogMode(1, "Säker inloggning", 3, useEmailKeyEx, "Skicka token till registrerad e-postadress?", panelAction);
        }
        ...
        function useSMSToken(panelAction) {
            ...
            setDialogMode(1, "Säker inloggning", 3, useSMSTokenEx, "Skicka token till registrerat telefonnummer?", panelAction);
        }
        ...
        function useMsgToken(panelAction) {
            ...
            setDialogMode(1, "Säker inloggning", 3, useMsgTokenEx, "Send token to messaging application?", panelAction);
        }
        ...
        function showPassHint(e) {
            messagebox("Lösenordsledtråd", passhint);
            haltEvent(e);
            return false;
        }
        ...
        function validateCreate(box, e) {
            ...
            if (Q('apassword1').value == '') {
                ...
                if (!passRequirementsEx) {
                    ...
                    if (passStrength >= 80) { QH('passWarning', '<span style=color:green><b>' + "Starkt lösenord" + '</b><span>'); }
                    else if (passStrength >= 60) { QH('passWarning', '<span style=color:blue><b>' + "Bra lösenord" + '</b><span>'); }
                    else { QH('passWarning', '<span style=color:red><b>' + "Svagt lösenord" + '</b><span>'); }
                } else {
                    ...
                    if (passReq == false) {
                        ...
                        QH('passWarning', '<div style=color:red;cursor:pointer onclick=showPasswordPolicy()><b>' + "Lösenordspolicy" + '</b><div>'); // This is also a link to the password policy
        ...
        function validatePassReset(box, e) {
            ...
            if (Q('rapassword1').value == '') {
                ...
                if (!passRequirementsEx) {
                    ...
                    if (passStrength >= 80) { QH('rpassWarning', '<span style=color:green><b>' + "Starkt lösenord" + '</b><span>'); }
                    else if (passStrength >= 60) { QH('rpassWarning', '<span style=color:blue><b>' + "Bra lösenord" + '</b><span>'); }
                    else { QH('rpassWarning', '<span style=color:red><b>' + "Svagt lösenord" + '</b><span>'); }
                } else {
                    // Password requirements provided, use that
                    ...
                    if (passReq == false) {
                        ...
                        QH('rpassWarning', '<div style=color:red;cursor:pointer onclick=showPasswordPolicy()><b>' + "Lösenordspolicy" + '</b><div>'); // This is also a link to the password policy
        ...
        function passwordPolicyText(pass) {
            ...
            if (passRequirements.min && ((pass == null) || (pass.length < passRequirements.min))) { policy += format("Minsta längd på {0}", passRequirements.min) + '<br />'; }
            if (passRequirements.max && ((pass == null) || (pass.length > passRequirements.max))) { policy += format("Maximal längd på {0}", passRequirements.max) + '<br />'; }
            if (passRequirements.upper && ((pass == null) || (counts.upper < passRequirements.upper))) { policy += format("{0} versaler", passRequirements.upper) + '<br />'; }
            if (passRequirements.lower && ((pass == null) || (counts.lower < passRequirements.lower))) { policy += format("{0} gemener", passRequirements.lower) + '<br />'; }
            if (passRequirements.numeric && ((pass == null) || (counts.numeric < passRequirements.numeric))) { policy += format("{0} numeriskt", passRequirements.numeric) + '<br />'; }
            if (passRequirements.nonalpha && ((pass == null) || (counts.nonalpha < passRequirements.nonalpha))) { policy += format("{0} icke-alfanumerisk", passRequirements.nonalpha) + '<br />'; }
            policy += '</div>';
            return policy;
        }

        function showPasswordPolicy() {
            messagebox("Lösenordspolicy", passwordPolicyText());
        }
        ...
        function changeEmailAddress() {
            ...
            var x = addHtmlValue("E-post", '<input id=dp1email style=width:230px maxlength=256 value="' + email + '" {{{autocomplete}}}=off onchange=validateEmailAddress() onkeyup=validateEmailAddress() />');
            setDialogMode(1, "e-post bekräftelse", 3, changeEmailAddressEx, x);
