<!DOCTYPE html><html dir="ltr" xmlns="http://www.w3.org/1999/xhtml"><head lang="en">
                            ...
                            <div id="loginpanel" style="background-color:#979797;border-radius:16px;width:260px;padding:16px;text-align:center;clear:both;display:none">
                                <form method="post">
                                    ...
                                    <table>
                                        ...
                                        <tr>
                                            <td><div id="showPassHintLink" style="display:none"><a onclick="showPassHint()" style="cursor:pointer">Показати підказку</a></div></td>
                                    ...
                                    <div id="resetAccountDiv" style="display:none;padding:2px">
                                        <span id="resetAccountSpan">Забули ім'я/пароль?</span> <a onclick="xgo(3)" style="cursor:pointer">Відновити акаунт</a>.
                                    </div>
                                    <div id="newAccountDiv" style="display:none;padding:2px">
                                        Не маєте акаунту? <a onclick="xgo(2)" style="cursor:pointer">Створити новий</a>.
                                    </div>
                                    ...
                                    <div id="authStrategies" style="display:none">
                                        ...
                                        <a id="auth-twitter" href="auth-twitter" style="display:none"><img src="images/login/twitter32.png" width="32" height="32" style="margin-left:3px;margin-right:3px;border-radius:3px;box-shadow:2px 2px 5px black;cursor:pointer" title="Увійти за допомогою X"></a>
                                        <a id="auth-google" href="auth-google" style="display:none"><img src="images/login/google32.png" width="32" height="32" style="margin-left:3px;margin-right:3px;border-radius:3px;box-shadow:2px 2px 5px black;cursor:pointer" title="Увійти за допомогою Google"></a>
                                        <a id="auth-github" href="auth-github" style="display:none"><img src="images/login/github32.png" width="32" height="32" style="margin-left:3px;margin-right:3px;border-radius:3px;box-shadow:2px 2px 5px black;cursor:pointer" title="Увійти за допомогою GitHub"></a>
                                        <a id="auth-azure" href="auth-azure" style="display:none"><img src="images/login/azure32.png" width="32" height="32" style="margin-left:3px;margin-right:3px;border-radius:3px;box-shadow:2px 2px 5px black;cursor:pointer" title="Увійти за допомогою Azure"></a>
                                        ...
                                        <a id="auth-jumpcloud" href="auth-jumpcloud" style="display:none"><img src="images/login/jumpcloud32.png" width="32" height="32" style="margin-left:3px;margin-right:3px;border-radius:3px;box-shadow:2px 2px 5px black;cursor:pointer" title="Увійти за допомогою JumpCloud"></a>
                                        <a id="auth-intel" href="auth-intel" style="display:none"><img src="images/login/intel32.png" width="32" height="32" style="margin-left:3px;margin-right:3px;border-radius:3px;box-shadow:2px 2px 5px black;cursor:pointer" title="Увійти за допомогою Intel"></a>
                                        <a id="auth-saml" href="auth-saml" style="display:none"><img src="images/login/generic32.png" width="32" height="32" style="margin-left:3px;margin-right:3px;border-radius:3px;box-shadow:2px 2px 5px black;cursor:pointer" title="Єдиний вхід (локальний)"></a>
                                    </div>
                                </form>
                            </div>
                                    ...
                                    <form method="post">
                                        ...
                                        <table>
                                            <tbody><tr id="nuUserRow">
                                                <td align="right" width="100">Ім'я користувача:</td>
                                            ...
                                            <tr id="createPanelHint" style="display:none">
                                                <td align="right">Натяк Пароля:</td>
                                            ...
                                            <tr id="newAccountPass" title="Введіть токен для створення акаунту">
                                                <td align="right">Токен Створено:</td>
                                        ...
                                        <hr><a onclick="xgo(1)" style="cursor:pointer">Повернутися до лоґіну</a>
                                        ...
                                        <tr>
                                            <td colspan="2">
                                                ...
                                                <div style="float:right">
                                                    <input style="display:none;float:right" id="securityKeyButton" type="button" value="Використовувати ключ безпеки" onclick="useSecurityKey()">
                                                    <input style="display:none;float:right" id="emailKeyButton" type="button" value="е-пошта" onclick="useEmailToken()">
        ...
        <div id="footer" style="height:32px;width:100%;text-align:center;background-color:#113962;position:absolute;bottom:0px">
            <table cellpadding="0" cellspacing="6" style="width:100%">
                <tbody><tr>
                    ...
                    <td style="text-align:right">{{{rootCertLink}}}&nbsp;<a href="terms">Умови та конфіденційність</a></td>
                </tr>
            </tbody></table>
        </div>
    </div>
    ...
    <script>
        ...
        var okmessages = ['', "Якщо е-пошта дійсна, то лист для скидання паролю надіслано", "Е-пошту надіслано.", "Потрібно верифікувати е-пошту, для цього перевірте свою поштову скриньку та натисніть на посилання для підтвердження.", "SMS надіслано."];
        ...
        function useEmailToken() {
            ...
            setDialogMode(1, "Безпечний вхід", 3, useEmailKeyEx, "Надіслати токен на зареєстровану е-пошту?");
        }
        ...
        function useSMSToken() {
            ...
            setDialogMode(1, "Безпечний вхід", 3, useSMSTokenEx, "Надіслати токен на зареєстрований номер телефону?");
        }
        ...
        function showPassHint() {
            if (passRequirements.hint === true) { messagebox("Натяк Пароля", passhint); }
        }
            ...
            if (Q('apassword1').value == '') {
                ...
                if (!passRequirementsEx) {
                    ...
                    if (passReq == false) {
                        ...
                        QH('passWarning', '<span style=color:red><b>' + "Полісі паролів" + '</b><span>'); // TODO: Display problem hint
