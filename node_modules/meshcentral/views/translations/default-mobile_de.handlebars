<!DOCTYPE html><html lang="de" dir="ltr" xmlns="http://www.w3.org/1999/xhtml"><head>
    ...
    <div id="container">
        ...
        <div id="masthead" style="background:url(logo.png) 0px 0px;background-size:341px 50px;background-color:#036;background-repeat:no-repeat;height:50px;width:100%;overflow:hidden">
            ...
            <div id="notificationCount" onclick="clickNotificationIcon()" class="unselectable" style="position:absolute;right:50px;top:0px;font-size:28px;width:50px;height:50px;cursor:pointer;display:none" title="Hier klicken, um aktuelle Benachrichtigungen anzuzeigen"><div id="notificationCount2" style="padding-top:8px">0</div></div>
            ...
            <div id="column_l" style="width:100%;padding:0;position:absolute;bottom:0px;top:0px">
                <div id="p0" style="display:none;width:100%;height:100%">
                    <div style="display:flex;align-items:center;width:100%;height:100%">
                        <div id="p0message" style="text-align:center;width:100%"><span id="p0span">Server getrennt</span>, <href onclick="reload()" style="cursor:pointer"><u>zum Wiederverbinden klicken</u></href>.</div>
                    </div>
                </div>
                ...
                <div id="p2" style="display:none;position:absolute;top:0;left:0;right:0;bottom:0">
                    ...
                    <div id="xdevicesBar" style="position:absolute;overflow-y:auto;height:34px;left:0;right:0;bottom:0px;background-color:#aaa;color:black">
                        <div style="margin:4px">
                            ...
                            <label class="noselect"><input type="checkbox" id="RealNameCheckBox" onclick="onRealNameCheckBox()">Name im Betriebssystem</label>
                            ...
                            <div id="p3AccountActions">
                                <div id="p2AccountSecurity" style="display:none">
                                    ...
                                    <div style="margin-left:9px;margin-bottom:8px">
                                        <div id="managePhoneNumber1" style="margin-top:5px;display:none"><a onclick="account_managePhone()" style="cursor:pointer">Telefonnummer verwalten</a> <span id="authPhoneNumberCheck"><strong>✓</strong></span></div>
                                        <div id="manageEmail2FA" style="margin-top:5px;display:none"><a onclick="account_manageAuthEmail()" style="cursor:pointer">E-Mail-Authentifizierung verwalten</a> <span id="authEmailSetupCheck"><strong>✓</strong></span></div>
                                        <div style="margin-top:5px"><a href="#" onclick="account_showLocalizationSettings()">Lokalisierungseinstellungen</a></div>
                                        <div id="manageAuthApp" style="margin-top:5px;display:none"><a onclick="account_manageAuthApp()" style="cursor:pointer">Authentifikator-App verwalten</a> <span id="authAppSetupCheck"><strong>✓</strong></span></div>
                                        <div id="manageOtp" style="margin-top:5px;display:none"><a onclick="account_manageOtp(0)" style="cursor:pointer">Sicherungscodes verwalten</a> <span id="authCodesSetupCheck"><strong>✓</strong></span></div>
                                    </div>
                                </div>
                                <div id="p2AccountActions" style="display:none">
                                    <p><strong>Konto-Aktionen</strong></p>
                                    <div style="margin-left:9px;margin-bottom:8px">
                                        <div style="margin-top:5px"><span id="viewPreviousLogins"><a onclick="return account_viewPreviousLogins()" style="cursor:pointer">Vorherige Anmeldungen anzeigen</a></span></div>
                                        <div style="margin-top:5px"><span id="managePhoneNumber2" style="display:none"><a onclick="account_managePhone()" style="cursor:pointer">Telefonnummer verwalten</a></span></div>
                                        <div style="margin-top:5px"><span id="verifyEmailId" style="display:none"><a onclick="account_showVerifyEmail()" style="cursor:pointer">E-Mail verifizieren</a></span></div>
                                        <span id="p2AccountPassActions">
                                            <div style="margin-top:5px"><span id="changeEmailId" style="display:none"><a onclick="account_showChangeEmail()" style="cursor:pointer">E-Mail-Adresse ändern</a></span></div>
                                            <div style="margin-top:5px"><a onclick="account_showChangePassword()" style="cursor:pointer">Passwort ändern</a><span id="p2nextPasswordUpdateTime"></span></div>
                                            <div style="margin-top:5px"><a onclick="account_showDeleteAccount()" style="cursor:pointer">Konto löschen</a></div>
                                        </span>
                                        <div style="margin-top:5px" id="setDarkModeLink"><a onclick="toggleNightMode()" style="cursor:pointer">Setze den Dunkel Modus</a></div>
                                        <div style="margin-top:5px"><a onclick="showNotes(false)" style="cursor:pointer">Persönliche Notizen</a></div>
                                    </div>
                                <br style="clear:both">
                                </div>
                            </div>
                            <strong>Gerätegruppen</strong>
                            <span id="p3createMeshLink1">( <a onclick="account_createMesh()" style="cursor:pointer"><img src="images/icon-addnew.png" width="12" height="12" border="0"> Neu</a> )</span>
                            <br><br>
                            <div id="p3meshes"></div>
                            <div id="p3noMeshFound" style="margin-left:9px;display:none">Keine Gerätegruppen.<span id="p3createMeshLink2"> <a onclick="account_createMesh()" style="cursor:pointer"><strong>Fang hier an!</strong></a></span></div>
                            <br style="clear:both">
                        </div>
                    </div>
                </div>
                <div id="p5" style="display:none">
                    <table cellspacing="0" style="margin:0;padding:0;border-spacing:0;border:0;">
                        <tbody><tr style="padding:0">
                            ...
                            <td>
                                <div style="margin-left:5px">
                                    <strong style="font-size:large">Meine Dateien</strong><br>
                                </div>
                            </td>
                        </tr>
                    </tbody></table>
                            ...
                            <tbody><tr>
                                <td style="width:100%;background-color:#d3d9d6;text-align:left;padding:4px" valign="bottom">
                                    <div style="width:100%;text-align:center">
                                        <input type="button" style="width:calc(100%/5 - 5px)" id="p5FolderUp" disabled="disabled" onclick="p5folderup()" value="Hoch">
                                        <input type="button" style="width:calc(100%/5 - 5px)" id="p5SelectAllButton" disabled="disabled" onclick="p5selectallfile()" value="Alle auswählen" onkeypress="return false" onkeydown="return false">
                                        <input type="button" style="width:calc(100%/5 - 5px)" id="p5RenameFileButton" disabled="disabled" value="Umbenennen" onclick="p5renamefile()" onkeypress="return false" onkeydown="return false">
                                        <input type="button" style="width:calc(100%/5 - 5px)" id="p5DeleteFileButton" disabled="disabled" value="Löschen" onclick="p5deletefile()" onkeypress="return false" onkeydown="return false">
                                        <input type="button" style="width:calc(100%/5 - 5px)" id="p5NewFolderButton" disabled="disabled" value="Ordner" onclick="p5createfolder()" onkeypress="return false" onkeydown="return false">
                                    </div>
                                    <div style="width:100%;text-align:center">
                                        <input type="button" style="width:calc(100%/5 - 5px)" id="p5UploadButton" disabled="disabled" value="Hochladen" onclick="p5uploadFile()" onkeypress="return false" onkeydown="return false">
                                        <input type="button" style="width:calc(100%/5 - 5px)" id="p5CutButton" disabled="disabled" value="Ausschneiden" onclick="p5copyFile(1)" onkeypress="return false" onkeydown="return false">
                                        <input type="button" style="width:calc(100%/5 - 5px)" id="p5CopyButton" disabled="disabled" value="Kopie" onclick="p5copyFile(0)" onkeypress="return false" onkeydown="return false">
                                        <input type="button" style="width:calc(100%/5 - 5px)" id="p5PasteButton" disabled="disabled" value="Einfügen" onclick="p5pasteFile()" onkeypress="return false" onkeydown="return false">
                                        <input type="button" style="width:calc(100%/5 - 5px)" id="p5RefreshButton" value="Aktualisieren" onclick="p5refreshFiles()" onkeypress="return false" onkeydown="return false">
                                    </div>
                                </td>
                            </tr>
                            <tr>
                                        ...
                                        <tbody><tr>
                                            ...
                                            <td style="text-align:right;padding-right:4px">
                                                <select id="p5sortdropdown" onchange="updateFiles()">
                                                    <option value="1" selected="selected">Nach Name sortieren</option>
                                                    <option value="2">Nach Größe sortieren</option>
                                                    <option value="3">Nach Datum sortieren</option>
                                                    <option value="4">Nach Name absteigend</option>
                                                    <option value="5">Nach Größe absteigend</option>
                                                    <option value="6">Nach Datum absteigend</option>
                                                </select>
                                            </td>
                                        </tr>
                                    </tbody></table>
                ...
                <div id="p10" style="display:none;position:absolute;bottom:0;top:0;width:100%;overflow:hidden">
                    ...
                    <div id="p10dialog" style="z-index:1000;background-color:#EEE;box-shadow:0px 0px 15px #666;font-family:Arial,Helvetica,sans-serif;border-radius:5px;position:fixed;top:30px;width:300px;left:30px;display:none">
                        <div style="width:100%;background-color:#003366;color:#FFF;border-radius:5px 5px 0 0">
                            <div style="padding:5px">Anpassung der Tastaturkürzel</div>
                    ...
                    <div id="p10desktop" style="overflow:hidden;position:absolute;top:55px;bottom:0px;width:100%;display:none">
                        <div id="deskarea1" style="position:absolute;top:0px;width:100%;height:32px">
                            <div style="padding-top:2px;padding-bottom:2px;background:#C0C0C0;height:32px">
                                <div style="float:right;text-align:right">
                                    ...
                                    <input type="button" id="deskFullScreen" value="Ganzer Bildschirm" onclick="deskToggleFull(event)" onkeypress="return false" onkeydown="return false" disabled="disabled" style="height:28px;margin-right:3px;">
                                </div>
                                <div style="margin-left:3px">
                                    <input type="button" id="connectbutton1" value="Verbinden" onclick="connectDesktop(event,3)" onkeypress="return false" onkeydown="return false" disabled="disabled" style="height:28px">
                                    <input type="button" id="connectbutton1h" value="HW-Verbindung" onclick="connectDesktop(event,2)" onkeypress="return false" onkeydown="return false" disabled="disabled" style="height:28px">
                                    <input type="button" id="disconnectbutton1" value="Trennen" onclick="connectDesktop(event,0)" onkeypress="return false" onkeydown="return false" style="height:28px">
                                    <span id="deskstatus" style="color:black">Getrennt</span>
                                </div>
                            </div>
                        </div>
                        ...
                        <div id="deskarea4" style="position:absolute;bottom:0px;width:100%;height:32px">
                            <div style="padding-top:2px;padding-bottom:2px;background:#C0C0C0">
                                ...
                                <div>
                                    <input id="deskActionsBtn" type="button" style="margin-left:3px;height:28px" onkeypress="return false" onkeydown="return false" value="Aktionen" onclick="deviceActionFunction()">
                                    <input type="button" value="Einstellungen" onkeypress="return false" onkeydown="return false" onclick="showDesktopSettings()" style="height:28px">
                                    <input type="button" onkeypress="return false" onkeydown="return false" value="Energiezustandsaktionen" onclick="showPowerActionDlg()" style="display:none;height:28px">
                                    ...
                                    <input type="button" id="DeskScreens" value="Bildschirme" onkeypress="return false" onkeydown="return false" onclick="deskSelectScreens()" style="display:none;height:28px">
                                    <label><span id="DeskControlSpan" style="display:none"><input id="DeskControl" type="checkbox" onkeypress="return false" onkeydown="return false">Eingabe</span></label>
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div id="termTable" style="position:absolute;top:0;bottom:0;left:0;right:0">
                            <div id="termarea1">
                                <div class="areaHead" style="line-height:24px">
                                    <div class="toright2">
                                        <input type="button" id="termFullScreen" value="Ganzer Bildschirm" onclick="deskToggleFull(event)" onkeypress="return false" onkeydown="return false" disabled="disabled" style="height:28px;margin-right:3px;">
                                        <div id="terminalCustomUpperRight" style="float:left;margin-right:6px"></div>
                                    </div>
                                    <div>
                                        <span id="connectbutton2span" style="margin-left:3px"><input type="button" id="connectbutton2" value="Verbinden" style="height:28px" onclick="connectTerminal(event,1)" onkeypress="return false" onkeydown="return false" disabled="disabled"></span>
                                        <span id="connectbutton2sspan" style="margin-right:4px"><input type="button" id="connectbutton2s" value="SSH verbinden" style="height:28px" onclick="connectTerminal(event,3)" onkeypress="return false" onkeydown="return false" disabled="disabled"></span>
                                        <span id="disconnectbutton2span" style="margin-left:3px"><input type="button" id="disconnectbutton2" value="Trennen" style="height:28px" onclick="connectTerminal(event,0)" onkeypress="return false" onkeydown="return false"></span>
                                        <span id="termstatus" style="line-height:22px">Getrennt</span><span id="termtitle"></span>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div id="termarea4" style="position:relative;height:32px;">
                                <div class="areaFoot">
                                    ...
                                    <div style="height:28px">
                                        <input id="termActionsBtn" style="margin-left:3px;height:28px" type="button" title="Energiezustandsaktionen auf dem Gerät ausführen" onkeypress="return false" onkeydown="return false" value="Aktionen" onclick="deviceActionFunction()">
                                        <input id="ctrlcbutton" style="margin-left:3px;height:28px" type="button" onkeypress="return false" onkeydown="return false" value="Strg+C" onclick="termSendKey(3,'ctrlcbutton')">
                                        <input id="ctrlxbutton" style="margin-left:3px;height:28px" type="button" onkeypress="return false" onkeydown="return false" value="Strg+X" onclick="termSendKey(24,'ctrlxbutton')">
                        ...
                        <table id="p13toolbar" style="width:100%;height:111px" cellpadding="0" cellspacing="0">
                            <tbody><tr>
                                <td style="background-color:#C0C0C0;border-bottom:2px solid black;padding:2px;line-height:24px">
                                    <div style="float:right;text-align:right">
                                        <input id="filesActionsBtn" type="button" onkeypress="return false" onkeydown="return false" value="Aktionen" onclick="deviceActionFunction()" style="margin-right:2px">
                                        <div id="filesCustomUpperRight" style="float:left;margin-right:6px"></div>
                                    </div>
                                    <div style="margin-left:2px">
                                        <input id="p13AutoConnect" value="Auto-Verbindung" onclick="autoConnectFiles(event)" onkeypress="return false" onkeydown="return false" type="button" style="display:none">
                                        <input id="p13Connect" value="Verbinden" onclick="connectFiles(event,1)" onkeypress="return false" onkeydown="return false" type="button">
                                        <input id="p13Connects" value="SFTP-Verbindung" onclick="connectFiles(event,2)" onkeypress="return false" onkeydown="return false" type="button">
                                        <input id="p13Disconnect" value="Trennen" onclick="connectFiles(event)" onkeypress="return false" onkeydown="return false" type="button">
                                        <span class="textOverGray" id="p13Status">Getrennt</span>
                                    </div>
                                </td>
                            </tr>
                            <tr>
                                <td style="width:100%;background-color:#d3d9d6;text-align:left;padding:4px" valign="bottom">
                                    <div style="width:100%;text-align:center">
                                        <input type="button" style="width:calc(100%/5 - 5px)" id="p13FolderUp" disabled="disabled" onclick="p13folderup()" value="Hoch">
                                        <input type="button" style="width:calc(100%/5 - 5px)" id="p13SelectAllButton" disabled="disabled" onclick="p13selectallfile()" value="Alle auswählen" onkeypress="return false" onkeydown="return false">
                                        <input type="button" style="width:calc(100%/5 - 5px)" id="p13RenameFileButton" disabled="disabled" value="Umbenennen" onclick="p13renamefile()" onkeypress="return false" onkeydown="return false">
                                        <input type="button" style="width:calc(100%/5 - 5px)" id="p13DeleteFileButton" disabled="disabled" value="Löschen" onclick="p13deletefile()" onkeypress="return false" onkeydown="return false">
                                        <input type="button" style="width:calc(100%/5 - 5px)" id="p13NewFolderButton" disabled="disabled" value="Ordner" onclick="p13createfolder()" onkeypress="return false" onkeydown="return false">
                                    </div>
                                    <div style="width:100%;text-align:center">
                                        <input type="button" style="width:calc(100%/5 - 5px)" id="p13UploadButton" disabled="disabled" value="Hochladen" onclick="p13uploadFile()" onkeypress="return false" onkeydown="return false">
                                        <input type="button" style="width:calc(100%/5 - 5px)" id="p13CutButton" disabled="disabled" value="Ausschneiden" onclick="p13copyFile(1)" onkeypress="return false" onkeydown="return false">
                                        <input type="button" style="width:calc(100%/5 - 5px)" id="p13CopyButton" disabled="disabled" value="Kopie" onclick="p13copyFile(0)" onkeypress="return false" onkeydown="return false">
                                        <input type="button" style="width:calc(100%/5 - 5px)" id="p13PasteButton" disabled="disabled" value="Einfügen" onclick="p13pasteFile()" onkeypress="return false" onkeydown="return false">
                                        <input type="button" style="width:calc(100%/5 - 5px)" id="p13RefreshButton" disabled="disabled" value="Aktualisieren" onclick="p13folderup(9999)" onkeypress="return false" onkeydown="return false">
                                    </div>
                                </td>
                            </tr>
                            <tr>
                            ...
                            <tbody><tr style="height:28px">
                                <td class="areaHead">
                                    <div class="toright2">
                                        ...
                                        <input type="button" id="p15uploadCore" value="Agent-Aktion" onclick="p15uploadCore(event)">
                                    </div>
                                        ...
                                        <tbody><tr>
                                            ...
                                            <td id="p15outputselecttd">
                                                <select id="p15outputselect" onchange="setupConsole()">
                                                    ...
                                                    <option id="p15outputselect3" value="3">drücken</option>
                                                    <option id="p15outputselect2" value="2">MQTT</option>
                                                </select>
                                            </td>
                                            <td style="width:1%"><input id="id_p15consoleClear" type="button" class="bottombutton" value="Leeren" onclick="p15consoleClear()"></td>
                                        </tr>
                                    </tbody></table>
                                </td>
                            </tr>
    ...
    <div id="dialog" style="display:none">
        ...
        <div style="margin-right:16px;margin-left:8px">
            ...
            <div id="dialog3" style="margin:auto;margin:3px">
                <select id="deskkeys" style="width:100%">
                    <option value="10">Strg+Alt+Entf</option>
                    <option value="11">Tab</option>
                    <option value="5">Win</option>
                    <option value="0">Win+Runter</option>
                    <option value="1">Win+Hoch</option>
                    <option value="2">Win+L</option>
                    <option value="3">Win+M</option>
                    <option value="4">Umschalt+Win+M</option>
                    <option value="6">Win+R</option>
                    <option value="7">Alt+F4</option>
                    <option value="8">Strg+W</option>
            ...
            <div id="dialog4" style="margin:auto;margin:3px">
                <div id="d3upload">
                    ...
                    <select id="d3uploadMode" onchange="d3modechange()">
                        <option value="1">Lokale Datei hochladen</option>
                        <option value="2">Server-Dateiauswahl</option>
                    </select>
                </div>
                ...
                <div id="d3servermode">
                    <div id="d3serveraction" valign="bottom">
                        <input type="button" id="p3FolderUp" disabled="disabled" onclick="d3folderup()" value="Hoch">&nbsp;<span id="p3CurrentFolder"></span>
                    </div>
            ...
            <div id="dialog7" style="margin:auto;margin:3px">
                <div id="d7meshkvm">
                    <h4 style="width:100%;border-bottom:1px solid gray">Entfernter Desktop via Agent</h4>
                    <table style="width:100%">
                        <tbody><tr>
                            <td>
                                Qualität
                        ...
                        <tr>
                            ...
                            <td style="width:100px">
                                <select id="d7framelimiter" style="float:right;width:200px" dir="rtl">
                                    <option selected="selected" value="50">Schnell</option>
                                    <option value="100">Mittel</option>
                                    <option value="400">Langsam</option>
                                    <option value="1000">Sehr langsam</option>
                                </select>
                            </td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                            <td></td>
                            <td>
                                <label style="display:block" id="d7deskAutoLockLabel"><input type="checkbox" id="d7deskAutoLock">Sperren bei Trennen</label>
                            </td>
                        </tr>
                    </tbody></table>
                </div>
                        ...
                        <tbody><tr>
                            ...
                            <td style="width:100px">
                                <select id="d7desktopmode" style="float:right;width:200px">
                                    <option value="1">RLE8, am schnellsten</option>
                                    <option value="2">RLE16, empfohlen</option>
                                    <option value="3">RAW8, langsam</option>
                                    <option value="4">RAW16, sehr langsam</option>
                                </select>
                            </td>
                        </tr>
                    </tbody></table>
        ...
        <div id="idx_dlgButtonBar" style="padding:10px;margin-bottom:20px">
            <input id="idx_dlgCancelButton" type="button" value="Abbrechen" style="float:right;width:80px;margin-left:5px" onclick="dialogclose(0)">
            <input id="idx_dlgOkButton" type="button" value="OK" style="float:right;width:80px" onclick="dialogclose(1)">
            <div><input id="idx_dlgDeleteButton" type="button" value="Löschen" style="display:none" onclick="dialogclose(2)"></div>
        </div>
    </div>
    <div id="topMenu" style="z-index:1000;background-color:#EEE;box-shadow:0px 0px 15px #666;font-family:Arial,Helvetica,sans-serif;border-radius:0px 0px 5px 5px;position:fixed;top:50px;right:5px;width:170px;display:none">
        <div style="padding:12px;border-top:1px solid gray;color:black;cursor:pointer" onclick="topMenu(2)">Meine Dateien</div>
        <div style="padding:12px;border-top:1px solid gray;color:black;cursor:pointer" onclick="topMenu(1)">Mein Konto</div>
        <div id="logoutMenuOption"><a id="logoutMenuOptionRef" href="/logout"><div style="padding:12px;border-top:1px solid gray;color:black;cursor:pointer">Abmelden</div></a></div>
    </div>
    ...
    <script>
        ...
        var StatusStrs = ["Getrennt", "Verbinden...", "Einrichtung...", "Verbunden", "Intel&reg; AMT verbunden"];
        var agentsStr = ["Unbekannt", "Windows 32bit Konsole", "Windows 64bit Konsole", "Windows 32bit Dienst", "Windows 64bit Dienst", "Linux 32bit", "Linux 64bit", "MIPS", "XENx86", "Android", "Linux ARM", "macOS x86-32bit", "Android x86", "PogoPlug ARM", "Android", "Linux Poky x86-32bit", "macOS x86-64bit", "ChromeOS", "Linux Poky x86-64bit", "Linux NoKVM x86-32bit", "Linux NoKVM x86-64bit", "Windows MinCore Konsole", "Windows MinCore Dienst", "NodeJS", "ARM-Linaro", "ARMv6l / ARMv7l", "ARMv8 64bit", "ARMv6l / ARMv7l / NoKVM", "MIPS24KC (OpenWRT)", "Apple Silicon", "FreeBSD x86-64", "Unbekannt", "Linux ARM 64 bit (glibc/2.24 NOKVM)", "Alpine Linux x86 64 Bit (MUSL)", "Assistent (Windows)", "Armada370 - ARM32/HF (libc/2.26)", "OpenWRT x86-64", "OpenBSD x86-64", "Unbekannt", "Unbekannt", "MIPSEL24KC (OpenWRT)", "ARMADA/CORTEX-A53/MUSL (OpenWRT)", "Windows ARM (64bit) Konsole", "Windows ARM (64bit) Dienst", "ARMVIRT32 (OpenWRT)", "RISC-V x86-64"];
        var files;
        var terminal;
        ...
        function onStateChanged(server, state, prevState, errorCode) {
            if (state == 0) {
                ...
                if (errorCode == 'noauth') { QH('p0span', "Authentifizierung kann nicht durchgeführt werden"); return; }
                if (prevState == 2) { setTimeout(serverPoll, 5000); } else { QH('p0span', "Web-Socket kann nicht verbunden werden"); }
                // Clean up here
        ...
        function updateSelf() {
            ...
            if (typeof userinfo.passchange == 'number') {
                if (userinfo.passchange == -1) { QH('p2nextPasswordUpdateTime', " - Beim nächsten Anmelden zurücksetzen."); }
                    ...
                    if (seconds < 0) { QH('p2nextPasswordUpdateTime', " - Beim nächsten Anmelden zurücksetzen."); }
                    else if (seconds < 3600) { var secs = Math.floor(seconds / 60); QH('p2nextPasswordUpdateTime',format((secs == 1)?" - Zurücksetzen in 1 Minute.":" - Zurücksetzen in {0} Minuten.", secs)); }
                    else if (seconds < 86400) { var hours = Math.floor(seconds / 3600); QH('p2nextPasswordUpdateTime', format((hours == 1) ? " - Zurücksetzen in 1 Stunde." : " - Zurücksetzen in {0} Stunden.", hours)); }
                    else { var days = Math.floor(seconds / 86400); QH('p2nextPasswordUpdateTime', format((hours == 1) ? " - Zurücksetzen in 1 Tag." : " - Zurücksetzen in {0} Tagen.", days)); }
                }
            }
        }
            ...
            switch (message.action) {
                case 'serverinfo': {
                    ...
                    if (serverinfo.certExpire != null) {
                        ...
                        if ((days >= 0) && (days < 20)) {
                            addNotification({ text: format("Zertifikat läuft in {0} Tag(en) ab", days) });
                        }
                    }
                ...
                case 'otpauth-request': {
                    if ((xxdialogMode == 2) && (xxdialogTag == 'otpauth-request')) {
                        if (message.err != null) {
                            var otpauthErrors = ['', "2FA ist gesperrt", "Sicherungscodes sind gesperrt", "Login-Token verwendet", "OTP 2FA nicht erlaubt", "Konto ist gesperrt", "OTPLIB konnte nicht geladen werden"];
                            if ((message.err > 0) && (message.err < otpauthErrors.length)) { QH('d2optinfo', otpauthErrors[message.err]); } else { QH('d2optinfo', format("Fehler #{0}", message.err)); }
                        } else {
                ...
                case 'otpauth-setup': {
                    ...
                    setDialogMode(2, "Authentifikator-Anwendung", 1, null, message.success ? ('<b style=color:green>' + "Aktivierung der Authentifikator-Anwendung erfolgreich." + '</b> ' + "Sie benötigen jetzt ein gültiges Token, um sich erneut anzumelden.") : ('<b style=color:red>' + "Aktivierung der Zweifaktor-Anmeldung fehlgeschlagen." + '</b> ' + "Löschen Sie das Geheimnis aus der Anwendung und versuchen Sie es erneut.Sie haben nur wenige Minuten Zeit, um den richtigen Code einzugeben."));
                    break;
                }
                case 'otpauth-clear': {
                    if (xxdialogMode) return;
                    setDialogMode(2, "Authentifikator-Anwendung", 1, null, message.success ? ('<b>' + "Authentifikator-Anwendung entfernt." + '</b> ' + "Sie können diese Funktion jederzeit wieder aktivieren.") : ('<b style=color:red>' + "Entfernung der Aktivierung der Zweifaktor-Anmeldung fehlgeschlagen." + '</b> ' + "Versuchen Sie es erneut."));
                    break;
                }
                case 'otpauth-getpasswords': {
                    if (xxdialogMode) return;
                    var x = "Einmal-Token können als sekundäre Authentifizierung verwendet werden. Erstellen Sie ein Set, drucken Sie es aus und bewahren Sie es an einem sicheren Ort auf.";
                    ...
                    if (message.passwords) {
                        ...
                        x += '<tr><td>' + "Keine aktiven Token";
                    }
                    x += '</table></div></div><br />';
                    x += '<div><input type=button value=\'' + "Schließen" + '\' onclick=setDialogMode(0) style=float:right></input>';
                    x += '<input type=button value=\'' + "Neue Token" + '\' onclick=\'account_manageOtp(1);\'></input>';
                    if (message.passwords != null) { x += '<input type=button value=\'' + "Leeren" + '\' onclick=\'account_manageOtp(2);\'></input>'; }
                    x += '</div><br />';
                    setDialogMode(2, "Sicherungscodes verwalten", 8, null, x, 'otpauth-manage');
                    break;
                }
                case 'verifyPhone': {
                    ...
                    x += '<br /><br /><div style=width:100%;text-align:center>' + "Bestätigungscode:" + ' <input type=tel pattern="[0-9]" inputmode="number" maxlength=6 id=d2phoneCodeInput onKeyUp=account_managePhoneCodeValidate() onkeypress="if (event.key==\'Enter\') account_managePhoneCodeValidate(1)"></div></table>';
                    setDialogMode(2, "Telefonische Benachrichtigungen", 3, account_managePhoneConfirm, x, message.cookie);
                    ...
                    if ((xxdialogMode == 2) && (xxdialogTag == 'previousLogins')) {
                        ...
                        if (message.events.length == 0) {
                            ...
                            for (var i in message.events) {
                                ...
                                if (m == 107) { m = "Gültige Anmeldung"; c = 'BBD1BB'; xx = ''; }
                                else if (m == 108) { m = "Ungültige 2FA"; c = 'DD9DC3'; xx = 'x'; }
                                else if (m == 109) { m = "Gesperrtes Konto"; c = 'E1BBBB'; xx = 'x'; }
                                else if (m == 110) { m = "Ungültiges Passwort"; c = 'E1BBBB'; xx = 'x'; }
                        ...
                        setDialogMode(2, "Bisherige Logins", 1, null, x);
                    }
                    break;
                }
                case 'event': {
        ...
        function goStack() {
            ...
            if (idtype == 'files') {
                ...
                if ((features & 0x00040000) && !((userinfo.otpsecret == 1) || (userinfo.otphkeys > 0) || (userinfo.otpkeys > 0) || (userinfo.otpduo > 0) || (userinfo.otpdev > 0) || ((features & 0x00800000) && (userinfo.otpekey == 1)))) { setDialogMode(2, "Konto-Sicherheit", 1, null, "Unable to access this feature until two-factor authentication is enabled. This is required for extra security. Go to the \"My Account\" and look at the \"Account Security\" section."); return; }  
                go(5);
            }
        }
        ...
        function account_viewPreviousLogins() {
            if (xxdialogMode) return;
            setDialogMode(2, "Bisherige Logins", 1, null, "Laden...", 'previousLogins');
        ...
        function account_manageImage(mode) {
            ...
            setDialogMode(2, "Konto-Bild verwalten", 7, account_manageImageEx2, x, user._id);
        ...
        function toggleNightMode() {
            ...
            var x = '<input type=radio id=night0 name=nightmoderadio value=0 ' + ((cNightMode == 0) ? 'checked' : '') + '><label for=night0>' + "Browser Standard" + '</label><br>';
            x += '<input type=radio id=night2 name=nightmoderadio value=2 ' + ((cNightMode == 2) ? 'checked' : '') + '><label for=night2>' + "Heller Modus" + '</label><br>';
            x += '<input type=radio id=night1 name=nightmoderadio value=1 ' + ((cNightMode == 1) ? 'checked' : '') + '><label for=night1>' + "Dunklen Modus" + '</label><br>';
            setDialogMode(2, "Nacht Modus", 3, toggleNightModeEx, x);
            QV('uiMenu', false);
        }
        ...
        function account_managePhone() {
            ...
            if (userinfo.phone != null) {
                ...
                x += '<td style=text-align:center><div style=padding:6px>' + "Verifizierte Telefonnummer" + '</div><div style=font-size:20px>' + userinfo.phone + '</div>';
                x += '<div style=margin:10px><label><input id=d2delPhone type=checkbox onclick=account_managePhoneRemoveValidate() />' + "Telefonnummer entfernen" + '</label></div>';
                setDialogMode(2, "Telefonische Benachrichtigungen", 3, account_managePhoneRemove, x);
                ...
                setDialogMode(2, "Telefonische Benachrichtigungen", 3, account_managePhoneAdd, x, 'verifyPhone');
        ...
        function account_showLocalizationSettings() {
            ...
            if (serverinfo.languages && serverinfo.languages.length > 0) {
                y += "Das Ändern der Sprache erfordert eine Aktualisierung der Seite." + '<br /><br />';
                var z = '<select id=d2langselect style=width:180px><option value="*">' + "Browsereinstellung des Benutzers" + '</option>';
                ...
                z += '</select>';
                y += addHtmlValue("Sprache", z);
            }
            y += addHtmlValue("Datum & Uhrzeit", x);

            if ((userinfo.siteadmin == 0xFFFFFFFF) && (domain == '')) {
                y += '<br /><a rel="noreferrer noopener" target="_blank" href="translator.htm">' + "Hilf bei der Übersetzung von MeshCentral" + '</a>';
            }

            setDialogMode(2, "Lokalisierungseinstellungen", 3, account_showLocalizationSettingsEx, y);
            return false;
        }
        ...
        function account_addOtp() {
            ...
            setDialogMode(2, "Authentifikator-Anwendung", 2, function () { meshserver.send({ action: 'otpauth-setup', secret: Q('d2optsecret').attributes.secret.value, token: Q('d2otpauthinput').value }); }, '<div id=d2optinfo>' + "Laden..." + '</div>', 'otpauth-request');
        ...
        function account_removeOtp() {
            if (xxdialogMode || (userinfo.otpsecret != 1) || ((features & 4096) == 0)) return;
            setDialogMode(2, "Authentifikator-Anwendung", 3, function () { meshserver.send({ action: 'otpauth-clear' }); }, "Bestätigen Sie das Entfernen der Zweifaktor-Anmeldung mittels Authentifikator-Applikation?");
        }
        ...
        function account_showVerifyEmail() {
            ...
            var x = "Auf OK klicken, um eine Bestätigungsmail an folgende Adresse zu senden:" + '<br /><div style=padding:8px><b>' + EscapeHtml(userinfo.email) + '</b></div>' + "Bitte warten Sie einige Minuten, um die Bestätigung zu erhalten.";
            setDialogMode(2, "E-Mail-Verifizierung", 3, account_showVerifyEmailEx, x);
        }
        ...
        function account_showChangeEmail() {
            ...
            setDialogMode(2, "E-Mail-Adresse ändern", 3, account_changeEmail, x);
        ...
        function account_showDeleteAccount() {
            ...
            x += '<td align=right>' + "Passwort:" + '</td><td><input id=apassword1 type=password name=apassword1 autocomplete=off onchange=account_validateDeleteAccount() onkeyup=account_validateDeleteAccount() /></td>';
            x += '</tr><tr><td align=right>' + "Passwort:" + '</td><td><input id=apassword2 type=password name=apassword2 autocomplete=off onchange=account_validateDeleteAccount() onkeyup=account_validateDeleteAccount() /></td>';
            x += '</tr></table><div style=padding:10px;margin-bottom:4px>';
            x += '<input id=account_dlgCancelButton type=button value="' + "Abbrechen" + '" style=float:right;width:80px;margin-left:5px onclick=dialogclose(0)>';
            x += '<input id=account_dlgOkButton type=submit value="' + "OK" + '" style="float:right;width:80px" onclick=dialogclose(1)>';
            x += '</div><br /></form>';
            setDialogMode(2, "Konto löschen", 0, null, x);
        ...
        function account_showChangePassword() {
            ...
            x += '<tr><td align=right>' + nobreak("Altes Passwort:") + '</td><td><input id=apassword0 type=password name=apassword0 autocomplete=off onchange=account_validateNewPassword() onkeyup=account_validateNewPassword() onkeydown=account_validateNewPassword() /> <b></b></td></tr>';
            x += '<tr><td align=right>' + nobreak("Neues Passwort:") + '</td><td><input id=apassword1 type=password name=apassword1 autocomplete=off onchange=account_validateNewPassword() onkeyup=account_validateNewPassword() onkeydown=account_validateNewPassword() /> <b><span id=dxPassWarn></span></b></td></tr>';
            x += '<tr><td align=right>' + nobreak("Neues Passwort:") + '</td><td><input id=apassword2 type=password name=apassword2 autocomplete=off onchange=account_validateNewPassword() onkeyup=account_validateNewPassword() onkeydown=account_validateNewPassword() /></td></tr>';
            if (features & 0x00010000) { x += '<tr><td align=right>' + "Passwort-Tipp:" + '</td><td><input id=apasswordhint name=apasswordhint maxlength=250 type=text autocomplete=off onchange=account_validateNewPassword() onkeyup=account_validateNewPassword() onkeydown=account_validateNewPassword() /></td></tr>'; }
            x += '</table>'
            if (passRequirements) {
                var r = [], rc = 0;
                for (var i in passRequirements) { if ((i != 'reset') && (i != 'hint')) { r.push(i + ':' + passRequirements[i]); rc++; } }
                if (rc > 0) { x += '<br /><span style=font-size:x-small>' + format("Voraussetzungen: {0}.", r.join(', ')) + '</span>'; }
            }
            x += '<br />';
            setDialogMode(2, "Passwort ändern", 3, account_showChangePasswordEx, x);
            Q('apassword0').focus();
        ...
        function account_createMesh() {
            ...
            if ((userinfo.siteadmin != 0xFFFFFFFF) && ((userinfo.siteadmin & 64) != 0)) { setDialogMode(2, "Neue Gerätegruppe", 1, null, "Dieses Konto besitzt keine Rechte um eine neue Gerätegruppe zu erzeugen."); return; }

            // Remind the user to verify the email address
            if ((userinfo.emailVerified !== true) && (serverinfo.emailcheck == true) && (userinfo.siteadmin != 0xFFFFFFFF)) { setDialogMode(2, "Konto-Sicherheit", 1, null, "Auf Geräte kann nicht zugegriffen werden, bis die E-Mail-Adresse verifiziert wurde. Dies wird für eine Passwort-Wiederherstellung benötigt. Gehen Sie auf \"Mein Konto\", um Ihre E-Mail-Adresse zu ändern und zu verifizieren."); return; }

            // Remind the user to add two factor authentication
            if ((features & 0x00040000) && !((userinfo.otpsecret == 1) || (userinfo.otphkeys > 0) || (userinfo.otpkeys > 0) || (userinfo.otpduo > 0) || (userinfo.otpdev > 0) || ((features & 0x00800000) && (userinfo.otpekey == 1)))) { setDialogMode(2, "Konto-Sicherheit", 1, null, "Auf Geräte kann nicht zugegriffen werden, bis Zweifaktor-Authentifizierung eingeschaltet wurde. Dies wird als Sicherheitsmaßnahme vorausgesetzt. Gehen Sie auf \"Mein Konto\" und sehen Sie sich die \"Kontosicherheit\"-Sektion an."); return; }
            ...
            x += addHtmlValue("Modus", '<div style=width:170px;margin:0;padding:0><select id=dp3meshtype style=width:100% onchange=account_validateMeshCreate() ><option value=2>' + "Software-Agent-Gruppe" + '</option><option value=1>' + "Nur Intel&reg; AMT" + '</option></select></div>');
            x += addHtmlValue("Beschreibung", '<div style=width:170px;margin:0;padding:0><textarea id=dp3meshdesc maxlength=1024 style=width:100%;resize:none></textarea></div>');
            setDialogMode(2, "Gerätegruppe erstellen", 3, account_createMeshEx, x);
        ...
        function account_validateNewPassword() {
            ...
            if (Q('apassword1').value != '') {
                if (passRequirements == null || passRequirements == '') {
                    ...
                    if (passReq == false) { ok = false; r = '<span style=color:red>' + "Richtlinie" + '<span>' }
                }
            }
            QH('dxPassWarn', r);
        ...
        function updateMeshes() {
            ...
            for (i in meshes) {
                ...
                var rights = "Partielle Rechte";
                if (meshrights == 0xFFFFFFFF) rights = "Gesamtadministrator"; else if (meshrights == 0) rights = "Keine Berechtigungen";
        ...
        function getNiceSize(bytes) {
            if (bytes <= 0) return "Speicher überschritten";
            if (bytes < 2048) return format("{0}B verbleibend", bytes);
            if (bytes < 2097152) return format("{0}k verbleibend", Math.round(bytes / 1024));
            if (bytes < 2147483648) return format("{0}M verbleibend", Math.round(bytes / 1024 / 1024));
            return format("{0}G verbleibend", Math.round(bytes / 1024 / 1024 / 1024));
        }
        ...
        function p5showPublicLink(u) { setDialogMode(2, "Öffentlicher Link", 1, null, '<input type=text style=width:100% value="' + u + '" readonly />'); }
        ...
        function p5setActions() {
            ...
            Q('p5SelectAllButton').value = (cc > 0 ? "Kein(e)" : "Alle");
        ...
        function p5createfolder() { setDialogMode(2, "Neuer Ordner", 3, p5createfolderEx, '<input type=text id=p5renameinput maxlength=64 onkeyup=p5fileNameCheck(event) style=width:100% />'); focusTextBox('p5renameinput'); p5fileNameCheck(); }
        ...
        function p5deletefile() { var cc = getFileSelCount(), rec = (getFileSelDirCount() > 0) ? '<br /><br /><label><input type=checkbox id=p5recdeleteinput>' + "Rekursiv Löschen" + '</label><br>' : '<input type=checkbox id=p5recdeleteinput style=\'display:none\'>'; setDialogMode(2, "Löschen", 3, p5deletefileEx, (cc > 1) ? (format("{0} ausgewählte Elemente löschen?", cc) + rec) : ("Ausgewähltes Element löschen?" + rec)); }
        ...
        function p5pasteFile() { var x = ''; if ((p5clipboard != null) && (p5clipboard.length > 0)) { x = format("Bestätigen Sie das {0} von {1} Einträgen{2} an diesen Ort?", (p5clipboardCut == 0 ? 'copy' : 'move'), p5clipboard.length, ((p5clipboard.length > 1) ? 's' : '')) } setDialogMode(2, "Einfügen", 3, p5pasteFileEx, x); }
        ...
        function p5updateClipview() { var x = ''; if ((p5clipboard != null) && (p5clipboard.length > 0)) { x = format("Halte {0} Einträge{1} zum {2}", p5clipboard.length, ((p5clipboard.length > 1) ? 's' : ''), (p5clipboardCut == 0 ? "kopieren" : "verschieben")) + ', <a href=# onclick="return p5clearClip()" style=cursor:pointer>' + "Leeren" + '</a>.' } QH('p5bottomstatus', x); p5setActions(); }
        ...
        function updateDevices() {
            ...
            for (var i in nodes) {
                ...
                if (sort == 0) {
                    ...
                    if (((meshes[nodes[i].meshid]?nodes[i].meshid:'*') != current)) {
                        deviceHeaderSet();
                        var extra = '';
                        if ((meshes[nodes[i].meshid] != null) && (meshes[nodes[i].meshid].mtype == 1)) { extra = '<span style=color:lightgray>' + ", nur Intel&reg; AMT" + '</span>'; }
                        ...
                        if (meshes[nodes[i].meshid]) {
                            ...
                            r += '</span><span id=MxMESH><i>' + "Einzelne Geräte" + '</i></span><span id=DevxHeader' + deviceHeaderId + ' style=color:lightgray></span></div>';
                            current = '*';
                        }
            ...
            if ((r == '') && (nodes.length > 0) && (Q('SearchInput').value != '')) {
                viewNothing = true;
                r = '<div style="margin:30px">' + "Keine Geräte, die auf diese Suche passen." + '</div>';
            }
            ...
            if ((sort == 0) && (Q('SearchInput').value == '')) {
                for (var i in meshes) {
                    ...
                    if ((displayedMeshes[mesh._id] == null) && (IsMeshViewable(mesh))) {
                        ...
                        if (mesh.mtype == 1) { r += '<div style=padding:10px><i>' + "Keine Intel&reg;-AMT-Geräte in dieser Gruppe"; }
                        if (mesh.mtype > 1) { r += '<div style=padding:10px><i>' + "Keine Geräte in dieser Gruppe"; }
                        r += '.</i></div></div>';
                        current = mesh._id;
                        count++;
                    }
            ...
            if (count == 0) {
                if ((Q('SearchInput').value != '') || (Q('OnlineCheckBox').checked)) {
                    QH('xdevices', '<div style="margin-top:50px;text-align:center"><span style="font-size:30px">' + "Keine Geräte" + '</span><br /><br />' + "Keine Geräte, die auf diese Suche passen." + ' <a onclick=clearSearchInput() style=cursor:pointer>' + "Suchfilter löschen" + '</a></div>');
                } else {
                    QH('xdevices', '<div style="margin-top:50px;text-align:center"><span style="font-size:30px">' + "Keine Geräte" + '</span><br /><br />' + "Verwenden Sie die Desktop-Version dieser Website, um Geräte hinzuzufügen." + '</div>');
                }
            } else {
                QH('xdevices', r);
            }
        ...
        function updateDeviceViewHtml(div, node) {
            ...
            if ((div.offsetTop >= visibleTop) && (div.offsetTop < visibleBottom)) {
                ...
                if (title.length == 0) { title = '<i>' + "Kein(e)" + '</i>'; }
                ...
                if (name.length == 0) { name = '<i>' + "Kein(e)" + '</i>'; }
                ...
                if (node.sessions != null) {
                    ...
                    if (node.sessions.battery != null) {
                        ...
                        var statestr = '';
                        if (bat.state == 'ac') { statestr = "Gerät ist angeschlossen"; }
                        else if (bat.state == 'dc') { statestr = "Gerät ist batteriebetrieben"; }
        ...
        function showDeviceHelpRequests(nodeid, force, e) {
            ...
            if (x != '') { setDialogMode(2, "Hilfeanfragen" + ' - ' + EscapeHtml(node.name), 1, null, x, 'HELPREQ-' + node._id); } else { setDialogMode(0); }
            return false;
        }
                ...
                if ((i == 'kvm') && (node.sessions.multidesk == null)) {
                    ...
                    for (var j in node.sessions.kvm) {
                        if (j.startsWith('user/')) {
                            var trash = '';
                            if ((j == userinfo._id) || (GetNodeRights(node) == 0xFFFFFFFF)) { trash = ' <a href=# onclick=\'return endDeviceSession("kvm", "' + encodeURIComponentEx(node._id) + '", "' + encodeURIComponentEx(j) + '")\' title="' + "Trennen Sie diese Sitzung" + '" style=cursor:pointer><img src=images/trash.png border=0 height=10 width=10></a>'; }
                            x += addHtmlValue4(getUserName(j), ((node.sessions.kvm[j] == 1) ? "1 Sitzung" : nobreak(format("{0} Sitzungen", node.sessions.kvm[j]))) + trash);
                        } else if (j == 'busy') {
                            x += addHtmlValue2("Gerät ist beschäftigt", ((node.sessions.kvm[j] == 1) ? "1 Sitzung" : nobreak(format("{0} Sitzungen", node.sessions.kvm[j]))));
                        }
                    }
                } else if (i == 'multidesk') {
                    x += '<u>' + "Remotedesktop" + '</u>';
                    for (var j in node.sessions.multidesk) {
                        var trash = '';
                        if ((j == userinfo._id) || (GetNodeRights(node) == 0xFFFFFFFF)) { trash = ' <a href=# onclick=\'return endDeviceSession("multidesk", "' + encodeURIComponentEx(node._id) + '", "' + encodeURIComponentEx(j) + '")\' title="' + "Trennen Sie diese Sitzung" + '" style=cursor:pointer><img src=images/trash.png border=0 height=10 width=10></a>'; }
                        x += addHtmlValue4(getUserName(j), ((node.sessions.multidesk[j] == 1) ? "1 Sitzung" : nobreak(format("{0} Sitzungen", node.sessions.multidesk[j]))) + trash);
                    }
                } else if (i == 'terminal') {
                    x += '<u>' + "Terminal" + '</u>';
                    for (var j in node.sessions.terminal) {
                        var trash = '';
                        if ((j == userinfo._id) || (GetNodeRights(node) == 0xFFFFFFFF)) { trash = ' <a href=# onclick=\'return endDeviceSession("terminal", "' + encodeURIComponentEx(node._id) + '", "' + encodeURIComponentEx(j) + '")\' title="' + "Trennen Sie diese Sitzung" + '" style=cursor:pointer><img src=images/trash.png border=0 height=10 width=10></a>'; }
                        x += addHtmlValue4(getUserName(j), ((node.sessions.terminal[j] == 1) ? "1 Sitzung" : nobreak(format("{0} Sitzungen", node.sessions.terminal[j]))) + trash);
                    }
                } else if (i == 'files') {
                    x += '<u>' + "Dateien" + '</u>';
                    for (var j in node.sessions.files) {
                        var trash = '';
                        if ((j == userinfo._id) || (GetNodeRights(node) == 0xFFFFFFFF)) { trash = ' <a href=# onclick=\'return endDeviceSession("files", "' + encodeURIComponentEx(node._id) + '", "' + encodeURIComponentEx(j) + '")\' title="' + "Trennen Sie diese Sitzung" + '" style=cursor:pointer><img src=images/trash.png border=0 height=10 width=10></a>'; }
                        x += addHtmlValue4(getUserName(j), ((node.sessions.files[j] == 1) ? "1 Sitzung" : nobreak(format("{0} Sitzungen", node.sessions.files[j]))) + trash);
                    }
                } else if (i == 'tcp') {
                    x += '<u>' + "TCP-Routing" + '</u>';
                    for (var j in node.sessions.tcp) {
                        var trash = '';
                        if ((j == userinfo._id) || (GetNodeRights(node) == 0xFFFFFFFF)) { trash = ' <a href=# onclick=\'return endDeviceSession("tcp", "' + encodeURIComponentEx(node._id) + '", "' + encodeURIComponentEx(j) + '")\' title="' + "Trennen Sie diese Sitzung" + '" style=cursor:pointer><img src=images/trash.png border=0 height=10 width=10></a>'; }
                        x += addHtmlValue4(getUserName(j), ((node.sessions.tcp[j] == 1) ? "1 Sitzung" : nobreak(format("{0} Sitzungen", node.sessions.tcp[j]))) + trash);
                    }
                } else if (i == 'udp') {
                    x += '<u>' + "UDP-Routing" + '</u>';
                    for (var j in node.sessions.udp) {
                        var trash = '';
                        if ((j == userinfo._id) || (GetNodeRights(node) == 0xFFFFFFFF)) { trash = ' <a href=# onclick=\'return endDeviceSession("udp", "' + encodeURIComponentEx(node._id) + '", "' + encodeURIComponentEx(j) + '")\' title="' + "Trennen Sie diese Sitzung" + '" style=cursor:pointer><img src=images/trash.png border=0 height=10 width=10></a>'; }
                        x += addHtmlValue4(getUserName(j), ((node.sessions.udp[j] == 1) ? "1 Sitzung" : nobreak(format("{0} Sitzungen", node.sessions.udp[j]))) + trash);
                    }
                }
            }
            if (x != '') { setDialogMode(2, "Sitzungen" + ' - ' + EscapeHtml(node.name), 1, null, x, 'SESSIONS-' + node._id); } else { setDialogMode(0); }
        }
        ...
        function showDeviceMessages(nodeid, force, e) {
            ...
            x += '</div>';
            if (count > 0) setDialogMode(2, "Agentennachrichten" + ' - ' + EscapeHtml(node.name), 1, null, x, 'MESSAGES-' + node._id);
            return false;
        }

        var powerStatetable = ['', "eingeschaltet", "Ruhezustand", "Ruhezustand", "Ruhezustand", "Ruhezustand", "Ausschalten", "präsent", "aus"];
        var powerStateStrings = ['', "eingeschaltet", "Ruhezustand", "Ruhezustand", "Tiefschlaf", "Ruhezustand", "Soft-Off", "präsent", "aus"];
        var powerStateStrings2 = ['', "Gerät ist eingeschaltet", "Gerät befindet sich im Stand-By (S1)", "Gerät befindet sich im Ruhezustand (S2)", "Gerät befindet sich im Tiefschlaf (S3)", "Gerät ist im Ruhezustand (S4)", "Gerät ist im Soft-Off-Zustand (S5)", "Gerät ist präsent, aber der Energiezustand kann nicht ermittelt werden", "Das Gerät ist ausgeschaltet"];
        ...
        function NodeStateStr(node) {
            ...
            if (node.conn) {
                if ((node.conn & 1) != 0) { states.push('<span>' + ((node.mtype == 4) ? ((node.porttype == 'PDU') ? "Schalten" : "IP-KVM") : "Agent") + '</span>'); }
                if ((node.conn & 2) != 0) { states.push('<span>' + "CIRA" + '</span>'); }
                else if ((node.conn & 4) != 0) { states.push('<span>' + "Intel&reg; AMT" + '</span>'); }
                if ((node.conn & 8) != 0) { states.push('<span>' + "Weiterleitung" + '</span>'); }
        ...
        function deviceHeaderSet() {
            ...
            deviceHeaders['DevxHeader' + deviceHeaderId] = ', ' + deviceHeaderTotal + ((deviceHeaderTotal == 1) ? " Knoten" : " Knoten");
            var title = '';
        ...
        */
        ...
        function gotoDevice(nodeid, panel, refresh) {
            ...
            if (!currentNode || currentNode._id != node._id || refresh == true) {
                ...
                if ((currentNode.sessions != null) && (currentNode.sessions.battery != null)) {
                    ...
                    var statestr = '';
                    if (bat.state == 'ac') { statestr = "Gerät ist angeschlossen"; }
                    if (bat.state == 'dc') { statestr = "Gerät ist batteriebetrieben"; }
                ...
                if (nname.length == 0) { nname = '<i>' + "Kein(e)" + '</i>'; }
                ...
                // Attribute: Mesh
                if (mesh) { x += addDeviceAttribute('<span>' + "Gruppe" + '</span>', '<a onclick=goForward("' + node.meshid + '") style=cursor:pointer>' + EscapeHtml(meshes[node.meshid].name) + '</a>'); }
                ...
                if ((((features & 1) == 0) && (node.mtype != 4)) || (node.mtype == 3)) { // If not WAN-only, local hostname is in use
                    if ((meshrights & 4) != 0) {
                        if (node.host) {
                            ...
                            x += addDeviceAttribute("Hostname", '<span onclick=showEditNodeValueDialog(1) style=cursor:pointer><i>' + "Kein(e)" + '</i></span>');
                        }
                    } else {
                ...
                var description = node.desc ? EscapeHtml(node.desc) : '<i>' + "Kein(e)" + '</i>';
                if ((meshrights & 4) != 0) {
                    x += addDeviceAttribute("Beschreibung", '<span onclick=showEditNodeValueDialog(2) style=cursor:pointer>' + description + '</span>');
                } else {
                    x += addDeviceAttribute("Beschreibung", description);
                }

                // IP-KVM information
                if (node.mtype == 4) {
                    if (node.portnum != null) { x += addDeviceAttribute("Port-Nummer", node.portnum); }
                    if (node.porttype != null) { x += addDeviceAttribute("Porttyp", node.porttype); }
                }

                // Attribute: Mesh Agent
                if ((node.agent != null) && (node.agent.id != null) && (node.mtype == 3)) {
                    if (node.agent.id == 4) { x += addDeviceAttribute("Gerätetyp", "Windows"); }
                    if (node.agent.id == 6) { x += addDeviceAttribute("Gerätetyp", "Linux"); }
                    if (node.agent.id == 29) { x += addDeviceAttribute("Gerätetyp", "macOS"); }
                    ...
                    if ((node.agent.root === false) && ((node.conn & 1) != 0)) { str += ', ' + "Beschränkt"; }
                ...
                if (node.intelamt != null) {
                    var str = '';
                    var provisioningStates = { 0: nobreak("Nicht aktiviert (Pre)"), 1: nobreak("Nicht aktiviert (In)"), 2: nobreak("Aktiviert") };
                    if (node.intelamt.ver != null && node.intelamt.state == null) { str += '<i>' + nobreak("Unbekannter Zustand") + '</i>, v' + EscapeHtml(node.intelamt.ver); }
                    else if ((node.intelamt.ver == null) && (node.intelamt.state == 2)) { str += '<i>' + "Aktiviert" + '</i>'; }
                    else if ((node.intelamt.ver == null) || (node.intelamt.state == null)) { str += '<i>' + "Unbekannte Version & Zustand" + '</i>'; }
                    else {
                    ...
                    if (node.intelamt.state == 2) {
                        if (node.intelamt.tls == 1) { str += ', <span title="' + "Intel&reg; AMT ist mit TLS-Netzwerksicherheit eingerichtet" + '">' + "TLS" + '</span>'; }
                        ...
                        if (node.intelamt.user == null || node.intelamt.user == '') { // If credentials are not set, allow setting them.
                            if ((meshrights & 4) != 0) {
                                str += ', <i style=color:#FF0000;cursor:pointer title="' + "Zugangsdaten für Intel&reg; AMT bearbeiten" + '" onclick=editDeviceAmtSettings("' + node._id + '")>' + "Keine Zugangsdaten" + '</i>';
                                editUserCredentialsIcon = true;
                            } else {
                                str += ', <i style=color:#FF0000>' + "Keine Zugangsdaten" + '</i>';
                            }
                            ...
                            var warn = null;
                            if ((node.intelamt.warn & 1) != 0) { warn = "Ungültige Anmeldeinformationen"; }
                            if ((node.intelamt.warn & 8) != 0) { warn = "Anmeldeinformationen versuchen"; }
                            if (warn != null) {
                                if ((meshrights & 4) != 0) {
                                    str += ', <i style=color:#FF0000;cursor:pointer title="' + "Zugangsdaten für Intel&reg; AMT bearbeiten" + '" onclick=editDeviceAmtSettings("' + node._id + '")>' + warn + '</i>';
                                    editUserCredentialsIcon = true;
                                } else {
                        ...
                        if (editUserCredentialsIcon) {
                            str += '<img src=images/link4.png height=10 width=10 title="' + "Zugangsdaten für Intel&reg; AMT bearbeiten" + '" style=cursor:pointer onclick=editDeviceAmtSettings("' + node._id + '")>';
                        }
                    }
                ...
                if ((node.agent != null) && (node.agent.tag != null) && (node.agent.tag != 'mailto:')) {
                    ...
                    x += addDeviceAttribute("Agent-Markierung", tag);
                }
                ...
                if (connectivity && connectivity > 1) {
                    var cstate = [];
                    if ((node.conn & 1) != 0) cstate.push('<span>' + ((node.mtype == 4) ? ((node.porttype == 'PDU') ? "Schalten" : "IP-KVM") : "Agent") + '</span>');
                    if ((node.conn & 2) != 0) cstate.push('<span>' + "Intel&reg; AMT CIRA" + '</span>');
                    else if ((node.conn & 4) != 0) cstate.push('<span>' + "Intel&reg; AMT" + '</span>');
                    if ((node.conn & 8) != 0) cstate.push('<span>' + "Agent-Weiterleitung" + '</span>');
                    if ((node.conn & 16) != 0) cstate.push('<span>' + "MQTT" + '</span>');
                    x += addDeviceAttribute("Konnektivität", cstate.join(', '));
                }

                // Node tags
                var groupingTags = '<i>' + "Kein(e)" + '</i>';
                ...
                if ((node.ssh != null) || (node.rdp != null)) {
                    var y = [];
                    if ((meshrights & 4) != 0) {
                        if (node.ssh != null) { y.push('<span onclick=showClearSshDialog(3) style=cursor:pointer>' + ((node.ssh == 1) ? "SSH-Benutzer+Passwort" : ((node.ssh == 2) ? "SSH-Benutzername+Schlüssel+Passwort" : "SSH-Benutzername+Schlüssel")) + ' <img class=hoverButton src="images/link5.png" width=10 height=10 /></span>'); }
                        ...
                        if (node.ssh != null) { y.push(((node.ssh == 1) ? "SSH-Benutzer+Passwort" : ((node.ssh == 2) ? "SSH-Benutzername+Schlüssel+Passwort" : "SSH-Benutzername+Schlüssel"))); }
                        if (node.rdp != null) { y.push("RDP"); }
                    }
                    x += addDeviceAttribute("Anmeldedaten", y.join(', '));
                }

                x += '</table><br />';
                // Show action button, only show if we have permissions 4, 8, 64
                if (((meshrights & (4 + 8 + 64 + 262144)) != 0) && (node.mtype < 3)) { x += '<input type=button value="' + "Aktionen" + '" onclick=deviceActionFunction() />'; }
                x += '<input type=button value="' + "Notizen" + '" onclick=showNotes(' + ((meshrights & 128) == 0) + ',"' + encodeURIComponent(node._id) + '") />';
                ...
                if ((node.mtype == 4) && (connectivity & 1)) {
                    if (node.porttype == 'PDU') {
                        if (node.pwr == 1) {
                            if (meshrights & 0x40000) { x += '<input type=button value="' + "Schalte aus" + '" title="' + "Schalte aus" + '" onclick=setIpPduState(0) />'; }
                        } else if (node.pwr == 8) {
                            if (meshrights & 0x40) { x += '<input type=button value="' + "Anmachen" + '" title="' + "Anmachen" + '" onclick=setIpPduState(1) />'; }
                        }
                    } else {
                        if (meshrights & 8) { x += '<input type=button value="' + "Fernsteuerung" + '" title="' + "Fernsteuerung" + '" onclick=openIpKvmRemoteControl("' + encodeURIComponentEx(node._id) + '") />'; }x
                    }
                }
                ...
                if ((meshrights & 0x8000) != 0) { x += '<a style=cursor:pointer onclick=p10showDeleteNodeDialog("' + node._id + '")>' + "Gerät löschen" + '</a>'; }
                ...
                if ((connectivity & 1) != 0) { if (powerstate.length > 0) { powerstate += ', '; } powerstate += ((node.mtype == 4) ? ((node.porttype == 'PDU') ? "Schalten" : "IP-KVM") : "Mesh-Agent"); }
                if ((connectivity & 2) != 0) { if (powerstate.length > 0) { powerstate += ', '; } powerstate += "Intel&reg; AMT verbunden"; }
                else if ((connectivity & 4) != 0) { if (powerstate.length > 0) { powerstate += ', '; } powerstate += "Intel&reg; AMT erkannt"; }
                if ((connectivity & 16) != 0) { if (powerstate.length > 0) { powerstate += ', '; } powerstate += "MQTT-Kanal verbunden"; }
        ...
        function setIpPduState(op) {
            if (op == 0) {
                setDialogMode(2, "Leistungsbetrieb", 3, function () { meshserver.send({ action: 'poweraction', nodeids: [currentNode._id], actiontype: 2 }); }, "Ausschalten durchführen?"); // Turn off
            } else {
                setDialogMode(2, "Leistungsbetrieb", 3, function () { meshserver.send({ action: 'wakedevices', nodeids: [currentNode._id] }); }, "Einschalten durchführen?"); // Turn on
            }
        }
        ...
        function deviceToastFunction() {
            if (xxdialogMode) return;
            setDialogMode(2, "Geräte-Toast", 3, deviceToastFunctionEx, '<textarea id=d2devToast style=width:100%;height:80px;resize:none;overflow-y:scroll></textarea>');
        }
        ...
        function setupDeviceMenu(op, obj) {
            ...
            var menus = [];
            if (currentDevicePanel != 0) { menus.push({ n: "Allgemein", f: 'setupDeviceMenu(0)' }); }
            ...
            if ((currentDevicePanel != 2) && (currentNode != null) && (meshrights & 8) && ((meshrights == 0xFFFFFFFF) || ((meshrights & 1024) == 0)) && ((currentNode.mtype != 1) && (currentNode.agent) && (currentNode.agent.caps & 4))) { menus.push({ n: "Dateien", f: 'setupDeviceMenu(2)' }); }
            ...
            if ((currentDevicePanel != 4) && (currentNode != null) && (meshrights & 0x00000010) && (currentNode.mtype == 2)) { menus.push({ n: "Konsole", f: 'setupDeviceMenu(4)' }); }
        ...
        function deviceActionFunction() {
            ...
            var x = "Wählen Sie eine Operation für die Durchführung auf diesem Gerät." + '<br /><br />';
            ...
            if ((currentNode.agent != null) && (currentNode.agent.id == 14)) {
                if (((currentNode.conn & 1) != 0) && ((rights & 8) != 0)) {
                    count++;
                    y += '<option value=400>' + "Blitz" + '</option>';
                    y += '<option value=401>' + "Vibrieren" + '</option>';
                    z += '<div id=d2devicetimediv>' + addHtmlValue("Zeit", '<select id=d2devicetime style=float:right;width:170px><option value=1000>' + "1 Sekunde" + '</option><option value=5000>' + "5 Sekunden" + '</option><option value=10000>' + "10 Sekunden" + '</option></select>') + '</div>';
                }
            } else {
                if ((rights & 64) != 0) { count++; y += '<option value=100>' + "Aufwecken" + '</option>'; } // Wake-up permission
                //if (((currentNode.conn & 1) != 0) && ((rights & 131072) != 0)) { count++; y += '<option value=106>' + "Run Commands" + '</option>'; } // Remote command permission
                if ((currentNode.conn != 0) && ((rights & 262144) != 0)) { count++; y += '<option value=4>' + "Ruhezustand" + '</option><option value=3>' + "Neustarten" + '</option><option value=2>' + "Ausschalten" + '</option>'; }
                ...
                if ((currentNode.intelamt != null) && (currentNode.intelamt.state == 2) && ((currentNode.conn & 6) != 0) && ((rights & 262144) != 0)) {
                    count++;
                    y += '<option value=310>' + "Intel&reg; AMT Zurücksetzen" + '</option>';
                    y += '<option value=308>' + "Intel&reg; AMT Ausschalten" + '</option>';
                }
                if ((currentNode.intelamt != null) && (currentNode.intelamt.state == 2) && ((currentNode.conn & 6) != 0) && ((rights & 64) != 0)) {
                    count++;
                    y += '<option value=302>' + "Intel&reg; AMT Einschalten" + '</option>';
                }
            ...
            y += '</select>';
            x += addHtmlValue("Vorgang", y);
            if (count == 0) { x = "Derzeit sind keine Aktionen für dieses Gerät verfügbar."; }
            setDialogMode(2, "Geräteaktion", (count == 0) ? 2 : 3, deviceActionFunctionEx, x + z);
        ...
        function deviceActionFunctionEx() {
            ...
            if (op == 100) {
                ...
                */
                ...
                setDialogMode(2, "Intel&reg; AMT in Betrieb", 3, function () { meshserver.send({ action: 'poweraction', nodeids: [currentNode._id], actiontype: parseInt(op) }); }, "Intel&reg; AMT Einschalten?");
            } else if (op == 308) { // Intel AMT power off
                setDialogMode(2, "Intel&reg; AMT in Betrieb", 3, function () { meshserver.send({ action: 'poweraction', nodeids: [currentNode._id], actiontype: parseInt(op) }); }, "Perform Intel&reg; AMT power off?<br><br><b>NOTE: If there is an active AMT session, then power off command will be rejected, so you must disconnect from the AMT session first!</b>");
            } else if (op == 310) { // Intel AMT reset
                setDialogMode(2, "Intel&reg; AMT in Betrieb", 3, function () { meshserver.send({ action: 'poweraction', nodeids: [currentNode._id], actiontype: parseInt(op) }); }, "Intel&reg; AMT Zurücksetzen?");
        ...
        function showNotes(readonly, noteid) {
            ...
            if (noteid.startsWith('node%2F%2F')) { x += '<span style=font-size:10px>' + "Gerätegruppennotizen können von anderen Gerätegruppenadministratoren eingesehen und verändert werden." + '<span>'; }
            setDialogMode(2, "Notizen", 3, showNotesEx, x, noteid);
        ...
        function deviceLockFunction() {
            if ((xxdialogMode != null || xxdialogMode == 0) && (desktop != null) && (desktop.contype == 1)) { setDialogMode(2, "Desktop sperren", 3, function() { if ((desktop != null) && (desktop.contype == 1)) { desktop.sendCtrlMsg('{"ctrlChannel":"102938","type":"lock"}'); } }, "Benutzerdesktop sperren?"); }
        }

        function deviceChat(e) {
            if (xxdialogMode) return;
            setDialogMode(2, "Geräteaktion", 3, function () {
        ...
        function deviceUrlFunction() {
            if (xxdialogMode) return;
            setDialogMode(2, "Öffne Seite auf Gerät", 3, deviceUrlFunctionEx, '<input id=d2devurl placeholder="http://server.com" style=width:100%;overflow-y:scroll onkeyup=deviceUrlFunctionValidate() onchange=deviceUrlFunctionValidate()></input>');
            Q('d2devurl').focus();
        ...
        function d2runCommandDialog(options) {
            ...
            if ((wintype == true) || (linuxtype == true) || (agenttype == true)) {
                ...
                if (wintype == true) { x += '<option value=1' + ((runopt.type == 1)?' selected':'') + '>' + "Windows-Eingabeaufforderung" + '</option><option value=2' + ((runopt.type == 2)?' selected':'') + '>' + "Windows PowerShell" + '</option>'; }
                if (linuxtype == true) { x += '<option value=3' + ((runopt.type == 3)?' selected':'') + '>' + "Linux / BSD / macOS-Befehlsshell" + '</option>'; }
                if (agenttype == true) { x += '<option value=4' + ((runopt.type == 4)?' selected':'') + '>' + "Agent-Konsole" + '</option>'; } // MESHRIGHT_REMOTECONTROL & MESHRIGHT_AGENTCONSOLE are needed
                x += '</select>';
                x += '<select id=d2cmduser style=width:100%;margin-bottom:4px><option value=0' + ((runopt.runAs == 0)?' selected':'') + '>' + "Als Agent ausführen" + '</option><option value=1' + ((runopt.runAs == 1)?' selected':'') + '>' + "Als Benutzer ausführen, Agent, wenn kein Benutzer vorhanden ist" + '</option><option value=2' + ((runopt.runAs == 2)?' selected':'') + '>' + "Muss als Benutzer ausgeführt werden" + '</option></select>';
                if (options.selectedFile == null) {
                    x += '<select id=d2cmdsource onclick=d2runCommandValidate() style=width:100%;margin-bottom:4px><option value=0' + ((runopt.source == 0)?' selected':'') + '>' + "Befehle aus Textfeld" + '</option><option value=1' + ((runopt.source == 1)?' selected':'') + '>' + "Befehle aus Datei" + '</option>';
                    if (userinfo.siteadmin & 8) { x += '<option value=2' + ((runopt.source == 2)?' selected':'') + '>' + "Befehle aus Datei vom Server" + '</option>'; }
                ...
                setDialogMode(2, "Befehle ausführen", 3, d2groupActionFunctionRunCommands, x, options);
                if (options.selectedFile == null) {
                    Q('d2runcmd').focus();
        ...
        function editDeviceAmtSettings(nodeid, func) {
            ...
            x += addHtmlValue("Benutzername", '<input id=dp10username style=width:170px maxlength=32 autocomplete=nope placeholder="admin" onchange=validateDeviceAmtSettings() onkeyup=validateDeviceAmtSettings() />');
            x += addHtmlValue("Passwort", '<input id=dp10password type=password style=width:170px autocomplete=nope maxlength=32 onchange=validateDeviceAmtSettings() onkeyup=validateDeviceAmtSettings() />');
            // Only display the TLS setting if the Intel AMT manager is not running on the server. With the manager TLS is auto-detected.
            if ((features2 & 1) == 0) { x += addHtmlValue("Sicherheit", '<select id=dp10tls style=width:176px><option value=0>' + "Keine TLS-Sicherheit" + '</option><option value=1>' + "TLS-Sicherheit vorausgesetzt" + '</option></select>'); }
            if ((node.intelamt.user != null) && (node.intelamt.user != '')) { buttons = 7; }
            setDialogMode(2, "Zugangsdaten für Intel&reg; AMT bearbeiten", buttons, editDeviceAmtSettingsEx, x, { node: node, func: func });
        ...
        function p10showDeleteNodeDialog(nodeid) {
            if (xxdialogMode) return;
            setDialogMode(2, "Knoten löschen", 3, p10showDeleteNodeDialogEx, format("{0} löschen?", EscapeHtml(currentNode.name)) + '<br /><br /><label><input id=p10check type=checkbox onchange=p10validateDeleteNodeDialog() />' + "Bestätigen" + '</label>', nodeid);
        ...
        function p10showiconselector() {
            ...
            setDialogMode(2, "Icon-Auswahl", 0, null, x);
        ...
        function showClearSshDialog() { setDialogMode(2, "Gerät bearbeiten", 3, showClearSshDialogEx, "SSH-Anmeldeinformationen löschen?"); }
        function showClearSshDialogEx(button, mode) { meshserver.send({ action: 'changedevice', nodeid: currentNode._id, ssh: 0 }); }
        function showClearRdpDialog() { setDialogMode(2, "Gerät bearbeiten", 3, showClearRdpDialogEx, "RDP-Anmeldeinformationen löschen?"); }
        function showClearRdpDialogEx(button, mode) { meshserver.send({ action: 'changedevice', nodeid: currentNode._id, rdp: 0 }); }

        var showEditNodeValueDialog_modes = ["Gerätename", "Hostname", "Beschreibung", "Tags"];
        var showEditNodeValueDialog_modes2 = ['name', 'host', 'desc', 'tags'];
        var showEditNodeValueDialog_modes3 = ['', '', '', "Gruppe1, Gruppe2, Gruppe3"];
        function showEditNodeValueDialog(mode) {
            ...
            setDialogMode(2, "Gerät bearbeiten", 3, showEditNodeValueDialogEx, x, mode);
        ...
        var agentConsoleMessages = ['', "Warten auf den Benutzer, um Zugriff zu gewähren ...", "Verweigert", "Fehler beim Starten der Remote-Terminalsitzung, {0} ({1})", "Auszeit", "Ungültige Netzwerkdaten empfangen"];
        ...
        function showDesktopSettings() {
            ...
            applyDesktopSettings();
            updateDesktopButtons();
            setDialogMode(7, "Einstellungen des entfernten Desktops", 3, showDesktopSettingsChanged);
        }
        ...
        function updateDeskShortcutKeys() {
            var x = '<div class="menuButton" onclick="deskMenuButton(-1)">' + "Anpassen" + '</div>';
        ...
        var keyStrings = { 8: "Rücktaste", 9: "Tab", 13: "Eingabe", 27: "Escape", 32: "Space", 44: "Bildschirm Drucken", 45: "Einfügen", 46: "Entf", 36: "Pos1", 35: "Ende", 32: "Espace", 33: "Seite hoch", 34: "Seite runter", 37: "Links", 38: "Hoch", 39: "Rechts", 40: "Runter", 0: "Kein(e)" }

        function keyShortcutTotext(n) {
            var x = [];
            if (n & 0x010000) { x.push("Umschalten"); }
            if (n & 0x020000) { x.push("Alt"); }
            if (n & 0x080000) { x.push("Strg"); }
        ...
        function deskCustomizeKeys() {
            ...
            x += '<label><input id=d1kshift type=checkbox /> ' + "Umschalten" + '</label><label> <input id=d1kalt type=checkbox /> ' + "Alt" + '</label><label> <input id=d1kctrl type=checkbox /> ' + "Strg" + '</label> <input id=d1kwin type=checkbox /> ' + "Win" + '</label>';
            ...
            x += '</select> <input type=button value=' + "hinzufügen" + ' onclick=addDeskCustomizeKey() /></div>';
            QH('p10dialog2', x);
            xxdialogMode = 2;
            QV('p10dialog', true);
        ...
        function deskUpdateShortcutList() {
            ...
            if (x == '') { x = '<i>' + "Kein Tastatur Kürzel definiert" + '</i>'; }
            QH('d2shortcuts', x);
        }
        ...
        function sendSpecialKeys() {
            if (xxdialogMode || desktop == null || desktop.State != 3) return;
            setDialogMode(3, "Spezielle Tasten", 3, deskSendKeys);
        }
        ...
        function deskSelectScreens() {
            ...
            x = addHtmlValue4("Bildschirm", '<select style=width:100% id=deskdisplays>' + x + '</select>');
            setDialogMode(2, "Bildschirmauswahl", 3, deskSelectScreensEx, x);
        }
        ...
        function cmsshportaction(action) {
            if (xxdialogMode) return;
            var x = "SSH-Remote-Verbindungsport:" + '<br /><br /><input type=text placeholder="22" inputmode="numeric" pattern="[0-9]*" onkeypress="return (event.keyCode == 8) || (event.charCode >= 48 && event.charCode <= 57)" maxlength=5 id=d10sshport type=text>';
            setDialogMode(2, "SSH-Verbindung", 3, function () {
        ...
        function sshTunnelAuthDialog(j, func) {
            var x = '';
            if (j.askkeypass) {
                x += addHtmlValue("Authentifizierung", '<select id=dp2authmethod style=width:150px onchange=sshAuthUpdate(event)><option value=3 selected>' + "Gespeicherter Schlüssel" + '</option><option value=1>' + "Benutzername Passwort" + '</option><option value=2>' + "Benutzername und Schlüssel" + '</option></select>');
            } else {
                x += addHtmlValue("Authentifizierung", '<select id=dp2authmethod style=width:150px onchange=sshAuthUpdate(event)><option value=1 selected>' + "Benutzername Passwort" + '</option><option value=2>' + "Benutzername und Schlüssel" + '</option></select>');
            }
            x += '<div id=d2userauth style=display:none>';
            x += addHtmlValue("Benutzername", '<input id=dp2user style=width:150px maxlength=64 autocomplete=off onkeyup=sshAuthUpdate(event) />');
            x += '</div>';
            x += '<div id=d2passauth style=display:none>';
            x += addHtmlValue("Passwort", '<input type=password id=dp2pass style=width:150px maxlength=64 autocomplete=off onkeyup=sshAuthUpdate(event) />');
            if ((features2 & 0x00400000) == 0) { x += '<label><input id=dp2keep type=checkbox>' + "Anmeldedaten merken" + '</label>'; }
            x += '</div><div id=d2keyauth style=display:none>';
            x += addHtmlValue("Schlüsseldatei", '<input type=file id=dp2key style=width:150px maxlength=64 autocomplete=off onchange=sshAuthUpdate(event) />' + '<div id=d2badkey style=font-size:x-small>' + "Die Schlüsseldatei muss im OpenSSH-Format vorliegen." + '</div>');
            x += addHtmlValue("Schlüssel Passwort", '<input type=password id=dp2keypass style=width:150px maxlength=64 autocomplete=off onkeyup=sshAuthUpdate(event) />');
            if ((features2 & 0x00400000) == 0) {
                x += '<label><input id=dp2keep1 type=checkbox onchange=sshAuthUpdate(event)>' + "Benutzer & Schlüssel merken" + '</label><br/>';
                x += '<label><input id=dp2keep2 type=checkbox>' + "Passwort merken" + '</label>';
            }
            x += '</div>';
            if (j.askkeypass) {
                x += '<div id=d2keyauth2 style=display:none>';
                x += addHtmlValue("Passwort", '<input type=password id=dp2keypass2 style=width:150px maxlength=64 autocomplete=off onkeyup=sshAuthUpdate(event) />');
                x += '</div>';
            }
            setDialogMode(2, "Authentifizierung", 11, func, x, 'ssh');
            Q('dp2user').focus();
            sshAuthUpdate();
            ...
            if (typeof data == 'string') {
                if (data[0] == '{') {
                    ...
                    switch (j.action) {
                        ...
                        case 'autherror': { p12setConsoleMsg("Authentifizierungsfehler", 5000); break; }
                        case 'sessionerror': { p12setConsoleMsg("Sitzung abgelaufen", 5000); break; }
        ...
        */
        ...
        function updateTermShortcutKeys() {
            var x = '';
            for (var i = 64; i <= 95; i++) { x += '<div class="menuButton" style="width:70px" onclick="termMenuButton(' + i + ')">' + "Strg +" + String.fromCharCode(i) + '</div>'; }
            QH('termButtonMenu', x);
        }
        ...
        function p13gotFiles(data) {
            ...
            switch (data.action) {
                ...
                case 'autherror': { p13setConsoleMsg("Authentifizierungsfehler", 5000); return; }
                case 'connectionerror': { p13setConsoleMsg("Verbindungsfehler", 5000); return; }
                case 'sessionerror': { p13setConsoleMsg("Sitzung abgelaufen", 5000); return; }
        ...
        function p13setActions() {
            ...
            if (p13filetree == null) {
                ...
                Q('p13SelectAllButton').value = "Alle";
                ...
                Q('p13SelectAllButton').value = (cc > 0 ? "Kein(e)" : "Alle");
        ...
        function p13createfolder() { setDialogMode(2, "Neuer Ordner", 3, p13createfolderEx, '<input type=text id=p13renameinput maxlength=64 onkeyup=p13fileNameCheck(event) style=width:100% />'); focusTextBox('p13renameinput'); p13fileNameCheck(); }
        ...
        function p13deletefile() { var cc = p13getFileSelCount(), rec = (p13getFileSelDirCount() > 0) ? '<br /><br /><label><input type=checkbox id=p13recdeleteinput>' + "Rekursiv Löschen" + '</label><br>' : '<input type=checkbox id=p13recdeleteinput style=\'display:none\'>'; setDialogMode(2, "Löschen", 3, p13deletefileEx, (cc > 1) ? (format("{0} ausgewählte Elemente löschen?", cc) + rec) : ("Ausgewähltes Element löschen?" + rec)); }
        ...
        function p13renamefile() { var renamefile, checkboxes = document.getElementsByName('fd'); for (var i = 0; i < checkboxes.length; i++) { if (checkboxes[i].checked) { renamefile = p13filetree.dir[checkboxes[i].value].n; } } setDialogMode(2, "Umbenennen", 3, p13renamefileEx, '<input type=text id=p13renameinput maxlength=64 onkeyup=p13fileNameCheck(event) style=width:100% value="' + renamefile + '" />', { action: 'rename', path: p13filetreelocation.join('/'), oldname: renamefile }); focusTextBox('p13renameinput'); p13fileNameCheck(); }
        ...
        function p13uploadFile() { setDialogMode(2, "Datei hochladen", 3, p13uploadFileEx, '<input type=file name=files id=p13uploadinput style=width:100% multiple=multiple onchange="updateUploadDialogOk(\'p13uploadinput\')" />'); updateUploadDialogOk('p13uploadinput'); }
        ...
        function p13viewfile() {
            ...
            for (var i = 0; i < checkboxes.length; i++) {
                if (checkboxes[i].checked) {
                    ...
                    } else { messagebox("Datei-Editor", "Nur Dateien kleiner als 200 kB können bearbeitet werden."); }
                    break;
                }
            }
        }
        ...
        function p13pasteFile() {
            ...
            if ((p13clipboard != null) && (p13clipboard.length > 0)) {
                if (p13clipboardCut == 0) {
                    if (p13clipboard.length > 1) { x = format("Kopie von {0} Einträgen an diesem Speicherort bestätigen?", p13clipboard.length); } else { x = format("Bestätigen Sie das Kopieren von 1 Eintrag an diesen Ort?"); }
                } else {
                    if (p13clipboard.length > 1) { x = format("Verschieben von {0} Einträgen an diesen Speicherort bestätigen?", p13clipboard.length); } else { x = format("Bestätigen Sie das Verschieben von 1 Eintrag an diesen Ort?"); }
                }
            }
            setDialogMode(2, "Einfügen", 3, p13pasteFileEx, x);
        }
            ...
            if ((p13clipboard != null) && (p13clipboard.length > 0)) {
                if (p13clipboardCut == 0) {
                    if (p13clipboard.length > 1) {
                        x = format("Halte {0} Einträge zum Kopieren" + ', <a href=# onclick="return p13clearClip()" style=cursor:pointer>' + "Leeren" + '</a>.', p13clipboard.length);
                    } else {
                        x = format("Halte 1 Eintrag zum Kopieren" + ', <a href=# onclick="return p13clearClip()" style=cursor:pointer>' + "Leeren" + '</a>.');
                    }
                } else {
                    if (p13clipboard.length > 1) {
                        x = format("Halte {0} Einträge zum Verschieben" + ', <a href=# onclick="return p13clearClip()" style=cursor:pointer>' + "Leeren" + '</a>.', p13clipboard.length);
                    } else {
                        x = format("Halte 1 Eintrag zum Verschieben" + ', <a href=# onclick="return p13clearClip()" style=cursor:pointer>' + "Leeren" + '</a>.');
                    }
                }
            }
        ...
        function p13downloadfile(x, y, z) {
            ...
            setDialogMode(2, "Datei herunterladen", 10, p13downloadFileCancel, '<div>' + EscapeHtml(downloadFile.file) + '</div><br /><progress id=d2progressBar style=width:100% value=0 max=' + z + ' />');
        }
        ...
        */
        ...
        function p13doUploadFiles(files) {
            ...
            if (overWriteCount == 0) {
                ...
                setDialogMode(2, "Datei hochladen", 3, p13uploadFileContinue, format((overWriteCount == 1) ? "Das Hochladen wird 1 Datei überschreiben. Fortfahren?" : "Das Hochladen wird {0} Dateien überschreiben. Fortfahren?", overWriteCount), files);
            }
        }
        ...
        function p13uploadFileContinue(b, files) {
            ...
            setDialogMode(2, "Datei hochladen", 10, p13uploadFileCancel, '<div id=p13dfileName>' + "Verbinden..." + '</div><br /><progress id=d2progressBar style=width:100% value=0 max=0 />');
            p13uploadNextFile();
        }
        ...
        function updateDeviceDetails(node, hardware, network) {
            ...
            if (hardware.windows && hardware.windows.osinfo && hardware.windows.osinfo.Description) { x += addDetailItem("Beschreibung", EscapeHtml(hardware.windows.osinfo.Description), s); }
            ...
            if (hardware.windows && hardware.windows.osinfo) {
                ...
                if (m.OSArchitecture) {
                    if (m.OSArchitecture.startsWith('32')) { x += addDetailItem("Architektur", "32-Bit", s); }
                    else if (m.OSArchitecture.startsWith('64')) { x += addDetailItem("Architektur", "64-Bit", s); }
                    else { x += addDetailItem("Architektur", EscapeHtml(m.OSArchitecture), s); }
                }
                if(m.LastBootUpTime){
                    var thedate = {
                    ...
                    x += addDetailItem("Letzter Startvorgang", date);
                }
                if(m.Domain){ x += addDetailItem((m.PartOfDomain ? "Domain" : "Arbeitsgruppe"), EscapeHtml(m.Domain), s); }
            }
            ...
            if (node.wsc) {
                var y = [];
                if (node.wsc.antiVirus != null) { if (node.wsc.antiVirus == 'OK') { y.push("Antivirus" + ' - <span style=color:green>' + "OK" + '</span>'); } else { y.push("Antivirus" + ' - <span style=color:red>' + "PROBLEM" + '</span>'); } }
                if (node.wsc.autoUpdate != null) { if (node.wsc.autoUpdate == 'OK') { y.push("Aktualisierung" + ' - <span style=color:green>' + "OK" + '</span>'); } else { y.push("Aktualisierung" + ' - <span style=color:red>' + "PROBLEM" + '</span>'); } }
                ...
                x += addDetailItem("Windows Sicherheit", y.join(', '));
            }

            // Defender for Windows Server
            if(node.defender) {
                var y = [];
                if (node.defender.RealTimeProtection != null) { if (node.defender.RealTimeProtection == true) { y.push("RealTimeProtection" + ' - <span style=color:green>' + "On" + '</span>'); } else { y.push("RealTimeProtection" + ' - <span style=color:red>' + "aus" + '</span>'); } }
                if (node.defender.TamperProtected != null) { if (node.defender.TamperProtected == true) { y.push("TamperProtection" + ' - <span style=color:green>' + "On" + '</span>'); } else { y.push("TamperProtection" + ' - <span style=color:red>' + "aus" + '</span>'); } }
            ...
            if (node.av && node.av.length > 0) {
                ...
                for (var i in node.av) {
                    if (node.av[i].product) {
                        ...
                        if (node.av[i].enabled !== true) { avx += ' - <span style=color:red>' + "Deaktiviert" + '</span>'; }
                        if (node.av[i].updated !== true) { avx += ' - <span style=color:red>' + "Veraltet" + '</span>'; }
           ...
           if (node.users && node.users.length > 0) {
                var u = node.users.map(function(user) {
                    return addKeyLinkConditional(EscapeHtml(user), "Gesperrt", (node.lusers && node.lusers.indexOf(user) >= 0));
                }).join(', ');
                x += addDetailItem((node.users.length > 1 ? "Aktive Benutzer" : "Aktiver Nutzer"), u);
            }

            if (x != '') { sections.push({ name: "Betriebssystem", html: x, img: 'software' }); }
            ...
            if (node.agent) {
                ...
                if (node.firstconnect) { x += addDetailItem("Erste Agentenverbindung", printDateTime(new Date(node.firstconnect))); }
                if ((node.conn & 1) != 0) {
                    x += addDetailItem("Letzte Agent-Verbindung", "Jetzt verbunden");
                } else {
                    if (node.lastconnect) { x += addDetailItem("Letzte Agent-Verbindung", printDateTime(new Date(node.lastconnect))); }
                }
                if (node.lastaddr) {
                    var splitip = node.lastaddr.split(':');
                    if (splitip.length > 2) {
                        // IPv6
                        x += addDetailItem("Letzte Agent-Adresse", node.lastaddr);
                    } else {
                        // IPv4
                        if (isPrivateIP(node.lastaddr)) {
                            x += addDetailItem("Letzte Agent-Adresse", splitip[0]);
                        } else {
                            x += addDetailItem("Letzte Agent-Adresse", '<a href="https://iplocation.com/?ip=' + splitip[0] + '" rel="noreferrer noopener" target="MeshIPLoopup">' + splitip[0] + '</a>');
                        }
                    }
                }
                if (hardware.agentvers != null) {
                    if (hardware.agentvers.compileTime) {
                        try {
                            ...
                            x += addDetailItem("Kompilierungszeit", printDateTime(new Date(d)));
                        } catch (ex) { }
                    }
                }
                if (hardware.time != null) {
                    x += addDetailItem("Letzte Detail-Aktualisierung", printDateTime(new Date(hardware.time)));
                }
            ...
            if (hardware.mobile) {
                ...
                if (hardware.mobile.device) { x += addDetailItem("Gerät", EscapeHtml(hardware.mobile.device), s); }
                if (hardware.mobile.bootloader) { x += addDetailItem("Bootloader", EscapeHtml(hardware.mobile.bootloader), s); }
                if (hardware.mobile.id) { x += addDetailItem("Kennung", EscapeHtml(hardware.mobile.id), s); }
                ...
                if (x != '') { sections.push({ name: "Mobiles Gerät", html: x, img: 'mobile' }); }
            }
            ...
            if (network.netif2 != null) {
                ...
                for (var i in network.netif2) {
                    ...
                    if (m.desc) { x += addDetailItem("Beschreibung", EscapeHtml(m.desc).split('(R)').join('&reg;')); }
                    //if (m.dnssuffix) { x += addDetailItem("DNS Suffix", m.dnssuffix); }
                    if (typeof m[0].mac == 'string') {
                        if (m[0].gatewaymac) {
                            x += addDetailItem("MAC-Schicht", format("MAC: {0}, Gateway: {1}", EscapeHtml(m[0].mac), EscapeHtml(m[0].gatewaymac)));
                        } else {
                            x += addDetailItem("MAC-Schicht", format("MAC: {0}", EscapeHtml(m[0].mac)));
                        }
                    }
                    if (typeof m[0].speed == 'number' && (m[0].speed != 9223372036854775807 && m[0].speed > 0)) {
                        x += addDetailItem("Schnittstellengeschwindigkeit", format("{0}", getNetworkSpeed(m[0].speed)));
                    }
                    for (var j = 0; j < m.length; j++) {
                        var iplayer = m[j], items = [];
                        if (iplayer.address) { items.push(format("IP: {0}", EscapeHtml(iplayer.address))); }
                        if (iplayer.netmask) { items.push(format("Maske: {0}", EscapeHtml(iplayer.netmask))); }
                        if (iplayer.gateway) { items.push(format("Gateway: {0}", EscapeHtml(iplayer.gateway))); }
                        if (items.length > 0) {
                            if (iplayer.family == 'IPv4') { x += addDetailItem("IPv4-Schicht", items.join(", ")); }
                            if (iplayer.family == 'IPv6') { x += addDetailItem("IPv6-Schicht", items.join(", ")); }
                        }
                    }
                    x += '</div></td></tr>';
                }
                if (hardware.network && hardware.network.dns) {
                    x += '<tr><td><div class=style10 style=border-radius:5px;padding:8px>';
                    x += addDetailItem('<b>' + "DNS Server" + '</b>', hardware.network.dns.join(", "));
                    x += '</div></td></tr>';
                }
                x += '</table>';
                if (x != '') { sections.push({ name: "Netzwerk", html: x, img: 'networking' }); }
            }

            // Attribute: Intel AMT
            if (node.intelamt != null) {
                var x = '';
                x += addDetailItem("Version", (node.intelamt.ver) ? ('v' + EscapeHtml(node.intelamt.ver)) : ('<i>' + "Unbekannt" + '</i>'), s);
                x += addDetailItem("Kennung", (node.intelamt.uuid) ? (EscapeHtml(node.intelamt.uuid)) : ('<i>' + "Unbekannt" + '</i>'), s);
                var provisioningStates = { 0: nobreak("Nicht aktiviert (Pre)"), 1: nobreak("Nicht aktiviert (In)"), 2: nobreak("Aktiviert") };
                ...
                x += addDetailItem("Bereitstellungszustand", ((node.intelamt.state) ? (provisioningStates[node.intelamt.state]) : ('<i>' + "Unbekannt" + '</i>')) + provisioningMode, s);
                x += addDetailItem("Sicherheit", (node.intelamt.tls == 1) ? "Mit TLS gesichert" : "TLS ist nicht eingerichtet", s);
                // Check that the Intel AMT user is setup and there is no warnings (1 = invalid credentials, 8 = trying)
                x += addDetailItem("Administrator-Anmeldeinformationen", ((node.intelamt.user) == null || (node.intelamt.user == '') || ((node.intelamt.warn != null) && ((node.intelamt.warn & 9) != 0))) ? "Nicht bekannt" : "Bekannt", s);
                if (x != '') {
                    if ((typeof node.intelamt.sku == 'number') && ((node.intelamt.sku & 16) != 0)) {
                        sections.push({ name: "Intel&reg; Standard-Verwaltbarkeit (Intel&reg; SM)", html: x, img: 'amt' });
                    } else {
            ...
            if (hardware.identifiers) {
                ...
                // BIOS
                if (ident.bios_vendor) { x += addDetailItem("Hersteller", EscapeHtml(ident.bios_vendor), s); }
                if (ident.bios_version) { x += addDetailItem("Version", EscapeHtml(ident.bios_version), s); }
                if (ident.bios_serial) { x += addDetailItem("Seriennummer", EscapeHtml(ident.bios_serial), s); }
                if (ident.bios_mode) { x += addDetailItem("Mode", EscapeHtml(ident.bios_mode), s); }
                if (x != '') { sections.push({ name: "BIOS", html: x, img: 'chip' }); }

                // Motherboard
                x = '';
                if (ident.board_vendor) { x += addDetailItem("Hersteller", EscapeHtml(ident.board_vendor), s); }
                if (ident.board_name) { x += addDetailItem("Name", EscapeHtml(ident.board_name), s); }
                if (ident.board_serial && (ident.board_serial != '')) { x += addDetailItem("Seriennummer", EscapeHtml(ident.board_serial), s); }
                if (ident.board_version) { x += addDetailItem("Version", EscapeHtml(ident.board_version), s); }
                if (ident.product_uuid) { x += addDetailItem("Kennung", EscapeHtml(ident.product_uuid), s); }
                ...
                if (x != '') { sections.push({ name: "Hauptplatine", html: x, img: 'motherboard' }); }
            }

            // TPM
            if (hardware.tpm) {
                var x = '', tpm = hardware.tpm;
                if (tpm.SpecVersion) { x += addDetailItem("TPM-Standard", parseFloat(EscapeHtml(tpm.SpecVersion)).toFixed(1), s); }
                if (tpm.ManufacturerId) { x += addDetailItem("Kennung", EscapeHtml(tpm.ManufacturerId), s); }
                if (tpm.ManufacturerVersion) { x += addDetailItem("Version", EscapeHtml(tpm.ManufacturerVersion), s); }
                if (tpm.IsActivated != null) { x += addDetailItem("Aktiviert", (tpm.IsActivated ? "Ja" : "No"), s); }
                if (tpm.IsEnabled != null) { x += addDetailItem("aktiviert", (tpm.IsEnabled ? "Ja" : "No"), s); }
                if (tpm.IsOwned != null) { x += addDetailItem("Im Besitz", (tpm.IsOwned ? "Ja" : "No"), s); }
            ...
            if (hardware.battery) {
                ...
                for (var i in hardware.battery) {
                    ...
                    x += '<tr><td><div class=style10 style=border-radius:5px;padding:8px>';
                    x += '<div style=margin-bottom:3px><b>' + EscapeHtml(battery.DeviceName ? battery.DeviceName : "Unbekannt") + '</b></div>';
                    if (battery.CycleCount) { x += addDetailItem("Zyklusanzahl", EscapeHtml(battery.CycleCount), s); }
                    if (battery.FullChargedCapacity) { x += addDetailItem("Volle geladene Kapazität", format("{0} mWh", battery.FullChargedCapacity), s); }
                    if (battery.EstimatedRuntime) { x += addDetailItem("Geschätzte Laufzeit", format("{0} Minuten", Math.floor((battery.EstimatedRuntime / 60))), s); }
                    if (battery.Chemistry) { x += addDetailItem("Chemie", EscapeHtml(battery.Chemistry), s); }
                    if (battery.DesignedCapacity) { x += addDetailItem("Designkapazität", format("{0} mWh", battery.DesignedCapacity), s); }
                    if (battery.ManufactureDate) { x += addDetailItem("Herstellungsdatum", EscapeHtml(battery.ManufactureDate), s); }
                    if (battery.ManufactureName) { x += addDetailItem("Herstellername", EscapeHtml(battery.ManufactureName), s); }
                    if (battery.SerialNumber) { x += addDetailItem("Seriennummer", EscapeHtml(battery.SerialNumber), s); }
                    if (battery.ChargeRate) { x += addDetailItem("Gebührensatz", format("{0} mW", battery.ChargeRate), s); }
                    if (battery.Charging != null) { x += addDetailItem("Aufladen", (battery.Charging ? "Ja" : "No"), s); }
                    if (battery.DischargeRate) { x += addDetailItem("Entladungsrate", format("{0} mW", battery.DischargeRate), s); }
                    if (battery.Discharging != null) { x += addDetailItem("Entladen", (battery.Discharging ? "Ja" : "No"), s); }
                    if (battery.RemainingCapacity) { x += addDetailItem("Verbleibende Kapazität", format("{0} mWh", battery.RemainingCapacity), s); }
                    if (battery.Voltage) { x += addDetailItem("Stromspannung", format("{0} V", (battery.Voltage / 1000)), s); }
                    if (battery.Health) { x += addDetailItem("Gesundheit", format("{0} %", battery.Health), s); }
                    if (battery.BatteryCharge) { x += addDetailItem("Batterieladung", format("{0} %", battery.BatteryCharge), s); }   
                    x += '</div>';
                }
                x += '</table>';
                if (x != '') { sections.push({ name: "Batterie", html: x, img: 'battery'}); }
            }
            ...
            if (hardware.windows) {
                if (hardware.windows.memory && (hardware.windows.memory.length > 0)) {
                    ...
                    for (var i in hardware.windows.memory) {
                        ...
                        if (m.Capacity && m.Speed) { x += addDetailItem("Kapazität / Geschwindigkeit", format("{0} MB, {1} MHz", (m.Capacity / 1024 / 1024), m.Speed), s); }
                        else if (m.Capacity) { x += addDetailItem("Kapazität", format("{0} MB", (m.Capacity / 1024 / 1024)), s); }
                        if (m.PartNumber) { x += addDetailItem("Teilenummer", EscapeHtml((m.Manufacturer && m.Manufacturer != 'Undefined') ? (m.Manufacturer + ', ') : '') + EscapeHtml(m.PartNumber), s); }
                        x += '</div>';
                    }
                    x += '</table>';

                    if (x != '') { sections.push({ name: "Speicher", html: x, img: 'ram' }); }
                }
            }
            ...
            if (hardware.linux) {
                if (hardware.linux.memory && (hardware.linux.memory.Memory_Device.length > 0)) {
                    ...
                    for (var i in hardware.linux.memory.Memory_Device) {
                        ...
                        if (m.Size && m.Speed) { x += addDetailItem("Kapazität / Geschwindigkeit", format("{0}, {1}", m.Size, m.Speed), s); }
                        else if (m.Size) { x += addDetailItem("Kapazität", format("{0}", (m.Size)), s); }
                        if (m.PartNumber) { x += addDetailItem("Teilenummer", EscapeHtml((m.Manufacturer && m.Manufacturer != 'Undefined')?(m.Manufacturer + ', '):'') + EscapeHtml(m.PartNumber), s); }
                        x += '</div>';
                    }
                    x += '</table>';
            ...
            if (hardware.darwin) {
                if (hardware.darwin.memory && (hardware.darwin.memory.length > 0)) {
                    ...
                    for (var i in hardware.darwin.memory) {
                        ...
                        if (m.PartNumber) { x += addDetailItem("Teilenummer", EscapeHtml((m.Manufacturer && m.Manufacturer != '')?(m.Manufacturer + ', '):'') + EscapeHtml(m.PartNumber), s); }
                        x += '</div>';
                    }
                    x += '</table>';
                    if (x != '') { sections.push({ name: "Speicher", html: x, img: 'ram'}); }
            ...
            if (hardware.identifiers && ident.storage_devices) {
                ...
                for (var i in ident.storage_devices) {
                    ...
                    if (m.Size) {
                        ...
                        if (m.Size) {
                            ...
                            if (typeof m.Size == 'number') { x += addDetailItem("Kapazität", format("{0} MB", Math.floor(m.Size / 1024 / 1024)), s); }
                            if (typeof m.Size == 'string') { x += addDetailItem("Kapazität", EscapeHtml(m.Size), s); }
                        }
                ...
                if (x != '') { sections.push({ name: "Speicher", html: x, img: 'storage' }); }
            }
            ...
            if (hardware.windows && hardware.windows.volumes) {
                ...
                for (var i in hardware.windows.volumes) {
                    ...
                    if (m.size) {
                        ...
                        x += addDetailItem("Kapazität", EscapeHtml(fsize), s);
                    }
                    if (m.sizeremaining) {
                        var sizes = ['Bytes', 'KB', 'MB', 'GB', 'TB'];
                        ...
                        x += addDetailItem("Verbleibende Kapazität", EscapeHtml(fsize), s);
                    }
                    if (m.type) {
                        var type = (m.removable == true ? "Removable" : (m.cdrom == true ? "CD-ROM" : ''));
                        x += addDetailItem("Dateisystem", (type != '' ? (type + ' / ') : '') + (m.type == 'Unknown' ? "Unbekannt" : EscapeHtml(m.type)), s);
                    }

                    if (m.protectionStatus || m.volumeStatus) {
                        var bitlockerState = [];
                        if (m.protectionStatus) bitlockerState.push("aktiviert");
                        if (m.volumeStatus && m.volumeStatus == 'FullyDecrypted') bitlockerState.push("Vollständig entschlüsselt");
                        if (m.volumeStatus && m.volumeStatus == 'EncryptionInProgress') bitlockerState.push("Verschlüsselung wird durchgeführt");
                        if (m.volumeStatus && m.volumeStatus == 'FullyEncrypted') bitlockerState.push("Vollständig verschlüsselt");
                ...
                if (x != '') { sections.push({ name: "Logische Laufwerke", html: '<table style=width:100%>' + x + '</table>', img: 'storage'}); }
            }
            ...
            if (hardware.darwin && hardware.darwin.volumes) {
                ...
                for (var i in hardware.darwin.volumes) {
                    ...
                    x += '<div style=margin-bottom:3px><b>' + m.mount_point + '</b></div>';
                    if (m.size) {
                        x += addDetailItem("Kapazität", EscapeHtml(m.size), s);
                    }
                    if (m.available) {
                        x += addDetailItem("Verbleibende Kapazität", EscapeHtml(m.available), s);
                    }
                    if (m.type) {
                        var type = (m.removable == true ? "Removable" : (m.cdrom == true ? "CD-ROM" : ''));
                        x += addDetailItem("Dateisystem", (type != '' ? (type + ' / ') : '') + (m.type == 'Unknown' ? "Unbekannt" : EscapeHtml(m.type)), s);
            ...
            if (x == '') {
                QH('p10detailshtml', "Keine Informationen zu diesem Gerät.");
            } else {
                QH('p10detailshtml', x);
            }
        }
        ...
        function deviceDetailsShowBitlockerInfo(drive, identifier, password) {
            if (xxdialogMode) return false;
            var x = '<div><p>' + "Kennung" + '</p><p style=user-select:text;font-weight:bold>' + (identifier ? decodeURIComponent(identifier) : "Unbekannt") + '</p>';
            x += '<p>' + "Recovery Password" + '</p><p style=user-select:text;font-weight:bold>' + (password ? decodeURIComponent(password) : "Unbekannt") + '</p></div>';
        ...
        */
        ...
        function setupConsole() {
            ...
            if ((rights & 16) != 0) {
                ...
                var onlineText = ((consoleNode.conn & 1) != 0) ? "Agent ist online" : "Agent ist offline"
                if ((consoleNode.conn & 16) != 0) { onlineText += ", MQTT ist verbunden" }
                ...
                QH('p15statetext', "Zugriff verweigert");
        ...
        function p15consoleSend(e) {
            ...
            if (((consoleNode.conn & 16) != 0) && (Q('p15outputselect').value == 2)) {
                ...
                t = '<div style=color:violet>' + "DRÜCKEN" + '&gt; ' + EscapeHtml(v) + '<br/></div>';
                consoleNode.consoleText += t;
        ...
        function p15uploadCore(e) {
            ...
            if (e.shiftKey == true) { meshserver.send({ action: 'uploadagentcore', nodeid: consoleNode._id, type: 'default' }); } // Upload default core
                ...
                var htmlValue = '<select id=d3coreMode style=width:230px>' +
                    '<option value=1>' + "Vorgabe-Serverkern hochladen" + '</option>' +
                    '<option value=2>' + "Den Kern löschen" + '</option>' +
                    '<option value=3>' + "Kern-Datei hochladen" + '</option>' +
                    '<option value=4>' + "Agent sanft trennen" + '</option>' +
                    '<option value=5>' + "Agent hart trennen" + '</option>' +
                    '<option value=6>' + "Wiederherstellungkern hochladen" + '</option>' +
                    '<option value=7>' + "Kleinstkern hochladen" + '</option>' +
                    '<option value=8>' + "Agent/Dienst neustarten" + '</option>' +
                    '<option value=9>' + "Aktualisierung des Agents erzwingen" + '</option></select>';
                setDialogMode(2, "Agent-Aktion durchführen", 3, p15uploadCoreEx, addHtmlValue("Aktion", htmlValue));
            }
        }
        ...
        function p15uploadCore2() {
            ...
            Q('d3auth').value = authCookie;
            Q('d3attrib').value = currentNode._id;
            setDialogMode(4, "Mesh-Agent-Kern hochladen", 3, p15uploadCoreEx2);
            d3init();
        }
        ...
        function p20updateMesh() {
            ...
            var meshtype = format("Unbekannt #{0}", currentMesh.mtype);
            var meshrights = GetMeshRights(currentMesh);
            if (currentMesh.mtype == 1) meshtype = "Nur Intel&reg; AMT, kein Agent";
            if (currentMesh.mtype == 2) meshtype = "Verwaltet mittels Software-Agent";
            if (currentMesh.mtype == 3) { if (currentMesh.relayid == null) { meshtype = "Lokale Geräte, kein Agent"; } else { meshtype = "Keine Agentengeräte werden über den Agenten weitergeleitet"; } }
            if (currentMesh.mtype == 4) { if (currentMesh.relayid == null) { meshtype = "IP-KVM-Gerät"; } else { meshtype = "IP-KVM-Gerät wird über Agent weitergeleitet"; } if (currentMesh.kvm.model == 1) { meshtype += ', ' + 'Raritan KX III'; } }

            var x = '';
            x += addHtmlValue("Name", addLinkConditional(EscapeHtml(currentMesh.name), 'p20editmesh(1)', (meshrights & 1) != 0));
            x += addHtmlValue("Beschreibung", addLinkConditional(((currentMesh.desc && currentMesh.desc != '') ? EscapeHtml(currentMesh.desc) : ('<i>' + "Kein(e)" + '</i>')), 'p20editmesh(2)', (meshrights & 1) != 0));
            x += addHtmlValue("Modus", meshtype);
            //x += addHtmlValue('Identifier', currentMesh._id.split('/')[2]);

            // Display the relay device if applicable
            if (((currentMesh.mtype == 3) || (currentMesh.mtype == 4)) && (currentMesh.relayid != null)) {
                var relayName = '<i>' + "Unbekannt" + '</i>';
                var relayNode = getNodeFromId(currentMesh.relayid);
                if (relayNode != null) { relayName = EscapeHtml(relayNode.name); }
                x += addHtmlValue("Relay-Gerät", addLinkConditional(relayName, 'p20editmeshrelay()', (meshrights & 1) != 0));
            }

            // Display IP-KVM information if needed
            if (currentMesh.mtype == 4) {
                x += addHtmlValue("Hostname", currentMesh.kvm.host);
                x += addHtmlValue("Benutzername", currentMesh.kvm.user);
            }

            x += '<br><input type=button value="' + "Notizen" + '" onclick=showNotes(false,"' + encodeURIComponent(currentMesh._id) + '") />';

            x += '<br style=clear:both><br>';
            var currentMeshLinks = currentMesh.links[userinfo._id];
            if (currentMeshLinks && ((currentMeshLinks.rights & 2) != 0)) { x += '<div style=margin-bottom:6px;float:left;margin-right:10px><a onclick=p20showAddMeshUserDialog() style=cursor:pointer><img src=images/icon-addnew.png border=0 height=12 width=12> ' + "Benutzer hinzufügen" + '</a></div>'; }

            if (navigator.userAgent.toLowerCase().indexOf('android') >= 0) {
                x += '<div style=margin-bottom:6px;float:left;margin-right:10px><a onclick=p20installAndroidDialog() style=cursor:pointer><img src=images/icon-addnew.png border=0 height=12 width=12> ' + "Auf diesem Gerät installieren" + '</a></div>';
            }
            ...
            */
            ...
            for (var i in sortedusers) {
                var trash = '', rights = "Partielle Rechte", r = sortedusers[i].rights, icon = 2;
                if (r == 0xFFFFFFFF) rights = "Gesamtadministrator"; else if (r == 0) rights = "Keine Berechtigungen";
            ...
            if (meshrights == 0xFFFFFFFF) { x += '<div style=font-size:small;text-align:right;margin-top:6px><span><a onclick=p20showDeleteMeshDialog() style=cursor:pointer>' + "Gruppe löschen" + '</a></span></div>'; }
        ...
        function p20showDeleteMeshDialog() {
            if (xxdialogMode) return false;
            var x = format("Möchten Sie die Gruppe {0} wirklich löschen? Das Löschen der Gerätegruppe wird auch alle Informationen über die Geräte innerhalb dieser Gruppe löschen.", EscapeHtml(currentMesh.name)) + '<br /><br />';
            x += '<label><input id=p20check type=checkbox onchange=p20validateDeleteMeshDialog() />' + "Bestätigen" + '</label>';
            setDialogMode(2, "Gruppe löschen", 3, p20showDeleteMeshDialogEx, x);
        ...
        function p20editmeshrelay() {
            ...
            if (relayDevices.length == 0) {
                ...
                setDialogMode(2, "Gerätegruppe bearbeiten", 1, null, "Keine Relaisgeräte verfügbar.");
            } else {
                var relayDevices2 = [];
                ...
                var x = addHtmlValue("Relay-Gerät", '<div style=width:170px><select id=d2devrelay style=width:100%>' + relayDevices2.join('') + '</select></div>');
                setDialogMode(2, "Gerätegruppe bearbeiten", 3, p20editmeshrelayEx, x);
            }
        }
        ...
        function p20editmesh(focus) {
            ...
            x += addHtmlValue("Beschreibung", '<input id=dp20meshdesc style=width:170px maxlength=1024 onkeyup=p20editmeshValidate() />');
            setDialogMode(2, "Gerätegruppe bearbeiten", 3, p20editmeshEx, x);
        ...
        function p20installAndroidDialog() {
            if (xxdialogMode) return;
            var x = '<div style=text-align:center><p>' + "Installieren Sie den MeshCentral Agent auf Ihrem Android-Gerät. Klicken Sie nach der Installation auf den Link, um Ihr Gerät mit diesem Server zu verbinden." + '</p>';
            ...
            x += '<p><a rel=\"noreferrer noopener\" target=_blank href="meshagents?id=14' + (urlargs.key?('&key=' + urlargs.key):'') + '" title="' + "APK Version von MeshAgent" + '">' + "Android-APK" + '</a></p>';
            x += '<p><a href="' + serverinfo.magenturl + ',' + serverinfo.agentCertHash + ',' + currentMesh._id.split('/')[2] + '"><b>' + "Gerät Verbindungs-Link" + '</b></a></p></div>';
        ...
        function p20showAddMeshUserDialog() {
            ...
            x += '<label><input type=checkbox onchange=p20validateAddMeshUserDialog() id=p20fulladmin>' + "Gesamtadministrator" + '</label><br>';
            x += '<label><input type=checkbox onchange=p20validateAddMeshUserDialog() id=p20editmesh>' + "Gerätegruppe bearbeiten" + '</label><br>';
            x += '<label><input type=checkbox onchange=p20validateAddMeshUserDialog() id=p20manageusers>' + "Gerätegruppen-Benutzer verwalten" + '</label><br>';
            x += '<label><input type=checkbox onchange=p20validateAddMeshUserDialog() id=p20managecomputers>' + "Gerätegruppen-Rechner verwalten" + '</label><br>';
            x += '<label><input type=checkbox onchange=p20validateAddMeshUserDialog() id=p20remotecontrol>' + "Fernsteuerung" + '</label><br>';
            x += '<label><input type=checkbox onchange=p20validateAddMeshUserDialog() id=p20remoteview style=margin-left:12px>' + "Nur entfernte Ansicht" + '</label><br>';
            x += '<label><input type=checkbox onchange=p20validateAddMeshUserDialog() id=p20remotelimitedinput style=margin-left:12px>' + "Nur eingeschränkte Eingabe" + '</label><br>';
            x += '<label><input type=checkbox onchange=p20validateAddMeshUserDialog() id=p20noterminal style=margin-left:12px>' + "Kein Terminalzugriff" + '</label><br>';
            x += '<label><input type=checkbox onchange=p20validateAddMeshUserDialog() id=p20nofiles style=margin-left:12px>' + "Kein Dateizugriff" + '</label><br>';
            x += '<label><input type=checkbox onchange=p20validateAddMeshUserDialog() id=p20noamt style=margin-left:12px>' + "Kein Intel&reg; AMT" + '</label><br>';
            x += '<label><input type=checkbox onchange=p20validateAddMeshUserDialog() id=p20meshagentconsole>' + "Mesh-Agent-Konsole" + '</label><br>';
            x += '<label><input type=checkbox onchange=p20validateAddMeshUserDialog() id=p20meshserverfiles>' + "Server-Dateien" + '</label><br>';
            x += '<label><input type=checkbox onchange=p20validateAddMeshUserDialog() id=p20wakedevices>' + "Geräte wecken" + '</label><br>';
            x += '<label><input type=checkbox onchange=p20validateAddMeshUserDialog() id=p20editnotes>' + "Geräte-Notizen bearbeiten" + '</label><br>';
            x += '<label><input type=checkbox onchange=p20validateAddMeshUserDialog() id=p20limitevents>' + "Nur eigene Ereignisse anzeigen" + '</label><br>';
            x += '<label><input type=checkbox onchange=p20validateAddMeshUserDialog() id=p20chatnotify>' + "Chat & Benachrichtigen" + '</label><br>';
            x += '<label><input type=checkbox onchange=p20validateAddMeshUserDialog() id=p20uninstall>' + "Agent deinstallieren" + '</label><br>';
            x += '<label><input type=checkbox onchange=p20validateAddMeshUserDialog() id=p20commands>' + "Remote-Befehle" + '</label><br>';
            x += '<label><input type=checkbox onchange=p20validateAddMeshUserDialog() id=p20resetoff>' + "Zurücksetzen / Ausschalten" + '</label><br>';
            x += '</div>';
            setDialogMode(2, "Benutzer zu Gerätegruppe hinzufügen", 3, p20showAddMeshUserDialogEx, x);
        ...
        function p20viewuser(userid) {
            ...
            if (meshrights == 0xFFFFFFFF) r.push("Gesamtadministrator"); else {
                if ((meshrights & 1) != 0) r.push("Gerätegruppe bearbeiten");
                if ((meshrights & 2) != 0) r.push("Gerätegruppen-Benutzer verwalten");
                if ((meshrights & 4) != 0) r.push("Gerätegruppen-Rechner verwalten");
                if ((meshrights & 8) != 0) r.push("Fernsteuerung");
                if ((meshrights & 16) != 0) r.push("Agent-Konsole");
                if ((meshrights & 32) != 0) r.push("Server-Dateien");
                if ((meshrights & 64) != 0) r.push("Geräte wecken");
                if ((meshrights & 128) != 0) r.push("Notizen bearbeiten");
                if ((meshrights & 256) != 0) r.push("Nur entfernte Ansicht");
                if ((meshrights & 512) != 0) r.push("Kein Terminal");
                if ((meshrights & 1024) != 0) r.push("Keine Dateien");
                if ((meshrights & 2048) != 0) r.push("Kein Intel&reg; AMT");
                if (((meshrights & 8) != 0) && ((meshrights & 4096) != 0) && ((meshrights & 256) == 0)) r.push("Eingeschränkte Eingabe");
                if ((meshrights & 8192) != 0) r.push("Nur eigene Ereignisse");
                if ((meshrights & 16384) != 0) r.push("Chat & Benachrichtigen");
                if ((meshrights & 32768) != 0) r.push("Deinstallation");
                if ((meshrights & 131072) != 0) r.push("Befehle");
                if ((meshrights & 262144) != 0) r.push("Zurücksetzen / Aus");
            }
            if (r.length == 0) { r.push("Keine Berechtigungen"); }
            var buttons = 1, uname = userid.split('/')[2];
            if (currentMesh.links[userid].name) { uname = currentMesh.links[userid].name; }
            var x = addHtmlValue("Benutzername", EscapeHtml(uname));
            if (uname != userid.split('/')[2]) { x += addHtmlValue("Benutzeridentifikation", EscapeHtml(userid.split('/')[2])); }
            x += addHtmlValue("Berechtigungen", r.join(", "));
            if (((userinfo._id) != userid) && (cmeshrights == 0xFFFFFFFF || (((cmeshrights & 2) != 0) && (meshrights != 0xFFFFFFFF)))) buttons += 4;
            setDialogMode(2, "Gerätegruppenbenutzer", buttons, p20viewuserEx, x, userid);
        }
        ...
        function p20viewuserEx(button, userid) {
            ...
            setDialogMode(2, "Entfernter Mesh-Benutzer", 3, p20viewuserEx2, format("Bestätigen Sie das Entfernen des Benutzers {0}?", uname), userid);
        }
        ...
        function drawNotifications() {
            ...
            if (notifications.length == 0) {
                r = '<div style=margin:5px>' + "Derzeit gibt es keine Benachrichtigungen" + '</div>';
            } else {
                for (var i in notifications) {
                    ...
                    r += '<div title="' + format("Aufgetreten am/um {0}", printDateTime(d)) + '" id="notifyx' + n.id + '" class=notification style="cursor:pointer;border-top:1px solid ' + ((r == '') ? 'transparent' : 'orange') + '">';
                    if (icon) { r += '<div class=j' + icon + ' onclick="notificationSelected(' + n.id + ')" style=margin:5px;float:left></div>'; }
                    r += '<div onclick="notificationDelete(' + n.id + ')" class=unselectable title="' + "Löschen Sie diese Benachrichtigung" + '" style=margin:5px;float:right;color:orange><b>X</b></div><div onclick="notificationSelected(' + n.id + ')" style=margin:5px>' + t + EscapeHtml(n.text) + '</div><div style=margin-left:5px;margin-bottom:5px;color:gray;font-size:10px>' + printDateTime(d) + '</div></div>';
                }
            }
            var deleteall = '';
            if (notifications.length > 1) { deleteall = '<div id="notifyRemoveAll" onclick="deleteAllNotifications()" style="cursor:pointer;border-top:1px solid orange;margin:5px;color:orange;text-align:right;padding-right:3px">' + "Alles leeren" + '</div>'; }
        ...
        function addNotification(n) {
            ...
            var translatedMessages = [
                ...
                "Ungültige E-Mail",
                "Ungültige Domain",
                "Ungültige Berechtigung der Seite",
                "Benutzer existiert bereits.",
                "In diesem Modus kann kein Benutzer hinzugefügt werden",
                "Validierungsausnahme",
                "Konten-Obergrenze erreicht.", // 10
                "Chat Anfrage, Drücken Sie hier zum annehmen.",
                "Seit der letzten Anmeldung sind {0} Anmeldeversuche für dieses Konto fehlgeschlagen.",
                "Fehler beim ändern der E-Mail-Adresse, diese wird bereits von einem anderen Konto verwendet: {0}.",
                "E-Mail gesendet.",
                "Benutzer {0} nicht gefunden",
                "Benutzer {0} nicht gefunden",
                "Fehler, Änderung zu einem zuvor verwendeten Passwort ist nicht möglich.",
                "Fehler, kann nicht zu häufig verwendeten Passwörtern geändert werden.",
                "Fehler, Passwort wurde nicht geändert.",
                "Passwort geändert.", // 20
                "Aktuelles Passwort ist nicht korrekt.",
                "Fehler, Einladungscode \"{0}\" wird bereits verwendet.",
                "SMS-Gateway nicht aktiviert",
                "Keine Benutzer Verwaltungsrechte",
                "Ungültige SMS Nachricht",
                "Keine Telefonnummer für diese Benutzer",
                "SMS erfolgreich gesendet.",
                "SMS Fehler",
                "SMS Fehler: {0}",
                "E-Mail domain \"{0}\" ist nicht erlaubt. Nur ({1}) ist erlaubt" // 30
            ];
