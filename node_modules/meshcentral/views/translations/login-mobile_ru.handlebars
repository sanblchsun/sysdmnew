<!DOCTYPE html><html dir="ltr" xmlns="http://www.w3.org/1999/xhtml"><head lang="en">
                            ...
                            <div id="loginpanel" style="background-color:#979797;border-radius:16px;width:260px;padding:16px;text-align:center;clear:both;display:none">
                                <form method="post">
                                    ...
                                    <table>
                                        ...
                                        <tr>
                                            <td><div id="showPassHintLink" style="display:none"><a onclick="showPassHint()" style="cursor:pointer">Показать подсказку</a></div></td>
                                    ...
                                    <div id="resetAccountDiv" style="display:none;padding:2px">
                                        <span id="resetAccountSpan">Забыли логин/пароль?</span> <a onclick="xgo(3)" style="cursor:pointer">Сбросить учетную запись</a>.
                                    </div>
                                    <div id="newAccountDiv" style="display:none;padding:2px">
                                        Нет учетной записи? <a onclick="xgo(2)" style="cursor:pointer">Создать</a>.
                                    </div>
                                    ...
                                    <div id="authStrategies" style="display:none">
                                        ...
                                        <a id="auth-twitter" href="auth-twitter" style="display:none"><img src="images/login/twitter32.png" width="32" height="32" style="margin-left:3px;margin-right:3px;border-radius:3px;box-shadow:2px 2px 5px black;cursor:pointer" title="Войти с помощью Twitter"></a>
                                        <a id="auth-google" href="auth-google" style="display:none"><img src="images/login/google32.png" width="32" height="32" style="margin-left:3px;margin-right:3px;border-radius:3px;box-shadow:2px 2px 5px black;cursor:pointer" title="Войти с помощью Google"></a>
                                        <a id="auth-github" href="auth-github" style="display:none"><img src="images/login/github32.png" width="32" height="32" style="margin-left:3px;margin-right:3px;border-radius:3px;box-shadow:2px 2px 5px black;cursor:pointer" title="Войти с помощью GitHub"></a>
                                        <a id="auth-azure" href="auth-azure" style="display:none"><img src="images/login/azure32.png" width="32" height="32" style="margin-left:3px;margin-right:3px;border-radius:3px;box-shadow:2px 2px 5px black;cursor:pointer" title="Войти с помощью Azure"></a>
                                        ...
                                        <a id="auth-jumpcloud" href="auth-jumpcloud" style="display:none"><img src="images/login/jumpcloud32.png" width="32" height="32" style="margin-left:3px;margin-right:3px;border-radius:3px;box-shadow:2px 2px 5px black;cursor:pointer" title="Войти с помощью JumpCloud"></a>
                                        <a id="auth-intel" href="auth-intel" style="display:none"><img src="images/login/intel32.png" width="32" height="32" style="margin-left:3px;margin-right:3px;border-radius:3px;box-shadow:2px 2px 5px black;cursor:pointer" title="Войти с помощью Intel"></a>
                                        <a id="auth-saml" href="auth-saml" style="display:none"><img src="images/login/generic32.png" width="32" height="32" style="margin-left:3px;margin-right:3px;border-radius:3px;box-shadow:2px 2px 5px black;cursor:pointer" title="Единый вход"></a>
                                    </div>
                                </form>
                            </div>
                                    ...
                                    <form method="post">
                                        ...
                                        <table>
                                            ...
                                            <tr id="createPanelHint" style="display:none">
                                                <td align="right">Подсказка пароля:</td>
                                            ...
                                            <tr id="newAccountPass" title="Введите токен создания аккаунта">
                                                <td align="right">Создание токена:</td>
                                        ...
                                        <hr><a onclick="xgo(1)" style="cursor:pointer">Обратно к экрану входа</a>
                                        ...
                                        <tr>
                                            <td colspan="2">
                                                ...
                                                <div style="float:right">
                                                    <input style="display:none;float:right" id="securityKeyButton" type="button" value="Используйте ключ безопасности" onclick="useSecurityKey()">
                                                    <input style="display:none;float:right" id="emailKeyButton" type="button" value="Email" onclick="useEmailToken()">
                                                    <input style="display:none;float:right" id="smsKeyButton" type="button" value="смс" onclick="useSMSToken()">
                                                </div>
                                            </td>
                                        </tr>
                                    </tbody></table>
        ...
        <div id="footer" style="height:32px;width:100%;text-align:center;background-color:#113962;position:absolute;bottom:0px">
            <table cellpadding="0" cellspacing="6" style="width:100%">
                <tbody><tr>
                    ...
                    <td style="text-align:right">{{{rootCertLink}}}&nbsp;<a href="terms">Условия и конфиденциальность</a></td>
                </tr>
            </tbody></table>
        </div>
    </div>
    ...
    <script>
        ...
        var okmessages = ['', "Если верно, сбросить отправленное письмо.", "Письмо отправлено.", "Требуется подтверждение по электронной почте, проверьте свой почтовый ящик и нажмите ссылку для подтверждения.", "SMS отправлено."];
        ...
        function useEmailToken() {
            ...
            setDialogMode(1, "Безопасный вход", 3, useEmailKeyEx, "Отправить токен на зарегистрированный адрес электронной почты?");
        }
        ...
        function useSMSToken() {
            ...
            setDialogMode(1, "Безопасный вход", 3, useSMSTokenEx, "Отправить токен на зарегистрированный номер телефона?");
        }
        ...
        function showPassHint() {
            if (passRequirements.hint === true) { messagebox("Подсказка пароля", passhint); }
        }
            ...
            if (Q('apassword1').value == '') {
                ...
                if (!passRequirementsEx) {
                    ...
                    if (passReq == false) {
                        ...
                        QH('passWarning', '<span style=color:red><b>' + "Политика пароля" + '</b><span>'); // TODO: Display problem hint
