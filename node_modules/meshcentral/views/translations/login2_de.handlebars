<!DOCTYPE html><html dir="ltr" xmlns="http://www.w3.org/1999/xhtml"><head lang="en">
    ...
    <table id="centralTable" class="container" style="height:100%;z-index:1">
            ...
            <td id="logincell">
                    ...
                    <form id="loginpanelform" method="post">
                        ...
                        <div id="loginuserpassdiv" style="display:none">
                            <table style="width:100%">
                                <tbody><tr>
                                    <td>
                                        <input id="username" title="Benutzername" style="box-sizing:border-box;width:280px;border:0;border-radius:4px;padding:8px;background-color:#FFF8CC" {{{autocomplete}}}="username" placeholder="Benutzername" type="text" maxlength="64" name="username" required="" onchange="validateLogin(1)" onkeyup="validateLogin(1,event)">
                                    </td>
                                </tr>
                                <tr>
                                    <td>
                                        <input id="password" title="Passwort" style="box-sizing:border-box;width:280px;border:0;border-radius:4px;padding:8px;background-color:#FFF8CC" {{{autocomplete}}}="current-password" placeholder="Passwort" type="password" maxlength="256" name="password" required="" onchange="validateLogin(2)" onkeyup="validateLogin(2,event)">
                                    </td>
                                </tr>
                                <tr>
                                    <td>
                                        <div id="showPassHintLink" title="Passwort-Tipp" style="box-sizing:border-box;width:280px;border:0;border-radius:4px;padding:8px;background-color:#FFF8CC;display:none"><a onclick="return showPassHint(event);" href="#" style="cursor:pointer">Hinweis anzeigen</a></div>
                                    </td>
                                </tr>
                                <tr>
                                    <td>
                                        <input id="loginButton" style="box-sizing:border-box;width:280px;border:0;border-radius:4px;padding:6px" onclick="submitButtonClicked('loginpanelform')" type="button" value="Anmelden">
                                    </td>
                                </tr>
                            ...
                            <div id="resetAccountDiv" style="display:none;padding:2px">
                                <span id="resetAccountSpan">Benutzername/Passwort vergessen?</span> <a onclick="return xgo(3,event);" href="#" style="cursor:pointer">Konto zurücksetzen</a>.
                            </div>
                            <div id="newAccountDiv" style="display:none;padding:2px;padding-top:10px">
                                Sie haben kein Konto? <a onclick="return xgo(2,event);" href="#" style="cursor:pointer">Erstelle eines</a>.
                            </div>
                        </div>
                        ...
                        <div id="authStrategies" style="display:none">
                            ...
                            <div style="margin-bottom:8px">Melden Sie sich mit einem vorhandenen Konto an</div>
                            <a id="auth-twitter" href="auth-twitter" style="display:none"><img src="images/login/twitter32.png" srcset="images/login/twitter64.png 2x" width="32" height="32" style="margin-left:3px;margin-right:3px;border-radius:3px;box-shadow:2px 2px 5px black;cursor:pointer" title="Melden Sie sich über Twitter an"></a>
                            <a id="auth-google" href="auth-google" style="display:none"><img src="images/login/google32.png" srcset="images/login/google64.png 2x" width="32" height="32" style="margin-left:3px;margin-right:3px;border-radius:3px;box-shadow:2px 2px 5px black;cursor:pointer" title="Melden Sie sich mit Google an"></a>
                            <a id="auth-github" href="auth-github" style="display:none"><img src="images/login/github32.png" srcset="images/login/github64.png 2x" width="32" height="32" style="margin-left:3px;margin-right:3px;border-radius:3px;box-shadow:2px 2px 5px black;cursor:pointer" title="Melden Sie sich mit GitHub an"></a>
                            <a id="auth-azure" href="auth-azure" style="display:none"><img src="images/login/azure32.png" srcset="images/login/azure64.png 2x" width="32" height="32" style="margin-left:3px;margin-right:3px;border-radius:3px;box-shadow:2px 2px 5px black;cursor:pointer" title="Melden Sie sich mit Azure an"></a>
                            <a id="auth-oidc" href="auth-oidc" style="display:none"><img src="images/login/oidc32.png" srcset="images/login/oidc64.png 2x" width="32" height="32" style="margin-left:3px;margin-right:3px;border-radius:3px;box-shadow:2px 2px 5px black;cursor:pointer" title="Melden Sie sich mit OpenID an"></a>
                            ...
                            <a id="auth-jumpcloud" href="auth-jumpcloud" style="display:none"><img src="images/login/jumpcloud32.png" srcset="images/login/jumpcloud64.png 2x" width="32" height="32" style="margin-left:3px;margin-right:3px;border-radius:3px;box-shadow:2px 2px 5px black;cursor:pointer" title="Melden Sie sich mit JumpCloud an"></a>
                            <a id="auth-intel" href="auth-intel" style="display:none"><img src="images/login/intel32.png" srcset="images/login/intel64.png 2x" width="32" height="32" style="margin-left:3px;margin-right:3px;border-radius:3px;box-shadow:2px 2px 5px black;cursor:pointer" title="Melden Sie sich mit Intel an"></a>
                    ...
                    <form id="createpanelform" method="post">
                        ...
                        <table>
                            <tbody><tr id="nuUserRow">
                                <td id="nuUser" align="right" width="100">Benutzername:</td>
                            ...
                            <tr>
                                <td id="nuPass1" align="right">Passwort:</td>
                            ...
                            <tr>
                                <td id="nuPass2" align="right">Passwort:</td>
                            ...
                            <tr id="createPanelHint" style="display:none">
                                <td id="nuHint" align="right">Passwort-Tipp:</td>
                            ...
                            <tr id="newAccountPass" title="Geben Sie das Kontoerstellungstoken ein">
                                <td id="nuToken" align="right">Erzeugungs-Token:</td>
                            ...
                            <tr id="newAccountCaptchaImg" title="CAPTCHA Bild">
                                <td></td>
                                <td colspan="2"><img src="{{{newAccountCaptchaImage}}}"></td>
                            </tr>
                            <tr id="newAccountCaptcha" title="Sicherheitsprüfung">
                                <td id="nuCaptcha" align="right">Sicherheitsprüfung:</td>
                            ...
                            <tr>
                                <td colspan="2">
                                    <div style="float:right"><input id="createButton" type="button" onclick="submitButtonClicked('createpanelform')" value="Konto erstellen" disabled="disabled"></div>
                                    <div id="passWarning" style="padding-top:6px"></div>
                                </td>
                            </tr>
                        </tbody></table>
                        <hr><a onclick="return xgo(1,event);" href="#" style="cursor:pointer">Zurück zur Anmeldung</a>
                ...
                <div id="resetpanel" style="display:none">
                    <form id="resetpanelform" method="post">
                        ...
                        <table style="width:100%;margin-top:4px;margin-bottom:4px">
                            ...
                            <tr>
                                <td>
                                    <input id="eresetButton" style="box-sizing:border-box;width:280px;border:0;border-radius:4px;padding:6px" type="button" onclick="submitButtonClicked('resetpanelform')" value="Konto zurücksetzen" disabled="disabled">
                                </td>
                            </tr>
                        </tbody></table>
                        <hr><a onclick="return xgo(1,event);" href="#" style="cursor:pointer">Zurück zur Anmeldung</a>
                    ...
                    <form id="tokenpanelform" method="post" {{{autocomplete}}}="off">
                        ...
                        <table style="width:100%">
                            ...
                            <tr>
                                <td>
                                    <div>
                                        <input id="tokenOkButton" style="box-sizing:border-box;width:280px;border:0;border-radius:4px;padding:6px" type="button" onclick="submitButtonClicked('tokenpanelform')" value="Anmelden" disabled="disabled">
                                    </div>
                                </td>
                            </tr>
                            <tr>
                            ...
                            <tr id="2farow">
                                <td>
                                    ...
                                    <div>
                                        ...
                                        <img id="msgKeyButton" src="images/login/2fa-messaging-48.png" srcset="images/login/2fa-messaging-96.png 2x" title="Benachrichtigung" width="48" height="48" style="display:none;margin-left:3px;margin-right:3px;border-radius:3px;box-shadow:2px 2px 5px black;cursor:pointer;background-color:#FFF" onclick="useMsgToken(1)">
                                        ...
                                        <img id="pushKeyButton" src="images/login/2fa-push-48.png" srcset="images/login/2fa-push-96.png 2x" title="Geräteauthentifizierung" width="48" height="48" style="display:none;margin-left:3px;margin-right:3px;border-radius:3px;box-shadow:2px 2px 5px black;cursor:pointer;background-color:#FFF" onclick="usePushToken(1)">
                    ...
                    <form id="resettokenpanelform" method="post">
                        ...
                        <table style="width:100%">
                            ...
                            <tr>
                                <td>
                                    <div>
                                        <input id="resetTokenOkButton" style="box-sizing:border-box;width:280px;border:0;border-radius:4px;padding:6px" type="button" onclick="submitButtonClicked('resettokenpanelform')" value="Anmelden" disabled="disabled">
                                    </div>
                                </td>
                            </tr>
                            <tr id="2farow2">
                                <td colspan="2">
                                    ...
                                    <div>
                                        ...
                                        <img id="msgKeyButton2" src="images/login/2fa-messaging-48.png" srcset="images/login/2fa-messaging-96.png 2x" title="Benachrichtigung" width="48" height="48" style="display:none;margin-left:3px;margin-right:3px;border-radius:3px;box-shadow:2px 2px 5px black;cursor:pointer;background-color:#FFF" onclick="useMsgToken(2)">
                                        ...
                                        <img id="pushKeyButton2" src="images/login/2fa-push-48.png" srcset="images/login/2fa-push-96.png 2x" title="Geräteauthentifizierung" width="48" height="48" style="display:none;margin-left:3px;margin-right:3px;border-radius:3px;box-shadow:2px 2px 5px black;cursor:pointer;background-color:#FFF" onclick="usePushToken(2)">
                ...
                <div id="resetpasswordpanel" style="display:none;position:relative">
                    <form id="resetpasswordpanelform" method="post">
                        ...
                        <table>
                            <tbody><tr>
                                <td id="rnuPass1" width="100" align="right">Passwort:</td>
                            ...
                            <tr>
                                <td id="rnuPass2" align="right">Passwort:</td>
                            ...
                            <tr id="resetpasswordpanelHint" style="display:none">
                                <td id="rnuHint" align="right">Passwort-Tipp:</td>
                            ...
                            <tr>
                                <td colspan="2">
                                    <div style="float:right"><input id="resetPassButton" type="button" onclick="submitButtonClicked('resetpasswordpanelform')" value="Passwort zurücksetzen" disabled="disabled"></div>
                    ...
                    <form id="checkemailpanelform" method="post">
                        ...
                        <table id="checkCheckOperations" style="width:100%;display:none">
                            ...
                            <tr>
                                <td>
                                    <div>
                                        <input id="changeEmailButton" type="button" value="E-Mail Adresse ändern" onclick="changeEmailAddress()">
                                        <input id="checkEmailButton2" type="button" value="Bestätigungsmail erneut senden" onclick="resentEmailConfirmation()">
        ...
        <tr style="height:20px">
            <td>
                <div>
                    <div id="flink" style="float:right;margin-right:4px;color:#c8c8c8">{{{rootCertLink}}}&nbsp;<a href="terms">Nutzungsbedingungen &amp; Datenschutz</a></div>
    ...
    <script>
        ...
        function startup() {
            ...
            var okmessages = ['', "Falls gültig, gesendete E-Mail zurücksetzen.", "E-Mail gesendet.", "E-Mail-Bestätigung erforderlich, überprüfen Sie Ihre Mailbox und klicken Sie auf den Bestätigungslink.", "SMS gesendet.", "Benachrichtigung wird gesendet...", "Nachricht gesendet."];
            var failmessages = ["Konto kann nicht anlegen werden", "Konten-Obergrenze erreicht.", "Bestehendes Konto mit dieser E-Mail-Adresse.", "Ungültiges Kontoerstellungstoken.", "Benutzername existiert bereits.", "Passwort abgelehnt, verwenden Sie ein anderes.", "Ungültige E-Mail.", "Konto nicht gefunden.", "Ungültiges Token, versuchen Sie es erneut.", "E-Mail kann nicht gesendet werden.", "Konto gesperrt.", "Zugriff verweigert.", "Anmeldung fehlgeschlagen, Benutzername und Passwort prüfen.", "Passwortänderung angefragt.", "IP-Adresse gesperrt, versuchen Sie es später erneut.", "Server in Wartung.", "Gerätebenachrichtigung kann nicht gesendet werden.", "Ungültiger Sicherheitscheck"];
            if (messageid > 0) {
                var msg = '';
            ...
            if (twoFactorCookieDays > 0) {
                ...
                QH('tokenInputRememberSpan', format("Erinnern Sie sich an dieses Gerät für {0} Tage.", twoFactorCookieDays));
                QV('tokenInputRememberLabel2', true);
                QH('tokenInputRememberSpan2', format("Erinnern Sie sich an dieses Gerät für {0} Tage.", twoFactorCookieDays));
            } else {
            ...
            if (features & 0x200000) { // Email is username
                ...
                QH('resetAccountSpan', "Passwort vergessen?");
                QV('nuUserRow', false);
            }
            ...
            if (loginMode == '8') {
                ...
                websocket.onmessage = function (e) {
                    ...
                    if (r.sent === true) {
                        // Request was sent
                        QH('message8', '<span class="msg success"><b>' + format("Anfrage gesendet, {0}.", r.code) + '</b></span><br /><br />');
                    } else if (r.sent === false) {
                        // Request failed to send
                        QH('message8', '<span class="msg error"><b style=color:#8C001A>' + "Anfrage konnte nicht gesendet werden." + '<b></span><br /><br />');
                        QV('tokenInputRememberLabel2', false);
                        this.close();
                        ...
                        this.close();
                        QV('tokenInputRememberLabel2', false);
                        QH('message8', '<span class="msg success"><b>' + "Anfrage akzeptiert." + '</b></span><br /><br />');
                        Q('pushtokenInput').value = r.token;
                        Q('pushOkButton').click();
                    } else {
                        // Request rejected
                        QH('message8', '<span class="msg error"><b style=color:#8C001A>' + "Zugriff abgelehnt." + '<b></span><br /><br />');
                        QV('tokenInputRememberLabel2', false);
                        this.close();
                    }
                }
                ...
                websocket.onerror = function (e) {
                    QH('message8', '<span class="msg error"><b style=color:#8C001A>' + "Verbindungsfehler" + '<b></span><br /><br />');
        ...
        function useEmailToken(panelAction) {
            ...
            setDialogMode(1, "Sicherheits Login", 3, useEmailKeyEx, "Token an registrierte E-Mail-Adresse senden?", panelAction);
        }
        ...
        function useSMSToken(panelAction) {
            ...
            setDialogMode(1, "Sicherheits Login", 3, useSMSTokenEx, "Token an registrierte Telefonnummer senden?", panelAction);
        }
        ...
        function useMsgToken(panelAction) {
            ...
            setDialogMode(1, "Sicherheits Login", 3, useMsgTokenEx, "Token an Nachrichten-App senden?", panelAction);
        }
        ...
        function showPassHint(e) {
            messagebox("Passwort-Tipp", passhint);
            haltEvent(e);
            return false;
        }
        ...
        function validateCreate(box, e) {
            ...
            if (Q('apassword1').value == '') {
                ...
                if (!passRequirementsEx) {
                    ...
                    if (passStrength >= 80) { QH('passWarning', '<span style=color:green><b>' + "Starkes Passwort" + '</b><span>'); }
                    else if (passStrength >= 60) { QH('passWarning', '<span style=color:blue><b>' + "Gutes Passwort" + '</b><span>'); }
                    else { QH('passWarning', '<span style=color:red><b>' + "Schwaches Passwort" + '</b><span>'); }
                } else {
                    ...
                    if (passReq == false) {
                        ...
                        QH('passWarning', '<div style=color:red;cursor:pointer onclick=showPasswordPolicy()><b>' + "Passwort-Richtlinie" + '</b><div>'); // This is also a link to the password policy
        ...
        function validatePassReset(box, e) {
            ...
            if (Q('rapassword1').value == '') {
                ...
                if (!passRequirementsEx) {
                    ...
                    if (passStrength >= 80) { QH('rpassWarning', '<span style=color:green><b>' + "Starkes Passwort" + '</b><span>'); }
                    else if (passStrength >= 60) { QH('rpassWarning', '<span style=color:blue><b>' + "Gutes Passwort" + '</b><span>'); }
                    else { QH('rpassWarning', '<span style=color:red><b>' + "Schwaches Passwort" + '</b><span>'); }
                } else {
                    // Password requirements provided, use that
                    ...
                    if (passReq == false) {
                        ...
                        QH('rpassWarning', '<div style=color:red;cursor:pointer onclick=showPasswordPolicy()><b>' + "Passwort-Richtlinie" + '</b><div>'); // This is also a link to the password policy
        ...
        function passwordPolicyText(pass) {
            ...
            if (passRequirements.min && ((pass == null) || (pass.length < passRequirements.min))) { policy += format("Mindestlänge von {0}", passRequirements.min) + '<br />'; }
            if (passRequirements.max && ((pass == null) || (pass.length > passRequirements.max))) { policy += format("Maximale Länge von {0}", passRequirements.max) + '<br />'; }
            if (passRequirements.upper && ((pass == null) || (counts.upper < passRequirements.upper))) { policy += format("{0} Großbuchstaben", passRequirements.upper) + '<br />'; }
            if (passRequirements.lower && ((pass == null) || (counts.lower < passRequirements.lower))) { policy += format("{0} Kleinbuchstaben", passRequirements.lower) + '<br />'; }
            if (passRequirements.numeric && ((pass == null) || (counts.numeric < passRequirements.numeric))) { policy += format("{0} numerisch", passRequirements.numeric) + '<br />'; }
            if (passRequirements.nonalpha && ((pass == null) || (counts.nonalpha < passRequirements.nonalpha))) { policy += format("{0} nicht-alphanumerisch", passRequirements.nonalpha) + '<br />'; }
            policy += '</div>';
            return policy;
        }

        function showPasswordPolicy() {
            messagebox("Passwort-Richtlinie", passwordPolicyText());
        }
        ...
        function changeEmailAddress() {
            ...
            setDialogMode(1, "E-Mail Bestätigung", 3, changeEmailAddressEx, x);
