        ...
        <div id="column_l" style="overflow-y:auto">
            ...
            <div>
                <div class="tab">
                    ...
                    <button id="tlinuxbinarytab" class="tablinks" onclick="openTab(event, 'linuxbinarytab')">लिनक्स / बीएसडी / मैकओएस बाइनरी इंस्टॉलर</button>
                    <button id="tmacostab64" class="tablinks" onclick="openTab(event, 'macostab64')">मैकओएस x86-64 बिट</button>
                    <button id="tmacostabarm64" class="tablinks" onclick="openTab(event, 'macostabarm64')">macOS ARM (64 बिट)</button>
                ...
                <div id="macostab64" class="tabcontent" style="background-color:white;color:black">
                    ...
                    <p><a id="macos64url">यहां इंस्टॉलर डाउनलोड करें</a>, उस पर क्लिक करें या "नियंत्रण" दबाएं और फ़ाइल पर क्लिक करें। फिर "ओपन" चुनें और निर्देशों का पालन करें।</p>
                    <div style="text-align:center">
                ...
                <div id="macostabarm64" class="tabcontent" style="background-color:white;color:black">
                    ...
                    <p><a id="macosarm64url">यहां इंस्टॉलर डाउनलोड करें</a>, उस पर क्लिक करें या "नियंत्रण" दबाएं और फ़ाइल पर क्लिक करें। फिर "ओपन" चुनें और निर्देशों का पालन करें।</p>
                    <div style="text-align:center">
