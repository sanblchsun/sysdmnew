<!DOCTYPE html><html dir="ltr" xmlns="http://www.w3.org/1999/xhtml"><head lang="en">
    ...
    <div id="termShellContextMenu" class="contextMenu noselect" style="display:none;min-width:0px">
        <div id="cxtermnorm" class="cmtext" onclick="cmtermaction(1,event)"><b>Console amministrativa</b></div>
        <div id="cxtermps" class="cmtext" onclick="cmtermaction(6,event)">Credenziali di amministratore PowerShell</div>
        <div id="cxtermunorm" class="cmtext" onclick="cmtermaction(8,event)">Shell utente </div>
        <div id="cxtermups" class="cmtext" onclick="cmtermaction(9,event)">PowerShell Utente </div>
    </div>
    <div id="termShellContextMenuLinux" class="contextMenu noselect" style="display:none;min-width:0px">
        ...
        <div id="cxtermps" class="cmtext" onclick="cmtermaction(8,event)">Shell utente </div>
        <div id="cxtermps" class="cmtext" onclick="cmtermaction(100,event)">Shell di accesso</div>
    </div>
