<!DOCTYPE html><html lang="pl"><head>
    ...
    <div id="container">
        ...
        <div id="column_l" style="overflow-y:auto">
            <h1><span id="groupname">Zdalna Instalacja Agenta</span></h1>
            <p>
            ...
            <div>
                <div class="tab">
                    ...
                    <button id="tlinuxbinarytab" class="tablinks" onclick="openTab(event, 'linuxbinarytab')">Instalator Binarny Linux / BSD / macOS</button>
                    ...
                    <button id="tassistab" class="tablinks" onclick="openTab(event, 'assistab')">Asystent</button>
                </div>

                <div id="wintab64" class="tabcontent" style="background-color:white;color:black">
                    <h3>Microsoft™ Windows 64-bitowy</h3>
                    <p><a id="win64url">Pobierz oprogramowanie tutaj</a>, Uruchom i naciśnij "Install" lub "Connect".</p>
                ...
                <div id="wintab32" class="tabcontent" style="background-color:white;color:black">
                    <h3>Microsoft™ Windows 32-bitowy</h3>
                    <p><a id="win32url">Pobierz oprogramowanie tutaj</a>, Uruchom i naciśnij "Install" lub "Connect".</p>
                    <div style="text-align:center">
                ...
                <div id="wintabarm64" class="tabcontent" style="background-color:white;color:black">
                    ...
                    <p><a id="winarm64url">Pobierz oprogramowanie tutaj</a>, Uruchom i naciśnij "Install" lub "Connect".</p>
                    <div style="text-align:center">
                ...
                <div id="linuxtab" class="tabcontent" style="background-color:white;color:black">
                    <h3>Linux</h3>
                    <p>Aby zainstalować, wytnij i wklej następujące polecenie w terminalu roota.</p>
                    <div id="linuxinstall" style="font-family:courier,'courier new',monospace;margin-left:30px"></div>
                    <input type="button" value="Kopiuj do schowka" style="margin-left:30px;margin-top:4px" onclick="copyToClipLinuxInstall()">
                    <p>Aby odinstalować, wytnij i wklej następujące polecenie jako root.</p>
                    <div id="unlinuxinstall" style="font-family:courier,'courier new',monospace;margin-left:30px"></div>
                    <input type="button" value="Kopiuj do schowka" style="margin-left:30px;margin-top:4px" onclick="copyToClipLinuxUnInstall()">
                    <br><br>
                </div>
                ...
                <div id="macostab64" class="tabcontent" style="background-color:white;color:black">
                    ...
                    <p><a id="macos64url">Pobierz instalator tutaj</a>, kliknij na nim prawym przyciskiem myszy lub naciśnij "control" i kliknij na plik. Następnie wybierz "Otwórz" i postępuj zgodnie z instrukcjami.</p>
                    <div style="text-align:center">
                ...
                <div id="macostabarm64" class="tabcontent" style="background-color:white;color:black">
                    ...
                    <p><a id="macosarm64url">Pobierz instalator tutaj</a>, kliknij na nim prawym przyciskiem myszy lub naciśnij "control" i kliknij na plik. Następnie wybierz "Otwórz" i postępuj zgodnie z instrukcjami.</p>
                    <div style="text-align:center">
                ...
                <div id="macostab" class="tabcontent" style="background-color:white;color:black">
                    ...
                    <p><a id="macosurl">Pobierz instalator tutaj</a>, kliknij na nim prawym przyciskiem myszy lub naciśnij "control" i kliknij na plik. Następnie wybierz "Otwórz" i postępuj zgodnie z instrukcjami.</p>
                    <div style="text-align:center">
                ...
                <div id="androtab" class="tabcontent" style="background-color:white;color:black">
                    ...
                    <div style="min-height:220px">
                        <p>Pobierz oprogramowanie agenta za pomocą sklepu Google Play lub pliku APK, zainstaluj go i użyj kodu QR po prawej stronie lub poniższego linku parowania, aby skonfigurować swoje urządzenie na tym serwerze.</p>
                        <p>
                        ...
                        <p>
                            <a id="androidurl">Pobieranie Android APK</a>
                        </p>
                        <p>
                            <a rel="noreferrer noopener" target="_blank" href="{{{magenturl}}}">Link Parowania Serwera</a>
                        </p>
                    </div>
                </div>
                ...
                <div id="assistab" class="tabcontent" style="background-color:white;color:black">
                    ...
                    <div style="min-height:220px">
                        ...
                        <p>Asystent jest narzędziem w zasobniku systemowym Windows, które może być użyte, gdy potrzebna jest pomoc. Nie jest to agent, który działa w tle komputera zarządzanego, lecz narzędzie, które łączy się z serwerem tylko wtedy gdy jest to wymagane.</p>
                        <p>
                            <a id="assisturl" rel="noreferrer noopener" target="_blank">Pobierz Asystenta dla Windows</a>
                        </p>
                    </div>
                    <br style="clear:both">
                </div>
    ...
    <script>
        ...
        function startup() {
            ...
            if (groupName != '') {
                QH('groupname', format("Zdalna Instalacja Agenta dla {0}", escapeHtml(groupName)));
                document.title = format("{0} - Instalacja Agenta", groupName);
            } else {
                document.title = "Instalacja Agenta";
            }
        ...
        function linuxBinarySetup() {
            var x = '<h3>' + "Instalator Binarny Linux / BSD / macOS" + '</h3>', moreoptions = '';
            var opts = '<select id=aginsSelect onchange=addAgentToMeshClick() style=width:236px>';
            opts += '<option value=5 selected>' + "Instalator Binarny Linux / BSD / macOS" + '</option>';
            opts += '</select>';
            ...
            x += addHtmlValue("Typ Systemu", '<select id=aginsSysType onchange=addAgentToMeshClick() style=width:236px>' + moreoptions + '</select>');
            x += '</div>';
            x += '<div id=aginsTypeDiv>';
            x += addHtmlValue("Typ Instalacji", '<select id=aginsType onchange=addAgentToMeshClick() style=width:236px><option value=0>' + "W tle lub interaktywnie" + '</option><option value=2>' + "Tylko w tle" + '</option><option value=1>' + "Tylko interaktywny" + '</option></select>');
            x += '</div><hr>';
            ...
            x += addHtmlValue("Agent", '<a id=aginsbinlnk name="meshagents?id=' + meshid + '&installflags=0' + (urlargs.key?('&key=' + urlargs.key):'') + '">' + "meshagent" + '</a> <img src=images/link4.png height=10 width=10 title="' + "Skopiuj adres URL agenta do schowka" + '" style=cursor:pointer onclick=copyAgentUrl("meshagents?id=' + meshid + '&installflags=",1)>');
            x += addHtmlValue("Komenda", '<input id=aginsbincmd type=text style="width:216px" readonly value=\'wget -O meshagent ' + ((serverNoProxy != 0) ?'--no-proxy':'') + ' --no-check-certificate \"https://' + servername + portStr + domainUrl + 'meshagents?id=' + meshid.split('$').join('%24').split('@').join('%40') + '\' /> <img src=images/link4.png height=10 width=10 title="' + "Skopiuj adres URL agenta do schowka" + '" style=cursor:pointer onclick=copyAgentIdValue("aginsbincmd")>');
            x += '</div>';
            QH('linuxbinarytab', x);
            addAgentToMeshClick();
        }
