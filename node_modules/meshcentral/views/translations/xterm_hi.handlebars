<!DOCTYPE html><html dir="ltr" xmlns="http://www.w3.org/1999/xhtml"><head lang="en">
    ...
    </head><body style="overflow:hidden;background-color:black" oncontextmenu="handleContextMenu(event)">{{{customCSSTags}}}
    ...
    <div id="termShellContextMenu" class="contextMenu noselect" style="display:none;min-width:0px">
        <div id="cxtermnorm" class="cmtext" onclick="cmtermaction(1,event)"><b>व्यवस्थापक शेल</b></div>
        <div id="cxtermps" class="cmtext" onclick="cmtermaction(6,event)">व्यवस्थापक PowerShell</div>
        <div id="cxtermunorm" class="cmtext" onclick="cmtermaction(8,event)">उपयोगकर्ता शेल</div>
        <div id="cxtermups" class="cmtext" onclick="cmtermaction(9,event)">उपयोगकर्ता पॉवरशेल</div>
    </div>
    <div id="termShellContextMenuLinux" class="contextMenu noselect" style="display:none;min-width:0px">
        <div id="cxtermnorm" class="cmtext" onclick="cmtermaction(1,event)"><b>जड़ शैल</b></div>
        <div id="cxtermps" class="cmtext" onclick="cmtermaction(8,event)">उपयोगकर्ता शेल</div>
        <div id="cxtermps" class="cmtext" onclick="cmtermaction(100,event)">लॉग इन शेल</div>
    </div>
