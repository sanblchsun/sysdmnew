<!DOCTYPE html><html dir="ltr" xmlns="http://www.w3.org/1999/xhtml"><head lang="en">
    ...
    <table id="centralTable" class="container" style="height:100%;z-index:1">
            ...
            <td id="logincell">
                    ...
                    <form id="loginpanelform" method="post">
                        ...
                        <div id="loginuserpassdiv" style="display:none">
                            <table style="width:100%">
                                <tbody><tr>
                                    <td>
                                        <input id="username" title="Nazwa użytkownika" style="box-sizing:border-box;width:280px;border:0;border-radius:4px;padding:8px;background-color:#FFF8CC" {{{autocomplete}}}="username" placeholder="Nazwa użytkownika" type="text" maxlength="64" name="username" required="" onchange="validateLogin(1)" onkeyup="validateLogin(1,event)">
                                    </td>
                                </tr>
                                <tr>
                                    <td>
                                        <input id="password" title="Hasło" style="box-sizing:border-box;width:280px;border:0;border-radius:4px;padding:8px;background-color:#FFF8CC" {{{autocomplete}}}="current-password" placeholder="Hasło" type="password" maxlength="256" name="password" required="" onchange="validateLogin(2)" onkeyup="validateLogin(2,event)">
                                    </td>
                                </tr>
                                <tr>
                                    <td>
                                        <div id="showPassHintLink" title="Podpowiedź do Hasła" style="box-sizing:border-box;width:280px;border:0;border-radius:4px;padding:8px;background-color:#FFF8CC;display:none"><a onclick="return showPassHint(event);" href="#" style="cursor:pointer">Pokaż Podpowiedź</a></div>
                                    </td>
                                </tr>
                                <tr>
                                    <td>
                                        <input id="loginButton" style="box-sizing:border-box;width:280px;border:0;border-radius:4px;padding:6px" onclick="submitButtonClicked('loginpanelform')" type="button" value="Zaloguj">
                                    </td>
                                </tr>
                            ...
                            <div id="resetAccountDiv" style="display:none;padding:2px">
                                <span id="resetAccountSpan">Zapomniałeś nazwy użytkownika/hasła?</span> <a onclick="return xgo(3,event);" href="#" style="cursor:pointer">Reset konta</a>.
                            </div>
                            <div id="newAccountDiv" style="display:none;padding:2px;padding-top:10px">
                                Nie masz konta? <a onclick="return xgo(2,event);" href="#" style="cursor:pointer">Utwórz nowe</a>.
                            </div>
                        </div>
                        ...
                        <div id="authStrategies" style="display:none">
                            ...
                            <div style="margin-bottom:8px">Zalogowanie używając istniejącego konta</div>
                            <a id="auth-twitter" href="auth-twitter" style="display:none"><img src="images/login/twitter32.png" srcset="images/login/twitter64.png 2x" width="32" height="32" style="margin-left:3px;margin-right:3px;border-radius:3px;box-shadow:2px 2px 5px black;cursor:pointer" title="Zaloguj się używając Twitter"></a>
                            <a id="auth-google" href="auth-google" style="display:none"><img src="images/login/google32.png" srcset="images/login/google64.png 2x" width="32" height="32" style="margin-left:3px;margin-right:3px;border-radius:3px;box-shadow:2px 2px 5px black;cursor:pointer" title="Zaloguj się używając Google"></a>
                            <a id="auth-github" href="auth-github" style="display:none"><img src="images/login/github32.png" srcset="images/login/github64.png 2x" width="32" height="32" style="margin-left:3px;margin-right:3px;border-radius:3px;box-shadow:2px 2px 5px black;cursor:pointer" title="Zaloguj się używając GitHub"></a>
                            <a id="auth-azure" href="auth-azure" style="display:none"><img src="images/login/azure32.png" srcset="images/login/azure64.png 2x" width="32" height="32" style="margin-left:3px;margin-right:3px;border-radius:3px;box-shadow:2px 2px 5px black;cursor:pointer" title="Zaloguj się używając Azure"></a>
                            <a id="auth-oidc" href="auth-oidc" style="display:none"><img src="images/login/oidc32.png" srcset="images/login/oidc64.png 2x" width="32" height="32" style="margin-left:3px;margin-right:3px;border-radius:3px;box-shadow:2px 2px 5px black;cursor:pointer" title="Zaloguj używając OpenID Connect"></a>
                            ...
                            <a id="auth-jumpcloud" href="auth-jumpcloud" style="display:none"><img src="images/login/jumpcloud32.png" srcset="images/login/jumpcloud64.png 2x" width="32" height="32" style="margin-left:3px;margin-right:3px;border-radius:3px;box-shadow:2px 2px 5px black;cursor:pointer" title="Zaloguj się używając JimpCloud"></a>
                            <a id="auth-intel" href="auth-intel" style="display:none"><img src="images/login/intel32.png" srcset="images/login/intel64.png 2x" width="32" height="32" style="margin-left:3px;margin-right:3px;border-radius:3px;box-shadow:2px 2px 5px black;cursor:pointer" title="Zaloguj się używając Intel"></a>
                            <a id="auth-saml" href="auth-saml" style="display:none"><img src="images/login/generic32.png" srcset="images/login/generic64.png 2x" width="32" height="32" style="margin-left:3px;margin-right:3px;border-radius:3px;box-shadow:2px 2px 5px black;cursor:pointer" title="Pojedyncze Logowanie"></a>
                        </div>
                    </form>
                </div>
                    ...
                    <form id="createpanelform" method="post">
                        ...
                        <table>
                            <tbody><tr id="nuUserRow">
                                <td id="nuUser" align="right" width="100">Nazwa użytkownika:</td>
                            ...
                            <tr>
                                <td id="nuPass1" align="right">Hasło:</td>
                            ...
                            <tr>
                                <td id="nuPass2" align="right">Hasło:</td>
                            ...
                            <tr id="createPanelHint" style="display:none">
                                <td id="nuHint" align="right">Podpowiedź do Hasła:</td>
                            ...
                            <tr id="newAccountPass" title="Wprowadź token tworzenia konta">
                                <td id="nuToken" align="right">Token Utworzenia:</td>
                            ...
                            <tr id="newAccountCaptchaImg" title="Obraz CAPTCHA">
                                <td></td>
                                <td colspan="2"><img src="{{{newAccountCaptchaImage}}}"></td>
                            </tr>
                            <tr id="newAccountCaptcha" title="Walidacja bezpieczeństwa">
                                <td id="nuCaptcha" align="right">Walidacja Bezpieczeństwa:</td>
                            ...
                            <tr>
                                <td colspan="2">
                                    <div style="float:right"><input id="createButton" type="button" onclick="submitButtonClicked('createpanelform')" value="Utwórz Konto" disabled="disabled"></div>
                                    <div id="passWarning" style="padding-top:6px"></div>
                                </td>
                            </tr>
                        </tbody></table>
                        <hr><a onclick="return xgo(1,event);" href="#" style="cursor:pointer">Powrót do logowania</a>
                ...
                <div id="resetpanel" style="display:none">
                    <form id="resetpanelform" method="post">
                        ...
                        <table style="width:100%;margin-top:4px;margin-bottom:4px">
                            ...
                            <tr>
                                <td>
                                    <input id="eresetButton" style="box-sizing:border-box;width:280px;border:0;border-radius:4px;padding:6px" type="button" onclick="submitButtonClicked('resetpanelform')" value="Reset Konta" disabled="disabled">
                                </td>
                            </tr>
                        </tbody></table>
                        <hr><a onclick="return xgo(1,event);" href="#" style="cursor:pointer">Powrót do logowania</a>
                    ...
                    <form id="tokenpanelform" method="post" {{{autocomplete}}}="off">
                        ...
                        <table style="width:100%">
                            ...
                            <tr>
                                <td>
                                    <div>
                                        <input id="tokenOkButton" style="box-sizing:border-box;width:280px;border:0;border-radius:4px;padding:6px" type="button" onclick="submitButtonClicked('tokenpanelform')" value="Zaloguj" disabled="disabled">
                                    </div>
                                </td>
                            </tr>
                            <tr>
                            ...
                            <tr id="2farow">
                                <td>
                                    <hr>
                                    <div>
                                        <img id="securityKeyButton" src="images/login/2fa-key-48.png" srcset="images/login/2fa-key-96.png 2x" title="Użyj Klucza Bezpieczeństwa" width="48" height="48" style="display:none;margin-left:3px;margin-right:3px;border-radius:3px;box-shadow:2px 2px 5px black;cursor:pointer;background-color:#FFF" onclick="useSecurityKey(1)">
                                        ...
                                        <img id="msgKeyButton" src="images/login/2fa-messaging-48.png" srcset="images/login/2fa-messaging-96.png 2x" title="Wiadomości" width="48" height="48" style="display:none;margin-left:3px;margin-right:3px;border-radius:3px;box-shadow:2px 2px 5px black;cursor:pointer;background-color:#FFF" onclick="useMsgToken(1)">
                                        <img id="emailKeyButton" src="images/login/2fa-mail-48.png" srcset="images/login/2fa-mail-96.png 2x" title="E-mail" width="48" height="48" style="display:none;margin-left:3px;margin-right:3px;border-radius:3px;box-shadow:2px 2px 5px black;cursor:pointer;background-color:#FFF" onclick="useEmailToken(1)">
                                        <img id="pushKeyButton" src="images/login/2fa-push-48.png" srcset="images/login/2fa-push-96.png 2x" title="Uwierzytelnianie Urządzenia" width="48" height="48" style="display:none;margin-left:3px;margin-right:3px;border-radius:3px;box-shadow:2px 2px 5px black;cursor:pointer;background-color:#FFF" onclick="usePushToken(1)">
                    ...
                    <form id="resettokenpanelform" method="post">
                        ...
                        <table style="width:100%">
                            ...
                            <tr>
                                <td>
                                    <div>
                                        <input id="resetTokenOkButton" style="box-sizing:border-box;width:280px;border:0;border-radius:4px;padding:6px" type="button" onclick="submitButtonClicked('resettokenpanelform')" value="Zaloguj" disabled="disabled">
                                    </div>
                                </td>
                            </tr>
                            <tr id="2farow2">
                                <td colspan="2">
                                    <hr>
                                    <div>
                                        <img id="securityKeyButton2" src="images/login/2fa-key-48.png" srcset="images/login/2fa-key-96.png 2x" title="Użyj Klucza Bezpieczeństwa" width="48" height="48" style="display:none;margin-left:3px;margin-right:3px;border-radius:3px;box-shadow:2px 2px 5px black;cursor:pointer;background-color:#FFF" onclick="useSecurityKey(2)">
                                        ...
                                        <img id="msgKeyButton2" src="images/login/2fa-messaging-48.png" srcset="images/login/2fa-messaging-96.png 2x" title="Wiadomości" width="48" height="48" style="display:none;margin-left:3px;margin-right:3px;border-radius:3px;box-shadow:2px 2px 5px black;cursor:pointer;background-color:#FFF" onclick="useMsgToken(2)">
                                        <img id="emailKeyButton2" src="images/login/2fa-mail-48.png" srcset="images/login/2fa-mail-96.png 2x" title="E-mail" width="48" height="48" style="display:none;margin-left:3px;margin-right:3px;border-radius:3px;box-shadow:2px 2px 5px black;cursor:pointer;background-color:#FFF" onclick="useEmailToken(2)">
                                        <img id="pushKeyButton2" src="images/login/2fa-push-48.png" srcset="images/login/2fa-push-96.png 2x" title="Uwierzytelnianie Urządzenia" width="48" height="48" style="display:none;margin-left:3px;margin-right:3px;border-radius:3px;box-shadow:2px 2px 5px black;cursor:pointer;background-color:#FFF" onclick="usePushToken(2)">
                ...
                <div id="resetpasswordpanel" style="display:none;position:relative">
                    <form id="resetpasswordpanelform" method="post">
                        ...
                        <table>
                            <tbody><tr>
                                <td id="rnuPass1" width="100" align="right">Hasło:</td>
                            ...
                            <tr>
                                <td id="rnuPass2" align="right">Hasło:</td>
                            ...
                            <tr id="resetpasswordpanelHint" style="display:none">
                                <td id="rnuHint" align="right">Podpowiedź do Hasła:</td>
                            ...
                            <tr>
                                <td colspan="2">
                                    <div style="float:right"><input id="resetPassButton" type="button" onclick="submitButtonClicked('resetpasswordpanelform')" value="Reset Hasła" disabled="disabled"></div>
                    ...
                    <form id="checkemailpanelform" method="post">
                        ...
                        <table id="checkCheckOperations" style="width:100%;display:none">
                            ...
                            <tr>
                                <td>
                                    <div>
                                        <input id="changeEmailButton" type="button" value="Zmień Adres Email" onclick="changeEmailAddress()">
                                        <input id="checkEmailButton2" type="button" value="Wyślij Ponownie Email z Potwierdzeniem" onclick="resentEmailConfirmation()">
        ...
        <tr style="height:20px">
            <td>
                <div>
                    <div id="flink" style="float:right;margin-right:4px;color:#c8c8c8">{{{rootCertLink}}}&nbsp;<a href="terms">Warunki użytkowania i Prywatności</a></div>
    ...
    <div id="dialog" style="display:none">
        ...
        <div id="idx_dlgButtonBar" style="">
            <input id="idx_dlgCancelButton" type="button" value="Anuluj" style="" onclick="dialogclose(0)">
    ...
    <script>
        ...
        function startup() {
            ...
            if (twoFactorCookieDays > 0) {
                ...
                QH('tokenInputRememberSpan', format("Zapamiętaj to urządzenie na {0} dni.", twoFactorCookieDays));
                QV('tokenInputRememberLabel2', true);
                QH('tokenInputRememberSpan2', format("Zapamiętaj to urządzenie na {0} dni.", twoFactorCookieDays));
            } else {
            ...
            if (features & 0x200000) { // Email is username
                ...
                QH('resetAccountSpan', "Zapomniałeś hasła?");
                QV('nuUserRow', false);
            }
            ...
            if (loginMode == '8') {
                ...
                websocket.onmessage = function (e) {
                    ...
                    if (r.sent === true) {
                        // Request was sent
                        QH('message8', '<span class="msg success"><b>' + format("Prośba wysłana, {0}.", r.code) + '</b></span><br /><br />');
                    } else if (r.sent === false) {
                        // Request failed to send
                        QH('message8', '<span class="msg error"><b style=color:#8C001A>' + "Nie udało się wysłać żądania." + '<b></span><br /><br />');
                        QV('tokenInputRememberLabel2', false);
                        this.close();
                        ...
                        this.close();
                        QV('tokenInputRememberLabel2', false);
                        QH('message8', '<span class="msg success"><b>' + "Prośba zaakceptowana." + '</b></span><br /><br />');
                        Q('pushtokenInput').value = r.token;
                        Q('pushOkButton').click();
                    } else {
                        // Request rejected
                        QH('message8', '<span class="msg error"><b style=color:#8C001A>' + "Dostęp Odrzucony." + '<b></span><br /><br />');
                        QV('tokenInputRememberLabel2', false);
                        this.close();
                    }
                }
                ...
                websocket.onerror = function (e) {
                    QH('message8', '<span class="msg error"><b style=color:#8C001A>' + "Błąd Połączenia" + '<b></span><br /><br />');
        ...
        function useEmailToken(panelAction) {
            ...
            setDialogMode(1, "Bezpieczne Logowanie", 3, useEmailKeyEx, "Wysłać token na zarejestrowany adres email?", panelAction);
        }
        ...
        function useSMSToken(panelAction) {
            ...
            setDialogMode(1, "Bezpieczne Logowanie", 3, useSMSTokenEx, "Wysłać token na zarejestrowany numer telefonu?", panelAction);
        }
        ...
        function useMsgToken(panelAction) {
            ...
            setDialogMode(1, "Bezpieczne Logowanie", 3, useMsgTokenEx, "Wysłac token na komunikator?", panelAction);
        }
        ...
        function showPassHint(e) {
            messagebox("Podpowiedź do Hasła", passhint);
            haltEvent(e);
            return false;
        }
        ...
        function validateCreate(box, e) {
            ...
            if (Q('apassword1').value == '') {
                ...
                if (!passRequirementsEx) {
                    ...
                    if (passStrength >= 80) { QH('passWarning', '<span style=color:green><b>' + "Silne Hasło" + '</b><span>'); }
                    else if (passStrength >= 60) { QH('passWarning', '<span style=color:blue><b>' + "Hasło Prawidłowe" + '</b><span>'); }
                    else { QH('passWarning', '<span style=color:red><b>' + "Słabe hasło" + '</b><span>'); }
                } else {
                    ...
                    if (passReq == false) {
                        ...
                        QH('passWarning', '<div style=color:red;cursor:pointer onclick=showPasswordPolicy()><b>' + "Polityka Haseł" + '</b><div>'); // This is also a link to the password policy
        ...
        function validatePassReset(box, e) {
            ...
            if (Q('rapassword1').value == '') {
                ...
                if (!passRequirementsEx) {
                    ...
                    if (passStrength >= 80) { QH('rpassWarning', '<span style=color:green><b>' + "Silne Hasło" + '</b><span>'); }
                    else if (passStrength >= 60) { QH('rpassWarning', '<span style=color:blue><b>' + "Hasło Prawidłowe" + '</b><span>'); }
                    else { QH('rpassWarning', '<span style=color:red><b>' + "Słabe hasło" + '</b><span>'); }
                } else {
                    // Password requirements provided, use that
                    ...
                    if (passReq == false) {
                        ...
                        QH('rpassWarning', '<div style=color:red;cursor:pointer onclick=showPasswordPolicy()><b>' + "Polityka Haseł" + '</b><div>'); // This is also a link to the password policy
        ...
        function passwordPolicyText(pass) {
            ...
            if (passRequirements.min && ((pass == null) || (pass.length < passRequirements.min))) { policy += format("Minimalna długość to {0}", passRequirements.min) + '<br />'; }
            if (passRequirements.max && ((pass == null) || (pass.length > passRequirements.max))) { policy += format("Maksymalna długość {0}", passRequirements.max) + '<br />'; }
            if (passRequirements.upper && ((pass == null) || (counts.upper < passRequirements.upper))) { policy += format("{0} wielkie litery", passRequirements.upper) + '<br />'; }
            if (passRequirements.lower && ((pass == null) || (counts.lower < passRequirements.lower))) { policy += format("{0} małe litery", passRequirements.lower) + '<br />'; }
            if (passRequirements.numeric && ((pass == null) || (counts.numeric < passRequirements.numeric))) { policy += format("{0} numeryczne", passRequirements.numeric) + '<br />'; }
            if (passRequirements.nonalpha && ((pass == null) || (counts.nonalpha < passRequirements.nonalpha))) { policy += format("{0} niealfanumeryczne", passRequirements.nonalpha) + '<br />'; }
            policy += '</div>';
            return policy;
        }

        function showPasswordPolicy() {
            messagebox("Polityka Haseł", passwordPolicyText());
        }
        ...
        function changeEmailAddress() {
            ...
            setDialogMode(1, "Potwierdzenie Email", 3, changeEmailAddressEx, x);
