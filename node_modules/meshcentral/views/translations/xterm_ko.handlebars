<!DOCTYPE html><html dir="ltr" xmlns="http://www.w3.org/1999/xhtml"><head lang="en">
    ...
    <div id="termShellContextMenu" class="contextMenu noselect" style="display:none;min-width:0px">
        <div id="cxtermnorm" class="cmtext" onclick="cmtermaction(1,event)"><b>관리자 쉘</b></div>
        <div id="cxtermps" class="cmtext" onclick="cmtermaction(6,event)">PowerShell 관리자</div>
        <div id="cxtermunorm" class="cmtext" onclick="cmtermaction(8,event)">사용자 쉘</div>
        <div id="cxtermups" class="cmtext" onclick="cmtermaction(9,event)">사용자 PowerShell</div>
    </div>
    <div id="termShellContextMenuLinux" class="contextMenu noselect" style="display:none;min-width:0px">
        <div id="cxtermnorm" class="cmtext" onclick="cmtermaction(1,event)"><b>루트 쉘</b></div>
        <div id="cxtermps" class="cmtext" onclick="cmtermaction(8,event)">사용자 쉘</div>
        <div id="cxtermps" class="cmtext" onclick="cmtermaction(100,event)">로그인 쉘</div>
    </div>
