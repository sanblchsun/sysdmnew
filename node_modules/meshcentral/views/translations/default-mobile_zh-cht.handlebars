<!DOCTYPE html><html lang="zh-cht" dir="ltr" xmlns="http://www.w3.org/1999/xhtml"><head>
    ...
    <div id="container">
        ...
        <div id="masthead" style="background:url(logo.png) 0px 0px;background-size:341px 50px;background-color:#036;background-repeat:no-repeat;height:50px;width:100%;overflow:hidden">
            ...
            <div id="notificationCount" onclick="clickNotificationIcon()" class="unselectable" style="position:absolute;right:50px;top:0px;font-size:28px;width:50px;height:50px;cursor:pointer;display:none" title="點擊查看當前通知"><div id="notificationCount2" style="padding-top:8px">0</div></div>
            ...
            <div id="column_l" style="width:100%;padding:0;position:absolute;bottom:0px;top:0px">
                <div id="p0" style="display:none;width:100%;height:100%">
                    <div style="display:flex;align-items:center;width:100%;height:100%">
                        <div id="p0message" style="text-align:center;width:100%"><span id="p0span">伺服器已斷開連接</span>, <href onclick="reload()" style="cursor:pointer"><u>點擊重新連接</u></href>.</div>
                    </div>
                </div>
                ...
                <div id="p2" style="display:none;position:absolute;top:0;left:0;right:0;bottom:0">
                    ...
                    <div id="xdevicesBar" style="position:absolute;overflow-y:auto;height:34px;left:0;right:0;bottom:0px;background-color:#aaa;color:black">
                        <div style="margin:4px">
                            ...
                            <input id="SearchInput" autocomplete="off" type="search" placeholder="過濾" onchange="onDeviceSearchChanged(event)" onclick="onDeviceSearchChanged(event)" onkeyup="onDeviceSearchChanged(event)" style="padding:2px;margin:0;height:20px;background-color:#FFF">&nbsp;
                            <label class="noselect"><input type="checkbox" id="RealNameCheckBox" onclick="onRealNameCheckBox()">操作系統名稱</label>
                            <label class="noselect"><input type="checkbox" id="OnlineCheckBox" onclick="onOnlineCheckBox(event)">線上</label>
                        </div>
                    </div>
                </div>
                        ...
                        <div style="margin-left:8px">
                            <div id="p3AccountActions">
                                <div id="p2AccountSecurity" style="display:none">
                                    <p><strong>帳號安全</strong></p>
                                    <div style="margin-left:9px;margin-bottom:8px">
                                        <div id="managePhoneNumber1" style="margin-top:5px;display:none"><a onclick="account_managePhone()" style="cursor:pointer">管理電話號碼</a> <span id="authPhoneNumberCheck"><strong>✓</strong></span></div>
                                        <div id="manageEmail2FA" style="margin-top:5px;display:none"><a onclick="account_manageAuthEmail()" style="cursor:pointer">管理電郵身份驗證</a> <span id="authEmailSetupCheck"><strong>✓</strong></span></div>
                                        <div style="margin-top:5px"><a href="#" onclick="account_showLocalizationSettings()">本地化設置</a></div>
                                        <div id="manageAuthApp" style="margin-top:5px;display:none"><a onclick="account_manageAuthApp()" style="cursor:pointer">管理身份驗證器軟體</a> <span id="authAppSetupCheck"><strong>✓</strong></span></div>
                                        <div id="manageOtp" style="margin-top:5px;display:none"><a onclick="account_manageOtp(0)" style="cursor:pointer">管理備用碼</a> <span id="authCodesSetupCheck"><strong>✓</strong></span></div>
                                    </div>
                                </div>
                                <div id="p2AccountActions" style="display:none">
                                    <p><strong>帳戶動作</strong></p>
                                    <div style="margin-left:9px;margin-bottom:8px">
                                        <div style="margin-top:5px"><span id="viewPreviousLogins"><a onclick="return account_viewPreviousLogins()" style="cursor:pointer">查看以前的登錄</a></span></div>
                                        <div style="margin-top:5px"><span id="managePhoneNumber2" style="display:none"><a onclick="account_managePhone()" style="cursor:pointer">管理電話號碼</a></span></div>
                                        <div style="margin-top:5px"><span id="verifyEmailId" style="display:none"><a onclick="account_showVerifyEmail()" style="cursor:pointer">驗證電郵</a></span></div>
                                        <span id="p2AccountPassActions">
                                            <div style="margin-top:5px"><span id="changeEmailId" style="display:none"><a onclick="account_showChangeEmail()" style="cursor:pointer">更改電郵地址</a></span></div>
                                            <div style="margin-top:5px"><a onclick="account_showChangePassword()" style="cursor:pointer">更改密碼</a><span id="p2nextPasswordUpdateTime"></span></div>
                                            <div style="margin-top:5px"><a onclick="account_showDeleteAccount()" style="cursor:pointer">刪除帳戶</a></div>
                                        </span>
                                        <div style="margin-top:5px" id="setDarkModeLink"><a onclick="toggleNightMode()" style="cursor:pointer">設置暗模式</a></div>
                                        <div style="margin-top:5px"><a onclick="showNotes(false)" style="cursor:pointer">個人筆記</a></div>
                                    </div>
                                <br style="clear:both">
                                </div>
                            </div>
                            ...
                            <br><br>
                            <div id="p3meshes"></div>
                            <div id="p3noMeshFound" style="margin-left:9px;display:none">沒有裝置群。<span id="p3createMeshLink2"> <a onclick="account_createMesh()" style="cursor:pointer"><strong>從這裡開始！</strong></a></span></div>
                            <br style="clear:both">
                        </div>
                    </div>
                </div>
                <div id="p5" style="display:none">
                    <table cellspacing="0" style="margin:0;padding:0;border-spacing:0;border:0;">
                        <tbody><tr style="padding:0">
                            ...
                            <td>
                                <div style="margin-left:5px">
                                    <strong style="font-size:large">我的檔案</strong><br>
                                </div>
                            </td>
                        </tr>
                    </tbody></table>
                            ...
                            <tbody><tr>
                                <td style="width:100%;background-color:#d3d9d6;text-align:left;padding:4px" valign="bottom">
                                    <div style="width:100%;text-align:center">
                                        ...
                                        <input type="button" style="width:calc(100%/5 - 5px)" id="p5SelectAllButton" disabled="disabled" onclick="p5selectallfile()" value="全選" onkeypress="return false" onkeydown="return false">
                                        ...
                                        <input type="button" style="width:calc(100%/5 - 5px)" id="p5DeleteFileButton" disabled="disabled" value="刪除" onclick="p5deletefile()" onkeypress="return false" onkeydown="return false">
                                        <input type="button" style="width:calc(100%/5 - 5px)" id="p5NewFolderButton" disabled="disabled" value="檔案夾" onclick="p5createfolder()" onkeypress="return false" onkeydown="return false">
                                    </div>
                                    <div style="width:100%;text-align:center">
                                        <input type="button" style="width:calc(100%/5 - 5px)" id="p5UploadButton" disabled="disabled" value="上載" onclick="p5uploadFile()" onkeypress="return false" onkeydown="return false">
                                        <input type="button" style="width:calc(100%/5 - 5px)" id="p5CutButton" disabled="disabled" value="切" onclick="p5copyFile(1)" onkeypress="return false" onkeydown="return false">
                                        <input type="button" style="width:calc(100%/5 - 5px)" id="p5CopyButton" disabled="disabled" value="複製" onclick="p5copyFile(0)" onkeypress="return false" onkeydown="return false">
                                        <input type="button" style="width:calc(100%/5 - 5px)" id="p5PasteButton" disabled="disabled" value="糊" onclick="p5pasteFile()" onkeypress="return false" onkeydown="return false">
                                        ...
                                        <tbody><tr>
                                            ...
                                            <td style="text-align:right;padding-right:4px">
                                                <select id="p5sortdropdown" onchange="updateFiles()">
                                                    <option value="1" selected="selected">按名稱排序</option>
                                                    <option value="2">按大小排序</option>
                                                    <option value="3">按日期排序</option>
                                                    <option value="4">按名稱降序</option>
                ...
                <div id="p10" style="display:none;position:absolute;bottom:0;top:0;width:100%;overflow:hidden">
                    ...
                    <div id="p10dialog" style="z-index:1000;background-color:#EEE;box-shadow:0px 0px 15px #666;font-family:Arial,Helvetica,sans-serif;border-radius:5px;position:fixed;top:30px;width:300px;left:30px;display:none">
                        <div style="width:100%;background-color:#003366;color:#FFF;border-radius:5px 5px 0 0">
                            <div style="padding:5px">鍵盤快捷鍵自定義</div>
                    ...
                    <div id="p10desktop" style="overflow:hidden;position:absolute;top:55px;bottom:0px;width:100%;display:none">
                        <div id="deskarea1" style="position:absolute;top:0px;width:100%;height:32px">
                            <div style="padding-top:2px;padding-bottom:2px;background:#C0C0C0;height:32px">
                                ...
                                <div style="margin-left:3px">
                                    <input type="button" id="connectbutton1" value="連接" onclick="connectDesktop(event,3)" onkeypress="return false" onkeydown="return false" disabled="disabled" style="height:28px">
                                    <input type="button" id="connectbutton1h" value="硬件連接" onclick="connectDesktop(event,2)" onkeypress="return false" onkeydown="return false" disabled="disabled" style="height:28px">
                                    <input type="button" id="disconnectbutton1" value="斷線" onclick="connectDesktop(event,0)" onkeypress="return false" onkeydown="return false" style="height:28px">
                                    <span id="deskstatus" style="color:black">已斷線</span>
                                </div>
                            </div>
                        </div>
                        ...
                        <div id="deskarea4" style="position:absolute;bottom:0px;width:100%;height:32px">
                            <div style="padding-top:2px;padding-bottom:2px;background:#C0C0C0">
                                ...
                                <div>
                                    <input id="deskActionsBtn" type="button" style="margin-left:3px;height:28px" onkeypress="return false" onkeydown="return false" value="動作" onclick="deviceActionFunction()">
                                    <input type="button" value="設定" onkeypress="return false" onkeydown="return false" onclick="showDesktopSettings()" style="height:28px">
                                    <input type="button" onkeypress="return false" onkeydown="return false" value="電源指令..." onclick="showPowerActionDlg()" style="display:none;height:28px">
                                    ...
                                    <label><span id="DeskControlSpan" style="display:none"><input id="DeskControl" type="checkbox" onkeypress="return false" onkeydown="return false">輸入</span></label>
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div id="termTable" style="position:absolute;top:0;bottom:0;left:0;right:0">
                            <div id="termarea1">
                                <div class="areaHead" style="line-height:24px">
                                    ...
                                    <div>
                                        <span id="connectbutton2span" style="margin-left:3px"><input type="button" id="connectbutton2" value="連接" style="height:28px" onclick="connectTerminal(event,1)" onkeypress="return false" onkeydown="return false" disabled="disabled"></span>
                                        <span id="connectbutton2sspan" style="margin-right:4px"><input type="button" id="connectbutton2s" value="SSH 連接" style="height:28px" onclick="connectTerminal(event,3)" onkeypress="return false" onkeydown="return false" disabled="disabled"></span>
                                        <span id="disconnectbutton2span" style="margin-left:3px"><input type="button" id="disconnectbutton2" value="斷線" style="height:28px" onclick="connectTerminal(event,0)" onkeypress="return false" onkeydown="return false"></span>
                                        <span id="termstatus" style="line-height:22px">已斷線</span><span id="termtitle"></span>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div id="termarea4" style="position:relative;height:32px;">
                                <div class="areaFoot">
                                    ...
                                    <div style="height:28px">
                                        <input id="termActionsBtn" style="margin-left:3px;height:28px" type="button" title="在裝置上執行電源操作" onkeypress="return false" onkeydown="return false" value="動作" onclick="deviceActionFunction()">
                        ...
                        <table id="p13toolbar" style="width:100%;height:111px" cellpadding="0" cellspacing="0">
                            <tbody><tr>
                                <td style="background-color:#C0C0C0;border-bottom:2px solid black;padding:2px;line-height:24px">
                                    <div style="float:right;text-align:right">
                                        <input id="filesActionsBtn" type="button" onkeypress="return false" onkeydown="return false" value="動作" onclick="deviceActionFunction()" style="margin-right:2px">
                                        <div id="filesCustomUpperRight" style="float:left;margin-right:6px"></div>
                                    </div>
                                    <div style="margin-left:2px">
                                        <input id="p13AutoConnect" value="自動連接" onclick="autoConnectFiles(event)" onkeypress="return false" onkeydown="return false" type="button" style="display:none">
                                        <input id="p13Connect" value="連接" onclick="connectFiles(event,1)" onkeypress="return false" onkeydown="return false" type="button">
                                        <input id="p13Connects" value="SFTP 連接" onclick="connectFiles(event,2)" onkeypress="return false" onkeydown="return false" type="button">
                                        <input id="p13Disconnect" value="斷線" onclick="connectFiles(event)" onkeypress="return false" onkeydown="return false" type="button">
                                        <span class="textOverGray" id="p13Status">已斷線</span>
                                    </div>
                                </td>
                            </tr>
                            <tr>
                                <td style="width:100%;background-color:#d3d9d6;text-align:left;padding:4px" valign="bottom">
                                    <div style="width:100%;text-align:center">
                                        ...
                                        <input type="button" style="width:calc(100%/5 - 5px)" id="p13SelectAllButton" disabled="disabled" onclick="p13selectallfile()" value="全選" onkeypress="return false" onkeydown="return false">
                                        ...
                                        <input type="button" style="width:calc(100%/5 - 5px)" id="p13DeleteFileButton" disabled="disabled" value="刪除" onclick="p13deletefile()" onkeypress="return false" onkeydown="return false">
                                        <input type="button" style="width:calc(100%/5 - 5px)" id="p13NewFolderButton" disabled="disabled" value="檔案夾" onclick="p13createfolder()" onkeypress="return false" onkeydown="return false">
                                    </div>
                                    <div style="width:100%;text-align:center">
                                        <input type="button" style="width:calc(100%/5 - 5px)" id="p13UploadButton" disabled="disabled" value="上載" onclick="p13uploadFile()" onkeypress="return false" onkeydown="return false">
                                        <input type="button" style="width:calc(100%/5 - 5px)" id="p13CutButton" disabled="disabled" value="切" onclick="p13copyFile(1)" onkeypress="return false" onkeydown="return false">
                                        <input type="button" style="width:calc(100%/5 - 5px)" id="p13CopyButton" disabled="disabled" value="複製" onclick="p13copyFile(0)" onkeypress="return false" onkeydown="return false">
                                        <input type="button" style="width:calc(100%/5 - 5px)" id="p13PasteButton" disabled="disabled" value="糊" onclick="p13pasteFile()" onkeypress="return false" onkeydown="return false">
    ...
    <div id="dialog" style="display:none">
        ...
        <div style="margin-right:16px;margin-left:8px">
            ...
            <div id="dialog4" style="margin:auto;margin:3px">
                <div id="d3upload">
                    ...
                    <select id="d3uploadMode" onchange="d3modechange()">
                        <option value="1">本地檔案上傳</option>
                        <option value="2">伺服器檔案選擇</option>
                    </select>
                </div>
            ...
            <div id="dialog7" style="margin:auto;margin:3px">
                <div id="d7meshkvm">
                    <h4 style="width:100%;border-bottom:1px solid gray">代理遠程桌面</h4>
                    <table style="width:100%">
                        <tbody><tr>
                            <td>
                                品質
                        ...
                        <tr>
                            <td></td>
                            <td>
                                <label style="display:block" id="d7deskAutoLockLabel"><input type="checkbox" id="d7deskAutoLock">斷開連接鎖定</label>
                            </td>
                        </tr>
                    </tbody></table>
                </div>
                <div id="d7amtkvm">
                    <h4 style="width:100%;border-bottom:1px solid gray">Intel® AMT硬件KVM</h4>
                    <table style="width:100%">
                        <tbody><tr>
                            <td>編碼</td>
                            <td style="width:100px">
                                <select id="d7desktopmode" style="float:right;width:200px">
                                    ...
                                    <option value="2">RLE16，推薦</option>
        ...
        <div id="idx_dlgButtonBar" style="padding:10px;margin-bottom:20px">
            ...
            <div><input id="idx_dlgDeleteButton" type="button" value="刪除" style="display:none" onclick="dialogclose(2)"></div>
        </div>
    </div>
    <div id="topMenu" style="z-index:1000;background-color:#EEE;box-shadow:0px 0px 15px #666;font-family:Arial,Helvetica,sans-serif;border-radius:0px 0px 5px 5px;position:fixed;top:50px;right:5px;width:170px;display:none">
        <div style="padding:12px;border-top:1px solid gray;color:black;cursor:pointer" onclick="topMenu(2)">我的檔案</div>
        <div style="padding:12px;border-top:1px solid gray;color:black;cursor:pointer" onclick="topMenu(1)">我的帳戶</div>
    ...
    <script>
        ...
        var StatusStrs = ["已斷線", "正在連線...", "設定...", "已連接", "Intel&reg; AMT已連接"];
        var agentsStr = ["未知", "Windows 32位控制台", "Windows 64位控制台", "Windows 32位服務", "Windows 64位服務", "Linux 32位", "Linux 64位", "MIPS", "XENx86", "Android", "Linux ARM", "macOS x86-32位", "安卓x86", "PogoPlug ARM", "Android", "Linux Poky x86-32位", "macOS x86-64位", "ChromeOS", "Linux Poky x86-64位", "Linux NoKVM x86-32位", "Linux NoKVM x86-64位", "Windows MinCore控制台", "Windows MinCore服務", "NodeJS", "ARM-Linaro", "ARMv6l / ARMv7l", "ARMv8 64位", "ARMv6l / ARMv7l / NoKVM", "MIPS24KC（OpenWRT）", "蘋果矽", "FreeBSD x86-64", "未知", "Linux ARM 64 bit (glibc/2.24 NOKVM)", "Alpine Linux x86 64 Bit (MUSL)", "助理（Windows）", "Armada370 - ARM32/HF (libc/2.26)", "OpenWRT x86-64", "OpenBSD x86-64", "未知", "未知", "MIPSEL24KC (OpenWRT)", "ARMADA/CORTEX-A53/MUSL (OpenWRT)", "Windows ARM 64bit console", "Windows ARM 64bit service", "ARMVIRT32 (OpenWRT)", "RISC-V x86-64"];
        var files;
        var terminal;
        ...
        function onStateChanged(server, state, prevState, errorCode) {
            if (state == 0) {
                ...
                if (errorCode == 'noauth') { QH('p0span', "無法執行身份驗證"); return; }
                if (prevState == 2) { setTimeout(serverPoll, 5000); } else { QH('p0span', "無法連接網絡插座"); }
                // Clean up here
        ...
        function updateSelf() {
            ...
            if (typeof userinfo.passchange == 'number') {
                if (userinfo.passchange == -1) { QH('p2nextPasswordUpdateTime', " -下次登入時重置。"); }
                    ...
                    if (seconds < 0) { QH('p2nextPasswordUpdateTime', " -下次登入時重置。"); }
                    else if (seconds < 3600) { var secs = Math.floor(seconds / 60); QH('p2nextPasswordUpdateTime',format((secs == 1)?" - 1分鐘後重設。":" - 在{0}分鐘內重置。", secs)); }
                    else if (seconds < 86400) { var hours = Math.floor(seconds / 3600); QH('p2nextPasswordUpdateTime', format((hours == 1) ? " - 1小時後重設。" : " - 在{0}小時內重置。", hours)); }
                    else { var days = Math.floor(seconds / 86400); QH('p2nextPasswordUpdateTime', format((hours == 1) ? " - 1天后重設。" : " - 在{0}天內重置。", days)); }
                }
            }
        }
            ...
            switch (message.action) {
                case 'serverinfo': {
                    ...
                    if (serverinfo.certExpire != null) {
                        ...
                        if ((days >= 0) && (days < 20)) {
                            addNotification({ text: format("證書將在 {0} 天后到期", days) });
                        }
                    }
                ...
                case 'otpauth-request': {
                    if ((xxdialogMode == 2) && (xxdialogTag == 'otpauth-request')) {
                        if (message.err != null) {
                            var otpauthErrors = ['', "2FA被鎖定", "備用代碼已鎖定", "正在使用的登錄令牌", "不允許 OTP 2FA", "帳戶已被鎖定", "無法加載 OTPLIB"];
                            if ((message.err > 0) && (message.err < otpauthErrors.length)) { QH('d2optinfo', otpauthErrors[message.err]); } else { QH('d2optinfo', format("錯誤 #{0}", message.err)); }
                        } else {
                ...
                case 'otpauth-setup': {
                    ...
                    setDialogMode(2, "認證軟體", 1, null, message.success ? ('<b style=color:green>' + "認證軟體啟動成功。" + '</b> ' + "你現在需要一個有效的保安編碼才能再次登入。") : ('<b style=color:red>' + "兩步登入啟用失敗。" + '</b> ' + "從應用程序中清除秘密，然後重試。你只有幾分鐘的時間來輸入正確的代碼。"));
                    break;
                }
                case 'otpauth-clear': {
                    if (xxdialogMode) return;
                    setDialogMode(2, "認證軟體", 1, null, message.success ? ('<b>' + "認證軟體已刪除。" + '</b> ' + "你可以隨時重新啟動此功能。") : ('<b style=color:red>' + "兩步登入啟用刪除失敗。" + '</b> ' + "再試一次。"));
                    break;
                }
                case 'otpauth-getpasswords': {
                    if (xxdialogMode) return;
                    var x = "一次性保安編碼可以用作輔助身份驗證。生成一群，打印並保存在安全的地方。";
                    ...
                    x += '</table></div></div><br />';
                    x += '<div><input type=button value=\'' + "關" + '\' onclick=setDialogMode(0) style=float:right></input>';
                    x += '<input type=button value=\'' + "新保安編碼" + '\' onclick=\'account_manageOtp(1);\'></input>';
                    if (message.passwords != null) { x += '<input type=button value=\'' + "清除" + '\' onclick=\'account_manageOtp(2);\'></input>'; }
                    x += '</div><br />';
                    setDialogMode(2, "管理備用碼", 8, null, x, 'otpauth-manage');
                    break;
                }
                case 'verifyPhone': {
                    ...
                    x += '<br /><br /><div style=width:100%;text-align:center>' + "驗證碼：" + ' <input type=tel pattern="[0-9]" inputmode="number" maxlength=6 id=d2phoneCodeInput onKeyUp=account_managePhoneCodeValidate() onkeypress="if (event.key==\'Enter\') account_managePhoneCodeValidate(1)"></div></table>';
                    setDialogMode(2, "電話通知", 3, account_managePhoneConfirm, x, message.cookie);
                    ...
                    if ((xxdialogMode == 2) && (xxdialogTag == 'previousLogins')) {
                        ...
                        if (message.events.length == 0) {
                            ...
                            for (var i in message.events) {
                                ...
                                if (m == 107) { m = "有效登錄"; c = 'BBD1BB'; xx = ''; }
                                else if (m == 108) { m = "無效的 2FA"; c = 'DD9DC3'; xx = 'x'; }
                                else if (m == 109) { m = "被鎖定賬戶"; c = 'E1BBBB'; xx = 'x'; }
                                else if (m == 110) { m = "無效的密碼"; c = 'E1BBBB'; xx = 'x'; }
                        ...
                        setDialogMode(2, "以前的登錄", 1, null, x);
                    }
                    break;
                }
                case 'event': {
        ...
        function goStack() {
            ...
            if (idtype == 'files') {
                ...
                if ((features & 0x00040000) && !((userinfo.otpsecret == 1) || (userinfo.otphkeys > 0) || (userinfo.otpkeys > 0) || (userinfo.otpduo > 0) || (userinfo.otpdev > 0) || ((features & 0x00800000) && (userinfo.otpekey == 1)))) { setDialogMode(2, "帳號安全", 1, null, "Unable to access this feature until two-factor authentication is enabled. This is required for extra security. Go to the \"My Account\" and look at the \"Account Security\" section."); return; }  
                go(5);
            }
        }
        ...
        function account_viewPreviousLogins() {
            if (xxdialogMode) return;
            setDialogMode(2, "以前的登錄", 1, null, "載入中...", 'previousLogins');
        ...
        function account_manageImage(mode) {
            ...
            setDialogMode(2, "管理帳戶圖片", 7, account_manageImageEx2, x, user._id);
        ...
        function toggleNightMode() {
            ...
            var x = '<input type=radio id=night0 name=nightmoderadio value=0 ' + ((cNightMode == 0) ? 'checked' : '') + '><label for=night0>' + "瀏覽器默認" + '</label><br>';
            x += '<input type=radio id=night2 name=nightmoderadio value=2 ' + ((cNightMode == 2) ? 'checked' : '') + '><label for=night2>' + "燈光模式" + '</label><br>';
            x += '<input type=radio id=night1 name=nightmoderadio value=1 ' + ((cNightMode == 1) ? 'checked' : '') + '><label for=night1>' + "黑暗模式" + '</label><br>';
            setDialogMode(2, "夜間模式", 3, toggleNightModeEx, x);
            QV('uiMenu', false);
        }
        ...
        function account_managePhone() {
            ...
            if (userinfo.phone != null) {
                ...
                x += '<td style=text-align:center><div style=padding:6px>' + "驗證電話號碼" + '</div><div style=font-size:20px>' + userinfo.phone + '</div>';
                x += '<div style=margin:10px><label><input id=d2delPhone type=checkbox onclick=account_managePhoneRemoveValidate() />' + "刪除電話號碼" + '</label></div>';
                setDialogMode(2, "電話通知", 3, account_managePhoneRemove, x);
                ...
                x += '<br /><br /><div style=width:100%;text-align:center>' + "電話號碼：" + ' <input type=tel pattern="[0-9]" autocomplete="tel" inputmode="tel" maxlength=18 id=d2phoneinput onKeyUp=account_managePhoneValidate() onkeypress="if (event.key==\'Enter\') account_managePhoneValidate(1)"></div></table>';
                setDialogMode(2, "電話通知", 3, account_managePhoneAdd, x, 'verifyPhone');
        ...
        function account_showLocalizationSettings() {
            ...
            if (serverinfo.languages && serverinfo.languages.length > 0) {
                y += "更改語言將需要刷新頁面。" + '<br /><br />';
                var z = '<select id=d2langselect style=width:180px><option value="*">' + "用戶瀏覽器值" + '</option>';
            ...
            y += addHtmlValue("日期和時間", x);

            if ((userinfo.siteadmin == 0xFFFFFFFF) && (domain == '')) {
                y += '<br /><a rel="noreferrer noopener" target="_blank" href="translator.htm">' + "幫助翻譯MeshCentral" + '</a>';
            }

            setDialogMode(2, "本地化設置", 3, account_showLocalizationSettingsEx, y);
            return false;
        }
        ...
        function account_addOtp() {
            ...
            setDialogMode(2, "認證軟體", 2, function () { meshserver.send({ action: 'otpauth-setup', secret: Q('d2optsecret').attributes.secret.value, token: Q('d2otpauthinput').value }); }, '<div id=d2optinfo>' + "載入中..." + '</div>', 'otpauth-request');
        ...
        function account_removeOtp() {
            if (xxdialogMode || (userinfo.otpsecret != 1) || ((features & 4096) == 0)) return;
            setDialogMode(2, "認證軟體", 3, function () { meshserver.send({ action: 'otpauth-clear' }); }, "確認刪除身份驗證軟體兩步登入？");
        }
        ...
        function account_showVerifyEmail() {
            ...
            var x = "單擊確定將驗證電郵發送到：" + '<br /><div style=padding:8px><b>' + EscapeHtml(userinfo.email) + '</b></div>' + "請等待幾分鐘以接收驗證。";
            setDialogMode(2, "電郵驗證", 3, account_showVerifyEmailEx, x);
        }
        ...
        function account_showChangeEmail() {
            if (xxdialogMode) return;
            var x = addHtmlValue("電郵", '<input id=dp3email style=width:170px maxlength=256 onchange=account_validateEmail() onkeyup=account_validateEmail(event) />');
            setDialogMode(2, "電郵地址變更", 3, account_changeEmail, x);
        ...
        function account_showDeleteAccount() {
            ...
            x += '<td align=right>' + "密碼：" + '</td><td><input id=apassword1 type=password name=apassword1 autocomplete=off onchange=account_validateDeleteAccount() onkeyup=account_validateDeleteAccount() /></td>';
            x += '</tr><tr><td align=right>' + "密碼：" + '</td><td><input id=apassword2 type=password name=apassword2 autocomplete=off onchange=account_validateDeleteAccount() onkeyup=account_validateDeleteAccount() /></td>';
        ...
        function account_showChangePassword() {
            ...
            x += '<tr><td align=right>' + nobreak("舊密碼：") + '</td><td><input id=apassword0 type=password name=apassword0 autocomplete=off onchange=account_validateNewPassword() onkeyup=account_validateNewPassword() onkeydown=account_validateNewPassword() /> <b></b></td></tr>';
            x += '<tr><td align=right>' + nobreak("新密碼：") + '</td><td><input id=apassword1 type=password name=apassword1 autocomplete=off onchange=account_validateNewPassword() onkeyup=account_validateNewPassword() onkeydown=account_validateNewPassword() /> <b><span id=dxPassWarn></span></b></td></tr>';
            x += '<tr><td align=right>' + nobreak("新密碼：") + '</td><td><input id=apassword2 type=password name=apassword2 autocomplete=off onchange=account_validateNewPassword() onkeyup=account_validateNewPassword() onkeydown=account_validateNewPassword() /></td></tr>';
            if (features & 0x00010000) { x += '<tr><td align=right>' + "密碼提示：" + '</td><td><input id=apasswordhint name=apasswordhint maxlength=250 type=text autocomplete=off onchange=account_validateNewPassword() onkeyup=account_validateNewPassword() onkeydown=account_validateNewPassword() /></td></tr>'; }
            x += '</table>'
            if (passRequirements) {
                var r = [], rc = 0;
            ...
            x += '<br />';
            setDialogMode(2, "更改密碼", 3, account_showChangePasswordEx, x);
            Q('apassword0').focus();
        ...
        function account_createMesh() {
            ...
            if ((userinfo.siteadmin != 0xFFFFFFFF) && ((userinfo.siteadmin & 64) != 0)) { setDialogMode(2, "新裝置群", 1, null, "此帳戶無權建立新的裝置群。"); return; }

            // Remind the user to verify the email address
            if ((userinfo.emailVerified !== true) && (serverinfo.emailcheck == true) && (userinfo.siteadmin != 0xFFFFFFFF)) { setDialogMode(2, "帳號安全", 1, null, "在驗證電郵地址之前，無法訪問裝置。這是密碼恢復所必需的。轉到“我的帳戶”以更改並驗證電郵地址。"); return; }

            // Remind the user to add two factor authentication
            if ((features & 0x00040000) && !((userinfo.otpsecret == 1) || (userinfo.otphkeys > 0) || (userinfo.otpkeys > 0) || (userinfo.otpduo > 0) || (userinfo.otpdev > 0) || ((features & 0x00800000) && (userinfo.otpekey == 1)))) { setDialogMode(2, "帳號安全", 1, null, "在啟用二因子身份驗證之前，無法訪問裝置。這是額外的安全性所必需的。轉到“我的帳戶”，然後查看“帳戶安全性”部分。"); return; }

            // We are allowed, let's prompt to information
            var x = addHtmlValue("名稱", '<input id=dp3meshname style=width:170px maxlength=64 onchange=account_validateMeshCreate() onkeyup=account_validateMeshCreate() />');
            x += addHtmlValue("類型", '<div style=width:170px;margin:0;padding:0><select id=dp3meshtype style=width:100% onchange=account_validateMeshCreate() ><option value=2>' + "軟體代理群" + '</option><option value=1>' + "僅限Intel&reg; AMT" + '</option></select></div>');
            ...
            setDialogMode(2, "創建裝置群", 3, account_createMeshEx, x);
        ...
        function updateMeshes() {
            ...
            for (i in meshes) {
                ...
                var rights = "部分權限";
                if (meshrights == 0xFFFFFFFF) rights = "完整管理員"; else if (meshrights == 0) rights = "沒有權利";
        ...
        function updateFiles() {
            ...
            for (var i in filetreexx) {
                ...
                if (f.t < 3 || f.t == 4) {
                    ...
                    var link = shortname;
                    var publiclink = '';
                    if (publicfolder) { publiclink = ' (<a style=cursor:pointer onclick=\'p5showPublicLink("' + publicPath + '/' + f.nx + '")\'>' + "鏈結" + '</a>)'; }
        ...
        function getNiceSize(bytes) {
            if (bytes <= 0) return "超出儲存空間";
            if (bytes < 2048) return format("還剩{0}b", bytes);
            if (bytes < 2097152) return format("還剩{0}k", Math.round(bytes / 1024));
            if (bytes < 2147483648) return format("還剩{0}m", Math.round(bytes / 1024 / 1024));
            return format("還剩{0}g", Math.round(bytes / 1024 / 1024 / 1024));
        }
        ...
        function p5showPublicLink(u) { setDialogMode(2, "公開鏈結", 1, null, '<input type=text style=width:100% value="' + u + '" readonly />'); }
        ...
        function p5setActions() {
            ...
            Q('p5SelectAllButton').value = (cc > 0 ? "沒有" : "所有");
        ...
        function getFileSizeStr(size) { if (size == 1) return "1個位元組"; return format("{0}個字節", size); }
        ...
        function p5createfolder() { setDialogMode(2, "新建檔案夾", 3, p5createfolderEx, '<input type=text id=p5renameinput maxlength=64 onkeyup=p5fileNameCheck(event) style=width:100% />'); focusTextBox('p5renameinput'); p5fileNameCheck(); }
        ...
        function p5deletefile() { var cc = getFileSelCount(), rec = (getFileSelDirCount() > 0) ? '<br /><br /><label><input type=checkbox id=p5recdeleteinput>' + "遞迴刪除" + '</label><br>' : '<input type=checkbox id=p5recdeleteinput style=\'display:none\'>'; setDialogMode(2, "刪除", 3, p5deletefileEx, (cc > 1) ? (format("刪除{0}個所選項目？", cc) + rec) : ("刪除所選項目？" + rec)); }
        ...
        function p5pasteFile() { var x = ''; if ((p5clipboard != null) && (p5clipboard.length > 0)) { x = format("將{1}入口{2}中的{0}限製到此位置？", (p5clipboardCut == 0 ? 'copy' : 'move'), p5clipboard.length, ((p5clipboard.length > 1) ? 's' : '')) } setDialogMode(2, "糊", 3, p5pasteFileEx, x); }
        ...
        function p5updateClipview() { var x = ''; if ((p5clipboard != null) && (p5clipboard.length > 0)) { x = format("保存{0}項目{1}給{2}", p5clipboard.length, ((p5clipboard.length > 1) ? 's' : ''), (p5clipboardCut == 0 ? "複製" : "移動")) + ', <a href=# onclick="return p5clearClip()" style=cursor:pointer>' + "清除" + '</a>.' } QH('p5bottomstatus', x); p5setActions(); }
        ...
        function updateDevices() {
            ...
            for (var i in nodes) {
                ...
                if (sort == 0) {
                    ...
                    if (((meshes[nodes[i].meshid]?nodes[i].meshid:'*') != current)) {
                        deviceHeaderSet();
                        var extra = '';
                        if ((meshes[nodes[i].meshid] != null) && (meshes[nodes[i].meshid].mtype == 1)) { extra = '<span style=color:lightgray>' + "，只適用於Intel&reg; AMT" + '</span>'; }
                        ...
                        if (meshes[nodes[i].meshid]) {
                            ...
                            r += '</span><span id=MxMESH><i>' + "個別裝置" + '</i></span><span id=DevxHeader' + deviceHeaderId + ' style=color:lightgray></span></div>';
                            current = '*';
                        }
            ...
            if ((r == '') && (nodes.length > 0) && (Q('SearchInput').value != '')) {
                viewNothing = true;
                r = '<div style="margin:30px">' + "沒有與此搜索匹配的裝置。" + '</div>';
            }
            ...
            if ((sort == 0) && (Q('SearchInput').value == '')) {
                for (var i in meshes) {
                    ...
                    if ((displayedMeshes[mesh._id] == null) && (IsMeshViewable(mesh))) {
                        ...
                        if (mesh.mtype == 1) { r += '<div style=padding:10px><i>' + "該群中沒有Intel&reg; AMT裝置"; }
                        if (mesh.mtype > 1) { r += '<div style=padding:10px><i>' + "該群中沒有裝置"; }
                        r += '.</i></div></div>';
                        current = mesh._id;
                        count++;
                    }
            ...
            if (count == 0) {
                if ((Q('SearchInput').value != '') || (Q('OnlineCheckBox').checked)) {
                    QH('xdevices', '<div style="margin-top:50px;text-align:center"><span style="font-size:30px">' + "沒有裝置" + '</span><br /><br />' + "沒有與此搜索匹配的裝置。" + ' <a onclick=clearSearchInput() style=cursor:pointer>' + "清除搜索過濾器" + '</a></div>');
                } else {
                    QH('xdevices', '<div style="margin-top:50px;text-align:center"><span style="font-size:30px">' + "沒有裝置" + '</span><br /><br />' + "使用此網站的桌面版本新增裝置。" + '</div>');
                }
            } else {
                QH('xdevices', r);
            }
        ...
        function updateDeviceViewHtml(div, node) {
            ...
            if ((div.offsetTop >= visibleTop) && (div.offsetTop < visibleBottom)) {
                ...
                if (title.length == 0) { title = '<i>' + "沒有" + '</i>'; }
                ...
                if (node.sessions != null) {
                    ...
                    if (node.sessions.battery != null) {
                        ...
                        var statestr = '';
                        if (bat.state == 'ac') { statestr = "裝置已插入"; }
                        else if (bat.state == 'dc') { statestr = "裝置由電池供電"; }
        ...
        function showDeviceHelpRequests(nodeid, force, e) {
            ...
            if (x != '') { setDialogMode(2, "幫助請求" + ' - ' + EscapeHtml(node.name), 1, null, x, 'HELPREQ-' + node._id); } else { setDialogMode(0); }
            return false;
        }
                ...
                if ((i == 'kvm') && (node.sessions.multidesk == null)) {
                    ...
                    for (var j in node.sessions.kvm) {
                        if (j.startsWith('user/')) {
                            var trash = '';
                            if ((j == userinfo._id) || (GetNodeRights(node) == 0xFFFFFFFF)) { trash = ' <a href=# onclick=\'return endDeviceSession("kvm", "' + encodeURIComponentEx(node._id) + '", "' + encodeURIComponentEx(j) + '")\' title="' + "斷開此會話" + '" style=cursor:pointer><img src=images/trash.png border=0 height=10 width=10></a>'; }
                            x += addHtmlValue4(getUserName(j), ((node.sessions.kvm[j] == 1) ? "1節" : nobreak(format("{0}節", node.sessions.kvm[j]))) + trash);
                        } else if (j == 'busy') {
                            x += addHtmlValue2("設備忙", ((node.sessions.kvm[j] == 1) ? "1節" : nobreak(format("{0}節", node.sessions.kvm[j]))));
                        }
                    }
                } else if (i == 'multidesk') {
                    x += '<u>' + "遠程桌面" + '</u>';
                    for (var j in node.sessions.multidesk) {
                        var trash = '';
                        if ((j == userinfo._id) || (GetNodeRights(node) == 0xFFFFFFFF)) { trash = ' <a href=# onclick=\'return endDeviceSession("multidesk", "' + encodeURIComponentEx(node._id) + '", "' + encodeURIComponentEx(j) + '")\' title="' + "斷開此會話" + '" style=cursor:pointer><img src=images/trash.png border=0 height=10 width=10></a>'; }
                        x += addHtmlValue4(getUserName(j), ((node.sessions.multidesk[j] == 1) ? "1節" : nobreak(format("{0}節", node.sessions.multidesk[j]))) + trash);
                    }
                } else if (i == 'terminal') {
                    x += '<u>' + "終端機" + '</u>';
                    for (var j in node.sessions.terminal) {
                        var trash = '';
                        if ((j == userinfo._id) || (GetNodeRights(node) == 0xFFFFFFFF)) { trash = ' <a href=# onclick=\'return endDeviceSession("terminal", "' + encodeURIComponentEx(node._id) + '", "' + encodeURIComponentEx(j) + '")\' title="' + "斷開此會話" + '" style=cursor:pointer><img src=images/trash.png border=0 height=10 width=10></a>'; }
                        x += addHtmlValue4(getUserName(j), ((node.sessions.terminal[j] == 1) ? "1節" : nobreak(format("{0}節", node.sessions.terminal[j]))) + trash);
                    }
                } else if (i == 'files') {
                    x += '<u>' + "檔案" + '</u>';
                    for (var j in node.sessions.files) {
                        var trash = '';
                        if ((j == userinfo._id) || (GetNodeRights(node) == 0xFFFFFFFF)) { trash = ' <a href=# onclick=\'return endDeviceSession("files", "' + encodeURIComponentEx(node._id) + '", "' + encodeURIComponentEx(j) + '")\' title="' + "斷開此會話" + '" style=cursor:pointer><img src=images/trash.png border=0 height=10 width=10></a>'; }
                        x += addHtmlValue4(getUserName(j), ((node.sessions.files[j] == 1) ? "1節" : nobreak(format("{0}節", node.sessions.files[j]))) + trash);
                    }
                } else if (i == 'tcp') {
                    x += '<u>' + "TCP路由" + '</u>';
                    for (var j in node.sessions.tcp) {
                        var trash = '';
                        if ((j == userinfo._id) || (GetNodeRights(node) == 0xFFFFFFFF)) { trash = ' <a href=# onclick=\'return endDeviceSession("tcp", "' + encodeURIComponentEx(node._id) + '", "' + encodeURIComponentEx(j) + '")\' title="' + "斷開此會話" + '" style=cursor:pointer><img src=images/trash.png border=0 height=10 width=10></a>'; }
                        x += addHtmlValue4(getUserName(j), ((node.sessions.tcp[j] == 1) ? "1節" : nobreak(format("{0}節", node.sessions.tcp[j]))) + trash);
                    }
                } else if (i == 'udp') {
                    x += '<u>' + "UDP路由" + '</u>';
                    for (var j in node.sessions.udp) {
                        var trash = '';
                        if ((j == userinfo._id) || (GetNodeRights(node) == 0xFFFFFFFF)) { trash = ' <a href=# onclick=\'return endDeviceSession("udp", "' + encodeURIComponentEx(node._id) + '", "' + encodeURIComponentEx(j) + '")\' title="' + "斷開此會話" + '" style=cursor:pointer><img src=images/trash.png border=0 height=10 width=10></a>'; }
                        x += addHtmlValue4(getUserName(j), ((node.sessions.udp[j] == 1) ? "1節" : nobreak(format("{0}節", node.sessions.udp[j]))) + trash);
                    }
                }
            }
            if (x != '') { setDialogMode(2, "節" + ' - ' + EscapeHtml(node.name), 1, null, x, 'SESSIONS-' + node._id); } else { setDialogMode(0); }
        }
        ...
        function showDeviceMessages(nodeid, force, e) {
            ...
            x += '</div>';
            if (count > 0) setDialogMode(2, "代理訊息" + ' - ' + EscapeHtml(node.name), 1, null, x, 'MESSAGES-' + node._id);
            return false;
        }

        var powerStatetable = ['', "有電源", "休眠", "休眠", "休眠", "冬眠", "關機", "存在", "離開"];
        var powerStateStrings = ['', "有電源", "休眠中", "休眠中", "沉睡", "冬眠", "軟關機", "存在", "離開"];
        var powerStateStrings2 = ['', "裝置已連接電源", "裝置處於睡眠狀態（S1）", "裝置處於睡眠狀態（S2）", "裝置處於深度睡眠狀態（S3）", "裝置正在休眠（S4）", "裝置處於軟關機狀態（S5）", "裝置存在，但無法確定電源狀態", "設備已關機"];
        ...
        function NodeStateStr(node) {
            ...
            if (node.conn) {
                if ((node.conn & 1) != 0) { states.push('<span>' + ((node.mtype == 4) ? ((node.porttype == 'PDU') ? "轉變" : "IP-KVM") : "代理") + '</span>'); }
                if ((node.conn & 2) != 0) { states.push('<span>' + "CIRA" + '</span>'); }
                else if ((node.conn & 4) != 0) { states.push('<span>' + "Intel&reg; AMT" + '</span>'); }
                if ((node.conn & 8) != 0) { states.push('<span>' + "中繼" + '</span>'); }
        ...
        function deviceHeaderSet() {
            ...
            deviceHeaders['DevxHeader' + deviceHeaderId] = ', ' + deviceHeaderTotal + ((deviceHeaderTotal == 1) ? " 節點" : " 節點");
            var title = '';
        ...
        */
        ...
        function gotoDevice(nodeid, panel, refresh) {
            ...
            if (!currentNode || currentNode._id != node._id || refresh == true) {
                ...
                if ((currentNode.sessions != null) && (currentNode.sessions.battery != null)) {
                    ...
                    var statestr = '';
                    if (bat.state == 'ac') { statestr = "裝置已插入"; }
                    if (bat.state == 'dc') { statestr = "裝置由電池供電"; }
                ...
                if (nname.length == 0) { nname = '<i>' + "沒有" + '</i>'; }
                ...
                // Attribute: Mesh
                if (mesh) { x += addDeviceAttribute('<span>' + "群" + '</span>', '<a onclick=goForward("' + node.meshid + '") style=cursor:pointer>' + EscapeHtml(meshes[node.meshid].name) + '</a>'); }

                // Attribute: Name
                if (node.rname != null) { x += addDeviceAttribute('<span>' + "名稱" + '</span>', '<span>' + EscapeHtml(node.rname) + '</span>'); }

                // Attribute: Host
                if ((((features & 1) == 0) && (node.mtype != 4)) || (node.mtype == 3)) { // If not WAN-only, local hostname is in use
                    if ((meshrights & 4) != 0) {
                        if (node.host) {
                            x += addDeviceAttribute("主機名", '<span onclick=showEditNodeValueDialog(1) style=cursor:pointer>' + EscapeHtml(node.host) + '</span>');
                        } else {
                            x += addDeviceAttribute("主機名", '<span onclick=showEditNodeValueDialog(1) style=cursor:pointer><i>' + "沒有" + '</i></span>');
                        }
                    } else {
                        x += addDeviceAttribute("主機名", EscapeHtml(node.host));
                    }
                }

                // Attribute: Description
                var description = node.desc ? EscapeHtml(node.desc) : '<i>' + "沒有" + '</i>';
                if ((meshrights & 4) != 0) {
                ...
                // IP-KVM information
                if (node.mtype == 4) {
                    if (node.portnum != null) { x += addDeviceAttribute("端口號", node.portnum); }
                    if (node.porttype != null) { x += addDeviceAttribute("端口類型", node.porttype); }
                }

                // Attribute: Mesh Agent
                if ((node.agent != null) && (node.agent.id != null) && (node.mtype == 3)) {
                    if (node.agent.id == 4) { x += addDeviceAttribute("設備類型", "視窗"); }
                    if (node.agent.id == 6) { x += addDeviceAttribute("設備類型", "Linux"); }
                    if (node.agent.id == 29) { x += addDeviceAttribute("設備類型", "macOS"); }
                ...
                if (node.intelamt != null) {
                    var str = '';
                    var provisioningStates = { 0: nobreak("未啟動（預）"), 1: nobreak("未啟動（輸入）"), 2: nobreak("已啟動") };
                    if (node.intelamt.ver != null && node.intelamt.state == null) { str += '<i>' + nobreak("未知狀態") + '</i>, v' + EscapeHtml(node.intelamt.ver); }
                    else if ((node.intelamt.ver == null) && (node.intelamt.state == 2)) { str += '<i>' + "已啟動" + '</i>'; }
                    else if ((node.intelamt.ver == null) || (node.intelamt.state == null)) { str += '<i>' + "未知版本和狀態" + '</i>'; }
                    else {
                    ...
                    if (node.intelamt.state == 2) {
                        if (node.intelamt.tls == 1) { str += ', <span title="' + "Intel&reg; AMT已設置TLS網絡安全性" + '">' + "TLS" + '</span>'; }
                        ...
                        if (node.intelamt.user == null || node.intelamt.user == '') { // If credentials are not set, allow setting them.
                            if ((meshrights & 4) != 0) {
                                str += ', <i style=color:#FF0000;cursor:pointer title="' + "編輯Intel&reg; AMT憑證" + '" onclick=editDeviceAmtSettings("' + node._id + '")>' + "沒有憑證" + '</i>';
                                editUserCredentialsIcon = true;
                            } else {
                                str += ', <i style=color:#FF0000>' + "沒有憑證" + '</i>';
                            }
                            ...
                            var warn = null;
                            if ((node.intelamt.warn & 1) != 0) { warn = "無效證件"; }
                            if ((node.intelamt.warn & 8) != 0) { warn = "嘗試憑證"; }
                            if (warn != null) {
                                if ((meshrights & 4) != 0) {
                                    str += ', <i style=color:#FF0000;cursor:pointer title="' + "編輯Intel&reg; AMT憑證" + '" onclick=editDeviceAmtSettings("' + node._id + '")>' + warn + '</i>';
                                    editUserCredentialsIcon = true;
                                } else {
                        ...
                        if (editUserCredentialsIcon) {
                            str += '<img src=images/link4.png height=10 width=10 title="' + "編輯Intel&reg; AMT憑證" + '" style=cursor:pointer onclick=editDeviceAmtSettings("' + node._id + '")>';
                        }
                    }
                    ...
                    */
                    ...
                    if (typeof node.intelamt.sku == 'number') {
                        ...
                        else if ((node.intelamt.sku & 16) != 0) { meName = "Intel&reg; M"; }
                    }
                ...
                if (connectivity && connectivity > 1) {
                    var cstate = [];
                    if ((node.conn & 1) != 0) cstate.push('<span>' + ((node.mtype == 4) ? ((node.porttype == 'PDU') ? "轉變" : "IP-KVM") : "代理") + '</span>');
                    if ((node.conn & 2) != 0) cstate.push('<span>' + "Intel&reg; AMT CIRA" + '</span>');
                    else if ((node.conn & 4) != 0) cstate.push('<span>' + "Intel&reg; AMT" + '</span>');
                    if ((node.conn & 8) != 0) cstate.push('<span>' + "代理中繼" + '</span>');
                    if ((node.conn & 16) != 0) cstate.push('<span>' + "MQTT" + '</span>');
                    x += addDeviceAttribute("連接性", cstate.join(', '));
                }

                // Node tags
                var groupingTags = '<i>' + "沒有" + '</i>';
                if (node.tags != null) { groupingTags = ''; for (var i in node.tags) { groupingTags += '<span class=tagSpan>' + EscapeHtml(node.tags[i]) + '</span> '; } }
                if ((meshrights & 4) != 0) {
                    x += addDeviceAttribute("標籤", '<span onclick=showEditNodeValueDialog(3) style=cursor:pointer;color:black>' + groupingTags + '</span>');
                } else {
                    x += addDeviceAttribute("標籤", '<span style=line-height:26px;color:black>' + groupingTags + '</span>');
                }
                ...
                if ((node.ssh != null) || (node.rdp != null)) {
                    var y = [];
                    if ((meshrights & 4) != 0) {
                        if (node.ssh != null) { y.push('<span onclick=showClearSshDialog(3) style=cursor:pointer>' + ((node.ssh == 1) ? "SSH-用戶+密碼" : ((node.ssh == 2) ? "SSH-用戶+密鑰+密碼" : "SSH-用戶+密鑰")) + ' <img class=hoverButton src="images/link5.png" width=10 height=10 /></span>'); }
                        ...
                        if (node.ssh != null) { y.push(((node.ssh == 1) ? "SSH-用戶+密碼" : ((node.ssh == 2) ? "SSH-用戶+密鑰+密碼" : "SSH-用戶+密鑰"))); }
                        if (node.rdp != null) { y.push("RDP"); }
                    }
                    x += addDeviceAttribute("證書", y.join(', '));
                }

                x += '</table><br />';
                // Show action button, only show if we have permissions 4, 8, 64
                if (((meshrights & (4 + 8 + 64 + 262144)) != 0) && (node.mtype < 3)) { x += '<input type=button value="' + "動作" + '" onclick=deviceActionFunction() />'; }
                x += '<input type=button value="' + "筆記" + '" onclick=showNotes(' + ((meshrights & 128) == 0) + ',"' + encodeURIComponent(node._id) + '") />';
                ...
                if ((node.mtype == 4) && (connectivity & 1)) {
                    if (node.porttype == 'PDU') {
                        if (node.pwr == 1) {
                            if (meshrights & 0x40000) { x += '<input type=button value="' + "關掉" + '" title="' + "關掉" + '" onclick=setIpPduState(0) />'; }
                        } else if (node.pwr == 8) {
                            if (meshrights & 0x40) { x += '<input type=button value="' + "打開" + '" title="' + "打開" + '" onclick=setIpPduState(1) />'; }
                        }
                    } else {
                        if (meshrights & 8) { x += '<input type=button value="' + "遙控" + '" title="' + "遙控" + '" onclick=openIpKvmRemoteControl("' + encodeURIComponentEx(node._id) + '") />'; }x
                    }
                }
                ...
                if ((meshrights & 0x8000) != 0) { x += '<a style=cursor:pointer onclick=p10showDeleteNodeDialog("' + node._id + '")>' + "刪除裝置" + '</a>'; }
                ...
                if ((connectivity & 1) != 0) { if (powerstate.length > 0) { powerstate += ', '; } powerstate += ((node.mtype == 4) ? ((node.porttype == 'PDU') ? "轉變" : "IP-KVM") : "Mesh Agent"); }
                if ((connectivity & 2) != 0) { if (powerstate.length > 0) { powerstate += ', '; } powerstate += "Intel &reg;AMT已連接"; }
                else if ((connectivity & 4) != 0) { if (powerstate.length > 0) { powerstate += ', '; } powerstate += "檢測到Intel&reg; AMT"; }
                if ((connectivity & 16) != 0) { if (powerstate.length > 0) { powerstate += ', '; } powerstate += "MQTT通道已連接"; }
        ...
        function setIpPduState(op) {
            if (op == 0) {
                setDialogMode(2, "電源操作", 3, function () { meshserver.send({ action: 'poweraction', nodeids: [currentNode._id], actiontype: 2 }); }, "執行斷電？"); // Turn off
            } else {
                setDialogMode(2, "電源操作", 3, function () { meshserver.send({ action: 'wakedevices', nodeids: [currentNode._id] }); }, "執行開機？"); // Turn on
            }
        }
        ...
        function deviceToastFunction() {
            if (xxdialogMode) return;
            setDialogMode(2, "裝置吐司", 3, deviceToastFunctionEx, '<textarea id=d2devToast style=width:100%;height:80px;resize:none;overflow-y:scroll></textarea>');
        }
        ...
        function setupDeviceMenu(op, obj) {
            ...
            ) { menus.push({ n: "終端機", f: 'setupDeviceMenu(5)' }); }

            if ((currentDevicePanel != 2) && (currentNode != null) && (meshrights & 8) && ((meshrights == 0xFFFFFFFF) || ((meshrights & 1024) == 0)) && ((currentNode.mtype != 1) && (currentNode.agent) && (currentNode.agent.caps & 4))) { menus.push({ n: "檔案", f: 'setupDeviceMenu(2)' }); }
            if ((currentDevicePanel != 3) && (currentNode != null) && (currentNode.mtype < 3) && ((meshrights & 1048576) != 0)) { menus.push({ n: "細節", f: 'setupDeviceMenu(3)' }); }
        ...
        function deviceActionFunction() {
            ...
            if ((currentNode.agent != null) && (currentNode.agent.id == 14)) {
                if (((currentNode.conn & 1) != 0) && ((rights & 8) != 0)) {
                    count++;
                    y += '<option value=400>' + "閃光" + '</option>';
                    y += '<option value=401>' + "顫動" + '</option>';
                    z += '<div id=d2devicetimediv>' + addHtmlValue("時間", '<select id=d2devicetime style=float:right;width:170px><option value=1000>' + "1秒" + '</option><option value=5000>' + "5秒" + '</option><option value=10000>' + "10 秒" + '</option></select>') + '</div>';
                }
            } else {
                if ((rights & 64) != 0) { count++; y += '<option value=100>' + "喚醒" + '</option>'; } // Wake-up permission
                //if (((currentNode.conn & 1) != 0) && ((rights & 131072) != 0)) { count++; y += '<option value=106>' + "Run Commands" + '</option>'; } // Remote command permission
                if ((currentNode.conn != 0) && ((rights & 262144) != 0)) { count++; y += '<option value=4>' + "休眠" + '</option><option value=3>' + "重設" + '</option><option value=2>' + "關機" + '</option>'; }
                ...
                if ((currentNode.intelamt != null) && (currentNode.intelamt.state == 2) && ((currentNode.conn & 6) != 0) && ((rights & 262144) != 0)) {
                    count++;
                    y += '<option value=310>' + "英特爾&reg; AMT 重置" + '</option>';
                    y += '<option value=308>' + "英特爾&reg; AMT 關機" + '</option>';
                }
                if ((currentNode.intelamt != null) && (currentNode.intelamt.state == 2) && ((currentNode.conn & 6) != 0) && ((rights & 64) != 0)) {
                    count++;
                    y += '<option value=302>' + "英特爾&reg; AMT 開機" + '</option>';
                }
            ...
            y += '</select>';
            x += addHtmlValue("操作", y);
            if (count == 0) { x = "該設備當前無可用操作。"; }
            setDialogMode(2, "裝置指令", (count == 0) ? 2 : 3, deviceActionFunctionEx, x + z);
        ...
        function deviceActionFunctionEx() {
            ...
            if (op == 100) {
                ...
                */
                ...
                setDialogMode(2, "英特爾&reg; AMT 電源操作", 3, function () { meshserver.send({ action: 'poweraction', nodeids: [currentNode._id], actiontype: parseInt(op) }); }, "執行英特爾&reg; AMT 開機？");
            } else if (op == 308) { // Intel AMT power off
                setDialogMode(2, "英特爾&reg; AMT 電源操作", 3, function () { meshserver.send({ action: 'poweraction', nodeids: [currentNode._id], actiontype: parseInt(op) }); }, "Perform Intel&reg; AMT power off?<br><br><b>NOTE: If there is an active AMT session, then power off command will be rejected, so you must disconnect from the AMT session first!</b>");
            } else if (op == 310) { // Intel AMT reset
                setDialogMode(2, "英特爾&reg; AMT 電源操作", 3, function () { meshserver.send({ action: 'poweraction', nodeids: [currentNode._id], actiontype: parseInt(op) }); }, "執行英特爾&reg; AMT 重置？");
        ...
        function showNotes(readonly, noteid) {
            ...
            if (noteid.startsWith('node%2F%2F')) { x += '<span style=font-size:10px>' + "其他裝置群管理員可以查看和更改裝置群註釋。" + '<span>'; }
            setDialogMode(2, "筆記", 3, showNotesEx, x, noteid);
        ...
        function deviceLockFunction() {
            if ((xxdialogMode != null || xxdialogMode == 0) && (desktop != null) && (desktop.contype == 1)) { setDialogMode(2, "鎖定桌面", 3, function() { if ((desktop != null) && (desktop.contype == 1)) { desktop.sendCtrlMsg('{"ctrlChannel":"102938","type":"lock"}'); } }, "鎖定用戶桌面？"); }
        }

        function deviceChat(e) {
            if (xxdialogMode) return;
            setDialogMode(2, "裝置指令", 3, function () {
        ...
        function deviceUrlFunction() {
            if (xxdialogMode) return;
            setDialogMode(2, "在裝置上打開頁面", 3, deviceUrlFunctionEx, '<input id=d2devurl placeholder="http://server.com" style=width:100%;overflow-y:scroll onkeyup=deviceUrlFunctionValidate() onchange=deviceUrlFunctionValidate()></input>');
            Q('d2devurl').focus();
        ...
        function d2runCommandDialog(options) {
            ...
            if ((wintype == true) || (linuxtype == true) || (agenttype == true)) {
                ...
                if (linuxtype == true) { x += '<option value=3' + ((runopt.type == 3)?' selected':'') + '>' + "Linux / BSD / macOS命令外殼" + '</option>'; }
                ...
                x += '</select>';
                x += '<select id=d2cmduser style=width:100%;margin-bottom:4px><option value=0' + ((runopt.runAs == 0)?' selected':'') + '>' + "以代理身份運行" + '</option><option value=1' + ((runopt.runAs == 1)?' selected':'') + '>' + "以用戶身份運行，如果沒有用戶，則運行代理" + '</option><option value=2' + ((runopt.runAs == 2)?' selected':'') + '>' + "必須以用戶身份運行" + '</option></select>';
                ...
                setDialogMode(2, "運行命令", 3, d2groupActionFunctionRunCommands, x, options);
                if (options.selectedFile == null) {
                    Q('d2runcmd').focus();
        ...
        function editDeviceAmtSettings(nodeid, func) {
            ...
            x += addHtmlValue("用戶名", '<input id=dp10username style=width:170px maxlength=32 autocomplete=nope placeholder="admin" onchange=validateDeviceAmtSettings() onkeyup=validateDeviceAmtSettings() />');
            x += addHtmlValue("密碼", '<input id=dp10password type=password style=width:170px autocomplete=nope maxlength=32 onchange=validateDeviceAmtSettings() onkeyup=validateDeviceAmtSettings() />');
            // Only display the TLS setting if the Intel AMT manager is not running on the server. With the manager TLS is auto-detected.
            if ((features2 & 1) == 0) { x += addHtmlValue("安全", '<select id=dp10tls style=width:176px><option value=0>' + "沒有TLS加密" + '</option><option value=1>' + "需要TLS加密" + '</option></select>'); }
            if ((node.intelamt.user != null) && (node.intelamt.user != '')) { buttons = 7; }
            setDialogMode(2, "編輯Intel&reg; AMT憑證", buttons, editDeviceAmtSettingsEx, x, { node: node, func: func });
        ...
        function p10showDeleteNodeDialog(nodeid) {
            if (xxdialogMode) return;
            setDialogMode(2, "刪除節點", 3, p10showDeleteNodeDialogEx, format("刪除{0}？", EscapeHtml(currentNode.name)) + '<br /><br /><label><input id=p10check type=checkbox onchange=p10validateDeleteNodeDialog() />' + "確認" + '</label>', nodeid);
        ...
        function showEditNodeValueDialog(mode) {
            ...
            setDialogMode(2, "編輯裝置", 3, showEditNodeValueDialogEx, x, mode);
        ...
        var agentConsoleMessages = ['', "正在等待用戶授予訪問權限...", "被拒絕", "無法啟動遠程終端接合{0}（{1}）", "超時", "收到無效的網絡數據"];
        ...
        function showDesktopSettings() {
            ...
            applyDesktopSettings();
            updateDesktopButtons();
            setDialogMode(7, "遠程桌面設置", 3, showDesktopSettingsChanged);
        }
        ...
        var keyStrings = { 8: "退格", 9: "Tab", 13: "輸入", 27: "逃脫", 32: "Space", 44: "打印屏幕", 45: "插入", 46: "Del", 36: "家", 35: "結尾", 32: "Espace", 33: "向上翻頁", 34: "向下翻頁", 37: "左", 38: "上", 39: "右", 40: "下", 0: "沒有" }
        ...
        function sendSpecialKeys() {
            if (xxdialogMode || desktop == null || desktop.State != 3) return;
            setDialogMode(3, "特殊鍵", 3, deskSendKeys);
        }
        ...
        function deskSelectScreens() {
            ...
            setDialogMode(2, "屏幕選擇", 3, deskSelectScreensEx, x);
        }
        ...
        function cmsshportaction(action) {
            if (xxdialogMode) return;
            var x = "SSH遠程連接端口：" + '<br /><br /><input type=text placeholder="22" inputmode="numeric" pattern="[0-9]*" onkeypress="return (event.keyCode == 8) || (event.charCode >= 48 && event.charCode <= 57)" maxlength=5 id=d10sshport type=text>';
            setDialogMode(2, "SSH 連接", 3, function () {
        ...
        function sshTunnelAuthDialog(j, func) {
            var x = '';
            if (j.askkeypass) {
                x += addHtmlValue("驗證", '<select id=dp2authmethod style=width:150px onchange=sshAuthUpdate(event)><option value=3 selected>' + "存儲密鑰" + '</option><option value=1>' + "用戶名密碼" + '</option><option value=2>' + "用戶名和密鑰" + '</option></select>');
            } else {
                x += addHtmlValue("驗證", '<select id=dp2authmethod style=width:150px onchange=sshAuthUpdate(event)><option value=1 selected>' + "用戶名密碼" + '</option><option value=2>' + "用戶名和密鑰" + '</option></select>');
            }
            x += '<div id=d2userauth style=display:none>';
            x += addHtmlValue("用戶名", '<input id=dp2user style=width:150px maxlength=64 autocomplete=off onkeyup=sshAuthUpdate(event) />');
            x += '</div>';
            x += '<div id=d2passauth style=display:none>';
            x += addHtmlValue("密碼", '<input type=password id=dp2pass style=width:150px maxlength=64 autocomplete=off onkeyup=sshAuthUpdate(event) />');
            if ((features2 & 0x00400000) == 0) { x += '<label><input id=dp2keep type=checkbox>' + "記住憑據" + '</label>'; }
            x += '</div><div id=d2keyauth style=display:none>';
            x += addHtmlValue("密鑰文件", '<input type=file id=dp2key style=width:150px maxlength=64 autocomplete=off onchange=sshAuthUpdate(event) />' + '<div id=d2badkey style=font-size:x-small>' + "密鑰文件必須是 OpenSSH 格式。" + '</div>');
            x += addHtmlValue("密鑰密碼", '<input type=password id=dp2keypass style=width:150px maxlength=64 autocomplete=off onkeyup=sshAuthUpdate(event) />');
            if ((features2 & 0x00400000) == 0) {
                x += '<label><input id=dp2keep1 type=checkbox onchange=sshAuthUpdate(event)>' + "記住用戶和密鑰" + '</label><br/>';
                x += '<label><input id=dp2keep2 type=checkbox>' + "記住密碼" + '</label>';
            }
            x += '</div>';
            if (j.askkeypass) {
                x += '<div id=d2keyauth2 style=display:none>';
                x += addHtmlValue("密碼", '<input type=password id=dp2keypass2 style=width:150px maxlength=64 autocomplete=off onkeyup=sshAuthUpdate(event) />');
                x += '</div>';
            }
            setDialogMode(2, "驗證", 11, func, x, 'ssh');
            Q('dp2user').focus();
            sshAuthUpdate();
            ...
            if (typeof data == 'string') {
                if (data[0] == '{') {
                    ...
                    switch (j.action) {
                        ...
                        case 'autherror': { p12setConsoleMsg("授權錯誤", 5000); break; }
                        case 'sessionerror': { p12setConsoleMsg("會話已過期", 5000); break; }
                        case 'sessiontimeout': { p12setConsoleMsg("會話超時", 5000); break; }
                    }
                } else if (data[0] == '~') {
        ...
        */
        ...
        function p13gotFiles(data) {
            ...
            switch (data.action) {
                ...
                case 'autherror': { p13setConsoleMsg("授權錯誤", 5000); return; }
                case 'connectionerror': { p13setConsoleMsg("連接錯誤", 5000); return; }
                case 'sessionerror': { p13setConsoleMsg("會話已過期", 5000); return; }
                case 'sessiontimeout': { p13setConsoleMsg("會話超時", 5000); return; }
            }
        ...
        function p13setActions() {
            ...
            if (p13filetree == null) {
                ...
                Q('p13SelectAllButton').value = (cc > 0 ? "沒有" : "所有");
        ...
        function p13createfolder() { setDialogMode(2, "新建檔案夾", 3, p13createfolderEx, '<input type=text id=p13renameinput maxlength=64 onkeyup=p13fileNameCheck(event) style=width:100% />'); focusTextBox('p13renameinput'); p13fileNameCheck(); }
        ...
        function p13deletefile() { var cc = p13getFileSelCount(), rec = (p13getFileSelDirCount() > 0) ? '<br /><br /><label><input type=checkbox id=p13recdeleteinput>' + "遞迴刪除" + '</label><br>' : '<input type=checkbox id=p13recdeleteinput style=\'display:none\'>'; setDialogMode(2, "刪除", 3, p13deletefileEx, (cc > 1) ? (format("刪除{0}個所選項目？", cc) + rec) : ("刪除所選項目？" + rec)); }
        ...
        function p13uploadFile() { setDialogMode(2, "上載檔案", 3, p13uploadFileEx, '<input type=file name=files id=p13uploadinput style=width:100% multiple=multiple onchange="updateUploadDialogOk(\'p13uploadinput\')" />'); updateUploadDialogOk('p13uploadinput'); }
        ...
        function p13viewfile() {
            ...
            for (var i = 0; i < checkboxes.length; i++) {
                if (checkboxes[i].checked) {
                    ...
                    } else { messagebox("檔案編輯器", "只能編輯小於200k的檔案。"); }
                    break;
                }
            }
        }
        ...
        function p13pasteFile() {
            ...
            if ((p13clipboard != null) && (p13clipboard.length > 0)) {
                if (p13clipboardCut == 0) {
                    if (p13clipboard.length > 1) { x = format("確認{0}個條目的副本到此位置？", p13clipboard.length); } else { x = format("確認將1個副本複製到此位置？"); }
                } else {
                    if (p13clipboard.length > 1) { x = format("確認將{0}個條目移到該位置？", p13clipboard.length); } else { x = format("確認將1個條目移動到此位置？"); }
                }
            }
            setDialogMode(2, "糊", 3, p13pasteFileEx, x);
        }
            ...
            if ((p13clipboard != null) && (p13clipboard.length > 0)) {
                if (p13clipboardCut == 0) {
                    if (p13clipboard.length > 1) {
                        x = format("保留{0}個項目進行複製" + ', <a href=# onclick="return p13clearClip()" style=cursor:pointer>' + "清除" + '</a>.', p13clipboard.length);
                    } else {
                        x = format("保存1個項目進行複製" + ', <a href=# onclick="return p13clearClip()" style=cursor:pointer>' + "清除" + '</a>.');
                    }
                } else {
                    if (p13clipboard.length > 1) {
                        x = format("保存{0}個項目以進行移動" + ', <a href=# onclick="return p13clearClip()" style=cursor:pointer>' + "清除" + '</a>.', p13clipboard.length);
                    } else {
                        x = format("保存1個項目進行移動" + ', <a href=# onclick="return p13clearClip()" style=cursor:pointer>' + "清除" + '</a>.');
                    }
                }
            }
        ...
        function p13downloadfile(x, y, z) {
            ...
            setDialogMode(2, "下載檔案", 10, p13downloadFileCancel, '<div>' + EscapeHtml(downloadFile.file) + '</div><br /><progress id=d2progressBar style=width:100% value=0 max=' + z + ' />');
        }
        ...
        */
        ...
        function p13doUploadFiles(files) {
            ...
            if (overWriteCount == 0) {
                ...
                setDialogMode(2, "上載檔案", 3, p13uploadFileContinue, format((overWriteCount == 1) ? "上傳將覆蓋1個檔案。繼續？" : "上傳將覆蓋{0}個檔案。繼續？", overWriteCount), files);
            }
        }
        ...
        function p13uploadFileContinue(b, files) {
            ...
            setDialogMode(2, "上載檔案", 10, p13uploadFileCancel, '<div id=p13dfileName>' + "正在連線..." + '</div><br /><progress id=d2progressBar style=width:100% value=0 max=0 />');
            p13uploadNextFile();
        }
        ...
        function updateDeviceDetails(node, hardware, network) {
            ...
            // Operating System
            var x = '';
            if (node.rname) { x += addDetailItem("名稱", EscapeHtml(node.rname), s); }
            ...
            if (node.osdesc) { x += addDetailItem("版", EscapeHtml(node.osdesc), s); }
            if (hardware.windows && hardware.windows.osinfo) {
                var m = hardware.windows.osinfo;
                if (m.OSArchitecture) {
                    if (m.OSArchitecture.startsWith('32')) { x += addDetailItem("結構", "32 位", s); }
                    else if (m.OSArchitecture.startsWith('64')) { x += addDetailItem("結構", "64 位", s); }
                    else { x += addDetailItem("結構", EscapeHtml(m.OSArchitecture), s); }
                }
                if(m.LastBootUpTime){
                    var thedate = {
                ...
                if(m.Domain){ x += addDetailItem((m.PartOfDomain ? "域" : "工作群組"), EscapeHtml(m.Domain), s); }
            }
            ...
            if (node.wsc) {
                var y = [];
                if (node.wsc.antiVirus != null) { if (node.wsc.antiVirus == 'OK') { y.push("視聽" + ' - <span style=color:green>' + "OK" + '</span>'); } else { y.push("視聽" + ' - <span style=color:red>' + "壞的" + '</span>'); } }
                if (node.wsc.autoUpdate != null) { if (node.wsc.autoUpdate == 'OK') { y.push("更新資料" + ' - <span style=color:green>' + "OK" + '</span>'); } else { y.push("更新資料" + ' - <span style=color:red>' + "壞的" + '</span>'); } }
                if (node.wsc.firewall != null) { if (node.wsc.firewall == 'OK') { y.push("防火牆" + ' - <span style=color:green>' + "OK" + '</span>'); } else { y.push("防火牆" + ' - <span style=color:red>' + "壞的" + '</span>'); } }
                x += addDetailItem("Windows 安全", y.join(', '));
            }

            // Defender for Windows Server
            if(node.defender) {
                var y = [];
                if (node.defender.RealTimeProtection != null) { if (node.defender.RealTimeProtection == true) { y.push("RealTimeProtection" + ' - <span style=color:green>' + "On" + '</span>'); } else { y.push("RealTimeProtection" + ' - <span style=color:red>' + "離開" + '</span>'); } }
                if (node.defender.TamperProtected != null) { if (node.defender.TamperProtected == true) { y.push("TamperProtection" + ' - <span style=color:green>' + "On" + '</span>'); } else { y.push("TamperProtection" + ' - <span style=color:red>' + "離開" + '</span>'); } }
                if (node.defender.AntivirusSignatureVersion != null) { y.push("簽名版本" + ' - <span style=color:green>' + EscapeHtml(node.defender.AntivirusSignatureVersion) + '</span>'); }
            ...
            if (node.av && node.av.length > 0) {
                ...
                for (var i in node.av) {
                    if (node.av[i].product) {
                        ...
                        if (node.av[i].updated !== true) { avx += ' - <span style=color:red>' + "過時的" + '</span>'; }
                        if ((node.av[i].enabled == true) && (node.av[i].updated == true)) { avx += ' - <span style=color:green>' + "OK" + '</span>'; }
                        y.push(avx);
                    }
                }
                x += addDetailItem("防毒軟體", y.join('<br />'));
            }

            // Active Users
           if (node.users && node.users.length > 0) {
                var u = node.users.map(function(user) {
                    return addKeyLinkConditional(EscapeHtml(user), "已鎖定", (node.lusers && node.lusers.indexOf(user) >= 0));
                }).join(', ');
                x += addDetailItem((node.users.length > 1 ? "活躍用戶" : "活躍用戶"), u);
            }

            if (x != '') { sections.push({ name: "操作系統", html: x, img: 'software' }); }
            ...
            if (node.agent) {
                ...
                if (node.firstconnect) { x += addDetailItem("首次代理連接", printDateTime(new Date(node.firstconnect))); }
                if ((node.conn & 1) != 0) {
                    x += addDetailItem("上次代理連接", "現在已連接");
                } else {
                    if (node.lastconnect) { x += addDetailItem("上次代理連接", printDateTime(new Date(node.lastconnect))); }
                }
                if (node.lastaddr) {
                ...
                if (hardware.agentvers != null) {
                    if (hardware.agentvers.compileTime) {
                        try {
                            ...
                            x += addDetailItem("編譯時間", printDateTime(new Date(d)));
                        } catch (ex) { }
                    }
                }
                if (hardware.time != null) {
                    x += addDetailItem("最後詳細信息更新", printDateTime(new Date(hardware.time)));
                }
            ...
            if (hardware.mobile) {
                ...
                if (hardware.mobile.device) { x += addDetailItem("裝置", EscapeHtml(hardware.mobile.device), s); }
                if (hardware.mobile.bootloader) { x += addDetailItem("引導加載程序", EscapeHtml(hardware.mobile.bootloader), s); }
                if (hardware.mobile.id) { x += addDetailItem("識別符", EscapeHtml(hardware.mobile.id), s); }
                if (hardware.mobile.host) { x += addDetailItem("主機名", EscapeHtml(hardware.mobile.host), s); }
                ...
                if (x != '') { sections.push({ name: "移動設備", html: x, img: 'mobile' }); }
            }
            ...
            if (network.netif2 != null) {
                ...
                for (var i in network.netif2) {
                    ...
                    if (typeof m[0].mac == 'string') {
                        if (m[0].gatewaymac) {
                            x += addDetailItem("MAC層", format("MAC：{0}，網關：{1}", EscapeHtml(m[0].mac), EscapeHtml(m[0].gatewaymac)));
                        } else {
                            x += addDetailItem("MAC層", format("MAC：{0}", EscapeHtml(m[0].mac)));
                        }
                    }
                    if (typeof m[0].speed == 'number' && (m[0].speed != 9223372036854775807 && m[0].speed > 0)) {
                        x += addDetailItem("介面速度", format("{0}", getNetworkSpeed(m[0].speed)));
                    }
                    for (var j = 0; j < m.length; j++) {
                        var iplayer = m[j], items = [];
                        if (iplayer.address) { items.push(format("IP：{0}", EscapeHtml(iplayer.address))); }
                        if (iplayer.netmask) { items.push(format("掩碼：{0}", EscapeHtml(iplayer.netmask))); }
                        if (iplayer.gateway) { items.push(format("網關：{0}", EscapeHtml(iplayer.gateway))); }
                        if (items.length > 0) {
                            if (iplayer.family == 'IPv4') { x += addDetailItem("IPv4層", items.join("，")); }
                            if (iplayer.family == 'IPv6') { x += addDetailItem("IPv6層", items.join("，")); }
                        }
                    }
                    x += '</div></td></tr>';
                }
                ...
                x += '</table>';
                if (x != '') { sections.push({ name: "網路", html: x, img: 'networking' }); }
            }

            // Attribute: Intel AMT
            if (node.intelamt != null) {
                var x = '';
                x += addDetailItem("版", (node.intelamt.ver) ? ('v' + EscapeHtml(node.intelamt.ver)) : ('<i>' + "未知" + '</i>'), s);
                x += addDetailItem("識別符", (node.intelamt.uuid) ? (EscapeHtml(node.intelamt.uuid)) : ('<i>' + "未知" + '</i>'), s);
                var provisioningStates = { 0: nobreak("未啟動（預）"), 1: nobreak("未啟動（輸入）"), 2: nobreak("已啟動") };
                var provisioningMode = '';
                if ((node.intelamt.state == 2) && node.intelamt.flags) { if (node.intelamt.flags & 2) { provisioningMode = (', ' + "客戶端控制模式（CCM）"); } else if (node.intelamt.flags & 4) { provisioningMode = (', ' + "管理員控制模式（ACM）"); } }
                x += addDetailItem("配置狀態", ((node.intelamt.state) ? (provisioningStates[node.intelamt.state]) : ('<i>' + "未知" + '</i>')) + provisioningMode, s);
                x += addDetailItem("安全", (node.intelamt.tls == 1) ? "已使用TLS保安" : "未設置TLS", s);
                // Check that the Intel AMT user is setup and there is no warnings (1 = invalid credentials, 8 = trying)
                x += addDetailItem("管理員憑證", ((node.intelamt.user) == null || (node.intelamt.user == '') || ((node.intelamt.warn != null) && ((node.intelamt.warn & 9) != 0))) ? "未知" : "已知的", s);
                if (x != '') {
                    if ((typeof node.intelamt.sku == 'number') && ((node.intelamt.sku & 16) != 0)) {
                        sections.push({ name: "英特爾&reg; 標準可管理性（英特爾&reg; SM）", html: x, img: 'amt' });
                    } else {
            ...
            if (hardware.identifiers) {
                ...
                // BIOS
                if (ident.bios_vendor) { x += addDetailItem("供應商", EscapeHtml(ident.bios_vendor), s); }
                if (ident.bios_version) { x += addDetailItem("版", EscapeHtml(ident.bios_version), s); }
                if (ident.bios_serial) { x += addDetailItem("序列號", EscapeHtml(ident.bios_serial), s); }
                if (ident.bios_mode) { x += addDetailItem("Mode", EscapeHtml(ident.bios_mode), s); }
                if (x != '') { sections.push({ name: "的BIOS", html: x, img: 'chip' }); }

                // Motherboard
                x = '';
                if (ident.board_vendor) { x += addDetailItem("供應商", EscapeHtml(ident.board_vendor), s); }
                if (ident.board_name) { x += addDetailItem("名稱", EscapeHtml(ident.board_name), s); }
                if (ident.board_serial && (ident.board_serial != '')) { x += addDetailItem("序列號", EscapeHtml(ident.board_serial), s); }
                if (ident.board_version) { x += addDetailItem("版", EscapeHtml(ident.board_version), s); }
                if (ident.product_uuid) { x += addDetailItem("識別符", EscapeHtml(ident.product_uuid), s); }
            ...
            if (hardware.tpm) {
                ...
                if (tpm.ManufacturerId) { x += addDetailItem("識別符", EscapeHtml(tpm.ManufacturerId), s); }
                if (tpm.ManufacturerVersion) { x += addDetailItem("版", EscapeHtml(tpm.ManufacturerVersion), s); }
                if (tpm.IsActivated != null) { x += addDetailItem("已啟動", (tpm.IsActivated ? "Yes" : "No"), s); }
                if (tpm.IsEnabled != null) { x += addDetailItem("已啟用", (tpm.IsEnabled ? "Yes" : "No"), s); }
                if (tpm.IsOwned != null) { x += addDetailItem("擁有", (tpm.IsOwned ? "Yes" : "No"), s); }
            ...
            if (hardware.battery) {
                ...
                for (var i in hardware.battery) {
                    ...
                    if (battery.CycleCount) { x += addDetailItem("循環計數", EscapeHtml(battery.CycleCount), s); }
                    if (battery.FullChargedCapacity) { x += addDetailItem("滿電容量", format("{0} mWh", battery.FullChargedCapacity), s); }
                    if (battery.EstimatedRuntime) { x += addDetailItem("預計運行時間", format("{0} 分鐘", Math.floor((battery.EstimatedRuntime / 60))), s); }
                    if (battery.Chemistry) { x += addDetailItem("化學", EscapeHtml(battery.Chemistry), s); }
                    if (battery.DesignedCapacity) { x += addDetailItem("設計容量", format("{0} mWh", battery.DesignedCapacity), s); }
                    if (battery.ManufactureDate) { x += addDetailItem("生產日期", EscapeHtml(battery.ManufactureDate), s); }
                    if (battery.ManufactureName) { x += addDetailItem("製造商名稱", EscapeHtml(battery.ManufactureName), s); }
                    if (battery.SerialNumber) { x += addDetailItem("序號", EscapeHtml(battery.SerialNumber), s); }
                    if (battery.ChargeRate) { x += addDetailItem("收費率", format("{0} mW", battery.ChargeRate), s); }
                    if (battery.Charging != null) { x += addDetailItem("收費", (battery.Charging ? "Yes" : "No"), s); }
                    ...
                    if (battery.RemainingCapacity) { x += addDetailItem("剩餘容量", format("{0} mWh", battery.RemainingCapacity), s); }
                    if (battery.Voltage) { x += addDetailItem("電壓", format("{0} V", (battery.Voltage / 1000)), s); }
                    if (battery.Health) { x += addDetailItem("健康", format("{0} %", battery.Health), s); }
                    if (battery.BatteryCharge) { x += addDetailItem("電池充電", format("{0} %", battery.BatteryCharge), s); }   
                    x += '</div>';
                }
                x += '</table>';
                if (x != '') { sections.push({ name: "電池", html: x, img: 'battery'}); }
            }
            ...
            if (hardware.windows) {
                if (hardware.windows.memory && (hardware.windows.memory.length > 0)) {
                    ...
                    for (var i in hardware.windows.memory) {
                        ...
                        if (m.PartNumber) { x += addDetailItem("零件號", EscapeHtml((m.Manufacturer && m.Manufacturer != 'Undefined') ? (m.Manufacturer + ', ') : '') + EscapeHtml(m.PartNumber), s); }
                        x += '</div>';
                    }
                    x += '</table>';

                    if (x != '') { sections.push({ name: "記憶體", html: x, img: 'ram' }); }
                }
            }
            ...
            if (hardware.darwin) {
                if (hardware.darwin.memory && (hardware.darwin.memory.length > 0)) {
                    ...
                    for (var i in hardware.darwin.memory) {
                        ...
                        if (m.PartNumber) { x += addDetailItem("零件號", EscapeHtml((m.Manufacturer && m.Manufacturer != '')?(m.Manufacturer + ', '):'') + EscapeHtml(m.PartNumber), s); }
                        x += '</div>';
                    }
                    x += '</table>';
                    if (x != '') { sections.push({ name: "記憶體", html: x, img: 'ram'}); }
            ...
            if (hardware.identifiers && ident.storage_devices) {
                ...
                for (var i in ident.storage_devices) {
                    ...
                    if (m.Size) {
                        ...
                        if(hardware.windows && hardware.windows.drives && m.Model){
                            ...
                            if(foundObject) x += addDetailItem("狀態", EscapeHtml(foundObject.Status), s);
                        }
                        x += '</div>';
                    }
                }
                ...
                if (x != '') { sections.push({ name: "儲存", html: x, img: 'storage' }); }
            }
            ...
            if (hardware.windows && hardware.windows.volumes) {
                ...
                for (var i in hardware.windows.volumes) {
                    ...
                    if (m.sizeremaining) {
                        ...
                        x += addDetailItem("剩餘容量", EscapeHtml(fsize), s);
                    }
                    if (m.type) {
                    ...
                    if (m.protectionStatus || m.volumeStatus) {
                        var bitlockerState = [];
                        if (m.protectionStatus) bitlockerState.push("已啟用");
            ...
            if (hardware.darwin && hardware.darwin.volumes) {
                ...
                for (var i in hardware.darwin.volumes) {
                    ...
                    if (m.available) {
                        x += addDetailItem("剩餘容量", EscapeHtml(m.available), s);
                    }
                    if (m.type) {
                        var type = (m.removable == true ? "Removable" : (m.cdrom == true ? "CD-ROM" : ''));
                        x += addDetailItem("File System", (type != '' ? (type + ' / ') : '') + (m.type == 'Unknown' ? "未知" : EscapeHtml(m.type)), s);
        ...
        function deviceDetailsShowBitlockerInfo(drive, identifier, password) {
            if (xxdialogMode) return false;
            var x = '<div><p>' + "識別符" + '</p><p style=user-select:text;font-weight:bold>' + (identifier ? decodeURIComponent(identifier) : "未知") + '</p>';
        ...
        */
        ...
        function setupConsole() {
            ...
            if ((rights & 16) != 0) {
                ...
                var onlineText = ((consoleNode.conn & 1) != 0) ? "代理在線" : "代理離線"
                if ((consoleNode.conn & 16) != 0) { onlineText += "，MQTT在線" }
        ...
        function p15uploadCore(e) {
            ...
            if (e.shiftKey == true) { meshserver.send({ action: 'uploadagentcore', nodeid: consoleNode._id, type: 'default' }); } // Upload default core
                ...
                var htmlValue = '<select id=d3coreMode style=width:230px>' +
                    '<option value=1>' + "上載默認伺服器核心" + '</option>' +
                    '<option value=2>' + "清除核心" + '</option>' +
                    '<option value=3>' + "上載核心檔案" + '</option>' +
                    '<option value=4>' + "軟斷開代理" + '</option>' +
                    '<option value=5>' + "強行斷開代理" + '</option>' +
                    '<option value=6>' + "上傳恢復核心" + '</option>' +
                    '<option value=7>' + "上傳小核心" + '</option>' +
                    '<option value=8>' + "Restart agent service" + '</option>' +
                    '<option value=9>' + "強制代理更新" + '</option></select>';
                setDialogMode(2, "執行代理指令", 3, p15uploadCoreEx, addHtmlValue("指令", htmlValue));
            }
        }
        ...
        function p15uploadCore2() {
            ...
            Q('d3auth').value = authCookie;
            Q('d3attrib').value = currentNode._id;
            setDialogMode(4, "上載mesh agent核心", 3, p15uploadCoreEx2);
            d3init();
        }
        ...
        function p20updateMesh() {
            ...
            if (currentMesh.mtype == 1) meshtype = "僅限Intel&reg; AMT，無代理";
            if (currentMesh.mtype == 2) meshtype = "使用軟體代理進行管理";
            if (currentMesh.mtype == 3) { if (currentMesh.relayid == null) { meshtype = "本地設備，無代理"; } else { meshtype = "沒有代理設備通過代理中繼"; } }
            if (currentMesh.mtype == 4) { if (currentMesh.relayid == null) { meshtype = "IP-KVM 設備"; } else { meshtype = "通過代理中繼的 IP-KVM 設備"; } if (currentMesh.kvm.model == 1) { meshtype += ', ' + 'Raritan KX III'; } }

            var x = '';
            x += addHtmlValue("名稱", addLinkConditional(EscapeHtml(currentMesh.name), 'p20editmesh(1)', (meshrights & 1) != 0));
            x += addHtmlValue("描述", addLinkConditional(((currentMesh.desc && currentMesh.desc != '') ? EscapeHtml(currentMesh.desc) : ('<i>' + "沒有" + '</i>')), 'p20editmesh(2)', (meshrights & 1) != 0));
            x += addHtmlValue("類型", meshtype);
            ...
            if (((currentMesh.mtype == 3) || (currentMesh.mtype == 4)) && (currentMesh.relayid != null)) {
                ...
                x += addHtmlValue("繼電器裝置", addLinkConditional(relayName, 'p20editmeshrelay()', (meshrights & 1) != 0));
            }

            // Display IP-KVM information if needed
            if (currentMesh.mtype == 4) {
                x += addHtmlValue("主機名", currentMesh.kvm.host);
                x += addHtmlValue("用戶名", currentMesh.kvm.user);
            }

            x += '<br><input type=button value="' + "筆記" + '" onclick=showNotes(false,"' + encodeURIComponent(currentMesh._id) + '") />';

            x += '<br style=clear:both><br>';
            var currentMeshLinks = currentMesh.links[userinfo._id];
            if (currentMeshLinks && ((currentMeshLinks.rights & 2) != 0)) { x += '<div style=margin-bottom:6px;float:left;margin-right:10px><a onclick=p20showAddMeshUserDialog() style=cursor:pointer><img src=images/icon-addnew.png border=0 height=12 width=12> ' + "新增用戶" + '</a></div>'; }

            if (navigator.userAgent.toLowerCase().indexOf('android') >= 0) {
                x += '<div style=margin-bottom:6px;float:left;margin-right:10px><a onclick=p20installAndroidDialog() style=cursor:pointer><img src=images/icon-addnew.png border=0 height=12 width=12> ' + "在此設備上安裝" + '</a></div>';
            }
            ...
            */
            ...
            x += '<table style="color:black;background-color:#EEE;border-color:#AAA;border-width:1px;border-style:solid;border-collapse:collapse" border=0 cellpadding=2 cellspacing=0 width=100%><tbody><tr style=background-color:#AAAAAA;font-weight:bold><th scope=col style=text-align:left;width:430px>' + "用戶授權" + '</th></tr>';
            ...
            for (var i in sortedusers) {
                var trash = '', rights = "部分權限", r = sortedusers[i].rights, icon = 2;
                if (r == 0xFFFFFFFF) rights = "完整管理員"; else if (r == 0) rights = "沒有權利";
            ...
            if (meshrights == 0xFFFFFFFF) { x += '<div style=font-size:small;text-align:right;margin-top:6px><span><a onclick=p20showDeleteMeshDialog() style=cursor:pointer>' + "刪除群組" + '</a></span></div>'; }
        ...
        function p20showDeleteMeshDialog() {
            if (xxdialogMode) return false;
            var x = format("你確定要刪除群{0}嗎？刪除裝置群還將刪除該群中有關裝置的所有訊息。", EscapeHtml(currentMesh.name)) + '<br /><br />';
            x += '<label><input id=p20check type=checkbox onchange=p20validateDeleteMeshDialog() />' + "確認" + '</label>';
            setDialogMode(2, "刪除群組", 3, p20showDeleteMeshDialogEx, x);
        ...
        function p20editmeshrelay() {
            ...
            if (relayDevices.length == 0) {
                ...
                setDialogMode(2, "編輯裝置群", 1, null, "沒有可用的中繼設備。");
            } else {
                var relayDevices2 = [];
                ...
                var x = addHtmlValue("繼電器裝置", '<div style=width:170px><select id=d2devrelay style=width:100%>' + relayDevices2.join('') + '</select></div>');
                setDialogMode(2, "編輯裝置群", 3, p20editmeshrelayEx, x);
            }
        }
        ...
        function p20editmesh(focus) {
            if (xxdialogMode) return;
            var x = addHtmlValue("名稱", '<input id=dp20meshname style=width:170px maxlength=32 onchange=p20editmeshValidate() onkeyup=p20editmeshValidate() />');
            x += addHtmlValue("描述", '<input id=dp20meshdesc style=width:170px maxlength=1024 onkeyup=p20editmeshValidate() />');
            setDialogMode(2, "編輯裝置群", 3, p20editmeshEx, x);
        ...
        function p20installAndroidDialog() {
            if (xxdialogMode) return;
            var x = '<div style=text-align:center><p>' + "在您的 Android 設備上安裝 MeshCentral Agent。安裝後，單擊配對鏈接將您的設備連接到此服務器。" + '</p>';
            ...
            x += '<p><a href="' + serverinfo.magenturl + ',' + serverinfo.agentCertHash + ',' + currentMesh._id.split('/')[2] + '"><b>' + "設備配對鏈接" + '</b></a></p></div>';
            setDialogMode(2, "安卓安裝", 1, null, x);
        }
        ...
        function p20showAddMeshUserDialog() {
            ...
            x += '<label><input type=checkbox onchange=p20validateAddMeshUserDialog() id=p20fulladmin>' + "完整管理員" + '</label><br>';
            x += '<label><input type=checkbox onchange=p20validateAddMeshUserDialog() id=p20editmesh>' + "編輯裝置群" + '</label><br>';
            x += '<label><input type=checkbox onchange=p20validateAddMeshUserDialog() id=p20manageusers>' + "管理裝置群用戶" + '</label><br>';
            x += '<label><input type=checkbox onchange=p20validateAddMeshUserDialog() id=p20managecomputers>' + "管理裝置群電腦" + '</label><br>';
            x += '<label><input type=checkbox onchange=p20validateAddMeshUserDialog() id=p20remotecontrol>' + "遙控" + '</label><br>';
            x += '<label><input type=checkbox onchange=p20validateAddMeshUserDialog() id=p20remoteview style=margin-left:12px>' + "僅遠程查看" + '</label><br>';
            x += '<label><input type=checkbox onchange=p20validateAddMeshUserDialog() id=p20remotelimitedinput style=margin-left:12px>' + "僅有限輸入" + '</label><br>';
            x += '<label><input type=checkbox onchange=p20validateAddMeshUserDialog() id=p20noterminal style=margin-left:12px>' + "不能訪問終端" + '</label><br>';
            x += '<label><input type=checkbox onchange=p20validateAddMeshUserDialog() id=p20nofiles style=margin-left:12px>' + "不能存取檔案" + '</label><br>';
            x += '<label><input type=checkbox onchange=p20validateAddMeshUserDialog() id=p20noamt style=margin-left:12px>' + "沒有Intel&reg; AMT" + '</label><br>';
            x += '<label><input type=checkbox onchange=p20validateAddMeshUserDialog() id=p20meshagentconsole>' + "網格代理控制台" + '</label><br>';
            x += '<label><input type=checkbox onchange=p20validateAddMeshUserDialog() id=p20meshserverfiles>' + "伺服器檔案" + '</label><br>';
            x += '<label><input type=checkbox onchange=p20validateAddMeshUserDialog() id=p20wakedevices>' + "喚醒裝置" + '</label><br>';
            x += '<label><input type=checkbox onchange=p20validateAddMeshUserDialog() id=p20editnotes>' + "編輯裝置筆記" + '</label><br>';
            x += '<label><input type=checkbox onchange=p20validateAddMeshUserDialog() id=p20limitevents>' + "只顯示自己的事件" + '</label><br>';
            x += '<label><input type=checkbox onchange=p20validateAddMeshUserDialog() id=p20chatnotify>' + "聊天並通知" + '</label><br>';
            x += '<label><input type=checkbox onchange=p20validateAddMeshUserDialog() id=p20uninstall>' + "卸載代理" + '</label><br>';
            x += '<label><input type=checkbox onchange=p20validateAddMeshUserDialog() id=p20commands>' + "遠程命令" + '</label><br>';
            x += '<label><input type=checkbox onchange=p20validateAddMeshUserDialog() id=p20resetoff>' + "重置/關閉電源" + '</label><br>';
            x += '</div>';
            setDialogMode(2, "將用戶新增到裝置群", 3, p20showAddMeshUserDialogEx, x);
        ...
        function p20viewuser(userid) {
            ...
            if (meshrights == 0xFFFFFFFF) r.push("完整管理員"); else {
                if ((meshrights & 1) != 0) r.push("編輯裝置群");
                if ((meshrights & 2) != 0) r.push("管理裝置群用戶");
                if ((meshrights & 4) != 0) r.push("管理裝置群電腦");
                if ((meshrights & 8) != 0) r.push("遙控");
                if ((meshrights & 16) != 0) r.push("代理控制台");
                if ((meshrights & 32) != 0) r.push("伺服器檔案");
                if ((meshrights & 64) != 0) r.push("喚醒裝置");
                if ((meshrights & 128) != 0) r.push("編輯筆記");
                if ((meshrights & 256) != 0) r.push("僅遠程查看");
                if ((meshrights & 512) != 0) r.push("沒有終端");
                if ((meshrights & 1024) != 0) r.push("沒有檔案");
                if ((meshrights & 2048) != 0) r.push("沒有Intel&reg; AMT");
                if (((meshrights & 8) != 0) && ((meshrights & 4096) != 0) && ((meshrights & 256) == 0)) r.push("有限輸入");
                if ((meshrights & 8192) != 0) r.push("僅自我事件");
                if ((meshrights & 16384) != 0) r.push("聊天並通知");
                if ((meshrights & 32768) != 0) r.push("卸載");
                if ((meshrights & 131072) != 0) r.push("指令");
                if ((meshrights & 262144) != 0) r.push("重置/關閉");
            }
            if (r.length == 0) { r.push("沒有權利"); }
            var buttons = 1, uname = userid.split('/')[2];
            if (currentMesh.links[userid].name) { uname = currentMesh.links[userid].name; }
            var x = addHtmlValue("用戶名", EscapeHtml(uname));
            if (uname != userid.split('/')[2]) { x += addHtmlValue("用戶識別碼", EscapeHtml(userid.split('/')[2])); }
            x += addHtmlValue("權限", r.join("，"));
            if (((userinfo._id) != userid) && (cmeshrights == 0xFFFFFFFF || (((cmeshrights & 2) != 0) && (meshrights != 0xFFFFFFFF)))) buttons += 4;
            setDialogMode(2, "裝置群用戶", buttons, p20viewuserEx, x, userid);
        }
        ...
        function p20viewuserEx(button, userid) {
            ...
            setDialogMode(2, "遠程網格用戶", 3, p20viewuserEx2, format("確認刪除用戶{0}？", uname), userid);
        }
        ...
        function drawNotifications() {
            ...
            if (notifications.length == 0) {
                r = '<div style=margin:5px>' + "目前沒有任何通知" + '</div>';
            } else {
                for (var i in notifications) {
                    ...
                    r += '<div title="' + format("發生在{0}", printDateTime(d)) + '" id="notifyx' + n.id + '" class=notification style="cursor:pointer;border-top:1px solid ' + ((r == '') ? 'transparent' : 'orange') + '">';
        ...
        function addNotification(n) {
            ...
            var translatedMessages = [
                ...
                "達到帳戶限制。", // 10
                "聊天請求，點擊這裡接受。",
                "自上次登錄以來，此帳戶有 {0} 次登錄嘗試失敗。",
                "更改電子郵件地址失敗，另一個帳戶已在使用：{0}。",
                "電郵已發送。",
                "未找到用戶 {0}。",
                "未找到用戶 {0}。",
                "錯誤，無法更改為以前使用的密碼。",
        ...
        function getFileSizeStr(size) { if (typeof size != 'number') { size = 0; } if (size == 1) return "1個位元組"; return format('{0} bytes', size); }
