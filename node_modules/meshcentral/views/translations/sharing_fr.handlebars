<!DOCTYPE html><html lang="fr" dir="ltr" xmlns="http://www.w3.org/1999/xhtml"><head>
    ...
    <div id="LeftSideToolBar" style="display:none;position:absolute;left:0;bottom:0;width:52px;top:0;background:#113962;background:linear-gradient(to bottom, #104893 0%,#113962 100%);color:white;border-right: 5px solid #BBB;">
        <div id="LeftMenuDesktop" class="slbbutton slbbuttonsel2" title="Bureau" onclick="go(11)">
        ...
        <div id="LeftMenuFiles" class="slbbutton" title="Dossiers" onclick="go(13)">
        ...
        <div id="deskarea0">
            <div id="deskarea1" class="areaHead" style="line-height:24px">
                <div class="toright2">
                    ...
                    <div class="deskareaicon" title="Basculer le mode d'affichage" onclick="toggleAspectRatio(1)">⇲</div>
                    <div class="deskareaicon" title="Tourne à gauche" onclick="drotate(-1)">↺</div>
                    <div class="deskareaicon" title="Tourner à droite" onclick="drotate(1)">↻</div>
                    <input id="deskActionsSettings" type="button" value="Paramètres..." title="Modifier les paramètres du bureau distant" onkeypress="return false" onkeydown="return false" onclick="showDesktopSettings()" class="mR">
                    <div id="desktopCustomUiButtons" style="float:left"></div>
                    <div id="deskRecordIcon" class="deskareaicon" title="Session en cours d'enregistrement" style="display:none;background-color:red;width:12px;height:12px;border-radius:6px;margin-top:5px"></div>
                </div>
                <div>
                    <div id="idx_deskFullBtn2" onclick="deskToggleFull(event)">&nbsp;✖</div>
                    <input type="button" id="autoconnectbutton1" value="Connection automatique" onclick="autoConnectDesktop(event)" onkeypress="return false" onkeydown="return false" style="display:none">
                    <span id="connectbutton1span"><input type="button" id="connectbutton1" cmenu="deskConnectButton" value="Se connecter" onclick="connectDesktop(event,3)" onkeypress="return false" onkeydown="return false" disabled="disabled"></span>
                    <span id="connectbutton1hspan">&nbsp;<input type="button" id="connectbutton1h" value="Connexion AMT" title="Connectez-vous à l'aide du KVM matériel Intel AMT" onclick="connectDesktop(event,2)" onkeypress="return false" onkeydown="return false" disabled="disabled"></span>
                    <span id="disconnectbutton1span">&nbsp;<input type="button" id="disconnectbutton1" value="Déconnecter" onclick="connectDesktop(event,0)" onkeypress="return false" onkeydown="return false"></span>
                    &nbsp;<span id="deskstatus">Débranché</span><span id="deskmetadata"></span>
                </div>
            </div>
            ...
            <div id="deskarea4" class="areaFoot" style="min-height:24px">
                <div class="toright2">
                    <span id="DeskLatency" style="line-height:22px;width:50px" title="Latence de la session de bureau"></span>
                    <span id="DeskTimer" style="line-height:22px" title="Temps de session"></span>&nbsp;
                    ...
                    <span id="DeskSaveImageButton" title="Enregistrer une capture d'écran du bureau distant"><img src="images/icon-camera.png" onclick="deskSaveImage()" height="16" width="16" style="padding-top:2px"></span>
                </div>
                <div style="height:22px">
                    <select id="deskkeys">
                        ...
                        <option value="11">Win+Gauche</option>
                        <option value="12">Win+Droite</option>
                    </select>
                    <input id="DeskWD" type="button" value="Envoyer" onkeypress="return false" onkeydown="return false" onclick="deskSendKeys()">
                    <input id="DeskClip" style="" type="button" value="Presse-papiers" onkeypress="return false" onkeydown="return false" onclick="showDeskClip()">
                    <input id="DeskType" style="" type="button" value="Type" onkeypress="return false" onkeydown="return false" onclick="showDeskType()">
                    <label><span id="DeskControlSpan" title="Basculer la souris et le clavier"><input id="DeskControl" type="checkbox" onkeypress="return false" onkeydown="return false" onclick="toggleKvmControl()">Entrée</span></label>&nbsp;
                </div>
            </div>
        </div>
    </div>
    <div id="p12" class="noselect" style="overflow:hidden;position:absolute;left:54px;top:0;right:0;bottom:0;display:none;background-color:black">
        <div id="p12warning" onclick="showFeaturesDlg()">
            <div class="icon2"></div>
            <div class="warningbox">Le port de redirection Intel® AMT ou la fonctionnalité KVM est désactivé<span id="p12warninga">, cliquez ici pour l'activer</span></div>
        </div>
        ...
        <div class="areaHead" style="position:absolute;top:0;left:0;right:0;height:24px">
            <div class="toright2">
                <div id="termRecordIcon" class="deskareaicon" title="Session en cours d'enregistrement" style="display:none;background-color:red;width:12px;height:12px;border-radius:6px;margin-top:5px;margin-left:5px"></div>
                <div id="p12power" style="margin-top:3px;margin-right:4px;float:right"></div>
            </div>
            <div>
                <span id="connectbutton2span"><input type="button" id="connectbutton2" cmenu="termConnectButton" value="Se connecter" onclick="connectTerminal(event,1)" onkeypress="return false" onkeydown="return false" disabled="disabled"></span>
                <span id="disconnectbutton2span">&nbsp;<input type="button" id="disconnectbutton2" value="Déconnecter" onclick="connectTerminal(event,0)" onkeypress="return false" onkeydown="return false"></span>
        ...
        <div class="areaFoot" style="position:absolute;bottom:0;left:0;right:0;height:24px">
            <div class="toright2">
                <span id="TermLatency" title="Latence de la session du terminal"></span>
                <span id="TermTimer" title="Temps de session"></span>&nbsp;
                <span id="terminalSettingsButtons" style="display:none">
                    <input id="id_tcrbutton" type="button" onkeypress="return false" onkeydown="return false" class="bottombutton" value="CR+LF" title="Inverser ce que la touche retour enverra" onclick="termToggleCr()">
                    <input id="id_tfxkeysbutton" type="button" onkeypress="return false" onkeydown="return false" class="bottombutton" value="Intel (F10 = ESC + [OM)" title="Basculer le type d'émulation des touches F1 à F10" onclick="termToggleFx()">
                    <input id="id_ttypebutton" type="button" onkeypress="return false" onkeydown="return false" class="bottombutton" value="Ascii étendu" title="Basculer le type d'émulation de terminal" onclick="termToggleType()">
                </span>
                ...
                <span id="specialKeyDropDown">
                    ...
                    <input id="specialkeylistinput" type="button" onkeypress="return false" class="bottombutton" value="Envoyer" title="Envoyer la clé sélectionnée" onclick="sendSpecialKey()">
                </span>
            </div>
            <div>
                &nbsp;
                ...
                <input type="button" onkeypress="return false" onkeydown="return false" class="bottombutton" id="bsbutton" value="Retour arrière" onclick="termSendKey(8,'bsbutton')" style="display:none">
                <input type="button" onkeypress="return false" onkeydown="return false" class="bottombutton" id="pastebutton" value="Coller" title="Coller du texte dans le terminal" onclick="showTermPasteDialog()" style="display:none">
            </div>
        </div>
    ...
    <div id="p13" class="noselect" style="overflow:hidden;position:absolute;left:54px;top:0;right:0;bottom:0;display:none;background-color:white">
        <div id="p13toolbar" style="position:absolute;left:0;top:0;right:0;bottom:28px">
            <div class="areaHead">
                <div class="toright2">
                    <div id="filesRecordIcon" class="deskareaicon" title="Session en cours d'enregistrement" style="display:none;background-color:red;width:12px;height:12px;border-radius:6px;margin-top:5px;margin-left:5px"></div>
                    <div id="p13power" style="margin-top:3px;margin-right:4px;float:right"></div>
                </div>
                <div>
                    <input id="p13Connect" value="Se connecter" onclick="connectFiles(event)" type="button">
            ...
            <div id="fileArea2" class="areaHead2" valign="bottom">
                ...
                <div>
                    <input type="button" id="p13FolderUp" disabled="disabled" onclick="p13folderup()" value="Parent">&nbsp;
                    <input type="button" id="p13SelectAllButton" disabled="disabled" onclick="p13selectallfile()" value="Tout Sélectionner">&nbsp;
                    <input type="button" id="p13RenameFileButton" disabled="disabled" value="Renommer" onclick="p13renamefile()">&nbsp;
                    <input type="button" id="p13DeleteFileButton" disabled="disabled" value="Supprimer" onclick="p13deletefile()">&nbsp;
                    <input type="button" id="p13ViewFileButton" disabled="disabled" value="Modifier" onclick="p13viewfile()">&nbsp;
                    <input type="button" id="p13NewFolderButton" disabled="disabled" value="Nouveau Dossier" onclick="p13createfolder()">&nbsp;
                    <input type="button" id="p13UploadButton" disabled="disabled" value="Téléverser" onclick="p13uploadFile()">&nbsp;
                    <input type="button" id="p13CutButton" disabled="disabled" value="Couper" onclick="p13copyFile(1)">&nbsp;
                    <input type="button" id="p13CopyButton" disabled="disabled" value="Copier" onclick="p13copyFile(0)">&nbsp;
                    ...
                    <input type="button" id="p13FindButton" disabled="disabled" value="Rechercher" onclick="p13findfile()">&nbsp;
                </div>
            </div>
    ...
    <div id="dialog" class="noselect" style="display:none">
        ...
        <div id="dialogBody">
            ...
            <div id="dialog4" style="">
                <input id="d4WrapButton" type="button" value="Envelopper" onclick="d4ToggleWrap()">
                <input id="d4SizeButton" type="button" value="Petit" onclick="d4ToggleSize()">
                <input id="d4EncodingButton" type="button" value="Brut" onclick="d4ToggleEncoding()">
            ...
            <div id="dialog7" style="">
                <div id="d7meshkvm">
                    <h4>Bureau distant - Configuration de l'agent</h4>
                    <div>
                        <div>Qualité</div>
                        <select id="d7bitmapquality" dir="rtl"></select>
                    </div>
                    <div>
                        <div>Mise à l'échelle</div>
                    ...
                    <div>
                        <div>Taux de rafraîchissement</div>
                    ...
                    <div id="d7desktopOtherSettings">
                        ...
                        <div id="d7otherset2" style="display:block">
                            <label style="display:block"><input type="checkbox" id="d7deskSwapMouse">Echanger les boutons de la souris</label>
                            <label style="display:block"><input type="checkbox" id="d7deskRemoteKeyMap">Utiliser la configuration du clavier distant</label>
                        </div>
                    </div>
                </div>
                <div id="d7amtkvm">
                    ...
                    <div>
                        ...
                        <div id="d7otherset" style="display:block">
                            <label style="display:block"><input type="checkbox" id="d7showfocus">Afficher l'outil de mise au point</label>
                            <label style="display:block"><input type="checkbox" id="d7showcursor">Afficher le curseur local</label>
                            <label style="display:block"><input type="checkbox" id="d7localKeyMap">Carte du clavier local</label>
                        </div>
                    </div>
                </div>
            </div>
    ...
    <script>
        ...
        function updateMetadata(conn, elementid) {
            ...
            if (conn && (conn.State == 3)) {
                ...
                if (viewerCount > 1) { str = '<span onclick=showSessionMetadata(1) style=cursor:pointer>' + format(", {0} regarde", viewerCount) + '</span>'; }
            }
            QH('deskmetadata', str);
        ...
        function showSessionMetadata(cid) {
            ...
            if (conn && conn.metadata) {
                var x = '';
                if (conn.metadata.startTime) { x += addHtmlValue4("Heure de démarrage", printDateTime(new Date(conn.metadata.startTime))); }
                if (conn.metadata.users) {
                    for (var i in conn.metadata.users) {
                        var val = (conn.metadata.users[i] == 1) ? "1 connexion" : format("{0} connexions", conn.metadata.users[i]);
                        var username = i.split('/')[2];
                        if ((users != null) && (users[i] != null)) { username = users[i].name; }
                        x += addHtmlValue4(format("Utilisateur \"{0}\"", username), val);
                    }
                }
                setDialogMode(2, "Information de session", 1, null, x, 'sessionMetadata' + cid);
            }
        }
        ...
        function showDeskType() {
            if (xxdialogMode || desktop == null || desktop.State != 3) return;
            Q('DeskType').blur();
            var x = '<div>' + "Entrer le texte et cliquer sur OK pour le saisir avec un clavier américain. Vérifier avant la position du curseur distant." + '<div>';
        ...
        */
        ...
        function deskSaveImage() {
            if (xxdialogMode || desktop == null || desktop.State != 3) return;
            var d = new Date(), n = "Bureau" + '-' + d.getFullYear() + '-' + ('0' + (d.getMonth() + 1)).slice(-2) + '-' + ('0' + d.getDate()).slice(-2) + '-' + ('0' + d.getHours()).slice(-2) + '-' + ('0' + d.getMinutes()).slice(-2);
        ...
        var terminalEmulations = ["Terminal UTF8", "ASCII étendu", "Intel ASCII"];
        ...
        var fxEmulations = ["Intel (F10 = ESC + [OM)", "Alternative (F10 = ESC+0)", "VT100 + (F10 = ESC + [OY)"];
        ...
        function onFilesStateChange(xfiles, state) {
            p13Connect.value = (state == 0) ? "Se connecter" : "Déconnecter";
        ...
        function p13gotFiles(data) {
            ...
            if (data.action == 'findfile') {
                if (xxdialogTag == data.reqid) {
                    if (data.r == null) {
                        ...
                        xxdialogTag = null;
                        if (Q('d2findResults').innerHTML == '') { QH('d2findResults', '<div style=text-align:center;margin:10px><i>' + "Aucun fichier trouvé" + '</i></div>'); }
                    } else {
            ...
            if (data.action == 'dialogmessage') {
                if ((data.msg == null) && (xxdialogTag == 'fileMsgDialog')) {
                    ...
                    setDialogMode(2, "Opération sur les fichiers", 10, p13fileOperationDialogEx, '<div style=margin:10px>' + "Compression des fichiers ..." + '<div>', 'fileMsgDialog');
                } else if ((data.msg == 'zippingFile') && ((!xxdialogMode) || (xxdialogTag == 'fileMsgDialog'))) {
                    // Show the dialog box message
                    setDialogMode(2, "Opération sur les fichiers", 10, p13fileOperationDialogEx, '<div style=margin:10px>' + EscapeHtml(data.file) + '<div><br /><progress value=' + EscapeHtml(data.progress) + ' style=width:100% max=100 />', 'fileMsgDialog');
                }
                return;
            }
        ...
        function p13findfile() {
            ...
            x += '<div style=margin-top:8px><input id=filefind_dlgCancelButton type=button value=' + "Fermer" + ' style=float:right;width:80px;margin-left:5px onclick=p13findfileCancel()>';
            x += '<input id=filefind_dlgOkButton type=submit value=' + "Chercher" + ' style=float:right;width:80px onclick=p13findfileEx()><br /><br /></div>';
            setDialogMode(2, "Recherche des fichiers", 0, null, x);
            p13findfileValidate();
            Q('d2findFilter').focus();
        }

        function p13findfileDown(e) { if (e.code == "Entrer") { p13findfileEx(); } }
        ...
        function p13zipFiles() {
            ...
            setDialogMode(2, "Nom de fichier Zip", 3, p13zipFilesEx, '<input type=text id=p13renameinput maxlength=64 onkeyup=p13fileNameCheck(event) style=width:100% value="" />', { action: 'zip', path: p13filetreelocation.join('/'), files: inputFiles });
        ...
        function p13downloadfile(x, y, z, tag) {
            ...
            setDialogMode(2, "Télécharger le fichier", 10, p13downloadFileCancel, '<div>' + gdownloadFile.file + '</div><br /><progress id=d2progressBar style=width:100% value=0 max=' + z + ' />');
        }
        ...
        function d4ToggleWrap(update) {
            ...
            Q('d4WrapButton').value = ["Enveloppement: ON", "Envelopper: OFF"][d4EditWrapVal];
        ...
        function d4ToggleSize(update) {
            ...
            Q('d4SizeButton').value = ["Taille : 100%", "Taille : 125%", "Taille : 150%", "Taille : 200%"][d4EditSizeVal];
        ...
        function d4ToggleEncoding(update) {
            ...
            Q('d4EncodingButton').value = ["Encodage : RAW","Encodage : UTF8"][d4EditEncodingVal];
        ...
        function printFlexDateTime(d) { if (printDate(new Date()) == printDate(d)) { return format("Expire à {0}", printTime(d)); } else { return format("Expire le {0}", printDateTime(d)); } }
        function getFileSizeStr(size) { if (typeof size != 'number') { size = 0; } if (size == 1) return "1 octet"; return format("{0} octets", size); }
