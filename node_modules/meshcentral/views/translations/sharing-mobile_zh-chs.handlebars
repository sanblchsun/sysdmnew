<!DOCTYPE html><html lang="zh-chs" dir="ltr" xmlns="http://www.w3.org/1999/xhtml"><head>
                        ...
                        <div id="termTable" style="position:absolute;top:0;bottom:0;left:0;right:0">
                            <div id="termarea1">
                                <div class="areaHead" style="line-height:24px">
                                    ...
                                    <div>
                                        <span id="connectbutton2span" style="margin-left:3px"><input type="button" id="connectbutton2" cmenu="termConnectButton" value="连接" style="height:28px" onclick="connectTerminal(event,1)" onkeypress="return false" onkeydown="return false" disabled="disabled"></span>
                            ...
                            <tbody><tr>
                                <td style="background-color:#C0C0C0;border-bottom:2px solid black;padding:2px;line-height:24px">
                                    ...
                                    <div style="margin-left:2px">
                                        ...
                                        <input id="p13Connect" value="连接" onclick="connectFiles(event)" onkeypress="return false" onkeydown="return false" type="button">
    ...
    <script>
        ...
        function setupDeviceMenu(op, obj) {
            ...
            if (features & 1) { menus.push({ n: "终端", f: 'setupDeviceMenu(5)', s: (currentDevicePanel == 5) }); }
            if (features & 4) { menus.push({ n: "档案", f: 'setupDeviceMenu(2)', s: (currentDevicePanel == 2) }); }
        ...
        var keyStrings = { 8: "退格", 9: "Tab", 13: "输入", 27: "逃脱", 44 : "打印屏幕", 45: "插", 46: "Del", 36: "家", 35: "结尾", 33: "向上翻页", 34: "向下翻页", 37: "左", 38: "上", 39: "右", 40: "下", 0: "没有" }
                ...
                if (data[0] == '{') {
                    ...
                    switch (j.action) {
                        case 'sshauth': {
                            ...
                            x += addHtmlValue("密钥文件", '<input type=file id=dp2key style=width:150px maxlength=64 autocomplete=off onchange=sshAuthUpdate(event) />');
                            ...
                            x += '</div>';
                            x += '<label><input id=dp2keep type=checkbox>' + "记住凭据" + '</label>';
                            x += '<div id=d2keyauth2 style=font-size:x-small><br />' + "密钥文件必须是 OpenSSH 格式。" + '</div>';
                            setDialogMode(2, "验证", 11, sshConnectEx, x, 'ssh');
        ...
        function p13gotFiles(data) {
            ...
            switch (data.action) {
                case 'sshauth': {
                    ...
                    x += '<label><input id=dp2keep type=checkbox>' + "记住凭据" + '</label>';
                    x += '<div id=d2keyauth2 style=font-size:x-small><br />' + "密钥文件必须是 OpenSSH 格式。" + '</div>';
                    setDialogMode(2, "验证", 11, p13sshConnectEx, x, 'ssh');
                    setTimeout(sshAuthUpdate, 50);
                    break;
                }
        ...
        function p13downloadfile(x, y, z) {
            ...
            setDialogMode(2, "下载文件", 10, p13downloadFileCancel, '<div>' + downloadFile.file + '</div><br /><progress id=d2progressBar style=width:100% value=0 max=' + z + ' />');
        }
