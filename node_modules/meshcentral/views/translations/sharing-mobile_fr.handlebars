<!DOCTYPE html><html lang="fr" dir="ltr" xmlns="http://www.w3.org/1999/xhtml"><head>
                        ...
                        <div id="termTable" style="position:absolute;top:0;bottom:0;left:0;right:0">
                            <div id="termarea1">
                                <div class="areaHead" style="line-height:24px">
                                    ...
                                    <div>
                                        <span id="connectbutton2span" style="margin-left:3px"><input type="button" id="connectbutton2" cmenu="termConnectButton" value="Se connecter" style="height:28px" onclick="connectTerminal(event,1)" onkeypress="return false" onkeydown="return false" disabled="disabled"></span>
                            ...
                            <tbody><tr>
                                <td style="background-color:#C0C0C0;border-bottom:2px solid black;padding:2px;line-height:24px">
                                    ...
                                    <div style="margin-left:2px">
                                        ...
                                        <input id="p13Connect" value="Se connecter" onclick="connectFiles(event)" onkeypress="return false" onkeydown="return false" type="button">
    ...
    <script>
        ...
        function setupDeviceMenu(op, obj) {
            ...
            var menus = [];
            if (features & 2) { menus.push({ n: "Bureau", f: 'setupDeviceMenu(1)', s: (currentDevicePanel == 1) }); }
            if (features & 1) { menus.push({ n: "Terminal", f: 'setupDeviceMenu(5)', s: (currentDevicePanel == 5) }); }
            if (features & 4) { menus.push({ n: "Dossiers", f: 'setupDeviceMenu(2)', s: (currentDevicePanel == 2) }); }
        ...
        var keyStrings = { 8: "Backspace", 9: "Tab", 13: "Entrer", 27: "Echap", 44 : "Impression écran", 45: "Insérer", 46: "Suppr", 36: "Home", 35: "Fin", 33: "Haut de page", 34: "Bas de page", 37: "Gauche", 38: "Parent", 39: "Droit", 40: "Bas", 0: "Aucun" }
                ...
                if (data[0] == '{') {
                    ...
                    switch (j.action) {
                        case 'sshauth': {
                            ...
                            x += addHtmlValue("Fichier de la clé", '<input type=file id=dp2key style=width:150px maxlength=64 autocomplete=off onchange=sshAuthUpdate(event) />');
                            ...
                            x += '</div>';
                            x += '<label><input id=dp2keep type=checkbox>' + "Mémoriser les identifiants" + '</label>';
                            x += '<div id=d2keyauth2 style=font-size:x-small><br />' + "La clé doit être au format OpenSSH" + '</div>';
                            setDialogMode(2, "Authentification", 11, sshConnectEx, x, 'ssh');
        ...
        function p13gotFiles(data) {
            ...
            switch (data.action) {
                case 'sshauth': {
                    ...
                    x += '<label><input id=dp2keep type=checkbox>' + "Mémoriser les identifiants" + '</label>';
                    x += '<div id=d2keyauth2 style=font-size:x-small><br />' + "La clé doit être au format OpenSSH" + '</div>';
                    setDialogMode(2, "Authentification", 11, p13sshConnectEx, x, 'ssh');
                    setTimeout(sshAuthUpdate, 50);
                    break;
                }
        ...
        function p13downloadfile(x, y, z) {
            ...
            setDialogMode(2, "Télécharger le fichier", 10, p13downloadFileCancel, '<div>' + downloadFile.file + '</div><br /><progress id=d2progressBar style=width:100% value=0 max=' + z + ' />');
        }
