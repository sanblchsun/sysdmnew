<!DOCTYPE html><html lang="fr" dir="ltr" xmlns="http://www.w3.org/1999/xhtml"><head>
    <meta charset="utf-8">
    ...
    <div id="container">
        ...
        <div id="masthead" style="background:url(logo.png) 0px 0px;background-size:341px 50px;background-color:#036;background-repeat:no-repeat;height:50px;width:100%;overflow:hidden">
            ...
            <div id="notificationCount" onclick="clickNotificationIcon()" class="unselectable" style="position:absolute;right:50px;top:0px;font-size:28px;width:50px;height:50px;cursor:pointer;display:none" title="Voir les dernières notifications"><div id="notificationCount2" style="padding-top:8px">0</div></div>
            ...
            <div id="column_l" style="width:100%;padding:0;position:absolute;bottom:0px;top:0px">
                <div id="p0" style="display:none;width:100%;height:100%">
                    <div style="display:flex;align-items:center;width:100%;height:100%">
                        <div id="p0message" style="text-align:center;width:100%"><span id="p0span">Le serveur est déconnecté</span>, <href onclick="reload()" style="cursor:pointer"><u>Se reconnecter</u></href>.</div>
                    </div>
                </div>
                ...
                <div id="p2" style="display:none;position:absolute;top:0;left:0;right:0;bottom:0">
                    ...
                    <div id="xdevicesBar" style="position:absolute;overflow-y:auto;height:34px;left:0;right:0;bottom:0px;background-color:#aaa;color:black">
                        <div style="margin:4px">
                            ...
                            <input id="SearchInput" autocomplete="off" type="search" placeholder="Filtre" onchange="onDeviceSearchChanged(event)" onclick="onDeviceSearchChanged(event)" onkeyup="onDeviceSearchChanged(event)" style="padding:2px;margin:0;height:20px;background-color:#FFF">&nbsp;
                            <label class="noselect"><input type="checkbox" id="RealNameCheckBox" onclick="onRealNameCheckBox()">Nom du système</label>
                            <label class="noselect"><input type="checkbox" id="OnlineCheckBox" onclick="onOnlineCheckBox(event)">En ligne</label>
                        </div>
                    </div>
                </div>
                            ...
                            <div id="p3AccountActions">
                                <div id="p2AccountSecurity" style="display:none">
                                    ...
                                    <div style="margin-left:9px;margin-bottom:8px">
                                        <div id="managePhoneNumber1" style="margin-top:5px;display:none"><a onclick="account_managePhone()" style="cursor:pointer">Gérer le numéro de téléphone</a> <span id="authPhoneNumberCheck"><strong>✓</strong></span></div>
                                        <div id="manageEmail2FA" style="margin-top:5px;display:none"><a onclick="account_manageAuthEmail()" style="cursor:pointer">Gérer l'authentification des e-mails</a> <span id="authEmailSetupCheck"><strong>✓</strong></span></div>
                                        <div style="margin-top:5px"><a href="#" onclick="account_showLocalizationSettings()">Paramètres de localisation</a></div>
                                        <div id="manageAuthApp" style="margin-top:5px;display:none"><a onclick="account_manageAuthApp()" style="cursor:pointer">Gérer la double authentification</a> <span id="authAppSetupCheck"><strong>✓</strong></span></div>
                                        <div id="manageOtp" style="margin-top:5px;display:none"><a onclick="account_manageOtp(0)" style="cursor:pointer">Gérer les codes de récupérations</a> <span id="authCodesSetupCheck"><strong>✓</strong></span></div>
                                    </div>
                                </div>
                                <div id="p2AccountActions" style="display:none">
                                    <p><strong>Gestion du compte</strong></p>
                                    <div style="margin-left:9px;margin-bottom:8px">
                                        <div style="margin-top:5px"><span id="viewPreviousLogins"><a onclick="return account_viewPreviousLogins()" style="cursor:pointer">Historique des connexions</a></span></div>
                                        <div style="margin-top:5px"><span id="managePhoneNumber2" style="display:none"><a onclick="account_managePhone()" style="cursor:pointer">Gérer le numéro de téléphone</a></span></div>
                                        ...
                                        <span id="p2AccountPassActions">
                                            <div style="margin-top:5px"><span id="changeEmailId" style="display:none"><a onclick="account_showChangeEmail()" style="cursor:pointer">Modifier l'adresse mail</a></span></div>
                                            <div style="margin-top:5px"><a onclick="account_showChangePassword()" style="cursor:pointer">Changer le mot de passe</a><span id="p2nextPasswordUpdateTime"></span></div>
                                            <div style="margin-top:5px"><a onclick="account_showDeleteAccount()" style="cursor:pointer">Supprimer le compte</a></div>
                                        </span>
                                        <div style="margin-top:5px" id="setDarkModeLink"><a onclick="toggleNightMode()" style="cursor:pointer">Définir le mode sombre</a></div>
                                        <div style="margin-top:5px"><a onclick="showNotes(false)" style="cursor:pointer">Notes personnelles</a></div>
                                    </div>
                                <br style="clear:both">
                                </div>
                            </div>
                            <strong>Groupes d'appareils</strong>
                ...
                <div id="p5" style="display:none">
                    <table cellspacing="0" style="margin:0;padding:0;border-spacing:0;border:0;">
                        <tbody><tr style="padding:0">
                            ...
                            <td>
                                <div style="margin-left:5px">
                                    <strong style="font-size:large">Mes Dossiers et Fichiers</strong><br>
                                </div>
                            </td>
                        </tr>
                    </tbody></table>
                            ...
                            <tbody><tr>
                                <td style="width:100%;background-color:#d3d9d6;text-align:left;padding:4px" valign="bottom">
                                    <div style="width:100%;text-align:center">
                                        <input type="button" style="width:calc(100%/5 - 5px)" id="p5FolderUp" disabled="disabled" onclick="p5folderup()" value="Parent">
                                        ...
                                        <input type="button" style="width:calc(100%/5 - 5px)" id="p5DeleteFileButton" disabled="disabled" value="Supprimer" onclick="p5deletefile()" onkeypress="return false" onkeydown="return false">
                                    ...
                                    <div style="width:100%;text-align:center">
                                        <input type="button" style="width:calc(100%/5 - 5px)" id="p5UploadButton" disabled="disabled" value="Téléverser" onclick="p5uploadFile()" onkeypress="return false" onkeydown="return false">
                                        <input type="button" style="width:calc(100%/5 - 5px)" id="p5CutButton" disabled="disabled" value="Couper" onclick="p5copyFile(1)" onkeypress="return false" onkeydown="return false">
                                        <input type="button" style="width:calc(100%/5 - 5px)" id="p5CopyButton" disabled="disabled" value="Copier" onclick="p5copyFile(0)" onkeypress="return false" onkeydown="return false">
                                        ...
                                        <tbody><tr>
                                            ...
                                            <td style="text-align:right;padding-right:4px">
                                                <select id="p5sortdropdown" onchange="updateFiles()">
                                                    <option value="1" selected="selected">Trier par nom</option>
                                                    <option value="2">Trier par taille</option>
                                                    <option value="3">Trier par date</option>
                                                    <option value="4">Tri décroissant par nom</option>
                                                    <option value="5">Tri décroissant par taille</option>
                                                    <option value="6">Tri décroissant par date</option>
                                                </select>
                                            </td>
                                        </tr>
                                    </tbody></table>
                ...
                <div id="p10" style="display:none;position:absolute;bottom:0;top:0;width:100%;overflow:hidden">
                    ...
                    <div id="p10dialog" style="z-index:1000;background-color:#EEE;box-shadow:0px 0px 15px #666;font-family:Arial,Helvetica,sans-serif;border-radius:5px;position:fixed;top:30px;width:300px;left:30px;display:none">
                        <div style="width:100%;background-color:#003366;color:#FFF;border-radius:5px 5px 0 0">
                            <div style="padding:5px">Personnalisation des raccourcis clavier</div>
                        ...
                        <div id="deskarea1" style="position:absolute;top:0px;width:100%;height:32px">
                            <div style="padding-top:2px;padding-bottom:2px;background:#C0C0C0;height:32px">
                                <div style="float:right;text-align:right">
                                    ...
                                    <input type="button" id="deskFullScreen" value="Plein écran" onclick="deskToggleFull(event)" onkeypress="return false" onkeydown="return false" disabled="disabled" style="height:28px;margin-right:3px;">
                                </div>
                                <div style="margin-left:3px">
                                    <input type="button" id="connectbutton1" value="Se connecter" onclick="connectDesktop(event,3)" onkeypress="return false" onkeydown="return false" disabled="disabled" style="height:28px">
                                    <input type="button" id="connectbutton1h" value="Connexion AMT" onclick="connectDesktop(event,2)" onkeypress="return false" onkeydown="return false" disabled="disabled" style="height:28px">
                                    <input type="button" id="disconnectbutton1" value="Déconnecter" onclick="connectDesktop(event,0)" onkeypress="return false" onkeydown="return false" style="height:28px">
                                    <span id="deskstatus" style="color:black">Débranché</span>
                                </div>
                            </div>
                        </div>
                        ...
                        <div id="deskarea4" style="position:absolute;bottom:0px;width:100%;height:32px">
                            <div style="padding-top:2px;padding-bottom:2px;background:#C0C0C0">
                                ...
                                <div>
                                    ...
                                    <input type="button" value="Paramètres" onkeypress="return false" onkeydown="return false" onclick="showDesktopSettings()" style="height:28px">
                                    <input type="button" onkeypress="return false" onkeydown="return false" value="Actions de puissance ..." onclick="showPowerActionDlg()" style="display:none;height:28px">
                                    ...
                                    <input type="button" id="DeskScreens" value="Écrans" onkeypress="return false" onkeydown="return false" onclick="deskSelectScreens()" style="display:none;height:28px">
                                    <label><span id="DeskControlSpan" style="display:none"><input id="DeskControl" type="checkbox" onkeypress="return false" onkeydown="return false">Entrée</span></label>
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div id="termTable" style="position:absolute;top:0;bottom:0;left:0;right:0">
                            <div id="termarea1">
                                <div class="areaHead" style="line-height:24px">
                                    <div class="toright2">
                                        <input type="button" id="termFullScreen" value="Plein écran" onclick="deskToggleFull(event)" onkeypress="return false" onkeydown="return false" disabled="disabled" style="height:28px;margin-right:3px;">
                                        <div id="terminalCustomUpperRight" style="float:left;margin-right:6px"></div>
                                    </div>
                                    <div>
                                        <span id="connectbutton2span" style="margin-left:3px"><input type="button" id="connectbutton2" value="Se connecter" style="height:28px" onclick="connectTerminal(event,1)" onkeypress="return false" onkeydown="return false" disabled="disabled"></span>
                                        <span id="connectbutton2sspan" style="margin-right:4px"><input type="button" id="connectbutton2s" value="Connexion SSH" style="height:28px" onclick="connectTerminal(event,3)" onkeypress="return false" onkeydown="return false" disabled="disabled"></span>
                                        <span id="disconnectbutton2span" style="margin-left:3px"><input type="button" id="disconnectbutton2" value="Déconnecter" style="height:28px" onclick="connectTerminal(event,0)" onkeypress="return false" onkeydown="return false"></span>
                                        <span id="termstatus" style="line-height:22px">Débranché</span><span id="termtitle"></span>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div id="termarea4" style="position:relative;height:32px;">
                                <div class="areaFoot">
                                    ...
                                    <div style="height:28px">
                                        <input id="termActionsBtn" style="margin-left:3px;height:28px" type="button" title="Effectuer des actions d'alimentation sur le périphérique" onkeypress="return false" onkeydown="return false" value="Actions" onclick="deviceActionFunction()">
                            ...
                            <tbody><tr>
                                <td style="background-color:#C0C0C0;border-bottom:2px solid black;padding:2px;line-height:24px">
                                    ...
                                    <div style="margin-left:2px">
                                        <input id="p13AutoConnect" value="Connection automatique" onclick="autoConnectFiles(event)" onkeypress="return false" onkeydown="return false" type="button" style="display:none">
                                        <input id="p13Connect" value="Se connecter" onclick="connectFiles(event,1)" onkeypress="return false" onkeydown="return false" type="button">
                                        <input id="p13Connects" value="Connexion SFTP" onclick="connectFiles(event,2)" onkeypress="return false" onkeydown="return false" type="button">
                                        <input id="p13Disconnect" value="Déconnecter" onclick="connectFiles(event)" onkeypress="return false" onkeydown="return false" type="button">
                                        <span class="textOverGray" id="p13Status">Débranché</span>
                                    </div>
                                </td>
                            </tr>
                            <tr>
                                <td style="width:100%;background-color:#d3d9d6;text-align:left;padding:4px" valign="bottom">
                                    <div style="width:100%;text-align:center">
                                        <input type="button" style="width:calc(100%/5 - 5px)" id="p13FolderUp" disabled="disabled" onclick="p13folderup()" value="Parent">
                                        ...
                                        <input type="button" style="width:calc(100%/5 - 5px)" id="p13DeleteFileButton" disabled="disabled" value="Supprimer" onclick="p13deletefile()" onkeypress="return false" onkeydown="return false">
                                    ...
                                    <div style="width:100%;text-align:center">
                                        <input type="button" style="width:calc(100%/5 - 5px)" id="p13UploadButton" disabled="disabled" value="Téléverser" onclick="p13uploadFile()" onkeypress="return false" onkeydown="return false">
                                        <input type="button" style="width:calc(100%/5 - 5px)" id="p13CutButton" disabled="disabled" value="Couper" onclick="p13copyFile(1)" onkeypress="return false" onkeydown="return false">
                                        <input type="button" style="width:calc(100%/5 - 5px)" id="p13CopyButton" disabled="disabled" value="Copier" onclick="p13copyFile(0)" onkeypress="return false" onkeydown="return false">
                            ...
                            <tbody><tr style="height:28px">
                                <td class="areaHead">
                                    <div class="toright2">
                                        ...
                                        <input type="button" id="p15uploadCore" value="Action de l'agent" onclick="p15uploadCore(event)">
                                    </div>
                                        ...
                                        <tbody><tr>
                                            ...
                                            <td id="p15outputselecttd">
                                                <select id="p15outputselect" onchange="setupConsole()">
                                                    ...
                                                    <option id="p15outputselect3" value="3">Envoyer</option>
                                                    <option id="p15outputselect2" value="2">MQTT</option>
                                                </select>
                                            </td>
                                            <td style="width:1%"><input id="id_p15consoleClear" type="button" class="bottombutton" value="Nettoyer" onclick="p15consoleClear()"></td>
                                        </tr>
                                    </tbody></table>
                                </td>
                            </tr>
    ...
    <div id="dialog" style="display:none">
        ...
        <div style="margin-right:16px;margin-left:8px">
            ...
            <div id="dialog4" style="margin:auto;margin:3px">
                <div id="d3upload">
                    ...
                    <select id="d3uploadMode" onchange="d3modechange()">
                        <option value="1">Charger un fichier local</option>
                        <option value="2">Sélection de fichiers serveur</option>
                    </select>
                </div>
                ...
                <div id="d3servermode">
                    <div id="d3serveraction" valign="bottom">
                        <input type="button" id="p3FolderUp" disabled="disabled" onclick="d3folderup()" value="Parent">&nbsp;<span id="p3CurrentFolder"></span>
                    </div>
            ...
            <div id="dialog7" style="margin:auto;margin:3px">
                <div id="d7meshkvm">
                    <h4 style="width:100%;border-bottom:1px solid gray">Bureau distant - Configuration de l'agent</h4>
                    <table style="width:100%">
                        <tbody><tr>
                            <td>
                                Qualité
                        ...
                        <tr>
                            <td></td>
                            <td>
                                <label style="display:block" id="d7deskAutoLockLabel"><input type="checkbox" id="d7deskAutoLock">Verrouiller lors de la déconnexion</label>
                            </td>
                        </tr>
                    </tbody></table>
                </div>
        ...
        <div id="idx_dlgButtonBar" style="padding:10px;margin-bottom:20px">
            <input id="idx_dlgCancelButton" type="button" value="Annuler" style="float:right;width:80px;margin-left:5px" onclick="dialogclose(0)">
            <input id="idx_dlgOkButton" type="button" value="OK" style="float:right;width:80px" onclick="dialogclose(1)">
            <div><input id="idx_dlgDeleteButton" type="button" value="Supprimer" style="display:none" onclick="dialogclose(2)"></div>
        </div>
    </div>
    <div id="topMenu" style="z-index:1000;background-color:#EEE;box-shadow:0px 0px 15px #666;font-family:Arial,Helvetica,sans-serif;border-radius:0px 0px 5px 5px;position:fixed;top:50px;right:5px;width:170px;display:none">
        <div style="padding:12px;border-top:1px solid gray;color:black;cursor:pointer" onclick="topMenu(2)">Mes Dossiers et Fichiers</div>
        <div style="padding:12px;border-top:1px solid gray;color:black;cursor:pointer" onclick="topMenu(1)">Mon Compte</div>
        <div id="logoutMenuOption"><a id="logoutMenuOptionRef" href="/logout"><div style="padding:12px;border-top:1px solid gray;color:black;cursor:pointer">Déconnexion</div></a></div>
    </div>
    ...
    <script>
        ...
        var StatusStrs = ["Débranché", "En cours de connexion ...", "Traitement...", "Connecté", "Intel&reg; AMT Connecté"];
        var agentsStr = ["Inconnue", "Console Windows 32 bits", "Console Windows 64 bits", "Service Windows 32 bits", "Service Windows 64 bits", "Linux 32bit", "Linux 64bit", "MIPS", "XENx86", "Android", "Linux ARM", "macOS x86-32bit", "Android x86", "PogoPlug ARM", "Android", "Linux Poky x86-32bit", "macOS x86-64bit", "ChromeOS", "Linux Poky x86-64bit", "Linux NoKVM x86-32bit", "Linux NoKVM x86-64bit", "Console Windows MinCore", "Service Windows MinCore", "NodeJS", "ARM-Linaro", "ARMv6l / ARMv7l", "ARMv8 64bit", "ARMv6l / ARMv7l / NoKVM", "MIPS24KC (OpenWRT)", "Apple Silicon", "FreeBSD x86-64", "Inconnue", "Linux ARM 64 bit (glibc/2.24 NOKVM)", "Alpine Linux x86 64 Bit (MUSL)", "Assistant (Windows)", "Armada370 - ARM32/HF (libc/2.26)", "OpenWRT x86-64", "OpenBSD x86-64", "Inconnue", "Inconnue", "MIPSEL24KC (OpenWRT)", "ARMADA/CORTEX-A53/MUSL (OpenWRT)", "Windows ARM 64bit console", "Windows ARM 64bit service", "ARMVIRT32 (OpenWRT)", "RISC-V x86-64"];
        var files;
        var terminal;
        ...
        function startup() {
            ...
            QH('p1message', "En cours de connexion ...");
            go(1);
        ...
        function onStateChanged(server, state, prevState, errorCode) {
            if (state == 0) {
                ...
                if (errorCode == 'noauth') { QH('p0span', "Impossible d'effectuer l'authentification"); return; }
                if (prevState == 2) { setTimeout(serverPoll, 5000); } else { QH('p0span', "Impossible de se connecter à la web socket"); }
                // Clean up here
        ...
        function updateSelf() {
            ...
            if (typeof userinfo.passchange == 'number') {
                if (userinfo.passchange == -1) { QH('p2nextPasswordUpdateTime', " - Réinitialiser à la prochaine connexion."); }
                    ...
                    else if (seconds < 3600) { var secs = Math.floor(seconds / 60); QH('p2nextPasswordUpdateTime',format((secs == 1)?" - Réinitialisation dans une minute":" - Réinitialisation dans {0} minutes.", secs)); }
                    else if (seconds < 86400) { var hours = Math.floor(seconds / 3600); QH('p2nextPasswordUpdateTime', format((hours == 1) ? " - Réinitialisation dans une heure" : " - Réinitialisation dans {0} heures.", hours)); }
                    else { var days = Math.floor(seconds / 86400); QH('p2nextPasswordUpdateTime', format((hours == 1) ? " - Réinitialisation dans un jour" : " - Réinitialisation dans {0} jours.", days)); }
                }
            }
        }
            ...
            switch (message.action) {
                case 'serverinfo': {
                    ...
                    if (serverinfo.certExpire != null) {
                        ...
                        if ((days >= 0) && (days < 20)) {
                            addNotification({ text: format("Le certificat expire dans {0} jour(s)", days) });
                        }
                    }
                ...
                case 'otpauth-request': {
                    if ((xxdialogMode == 2) && (xxdialogTag == 'otpauth-request')) {
                        if (message.err != null) {
                            var otpauthErrors = ['', "2FA est bloqué", "Les codes de récupérations sont verrouillés", "Jeton de connexion utilisé", "OTP 2FA non autorisé", "Le compte est verrouillé", "Impossible de charger la librairie OTPLIB"];
                            if ((message.err > 0) && (message.err < otpauthErrors.length)) { QH('d2optinfo', otpauthErrors[message.err]); } else { QH('d2optinfo', format("Erreur #{0}", message.err)); }
                        } else {
                ...
                case 'otpauth-setup': {
                    ...
                    setDialogMode(2, "Application d'authentification", 1, null, message.success ? ('<b style=color:green>' + "Authentification à double facteur activée avec succès." + '</b> ' + "Vous aurez maintenant besoin d'un jeton valide pour vous connecter à nouveau.") : ('<b style=color:red>' + "Echec de l'activitation de l'authentifcation à double facteur." + '</b> ' + "Supprimez la phrase secrète de l'application et réessayez. Vous disposez de quelques minutes pour saisir le bon code."));
                    break;
                }
                case 'otpauth-clear': {
                    if (xxdialogMode) return;
                    setDialogMode(2, "Application d'authentification", 1, null, message.success ? ('<b>' + "Authentification à double facteur supprimée." + '</b> ' + "Vous pouvez réactiver cette fonctionnalité à tout moment.") : ('<b style=color:red>' + "Echec de la suppression de l'authenfication à double facteur." + '</b> ' + "Essayer à nouveau."));
                    break;
                }
                case 'otpauth-getpasswords': {
                    if (xxdialogMode) return;
                    var x = "Les jetons à usage unique peuvent être utilisés pour la double authentification. Générez les et gardez les dans un endroit sûr.";
                    ...
                    if (message.passwords) {
                        ...
                        x += '<tr><td>' + "Aucun jeton actif";
                    }
                    x += '</table></div></div><br />';
                    x += '<div><input type=button value=\'' + "Fermer" + '\' onclick=setDialogMode(0) style=float:right></input>';
                    x += '<input type=button value=\'' + "Nouveaux Jetons" + '\' onclick=\'account_manageOtp(1);\'></input>';
                    if (message.passwords != null) { x += '<input type=button value=\'' + "Nettoyer" + '\' onclick=\'account_manageOtp(2);\'></input>'; }
                    x += '</div><br />';
                    setDialogMode(2, "Gérer les codes de récupérations", 8, null, x, 'otpauth-manage');
                    break;
                }
                case 'verifyPhone': {
                    ...
                    x += '<br /><br /><div style=width:100%;text-align:center>' + "Code de vérification:" + ' <input type=tel pattern="[0-9]" inputmode="number" maxlength=6 id=d2phoneCodeInput onKeyUp=account_managePhoneCodeValidate() onkeypress="if (event.key==\'Enter\') account_managePhoneCodeValidate(1)"></div></table>';
                    setDialogMode(2, "Notifications téléphoniques", 3, account_managePhoneConfirm, x, message.cookie);
                    ...
                    if ((xxdialogMode == 2) && (xxdialogTag == 'previousLogins')) {
                        ...
                        if (message.events.length == 0) {
                            ...
                            for (var i in message.events) {
                                ...
                                if (m == 107) { m = "Connexion réussie"; c = 'BBD1BB'; xx = ''; }
                                else if (m == 108) { m = "Authentification à double facteur invalide"; c = 'DD9DC3'; xx = 'x'; }
                                else if (m == 109) { m = "Compte verrouillé"; c = 'E1BBBB'; xx = 'x'; }
                                else if (m == 110) { m = "Mot de passe incorrect"; c = 'E1BBBB'; xx = 'x'; }
                        ...
                        setDialogMode(2, "Logins précédents", 1, null, x);
                    }
                    break;
                }
                case 'event': {
        ...
        function goStack() {
            ...
            if (idtype == 'files') {
                ...
                if ((features & 0x00040000) && !((userinfo.otpsecret == 1) || (userinfo.otphkeys > 0) || (userinfo.otpkeys > 0) || (userinfo.otpduo > 0) || (userinfo.otpdev > 0) || ((features & 0x00800000) && (userinfo.otpekey == 1)))) { setDialogMode(2, "Sécurité du compte", 1, null, "Unable to access this feature until two-factor authentication is enabled. This is required for extra security. Go to the \"My Account\" and look at the \"Account Security\" section."); return; }  
                go(5);
            }
        }
        ...
        function account_viewPreviousLogins() {
            if (xxdialogMode) return;
            setDialogMode(2, "Logins précédents", 1, null, "Chargement...", 'previousLogins');
        ...
        function account_manageImage(mode) {
            ...
            setDialogMode(2, "Gérer la photo du compte", 7, account_manageImageEx2, x, user._id);
        ...
        function toggleNightMode() {
            ...
            var x = '<input type=radio id=night0 name=nightmoderadio value=0 ' + ((cNightMode == 0) ? 'checked' : '') + '><label for=night0>' + "Navigateur par défaut" + '</label><br>';
            x += '<input type=radio id=night2 name=nightmoderadio value=2 ' + ((cNightMode == 2) ? 'checked' : '') + '><label for=night2>' + "Thème clair" + '</label><br>';
            x += '<input type=radio id=night1 name=nightmoderadio value=1 ' + ((cNightMode == 1) ? 'checked' : '') + '><label for=night1>' + "Thême sombre" + '</label><br>';
            setDialogMode(2, "Mode nuit", 3, toggleNightModeEx, x);
            QV('uiMenu', false);
        }
        ...
        function account_managePhone() {
            ...
            if (userinfo.phone != null) {
                ...
                x += '<td style=text-align:center><div style=padding:6px>' + "Numéro de téléphone vérifié" + '</div><div style=font-size:20px>' + userinfo.phone + '</div>';
                x += '<div style=margin:10px><label><input id=d2delPhone type=checkbox onclick=account_managePhoneRemoveValidate() />' + "Supprimer le numéro de téléphone" + '</label></div>';
                setDialogMode(2, "Notifications téléphoniques", 3, account_managePhoneRemove, x);
                ...
                x += '<br /><br /><div style=width:100%;text-align:center>' + "Numéro de téléphone:" + ' <input type=tel pattern="[0-9]" autocomplete="tel" inputmode="tel" maxlength=18 id=d2phoneinput onKeyUp=account_managePhoneValidate() onkeypress="if (event.key==\'Enter\') account_managePhoneValidate(1)"></div></table>';
                setDialogMode(2, "Notifications téléphoniques", 3, account_managePhoneAdd, x, 'verifyPhone');
        ...
        function account_showLocalizationSettings() {
            ...
            if (serverinfo.languages && serverinfo.languages.length > 0) {
                y += "Changer de langue requiert de rafraîchir la page." + '<br /><br />';
                var z = '<select id=d2langselect style=width:180px><option value="*">' + "Configuration du navigateur" + '</option>';
            ...
            y += addHtmlValue("dates et heure", x);

            if ((userinfo.siteadmin == 0xFFFFFFFF) && (domain == '')) {
                y += '<br /><a rel="noreferrer noopener" target="_blank" href="translator.htm">' + "Traduire MeshCentral" + '</a>';
            }

            setDialogMode(2, "Paramètres de localisation", 3, account_showLocalizationSettingsEx, y);
            return false;
        }
        ...
        function account_addOtp() {
            ...
            setDialogMode(2, "Application d'authentification", 2, function () { meshserver.send({ action: 'otpauth-setup', secret: Q('d2optsecret').attributes.secret.value, token: Q('d2otpauthinput').value }); }, '<div id=d2optinfo>' + "Chargement..." + '</div>', 'otpauth-request');
        ...
        function account_removeOtp() {
            if (xxdialogMode || (userinfo.otpsecret != 1) || ((features & 4096) == 0)) return;
            setDialogMode(2, "Application d'authentification", 3, function () { meshserver.send({ action: 'otpauth-clear' }); }, "Confirmer la suppression de l'authentification à double facteur?");
        }
        ...
        function account_showVerifyEmail() {
            ...
            var x = "Envoyer un mail de confirmation à :" + '<br /><div style=padding:8px><b>' + EscapeHtml(userinfo.email) + '</b></div>' + "Merci de patienter quelques minutes pour recevoir la vérification.";
            setDialogMode(2, "Vérification de l'email", 3, account_showVerifyEmailEx, x);
        }
        ...
        function account_showChangeEmail() {
            ...
            setDialogMode(2, "Changement d'adresse mail", 3, account_changeEmail, x);
        ...
        function account_showDeleteAccount() {
            ...
            x += '</div><br /></form>';
            setDialogMode(2, "Supprimer mon compte", 0, null, x);
        ...
        function account_showChangePassword() {
            ...
            if (features & 0x00010000) { x += '<tr><td align=right>' + "Indice pour le mot de passe:" + '</td><td><input id=apasswordhint name=apasswordhint maxlength=250 type=text autocomplete=off onchange=account_validateNewPassword() onkeyup=account_validateNewPassword() onkeydown=account_validateNewPassword() /></td></tr>'; }
            x += '</table>'
            if (passRequirements) {
                var r = [], rc = 0;
                for (var i in passRequirements) { if ((i != 'reset') && (i != 'hint')) { r.push(i + ':' + passRequirements[i]); rc++; } }
                if (rc > 0) { x += '<br /><span style=font-size:x-small>' + format("Prérequis : {0}.", r.join(', ')) + '</span>'; }
            }
            x += '<br />';
            setDialogMode(2, "Changer le mot de passe", 3, account_showChangePasswordEx, x);
            Q('apassword0').focus();
        ...
        function account_createMesh() {
            ...
            if ((userinfo.siteadmin != 0xFFFFFFFF) && ((userinfo.siteadmin & 64) != 0)) { setDialogMode(2, "Nouveau Group", 1, null, "Ce compte ne permet pas la création de groupe utilisateurs"); return; }

            // Remind the user to verify the email address
            if ((userinfo.emailVerified !== true) && (serverinfo.emailcheck == true) && (userinfo.siteadmin != 0xFFFFFFFF)) { setDialogMode(2, "Sécurité du compte", 1, null, "Les appareils sont inaccessibles tant que l'email n'est pas vérifié. Cette action est nécessaire pour la récupération des mots de passe. Allez dans \"Mon compte\" pour vérifier l'adresse mail."); return; }

            // Remind the user to add two factor authentication
            if ((features & 0x00040000) && !((userinfo.otpsecret == 1) || (userinfo.otphkeys > 0) || (userinfo.otpkeys > 0) || (userinfo.otpduo > 0) || (userinfo.otpdev > 0) || ((features & 0x00800000) && (userinfo.otpekey == 1)))) { setDialogMode(2, "Sécurité du compte", 1, null, "Impossible d'accéder à un périphérique tant que l'authentification à deux facteurs n'est pas activée. Ceci est nécessaire pour plus de sécurité. Allez dans \"Mon compte\" et regardez la section \"Sécurité du compte\"."); return; }

            // We are allowed, let's prompt to information
            var x = addHtmlValue("Nom", '<input id=dp3meshname style=width:170px maxlength=64 onchange=account_validateMeshCreate() onkeyup=account_validateMeshCreate() />');
            x += addHtmlValue("Type", '<div style=width:170px;margin:0;padding:0><select id=dp3meshtype style=width:100% onchange=account_validateMeshCreate() ><option value=2>' + "Groupe d'agents logiciels" + '</option><option value=1>' + "Intel&reg; AMT uniquement" + '</option></select></div>');
            ...
            setDialogMode(2, "Créer un groupe d'appareils", 3, account_createMeshEx, x);
        ...
        function updateMeshes() {
            ...
            for (i in meshes) {
                ...
                var rights = "Droits limités";
                if (meshrights == 0xFFFFFFFF) rights = "Administrateur Complet"; else if (meshrights == 0) rights = "Aucun droit";
        ...
        function updateFiles() {
            ...
            var html1 = '', html2 = '', displayPath = '<a style=cursor:pointer;color:black onclick=p5folderup(0)>' + "Racine" + '</a>', fullPath = 'Root', publicPath, filetreex = filetree, folderdepth = 1;
        ...
        function getNiceSize(bytes) {
            if (bytes <= 0) return "Limite de stockage dépassée";
            if (bytes < 2048) return format("{0}b restant", bytes);
            if (bytes < 2097152) return format("{0}k restant", Math.round(bytes / 1024));
            if (bytes < 2147483648) return format("{0}m restant", Math.round(bytes / 1024 / 1024));
            return format("{0}g restant", Math.round(bytes / 1024 / 1024 / 1024));
        }
        ...
        function p5deletefile() { var cc = getFileSelCount(), rec = (getFileSelDirCount() > 0) ? '<br /><br /><label><input type=checkbox id=p5recdeleteinput>' + "Suppression récursive" + '</label><br>' : '<input type=checkbox id=p5recdeleteinput style=\'display:none\'>'; setDialogMode(2, "Supprimer", 3, p5deletefileEx, (cc > 1) ? (format("Supprimer ces {0} éléments ?", cc) + rec) : ("Supprimer cet élément ?" + rec)); }
        ...
        function p5pasteFile() { var x = ''; if ((p5clipboard != null) && (p5clipboard.length > 0)) { x = format("Confirmer {0} de {1} entrée {2} à cet emplacement ?", (p5clipboardCut == 0 ? 'copy' : 'move'), p5clipboard.length, ((p5clipboard.length > 1) ? 's' : '')) } setDialogMode(2, "Coller", 3, p5pasteFileEx, x); }
        ...
        function p5updateClipview() { var x = ''; if ((p5clipboard != null) && (p5clipboard.length > 0)) { x = format("Tenir {0} entrée {1} pour {2}", p5clipboard.length, ((p5clipboard.length > 1) ? 's' : ''), (p5clipboardCut == 0 ? "Copier" : "Déplacer")) + ', <a href=# onclick="return p5clearClip()" style=cursor:pointer>' + "Nettoyer" + '</a>.' } QH('p5bottomstatus', x); p5setActions(); }
        ...
        function updateDevices() {
            ...
            for (var i in nodes) {
                ...
                if (sort == 0) {
                    ...
                    if (((meshes[nodes[i].meshid]?nodes[i].meshid:'*') != current)) {
                        deviceHeaderSet();
                        var extra = '';
                        if ((meshes[nodes[i].meshid] != null) && (meshes[nodes[i].meshid].mtype == 1)) { extra = '<span style=color:lightgray>' + ", Intel&reg; AMT uniquement" + '</span>'; }
                        ...
                        if (meshes[nodes[i].meshid]) {
                            ...
                            r += '</span><span id=MxMESH><i>' + "Appareils individuels" + '</i></span><span id=DevxHeader' + deviceHeaderId + ' style=color:lightgray></span></div>';
                            current = '*';
                        }
            ...
            if ((sort == 0) && (Q('SearchInput').value == '')) {
                for (var i in meshes) {
                    ...
                    if ((displayedMeshes[mesh._id] == null) && (IsMeshViewable(mesh))) {
                        ...
                        if (mesh.mtype == 1) { r += '<div style=padding:10px><i>' + "Aucun appareil Intel&reg; AMT dans ce groupe"; }
                        if (mesh.mtype > 1) { r += '<div style=padding:10px><i>' + "Aucun appareil dans ce groupe"; }
                        r += '.</i></div></div>';
                        current = mesh._id;
                        count++;
                    }
            ...
            if (count == 0) {
                if ((Q('SearchInput').value != '') || (Q('OnlineCheckBox').checked)) {
                    QH('xdevices', '<div style="margin-top:50px;text-align:center"><span style="font-size:30px">' + "Aucun appareil" + '</span><br /><br />' + "Aucun appareil ne correspond à cette recherche." + ' <a onclick=clearSearchInput() style=cursor:pointer>' + "Annuler la recherche" + '</a></div>');
                } else {
            ...
            if ((div.offsetTop >= visibleTop) && (div.offsetTop < visibleBottom)) {
                ...
                if (node.sessions != null) {
                    ...
                    if (node.sessions.battery != null) {
                        ...
                        var statestr = '';
                        if (bat.state == 'ac') { statestr = "L'appareil est branché sur secteur"; }
                        else if (bat.state == 'dc') { statestr = "L'appareil est sur batterie"; }
        ...
        function showDeviceHelpRequests(nodeid, force, e) {
            ...
            if (x != '') { setDialogMode(2, "Demandes d'assistaSnce" + ' - ' + EscapeHtml(node.name), 1, null, x, 'HELPREQ-' + node._id); } else { setDialogMode(0); }
            return false;
        }
        ...
        function showDeviceSessions(nodeid, force, e) {
            ...
            for (var i in node.sessions) {
                if ((i == 'kvm') && (node.sessions.multidesk == null)) {
                    x += '<u>' + "Bureau distant" + '</u>';
                    for (var j in node.sessions.kvm) {
                        if (j.startsWith('user/')) {
                            var trash = '';
                            if ((j == userinfo._id) || (GetNodeRights(node) == 0xFFFFFFFF)) { trash = ' <a href=# onclick=\'return endDeviceSession("kvm", "' + encodeURIComponentEx(node._id) + '", "' + encodeURIComponentEx(j) + '")\' title="' + "Déconnecter cette session" + '" style=cursor:pointer><img src=images/trash.png border=0 height=10 width=10></a>'; }
                            x += addHtmlValue4(getUserName(j), ((node.sessions.kvm[j] == 1) ? "1 session" : nobreak(format("{0} sessions", node.sessions.kvm[j]))) + trash);
                        } else if (j == 'busy') {
                            x += addHtmlValue2("L'appareil est occupé", ((node.sessions.kvm[j] == 1) ? "1 session" : nobreak(format("{0} sessions", node.sessions.kvm[j]))));
                        }
                    }
                } else if (i == 'multidesk') {
                    x += '<u>' + "Bureau distant" + '</u>';
                    for (var j in node.sessions.multidesk) {
                        var trash = '';
                        if ((j == userinfo._id) || (GetNodeRights(node) == 0xFFFFFFFF)) { trash = ' <a href=# onclick=\'return endDeviceSession("multidesk", "' + encodeURIComponentEx(node._id) + '", "' + encodeURIComponentEx(j) + '")\' title="' + "Déconnecter cette session" + '" style=cursor:pointer><img src=images/trash.png border=0 height=10 width=10></a>'; }
                    ...
                    for (var j in node.sessions.terminal) {
                        var trash = '';
                        if ((j == userinfo._id) || (GetNodeRights(node) == 0xFFFFFFFF)) { trash = ' <a href=# onclick=\'return endDeviceSession("terminal", "' + encodeURIComponentEx(node._id) + '", "' + encodeURIComponentEx(j) + '")\' title="' + "Déconnecter cette session" + '" style=cursor:pointer><img src=images/trash.png border=0 height=10 width=10></a>'; }
                    ...
                    for (var j in node.sessions.files) {
                        var trash = '';
                        if ((j == userinfo._id) || (GetNodeRights(node) == 0xFFFFFFFF)) { trash = ' <a href=# onclick=\'return endDeviceSession("files", "' + encodeURIComponentEx(node._id) + '", "' + encodeURIComponentEx(j) + '")\' title="' + "Déconnecter cette session" + '" style=cursor:pointer><img src=images/trash.png border=0 height=10 width=10></a>'; }
                    ...
                    for (var j in node.sessions.tcp) {
                        var trash = '';
                        if ((j == userinfo._id) || (GetNodeRights(node) == 0xFFFFFFFF)) { trash = ' <a href=# onclick=\'return endDeviceSession("tcp", "' + encodeURIComponentEx(node._id) + '", "' + encodeURIComponentEx(j) + '")\' title="' + "Déconnecter cette session" + '" style=cursor:pointer><img src=images/trash.png border=0 height=10 width=10></a>'; }
                    ...
                    for (var j in node.sessions.udp) {
                        var trash = '';
                        if ((j == userinfo._id) || (GetNodeRights(node) == 0xFFFFFFFF)) { trash = ' <a href=# onclick=\'return endDeviceSession("udp", "' + encodeURIComponentEx(node._id) + '", "' + encodeURIComponentEx(j) + '")\' title="' + "Déconnecter cette session" + '" style=cursor:pointer><img src=images/trash.png border=0 height=10 width=10></a>'; }
        ...
        function showDeviceMessages(nodeid, force, e) {
            ...
            x += '</div>';
            if (count > 0) setDialogMode(2, "Messages de l'agent" + ' - ' + EscapeHtml(node.name), 1, null, x, 'MESSAGES-' + node._id);
            return false;
        }

        var powerStatetable = ['', "Connecté", "Mettre en veille", "Mettre en veille", "Mettre en veille", "Veille prolongée", "Éteindre", "Présent", "Éteint"];
        var powerStateStrings = ['', "Connecté", "Dormir", "Dormir", "Veuille profonde", "Veille prolongée", "Arrêt progressif", "Présent", "Éteint"];
        var powerStateStrings2 = ['', "L'appareil est allumé", "L'appareil est en veille (S1)", "L'appareil est en veille (S2)", "L'appareil est en veille profonde (S3)", "L'appareil est en veille profonde (S4)", "L'appareil est arrêté (S5)", "L'appareil est connecté mais impossible de déterminer l'état de l'alimentation", "L'appareil est éteint"];
        ...
        function NodeStateStr(node) {
            ...
            if (node.conn) {
                ...
                if ((node.conn & 8) != 0) { states.push('<span>' + "Relais" + '</span>'); }
        ...
        function deviceHeaderSet() {
            ...
            deviceHeaders['DevxHeader' + deviceHeaderId] = ', ' + deviceHeaderTotal + ((deviceHeaderTotal == 1) ? " nœud" : " noeuds");
            var title = '';
        ...
        */
        ...
        function gotoDevice(nodeid, panel, refresh) {
            ...
            if (!currentNode || currentNode._id != node._id || refresh == true) {
                ...
                if ((currentNode.sessions != null) && (currentNode.sessions.battery != null)) {
                    ...
                    var statestr = '';
                    if (bat.state == 'ac') { statestr = "L'appareil est branché sur secteur"; }
                    if (bat.state == 'dc') { statestr = "L'appareil est sur batterie"; }
                ...
                // Attribute: Mesh
                if (mesh) { x += addDeviceAttribute('<span>' + "Groupe" + '</span>', '<a onclick=goForward("' + node.meshid + '") style=cursor:pointer>' + EscapeHtml(meshes[node.meshid].name) + '</a>'); }

                // Attribute: Name
                if (node.rname != null) { x += addDeviceAttribute('<span>' + "Nom" + '</span>', '<span>' + EscapeHtml(node.rname) + '</span>'); }

                // Attribute: Host
                if ((((features & 1) == 0) && (node.mtype != 4)) || (node.mtype == 3)) { // If not WAN-only, local hostname is in use
                    if ((meshrights & 4) != 0) {
                        if (node.host) {
                            x += addDeviceAttribute("Nom d'hôte", '<span onclick=showEditNodeValueDialog(1) style=cursor:pointer>' + EscapeHtml(node.host) + '</span>');
                        } else {
                            x += addDeviceAttribute("Nom d'hôte", '<span onclick=showEditNodeValueDialog(1) style=cursor:pointer><i>' + "Aucun" + '</i></span>');
                        }
                    } else {
                        x += addDeviceAttribute("Nom d'hôte", EscapeHtml(node.host));
                    }
                }
                ...
                // IP-KVM information
                if (node.mtype == 4) {
                    if (node.portnum != null) { x += addDeviceAttribute("Numéro de port", node.portnum); }
                    if (node.porttype != null) { x += addDeviceAttribute("Type de port", node.porttype); }
                }

                // Attribute: Mesh Agent
                if ((node.agent != null) && (node.agent.id != null) && (node.mtype == 3)) {
                    if (node.agent.id == 4) { x += addDeviceAttribute("Type d'appareil", "Windows"); }
                    if (node.agent.id == 6) { x += addDeviceAttribute("Type d'appareil", "Linux"); }
                    if (node.agent.id == 29) { x += addDeviceAttribute("Type d'appareil", "macOS"); }
                    ...
                    if ((node.agent.root === false) && ((node.conn & 1) != 0)) { str += ', ' + "Limité"; }
                ...
                if (node.intelamt != null) {
                    var str = '';
                    var provisioningStates = { 0: nobreak("Non activé (pré)"), 1: nobreak("Non activé (en)"), 2: nobreak("Activé") };
                    if (node.intelamt.ver != null && node.intelamt.state == null) { str += '<i>' + nobreak("Etat inconnu") + '</i>, v' + EscapeHtml(node.intelamt.ver); }
                    else if ((node.intelamt.ver == null) && (node.intelamt.state == 2)) { str += '<i>' + "Activé" + '</i>'; }
                    ...
                    if (node.intelamt.state == 2) {
                        if (node.intelamt.tls == 1) { str += ', <span title="' + "Intel&reg; AMT est configuré avec une sécurité réseau TLS" + '">' + "TLS" + '</span>'; }
                        ...
                        if (node.intelamt.user == null || node.intelamt.user == '') { // If credentials are not set, allow setting them.
                            if ((meshrights & 4) != 0) {
                                str += ', <i style=color:#FF0000;cursor:pointer title="' + "Éditer les certificats Intel&reg; AMT" + '" onclick=editDeviceAmtSettings("' + node._id + '")>' + "Aucun certificat" + '</i>';
                                editUserCredentialsIcon = true;
                            } else {
                                str += ', <i style=color:#FF0000>' + "Aucun certificat" + '</i>';
                            }
                            ...
                            var warn = null;
                            if ((node.intelamt.warn & 1) != 0) { warn = "Autorisation invalide"; }
                            if ((node.intelamt.warn & 8) != 0) { warn = "Vérification des identifiants"; }
                            if (warn != null) {
                                if ((meshrights & 4) != 0) {
                                    str += ', <i style=color:#FF0000;cursor:pointer title="' + "Éditer les certificats Intel&reg; AMT" + '" onclick=editDeviceAmtSettings("' + node._id + '")>' + warn + '</i>';
                                    editUserCredentialsIcon = true;
                                } else {
                        ...
                        if (editUserCredentialsIcon) {
                            str += '<img src=images/link4.png height=10 width=10 title="' + "Éditer les certificats Intel&reg; AMT" + '" style=cursor:pointer onclick=editDeviceAmtSettings("' + node._id + '")>';
                        }
                    }
                ...
                if ((node.agent != null) && (node.agent.tag != null) && (node.agent.tag != 'mailto:')) {
                    ...
                    x += addDeviceAttribute("Tag d'agent", tag);
                }
                ...
                if (connectivity && connectivity > 1) {
                    ...
                    if ((node.conn & 8) != 0) cstate.push('<span>' + "Relais d'agent" + '</span>');
                    if ((node.conn & 16) != 0) cstate.push('<span>' + "MQTT" + '</span>');
                    x += addDeviceAttribute("Connectivité", cstate.join(', '));
                }
                ...
                if ((meshrights & 4) != 0) {
                    x += addDeviceAttribute("Etiquettes", '<span onclick=showEditNodeValueDialog(3) style=cursor:pointer;color:black>' + groupingTags + '</span>');
                } else {
                    x += addDeviceAttribute("Etiquettes", '<span style=line-height:26px;color:black>' + groupingTags + '</span>');
                }
                ...
                if ((node.ssh != null) || (node.rdp != null)) {
                    var y = [];
                    if ((meshrights & 4) != 0) {
                        if (node.ssh != null) { y.push('<span onclick=showClearSshDialog(3) style=cursor:pointer>' + ((node.ssh == 1) ? "SSH - Utilisateur + Mot de passe" : ((node.ssh == 2) ? "SSH-Utlisateur+Clé+Mot de passe" : "SSH-Utilisateur+Clé")) + ' <img class=hoverButton src="images/link5.png" width=10 height=10 /></span>'); }
                        ...
                        if (node.ssh != null) { y.push(((node.ssh == 1) ? "SSH - Utilisateur + Mot de passe" : ((node.ssh == 2) ? "SSH-Utlisateur+Clé+Mot de passe" : "SSH-Utilisateur+Clé"))); }
                        if (node.rdp != null) { y.push("RDP"); }
                    }
                    x += addDeviceAttribute("Identifiants", y.join(', '));
                }

                x += '</table><br />';
                // Show action button, only show if we have permissions 4, 8, 64
                if (((meshrights & (4 + 8 + 64 + 262144)) != 0) && (node.mtype < 3)) { x += '<input type=button value="' + "Actions" + '" onclick=deviceActionFunction() />'; }
                x += '<input type=button value="' + "Remarques" + '" onclick=showNotes(' + ((meshrights & 128) == 0) + ',"' + encodeURIComponent(node._id) + '") />';
                ...
                if ((node.mtype == 4) && (connectivity & 1)) {
                    if (node.porttype == 'PDU') {
                        if (node.pwr == 1) {
                            if (meshrights & 0x40000) { x += '<input type=button value="' + "Éteindre" + '" title="' + "Éteindre" + '" onclick=setIpPduState(0) />'; }
                        } else if (node.pwr == 8) {
                            if (meshrights & 0x40) { x += '<input type=button value="' + "Allumer" + '" title="' + "Allumer" + '" onclick=setIpPduState(1) />'; }
                        }
                    } else {
                        if (meshrights & 8) { x += '<input type=button value="' + "Télécommande" + '" title="' + "Télécommande" + '" onclick=openIpKvmRemoteControl("' + encodeURIComponentEx(node._id) + '") />'; }x
                    }
                }
                ...
                if ((meshrights & 0x8000) != 0) { x += '<a style=cursor:pointer onclick=p10showDeleteNodeDialog("' + node._id + '")>' + "Supprimer l'appareil" + '</a>'; }
                ...
                if ((connectivity & 2) != 0) { if (powerstate.length > 0) { powerstate += ', '; } powerstate += "Intel&reg; AMT connecté"; }
                else if ((connectivity & 4) != 0) { if (powerstate.length > 0) { powerstate += ', '; } powerstate += "Intel&reg; AMT detecté"; }
                if ((connectivity & 16) != 0) { if (powerstate.length > 0) { powerstate += ', '; } powerstate += "Canal MQTT connecté"; }
        ...
        function setIpPduState(op) {
            if (op == 0) {
                setDialogMode(2, "Alimentation", 3, function () { meshserver.send({ action: 'poweraction', nodeids: [currentNode._id], actiontype: 2 }); }, "Éteindre ?"); // Turn off
            } else {
                setDialogMode(2, "Alimentation", 3, function () { meshserver.send({ action: 'wakedevices', nodeids: [currentNode._id] }); }, "Démarrer ?"); // Turn on
            }
        }
        ...
        function deviceToastFunction() {
            if (xxdialogMode) return;
            setDialogMode(2, "Toast de l'appareil", 3, deviceToastFunctionEx, '<textarea id=d2devToast style=width:100%;height:80px;resize:none;overflow-y:scroll></textarea>');
        }
        ...
        function setupDeviceMenu(op, obj) {
            ...
            var menus = [];
            if (currentDevicePanel != 0) { menus.push({ n: "Général", f: 'setupDeviceMenu(0)' }); }
            ...
            ) { menus.push({ n: "Bureau", f: 'setupDeviceMenu(1)' }); }
            ...
            if ((currentDevicePanel != 2) && (currentNode != null) && (meshrights & 8) && ((meshrights == 0xFFFFFFFF) || ((meshrights & 1024) == 0)) && ((currentNode.mtype != 1) && (currentNode.agent) && (currentNode.agent.caps & 4))) { menus.push({ n: "Dossiers", f: 'setupDeviceMenu(2)' }); }
            if ((currentDevicePanel != 3) && (currentNode != null) && (currentNode.mtype < 3) && ((meshrights & 1048576) != 0)) { menus.push({ n: "Détails", f: 'setupDeviceMenu(3)' }); }
        ...
        function deviceActionFunction() {
            ...
            var x = "Sélectionner l'opération à réaliser sur l'appareil" + '<br /><br />';
            ...
            if ((currentNode.agent != null) && (currentNode.agent.id == 14)) {
                if (((currentNode.conn & 1) != 0) && ((rights & 8) != 0)) {
                    ...
                    y += '<option value=401>' + "Vibrer" + '</option>';
                    z += '<div id=d2devicetimediv>' + addHtmlValue("Temps", '<select id=d2devicetime style=float:right;width:170px><option value=1000>' + "1 seconde" + '</option><option value=5000>' + "5 secondes" + '</option><option value=10000>' + "10 secondes" + '</option></select>') + '</div>';
                }
            } else {
                if ((rights & 64) != 0) { count++; y += '<option value=100>' + "Réveil" + '</option>'; } // Wake-up permission
                //if (((currentNode.conn & 1) != 0) && ((rights & 131072) != 0)) { count++; y += '<option value=106>' + "Run Commands" + '</option>'; } // Remote command permission
                if ((currentNode.conn != 0) && ((rights & 262144) != 0)) { count++; y += '<option value=4>' + "Mettre en veille" + '</option><option value=3>' + "Réinitialiser" + '</option><option value=2>' + "Éteindre" + '</option>'; }
                ...
                if ((currentNode.intelamt != null) && (currentNode.intelamt.state == 2) && ((currentNode.conn & 6) != 0) && ((rights & 262144) != 0)) {
                    count++;
                    y += '<option value=310>' + "Redémarrage Intel&reg; AMT" + '</option>';
                    y += '<option value=308>' + "Extinction Intel&reg; AMT" + '</option>';
                }
                if ((currentNode.intelamt != null) && (currentNode.intelamt.state == 2) && ((currentNode.conn & 6) != 0) && ((rights & 64) != 0)) {
                    count++;
                    y += '<option value=302>' + "Démarrage Intel&reg; AMT" + '</option>';
                }
            ...
            if (count == 0) { x = "Aucune action n'est actuellement disponible pour cet appareil."; }
            setDialogMode(2, "Action du périphérique", (count == 0) ? 2 : 3, deviceActionFunctionEx, x + z);
        ...
        function deviceActionFunctionEx() {
            ...
            if (op == 100) {
                ...
                */
                ...
                setDialogMode(2, "Fonctionnement de l'alimentation Intel&reg; AMT", 3, function () { meshserver.send({ action: 'poweraction', nodeids: [currentNode._id], actiontype: parseInt(op) }); }, "Démarrage par Intel&reg; AMT ?");
            } else if (op == 308) { // Intel AMT power off
                setDialogMode(2, "Fonctionnement de l'alimentation Intel&reg; AMT", 3, function () { meshserver.send({ action: 'poweraction', nodeids: [currentNode._id], actiontype: parseInt(op) }); }, "Perform Intel&reg; AMT power off?<br><br><b>NOTE: If there is an active AMT session, then power off command will be rejected, so you must disconnect from the AMT session first!</b>");
            } else if (op == 310) { // Intel AMT reset
                setDialogMode(2, "Fonctionnement de l'alimentation Intel&reg; AMT", 3, function () { meshserver.send({ action: 'poweraction', nodeids: [currentNode._id], actiontype: parseInt(op) }); }, "Redémarrage par Intel&reg; AMT ?");
        ...
        function showNotes(readonly, noteid) {
            ...
            if (noteid.startsWith('node%2F%2F')) { x += '<span style=font-size:10px>' + "Les notes de groupes peuvent être vues et modifiées par les autres administrateurs de groupes." + '<span>'; }
            setDialogMode(2, "Remarques", 3, showNotesEx, x, noteid);
        ...
        function deviceLockFunction() {
            if ((xxdialogMode != null || xxdialogMode == 0) && (desktop != null) && (desktop.contype == 1)) { setDialogMode(2, "Verrouiller le bureau", 3, function() { if ((desktop != null) && (desktop.contype == 1)) { desktop.sendCtrlMsg('{"ctrlChannel":"102938","type":"lock"}'); } }, "Verrouiller le bureau de l'utilisateur ?"); }
        }

        function deviceChat(e) {
            if (xxdialogMode) return;
            setDialogMode(2, "Action du périphérique", 3, function () {
        ...
        function deviceUrlFunction() {
            if (xxdialogMode) return;
            setDialogMode(2, "Ouvrir la page sur l'appareil", 3, deviceUrlFunctionEx, '<input id=d2devurl placeholder="http://server.com" style=width:100%;overflow-y:scroll onkeyup=deviceUrlFunctionValidate() onchange=deviceUrlFunctionValidate()></input>');
            Q('d2devurl').focus();
        ...
        function d2runCommandDialog(options) {
            ...
            if ((wintype == true) || (linuxtype == true) || (agenttype == true)) {
                ...
                if (wintype == true) { x += '<option value=1' + ((runopt.type == 1)?' selected':'') + '>' + "Ligne de commande Windows" + '</option><option value=2' + ((runopt.type == 2)?' selected':'') + '>' + "Windows PowerShell" + '</option>'; }
                if (linuxtype == true) { x += '<option value=3' + ((runopt.type == 3)?' selected':'') + '>' + "Commandes d'installation Linux / BSD / macOS" + '</option>'; }
                if (agenttype == true) { x += '<option value=4' + ((runopt.type == 4)?' selected':'') + '>' + "Console d'agent" + '</option>'; } // MESHRIGHT_REMOTECONTROL & MESHRIGHT_AGENTCONSOLE are needed
                x += '</select>';
                x += '<select id=d2cmduser style=width:100%;margin-bottom:4px><option value=0' + ((runopt.runAs == 0)?' selected':'') + '>' + "Exécution en tant qu'agent" + '</option><option value=1' + ((runopt.runAs == 1)?' selected':'') + '>' + "Exécution en tant qu'utilisateur, à défaut en tant qu'agent" + '</option><option value=2' + ((runopt.runAs == 2)?' selected':'') + '>' + "Doit être exécuté en tant qu'utilisateur" + '</option></select>';
                if (options.selectedFile == null) {
                    x += '<select id=d2cmdsource onclick=d2runCommandValidate() style=width:100%;margin-bottom:4px><option value=0' + ((runopt.source == 0)?' selected':'') + '>' + "Commandes depuis une zone de texte" + '</option><option value=1' + ((runopt.source == 1)?' selected':'') + '>' + "Commandes depuis le fichier" + '</option>';
                    if (userinfo.siteadmin & 8) { x += '<option value=2' + ((runopt.source == 2)?' selected':'') + '>' + "Commandes depuis le fichier sur le serveur" + '</option>'; }
                ...
                setDialogMode(2, "Exécuter des commandes", 3, d2groupActionFunctionRunCommands, x, options);
                if (options.selectedFile == null) {
                    Q('d2runcmd').focus();
        ...
        function editDeviceAmtSettings(nodeid, func) {
            ...
            if ((features2 & 1) == 0) { x += addHtmlValue("Sécurité", '<select id=dp10tls style=width:176px><option value=0>' + "Pas de sécurité TLS" + '</option><option value=1>' + "Sécurité TLS requise" + '</option></select>'); }
            if ((node.intelamt.user != null) && (node.intelamt.user != '')) { buttons = 7; }
            setDialogMode(2, "Éditer les certificats Intel&reg; AMT", buttons, editDeviceAmtSettingsEx, x, { node: node, func: func });
        ...
        function p10showDeleteNodeDialog(nodeid) {
            if (xxdialogMode) return;
            setDialogMode(2, "Supprimer le noeud", 3, p10showDeleteNodeDialogEx, format("Supprimer {0}?", EscapeHtml(currentNode.name)) + '<br /><br /><label><input id=p10check type=checkbox onchange=p10validateDeleteNodeDialog() />' + "Confirmer" + '</label>', nodeid);
        ...
        function showClearSshDialog() { setDialogMode(2, "Modifier l'appareil", 3, showClearSshDialogEx, "Effacer les identifiants SSH ?"); }
        function showClearSshDialogEx(button, mode) { meshserver.send({ action: 'changedevice', nodeid: currentNode._id, ssh: 0 }); }
        function showClearRdpDialog() { setDialogMode(2, "Modifier l'appareil", 3, showClearRdpDialogEx, "Supprimer les accréditations RDP ?"); }
        function showClearRdpDialogEx(button, mode) { meshserver.send({ action: 'changedevice', nodeid: currentNode._id, rdp: 0 }); }

        var showEditNodeValueDialog_modes = ["Nom de l'appareil", "Nom d'hôte", "Description", "Etiquettes"];
        ...
        function showEditNodeValueDialog(mode) {
            ...
            setDialogMode(2, "Modifier l'appareil", 3, showEditNodeValueDialogEx, x, mode);
        ...
        var agentConsoleMessages = ['', "En attente de l'autorisation d'accès par l'utilisateur ...", "Refusée", "Impossible de démarrer la session de terminal distant, {0} ({1})", "Timeout", "Données réseau reçues non valides"];
        ...
        function updateDeskShortcutKeys() {
            var x = '<div class="menuButton" onclick="deskMenuButton(-1)">' + "Personnaliser" + '</div>';
        ...
        var keyStrings = { 8: "Backspace", 9: "Tab", 13: "Entrer", 27: "Echap", 32: "Space", 44: "Impression écran", 45: "Insérer", 46: "Suppr", 36: "Home", 35: "Fin", 32: "Espace", 33: "Haut de page", 34: "Bas de page", 37: "Gauche", 38: "Parent", 39: "Droit", 40: "Bas", 0: "Aucun" }
        ...
        function deskCustomizeKeys() {
            ...
            x += '</select> <input type=button value=' + "Ajouter" + ' onclick=addDeskCustomizeKey() /></div>';
            QH('p10dialog2', x);
            xxdialogMode = 2;
            QV('p10dialog', true);
        ...
        function deskUpdateShortcutList() {
            ...
            if (x == '') { x = '<i>' + "Aucun raccourci clavier défini" + '</i>'; }
            QH('d2shortcuts', x);
        }
        ...
        function sendSpecialKeys() {
            if (xxdialogMode || desktop == null || desktop.State != 3) return;
            setDialogMode(3, "Touches spéciales", 3, deskSendKeys);
        }
        ...
        function deskSelectScreens() {
            ...
            x = addHtmlValue4("Écran", '<select style=width:100% id=deskdisplays>' + x + '</select>');
            setDialogMode(2, "Sélection d'écran", 3, deskSelectScreensEx, x);
        }
        ...
        function cmsshportaction(action) {
            if (xxdialogMode) return;
            var x = "Port de connexion distant SSH :" + '<br /><br /><input type=text placeholder="22" inputmode="numeric" pattern="[0-9]*" onkeypress="return (event.keyCode == 8) || (event.charCode >= 48 && event.charCode <= 57)" maxlength=5 id=d10sshport type=text>';
            setDialogMode(2, "Connexion SSH", 3, function () {
        ...
        function sshTunnelAuthDialog(j, func) {
            var x = '';
            if (j.askkeypass) {
                x += addHtmlValue("Authentification", '<select id=dp2authmethod style=width:150px onchange=sshAuthUpdate(event)><option value=3 selected>' + "Clé enregistrée" + '</option><option value=1>' + "Identifiant & Mot de passe" + '</option><option value=2>' + "Identifiant & Clé" + '</option></select>');
            } else {
                x += addHtmlValue("Authentification", '<select id=dp2authmethod style=width:150px onchange=sshAuthUpdate(event)><option value=1 selected>' + "Identifiant & Mot de passe" + '</option><option value=2>' + "Identifiant & Clé" + '</option></select>');
            }
            x += '<div id=d2userauth style=display:none>';
            x += addHtmlValue("Nom d'utilisateur", '<input id=dp2user style=width:150px maxlength=64 autocomplete=off onkeyup=sshAuthUpdate(event) />');
            x += '</div>';
            x += '<div id=d2passauth style=display:none>';
            x += addHtmlValue("Mot de passe", '<input type=password id=dp2pass style=width:150px maxlength=64 autocomplete=off onkeyup=sshAuthUpdate(event) />');
            if ((features2 & 0x00400000) == 0) { x += '<label><input id=dp2keep type=checkbox>' + "Mémoriser les identifiants" + '</label>'; }
            x += '</div><div id=d2keyauth style=display:none>';
            x += addHtmlValue("Fichier de la clé", '<input type=file id=dp2key style=width:150px maxlength=64 autocomplete=off onchange=sshAuthUpdate(event) />' + '<div id=d2badkey style=font-size:x-small>' + "La clé doit être au format OpenSSH" + '</div>');
            x += addHtmlValue("Mot de passe de la clé", '<input type=password id=dp2keypass style=width:150px maxlength=64 autocomplete=off onkeyup=sshAuthUpdate(event) />');
            if ((features2 & 0x00400000) == 0) {
                x += '<label><input id=dp2keep1 type=checkbox onchange=sshAuthUpdate(event)>' + "Se souvenir de l'utilisateur et de la clé" + '</label><br/>';
                x += '<label><input id=dp2keep2 type=checkbox>' + "Se souvenir du mot de passe" + '</label>';
            }
            x += '</div>';
            if (j.askkeypass) {
                x += '<div id=d2keyauth2 style=display:none>';
                x += addHtmlValue("Mot de passe", '<input type=password id=dp2keypass2 style=width:150px maxlength=64 autocomplete=off onkeyup=sshAuthUpdate(event) />');
                x += '</div>';
            }
            setDialogMode(2, "Authentification", 11, func, x, 'ssh');
            Q('dp2user').focus();
            sshAuthUpdate();
            ...
            if (typeof data == 'string') {
                if (data[0] == '{') {
                    ...
                    switch (j.action) {
                        ...
                        case 'autherror': { p12setConsoleMsg("Erreur d'authentification", 5000); break; }
                        case 'sessionerror': { p12setConsoleMsg("Session expirée", 5000); break; }
                        case 'sessiontimeout': { p12setConsoleMsg("Expiration de la session", 5000); break; }
                    }
                } else if (data[0] == '~') {
        ...
        */
        ...
        function p13gotFiles(data) {
            ...
            switch (data.action) {
                ...
                case 'autherror': { p13setConsoleMsg("Erreur d'authentification", 5000); return; }
                case 'connectionerror': { p13setConsoleMsg("Erreur de connexion", 5000); return; }
                case 'sessionerror': { p13setConsoleMsg("Session expirée", 5000); return; }
                case 'sessiontimeout': { p13setConsoleMsg("Expiration de la session", 5000); return; }
            }
        ...
        function p13updateFiles(checkedNames) {
            var html1 = '', html2 = '', displayPath = '<a style=cursor:pointer;color:black onclick=p13folderup(0)>' + "Racine" + '</a>', fullPath = 'Root';
        ...
        function p13setActions() {
            ...
            if (p13filetree == null) {
                ...
                Q('p13SelectAllButton').value = "Tout";
        ...
        function p13deletefile() { var cc = p13getFileSelCount(), rec = (p13getFileSelDirCount() > 0) ? '<br /><br /><label><input type=checkbox id=p13recdeleteinput>' + "Suppression récursive" + '</label><br>' : '<input type=checkbox id=p13recdeleteinput style=\'display:none\'>'; setDialogMode(2, "Supprimer", 3, p13deletefileEx, (cc > 1) ? (format("Supprimer ces {0} éléments ?", cc) + rec) : ("Supprimer cet élément ?" + rec)); }
        ...
        function p13uploadFile() { setDialogMode(2, "Envoyer un fichier", 3, p13uploadFileEx, '<input type=file name=files id=p13uploadinput style=width:100% multiple=multiple onchange="updateUploadDialogOk(\'p13uploadinput\')" />'); updateUploadDialogOk('p13uploadinput'); }
        ...
        function p13viewfile() {
            ...
            for (var i = 0; i < checkboxes.length; i++) {
                if (checkboxes[i].checked) {
                    ...
                    } else { messagebox("Éditeur de fichier", "Seuls les fichiers de moins de 200k peuvent être modifiés."); }
                    break;
                }
            }
        }
        ...
        function p13pasteFile() {
            ...
            if ((p13clipboard != null) && (p13clipboard.length > 0)) {
                if (p13clipboardCut == 0) {
                    if (p13clipboard.length > 1) { x = format("Confirmer la copie de {0} entrées à cet emplacement?", p13clipboard.length); } else { x = format("Confirmer la copie de 1 entrée à cet emplacement?"); }
                } else {
                    if (p13clipboard.length > 1) { x = format("Confirmer le déplacement de {0} entrées vers cet emplacement?", p13clipboard.length); } else { x = format("Confirmer le déplacement de 1 entrée vers cet emplacement?"); }
                }
            }
            ...
            if ((p13clipboard != null) && (p13clipboard.length > 0)) {
                if (p13clipboardCut == 0) {
                    if (p13clipboard.length > 1) {
                        x = format("Conservation de {0} entrées pour la copie" + ', <a href=# onclick="return p13clearClip()" style=cursor:pointer>' + "Nettoyer" + '</a>.', p13clipboard.length);
                    } else {
                        x = format("Tenir 1 entrée pour copie" + ', <a href=# onclick="return p13clearClip()" style=cursor:pointer>' + "Nettoyer" + '</a>.');
                    }
                } else {
                    if (p13clipboard.length > 1) {
                        x = format("Conservation de {0} entrées pour le déplacement" + ', <a href=# onclick="return p13clearClip()" style=cursor:pointer>' + "Nettoyer" + '</a>.', p13clipboard.length);
                    } else {
                        x = format("Tenir 1 entrée pour se déplacer" + ', <a href=# onclick="return p13clearClip()" style=cursor:pointer>' + "Nettoyer" + '</a>.');
                    }
                }
            }
        ...
        function p13downloadfile(x, y, z) {
            ...
            setDialogMode(2, "Télécharger le fichier", 10, p13downloadFileCancel, '<div>' + EscapeHtml(downloadFile.file) + '</div><br /><progress id=d2progressBar style=width:100% value=0 max=' + z + ' />');
        }
        ...
        */
        ...
        function p13doUploadFiles(files) {
            ...
            if (overWriteCount == 0) {
                ...
                setDialogMode(2, "Envoyer un fichier", 3, p13uploadFileContinue, format((overWriteCount == 1) ? "L'envoi écrasera 1 fichier. Continuer ?" : "L'envoi écrasera {0} fichiers. Continuer ?", overWriteCount), files);
            }
        }
        ...
        function p13uploadFileContinue(b, files) {
            ...
            setDialogMode(2, "Envoyer un fichier", 10, p13uploadFileCancel, '<div id=p13dfileName>' + "En cours de connexion ..." + '</div><br /><progress id=d2progressBar style=width:100% value=0 max=0 />');
            p13uploadNextFile();
        }
        ...
        function updateDeviceDetails(node, hardware, network) {
            ...
            if (hardware.windows && hardware.windows.osinfo) {
                ...
                if (m.OSArchitecture) {
                    if (m.OSArchitecture.startsWith('32')) { x += addDetailItem("Architecture", "32 bits", s); }
                    else if (m.OSArchitecture.startsWith('64')) { x += addDetailItem("Architecture", "64 bits", s); }
                ...
                if(m.Domain){ x += addDetailItem((m.PartOfDomain ? "Domaine" : "Groupe de travail"), EscapeHtml(m.Domain), s); }
            }
            ...
            if (node.wsc) {
                var y = [];
                if (node.wsc.antiVirus != null) { if (node.wsc.antiVirus == 'OK') { y.push("Antivirus" + ' - <span style=color:green>' + "OK" + '</span>'); } else { y.push("Antivirus" + ' - <span style=color:red>' + "Désactivé" + '</span>'); } }
                if (node.wsc.autoUpdate != null) { if (node.wsc.autoUpdate == 'OK') { y.push("Mettre à jour" + ' - <span style=color:green>' + "OK" + '</span>'); } else { y.push("Mettre à jour" + ' - <span style=color:red>' + "Désactivé" + '</span>'); } }
                if (node.wsc.firewall != null) { if (node.wsc.firewall == 'OK') { y.push("Parefeu" + ' - <span style=color:green>' + "OK" + '</span>'); } else { y.push("Parefeu" + ' - <span style=color:red>' + "Désactivé" + '</span>'); } }
                x += addDetailItem("Sécurité Windows", y.join(', '));
            }

            // Defender for Windows Server
            if(node.defender) {
                var y = [];
                if (node.defender.RealTimeProtection != null) { if (node.defender.RealTimeProtection == true) { y.push("RealTimeProtection" + ' - <span style=color:green>' + "On" + '</span>'); } else { y.push("RealTimeProtection" + ' - <span style=color:red>' + "Éteint" + '</span>'); } }
                if (node.defender.TamperProtected != null) { if (node.defender.TamperProtected == true) { y.push("TamperProtection" + ' - <span style=color:green>' + "On" + '</span>'); } else { y.push("TamperProtection" + ' - <span style=color:red>' + "Éteint" + '</span>'); } }
                if (node.defender.AntivirusSignatureVersion != null) { y.push("Version de la signature" + ' - <span style=color:green>' + EscapeHtml(node.defender.AntivirusSignatureVersion) + '</span>'); }
            ...
            if (node.av && node.av.length > 0) {
                ...
                for (var i in node.av) {
                    if (node.av[i].product) {
                        ...
                        if (node.av[i].enabled !== true) { avx += ' - <span style=color:red>' + "Désactivé" + '</span>'; }
           ...
           if (node.users && node.users.length > 0) {
                var u = node.users.map(function(user) {
                    return addKeyLinkConditional(EscapeHtml(user), "Verrouiller", (node.lusers && node.lusers.indexOf(user) >= 0));
                }).join(', ');
                x += addDetailItem((node.users.length > 1 ? "Utilisateurs actifs" : "Utilisateur actif"), u);
            }

            if (x != '') { sections.push({ name: "Système d'exploitation", html: x, img: 'software' }); }
            ...
            if (node.agent) {
                ...
                if (node.firstconnect) { x += addDetailItem("Connexion du premier agent", printDateTime(new Date(node.firstconnect))); }
                if ((node.conn & 1) != 0) {
                    x += addDetailItem("Dernière connexion de l'agent", "Connecté maintenant");
                } else {
                    if (node.lastconnect) { x += addDetailItem("Dernière connexion de l'agent", printDateTime(new Date(node.lastconnect))); }
                }
                if (node.lastaddr) {
                    var splitip = node.lastaddr.split(':');
                    if (splitip.length > 2) {
                        // IPv6
                        x += addDetailItem("Dernière adresse de l'agent", node.lastaddr);
                    } else {
                        // IPv4
                        if (isPrivateIP(node.lastaddr)) {
                            x += addDetailItem("Dernière adresse de l'agent", splitip[0]);
                        } else {
                            x += addDetailItem("Dernière adresse de l'agent", '<a href="https://iplocation.com/?ip=' + splitip[0] + '" rel="noreferrer noopener" target="MeshIPLoopup">' + splitip[0] + '</a>');
                        }
                    }
                }
                if (hardware.agentvers != null) {
                    if (hardware.agentvers.compileTime) {
                        try {
                            ...
                            x += addDetailItem("Date de compilation", printDateTime(new Date(d)));
                        } catch (ex) { }
                    }
                }
                if (hardware.time != null) {
                    x += addDetailItem("Dernière mise à jour des détails", printDateTime(new Date(hardware.time)));
                }
            ...
            if (hardware.mobile) {
                var x = '';
                if (hardware.mobile.brand && hardware.mobile.model) { x += addDetailItem("Modèle", EscapeHtml(hardware.mobile.brand + ', ' + hardware.mobile.model), s); }
                if (hardware.mobile.device) { x += addDetailItem("Appareil", EscapeHtml(hardware.mobile.device), s); }
                if (hardware.mobile.bootloader) { x += addDetailItem("Chargeur de démarrage", EscapeHtml(hardware.mobile.bootloader), s); }
                if (hardware.mobile.id) { x += addDetailItem("Identifiant", EscapeHtml(hardware.mobile.id), s); }
                if (hardware.mobile.host) { x += addDetailItem("Nom d'hôte", EscapeHtml(hardware.mobile.host), s); }
                ...
                if (x != '') { sections.push({ name: "Appareil mobile", html: x, img: 'mobile' }); }
            }
            ...
            if (network.netif2 != null) {
                ...
                for (var i in network.netif2) {
                    ...
                    if (typeof m[0].mac == 'string') {
                        if (m[0].gatewaymac) {
                            x += addDetailItem("Couche MAC", format("MAC: {0}, passerelle: {1}", EscapeHtml(m[0].mac), EscapeHtml(m[0].gatewaymac)));
                        } else {
                            x += addDetailItem("Couche MAC", format("MAC: {0}", EscapeHtml(m[0].mac)));
                        }
                    }
                    if (typeof m[0].speed == 'number' && (m[0].speed != 9223372036854775807 && m[0].speed > 0)) {
                        x += addDetailItem("Vitesse d'interface", format("{0}", getNetworkSpeed(m[0].speed)));
                    }
                    for (var j = 0; j < m.length; j++) {
                        var iplayer = m[j], items = [];
                        if (iplayer.address) { items.push(format("IP: {0}", EscapeHtml(iplayer.address))); }
                        if (iplayer.netmask) { items.push(format("Masque : {0}", EscapeHtml(iplayer.netmask))); }
                        if (iplayer.gateway) { items.push(format("Passerelle : {0}", EscapeHtml(iplayer.gateway))); }
                        if (items.length > 0) {
                            if (iplayer.family == 'IPv4') { x += addDetailItem("Couche IPv4", items.join(", ")); }
                            if (iplayer.family == 'IPv6') { x += addDetailItem("Couche IPv6", items.join(", ")); }
                        }
                    }
                    x += '</div></td></tr>';
                }
                ...
                x += '</table>';
                if (x != '') { sections.push({ name: "Réseaux", html: x, img: 'networking' }); }
            }

            // Attribute: Intel AMT
            if (node.intelamt != null) {
                var x = '';
                x += addDetailItem("Version", (node.intelamt.ver) ? ('v' + EscapeHtml(node.intelamt.ver)) : ('<i>' + "Inconnue" + '</i>'), s);
                x += addDetailItem("Identifiant", (node.intelamt.uuid) ? (EscapeHtml(node.intelamt.uuid)) : ('<i>' + "Inconnue" + '</i>'), s);
                var provisioningStates = { 0: nobreak("Non activé (pré)"), 1: nobreak("Non activé (en)"), 2: nobreak("Activé") };
                ...
                x += addDetailItem("État d'approvisionnement", ((node.intelamt.state) ? (provisioningStates[node.intelamt.state]) : ('<i>' + "Inconnue" + '</i>')) + provisioningMode, s);
                x += addDetailItem("Sécurité", (node.intelamt.tls == 1) ? "Sécurisé à l'aide de TLS" : "TLS n'est pas configuré", s);
                // Check that the Intel AMT user is setup and there is no warnings (1 = invalid credentials, 8 = trying)
                x += addDetailItem("Informations d'identification d'administrateur", ((node.intelamt.user) == null || (node.intelamt.user == '') || ((node.intelamt.warn != null) && ((node.intelamt.warn & 9) != 0))) ? "Pas connu" : "Connu", s);
                if (x != '') {
                    if ((typeof node.intelamt.sku == 'number') && ((node.intelamt.sku & 16) != 0)) {
                        sections.push({ name: "Gestion standard Intel&reg; (Intel&reg; SM)", html: x, img: 'amt' });
                    } else {
            ...
            if (hardware.identifiers) {
                ...
                // BIOS
                if (ident.bios_vendor) { x += addDetailItem("Vendeur", EscapeHtml(ident.bios_vendor), s); }
                if (ident.bios_version) { x += addDetailItem("Version", EscapeHtml(ident.bios_version), s); }
                if (ident.bios_serial) { x += addDetailItem("Numéro de série", EscapeHtml(ident.bios_serial), s); }
                if (ident.bios_mode) { x += addDetailItem("Mode", EscapeHtml(ident.bios_mode), s); }
                if (x != '') { sections.push({ name: "BIOS", html: x, img: 'chip' }); }

                // Motherboard
                x = '';
                if (ident.board_vendor) { x += addDetailItem("Vendeur", EscapeHtml(ident.board_vendor), s); }
                if (ident.board_name) { x += addDetailItem("Nom", EscapeHtml(ident.board_name), s); }
                if (ident.board_serial && (ident.board_serial != '')) { x += addDetailItem("Numéro de série", EscapeHtml(ident.board_serial), s); }
                if (ident.board_version) { x += addDetailItem("Version", EscapeHtml(ident.board_version), s); }
                if (ident.product_uuid) { x += addDetailItem("Identifiant", EscapeHtml(ident.product_uuid), s); }
                ...
                if (x != '') { sections.push({ name: "Carte mère", html: x, img: 'motherboard' }); }
            }
            ...
            if (hardware.tpm) {
                ...
                if (tpm.ManufacturerId) { x += addDetailItem("Identifiant", EscapeHtml(tpm.ManufacturerId), s); }
                if (tpm.ManufacturerVersion) { x += addDetailItem("Version", EscapeHtml(tpm.ManufacturerVersion), s); }
                if (tpm.IsActivated != null) { x += addDetailItem("Activé", (tpm.IsActivated ? "Yes" : "No"), s); }
                if (tpm.IsEnabled != null) { x += addDetailItem("Activer", (tpm.IsEnabled ? "Yes" : "No"), s); }
                if (tpm.IsOwned != null) { x += addDetailItem("Possédé", (tpm.IsOwned ? "Yes" : "No"), s); }
            ...
            if (hardware.battery) {
                ...
                for (var i in hardware.battery) {
                    ...
                    x += '<tr><td><div class=style10 style=border-radius:5px;padding:8px>';
                    x += '<div style=margin-bottom:3px><b>' + EscapeHtml(battery.DeviceName ? battery.DeviceName : "Inconnue") + '</b></div>';
                    if (battery.CycleCount) { x += addDetailItem("Nombre de cycles", EscapeHtml(battery.CycleCount), s); }
                    if (battery.FullChargedCapacity) { x += addDetailItem("Capacité chargée à pleine capacité", format("{0} mWh", battery.FullChargedCapacity), s); }
                    if (battery.EstimatedRuntime) { x += addDetailItem("Durée d'exécution estimée", format("{0} minutes", Math.floor((battery.EstimatedRuntime / 60))), s); }
                    if (battery.Chemistry) { x += addDetailItem("Chimie", EscapeHtml(battery.Chemistry), s); }
                    if (battery.DesignedCapacity) { x += addDetailItem("Capacité de conception", format("{0} mWh", battery.DesignedCapacity), s); }
                    if (battery.ManufactureDate) { x += addDetailItem("Date de fabrication", EscapeHtml(battery.ManufactureDate), s); }
                    if (battery.ManufactureName) { x += addDetailItem("Nom de fabrication", EscapeHtml(battery.ManufactureName), s); }
                    if (battery.SerialNumber) { x += addDetailItem("Numéro de série", EscapeHtml(battery.SerialNumber), s); }
                    if (battery.ChargeRate) { x += addDetailItem("Taux de facturation", format("{0} mW", battery.ChargeRate), s); }
                    if (battery.Charging != null) { x += addDetailItem("Chargement", (battery.Charging ? "Yes" : "No"), s); }
                    if (battery.DischargeRate) { x += addDetailItem("Taux de décharge", format("{0} mW", battery.DischargeRate), s); }
                    if (battery.Discharging != null) { x += addDetailItem("Décharge", (battery.Discharging ? "Yes" : "No"), s); }
                    if (battery.RemainingCapacity) { x += addDetailItem("Capacité restante", format("{0} mWh", battery.RemainingCapacity), s); }
                    if (battery.Voltage) { x += addDetailItem("Tension", format("{0} V", (battery.Voltage / 1000)), s); }
                    if (battery.Health) { x += addDetailItem("Santé", format("{0} %", battery.Health), s); }
                    if (battery.BatteryCharge) { x += addDetailItem("Charge de la batterie", format("{0} %", battery.BatteryCharge), s); }   
                    x += '</div>';
                }
                x += '</table>';
            ...
            if (hardware.windows) {
                if (hardware.windows.memory && (hardware.windows.memory.length > 0)) {
                    ...
                    for (var i in hardware.windows.memory) {
                        ...
                        if (m.Capacity && m.Speed) { x += addDetailItem("Capcité / Vitesse", format("{0} Mo, {1} Mhz", (m.Capacity / 1024 / 1024), m.Speed), s); }
                        else if (m.Capacity) { x += addDetailItem("Capacité", format("{0} Mo", (m.Capacity / 1024 / 1024)), s); }
                        if (m.PartNumber) { x += addDetailItem("Réference", EscapeHtml((m.Manufacturer && m.Manufacturer != 'Undefined') ? (m.Manufacturer + ', ') : '') + EscapeHtml(m.PartNumber), s); }
                        x += '</div>';
                    }
                    x += '</table>';

                    if (x != '') { sections.push({ name: "Mémoire", html: x, img: 'ram' }); }
                }
            }
            ...
            if (hardware.linux) {
                if (hardware.linux.memory && (hardware.linux.memory.Memory_Device.length > 0)) {
                    ...
                    for (var i in hardware.linux.memory.Memory_Device) {
                        ...
                        if (m.Size && m.Speed) { x += addDetailItem("Capcité / Vitesse", format("{0}, {1}", m.Size, m.Speed), s); }
                        else if (m.Size) { x += addDetailItem("Capacité", format("{0}", (m.Size)), s); }
                        if (m.PartNumber) { x += addDetailItem("Réference", EscapeHtml((m.Manufacturer && m.Manufacturer != 'Undefined')?(m.Manufacturer + ', '):'') + EscapeHtml(m.PartNumber), s); }
                        x += '</div>';
                    }
                    x += '</table>';
            ...
            if (hardware.darwin) {
                if (hardware.darwin.memory && (hardware.darwin.memory.length > 0)) {
                    ...
                    for (var i in hardware.darwin.memory) {
                        ...
                        if (m.PartNumber) { x += addDetailItem("Réference", EscapeHtml((m.Manufacturer && m.Manufacturer != '')?(m.Manufacturer + ', '):'') + EscapeHtml(m.PartNumber), s); }
                        x += '</div>';
                    }
                    x += '</table>';
                    if (x != '') { sections.push({ name: "Mémoire", html: x, img: 'ram'}); }
            ...
            if (hardware.identifiers && ident.storage_devices) {
                ...
                for (var i in ident.storage_devices) {
                    ...
                    if (m.Size) {
                        ...
                        if (m.Model && (m.Model != m.Caption)) { x += addDetailItem("Modèle", EscapeHtml(m.Model), s); }
                        if (m.Size) {
                            if ((typeof m.Size == 'string') && (parseInt(m.Size) == m.Size)) { m.Size = parseInt(m.Size); }
                            if (typeof m.Size == 'number') { x += addDetailItem("Capacité", format("{0} Mo", Math.floor(m.Size / 1024 / 1024)), s); }
                            if (typeof m.Size == 'string') { x += addDetailItem("Capacité", EscapeHtml(m.Size), s); }
                        }
                        if(hardware.windows && hardware.windows.drives && m.Model){
                            const foundObject = hardware.windows.drives.find(obj => obj['Model'] === m.Model);
                            if(foundObject) x += addDetailItem("Statut", EscapeHtml(foundObject.Status), s);
                        }
                        x += '</div>';
                    }
                }
                ...
                if (x != '') { sections.push({ name: "Stockage", html: x, img: 'storage' }); }
            }
            ...
            if (hardware.windows && hardware.windows.volumes) {
                ...
                for (var i in hardware.windows.volumes) {
                    ...
                    if (m.size) {
                        ...
                        x += addDetailItem("Capacité", EscapeHtml(fsize), s);
                    }
                    if (m.sizeremaining) {
                        var sizes = ['Bytes', 'KB', 'MB', 'GB', 'TB'];
                        ...
                        x += addDetailItem("Capacité restante", EscapeHtml(fsize), s);
                    }
                    if (m.type) {
                        var type = (m.removable == true ? "Removable" : (m.cdrom == true ? "CD-ROM" : ''));
                        x += addDetailItem("File System", (type != '' ? (type + ' / ') : '') + (m.type == 'Unknown' ? "Inconnue" : EscapeHtml(m.type)), s);
                    }

                    if (m.protectionStatus || m.volumeStatus) {
                        var bitlockerState = [];
                        if (m.protectionStatus) bitlockerState.push("Activer");
            ...
            if (hardware.darwin && hardware.darwin.volumes) {
                ...
                for (var i in hardware.darwin.volumes) {
                    ...
                    x += '<div style=margin-bottom:3px><b>' + m.mount_point + '</b></div>';
                    if (m.size) {
                        x += addDetailItem("Capacité", EscapeHtml(m.size), s);
                    }
                    if (m.available) {
                        x += addDetailItem("Capacité restante", EscapeHtml(m.available), s);
                    }
                    if (m.type) {
                        var type = (m.removable == true ? "Removable" : (m.cdrom == true ? "CD-ROM" : ''));
                        x += addDetailItem("File System", (type != '' ? (type + ' / ') : '') + (m.type == 'Unknown' ? "Inconnue" : EscapeHtml(m.type)), s);
            ...
            if (x == '') {
                QH('p10detailshtml', "Aucune information sur cet appareil.");
            } else {
                QH('p10detailshtml', x);
            }
        }
        ...
        function deviceDetailsShowBitlockerInfo(drive, identifier, password) {
            if (xxdialogMode) return false;
            var x = '<div><p>' + "Identifiant" + '</p><p style=user-select:text;font-weight:bold>' + (identifier ? decodeURIComponent(identifier) : "Inconnue") + '</p>';
            x += '<p>' + "Recovery Password" + '</p><p style=user-select:text;font-weight:bold>' + (password ? decodeURIComponent(password) : "Inconnue") + '</p></div>';
        ...
        */
        ...
        function setupConsole() {
            ...
            if ((rights & 16) != 0) {
                ...
                var onlineText = ((consoleNode.conn & 1) != 0) ? "Agent connecté" : "Agent déconnecté"
                if ((consoleNode.conn & 16) != 0) { onlineText += ", MQTT est connecté" }
        ...
        function p15consoleSend(e) {
            ...
            if (((consoleNode.conn & 16) != 0) && (Q('p15outputselect').value == 2)) {
                ...
                t = '<div style=color:violet>' + "Envoyer" + '&gt; ' + EscapeHtml(v) + '<br/></div>';
                consoleNode.consoleText += t;
        ...
        function p15uploadCore(e) {
            ...
            if (e.shiftKey == true) { meshserver.send({ action: 'uploadagentcore', nodeid: consoleNode._id, type: 'default' }); } // Upload default core
                ...
                var htmlValue = '<select id=d3coreMode style=width:230px>' +
                    '<option value=1>' + "Télécharger le noyau du serveur par défaut" + '</option>' +
                    '<option value=2>' + "Nettoyer le coeur" + '</option>' +
                    '<option value=3>' + "Téléchargez un fichier principal" + '</option>' +
                    '<option value=4>' + "Déconnecter l'agent" + '</option>' +
                    '<option value=5>' + "Déconnexion forcée de l'agent" + '</option>' +
                    '<option value=6>' + "Télécharger le noyau de récupération" + '</option>' +
                    '<option value=7>' + "Charger un micro noyau" + '</option>' +
                    '<option value=8>' + "Restart agent service" + '</option>' +
                    '<option value=9>' + "Forcer la mise à jour de l'agent" + '</option></select>';
                setDialogMode(2, "Effectuer une action sur l'agent", 3, p15uploadCoreEx, addHtmlValue("Action", htmlValue));
            }
        }
        ...
        function p15uploadCore2() {
            ...
            Q('d3auth').value = authCookie;
            Q('d3attrib').value = currentNode._id;
            setDialogMode(4, "Importer le noyau de l'agent de maillage", 3, p15uploadCoreEx2);
            d3init();
        }
        ...
        function p20updateMesh() {
            ...
            if (currentMesh.mtype == 1) meshtype = "Intel&reg; AMT uniquement, aucun agent";
            if (currentMesh.mtype == 2) meshtype = "Géré à l'aide d'un agent logiciel";
            if (currentMesh.mtype == 3) { if (currentMesh.relayid == null) { meshtype = "Appareils locaux, aucun agent"; } else { meshtype = "Aucun agent d'appareil relayé au travers de l'agent"; } }
            if (currentMesh.mtype == 4) { if (currentMesh.relayid == null) { meshtype = "Appareil IP-KVM"; } else { meshtype = "Appareil IP-KAM relayé par l'agent"; } if (currentMesh.kvm.model == 1) { meshtype += ', ' + 'Raritan KX III'; } }
            ...
            if (((currentMesh.mtype == 3) || (currentMesh.mtype == 4)) && (currentMesh.relayid != null)) {
                var relayName = '<i>' + "Inconnue" + '</i>';
                var relayNode = getNodeFromId(currentMesh.relayid);
                if (relayNode != null) { relayName = EscapeHtml(relayNode.name); }
                x += addHtmlValue("Dispositif de relais", addLinkConditional(relayName, 'p20editmeshrelay()', (meshrights & 1) != 0));
            }

            // Display IP-KVM information if needed
            if (currentMesh.mtype == 4) {
                x += addHtmlValue("Nom d'hôte", currentMesh.kvm.host);
                x += addHtmlValue("Nom d'utilisateur", currentMesh.kvm.user);
            }

            x += '<br><input type=button value="' + "Remarques" + '" onclick=showNotes(false,"' + encodeURIComponent(currentMesh._id) + '") />';

            x += '<br style=clear:both><br>';
            var currentMeshLinks = currentMesh.links[userinfo._id];
            if (currentMeshLinks && ((currentMeshLinks.rights & 2) != 0)) { x += '<div style=margin-bottom:6px;float:left;margin-right:10px><a onclick=p20showAddMeshUserDialog() style=cursor:pointer><img src=images/icon-addnew.png border=0 height=12 width=12> ' + "Ajouter un utilisateur" + '</a></div>'; }

            if (navigator.userAgent.toLowerCase().indexOf('android') >= 0) {
                x += '<div style=margin-bottom:6px;float:left;margin-right:10px><a onclick=p20installAndroidDialog() style=cursor:pointer><img src=images/icon-addnew.png border=0 height=12 width=12> ' + "Installer sur cet appareil" + '</a></div>';
            }
            ...
            */
            ...
            for (var i in sortedusers) {
                var trash = '', rights = "Droits limités", r = sortedusers[i].rights, icon = 2;
                if (r == 0xFFFFFFFF) rights = "Administrateur Complet"; else if (r == 0) rights = "Aucun droit";
            ...
            if (meshrights == 0xFFFFFFFF) { x += '<div style=font-size:small;text-align:right;margin-top:6px><span><a onclick=p20showDeleteMeshDialog() style=cursor:pointer>' + "Supprimer le groupe" + '</a></span></div>'; }
        ...
        function p20showDeleteMeshDialog() {
            ...
            x += '<label><input id=p20check type=checkbox onchange=p20validateDeleteMeshDialog() />' + "Confirmer" + '</label>';
            setDialogMode(2, "Supprimer le groupe", 3, p20showDeleteMeshDialogEx, x);
        ...
        function p20editmeshrelay() {
            ...
            if (relayDevices.length == 0) {
                ...
                setDialogMode(2, "Modifier le groupe d'appareil", 1, null, "Pas d'appareil relais disponible.");
            } else {
                var relayDevices2 = [];
                ...
                var x = addHtmlValue("Dispositif de relais", '<div style=width:170px><select id=d2devrelay style=width:100%>' + relayDevices2.join('') + '</select></div>');
                setDialogMode(2, "Modifier le groupe d'appareil", 3, p20editmeshrelayEx, x);
            }
        }
        ...
        function p20editmesh(focus) {
            if (xxdialogMode) return;
            var x = addHtmlValue("Nom", '<input id=dp20meshname style=width:170px maxlength=32 onchange=p20editmeshValidate() onkeyup=p20editmeshValidate() />');
            x += addHtmlValue("Description", '<input id=dp20meshdesc style=width:170px maxlength=1024 onkeyup=p20editmeshValidate() />');
            setDialogMode(2, "Modifier le groupe d'appareil", 3, p20editmeshEx, x);
        ...
        function p20installAndroidDialog() {
            if (xxdialogMode) return;
            var x = '<div style=text-align:center><p>' + "Installez l'agent MeshCentral sur votre appareil android puis cliquez sur ce lien pour le connecter au serveur." + '</p>';
            ...
            x += '<p><a href="' + serverinfo.magenturl + ',' + serverinfo.agentCertHash + ',' + currentMesh._id.split('/')[2] + '"><b>' + "Lien de jumelage de l'appareil" + '</b></a></p></div>';
            setDialogMode(2, "Installation pour Android", 1, null, x);
        }
        ...
        function p20showAddMeshUserDialog() {
            ...
            x += '<label><input type=checkbox onchange=p20validateAddMeshUserDialog() id=p20editmesh>' + "Modifier le groupe d'appareil" + '</label><br>';
            x += '<label><input type=checkbox onchange=p20validateAddMeshUserDialog() id=p20manageusers>' + "Gérer les utilisateurs du groupe d'appareils" + '</label><br>';
            x += '<label><input type=checkbox onchange=p20validateAddMeshUserDialog() id=p20managecomputers>' + "Gérer les appareils du groupe" + '</label><br>';
            x += '<label><input type=checkbox onchange=p20validateAddMeshUserDialog() id=p20remotecontrol>' + "Télécommande" + '</label><br>';
            x += '<label><input type=checkbox onchange=p20validateAddMeshUserDialog() id=p20remoteview style=margin-left:12px>' + "Affichage à distance uniquement" + '</label><br>';
            x += '<label><input type=checkbox onchange=p20validateAddMeshUserDialog() id=p20remotelimitedinput style=margin-left:12px>' + "Entrée limitée uniquement" + '</label><br>';
            x += '<label><input type=checkbox onchange=p20validateAddMeshUserDialog() id=p20noterminal style=margin-left:12px>' + "Pas d'accès à ligne de commande" + '</label><br>';
            ...
            x += '<label><input type=checkbox onchange=p20validateAddMeshUserDialog() id=p20noamt style=margin-left:12px>' + "Pas d'appareil Intel&reg; AMT" + '</label><br>';
            x += '<label><input type=checkbox onchange=p20validateAddMeshUserDialog() id=p20meshagentconsole>' + "Console d'agent de maillage" + '</label><br>';
            x += '<label><input type=checkbox onchange=p20validateAddMeshUserDialog() id=p20meshserverfiles>' + "Serveur de fichiers" + '</label><br>';
            x += '<label><input type=checkbox onchange=p20validateAddMeshUserDialog() id=p20wakedevices>' + "Réveil d'appareils" + '</label><br>';
            x += '<label><input type=checkbox onchange=p20validateAddMeshUserDialog() id=p20editnotes>' + "Modifier les notes sur l'appareil" + '</label><br>';
            x += '<label><input type=checkbox onchange=p20validateAddMeshUserDialog() id=p20limitevents>' + "Voir ses propres évènements" + '</label><br>';
            x += '<label><input type=checkbox onchange=p20validateAddMeshUserDialog() id=p20chatnotify>' + "Discussion instantanée et notification" + '</label><br>';
            x += '<label><input type=checkbox onchange=p20validateAddMeshUserDialog() id=p20uninstall>' + "Désinstaller l'agent" + '</label><br>';
            x += '<label><input type=checkbox onchange=p20validateAddMeshUserDialog() id=p20commands>' + "Commandes distantes" + '</label><br>';
            x += '<label><input type=checkbox onchange=p20validateAddMeshUserDialog() id=p20resetoff>' + "Réinitialiser / Éteindre" + '</label><br>';
            x += '</div>';
            setDialogMode(2, "Ajouter un utilisateur au groupe d'appareils", 3, p20showAddMeshUserDialogEx, x);
        ...
        function p20viewuser(userid) {
            ...
            if (meshrights == 0xFFFFFFFF) r.push("Administrateur Complet"); else {
                if ((meshrights & 1) != 0) r.push("Modifier le groupe d'appareil");
                if ((meshrights & 2) != 0) r.push("Gérer les utilisateurs du groupe d'appareils");
                if ((meshrights & 4) != 0) r.push("Gérer les appareils du groupe");
                if ((meshrights & 8) != 0) r.push("Télécommande");
                if ((meshrights & 16) != 0) r.push("Console d'agent");
                if ((meshrights & 32) != 0) r.push("Serveur de fichiers");
                if ((meshrights & 64) != 0) r.push("Réveil d'appareils");
                if ((meshrights & 128) != 0) r.push("Modifier les notes");
                if ((meshrights & 256) != 0) r.push("Affichage à distance uniquement");
                if ((meshrights & 512) != 0) r.push("Aucun terminal");
                if ((meshrights & 1024) != 0) r.push("Aucun fichier");
                if ((meshrights & 2048) != 0) r.push("Pas d'appareil Intel&reg; AMT");
                if (((meshrights & 8) != 0) && ((meshrights & 4096) != 0) && ((meshrights & 256) == 0)) r.push("Entrée limitée");
                if ((meshrights & 8192) != 0) r.push("Événements personnels uniquement");
                if ((meshrights & 16384) != 0) r.push("Discussion instantanée et notification");
                if ((meshrights & 32768) != 0) r.push("Désinstaller");
                if ((meshrights & 131072) != 0) r.push("Commandes");
                if ((meshrights & 262144) != 0) r.push("Réinitialisation / arrêt");
            }
            if (r.length == 0) { r.push("Aucun droit"); }
            var buttons = 1, uname = userid.split('/')[2];
            if (currentMesh.links[userid].name) { uname = currentMesh.links[userid].name; }
            var x = addHtmlValue("Nom", EscapeHtml(uname));
            if (uname != userid.split('/')[2]) { x += addHtmlValue("ID utilisateur", EscapeHtml(userid.split('/')[2])); }
            ...
            setDialogMode(2, "Utilisateur du groupe", buttons, p20viewuserEx, x, userid);
        }
        ...
        function p20viewuserEx(button, userid) {
            ...
            setDialogMode(2, "Utilisateur de maillage à distance", 3, p20viewuserEx2, format("Supprimer l'utilisateur {0} ?", uname), userid);
        }
        ...
        function drawNotifications() {
            ...
            if (notifications.length == 0) {
                ...
                for (var i in notifications) {
                    ...
                    r += '<div onclick="notificationDelete(' + n.id + ')" class=unselectable title="' + "Effacez cette notification" + '" style=margin:5px;float:right;color:orange><b>X</b></div><div onclick="notificationSelected(' + n.id + ')" style=margin:5px>' + t + EscapeHtml(n.text) + '</div><div style=margin-left:5px;margin-bottom:5px;color:gray;font-size:10px>' + printDateTime(d) + '</div></div>';
                }
            }
            var deleteall = '';
            if (notifications.length > 1) { deleteall = '<div id="notifyRemoveAll" onclick="deleteAllNotifications()" style="cursor:pointer;border-top:1px solid orange;margin:5px;color:orange;text-align:right;padding-right:3px">' + "Tout effacer" + '</div>'; }
        ...
        function addNotification(n) {
            ...
            var translatedMessages = [
                ...
                "Email invalide",
                "Domaine non valide",
                "Autorisations de site non valides",
                "L'utilisateur existe déjà",
                "Impossible d'ajouter un utilisateur dans ce mode",
                "Exception de validation",
                "Limite du compte atteinte.", // 10
                "Demande de discussion, cliquez ici pour accepter.",
                "Il y a eu {0} tentatives de connexion infructueuses sur ce compte depuis la dernière connexion.",
                "Échec de la modification de l'adresse e-mail, un autre compte utilise déjà: {0}.",
                "Email envoyé.",
                "Utilisateur {0} introuvable.",
                "Utilisateurs {0} introuvables.",
                "Erreur, impossible de changer le mot de passe précédemment utilisé.",
                "Erreur, impossible de changer le mot de passe couramment utilisé.",
                "Erreur, mot de passe non modifié.",
                "Mot de passe changé.", // 20
                "Le mot de passe actuel n'est pas correct.",
                "Erreur, code d'invitation \"{0}\" déjà utilisé.",
                "Passerelle SMS non activée",
                "Aucun droit de gestion des utilisateurs",
                "Message SMS non valide",
                "Aucun numéro de téléphone pour cet utilisateur",
                "SMS envoyé avec succès.",
                "Erreur SMS",
                "Erreur SMS: {0}",
                "Les courriels de \"{0}\" ne sont pas autorisés. Seulement ceux de ({1}) sont permis" // 30
            ];
        ...
        function getFileSizeStr(size) { if (typeof size != 'number') { size = 0; } if (size == 1) return "1 octet"; return format('{0} bytes', size); }
