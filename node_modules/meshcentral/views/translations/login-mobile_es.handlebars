<!DOCTYPE html><html dir="ltr" xmlns="http://www.w3.org/1999/xhtml"><head lang="en">
                            ...
                            <div id="loginpanel" style="background-color:#979797;border-radius:16px;width:260px;padding:16px;text-align:center;clear:both;display:none">
                                <form method="post">
                                    ...
                                    <table>
                                        ...
                                        <tr>
                                            <td><div id="showPassHintLink" style="display:none"><a onclick="showPassHint()" style="cursor:pointer">Mostrar Pista</a></div></td>
                                    ...
                                    <div id="resetAccountDiv" style="display:none;padding:2px">
                                        <span id="resetAccountSpan">¿Olvidó su usuario / contraseña?</span> <a onclick="xgo(3)" style="cursor:pointer">Restablecer cuenta</a>.
                                    </div>
                                    <div id="newAccountDiv" style="display:none;padding:2px">
                                        ¿No tienes una cuenta? <a onclick="xgo(2)" style="cursor:pointer">Crear una</a>.
                                    </div>
                                    ...
                                    <div id="authStrategies" style="display:none">
                                        ...
                                        <a id="auth-twitter" href="auth-twitter" style="display:none"><img src="images/login/twitter32.png" width="32" height="32" style="margin-left:3px;margin-right:3px;border-radius:3px;box-shadow:2px 2px 5px black;cursor:pointer" title="Ingresar usando Twitter"></a>
                                        <a id="auth-google" href="auth-google" style="display:none"><img src="images/login/google32.png" width="32" height="32" style="margin-left:3px;margin-right:3px;border-radius:3px;box-shadow:2px 2px 5px black;cursor:pointer" title="Ingresar usando Google"></a>
                                        <a id="auth-github" href="auth-github" style="display:none"><img src="images/login/github32.png" width="32" height="32" style="margin-left:3px;margin-right:3px;border-radius:3px;box-shadow:2px 2px 5px black;cursor:pointer" title="Ingresar usando GitHub"></a>
                                        <a id="auth-azure" href="auth-azure" style="display:none"><img src="images/login/azure32.png" width="32" height="32" style="margin-left:3px;margin-right:3px;border-radius:3px;box-shadow:2px 2px 5px black;cursor:pointer" title="Ingresar usando Azure"></a>
                                        ...
                                        <a id="auth-jumpcloud" href="auth-jumpcloud" style="display:none"><img src="images/login/jumpcloud32.png" width="32" height="32" style="margin-left:3px;margin-right:3px;border-radius:3px;box-shadow:2px 2px 5px black;cursor:pointer" title="Ingresar usando JumpCloud"></a>
                                        <a id="auth-intel" href="auth-intel" style="display:none"><img src="images/login/intel32.png" width="32" height="32" style="margin-left:3px;margin-right:3px;border-radius:3px;box-shadow:2px 2px 5px black;cursor:pointer" title="Ingresar usando Intel&amp;reg;"></a>
                                        <a id="auth-saml" href="auth-saml" style="display:none"><img src="images/login/generic32.png" width="32" height="32" style="margin-left:3px;margin-right:3px;border-radius:3px;box-shadow:2px 2px 5px black;cursor:pointer" title="Inicio de Sesión Único"></a>
                                    </div>
                                </form>
                            </div>
                                    ...
                                    <form method="post">
                                        ...
                                        <table>
                                            <tbody><tr id="nuUserRow">
                                                <td align="right" width="100">Nombre de Usuario:</td>
                                            ...
                                            <tr id="createPanelHint" style="display:none">
                                                <td align="right">Pista de la Contraseña:</td>
                                            ...
                                            <tr id="newAccountPass" title="Ingresa el token de creación de cuenta">
                                                <td align="right">Token de Creación:</td>
                                        ...
                                        <hr><a onclick="xgo(1)" style="cursor:pointer">Regresar al inicio de sesión</a>
                                        ...
                                        <tr>
                                            <td colspan="2">
                                                ...
                                                <div style="float:right">
                                                    <input style="display:none;float:right" id="securityKeyButton" type="button" value="Usar Clave de Seguridad" onclick="useSecurityKey()">
                                                    <input style="display:none;float:right" id="emailKeyButton" type="button" value="Correo electrónico" onclick="useEmailToken()">
        ...
        <div id="footer" style="height:32px;width:100%;text-align:center;background-color:#113962;position:absolute;bottom:0px">
            <table cellpadding="0" cellspacing="6" style="width:100%">
                <tbody><tr>
                    ...
                    <td style="text-align:right">{{{rootCertLink}}}&nbsp;<a href="terms">Términos y Privacidad</a></td>
                </tr>
            </tbody></table>
        </div>
    </div>
    ...
    <script>
        ...
        var okmessages = ['', "Si es correcto, se envió correo de restablecimiento.", "Correo electrónico enviado.", "Se requiere verificación de correo electrónico, verifica tu buzón y haz clic en el enlace de confirmación.", "SMS enviado."];
        ...
        function useEmailToken() {
            ...
            setDialogMode(1, "Inicio de Sesión Seguro", 3, useEmailKeyEx, "¿Enviar token a la dirección de correo electrónico registrada?");
        }
        ...
        function useSMSToken() {
            ...
            setDialogMode(1, "Inicio de Sesión Seguro", 3, useSMSTokenEx, "¿Enviar token al número de teléfono registrado?");
        }
        ...
        function showPassHint() {
            if (passRequirements.hint === true) { messagebox("Pista de la Contraseña:", passhint); }
        }
            ...
            if (Q('apassword1').value == '') {
                ...
                if (!passRequirementsEx) {
                    ...
                    if (passReq == false) {
                        ...
                        QH('passWarning', '<span style=color:red><b>' + "Política de Contraseñas" + '</b><span>'); // TODO: Display problem hint
