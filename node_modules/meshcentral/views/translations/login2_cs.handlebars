<!DOCTYPE html><html dir="ltr" xmlns="http://www.w3.org/1999/xhtml"><head lang="en">
    ...
    <table id="centralTable" class="container" style="height:100%;z-index:1">
                    ...
                    <form id="loginpanelform" method="post">
                        ...
                        <div id="loginuserpassdiv" style="display:none">
                            <table style="width:100%">
                                <tbody><tr>
                                    <td>
                                        <input id="username" title="Uživatelské jméno" style="box-sizing:border-box;width:280px;border:0;border-radius:4px;padding:8px;background-color:#FFF8CC" {{{autocomplete}}}="username" placeholder="Uživatelské jméno" type="text" maxlength="64" name="username" required="" onchange="validateLogin(1)" onkeyup="validateLogin(1,event)">
                                    </td>
                                </tr>
                                <tr>
                                    <td>
                                        <input id="password" title="Heslo" style="box-sizing:border-box;width:280px;border:0;border-radius:4px;padding:8px;background-color:#FFF8CC" {{{autocomplete}}}="current-password" placeholder="Heslo" type="password" maxlength="256" name="password" required="" onchange="validateLogin(2)" onkeyup="validateLogin(2,event)">
                                    </td>
                                </tr>
                                <tr>
                                    <td>
                                        <div id="showPassHintLink" title="Nápověda k heslu" style="box-sizing:border-box;width:280px;border:0;border-radius:4px;padding:8px;background-color:#FFF8CC;display:none"><a onclick="return showPassHint(event);" href="#" style="cursor:pointer">Zobrazit nápovědu</a></div>
                                    </td>
                                </tr>
                                <tr>
                                    <td>
                                        <input id="loginButton" style="box-sizing:border-box;width:280px;border:0;border-radius:4px;padding:6px" onclick="submitButtonClicked('loginpanelform')" type="button" value="Přihlásit se">
                                    </td>
                                </tr>
                        ...
                        <div id="authStrategies" style="display:none">
                            ...
                            <div style="margin-bottom:8px">Přihlaste se pomocí existujícího účtu</div>
                            <a id="auth-twitter" href="auth-twitter" style="display:none"><img src="images/login/twitter32.png" srcset="images/login/twitter64.png 2x" width="32" height="32" style="margin-left:3px;margin-right:3px;border-radius:3px;box-shadow:2px 2px 5px black;cursor:pointer" title="Přihlaste se pomocí Twitteru"></a>
                            <a id="auth-google" href="auth-google" style="display:none"><img src="images/login/google32.png" srcset="images/login/google64.png 2x" width="32" height="32" style="margin-left:3px;margin-right:3px;border-radius:3px;box-shadow:2px 2px 5px black;cursor:pointer" title="Přihlaste se pomocí Google"></a>
                            <a id="auth-github" href="auth-github" style="display:none"><img src="images/login/github32.png" srcset="images/login/github64.png 2x" width="32" height="32" style="margin-left:3px;margin-right:3px;border-radius:3px;box-shadow:2px 2px 5px black;cursor:pointer" title="Přihlaste se pomocí GitHubu"></a>
                            <a id="auth-azure" href="auth-azure" style="display:none"><img src="images/login/azure32.png" srcset="images/login/azure64.png 2x" width="32" height="32" style="margin-left:3px;margin-right:3px;border-radius:3px;box-shadow:2px 2px 5px black;cursor:pointer" title="Přihlaste se pomocí Azure"></a>
                            <a id="auth-oidc" href="auth-oidc" style="display:none"><img src="images/login/oidc32.png" srcset="images/login/oidc64.png 2x" width="32" height="32" style="margin-left:3px;margin-right:3px;border-radius:3px;box-shadow:2px 2px 5px black;cursor:pointer" title="Přihlaste se pomocí OpenID Connect"></a>
                            ...
                            <a id="auth-jumpcloud" href="auth-jumpcloud" style="display:none"><img src="images/login/jumpcloud32.png" srcset="images/login/jumpcloud64.png 2x" width="32" height="32" style="margin-left:3px;margin-right:3px;border-radius:3px;box-shadow:2px 2px 5px black;cursor:pointer" title="Přihlaste se pomocí JumpCloud"></a>
                            <a id="auth-intel" href="auth-intel" style="display:none"><img src="images/login/intel32.png" srcset="images/login/intel64.png 2x" width="32" height="32" style="margin-left:3px;margin-right:3px;border-radius:3px;box-shadow:2px 2px 5px black;cursor:pointer" title="Přihlaste se pomocí Intel"></a>
                            <a id="auth-saml" href="auth-saml" style="display:none"><img src="images/login/generic32.png" srcset="images/login/generic64.png 2x" width="32" height="32" style="margin-left:3px;margin-right:3px;border-radius:3px;box-shadow:2px 2px 5px black;cursor:pointer" title="Jednotné přihlášení"></a>
                        </div>
                    </form>
                </div>
                    ...
                    <form id="createpanelform" method="post">
                        ...
                        <table>
                            <tbody><tr id="nuUserRow">
                                <td id="nuUser" align="right" width="100">Uživatelské jméno:</td>
                            ...
                            <tr>
                                <td colspan="2">
                                    <div style="float:right"><input id="createButton" type="button" onclick="submitButtonClicked('createpanelform')" value="Vytvořit účet" disabled="disabled"></div>
                ...
                <div id="resetpanel" style="display:none">
                    <form id="resetpanelform" method="post">
                        ...
                        <table style="width:100%;margin-top:4px;margin-bottom:4px">
                            ...
                            <tr>
                                <td>
                                    <input id="eresetButton" style="box-sizing:border-box;width:280px;border:0;border-radius:4px;padding:6px" type="button" onclick="submitButtonClicked('resetpanelform')" value="Reset účtu" disabled="disabled">
                                </td>
                            </tr>
                        </tbody></table>
                        <hr><a onclick="return xgo(1,event);" href="#" style="cursor:pointer">Zpět na přihlášení</a>
                ...
                <div id="tokenpanel" style="display:none">
                    <form id="tokenpanelform" method="post" {{{autocomplete}}}="off">
                        ...
                        <table style="width:100%">
                            <tbody><tr>
                                <td>
                                    <input id="tokenInput" {{{autocomplete}}}="one-time-code" title="Žeton" style="box-sizing:border-box;width:280px;border:0;border-radius:4px;padding:8px;background-color:#FFF8CC" placeholder="Žeton" type="text" maxlength="50" name="token" onchange="checkToken(event)" onpaste="checkToken(event)" onkeyup="checkToken(event)" onkeydown="checkToken(event)"><br>
                            ...
                            <tr>
                                <td>
                                    <div>
                                        <input id="tokenOkButton" style="box-sizing:border-box;width:280px;border:0;border-radius:4px;padding:6px" type="button" onclick="submitButtonClicked('tokenpanelform')" value="Přihlásit se" disabled="disabled">
                                    </div>
                                </td>
                            </tr>
                            <tr>
                            ...
                            <tr id="2farow">
                                <td>
                                    <hr>
                                    <div>
                                        <img id="securityKeyButton" src="images/login/2fa-key-48.png" srcset="images/login/2fa-key-96.png 2x" title="Použít bezpečnostní klíč" width="48" height="48" style="display:none;margin-left:3px;margin-right:3px;border-radius:3px;box-shadow:2px 2px 5px black;cursor:pointer;background-color:#FFF" onclick="useSecurityKey(1)">
                                        ...
                                        <img id="pushKeyButton" src="images/login/2fa-push-48.png" srcset="images/login/2fa-push-96.png 2x" title="Ověření zařízení" width="48" height="48" style="display:none;margin-left:3px;margin-right:3px;border-radius:3px;box-shadow:2px 2px 5px black;cursor:pointer;background-color:#FFF" onclick="usePushToken(1)">
                ...
                <div id="resettokenpanel" style="display:none">
                    <form id="resettokenpanelform" method="post">
                        ...
                        <table style="width:100%">
                            <tbody><tr>
                                <td>
                                    <input id="resetTokenInput" {{{autocomplete}}}="one-time-code" title="Žeton" style="box-sizing:border-box;width:280px;border:0;border-radius:4px;padding:8px;background-color:#FFF8CC" placeholder="Žeton" type="text" maxlength="50" name="token" onchange="resetCheckToken(event)" onpaste="resetCheckToken(event)" onkeyup="resetCheckToken(event)" onkeydown="resetCheckToken(event)"><br>
                            ...
                            <tr>
                                <td>
                                    <div>
                                        <input id="resetTokenOkButton" style="box-sizing:border-box;width:280px;border:0;border-radius:4px;padding:6px" type="button" onclick="submitButtonClicked('resettokenpanelform')" value="Přihlásit se" disabled="disabled">
                                    </div>
                                </td>
                            </tr>
                            <tr id="2farow2">
                                <td colspan="2">
                                    <hr>
                                    <div>
                                        <img id="securityKeyButton2" src="images/login/2fa-key-48.png" srcset="images/login/2fa-key-96.png 2x" title="Použít bezpečnostní klíč" width="48" height="48" style="display:none;margin-left:3px;margin-right:3px;border-radius:3px;box-shadow:2px 2px 5px black;cursor:pointer;background-color:#FFF" onclick="useSecurityKey(2)">
                                        ...
                                        <img id="pushKeyButton2" src="images/login/2fa-push-48.png" srcset="images/login/2fa-push-96.png 2x" title="Ověření zařízení" width="48" height="48" style="display:none;margin-left:3px;margin-right:3px;border-radius:3px;box-shadow:2px 2px 5px black;cursor:pointer;background-color:#FFF" onclick="usePushToken(2)">
                ...
                <div id="resetpasswordpanel" style="display:none;position:relative">
                    <form id="resetpasswordpanelform" method="post">
                        ...
                        <table>
                            ...
                            <tr>
                                <td colspan="2">
                                    <div style="float:right"><input id="resetPassButton" type="button" onclick="submitButtonClicked('resetpasswordpanelform')" value="Reset hesla" disabled="disabled"></div>
                    ...
                    <form id="checkemailpanelform" method="post">
                        ...
                        <table id="checkCheckOperations" style="width:100%;display:none">
                            ...
                            <tr>
                                <td>
                                    <div>
                                        <input id="changeEmailButton" type="button" value="Změňte emailovou adresu" onclick="changeEmailAddress()">
                                        <input id="checkEmailButton2" type="button" value="Znovu odeslat potvrzovací e-mail" onclick="resentEmailConfirmation()">
        ...
        <tr style="height:20px">
            <td>
                <div>
                    <div id="flink" style="float:right;margin-right:4px;color:#c8c8c8">{{{rootCertLink}}}&nbsp;<a href="terms">Smluvní podmínky a ochrana soukromí</a></div>
    ...
    <div id="dialog" style="display:none">
        ...
        <div id="idx_dlgButtonBar" style="">
            <input id="idx_dlgCancelButton" type="button" value="Storno" style="" onclick="dialogclose(0)">
    ...
    <script>
        ...
        function startup() {
            ...
            var okmessages = ['', "Pokud je platný, resetujte odeslanou poštu.", "Email odeslán.", "Je vyžadováno ověření e-mailem, zkontrolujte svou poštovní schránku a klikněte na odkaz pro potvrzení.", "SMS odeslána.", "Odesílání oznámení ...", "Message sent."];
            var failmessages = ["Nedaří se vytvořit účet.", "Dosažen nejvyšší možný počet účtů.", "Tato e-mailová adresa už je používána u jiného účtu.", "Neplatný token pro vytvoření účtu.", "Toto uživatelské jméno už je používáno jiným účtem.", "Heslo odmítnuto, zkuste jiné.", "Neplatný e-mail.", "Účet nenalezen.", "Neplatný token, zkuste to znovu.", "Nedaří se poslat e-mail.", "Účet uzamknut.", "Přístup odepřen", "Neplatné přihlášení, zkontrolujte uživatelské jméno a heslo.", "Je vyžadována změna hesla.", "IP adresa blokována, zkuste to znovu později.", "Server je v údržbě.", "Oznámení ze zařízení nelze odeslat.", "Invalid security check."];
            if (messageid > 0) {
                var msg = '';
            ...
            if (twoFactorCookieDays > 0) {
                ...
                QH('tokenInputRememberSpan', format("Zapamatujte si toto zařízení po dobu {0} dnů.", twoFactorCookieDays));
                QV('tokenInputRememberLabel2', true);
                QH('tokenInputRememberSpan2', format("Zapamatujte si toto zařízení po dobu {0} dnů.", twoFactorCookieDays));
            } else {
            ...
            if (loginMode == '8') {
                ...
                websocket.onmessage = function (e) {
                    ...
                    if (r.sent === true) {
                        // Request was sent
                        QH('message8', '<span class="msg success"><b>' + format("Žádost odeslána, {0}.", r.code) + '</b></span><br /><br />');
                    } else if (r.sent === false) {
                        // Request failed to send
                        QH('message8', '<span class="msg error"><b style=color:#8C001A>' + "Odeslání požadavku se nezdařilo." + '<b></span><br /><br />');
                        QV('tokenInputRememberLabel2', false);
                        this.close();
                        ...
                        this.close();
                        QV('tokenInputRememberLabel2', false);
                        QH('message8', '<span class="msg success"><b>' + "Žádost přijata." + '</b></span><br /><br />');
                        Q('pushtokenInput').value = r.token;
                        Q('pushOkButton').click();
                    } else {
                        // Request rejected
                        QH('message8', '<span class="msg error"><b style=color:#8C001A>' + "Přístup zamítnut." + '<b></span><br /><br />');
                        QV('tokenInputRememberLabel2', false);
                        this.close();
                    }
                }
                ...
                websocket.onerror = function (e) {
                    QH('message8', '<span class="msg error"><b style=color:#8C001A>' + "Chyba připojení" + '<b></span><br /><br />');
        ...
        function useEmailToken(panelAction) {
            ...
            setDialogMode(1, "Zabezpečené přihlášení", 3, useEmailKeyEx, "Odeslat token na zaregistrovanou e-mailovou adresu?", panelAction);
        }
        ...
        function useSMSToken(panelAction) {
            ...
            setDialogMode(1, "Zabezpečené přihlášení", 3, useSMSTokenEx, "Poslat token na registrované telefonní číslo?", panelAction);
        }
        ...
        function useMsgToken(panelAction) {
            ...
            setDialogMode(1, "Zabezpečené přihlášení", 3, useMsgTokenEx, "Send token to messaging application?", panelAction);
        }
            ...
            if (Q('apassword1').value == '') {
                ...
                if (!passRequirementsEx) {
                    ...
                    if (passReq == false) {
                        ...
                        QH('passWarning', '<div style=color:red;cursor:pointer onclick=showPasswordPolicy()><b>' + "Zásady pro hesla" + '</b><div>'); // This is also a link to the password policy
            ...
            if (Q('rapassword1').value == '') {
                ...
                if (!passRequirementsEx) {
                    ...
                    if (passReq == false) {
                        ...
                        QH('rpassWarning', '<div style=color:red;cursor:pointer onclick=showPasswordPolicy()><b>' + "Zásady pro hesla" + '</b><div>'); // This is also a link to the password policy
        ...
        function showPasswordPolicy() {
            messagebox("Zásady pro hesla", passwordPolicyText());
        }
        ...
        function changeEmailAddress() {
            ...
            setDialogMode(1, "potvrzení e-mailem", 3, changeEmailAddressEx, x);
