<!DOCTYPE html><html dir="ltr" xmlns="http://www.w3.org/1999/xhtml"><head lang="en">
    ...
    <div id="container">
                                ...
                                <div id="loginuserpassdiv" style="display:none">
                                    ...
                                    <table>
                                        ...
                                        <tr>
                                            ...
                                            <td align="right"><input id="loginButton" type="submit" value="ログイン"></td>
                                        </tr>
                                    </tbody></table>
                                    ...
                                    <tr>
                                        <td colspan="2">
                                            ...
                                            <div style="float:right">
                                                <input style="display:none;float:right" id="securityKeyButton" type="button" value="セキュリティキーを使用" onclick="useSecurityKey(1)">
                                                <input style="display:none;float:right" id="emailKeyButton" type="button" value="Eメール" onclick="useEmailToken(1)">
                                ...
                                <table>
                                    ...
                                    <tr>
                                        <td colspan="2">
                                            ...
                                            <div style="float:right">
                                                <input style="display:none;float:right" id="securityKeyButton2" type="button" value="セキュリティキーを使用" onclick="useSecurityKey(2)">
                                                <input style="display:none;float:right" id="emailKeyButton2" type="button" value="Eメール" onclick="useEmailToken(2)">
        ...
        <div id="footer">
            ...
            <div class="footer2">
                {{{rootCertLink}}}
                &nbsp;<a id="termsLinkFooter" href="terms">利用規約とプライバシー</a>
            </div>
        </div>
