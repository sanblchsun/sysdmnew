<!DOCTYPE html><html dir="ltr" xmlns="http://www.w3.org/1999/xhtml"><head lang="en">
    ...
    <table id="centralTable" class="container" style="height:100%;z-index:1">
                    ...
                    <form id="loginpanelform" method="post">
                        ...
                        <div id="loginuserpassdiv" style="display:none">
                            <table style="width:100%">
                                <tbody><tr>
                                    <td>
                                        <input id="username" title="ユーザー名" style="box-sizing:border-box;width:280px;border:0;border-radius:4px;padding:8px;background-color:#FFF8CC" {{{autocomplete}}}="username" placeholder="ユーザー名" type="text" maxlength="64" name="username" required="" onchange="validateLogin(1)" onkeyup="validateLogin(1,event)">
                                    </td>
                                </tr>
                                <tr>
                                    <td>
                                        <input id="password" title="パスワード" style="box-sizing:border-box;width:280px;border:0;border-radius:4px;padding:8px;background-color:#FFF8CC" {{{autocomplete}}}="current-password" placeholder="パスワード" type="password" maxlength="256" name="password" required="" onchange="validateLogin(2)" onkeyup="validateLogin(2,event)">
                                    </td>
                                </tr>
                                <tr>
                                    <td>
                                        <div id="showPassHintLink" title="パスワードのヒント" style="box-sizing:border-box;width:280px;border:0;border-radius:4px;padding:8px;background-color:#FFF8CC;display:none"><a onclick="return showPassHint(event);" href="#" style="cursor:pointer">ヒントを見せて</a></div>
                                    </td>
                                </tr>
                                <tr>
                                    <td>
                                        <input id="loginButton" style="box-sizing:border-box;width:280px;border:0;border-radius:4px;padding:6px" onclick="submitButtonClicked('loginpanelform')" type="button" value="ログイン">
                                    </td>
                                </tr>
                            ...
                            <div id="newAccountDiv" style="display:none;padding:2px;padding-top:10px">
                                アカウントをお持ちでないですか？ <a onclick="return xgo(2,event);" href="#" style="cursor:pointer">一つ作る</a>。
                            </div>
                        </div>
                        ...
                        <div id="authStrategies" style="display:none">
                            ...
                            <div style="margin-bottom:8px">既存のアカウントを使用してログインする</div>
                            <a id="auth-twitter" href="auth-twitter" style="display:none"><img src="images/login/twitter32.png" srcset="images/login/twitter64.png 2x" width="32" height="32" style="margin-left:3px;margin-right:3px;border-radius:3px;box-shadow:2px 2px 5px black;cursor:pointer" title="Twitterを使用したサインイン"></a>
                            <a id="auth-google" href="auth-google" style="display:none"><img src="images/login/google32.png" srcset="images/login/google64.png 2x" width="32" height="32" style="margin-left:3px;margin-right:3px;border-radius:3px;box-shadow:2px 2px 5px black;cursor:pointer" title="Googleを使用してサインインする"></a>
                            <a id="auth-github" href="auth-github" style="display:none"><img src="images/login/github32.png" srcset="images/login/github64.png 2x" width="32" height="32" style="margin-left:3px;margin-right:3px;border-radius:3px;box-shadow:2px 2px 5px black;cursor:pointer" title="GitHubを使用したサインイン"></a>
                            <a id="auth-azure" href="auth-azure" style="display:none"><img src="images/login/azure32.png" srcset="images/login/azure64.png 2x" width="32" height="32" style="margin-left:3px;margin-right:3px;border-radius:3px;box-shadow:2px 2px 5px black;cursor:pointer" title="Azureを使用してサインインする"></a>
                            <a id="auth-oidc" href="auth-oidc" style="display:none"><img src="images/login/oidc32.png" srcset="images/login/oidc64.png 2x" width="32" height="32" style="margin-left:3px;margin-right:3px;border-radius:3px;box-shadow:2px 2px 5px black;cursor:pointer" title="OpenID Connect를 사용하여 로그인"></a>
                            ...
                            <a id="auth-jumpcloud" href="auth-jumpcloud" style="display:none"><img src="images/login/jumpcloud32.png" srcset="images/login/jumpcloud64.png 2x" width="32" height="32" style="margin-left:3px;margin-right:3px;border-radius:3px;box-shadow:2px 2px 5px black;cursor:pointer" title="JumpCloudを使用したサインイン"></a>
                            <a id="auth-intel" href="auth-intel" style="display:none"><img src="images/login/intel32.png" srcset="images/login/intel64.png 2x" width="32" height="32" style="margin-left:3px;margin-right:3px;border-radius:3px;box-shadow:2px 2px 5px black;cursor:pointer" title="Intelを使用したサインイン"></a>
                            <a id="auth-saml" href="auth-saml" style="display:none"><img src="images/login/generic32.png" srcset="images/login/generic64.png 2x" width="32" height="32" style="margin-left:3px;margin-right:3px;border-radius:3px;box-shadow:2px 2px 5px black;cursor:pointer" title="シングルサインイン"></a>
                        </div>
                    </form>
                </div>
                <div id="createpanel" style="display:none;position:relative">
                    <form id="createpanelform" method="post">
                        ...
                        <table>
                            ...
                            <tr>
                                <td colspan="2">
                                    <div style="float:right"><input id="createButton" type="button" onclick="submitButtonClicked('createpanelform')" value="アカウントを作成する" disabled="disabled"></div>
                ...
                <div id="resetpanel" style="display:none">
                    <form id="resetpanelform" method="post">
                        ...
                        <table style="width:100%;margin-top:4px;margin-bottom:4px">
                            <tbody><tr>
                                <td>
                                    <input id="remail" title="Eメール" style="box-sizing:border-box;width:280px;border:0;border-radius:4px;padding:8px;background-color:#FFF8CC" {{{autocomplete}}}="username" placeholder="Eメール" type="text" maxlength="256" name="email" onchange="validateReset()" onkeyup="validateReset(event)">
                                </td>
                            </tr>
                            <tr>
                                <td>
                                    <input id="eresetButton" style="box-sizing:border-box;width:280px;border:0;border-radius:4px;padding:6px" type="button" onclick="submitButtonClicked('resetpanelform')" value="アカウントをリセット" disabled="disabled">
                                </td>
                            </tr>
                        </tbody></table>
                        <hr><a onclick="return xgo(1,event);" href="#" style="cursor:pointer">ログインに戻る</a>
                ...
                <div id="tokenpanel" style="display:none">
                    <form id="tokenpanelform" method="post" {{{autocomplete}}}="off">
                        ...
                        <table style="width:100%">
                            <tbody><tr>
                                <td>
                                    <input id="tokenInput" {{{autocomplete}}}="one-time-code" title="トークン" style="box-sizing:border-box;width:280px;border:0;border-radius:4px;padding:8px;background-color:#FFF8CC" placeholder="トークン" type="text" maxlength="50" name="token" onchange="checkToken(event)" onpaste="checkToken(event)" onkeyup="checkToken(event)" onkeydown="checkToken(event)"><br>
                            ...
                            <tr>
                                <td>
                                    <div>
                                        <input id="tokenOkButton" style="box-sizing:border-box;width:280px;border:0;border-radius:4px;padding:6px" type="button" onclick="submitButtonClicked('tokenpanelform')" value="ログイン" disabled="disabled">
                                    </div>
                                </td>
                            </tr>
                            <tr>
                            ...
                            <tr id="2farow">
                                <td>
                                    <hr>
                                    <div>
                                        <img id="securityKeyButton" src="images/login/2fa-key-48.png" srcset="images/login/2fa-key-96.png 2x" title="セキュリティキーを使用" width="48" height="48" style="display:none;margin-left:3px;margin-right:3px;border-radius:3px;box-shadow:2px 2px 5px black;cursor:pointer;background-color:#FFF" onclick="useSecurityKey(1)">
                                        ...
                                        <img id="emailKeyButton" src="images/login/2fa-mail-48.png" srcset="images/login/2fa-mail-96.png 2x" title="Eメール" width="48" height="48" style="display:none;margin-left:3px;margin-right:3px;border-radius:3px;box-shadow:2px 2px 5px black;cursor:pointer;background-color:#FFF" onclick="useEmailToken(1)">
                                        <img id="pushKeyButton" src="images/login/2fa-push-48.png" srcset="images/login/2fa-push-96.png 2x" title="デバイス認証" width="48" height="48" style="display:none;margin-left:3px;margin-right:3px;border-radius:3px;box-shadow:2px 2px 5px black;cursor:pointer;background-color:#FFF" onclick="usePushToken(1)">
                ...
                <div id="resettokenpanel" style="display:none">
                    <form id="resettokenpanelform" method="post">
                        ...
                        <table style="width:100%">
                            <tbody><tr>
                                <td>
                                    <input id="resetTokenInput" {{{autocomplete}}}="one-time-code" title="トークン" style="box-sizing:border-box;width:280px;border:0;border-radius:4px;padding:8px;background-color:#FFF8CC" placeholder="トークン" type="text" maxlength="50" name="token" onchange="resetCheckToken(event)" onpaste="resetCheckToken(event)" onkeyup="resetCheckToken(event)" onkeydown="resetCheckToken(event)"><br>
                            ...
                            <tr>
                                <td>
                                    <div>
                                        <input id="resetTokenOkButton" style="box-sizing:border-box;width:280px;border:0;border-radius:4px;padding:6px" type="button" onclick="submitButtonClicked('resettokenpanelform')" value="ログイン" disabled="disabled">
                                    </div>
                                </td>
                            </tr>
                            <tr id="2farow2">
                                <td colspan="2">
                                    <hr>
                                    <div>
                                        <img id="securityKeyButton2" src="images/login/2fa-key-48.png" srcset="images/login/2fa-key-96.png 2x" title="セキュリティキーを使用" width="48" height="48" style="display:none;margin-left:3px;margin-right:3px;border-radius:3px;box-shadow:2px 2px 5px black;cursor:pointer;background-color:#FFF" onclick="useSecurityKey(2)">
                                        ...
                                        <img id="emailKeyButton2" src="images/login/2fa-mail-48.png" srcset="images/login/2fa-mail-96.png 2x" title="Eメール" width="48" height="48" style="display:none;margin-left:3px;margin-right:3px;border-radius:3px;box-shadow:2px 2px 5px black;cursor:pointer;background-color:#FFF" onclick="useEmailToken(2)">
                                        <img id="pushKeyButton2" src="images/login/2fa-push-48.png" srcset="images/login/2fa-push-96.png 2x" title="デバイス認証" width="48" height="48" style="display:none;margin-left:3px;margin-right:3px;border-radius:3px;box-shadow:2px 2px 5px black;cursor:pointer;background-color:#FFF" onclick="usePushToken(2)">
                ...
                <div id="resetpasswordpanel" style="display:none;position:relative">
                    <form id="resetpasswordpanelform" method="post">
                        ...
                        <table>
                            ...
                            <tr>
                                <td colspan="2">
                                    <div style="float:right"><input id="resetPassButton" type="button" onclick="submitButtonClicked('resetpasswordpanelform')" value="パスワードを再設定する" disabled="disabled"></div>
                    ...
                    <form id="checkemailpanelform" method="post">
                        ...
                        <table id="checkCheckOperations" style="width:100%;display:none">
                            ...
                            <tr>
                                <td>
                                    <div>
                                        <input id="changeEmailButton" type="button" value="メールアドレスを変更する" onclick="changeEmailAddress()">
                                        <input id="checkEmailButton2" type="button" value="確認メールを再送信" onclick="resentEmailConfirmation()">
        ...
        <tr style="height:20px">
            <td>
                <div>
                    <div id="flink" style="float:right;margin-right:4px;color:#c8c8c8">{{{rootCertLink}}}&nbsp;<a href="terms">利用規約とプライバシー</a></div>
    ...
    <script>
        ...
        function startup() {
            ...
            if (twoFactorCookieDays > 0) {
                ...
                QH('tokenInputRememberSpan', format("このデバイスを{0}日間記憶します。", twoFactorCookieDays));
                QV('tokenInputRememberLabel2', true);
                QH('tokenInputRememberSpan2', format("このデバイスを{0}日間記憶します。", twoFactorCookieDays));
            } else {
            ...
            if (loginMode == '8') {
                ...
                websocket.onmessage = function (e) {
                    ...
                    if (r.sent === true) {
                        // Request was sent
                        QH('message8', '<span class="msg success"><b>' + format("リクエストが送信されました、{0}。", r.code) + '</b></span><br /><br />');
                    } else if (r.sent === false) {
                        // Request failed to send
                        QH('message8', '<span class="msg error"><b style=color:#8C001A>' + "リクエストの送信に失敗しました。" + '<b></span><br /><br />');
                        QV('tokenInputRememberLabel2', false);
                        this.close();
                        ...
                        this.close();
                        QV('tokenInputRememberLabel2', false);
                        QH('message8', '<span class="msg success"><b>' + "リクエストを受け付けました。" + '</b></span><br /><br />');
                        Q('pushtokenInput').value = r.token;
                        Q('pushOkButton').click();
                    } else {
                        // Request rejected
                        QH('message8', '<span class="msg error"><b style=color:#8C001A>' + "アクセスが拒否されました。" + '<b></span><br /><br />');
                        QV('tokenInputRememberLabel2', false);
                        this.close();
                    }
                }
                ...
                websocket.onerror = function (e) {
                    QH('message8', '<span class="msg error"><b style=color:#8C001A>' + "接続エラー" + '<b></span><br /><br />');
        ...
        function useEmailToken(panelAction) {
            ...
            setDialogMode(1, "安全なログイン", 3, useEmailKeyEx, "登録済みのメールアドレスにトークンを送信しますか？", panelAction);
        }
        ...
        function useSMSToken(panelAction) {
            ...
            setDialogMode(1, "安全なログイン", 3, useSMSTokenEx, "登録した電話番号にトークンを送信しますか？", panelAction);
        }
        ...
        function useMsgToken(panelAction) {
            ...
            setDialogMode(1, "安全なログイン", 3, useMsgTokenEx, "Send token to messaging application?", panelAction);
        }
        ...
        function changeEmailAddress() {
            ...
            var x = addHtmlValue("Eメール", '<input id=dp1email style=width:230px maxlength=256 value="' + email + '" {{{autocomplete}}}=off onchange=validateEmailAddress() onkeyup=validateEmailAddress() />');
            setDialogMode(1, "メール確認", 3, changeEmailAddressEx, x);
