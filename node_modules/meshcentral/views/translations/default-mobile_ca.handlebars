<!DOCTYPE html><html lang="ca" dir="ltr" xmlns="http://www.w3.org/1999/xhtml"><head>
    <meta charset="utf-8">
    ...
    <div id="container">
        ...
        <div id="masthead" style="background:url(logo.png) 0px 0px;background-size:341px 50px;background-color:#036;background-repeat:no-repeat;height:50px;width:100%;overflow:hidden">
            ...
            <div id="notificationCount" onclick="clickNotificationIcon()" class="unselectable" style="position:absolute;right:50px;top:0px;font-size:28px;width:50px;height:50px;cursor:pointer;display:none" title="Feu clic per veure les notificacions actuals"><div id="notificationCount2" style="padding-top:8px">0</div></div>
            ...
            <div id="column_l" style="width:100%;padding:0;position:absolute;bottom:0px;top:0px">
                <div id="p0" style="display:none;width:100%;height:100%">
                    <div style="display:flex;align-items:center;width:100%;height:100%">
                        <div id="p0message" style="text-align:center;width:100%"><span id="p0span">Servidor desconnectat</span>, <href onclick="reload()" style="cursor:pointer"><u>feu clic per tornar a connectar</u></href>.</div>
                    </div>
                </div>
                ...
                <div id="p2" style="display:none;position:absolute;top:0;left:0;right:0;bottom:0">
                    ...
                    <div id="xdevicesBar" style="position:absolute;overflow-y:auto;height:34px;left:0;right:0;bottom:0px;background-color:#aaa;color:black">
                        <div style="margin:4px">
                            ...
                            <label class="noselect"><input type="checkbox" id="RealNameCheckBox" onclick="onRealNameCheckBox()">Nom del sistema operatiu</label>
                            <label class="noselect"><input type="checkbox" id="OnlineCheckBox" onclick="onOnlineCheckBox(event)">En línia</label>
                        </div>
                    </div>
                </div>
                        ...
                        <div style="margin-left:8px">
                            <div id="p3AccountActions">
                                <div id="p2AccountSecurity" style="display:none">
                                    <p><strong>Seguretat del compte</strong></p>
                                    <div style="margin-left:9px;margin-bottom:8px">
                                        <div id="managePhoneNumber1" style="margin-top:5px;display:none"><a onclick="account_managePhone()" style="cursor:pointer">Gestionar el número de telèfon</a> <span id="authPhoneNumberCheck"><strong>✓</strong></span></div>
                                        <div id="manageEmail2FA" style="margin-top:5px;display:none"><a onclick="account_manageAuthEmail()" style="cursor:pointer">Gestioneu l'autenticació del correu electrònic</a> <span id="authEmailSetupCheck"><strong>✓</strong></span></div>
                                        <div style="margin-top:5px"><a href="#" onclick="account_showLocalizationSettings()">Configuració de localització</a></div>
                                        <div id="manageAuthApp" style="margin-top:5px;display:none"><a onclick="account_manageAuthApp()" style="cursor:pointer">Gestioneu l'aplicació d'autenticació</a> <span id="authAppSetupCheck"><strong>✓</strong></span></div>
                                        <div id="manageOtp" style="margin-top:5px;display:none"><a onclick="account_manageOtp(0)" style="cursor:pointer">Gestioneu els codis de seguretat</a> <span id="authCodesSetupCheck"><strong>✓</strong></span></div>
                                    </div>
                                </div>
                                <div id="p2AccountActions" style="display:none">
                                    <p><strong>Accions del compte</strong></p>
                                    <div style="margin-left:9px;margin-bottom:8px">
                                        <div style="margin-top:5px"><span id="viewPreviousLogins"><a onclick="return account_viewPreviousLogins()" style="cursor:pointer">Veure els inicis de sessió anteriors</a></span></div>
                                        <div style="margin-top:5px"><span id="managePhoneNumber2" style="display:none"><a onclick="account_managePhone()" style="cursor:pointer">Gestionar el número de telèfon</a></span></div>
                                        <div style="margin-top:5px"><span id="verifyEmailId" style="display:none"><a onclick="account_showVerifyEmail()" style="cursor:pointer">Verificar Correu</a></span></div>
                                        <span id="p2AccountPassActions">
                                            <div style="margin-top:5px"><span id="changeEmailId" style="display:none"><a onclick="account_showChangeEmail()" style="cursor:pointer">Canvia l'adreça de correu electrònic</a></span></div>
                                            <div style="margin-top:5px"><a onclick="account_showChangePassword()" style="cursor:pointer">Canvia la contrasenya</a><span id="p2nextPasswordUpdateTime"></span></div>
                                            <div style="margin-top:5px"><a onclick="account_showDeleteAccount()" style="cursor:pointer">Esborrar compte</a></div>
                                        </span>
                                        <div style="margin-top:5px" id="setDarkModeLink"><a onclick="toggleNightMode()" style="cursor:pointer">Estableix el mode fosc</a></div>
                                        <div style="margin-top:5px"><a onclick="showNotes(false)" style="cursor:pointer">Notes personals</a></div>
                                    </div>
                                <br style="clear:both">
                                </div>
                            </div>
                            <strong>Grups de dispositius</strong>
                            <span id="p3createMeshLink1">( <a onclick="account_createMesh()" style="cursor:pointer"><img src="images/icon-addnew.png" width="12" height="12" border="0"> Nou</a> )</span>
                            <br><br>
                            <div id="p3meshes"></div>
                            <div id="p3noMeshFound" style="margin-left:9px;display:none">No hi ha grups de dispositius.<span id="p3createMeshLink2"> <a onclick="account_createMesh()" style="cursor:pointer"><strong>Comença aquí!</strong></a></span></div>
                            <br style="clear:both">
                        </div>
                    </div>
                </div>
                <div id="p5" style="display:none">
                    <table cellspacing="0" style="margin:0;padding:0;border-spacing:0;border:0;">
                        <tbody><tr style="padding:0">
                            ...
                            <td>
                                <div style="margin-left:5px">
                                    <strong style="font-size:large">Els meus fitxers</strong><br>
                                </div>
                            </td>
                        </tr>
                    </tbody></table>
                            ...
                            <tbody><tr>
                                <td style="width:100%;background-color:#d3d9d6;text-align:left;padding:4px" valign="bottom">
                                    <div style="width:100%;text-align:center">
                                        <input type="button" style="width:calc(100%/5 - 5px)" id="p5FolderUp" disabled="disabled" onclick="p5folderup()" value="Amunt">
                                        <input type="button" style="width:calc(100%/5 - 5px)" id="p5SelectAllButton" disabled="disabled" onclick="p5selectallfile()" value="Seleccionar tot" onkeypress="return false" onkeydown="return false">
                                        <input type="button" style="width:calc(100%/5 - 5px)" id="p5RenameFileButton" disabled="disabled" value="Canvia el nom" onclick="p5renamefile()" onkeypress="return false" onkeydown="return false">
                                        <input type="button" style="width:calc(100%/5 - 5px)" id="p5DeleteFileButton" disabled="disabled" value="Suprimeix" onclick="p5deletefile()" onkeypress="return false" onkeydown="return false">
                                    ...
                                    <div style="width:100%;text-align:center">
                                        <input type="button" style="width:calc(100%/5 - 5px)" id="p5UploadButton" disabled="disabled" value="Carrega" onclick="p5uploadFile()" onkeypress="return false" onkeydown="return false">
                                        <input type="button" style="width:calc(100%/5 - 5px)" id="p5CutButton" disabled="disabled" value="Tallar" onclick="p5copyFile(1)" onkeypress="return false" onkeydown="return false">
                                        <input type="button" style="width:calc(100%/5 - 5px)" id="p5CopyButton" disabled="disabled" value="Còpia" onclick="p5copyFile(0)" onkeypress="return false" onkeydown="return false">
                                        <input type="button" style="width:calc(100%/5 - 5px)" id="p5PasteButton" disabled="disabled" value="Enganxa" onclick="p5pasteFile()" onkeypress="return false" onkeydown="return false">
                                        <input type="button" style="width:calc(100%/5 - 5px)" id="p5RefreshButton" value="Actualització" onclick="p5refreshFiles()" onkeypress="return false" onkeydown="return false">
                                    </div>
                                </td>
                            </tr>
                            <tr>
                                        ...
                                        <tbody><tr>
                                            ...
                                            <td style="text-align:right;padding-right:4px">
                                                <select id="p5sortdropdown" onchange="updateFiles()">
                                                    <option value="1" selected="selected">Ordena per nom</option>
                                                    <option value="2">Ordena per mida</option>
                                                    <option value="3">Ordena per data</option>
                                                    <option value="4">Baixar pel nom</option>
                                                    <option value="5">Baixar per mida</option>
                                                    <option value="6">Descens per data</option>
                                                </select>
                                            </td>
                                        </tr>
                                    </tbody></table>
                ...
                <div id="p10" style="display:none;position:absolute;bottom:0;top:0;width:100%;overflow:hidden">
                    ...
                    <div id="p10dialog" style="z-index:1000;background-color:#EEE;box-shadow:0px 0px 15px #666;font-family:Arial,Helvetica,sans-serif;border-radius:5px;position:fixed;top:30px;width:300px;left:30px;display:none">
                        <div style="width:100%;background-color:#003366;color:#FFF;border-radius:5px 5px 0 0">
                            <div style="padding:5px">Personalització de dreceres de teclat</div>
                            <div style="width:100%;margin:6px"></div>
                        </div>
                        <div style="margin-right:16px;margin-left:8px"><div id="p10dialog2" style="margin:auto;margin:3px"></div></div>
                        <div style="width:100%;padding:2px;text-align:center"><input type="button" value="Restaura les dreceres de teclat predeterminades" onclick="restoreDeskCustomizeKey()"></div>
                        <div style="padding:10px;margin-bottom:20px"><input type="button" value="D'acord" style="float:right;width:80px" onclick="deskCustomizeKeysEx()"></div>
                    </div>
                    ...
                    <div id="p10desktop" style="overflow:hidden;position:absolute;top:55px;bottom:0px;width:100%;display:none">
                        <div id="deskarea1" style="position:absolute;top:0px;width:100%;height:32px">
                            <div style="padding-top:2px;padding-bottom:2px;background:#C0C0C0;height:32px">
                                ...
                                <div style="margin-left:3px">
                                    <input type="button" id="connectbutton1" value="Connecta't" onclick="connectDesktop(event,3)" onkeypress="return false" onkeydown="return false" disabled="disabled" style="height:28px">
                                    ...
                                    <input type="button" id="disconnectbutton1" value="Desconnecta" onclick="connectDesktop(event,0)" onkeypress="return false" onkeydown="return false" style="height:28px">
                                    <span id="deskstatus" style="color:black">Desconnectat</span>
                                </div>
                            </div>
                        </div>
                        ...
                        <div id="deskarea4" style="position:absolute;bottom:0px;width:100%;height:32px">
                            <div style="padding-top:2px;padding-bottom:2px;background:#C0C0C0">
                                ...
                                <div>
                                    <input id="deskActionsBtn" type="button" style="margin-left:3px;height:28px" onkeypress="return false" onkeydown="return false" value="Accions" onclick="deviceActionFunction()">
                                    <input type="button" value="Configuració" onkeypress="return false" onkeydown="return false" onclick="showDesktopSettings()" style="height:28px">
                                    <input type="button" onkeypress="return false" onkeydown="return false" value="Accions de poder..." onclick="showPowerActionDlg()" style="display:none;height:28px">
                                    ...
                                    <input type="button" id="DeskScreens" value="Pantalles" onkeypress="return false" onkeydown="return false" onclick="deskSelectScreens()" style="display:none;height:28px">
                        ...
                        <div id="termTable" style="position:absolute;top:0;bottom:0;left:0;right:0">
                            <div id="termarea1">
                                <div class="areaHead" style="line-height:24px">
                                    ...
                                    <div>
                                        <span id="connectbutton2span" style="margin-left:3px"><input type="button" id="connectbutton2" value="Connecta't" style="height:28px" onclick="connectTerminal(event,1)" onkeypress="return false" onkeydown="return false" disabled="disabled"></span>
                                        <span id="connectbutton2sspan" style="margin-right:4px"><input type="button" id="connectbutton2s" value="Connexió SSH" style="height:28px" onclick="connectTerminal(event,3)" onkeypress="return false" onkeydown="return false" disabled="disabled"></span>
                                        <span id="disconnectbutton2span" style="margin-left:3px"><input type="button" id="disconnectbutton2" value="Desconnecta" style="height:28px" onclick="connectTerminal(event,0)" onkeypress="return false" onkeydown="return false"></span>
                                        <span id="termstatus" style="line-height:22px">Desconnectat</span><span id="termtitle"></span>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div id="termarea4" style="position:relative;height:32px;">
                                <div class="areaFoot">
                                    ...
                                    <div style="height:28px">
                                        <input id="termActionsBtn" style="margin-left:3px;height:28px" type="button" title="Realitzeu accions d'alimentació al dispositiu" onkeypress="return false" onkeydown="return false" value="Accions" onclick="deviceActionFunction()">
                        ...
                        <table id="p13toolbar" style="width:100%;height:111px" cellpadding="0" cellspacing="0">
                            <tbody><tr>
                                <td style="background-color:#C0C0C0;border-bottom:2px solid black;padding:2px;line-height:24px">
                                    <div style="float:right;text-align:right">
                                        <input id="filesActionsBtn" type="button" onkeypress="return false" onkeydown="return false" value="Accions" onclick="deviceActionFunction()" style="margin-right:2px">
                                        <div id="filesCustomUpperRight" style="float:left;margin-right:6px"></div>
                                    </div>
                                    <div style="margin-left:2px">
                                        <input id="p13AutoConnect" value="Connexió automàtica" onclick="autoConnectFiles(event)" onkeypress="return false" onkeydown="return false" type="button" style="display:none">
                                        <input id="p13Connect" value="Connecta't" onclick="connectFiles(event,1)" onkeypress="return false" onkeydown="return false" type="button">
                                        <input id="p13Connects" value="Connexió SFTP" onclick="connectFiles(event,2)" onkeypress="return false" onkeydown="return false" type="button">
                                        <input id="p13Disconnect" value="Desconnecta" onclick="connectFiles(event)" onkeypress="return false" onkeydown="return false" type="button">
                                        <span class="textOverGray" id="p13Status">Desconnectat</span>
                                    </div>
                                </td>
                            </tr>
                            <tr>
                                <td style="width:100%;background-color:#d3d9d6;text-align:left;padding:4px" valign="bottom">
                                    <div style="width:100%;text-align:center">
                                        <input type="button" style="width:calc(100%/5 - 5px)" id="p13FolderUp" disabled="disabled" onclick="p13folderup()" value="Amunt">
                                        <input type="button" style="width:calc(100%/5 - 5px)" id="p13SelectAllButton" disabled="disabled" onclick="p13selectallfile()" value="Seleccionar tot" onkeypress="return false" onkeydown="return false">
                                        <input type="button" style="width:calc(100%/5 - 5px)" id="p13RenameFileButton" disabled="disabled" value="Canvia el nom" onclick="p13renamefile()" onkeypress="return false" onkeydown="return false">
                                        <input type="button" style="width:calc(100%/5 - 5px)" id="p13DeleteFileButton" disabled="disabled" value="Suprimeix" onclick="p13deletefile()" onkeypress="return false" onkeydown="return false">
                                    ...
                                    <div style="width:100%;text-align:center">
                                        <input type="button" style="width:calc(100%/5 - 5px)" id="p13UploadButton" disabled="disabled" value="Carrega" onclick="p13uploadFile()" onkeypress="return false" onkeydown="return false">
                                        <input type="button" style="width:calc(100%/5 - 5px)" id="p13CutButton" disabled="disabled" value="Tallar" onclick="p13copyFile(1)" onkeypress="return false" onkeydown="return false">
                                        <input type="button" style="width:calc(100%/5 - 5px)" id="p13CopyButton" disabled="disabled" value="Còpia" onclick="p13copyFile(0)" onkeypress="return false" onkeydown="return false">
                                        <input type="button" style="width:calc(100%/5 - 5px)" id="p13PasteButton" disabled="disabled" value="Enganxa" onclick="p13pasteFile()" onkeypress="return false" onkeydown="return false">
                                        <input type="button" style="width:calc(100%/5 - 5px)" id="p13RefreshButton" disabled="disabled" value="Actualització" onclick="p13folderup(9999)" onkeypress="return false" onkeydown="return false">
                                    </div>
                                </td>
                            </tr>
                            <tr>
                            ...
                            <tbody><tr style="height:28px">
                                <td class="areaHead">
                                    <div class="toright2">
                                        ...
                                        <input type="button" id="p15uploadCore" value="Acció de l'agent" onclick="p15uploadCore(event)">
                                    </div>
                                        ...
                                        <tbody><tr>
                                            ...
                                            <td id="p15outputselecttd">
                                                <select id="p15outputselect" onchange="setupConsole()">
                                                    ...
                                                    <option id="p15outputselect3" value="3">Empènyer</option>
                                                    <option id="p15outputselect2" value="2">MQTT</option>
                                                </select>
                                            </td>
                                            <td style="width:1%"><input id="id_p15consoleClear" type="button" class="bottombutton" value="Clar" onclick="p15consoleClear()"></td>
                                        </tr>
                                    </tbody></table>
                                </td>
                            </tr>
    ...
    <div id="dialog" style="display:none">
        ...
        <div style="margin-right:16px;margin-left:8px">
            ...
            <div id="dialog3" style="margin:auto;margin:3px">
                <select id="deskkeys" style="width:100%">
                    <option value="10">Ctrl+Alt+Supr</option>
                    <option value="11">Tab</option>
                    <option value="5">Guanyar</option>
                    <option value="0">Win+Down</option>
                    <option value="1">Guanyar+Amunt</option>
                    <option value="2">Guanya+L</option>
                    <option value="3">Guanya+M</option>
                    <option value="4">Maj+Win+M</option>
                    <option value="6">Guanya+R</option>
            ...
            <div id="dialog4" style="margin:auto;margin:3px">
                <div id="d3upload">
                    <div>Selecció de fitxers</div>
                    <select id="d3uploadMode" onchange="d3modechange()">
                        <option value="1">Càrrega de fitxers locals</option>
                        <option value="2">Selecció de fitxers del servidor</option>
                    </select>
                </div>
                <div id="d3localmode" style="display:none">
                    <div>Penja el document</div>
                ...
                <div id="d3servermode">
                    <div id="d3serveraction" valign="bottom">
                        <input type="button" id="p3FolderUp" disabled="disabled" onclick="d3folderup()" value="Amunt">&nbsp;<span id="p3CurrentFolder"></span>
                    </div>
            ...
            <div id="dialog7" style="margin:auto;margin:3px">
                <div id="d7meshkvm">
                    <h4 style="width:100%;border-bottom:1px solid gray">Agent d'escriptori remot</h4>
                    <table style="width:100%">
                        <tbody><tr>
                            <td>
                                Qualitat
                        ...
                        <tr>
                            ...
                            <td style="width:100px">
                                <select id="d7framelimiter" style="float:right;width:200px" dir="rtl">
                                    <option selected="selected" value="50">Ràpid</option>
                                    <option value="100">Mitjana</option>
                                    <option value="400">Lent</option>
                                    <option value="1000">Molt lent</option>
                                </select>
                            </td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                            <td></td>
                            <td>
                                <label style="display:block" id="d7deskAutoLockLabel"><input type="checkbox" id="d7deskAutoLock">Bloqueja a Desconnecta</label>
                            </td>
                        </tr>
                    </tbody></table>
                </div>
                <div id="d7amtkvm">
                    <h4 style="width:100%;border-bottom:1px solid gray">KVM de maquinari Intel® AMT</h4>
                    <table style="width:100%">
                        <tbody><tr>
                            <td>Codificació</td>
                            <td style="width:100px">
                                <select id="d7desktopmode" style="float:right;width:200px">
                                    <option value="1">RLE8, el més ràpid</option>
                                    <option value="2">RLE16, recomanat</option>
                                    <option value="3">RAW8, Lent</option>
                                    <option value="4">RAW16, molt lent</option>
                                </select>
                            </td>
                        </tr>
                    </tbody></table>
        ...
        <div id="idx_dlgButtonBar" style="padding:10px;margin-bottom:20px">
            <input id="idx_dlgCancelButton" type="button" value="Cancel · lar" style="float:right;width:80px;margin-left:5px" onclick="dialogclose(0)">
            <input id="idx_dlgOkButton" type="button" value="D'acord" style="float:right;width:80px" onclick="dialogclose(1)">
            <div><input id="idx_dlgDeleteButton" type="button" value="Suprimeix" style="display:none" onclick="dialogclose(2)"></div>
        </div>
    </div>
    <div id="topMenu" style="z-index:1000;background-color:#EEE;box-shadow:0px 0px 15px #666;font-family:Arial,Helvetica,sans-serif;border-radius:0px 0px 5px 5px;position:fixed;top:50px;right:5px;width:170px;display:none">
        <div style="padding:12px;border-top:1px solid gray;color:black;cursor:pointer" onclick="topMenu(2)">Els meus fitxers</div>
        <div style="padding:12px;border-top:1px solid gray;color:black;cursor:pointer" onclick="topMenu(1)">El meu compte</div>
        <div id="logoutMenuOption"><a id="logoutMenuOptionRef" href="/logout"><div style="padding:12px;border-top:1px solid gray;color:black;cursor:pointer">Tancar sessió</div></a></div>
    </div>
    ...
    <script>
        ...
        function onStateChanged(server, state, prevState, errorCode) {
            if (state == 0) {
                ...
                if (prevState == 2) { setTimeout(serverPoll, 5000); } else { QH('p0span', "No es pot connectar el sòcol web"); }
                // Clean up here
        ...
        function onMessage(server, message) {
            switch (message.action) {
                ...
                case 'otpauth-getpasswords': {
                    ...
                    x += '<input type=button value=\'' + "Noves fitxes" + '\' onclick=\'account_manageOtp(1);\'></input>';
                    if (message.passwords != null) { x += '<input type=button value=\'' + "Clar" + '\' onclick=\'account_manageOtp(2);\'></input>'; }
                    x += '</div><br />';
                    ...
                    if ((xxdialogMode == 2) && (xxdialogTag == 'previousLogins')) {
                        ...
                        if (message.events.length == 0) {
                            ...
                            for (var i in message.events) {
                                ...
                                if (m == 107) { m = "Inici de sessió vàlid"; c = 'BBD1BB'; xx = ''; }
        ...
        function goStack() {
            ...
            if (idtype == 'files') {
                ...
                if ((features & 0x00040000) && !((userinfo.otpsecret == 1) || (userinfo.otphkeys > 0) || (userinfo.otpkeys > 0) || (userinfo.otpduo > 0) || (userinfo.otpdev > 0) || ((features & 0x00800000) && (userinfo.otpekey == 1)))) { setDialogMode(2, "Seguretat del compte", 1, null, "No es pot accedir a aquesta funció fins que s'hagi activat l'autenticació de dos factors. Això és necessari per a una seguretat addicional. Aneu a \"El meu compte\" i mireu la secció \"Seguretat del compte\"."); return; }  
                go(5);
            }
        }
        ...
        function account_managePhone() {
            ...
            if (userinfo.phone != null) {
                ...
                x += '<td style=text-align:center><div style=padding:6px>' + "Número de telèfon verificat" + '</div><div style=font-size:20px>' + userinfo.phone + '</div>';
        ...
        function account_showLocalizationSettings() {
            ...
            var x = '<select id=d2locselect style=width:180px><option value="*">' + "Valor del navegador d'usuari" + '</option>';
            ...
            if (serverinfo.languages && serverinfo.languages.length > 0) {
                ...
                var z = '<select id=d2langselect style=width:180px><option value="*">' + "Valor del navegador d'usuari" + '</option>';
        ...
        function account_showChangeEmail() {
            if (xxdialogMode) return;
            var x = addHtmlValue("Correu electrònic", '<input id=dp3email style=width:170px maxlength=256 onchange=account_validateEmail() onkeyup=account_validateEmail(event) />');
        ...
        function account_showChangePassword() {
            ...
            if (passRequirements) {
                ...
                if (rc > 0) { x += '<br /><span style=font-size:x-small>' + format("Requisits: {0}.", r.join(', ')) + '</span>'; }
            }
            x += '<br />';
        ...
        function account_createMesh() {
            ...
            if ((userinfo.siteadmin != 0xFFFFFFFF) && ((userinfo.siteadmin & 64) != 0)) { setDialogMode(2, "Nou grup de dispositius", 1, null, "Aquest compte no té els drets per crear un grup de dispositius nou."); return; }

            // Remind the user to verify the email address
            if ((userinfo.emailVerified !== true) && (serverinfo.emailcheck == true) && (userinfo.siteadmin != 0xFFFFFFFF)) { setDialogMode(2, "Seguretat del compte", 1, null, "No es pot accedir a un dispositiu fins que no es verifiqui una adreça de correu electrònic. Això és necessari per a la recuperació de la contrasenya. Aneu a \"El meu compte\" per canviar i verificar una adreça de correu electrònic."); return; }

            // Remind the user to add two factor authentication
            if ((features & 0x00040000) && !((userinfo.otpsecret == 1) || (userinfo.otphkeys > 0) || (userinfo.otpkeys > 0) || (userinfo.otpduo > 0) || (userinfo.otpdev > 0) || ((features & 0x00800000) && (userinfo.otpekey == 1)))) { setDialogMode(2, "Seguretat del compte", 1, null, "No es pot accedir a un dispositiu fins que no s'hagi activat l'autenticació de dos factors. Això és necessari per a una seguretat addicional. Aneu a \"El meu compte\" i mireu la secció \"Seguretat del compte\"."); return; }
            ...
            x += addHtmlValue("Tipus", '<div style=width:170px;margin:0;padding:0><select id=dp3meshtype style=width:100% onchange=account_validateMeshCreate() ><option value=2>' + "Grup d'agents de programari" + '</option><option value=1>' + "Només Intel&reg; AMT" + '</option></select></div>');
            x += addHtmlValue("Descripció", '<div style=width:170px;margin:0;padding:0><textarea id=dp3meshdesc maxlength=1024 style=width:100%;resize:none></textarea></div>');
            setDialogMode(2, "Crea un grup de dispositius", 3, account_createMeshEx, x);
        ...
        function updateFiles() {
            ...
            var html1 = '', html2 = '', displayPath = '<a style=cursor:pointer;color:black onclick=p5folderup(0)>' + "Arrel" + '</a>', fullPath = 'Root', publicPath, filetreex = filetree, folderdepth = 1;
            ...
            for (var i in filetreexx) {
                ...
                if (f.t < 3 || f.t == 4) {
                    ...
                    var link = shortname;
                    var publiclink = '';
                    if (publicfolder) { publiclink = ' (<a style=cursor:pointer onclick=\'p5showPublicLink("' + publicPath + '/' + f.nx + '")\'>' + "Enllaç" + '</a>)'; }
        ...
        function getNiceSize(bytes) {
            if (bytes <= 0) return "L'emmagatzematge supera";
            if (bytes < 2048) return format("{0}b a l'esquerra", bytes);
            if (bytes < 2097152) return format("Queden {0}k", Math.round(bytes / 1024));
            if (bytes < 2147483648) return format("Queden {0}m", Math.round(bytes / 1024 / 1024));
            return format("Queden {0}g", Math.round(bytes / 1024 / 1024 / 1024));
        }
        ...
        function p5showPublicLink(u) { setDialogMode(2, "Enllaç públic", 1, null, '<input type=text style=width:100% value="' + u + '" readonly />'); }
        ...
        function p5setActions() {
            ...
            Q('p5SelectAllButton').value = (cc > 0 ? "Cap" : "Tots");
        ...
        function updateDevices() {
            ...
            for (var i in nodes) {
                ...
                if (sort == 0) {
                    ...
                    if (((meshes[nodes[i].meshid]?nodes[i].meshid:'*') != current)) {
                        deviceHeaderSet();
                        var extra = '';
                        if ((meshes[nodes[i].meshid] != null) && (meshes[nodes[i].meshid].mtype == 1)) { extra = '<span style=color:lightgray>' + ", només Intel&reg; AMT" + '</span>'; }
                        ...
                        if (meshes[nodes[i].meshid]) {
                            ...
                            r += '</span><span id=MxMESH><i>' + "Dispositius individuals" + '</i></span><span id=DevxHeader' + deviceHeaderId + ' style=color:lightgray></span></div>';
                            current = '*';
                        }
            ...
            if ((r == '') && (nodes.length > 0) && (Q('SearchInput').value != '')) {
                viewNothing = true;
                r = '<div style="margin:30px">' + "No hi ha cap dispositiu que coincideixi amb aquesta cerca." + '</div>';
            }
            ...
            if ((sort == 0) && (Q('SearchInput').value == '')) {
                for (var i in meshes) {
                    ...
                    if ((displayedMeshes[mesh._id] == null) && (IsMeshViewable(mesh))) {
                        ...
                        if (mesh.mtype == 1) { r += '<div style=padding:10px><i>' + "No hi ha dispositius Intel&reg; AMT en aquest grup"; }
                        if (mesh.mtype > 1) { r += '<div style=padding:10px><i>' + "No hi ha cap dispositiu en aquest grup"; }
                        r += '.</i></div></div>';
                        current = mesh._id;
                        count++;
                    }
            ...
            if (count == 0) {
                if ((Q('SearchInput').value != '') || (Q('OnlineCheckBox').checked)) {
                    QH('xdevices', '<div style="margin-top:50px;text-align:center"><span style="font-size:30px">' + "Sense dispositius" + '</span><br /><br />' + "No hi ha cap dispositiu que coincideixi amb aquesta cerca." + ' <a onclick=clearSearchInput() style=cursor:pointer>' + "Esborra el filtre de cerca" + '</a></div>');
                } else {
                    QH('xdevices', '<div style="margin-top:50px;text-align:center"><span style="font-size:30px">' + "Sense dispositius" + '</span><br /><br />' + "Utilitzeu la versió d'escriptori d'aquest lloc web per afegir dispositius." + '</div>');
                }
            } else {
                QH('xdevices', r);
            }
            ...
            if ((div.offsetTop >= visibleTop) && (div.offsetTop < visibleBottom)) {
                ...
                if (node.sessions != null) {
                    ...
                    if (node.sessions.battery != null) {
                        ...
                        else if (bat.state == 'dc') { statestr = "El dispositiu funciona amb bateria"; }
                ...
                if ((i == 'kvm') && (node.sessions.multidesk == null)) {
                    ...
                    for (var j in node.sessions.kvm) {
                        if (j.startsWith('user/')) {
                            ...
                            x += addHtmlValue4(getUserName(j), ((node.sessions.kvm[j] == 1) ? "1 sessió" : nobreak(format("{0} sessions", node.sessions.kvm[j]))) + trash);
                        } else if (j == 'busy') {
                    ...
                    for (var j in node.sessions.multidesk) {
                        ...
                        x += addHtmlValue4(getUserName(j), ((node.sessions.multidesk[j] == 1) ? "1 sessió" : nobreak(format("{0} sessions", node.sessions.multidesk[j]))) + trash);
                    }
                } else if (i == 'terminal') {
                    x += '<u>' + "Terminal" + '</u>';
                    for (var j in node.sessions.terminal) {
                        ...
                        x += addHtmlValue4(getUserName(j), ((node.sessions.terminal[j] == 1) ? "1 sessió" : nobreak(format("{0} sessions", node.sessions.terminal[j]))) + trash);
                    }
                } else if (i == 'files') {
                    x += '<u>' + "Fitxers" + '</u>';
                    for (var j in node.sessions.files) {
                        ...
                        x += addHtmlValue4(getUserName(j), ((node.sessions.files[j] == 1) ? "1 sessió" : nobreak(format("{0} sessions", node.sessions.files[j]))) + trash);
                    }
                } else if (i == 'tcp') {
                    ...
                    for (var j in node.sessions.tcp) {
                        ...
                        x += addHtmlValue4(getUserName(j), ((node.sessions.tcp[j] == 1) ? "1 sessió" : nobreak(format("{0} sessions", node.sessions.tcp[j]))) + trash);
                    }
                } else if (i == 'udp') {
                    ...
                    for (var j in node.sessions.udp) {
                        ...
                        x += addHtmlValue4(getUserName(j), ((node.sessions.udp[j] == 1) ? "1 sessió" : nobreak(format("{0} sessions", node.sessions.udp[j]))) + trash);
                    }
                }
            }
        ...
        var powerStatetable = ['', "Alimentat", "Dormir", "Dormir", "Dormir", "Hibernant", "Apagar", "Present", "Apagat"];
        var powerStateStrings = ['', "Alimentat", "Dorment", "Dorment", "El somni profund", "Hibernant", "Soft-Off", "Present", "Apagat"];
        ...
        function NodeStateStr(node) {
            ...
            if (node.conn) {
                if ((node.conn & 1) != 0) { states.push('<span>' + ((node.mtype == 4) ? ((node.porttype == 'PDU') ? "Interruptor" : "IP-KVM") : "Agent") + '</span>'); }
                if ((node.conn & 2) != 0) { states.push('<span>' + "CIRA" + '</span>'); }
                else if ((node.conn & 4) != 0) { states.push('<span>' + "Intel&reg; AMT" + '</span>'); }
                if ((node.conn & 8) != 0) { states.push('<span>' + "Relleu" + '</span>'); }
        ...
        */
        ...
        function gotoDevice(nodeid, panel, refresh) {
            ...
            if (!currentNode || currentNode._id != node._id || refresh == true) {
                ...
                if ((((features & 1) == 0) && (node.mtype != 4)) || (node.mtype == 3)) { // If not WAN-only, local hostname is in use
                    if ((meshrights & 4) != 0) {
                        if (node.host) {
                            x += addDeviceAttribute("Nom d'amfitrió", '<span onclick=showEditNodeValueDialog(1) style=cursor:pointer>' + EscapeHtml(node.host) + '</span>');
                        } else {
                            x += addDeviceAttribute("Nom d'amfitrió", '<span onclick=showEditNodeValueDialog(1) style=cursor:pointer><i>' + "Cap" + '</i></span>');
                        }
                    } else {
                        x += addDeviceAttribute("Nom d'amfitrió", EscapeHtml(node.host));
                    }
                }
                ...
                if ((meshrights & 4) != 0) {
                    x += addDeviceAttribute("Descripció", '<span onclick=showEditNodeValueDialog(2) style=cursor:pointer>' + description + '</span>');
                } else {
                ...
                if (node.intelamt != null) {
                    ...
                    if (node.intelamt.ver != null && node.intelamt.state == null) { str += '<i>' + nobreak("Estat desconegut") + '</i>, v' + EscapeHtml(node.intelamt.ver); }
                ...
                if (connectivity && connectivity > 1) {
                    var cstate = [];
                    if ((node.conn & 1) != 0) cstate.push('<span>' + ((node.mtype == 4) ? ((node.porttype == 'PDU') ? "Interruptor" : "IP-KVM") : "Agent") + '</span>');
                    if ((node.conn & 2) != 0) cstate.push('<span>' + "Intel&reg; AMT CIRA" + '</span>');
                    else if ((node.conn & 4) != 0) cstate.push('<span>' + "Intel&reg; AMT" + '</span>');
                    if ((node.conn & 8) != 0) cstate.push('<span>' + "Agent de relleu" + '</span>');
                ...
                if ((meshrights & 4) != 0) {
                    x += addDeviceAttribute("Etiquetes", '<span onclick=showEditNodeValueDialog(3) style=cursor:pointer;color:black>' + groupingTags + '</span>');
                } else {
                    x += addDeviceAttribute("Etiquetes", '<span style=line-height:26px;color:black>' + groupingTags + '</span>');
                }
                ...
                if (((meshrights & (4 + 8 + 64 + 262144)) != 0) && (node.mtype < 3)) { x += '<input type=button value="' + "Accions" + '" onclick=deviceActionFunction() />'; }
                ...
                if ((node.mtype == 4) && (connectivity & 1)) {
                    if (node.porttype == 'PDU') {
                        ...
                        if (meshrights & 8) { x += '<input type=button value="' + "Control remot" + '" title="' + "Control remot" + '" onclick=openIpKvmRemoteControl("' + encodeURIComponentEx(node._id) + '") />'; }x
                    }
                }
                ...
                if ((meshrights & 0x8000) != 0) { x += '<a style=cursor:pointer onclick=p10showDeleteNodeDialog("' + node._id + '")>' + "Suprimeix el dispositiu" + '</a>'; }
                ...
                if ((connectivity & 1) != 0) { if (powerstate.length > 0) { powerstate += ', '; } powerstate += ((node.mtype == 4) ? ((node.porttype == 'PDU') ? "Interruptor" : "IP-KVM") : "Agent de malla"); }
                if ((connectivity & 2) != 0) { if (powerstate.length > 0) { powerstate += ', '; } powerstate += "Intel&reg; AMT connectat"; }
                else if ((connectivity & 4) != 0) { if (powerstate.length > 0) { powerstate += ', '; } powerstate += "Intel&reg; AMT detectat"; }
                if ((connectivity & 16) != 0) { if (powerstate.length > 0) { powerstate += ', '; } powerstate += "Canal MQTT connectat"; }
        ...
        function deviceToastFunction() {
            if (xxdialogMode) return;
            setDialogMode(2, "Torrada del dispositiu", 3, deviceToastFunctionEx, '<textarea id=d2devToast style=width:100%;height:80px;resize:none;overflow-y:scroll></textarea>');
        }
        ...
        function setupDeviceMenu(op, obj) {
            ...
            ) { menus.push({ n: "Escriptori", f: 'setupDeviceMenu(1)' }); }
            ...
            if ((currentDevicePanel != 2) && (currentNode != null) && (meshrights & 8) && ((meshrights == 0xFFFFFFFF) || ((meshrights & 1024) == 0)) && ((currentNode.mtype != 1) && (currentNode.agent) && (currentNode.agent.caps & 4))) { menus.push({ n: "Fitxers", f: 'setupDeviceMenu(2)' }); }
            if ((currentDevicePanel != 3) && (currentNode != null) && (currentNode.mtype < 3) && ((meshrights & 1048576) != 0)) { menus.push({ n: "Detalls", f: 'setupDeviceMenu(3)' }); }
        ...
        function deviceActionFunction() {
            ...
            if ((currentNode.agent != null) && (currentNode.agent.id == 14)) {
                if (((currentNode.conn & 1) != 0) && ((rights & 8) != 0)) {
                    ...
                    z += '<div id=d2devicetimediv>' + addHtmlValue("Temps", '<select id=d2devicetime style=float:right;width:170px><option value=1000>' + "1 segon" + '</option><option value=5000>' + "5 segons" + '</option><option value=10000>' + "10 segons" + '</option></select>') + '</div>';
                }
            } else {
        ...
        function deviceLockFunction() {
            if ((xxdialogMode != null || xxdialogMode == 0) && (desktop != null) && (desktop.contype == 1)) { setDialogMode(2, "Bloqueja l'escriptori", 3, function() { if ((desktop != null) && (desktop.contype == 1)) { desktop.sendCtrlMsg('{"ctrlChannel":"102938","type":"lock"}'); } }, "Bloquejar l'escriptori de l'usuari?"); }
        }

        function deviceChat(e) {
            if (xxdialogMode) return;
            setDialogMode(2, "Acció del dispositiu", 3, function () {
        ...
        function editDeviceAmtSettings(nodeid, func) {
            ...
            x += addHtmlValue("Nom d'usuari", '<input id=dp10username style=width:170px maxlength=32 autocomplete=nope placeholder="admin" onchange=validateDeviceAmtSettings() onkeyup=validateDeviceAmtSettings() />');
            x += addHtmlValue("Contrasenya", '<input id=dp10password type=password style=width:170px autocomplete=nope maxlength=32 onchange=validateDeviceAmtSettings() onkeyup=validateDeviceAmtSettings() />');
            // Only display the TLS setting if the Intel AMT manager is not running on the server. With the manager TLS is auto-detected.
            if ((features2 & 1) == 0) { x += addHtmlValue("Seguretat", '<select id=dp10tls style=width:176px><option value=0>' + "Sense seguretat TLS" + '</option><option value=1>' + "Es requereix seguretat TLS" + '</option></select>'); }
            if ((node.intelamt.user != null) && (node.intelamt.user != '')) { buttons = 7; }
            setDialogMode(2, "Editeu les credencials d'Intel&reg; AMT", buttons, editDeviceAmtSettingsEx, x, { node: node, func: func });
        ...
        function p10showDeleteNodeDialog(nodeid) {
            if (xxdialogMode) return;
            setDialogMode(2, "Suprimeix el node", 3, p10showDeleteNodeDialogEx, format("Vols suprimir {0}?", EscapeHtml(currentNode.name)) + '<br /><br /><label><input id=p10check type=checkbox onchange=p10validateDeleteNodeDialog() />' + "Confirmeu" + '</label>', nodeid);
        ...
        var showEditNodeValueDialog_modes3 = ['', '', '', "Grup 1, Grup 2, Grup 3"];
        ...
        var agentConsoleMessages = ['', "S'està esperant que l'usuari concedeixi l'accés...", "Negat", "No s'ha pogut iniciar la sessió del terminal remot, {0} ({1})", "Temps mort", "S'han rebut dades de xarxa no vàlides"];
        ...
        function updateDeskShortcutKeys() {
            var x = '<div class="menuButton" onclick="deskMenuButton(-1)">' + "Personalitza" + '</div>';
        ...
        var keyStrings = { 8: "Espai enrere", 9: "Tab", 13: "Entra", 27: "escapar", 32: "Espai", 44: "Imprimir pantalla", 45: "Insereix", 46: "Del", 36: "a casa", 35: "Final", 32: "Espai", 33: "Amunt pàgina", 34: "Avançar pagina", 37: "Esquerra", 38: "Amunt", 39: "Dret", 40: "Avall", 0: "Cap" }
        ...
        function sendSpecialKeys() {
            if (xxdialogMode || desktop == null || desktop.State != 3) return;
            setDialogMode(3, "Claus especials", 3, deskSendKeys);
        }
        ...
        function deskSelectScreens() {
            ...
            setDialogMode(2, "Selecció de pantalla", 3, deskSelectScreensEx, x);
        }
        ...
        function sshTunnelAuthDialog(j, func) {
            var x = '';
            if (j.askkeypass) {
                x += addHtmlValue("Autenticació", '<select id=dp2authmethod style=width:150px onchange=sshAuthUpdate(event)><option value=3 selected>' + "Clau emmagatzemada" + '</option><option value=1>' + "Usuari contrasenya" + '</option><option value=2>' + "Nom d'usuari i clau" + '</option></select>');
            } else {
                x += addHtmlValue("Autenticació", '<select id=dp2authmethod style=width:150px onchange=sshAuthUpdate(event)><option value=1 selected>' + "Usuari contrasenya" + '</option><option value=2>' + "Nom d'usuari i clau" + '</option></select>');
            }
            x += '<div id=d2userauth style=display:none>';
            x += addHtmlValue("Nom d'usuari", '<input id=dp2user style=width:150px maxlength=64 autocomplete=off onkeyup=sshAuthUpdate(event) />');
            x += '</div>';
            x += '<div id=d2passauth style=display:none>';
            x += addHtmlValue("Contrasenya", '<input type=password id=dp2pass style=width:150px maxlength=64 autocomplete=off onkeyup=sshAuthUpdate(event) />');
            if ((features2 & 0x00400000) == 0) { x += '<label><input id=dp2keep type=checkbox>' + "Recordeu les credencials" + '</label>'; }
            x += '</div><div id=d2keyauth style=display:none>';
            x += addHtmlValue("Fitxer de claus", '<input type=file id=dp2key style=width:150px maxlength=64 autocomplete=off onchange=sshAuthUpdate(event) />' + '<div id=d2badkey style=font-size:x-small>' + "El fitxer de clau ha d'estar en format OpenSSH." + '</div>');
            x += addHtmlValue("Contrasenya clau", '<input type=password id=dp2keypass style=width:150px maxlength=64 autocomplete=off onkeyup=sshAuthUpdate(event) />');
            if ((features2 & 0x00400000) == 0) {
                x += '<label><input id=dp2keep1 type=checkbox onchange=sshAuthUpdate(event)>' + "Recorda l'usuari i la clau" + '</label><br/>';
                x += '<label><input id=dp2keep2 type=checkbox>' + "Recordar contrasenya" + '</label>';
            }
            x += '</div>';
            if (j.askkeypass) {
                x += '<div id=d2keyauth2 style=display:none>';
                x += addHtmlValue("Contrasenya", '<input type=password id=dp2keypass2 style=width:150px maxlength=64 autocomplete=off onkeyup=sshAuthUpdate(event) />');
                x += '</div>';
            }
        ...
        */
        ...
        function p13updateFiles(checkedNames) {
            var html1 = '', html2 = '', displayPath = '<a style=cursor:pointer;color:black onclick=p13folderup(0)>' + "Arrel" + '</a>', fullPath = 'Root';
        ...
        function p13setActions() {
            ...
            if (p13filetree == null) {
                ...
                Q('p13SelectAllButton').value = "Tots";
                ...
                Q('p13SelectAllButton').value = (cc > 0 ? "Cap" : "Tots");
        ...
        function p13downloadfile(x, y, z) {
            ...
            setDialogMode(2, "Descarrega l'arxiu", 10, p13downloadFileCancel, '<div>' + EscapeHtml(downloadFile.file) + '</div><br /><progress id=d2progressBar style=width:100% value=0 max=' + z + ' />');
        }
        ...
        */
        ...
        function updateDeviceDetails(node, hardware, network) {
            ...
            if (hardware.windows && hardware.windows.osinfo && hardware.windows.osinfo.Description) { x += addDetailItem("Descripció", EscapeHtml(hardware.windows.osinfo.Description), s); }
            ...
            if (hardware.windows && hardware.windows.osinfo) {
                ...
                if(m.Domain){ x += addDetailItem((m.PartOfDomain ? "Domini" : "Grup de treball"), EscapeHtml(m.Domain), s); }
            }
            ...
            if (node.wsc) {
                ...
                x += addDetailItem("Seguretat de Windows", y.join(', '));
            }
            ...
            if(node.defender) {
                ...
                if (node.defender.AntivirusSignatureVersion != null) { y.push("Versió de signatura" + ' - <span style=color:green>' + EscapeHtml(node.defender.AntivirusSignatureVersion) + '</span>'); }
           ...
           if (node.users && node.users.length > 0) {
                var u = node.users.map(function(user) {
                    return addKeyLinkConditional(EscapeHtml(user), "Tancat", (node.lusers && node.lusers.indexOf(user) >= 0));
                }).join(', ');
                x += addDetailItem((node.users.length > 1 ? "Usuaris actius" : "Usuari actiu"), u);
            }

            if (x != '') { sections.push({ name: "Sistema operatiu", html: x, img: 'software' }); }
            ...
            if (node.agent) {
                ...
                if (node.firstconnect) { x += addDetailItem("Primera connexió d'agent", printDateTime(new Date(node.firstconnect))); }
                if ((node.conn & 1) != 0) {
                ...
                if (hardware.agentvers != null) {
                    if (hardware.agentvers.compileTime) {
                        try {
                            ...
                            x += addDetailItem("Temps de compilació", printDateTime(new Date(d)));
                        } catch (ex) { }
                    }
                }
                if (hardware.time != null) {
                    x += addDetailItem("Última actualització de detalls", printDateTime(new Date(hardware.time)));
                }
                if (x != '') { sections.push({ name: "Agent de malla", html: x, img: 'meshagent' }); }
            }
            ...
            if (hardware.mobile) {
                ...
                if (x != '') { sections.push({ name: "Dispositiu mòbil", html: x, img: 'mobile' }); }
            }
            ...
            if (network.netif2 != null) {
                ...
                for (var i in network.netif2) {
                    ...
                    if (typeof m[0].speed == 'number' && (m[0].speed != 9223372036854775807 && m[0].speed > 0)) {
                        x += addDetailItem("Velocitat de la interfície", format("{0}", getNetworkSpeed(m[0].speed)));
                    }
                ...
                x += '</table>';
                if (x != '') { sections.push({ name: "Treball en xarxa", html: x, img: 'networking' }); }
            }
            ...
            if (node.intelamt != null) {
                ...
                x += addDetailItem("Identificador", (node.intelamt.uuid) ? (EscapeHtml(node.intelamt.uuid)) : ('<i>' + "Desconegut" + '</i>'), s);
                var provisioningStates = { 0: nobreak("No activat (previ)"), 1: nobreak("No activat (Entrada)"), 2: nobreak("Activat") };
                ...
                if (x != '') {
                    if ((typeof node.intelamt.sku == 'number') && ((node.intelamt.sku & 16) != 0)) {
                        sections.push({ name: "Gestió estàndard d'Intel&reg; (Intel&reg; SM)", html: x, img: 'amt' });
                    } else {
                        sections.push({ name: "Tecnologia de gestió activa Intel&reg; (Intel&reg; AMT)", html: x, img: 'amt' });
                    }
                }
            }
            ...
            if (hardware.identifiers) {
                ...
                if (x != '') { sections.push({ name: "Placa base", html: x, img: 'motherboard' }); }
            }
            ...
            if (hardware.tpm) {
                ...
                if (tpm.ManufacturerVersion) { x += addDetailItem("Versió", EscapeHtml(tpm.ManufacturerVersion), s); }
                if (tpm.IsActivated != null) { x += addDetailItem("Activat", (tpm.IsActivated ? "Sí" : "No"), s); }
                if (tpm.IsEnabled != null) { x += addDetailItem("Habilitat", (tpm.IsEnabled ? "Sí" : "No"), s); }
                if (tpm.IsOwned != null) { x += addDetailItem("Owned", (tpm.IsOwned ? "Sí" : "No"), s); }
            ...
            if (hardware.battery) {
                ...
                for (var i in hardware.battery) {
                    ...
                    x += '<tr><td><div class=style10 style=border-radius:5px;padding:8px>';
                    x += '<div style=margin-bottom:3px><b>' + EscapeHtml(battery.DeviceName ? battery.DeviceName : "Desconegut") + '</b></div>';
                    ...
                    if (battery.EstimatedRuntime) { x += addDetailItem("Estimated Runtime", format("{0} minuts", Math.floor((battery.EstimatedRuntime / 60))), s); }
                    ...
                    if (battery.Charging != null) { x += addDetailItem("Charging", (battery.Charging ? "Sí" : "No"), s); }
                    if (battery.DischargeRate) { x += addDetailItem("Discharge Rate", format("{0} mW", battery.DischargeRate), s); }
                    if (battery.Discharging != null) { x += addDetailItem("Discharging", (battery.Discharging ? "Sí" : "No"), s); }
                    ...
                    if (battery.Health) { x += addDetailItem("Salut", format("{0} %", battery.Health), s); }
                    if (battery.BatteryCharge) { x += addDetailItem("Carrega de la bateria", format("{0} %", battery.BatteryCharge), s); }   
                    x += '</div>';
                }
                x += '</table>';
            ...
            if (hardware.windows) {
                if (hardware.windows.memory && (hardware.windows.memory.length > 0)) {
                    ...
                    if (x != '') { sections.push({ name: "Memòria", html: x, img: 'ram' }); }
                }
            }
            ...
            if (hardware.identifiers && ident.storage_devices) {
                ...
                for (var i in ident.storage_devices) {
                    ...
                    if (m.Size) {
                        ...
                        if(hardware.windows && hardware.windows.drives && m.Model){
                            ...
                            if(foundObject) x += addDetailItem("Estat", EscapeHtml(foundObject.Status), s);
                        }
                        x += '</div>';
                    }
                }
                ...
                if (x != '') { sections.push({ name: "Emmagatzematge", html: x, img: 'storage' }); }
            }
            ...
            if (hardware.windows && hardware.windows.volumes) {
                ...
                if (x != '') { sections.push({ name: "Volums d'emmagatzematge", html: '<table style=width:100%>' + x + '</table>', img: 'storage'}); }
            }
            ...
            if (x == '') {
                QH('p10detailshtml', "No hi ha informació per a aquest dispositiu.");
            } else {
                QH('p10detailshtml', x);
            }
        }
        ...
        */
        ...
        function p15uploadCore(e) {
            ...
            if (e.shiftKey == true) { meshserver.send({ action: 'uploadagentcore', nodeid: consoleNode._id, type: 'default' }); } // Upload default core
                ...
                var htmlValue = '<select id=d3coreMode style=width:230px>' +
                    '<option value=1>' + "Carregueu el nucli del servidor predeterminat" + '</option>' +
                    '<option value=2>' + "Netegeu el nucli" + '</option>' +
                    '<option value=3>' + "Carregueu un fitxer bàsic" + '</option>' +
                    '<option value=4>' + "Agent de desconnexió suau" + '</option>' +
                    '<option value=5>' + "Agent de desconnexió dura" + '</option>' +
                    '<option value=6>' + "Carregueu el nucli de recuperació" + '</option>' +
                    '<option value=7>' + "Carregueu un nucli petit" + '</option>' +
                    '<option value=8>' + "Restart agent service" + '</option>' +
                    '<option value=9>' + "Força l'actualització de l'agent" + '</option></select>';
                setDialogMode(2, "Realitza l'acció de l'agent", 3, p15uploadCoreEx, addHtmlValue("Acció", htmlValue));
            }
        }
        ...
        function p15uploadCore2() {
            ...
            Q('d3auth').value = authCookie;
            Q('d3attrib').value = currentNode._id;
            setDialogMode(4, "Carregueu Mesh Agent Core", 3, p15uploadCoreEx2);
            d3init();
        }
        ...
        function p20updateMesh() {
            ...
            if (currentMeshLinks && ((currentMeshLinks.rights & 2) != 0)) { x += '<div style=margin-bottom:6px;float:left;margin-right:10px><a onclick=p20showAddMeshUserDialog() style=cursor:pointer><img src=images/icon-addnew.png border=0 height=12 width=12> ' + "Afegeix usuari" + '</a></div>'; }

            if (navigator.userAgent.toLowerCase().indexOf('android') >= 0) {
                x += '<div style=margin-bottom:6px;float:left;margin-right:10px><a onclick=p20installAndroidDialog() style=cursor:pointer><img src=images/icon-addnew.png border=0 height=12 width=12> ' + "Instal·leu en aquest dispositiu" + '</a></div>';
            }
            ...
            */
            ...
            for (var i in sortedusers) {
                var trash = '', rights = "Drets Parcials", r = sortedusers[i].rights, icon = 2;
                if (r == 0xFFFFFFFF) rights = "Administrador total"; else if (r == 0) rights = "Sense Drets";
            ...
            if (meshrights == 0xFFFFFFFF) { x += '<div style=font-size:small;text-align:right;margin-top:6px><span><a onclick=p20showDeleteMeshDialog() style=cursor:pointer>' + "Suprimeix el grup" + '</a></span></div>'; }
        ...
        function p20editmeshrelay() {
            ...
            if (relayDevices.length == 0) {
                ...
                var x = addHtmlValue("Dispositiu de relé", '<div style=width:170px><select id=d2devrelay style=width:100%>' + relayDevices2.join('') + '</select></div>');
        ...
        function p20editmesh(focus) {
            ...
            x += addHtmlValue("Descripció", '<input id=dp20meshdesc style=width:170px maxlength=1024 onkeyup=p20editmeshValidate() />');
        ...
        function p20installAndroidDialog() {
            if (xxdialogMode) return;
            var x = '<div style=text-align:center><p>' + "Instal·leu l'agent MeshCentral al vostre dispositiu Android. Un cop instal·lat, feu clic a l'enllaç de vinculació per connectar el vostre dispositiu a aquest servidor." + '</p>';
            ...
            x += '<p><a rel=\"noreferrer noopener\" target=_blank href="meshagents?id=14' + (urlargs.key?('&key=' + urlargs.key):'') + '" title="' + "Versió APK de MeshAgent" + '">' + "APK d'Android" + '</a></p>';
            x += '<p><a href="' + serverinfo.magenturl + ',' + serverinfo.agentCertHash + ',' + currentMesh._id.split('/')[2] + '"><b>' + "Enllaç de vinculació del dispositiu" + '</b></a></p></div>';
            setDialogMode(2, "Instal·lació d'Android", 1, null, x);
        }
        ...
        function p20showAddMeshUserDialog() {
            ...
            x += '<label><input type=checkbox onchange=p20validateAddMeshUserDialog() id=p20remotecontrol>' + "Control remot" + '</label><br>';
            ...
            x += '<label><input type=checkbox onchange=p20validateAddMeshUserDialog() id=p20uninstall>' + "Desinstal·leu l'agent" + '</label><br>';
            ...
            x += '</div>';
            setDialogMode(2, "Afegeix usuari al grup de dispositius", 3, p20showAddMeshUserDialogEx, x);
        ...
        function p20viewuser(userid) {
            ...
            if (meshrights == 0xFFFFFFFF) r.push("Administrador total"); else {
                ...
                if ((meshrights & 256) != 0) r.push("Només visualització remota");
                if ((meshrights & 512) != 0) r.push("Sense terminal");
                if ((meshrights & 1024) != 0) r.push("No hi ha fitxers");
            ...
            var x = addHtmlValue("Nom d'usuari", EscapeHtml(uname));
            if (uname != userid.split('/')[2]) { x += addHtmlValue("ID d'usuari", EscapeHtml(userid.split('/')[2])); }
            ...
            setDialogMode(2, "Usuari del grup de dispositius", buttons, p20viewuserEx, x, userid);
        }
        ...
        function p20viewuserEx(button, userid) {
            ...
            setDialogMode(2, "Usuari de malla remot", 3, p20viewuserEx2, format("Confirmeu l'eliminació de l'usuari {0}?", uname), userid);
        }
