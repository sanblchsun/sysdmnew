<!DOCTYPE html><html lang="hu" dir="ltr" xmlns="http://www.w3.org/1999/xhtml"><head>
    <meta charset="utf-8">
    ...
    <div id="container">
        ...
        <div id="masthead" style="background:url(logo.png) 0px 0px;background-size:341px 50px;background-color:#036;background-repeat:no-repeat;height:50px;width:100%;overflow:hidden">
            ...
            <div id="notificationCount" onclick="clickNotificationIcon()" class="unselectable" style="position:absolute;right:50px;top:0px;font-size:28px;width:50px;height:50px;cursor:pointer;display:none" title="Kattintson az aktuális értesítések megtekintéséhez"><div id="notificationCount2" style="padding-top:8px">0</div></div>
            ...
            <div id="column_l" style="width:100%;padding:0;position:absolute;bottom:0px;top:0px">
                <div id="p0" style="display:none;width:100%;height:100%">
                    <div style="display:flex;align-items:center;width:100%;height:100%">
                        <div id="p0message" style="text-align:center;width:100%"><span id="p0span">A kiszolgáló megszakította a kapcsolatot</span>, <href onclick="reload()" style="cursor:pointer"><u>kattintson az újracsatlakozáshoz</u></href>.</div>
                    </div>
                </div>
                ...
                <div id="p2" style="display:none;position:absolute;top:0;left:0;right:0;bottom:0">
                    ...
                    <div id="xdevicesBar" style="position:absolute;overflow-y:auto;height:34px;left:0;right:0;bottom:0px;background-color:#aaa;color:black">
                        <div style="margin:4px">
                            ...
                            <input id="SearchInput" autocomplete="off" type="search" placeholder="Szűrő" onchange="onDeviceSearchChanged(event)" onclick="onDeviceSearchChanged(event)" onkeyup="onDeviceSearchChanged(event)" style="padding:2px;margin:0;height:20px;background-color:#FFF">&nbsp;
                            <label class="noselect"><input type="checkbox" id="RealNameCheckBox" onclick="onRealNameCheckBox()">Os név</label>
                        ...
                        <div style="margin-left:8px">
                            <div id="p3AccountActions">
                                <div id="p2AccountSecurity" style="display:none">
                                    <p><strong>Fiók biztonság</strong></p>
                                    <div style="margin-left:9px;margin-bottom:8px">
                                        <div id="managePhoneNumber1" style="margin-top:5px;display:none"><a onclick="account_managePhone()" style="cursor:pointer">Telefonszám kezelése</a> <span id="authPhoneNumberCheck"><strong>✓</strong></span></div>
                                        <div id="manageEmail2FA" style="margin-top:5px;display:none"><a onclick="account_manageAuthEmail()" style="cursor:pointer">E-mail hitelesítés kezelése</a> <span id="authEmailSetupCheck"><strong>✓</strong></span></div>
                                        <div style="margin-top:5px"><a href="#" onclick="account_showLocalizationSettings()">Nyelvi és területi beállítások</a></div>
                                        <div id="manageAuthApp" style="margin-top:5px;display:none"><a onclick="account_manageAuthApp()" style="cursor:pointer">Hitelesítő alkalmazás kezelése</a> <span id="authAppSetupCheck"><strong>✓</strong></span></div>
                                        <div id="manageOtp" style="margin-top:5px;display:none"><a onclick="account_manageOtp(0)" style="cursor:pointer">Biztonsági kódok kezelése</a> <span id="authCodesSetupCheck"><strong>✓</strong></span></div>
                                    </div>
                                </div>
                                <div id="p2AccountActions" style="display:none">
                                    <p><strong>Fiók műveletek</strong></p>
                                    <div style="margin-left:9px;margin-bottom:8px">
                                        <div style="margin-top:5px"><span id="viewPreviousLogins"><a onclick="return account_viewPreviousLogins()" style="cursor:pointer">Korábbi bejelentkezések megtekintése</a></span></div>
                                        <div style="margin-top:5px"><span id="managePhoneNumber2" style="display:none"><a onclick="account_managePhone()" style="cursor:pointer">Telefonszám kezelése</a></span></div>
                                        <div style="margin-top:5px"><span id="verifyEmailId" style="display:none"><a onclick="account_showVerifyEmail()" style="cursor:pointer">E-mail megerősítés</a></span></div>
                                        <span id="p2AccountPassActions">
                                            <div style="margin-top:5px"><span id="changeEmailId" style="display:none"><a onclick="account_showChangeEmail()" style="cursor:pointer">E-mail cím módosítása</a></span></div>
                                            <div style="margin-top:5px"><a onclick="account_showChangePassword()" style="cursor:pointer">Jelszó módosítása</a><span id="p2nextPasswordUpdateTime"></span></div>
                                            <div style="margin-top:5px"><a onclick="account_showDeleteAccount()" style="cursor:pointer">Fiók törlése</a></div>
                                        </span>
                                        <div style="margin-top:5px" id="setDarkModeLink"><a onclick="toggleNightMode()" style="cursor:pointer">Sötét mód beállítása</a></div>
                                        <div style="margin-top:5px"><a onclick="showNotes(false)" style="cursor:pointer">Személyes jegyzetek</a></div>
                                    </div>
                                <br style="clear:both">
                                </div>
                            </div>
                            <strong>Eszköz csoportok</strong>
                            <span id="p3createMeshLink1">( <a onclick="account_createMesh()" style="cursor:pointer"><img src="images/icon-addnew.png" width="12" height="12" border="0"> Új</a> )</span>
                            <br><br>
                            <div id="p3meshes"></div>
                            <div id="p3noMeshFound" style="margin-left:9px;display:none">Nincsenek eszközcsoportok.<span id="p3createMeshLink2"> <a onclick="account_createMesh()" style="cursor:pointer"><strong>Kezdje el itt!</strong></a></span></div>
                            <br style="clear:both">
                        </div>
                    </div>
                </div>
                <div id="p5" style="display:none">
                    <table cellspacing="0" style="margin:0;padding:0;border-spacing:0;border:0;">
                        <tbody><tr style="padding:0">
                            ...
                            <td>
                                <div style="margin-left:5px">
                                    <strong style="font-size:large">Fájlok</strong><br>
                                </div>
                            </td>
                        </tr>
                    </tbody></table>
                            ...
                            <tbody><tr>
                                <td style="width:100%;background-color:#d3d9d6;text-align:left;padding:4px" valign="bottom">
                                    <div style="width:100%;text-align:center">
                                        <input type="button" style="width:calc(100%/5 - 5px)" id="p5FolderUp" disabled="disabled" onclick="p5folderup()" value="Fel">
                                        <input type="button" style="width:calc(100%/5 - 5px)" id="p5SelectAllButton" disabled="disabled" onclick="p5selectallfile()" value="Mindet kiválaszt" onkeypress="return false" onkeydown="return false">
                                        <input type="button" style="width:calc(100%/5 - 5px)" id="p5RenameFileButton" disabled="disabled" value="Átnevezés" onclick="p5renamefile()" onkeypress="return false" onkeydown="return false">
                                        <input type="button" style="width:calc(100%/5 - 5px)" id="p5DeleteFileButton" disabled="disabled" value="Törlés" onclick="p5deletefile()" onkeypress="return false" onkeydown="return false">
                                        <input type="button" style="width:calc(100%/5 - 5px)" id="p5NewFolderButton" disabled="disabled" value="Mappa" onclick="p5createfolder()" onkeypress="return false" onkeydown="return false">
                                    </div>
                                    <div style="width:100%;text-align:center">
                                        <input type="button" style="width:calc(100%/5 - 5px)" id="p5UploadButton" disabled="disabled" value="Feltöltés" onclick="p5uploadFile()" onkeypress="return false" onkeydown="return false">
                                        <input type="button" style="width:calc(100%/5 - 5px)" id="p5CutButton" disabled="disabled" value="Kivágás" onclick="p5copyFile(1)" onkeypress="return false" onkeydown="return false">
                                        <input type="button" style="width:calc(100%/5 - 5px)" id="p5CopyButton" disabled="disabled" value="Másolás" onclick="p5copyFile(0)" onkeypress="return false" onkeydown="return false">
                                        <input type="button" style="width:calc(100%/5 - 5px)" id="p5PasteButton" disabled="disabled" value="Beillesztés" onclick="p5pasteFile()" onkeypress="return false" onkeydown="return false">
                                        <input type="button" style="width:calc(100%/5 - 5px)" id="p5RefreshButton" value="Frissít" onclick="p5refreshFiles()" onkeypress="return false" onkeydown="return false">
                                    </div>
                                </td>
                            </tr>
                            <tr>
                                        ...
                                        <tbody><tr>
                                            ...
                                            <td style="text-align:right;padding-right:4px">
                                                <select id="p5sortdropdown" onchange="updateFiles()">
                                                    <option value="1" selected="selected">Rendezés név szerint</option>
                                                    <option value="2">Rendezés méret szerint</option>
                                                    <option value="3">Rendezés dátum szerint</option>
                                                    <option value="4">Rendezés név szerint csökkenő sorrendben</option>
                                                    <option value="5">Rendezés méret szerint csökkenő sorrendben</option>
                                                    <option value="6">Rendezés dátum szerint csökkenő sorrendben</option>
                                                </select>
                                            </td>
                                        </tr>
                                    </tbody></table>
                ...
                <div id="p10" style="display:none;position:absolute;bottom:0;top:0;width:100%;overflow:hidden">
                    ...
                    <div id="p10dialog" style="z-index:1000;background-color:#EEE;box-shadow:0px 0px 15px #666;font-family:Arial,Helvetica,sans-serif;border-radius:5px;position:fixed;top:30px;width:300px;left:30px;display:none">
                        <div style="width:100%;background-color:#003366;color:#FFF;border-radius:5px 5px 0 0">
                            <div style="padding:5px">Billentyű parancsok testreszabása</div>
                    ...
                    <div id="p10desktop" style="overflow:hidden;position:absolute;top:55px;bottom:0px;width:100%;display:none">
                        <div id="deskarea1" style="position:absolute;top:0px;width:100%;height:32px">
                            <div style="padding-top:2px;padding-bottom:2px;background:#C0C0C0;height:32px">
                                <div style="float:right;text-align:right">
                                    ...
                                    <input type="button" id="deskFullScreen" value="Teljes képernyő" onclick="deskToggleFull(event)" onkeypress="return false" onkeydown="return false" disabled="disabled" style="height:28px;margin-right:3px;">
                                </div>
                                <div style="margin-left:3px">
                                    <input type="button" id="connectbutton1" value="Kapcsolódás" onclick="connectDesktop(event,3)" onkeypress="return false" onkeydown="return false" disabled="disabled" style="height:28px">
                                    <input type="button" id="connectbutton1h" value="HW Kapcsolat" onclick="connectDesktop(event,2)" onkeypress="return false" onkeydown="return false" disabled="disabled" style="height:28px">
                                    <input type="button" id="disconnectbutton1" value="Lekapcsolódás" onclick="connectDesktop(event,0)" onkeypress="return false" onkeydown="return false" style="height:28px">
                                    <span id="deskstatus" style="color:black">Lecsatlakozott</span>
                                </div>
                            </div>
                        </div>
                        ...
                        <div id="deskarea4" style="position:absolute;bottom:0px;width:100%;height:32px">
                            <div style="padding-top:2px;padding-bottom:2px;background:#C0C0C0">
                                ...
                                <div>
                                    <input id="deskActionsBtn" type="button" style="margin-left:3px;height:28px" onkeypress="return false" onkeydown="return false" value="Tevékenységek" onclick="deviceActionFunction()">
                                    <input type="button" value="Beállítások" onkeypress="return false" onkeydown="return false" onclick="showDesktopSettings()" style="height:28px">
                                    <input type="button" onkeypress="return false" onkeydown="return false" value="Tápellátás tevékenység..." onclick="showPowerActionDlg()" style="display:none;height:28px">
                                    ...
                                    <input type="button" id="DeskScreens" value="Képernyők" onkeypress="return false" onkeydown="return false" onclick="deskSelectScreens()" style="display:none;height:28px">
                                    <label><span id="DeskControlSpan" style="display:none"><input id="DeskControl" type="checkbox" onkeypress="return false" onkeydown="return false">Bevitel</span></label>
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div id="termTable" style="position:absolute;top:0;bottom:0;left:0;right:0">
                            <div id="termarea1">
                                <div class="areaHead" style="line-height:24px">
                                    <div class="toright2">
                                        <input type="button" id="termFullScreen" value="Teljes képernyő" onclick="deskToggleFull(event)" onkeypress="return false" onkeydown="return false" disabled="disabled" style="height:28px;margin-right:3px;">
                                        <div id="terminalCustomUpperRight" style="float:left;margin-right:6px"></div>
                                    </div>
                                    <div>
                                        <span id="connectbutton2span" style="margin-left:3px"><input type="button" id="connectbutton2" value="Kapcsolódás" style="height:28px" onclick="connectTerminal(event,1)" onkeypress="return false" onkeydown="return false" disabled="disabled"></span>
                                        <span id="connectbutton2sspan" style="margin-right:4px"><input type="button" id="connectbutton2s" value="SSH Kapcsolat" style="height:28px" onclick="connectTerminal(event,3)" onkeypress="return false" onkeydown="return false" disabled="disabled"></span>
                                        <span id="disconnectbutton2span" style="margin-left:3px"><input type="button" id="disconnectbutton2" value="Lekapcsolódás" style="height:28px" onclick="connectTerminal(event,0)" onkeypress="return false" onkeydown="return false"></span>
                                        <span id="termstatus" style="line-height:22px">Lecsatlakozott</span><span id="termtitle"></span>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div id="termarea4" style="position:relative;height:32px;">
                                <div class="areaFoot">
                                    ...
                                    <div style="height:28px">
                                        <input id="termActionsBtn" style="margin-left:3px;height:28px" type="button" title="Tápellátással kapcsolatos műveleteket végzése az eszközön" onkeypress="return false" onkeydown="return false" value="Tevékenységek" onclick="deviceActionFunction()">
                        ...
                        <table id="p13toolbar" style="width:100%;height:111px" cellpadding="0" cellspacing="0">
                            <tbody><tr>
                                <td style="background-color:#C0C0C0;border-bottom:2px solid black;padding:2px;line-height:24px">
                                    <div style="float:right;text-align:right">
                                        <input id="filesActionsBtn" type="button" onkeypress="return false" onkeydown="return false" value="Tevékenységek" onclick="deviceActionFunction()" style="margin-right:2px">
                                    ...
                                    <div style="margin-left:2px">
                                        ...
                                        <input id="p13Connect" value="Kapcsolódás" onclick="connectFiles(event,1)" onkeypress="return false" onkeydown="return false" type="button">
                                        <input id="p13Connects" value="SFTP Kapcsolat" onclick="connectFiles(event,2)" onkeypress="return false" onkeydown="return false" type="button">
                                        <input id="p13Disconnect" value="Lekapcsolódás" onclick="connectFiles(event)" onkeypress="return false" onkeydown="return false" type="button">
                                        <span class="textOverGray" id="p13Status">Lecsatlakozott</span>
                                    </div>
                                </td>
                            </tr>
                            <tr>
                                <td style="width:100%;background-color:#d3d9d6;text-align:left;padding:4px" valign="bottom">
                                    <div style="width:100%;text-align:center">
                                        <input type="button" style="width:calc(100%/5 - 5px)" id="p13FolderUp" disabled="disabled" onclick="p13folderup()" value="Fel">
                                        <input type="button" style="width:calc(100%/5 - 5px)" id="p13SelectAllButton" disabled="disabled" onclick="p13selectallfile()" value="Mindet kiválaszt" onkeypress="return false" onkeydown="return false">
                                        <input type="button" style="width:calc(100%/5 - 5px)" id="p13RenameFileButton" disabled="disabled" value="Átnevezés" onclick="p13renamefile()" onkeypress="return false" onkeydown="return false">
                                        <input type="button" style="width:calc(100%/5 - 5px)" id="p13DeleteFileButton" disabled="disabled" value="Törlés" onclick="p13deletefile()" onkeypress="return false" onkeydown="return false">
                                        <input type="button" style="width:calc(100%/5 - 5px)" id="p13NewFolderButton" disabled="disabled" value="Mappa" onclick="p13createfolder()" onkeypress="return false" onkeydown="return false">
                                    </div>
                                    <div style="width:100%;text-align:center">
                                        <input type="button" style="width:calc(100%/5 - 5px)" id="p13UploadButton" disabled="disabled" value="Feltöltés" onclick="p13uploadFile()" onkeypress="return false" onkeydown="return false">
                                        <input type="button" style="width:calc(100%/5 - 5px)" id="p13CutButton" disabled="disabled" value="Kivágás" onclick="p13copyFile(1)" onkeypress="return false" onkeydown="return false">
                                        <input type="button" style="width:calc(100%/5 - 5px)" id="p13CopyButton" disabled="disabled" value="Másolás" onclick="p13copyFile(0)" onkeypress="return false" onkeydown="return false">
                                        <input type="button" style="width:calc(100%/5 - 5px)" id="p13PasteButton" disabled="disabled" value="Beillesztés" onclick="p13pasteFile()" onkeypress="return false" onkeydown="return false">
                                        <input type="button" style="width:calc(100%/5 - 5px)" id="p13RefreshButton" disabled="disabled" value="Frissít" onclick="p13folderup(9999)" onkeypress="return false" onkeydown="return false">
                                    </div>
                                </td>
                            </tr>
                            <tr>
                            ...
                            <tbody><tr style="height:28px">
                                <td class="areaHead">
                                    <div class="toright2">
                                        ...
                                        <input type="button" id="p15uploadCore" value="Agent műveletek" onclick="p15uploadCore(event)">
                                    </div>
                                ...
                                <td class="areaFoot">
                                    <table style="width:100%">
                                        <tbody><tr>
                                            ...
                                            <td style="width:1%"><input id="id_p15consoleClear" type="button" class="bottombutton" value="Törlés" onclick="p15consoleClear()"></td>
                                        </tr>
                                    </tbody></table>
                                </td>
                            </tr>
    ...
    <div id="dialog" style="display:none">
        ...
        <div style="margin-right:16px;margin-left:8px">
            ...
            <div id="dialog3" style="margin:auto;margin:3px">
                <select id="deskkeys" style="width:100%">
                    ...
                    <option value="0">Win+Le</option>
                    <option value="1">Win+Fel</option>
            ...
            <div id="dialog4" style="margin:auto;margin:3px">
                <div id="d3upload">
                    <div>Fájl Kiválasztás</div>
                    <select id="d3uploadMode" onchange="d3modechange()">
                        <option value="1">Helyi fájl feltöltése</option>
                        <option value="2">Kiszolgáló fájl kiválasztás</option>
                    </select>
                </div>
                ...
                <div id="d3servermode">
                    <div id="d3serveraction" valign="bottom">
                        <input type="button" id="p3FolderUp" disabled="disabled" onclick="d3folderup()" value="Fel">&nbsp;<span id="p3CurrentFolder"></span>
                    </div>
            ...
            <div id="dialog7" style="margin:auto;margin:3px">
                <div id="d7meshkvm">
                    <h4 style="width:100%;border-bottom:1px solid gray">Agent Távoli Asztal</h4>
                    <table style="width:100%">
                        <tbody><tr>
                            <td>
                                Minőség
                        ...
                        <tr>
                            ...
                            <td style="width:100px">
                                <select id="d7framelimiter" style="float:right;width:200px" dir="rtl">
                                    <option selected="selected" value="50">Gyors</option>
                                    <option value="100">Közepes</option>
                                    <option value="400">Lassú</option>
                                    <option value="1000">Nagyon lassú</option>
                                </select>
                            </td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                            <td></td>
                            <td>
                                <label style="display:block" id="d7deskAutoLockLabel"><input type="checkbox" id="d7deskAutoLock">Zárolás a kapcsolat bontásakor</label>
                            </td>
                        </tr>
                    </tbody></table>
                </div>
                        ...
                        <tbody><tr>
                            ...
                            <td style="width:100px">
                                <select id="d7desktopmode" style="float:right;width:200px">
                                    <option value="1">RLE8, Leggyorsabb</option>
                                    <option value="2">RLE16, Ajánlott</option>
                                    <option value="3">RAW8, Lassú</option>
                                    <option value="4">RAW16, nagyon lassú</option>
                                </select>
                            </td>
                        </tr>
                    </tbody></table>
        ...
        <div id="idx_dlgButtonBar" style="padding:10px;margin-bottom:20px">
            <input id="idx_dlgCancelButton" type="button" value="Mégse" style="float:right;width:80px;margin-left:5px" onclick="dialogclose(0)">
            <input id="idx_dlgOkButton" type="button" value="OK" style="float:right;width:80px" onclick="dialogclose(1)">
            <div><input id="idx_dlgDeleteButton" type="button" value="Törlés" style="display:none" onclick="dialogclose(2)"></div>
        </div>
    </div>
    <div id="topMenu" style="z-index:1000;background-color:#EEE;box-shadow:0px 0px 15px #666;font-family:Arial,Helvetica,sans-serif;border-radius:0px 0px 5px 5px;position:fixed;top:50px;right:5px;width:170px;display:none">
        <div style="padding:12px;border-top:1px solid gray;color:black;cursor:pointer" onclick="topMenu(2)">Fájlok</div>
        <div style="padding:12px;border-top:1px solid gray;color:black;cursor:pointer" onclick="topMenu(1)">Fiókom</div>
        <div id="logoutMenuOption"><a id="logoutMenuOptionRef" href="/logout"><div style="padding:12px;border-top:1px solid gray;color:black;cursor:pointer">Kijelentkezés</div></a></div>
    </div>
    ...
    <script>
        ...
        var StatusStrs = ["Lecsatlakozott", "Csatlakozás...", "Beállít...", "Csatlakozott", "Intel&reg; AMT csatlakoztatva"];
        var agentsStr = ["Ismeretlen", "Windows 32bit konzol", "Windows 64bit konzol", "Windows 32bit szolgáltatás", "Windows 64bit szolgáltatás", "Linux 32bit", "Linux 64bit", "MIPS", "XENx86", "Android", "Linux ARM", "macOS x86-32bit", "Android x86", "PogoPlug ARM", "Android", "Linux Poky x86-32bit", "macOS x86-64bit", "ChromeOS", "Linux Poky x86-64bit", "Linux NoKVM x86-32bit", "Linux NoKVM x86-64bit", "Windows MinCore konzol", "Windows MinCore szolgáltatás", "NodeJS", "ARM-Linaro", "ARMv6l / ARMv7l", "ARMv8 64bit", "ARMv6l / ARMv7l / NoKVM", "MIPS24KC (OpenWRT)", "Apple Silicon", "FreeBSD x86-64", "Ismeretlen", "Linux ARM 64 bit (glibc/2.24 NOKVM)", "Alpine Linux x86 64 Bit (MUSL)", "Assistant (Windows)", "Armada370 - ARM32/HF (libc/2.26)", "OpenWRT x86-64", "OpenBSD x86-64", "Ismeretlen", "Ismeretlen", "MIPSEL24KC (OpenWRT)", "ARMADA/CORTEX-A53/MUSL (OpenWRT)", "Windows ARM 64bit console", "Windows ARM 64bit service", "ARMVIRT32 (OpenWRT)", "RISC-V x86-64"];
        var files;
        var terminal;
        ...
        function onStateChanged(server, state, prevState, errorCode) {
            if (state == 0) {
                ...
                if (errorCode == 'noauth') { QH('p0span', "Nem lehet hitelesítést végrehajtani"); return; }
                if (prevState == 2) { setTimeout(serverPoll, 5000); } else { QH('p0span', "Nem sikerült a web socket csatlakozás"); }
                // Clean up here
        ...
        function updateSelf() {
            ...
            if (typeof userinfo.passchange == 'number') {
                if (userinfo.passchange == -1) { QH('p2nextPasswordUpdateTime', " - Reset következő bejelentkezéskor."); }
                    ...
                    if (seconds < 0) { QH('p2nextPasswordUpdateTime', " - Reset következő bejelentkezéskor."); }
                    else if (seconds < 3600) { var secs = Math.floor(seconds / 60); QH('p2nextPasswordUpdateTime',format((secs == 1)?" - Reset 1 perc.":" - Reset {0} perc múlva.", secs)); }
                    else if (seconds < 86400) { var hours = Math.floor(seconds / 3600); QH('p2nextPasswordUpdateTime', format((hours == 1) ? " - Reset 1 óra múlva." : " - Reset {0} óra múlva.", hours)); }
                    else { var days = Math.floor(seconds / 86400); QH('p2nextPasswordUpdateTime', format((hours == 1) ? " - Reset 1 nap múlva." : " - Reset {0} nap múlva.", days)); }
                }
            }
        }
            ...
            switch (message.action) {
                case 'serverinfo': {
                    ...
                    if (serverinfo.certExpire != null) {
                        ...
                        if ((days >= 0) && (days < 20)) {
                            addNotification({ text: format("A tanúsítvány {0} napon belül lejár", days) });
                        }
                    }
                ...
                case 'otpauth-request': {
                    if ((xxdialogMode == 2) && (xxdialogTag == 'otpauth-request')) {
                        if (message.err != null) {
                            var otpauthErrors = ['', "2FA zárolva van", "A biztonsági kódok zároltak", "Bejelentkezési token használatban", "OTP 2FA nem engedélyezett", "Fiók zárolva", "Az OTPLIB betöltése nem lehetséges"];
                            if ((message.err > 0) && (message.err < otpauthErrors.length)) { QH('d2optinfo', otpauthErrors[message.err]); } else { QH('d2optinfo', format("Hiba #{0}", message.err)); }
                        } else {
                ...
                case 'otpauth-setup': {
                    ...
                    setDialogMode(2, "Hitelesítő alkalmazás", 1, null, message.success ? ('<b style=color:green>' + "Hitelesítő alkalmazás aktiválása sikeres." + '</b> ' + "Az újbóli bejelentkezéshez most már érvényes tokenre lesz szüksége.") : ('<b style=color:red>' + "A kétlépcsős bejelentkezés aktiválása nem sikerült." + '</b> ' + "Törölje ki a titkos kulcsot az alkalmazásból, és próbálja újra. Csak néhány perce van a megfelelő kód megadására."));
                    break;
                }
                case 'otpauth-clear': {
                    if (xxdialogMode) return;
                    setDialogMode(2, "Hitelesítő alkalmazás", 1, null, message.success ? ('<b>' + "Hitelesítő alkalmazás eltávolítva." + '</b> ' + "Ezt a funkciót bármikor újraaktiválhatja.") : ('<b style=color:red>' + "Nem sikerült eltávolítani a 2 faktoros hitelesítést." + '</b> ' + "Próbálja meg újra."));
                    break;
                }
                case 'otpauth-getpasswords': {
                    if (xxdialogMode) return;
                    var x = "Az egyszer használatos tokenek másodlagos hitelesítésként használhatók. Generáljon egy készletet, nyomtassa ki és tartsa biztonságos helyen.";
                    ...
                    if (message.passwords) {
                        ...
                        x += '<tr><td>' + "Nincsenek aktív tokenek";
                    }
                    x += '</table></div></div><br />';
                    x += '<div><input type=button value=\'' + "Bezár" + '\' onclick=setDialogMode(0) style=float:right></input>';
                    x += '<input type=button value=\'' + "Új Tokenek" + '\' onclick=\'account_manageOtp(1);\'></input>';
                    if (message.passwords != null) { x += '<input type=button value=\'' + "Törlés" + '\' onclick=\'account_manageOtp(2);\'></input>'; }
                    x += '</div><br />';
                    setDialogMode(2, "Biztonsági kódok kezelése", 8, null, x, 'otpauth-manage');
                    break;
                }
                case 'verifyPhone': {
                    ...
                    x += '<br /><br /><div style=width:100%;text-align:center>' + "Megerősítő kód:" + ' <input type=tel pattern="[0-9]" inputmode="number" maxlength=6 id=d2phoneCodeInput onKeyUp=account_managePhoneCodeValidate() onkeypress="if (event.key==\'Enter\') account_managePhoneCodeValidate(1)"></div></table>';
                    setDialogMode(2, "Telefon Értesítések", 3, account_managePhoneConfirm, x, message.cookie);
                    ...
                    if ((xxdialogMode == 2) && (xxdialogTag == 'previousLogins')) {
                        ...
                        if (message.events.length == 0) {
                            ...
                            for (var i in message.events) {
                                ...
                                if (m == 107) { m = "Érvényes bejelentkezés"; c = 'BBD1BB'; xx = ''; }
                                else if (m == 108) { m = "Érvénytelen 2FA azonosító"; c = 'DD9DC3'; xx = 'x'; }
                                else if (m == 109) { m = "Fiók zárolva"; c = 'E1BBBB'; xx = 'x'; }
                                else if (m == 110) { m = "Érvénytelen jelszó"; c = 'E1BBBB'; xx = 'x'; }
                        ...
                        setDialogMode(2, "Korábbi bejelentkezések", 1, null, x);
                    }
                    break;
                }
                case 'event': {
        ...
        function goStack() {
            ...
            if (idtype == 'files') {
                ...
                if ((features & 0x00040000) && !((userinfo.otpsecret == 1) || (userinfo.otphkeys > 0) || (userinfo.otpkeys > 0) || (userinfo.otpduo > 0) || (userinfo.otpdev > 0) || ((features & 0x00800000) && (userinfo.otpekey == 1)))) { setDialogMode(2, "Fiók biztonság", 1, null, "Unable to access this feature until two-factor authentication is enabled. This is required for extra security. Go to the \"My Account\" and look at the \"Account Security\" section."); return; }  
                go(5);
            }
        }
        ...
        function account_viewPreviousLogins() {
            if (xxdialogMode) return;
            setDialogMode(2, "Korábbi bejelentkezések", 1, null, "Betöltés...", 'previousLogins');
        ...
        function account_manageImage(mode) {
            ...
            setDialogMode(2, "A fiókhoz tartozó kép módosítása", 7, account_manageImageEx2, x, user._id);
        ...
        function toggleNightMode() {
            ...
            var x = '<input type=radio id=night0 name=nightmoderadio value=0 ' + ((cNightMode == 0) ? 'checked' : '') + '><label for=night0>' + "A böngésző alapértelmezett beállítása" + '</label><br>';
            x += '<input type=radio id=night2 name=nightmoderadio value=2 ' + ((cNightMode == 2) ? 'checked' : '') + '><label for=night2>' + "Világos mód" + '</label><br>';
            x += '<input type=radio id=night1 name=nightmoderadio value=1 ' + ((cNightMode == 1) ? 'checked' : '') + '><label for=night1>' + "Sötét mód" + '</label><br>';
            setDialogMode(2, "Éjszakai mód", 3, toggleNightModeEx, x);
            QV('uiMenu', false);
        }
        ...
        function account_managePhone() {
            ...
            if (userinfo.phone != null) {
                ...
                x += '<td style=text-align:center><div style=padding:6px>' + "Megerősített telefonszám " + '</div><div style=font-size:20px>' + userinfo.phone + '</div>';
                x += '<div style=margin:10px><label><input id=d2delPhone type=checkbox onclick=account_managePhoneRemoveValidate() />' + "Telefonszám eltávolítása" + '</label></div>';
                setDialogMode(2, "Telefon Értesítések", 3, account_managePhoneRemove, x);
                ...
                x += '<br /><br /><div style=width:100%;text-align:center>' + "Telefonszám:" + ' <input type=tel pattern="[0-9]" autocomplete="tel" inputmode="tel" maxlength=18 id=d2phoneinput onKeyUp=account_managePhoneValidate() onkeypress="if (event.key==\'Enter\') account_managePhoneValidate(1)"></div></table>';
                setDialogMode(2, "Telefon Értesítések", 3, account_managePhoneAdd, x, 'verifyPhone');
        ...
        function account_manageAuthEmail() {
            ...
            setDialogMode(2, "E-mail hitelesítés", 1, function () {
                if (emailU2Fenabled != Q('email2facheck').checked) { meshserver.send({ action: 'otpemail', enabled: Q('email2facheck').checked }); }
            }, "Ha engedélyezi, lehetőséget kap, hogy bejelentkezéskor a nagyobb biztonság érdekében 2 faktoros bejelentkezési jelszót kérjen az e-mail fiókjába." + '<br /><br /><label><input id=email2facheck type=checkbox ' + (emailU2Fenabled ? 'checked' : '') + '/>' + "Kétfaktoros e-mail hitelesítés engedélyezése." + '</label>');
        }

        var loclist = { 'af': "afrikai", 'sq': "albán", 'ar': "arab", 'ar-dz': "arab (Algéria)", 'ar-bh': "arab (Bahrein)", 'ar-eg': "arab (Egyiptom)", 'ar-iq': "arab (Irak)", 'ar-jo': "arab (Jordánia)", 'ar-kw': "arab (Kuvait)", 'ar-lb': "arab (Libanon)", 'ar-ly': "arab (Líbia)", 'ar-ma': "arab (Marokkó)", 'ar-om': "arab (Omán)", 'ar-qa': "arab (Katar)", 'ar-sa': "arab (Szaúd-Arábia)", 'ar-sy': "arab (Szíria)", 'ar-tn': "arab (Tunézia)", 'ar-ae': "arab (Egyesült Arab Emírségek)", 'ar-ye': "arab (Jemen)", 'an': "aragóniai", 'hy': "örmény", 'as': "asszámi", 'ast': "asztúriai", 'az': "azerbajdzsáni", 'eu': "baszk", 'bg': "bolgár", 'be': "fehérorosz", 'bn': "bengáli", 'bs': "bosznia", 'br': "breton", 'my': "burmai", 'ca': "katalán", 'ch': "chamorro", 'ce': "csecsen", 'zh': "kínai", 'zh-hk': "kínai (Hongkong)", 'zh-cn': "kínai (Kínai Népköztársaság)", 'zh-sg': "kínai (Szingapúr)", 'zh-tw': "kínai (Tajvan)", 'cv': "csuvas", 'co': "korzikai", 'cr': "cree", 'hr': "horvát", 'cs': "cseh", 'da': "dán", 'nl': "holland", 'nl-be': "holland (Belga)", 'en': "angol", 'en-au': "angol (Ausztrália)", 'en-bz': "angol (Belize)", 'en-ca': "angol (Kanada)", 'en-ie': "angol (Írország)", 'en-jm': "angol (Jamaika)", 'en-nz': "angol (Új-Zéland)", 'en-ph': "angol (Fülöp-szigetek)", 'en-za': "angol (Dél-Afrika)", 'en-tt': "angol (Trinidad és Tobago)", 'en-gb': "angol (Egyesült Királyság)", 'en-us': "angol (USA)", 'en-zw': "angol (Zimbabwe)", 'eo': "eszperantó", 'et': "észt", 'fo': "feröer-szigeteki", 'fa': "fárszi (perzsa)", 'fj': "fidzsi", 'fi': "finn", 'fr': "francia", 'fr-be': "francia (Belgium)", 'fr-ca': "francia (Kanada)", 'fr-fr': "francia (Franciaország)", 'fr-lu': "francia (Luxembourg)", 'fr-mc': "francia (Monaco)", 'fr-ch': "francia (Svájc)", 'fy': "fríz", 'fur': "friuli", 'gd': "gael (Skót)", 'gd-ie': "gael (Ír)", 'gl': "galíciai", 'ka': "grúz", 'de': "német", 'de-at': "német (Ausztria)", 'de-de': "német (Németország)", 'de-li': "német (Liechtenstein)", 'de-lu': "német (Luxemburg)", 'de-ch': "német (Svájc)", 'el': "görög", 'gu': "gudzsaráti", 'ht': "haiti-szigeteki", 'he': "héber", 'hi': "hindi", 'hu': "magyar", 'is': "izlandi", 'id': "indonéz", 'iu': "inuktitut", 'ga': "ír", 'it': "olasz", 'it-ch': "olasz (Svájc)", 'ja': "japán", 'kn': "kannada", 'ks': "kasmíri", 'kk': "kazah", 'km': "khmer", 'ky': "kirgiz", 'tlh': "klingon", 'ko': "koreai", 'ko-kp': "koreai (Észak-Korea)", 'ko-kr': "koreai (Dél-Korea)", 'la': "latin", 'lv': "lett", 'lt': "litván", 'lb': "luxemburgi", 'mk': "FYRO macedón", 'ms': "maláj", 'ml': "malajálam", 'mt': "máltai", 'mi': "maori", 'mr': "marathi", 'mo': "moldvai", 'nv': "navajo", 'ng': "ndonga-oshindonga", 'ne': "nepáli", 'no': "norvég", 'nb': "norvég (Bokmal)", 'nn': "norvég (Nynorsk)", 'oc': "okcitán", 'or': " orija", 'om': "oromó", 'fa-ir': "perzsa/irán", 'pl': "lengyel", 'pt': "portugál", 'pt-br': "portugál (Brazília)", 'pa': "pandzsábi", 'pa-in': "pandzsábi (India)", 'pa-pk': "pandzsábi (Pakisztán)", 'qu': "quechua", 'rm': "rheto-román", 'ro': "román", 'ro-mo': "román (Moldova)", 'ru': "orosz", 'ru-mo': "orosz (Moldávia)", 'sz': "sami (Lappföld)", 'sg': "sango", 'sa': "szanszkrit", 'sc': "szardíniai", 'sd': "szindhi", 'si': "szingaléz", 'sr': "szerb", 'sk': "szlovák", 'sl': "szlovén", 'so': "somani", 'sb': "szorbiai", 'es': "spanyol", 'es-ar': "spanyol (Argentína)", 'es-bo': "spanyol (Bolívia)", 'es-cl': "spanyol (Chile)", 'es-co': "spanyol (Kolumbia)", 'es-cr': "spanyol (Costa Rica)", 'es-do': "spanyol (Dominikai Köztársaság)", 'es-ec': "spanyol (Ecuador)", 'es-sv': "spanyol (El Salvador)", 'es-gt': "spanyol (Guatemala)", 'es-hn': "spanyol (Honduras)", 'es-mx': "spanyol (Mexikó)", 'es-ni': "spanyol (Nicaragua)", 'es-pa': "spanyol (Panama)", 'es-py': "spanyol (Paraguay)", 'es-pe': "spanyol (Peru)", 'es-pr': "spanyol (Puerto Rico)", 'es-es': "spanyol (Spanyolország)", 'es-uy': "spanyol (Uruguay)", 'es-ve': "spanyol (Venezuela)", 'sx': "sutu", 'sw': "szuahéli", 'sv': "svéd", 'sv-fi': "svéd (Finnország)", 'sv-sv': "svéd (Svédország)", 'ta': "tamil", 'tt': "tatár", 'te': "teluga", 'th': "thai", 'tig': "tigre", 'ts': "tsonga", 'tn': "tswana", 'tr': "török", 'tk': "türkmén", 'uk': "ukrán", 'hsb': "felső-sorbiai", 'ur': "urdu", 've': "venda", 'vi': "vietnámi", 'vo': "volapuk", 'wa': "walloon", 'cy': "walesi", 'xh': "xhosa", 'ji': "jiddis", 'zu': "zulu" };
        var loclistex = { 'zh-chs': "kínai (egyszerűsített)", 'zh-cht': "kínai (hagyományos)" };
        function account_showLocalizationSettings() {
            if (xxdialogMode) return false;
            var n = getstore('loctag', 0), y = '';
            var x = '<select id=d2locselect style=width:180px><option value="*">' + "Böngésző beállítása szerint" + '</option>';
            ...
            if (serverinfo.languages && serverinfo.languages.length > 0) {
                y += "A nyelv megváltoztatásához az oldal frissítése szükséges!" + '<br /><br />';
                var z = '<select id=d2langselect style=width:180px><option value="*">' + "Böngésző beállítása szerint" + '</option>';
                ...
                z += '</select>';
                y += addHtmlValue("Nyelv", z);
            }
            y += addHtmlValue("Dátum és idő", x);

            if ((userinfo.siteadmin == 0xFFFFFFFF) && (domain == '')) {
                y += '<br /><a rel="noreferrer noopener" target="_blank" href="translator.htm">' + "Segítsen a MeshCentral fordításában" + '</a>';
            }

            setDialogMode(2, "Nyelvi és területi beállítások", 3, account_showLocalizationSettingsEx, y);
            return false;
        }
        ...
        function account_addOtp() {
            ...
            setDialogMode(2, "Hitelesítő alkalmazás", 2, function () { meshserver.send({ action: 'otpauth-setup', secret: Q('d2optsecret').attributes.secret.value, token: Q('d2otpauthinput').value }); }, '<div id=d2optinfo>' + "Betöltés..." + '</div>', 'otpauth-request');
        ...
        function account_removeOtp() {
            if (xxdialogMode || (userinfo.otpsecret != 1) || ((features & 4096) == 0)) return;
            setDialogMode(2, "Hitelesítő alkalmazás", 3, function () { meshserver.send({ action: 'otpauth-clear' }); }, "Megerősíti a hitelesítő alkalmazás, kétlépcsős bejelentkezés eltávolítását?");
        }
        ...
        function account_showVerifyEmail() {
            ...
            var x = "Kattintson az OK gombra, ha megerősítő e-mailt szeretne küldeni a következő címre:" + '<br /><div style=padding:8px><b>' + EscapeHtml(userinfo.email) + '</b></div>' + "Kérjük, várjon néhány percet, amíg megkapja az igazolást.";
            setDialogMode(2, "Email megerősítés", 3, account_showVerifyEmailEx, x);
        }
        ...
        function account_showChangeEmail() {
            ...
            setDialogMode(2, "E-mail cím módosítása", 3, account_changeEmail, x);
        ...
        function account_showDeleteAccount() {
            ...
            x += '<td align=right>' + "Jelszó:" + '</td><td><input id=apassword1 type=password name=apassword1 autocomplete=off onchange=account_validateDeleteAccount() onkeyup=account_validateDeleteAccount() /></td>';
            x += '</tr><tr><td align=right>' + "Jelszó:" + '</td><td><input id=apassword2 type=password name=apassword2 autocomplete=off onchange=account_validateDeleteAccount() onkeyup=account_validateDeleteAccount() /></td>';
            x += '</tr></table><div style=padding:10px;margin-bottom:4px>';
            x += '<input id=account_dlgCancelButton type=button value="' + "Mégse" + '" style=float:right;width:80px;margin-left:5px onclick=dialogclose(0)>';
            x += '<input id=account_dlgOkButton type=submit value="' + "OK" + '" style="float:right;width:80px" onclick=dialogclose(1)>';
            x += '</div><br /></form>';
            setDialogMode(2, "Fiók törlése", 0, null, x);
        ...
        function account_showChangePassword() {
            ...
            x += '<tr><td align=right>' + nobreak("Jelenlegi jelszó:") + '</td><td><input id=apassword0 type=password name=apassword0 autocomplete=off onchange=account_validateNewPassword() onkeyup=account_validateNewPassword() onkeydown=account_validateNewPassword() /> <b></b></td></tr>';
            x += '<tr><td align=right>' + nobreak("Új jelszó:") + '</td><td><input id=apassword1 type=password name=apassword1 autocomplete=off onchange=account_validateNewPassword() onkeyup=account_validateNewPassword() onkeydown=account_validateNewPassword() /> <b><span id=dxPassWarn></span></b></td></tr>';
            x += '<tr><td align=right>' + nobreak("Új jelszó:") + '</td><td><input id=apassword2 type=password name=apassword2 autocomplete=off onchange=account_validateNewPassword() onkeyup=account_validateNewPassword() onkeydown=account_validateNewPassword() /></td></tr>';
            if (features & 0x00010000) { x += '<tr><td align=right>' + "Jelszó tipp:" + '</td><td><input id=apasswordhint name=apasswordhint maxlength=250 type=text autocomplete=off onchange=account_validateNewPassword() onkeyup=account_validateNewPassword() onkeydown=account_validateNewPassword() /></td></tr>'; }
            x += '</table>'
            if (passRequirements) {
                var r = [], rc = 0;
                for (var i in passRequirements) { if ((i != 'reset') && (i != 'hint')) { r.push(i + ':' + passRequirements[i]); rc++; } }
                if (rc > 0) { x += '<br /><span style=font-size:x-small>' + format("Követelmények: {0}.", r.join(', ')) + '</span>'; }
            }
            x += '<br />';
            setDialogMode(2, "Jelszó módosítása", 3, account_showChangePasswordEx, x);
            Q('apassword0').focus();
        ...
        function account_createMesh() {
            ...
            if ((userinfo.siteadmin != 0xFFFFFFFF) && ((userinfo.siteadmin & 64) != 0)) { setDialogMode(2, "Új eszközcsoport", 1, null, "Ez a fiók nem jogosult új eszközcsoport létrehozására."); return; }

            // Remind the user to verify the email address
            if ((userinfo.emailVerified !== true) && (serverinfo.emailcheck == true) && (userinfo.siteadmin != 0xFFFFFFFF)) { setDialogMode(2, "Fiók biztonság", 1, null, "Az e-mail-cím ellenőrzéséig nem lehet hozzáférni az eszközhöz. Ez a jelszó helyreállításához szükséges. Az e-mail cím módosításához és ellenőrzéséhez lépjen a \"Saját fiók\" oldalra."); return; }

            // Remind the user to add two factor authentication
            if ((features & 0x00040000) && !((userinfo.otpsecret == 1) || (userinfo.otphkeys > 0) || (userinfo.otpkeys > 0) || (userinfo.otpduo > 0) || (userinfo.otpdev > 0) || ((features & 0x00800000) && (userinfo.otpekey == 1)))) { setDialogMode(2, "Fiók biztonság", 1, null, "Nem lehet hozzáférni egy eszközhöz, amíg a kétfaktoros hitelesítés nem engedélyezett. Ez a fokozott biztonság érdekében szükséges. Menjen a \"Fiókom\" fülre, és nézze meg a \"Fiókbiztonság\" részt."); return; }

            // We are allowed, let's prompt to information
            var x = addHtmlValue("Név", '<input id=dp3meshname style=width:170px maxlength=64 onchange=account_validateMeshCreate() onkeyup=account_validateMeshCreate() />');
            x += addHtmlValue("Típus", '<div style=width:170px;margin:0;padding:0><select id=dp3meshtype style=width:100% onchange=account_validateMeshCreate() ><option value=2>' + "Szoftver Agent Csoport" + '</option><option value=1>' + "csak Intel&reg; AMT" + '</option></select></div>');
            x += addHtmlValue("Leírás", '<div style=width:170px;margin:0;padding:0><textarea id=dp3meshdesc maxlength=1024 style=width:100%;resize:none></textarea></div>');
            setDialogMode(2, "Eszközcsoport létrehozása", 3, account_createMeshEx, x);
        ...
        function account_validateNewPassword() {
            ...
            if (Q('apassword1').value != '') {
                if (passRequirements == null || passRequirements == '') {
                    ...
                    if (passReq == false) { ok = false; r = '<span style=color:red>' + "Házirend" + '<span>' }
                }
            }
            QH('dxPassWarn', r);
        ...
        function updateMeshes() {
            ...
            for (i in meshes) {
                ...
                var rights = "Részleges jogok";
                if (meshrights == 0xFFFFFFFF) rights = "Teljes körű adminisztrátor"; else if (meshrights == 0) rights = "Nincsenek jogok";
        ...
        function getNiceSize(bytes) {
            if (bytes <= 0) return "Tároló kapacitás túllépése";
            if (bytes < 2048) return format("{0}b van hátra", bytes);
            if (bytes < 2097152) return format("{0}k van hátra", Math.round(bytes / 1024));
            if (bytes < 2147483648) return format("{0}m van hátra", Math.round(bytes / 1024 / 1024));
            return format("{0}g van hátra", Math.round(bytes / 1024 / 1024 / 1024));
        }
        ...
        function p5showPublicLink(u) { setDialogMode(2, "Puvlikus link", 1, null, '<input type=text style=width:100% value="' + u + '" readonly />'); }
        ...
        function p5setActions() {
            ...
            Q('p5SelectAllButton').value = (cc > 0 ? "Nincs" : "Összes");
        ...
        function p5createfolder() { setDialogMode(2, "Új mappa", 3, p5createfolderEx, '<input type=text id=p5renameinput maxlength=64 onkeyup=p5fileNameCheck(event) style=width:100% />'); focusTextBox('p5renameinput'); p5fileNameCheck(); }
        ...
        function p5deletefile() { var cc = getFileSelCount(), rec = (getFileSelDirCount() > 0) ? '<br /><br /><label><input type=checkbox id=p5recdeleteinput>' + "Recurzív törlés" + '</label><br>' : '<input type=checkbox id=p5recdeleteinput style=\'display:none\'>'; setDialogMode(2, "Törlés", 3, p5deletefileEx, (cc > 1) ? (format("A(z) {0} kiválasztott elem törlése?", cc) + rec) : ("Kijelölt elem törlése?" + rec)); }
        ...
        function p5pasteFile() { var x = ''; if ((p5clipboard != null) && (p5clipboard.length > 0)) { x = format("Megerősíti {0} / {1} bejegyzés {2} erre a helyre?", (p5clipboardCut == 0 ? 'copy' : 'move'), p5clipboard.length, ((p5clipboard.length > 1) ? 's' : '')) } setDialogMode(2, "Beillesztés", 3, p5pasteFileEx, x); }
        ...
        function p5updateClipview() { var x = ''; if ((p5clipboard != null) && (p5clipboard.length > 0)) { x = format("{0} bejegyzés megtartása {1} {2}", p5clipboard.length, ((p5clipboard.length > 1) ? 's' : ''), (p5clipboardCut == 0 ? "másolás" : "mozgat")) + ', <a href=# onclick="return p5clearClip()" style=cursor:pointer>' + "Törlés" + '</a>.' } QH('p5bottomstatus', x); p5setActions(); }
        ...
        function updateDevices() {
            ...
            for (var i in nodes) {
                ...
                if (sort == 0) {
                    ...
                    if (((meshes[nodes[i].meshid]?nodes[i].meshid:'*') != current)) {
                        deviceHeaderSet();
                        var extra = '';
                        if ((meshes[nodes[i].meshid] != null) && (meshes[nodes[i].meshid].mtype == 1)) { extra = '<span style=color:lightgray>' + ", csak Intel&reg; AMT" + '</span>'; }
                        ...
                        if (meshes[nodes[i].meshid]) {
                            ...
                            r += '</span><span id=MxMESH><i>' + "Egyedi eszközök" + '</i></span><span id=DevxHeader' + deviceHeaderId + ' style=color:lightgray></span></div>';
                            current = '*';
                        }
            ...
            if ((r == '') && (nodes.length > 0) && (Q('SearchInput').value != '')) {
                viewNothing = true;
                r = '<div style="margin:30px">' + "Nincsenek a keresésnek megfelelő eszközök." + '</div>';
            }
            ...
            if ((sort == 0) && (Q('SearchInput').value == '')) {
                for (var i in meshes) {
                    ...
                    if ((displayedMeshes[mesh._id] == null) && (IsMeshViewable(mesh))) {
                        ...
                        if (mesh.mtype == 1) { r += '<div style=padding:10px><i>' + "Ebben a csoportban nincsenek Intel&reg; AMT eszközök"; }
                        if (mesh.mtype > 1) { r += '<div style=padding:10px><i>' + "Nincsenek eszközök ebben a csoportban"; }
                        r += '.</i></div></div>';
                        current = mesh._id;
                        count++;
                    }
            ...
            if (count == 0) {
                if ((Q('SearchInput').value != '') || (Q('OnlineCheckBox').checked)) {
                    QH('xdevices', '<div style="margin-top:50px;text-align:center"><span style="font-size:30px">' + "Nincsenek eszközök" + '</span><br /><br />' + "Nincsenek a keresésnek megfelelő eszközök." + ' <a onclick=clearSearchInput() style=cursor:pointer>' + "Szűrő törlése" + '</a></div>');
                } else {
                    QH('xdevices', '<div style="margin-top:50px;text-align:center"><span style="font-size:30px">' + "Nincsenek eszközök" + '</span><br /><br />' + "Az eszközök hozzáadásához használja a weboldal asztali verzióját." + '</div>');
                }
            } else {
                QH('xdevices', r);
            }
        ...
        function updateDeviceViewHtml(div, node) {
            ...
            if ((div.offsetTop >= visibleTop) && (div.offsetTop < visibleBottom)) {
                ...
                if (title.length == 0) { title = '<i>' + "Nincs" + '</i>'; }
                ...
                if (name.length == 0) { name = '<i>' + "Nincs" + '</i>'; }
                ...
                if (node.sessions != null) {
                    ...
                    if (node.sessions.battery != null) {
                        ...
                        var statestr = '';
                        if (bat.state == 'ac') { statestr = "A készülék be van dugva."; }
                        else if (bat.state == 'dc') { statestr = "A készülék akkumulátorról működik."; }
        ...
        function showDeviceHelpRequests(nodeid, force, e) {
            ...
            if (x != '') { setDialogMode(2, "Segítség kérések" + ' - ' + EscapeHtml(node.name), 1, null, x, 'HELPREQ-' + node._id); } else { setDialogMode(0); }
            return false;
        }
                ...
                if ((i == 'kvm') && (node.sessions.multidesk == null)) {
                    ...
                    for (var j in node.sessions.kvm) {
                        if (j.startsWith('user/')) {
                            var trash = '';
                            if ((j == userinfo._id) || (GetNodeRights(node) == 0xFFFFFFFF)) { trash = ' <a href=# onclick=\'return endDeviceSession("kvm", "' + encodeURIComponentEx(node._id) + '", "' + encodeURIComponentEx(j) + '")\' title="' + "A munkamenet leválasztása" + '" style=cursor:pointer><img src=images/trash.png border=0 height=10 width=10></a>'; }
                            x += addHtmlValue4(getUserName(j), ((node.sessions.kvm[j] == 1) ? "1 munkamenet" : nobreak(format("{0} munkamenet", node.sessions.kvm[j]))) + trash);
                        } else if (j == 'busy') {
                            x += addHtmlValue2("Az eszköz foglalt", ((node.sessions.kvm[j] == 1) ? "1 munkamenet" : nobreak(format("{0} munkamenet", node.sessions.kvm[j]))));
                        }
                    }
                } else if (i == 'multidesk') {
                    x += '<u>' + "Távoli Asztal" + '</u>';
                    for (var j in node.sessions.multidesk) {
                        var trash = '';
                        if ((j == userinfo._id) || (GetNodeRights(node) == 0xFFFFFFFF)) { trash = ' <a href=# onclick=\'return endDeviceSession("multidesk", "' + encodeURIComponentEx(node._id) + '", "' + encodeURIComponentEx(j) + '")\' title="' + "A munkamenet leválasztása" + '" style=cursor:pointer><img src=images/trash.png border=0 height=10 width=10></a>'; }
                        x += addHtmlValue4(getUserName(j), ((node.sessions.multidesk[j] == 1) ? "1 munkamenet" : nobreak(format("{0} munkamenet", node.sessions.multidesk[j]))) + trash);
                    }
                } else if (i == 'terminal') {
                    x += '<u>' + "Terminál" + '</u>';
                    for (var j in node.sessions.terminal) {
                        var trash = '';
                        if ((j == userinfo._id) || (GetNodeRights(node) == 0xFFFFFFFF)) { trash = ' <a href=# onclick=\'return endDeviceSession("terminal", "' + encodeURIComponentEx(node._id) + '", "' + encodeURIComponentEx(j) + '")\' title="' + "A munkamenet leválasztása" + '" style=cursor:pointer><img src=images/trash.png border=0 height=10 width=10></a>'; }
                        x += addHtmlValue4(getUserName(j), ((node.sessions.terminal[j] == 1) ? "1 munkamenet" : nobreak(format("{0} munkamenet", node.sessions.terminal[j]))) + trash);
                    }
                } else if (i == 'files') {
                    x += '<u>' + "Fájlok" + '</u>';
                    for (var j in node.sessions.files) {
                        var trash = '';
                        if ((j == userinfo._id) || (GetNodeRights(node) == 0xFFFFFFFF)) { trash = ' <a href=# onclick=\'return endDeviceSession("files", "' + encodeURIComponentEx(node._id) + '", "' + encodeURIComponentEx(j) + '")\' title="' + "A munkamenet leválasztása" + '" style=cursor:pointer><img src=images/trash.png border=0 height=10 width=10></a>'; }
                        x += addHtmlValue4(getUserName(j), ((node.sessions.files[j] == 1) ? "1 munkamenet" : nobreak(format("{0} munkamenet", node.sessions.files[j]))) + trash);
                    }
                } else if (i == 'tcp') {
                    x += '<u>' + "TCP Routing" + '</u>';
                    for (var j in node.sessions.tcp) {
                        var trash = '';
                        if ((j == userinfo._id) || (GetNodeRights(node) == 0xFFFFFFFF)) { trash = ' <a href=# onclick=\'return endDeviceSession("tcp", "' + encodeURIComponentEx(node._id) + '", "' + encodeURIComponentEx(j) + '")\' title="' + "A munkamenet leválasztása" + '" style=cursor:pointer><img src=images/trash.png border=0 height=10 width=10></a>'; }
                        x += addHtmlValue4(getUserName(j), ((node.sessions.tcp[j] == 1) ? "1 munkamenet" : nobreak(format("{0} munkamenet", node.sessions.tcp[j]))) + trash);
                    }
                } else if (i == 'udp') {
                    x += '<u>' + "UDP Routing" + '</u>';
                    for (var j in node.sessions.udp) {
                        var trash = '';
                        if ((j == userinfo._id) || (GetNodeRights(node) == 0xFFFFFFFF)) { trash = ' <a href=# onclick=\'return endDeviceSession("udp", "' + encodeURIComponentEx(node._id) + '", "' + encodeURIComponentEx(j) + '")\' title="' + "A munkamenet leválasztása" + '" style=cursor:pointer><img src=images/trash.png border=0 height=10 width=10></a>'; }
                        x += addHtmlValue4(getUserName(j), ((node.sessions.udp[j] == 1) ? "1 munkamenet" : nobreak(format("{0} munkamenet", node.sessions.udp[j]))) + trash);
                    }
                }
            }
            if (x != '') { setDialogMode(2, "Munkamenetek" + ' - ' + EscapeHtml(node.name), 1, null, x, 'SESSIONS-' + node._id); } else { setDialogMode(0); }
        }
        ...
        function showDeviceMessages(nodeid, force, e) {
            ...
            x += '</div>';
            if (count > 0) setDialogMode(2, "Agent üzenetek" + ' - ' + EscapeHtml(node.name), 1, null, x, 'MESSAGES-' + node._id);
            return false;
        }

        var powerStatetable = ['', "Bekapcsolva", "Alvás", "Alvás", "Alvás", "Hibernálás", "Kikapcsolás", "Present", "Ki"];
        var powerStateStrings = ['', "Bekapcsolva", "Alvás", "Alvás", "Mély alvás", "Hibernálás", "Soft-Off", "Present", "Ki"];
        var powerStateStrings2 = ['', "Az eszköz energiaellátása biztosított", "Az eszköz alvó állapotban van (S1)", "Az eszköz alvó állapotban van (S2)", "Az eszköz mély alvó állapotban van (S3)", "Az eszköz hibernált (S4)", "Az eszköz soft-off állapotban van (S5)", "Az eszköz jelen van, de a energiaellátás állapota nem állapítható meg.", "Az eszköz ki van kapcsolva"];
        ...
        function deviceHeaderSet() {
            ...
            deviceHeaders['DevxHeader' + deviceHeaderId] = ', ' + deviceHeaderTotal + ((deviceHeaderTotal == 1) ? " node" : "node-ok");
            var title = '';
        ...
        */
        ...
        function gotoDevice(nodeid, panel, refresh) {
            ...
            if (!currentNode || currentNode._id != node._id || refresh == true) {
                ...
                if ((currentNode.sessions != null) && (currentNode.sessions.battery != null)) {
                    ...
                    var statestr = '';
                    if (bat.state == 'ac') { statestr = "A készülék be van dugva."; }
                    if (bat.state == 'dc') { statestr = "A készülék akkumulátorról működik."; }
                ...
                if (nname.length == 0) { nname = '<i>' + "Nincs" + '</i>'; }
                ...
                // Attribute: Mesh
                if (mesh) { x += addDeviceAttribute('<span>' + "Csoport" + '</span>', '<a onclick=goForward("' + node.meshid + '") style=cursor:pointer>' + EscapeHtml(meshes[node.meshid].name) + '</a>'); }

                // Attribute: Name
                if (node.rname != null) { x += addDeviceAttribute('<span>' + "Név" + '</span>', '<span>' + EscapeHtml(node.rname) + '</span>'); }

                // Attribute: Host
                if ((((features & 1) == 0) && (node.mtype != 4)) || (node.mtype == 3)) { // If not WAN-only, local hostname is in use
                    if ((meshrights & 4) != 0) {
                        if (node.host) {
                            x += addDeviceAttribute("Gépnév", '<span onclick=showEditNodeValueDialog(1) style=cursor:pointer>' + EscapeHtml(node.host) + '</span>');
                        } else {
                            x += addDeviceAttribute("Gépnév", '<span onclick=showEditNodeValueDialog(1) style=cursor:pointer><i>' + "Nincs" + '</i></span>');
                        }
                    } else {
                        x += addDeviceAttribute("Gépnév", EscapeHtml(node.host));
                    }
                }

                // Attribute: Description
                var description = node.desc ? EscapeHtml(node.desc) : '<i>' + "Nincs" + '</i>';
                if ((meshrights & 4) != 0) {
                    x += addDeviceAttribute("Leírás", '<span onclick=showEditNodeValueDialog(2) style=cursor:pointer>' + description + '</span>');
                } else {
                    x += addDeviceAttribute("Leírás", description);
                }

                // IP-KVM information
                if (node.mtype == 4) {
                    if (node.portnum != null) { x += addDeviceAttribute("Port Szám", node.portnum); }
                    if (node.porttype != null) { x += addDeviceAttribute("Port Típus", node.porttype); }
                }

                // Attribute: Mesh Agent
                if ((node.agent != null) && (node.agent.id != null) && (node.mtype == 3)) {
                    if (node.agent.id == 4) { x += addDeviceAttribute("Eszköz típusa", "Windows"); }
                    if (node.agent.id == 6) { x += addDeviceAttribute("Eszköz típusa", "Linux"); }
                    if (node.agent.id == 29) { x += addDeviceAttribute("Eszköz típusa", "macOS"); }
                    ...
                    if ((node.agent.root === false) && ((node.conn & 1) != 0)) { str += ', ' + "Korlátozott"; }
                ...
                if (node.intelamt != null) {
                    var str = '';
                    var provisioningStates = { 0: nobreak("Not Activated (Pre)"), 1: nobreak("Not Activated (In)"), 2: nobreak("Aktiválva") };
                    if (node.intelamt.ver != null && node.intelamt.state == null) { str += '<i>' + nobreak("Ismeretlen Státusz") + '</i>, v' + EscapeHtml(node.intelamt.ver); }
                    else if ((node.intelamt.ver == null) && (node.intelamt.state == 2)) { str += '<i>' + "Aktiválva" + '</i>'; }
                    else if ((node.intelamt.ver == null) || (node.intelamt.state == null)) { str += '<i>' + "Ismeretlen Verzió és Státusz" + '</i>'; }
                    else {
                    ...
                    if (node.intelamt.state == 2) {
                        if (node.intelamt.tls == 1) { str += ', <span title="' + "Intel&reg; AMT beállítás TLS network security használatával" + '">' + "TLS" + '</span>'; }
                        ...
                        if (node.intelamt.user == null || node.intelamt.user == '') { // If credentials are not set, allow setting them.
                            if ((meshrights & 4) != 0) {
                                str += ', <i style=color:#FF0000;cursor:pointer title="' + "Intel&reg; AMT hitelesítő adatok szerkesztése" + '" onclick=editDeviceAmtSettings("' + node._id + '")>' + "Nincs hitelesítő adat" + '</i>';
                                editUserCredentialsIcon = true;
                            } else {
                                str += ', <i style=color:#FF0000>' + "Nincs hitelesítő adat" + '</i>';
                            }
                            ...
                            var warn = null;
                            if ((node.intelamt.warn & 1) != 0) { warn = "Érvénytelen hitelesító adat"; }
                            if ((node.intelamt.warn & 8) != 0) { warn = "Hitelesítő adatok kipróbálása"; }
                            if (warn != null) {
                                if ((meshrights & 4) != 0) {
                                    str += ', <i style=color:#FF0000;cursor:pointer title="' + "Intel&reg; AMT hitelesítő adatok szerkesztése" + '" onclick=editDeviceAmtSettings("' + node._id + '")>' + warn + '</i>';
                                    editUserCredentialsIcon = true;
                                } else {
                        ...
                        if (editUserCredentialsIcon) {
                            str += '<img src=images/link4.png height=10 width=10 title="' + "Intel&reg; AMT hitelesítő adatok szerkesztése" + '" style=cursor:pointer onclick=editDeviceAmtSettings("' + node._id + '")>';
                        }
                    }
                ...
                if ((node.agent != null) && (node.agent.tag != null) && (node.agent.tag != 'mailto:')) {
                    ...
                    x += addDeviceAttribute("Agent Cimke", tag);
                }
                ...
                if (connectivity && connectivity > 1) {
                    ...
                    x += addDeviceAttribute("Kapcsolódás", cstate.join(', '));
                }

                // Node tags
                var groupingTags = '<i>' + "Nincs" + '</i>';
                if (node.tags != null) { groupingTags = ''; for (var i in node.tags) { groupingTags += '<span class=tagSpan>' + EscapeHtml(node.tags[i]) + '</span> '; } }
                if ((meshrights & 4) != 0) {
                    x += addDeviceAttribute("Címkék", '<span onclick=showEditNodeValueDialog(3) style=cursor:pointer;color:black>' + groupingTags + '</span>');
                } else {
                    x += addDeviceAttribute("Címkék", '<span style=line-height:26px;color:black>' + groupingTags + '</span>');
                }
                ...
                if ((node.ssh != null) || (node.rdp != null)) {
                    var y = [];
                    if ((meshrights & 4) != 0) {
                        if (node.ssh != null) { y.push('<span onclick=showClearSshDialog(3) style=cursor:pointer>' + ((node.ssh == 1) ? "SSH-Felhasználó+Jelszó" : ((node.ssh == 2) ? "SSH-Felhasználó+Kulcs+Jelszó" : "SSH-Felhasználó+Kulcs")) + ' <img class=hoverButton src="images/link5.png" width=10 height=10 /></span>'); }
                        ...
                        if (node.ssh != null) { y.push(((node.ssh == 1) ? "SSH-Felhasználó+Jelszó" : ((node.ssh == 2) ? "SSH-Felhasználó+Kulcs+Jelszó" : "SSH-Felhasználó+Kulcs"))); }
                        if (node.rdp != null) { y.push("RDP"); }
                    }
                    x += addDeviceAttribute("Hitelesítő adatok", y.join(', '));
                }

                x += '</table><br />';
                // Show action button, only show if we have permissions 4, 8, 64
                if (((meshrights & (4 + 8 + 64 + 262144)) != 0) && (node.mtype < 3)) { x += '<input type=button value="' + "Tevékenységek" + '" onclick=deviceActionFunction() />'; }
                x += '<input type=button value="' + "Jegyzetek" + '" onclick=showNotes(' + ((meshrights & 128) == 0) + ',"' + encodeURIComponent(node._id) + '") />';
                ...
                if ((node.mtype == 4) && (connectivity & 1)) {
                    if (node.porttype == 'PDU') {
                        if (node.pwr == 1) {
                            if (meshrights & 0x40000) { x += '<input type=button value="' + "Kapcsolja ki" + '" title="' + "Kapcsolja ki" + '" onclick=setIpPduState(0) />'; }
                        } else if (node.pwr == 8) {
                            if (meshrights & 0x40) { x += '<input type=button value="' + "Kapcsolja be" + '" title="' + "Kapcsolja be" + '" onclick=setIpPduState(1) />'; }
                        }
                    } else {
                        if (meshrights & 8) { x += '<input type=button value="' + "Távvezérlés" + '" title="' + "Távvezérlés" + '" onclick=openIpKvmRemoteControl("' + encodeURIComponentEx(node._id) + '") />'; }x
                    }
                }
                ...
                if ((meshrights & 0x8000) != 0) { x += '<a style=cursor:pointer onclick=p10showDeleteNodeDialog("' + node._id + '")>' + "Eszköz törlése" + '</a>'; }
                ...
                if ((connectivity & 2) != 0) { if (powerstate.length > 0) { powerstate += ', '; } powerstate += "Intel&reg; AMT csatlakoztatva"; }
                else if ((connectivity & 4) != 0) { if (powerstate.length > 0) { powerstate += ', '; } powerstate += "Intel&reg; AMT észlelve"; }
                if ((connectivity & 16) != 0) { if (powerstate.length > 0) { powerstate += ', '; } powerstate += "MQTT csatorna csatlakoztatva"; }
        ...
        function setIpPduState(op) {
            if (op == 0) {
                setDialogMode(2, "Tápellátás Művelet", 3, function () { meshserver.send({ action: 'poweraction', nodeids: [currentNode._id], actiontype: 2 }); }, "Végrehajtja a kikapcsolását?"); // Turn off
            } else {
                setDialogMode(2, "Tápellátás Művelet", 3, function () { meshserver.send({ action: 'wakedevices', nodeids: [currentNode._id] }); }, "Végrehajtja a bekapcsolását?"); // Turn on
            }
        }
        ...
        function deviceToastFunction() {
            if (xxdialogMode) return;
            setDialogMode(2, "Eszköz Üzenet", 3, deviceToastFunctionEx, '<textarea id=d2devToast style=width:100%;height:80px;resize:none;overflow-y:scroll></textarea>');
        }
        ...
        function setupDeviceMenu(op, obj) {
            ...
            var menus = [];
            if (currentDevicePanel != 0) { menus.push({ n: "Általános", f: 'setupDeviceMenu(0)' }); }
            ...
            ) { menus.push({ n: "Asztal", f: 'setupDeviceMenu(1)' }); }
            ...
            ) { menus.push({ n: "Terminál", f: 'setupDeviceMenu(5)' }); }

            if ((currentDevicePanel != 2) && (currentNode != null) && (meshrights & 8) && ((meshrights == 0xFFFFFFFF) || ((meshrights & 1024) == 0)) && ((currentNode.mtype != 1) && (currentNode.agent) && (currentNode.agent.caps & 4))) { menus.push({ n: "Fájlok", f: 'setupDeviceMenu(2)' }); }
            if ((currentDevicePanel != 3) && (currentNode != null) && (currentNode.mtype < 3) && ((meshrights & 1048576) != 0)) { menus.push({ n: "Eszköz részletek", f: 'setupDeviceMenu(3)' }); }
            if ((currentDevicePanel != 4) && (currentNode != null) && (meshrights & 0x00000010) && (currentNode.mtype == 2)) { menus.push({ n: "Mesh Agent konzol", f: 'setupDeviceMenu(4)' }); }
        ...
        function deviceActionFunction() {
            ...
            var x = "Válassza ki az eszközön végrehajtandó műveletet." + '<br /><br />';
            ...
            if ((currentNode.agent != null) && (currentNode.agent.id == 14)) {
                if (((currentNode.conn & 1) != 0) && ((rights & 8) != 0)) {
                    count++;
                    y += '<option value=400>' + "Villog" + '</option>';
                    y += '<option value=401>' + "Rezgés" + '</option>';
                    z += '<div id=d2devicetimediv>' + addHtmlValue("Idő", '<select id=d2devicetime style=float:right;width:170px><option value=1000>' + "1 másodperc" + '</option><option value=5000>' + "5 másodperc" + '</option><option value=10000>' + "10 másodperc" + '</option></select>') + '</div>';
                }
            } else {
                if ((rights & 64) != 0) { count++; y += '<option value=100>' + "Felébresztés" + '</option>'; } // Wake-up permission
                //if (((currentNode.conn & 1) != 0) && ((rights & 131072) != 0)) { count++; y += '<option value=106>' + "Run Commands" + '</option>'; } // Remote command permission
                if ((currentNode.conn != 0) && ((rights & 262144) != 0)) { count++; y += '<option value=4>' + "Alvás" + '</option><option value=3>' + "Visszaállít" + '</option><option value=2>' + "Kikapcsolás" + '</option>'; }
                ...
                if ((currentNode.intelamt != null) && (currentNode.intelamt.state == 2) && ((currentNode.conn & 6) != 0) && ((rights & 262144) != 0)) {
                    ...
                    y += '<option value=308>' + "Intel&reg; AMT Kikapcsolás" + '</option>';
                }
                if ((currentNode.intelamt != null) && (currentNode.intelamt.state == 2) && ((currentNode.conn & 6) != 0) && ((rights & 64) != 0)) {
                    count++;
                    y += '<option value=302>' + "Intel&reg; AMT Bekapcsolás" + '</option>';
                }
            ...
            y += '</select>';
            x += addHtmlValue("Művelet", y);
            if (count == 0) { x = "Jelenleg nem érhetők el műveletek ehhez az eszközhöz."; }
            setDialogMode(2, "Eszköz műveletek", (count == 0) ? 2 : 3, deviceActionFunctionEx, x + z);
        ...
        function deviceActionFunctionEx() {
            ...
            if (op == 100) {
                ...
                */
                ...
                setDialogMode(2, "Intel&reg; AMT Tápellátás Művelet", 3, function () { meshserver.send({ action: 'poweraction', nodeids: [currentNode._id], actiontype: parseInt(op) }); }, "Végrehajtja az Intel&reg; AMT bekapcsolását?");
            } else if (op == 308) { // Intel AMT power off
                setDialogMode(2, "Intel&reg; AMT Tápellátás Művelet", 3, function () { meshserver.send({ action: 'poweraction', nodeids: [currentNode._id], actiontype: parseInt(op) }); }, "Perform Intel&reg; AMT power off?<br><br><b>NOTE: If there is an active AMT session, then power off command will be rejected, so you must disconnect from the AMT session first!</b>");
            } else if (op == 310) { // Intel AMT reset
                setDialogMode(2, "Intel&reg; AMT Tápellátás Művelet", 3, function () { meshserver.send({ action: 'poweraction', nodeids: [currentNode._id], actiontype: parseInt(op) }); }, "Végrehajtása az Intel&reg; AMT reset-et?");
        ...
        function showNotes(readonly, noteid) {
            ...
            if (noteid.startsWith('node%2F%2F')) { x += '<span style=font-size:10px>' + "Az eszközcsoportok megjegyzéseit más eszközcsoport-adminisztrátorok is megtekinthetik és módosíthatják." + '<span>'; }
            setDialogMode(2, "Jegyzetek", 3, showNotesEx, x, noteid);
        ...
        function deviceLockFunction() {
            if ((xxdialogMode != null || xxdialogMode == 0) && (desktop != null) && (desktop.contype == 1)) { setDialogMode(2, "Asztal zárolása", 3, function() { if ((desktop != null) && (desktop.contype == 1)) { desktop.sendCtrlMsg('{"ctrlChannel":"102938","type":"lock"}'); } }, "Felhasználó Asztal zárolása?"); }
        }

        function deviceChat(e) {
            if (xxdialogMode) return;
            setDialogMode(2, "Eszköz műveletek", 3, function () {
            ...
            }, "Csevegés munkamenet indítása?");
        }

        function deviceUrlFunction() {
            if (xxdialogMode) return;
            setDialogMode(2, "Oldal megnyitása az eszközön", 3, deviceUrlFunctionEx, '<input id=d2devurl placeholder="http://server.com" style=width:100%;overflow-y:scroll onkeyup=deviceUrlFunctionValidate() onchange=deviceUrlFunctionValidate()></input>');
            Q('d2devurl').focus();
        ...
        function d2runCommandDialog(options) {
            ...
            if ((wintype == true) || (linuxtype == true) || (agenttype == true)) {
                ...
                if (wintype == true) { x += '<option value=1' + ((runopt.type == 1)?' selected':'') + '>' + "Windows parancssor (CMD)" + '</option><option value=2' + ((runopt.type == 2)?' selected':'') + '>' + "Windows PowerShell" + '</option>'; }
                if (linuxtype == true) { x += '<option value=3' + ((runopt.type == 3)?' selected':'') + '>' + "Linux/BSD/macOS Parancs Shell" + '</option>'; }
                if (agenttype == true) { x += '<option value=4' + ((runopt.type == 4)?' selected':'') + '>' + "Agent konzol" + '</option>'; } // MESHRIGHT_REMOTECONTROL & MESHRIGHT_AGENTCONSOLE are needed
                x += '</select>';
                x += '<select id=d2cmduser style=width:100%;margin-bottom:4px><option value=0' + ((runopt.runAs == 0)?' selected':'') + '>' + "Futtatás agent-ként" + '</option><option value=1' + ((runopt.runAs == 1)?' selected':'') + '>' + "Futtatás felhasználóként, vagy mint agent, ha nincs felhasználó" + '</option><option value=2' + ((runopt.runAs == 2)?' selected':'') + '>' + "Futtatás felhasználóként" + '</option></select>';
                if (options.selectedFile == null) {
                    x += '<select id=d2cmdsource onclick=d2runCommandValidate() style=width:100%;margin-bottom:4px><option value=0' + ((runopt.source == 0)?' selected':'') + '>' + "Parancsok a szövegdobozból" + '</option><option value=1' + ((runopt.source == 1)?' selected':'') + '>' + "Parancsok fájlból" + '</option>';
                    if (userinfo.siteadmin & 8) { x += '<option value=2' + ((runopt.source == 2)?' selected':'') + '>' + "Parancsok a kiszolgálón lévő fájlból" + '</option>'; }
                ...
                setDialogMode(2, "Parancsok futtatása", 3, d2groupActionFunctionRunCommands, x, options);
                if (options.selectedFile == null) {
                    Q('d2runcmd').focus();
        ...
        function editDeviceAmtSettings(nodeid, func) {
            ...
            x += addHtmlValue("Felhasználó név", '<input id=dp10username style=width:170px maxlength=32 autocomplete=nope placeholder="admin" onchange=validateDeviceAmtSettings() onkeyup=validateDeviceAmtSettings() />');
            x += addHtmlValue("Jelszó", '<input id=dp10password type=password style=width:170px autocomplete=nope maxlength=32 onchange=validateDeviceAmtSettings() onkeyup=validateDeviceAmtSettings() />');
            // Only display the TLS setting if the Intel AMT manager is not running on the server. With the manager TLS is auto-detected.
            if ((features2 & 1) == 0) { x += addHtmlValue("Biztonság", '<select id=dp10tls style=width:176px><option value=0>' + "Nincs TLS security" + '</option><option value=1>' + "TLS security szükséges" + '</option></select>'); }
            if ((node.intelamt.user != null) && (node.intelamt.user != '')) { buttons = 7; }
            setDialogMode(2, "Intel&reg; AMT hitelesítő adatok szerkesztése", buttons, editDeviceAmtSettingsEx, x, { node: node, func: func });
        ...
        function p10showDeleteNodeDialog(nodeid) {
            if (xxdialogMode) return;
            setDialogMode(2, "Node törlése", 3, p10showDeleteNodeDialogEx, format("Törli a következőt: {0}?", EscapeHtml(currentNode.name)) + '<br /><br /><label><input id=p10check type=checkbox onchange=p10validateDeleteNodeDialog() />' + "Megerősít" + '</label>', nodeid);
        ...
        function p10showiconselector() {
            ...
            setDialogMode(2, "Ikon kiválasztás", 0, null, x);
        ...
        function showClearSshDialog() { setDialogMode(2, "Eszköz szerkesztése", 3, showClearSshDialogEx, "SSH hitelesítő adatok törlése?"); }
        function showClearSshDialogEx(button, mode) { meshserver.send({ action: 'changedevice', nodeid: currentNode._id, ssh: 0 }); }
        function showClearRdpDialog() { setDialogMode(2, "Eszköz szerkesztése", 3, showClearRdpDialogEx, "RDP hitelesítő adatok törlése?"); }
        function showClearRdpDialogEx(button, mode) { meshserver.send({ action: 'changedevice', nodeid: currentNode._id, rdp: 0 }); }

        var showEditNodeValueDialog_modes = ["Eszköz Neve", "Gépnév", "Leírás", "Címkék"];
        var showEditNodeValueDialog_modes2 = ['name', 'host', 'desc', 'tags'];
        var showEditNodeValueDialog_modes3 = ['', '', '', "Csoport1, Csoport2, Csoport3"];
        function showEditNodeValueDialog(mode) {
            ...
            setDialogMode(2, "Eszköz szerkesztése", 3, showEditNodeValueDialogEx, x, mode);
        ...
        var agentConsoleMessages = ['', "Várjuk, hogy a felhasználó engedélyezze a hozzáférést...", "Elutasítva", "Sikertelen távoli terminál munkamenet indítása, {0} ({1})", "Időtúllépés", "A fogadott hálózati adatok érvénytelenek"];
        ...
        function showDesktopSettings() {
            ...
            applyDesktopSettings();
            updateDesktopButtons();
            setDialogMode(7, "Távoli Asztal beállítások", 3, showDesktopSettingsChanged);
        }
        ...
        function updateDeskShortcutKeys() {
            var x = '<div class="menuButton" onclick="deskMenuButton(-1)">' + "Testreszabás" + '</div>';
        ...
        var keyStrings = { 8: "BackSpace", 9: "Tab", 13: "Enter", 27: "Escape", 32: "Space", 44: "Print Screen", 45: "Beszúrás", 46: "Del", 36: "Home", 35: "Vége", 32: "Espace", 33: "Page Up", 34: "Page Down", 37: "Bal", 38: "Fel", 39: "Jobb", 40: "Le", 0: "Nincs" }
        ...
        function deskCustomizeKeys() {
            ...
            x += '</select> <input type=button value=' + "Hozzáadás" + ' onclick=addDeskCustomizeKey() /></div>';
            QH('p10dialog2', x);
            xxdialogMode = 2;
            QV('p10dialog', true);
        ...
        function deskUpdateShortcutList() {
            ...
            if (x == '') { x = '<i>' + "Nincsenek billentyű parancsok definiálva" + '</i>'; }
            QH('d2shortcuts', x);
        }
        ...
        function sendSpecialKeys() {
            if (xxdialogMode || desktop == null || desktop.State != 3) return;
            setDialogMode(3, "Speciális billentyűk", 3, deskSendKeys);
        }
        ...
        function deskSelectScreens() {
            ...
            x = addHtmlValue4("Képernyő", '<select style=width:100% id=deskdisplays>' + x + '</select>');
            setDialogMode(2, "Képernyő kiválasztása", 3, deskSelectScreensEx, x);
        }
        ...
        function cmsshportaction(action) {
            if (xxdialogMode) return;
            var x = "SSH távoli kapcsolat portja:" + '<br /><br /><input type=text placeholder="22" inputmode="numeric" pattern="[0-9]*" onkeypress="return (event.keyCode == 8) || (event.charCode >= 48 && event.charCode <= 57)" maxlength=5 id=d10sshport type=text>';
            setDialogMode(2, "SSH Kapcsolat", 3, function () {
        ...
        function sshTunnelAuthDialog(j, func) {
            var x = '';
            if (j.askkeypass) {
                x += addHtmlValue("Hitelesítés", '<select id=dp2authmethod style=width:150px onchange=sshAuthUpdate(event)><option value=3 selected>' + "Tárolt kulcs" + '</option><option value=1>' + "Felhasználónév és Jelszó" + '</option><option value=2>' + "Felhasználó néc és kulcs" + '</option></select>');
            } else {
                x += addHtmlValue("Hitelesítés", '<select id=dp2authmethod style=width:150px onchange=sshAuthUpdate(event)><option value=1 selected>' + "Felhasználónév és Jelszó" + '</option><option value=2>' + "Felhasználó néc és kulcs" + '</option></select>');
            }
            x += '<div id=d2userauth style=display:none>';
            x += addHtmlValue("Felhasználó név", '<input id=dp2user style=width:150px maxlength=64 autocomplete=off onkeyup=sshAuthUpdate(event) />');
            x += '</div>';
            x += '<div id=d2passauth style=display:none>';
            x += addHtmlValue("Jelszó", '<input type=password id=dp2pass style=width:150px maxlength=64 autocomplete=off onkeyup=sshAuthUpdate(event) />');
            if ((features2 & 0x00400000) == 0) { x += '<label><input id=dp2keep type=checkbox>' + "Hitelesítő adatok megjegyzése" + '</label>'; }
            x += '</div><div id=d2keyauth style=display:none>';
            x += addHtmlValue("Kulcs fájl", '<input type=file id=dp2key style=width:150px maxlength=64 autocomplete=off onchange=sshAuthUpdate(event) />' + '<div id=d2badkey style=font-size:x-small>' + "A kulcsfájlnak OpenSSH formátumúnak kell lennie." + '</div>');
            x += addHtmlValue("Kulcs jelszó", '<input type=password id=dp2keypass style=width:150px maxlength=64 autocomplete=off onkeyup=sshAuthUpdate(event) />');
            if ((features2 & 0x00400000) == 0) {
                x += '<label><input id=dp2keep1 type=checkbox onchange=sshAuthUpdate(event)>' + "Emlékezzen a felhaszálóra és kulcsra" + '</label><br/>';
                x += '<label><input id=dp2keep2 type=checkbox>' + "Elmékezzej a jelszóra" + '</label>';
            }
            x += '</div>';
            if (j.askkeypass) {
                x += '<div id=d2keyauth2 style=display:none>';
                x += addHtmlValue("Jelszó", '<input type=password id=dp2keypass2 style=width:150px maxlength=64 autocomplete=off onkeyup=sshAuthUpdate(event) />');
                x += '</div>';
            }
            setDialogMode(2, "Hitelesítés", 11, func, x, 'ssh');
            Q('dp2user').focus();
            sshAuthUpdate();
            ...
            if (typeof data == 'string') {
                if (data[0] == '{') {
                    ...
                    switch (j.action) {
                        ...
                        case 'autherror': { p12setConsoleMsg("Hitelesítés Hiba", 5000); break; }
                        case 'sessionerror': { p12setConsoleMsg("Munkamenet lejárt", 5000); break; }
                        case 'sessiontimeout': { p12setConsoleMsg("Munkamenet időtúllépés", 5000); break; }
                    }
                } else if (data[0] == '~') {
        ...
        */
        ...
        function p13gotFiles(data) {
            ...
            switch (data.action) {
                ...
                case 'autherror': { p13setConsoleMsg("Hitelesítés Hiba", 5000); return; }
                case 'connectionerror': { p13setConsoleMsg("Kapcsolat Hiba", 5000); return; }
                case 'sessionerror': { p13setConsoleMsg("Munkamenet lejárt", 5000); return; }
                case 'sessiontimeout': { p13setConsoleMsg("Munkamenet időtúllépés", 5000); return; }
            }
        ...
        function p13setActions() {
            ...
            if (p13filetree == null) {
                ...
                Q('p13SelectAllButton').value = "Összes";
                ...
                Q('p13SelectAllButton').value = (cc > 0 ? "Nincs" : "Összes");
        ...
        function p13createfolder() { setDialogMode(2, "Új mappa", 3, p13createfolderEx, '<input type=text id=p13renameinput maxlength=64 onkeyup=p13fileNameCheck(event) style=width:100% />'); focusTextBox('p13renameinput'); p13fileNameCheck(); }
        ...
        function p13deletefile() { var cc = p13getFileSelCount(), rec = (p13getFileSelDirCount() > 0) ? '<br /><br /><label><input type=checkbox id=p13recdeleteinput>' + "Recurzív törlés" + '</label><br>' : '<input type=checkbox id=p13recdeleteinput style=\'display:none\'>'; setDialogMode(2, "Törlés", 3, p13deletefileEx, (cc > 1) ? (format("A(z) {0} kiválasztott elem törlése?", cc) + rec) : ("Kijelölt elem törlése?" + rec)); }
        ...
        function p13renamefile() { var renamefile, checkboxes = document.getElementsByName('fd'); for (var i = 0; i < checkboxes.length; i++) { if (checkboxes[i].checked) { renamefile = p13filetree.dir[checkboxes[i].value].n; } } setDialogMode(2, "Átnevezés", 3, p13renamefileEx, '<input type=text id=p13renameinput maxlength=64 onkeyup=p13fileNameCheck(event) style=width:100% value="' + renamefile + '" />', { action: 'rename', path: p13filetreelocation.join('/'), oldname: renamefile }); focusTextBox('p13renameinput'); p13fileNameCheck(); }
        ...
        function p13uploadFile() { setDialogMode(2, "Fájl feltöltése", 3, p13uploadFileEx, '<input type=file name=files id=p13uploadinput style=width:100% multiple=multiple onchange="updateUploadDialogOk(\'p13uploadinput\')" />'); updateUploadDialogOk('p13uploadinput'); }
        ...
        function p13viewfile() {
            ...
            for (var i = 0; i < checkboxes.length; i++) {
                if (checkboxes[i].checked) {
                    ...
                    } else { messagebox("Fájl szerkesztő", "Csak 200k-nál kisebb fájlok szerkeszthetők."); }
                    break;
                }
            }
        }
        ...
        function p13pasteFile() {
            ...
            if ((p13clipboard != null) && (p13clipboard.length > 0)) {
                if (p13clipboardCut == 0) {
                    if (p13clipboard.length > 1) { x = format("Megerősíti a {0} bejegyzések másolását erre a helyre?", p13clipboard.length); } else { x = format("Megerősíti 1 bejegyzés másolatát erre a helyre?"); }
                } else {
                    if (p13clipboard.length > 1) { x = format("Megerősíti {0} bejegyzés áthelyezését erre a helyre?", p13clipboard.length); } else { x = format("Megerősíti 1 bejegyzés áthelyezését erre a helyre?"); }
                }
            }
            setDialogMode(2, "Beillesztés", 3, p13pasteFileEx, x);
        }
            ...
            if ((p13clipboard != null) && (p13clipboard.length > 0)) {
                if (p13clipboardCut == 0) {
                    if (p13clipboard.length > 1) {
                        x = format("{0} bejegyzés megtartása másoláshoz" + ', <a href=# onclick="return p13clearClip()" style=cursor:pointer>' + "Törlés" + '</a>.', p13clipboard.length);
                    } else {
                        x = format("1 bejegyzés megtartása másoláshoz" + ', <a href=# onclick="return p13clearClip()" style=cursor:pointer>' + "Törlés" + '</a>.');
                    }
                } else {
                    if (p13clipboard.length > 1) {
                        x = format("{0} bejegyzés megtartása áthehyezéshez" + ', <a href=# onclick="return p13clearClip()" style=cursor:pointer>' + "Törlés" + '</a>.', p13clipboard.length);
                    } else {
                        x = format("1 bejegyzés megtartása áthelyezéshez" + ', <a href=# onclick="return p13clearClip()" style=cursor:pointer>' + "Törlés" + '</a>.');
                    }
                }
            }
        ...
        function p13downloadfile(x, y, z) {
            ...
            setDialogMode(2, "Fájl letöltése", 10, p13downloadFileCancel, '<div>' + EscapeHtml(downloadFile.file) + '</div><br /><progress id=d2progressBar style=width:100% value=0 max=' + z + ' />');
        }
        ...
        */
        ...
        function p13doUploadFiles(files) {
            ...
            if (overWriteCount == 0) {
                ...
                setDialogMode(2, "Fájl feltöltése", 3, p13uploadFileContinue, format((overWriteCount == 1) ? "A feltöltés 1 fájlt ír felül. Folytatja?" : "A feltöltés {0} fájlt felülír. Folytja?", overWriteCount), files);
            }
        }
        ...
        function p13uploadFileContinue(b, files) {
            ...
            setDialogMode(2, "Fájl feltöltése", 10, p13uploadFileCancel, '<div id=p13dfileName>' + "Csatlakozás..." + '</div><br /><progress id=d2progressBar style=width:100% value=0 max=0 />');
            p13uploadNextFile();
        }
        ...
        function updateDeviceDetails(node, hardware, network) {
            ...
            // Operating System
            var x = '';
            if (node.rname) { x += addDetailItem("Név", EscapeHtml(node.rname), s); }
            if (hardware.windows && hardware.windows.osinfo && hardware.windows.osinfo.Description) { x += addDetailItem("Leírás", EscapeHtml(hardware.windows.osinfo.Description), s); }
            if (node.osdesc) { x += addDetailItem("Verzió", EscapeHtml(node.osdesc), s); }
            if (hardware.windows && hardware.windows.osinfo) {
                var m = hardware.windows.osinfo;
                if (m.OSArchitecture) {
                    if (m.OSArchitecture.startsWith('32')) { x += addDetailItem("Architektúra", "32-bit", s); }
                    else if (m.OSArchitecture.startsWith('64')) { x += addDetailItem("Architektúra", "64-bit", s); }
                    else { x += addDetailItem("Architektúra", EscapeHtml(m.OSArchitecture), s); }
                }
                if(m.LastBootUpTime){
                    var thedate = {
                ...
                if(m.Domain){ x += addDetailItem((m.PartOfDomain ? "Domain" : "Munkacsoport"), EscapeHtml(m.Domain), s); }
            }
            ...
            if (node.wsc) {
                var y = [];
                if (node.wsc.antiVirus != null) { if (node.wsc.antiVirus == 'OK') { y.push("AV" + ' - <span style=color:green>' + "OK" + '</span>'); } else { y.push("AV" + ' - <span style=color:red>' + "Rossz" + '</span>'); } }
                if (node.wsc.autoUpdate != null) { if (node.wsc.autoUpdate == 'OK') { y.push("Frissítés" + ' - <span style=color:green>' + "OK" + '</span>'); } else { y.push("Frissítés" + ' - <span style=color:red>' + "Rossz" + '</span>'); } }
                if (node.wsc.firewall != null) { if (node.wsc.firewall == 'OK') { y.push("Tűzfal" + ' - <span style=color:green>' + "OK" + '</span>'); } else { y.push("Tűzfal" + ' - <span style=color:red>' + "Rossz" + '</span>'); } }
                x += addDetailItem("Windows Biztonság", y.join(', '));
            }

            // Defender for Windows Server
            if(node.defender) {
                var y = [];
                if (node.defender.RealTimeProtection != null) { if (node.defender.RealTimeProtection == true) { y.push("RealTimeProtection" + ' - <span style=color:green>' + "On" + '</span>'); } else { y.push("RealTimeProtection" + ' - <span style=color:red>' + "Ki" + '</span>'); } }
                if (node.defender.TamperProtected != null) { if (node.defender.TamperProtected == true) { y.push("TamperProtection" + ' - <span style=color:green>' + "On" + '</span>'); } else { y.push("TamperProtection" + ' - <span style=color:red>' + "Ki" + '</span>'); } }
                if (node.defender.AntivirusSignatureVersion != null) { y.push("Aláírás verzió" + ' - <span style=color:green>' + EscapeHtml(node.defender.AntivirusSignatureVersion) + '</span>'); }
            ...
            if (node.av && node.av.length > 0) {
                ...
                for (var i in node.av) {
                    if (node.av[i].product) {
                        ...
                        if (node.av[i].enabled !== true) { avx += ' - <span style=color:red>' + "Tiltva" + '</span>'; }
                        if (node.av[i].updated !== true) { avx += ' - <span style=color:red>' + "Lejárt" + '</span>'; }
                        if ((node.av[i].enabled == true) && (node.av[i].updated == true)) { avx += ' - <span style=color:green>' + "OK" + '</span>'; }
                        y.push(avx);
                    }
                }
                x += addDetailItem("Antivírus", y.join('<br />'));
            }

            // Active Users
           if (node.users && node.users.length > 0) {
                var u = node.users.map(function(user) {
                    return addKeyLinkConditional(EscapeHtml(user), "Zárolva", (node.lusers && node.lusers.indexOf(user) >= 0));
                }).join(', ');
                x += addDetailItem((node.users.length > 1 ? "Aktív felhasználók" : "Aktív felhasználó"), u);
            }

            if (x != '') { sections.push({ name: "Operációs rendszer ", html: x, img: 'software' }); }
            ...
            if (node.agent) {
                ...
                if ((node.conn & 1) != 0) {
                    x += addDetailItem("Utolsó Agent kapcsolat", "Csatlakoztatva most");
                } else {
                    if (node.lastconnect) { x += addDetailItem("Utolsó Agent kapcsolat", printDateTime(new Date(node.lastconnect))); }
                }
                if (node.lastaddr) {
                    var splitip = node.lastaddr.split(':');
                    if (splitip.length > 2) {
                        // IPv6
                        x += addDetailItem("Utolsó Agent cím", node.lastaddr);
                    } else {
                        // IPv4
                        if (isPrivateIP(node.lastaddr)) {
                            x += addDetailItem("Utolsó Agent cím", splitip[0]);
                        } else {
                            x += addDetailItem("Utolsó Agent cím", '<a href="https://iplocation.com/?ip=' + splitip[0] + '" rel="noreferrer noopener" target="MeshIPLoopup">' + splitip[0] + '</a>');
                        }
                    }
                }
                if (hardware.agentvers != null) {
                    if (hardware.agentvers.compileTime) {
                        try {
                            ...
                            x += addDetailItem("Fordítás ideje", printDateTime(new Date(d)));
                        } catch (ex) { }
                    }
                }
            ...
            if (hardware.mobile) {
                ...
                if (hardware.mobile.device) { x += addDetailItem("Eszköz", EscapeHtml(hardware.mobile.device), s); }
                if (hardware.mobile.bootloader) { x += addDetailItem("Rendszerbetöltő", EscapeHtml(hardware.mobile.bootloader), s); }
                if (hardware.mobile.id) { x += addDetailItem("Azonosító", EscapeHtml(hardware.mobile.id), s); }
                if (hardware.mobile.host) { x += addDetailItem("Gépnév", EscapeHtml(hardware.mobile.host), s); }
                ...
                if (x != '') { sections.push({ name: "Mobile Eszköz", html: x, img: 'mobile' }); }
            }
            ...
            if (network.netif2 != null) {
                ...
                for (var i in network.netif2) {
                    ...
                    if (m.desc) { x += addDetailItem("Leírás", EscapeHtml(m.desc).split('(R)').join('&reg;')); }
                    //if (m.dnssuffix) { x += addDetailItem("DNS Suffix", m.dnssuffix); }
                    if (typeof m[0].mac == 'string') {
                        if (m[0].gatewaymac) {
                            x += addDetailItem("MAC réteg", format("MAC: {0}, Átjáró: {1}", EscapeHtml(m[0].mac), EscapeHtml(m[0].gatewaymac)));
                        } else {
                            x += addDetailItem("MAC réteg", format("MAC: {0}", EscapeHtml(m[0].mac)));
                        }
                    }
                    ...
                    for (var j = 0; j < m.length; j++) {
                        ...
                        if (iplayer.netmask) { items.push(format("Hálózati maszk: {0}", EscapeHtml(iplayer.netmask))); }
                        if (iplayer.gateway) { items.push(format("Átjáró: {0}", EscapeHtml(iplayer.gateway))); }
                        if (items.length > 0) {
                            if (iplayer.family == 'IPv4') { x += addDetailItem("IPv4 réteg", items.join(", ")); }
                            if (iplayer.family == 'IPv6') { x += addDetailItem("IPv6 réteg", items.join(", ")); }
                        }
                    }
                    x += '</div></td></tr>';
                }
                ...
                x += '</table>';
                if (x != '') { sections.push({ name: "Hálózat", html: x, img: 'networking' }); }
            }

            // Attribute: Intel AMT
            if (node.intelamt != null) {
                var x = '';
                x += addDetailItem("Verzió", (node.intelamt.ver) ? ('v' + EscapeHtml(node.intelamt.ver)) : ('<i>' + "Ismeretlen" + '</i>'), s);
                x += addDetailItem("Azonosító", (node.intelamt.uuid) ? (EscapeHtml(node.intelamt.uuid)) : ('<i>' + "Ismeretlen" + '</i>'), s);
                var provisioningStates = { 0: nobreak("Not Activated (Pre)"), 1: nobreak("Not Activated (In)"), 2: nobreak("Aktiválva") };
                ...
                x += addDetailItem("Telepítés (Provisioning) Állapot", ((node.intelamt.state) ? (provisioningStates[node.intelamt.state]) : ('<i>' + "Ismeretlen" + '</i>')) + provisioningMode, s);
                x += addDetailItem("Biztonság", (node.intelamt.tls == 1) ? "TLS használatával védett" : "TLS nincs beállítva", s);
                // Check that the Intel AMT user is setup and there is no warnings (1 = invalid credentials, 8 = trying)
                x += addDetailItem("Adminisztrátor Hitelesítő adatok", ((node.intelamt.user) == null || (node.intelamt.user == '') || ((node.intelamt.warn != null) && ((node.intelamt.warn & 9) != 0))) ? "Nem ismert" : "Ismert", s);
                if (x != '') {
            ...
            if (hardware.identifiers) {
                ...
                // BIOS
                if (ident.bios_vendor) { x += addDetailItem("Forgalmazó", EscapeHtml(ident.bios_vendor), s); }
                if (ident.bios_version) { x += addDetailItem("Verzió", EscapeHtml(ident.bios_version), s); }
                if (ident.bios_serial) { x += addDetailItem("Sorozatszám", EscapeHtml(ident.bios_serial), s); }
                if (ident.bios_mode) { x += addDetailItem("Mode", EscapeHtml(ident.bios_mode), s); }
                if (x != '') { sections.push({ name: "BIOS", html: x, img: 'chip' }); }

                // Motherboard
                x = '';
                if (ident.board_vendor) { x += addDetailItem("Forgalmazó", EscapeHtml(ident.board_vendor), s); }
                if (ident.board_name) { x += addDetailItem("Név", EscapeHtml(ident.board_name), s); }
                if (ident.board_serial && (ident.board_serial != '')) { x += addDetailItem("Sorozatszám", EscapeHtml(ident.board_serial), s); }
                if (ident.board_version) { x += addDetailItem("Verzió", EscapeHtml(ident.board_version), s); }
                if (ident.product_uuid) { x += addDetailItem("Azonosító", EscapeHtml(ident.product_uuid), s); }
                ...
                if (x != '') { sections.push({ name: "Alaplap", html: x, img: 'motherboard' }); }
            }
            ...
            if (hardware.tpm) {
                ...
                if (tpm.ManufacturerId) { x += addDetailItem("Azonosító", EscapeHtml(tpm.ManufacturerId), s); }
                if (tpm.ManufacturerVersion) { x += addDetailItem("Verzió", EscapeHtml(tpm.ManufacturerVersion), s); }
                if (tpm.IsActivated != null) { x += addDetailItem("Aktiválva", (tpm.IsActivated ? "Yes" : "No"), s); }
                if (tpm.IsEnabled != null) { x += addDetailItem("Engedélyezve", (tpm.IsEnabled ? "Yes" : "No"), s); }
            ...
            if (hardware.battery) {
                ...
                for (var i in hardware.battery) {
                    ...
                    x += '<tr><td><div class=style10 style=border-radius:5px;padding:8px>';
                    x += '<div style=margin-bottom:3px><b>' + EscapeHtml(battery.DeviceName ? battery.DeviceName : "Ismeretlen") + '</b></div>';
                    ...
                    if (battery.EstimatedRuntime) { x += addDetailItem("Estimated Runtime", format("{0} perc", Math.floor((battery.EstimatedRuntime / 60))), s); }
                    ...
                    if (battery.Health) { x += addDetailItem("Egészség", format("{0} %", battery.Health), s); }
            ...
            if (hardware.windows) {
                if (hardware.windows.memory && (hardware.windows.memory.length > 0)) {
                    ...
                    for (var i in hardware.windows.memory) {
                        ...
                        if (m.Capacity && m.Speed) { x += addDetailItem("Kapacitás / Sebesség", format("{0} Mb, {1} Mhz", (m.Capacity / 1024 / 1024), m.Speed), s); }
                        else if (m.Capacity) { x += addDetailItem("Kapacitás", format("{0} Mb", (m.Capacity / 1024 / 1024)), s); }
                        if (m.PartNumber) { x += addDetailItem("Cikkszám", EscapeHtml((m.Manufacturer && m.Manufacturer != 'Undefined') ? (m.Manufacturer + ', ') : '') + EscapeHtml(m.PartNumber), s); }
                        x += '</div>';
                    }
                    x += '</table>';

                    if (x != '') { sections.push({ name: "Memória", html: x, img: 'ram' }); }
                }
            }
            ...
            if (hardware.linux) {
                if (hardware.linux.memory && (hardware.linux.memory.Memory_Device.length > 0)) {
                    ...
                    for (var i in hardware.linux.memory.Memory_Device) {
                        ...
                        if (m.Size && m.Speed) { x += addDetailItem("Kapacitás / Sebesség", format("{0}, {1}", m.Size, m.Speed), s); }
                        else if (m.Size) { x += addDetailItem("Kapacitás", format("{0}", (m.Size)), s); }
                        if (m.PartNumber) { x += addDetailItem("Cikkszám", EscapeHtml((m.Manufacturer && m.Manufacturer != 'Undefined')?(m.Manufacturer + ', '):'') + EscapeHtml(m.PartNumber), s); }
                        x += '</div>';
                    }
                    x += '</table>';
            ...
            if (hardware.darwin) {
                if (hardware.darwin.memory && (hardware.darwin.memory.length > 0)) {
                    ...
                    for (var i in hardware.darwin.memory) {
                        ...
                        if (m.PartNumber) { x += addDetailItem("Cikkszám", EscapeHtml((m.Manufacturer && m.Manufacturer != '')?(m.Manufacturer + ', '):'') + EscapeHtml(m.PartNumber), s); }
                        x += '</div>';
                    }
                    x += '</table>';
                    if (x != '') { sections.push({ name: "Memória", html: x, img: 'ram'}); }
            ...
            if (hardware.identifiers && ident.storage_devices) {
                ...
                for (var i in ident.storage_devices) {
                    ...
                    if (m.Size) {
                        ...
                        if (m.Size) {
                            ...
                            if (typeof m.Size == 'number') { x += addDetailItem("Kapacitás", format("{0} Mb", Math.floor(m.Size / 1024 / 1024)), s); }
                            if (typeof m.Size == 'string') { x += addDetailItem("Kapacitás", EscapeHtml(m.Size), s); }
                        }
                        if(hardware.windows && hardware.windows.drives && m.Model){
                            const foundObject = hardware.windows.drives.find(obj => obj['Model'] === m.Model);
                            if(foundObject) x += addDetailItem("Státusz", EscapeHtml(foundObject.Status), s);
                        }
                        x += '</div>';
                    }
                }
                ...
                if (x != '') { sections.push({ name: "Háttértár", html: x, img: 'storage' }); }
            }
            ...
            if (hardware.windows && hardware.windows.volumes) {
                ...
                for (var i in hardware.windows.volumes) {
                    ...
                    if (m.size) {
                        ...
                        x += addDetailItem("Kapacitás", EscapeHtml(fsize), s);
                    }
                    if (m.sizeremaining) {
                        var sizes = ['Bytes', 'KB', 'MB', 'GB', 'TB'];
                    ...
                    if (m.type) {
                        ...
                        x += addDetailItem("File System", (type != '' ? (type + ' / ') : '') + (m.type == 'Unknown' ? "Ismeretlen" : EscapeHtml(m.type)), s);
                    }

                    if (m.protectionStatus || m.volumeStatus) {
                        var bitlockerState = [];
                        if (m.protectionStatus) bitlockerState.push("Engedélyezve");
            ...
            if (hardware.darwin && hardware.darwin.volumes) {
                ...
                for (var i in hardware.darwin.volumes) {
                    ...
                    x += '<div style=margin-bottom:3px><b>' + m.mount_point + '</b></div>';
                    if (m.size) {
                        x += addDetailItem("Kapacitás", EscapeHtml(m.size), s);
                    }
                    if (m.available) {
            ...
            if (x == '') {
                QH('p10detailshtml', "Nincs információ erről az eszközről.");
            } else {
                QH('p10detailshtml', x);
            }
        }
        ...
        function deviceDetailsShowBitlockerInfo(drive, identifier, password) {
            if (xxdialogMode) return false;
            var x = '<div><p>' + "Azonosító" + '</p><p style=user-select:text;font-weight:bold>' + (identifier ? decodeURIComponent(identifier) : "Ismeretlen") + '</p>';
            x += '<p>' + "Recovery Password" + '</p><p style=user-select:text;font-weight:bold>' + (password ? decodeURIComponent(password) : "Ismeretlen") + '</p></div>';
        ...
        */
        ...
        function setupConsole() {
            ...
            if ((rights & 16) != 0) {
                ...
                var onlineText = ((consoleNode.conn & 1) != 0) ? "Online Agent" : "Offline Agent"
                if ((consoleNode.conn & 16) != 0) { onlineText += ", MQTT online" }
                ...
                QH('p15statetext', "Hozzáférés megtagadva");
        ...
        function p15uploadCore(e) {
            ...
            if (e.shiftKey == true) { meshserver.send({ action: 'uploadagentcore', nodeid: consoleNode._id, type: 'default' }); } // Upload default core
                ...
                var htmlValue = '<select id=d3coreMode style=width:230px>' +
                    '<option value=1>' + "Alapértelmezett server core feltöltése" + '</option>' +
                    '<option value=2>' + "Core törlése" + '</option>' +
                    '<option value=3>' + "Core fájl feltöltése" + '</option>' +
                    '<option value=4>' + "Agent lecsatlakoztatása" + '</option>' +
                    '<option value=5>' + "Agent kényszerített lecsatlakoztatása" + '</option>' +
                    '<option value=6>' + "Recovery core feltöltése" + '</option>' +
                    '<option value=7>' + "Tiny core feltöltése" + '</option>' +
                    '<option value=8>' + "Restart agent service" + '</option>' +
                    '<option value=9>' + "Kényszerített Agent frissítés" + '</option></select>';
                setDialogMode(2, "Agent művelet végrehajtása", 3, p15uploadCoreEx, addHtmlValue("Művelet", htmlValue));
            }
        }
        ...
        function p15uploadCore2() {
            ...
            Q('d3auth').value = authCookie;
            Q('d3attrib').value = currentNode._id;
            setDialogMode(4, "Mesh Agent Core feltöltése", 3, p15uploadCoreEx2);
            d3init();
        }
        ...
        function p20updateMesh() {
            ...
            var meshtype = format("Ismeretlen #{0}", currentMesh.mtype);
            var meshrights = GetMeshRights(currentMesh);
            if (currentMesh.mtype == 1) meshtype = "Csak Intel&reg; AMT, agent nélkül";
            if (currentMesh.mtype == 2) meshtype = "Szoftver agent segítségével kezelt";
            if (currentMesh.mtype == 3) { if (currentMesh.relayid == null) { meshtype = "Helyi eszközök, agent nélkül"; } else { meshtype = "No agent devices relayed thru agent"; } }
            if (currentMesh.mtype == 4) { if (currentMesh.relayid == null) { meshtype = "IP-KVM eszköz"; } else { meshtype = "IP-KVM eszköz továbbítva ügynökön keresztül"; } if (currentMesh.kvm.model == 1) { meshtype += ', ' + 'Raritan KX III'; } }

            var x = '';
            x += addHtmlValue("Név", addLinkConditional(EscapeHtml(currentMesh.name), 'p20editmesh(1)', (meshrights & 1) != 0));
            x += addHtmlValue("Leírás", addLinkConditional(((currentMesh.desc && currentMesh.desc != '') ? EscapeHtml(currentMesh.desc) : ('<i>' + "Nincs" + '</i>')), 'p20editmesh(2)', (meshrights & 1) != 0));
            x += addHtmlValue("Típus", meshtype);
            //x += addHtmlValue('Identifier', currentMesh._id.split('/')[2]);

            // Display the relay device if applicable
            if (((currentMesh.mtype == 3) || (currentMesh.mtype == 4)) && (currentMesh.relayid != null)) {
                var relayName = '<i>' + "Ismeretlen" + '</i>';
                var relayNode = getNodeFromId(currentMesh.relayid);
                if (relayNode != null) { relayName = EscapeHtml(relayNode.name); }
                x += addHtmlValue("Relay Eszköz", addLinkConditional(relayName, 'p20editmeshrelay()', (meshrights & 1) != 0));
            }

            // Display IP-KVM information if needed
            if (currentMesh.mtype == 4) {
                x += addHtmlValue("Gépnév", currentMesh.kvm.host);
                x += addHtmlValue("Felhasználó név", currentMesh.kvm.user);
            }

            x += '<br><input type=button value="' + "Jegyzetek" + '" onclick=showNotes(false,"' + encodeURIComponent(currentMesh._id) + '") />';

            x += '<br style=clear:both><br>';
            var currentMeshLinks = currentMesh.links[userinfo._id];
            if (currentMeshLinks && ((currentMeshLinks.rights & 2) != 0)) { x += '<div style=margin-bottom:6px;float:left;margin-right:10px><a onclick=p20showAddMeshUserDialog() style=cursor:pointer><img src=images/icon-addnew.png border=0 height=12 width=12> ' + "Felhasználó hozzáadása" + '</a></div>'; }

            if (navigator.userAgent.toLowerCase().indexOf('android') >= 0) {
                x += '<div style=margin-bottom:6px;float:left;margin-right:10px><a onclick=p20installAndroidDialog() style=cursor:pointer><img src=images/icon-addnew.png border=0 height=12 width=12> ' + "Telepítés erre az eszközre" + '</a></div>';
            }
            ...
            */
            ...
            for (var i in sortedusers) {
                var trash = '', rights = "Részleges jogok", r = sortedusers[i].rights, icon = 2;
                if (r == 0xFFFFFFFF) rights = "Teljes körű adminisztrátor"; else if (r == 0) rights = "Nincsenek jogok";
            ...
            if (meshrights == 0xFFFFFFFF) { x += '<div style=font-size:small;text-align:right;margin-top:6px><span><a onclick=p20showDeleteMeshDialog() style=cursor:pointer>' + "Csoport törlése" + '</a></span></div>'; }
        ...
        function p20showDeleteMeshDialog() {
            if (xxdialogMode) return false;
            var x = format("Biztos, hogy törölni szeretné a {0} csoportot? Az eszközcsoport törlése a csoportba tartozó eszközökre vonatkozó összes információt is törli.", EscapeHtml(currentMesh.name)) + '<br /><br />';
            x += '<label><input id=p20check type=checkbox onchange=p20validateDeleteMeshDialog() />' + "Megerősít" + '</label>';
            setDialogMode(2, "Csoport törlése", 3, p20showDeleteMeshDialogEx, x);
        ...
        function p20editmeshrelay() {
            ...
            if (relayDevices.length == 0) {
                ...
                setDialogMode(2, "Eszközcsoport szerkesztés", 1, null, "Nem állnak rendelkezésre relay eszközök.");
            } else {
                var relayDevices2 = [];
                ...
                var x = addHtmlValue("Relay Eszköz", '<div style=width:170px><select id=d2devrelay style=width:100%>' + relayDevices2.join('') + '</select></div>');
                setDialogMode(2, "Eszközcsoport szerkesztés", 3, p20editmeshrelayEx, x);
            }
        }
        ...
        function p20editmesh(focus) {
            if (xxdialogMode) return;
            var x = addHtmlValue("Név", '<input id=dp20meshname style=width:170px maxlength=32 onchange=p20editmeshValidate() onkeyup=p20editmeshValidate() />');
            x += addHtmlValue("Leírás", '<input id=dp20meshdesc style=width:170px maxlength=1024 onkeyup=p20editmeshValidate() />');
            setDialogMode(2, "Eszközcsoport szerkesztés", 3, p20editmeshEx, x);
        ...
        function p20installAndroidDialog() {
            if (xxdialogMode) return;
            var x = '<div style=text-align:center><p>' + "Telepítse a MeshCentral Agent alkalmazást Android-eszközére. A telepítés után kattintson a párosítási linkre, hogy eszközét ehhez a kiszolgálóhoz csatlakoztassa." + '</p>';
            ...
            x += '<p><a href="' + serverinfo.magenturl + ',' + serverinfo.agentCertHash + ',' + currentMesh._id.split('/')[2] + '"><b>' + "Eszköz párosítás link" + '</b></a></p></div>';
            setDialogMode(2, "Android Telepítés", 1, null, x);
        }
        ...
        function p20showAddMeshUserDialog() {
            ...
            x += '<label><input type=checkbox onchange=p20validateAddMeshUserDialog() id=p20fulladmin>' + "Teljes körű adminisztrátor" + '</label><br>';
            x += '<label><input type=checkbox onchange=p20validateAddMeshUserDialog() id=p20editmesh>' + "Eszközcsoport szerkesztés" + '</label><br>';
            x += '<label><input type=checkbox onchange=p20validateAddMeshUserDialog() id=p20manageusers>' + "Eszközcsoport felhasználók kezelése" + '</label><br>';
            x += '<label><input type=checkbox onchange=p20validateAddMeshUserDialog() id=p20managecomputers>' + "Eszközcsoport számítógépeinek kezelése" + '</label><br>';
            x += '<label><input type=checkbox onchange=p20validateAddMeshUserDialog() id=p20remotecontrol>' + "Távvezérlés" + '</label><br>';
            x += '<label><input type=checkbox onchange=p20validateAddMeshUserDialog() id=p20remoteview style=margin-left:12px>' + "Csak távoli megtekintés" + '</label><br>';
            x += '<label><input type=checkbox onchange=p20validateAddMeshUserDialog() id=p20remotelimitedinput style=margin-left:12px>' + "Csak korlátozott bevitel" + '</label><br>';
            x += '<label><input type=checkbox onchange=p20validateAddMeshUserDialog() id=p20noterminal style=margin-left:12px>' + "Nincs Terminál hozzáférés" + '</label><br>';
            x += '<label><input type=checkbox onchange=p20validateAddMeshUserDialog() id=p20nofiles style=margin-left:12px>' + "Nincs Fájl hozzáférés" + '</label><br>';
            x += '<label><input type=checkbox onchange=p20validateAddMeshUserDialog() id=p20noamt style=margin-left:12px>' + "Nincs Intel&reg; AMT" + '</label><br>';
            x += '<label><input type=checkbox onchange=p20validateAddMeshUserDialog() id=p20meshagentconsole>' + "Konzol" + '</label><br>';
            x += '<label><input type=checkbox onchange=p20validateAddMeshUserDialog() id=p20meshserverfiles>' + "Kiszolgáló fájlok" + '</label><br>';
            x += '<label><input type=checkbox onchange=p20validateAddMeshUserDialog() id=p20wakedevices>' + "Eszközök felébresztése" + '</label><br>';
            x += '<label><input type=checkbox onchange=p20validateAddMeshUserDialog() id=p20editnotes>' + "Eszköz jegyzetek szerkesztése" + '</label><br>';
            x += '<label><input type=checkbox onchange=p20validateAddMeshUserDialog() id=p20limitevents>' + "Csak saját események megjelenítése" + '</label><br>';
            x += '<label><input type=checkbox onchange=p20validateAddMeshUserDialog() id=p20chatnotify>' + "Csevegés és Értesítés" + '</label><br>';
            x += '<label><input type=checkbox onchange=p20validateAddMeshUserDialog() id=p20uninstall>' + "Agent eltávolítása" + '</label><br>';
            x += '<label><input type=checkbox onchange=p20validateAddMeshUserDialog() id=p20commands>' + "Távoli parancsok" + '</label><br>';
            x += '<label><input type=checkbox onchange=p20validateAddMeshUserDialog() id=p20resetoff>' + "Újraindítás / Kikapcsolás" + '</label><br>';
            x += '</div>';
            setDialogMode(2, "Felhasználó hozzáadása az eszköz csoporthoz", 3, p20showAddMeshUserDialogEx, x);
        ...
        function p20viewuser(userid) {
            ...
            if (meshrights == 0xFFFFFFFF) r.push("Teljes körű adminisztrátor"); else {
                if ((meshrights & 1) != 0) r.push("Eszközcsoport szerkesztés");
                if ((meshrights & 2) != 0) r.push("Eszközcsoport felhasználók kezelése");
                if ((meshrights & 4) != 0) r.push("Eszközcsoport számítógépeinek kezelése");
                if ((meshrights & 8) != 0) r.push("Távvezérlés");
                if ((meshrights & 16) != 0) r.push("Agent konzol");
                if ((meshrights & 32) != 0) r.push("Kiszolgáló fájlok");
                if ((meshrights & 64) != 0) r.push("Eszközök felébresztése");
                if ((meshrights & 128) != 0) r.push("Jegyzetek szerkesztése");
                if ((meshrights & 256) != 0) r.push("Csak távoli megtekintés");
                if ((meshrights & 512) != 0) r.push("Nincs terminál");
                if ((meshrights & 1024) != 0) r.push("Nincs Fájlelérés");
                if ((meshrights & 2048) != 0) r.push("Nincs Intel&reg; AMT");
                if (((meshrights & 8) != 0) && ((meshrights & 4096) != 0) && ((meshrights & 256) == 0)) r.push("Korlátozott bevitel");
                if ((meshrights & 8192) != 0) r.push("Csak saját események");
                if ((meshrights & 16384) != 0) r.push("Csevegés és Értesítés");
                if ((meshrights & 32768) != 0) r.push("Eltávolítás");
                if ((meshrights & 131072) != 0) r.push("Parancsok");
                if ((meshrights & 262144) != 0) r.push("Újraindítás / Kikapcsolás");
            }
            if (r.length == 0) { r.push("Nincsenek jogok"); }
            var buttons = 1, uname = userid.split('/')[2];
            if (currentMesh.links[userid].name) { uname = currentMesh.links[userid].name; }
            var x = addHtmlValue("Felhasználó Név", EscapeHtml(uname));
            if (uname != userid.split('/')[2]) { x += addHtmlValue("User ID", EscapeHtml(userid.split('/')[2])); }
            x += addHtmlValue("Jogosultságok", r.join(", "));
            if (((userinfo._id) != userid) && (cmeshrights == 0xFFFFFFFF || (((cmeshrights & 2) != 0) && (meshrights != 0xFFFFFFFF)))) buttons += 4;
            setDialogMode(2, "Eszköz Csoport Felhasználó", buttons, p20viewuserEx, x, userid);
        }
        ...
        function p20viewuserEx(button, userid) {
            ...
            setDialogMode(2, "Távoli Mesh Felhasználó", 3, p20viewuserEx2, format("Megerősíti a(z) {0} felhasználó eltávolítását?", uname), userid);
        }
        ...
        function drawNotifications() {
            ...
            if (notifications.length == 0) {
                r = '<div style=margin:5px>' + "Jelenleg nincsenek értesítések" + '</div>';
            } else {
                for (var i in notifications) {
                    ...
                    r += '<div title="' + format("Történt {0}", printDateTime(d)) + '" id="notifyx' + n.id + '" class=notification style="cursor:pointer;border-top:1px solid ' + ((r == '') ? 'transparent' : 'orange') + '">';
                    if (icon) { r += '<div class=j' + icon + ' onclick="notificationSelected(' + n.id + ')" style=margin:5px;float:left></div>'; }
                    r += '<div onclick="notificationDelete(' + n.id + ')" class=unselectable title="' + "Törölje ezt az értesítést" + '" style=margin:5px;float:right;color:orange><b>X</b></div><div onclick="notificationSelected(' + n.id + ')" style=margin:5px>' + t + EscapeHtml(n.text) + '</div><div style=margin-left:5px;margin-bottom:5px;color:gray;font-size:10px>' + printDateTime(d) + '</div></div>';
                }
            }
            var deleteall = '';
            if (notifications.length > 1) { deleteall = '<div id="notifyRemoveAll" onclick="deleteAllNotifications()" style="cursor:pointer;border-top:1px solid orange;margin:5px;color:orange;text-align:right;padding-right:3px">' + "Összes törlése" + '</div>'; }
        ...
        function addNotification(n) {
            ...
            var translatedMessages = [
                ...
                "Érvénytelen email",
                "Érvénytelen domain",
                "Érvénytelen webhelyengedélyek",
                "A felhasználó már létezik",
                "Ebben a módban nem lehet felhasználót hozzáadni",
                "Érvényesítési kivétel",
                "Elérte a fiókkorlátot.", // 10
                "Csevegés kezdeményezés, kattintson ide az elfogadáshoz.",
                "A legutóbbi bejelentkezés óta {0} sikertelen bejelentkezési kísérlet történt ebbe a fiókba.",
                "Nem sikerült megváltoztatni az e-mail címet, mert egy másik fiók már használja: {0}.",
                "E-mail elküldve.",
                "{0} felhasználó nem található.",
                "{0} felhasználók nem találhatóak.",
                "Hiba, nem lehet átváltani a korábban használt jelszóra.",
                "Hiba, nem lehet átváltani a gyakran használt jelszóra.",
                "Hiba, a jelszó nem módosult.",
                "A jelszó megváltozott.", // 20
                "A jelenlegi jelszó nem megfelelő.",
                "Hiba, a \"{0}\" meghívókód már használatban van.",
                "SMS átjáró nincs engedélyezve",
                "Nincs felhasználói kezelői jog",
                "Érvénytelen SMS üzenet",
                "Ennek a felhasználónak nincs telefonszáma",
                "SMS sikeresen elküldve.",
                "SMS hiba",
                "SMS hiba: {0}",
                "A \"{0}\" e-mail domain nem engedélyezett. Csak ({1}) engedélyezett" // 30
            ];
