<!DOCTYPE html><html lang="nl" dir="ltr" xmlns="http://www.w3.org/1999/xhtml"><head>
    <meta charset="utf-8">
    ...
    <div id="container">
        ...
        <div id="masthead" style="background:url(logo.png) 0px 0px;background-size:341px 50px;background-color:#036;background-repeat:no-repeat;height:50px;width:100%;overflow:hidden">
            ...
            <div id="notificationCount" onclick="clickNotificationIcon()" class="unselectable" style="position:absolute;right:50px;top:0px;font-size:28px;width:50px;height:50px;cursor:pointer;display:none" title="Klik om de huidige meldingen te bekijken"><div id="notificationCount2" style="padding-top:8px">0</div></div>
            ...
            <div id="column_l" style="width:100%;padding:0;position:absolute;bottom:0px;top:0px">
                <div id="p0" style="display:none;width:100%;height:100%">
                    <div style="display:flex;align-items:center;width:100%;height:100%">
                        <div id="p0message" style="text-align:center;width:100%"><span id="p0span">Serververbinding verbroken</span>, <href onclick="reload()" style="cursor:pointer"><u> klik hier om opnieuw verbinding te maken</u></href>.</div>
                    </div>
                </div>
                ...
                <div id="p2" style="display:none;position:absolute;top:0;left:0;right:0;bottom:0">
                    ...
                    <div id="xdevicesBar" style="position:absolute;overflow-y:auto;height:34px;left:0;right:0;bottom:0px;background-color:#aaa;color:black">
                        <div style="margin:4px">
                            ...
                            <label class="noselect"><input type="checkbox" id="RealNameCheckBox" onclick="onRealNameCheckBox()">Besturingssysteem naam</label>
                            ...
                            <div id="p3AccountActions">
                                <div id="p2AccountSecurity" style="display:none">
                                    ...
                                    <div style="margin-left:9px;margin-bottom:8px">
                                        <div id="managePhoneNumber1" style="margin-top:5px;display:none"><a onclick="account_managePhone()" style="cursor:pointer">Beheer telefoonnummer</a> <span id="authPhoneNumberCheck"><strong>✓</strong></span></div>
                                        <div id="manageEmail2FA" style="margin-top:5px;display:none"><a onclick="account_manageAuthEmail()" style="cursor:pointer">Beheer e-mailverificatie</a> <span id="authEmailSetupCheck"><strong>✓</strong></span></div>
                                        <div style="margin-top:5px"><a href="#" onclick="account_showLocalizationSettings()">Lokalisatie instellingen</a></div>
                                        <div id="manageAuthApp" style="margin-top:5px;display:none"><a onclick="account_manageAuthApp()" style="cursor:pointer">Beheer authenticator-app</a> <span id="authAppSetupCheck"><strong>✓</strong></span></div>
                                        <div id="manageOtp" style="margin-top:5px;display:none"><a onclick="account_manageOtp(0)" style="cursor:pointer">Beheer back-up codes</a> <span id="authCodesSetupCheck"><strong>✓</strong></span></div>
                                    </div>
                                </div>
                                <div id="p2AccountActions" style="display:none">
                                    <p><strong>Gebruikersacties</strong></p>
                                    <div style="margin-left:9px;margin-bottom:8px">
                                        <div style="margin-top:5px"><span id="viewPreviousLogins"><a onclick="return account_viewPreviousLogins()" style="cursor:pointer">Bekijk eerdere aanmeldingen</a></span></div>
                                        <div style="margin-top:5px"><span id="managePhoneNumber2" style="display:none"><a onclick="account_managePhone()" style="cursor:pointer">Beheer telefoonnummer</a></span></div>
                                        <div style="margin-top:5px"><span id="verifyEmailId" style="display:none"><a onclick="account_showVerifyEmail()" style="cursor:pointer">Verifieer Email</a></span></div>
                                        <span id="p2AccountPassActions">
                                            <div style="margin-top:5px"><span id="changeEmailId" style="display:none"><a onclick="account_showChangeEmail()" style="cursor:pointer">Verander e-mailadres</a></span></div>
                                            <div style="margin-top:5px"><a onclick="account_showChangePassword()" style="cursor:pointer">Verander wachtwoord</a><span id="p2nextPasswordUpdateTime"></span></div>
                                            <div style="margin-top:5px"><a onclick="account_showDeleteAccount()" style="cursor:pointer">Verwijder account</a></div>
                                        </span>
                                        <div style="margin-top:5px" id="setDarkModeLink"><a onclick="toggleNightMode()" style="cursor:pointer">Schakel donkere modus in</a></div>
                                        <div style="margin-top:5px"><a onclick="showNotes(false)" style="cursor:pointer">Persoonlijke notities</a></div>
                                    </div>
                                <br style="clear:both">
                                </div>
                            </div>
                            <strong>Apparaatgroepen</strong>
                            <span id="p3createMeshLink1">( <a onclick="account_createMesh()" style="cursor:pointer"><img src="images/icon-addnew.png" width="12" height="12" border="0"> Nieuw</a> )</span>
                            <br><br>
                            <div id="p3meshes"></div>
                            <div id="p3noMeshFound" style="margin-left:9px;display:none">Geen apparaatgroepen.<span id="p3createMeshLink2"> <a onclick="account_createMesh()" style="cursor:pointer"><strong>Begin hier!</strong></a></span></div>
                            <br style="clear:both">
                        </div>
                    </div>
                </div>
                <div id="p5" style="display:none">
                    <table cellspacing="0" style="margin:0;padding:0;border-spacing:0;border:0;">
                        <tbody><tr style="padding:0">
                            ...
                            <td>
                                <div style="margin-left:5px">
                                    <strong style="font-size:large">Mijn bestanden</strong><br>
                                </div>
                            </td>
                        </tr>
                    </tbody></table>
                            ...
                            <tbody><tr>
                                <td style="width:100%;background-color:#d3d9d6;text-align:left;padding:4px" valign="bottom">
                                    <div style="width:100%;text-align:center">
                                        <input type="button" style="width:calc(100%/5 - 5px)" id="p5FolderUp" disabled="disabled" onclick="p5folderup()" value="Omhoog">
                                        <input type="button" style="width:calc(100%/5 - 5px)" id="p5SelectAllButton" disabled="disabled" onclick="p5selectallfile()" value="Selecteer alles" onkeypress="return false" onkeydown="return false">
                                        <input type="button" style="width:calc(100%/5 - 5px)" id="p5RenameFileButton" disabled="disabled" value="Hernoemen" onclick="p5renamefile()" onkeypress="return false" onkeydown="return false">
                                        <input type="button" style="width:calc(100%/5 - 5px)" id="p5DeleteFileButton" disabled="disabled" value="Verwijderen" onclick="p5deletefile()" onkeypress="return false" onkeydown="return false">
                                        <input type="button" style="width:calc(100%/5 - 5px)" id="p5NewFolderButton" disabled="disabled" value="Map" onclick="p5createfolder()" onkeypress="return false" onkeydown="return false">
                                    </div>
                                    <div style="width:100%;text-align:center">
                                        <input type="button" style="width:calc(100%/5 - 5px)" id="p5UploadButton" disabled="disabled" value="Uploaden" onclick="p5uploadFile()" onkeypress="return false" onkeydown="return false">
                                        <input type="button" style="width:calc(100%/5 - 5px)" id="p5CutButton" disabled="disabled" value="Knippen" onclick="p5copyFile(1)" onkeypress="return false" onkeydown="return false">
                                        <input type="button" style="width:calc(100%/5 - 5px)" id="p5CopyButton" disabled="disabled" value="Kopiëren" onclick="p5copyFile(0)" onkeypress="return false" onkeydown="return false">
                                        <input type="button" style="width:calc(100%/5 - 5px)" id="p5PasteButton" disabled="disabled" value="Plakken" onclick="p5pasteFile()" onkeypress="return false" onkeydown="return false">
                                        <input type="button" style="width:calc(100%/5 - 5px)" id="p5RefreshButton" value="Verversen" onclick="p5refreshFiles()" onkeypress="return false" onkeydown="return false">
                                    </div>
                                </td>
                            </tr>
                            <tr>
                ...
                <div id="p10" style="display:none;position:absolute;bottom:0;top:0;width:100%;overflow:hidden">
                    ...
                    <div id="p10dialog" style="z-index:1000;background-color:#EEE;box-shadow:0px 0px 15px #666;font-family:Arial,Helvetica,sans-serif;border-radius:5px;position:fixed;top:30px;width:300px;left:30px;display:none">
                        <div style="width:100%;background-color:#003366;color:#FFF;border-radius:5px 5px 0 0">
                            <div style="padding:5px">Toetsenbord sneltoetsen aanpassen</div>
                            <div style="width:100%;margin:6px"></div>
                        </div>
                        <div style="margin-right:16px;margin-left:8px"><div id="p10dialog2" style="margin:auto;margin:3px"></div></div>
                        <div style="width:100%;padding:2px;text-align:center"><input type="button" value="Herstel standaard toetsenbord sneltoetsen" onclick="restoreDeskCustomizeKey()"></div>
                    ...
                    <div id="p10desktop" style="overflow:hidden;position:absolute;top:55px;bottom:0px;width:100%;display:none">
                        <div id="deskarea1" style="position:absolute;top:0px;width:100%;height:32px">
                            <div style="padding-top:2px;padding-bottom:2px;background:#C0C0C0;height:32px">
                                <div style="float:right;text-align:right">
                                    ...
                                    <input type="button" id="deskFullScreen" value="Volledig scherm" onclick="deskToggleFull(event)" onkeypress="return false" onkeydown="return false" disabled="disabled" style="height:28px;margin-right:3px;">
                                </div>
                                <div style="margin-left:3px">
                                    ...
                                    <input type="button" id="connectbutton1h" value="HW verbinden" onclick="connectDesktop(event,2)" onkeypress="return false" onkeydown="return false" disabled="disabled" style="height:28px">
                                    <input type="button" id="disconnectbutton1" value="Verbreken" onclick="connectDesktop(event,0)" onkeypress="return false" onkeydown="return false" style="height:28px">
                                    <span id="deskstatus" style="color:black">Verbroken</span>
                                </div>
                            </div>
                        </div>
                        ...
                        <div id="deskarea4" style="position:absolute;bottom:0px;width:100%;height:32px">
                            <div style="padding-top:2px;padding-bottom:2px;background:#C0C0C0">
                                ...
                                <div>
                                    <input id="deskActionsBtn" type="button" style="margin-left:3px;height:28px" onkeypress="return false" onkeydown="return false" value="Acties" onclick="deviceActionFunction()">
                                    <input type="button" value="Instellingen" onkeypress="return false" onkeydown="return false" onclick="showDesktopSettings()" style="height:28px">
                                    <input type="button" onkeypress="return false" onkeydown="return false" value="Power Actie's..." onclick="showPowerActionDlg()" style="display:none;height:28px">
                                    ...
                                    <input type="button" id="DeskScreens" value="Schermen" onkeypress="return false" onkeydown="return false" onclick="deskSelectScreens()" style="display:none;height:28px">
                                    <label><span id="DeskControlSpan" style="display:none"><input id="DeskControl" type="checkbox" onkeypress="return false" onkeydown="return false">Invoer</span></label>
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div id="termTable" style="position:absolute;top:0;bottom:0;left:0;right:0">
                            <div id="termarea1">
                                <div class="areaHead" style="line-height:24px">
                                    <div class="toright2">
                                        <input type="button" id="termFullScreen" value="Volledig scherm" onclick="deskToggleFull(event)" onkeypress="return false" onkeydown="return false" disabled="disabled" style="height:28px;margin-right:3px;">
                                    ...
                                    <div>
                                        ...
                                        <span id="connectbutton2sspan" style="margin-right:4px"><input type="button" id="connectbutton2s" value="SSH verbinding" style="height:28px" onclick="connectTerminal(event,3)" onkeypress="return false" onkeydown="return false" disabled="disabled"></span>
                                        <span id="disconnectbutton2span" style="margin-left:3px"><input type="button" id="disconnectbutton2" value="Verbreken" style="height:28px" onclick="connectTerminal(event,0)" onkeypress="return false" onkeydown="return false"></span>
                                        <span id="termstatus" style="line-height:22px">Verbroken</span><span id="termtitle"></span>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div id="termarea4" style="position:relative;height:32px;">
                                <div class="areaFoot">
                                    ...
                                    <div style="height:28px">
                                        <input id="termActionsBtn" style="margin-left:3px;height:28px" type="button" title="Voer power acties uit op het apparaat" onkeypress="return false" onkeydown="return false" value="Acties" onclick="deviceActionFunction()">
                            ...
                            <tbody><tr>
                                <td style="background-color:#C0C0C0;border-bottom:2px solid black;padding:2px;line-height:24px">
                                    ...
                                    <div style="margin-left:2px">
                                        ...
                                        <input id="p13Connects" value="SFTP verbinding" onclick="connectFiles(event,2)" onkeypress="return false" onkeydown="return false" type="button">
                                        <input id="p13Disconnect" value="Verbreken" onclick="connectFiles(event)" onkeypress="return false" onkeydown="return false" type="button">
                                        <span class="textOverGray" id="p13Status">Verbroken</span>
                                    </div>
                                </td>
                            </tr>
                            <tr>
                                <td style="width:100%;background-color:#d3d9d6;text-align:left;padding:4px" valign="bottom">
                                    <div style="width:100%;text-align:center">
                                        <input type="button" style="width:calc(100%/5 - 5px)" id="p13FolderUp" disabled="disabled" onclick="p13folderup()" value="Omhoog">
                                        <input type="button" style="width:calc(100%/5 - 5px)" id="p13SelectAllButton" disabled="disabled" onclick="p13selectallfile()" value="Selecteer alles" onkeypress="return false" onkeydown="return false">
                                        <input type="button" style="width:calc(100%/5 - 5px)" id="p13RenameFileButton" disabled="disabled" value="Hernoemen" onclick="p13renamefile()" onkeypress="return false" onkeydown="return false">
                                        <input type="button" style="width:calc(100%/5 - 5px)" id="p13DeleteFileButton" disabled="disabled" value="Verwijderen" onclick="p13deletefile()" onkeypress="return false" onkeydown="return false">
                                        <input type="button" style="width:calc(100%/5 - 5px)" id="p13NewFolderButton" disabled="disabled" value="Map" onclick="p13createfolder()" onkeypress="return false" onkeydown="return false">
                                    </div>
                                    <div style="width:100%;text-align:center">
                                        <input type="button" style="width:calc(100%/5 - 5px)" id="p13UploadButton" disabled="disabled" value="Uploaden" onclick="p13uploadFile()" onkeypress="return false" onkeydown="return false">
                                        <input type="button" style="width:calc(100%/5 - 5px)" id="p13CutButton" disabled="disabled" value="Knippen" onclick="p13copyFile(1)" onkeypress="return false" onkeydown="return false">
                                        <input type="button" style="width:calc(100%/5 - 5px)" id="p13CopyButton" disabled="disabled" value="Kopiëren" onclick="p13copyFile(0)" onkeypress="return false" onkeydown="return false">
                                        <input type="button" style="width:calc(100%/5 - 5px)" id="p13PasteButton" disabled="disabled" value="Plakken" onclick="p13pasteFile()" onkeypress="return false" onkeydown="return false">
                                        <input type="button" style="width:calc(100%/5 - 5px)" id="p13RefreshButton" disabled="disabled" value="Verversen" onclick="p13folderup(9999)" onkeypress="return false" onkeydown="return false">
                                    </div>
                                </td>
                            </tr>
                            <tr>
                            ...
                            <tbody><tr style="height:28px">
                                <td class="areaHead">
                                    <div class="toright2">
                                        ...
                                        <input type="button" id="p15uploadCore" value="Agent actie" onclick="p15uploadCore(event)">
                                    </div>
    ...
    <div id="dialog" style="display:none">
        ...
        <div style="margin-right:16px;margin-left:8px">
            ...
            <div id="dialog4" style="margin:auto;margin:3px">
                ...
                <div id="d3servermode">
                    <div id="d3serveraction" valign="bottom">
                        <input type="button" id="p3FolderUp" disabled="disabled" onclick="d3folderup()" value="Omhoog">&nbsp;<span id="p3CurrentFolder"></span>
                    </div>
            ...
            <div id="dialog7" style="margin:auto;margin:3px">
                <div id="d7meshkvm">
                    <h4 style="width:100%;border-bottom:1px solid gray">Agent Extern bureaublad</h4>
                    <table style="width:100%">
                        <tbody><tr>
                            <td>
                                Kwaliteit
                        ...
                        <tr>
                            <td></td>
                            <td>
                                <label style="display:block" id="d7deskAutoLockLabel"><input type="checkbox" id="d7deskAutoLock">Vergrendelen bij verbreken</label>
                            </td>
                        </tr>
                    </tbody></table>
                </div>
        ...
        <div id="idx_dlgButtonBar" style="padding:10px;margin-bottom:20px">
            <input id="idx_dlgCancelButton" type="button" value="Annuleren" style="float:right;width:80px;margin-left:5px" onclick="dialogclose(0)">
    ...
    <div id="topMenu" style="z-index:1000;background-color:#EEE;box-shadow:0px 0px 15px #666;font-family:Arial,Helvetica,sans-serif;border-radius:0px 0px 5px 5px;position:fixed;top:50px;right:5px;width:170px;display:none">
        <div style="padding:12px;border-top:1px solid gray;color:black;cursor:pointer" onclick="topMenu(2)">Mijn bestanden</div>
        <div style="padding:12px;border-top:1px solid gray;color:black;cursor:pointer" onclick="topMenu(1)">Mijn Account</div>
        <div id="logoutMenuOption"><a id="logoutMenuOptionRef" href="/logout"><div style="padding:12px;border-top:1px solid gray;color:black;cursor:pointer">Uitloggen</div></a></div>
    </div>
    ...
    <script>
        ...
        function onStateChanged(server, state, prevState, errorCode) {
            if (state == 0) {
                ...
                if (prevState == 2) { setTimeout(serverPoll, 5000); } else { QH('p0span', "Kan geen websocket aansluiten"); }
                // Clean up here
        ...
        function updateSelf() {
            ...
            if (typeof userinfo.passchange == 'number') {
                if (userinfo.passchange == -1) { QH('p2nextPasswordUpdateTime', " - Reset bij volgende inlog."); }
                    ...
                    else if (seconds < 3600) { var secs = Math.floor(seconds / 60); QH('p2nextPasswordUpdateTime',format((secs == 1)?" - Herstart in {0} days.":" - Herstart in {0} minuten.", secs)); }
                    else if (seconds < 86400) { var hours = Math.floor(seconds / 3600); QH('p2nextPasswordUpdateTime', format((hours == 1) ? " - Herstart in 1 uur." : " - Herstart in {0} uren.", hours)); }
                    else { var days = Math.floor(seconds / 86400); QH('p2nextPasswordUpdateTime', format((hours == 1) ? " - Herstart in {0} dag." : " - Herstart in {0} dagen.", days)); }
                }
            }
        }
            ...
            switch (message.action) {
                case 'serverinfo': {
                    ...
                    if (serverinfo.certExpire != null) {
                        ...
                        if ((days >= 0) && (days < 20)) {
                            addNotification({ text: format("Certificaat verloopt over {0} dag(en)", days) });
                        }
                    }
                ...
                case 'otpauth-request': {
                    if ((xxdialogMode == 2) && (xxdialogTag == 'otpauth-request')) {
                        if (message.err != null) {
                            var otpauthErrors = ['', "2FA is vergrendeld", "Backup codes zijn vergrendeld", "Inlogtoken in gebruik", "OTP 2FA niet toegestaan", "Account is uitgeschakeld", "Kan OTPLIB niet laden"];
                            if ((message.err > 0) && (message.err < otpauthErrors.length)) { QH('d2optinfo', otpauthErrors[message.err]); } else { QH('d2optinfo', format("Foutmelding #{0}", message.err)); }
                        } else {
                            ...
                            QH('d2optinfo', format("Installeren" + ' <a href="https://play.google.com/store/apps/details?id=com.google.android.apps.authenticator2" rel="noreferrer noopener" target=_blank>' + "Google Authenticator" + '</a> ' + "of een compatibele toepassing, gebruik <a href=\"{0}\" rel=\"noreferrer noopener\" target=_blank>deze link</a> of voer hieronder het geheim in. Voer vervolgens het huidige 6-cijferige token in om 2-staps aanmelding te activeren.", message.url) + '<br /><br /><div style=width:100%;text-align:center><tt id=d2optsecret secret="' + message.secret + '" style=font-size:15px>' + secret + '</tt><br /><br />Token: <input type=text autocomplete="one-time-code" inputmode="numeric" pattern="[0-9]*" onkeypress=\"return (event.keyCode == 8) || (event.charCode >= 48 && event.charCode <= 57)\" onkeyup=account_addOtpCheck(event) onkeydown=account_addOtpCheck() maxlength=6 id=d2otpauthinput type=text></div>');
                            QV('idx_dlgOkButton', true);
                ...
                case 'otpauth-getpasswords': {
                    ...
                    x += '<input type=button value=\'' + "Nieuw token" + '\' onclick=\'account_manageOtp(1);\'></input>';
                    if (message.passwords != null) { x += '<input type=button value=\'' + "Wissen" + '\' onclick=\'account_manageOtp(2);\'></input>'; }
                    x += '</div><br />';
                ...
                case 'verifyPhone': {
                    ...
                    x += '<br /><br /><div style=width:100%;text-align:center>' + "Verificatie code:" + ' <input type=tel pattern="[0-9]" inputmode="number" maxlength=6 id=d2phoneCodeInput onKeyUp=account_managePhoneCodeValidate() onkeypress="if (event.key==\'Enter\') account_managePhoneCodeValidate(1)"></div></table>';
                    setDialogMode(2, "Telefonische meldingen", 3, account_managePhoneConfirm, x, message.cookie);
                    ...
                    if ((xxdialogMode == 2) && (xxdialogTag == 'previousLogins')) {
                        ...
                        if (message.events.length == 0) {
                            ...
                            for (var i in message.events) {
                                ...
                                if (m == 107) { m = "Geldige login"; c = 'BBD1BB'; xx = ''; }
                                else if (m == 108) { m = "Ongeldige 2FA"; c = 'DD9DC3'; xx = 'x'; }
                                else if (m == 109) { m = "Vergrendeld account"; c = 'E1BBBB'; xx = 'x'; }
                                else if (m == 110) { m = "Ongeldig wachtwoord"; c = 'E1BBBB'; xx = 'x'; }
                        ...
                        setDialogMode(2, "Eerdere aanmeldingen", 1, null, x);
                    }
                    break;
                }
                case 'event': {
        ...
        function goStack() {
            ...
            if (idtype == 'files') {
                ...
                if ((features & 0x00040000) && !((userinfo.otpsecret == 1) || (userinfo.otphkeys > 0) || (userinfo.otpkeys > 0) || (userinfo.otpduo > 0) || (userinfo.otpdev > 0) || ((features & 0x00800000) && (userinfo.otpekey == 1)))) { setDialogMode(2, "Gebruikersaccount beveiliging", 1, null, "Kan deze functie niet gebruiken totdat twee-factor authenticatie is ingeschakeld. Dit is vereist voor extra beveiliging. Ga naar \"Mijn account\" en kijk naar de sectie \"Accountbeveiliging\"."); return; }  
                go(5);
            }
        }
        ...
        function account_viewPreviousLogins() {
            if (xxdialogMode) return;
            setDialogMode(2, "Eerdere aanmeldingen", 1, null, "Laden...", 'previousLogins');
        ...
        function account_manageImage(mode) {
            ...
            setDialogMode(2, "Beheer accountafbeelding", 7, account_manageImageEx2, x, user._id);
        ...
        function toggleNightMode() {
            ...
            var x = '<input type=radio id=night0 name=nightmoderadio value=0 ' + ((cNightMode == 0) ? 'checked' : '') + '><label for=night0>' + "Browser standaard" + '</label><br>';
            x += '<input type=radio id=night2 name=nightmoderadio value=2 ' + ((cNightMode == 2) ? 'checked' : '') + '><label for=night2>' + "Lichte modus" + '</label><br>';
            x += '<input type=radio id=night1 name=nightmoderadio value=1 ' + ((cNightMode == 1) ? 'checked' : '') + '><label for=night1>' + "Donkere modus" + '</label><br>';
        ...
        function account_managePhone() {
            ...
            if (userinfo.phone != null) {
                ...
                x += '<td style=text-align:center><div style=padding:6px>' + "Geverifieerd telefoonnummer" + '</div><div style=font-size:20px>' + userinfo.phone + '</div>';
                x += '<div style=margin:10px><label><input id=d2delPhone type=checkbox onclick=account_managePhoneRemoveValidate() />' + "Verwijder telefoonnummer" + '</label></div>';
                setDialogMode(2, "Telefonische meldingen", 3, account_managePhoneRemove, x);
                ...
                x += '<br /><br /><div style=width:100%;text-align:center>' + "Telefoonnummer" + ' <input type=tel pattern="[0-9]" autocomplete="tel" inputmode="tel" maxlength=18 id=d2phoneinput onKeyUp=account_managePhoneValidate() onkeypress="if (event.key==\'Enter\') account_managePhoneValidate(1)"></div></table>';
                setDialogMode(2, "Telefonische meldingen", 3, account_managePhoneAdd, x, 'verifyPhone');
        ...
        function account_showLocalizationSettings() {
            ...
            var x = '<select id=d2locselect style=width:180px><option value="*">' + "Browserwaarde gebruiker" + '</option>';
            ...
            if (serverinfo.languages && serverinfo.languages.length > 0) {
                y += "Als u de taal wilt wijzigen, moet de pagina worden ververst." + '<br /><br />';
                var z = '<select id=d2langselect style=width:180px><option value="*">' + "Browserwaarde gebruiker" + '</option>';
        ...
        function account_showVerifyEmail() {
            ...
            setDialogMode(2, "E-mail verificatie", 3, account_showVerifyEmailEx, x);
        }
        ...
        function account_showChangeEmail() {
            ...
            setDialogMode(2, "E-mailadres wijzigen", 3, account_changeEmail, x);
        ...
        function account_showDeleteAccount() {
            ...
            x += '<input id=account_dlgCancelButton type=button value="' + "Annuleren" + '" style=float:right;width:80px;margin-left:5px onclick=dialogclose(0)>';
        ...
        function account_showChangePassword() {
            ...
            if (passRequirements) {
                ...
                if (rc > 0) { x += '<br /><span style=font-size:x-small>' + format("Vereisten: {0}.", r.join(', ')) + '</span>'; }
            }
            x += '<br />';
        ...
        function account_createMesh() {
            ...
            if ((userinfo.siteadmin != 0xFFFFFFFF) && ((userinfo.siteadmin & 64) != 0)) { setDialogMode(2, "Nieuwe apparaatgroep", 1, null, "Dit account heeft niet de rechten om een nieuwe apparaatgroep te maken."); return; }

            // Remind the user to verify the email address
            if ((userinfo.emailVerified !== true) && (serverinfo.emailcheck == true) && (userinfo.siteadmin != 0xFFFFFFFF)) { setDialogMode(2, "Gebruikersaccount beveiliging", 1, null, "Geen toegang tot een apparaat totdat het e-mailadres is geverifieerd. Dit is vereist voor wachtwoordherstel. Ga naar de \"Mijn account\" om het e-mailadres te wijzigen en te verifiëren."); return; }

            // Remind the user to add two factor authentication
            if ((features & 0x00040000) && !((userinfo.otpsecret == 1) || (userinfo.otphkeys > 0) || (userinfo.otpkeys > 0) || (userinfo.otpduo > 0) || (userinfo.otpdev > 0) || ((features & 0x00800000) && (userinfo.otpekey == 1)))) { setDialogMode(2, "Gebruikersaccount beveiliging", 1, null, "Geen toegang tot een apparaat totdat tweefactorauthenticatie is ingeschakeld. Dit is vereist voor extra beveiliging. Ga naar de \"Mijn account\" en bekijk het gedeelte \"Accountbeveiliging\"."); return; }

            // We are allowed, let's prompt to information
            var x = addHtmlValue("Naam", '<input id=dp3meshname style=width:170px maxlength=64 onchange=account_validateMeshCreate() onkeyup=account_validateMeshCreate() />');
            x += addHtmlValue("Type", '<div style=width:170px;margin:0;padding:0><select id=dp3meshtype style=width:100% onchange=account_validateMeshCreate() ><option value=2>' + "Software Agent Groep" + '</option><option value=1>' + "Alleen Intel&reg; AMT" + '</option></select></div>');
            x += addHtmlValue("Omschrijving", '<div style=width:170px;margin:0;padding:0><textarea id=dp3meshdesc maxlength=1024 style=width:100%;resize:none></textarea></div>');
            setDialogMode(2, "Apparaatgroep aanmaken", 3, account_createMeshEx, x);
        ...
        function getNiceSize(bytes) {
            if (bytes <= 0) return "Opslag overschrijden";
            if (bytes < 2048) return format("{0}b over", bytes);
            if (bytes < 2097152) return format("{0}k over", Math.round(bytes / 1024));
            if (bytes < 2147483648) return format("{0}m over", Math.round(bytes / 1024 / 1024));
            return format("{0}g over", Math.round(bytes / 1024 / 1024 / 1024));
        }
        ...
        function p5showPublicLink(u) { setDialogMode(2, "Publieke link", 1, null, '<input type=text style=width:100% value="' + u + '" readonly />'); }
        ...
        function p5setActions() {
            ...
            Q('p5SelectAllButton').value = (cc > 0 ? "Geen" : "Alles");
        ...
        function p5pasteFile() { var x = ''; if ((p5clipboard != null) && (p5clipboard.length > 0)) { x = format("Bevestig {0} van {1} bestand {2} naar deze locatie?", (p5clipboardCut == 0 ? 'copy' : 'move'), p5clipboard.length, ((p5clipboard.length > 1) ? 's' : '')) } setDialogMode(2, "Plakken", 3, p5pasteFileEx, x); }
        ...
        function p5updateClipview() { var x = ''; if ((p5clipboard != null) && (p5clipboard.length > 0)) { x = format("Houd {0} item {1} vast voor {2}", p5clipboard.length, ((p5clipboard.length > 1) ? 's' : ''), (p5clipboardCut == 0 ? "kopiëren" : "verplaatsen")) + ', <a href=# onclick="return p5clearClip()" style=cursor:pointer>' + "Wissen" + '</a>.' } QH('p5bottomstatus', x); p5setActions(); }
        ...
        function updateDevices() {
            ...
            for (var i in nodes) {
                ...
                if (sort == 0) {
                    ...
                    if (((meshes[nodes[i].meshid]?nodes[i].meshid:'*') != current)) {
                        deviceHeaderSet();
                        var extra = '';
                        if ((meshes[nodes[i].meshid] != null) && (meshes[nodes[i].meshid].mtype == 1)) { extra = '<span style=color:lightgray>' + ", alleen Intel&reg; AMT" + '</span>'; }
                        ...
                        if (meshes[nodes[i].meshid]) {
                            ...
                            r += '</span><span id=MxMESH><i>' + "Individuele apparaten" + '</i></span><span id=DevxHeader' + deviceHeaderId + ' style=color:lightgray></span></div>';
                            current = '*';
                        }
            ...
            if ((sort == 0) && (Q('SearchInput').value == '')) {
                for (var i in meshes) {
                    ...
                    if ((displayedMeshes[mesh._id] == null) && (IsMeshViewable(mesh))) {
                        ...
                        if (mesh.mtype == 1) { r += '<div style=padding:10px><i>' + "Geen Intel&reg; AMT-apparaten in deze groep"; }
                        if (mesh.mtype > 1) { r += '<div style=padding:10px><i>' + "Geen apparaten in deze groep"; }
                        r += '.</i></div></div>';
                        current = mesh._id;
                        count++;
                    }
            ...
            if (count == 0) {
                if ((Q('SearchInput').value != '') || (Q('OnlineCheckBox').checked)) {
                    QH('xdevices', '<div style="margin-top:50px;text-align:center"><span style="font-size:30px">' + "Geen apparaten" + '</span><br /><br />' + "Geen apparaten die overeenkomen met deze zoekopdracht." + ' <a onclick=clearSearchInput() style=cursor:pointer>' + "Wis zoekfilter" + '</a></div>');
                } else {
                    QH('xdevices', '<div style="margin-top:50px;text-align:center"><span style="font-size:30px">' + "Geen apparaten" + '</span><br /><br />' + "Gebruik de desktopversie van deze website om apparaten toe te voegen." + '</div>');
                }
            } else {
                QH('xdevices', r);
            }
            ...
            if ((div.offsetTop >= visibleTop) && (div.offsetTop < visibleBottom)) {
                ...
                if (node.sessions != null) {
                    ...
                    if (node.sessions.battery != null) {
                        ...
                        var statestr = '';
                        if (bat.state == 'ac') { statestr = "Apparaat is aangesloten"; }
                        else if (bat.state == 'dc') { statestr = "Apparaat werkt op batterijen"; }
        ...
        function showDeviceHelpRequests(nodeid, force, e) {
            ...
            if (x != '') { setDialogMode(2, "Hulp verzoeken" + ' - ' + EscapeHtml(node.name), 1, null, x, 'HELPREQ-' + node._id); } else { setDialogMode(0); }
            return false;
        }
        ...
        function showDeviceSessions(nodeid, force, e) {
            ...
            for (var i in node.sessions) {
                if ((i == 'kvm') && (node.sessions.multidesk == null)) {
                    x += '<u>' + "Extern bureaublad" + '</u>';
                    for (var j in node.sessions.kvm) {
                        if (j.startsWith('user/')) {
                            var trash = '';
                            if ((j == userinfo._id) || (GetNodeRights(node) == 0xFFFFFFFF)) { trash = ' <a href=# onclick=\'return endDeviceSession("kvm", "' + encodeURIComponentEx(node._id) + '", "' + encodeURIComponentEx(j) + '")\' title="' + "Deze sessie verbreken" + '" style=cursor:pointer><img src=images/trash.png border=0 height=10 width=10></a>'; }
                            x += addHtmlValue4(getUserName(j), ((node.sessions.kvm[j] == 1) ? "1 sessie" : nobreak(format("{0} sessies", node.sessions.kvm[j]))) + trash);
                        } else if (j == 'busy') {
                            x += addHtmlValue2("Apparaat is bezet", ((node.sessions.kvm[j] == 1) ? "1 sessie" : nobreak(format("{0} sessies", node.sessions.kvm[j]))));
                        }
                    }
                } else if (i == 'multidesk') {
                    x += '<u>' + "Extern bureaublad" + '</u>';
                    for (var j in node.sessions.multidesk) {
                        var trash = '';
                        if ((j == userinfo._id) || (GetNodeRights(node) == 0xFFFFFFFF)) { trash = ' <a href=# onclick=\'return endDeviceSession("multidesk", "' + encodeURIComponentEx(node._id) + '", "' + encodeURIComponentEx(j) + '")\' title="' + "Deze sessie verbreken" + '" style=cursor:pointer><img src=images/trash.png border=0 height=10 width=10></a>'; }
                        x += addHtmlValue4(getUserName(j), ((node.sessions.multidesk[j] == 1) ? "1 sessie" : nobreak(format("{0} sessies", node.sessions.multidesk[j]))) + trash);
                    }
                } else if (i == 'terminal') {
                    x += '<u>' + "Terminal" + '</u>';
                    for (var j in node.sessions.terminal) {
                        var trash = '';
                        if ((j == userinfo._id) || (GetNodeRights(node) == 0xFFFFFFFF)) { trash = ' <a href=# onclick=\'return endDeviceSession("terminal", "' + encodeURIComponentEx(node._id) + '", "' + encodeURIComponentEx(j) + '")\' title="' + "Deze sessie verbreken" + '" style=cursor:pointer><img src=images/trash.png border=0 height=10 width=10></a>'; }
                        x += addHtmlValue4(getUserName(j), ((node.sessions.terminal[j] == 1) ? "1 sessie" : nobreak(format("{0} sessies", node.sessions.terminal[j]))) + trash);
                    }
                } else if (i == 'files') {
                    x += '<u>' + "Bestanden" + '</u>';
                    for (var j in node.sessions.files) {
                        var trash = '';
                        if ((j == userinfo._id) || (GetNodeRights(node) == 0xFFFFFFFF)) { trash = ' <a href=# onclick=\'return endDeviceSession("files", "' + encodeURIComponentEx(node._id) + '", "' + encodeURIComponentEx(j) + '")\' title="' + "Deze sessie verbreken" + '" style=cursor:pointer><img src=images/trash.png border=0 height=10 width=10></a>'; }
                        x += addHtmlValue4(getUserName(j), ((node.sessions.files[j] == 1) ? "1 sessie" : nobreak(format("{0} sessies", node.sessions.files[j]))) + trash);
                    }
                } else if (i == 'tcp') {
                    x += '<u>' + "TCP routering" + '</u>';
                    for (var j in node.sessions.tcp) {
                        var trash = '';
                        if ((j == userinfo._id) || (GetNodeRights(node) == 0xFFFFFFFF)) { trash = ' <a href=# onclick=\'return endDeviceSession("tcp", "' + encodeURIComponentEx(node._id) + '", "' + encodeURIComponentEx(j) + '")\' title="' + "Deze sessie verbreken" + '" style=cursor:pointer><img src=images/trash.png border=0 height=10 width=10></a>'; }
                        x += addHtmlValue4(getUserName(j), ((node.sessions.tcp[j] == 1) ? "1 sessie" : nobreak(format("{0} sessies", node.sessions.tcp[j]))) + trash);
                    }
                } else if (i == 'udp') {
                    x += '<u>' + "UDP routering" + '</u>';
                    for (var j in node.sessions.udp) {
                        var trash = '';
                        if ((j == userinfo._id) || (GetNodeRights(node) == 0xFFFFFFFF)) { trash = ' <a href=# onclick=\'return endDeviceSession("udp", "' + encodeURIComponentEx(node._id) + '", "' + encodeURIComponentEx(j) + '")\' title="' + "Deze sessie verbreken" + '" style=cursor:pointer><img src=images/trash.png border=0 height=10 width=10></a>'; }
                        x += addHtmlValue4(getUserName(j), ((node.sessions.udp[j] == 1) ? "1 sessie" : nobreak(format("{0} sessies", node.sessions.udp[j]))) + trash);
                    }
                }
            }
            if (x != '') { setDialogMode(2, "Sessies" + ' - ' + EscapeHtml(node.name), 1, null, x, 'SESSIONS-' + node._id); } else { setDialogMode(0); }
        }
        ...
        function showDeviceMessages(nodeid, force, e) {
            ...
            x += '</div>';
            if (count > 0) setDialogMode(2, "Agent berichten" + ' - ' + EscapeHtml(node.name), 1, null, x, 'MESSAGES-' + node._id);
            return false;
        }

        var powerStatetable = ['', "Ingeschakeld", "Slaapstand", "Slaapstand", "Slaapstand", "Slaapstand", "Uitzetten", "Aanwezig", "Uit"];
        var powerStateStrings = ['', "Ingeschakeld", "Slapen", "Slapen", "Slaapstand", "Slaapstand", "softwarematig uit", "Aanwezig", "Uit"];
        var powerStateStrings2 = ['', "Apparaat is ingeschakeld", "Apparaat bevindt zich in slaapstand (S1)", "Apparaat bevindt zich in slaapstand (S2)", "Apparaat bevindt zich in diepe slaapstand (S3)", "Apparaat is in slaapstand (S4)", "Apparaat is uitgeschakeld (S5)", "Apparaat is aanwezig, maar de status kan niet worden bepaald", "Het apparaat is uitgeschakeld"];
        ...
        function NodeStateStr(node) {
            ...
            if (node.conn) {
                if ((node.conn & 1) != 0) { states.push('<span>' + ((node.mtype == 4) ? ((node.porttype == 'PDU') ? "Schakelaar" : "IP-KVM") : "Agent") + '</span>'); }
        ...
        function deviceHeaderSet() {
            ...
            deviceHeaders['DevxHeader' + deviceHeaderId] = ', ' + deviceHeaderTotal + ((deviceHeaderTotal == 1) ? " apparaat" : " apparaten");
            var title = '';
        ...
        */
        ...
        function gotoDevice(nodeid, panel, refresh) {
            ...
            if (!currentNode || currentNode._id != node._id || refresh == true) {
                ...
                if ((currentNode.sessions != null) && (currentNode.sessions.battery != null)) {
                    ...
                    var statestr = '';
                    if (bat.state == 'ac') { statestr = "Apparaat is aangesloten"; }
                    if (bat.state == 'dc') { statestr = "Apparaat werkt op batterijen"; }
                ...
                // Attribute: Mesh
                if (mesh) { x += addDeviceAttribute('<span>' + "Groep" + '</span>', '<a onclick=goForward("' + node.meshid + '") style=cursor:pointer>' + EscapeHtml(meshes[node.meshid].name) + '</a>'); }

                // Attribute: Name
                if (node.rname != null) { x += addDeviceAttribute('<span>' + "Naam" + '</span>', '<span>' + EscapeHtml(node.rname) + '</span>'); }

                // Attribute: Host
                if ((((features & 1) == 0) && (node.mtype != 4)) || (node.mtype == 3)) { // If not WAN-only, local hostname is in use
                    if ((meshrights & 4) != 0) {
                        if (node.host) {
                            x += addDeviceAttribute("Hostnaam", '<span onclick=showEditNodeValueDialog(1) style=cursor:pointer>' + EscapeHtml(node.host) + '</span>');
                        } else {
                            x += addDeviceAttribute("Hostnaam", '<span onclick=showEditNodeValueDialog(1) style=cursor:pointer><i>' + "Geen" + '</i></span>');
                        }
                    } else {
                        x += addDeviceAttribute("Hostnaam", EscapeHtml(node.host));
                    }
                }
                ...
                if ((meshrights & 4) != 0) {
                    x += addDeviceAttribute("Omschrijving", '<span onclick=showEditNodeValueDialog(2) style=cursor:pointer>' + description + '</span>');
                } else {
                ...
                // IP-KVM information
                if (node.mtype == 4) {
                    if (node.portnum != null) { x += addDeviceAttribute("Poortnummer", node.portnum); }
                    if (node.porttype != null) { x += addDeviceAttribute("Poort type", node.porttype); }
                }

                // Attribute: Mesh Agent
                if ((node.agent != null) && (node.agent.id != null) && (node.mtype == 3)) {
                    if (node.agent.id == 4) { x += addDeviceAttribute("Apparaatsoort", "Windows"); }
                    if (node.agent.id == 6) { x += addDeviceAttribute("Apparaatsoort", "Linux"); }
                    if (node.agent.id == 29) { x += addDeviceAttribute("Apparaatsoort", "macOS"); }
                    ...
                    if ((node.agent.root === false) && ((node.conn & 1) != 0)) { str += ', ' + "Beperkt"; }
                ...
                if (node.intelamt != null) {
                    ...
                    if (node.intelamt.ver != null && node.intelamt.state == null) { str += '<i>' + nobreak("Onbekende staat") + '</i>, v' + EscapeHtml(node.intelamt.ver); }
                    else if ((node.intelamt.ver == null) && (node.intelamt.state == 2)) { str += '<i>' + "Geactiveerd" + '</i>'; }
                    ...
                    if (node.intelamt.state == 2) {
                        if (node.intelamt.tls == 1) { str += ', <span title="' + "Intel&reg; AMT is ingesteld met TLS-netwerkbeveiliging" + '">' + "TLS" + '</span>'; }
                        ...
                        if (node.intelamt.user == null || node.intelamt.user == '') { // If credentials are not set, allow setting them.
                            ...
                            var warn = null;
                            if ((node.intelamt.warn & 1) != 0) { warn = "Ongeldige inloggegevens"; }
                            if ((node.intelamt.warn & 8) != 0) { warn = "Inloggegevens proberen"; }
                            if (warn != null) {
                                if ((meshrights & 4) != 0) {
                                    str += ', <i style=color:#FF0000;cursor:pointer title="' + "Bewerk Intel&reg; AMT-gegevens" + '" onclick=editDeviceAmtSettings("' + node._id + '")>' + warn + '</i>';
                                    editUserCredentialsIcon = true;
                                } else {
                ...
                if (connectivity && connectivity > 1) {
                    var cstate = [];
                    if ((node.conn & 1) != 0) cstate.push('<span>' + ((node.mtype == 4) ? ((node.porttype == 'PDU') ? "Schakelaar" : "IP-KVM") : "Agent") + '</span>');
                ...
                if ((node.ssh != null) || (node.rdp != null)) {
                    var y = [];
                    if ((meshrights & 4) != 0) {
                        if (node.ssh != null) { y.push('<span onclick=showClearSshDialog(3) style=cursor:pointer>' + ((node.ssh == 1) ? "SSH-gebruiker+wachtwoord" : ((node.ssh == 2) ? "SSH-gebruiker+sleutel+wachtwoord" : "SSH-gebruiker+sleutel")) + ' <img class=hoverButton src="images/link5.png" width=10 height=10 /></span>'); }
                        ...
                        if (node.ssh != null) { y.push(((node.ssh == 1) ? "SSH-gebruiker+wachtwoord" : ((node.ssh == 2) ? "SSH-gebruiker+sleutel+wachtwoord" : "SSH-gebruiker+sleutel"))); }
                        if (node.rdp != null) { y.push("RDP"); }
                    }
                    x += addDeviceAttribute("Inloggegevens", y.join(', '));
                }

                x += '</table><br />';
                // Show action button, only show if we have permissions 4, 8, 64
                if (((meshrights & (4 + 8 + 64 + 262144)) != 0) && (node.mtype < 3)) { x += '<input type=button value="' + "Acties" + '" onclick=deviceActionFunction() />'; }
                x += '<input type=button value="' + "Notities" + '" onclick=showNotes(' + ((meshrights & 128) == 0) + ',"' + encodeURIComponent(node._id) + '") />';
                ...
                if ((node.mtype == 4) && (connectivity & 1)) {
                    if (node.porttype == 'PDU') {
                        if (node.pwr == 1) {
                            if (meshrights & 0x40000) { x += '<input type=button value="' + "Uitschakelen" + '" title="' + "Uitschakelen" + '" onclick=setIpPduState(0) />'; }
                        } else if (node.pwr == 8) {
                            if (meshrights & 0x40) { x += '<input type=button value="' + "Inschakelen" + '" title="' + "Inschakelen" + '" onclick=setIpPduState(1) />'; }
                        }
                    } else {
                        if (meshrights & 8) { x += '<input type=button value="' + "Extern beheer" + '" title="' + "Extern beheer" + '" onclick=openIpKvmRemoteControl("' + encodeURIComponentEx(node._id) + '") />'; }x
                    }
                }
                ...
                if ((meshrights & 0x8000) != 0) { x += '<a style=cursor:pointer onclick=p10showDeleteNodeDialog("' + node._id + '")>' + "Verwijder apparaat" + '</a>'; }
                ...
                if ((connectivity & 1) != 0) { if (powerstate.length > 0) { powerstate += ', '; } powerstate += ((node.mtype == 4) ? ((node.porttype == 'PDU') ? "Schakelaar" : "IP-KVM") : "Mesh Agent"); }
                if ((connectivity & 2) != 0) { if (powerstate.length > 0) { powerstate += ', '; } powerstate += "Intel&reg; AMT verbonden"; }
                else if ((connectivity & 4) != 0) { if (powerstate.length > 0) { powerstate += ', '; } powerstate += "Intel&reg; AMT gedetecteerd"; }
                if ((connectivity & 16) != 0) { if (powerstate.length > 0) { powerstate += ', '; } powerstate += "MQTT-kanaal verbonden"; }
        ...
        function setIpPduState(op) {
            if (op == 0) {
                setDialogMode(2, "Power Operation", 3, function () { meshserver.send({ action: 'poweraction', nodeids: [currentNode._id], actiontype: 2 }); }, "Uitschakelen uitvoeren?"); // Turn off
            } else {
                setDialogMode(2, "Power Operation", 3, function () { meshserver.send({ action: 'wakedevices', nodeids: [currentNode._id] }); }, "Inschakelen uitvoeren?"); // Turn on
            }
        }
        ...
        function setupDeviceMenu(op, obj) {
            ...
            var menus = [];
            if (currentDevicePanel != 0) { menus.push({ n: "Algemeen", f: 'setupDeviceMenu(0)' }); }
            ...
            ) { menus.push({ n: "Bureaublad", f: 'setupDeviceMenu(1)' }); }
            ...
            if ((currentDevicePanel != 2) && (currentNode != null) && (meshrights & 8) && ((meshrights == 0xFFFFFFFF) || ((meshrights & 1024) == 0)) && ((currentNode.mtype != 1) && (currentNode.agent) && (currentNode.agent.caps & 4))) { menus.push({ n: "Bestanden", f: 'setupDeviceMenu(2)' }); }
        ...
        function deviceActionFunction() {
            ...
            if ((currentNode.agent != null) && (currentNode.agent.id == 14)) {
                if (((currentNode.conn & 1) != 0) && ((rights & 8) != 0)) {
                    count++;
                    y += '<option value=400>' + "Flits" + '</option>';
                    y += '<option value=401>' + "Trillen" + '</option>';
                    z += '<div id=d2devicetimediv>' + addHtmlValue("Tijd", '<select id=d2devicetime style=float:right;width:170px><option value=1000>' + "1 seconde" + '</option><option value=5000>' + "5 seconden" + '</option><option value=10000>' + "10 seconden" + '</option></select>') + '</div>';
                }
            } else {
                if ((rights & 64) != 0) { count++; y += '<option value=100>' + "Wakker worden" + '</option>'; } // Wake-up permission
                //if (((currentNode.conn & 1) != 0) && ((rights & 131072) != 0)) { count++; y += '<option value=106>' + "Run Commands" + '</option>'; } // Remote command permission
                if ((currentNode.conn != 0) && ((rights & 262144) != 0)) { count++; y += '<option value=4>' + "Slaapstand" + '</option><option value=3>' + "Herstarten" + '</option><option value=2>' + "Uitzetten" + '</option>'; }
                ...
                if ((currentNode.intelamt != null) && (currentNode.intelamt.state == 2) && ((currentNode.conn & 6) != 0) && ((rights & 262144) != 0)) {
                    ...
                    y += '<option value=308>' + "Intel&reg; AMT Afsluiten" + '</option>';
                }
                if ((currentNode.intelamt != null) && (currentNode.intelamt.state == 2) && ((currentNode.conn & 6) != 0) && ((rights & 64) != 0)) {
                    count++;
                    y += '<option value=302>' + "Intel&reg; AMT Opstarten" + '</option>';
                }
            ...
            if (count == 0) { x = "Er zijn momenteel geen acties beschikbaar voor dit apparaat."; }
            setDialogMode(2, "Apparaatactie", (count == 0) ? 2 : 3, deviceActionFunctionEx, x + z);
        ...
        function deviceActionFunctionEx() {
            ...
            if (op == 100) {
                ...
                */
                ...
                setDialogMode(2, "Intel&reg; AMT in werking", 3, function () { meshserver.send({ action: 'poweraction', nodeids: [currentNode._id], actiontype: parseInt(op) }); }, "Uitvoeren Intel&reg; AMT inschakelen?");
            } else if (op == 308) { // Intel AMT power off
                setDialogMode(2, "Intel&reg; AMT in werking", 3, function () { meshserver.send({ action: 'poweraction', nodeids: [currentNode._id], actiontype: parseInt(op) }); }, "Voer Intel&reg; AMT uit?<br><br><b>LET OP: Als er een actieve AMT-sessie is, wordt het uitschakelcommando afgewezen, dus u moet eerst de verbinding met de AMT-sessie verbreken!</b>");
            } else if (op == 310) { // Intel AMT reset
                setDialogMode(2, "Intel&reg; AMT in werking", 3, function () { meshserver.send({ action: 'poweraction', nodeids: [currentNode._id], actiontype: parseInt(op) }); }, "Uitvoeren Intel&reg; AMT reset?");
        ...
        function showNotes(readonly, noteid) {
            ...
            if (noteid.startsWith('node%2F%2F')) { x += '<span style=font-size:10px>' + "Apparaatgroepnotities kunnen worden bekeken en gewijzigd door andere apparaatgroepbeheerders." + '<span>'; }
            setDialogMode(2, "Notities", 3, showNotesEx, x, noteid);
        ...
        function deviceLockFunction() {
            if ((xxdialogMode != null || xxdialogMode == 0) && (desktop != null) && (desktop.contype == 1)) { setDialogMode(2, "Vergrendel het bureaublad", 3, function() { if ((desktop != null) && (desktop.contype == 1)) { desktop.sendCtrlMsg('{"ctrlChannel":"102938","type":"lock"}'); } }, "Bureaublad van gebruiker vergrendelen?"); }
        }

        function deviceChat(e) {
            if (xxdialogMode) return;
            setDialogMode(2, "Apparaatactie", 3, function () {
        ...
        function deviceUrlFunction() {
            if (xxdialogMode) return;
            setDialogMode(2, "Open pagina op apparaat", 3, deviceUrlFunctionEx, '<input id=d2devurl placeholder="http://server.com" style=width:100%;overflow-y:scroll onkeyup=deviceUrlFunctionValidate() onchange=deviceUrlFunctionValidate()></input>');
            Q('d2devurl').focus();
        ...
        function d2runCommandDialog(options) {
            ...
            if ((wintype == true) || (linuxtype == true) || (agenttype == true)) {
                ...
                if (wintype == true) { x += '<option value=1' + ((runopt.type == 1)?' selected':'') + '>' + "Windows opdrachtprompt" + '</option><option value=2' + ((runopt.type == 2)?' selected':'') + '>' + "Windows PowerShell" + '</option>'; }
                ...
                x += '</select>';
                x += '<select id=d2cmduser style=width:100%;margin-bottom:4px><option value=0' + ((runopt.runAs == 0)?' selected':'') + '>' + "Uitvoeren als agent" + '</option><option value=1' + ((runopt.runAs == 1)?' selected':'') + '>' + "Uitvoeren als gebruiker, agent als er geen gebruiker is" + '</option><option value=2' + ((runopt.runAs == 2)?' selected':'') + '>' + "Moet als gebruiker worden uitgevoerd" + '</option></select>';
                if (options.selectedFile == null) {
                    x += '<select id=d2cmdsource onclick=d2runCommandValidate() style=width:100%;margin-bottom:4px><option value=0' + ((runopt.source == 0)?' selected':'') + '>' + "Opdrachten uit tekstvak" + '</option><option value=1' + ((runopt.source == 1)?' selected':'') + '>' + "Opdrachten uit bestand" + '</option>';
                    if (userinfo.siteadmin & 8) { x += '<option value=2' + ((runopt.source == 2)?' selected':'') + '>' + "Opdrachten uit een bestand op de server" + '</option>'; }
                ...
                setDialogMode(2, "Voer opdrachten uit", 3, d2groupActionFunctionRunCommands, x, options);
                if (options.selectedFile == null) {
                    Q('d2runcmd').focus();
        ...
        function editDeviceAmtSettings(nodeid, func) {
            ...
            x += addHtmlValue("Gebruikersnaam", '<input id=dp10username style=width:170px maxlength=32 autocomplete=nope placeholder="admin" onchange=validateDeviceAmtSettings() onkeyup=validateDeviceAmtSettings() />');
            ...
            if ((features2 & 1) == 0) { x += addHtmlValue("Beveiliging", '<select id=dp10tls style=width:176px><option value=0>' + "Geen TLS beveiliging" + '</option><option value=1>' + "TLS beveiliging vereist" + '</option></select>'); }
        ...
        function p10showDeleteNodeDialog(nodeid) {
            if (xxdialogMode) return;
            setDialogMode(2, "Verwijder apparaat", 3, p10showDeleteNodeDialogEx, format("Verwijder {0}?", EscapeHtml(currentNode.name)) + '<br /><br /><label><input id=p10check type=checkbox onchange=p10validateDeleteNodeDialog() />' + "Bevestig" + '</label>', nodeid);
        ...
        function showClearSshDialog() { setDialogMode(2, "Bewerk apparaat", 3, showClearSshDialogEx, "SSH-inloggegevens wissen?"); }
        function showClearSshDialogEx(button, mode) { meshserver.send({ action: 'changedevice', nodeid: currentNode._id, ssh: 0 }); }
        function showClearRdpDialog() { setDialogMode(2, "Bewerk apparaat", 3, showClearRdpDialogEx, "RDP inloggegevens wissen?"); }
        function showClearRdpDialogEx(button, mode) { meshserver.send({ action: 'changedevice', nodeid: currentNode._id, rdp: 0 }); }

        var showEditNodeValueDialog_modes = ["Apparaat naam", "Hostnaam", "Omschrijving", "Tags"];
        var showEditNodeValueDialog_modes2 = ['name', 'host', 'desc', 'tags'];
        var showEditNodeValueDialog_modes3 = ['', '', '', "Groep1, Groep2, Groep3"];
        ...
        var agentConsoleMessages = ['', "Wachten op toestemming van de gebruiker...", "Geweigerd", "Kan externe terminalsessie niet starten, {0} ({1})", "Time-out", "Ongeldige netwerkgegevens ontvangen"];
        ...
        function updateDeskShortcutKeys() {
            var x = '<div class="menuButton" onclick="deskMenuButton(-1)">' + "Aanpassen" + '</div>';
        ...
        var keyStrings = { 8: "BackSpace", 9: "Tab", 13: "invoeren", 27: "Escape", 32: "Spatie", 44: "Print Screen", 45: "Insert", 46: "Del", 36: "Home", 35: "End", 32: "Ruimte", 33: "Page Up", 34: "Page Down", 37: "Links", 38: "Omhoog", 39: "Rechts", 40: "Omlaag", 0: "Geen" }
        ...
        function deskCustomizeKeys() {
            ...
            x += '</select> <input type=button value=' + "Toevoegen" + ' onclick=addDeskCustomizeKey() /></div>';
            QH('p10dialog2', x);
            xxdialogMode = 2;
            QV('p10dialog', true);
        ...
        function deskUpdateShortcutList() {
            ...
            if (x == '') { x = '<i>' + "Geen toetsenbord snelkoppelingen gedefinieerd" + '</i>'; }
            QH('d2shortcuts', x);
        }
        ...
        function sendSpecialKeys() {
            if (xxdialogMode || desktop == null || desktop.State != 3) return;
            setDialogMode(3, "Speciale toetsen", 3, deskSendKeys);
        }
        ...
        function deskSelectScreens() {
            ...
            x = addHtmlValue4("Scherm", '<select style=width:100% id=deskdisplays>' + x + '</select>');
            setDialogMode(2, "Scherm Selectie", 3, deskSelectScreensEx, x);
        }
        ...
        function updateTerminalButtons() {
            ...
            if (((termState == true) && (terminal.contype != 3)) || (terminalNode.agent == null) || (terminalNode.agent.id == 3) || (terminalNode.agent.id == 4)) {
                ...
                QH('terminalCustomUpperRight', '<a style=cursor:pointer onclick=cmsshportaction(1,event)>' + format("SSH poort {0}", (terminalNode.sshport ? terminalNode.sshport : 22)) + '</a>');
            }
        }

        function cmsshportaction(action) {
            if (xxdialogMode) return;
            var x = "SSH externe verbindingspoort:" + '<br /><br /><input type=text placeholder="22" inputmode="numeric" pattern="[0-9]*" onkeypress="return (event.keyCode == 8) || (event.charCode >= 48 && event.charCode <= 57)" maxlength=5 id=d10sshport type=text>';
            setDialogMode(2, "SSH verbinding", 3, function () {
        ...
        function sshTunnelAuthDialog(j, func) {
            var x = '';
            if (j.askkeypass) {
                x += addHtmlValue("Authenticatie", '<select id=dp2authmethod style=width:150px onchange=sshAuthUpdate(event)><option value=3 selected>' + "Opgeslagen sleutel" + '</option><option value=1>' + "Gebruikersnaam wachtwoord" + '</option><option value=2>' + "Gebruikersnaam en sleutel" + '</option></select>');
            } else {
                x += addHtmlValue("Authenticatie", '<select id=dp2authmethod style=width:150px onchange=sshAuthUpdate(event)><option value=1 selected>' + "Gebruikersnaam wachtwoord" + '</option><option value=2>' + "Gebruikersnaam en sleutel" + '</option></select>');
            }
            x += '<div id=d2userauth style=display:none>';
            x += addHtmlValue("Gebruikersnaam", '<input id=dp2user style=width:150px maxlength=64 autocomplete=off onkeyup=sshAuthUpdate(event) />');
            x += '</div>';
            x += '<div id=d2passauth style=display:none>';
            x += addHtmlValue("Wachtwoord", '<input type=password id=dp2pass style=width:150px maxlength=64 autocomplete=off onkeyup=sshAuthUpdate(event) />');
            if ((features2 & 0x00400000) == 0) { x += '<label><input id=dp2keep type=checkbox>' + "Onthoud inloggegevens" + '</label>'; }
            x += '</div><div id=d2keyauth style=display:none>';
            x += addHtmlValue("Sleutelbestand", '<input type=file id=dp2key style=width:150px maxlength=64 autocomplete=off onchange=sshAuthUpdate(event) />' + '<div id=d2badkey style=font-size:x-small>' + "Het sleutelbestand moet de OpenSSH-indeling hebben." + '</div>');
            x += addHtmlValue("Sleutelwachtwoord", '<input type=password id=dp2keypass style=width:150px maxlength=64 autocomplete=off onkeyup=sshAuthUpdate(event) />');
            if ((features2 & 0x00400000) == 0) {
                x += '<label><input id=dp2keep1 type=checkbox onchange=sshAuthUpdate(event)>' + "Onthoud gebruikeruser & sleutel" + '</label><br/>';
                x += '<label><input id=dp2keep2 type=checkbox>' + "Onthoud wachtwoord" + '</label>';
            }
            x += '</div>';
            if (j.askkeypass) {
                x += '<div id=d2keyauth2 style=display:none>';
                x += addHtmlValue("Wachtwoord", '<input type=password id=dp2keypass2 style=width:150px maxlength=64 autocomplete=off onkeyup=sshAuthUpdate(event) />');
                x += '</div>';
            }
            setDialogMode(2, "Authenticatie", 11, func, x, 'ssh');
            Q('dp2user').focus();
            sshAuthUpdate();
            ...
            if (typeof data == 'string') {
                if (data[0] == '{') {
                    ...
                    switch (j.action) {
                        ...
                        case 'autherror': { p12setConsoleMsg("Authenticatiefout", 5000); break; }
                        case 'sessionerror': { p12setConsoleMsg("Sessie verlopen", 5000); break; }
                        case 'sessiontimeout': { p12setConsoleMsg("Sessie timeout", 5000); break; }
                    }
                } else if (data[0] == '~') {
        ...
        */
        ...
        function p13gotFiles(data) {
            ...
            switch (data.action) {
                ...
                case 'autherror': { p13setConsoleMsg("Authenticatiefout", 5000); return; }
                case 'connectionerror': { p13setConsoleMsg("verbindingsfout", 5000); return; }
                case 'sessionerror': { p13setConsoleMsg("Sessie verlopen", 5000); return; }
                case 'sessiontimeout': { p13setConsoleMsg("Sessie timeout", 5000); return; }
            }
        ...
        function p13setActions() {
            ...
            if (p13filetree == null) {
                ...
                Q('p13SelectAllButton').value = "Alles";
                ...
                Q('p13SelectAllButton').value = (cc > 0 ? "Geen" : "Alles");
            ...
            if (((filesState == true) && (files.contype != 2)) || (filesNode.agent == null) || (filesNode.agent.id == 3) || (filesNode.agent.id == 4)) {
                ...
                QH('filesCustomUpperRight', '<a style=cursor:pointer onclick=cmsshportaction(1,event)>' + format("SSH poort {0}", (filesNode.sshport ? filesNode.sshport : 22)) + '</a>');
            }
        ...
        function p13pasteFile() {
            ...
            if ((p13clipboard != null) && (p13clipboard.length > 0)) {
                if (p13clipboardCut == 0) {
                    if (p13clipboard.length > 1) { x = format("Bevestig de kopie van {0} inzendingen naar deze locatie?", p13clipboard.length); } else { x = format("Bevestig kopiëren van 1 bestand naar deze locatie?"); }
                } else {
                    if (p13clipboard.length > 1) { x = format("Bevestig de verplaatsing van {0} items naar deze locatie?", p13clipboard.length); } else { x = format("Verplaatsing van 1 bestand naar deze locatie bevestigen?"); }
                }
            }
        ...
        function p13downloadfile(x, y, z) {
            ...
            setDialogMode(2, "Download bestand", 10, p13downloadFileCancel, '<div>' + EscapeHtml(downloadFile.file) + '</div><br /><progress id=d2progressBar style=width:100% value=0 max=' + z + ' />');
        }
        ...
        */
        ...
        function p13doUploadFiles(files) {
            ...
            if (overWriteCount == 0) {
                ...
                setDialogMode(2, "Upload bestand", 3, p13uploadFileContinue, format((overWriteCount == 1) ? "Upload overschrijft {0} bestand. Doorgaan?" : "Upload overschrijft {0} bestanden. Doorgaan?", overWriteCount), files);
            }
        }
        ...
        function updateDeviceDetails(node, hardware, network) {
            ...
            // Operating System
            var x = '';
            if (node.rname) { x += addDetailItem("Naam", EscapeHtml(node.rname), s); }
            if (hardware.windows && hardware.windows.osinfo && hardware.windows.osinfo.Description) { x += addDetailItem("Omschrijving", EscapeHtml(hardware.windows.osinfo.Description), s); }
            if (node.osdesc) { x += addDetailItem("Versie", EscapeHtml(node.osdesc), s); }
            if (hardware.windows && hardware.windows.osinfo) {
                var m = hardware.windows.osinfo;
                if (m.OSArchitecture) {
                    if (m.OSArchitecture.startsWith('32')) { x += addDetailItem("Architectuur", "32-bits", s); }
                    else if (m.OSArchitecture.startsWith('64')) { x += addDetailItem("Architectuur", "64-bits", s); }
                    else { x += addDetailItem("Architectuur", EscapeHtml(m.OSArchitecture), s); }
                }
                if(m.LastBootUpTime){
                    var thedate = {
                    ...
                    x += addDetailItem("Tijd van laatste opstart", date);
                }
                if(m.Domain){ x += addDetailItem((m.PartOfDomain ? "Domein" : "Werkgroep"), EscapeHtml(m.Domain), s); }
            }
            ...
            if (node.wsc) {
                var y = [];
                if (node.wsc.antiVirus != null) { if (node.wsc.antiVirus == 'OK') { y.push("Anti-virus" + ' - <span style=color:green>' + "OK" + '</span>'); } else { y.push("Anti-virus" + ' - <span style=color:red>' + "Uitgeschakeld" + '</span>'); } }
                if (node.wsc.autoUpdate != null) { if (node.wsc.autoUpdate == 'OK') { y.push("Bijwerken" + ' - <span style=color:green>' + "OK" + '</span>'); } else { y.push("Bijwerken" + ' - <span style=color:red>' + "Uitgeschakeld" + '</span>'); } }
                if (node.wsc.firewall != null) { if (node.wsc.firewall == 'OK') { y.push("Firewall" + ' - <span style=color:green>' + "OK" + '</span>'); } else { y.push("Firewall" + ' - <span style=color:red>' + "Uitgeschakeld" + '</span>'); } }
                x += addDetailItem("Windows Beveiliging", y.join(', '));
            }

            // Defender for Windows Server
            if(node.defender) {
                var y = [];
                if (node.defender.RealTimeProtection != null) { if (node.defender.RealTimeProtection == true) { y.push("RealTimeProtection" + ' - <span style=color:green>' + "Aan" + '</span>'); } else { y.push("RealTimeProtection" + ' - <span style=color:red>' + "Uit" + '</span>'); } }
                if (node.defender.TamperProtected != null) { if (node.defender.TamperProtected == true) { y.push("Pauzeer bescherming" + ' - <span style=color:green>' + "Aan" + '</span>'); } else { y.push("Pauzeer bescherming" + ' - <span style=color:red>' + "Uit" + '</span>'); } }
                if (node.defender.AntivirusSignatureVersion != null) { y.push("Handtekeningversie" + ' - <span style=color:green>' + EscapeHtml(node.defender.AntivirusSignatureVersion) + '</span>'); }
            ...
            if (node.av && node.av.length > 0) {
                ...
                x += addDetailItem("Anti-virus", y.join('<br />'));
            }

            // Active Users
           if (node.users && node.users.length > 0) {
                var u = node.users.map(function(user) {
                    return addKeyLinkConditional(EscapeHtml(user), "Vergrendeld", (node.lusers && node.lusers.indexOf(user) >= 0));
                }).join(', ');
                x += addDetailItem((node.users.length > 1 ? "Actieve gebruikers" : "Actieve gebruiker"), u);
            }

            if (x != '') { sections.push({ name: "Besturingssysteem", html: x, img: 'software' }); }
            ...
            if (node.agent) {
                ...
                if (node.firstconnect) { x += addDetailItem("Eerste agentverbinding", printDateTime(new Date(node.firstconnect))); }
                if ((node.conn & 1) != 0) {
                    x += addDetailItem("Laatste agentverbinding", "Nu verbonden");
                } else {
                    if (node.lastconnect) { x += addDetailItem("Laatste agentverbinding", printDateTime(new Date(node.lastconnect))); }
                }
                if (node.lastaddr) {
                    var splitip = node.lastaddr.split(':');
                    if (splitip.length > 2) {
                        // IPv6
                        x += addDetailItem("Laatste agentadres", node.lastaddr);
                    } else {
                        // IPv4
                        if (isPrivateIP(node.lastaddr)) {
                            x += addDetailItem("Laatste agentadres", splitip[0]);
                        } else {
                            x += addDetailItem("Laatste agentadres", '<a href="https://iplocation.com/?ip=' + splitip[0] + '" rel="noreferrer noopener" target="MeshIPLoopup">' + splitip[0] + '</a>');
                        }
                    }
                }
                if (hardware.agentvers != null) {
                    if (hardware.agentvers.compileTime) {
                        try {
                            ...
                            x += addDetailItem("Compileer tijd", printDateTime(new Date(d)));
                        } catch (ex) { }
                    }
                }
                if (hardware.time != null) {
                    x += addDetailItem("Laatste details update", printDateTime(new Date(hardware.time)));
                }
            ...
            if (hardware.mobile) {
                ...
                if (hardware.mobile.device) { x += addDetailItem("Apparaat", EscapeHtml(hardware.mobile.device), s); }
                ...
                if (hardware.mobile.host) { x += addDetailItem("Hostnaam", EscapeHtml(hardware.mobile.host), s); }
                if (hardware.mobile.androidapi && hardware.mobile.androidrelease) { x += addDetailItem("Android Versie", EscapeHtml(hardware.mobile.androidrelease + ', API Level ' + hardware.mobile.androidapi), s); }
                if (x != '') { sections.push({ name: "Mobiel apparaat", html: x, img: 'mobile' }); }
            }
            ...
            if (network.netif2 != null) {
                ...
                for (var i in network.netif2) {
                    ...
                    if (m.desc) { x += addDetailItem("Omschrijving", EscapeHtml(m.desc).split('(R)').join('&reg;')); }
                    //if (m.dnssuffix) { x += addDetailItem("DNS Suffix", m.dnssuffix); }
                    if (typeof m[0].mac == 'string') {
                        if (m[0].gatewaymac) {
                            x += addDetailItem("MAC Laag", format("MAC: {0}, Gateway: {1}", EscapeHtml(m[0].mac), EscapeHtml(m[0].gatewaymac)));
                        } else {
                            x += addDetailItem("MAC Laag", format("MAC: {0}", EscapeHtml(m[0].mac)));
                        }
                    }
                    if (typeof m[0].speed == 'number' && (m[0].speed != 9223372036854775807 && m[0].speed > 0)) {
                        x += addDetailItem("Interfacesnelheid", format("{0}", getNetworkSpeed(m[0].speed)));
                    }
                    for (var j = 0; j < m.length; j++) {
                        ...
                        if (items.length > 0) {
                            if (iplayer.family == 'IPv4') { x += addDetailItem("IPv4 Laag", items.join(", ")); }
                ...
                x += '</table>';
                if (x != '') { sections.push({ name: "Netwerken", html: x, img: 'networking' }); }
            }

            // Attribute: Intel AMT
            if (node.intelamt != null) {
                var x = '';
                x += addDetailItem("Versie", (node.intelamt.ver) ? ('v' + EscapeHtml(node.intelamt.ver)) : ('<i>' + "Onbekend" + '</i>'), s);
                x += addDetailItem("Identifier", (node.intelamt.uuid) ? (EscapeHtml(node.intelamt.uuid)) : ('<i>' + "Onbekend" + '</i>'), s);
                var provisioningStates = { 0: nobreak("Niet geactiveerd (Pre)"), 1: nobreak("Niet geactiveerd (In)"), 2: nobreak("Geactiveerd") };
                ...
                x += addDetailItem("Provisioning Staat", ((node.intelamt.state) ? (provisioningStates[node.intelamt.state]) : ('<i>' + "Onbekend" + '</i>')) + provisioningMode, s);
                x += addDetailItem("Beveiliging", (node.intelamt.tls == 1) ? "Beveiligd met TLS" : "TLS is niet ingesteld", s);
                // Check that the Intel AMT user is setup and there is no warnings (1 = invalid credentials, 8 = trying)
                x += addDetailItem("Beheerdersreferenties", ((node.intelamt.user) == null || (node.intelamt.user == '') || ((node.intelamt.warn != null) && ((node.intelamt.warn & 9) != 0))) ? "Onbekend" : "Bekend", s);
                if (x != '') {
                    if ((typeof node.intelamt.sku == 'number') && ((node.intelamt.sku & 16) != 0)) {
                        sections.push({ name: "Intel&reg; Standaard beheerbaarheid (Intel&reg; SM)", html: x, img: 'amt' });
                    } else {
            ...
            if (hardware.identifiers) {
                ...
                // BIOS
                if (ident.bios_vendor) { x += addDetailItem("Fabrikant", EscapeHtml(ident.bios_vendor), s); }
                if (ident.bios_version) { x += addDetailItem("Versie", EscapeHtml(ident.bios_version), s); }
                if (ident.bios_serial) { x += addDetailItem("Serie nummer", EscapeHtml(ident.bios_serial), s); }
                if (ident.bios_mode) { x += addDetailItem("Mode", EscapeHtml(ident.bios_mode), s); }
                if (x != '') { sections.push({ name: "BIOS", html: x, img: 'chip' }); }

                // Motherboard
                x = '';
                if (ident.board_vendor) { x += addDetailItem("Fabrikant", EscapeHtml(ident.board_vendor), s); }
                if (ident.board_name) { x += addDetailItem("Naam", EscapeHtml(ident.board_name), s); }
                if (ident.board_serial && (ident.board_serial != '')) { x += addDetailItem("Serie nummer", EscapeHtml(ident.board_serial), s); }
                if (ident.board_version) { x += addDetailItem("Versie", EscapeHtml(ident.board_version), s); }
                ...
                if (x != '') { sections.push({ name: "Moederbord", html: x, img: 'motherboard' }); }
            }
            ...
            if (hardware.tpm) {
                ...
                if (tpm.ManufacturerVersion) { x += addDetailItem("Versie", EscapeHtml(tpm.ManufacturerVersion), s); }
                if (tpm.IsActivated != null) { x += addDetailItem("Geactiveerd", (tpm.IsActivated ? "Ja" : "Nee"), s); }
                if (tpm.IsEnabled != null) { x += addDetailItem("Ingeschakeld", (tpm.IsEnabled ? "Ja" : "Nee"), s); }
                if (tpm.IsOwned != null) { x += addDetailItem("Eigendom", (tpm.IsOwned ? "Ja" : "Nee"), s); }
            ...
            if (hardware.battery) {
                ...
                for (var i in hardware.battery) {
                    ...
                    x += '<tr><td><div class=style10 style=border-radius:5px;padding:8px>';
                    x += '<div style=margin-bottom:3px><b>' + EscapeHtml(battery.DeviceName ? battery.DeviceName : "Onbekend") + '</b></div>';
                    if (battery.CycleCount) { x += addDetailItem("Cyclustelling", EscapeHtml(battery.CycleCount), s); }
                    if (battery.FullChargedCapacity) { x += addDetailItem("Volledig opgeladen capaciteit", format("{0} mWh", battery.FullChargedCapacity), s); }
                    if (battery.EstimatedRuntime) { x += addDetailItem("Geschatte looptijd", format("{0} minuten", Math.floor((battery.EstimatedRuntime / 60))), s); }
                    if (battery.Chemistry) { x += addDetailItem("Scheikunde", EscapeHtml(battery.Chemistry), s); }
                    if (battery.DesignedCapacity) { x += addDetailItem("Ontwerpcapaciteit", format("{0} mWh", battery.DesignedCapacity), s); }
                    if (battery.ManufactureDate) { x += addDetailItem("Fabricagedatum", EscapeHtml(battery.ManufactureDate), s); }
                    if (battery.ManufactureName) { x += addDetailItem("Naam van fabrikant", EscapeHtml(battery.ManufactureName), s); }
                    if (battery.SerialNumber) { x += addDetailItem("Serienummer", EscapeHtml(battery.SerialNumber), s); }
                    if (battery.ChargeRate) { x += addDetailItem("Kostentarief", format("{0} mW", battery.ChargeRate), s); }
                    if (battery.Charging != null) { x += addDetailItem("Opladen", (battery.Charging ? "Ja" : "Nee"), s); }
                    if (battery.DischargeRate) { x += addDetailItem("Ontladingssnelheid", format("{0} mW", battery.DischargeRate), s); }
                    if (battery.Discharging != null) { x += addDetailItem("Ontladen", (battery.Discharging ? "Ja" : "Nee"), s); }
                    if (battery.RemainingCapacity) { x += addDetailItem("Resterende capaciteit", format("{0} mWh", battery.RemainingCapacity), s); }
                    if (battery.Voltage) { x += addDetailItem("Spanning", format("{0} V", (battery.Voltage / 1000)), s); }
                    if (battery.Health) { x += addDetailItem("Gezondheid", format("{0} %", battery.Health), s); }
                    if (battery.BatteryCharge) { x += addDetailItem("Batterij opladen", format("{0} %", battery.BatteryCharge), s); }   
                    x += '</div>';
                }
                x += '</table>';
                if (x != '') { sections.push({ name: "Batterij", html: x, img: 'battery'}); }
            }
            ...
            if (hardware.windows) {
                if (hardware.windows.memory && (hardware.windows.memory.length > 0)) {
                    ...
                    for (var i in hardware.windows.memory) {
                        ...
                        if (m.Capacity && m.Speed) { x += addDetailItem("Capaciteit / snelheid", format("{0} Mb, {1} Mhz", (m.Capacity / 1024 / 1024), m.Speed), s); }
                        else if (m.Capacity) { x += addDetailItem("Capaciteit", format("{0} Mb", (m.Capacity / 1024 / 1024)), s); }
                        if (m.PartNumber) { x += addDetailItem("Onderdeel nummer", EscapeHtml((m.Manufacturer && m.Manufacturer != 'Undefined') ? (m.Manufacturer + ', ') : '') + EscapeHtml(m.PartNumber), s); }
                        x += '</div>';
                    }
                    x += '</table>';

                    if (x != '') { sections.push({ name: "Geheugen", html: x, img: 'ram' }); }
                }
            }
            ...
            if (hardware.linux) {
                if (hardware.linux.memory && (hardware.linux.memory.Memory_Device.length > 0)) {
                    ...
                    for (var i in hardware.linux.memory.Memory_Device) {
                        ...
                        if (m.Size && m.Speed) { x += addDetailItem("Capaciteit / snelheid", format("{0}, {1}", m.Size, m.Speed), s); }
                        else if (m.Size) { x += addDetailItem("Capaciteit", format("{0}", (m.Size)), s); }
                        if (m.PartNumber) { x += addDetailItem("Onderdeel nummer", EscapeHtml((m.Manufacturer && m.Manufacturer != 'Undefined')?(m.Manufacturer + ', '):'') + EscapeHtml(m.PartNumber), s); }
                        x += '</div>';
                    }
                    x += '</table>';
            ...
            if (hardware.darwin) {
                if (hardware.darwin.memory && (hardware.darwin.memory.length > 0)) {
                    ...
                    for (var i in hardware.darwin.memory) {
                        ...
                        if (m.PartNumber) { x += addDetailItem("Onderdeel nummer", EscapeHtml((m.Manufacturer && m.Manufacturer != '')?(m.Manufacturer + ', '):'') + EscapeHtml(m.PartNumber), s); }
                        x += '</div>';
                    }
                    x += '</table>';
                    if (x != '') { sections.push({ name: "Geheugen", html: x, img: 'ram'}); }
            ...
            if (hardware.identifiers && ident.storage_devices) {
                ...
                for (var i in ident.storage_devices) {
                    ...
                    if (m.Size) {
                        ...
                        if (m.Size) {
                            ...
                            if (typeof m.Size == 'number') { x += addDetailItem("Capaciteit", format("{0} Mb", Math.floor(m.Size / 1024 / 1024)), s); }
                            if (typeof m.Size == 'string') { x += addDetailItem("Capaciteit", EscapeHtml(m.Size), s); }
                        }
                ...
                if (x != '') { sections.push({ name: "Opslag", html: x, img: 'storage' }); }
            }
            ...
            if (hardware.windows && hardware.windows.volumes) {
                ...
                for (var i in hardware.windows.volumes) {
                    ...
                    if (m.size) {
                        ...
                        x += addDetailItem("Capaciteit", EscapeHtml(fsize), s);
                    }
                    if (m.sizeremaining) {
                        var sizes = ['Bytes', 'KB', 'MB', 'GB', 'TB'];
                        ...
                        x += addDetailItem("Resterende capaciteit", EscapeHtml(fsize), s);
                    }
                    if (m.type) {
                        var type = (m.removable == true ? "Verwijderbaar" : (m.cdrom == true ? "CD-ROM" : ''));
                        x += addDetailItem("Bestandssysteem", (type != '' ? (type + ' / ') : '') + (m.type == 'Unknown' ? "Onbekend" : EscapeHtml(m.type)), s);
                    }

                    if (m.protectionStatus || m.volumeStatus) {
                        var bitlockerState = [];
                        if (m.protectionStatus) bitlockerState.push("Ingeschakeld");
                        if (m.volumeStatus && m.volumeStatus == 'FullyDecrypted') bitlockerState.push("Volledig gedecodeerd");
                        if (m.volumeStatus && m.volumeStatus == 'EncryptionInProgress') bitlockerState.push("Versleuteling wordt uitgevoerd");
                        if (m.volumeStatus && m.volumeStatus == 'FullyEncrypted') bitlockerState.push("Volledig gecodeerd");
                ...
                if (x != '') { sections.push({ name: "Opslagvolumes", html: '<table style=width:100%>' + x + '</table>', img: 'storage'}); }
            }
            ...
            if (hardware.darwin && hardware.darwin.volumes) {
                ...
                for (var i in hardware.darwin.volumes) {
                    ...
                    x += '<div style=margin-bottom:3px><b>' + m.mount_point + '</b></div>';
                    if (m.size) {
                        x += addDetailItem("Capaciteit", EscapeHtml(m.size), s);
                    }
                    if (m.available) {
                        x += addDetailItem("Resterende capaciteit", EscapeHtml(m.available), s);
                    }
                    if (m.type) {
                        var type = (m.removable == true ? "Verwijderbaar" : (m.cdrom == true ? "CD-ROM" : ''));
                        x += addDetailItem("Bestandssysteem", (type != '' ? (type + ' / ') : '') + (m.type == 'Unknown' ? "Onbekend" : EscapeHtml(m.type)), s);
            ...
            if (x == '') {
                QH('p10detailshtml', "Geen informatie over dit apparaat.");
            } else {
                QH('p10detailshtml', x);
            }
        }
        ...
        function deviceDetailsShowBitlockerInfo(drive, identifier, password) {
            if (xxdialogMode) return false;
            var x = '<div><p>' + "Identifier" + '</p><p style=user-select:text;font-weight:bold>' + (identifier ? decodeURIComponent(identifier) : "Onbekend") + '</p>';
            x += '<p>' + "Herstelwachtwoord" + '</p><p style=user-select:text;font-weight:bold>' + (password ? decodeURIComponent(password) : "Onbekend") + '</p></div>';
            setDialogMode(2, decodeURIComponent(drive) + ': ' + "BitLocker informatie", 1, null, x, '');
        }
        ...
        */
        ...
        function p15uploadCore(e) {
            ...
            if (e.shiftKey == true) { meshserver.send({ action: 'uploadagentcore', nodeid: consoleNode._id, type: 'default' }); } // Upload default core
                ...
                var htmlValue = '<select id=d3coreMode style=width:230px>' +
                    '<option value=1>' + "Upload standaard serverkern" + '</option>' +
                    '<option value=2>' + "Maak de kern leeg" + '</option>' +
                    '<option value=3>' + "Upload een kernbestand" + '</option>' +
                    '<option value=4>' + "Softwarematig verbreken agent" + '</option>' +
                    '<option value=5>' + "Harde ontkoppeling agent" + '</option>' +
                    '<option value=6>' + "Upload herstelkern" + '</option>' +
                    '<option value=7>' + "Upload een kleine core" + '</option>' +
                    '<option value=8>' + "Restart agent service" + '</option>' +
                    '<option value=9>' + "Forceer agent update" + '</option></select>';
                setDialogMode(2, "Agentactie uitvoeren", 3, p15uploadCoreEx, addHtmlValue("Actie", htmlValue));
            }
        }
        ...
        function p20updateMesh() {
            ...
            if (currentMesh.mtype == 1) meshtype = "Alleen Intel&reg; AMT, geen agent";
            if (currentMesh.mtype == 2) meshtype = "Beheerd met behulp van een software-agent";
            if (currentMesh.mtype == 3) { if (currentMesh.relayid == null) { meshtype = "Lokale apparaten, geen agent"; } else { meshtype = "Geen apparaten doorgestuurd via agent"; } }
            if (currentMesh.mtype == 4) { if (currentMesh.relayid == null) { meshtype = "IP-KVM device"; } else { meshtype = "IP-KVM-apparaat doorgestuurd via agent"; } if (currentMesh.kvm.model == 1) { meshtype += ', ' + 'Raritan KX III'; } }
            ...
            if (((currentMesh.mtype == 3) || (currentMesh.mtype == 4)) && (currentMesh.relayid != null)) {
                var relayName = '<i>' + "Onbekend" + '</i>';
                var relayNode = getNodeFromId(currentMesh.relayid);
                if (relayNode != null) { relayName = EscapeHtml(relayNode.name); }
                x += addHtmlValue("Doorstuur apparaat", addLinkConditional(relayName, 'p20editmeshrelay()', (meshrights & 1) != 0));
            }

            // Display IP-KVM information if needed
            if (currentMesh.mtype == 4) {
                x += addHtmlValue("Hostnaam", currentMesh.kvm.host);
                x += addHtmlValue("Gebruikersnaam", currentMesh.kvm.user);
            }

            x += '<br><input type=button value="' + "Notities" + '" onclick=showNotes(false,"' + encodeURIComponent(currentMesh._id) + '") />';

            x += '<br style=clear:both><br>';
            var currentMeshLinks = currentMesh.links[userinfo._id];
            if (currentMeshLinks && ((currentMeshLinks.rights & 2) != 0)) { x += '<div style=margin-bottom:6px;float:left;margin-right:10px><a onclick=p20showAddMeshUserDialog() style=cursor:pointer><img src=images/icon-addnew.png border=0 height=12 width=12> ' + "Gebruiker toevoegen" + '</a></div>'; }

            if (navigator.userAgent.toLowerCase().indexOf('android') >= 0) {
                x += '<div style=margin-bottom:6px;float:left;margin-right:10px><a onclick=p20installAndroidDialog() style=cursor:pointer><img src=images/icon-addnew.png border=0 height=12 width=12> ' + "Installeren on dit apparaat" + '</a></div>';
            }
            ...
            */
            ...
            for (var i in sortedusers) {
                var trash = '', rights = "Gedeeltelijke rechten", r = sortedusers[i].rights, icon = 2;
            ...
            if (meshrights == 0xFFFFFFFF) { x += '<div style=font-size:small;text-align:right;margin-top:6px><span><a onclick=p20showDeleteMeshDialog() style=cursor:pointer>' + "Verwijder groep" + '</a></span></div>'; }
        ...
        function p20editmeshrelay() {
            ...
            if (relayDevices.length == 0) {
                ...
                setDialogMode(2, "Bewerk apparaatgroep", 1, null, "Geen relay apparaten beschikbaar.");
            } else {
                var relayDevices2 = [];
                ...
                var x = addHtmlValue("Doorstuur apparaat", '<div style=width:170px><select id=d2devrelay style=width:100%>' + relayDevices2.join('') + '</select></div>');
                setDialogMode(2, "Bewerk apparaatgroep", 3, p20editmeshrelayEx, x);
            }
        }
        ...
        function p20editmesh(focus) {
            if (xxdialogMode) return;
            var x = addHtmlValue("Naam", '<input id=dp20meshname style=width:170px maxlength=32 onchange=p20editmeshValidate() onkeyup=p20editmeshValidate() />');
            x += addHtmlValue("Omschrijving", '<input id=dp20meshdesc style=width:170px maxlength=1024 onkeyup=p20editmeshValidate() />');
        ...
        function p20installAndroidDialog() {
            if (xxdialogMode) return;
            var x = '<div style=text-align:center><p>' + "Installeer de MeshCentral Agent op uw Android apparaat. Na installatie klikt u op de koppelingslink om uw apparaat met deze server te verbinden." + '</p>';
            ...
            x += '<p><a rel=\"noreferrer noopener\" target=_blank href="meshagents?id=14' + (urlargs.key?('&key=' + urlargs.key):'') + '" title="' + "APK versie van de MeshAgent" + '">' + "Android APK" + '</a></p>';
            x += '<p><a href="' + serverinfo.magenturl + ',' + serverinfo.agentCertHash + ',' + currentMesh._id.split('/')[2] + '"><b>' + "Apparaat koppelingslink" + '</b></a></p></div>';
            setDialogMode(2, "Android installatie", 1, null, x);
        }
        ...
        function p20showAddMeshUserDialog() {
            ...
            x += '<label><input type=checkbox onchange=p20validateAddMeshUserDialog() id=p20uninstall>' + "Deïnstallatie agent" + '</label><br>';
            x += '<label><input type=checkbox onchange=p20validateAddMeshUserDialog() id=p20commands>' + "Externe opdrachten" + '</label><br>';
            x += '<label><input type=checkbox onchange=p20validateAddMeshUserDialog() id=p20resetoff>' + "Reset / uitschakelen" + '</label><br>';
            x += '</div>';
            setDialogMode(2, "Gebruiker toevoegen aan apparaatgroep", 3, p20showAddMeshUserDialogEx, x);
        ...
        function p20viewuser(userid) {
            ...
            if (meshrights == 0xFFFFFFFF) r.push("Volledige beheerder"); else {
                ...
                if ((meshrights & 256) != 0) r.push("Alleen extern meekijken");
                if ((meshrights & 512) != 0) r.push("Geen terminal");
                if ((meshrights & 1024) != 0) r.push("Geen bestanden");
                if ((meshrights & 2048) != 0) r.push("Geen Intel&reg; AMT");
                ...
                if ((meshrights & 32768) != 0) r.push("Deïnstallatie");
                if ((meshrights & 131072) != 0) r.push("Opdrachten");
                if ((meshrights & 262144) != 0) r.push("Reset/Uit");
            }
            ...
            var x = addHtmlValue("Gebruikersnaam", EscapeHtml(uname));
            if (uname != userid.split('/')[2]) { x += addHtmlValue("Gebruikers ID", EscapeHtml(userid.split('/')[2])); }
        ...
        function p20viewuserEx(button, userid) {
            ...
            setDialogMode(2, "Externe Mesh gebruiker", 3, p20viewuserEx2, format("Bevestig de verwijdering van gebruiker {0}?", uname), userid);
        }
        ...
        function drawNotifications() {
            ...
            if (notifications.length == 0) {
                ...
                for (var i in notifications) {
                    ...
                    r += '<div onclick="notificationDelete(' + n.id + ')" class=unselectable title="' + "Wis deze melding" + '" style=margin:5px;float:right;color:orange><b>X</b></div><div onclick="notificationSelected(' + n.id + ')" style=margin:5px>' + t + EscapeHtml(n.text) + '</div><div style=margin-left:5px;margin-bottom:5px;color:gray;font-size:10px>' + printDateTime(d) + '</div></div>';
                }
            }
            var deleteall = '';
            if (notifications.length > 1) { deleteall = '<div id="notifyRemoveAll" onclick="deleteAllNotifications()" style="cursor:pointer;border-top:1px solid orange;margin:5px;color:orange;text-align:right;padding-right:3px">' + "Wis alle meldingen" + '</div>'; }
        ...
        function addNotification(n) {
            ...
            var translatedMessages = [
                null,
                "Toestemming geweigerd", // 1
                "Ongeldige gebruikersnaam",
                "Ongeldig wachtwoord",
                "Ongeldig email",
                "Ongeldig domein",
                "Ongeldige sitemachtigingen",
                "Gebruiker bestaat al",
                "Kan geen gebruiker toevoegen in deze modus",
                "Validatie uitzondering",
                "Gebruikersaccount limiet bereikt.", // 10
                "Chatverzoek, klik hier om te accepteren.",
                "Er zijn {0} mislukte inlogpogingen voor dit account sinds de laatste keer inloggen.",
                "E-mailadres kan niet worden gewijzigd, een ander account gebruikt al: {0}.",
                "E-mail verzonden.",
                "Gebruiker {0} niet gevonden.",
                "Gebruikers {0} niet gevonden.",
                "Fout, kan niet wijzigen naar eerder gebruikt wachtwoord.",
                "Fout, het is niet mogelijk om naar algemeen gebruikt wachtwoord te veranderen.",
                "Fout, wachtwoord niet gewijzigd.",
                "Wachtwoord gewijzigd.", // 20
                "Huidig wachtwoord is niet correct.",
                "Fout, uitnodigingscode \"{0}\" al in gebruik.",
                "SMS gateway niet ingeschakeld",
                "Geen gebruikersbeheerrechten",
                "Ongeldig SMS bericht",
                "Geen telefoonnummer voor deze gebruiker",
                "SMS succesvol verzonden.",
                "SMS fout",
                "SMS fout: {0}",
                "Email domein \"{0}\" is niet toegestaan. Alleen ({1}) is toegestaan" // 30
            ];
