<!DOCTYPE html><html dir="ltr" xmlns="http://www.w3.org/1999/xhtml"><head lang="en">
                            ...
                            <div id="loginpanel" style="background-color:#979797;border-radius:16px;width:260px;padding:16px;text-align:center;clear:both;display:none">
                                <form method="post">
                                    ...
                                    <table>
                                        ...
                                        <tr>
                                            <td><div id="showPassHintLink" style="display:none"><a onclick="showPassHint()" style="cursor:pointer">힌트 표시</a></div></td>
                                            <td align="right"><input id="loginButton" type="submit" value="로그인"></td>
                                        </tr>
                                    </tbody></table>
                                    <div id="hrAccountDiv" style="display:none"><hr></div>
                                    <div id="resetAccountDiv" style="display:none;padding:2px">
                                        <span id="resetAccountSpan">사용자/비밀번호를 잊어버리셨습니까?</span> <a onclick="xgo(3)" style="cursor:pointer">계정 초기화</a>.
                                    </div>
                                    <div id="newAccountDiv" style="display:none;padding:2px">
                                        계정이 없습니까? <a onclick="xgo(2)" style="cursor:pointer">한 가지 만들기</a>.
                                    </div>
                                    ...
                                    <div id="authStrategies" style="display:none">
                                        ...
                                        <a id="auth-twitter" href="auth-twitter" style="display:none"><img src="images/login/twitter32.png" width="32" height="32" style="margin-left:3px;margin-right:3px;border-radius:3px;box-shadow:2px 2px 5px black;cursor:pointer" title="Twitter를 사용하여 로그인"></a>
                                        <a id="auth-google" href="auth-google" style="display:none"><img src="images/login/google32.png" width="32" height="32" style="margin-left:3px;margin-right:3px;border-radius:3px;box-shadow:2px 2px 5px black;cursor:pointer" title="Google을 사용하여 로그인"></a>
                                        <a id="auth-github" href="auth-github" style="display:none"><img src="images/login/github32.png" width="32" height="32" style="margin-left:3px;margin-right:3px;border-radius:3px;box-shadow:2px 2px 5px black;cursor:pointer" title="GitHub를 사용하여 로그인"></a>
                                        <a id="auth-azure" href="auth-azure" style="display:none"><img src="images/login/azure32.png" width="32" height="32" style="margin-left:3px;margin-right:3px;border-radius:3px;box-shadow:2px 2px 5px black;cursor:pointer" title="Azure를 사용하여 로그인"></a>
                                        ...
                                        <a id="auth-jumpcloud" href="auth-jumpcloud" style="display:none"><img src="images/login/jumpcloud32.png" width="32" height="32" style="margin-left:3px;margin-right:3px;border-radius:3px;box-shadow:2px 2px 5px black;cursor:pointer" title="JumpCloud를 사용하여 로그인"></a>
                                        <a id="auth-intel" href="auth-intel" style="display:none"><img src="images/login/intel32.png" width="32" height="32" style="margin-left:3px;margin-right:3px;border-radius:3px;box-shadow:2px 2px 5px black;cursor:pointer" title="Intel을 사용하여 로그인"></a>
                                        <a id="auth-saml" href="auth-saml" style="display:none"><img src="images/login/generic32.png" width="32" height="32" style="margin-left:3px;margin-right:3px;border-radius:3px;box-shadow:2px 2px 5px black;cursor:pointer" title="단일 로그인"></a>
                                    </div>
                                </form>
                            </div>
                                    ...
                                    <form method="post">
                                        ...
                                        <table>
                                            <tbody><tr id="nuUserRow">
                                                <td align="right" width="100">사용자 이름:</td>
                                        ...
                                        <hr><a onclick="xgo(1)" style="cursor:pointer">로그인으로 돌아가기</a>
                                        ...
                                        <tr>
                                            <td colspan="2">
                                                ...
                                                <div style="float:right">
                                                    <input style="display:none;float:right" id="securityKeyButton" type="button" value="보안키 사용" onclick="useSecurityKey()">
                                                    <input style="display:none;float:right" id="emailKeyButton" type="button" value="이메일" onclick="useEmailToken()">
        ...
        <div id="footer" style="height:32px;width:100%;text-align:center;background-color:#113962;position:absolute;bottom:0px">
            <table cellpadding="0" cellspacing="6" style="width:100%">
                <tbody><tr>
                    ...
                    <td style="text-align:right">{{{rootCertLink}}}&nbsp;<a href="terms">약관과 개인정보</a></td>
                </tr>
            </tbody></table>
        </div>
    </div>
    ...
    <script>
        ...
        var okmessages = ['', "유효한 경우 메일을 재설정하십시오.", "이메일이 발송되었습니다.", "이메일 검증이 요구됩니다. 당신의 메일박스를 확인하시고, 확인 링크를 클릭해주세요.", "SMS가 전송됨."];
        ...
        function useEmailToken() {
            ...
            setDialogMode(1, "안전한 로그인", 3, useEmailKeyEx, "등록 된 이메일 주소로 토큰을 보내시겠습니까?");
        }
        ...
        function useSMSToken() {
            ...
            setDialogMode(1, "안전한 로그인", 3, useSMSTokenEx, "등록 된 전화 번호로 토큰을 보내시겠습니까?");
        }
        ...
        function showPassHint() {
            if (passRequirements.hint === true) { messagebox("비밀번호 힌트", passhint); }
        }
            ...
            if (Q('apassword1').value == '') {
                ...
                if (!passRequirementsEx) {
                    ...
                    if (passReq == false) {
                        ...
                        QH('passWarning', '<span style=color:red><b>' + "비밀번호 정책" + '</b><span>'); // TODO: Display problem hint
