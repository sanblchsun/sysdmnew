<!DOCTYPE html><html dir="ltr" xmlns="http://www.w3.org/1999/xhtml"><head lang="en">
    ...
    <div id="container">
        ...
        <div id="topbar" class="noselect style3" style="height:24px">
            <div id="uiMenuButton" title="Выбор пользовательского интерфейса" onclick="showUserInterfaceSelectMenu()">
                ♦
                <div id="uiMenu" style="display:none">
                    <div id="uiViewButton1" class="uiSelector" onclick="userInterfaceSelectMenu(1)" title="Панель инструментов слева"><div class="uiSelector1"></div></div>
                    <div id="uiViewButton2" class="uiSelector" onclick="userInterfaceSelectMenu(2)" title="Панель инструментов сверху"><div class="uiSelector2"></div></div>
                    <div id="uiViewButton3" class="uiSelector" onclick="userInterfaceSelectMenu(3)" title="Интерфейс с фиксированной шириной"><div class="uiSelector3"></div></div>
                    <div id="uiViewButton4" class="uiSelector" onclick="toggleNightMode()" title="Переключить ночной режим"><div class="uiSelector4"></div></div>
                </div>
            </div>
        </div>
        <div id="column_l">
            <h1>Добро пожаловать</h1>
            <div id="welcomeText" style="display:none">Подключайтесь к домашним или офисным устройствам из любой точки мира с помощью веб-сайта MeshCentral в режиме реального времени с открытым исходным кодом для удаленного мониторинга и управления. Вам нужно будет загрузить и установить агент управления на свои компьютеры. После установки компьютеры будут отображаться в разделе «Мои устройства» на этом веб-сайте, и вы сможете контролировать их и управлять ими.</div>
                    ...
                    <td id="logincell">
                        <div id="loginpanel" style="display:none">
                            <form method="post">
                                ...
                                <div id="loginuserpassdiv" style="display:none">
                                    ...
                                    <table>
                                        <tbody><tr>
                                            <td id="loginusername" align="right" width="100">Имя пользователя:</td>
                                        ...
                                        <tr>
                                            <td><div id="showPassHintLink" style="display:none"><a onclick="return showPassHint(event);" href="#" style="cursor:pointer">Показать подсказку</a></div></td>
                                            <td align="right"><input id="loginButton" type="submit" value="Авторизация"></td>
                                        </tr>
                                    </tbody></table>
                        ...
                        <div id="createpanel" style="display:none;position:relative">
                            <form method="post">
                                ...
                                <table>
                                    ...
                                    <tr>
                                        <td colspan="2">
                                            <div style="float:right"><input id="createButton" type="submit" value="Создать учетную запись" disabled="disabled"></div>
                        ...
                        <div id="resetpanel" style="display:none">
                            <form method="post">
                                ...
                                <table>
                                    ...
                                    <tr>
                                        <td colspan="2">
                                            <div style="float:right"><input id="eresetButton" type="submit" value="Сбросить учетную запись" disabled="disabled"></div>
                                            <div id="passWarning" style="padding-top:6px"></div>
                                        </td>
                                    </tr>
                                </tbody></table>
                        ...
                        <div id="tokenpanel" style="display:none">
                            <form method="post" {{{autocomplete}}}="off">
                                ...
                                <table>
                                    <tbody><tr>
                                        <td align="right" width="100">Токен входа:</td>
                                        <td>
                                    ...
                                    <tr>
                                        <td colspan="2">
                                            <div style="float:right"><input id="tokenOkButton" type="submit" value="Войти" disabled="disabled"></div>
                                            <div style="float:right">
                                                <input style="display:none;float:right" id="securityKeyButton" type="button" value="Используйте ключ безопасности" onclick="useSecurityKey(1)">
                                                <input style="display:none;float:right" id="emailKeyButton" type="button" value="Email" onclick="useEmailToken(1)">
                                                <input style="display:none;float:right" id="smsKeyButton" type="button" value="смс" onclick="useSMSToken(1)">
                        ...
                        <div id="resettokenpanel" style="display:none">
                            <form method="post">
                                ...
                                <table>
                                    ...
                                    <tr>
                                        <td colspan="2">
                                            <div style="float:right"><input id="resetTokenOkButton" type="submit" value="Войти" disabled="disabled"></div>
                                            <div style="float:right">
                                                <input style="display:none;float:right" id="securityKeyButton2" type="button" value="Используйте ключ безопасности" onclick="useSecurityKey(2)">
                                                <input style="display:none;float:right" id="emailKeyButton2" type="button" value="Email" onclick="useEmailToken(2)">
                                                <input style="display:none;float:right" id="smsKeyButton2" type="button" value="смс" onclick="useSMSToken(2)">
                        ...
                        <div id="resetpasswordpanel" style="display:none;position:relative">
                            <form method="post">
                                ...
                                <table>
                                    ...
                                    <tr>
                                        <td colspan="2">
                                            <div style="float:right"><input id="resetPassButton" type="submit" value="Сбросить пароль" disabled="disabled"></div>
        ...
        <div id="footer">
            ...
            <div class="footer2">
                {{{rootCertLink}}}
                &nbsp;<a id="termsLinkFooter" href="terms">Условия и конфиденциальность</a>
            </div>
        </div>
