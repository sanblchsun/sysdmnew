<!DOCTYPE html><html lang="hu" dir="ltr" xmlns="http://www.w3.org/1999/xhtml"><head>
    ...
    <div id="LeftSideToolBar" style="display:none;position:absolute;left:0;bottom:0;width:52px;top:0;background:#113962;background:linear-gradient(to bottom, #104893 0%,#113962 100%);color:white;border-right: 5px solid #BBB;">
        <div id="LeftMenuDesktop" class="slbbutton slbbuttonsel2" title="Asztal" onclick="go(11)">
            <div class="slb1" style="position:absolute;top:6px;left:6px"></div>
        </div>
        <div id="LeftMenuTerminal" class="slbbutton" title="Terminál" onclick="go(12)">
            <div class="slb2" style="position:absolute;top:6px;left:6px"></div>
        </div>
        <div id="LeftMenuFiles" class="slbbutton" title="Fájlok" onclick="go(13)">
        ...
        <div id="deskarea0">
            <div id="deskarea1" class="areaHead" style="line-height:24px">
                <div class="toright2">
                    ...
                    <div class="deskareaicon" title="Nézet üzemmód váltás" onclick="toggleAspectRatio(1)">⇲</div>
                    <div class="deskareaicon" title="Forgatás balra" onclick="drotate(-1)">↺</div>
                    <div class="deskareaicon" title="Forgatás jobbra" onclick="drotate(1)">↻</div>
                    <input id="deskActionsSettings" type="button" value="Beállítások..." title="Távoli asztali beállítások szerkesztése" onkeypress="return false" onkeydown="return false" onclick="showDesktopSettings()" class="mR">
                    <div id="desktopCustomUiButtons" style="float:left"></div>
                    <div id="deskRecordIcon" class="deskareaicon" title="A kiszolgáló rögzíti ezt a munkamenetet" style="display:none;background-color:red;width:12px;height:12px;border-radius:6px;margin-top:5px"></div>
                </div>
                <div>
                    ...
                    <span id="connectbutton1span"><input type="button" id="connectbutton1" cmenu="deskConnectButton" value="Kapcsolódás" onclick="connectDesktop(event,3)" onkeypress="return false" onkeydown="return false" disabled="disabled"></span>
                    <span id="connectbutton1hspan">&nbsp;<input type="button" id="connectbutton1h" value="HW Kapcsolat" title="Csatlakozás Intel AMT hardveres KVM használatával" onclick="connectDesktop(event,2)" onkeypress="return false" onkeydown="return false" disabled="disabled"></span>
                    <span id="disconnectbutton1span">&nbsp;<input type="button" id="disconnectbutton1" value="Lekapcsolódás" onclick="connectDesktop(event,0)" onkeypress="return false" onkeydown="return false"></span>
                    &nbsp;<span id="deskstatus">Lecsatlakozott</span><span id="deskmetadata"></span>
                </div>
            </div>
            ...
            <div id="deskarea4" class="areaFoot" style="min-height:24px">
                <div class="toright2">
                    <span id="DeskLatency" style="line-height:22px;width:50px" title="Asztali munkamenet késleltetés"></span>
                    <span id="DeskTimer" style="line-height:22px" title="Munkamenet idő "></span>&nbsp;
                    ...
                    <span id="DeskSaveImageButton" title="Képernyőkép mentése a távoli asztalról"><img src="images/icon-camera.png" onclick="deskSaveImage()" height="16" width="16" style="padding-top:2px"></span>
                </div>
                <div style="height:22px">
                    <select id="deskkeys">
                        ...
                        <option value="11">Win+Bal</option>
                        <option value="12">Win+Jobb</option>
                    </select>
                    <input id="DeskWD" type="button" value="Küldés" onkeypress="return false" onkeydown="return false" onclick="deskSendKeys()">
                    <input id="DeskClip" style="" type="button" value="Vágólap" onkeypress="return false" onkeydown="return false" onclick="showDeskClip()">
                    <input id="DeskType" style="" type="button" value="Típus" onkeypress="return false" onkeydown="return false" onclick="showDeskType()">
                    <label><span id="DeskControlSpan" title="Egér és billentyűzet bevitel váltása"><input id="DeskControl" type="checkbox" onkeypress="return false" onkeydown="return false" onclick="toggleKvmControl()">Bevitel</span></label>&nbsp;
                </div>
            </div>
        </div>
    </div>
    <div id="p12" class="noselect" style="overflow:hidden;position:absolute;left:54px;top:0;right:0;bottom:0;display:none;background-color:black">
        <div id="p12warning" onclick="showFeaturesDlg()">
            <div class="icon2"></div>
            <div class="warningbox">Intel® AMT átirányítási port vagy a KVM funkció le van tiltva<span id="p12warninga">, kattintson ide az engedélyezéséhez.</span></div>
        </div>
        <div id="p12warning2" onclick="showPowerActionDlg()">
            <div class="icon2"></div>
            <div class="warningbox">A távoli számítógép nincs bekapcsolva, kattintson ide a energiaellátás parancs kiadásához.</div>
        </div>
        <div class="areaHead" style="position:absolute;top:0;left:0;right:0;height:24px">
            <div class="toright2">
                <div id="termRecordIcon" class="deskareaicon" title="A kiszolgáló rögzíti ezt a munkamenetet" style="display:none;background-color:red;width:12px;height:12px;border-radius:6px;margin-top:5px;margin-left:5px"></div>
                <div id="p12power" style="margin-top:3px;margin-right:4px;float:right"></div>
            </div>
            <div>
                <span id="connectbutton2span"><input type="button" id="connectbutton2" cmenu="termConnectButton" value="Kapcsolódás" onclick="connectTerminal(event,1)" onkeypress="return false" onkeydown="return false" disabled="disabled"></span>
                <span id="disconnectbutton2span">&nbsp;<input type="button" id="disconnectbutton2" value="Lekapcsolódás" onclick="connectTerminal(event,0)" onkeypress="return false" onkeydown="return false"></span>
                &nbsp;<span id="termstatus">Lecsatlakozott</span><span id="termtitle"></span>
            </div>
        </div>
        ...
        <div class="areaFoot" style="position:absolute;bottom:0;left:0;right:0;height:24px">
            <div class="toright2">
                <span id="TermLatency" title="Terminál munkamenet késleltetés"></span>
                <span id="TermTimer" title="Munkamenet idő "></span>&nbsp;
                <span id="terminalSettingsButtons" style="display:none">
                    <input id="id_tcrbutton" type="button" onkeypress="return false" onkeydown="return false" class="bottombutton" value="CR+LF" title="Kapcsolja be, hogy mit küld a return billentyű" onclick="termToggleCr()">
                    <input id="id_tfxkeysbutton" type="button" onkeypress="return false" onkeydown="return false" class="bottombutton" value="Intel (F10 = ESC+[OM)" title="F1-F10 billentyűk emulációs típusának váltása" onclick="termToggleFx()">
                    <input id="id_ttypebutton" type="button" onkeypress="return false" onkeydown="return false" class="bottombutton" value="Kiterjesztett Ascii" title="Terminál emuláció típusának váltása" onclick="termToggleType()">
                </span>
                ...
                <span id="specialKeyDropDown">
                    ...
                    <input id="specialkeylistinput" type="button" onkeypress="return false" class="bottombutton" value="Küldés" title="Kiválasztott speciális billentyű küldése" onclick="sendSpecialKey()">
                </span>
            </div>
            <div>
                &nbsp;
                ...
                <input type="button" onkeypress="return false" onkeydown="return false" class="bottombutton" id="pastebutton" value="Beillesztés" title="Szöveg beillesztése a terminálba" onclick="showTermPasteDialog()" style="display:none">
            </div>
        </div>
    ...
    <div id="p13" class="noselect" style="overflow:hidden;position:absolute;left:54px;top:0;right:0;bottom:0;display:none;background-color:white">
        <div id="p13toolbar" style="position:absolute;left:0;top:0;right:0;bottom:28px">
            <div class="areaHead">
                <div class="toright2">
                    <div id="filesRecordIcon" class="deskareaicon" title="A kiszolgáló rögzíti ezt a munkamenetet" style="display:none;background-color:red;width:12px;height:12px;border-radius:6px;margin-top:5px;margin-left:5px"></div>
                    <div id="p13power" style="margin-top:3px;margin-right:4px;float:right"></div>
                </div>
                <div>
                    <input id="p13Connect" value="Kapcsolódás" onclick="connectFiles(event)" type="button">
                    &nbsp;<span id="p13Status">Lecsatlakozott</span>
                </div>
            </div>
            <div id="fileArea2" class="areaHead2" valign="bottom">
                <div id="p13rightOfButtons" class="toright2"></div>
                <div>
                    <input type="button" id="p13FolderUp" disabled="disabled" onclick="p13folderup()" value="Fel">&nbsp;
                    <input type="button" id="p13SelectAllButton" disabled="disabled" onclick="p13selectallfile()" value="Összes kijelölése">&nbsp;
                    <input type="button" id="p13RenameFileButton" disabled="disabled" value="Átnevezés" onclick="p13renamefile()">&nbsp;
                    <input type="button" id="p13DeleteFileButton" disabled="disabled" value="Törlés" onclick="p13deletefile()">&nbsp;
                    <input type="button" id="p13ViewFileButton" disabled="disabled" value="Szerkesztés" onclick="p13viewfile()">&nbsp;
                    <input type="button" id="p13NewFolderButton" disabled="disabled" value="Új mappa" onclick="p13createfolder()">&nbsp;
                    <input type="button" id="p13UploadButton" disabled="disabled" value="Feltöltés" onclick="p13uploadFile()">&nbsp;
                    <input type="button" id="p13CutButton" disabled="disabled" value="Kivágás" onclick="p13copyFile(1)">&nbsp;
                    <input type="button" id="p13CopyButton" disabled="disabled" value="Másolás" onclick="p13copyFile(0)">&nbsp;
                    <input type="button" id="p13PasteButton" disabled="disabled" value="Beillesztés" onclick="p13pasteFile()">&nbsp;
                    <input type="button" id="p13ZipButton" disabled="disabled" value="Zip" onclick="p13zipFiles()">&nbsp;
                    <input type="button" id="p13RefreshButton" disabled="disabled" value="Frissít" onclick="p13folderup(9999)">&nbsp;
                    <input type="button" id="p13FindButton" disabled="disabled" value="Keresés" onclick="p13findfile()">&nbsp;
                </div>
            </div>
    ...
    <div id="dialog" class="noselect" style="display:none">
        ...
        <div id="dialogBody">
            ...
            <div id="dialog4" style="">
                <input id="d4WrapButton" type="button" value="Sortörés: BE" onclick="d4ToggleWrap()">
                <input id="d4SizeButton" type="button" value="Kicsi" onclick="d4ToggleSize()">
            ...
            <div id="dialog7" style="">
                <div id="d7meshkvm">
                    ...
                    <div id="d7desktopOtherSettings">
                        <div>További beállítások</div>
                        <div id="d7otherset2" style="display:block">
                            <label style="display:block"><input type="checkbox" id="d7deskSwapMouse">Egérgombok felcserélése</label>
                            <label style="display:block"><input type="checkbox" id="d7deskRemoteKeyMap">Távoli billentyűzet kiosztás használata</label>
                        </div>
                    </div>
                </div>
                <div id="d7amtkvm">
                    ...
                    <div>
                        ...
                        <div id="d7otherset" style="display:block">
                            <label style="display:block"><input type="checkbox" id="d7showfocus">Focus eszköz megjelenítése</label>
                            <label style="display:block"><input type="checkbox" id="d7showcursor">Helyi egérkurzor megjelenítése</label>
                            <label style="display:block"><input type="checkbox" id="d7localKeyMap">Helyi billentyűzet kiosztás</label>
                        </div>
                    </div>
                </div>
            </div>
    ...
    <script>
        ...
        function updateMetadata(conn, elementid) {
            ...
            if (conn && (conn.State == 3)) {
                ...
                if (viewerCount > 1) { str = '<span onclick=showSessionMetadata(1) style=cursor:pointer>' + format(", {0} nézi", viewerCount) + '</span>'; }
            }
            QH('deskmetadata', str);
        ...
        function showSessionMetadata(cid) {
            ...
            if (conn && conn.metadata) {
                var x = '';
                if (conn.metadata.startTime) { x += addHtmlValue4("Kezdés ideje", printDateTime(new Date(conn.metadata.startTime))); }
                if (conn.metadata.users) {
                    for (var i in conn.metadata.users) {
                        var val = (conn.metadata.users[i] == 1) ? "1 csatlakozás" : format("{0} kapcsolat", conn.metadata.users[i]);
                        var username = i.split('/')[2];
                        if ((users != null) && (users[i] != null)) { username = users[i].name; }
                        x += addHtmlValue4(format("Felhasználó \"{0}\"", username), val);
                    }
                }
                setDialogMode(2, "Munkamenet információk", 1, null, x, 'sessionMetadata' + cid);
            }
        }
        ...
        function showDeskType() {
            if (xxdialogMode || desktop == null || desktop.State != 3) return;
            Q('DeskType').blur();
            var x = '<div>' + "Írja be a szöveget, majd kattintson az OK gombra a távoli beíráshoz amerikai angol billentyűzet használatával. Győződjön meg arról, hogy a távoli kurzort a megfelelő pozícióba helyezte, mielőtt továbblép." + '<div>';
            x += '<textarea id=d2typeText style="margin-top:5px;width:100%;height:184px;resize:none" maxlength=2000></textarea>';
            setDialogMode(2, "Távoli billentyűzet bevitel", 3, showDeskTypeEx, x);
            Q('d2typeText').focus();
        }
        ...
        */
        ...
        function deskSaveImage() {
            if (xxdialogMode || desktop == null || desktop.State != 3) return;
            var d = new Date(), n = "Asztal" + '-' + d.getFullYear() + '-' + ('0' + (d.getMonth() + 1)).slice(-2) + '-' + ('0' + d.getDate()).slice(-2) + '-' + ('0' + d.getHours()).slice(-2) + '-' + ('0' + d.getMinutes()).slice(-2);
        ...
        var terminalEmulations = ["UTF8 Terminál", "Kiterjesztett ASCII", "Intel ASCII"];
        ...
        var fxEmulations = ["Intel (F10 = ESC+[OM)", "Alternatív (F10 = ESC+0)", "VT100+ (F10 = ESC+[OY)"];
        ...
        function showTermPasteDialog() {
            if (!terminal || xxdialogMode) return;
            Q('pastebutton').blur();
            setDialogMode(2, "Beillesztés", 3, showTermPasteDialogEx, '<textarea id=d2pasteText style="width:100%;height:184px;resize:none"></textarea>');
            Q('d2pasteText').focus();
        }
        ...
        function onFilesStateChange(xfiles, state) {
            p13Connect.value = (state == 0) ? "Kapcsolódás" : "Lekapcsolódás";
        ...
        function p13gotFiles(data) {
            ...
            if (data.action == 'findfile') {
                if (xxdialogTag == data.reqid) {
                    if (data.r == null) {
                        ...
                        xxdialogTag = null;
                        if (Q('d2findResults').innerHTML == '') { QH('d2findResults', '<div style=text-align:center;margin:10px><i>' + "Nem találhatóak fájlok" + '</i></div>'); }
                    } else {
            ...
            if (data.action == 'dialogmessage') {
                if ((data.msg == null) && (xxdialogTag == 'fileMsgDialog')) {
                    ...
                    setDialogMode(2, "Fáj Művelet", 10, p13fileOperationDialogEx, '<div style=margin:10px>' + "Fájlok tömörítése..." + '<div>', 'fileMsgDialog');
                } else if ((data.msg == 'zippingFile') && ((!xxdialogMode) || (xxdialogTag == 'fileMsgDialog'))) {
                    // Show the dialog box message
                    setDialogMode(2, "Fáj Művelet", 10, p13fileOperationDialogEx, '<div style=margin:10px>' + EscapeHtml(data.file) + '<div><br /><progress value=' + EscapeHtml(data.progress) + ' style=width:100% max=100 />', 'fileMsgDialog');
                }
                return;
            }
        ...
        function p13findfile() {
            if (xxdialogMode) return;
            var x = addHtmlValue("Szűrő", '<input id=d2findFilter style="width:230px" onkeyup=p13findfileValidate() onkeydown=p13findfileDown(event) placeholder="*.txt"></input>');
            ...
            x += '<div style=margin-top:8px><input id=filefind_dlgCancelButton type=button value=' + "Bezár" + ' style=float:right;width:80px;margin-left:5px onclick=p13findfileCancel()>';
            x += '<input id=filefind_dlgOkButton type=submit value=' + "Keresés" + ' style=float:right;width:80px onclick=p13findfileEx()><br /><br /></div>';
            setDialogMode(2, "Fájlok keresése", 0, null, x);
            p13findfileValidate();
        ...
        function p13setActions() {
            ...
            if (p13filetree == null) {
                ...
                Q('p13SelectAllButton').value = "Összes kijelölése";
                ...
                Q('p13SelectAllButton').value = (cc > 0 ? "Semelyik" : "Összes kijelölése");
        ...
        function p13zipFiles() {
            ...
            setDialogMode(2, "Zip fájlnév", 3, p13zipFilesEx, '<input type=text id=p13renameinput maxlength=64 onkeyup=p13fileNameCheck(event) style=width:100% value="" />', { action: 'zip', path: p13filetreelocation.join('/'), files: inputFiles });
        ...
        function p13downloadfile(x, y, z, tag) {
            ...
            setDialogMode(2, "Fájl letöltése", 10, p13downloadFileCancel, '<div>' + gdownloadFile.file + '</div><br /><progress id=d2progressBar style=width:100% value=0 max=' + z + ' />');
        }
        ...
        function d4ToggleWrap(update) {
            ...
            Q('d4WrapButton').value = ["Sortörés: BE", "Sortörés: KI"][d4EditWrapVal];
        ...
        function d4ToggleSize(update) {
            ...
            Q('d4SizeButton').value = ["Méret: 100%", "Méret: 125%", "Méret: 150%", "Méret: 200%"][d4EditSizeVal];
        ...
        function d4ToggleEncoding(update) {
            ...
            Q('d4EncodingButton').value = ["Kódolás: RAW","Kódolás: UTF8"][d4EditEncodingVal];
        ...
        function printFlexDateTime(d) { if (printDate(new Date()) == printDate(d)) { return format("Lejár: {0}", printTime(d)); } else { return format("Lejárat {0}", printDateTime(d)); } }
