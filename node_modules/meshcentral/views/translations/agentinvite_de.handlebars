<!DOCTYPE html><html lang="de"><head>
    ...
    {{{customJSTags}}}
    <title>Agenteninstallation</title>
    <style>
        .tab {
            overflow: hidden;
        ...
        <div id="column_l" style="overflow-y:auto">
            ...
            <div>
                <div class="tab">
                    ...
                    <button id="tlinuxbinarytab" class="tablinks" onclick="openTab(event, 'linuxbinarytab')">Binäres Linux / BSD / macOS-Installationsprogramm</button>
                ...
                <div id="wintab64" class="tabcontent" style="background-color:white;color:black">
                    ...
                    <p><a id="win64url">Die Software hier herunterladen</a>, ausführen und "Installieren" oder "Verbinden" wählen.</p>
                ...
                <div id="wintab32" class="tabcontent" style="background-color:white;color:black">
                    ...
                    <p><a id="win32url">Die Software hier herunterladen</a>, ausführen und "Installieren" oder "Verbinden" wählen.</p>
                    <div style="text-align:center">
                ...
                <div id="wintabarm64" class="tabcontent" style="background-color:white;color:black">
                    ...
                    <p><a id="winarm64url">Die Software hier herunterladen</a>, ausführen und "Installieren" oder "Verbinden" wählen.</p>
                    <div style="text-align:center">
                ...
                <div id="linuxtab" class="tabcontent" style="background-color:white;color:black">
                    <h3>Linux</h3>
                    <p>Zum Installieren, kopieren Sie den folgenden Befehl und führen Sie ihn in einem Root-Terminal aus.</p>
                    <div id="linuxinstall" style="font-family:courier,'courier new',monospace;margin-left:30px"></div>
                    <input type="button" value="In Zwischenablage kopieren" style="margin-left:30px;margin-top:4px" onclick="copyToClipLinuxInstall()">
                    <p>Zum Deinstallieren, kopieren Sie den folgenden Befehl und führen Sie ihn als root aus.</p>
                    <div id="unlinuxinstall" style="font-family:courier,'courier new',monospace;margin-left:30px"></div>
                    <input type="button" value="In Zwischenablage kopieren" style="margin-left:30px;margin-top:4px" onclick="copyToClipLinuxUnInstall()">
                    <br><br>
                </div>
                ...
                <div id="macostab64" class="tabcontent" style="background-color:white;color:black">
                    ...
                    <p><a id="macos64url">Den Installer hier herunterladen</a>, rechtsklicken oder "Strg" halten und Datei anklicken. Anschließend "Öffnen" wählen und den Anweisungen folgen.</p>
                    <div style="text-align:center">
                ...
                <div id="macostabarm64" class="tabcontent" style="background-color:white;color:black">
                    ...
                    <p><a id="macosarm64url">Den Installer hier herunterladen</a>, rechtsklicken oder "Strg" halten und Datei anklicken. Anschließend "Öffnen" wählen und den Anweisungen folgen.</p>
                    <div style="text-align:center">
                ...
                <div id="macostab" class="tabcontent" style="background-color:white;color:black">
                    ...
                    <p><a id="macosurl">Den Installer hier herunterladen</a>, rechtsklicken oder "Strg" halten und Datei anklicken. Anschließend "Öffnen" wählen und den Anweisungen folgen.</p>
                    <div style="text-align:center">
                ...
                <div id="androtab" class="tabcontent" style="background-color:white;color:black">
                    ...
                    <div style="min-height:220px">
                        <p>Laden Sie die Agentsoftware über den Google Play Store oder die APK-Datei herunter, installieren Sie sie und verwenden Sie den QR-Code rechts oder den unten stehenden Link, um Ihr Gerät auf diesem Server einzurichten.</p>
                        <p>
                        ...
                        <p>
                            <a rel="noreferrer noopener" target="_blank" href="{{{magenturl}}}">Link zur Serverkopplung</a>
                        </p>
                    </div>
                </div>
                ...
                <div id="assistab" class="tabcontent" style="background-color:white;color:black">
                    ...
                    <div style="min-height:220px">
                        ...
                        <p>Assistant ist ein Windows-Taskleistentool, das verwendet werden kann, wenn Hilfe benötigt wird. Dies ist kein Agent, der im Hintergrund des verwalteten Computers ausgeführt wird, sondern ein Tool, das sich nur auf Anforderung mit dem Server verbindet.</p>
                        <p>
                            <a id="assisturl" rel="noreferrer noopener" target="_blank">Download-Assistent für Windows</a>
                        </p>
                    </div>
                    <br style="clear:both">
                </div>
    ...
    <script>
        ...
        function startup() {
            ...
            if (groupName != '') {
                QH('groupname', format("Entfernte Agent-Installation für {0}", escapeHtml(groupName)));
                document.title = format("{0} - Agent-Installation", groupName);
            } else {
                document.title = "Agenteninstallation";
            }
        ...
        function linuxBinarySetup() {
            var x = '<h3>' + "Binäres Linux / BSD / macOS-Installationsprogramm" + '</h3>', moreoptions = '';
            var opts = '<select id=aginsSelect onchange=addAgentToMeshClick() style=width:236px>';
            opts += '<option value=5 selected>' + "Binäres Linux / BSD / macOS-Installationsprogramm" + '</option>';
            opts += '</select>';
            ...
            x += addHtmlValue("Systemtyp", '<select id=aginsSysType onchange=addAgentToMeshClick() style=width:236px>' + moreoptions + '</select>');
            x += '</div>';
            x += '<div id=aginsTypeDiv>';
            x += addHtmlValue("Installationstyp", '<select id=aginsType onchange=addAgentToMeshClick() style=width:236px><option value=0>' + "Hintergrund & interaktiv" + '</option><option value=2>' + "Nur Hintergrund" + '</option><option value=1>' + "Nur interaktiv" + '</option></select>');
            x += '</div><hr>';
