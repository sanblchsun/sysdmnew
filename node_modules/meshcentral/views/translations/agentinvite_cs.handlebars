<!DOCTYPE html><html lang="cs"><head>
        ...
        <div id="column_l" style="overflow-y:auto">
            ...
            <div>
                <div class="tab">
                    ...
                    <button id="tlinuxbinarytab" class="tablinks" onclick="openTab(event, 'linuxbinarytab')">Linux / BSD / macOS binární instalační program</button>
                ...
                <div id="wintab64" class="tabcontent" style="background-color:white;color:black">
                    ...
                    <p><a id="win64url">Software si stáhnete zde</a>, spusťte ho a zvolte „Nainstalovat“ nebo „Připojit“.</p>
                ...
                <div id="wintab32" class="tabcontent" style="background-color:white;color:black">
                    ...
                    <p><a id="win32url">Software si stáhnete zde</a>, spusťte ho a zvolte „Nainstalovat“ nebo „Připojit“.</p>
                    <div style="text-align:center">
                ...
                <div id="wintabarm64" class="tabcontent" style="background-color:white;color:black">
                    ...
                    <p><a id="winarm64url">Software si stáhnete zde</a>, spusťte ho a zvolte „Nainstalovat“ nebo „Připojit“.</p>
                    <div style="text-align:center">
                ...
                <div id="linuxtab" class="tabcontent" style="background-color:white;color:black">
                    <h3>Linux</h3>
                    <p>Pro instalaci spusťte následující příkaz s právy správce (root).</p>
                    ...
                    <p>Pro odinstalování spustťe tento příkaz jako správce systému (root).</p>
                ...
                <div id="macostab64" class="tabcontent" style="background-color:white;color:black">
                    ...
                    <p><a id="macos64url">Instalátor si stáhnete zde</a>, klikněte na něj pravým tlačítkem nebo stiskněte klávesu Ctrl a klikněte na něj levým tlačítkem. Pak vyberte „Otevřít“ a postupujte podle pokynů.</p>
                    <div style="text-align:center">
                ...
                <div id="macostabarm64" class="tabcontent" style="background-color:white;color:black">
                    ...
                    <p><a id="macosarm64url">Instalátor si stáhnete zde</a>, klikněte na něj pravým tlačítkem nebo stiskněte klávesu Ctrl a klikněte na něj levým tlačítkem. Pak vyberte „Otevřít“ a postupujte podle pokynů.</p>
                    <div style="text-align:center">
                ...
                <div id="macostab" class="tabcontent" style="background-color:white;color:black">
                    ...
                    <p><a id="macosurl">Instalátor si stáhnete zde</a>, klikněte na něj pravým tlačítkem nebo stiskněte klávesu Ctrl a klikněte na něj levým tlačítkem. Pak vyberte „Otevřít“ a postupujte podle pokynů.</p>
                    <div style="text-align:center">
                ...
                <div id="androtab" class="tabcontent" style="background-color:white;color:black">
                    ...
                    <div style="min-height:220px">
                        <p>Stáhněte si software agenta z obchodu Google Play nebo souboru APK, nainstalujte jej a použijte QR kód vpravo nebo odkaz na párování níže k nastavení zařízení na tomto serveru.</p>
                        <p>
                        ...
                        <p>
                            <a id="androidurl">Stažení APK pro Android</a>
                        </p>
                        <p>
                            <a rel="noreferrer noopener" target="_blank" href="{{{magenturl}}}">Odkaz na párování serveru</a>
                        </p>
                    </div>
                </div>
                ...
                <div id="assistab" class="tabcontent" style="background-color:white;color:black">
                    ...
                    <div style="min-height:220px">
                        ...
                        <p>Assistant je nástroj na hlavním panelu systému Windows, který lze použít v případě potřeby pomoci. Toto není agent, který běží na pozadí spravovaného počítače, místo toho je to nástroj, který se připojuje k serveru pouze na požádání.</p>
                        <p>
                            <a id="assisturl" rel="noreferrer noopener" target="_blank">Stáhnout asistenta pro Windows</a>
                        </p>
                    </div>
                    <br style="clear:both">
                </div>
    ...
    <script>
        ...
        function startup() {
            ...
            if (groupName != '') {
                QH('groupname', format("Vzdálená instalace agenta pro {0}", escapeHtml(groupName)));
                document.title = format("{0} - Instalace agenta", groupName);
            } else {
                document.title = "Instalace agenta";
            }
        ...
        function linuxBinarySetup() {
            var x = '<h3>' + "Linux / BSD / macOS binární instalační program" + '</h3>', moreoptions = '';
            var opts = '<select id=aginsSelect onchange=addAgentToMeshClick() style=width:236px>';
            opts += '<option value=5 selected>' + "Linux / BSD / macOS binární instalační program" + '</option>';
            opts += '</select>';
            ...
            x += addHtmlValue("Typ systému", '<select id=aginsSysType onchange=addAgentToMeshClick() style=width:236px>' + moreoptions + '</select>');
            x += '</div>';
            x += '<div id=aginsTypeDiv>';
            x += addHtmlValue("Typ instalace", '<select id=aginsType onchange=addAgentToMeshClick() style=width:236px><option value=0>' + "Bezobslužná a interaktivní" + '</option><option value=2>' + "Pouze bezobslužná" + '</option><option value=1>' + "Pouze interaktivní" + '</option></select>');
            x += '</div><hr>';
            ...
            x += addHtmlValue("Mesh Agent", '<a id=aginsbinlnk name="meshagents?id=' + meshid + '&installflags=0' + (urlargs.key?('&key=' + urlargs.key):'') + '">' + "MeshAgenta" + '</a> <img src=images/link4.png height=10 width=10 title="' + "Zkopírujte URL agenta do schránky" + '" style=cursor:pointer onclick=copyAgentUrl("meshagents?id=' + meshid + '&installflags=",1)>');
            x += addHtmlValue("Příkaz", '<input id=aginsbincmd type=text style="width:216px" readonly value=\'wget -O meshagent ' + ((serverNoProxy != 0) ?'--no-proxy':'') + ' --no-check-certificate \"https://' + servername + portStr + domainUrl + 'meshagents?id=' + meshid.split('$').join('%24').split('@').join('%40') + '\' /> <img src=images/link4.png height=10 width=10 title="' + "Zkopírujte URL agenta do schránky" + '" style=cursor:pointer onclick=copyAgentIdValue("aginsbincmd")>');
            x += '</div>';
            QH('linuxbinarytab', x);
            addAgentToMeshClick();
        }
