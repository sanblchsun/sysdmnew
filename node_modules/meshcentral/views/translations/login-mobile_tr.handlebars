<!DOCTYPE html><html dir="ltr" xmlns="http://www.w3.org/1999/xhtml"><head lang="en">
                            ...
                            <div id="loginpanel" style="background-color:#979797;border-radius:16px;width:260px;padding:16px;text-align:center;clear:both;display:none">
                                <form method="post">
                                    ...
                                    <table>
                                        ...
                                        <tr>
                                            <td><div id="showPassHintLink" style="display:none"><a onclick="showPassHint()" style="cursor:pointer">İpucu göster</a></div></td>
                                    ...
                                    <div id="resetAccountDiv" style="display:none;padding:2px">
                                        <span id="resetAccountSpan">Kullanıcıyı / parolayı mı unuttunuz?</span> <a onclick="xgo(3)" style="cursor:pointer">Hesabı sıfırla</a>.
                                    </div>
                                    <div id="newAccountDiv" style="display:none;padding:2px">
                                        Hesabın yok mu? <a onclick="xgo(2)" style="cursor:pointer">Bir tane yarat</a>.
                                    </div>
                                    ...
                                    <div id="authStrategies" style="display:none">
                                        ...
                                        <a id="auth-twitter" href="auth-twitter" style="display:none"><img src="images/login/twitter32.png" width="32" height="32" style="margin-left:3px;margin-right:3px;border-radius:3px;box-shadow:2px 2px 5px black;cursor:pointer" title="Twitter kullanarak oturum açın"></a>
                                        <a id="auth-google" href="auth-google" style="display:none"><img src="images/login/google32.png" width="32" height="32" style="margin-left:3px;margin-right:3px;border-radius:3px;box-shadow:2px 2px 5px black;cursor:pointer" title="Google kullanarak oturum açın"></a>
                                        <a id="auth-github" href="auth-github" style="display:none"><img src="images/login/github32.png" width="32" height="32" style="margin-left:3px;margin-right:3px;border-radius:3px;box-shadow:2px 2px 5px black;cursor:pointer" title="GitHub kullanarak oturum açın"></a>
                                        <a id="auth-azure" href="auth-azure" style="display:none"><img src="images/login/azure32.png" width="32" height="32" style="margin-left:3px;margin-right:3px;border-radius:3px;box-shadow:2px 2px 5px black;cursor:pointer" title="Azure kullanarak oturum açın"></a>
                                        ...
                                        <a id="auth-jumpcloud" href="auth-jumpcloud" style="display:none"><img src="images/login/jumpcloud32.png" width="32" height="32" style="margin-left:3px;margin-right:3px;border-radius:3px;box-shadow:2px 2px 5px black;cursor:pointer" title="JumpCloud kullanarak oturum açın"></a>
                                        <a id="auth-intel" href="auth-intel" style="display:none"><img src="images/login/intel32.png" width="32" height="32" style="margin-left:3px;margin-right:3px;border-radius:3px;box-shadow:2px 2px 5px black;cursor:pointer" title="Intel kullanarak oturum açın"></a>
                                        <a id="auth-saml" href="auth-saml" style="display:none"><img src="images/login/generic32.png" width="32" height="32" style="margin-left:3px;margin-right:3px;border-radius:3px;box-shadow:2px 2px 5px black;cursor:pointer" title="Tek Oturum Açma"></a>
                                    </div>
                                </form>
                            </div>
                                    ...
                                    <form method="post">
                                        ...
                                        <table>
                                            <tbody><tr id="nuUserRow">
                                                <td align="right" width="100">Kullanıcı adı:</td>
                                            ...
                                            <tr id="newAccountPass" title="Hesap oluşturma anahtarını girin">
                                                <td align="right">Oluşturma Anahtarı:</td>
                                        ...
                                        <hr><a onclick="xgo(1)" style="cursor:pointer">Girişe geri dön</a>
                                        ...
                                        <tr>
                                            <td colspan="2">
                                                ...
                                                <div style="float:right">
                                                    <input style="display:none;float:right" id="securityKeyButton" type="button" value="Güvenlik Anahtarını Kullan" onclick="useSecurityKey()">
                                                    <input style="display:none;float:right" id="emailKeyButton" type="button" value="E-posta" onclick="useEmailToken()">
        ...
        <div id="footer" style="height:32px;width:100%;text-align:center;background-color:#113962;position:absolute;bottom:0px">
            <table cellpadding="0" cellspacing="6" style="width:100%">
                <tbody><tr>
                    ...
                    <td style="text-align:right">{{{rootCertLink}}}&nbsp;<a href="terms">Şartlar ve Gizlilik</a></td>
                </tr>
            </tbody></table>
        </div>
    </div>
    ...
    <script>
        ...
        var okmessages = ['', "Geçerliyse, gönderilen postayı sıfırlayın.", "E-posta gönderildi.", "E-posta doğrulaması gerekiyor, posta kutunuzu kontrol edin ve onay bağlantısını tıklayın.", "SMS gönderildi."];
        ...
        function useEmailToken() {
            ...
            setDialogMode(1, "Güvenli giriş", 3, useEmailKeyEx, "Belirteç kayıtlı e-posta adresine gönderilsin mi?");
        }
        ...
        function useSMSToken() {
            ...
            setDialogMode(1, "Güvenli giriş", 3, useSMSTokenEx, "Belirteç kayıtlı telefon numarasına gönderilsin mi?");
        }
        ...
        function showPassHint() {
            if (passRequirements.hint === true) { messagebox("Şifre ipucu", passhint); }
        }
            ...
            if (Q('apassword1').value == '') {
                ...
                if (!passRequirementsEx) {
                    ...
                    if (passReq == false) {
                        ...
                        QH('passWarning', '<span style=color:red><b>' + "Şifre politikası" + '</b><span>'); // TODO: Display problem hint
