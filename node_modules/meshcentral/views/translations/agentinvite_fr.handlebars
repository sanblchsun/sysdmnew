<!DOCTYPE html><html lang="fr"><head>
    ...
    {{{customJSTags}}}
    <title>Installation de l'agent</title>
    <style>
        .tab {
            overflow: hidden;
    ...
    <div id="container">
        ...
        <div id="column_l" style="overflow-y:auto">
            <h1><span id="groupname">Installation de l'agent</span></h1>
            <p>
            ...
            <div>
                <div class="tab">
                    ...
                    <button id="tlinuxbinarytab" class="tablinks" onclick="openTab(event, 'linuxbinarytab')">Exécutable d'installation Linux / BSD / macOS</button>
                ...
                <div id="wintab64" class="tabcontent" style="background-color:white;color:black">
                    ...
                    <p><a id="win64url">Télécharger le logiciel ici</a>, exécutez le puis cliquez sur "Install" ou "Connect".</p>
                ...
                <div id="wintab32" class="tabcontent" style="background-color:white;color:black">
                    ...
                    <p><a id="win32url">Télécharger le logiciel ici</a>, exécutez le puis cliquez sur "Install" ou "Connect".</p>
                    <div style="text-align:center">
                ...
                <div id="wintabarm64" class="tabcontent" style="background-color:white;color:black">
                    ...
                    <p><a id="winarm64url">Télécharger le logiciel ici</a>, exécutez le puis cliquez sur "Install" ou "Connect".</p>
                    <div style="text-align:center">
                ...
                <div id="linuxtab" class="tabcontent" style="background-color:white;color:black">
                    <h3>Linux</h3>
                    <p>Pour installer, couper et coller la commande suivante dans un terminal ayant des droits administrateur</p>
                    <div id="linuxinstall" style="font-family:courier,'courier new',monospace;margin-left:30px"></div>
                    <input type="button" value="Copier dans le presse-papiers" style="margin-left:30px;margin-top:4px" onclick="copyToClipLinuxInstall()">
                    <p>Pour déinstaller, couper/coller la commande suivante avec un compte administrateur.</p>
                    <div id="unlinuxinstall" style="font-family:courier,'courier new',monospace;margin-left:30px"></div>
                    <input type="button" value="Copier dans le presse-papiers" style="margin-left:30px;margin-top:4px" onclick="copyToClipLinuxUnInstall()">
                    <br><br>
                </div>
                ...
                <div id="macostab64" class="tabcontent" style="background-color:white;color:black">
                    ...
                    <p><a id="macos64url">Télécharger l'installeur ici</a>, faites un clic droit dessus ou appuyez sur "contrôle" et cliquez sur le fichier. Sélectionnez ensuite "Ouvrir" et suivez les instructions.</p>
                    <div style="text-align:center">
                ...
                <div id="macostabarm64" class="tabcontent" style="background-color:white;color:black">
                    ...
                    <p><a id="macosarm64url">Télécharger l'installeur ici</a>, faites un clic droit dessus ou appuyez sur "contrôle" et cliquez sur le fichier. Sélectionnez ensuite "Ouvrir" et suivez les instructions.</p>
                    <div style="text-align:center">
                ...
                <div id="macostab" class="tabcontent" style="background-color:white;color:black">
                    ...
                    <p><a id="macosurl">Télécharger l'installeur ici</a>, faites un clic droit dessus ou appuyez sur "contrôle" et cliquez sur le fichier. Sélectionnez ensuite "Ouvrir" et suivez les instructions.</p>
                    <div style="text-align:center">
                ...
                <div id="androtab" class="tabcontent" style="background-color:white;color:black">
                    ...
                    <div style="min-height:220px">
                        <p>Installez l'agent depuis le store Google Play ou le fichier APK et utilisez le QR code ci-contre ou le lien de jumelage pour associer votre appareil à ce serveur</p>
                        <p>
                        ...
                        <p>
                            <a id="androidurl">Télécharger l'APK Android</a>
                        </p>
                        <p>
                            <a rel="noreferrer noopener" target="_blank" href="{{{magenturl}}}">Lien de jumelage au serveur</a>
                        </p>
                    </div>
                </div>
                ...
                <div id="assistab" class="tabcontent" style="background-color:white;color:black">
                    ...
                    <div style="min-height:220px">
                        ...
                        <p>Assistant est un outil Windows vous permettant de demander de l'assistance quand vous en avez besoin. Une fois installé, il est disponible dans la barre des tâches. Assistant se connecte au serveur uniquement le temps des demandes d'assistance. La connexion n'est donc pas permanente.</p>
                        <p>
                            <a id="assisturl" rel="noreferrer noopener" target="_blank">Télécharger "Assistant" pour Windows</a>
                        </p>
                    </div>
                    <br style="clear:both">
                </div>
    ...
    <script>
        ...
        function startup() {
            ...
            if (groupName != '') {
                QH('groupname', format("Installation distante de l'agent pour {0}", escapeHtml(groupName)));
                document.title = format("{0} {0} - Installation de l'agent", groupName);
            } else {
                document.title = "Installation de l'agent";
            }
        ...
        function linuxBinarySetup() {
            var x = '<h3>' + "Exécutable d'installation Linux / BSD / macOS" + '</h3>', moreoptions = '';
            var opts = '<select id=aginsSelect onchange=addAgentToMeshClick() style=width:236px>';
            opts += '<option value=5 selected>' + "Exécutable d'installation Linux / BSD / macOS" + '</option>';
            opts += '</select>';
            ...
            x += addHtmlValue("Type de système", '<select id=aginsSysType onchange=addAgentToMeshClick() style=width:236px>' + moreoptions + '</select>');
            x += '</div>';
            x += '<div id=aginsTypeDiv>';
            x += addHtmlValue("Type d'installation", '<select id=aginsType onchange=addAgentToMeshClick() style=width:236px><option value=0>' + "Ligne de commande & bureau distant" + '</option><option value=2>' + "Ligne de commande uniquement" + '</option><option value=1>' + "Interactif seulement" + '</option></select>');
            x += '</div><hr>';
            ...
            x += addHtmlValue("Mesh Agent", '<a id=aginsbinlnk name="meshagents?id=' + meshid + '&installflags=0' + (urlargs.key?('&key=' + urlargs.key):'') + '">' + "MeshAgent" + '</a> <img src=images/link4.png height=10 width=10 title="' + "Copier l'URL de l'agent dans le presse papier" + '" style=cursor:pointer onclick=copyAgentUrl("meshagents?id=' + meshid + '&installflags=",1)>');
            x += addHtmlValue("Commande", '<input id=aginsbincmd type=text style="width:216px" readonly value=\'wget -O meshagent ' + ((serverNoProxy != 0) ?'--no-proxy':'') + ' --no-check-certificate \"https://' + servername + portStr + domainUrl + 'meshagents?id=' + meshid.split('$').join('%24').split('@').join('%40') + '\' /> <img src=images/link4.png height=10 width=10 title="' + "Copier l'URL de l'agent dans le presse papier" + '" style=cursor:pointer onclick=copyAgentIdValue("aginsbincmd")>');
            x += '</div>';
            QH('linuxbinarytab', x);
            addAgentToMeshClick();
        }
