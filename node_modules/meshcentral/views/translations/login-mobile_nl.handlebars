<!DOCTYPE html><html dir="ltr" xmlns="http://www.w3.org/1999/xhtml"><head lang="en">
                            ...
                            <div id="loginpanel" style="background-color:#979797;border-radius:16px;width:260px;padding:16px;text-align:center;clear:both;display:none">
                                <form method="post">
                                    ...
                                    <table>
                                        ...
                                        <tr>
                                            <td><div id="showPassHintLink" style="display:none"><a onclick="showPassHint()" style="cursor:pointer">Toon hint</a></div></td>
                                    ...
                                    <div id="resetAccountDiv" style="display:none;padding:2px">
                                        <span id="resetAccountSpan">Gebruikersnaam/wachtwoord vergeten?</span> <a onclick="xgo(3)" style="cursor:pointer">Account opnieuw instellen</a>.
                                    </div>
                                    <div id="newAccountDiv" style="display:none;padding:2px">
                                        Heb je nog geen account? <a onclick="xgo(2)" style="cursor:pointer">Creëer er een</a>.
                                    </div>
                                    ...
                                    <div id="authStrategies" style="display:none">
                                        ...
                                        <a id="auth-twitter" href="auth-twitter" style="display:none"><img src="images/login/twitter32.png" width="32" height="32" style="margin-left:3px;margin-right:3px;border-radius:3px;box-shadow:2px 2px 5px black;cursor:pointer" title="Log in met Twitter"></a>
                                        <a id="auth-google" href="auth-google" style="display:none"><img src="images/login/google32.png" width="32" height="32" style="margin-left:3px;margin-right:3px;border-radius:3px;box-shadow:2px 2px 5px black;cursor:pointer" title="Log in met Google"></a>
                                        <a id="auth-github" href="auth-github" style="display:none"><img src="images/login/github32.png" width="32" height="32" style="margin-left:3px;margin-right:3px;border-radius:3px;box-shadow:2px 2px 5px black;cursor:pointer" title="Log in met GitHub"></a>
                                        <a id="auth-azure" href="auth-azure" style="display:none"><img src="images/login/azure32.png" width="32" height="32" style="margin-left:3px;margin-right:3px;border-radius:3px;box-shadow:2px 2px 5px black;cursor:pointer" title="Log in met Azure"></a>
                                        ...
                                        <a id="auth-jumpcloud" href="auth-jumpcloud" style="display:none"><img src="images/login/jumpcloud32.png" width="32" height="32" style="margin-left:3px;margin-right:3px;border-radius:3px;box-shadow:2px 2px 5px black;cursor:pointer" title="Log in met JumpCloud"></a>
                                        <a id="auth-intel" href="auth-intel" style="display:none"><img src="images/login/intel32.png" width="32" height="32" style="margin-left:3px;margin-right:3px;border-radius:3px;box-shadow:2px 2px 5px black;cursor:pointer" title="Log in met Intel"></a>
                                        <a id="auth-saml" href="auth-saml" style="display:none"><img src="images/login/generic32.png" width="32" height="32" style="margin-left:3px;margin-right:3px;border-radius:3px;box-shadow:2px 2px 5px black;cursor:pointer" title="Eenmalige aanmelding"></a>
                                    </div>
                                </form>
                            </div>
                                    ...
                                    <form method="post">
                                        ...
                                        <table>
                                            <tbody><tr id="nuUserRow">
                                                <td align="right" width="100">Gebruikersnaam:</td>
                                            ...
                                            <tr id="createPanelHint" style="display:none">
                                                <td align="right">Wachtwoord hint:</td>
                                            ...
                                            <tr id="newAccountPass" title="Voer het token voor het maken van een account in">
                                                <td align="right">Token aanmaken:</td>
                                        ...
                                        <hr><a onclick="xgo(1)" style="cursor:pointer">Terug naar inloggen</a>
                                        ...
                                        <tr>
                                            <td colspan="2">
                                                ...
                                                <div style="float:right">
                                                    <input style="display:none;float:right" id="securityKeyButton" type="button" value="Gebruik beveiligingssleutel" onclick="useSecurityKey()">
        ...
        <div id="footer" style="height:32px;width:100%;text-align:center;background-color:#113962;position:absolute;bottom:0px">
            <table cellpadding="0" cellspacing="6" style="width:100%">
                <tbody><tr>
                    ...
                    <td style="text-align:right">{{{rootCertLink}}}&nbsp;<a href="terms">Voorwaarden &amp; Privacy</a></td>
                </tr>
            </tbody></table>
        </div>
    </div>
    ...
    <script>
        ...
        var okmessages = ['', "Indien geldig, verzend de reset e-mail.", "E-mail verzonden.", "E-mailverificatie vereist, controleer uw mailbox en klik op de bevestigingslink.", "SMS verzonden."];
        ...
        function useEmailToken() {
            ...
            setDialogMode(1, "Beveiligde login", 3, useEmailKeyEx, "Token naar geregistreerd e-mailadres verzenden?");
        }
        ...
        function useSMSToken() {
            ...
            setDialogMode(1, "Beveiligde login", 3, useSMSTokenEx, "Token naar geregistreerd telefoonnummer verzenden?");
        }
        ...
        function showPassHint() {
            if (passRequirements.hint === true) { messagebox("Wachtwoord hint", passhint); }
        }
            ...
            if (Q('apassword1').value == '') {
                ...
                if (!passRequirementsEx) {
                    ...
                    if (passReq == false) {
                        ...
                        QH('passWarning', '<span style=color:red><b>' + "Wachtwoord beleid" + '</b><span>'); // TODO: Display problem hint
