<!DOCTYPE html><html dir="ltr" xmlns="http://www.w3.org/1999/xhtml"><head lang="en">
                            ...
                            <div id="loginpanel" style="background-color:#979797;border-radius:16px;width:260px;padding:16px;text-align:center;clear:both;display:none">
                                <form method="post">
                                    ...
                                    <table>
                                        ...
                                        <tr>
                                            <td><div id="showPassHintLink" style="display:none"><a onclick="showPassHint()" style="cursor:pointer">Vis tip</a></div></td>
                                    ...
                                    <div id="resetAccountDiv" style="display:none;padding:2px">
                                        <span id="resetAccountSpan">Glemt bruger/adgangskode?</span> <a onclick="xgo(3)" style="cursor:pointer">Nulstil konto</a>.
                                    </div>
                                    <div id="newAccountDiv" style="display:none;padding:2px">
                                        Har du ikke en konto? <a onclick="xgo(2)" style="cursor:pointer">Opret en</a>.
                                    </div>
                                    ...
                                    <div id="authStrategies" style="display:none">
                                        ...
                                        <a id="auth-twitter" href="auth-twitter" style="display:none"><img src="images/login/twitter32.png" width="32" height="32" style="margin-left:3px;margin-right:3px;border-radius:3px;box-shadow:2px 2px 5px black;cursor:pointer" title="Log ind med Twitter"></a>
                                        <a id="auth-google" href="auth-google" style="display:none"><img src="images/login/google32.png" width="32" height="32" style="margin-left:3px;margin-right:3px;border-radius:3px;box-shadow:2px 2px 5px black;cursor:pointer" title="Log ind med Google"></a>
                                        <a id="auth-github" href="auth-github" style="display:none"><img src="images/login/github32.png" width="32" height="32" style="margin-left:3px;margin-right:3px;border-radius:3px;box-shadow:2px 2px 5px black;cursor:pointer" title="Log ind med GitHub"></a>
                                        <a id="auth-azure" href="auth-azure" style="display:none"><img src="images/login/azure32.png" width="32" height="32" style="margin-left:3px;margin-right:3px;border-radius:3px;box-shadow:2px 2px 5px black;cursor:pointer" title="Log ind med Azure"></a>
                                        ...
                                        <a id="auth-jumpcloud" href="auth-jumpcloud" style="display:none"><img src="images/login/jumpcloud32.png" width="32" height="32" style="margin-left:3px;margin-right:3px;border-radius:3px;box-shadow:2px 2px 5px black;cursor:pointer" title="Log ind med JumpCloud"></a>
                                        <a id="auth-intel" href="auth-intel" style="display:none"><img src="images/login/intel32.png" width="32" height="32" style="margin-left:3px;margin-right:3px;border-radius:3px;box-shadow:2px 2px 5px black;cursor:pointer" title="Log ind med Intel"></a>
                                    ...
                                    <form method="post">
                                        ...
                                        <table>
                                            <tbody><tr id="nuUserRow">
                                                <td align="right" width="100">Brugernavn:</td>
                                            ...
                                            <tr id="createPanelHint" style="display:none">
                                                <td align="right">Adgangskodetip:</td>
                                            ...
                                            <tr id="newAccountPass" title="Indtast konto oprettelsestoken">
                                                <td align="right">Oprettelses token:</td>
                                        ...
                                        <hr><a onclick="xgo(1)" style="cursor:pointer">Tilbage til login</a>
                                        ...
                                        <tr>
                                            <td colspan="2">
                                                ...
                                                <div style="float:right">
                                                    <input style="display:none;float:right" id="securityKeyButton" type="button" value="Brug sikkerhedsnøgle" onclick="useSecurityKey()">
        ...
        <div id="footer" style="height:32px;width:100%;text-align:center;background-color:#113962;position:absolute;bottom:0px">
            <table cellpadding="0" cellspacing="6" style="width:100%">
                <tbody><tr>
                    ...
                    <td style="text-align:right">{{{rootCertLink}}}&nbsp;<a href="terms">Vilkår og privatliv</a></td>
                </tr>
            </tbody></table>
        </div>
    </div>
    ...
    <script>
        ...
        var okmessages = ['', "Hvis det er gyldigt, nulstil e-mail sendt.", "E-mail sendt.", "E-mail bekræftelse påkrævet, tjek din postkasse og klik på bekræftelseslinket.", "SMS sendt."];
        ...
        function useEmailToken() {
            ...
            setDialogMode(1, "Sikkert login", 3, useEmailKeyEx, "Send token til registreret e-mailadresse?");
        }
        ...
        function useSMSToken() {
            ...
            setDialogMode(1, "Sikkert login", 3, useSMSTokenEx, "Send token til registreret telefonnummer?");
        }
        ...
        function showPassHint() {
            if (passRequirements.hint === true) { messagebox("Adgangskodetip", passhint); }
        }
            ...
            if (Q('apassword1').value == '') {
                ...
                if (!passRequirementsEx) {
                    ...
                    if (passReq == false) {
                        ...
                        QH('passWarning', '<span style=color:red><b>' + "Adgangskodepolitik" + '</b><span>'); // TODO: Display problem hint
