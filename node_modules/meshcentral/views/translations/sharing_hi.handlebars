<!DOCTYPE html><html lang="hi" dir="ltr" xmlns="http://www.w3.org/1999/xhtml"><head>
    ...
    </head><body style="overflow:hidden;background-color:black">{{{customCSSTags}}}
    ...
    <div id="LeftSideToolBar" style="display:none;position:absolute;left:0;bottom:0;width:52px;top:0;background:#113962;background:linear-gradient(to bottom, #104893 0%,#113962 100%);color:white;border-right: 5px solid #BBB;">
        <div id="LeftMenuDesktop" class="slbbutton slbbuttonsel2" title="डेस्कटॉप" onclick="go(11)">
            <div class="slb1" style="position:absolute;top:6px;left:6px"></div>
        </div>
        <div id="LeftMenuTerminal" class="slbbutton" title="टर्मिनल" onclick="go(12)">
            <div class="slb2" style="position:absolute;top:6px;left:6px"></div>
        </div>
        <div id="LeftMenuFiles" class="slbbutton" title="फ़ाइलें" onclick="go(13)">
        ...
        <div id="deskarea0">
            <div id="deskarea1" class="areaHead" style="line-height:24px">
                <div class="toright2">
                    ...
                    <div class="deskareaicon" title="टॉगल देखें मोड" onclick="toggleAspectRatio(1)">⇲</div>
                    <div class="deskareaicon" title="बायीं ओर घुमाओ" onclick="drotate(-1)">↺</div>
                    <div class="deskareaicon" title="दाएं घुमाएं" onclick="drotate(1)">↻</div>
                    <input id="deskActionsSettings" type="button" value="समायोजन..." title="दूरस्थ डेस्कटॉप सेटिंग्स संपादित करें" onkeypress="return false" onkeydown="return false" onclick="showDesktopSettings()" class="mR">
                    <div id="desktopCustomUiButtons" style="float:left"></div>
                    <div id="deskRecordIcon" class="deskareaicon" title="सर्वर इस सत्र की रिकॉर्डिंग कर रहा है" style="display:none;background-color:red;width:12px;height:12px;border-radius:6px;margin-top:5px"></div>
                </div>
                <div>
                    <div id="idx_deskFullBtn2" onclick="deskToggleFull(event)">&nbsp;✖</div>
                    <input type="button" id="autoconnectbutton1" value="स्वतः जुड़ना" onclick="autoConnectDesktop(event)" onkeypress="return false" onkeydown="return false" style="display:none">
                    <span id="connectbutton1span"><input type="button" id="connectbutton1" cmenu="deskConnectButton" value="जुडिये" onclick="connectDesktop(event,3)" onkeypress="return false" onkeydown="return false" disabled="disabled"></span>
                    <span id="connectbutton1hspan">&nbsp;<input type="button" id="connectbutton1h" value="एचडब्ल्यू कनेक्ट" title="Intel AMT हार्डवेयर KVM का उपयोग करके कनेक्ट करें" onclick="connectDesktop(event,2)" onkeypress="return false" onkeydown="return false" disabled="disabled"></span>
                    <span id="disconnectbutton1span">&nbsp;<input type="button" id="disconnectbutton1" value="डिस्कनेक्ट" onclick="connectDesktop(event,0)" onkeypress="return false" onkeydown="return false"></span>
                    &nbsp;<span id="deskstatus">डिस्कनेक्ट किया गया</span><span id="deskmetadata"></span>
                </div>
            </div>
            ...
            <div id="deskarea4" class="areaFoot" style="min-height:24px">
                <div class="toright2">
                    <span id="DeskLatency" style="line-height:22px;width:50px" title="डेस्कटॉप सत्र विलंबता"></span>
                    <span id="DeskTimer" style="line-height:22px" title="सत्र का समय"></span>&nbsp;
                    ...
                    <span id="DeskSaveImageButton" title="दूरस्थ डेस्कटॉप का स्क्रीनशॉट सहेजें"><img src="images/icon-camera.png" onclick="deskSaveImage()" height="16" width="16" style="padding-top:2px"></span>
                </div>
                <div style="height:22px">
                    <select id="deskkeys">
                        ...
                        <option value="11">जीत + वाम</option>
                        <option value="12">जीत + दायां</option>
                    </select>
                    <input id="DeskWD" type="button" value="संदेश" onkeypress="return false" onkeydown="return false" onclick="deskSendKeys()">
                    <input id="DeskClip" style="" type="button" value="क्लिपबोर्ड" onkeypress="return false" onkeydown="return false" onclick="showDeskClip()">
                    <input id="DeskType" style="" type="button" value="प्रकार" onkeypress="return false" onkeydown="return false" onclick="showDeskType()">
                    <label><span id="DeskControlSpan" title="माउस और कीबोर्ड इनपुट टॉगल करें"><input id="DeskControl" type="checkbox" onkeypress="return false" onkeydown="return false" onclick="toggleKvmControl()">इनपुट</span></label>&nbsp;
                </div>
            </div>
        </div>
    </div>
    <div id="p12" class="noselect" style="overflow:hidden;position:absolute;left:54px;top:0;right:0;bottom:0;display:none;background-color:black">
        <div id="p12warning" onclick="showFeaturesDlg()">
            <div class="icon2"></div>
            <div class="warningbox">Intel® AMT पुनर्निर्देशन पोर्ट या KVM सुविधा अक्षम है<span id="p12warninga">इसे सक्षम करने के लिए यहां क्लिक करें।</span></div>
        </div>
        <div id="p12warning2" onclick="showPowerActionDlg()">
            <div class="icon2"></div>
            <div class="warningbox">रिमोट कंप्यूटर चालू नहीं है, पावर कमांड जारी करने के लिए यहां क्लिक करें।</div>
        </div>
        <div class="areaHead" style="position:absolute;top:0;left:0;right:0;height:24px">
            <div class="toright2">
                <div id="termRecordIcon" class="deskareaicon" title="सर्वर इस सत्र की रिकॉर्डिंग कर रहा है" style="display:none;background-color:red;width:12px;height:12px;border-radius:6px;margin-top:5px;margin-left:5px"></div>
                <div id="p12power" style="margin-top:3px;margin-right:4px;float:right"></div>
            </div>
            <div>
                <span id="connectbutton2span"><input type="button" id="connectbutton2" cmenu="termConnectButton" value="जुडिये" onclick="connectTerminal(event,1)" onkeypress="return false" onkeydown="return false" disabled="disabled"></span>
                <span id="disconnectbutton2span">&nbsp;<input type="button" id="disconnectbutton2" value="डिस्कनेक्ट" onclick="connectTerminal(event,0)" onkeypress="return false" onkeydown="return false"></span>
                &nbsp;<span id="termstatus">डिस्कनेक्ट किया गया</span><span id="termtitle"></span>
            </div>
        </div>
        ...
        <div class="areaFoot" style="position:absolute;bottom:0;left:0;right:0;height:24px">
            <div class="toright2">
                <span id="TermLatency" title="टर्मिनल सत्र की विलंबता"></span>
                <span id="TermTimer" title="सत्र का समय"></span>&nbsp;
                <span id="terminalSettingsButtons" style="display:none">
                    <input id="id_tcrbutton" type="button" onkeypress="return false" onkeydown="return false" class="bottombutton" value="सीआर + वामो" title="रिटर्न कुंजी को टॉगल करें" onclick="termToggleCr()">
                    <input id="id_tfxkeysbutton" type="button" onkeypress="return false" onkeydown="return false" class="bottombutton" value="इंटेल (F10 = ESC + [OM)" title="F10 से F10 कीज इम्यूलेशन टाइप को टॉगल करें" onclick="termToggleFx()">
                    <input id="id_ttypebutton" type="button" onkeypress="return false" onkeydown="return false" class="bottombutton" value="विस्तारित अस्सी" title="टर्मिनल एमुलेशन टाइप टॉगल करें" onclick="termToggleType()">
                </span>
                ...
                <span id="specialKeyDropDown">
                    ...
                    <input id="specialkeylistinput" type="button" onkeypress="return false" class="bottombutton" value="संदेश" title="चयनित विशेष कुंजी भेजें" onclick="sendSpecialKey()">
                </span>
            </div>
            <div>
                &nbsp;
                <input type="button" onkeypress="return false" onkeydown="return false" class="bottombutton" id="ctrlcbutton" value="सीटीएल-सी" onclick="termSendKey(3,'ctrlcbutton')">
                <input type="button" onkeypress="return false" onkeydown="return false" class="bottombutton" id="ctrlxbutton" value="सीटीएल एक्स" onclick="termSendKey(24,'ctrlxbutton')">
                ...
                <input type="button" onkeypress="return false" onkeydown="return false" class="bottombutton" id="bsbutton" value="बैकस्पेस" onclick="termSendKey(8,'bsbutton')" style="display:none">
                <input type="button" onkeypress="return false" onkeydown="return false" class="bottombutton" id="pastebutton" value="पेस्ट करें" title="टेक्स्ट को टर्मिनल में पेस्ट करें" onclick="showTermPasteDialog()" style="display:none">
            </div>
        </div>
    ...
    <div id="p13" class="noselect" style="overflow:hidden;position:absolute;left:54px;top:0;right:0;bottom:0;display:none;background-color:white">
        <div id="p13toolbar" style="position:absolute;left:0;top:0;right:0;bottom:28px">
            <div class="areaHead">
                <div class="toright2">
                    <div id="filesRecordIcon" class="deskareaicon" title="सर्वर इस सत्र की रिकॉर्डिंग कर रहा है" style="display:none;background-color:red;width:12px;height:12px;border-radius:6px;margin-top:5px;margin-left:5px"></div>
                    <div id="p13power" style="margin-top:3px;margin-right:4px;float:right"></div>
                </div>
                <div>
                    <input id="p13Connect" value="जुडिये" onclick="connectFiles(event)" type="button">
                    &nbsp;<span id="p13Status">डिस्कनेक्ट किया गया</span>
                </div>
            </div>
            <div id="fileArea2" class="areaHead2" valign="bottom">
                <div id="p13rightOfButtons" class="toright2"></div>
                <div>
                    <input type="button" id="p13FolderUp" disabled="disabled" onclick="p13folderup()" value="यूपी">&nbsp;
                    <input type="button" id="p13SelectAllButton" disabled="disabled" onclick="p13selectallfile()" value="सभी का चयन करे">&nbsp;
                    <input type="button" id="p13RenameFileButton" disabled="disabled" value="नाम बदलें" onclick="p13renamefile()">&nbsp;
                    <input type="button" id="p13DeleteFileButton" disabled="disabled" value="हटाएं" onclick="p13deletefile()">&nbsp;
                    <input type="button" id="p13ViewFileButton" disabled="disabled" value="संपादित करें" onclick="p13viewfile()">&nbsp;
                    <input type="button" id="p13NewFolderButton" disabled="disabled" value="नया फोल्डर" onclick="p13createfolder()">&nbsp;
                    <input type="button" id="p13UploadButton" disabled="disabled" value="डालना" onclick="p13uploadFile()">&nbsp;
                    <input type="button" id="p13CutButton" disabled="disabled" value="कट गया" onclick="p13copyFile(1)">&nbsp;
                    <input type="button" id="p13CopyButton" disabled="disabled" value="प्रतिलिपि" onclick="p13copyFile(0)">&nbsp;
                    <input type="button" id="p13PasteButton" disabled="disabled" value="पेस्ट करें" onclick="p13pasteFile()">&nbsp;
                    <input type="button" id="p13ZipButton" disabled="disabled" value="ज़िप" onclick="p13zipFiles()">&nbsp;
                    <input type="button" id="p13RefreshButton" disabled="disabled" value="ताज़ा करना" onclick="p13folderup(9999)">&nbsp;
                    <input type="button" id="p13FindButton" disabled="disabled" value="खोज" onclick="p13findfile()">&nbsp;
                </div>
            </div>
    ...
    <div id="dialog" class="noselect" style="display:none">
        ...
        <div id="dialogBody">
            ...
            <div id="dialog4" style="">
                <input id="d4WrapButton" type="button" value="लपेटें पर" onclick="d4ToggleWrap()">
                <input id="d4SizeButton" type="button" value="छोटा" onclick="d4ToggleSize()">
                <input id="d4EncodingButton" type="button" value="कच्चा" onclick="d4ToggleEncoding()">
                <input id="d4LineBreakButton" type="button" value="खिड़कियाँ" onclick="d4ToggleLineBreak()">
                ...
                <div id="d7meshkvm">
                    ...
                    <div id="d7desktopOtherSettings">
                        ...
                        <div id="d7otherset2" style="display:block">
                            <label style="display:block"><input type="checkbox" id="d7deskSwapMouse">माउस माउस को स्वैप करें</label>
                            <label style="display:block"><input type="checkbox" id="d7deskRemoteKeyMap">रिमोट कीबोर्ड मैप का उपयोग करें</label>
                        </div>
                    </div>
                </div>
                <div id="d7amtkvm">
                    <h4>Intel® AMT हार्डवेयर KVM</h4>
                    <div>
                        <div>छवि एनकोडिंग</div>
                    ...
                    <div>
                        ...
                        <div id="d7otherset" style="display:block">
                            <label style="display:block"><input type="checkbox" id="d7showfocus">फोकस टूल दिखाएं</label>
                            <label style="display:block"><input type="checkbox" id="d7showcursor">स्थानीय माउस कर्सर दिखाएँ</label>
                            <label style="display:block"><input type="checkbox" id="d7localKeyMap">स्थानीय कीबोर्ड मैप</label>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div id="idx_dlgButtonBar">
            <input id="idx_dlgCancelButton" type="button" value="रद्द करना" style="" onclick="dialogclose(0)">
            <input id="idx_dlgOkButton" type="button" value="ठीक" style="" onclick="dialogclose(1)">
    ...
    <script>
                        ...
                        if ((data != null) && (data.action != null)) {
                            if (data.action == 'restart') {
                                ...
                                webRtcDesktop.webchannel.onopen = function () {
                                    ...
                                    Q('deskstatus').textContent = StatusStrs[desktop.State] + ", शीतल-केवीएम";
                                    desktop.m.hold(true);
        ...
        function updateMetadata(conn, elementid) {
            ...
            if (conn && (conn.State == 3)) {
                ...
                if (viewerCount > 1) { str = '<span onclick=showSessionMetadata(1) style=cursor:pointer>' + format(", {0} देखना", viewerCount) + '</span>'; }
            }
            QH('deskmetadata', str);
        ...
        function showSessionMetadata(cid) {
            ...
            if (conn && conn.metadata) {
                var x = '';
                if (conn.metadata.startTime) { x += addHtmlValue4("समय शुरू", printDateTime(new Date(conn.metadata.startTime))); }
                if (conn.metadata.users) {
                    for (var i in conn.metadata.users) {
                        var val = (conn.metadata.users[i] == 1) ? "1 कनेक्शन" : format("{0} कनेक्शन", conn.metadata.users[i]);
                        var username = i.split('/')[2];
                        if ((users != null) && (users[i] != null)) { username = users[i].name; }
                        x += addHtmlValue4(format("उपयोगकर्ता \"{0}\"", username), val);
                    }
                }
                setDialogMode(2, "सत्र की जानकारी", 1, null, x, 'sessionMetadata' + cid);
            }
        }
        ...
        function showDeskType() {
            if (xxdialogMode || desktop == null || desktop.State != 3) return;
            Q('DeskType').blur();
            var x = '<div>' + "पाठ दर्ज करें और एक अमेरिकी अंग्रेजी कीबोर्ड का उपयोग करके इसे दूर से टाइप करने के लिए ठीक क्लिक करें। आगे बढ़ने से पहले रिमोट कर्सर को सही स्थिति में रखना सुनिश्चित करें।" + '<div>';
            x += '<textarea id=d2typeText style="margin-top:5px;width:100%;height:184px;resize:none" maxlength=2000></textarea>';
            setDialogMode(2, "रिमोट कीबोर्ड एंट्री", 3, showDeskTypeEx, x);
            Q('d2typeText').focus();
        }
        ...
        */
        ...
        function deskSaveImage() {
            if (xxdialogMode || desktop == null || desktop.State != 3) return;
            var d = new Date(), n = "डेस्कटॉप" + '-' + d.getFullYear() + '-' + ('0' + (d.getMonth() + 1)).slice(-2) + '-' + ('0' + d.getDate()).slice(-2) + '-' + ('0' + d.getHours()).slice(-2) + '-' + ('0' + d.getMinutes()).slice(-2);
        ...
        var terminalEmulations = ["UTF8 टर्मिनल", "विस्तारित ASCII", "इंटेल ASCII"];
        ...
        var fxEmulations = ["इंटेल (F10 = ESC + [OM)", "वैकल्पिक (F10 = ESC + 0)", "VT100 + (F10 = ESC + [ओए)"];
        ...
        function showTermPasteDialog() {
            if (!terminal || xxdialogMode) return;
            Q('pastebutton').blur();
            setDialogMode(2, "पेस्ट करें", 3, showTermPasteDialogEx, '<textarea id=d2pasteText style="width:100%;height:184px;resize:none"></textarea>');
            Q('d2pasteText').focus();
        }
        ...
        function onFilesStateChange(xfiles, state) {
            p13Connect.value = (state == 0) ? "जुडिये" : "डिस्कनेक्ट";
        ...
        function p13gotFiles(data) {
            ...
            if (data.action == 'findfile') {
                if (xxdialogTag == data.reqid) {
                    if (data.r == null) {
                        ...
                        xxdialogTag = null;
                        if (Q('d2findResults').innerHTML == '') { QH('d2findResults', '<div style=text-align:center;margin:10px><i>' + "कोई फाइल नहीं मिली" + '</i></div>'); }
                    } else {
            ...
            if (data.action == 'dialogmessage') {
                if ((data.msg == null) && (xxdialogTag == 'fileMsgDialog')) {
                    ...
                    setDialogMode(2, "फ़ाइल ऑपरेशन", 10, p13fileOperationDialogEx, '<div style=margin:10px>' + "फाइलों को समेटना ..." + '<div>', 'fileMsgDialog');
                } else if ((data.msg == 'zippingFile') && ((!xxdialogMode) || (xxdialogTag == 'fileMsgDialog'))) {
                    // Show the dialog box message
                    setDialogMode(2, "फ़ाइल ऑपरेशन", 10, p13fileOperationDialogEx, '<div style=margin:10px>' + EscapeHtml(data.file) + '<div><br /><progress value=' + EscapeHtml(data.progress) + ' style=width:100% max=100 />', 'fileMsgDialog');
                }
                return;
            }
        ...
        function p13updateFiles(checkedNames) {
            var html1 = '', html2 = '', displayPath = '<a href=# style=cursor:pointer onclick="return p13folderup(0)">' + "जड़" + '</a>', fullPath = 'Root';
            ...
            for (var i in filetreexx) {
                ...
                if (f.t < 3) {
                    var right = '', title = '';
                    h = '<div class=filelist file=999><input file=999 style=float:left name=fd class=fcb type=checkbox onchange=p13setActions() value=\'' + f.nx + '\'>&nbsp;<span style=float:right title="' + title + '">' + right + '</span><span title="' + shortname + '"><div class=fileIcon' + f.t + ' onclick=p13folderset("' + encodeURIComponentEx(f.nx) + '")></div><a href=# style=cursor:pointer onclick=\'return p13folderset("' + encodeURIComponentEx(f.nx) + '")\'>' + shortname + '</a></span></div>';
                } else {
                    var link = shortname;
                    if (f.s > 0) {
                        // Local link
                    ...
                    h = '<div id=fileEntry cmenu=filesContextMenu fileIndex=' + i + ' class=filelist file=3><input file=3 style=float:left name=fd class=fcb type=checkbox onchange=p13setActions() value=\'' + f.nx + '\'>&nbsp;<span class=fsize>' + fdatestr + '</span><span style=float:right>' + EscapeHtml(fsize) + '</span><span title="' + shortname + '"><div class=fileIcon' + f.t + '></div>' + link + '</span></div>';
                }
        ...
        function p13findfile() {
            if (xxdialogMode) return;
            var x = addHtmlValue("फ़िल्टर", '<input id=d2findFilter style="width:230px" onkeyup=p13findfileValidate() onkeydown=p13findfileDown(event) placeholder="*.txt"></input>');
            ...
            x += '<div style=margin-top:8px><input id=filefind_dlgCancelButton type=button value=' + "बंद करे" + ' style=float:right;width:80px;margin-left:5px onclick=p13findfileCancel()>';
            x += '<input id=filefind_dlgOkButton type=submit value=' + "खोज" + ' style=float:right;width:80px onclick=p13findfileEx()><br /><br /></div>';
            setDialogMode(2, "फ़ाइलें खोजें", 0, null, x);
            p13findfileValidate();
            Q('d2findFilter').focus();
        }

        function p13findfileDown(e) { if (e.code == "दर्ज") { p13findfileEx(); } }
        ...
        function p13setActions() {
            ...
            if (p13filetree == null) {
                ...
                Q('p13SelectAllButton').value = "सभी का चयन करे";
                ...
                Q('p13SelectAllButton').value = (cc > 0 ? "किसी का चयन न करें" : "सभी का चयन करे");
        ...
        function p13zipFiles() {
            ...
            setDialogMode(2, "ज़िप फ़ाइल नाम", 3, p13zipFilesEx, '<input type=text id=p13renameinput maxlength=64 onkeyup=p13fileNameCheck(event) style=width:100% value="" />', { action: 'zip', path: p13filetreelocation.join('/'), files: inputFiles });
        ...
        function p13pasteFile() {
            ...
            if ((p13clipboard != null) && (p13clipboard.length > 0)) {
                if (p13clipboardCut == 0) {
                    ...
                    if (p13clipboard.length > 1) { x = format("इस स्थान पर {0} प्रविष्टियों की पुष्टि करें?", p13clipboard.length); } else { x = format("इस स्थान पर 1 एंट्री की पुष्टि करें?"); }
                }
            }
        ...
        function p13downloadfile(x, y, z, tag) {
            ...
            setDialogMode(2, "फ़ाइल डाउनलोड करें", 10, p13downloadFileCancel, '<div>' + gdownloadFile.file + '</div><br /><progress id=d2progressBar style=width:100% value=0 max=' + z + ' />');
        }
        ...
        function d4ToggleWrap(update) {
            ...
            Q('d4WrapButton').value = ["लपेटें: पर", "लपेटें: बंद"][d4EditWrapVal];
        ...
        function d4ToggleSize(update) {
            ...
            Q('d4SizeButton').value = ["आकार: 100%", "आकार: 125%", "आकार: 150%", "आकार: 200%"][d4EditSizeVal];
        ...
        function d4ToggleEncoding(update) {
            ...
            Q('d4EncodingButton').value = ["एन्कोडिंग: रॉ","एन्कोडिंग: UTF8"][d4EditEncodingVal];
        ...
        function printFlexDateTime(d) { if (printDate(new Date()) == printDate(d)) { return format("{0} पर समाप्त हो रहा है", printTime(d)); } else { return format("समाप्ति {0}", printDateTime(d)); } }
        function getFileSizeStr(size) { if (typeof size != 'number') { size = 0; } if (size == 1) return "1 बाइट"; return format("{0} बाइट्स", size); }
