<!DOCTYPE html><html dir="ltr" xmlns="http://www.w3.org/1999/xhtml"><head lang="en">
    ...
    <div id="container">
        ...
        <div id="topbar" class="noselect style3" style="height:24px">
            <div id="uiMenuButton" title="Вибір інтерфейсу користувача" onclick="showUserInterfaceSelectMenu()">
                ♦
                <div id="uiMenu" style="display:none">
                    <div id="uiViewButton1" class="uiSelector" onclick="userInterfaceSelectMenu(1)" title="Інтерфейс із лівою панеллю меню"><div class="uiSelector1"></div></div>
                    <div id="uiViewButton2" class="uiSelector" onclick="userInterfaceSelectMenu(2)" title="Інтерфейс із верхньою панеллю"><div class="uiSelector2"></div></div>
                    <div id="uiViewButton3" class="uiSelector" onclick="userInterfaceSelectMenu(3)" title="Інтерфейс із фіксованою шириною"><div class="uiSelector3"></div></div>
                    <div id="uiViewButton4" class="uiSelector" onclick="toggleNightMode()" title="Перемкнути нічний режим"><div class="uiSelector4"></div></div>
                </div>
            </div>
        </div>
        <div id="column_l">
            <h1>Ласкаво просимо</h1>
            <div id="welcomeText" style="display:none">Підключайтеся до своїх домашніх або офісних пристроїв з будь-якої точки світу за допомогою MeshCentral, що являє собою вебсайт для віддаленого моніторингу та керування у режимі реального часу з відкритим кодом. Вам потрібно буде завантажити та встановити агент керування на своїх комп'ютерах. Після інсталювання, комп'ютери з'являться в розділі "Мої пристрої" цього вебсайту, і ви зможете відстежувати та керувати ними.</div>
                    ...
                    <td id="logincell">
                        <div id="loginpanel" style="display:none">
                            <form method="post">
                                ...
                                <div id="loginuserpassdiv" style="display:none">
                                    ...
                                    <table>
                                        <tbody><tr>
                                            <td id="loginusername" align="right" width="100">Ім'я користувача:</td>
                                        ...
                                        <tr>
                                            <td><div id="showPassHintLink" style="display:none"><a onclick="return showPassHint(event);" href="#" style="cursor:pointer">Показати підказку</a></div></td>
                                            <td align="right"><input id="loginButton" type="submit" value="Лоґін"></td>
                                        </tr>
                                    </tbody></table>
                        ...
                        <div id="createpanel" style="display:none;position:relative">
                            <form method="post">
                                ...
                                <table>
                                    ...
                                    <tr>
                                        <td colspan="2">
                                            <div style="float:right"><input id="createButton" type="submit" value="Створити Акаунт" disabled="disabled"></div>
                        ...
                        <div id="resetpanel" style="display:none">
                            <form method="post">
                                ...
                                <table>
                                    <tbody><tr>
                                        <td align="right" width="100">е-пошта:</td>
                                    ...
                                    <tr>
                                        <td colspan="2">
                                            <div style="float:right"><input id="eresetButton" type="submit" value="Скинути Акаунт" disabled="disabled"></div>
                                            <div id="passWarning" style="padding-top:6px"></div>
                                        </td>
                                    </tr>
                                </tbody></table>
                        ...
                        <div id="tokenpanel" style="display:none">
                            <form method="post" {{{autocomplete}}}="off">
                                ...
                                <table>
                                    <tbody><tr>
                                        <td align="right" width="100">Токен лоґіну:</td>
                                        <td>
                                    ...
                                    <tr>
                                        <td colspan="2">
                                            <div style="float:right"><input id="tokenOkButton" type="submit" value="Лоґін" disabled="disabled"></div>
                                            <div style="float:right">
                                                <input style="display:none;float:right" id="securityKeyButton" type="button" value="Використовувати ключ безпеки" onclick="useSecurityKey(1)">
                                                <input style="display:none;float:right" id="emailKeyButton" type="button" value="е-пошта" onclick="useEmailToken(1)">
                                                <input style="display:none;float:right" id="smsKeyButton" type="button" value="SMS" onclick="useSMSToken(1)">
                                                <input style="display:none;float:right" id="msgKeyButton" type="button" value="Обмін повідомленнями" onclick="useMsgToken(1)">
                        ...
                        <div id="resettokenpanel" style="display:none">
                            <form method="post">
                                ...
                                <table>
                                    ...
                                    <tr>
                                        <td colspan="2">
                                            <div style="float:right"><input id="resetTokenOkButton" type="submit" value="Лоґін" disabled="disabled"></div>
                                            <div style="float:right">
                                                <input style="display:none;float:right" id="securityKeyButton2" type="button" value="Використовувати ключ безпеки" onclick="useSecurityKey(2)">
                                                <input style="display:none;float:right" id="emailKeyButton2" type="button" value="е-пошта" onclick="useEmailToken(2)">
                                                <input style="display:none;float:right" id="smsKeyButton2" type="button" value="SMS" onclick="useSMSToken(2)">
                                                <input style="display:none;float:right" id="msgKeyButton2" type="button" value="Обмін повідомленнями" onclick="useMsgToken(2)">
                        ...
                        <div id="resetpasswordpanel" style="display:none;position:relative">
                            <form method="post">
                                ...
                                <table>
                                    ...
                                    <tr>
                                        <td colspan="2">
                                            <div style="float:right"><input id="resetPassButton" type="submit" value="Відновити Пароль" disabled="disabled"></div>
        ...
        <div id="footer">
            ...
            <div class="footer2">
                {{{rootCertLink}}}
                &nbsp;<a id="termsLinkFooter" href="terms">Умови та конфіденційність</a>
            </div>
        </div>
