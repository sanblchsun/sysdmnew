<!DOCTYPE html><html dir="ltr" xmlns="http://www.w3.org/1999/xhtml"><head lang="en">
    ...
    <div id="termShellContextMenu" class="contextMenu noselect" style="display:none;min-width:0px">
        ...
        <div id="cxtermps" class="cmtext" onclick="cmtermaction(6,event)">管理员PowerShell</div>
        <div id="cxtermunorm" class="cmtext" onclick="cmtermaction(8,event)">用户Shell</div>
        <div id="cxtermups" class="cmtext" onclick="cmtermaction(9,event)">用户PowerShell</div>
    </div>
    <div id="termShellContextMenuLinux" class="contextMenu noselect" style="display:none;min-width:0px">
        ...
        <div id="cxtermps" class="cmtext" onclick="cmtermaction(8,event)">用户Shell</div>
        <div id="cxtermps" class="cmtext" onclick="cmtermaction(100,event)">登录控制台</div>
    </div>
