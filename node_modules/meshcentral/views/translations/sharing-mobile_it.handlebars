<!DOCTYPE html><html lang="it" dir="ltr" xmlns="http://www.w3.org/1999/xhtml"><head>
                        ...
                        <div id="termTable" style="position:absolute;top:0;bottom:0;left:0;right:0">
                            <div id="termarea1">
                                <div class="areaHead" style="line-height:24px">
                                    ...
                                    <div>
                                        <span id="connectbutton2span" style="margin-left:3px"><input type="button" id="connectbutton2" cmenu="termConnectButton" value="Connetti" style="height:28px" onclick="connectTerminal(event,1)" onkeypress="return false" onkeydown="return false" disabled="disabled"></span>
                            ...
                            <tbody><tr>
                                <td style="background-color:#C0C0C0;border-bottom:2px solid black;padding:2px;line-height:24px">
                                    ...
                                    <div style="margin-left:2px">
                                        ...
                                        <input id="p13Connect" value="Connetti" onclick="connectFiles(event)" onkeypress="return false" onkeydown="return false" type="button">
    ...
    <div id="topMenu" style="z-index:1000;background-color:#EEE;box-shadow:0px 0px 15px #666;font-family:Arial,Helvetica,sans-serif;border-radius:0px 0px 5px 5px;position:fixed;top:50px;right:5px;width:170px;display:none">
        ...
        <div id="logoutMenuOption"><a href="/logout"><div style="padding:12px;border-top:1px solid gray;color:black;cursor:pointer">Disconnettersi</div></a></div>
    </div>
    ...
    <script>
        ...
        function setupDeviceMenu(op, obj) {
            ...
            if (features & 1) { menus.push({ n: "Terminale", f: 'setupDeviceMenu(5)', s: (currentDevicePanel == 5) }); }
            if (features & 4) { menus.push({ n: "File", f: 'setupDeviceMenu(2)', s: (currentDevicePanel == 2) }); }
        ...
        var keyStrings = { 8: "Tornare  indietro", 9: "Tab", 13: "accedere", 27: "Escape", 44 : "Stampa schermo", 45: "Inserire", 46: "Canc", 36: "Home", 35: "Fine", 33: "Pagina su", 34: "Pagina giù", 37: "Sinistra", 38: "Su", 39: "Destro", 40: "Giù", 0: "Nessuna " }
                ...
                if (data[0] == '{') {
                    ...
                    switch (j.action) {
                        case 'sshauth': {
                            ...
                            x += addHtmlValue("File chiave", '<input type=file id=dp2key style=width:150px maxlength=64 autocomplete=off onchange=sshAuthUpdate(event) />');
                            ...
                            x += '</div>';
                            x += '<label><input id=dp2keep type=checkbox>' + "Ricorda le credenziali" + '</label>';
                            x += '<div id=d2keyauth2 style=font-size:x-small><br />' + "Il file chiave deve essere in formato OpenSSH." + '</div>';
                            setDialogMode(2, "Autenticazione", 11, sshConnectEx, x, 'ssh');
        ...
        function p13gotFiles(data) {
            ...
            switch (data.action) {
                case 'sshauth': {
                    ...
                    x += '<label><input id=dp2keep type=checkbox>' + "Ricorda le credenziali" + '</label>';
                    x += '<div id=d2keyauth2 style=font-size:x-small><br />' + "Il file chiave deve essere in formato OpenSSH." + '</div>';
                    setDialogMode(2, "Autenticazione", 11, p13sshConnectEx, x, 'ssh');
                    setTimeout(sshAuthUpdate, 50);
                    break;
                }
        ...
        function p13downloadfile(x, y, z) {
            ...
            setDialogMode(2, "Scarca  File", 10, p13downloadFileCancel, '<div>' + downloadFile.file + '</div><br /><progress id=d2progressBar style=width:100% value=0 max=' + z + ' />');
        }
