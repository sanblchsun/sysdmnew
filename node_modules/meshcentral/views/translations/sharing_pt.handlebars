<!DOCTYPE html><html lang="pt" dir="ltr" xmlns="http://www.w3.org/1999/xhtml"><head>
        ...
        <div id="deskarea0">
            <div id="deskarea1" class="areaHead" style="line-height:24px">
                ...
                <div>
                    ...
                    <span id="connectbutton1hspan">&nbsp;<input type="button" id="connectbutton1h" value="Conectar HW" title="Conecte usando KVM de hardware Intel AMT" onclick="connectDesktop(event,2)" onkeypress="return false" onkeydown="return false" disabled="disabled"></span>
            ...
            <div id="deskarea4" class="areaFoot" style="min-height:24px">
                <div class="toright2">
                    <span id="DeskLatency" style="line-height:22px;width:50px" title="Latência de sessão de desktop"></span>
                    ...
                    <span id="DeskSaveImageButton" title="Salvar uma captura de tela da área de trabalho remota"><img src="images/icon-camera.png" onclick="deskSaveImage()" height="16" width="16" style="padding-top:2px"></span>
                </div>
    ...
    <div id="p12" class="noselect" style="overflow:hidden;position:absolute;left:54px;top:0;right:0;bottom:0;display:none;background-color:black">
        <div id="p12warning" onclick="showFeaturesDlg()">
            <div class="icon2"></div>
            <div class="warningbox">Intel® Porta de redirecionamento AMT ou recurso KVM desativado<span id="p12warninga">, clique aqui para o ativar.</span></div>
        </div>
        ...
        <div class="areaFoot" style="position:absolute;bottom:0;left:0;right:0;height:24px">
            ...
            <div>
                ...
                <input type="button" onkeypress="return false" onkeydown="return false" class="bottombutton" id="bsbutton" value="Excluir" onclick="termSendKey(8,'bsbutton')" style="display:none">
        ...
        <div id="p13toolbar" style="position:absolute;left:0;top:0;right:0;bottom:28px">
            ...
            <div id="fileArea2" class="areaHead2" valign="bottom">
                ...
                <div>
                    ...
                    <input type="button" id="p13ZipButton" disabled="disabled" value="Fecho eclair" onclick="p13zipFiles()">&nbsp;
                ...
                <div id="d7meshkvm">
                    ...
                    <div id="d7desktopOtherSettings">
                        ...
                        <div id="d7otherset2" style="display:block">
                            <label style="display:block"><input type="checkbox" id="d7deskSwapMouse">Botões de troca do mouse</label>
    ...
    <script>
        ...
        function updateMetadata(conn, elementid) {
            ...
            if (conn && (conn.State == 3)) {
                ...
                if (viewerCount > 1) { str = '<span onclick=showSessionMetadata(1) style=cursor:pointer>' + format(", {0} a assistir", viewerCount) + '</span>'; }
            }
            QH('deskmetadata', str);
            ...
            if (conn && conn.metadata) {
                ...
                if (conn.metadata.users) {
                    for (var i in conn.metadata.users) {
                        var val = (conn.metadata.users[i] == 1) ? "1 ligação" : format("{0} ligações", conn.metadata.users[i]);
