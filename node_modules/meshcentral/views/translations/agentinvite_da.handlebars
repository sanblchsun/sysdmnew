<!DOCTYPE html><html lang="da"><head>
    ...
    <div id="container">
        ...
        <div id="column_l" style="overflow-y:auto">
            <h1><span id="groupname">Fjernagentinstallation</span></h1>
            <p>
            ...
            <div>
                ...
                <div id="wintab64" class="tabcontent" style="background-color:white;color:black">
                    ...
                    <p><a id="win64url">Download softwaren her</a>, kør den og tryk på "Installer" eller "Forbind".</p>
                ...
                <div id="wintab32" class="tabcontent" style="background-color:white;color:black">
                    ...
                    <p><a id="win32url">Download softwaren her</a>, kør den og tryk på "Installer" eller "Forbind".</p>
                    <div style="text-align:center">
                ...
                <div id="wintabarm64" class="tabcontent" style="background-color:white;color:black">
                    ...
                    <p><a id="winarm64url">Download softwaren her</a>, kør den og tryk på "Installer" eller "Forbind".</p>
                    <div style="text-align:center">
                ...
                <div id="linuxtab" class="tabcontent" style="background-color:white;color:black">
                    <h3>Linux</h3>
                    <p>For at installere skal du klippe og indsætte følgende kommando i en root terminal.</p>
                    <div id="linuxinstall" style="font-family:courier,'courier new',monospace;margin-left:30px"></div>
                    <input type="button" value="Kopier til udklipsholder" style="margin-left:30px;margin-top:4px" onclick="copyToClipLinuxInstall()">
                    <p>For at afinstallere skal du klippe og indsætte følgende kommando som root.</p>
                    <div id="unlinuxinstall" style="font-family:courier,'courier new',monospace;margin-left:30px"></div>
                    <input type="button" value="Kopier til udklipsholder" style="margin-left:30px;margin-top:4px" onclick="copyToClipLinuxUnInstall()">
                    <br><br>
                </div>
                ...
                <div id="macostab64" class="tabcontent" style="background-color:white;color:black">
                    ...
                    <p><a id="macos64url">Download installationsprogrammet her</a>, højreklik den eller tryk på "kontrol" og klik på filen. Vælg herefter "Åben" og følg instruktionerne.</p>
                    <div style="text-align:center">
                ...
                <div id="macostabarm64" class="tabcontent" style="background-color:white;color:black">
                    ...
                    <p><a id="macosarm64url">Download installationsprogrammet her</a>, højreklik den eller tryk på "kontrol" og klik på filen. Vælg herefter "Åben" og følg instruktionerne.</p>
                    <div style="text-align:center">
                ...
                <div id="macostab" class="tabcontent" style="background-color:white;color:black">
                    ...
                    <p><a id="macosurl">Download installationsprogrammet her</a>, højreklik den eller tryk på "kontrol" og klik på filen. Vælg herefter "Åben" og følg instruktionerne.</p>
                    <div style="text-align:center">
                ...
                <div id="androtab" class="tabcontent" style="background-color:white;color:black">
                    ...
                    <div style="min-height:220px">
                        <p>Download agentsoftwaren ved hjælp af Google Play Butik eller APK-fil, installer den og brug QR-koden til højre eller parringslinket nedenfor for at konfigurere din enhed på denne server.</p>
                        <p>
                        ...
                        <p>
                            <a rel="noreferrer noopener" target="_blank" href="{{{magenturl}}}">Serverparringslink</a>
                        </p>
                    </div>
                </div>
                ...
                <div id="assistab" class="tabcontent" style="background-color:white;color:black">
                    ...
                    <div style="min-height:220px">
                        ...
                        <p>Assistent er et Windows-systembakkeværktøj, der kan bruges, når der er brug for hjælp. Dette er ikke en agent, der kører i baggrunden på den administrerede computer, i stedet er det et værktøj, der kun opretter forbindelse til serveren, når det bliver bedt om det.</p>
                        <p>
                            <a id="assisturl" rel="noreferrer noopener" target="_blank">Download Assistant til Windows</a>
                        </p>
                    </div>
                    <br style="clear:both">
                </div>
    ...
    <script>
        ...
        function startup() {
            ...
            if (groupName != '') {
                QH('groupname', format("Fjernagentinstallation for {0}", escapeHtml(groupName)));
        ...
        function linuxBinarySetup() {
            ...
            x += addHtmlValue("Systemtype", '<select id=aginsSysType onchange=addAgentToMeshClick() style=width:236px>' + moreoptions + '</select>');
            x += '</div>';
            x += '<div id=aginsTypeDiv>';
            x += addHtmlValue("Installationstype", '<select id=aginsType onchange=addAgentToMeshClick() style=width:236px><option value=0>' + "Baggrund & interaktive" + '</option><option value=2>' + "Kun baggrund" + '</option><option value=1>' + "Kun interaktiv" + '</option></select>');
            x += '</div><hr>';
            ...
            x += addHtmlValue("Mesh Agent", '<a id=aginsbinlnk name="meshagents?id=' + meshid + '&installflags=0' + (urlargs.key?('&key=' + urlargs.key):'') + '">' + "meshagent" + '</a> <img src=images/link4.png height=10 width=10 title="' + "Kopiér agent-URL til udklipsholder" + '" style=cursor:pointer onclick=copyAgentUrl("meshagents?id=' + meshid + '&installflags=",1)>');
            x += addHtmlValue("Kommando", '<input id=aginsbincmd type=text style="width:216px" readonly value=\'wget -O meshagent ' + ((serverNoProxy != 0) ?'--no-proxy':'') + ' --no-check-certificate \"https://' + servername + portStr + domainUrl + 'meshagents?id=' + meshid.split('$').join('%24').split('@').join('%40') + '\' /> <img src=images/link4.png height=10 width=10 title="' + "Kopiér agent-URL til udklipsholder" + '" style=cursor:pointer onclick=copyAgentIdValue("aginsbincmd")>');
            x += '</div>';
            QH('linuxbinarytab', x);
            addAgentToMeshClick();
        }
