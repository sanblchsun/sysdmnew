<!DOCTYPE html><html lang="ko"><head>
    ...
    <div id="container">
        ...
        <div id="column_l" style="overflow-y:auto">
            <h1><span id="groupname">원격 에이전트 설치</span></h1>
            <p>
                원격 운영자가 데스크톱 및 파일을 포함하여 귀하의 컴퓨터에 안전하게 액세스 할 수있는 애플리케이션을 설치하도록 초대 받았습니다. 이 초대가 예상되었고 누가 귀하의 컴퓨터에 액세스 할 것인지 알고있는 경우에만 아래 지침을 따르십시오. 운영 체제를 선택하고 아래 지침에 따라 설치하십시오.
            </p>
            <div>
                <div class="tab">
                    <button id="twintab64" class="tablinks" onclick="openTab(event, 'wintab64')">Windows 64비트</button>
                    <button id="twintab32" class="tablinks" onclick="openTab(event, 'wintab32')">Windows 32비트</button>
                    ...
                    <button id="tlinuxbinarytab" class="tablinks" onclick="openTab(event, 'linuxbinarytab')">Linux / BSD / macOS 바이너리 설치 프로그램</button>
                    <button id="tmacostab64" class="tablinks" onclick="openTab(event, 'macostab64')">macOS x86-64비트</button>
                    <button id="tmacostabarm64" class="tablinks" onclick="openTab(event, 'macostabarm64')">macOS ARM (64비트)</button>
                    ...
                    <button id="tassistab" class="tablinks" onclick="openTab(event, 'assistab')">조수</button>
                </div>

                <div id="wintab64" class="tabcontent" style="background-color:white;color:black">
                    <h3>Microsoft™ Windows 64비트</h3>
                    <p><a id="win64url">여기에서 소프트웨어를 다운로드하십시오</a>. 그리고 실행한 후에 "설치" 또는 "연결"을 누르십시오.</p>
                ...
                <div id="wintab32" class="tabcontent" style="background-color:white;color:black">
                    <h3>Microsoft™ Windows 32비트</h3>
                    <p><a id="win32url">여기에서 소프트웨어를 다운로드하십시오</a>. 그리고 실행한 후에 "설치" 또는 "연결"을 누르십시오.</p>
                    <div style="text-align:center">
                ...
                <div id="wintabarm64" class="tabcontent" style="background-color:white;color:black">
                    ...
                    <p><a id="winarm64url">여기에서 소프트웨어를 다운로드하십시오</a>. 그리고 실행한 후에 "설치" 또는 "연결"을 누르십시오.</p>
                    <div style="text-align:center">
                ...
                <div id="linuxtab" class="tabcontent" style="background-color:white;color:black">
                    <h3>Linux</h3>
                    <p>설치하려면, 다음 명령을 복사하여 Root 계정 터미널에 붙여넣어 실행하십시오.</p>
                    <div id="linuxinstall" style="font-family:courier,'courier new',monospace;margin-left:30px"></div>
                    <input type="button" value="클립보드에 복사" style="margin-left:30px;margin-top:4px" onclick="copyToClipLinuxInstall()">
                    <p>설치 제거하려면 다음 명령을 복사하여 Root 계정으로 붙여넣어 실행하십시오.</p>
                    <div id="unlinuxinstall" style="font-family:courier,'courier new',monospace;margin-left:30px"></div>
                    <input type="button" value="클립보드에 복사" style="margin-left:30px;margin-top:4px" onclick="copyToClipLinuxUnInstall()">
                    <br><br>
                </div>
                ...
                <div id="macostab64" class="tabcontent" style="background-color:white;color:black">
                    ...
                    <p><a id="macos64url">여기에서 설치 프로그램을 다운로드 하십시오.</a> 좌측의 링크를 마우스 오른쪽 버튼으로 클릭하거나 "control"을 누르고 파일을 클릭하십시오. 그리고 "열기"를 선택하고, 지침을 따르십시오.</p>
                    <div style="text-align:center">
                ...
                <div id="macostabarm64" class="tabcontent" style="background-color:white;color:black">
                    ...
                    <p><a id="macosarm64url">여기에서 설치 프로그램을 다운로드 하십시오.</a> 좌측의 링크를 마우스 오른쪽 버튼으로 클릭하거나 "control"을 누르고 파일을 클릭하십시오. 그리고 "열기"를 선택하고, 지침을 따르십시오.</p>
                    <div style="text-align:center">
                ...
                <div id="macostab" class="tabcontent" style="background-color:white;color:black">
                    ...
                    <p><a id="macosurl">여기에서 설치 프로그램을 다운로드 하십시오.</a> 좌측의 링크를 마우스 오른쪽 버튼으로 클릭하거나 "control"을 누르고 파일을 클릭하십시오. 그리고 "열기"를 선택하고, 지침을 따르십시오.</p>
                    <div style="text-align:center">
                ...
                <div id="androtab" class="tabcontent" style="background-color:white;color:black">
                    ...
                    <div style="min-height:220px">
                        <p>Google Play 스토어 또는 APK 파일을 사용하여 에이전트 소프트웨어를 다운로드하고 설치 한 후 오른쪽의 QR 코드 또는 아래 페어링 링크를 사용하여이 서버에 장치를 설정합니다.</p>
                        <p>
                        ...
                        <p>
                            <a id="androidurl">Android APK 다운로드</a>
                        </p>
                        <p>
                            <a rel="noreferrer noopener" target="_blank" href="{{{magenturl}}}">서버 페어링 링크</a>
                        </p>
                    </div>
                </div>
                ...
                <div id="assistab" class="tabcontent" style="background-color:white;color:black">
                    ...
                    <div style="min-height:220px">
                        ...
                        <p>Assistant는 도움이 필요할 때 사용할 수있는 Windows 시스템 트레이 도구입니다. 이것은 관리 컴퓨터의 백그라운드에서 실행되는 에이전트가 아니라 요청시에만 서버에 연결하는 도구입니다.</p>
                        <p>
                            <a id="assisturl" rel="noreferrer noopener" target="_blank">Windows 용 다운로드 도우미</a>
                        </p>
                    </div>
                    <br style="clear:both">
                </div>
    ...
    <script>
        ...
        function startup() {
            ...
            if (groupName != '') {
                QH('groupname', format("{0}에 대한 원격 에이전트 설치", escapeHtml(groupName)));
                document.title = format("{0} - 에이전트 설치", groupName);
            } else {
                document.title = "에이전트 설치";
            }
        ...
        function linuxBinarySetup() {
            var x = '<h3>' + "Linux / BSD / macOS 바이너리 설치 프로그램" + '</h3>', moreoptions = '';
            var opts = '<select id=aginsSelect onchange=addAgentToMeshClick() style=width:236px>';
            opts += '<option value=5 selected>' + "Linux / BSD / macOS 바이너리 설치 프로그램" + '</option>';
            opts += '</select>';
            ...
            x += addHtmlValue("시스템 유형", '<select id=aginsSysType onchange=addAgentToMeshClick() style=width:236px>' + moreoptions + '</select>');
            x += '</div>';
            x += '<div id=aginsTypeDiv>';
            x += addHtmlValue("설치 유형", '<select id=aginsType onchange=addAgentToMeshClick() style=width:236px><option value=0>' + "백그라운드 실행 및 대화식" + '</option><option value=2>' + "오직 백그라운드 실행만" + '</option><option value=1>' + "오직 대화식만" + '</option></select>');
            x += '</div><hr>';
            ...
            x += addHtmlValue("메시 에이전트", '<a id=aginsbinlnk name="meshagents?id=' + meshid + '&installflags=0' + (urlargs.key?('&key=' + urlargs.key):'') + '">' + "MeshAgent" + '</a> <img src=images/link4.png height=10 width=10 title="' + "에이전트 URL을 클립 보드에 복사" + '" style=cursor:pointer onclick=copyAgentUrl("meshagents?id=' + meshid + '&installflags=",1)>');
            x += addHtmlValue("명령", '<input id=aginsbincmd type=text style="width:216px" readonly value=\'wget -O meshagent ' + ((serverNoProxy != 0) ?'--no-proxy':'') + ' --no-check-certificate \"https://' + servername + portStr + domainUrl + 'meshagents?id=' + meshid.split('$').join('%24').split('@').join('%40') + '\' /> <img src=images/link4.png height=10 width=10 title="' + "에이전트 URL을 클립 보드에 복사" + '" style=cursor:pointer onclick=copyAgentIdValue("aginsbincmd")>');
            x += '</div>';
            QH('linuxbinarytab', x);
            addAgentToMeshClick();
        }
