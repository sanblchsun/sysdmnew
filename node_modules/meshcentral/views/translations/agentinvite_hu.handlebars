<!DOCTYPE html><html lang="hu"><head>
        ...
        <div id="column_l" style="overflow-y:auto">
            ...
            <div>
                <div class="tab">
                    ...
                    <button id="tlinuxbinarytab" class="tablinks" onclick="openTab(event, 'linuxbinarytab')">Linux / BSD / macOS Binary Telepítő</button>
                ...
                <div id="wintab64" class="tabcontent" style="background-color:white;color:black">
                    ...
                    <p><a id="win64url">Kattintson ide az alkalmazás letöltéséhez</a>, majd indítsa el és kattintson az "Install" vagy "Connect" gombra.</p>
                ...
                <div id="wintab32" class="tabcontent" style="background-color:white;color:black">
                    ...
                    <p><a id="win32url">Kattintson ide az alkalmazás letöltéséhez</a>, majd indítsa el és kattintson az "Install" vagy "Connect" gombra.</p>
                    <div style="text-align:center">
                ...
                <div id="wintabarm64" class="tabcontent" style="background-color:white;color:black">
                    ...
                    <p><a id="winarm64url">Kattintson ide az alkalmazás letöltéséhez</a>, majd indítsa el és kattintson az "Install" vagy "Connect" gombra.</p>
                    <div style="text-align:center">
                ...
                <div id="linuxtab" class="tabcontent" style="background-color:white;color:black">
                    <h3>Linux</h3>
                    <p>A telepítéshez vágja ki és illessze be a következő parancsot root felhasználóként egy terminálba.</p>
                    <div id="linuxinstall" style="font-family:courier,'courier new',monospace;margin-left:30px"></div>
                    <input type="button" value="Másolás a vágólapra" style="margin-left:30px;margin-top:4px" onclick="copyToClipLinuxInstall()">
                    <p>Az eltávolításhoz vágja ki és illessze be a következő parancsot root felhasználóként egy terminálba.</p>
                    <div id="unlinuxinstall" style="font-family:courier,'courier new',monospace;margin-left:30px"></div>
                    <input type="button" value="Másolás a vágólapra" style="margin-left:30px;margin-top:4px" onclick="copyToClipLinuxUnInstall()">
                    <br><br>
                </div>
                ...
                <div id="macostab64" class="tabcontent" style="background-color:white;color:black">
                    ...
                    <p><a id="macos64url">Töltse le a telepítő programot innen</a>, kattintson rá jobb gombbal, vagy nyomja meg a "Control" gombot, és kattintson a fájlra. Ezután válassza a "Megnyitás" lehetőséget, és kövesse az utasításokat.</p>
                    <div style="text-align:center">
                ...
                <div id="macostabarm64" class="tabcontent" style="background-color:white;color:black">
                    ...
                    <p><a id="macosarm64url">Töltse le a telepítő programot innen</a>, kattintson rá jobb gombbal, vagy nyomja meg a "Control" gombot, és kattintson a fájlra. Ezután válassza a "Megnyitás" lehetőséget, és kövesse az utasításokat.</p>
                    <div style="text-align:center">
                ...
                <div id="macostab" class="tabcontent" style="background-color:white;color:black">
                    ...
                    <p><a id="macosurl">Töltse le a telepítő programot innen</a>, kattintson rá jobb gombbal, vagy nyomja meg a "Control" gombot, és kattintson a fájlra. Ezután válassza a "Megnyitás" lehetőséget, és kövesse az utasításokat.</p>
                    <div style="text-align:center">
                ...
                <div id="androtab" class="tabcontent" style="background-color:white;color:black">
                    ...
                    <div style="min-height:220px">
                        <p>Töltse le az Agent szoftvert a Google Play áruházból vagy közvetlenül az APK-fájlt és telepítés ezután a jobb oldalon található QR-kóddal vagy az alábbi párosítási linkkel csatlakoztassa a készülékét ehhez a kiszolgálóhoz.</p>
                        <p>
                        ...
                        <p>
                            <a id="androidurl">Android APK Letöltése</a>
                        </p>
                        <p>
                            <a rel="noreferrer noopener" target="_blank" href="{{{magenturl}}}">Kiszolgáló párosítás link</a>
                        </p>
                    </div>
                </div>
                ...
                <div id="assistab" class="tabcontent" style="background-color:white;color:black">
                    ...
                    <div style="min-height:220px">
                        ...
                        <p>Az Assistant egy Windows rendszertálca eszköz, amely akkor használható, ha segítségre van szükség. Ez nem fut a számítógépen a háttérben, csak akkor csatlakozik a kiszolgálóhoz, amikor azt a felhasználó kéri.</p>
                        <p>
                            <a id="assisturl" rel="noreferrer noopener" target="_blank">Az Assistant letöltése Windows rendszerre</a>
                        </p>
                    </div>
                    <br style="clear:both">
                </div>
    ...
    <script>
        ...
        function startup() {
            ...
            if (groupName != '') {
                QH('groupname', format("Távoli ügynök telepítése {0}", escapeHtml(groupName)));
                document.title = format("{0} - Agent telepítés", groupName);
            } else {
                document.title = "Agent Telepítése";
            }
        ...
        function linuxBinarySetup() {
            var x = '<h3>' + "Linux / BSD / macOS Binary Telepítő" + '</h3>', moreoptions = '';
            var opts = '<select id=aginsSelect onchange=addAgentToMeshClick() style=width:236px>';
            opts += '<option value=5 selected>' + "Linux / BSD / macOS Binary Telepítő" + '</option>';
            opts += '</select>';
            ...
            x += addHtmlValue("Rendszer típusa", '<select id=aginsSysType onchange=addAgentToMeshClick() style=width:236px>' + moreoptions + '</select>');
            x += '</div>';
            x += '<div id=aginsTypeDiv>';
            x += addHtmlValue("Telepítés típusa", '<select id=aginsType onchange=addAgentToMeshClick() style=width:236px><option value=0>' + "Háttérben és interaktív módon" + '</option><option value=2>' + "Csak háttérben" + '</option><option value=1>' + "Csak internaktív" + '</option></select>');
            x += '</div><hr>';
            ...
            x += addHtmlValue("Mesh Agent", '<a id=aginsbinlnk name="meshagents?id=' + meshid + '&installflags=0' + (urlargs.key?('&key=' + urlargs.key):'') + '">' + "MeshAgent" + '</a> <img src=images/link4.png height=10 width=10 title="' + "Agent URL másolása a vágólapra" + '" style=cursor:pointer onclick=copyAgentUrl("meshagents?id=' + meshid + '&installflags=",1)>');
            x += addHtmlValue("Parancs", '<input id=aginsbincmd type=text style="width:216px" readonly value=\'wget -O meshagent ' + ((serverNoProxy != 0) ?'--no-proxy':'') + ' --no-check-certificate \"https://' + servername + portStr + domainUrl + 'meshagents?id=' + meshid.split('$').join('%24').split('@').join('%40') + '\' /> <img src=images/link4.png height=10 width=10 title="' + "Agent URL másolása a vágólapra" + '" style=cursor:pointer onclick=copyAgentIdValue("aginsbincmd")>');
            x += '</div>';
            QH('linuxbinarytab', x);
            addAgentToMeshClick();
        }
