<!DOCTYPE html><html lang="ca"><head>
    ...
    {{{customJSTags}}}
    <title>Instal·lació de l'agent</title>
    <style>
        .tab {
            overflow: hidden;
    ...
    <div id="container">
        ...
        <div id="column_l" style="overflow-y:auto">
            <h1><span id="groupname">Instal·lació de l'agent remot</span></h1>
            <p>
                Us han convidat a instal·lar una aplicació que permetrà a un operador remot accedir de manera segura al vostre ordinador, inclosos l'escriptori i els fitxers. Només seguiu les instruccions següents si s'esperava aquesta invitació i sabeu qui accedirà al vostre ordinador. Seleccioneu el vostre sistema operatiu i seguiu les instruccions següents per a la instal·lació.
            </p>
            <div>
                <div class="tab">
                    <button id="twintab64" class="tablinks" onclick="openTab(event, 'wintab64')">Windows de 64 bits</button>
                    <button id="twintab32" class="tablinks" onclick="openTab(event, 'wintab32')">Windows 32 bits</button>
                    <button id="twintabarm64" class="tablinks" onclick="openTab(event, 'wintabarm64')">Windows ARM de 64 bits</button>
                    <button id="tlinuxtab" class="tablinks" onclick="openTab(event, 'linuxtab')">Scripts Linux/BSD</button>
                    <button id="tlinuxbinarytab" class="tablinks" onclick="openTab(event, 'linuxbinarytab')">Instal·lador binari de Linux / BSD / macOS</button>
                    <button id="tmacostab64" class="tablinks" onclick="openTab(event, 'macostab64')">macOS x86-64bit</button>
                    <button id="tmacostabarm64" class="tablinks" onclick="openTab(event, 'macostabarm64')">macOS ARM (64 bits)</button>
                    ...
                    <button id="tassistab" class="tablinks" onclick="openTab(event, 'assistab')">Assistent</button>
                </div>

                <div id="wintab64" class="tabcontent" style="background-color:white;color:black">
                    <h3>Microsoft™ Windows de 64 bits</h3>
                    <p><a id="win64url">Descarrega el programari aquí</a>, executeu-lo i premeu "Instal·la" o "Connecta".</p>
                ...
                <div id="wintab32" class="tabcontent" style="background-color:white;color:black">
                    <h3>Microsoft™ Windows 32 bits</h3>
                    <p><a id="win32url">Descarrega el programari aquí</a>, executeu-lo i premeu "Instal·la" o "Connecta".</p>
                    <div style="text-align:center">
                ...
                <div id="wintabarm64" class="tabcontent" style="background-color:white;color:black">
                    <h3>Microsoft™ Windows ARM de 64 bits</h3>
                    <p><a id="winarm64url">Descarrega el programari aquí</a>, executeu-lo i premeu "Instal·la" o "Connecta".</p>
                    <div style="text-align:center">
                ...
                <div id="linuxtab" class="tabcontent" style="background-color:white;color:black">
                    <h3>Linux</h3>
                    <p>Per instal·lar, talleu i enganxeu l'ordre següent en un terminal arrel.</p>
                    <div id="linuxinstall" style="font-family:courier,'courier new',monospace;margin-left:30px"></div>
                    <input type="button" value="Copiar al portapapers" style="margin-left:30px;margin-top:4px" onclick="copyToClipLinuxInstall()">
                    <p>Per desinstal·lar, talleu i enganxeu l'ordre següent com a root.</p>
                    <div id="unlinuxinstall" style="font-family:courier,'courier new',monospace;margin-left:30px"></div>
                    <input type="button" value="Copiar al portapapers" style="margin-left:30px;margin-top:4px" onclick="copyToClipLinuxUnInstall()">
                    <br><br>
                </div>
                ...
                <div id="macostab64" class="tabcontent" style="background-color:white;color:black">
                    ...
                    <p><a id="macos64url">Descarrega l'instal·lador aquí</a>, feu-hi clic amb el botó dret o premeu "control" i feu clic al fitxer. A continuació, seleccioneu "Obre" i seguiu les instruccions.</p>
                    <div style="text-align:center">
                ...
                <div id="macostabarm64" class="tabcontent" style="background-color:white;color:black">
                    ...
                    <p><a id="macosarm64url">Descarrega l'instal·lador aquí</a>, feu-hi clic amb el botó dret o premeu "control" i feu clic al fitxer. A continuació, seleccioneu "Obre" i seguiu les instruccions.</p>
                    <div style="text-align:center">
                ...
                <div id="macostab" class="tabcontent" style="background-color:white;color:black">
                    ...
                    <p><a id="macosurl">Descarrega l'instal·lador aquí</a>, feu-hi clic amb el botó dret o premeu "control" i feu clic al fitxer. A continuació, seleccioneu "Obre" i seguiu les instruccions.</p>
                    <div style="text-align:center">
                ...
                <div id="androtab" class="tabcontent" style="background-color:white;color:black">
                    ...
                    <div style="min-height:220px">
                        <p>Baixeu el programari de l'agent mitjançant la botiga de Google Play o el fitxer APK, instal·leu-lo i utilitzeu el codi QR de la dreta o l'enllaç de vinculació següent per configurar el vostre dispositiu en aquest servidor.</p>
                        <p>
                        ...
                        <p>
                            <a id="androidurl">Descarregar APK d'Android</a>
                        </p>
                        <p>
                            <a rel="noreferrer noopener" target="_blank" href="{{{magenturl}}}">Enllaç de vinculació del servidor</a>
                        </p>
                    </div>
                </div>
                ...
                <div id="assistab" class="tabcontent" style="background-color:white;color:black">
                    ...
                    <div style="min-height:220px">
                        ...
                        <p>Assistant és una eina de safata del sistema de Windows que es pot utilitzar quan es necessita ajuda. Aquest no és un agent que s'executa en segon pla de l'ordinador gestionat, sinó que és una eina que es connecta al servidor només quan se'l sol·licita.</p>
                        <p>
                            <a id="assisturl" rel="noreferrer noopener" target="_blank">Descarrega l'Assistent per a Windows</a>
                        </p>
                    </div>
                    <br style="clear:both">
                </div>
    ...
    <script>
        ...
        function startup() {
            ...
            if (groupName != '') {
                QH('groupname', format("Instal·lació de l'agent remot per a {0}", escapeHtml(groupName)));
                document.title = format("{0} - Instal·lació de l'agent", groupName);
            } else {
                document.title = "Instal·lació de l'agent";
            }
        ...
        function linuxBinarySetup() {
            var x = '<h3>' + "Instal·lador binari de Linux / BSD / macOS" + '</h3>', moreoptions = '';
            var opts = '<select id=aginsSelect onchange=addAgentToMeshClick() style=width:236px>';
            opts += '<option value=5 selected>' + "Instal·lador binari de Linux / BSD / macOS" + '</option>';
            opts += '</select>';
            ...
            x += addHtmlValue("Agent de malla", '<a id=aginsbinlnk name="meshagents?id=' + meshid + '&installflags=0' + (urlargs.key?('&key=' + urlargs.key):'') + '">' + "agent de malla" + '</a> <img src=images/link4.png height=10 width=10 title="' + "Copia l'URL de l'agent al porta-retalls" + '" style=cursor:pointer onclick=copyAgentUrl("meshagents?id=' + meshid + '&installflags=",1)>');
