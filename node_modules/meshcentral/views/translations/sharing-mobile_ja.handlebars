<!DOCTYPE html><html lang="ja" dir="ltr" xmlns="http://www.w3.org/1999/xhtml"><head>
                        ...
                        <div id="termTable" style="position:absolute;top:0;bottom:0;left:0;right:0">
                            <div id="termarea1">
                                <div class="areaHead" style="line-height:24px">
                                    ...
                                    <div>
                                        <span id="connectbutton2span" style="margin-left:3px"><input type="button" id="connectbutton2" cmenu="termConnectButton" value="接続" style="height:28px" onclick="connectTerminal(event,1)" onkeypress="return false" onkeydown="return false" disabled="disabled"></span>
                            ...
                            <tbody><tr>
                                <td style="background-color:#C0C0C0;border-bottom:2px solid black;padding:2px;line-height:24px">
                                    ...
                                    <div style="margin-left:2px">
                                        ...
                                        <input id="p13Connect" value="接続" onclick="connectFiles(event)" onkeypress="return false" onkeydown="return false" type="button">
    ...
    <script>
        ...
        function setupDeviceMenu(op, obj) {
            ...
            var menus = [];
            if (features & 2) { menus.push({ n: "デスクトップ", f: 'setupDeviceMenu(1)', s: (currentDevicePanel == 1) }); }
            if (features & 1) { menus.push({ n: "ターミナル", f: 'setupDeviceMenu(5)', s: (currentDevicePanel == 5) }); }
            if (features & 4) { menus.push({ n: "ファイル", f: 'setupDeviceMenu(2)', s: (currentDevicePanel == 2) }); }
        ...
        var keyStrings = { 8: "BackSpace", 9: "タブ", 13: "入る", 27: "エスケープ", 44 : "印刷画面", 45: "入れる", 46: "Del", 36: "ホーム", 35: "終わり", 33: "ページアップ", 34: "ページダウン", 37: "左", 38: "アップ", 39: "右", 40: "下", 0: "なし" }
                ...
                if (data[0] == '{') {
                    ...
                    switch (j.action) {
                        case 'sshauth': {
                            ...
                            x += addHtmlValue("キーファイル", '<input type=file id=dp2key style=width:150px maxlength=64 autocomplete=off onchange=sshAuthUpdate(event) />');
                            ...
                            x += '</div>';
                            x += '<label><input id=dp2keep type=checkbox>' + "クレデンシャルを記憶" + '</label>';
                            x += '<div id=d2keyauth2 style=font-size:x-small><br />' + "キーファイルはOpenSSH形式である必要があります。" + '</div>';
                            setDialogMode(2, "認証", 11, sshConnectEx, x, 'ssh');
        ...
        function p13gotFiles(data) {
            ...
            switch (data.action) {
                case 'sshauth': {
                    ...
                    x += '<label><input id=dp2keep type=checkbox>' + "クレデンシャルを記憶" + '</label>';
                    x += '<div id=d2keyauth2 style=font-size:x-small><br />' + "キーファイルはOpenSSH形式である必要があります。" + '</div>';
                    setDialogMode(2, "認証", 11, p13sshConnectEx, x, 'ssh');
                    setTimeout(sshAuthUpdate, 50);
                    break;
                }
