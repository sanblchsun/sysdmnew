<!DOCTYPE html><html lang="ko" dir="ltr" xmlns="http://www.w3.org/1999/xhtml"><head>
                        ...
                        <div id="termTable" style="position:absolute;top:0;bottom:0;left:0;right:0">
                            <div id="termarea1">
                                <div class="areaHead" style="line-height:24px">
                                    ...
                                    <div>
                                        <span id="connectbutton2span" style="margin-left:3px"><input type="button" id="connectbutton2" cmenu="termConnectButton" value="연결" style="height:28px" onclick="connectTerminal(event,1)" onkeypress="return false" onkeydown="return false" disabled="disabled"></span>
                            ...
                            <tbody><tr>
                                <td style="background-color:#C0C0C0;border-bottom:2px solid black;padding:2px;line-height:24px">
                                    ...
                                    <div style="margin-left:2px">
                                        ...
                                        <input id="p13Connect" value="연결" onclick="connectFiles(event)" onkeypress="return false" onkeydown="return false" type="button">
    ...
    <div id="topMenu" style="z-index:1000;background-color:#EEE;box-shadow:0px 0px 15px #666;font-family:Arial,Helvetica,sans-serif;border-radius:0px 0px 5px 5px;position:fixed;top:50px;right:5px;width:170px;display:none">
        ...
        <div id="logoutMenuOption"><a href="/logout"><div style="padding:12px;border-top:1px solid gray;color:black;cursor:pointer">로그아웃</div></a></div>
    </div>
    ...
    <script>
        ...
        function setupDeviceMenu(op, obj) {
            ...
            var menus = [];
            if (features & 2) { menus.push({ n: "데스크탑", f: 'setupDeviceMenu(1)', s: (currentDevicePanel == 1) }); }
            if (features & 1) { menus.push({ n: "터미널", f: 'setupDeviceMenu(5)', s: (currentDevicePanel == 5) }); }
            if (features & 4) { menus.push({ n: "파일", f: 'setupDeviceMenu(2)', s: (currentDevicePanel == 2) }); }
        ...
        var keyStrings = { 8: "역행 키이", 9: "Tab", 13: "입력", 27: "탈출", 44 : "화면 인쇄", 45: "끼워 넣다", 46: "Del", 36: "집", 35: "종료", 33: "페이지 위로", 34: "페이지 아래로", 37: "왼쪽", 38: "상위 항목으로", 39: "권리", 40: "하위", 0: "없음" }
                ...
                if (data[0] == '{') {
                    ...
                    switch (j.action) {
                        case 'sshauth': {
                            ...
                            x += addHtmlValue("키 파일", '<input type=file id=dp2key style=width:150px maxlength=64 autocomplete=off onchange=sshAuthUpdate(event) />');
                            ...
                            x += '</div>';
                            x += '<label><input id=dp2keep type=checkbox>' + "자격 증명 기억" + '</label>';
                            x += '<div id=d2keyauth2 style=font-size:x-small><br />' + "키 파일은 OpenSSH 형식이어야 합니다." + '</div>';
                            setDialogMode(2, "입증", 11, sshConnectEx, x, 'ssh');
        ...
        function p13gotFiles(data) {
            ...
            switch (data.action) {
                case 'sshauth': {
                    ...
                    x += '<label><input id=dp2keep type=checkbox>' + "자격 증명 기억" + '</label>';
                    x += '<div id=d2keyauth2 style=font-size:x-small><br />' + "키 파일은 OpenSSH 형식이어야 합니다." + '</div>';
                    setDialogMode(2, "입증", 11, p13sshConnectEx, x, 'ssh');
                    setTimeout(sshAuthUpdate, 50);
                    break;
                }
        ...
        function p13downloadfile(x, y, z) {
            ...
            setDialogMode(2, "파일 다운로드", 10, p13downloadFileCancel, '<div>' + downloadFile.file + '</div><br /><progress id=d2progressBar style=width:100% value=0 max=' + z + ' />');
        }
