<!DOCTYPE html><html lang="tr" dir="ltr" xmlns="http://www.w3.org/1999/xhtml"><head>
                        ...
                        <div id="termTable" style="position:absolute;top:0;bottom:0;left:0;right:0">
                            <div id="termarea1">
                                <div class="areaHead" style="line-height:24px">
                                    ...
                                    <div>
                                        <span id="connectbutton2span" style="margin-left:3px"><input type="button" id="connectbutton2" cmenu="termConnectButton" value="Bağlan" style="height:28px" onclick="connectTerminal(event,1)" onkeypress="return false" onkeydown="return false" disabled="disabled"></span>
    ...
    <script>
        ...
        function setupDeviceMenu(op, obj) {
            ...
            var menus = [];
            if (features & 2) { menus.push({ n: "Masaüstü", f: 'setupDeviceMenu(1)', s: (currentDevicePanel == 1) }); }
            if (features & 1) { menus.push({ n: "Komut Satırı", f: 'setupDeviceMenu(5)', s: (currentDevicePanel == 5) }); }
            if (features & 4) { menus.push({ n: "Dosyalar", f: 'setupDeviceMenu(2)', s: (currentDevicePanel == 2) }); }
        ...
        var keyStrings = { 8: "Silme", 9: "Sekme", 13: "Giriş", 27: "Kaçmak", 44 : "Ekran görüntüsü", 45: "Sokmak", 46: "del", 36: "Ev", 35: "Son", 33: "Sayfa yukarı", 34: "Sayfa Aşağı", 37: "Sol", 38: "Yukarı", 39: "Doğru", 40: "Aşağı", 0: "Yok" }
                ...
                if (data[0] == '{') {
                    ...
                    switch (j.action) {
                        case 'sshauth': {
                            ...
                            x += addHtmlValue("Anahtar dosya", '<input type=file id=dp2key style=width:150px maxlength=64 autocomplete=off onchange=sshAuthUpdate(event) />');
                            ...
                            x += '</div>';
                            x += '<label><input id=dp2keep type=checkbox>' + "Kimlik bilgilerini hatırla" + '</label>';
                            x += '<div id=d2keyauth2 style=font-size:x-small><br />' + "Anahtar dosyası OpenSSH formatında olmalıdır." + '</div>';
                            setDialogMode(2, "Kimlik doğrulama", 11, sshConnectEx, x, 'ssh');
        ...
        function p13gotFiles(data) {
            ...
            switch (data.action) {
                case 'sshauth': {
                    ...
                    x += '<label><input id=dp2keep type=checkbox>' + "Kimlik bilgilerini hatırla" + '</label>';
                    x += '<div id=d2keyauth2 style=font-size:x-small><br />' + "Anahtar dosyası OpenSSH formatında olmalıdır." + '</div>';
                    setDialogMode(2, "Kimlik doğrulama", 11, p13sshConnectEx, x, 'ssh');
                    setTimeout(sshAuthUpdate, 50);
                    break;
                }
