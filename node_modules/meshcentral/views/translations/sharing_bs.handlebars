<!DOCTYPE html><html lang="bs" dir="ltr" xmlns="http://www.w3.org/1999/xhtml"><head>
    ...
    <div id="LeftSideToolBar" style="display:none;position:absolute;left:0;bottom:0;width:52px;top:0;background:#113962;background:linear-gradient(to bottom, #104893 0%,#113962 100%);color:white;border-right: 5px solid #BBB;">
        ...
        <div id="LeftMenuFiles" class="slbbutton" title="Fajlovi" onclick="go(13)">
        ...
        <div id="deskarea0">
            <div id="deskarea1" class="areaHead" style="line-height:24px">
                <div class="toright2">
                    ...
                    <div class="deskareaicon" title="Uključite način prikaza" onclick="toggleAspectRatio(1)">⇲</div>
                    <div class="deskareaicon" title="Rotirajte ulijevo" onclick="drotate(-1)">↺</div>
                    <div class="deskareaicon" title="Rotate Right" onclick="drotate(1)">↻</div>
                    <input id="deskActionsSettings" type="button" value="Postavke..." title="Uredite postavke udaljene radne površine" onkeypress="return false" onkeydown="return false" onclick="showDesktopSettings()" class="mR">
                    <div id="desktopCustomUiButtons" style="float:left"></div>
                    <div id="deskRecordIcon" class="deskareaicon" title="Server snima ovu sesiju" style="display:none;background-color:red;width:12px;height:12px;border-radius:6px;margin-top:5px"></div>
                </div>
                <div>
                    ...
                    <span id="connectbutton1span"><input type="button" id="connectbutton1" cmenu="deskConnectButton" value="Povežite se" onclick="connectDesktop(event,3)" onkeypress="return false" onkeydown="return false" disabled="disabled"></span>
                    <span id="connectbutton1hspan">&nbsp;<input type="button" id="connectbutton1h" value="HW Connect" title="Povežite se pomoću Intel AMT hardverskog KVM-a" onclick="connectDesktop(event,2)" onkeypress="return false" onkeydown="return false" disabled="disabled"></span>
                    <span id="disconnectbutton1span">&nbsp;<input type="button" id="disconnectbutton1" value="Prekini vezu" onclick="connectDesktop(event,0)" onkeypress="return false" onkeydown="return false"></span>
            ...
            <div id="deskarea4" class="areaFoot" style="min-height:24px">
                <div class="toright2">
                    <span id="DeskLatency" style="line-height:22px;width:50px" title="Kašnjenje sesije radne površine"></span>
                    <span id="DeskTimer" style="line-height:22px" title="Vrijeme sesije"></span>&nbsp;
                    ...
                    <span id="DeskSaveImageButton" title="Sačuvajte snimak ekrana udaljene radne površine"><img src="images/icon-camera.png" onclick="deskSaveImage()" height="16" width="16" style="padding-top:2px"></span>
                </div>
                <div style="height:22px">
                    <select id="deskkeys">
                        ...
                        <option value="12">Win+desno</option>
                    </select>
                    <input id="DeskWD" type="button" value="Pošalji" onkeypress="return false" onkeydown="return false" onclick="deskSendKeys()">
                    <input id="DeskClip" style="" type="button" value="Clipboard" onkeypress="return false" onkeydown="return false" onclick="showDeskClip()">
                    <input id="DeskType" style="" type="button" value="Tip" onkeypress="return false" onkeydown="return false" onclick="showDeskType()">
                    <label><span id="DeskControlSpan" title="Uključite unos miša i tastature"><input id="DeskControl" type="checkbox" onkeypress="return false" onkeydown="return false" onclick="toggleKvmControl()">Unos</span></label>&nbsp;
                </div>
            </div>
        </div>
    </div>
    <div id="p12" class="noselect" style="overflow:hidden;position:absolute;left:54px;top:0;right:0;bottom:0;display:none;background-color:black">
        <div id="p12warning" onclick="showFeaturesDlg()">
            <div class="icon2"></div>
            <div class="warningbox">Intel® AMT port za preusmeravanje ili KVM funkcija je onemogućena<span id="p12warninga">, kliknite ovdje da biste to omogućili.</span></div>
        </div>
        <div id="p12warning2" onclick="showPowerActionDlg()">
            <div class="icon2"></div>
            <div class="warningbox">Udaljeni računar nije uključen, kliknite ovdje da izdate komandu za napajanje.</div>
        </div>
        <div class="areaHead" style="position:absolute;top:0;left:0;right:0;height:24px">
            <div class="toright2">
                <div id="termRecordIcon" class="deskareaicon" title="Server snima ovu sesiju" style="display:none;background-color:red;width:12px;height:12px;border-radius:6px;margin-top:5px;margin-left:5px"></div>
                <div id="p12power" style="margin-top:3px;margin-right:4px;float:right"></div>
            </div>
            <div>
                <span id="connectbutton2span"><input type="button" id="connectbutton2" cmenu="termConnectButton" value="Povežite se" onclick="connectTerminal(event,1)" onkeypress="return false" onkeydown="return false" disabled="disabled"></span>
                <span id="disconnectbutton2span">&nbsp;<input type="button" id="disconnectbutton2" value="Prekini vezu" onclick="connectTerminal(event,0)" onkeypress="return false" onkeydown="return false"></span>
        ...
        <div class="areaFoot" style="position:absolute;bottom:0;left:0;right:0;height:24px">
            <div class="toright2">
                <span id="TermLatency" title="Kašnjenje terminalne sesije"></span>
                <span id="TermTimer" title="Vrijeme sesije"></span>&nbsp;
                <span id="terminalSettingsButtons" style="display:none">
                    <input id="id_tcrbutton" type="button" onkeypress="return false" onkeydown="return false" class="bottombutton" value="CR+LF" title="Uključite šta će poslati ključ za povratak" onclick="termToggleCr()">
                    <input id="id_tfxkeysbutton" type="button" onkeypress="return false" onkeydown="return false" class="bottombutton" value="Intel (F10 = ESC+[OM)" title="Uključite tip emulacije tipki F1 na F10" onclick="termToggleFx()">
                    <input id="id_ttypebutton" type="button" onkeypress="return false" onkeydown="return false" class="bottombutton" value="Extended Ascii" title="Uključite tip emulacije terminala" onclick="termToggleType()">
                </span>
                ...
                <span id="specialKeyDropDown">
                    ...
                    <input id="specialkeylistinput" type="button" onkeypress="return false" class="bottombutton" value="Pošalji" title="Pošaljite odabrani specijalni ključ" onclick="sendSpecialKey()">
                </span>
            </div>
            <div>
                &nbsp;
                ...
                <input type="button" onkeypress="return false" onkeydown="return false" class="bottombutton" id="escbutton" value="ITD" onclick="termSendKey(27,'escbutton')">
                ...
                <input type="button" onkeypress="return false" onkeydown="return false" class="bottombutton" id="pastebutton" value="Zalijepi" title="Zalijepite tekst u terminal" onclick="showTermPasteDialog()" style="display:none">
            </div>
        </div>
    ...
    <div id="p13" class="noselect" style="overflow:hidden;position:absolute;left:54px;top:0;right:0;bottom:0;display:none;background-color:white">
        <div id="p13toolbar" style="position:absolute;left:0;top:0;right:0;bottom:28px">
            <div class="areaHead">
                <div class="toright2">
                    <div id="filesRecordIcon" class="deskareaicon" title="Server snima ovu sesiju" style="display:none;background-color:red;width:12px;height:12px;border-radius:6px;margin-top:5px;margin-left:5px"></div>
                    <div id="p13power" style="margin-top:3px;margin-right:4px;float:right"></div>
                </div>
                <div>
                    <input id="p13Connect" value="Povežite se" onclick="connectFiles(event)" type="button">
            ...
            <div id="fileArea2" class="areaHead2" valign="bottom">
                ...
                <div>
                    <input type="button" id="p13FolderUp" disabled="disabled" onclick="p13folderup()" value="Gore">&nbsp;
                    <input type="button" id="p13SelectAllButton" disabled="disabled" onclick="p13selectallfile()" value="Označi sve">&nbsp;
                    <input type="button" id="p13RenameFileButton" disabled="disabled" value="Preimenuj" onclick="p13renamefile()">&nbsp;
                    <input type="button" id="p13DeleteFileButton" disabled="disabled" value="Izbriši" onclick="p13deletefile()">&nbsp;
                    <input type="button" id="p13ViewFileButton" disabled="disabled" value="Uredi" onclick="p13viewfile()">&nbsp;
                    ...
                    <input type="button" id="p13CopyButton" disabled="disabled" value="Kopiraj" onclick="p13copyFile(0)">&nbsp;
                    <input type="button" id="p13PasteButton" disabled="disabled" value="Zalijepi" onclick="p13pasteFile()">&nbsp;
                    <input type="button" id="p13ZipButton" disabled="disabled" value="Zip" onclick="p13zipFiles()">&nbsp;
                    <input type="button" id="p13RefreshButton" disabled="disabled" value="Osvježiti" onclick="p13folderup(9999)">&nbsp;
                    <input type="button" id="p13FindButton" disabled="disabled" value="Nađi" onclick="p13findfile()">&nbsp;
                </div>
            </div>
    ...
    <div id="dialog" class="noselect" style="display:none">
        ...
        <div id="dialogBody">
            ...
            <div id="dialog4" style="">
                ...
                <input id="d4SizeButton" type="button" value="Mala" onclick="d4ToggleSize()">
                <input id="d4EncodingButton" type="button" value="Sirova" onclick="d4ToggleEncoding()">
            ...
            <div id="dialog7" style="">
                <div id="d7meshkvm">
                    ...
                    <div id="d7desktopOtherSettings">
                        <div>Ostale postavke</div>
                        <div id="d7otherset2" style="display:block">
                            <label style="display:block"><input type="checkbox" id="d7deskSwapMouse">Zamijenite dugmad miša</label>
                            <label style="display:block"><input type="checkbox" id="d7deskRemoteKeyMap">Koristite mapu udaljene tastature</label>
                        </div>
                    </div>
                </div>
                <div id="d7amtkvm">
                    <h4>Intel® AMT hardverski KVM</h4>
                    <div>
                        <div>Kodiranje slike</div>
                    ...
                    <div>
                        ...
                        <div id="d7otherset" style="display:block">
                            <label style="display:block"><input type="checkbox" id="d7showfocus">Prikaži alat za fokusiranje</label>
                            <label style="display:block"><input type="checkbox" id="d7showcursor">Prikaži lokalni kursor miša</label>
                            <label style="display:block"><input type="checkbox" id="d7localKeyMap">Mapa lokalne tastature</label>
                        </div>
                    </div>
                </div>
            </div>
    ...
    <script>
        ...
        function updateMetadata(conn, elementid) {
            ...
            if (conn && (conn.State == 3)) {
                ...
                if (viewerCount > 1) { str = '<span onclick=showSessionMetadata(1) style=cursor:pointer>' + format(", {0} gleda", viewerCount) + '</span>'; }
            }
            QH('deskmetadata', str);
        ...
        function showSessionMetadata(cid) {
            ...
            if (conn && conn.metadata) {
                var x = '';
                if (conn.metadata.startTime) { x += addHtmlValue4("Vrijeme početka", printDateTime(new Date(conn.metadata.startTime))); }
                if (conn.metadata.users) {
                    for (var i in conn.metadata.users) {
                        var val = (conn.metadata.users[i] == 1) ? "1 veza" : format("{0} veze", conn.metadata.users[i]);
                        var username = i.split('/')[2];
                        if ((users != null) && (users[i] != null)) { username = users[i].name; }
                        x += addHtmlValue4(format("Korisnik \"{0}\"", username), val);
                    }
                }
                setDialogMode(2, "Informacije o sesiji", 1, null, x, 'sessionMetadata' + cid);
            }
        }
        ...
        function showDeskType() {
            if (xxdialogMode || desktop == null || desktop.State != 3) return;
            Q('DeskType').blur();
            var x = '<div>' + "Unesite tekst i kliknite U redu da ga daljinski otkucate koristeći američko englesku tastaturu. Obavezno postavite kursor daljinskog upravljača na ispravan položaj prije nego što nastavite." + '<div>';
            x += '<textarea id=d2typeText style="margin-top:5px;width:100%;height:184px;resize:none" maxlength=2000></textarea>';
            setDialogMode(2, "Daljinski unos sa tastature", 3, showDeskTypeEx, x);
            Q('d2typeText').focus();
        }
        ...
        */
        ...
        var terminalEmulations = ["UTF8 terminal", "Prošireni ASCII", "Intel ASCII"];
        ...
        var fxEmulations = ["Intel (F10 = ESC+[OM)", "Alternativno (F10 = ESC+0)", "VT100+ (F10 = ESC+[OY)"];
        ...
        function showTermPasteDialog() {
            if (!terminal || xxdialogMode) return;
            Q('pastebutton').blur();
            setDialogMode(2, "Zalijepi", 3, showTermPasteDialogEx, '<textarea id=d2pasteText style="width:100%;height:184px;resize:none"></textarea>');
            Q('d2pasteText').focus();
        }
        ...
        function onFilesStateChange(xfiles, state) {
            p13Connect.value = (state == 0) ? "Povežite se" : "Prekini vezu";
        ...
        function p13gotFiles(data) {
            ...
            if (data.action == 'findfile') {
                if (xxdialogTag == data.reqid) {
                    if (data.r == null) {
                        ...
                        xxdialogTag = null;
                        if (Q('d2findResults').innerHTML == '') { QH('d2findResults', '<div style=text-align:center;margin:10px><i>' + "Nije pronađen nijedan fajl" + '</i></div>'); }
                    } else {
            ...
            if (data.action == 'dialogmessage') {
                if ((data.msg == null) && (xxdialogTag == 'fileMsgDialog')) {
                    ...
                    setDialogMode(2, "File Operation", 10, p13fileOperationDialogEx, '<div style=margin:10px>' + "Kompresovanje fajlova..." + '<div>', 'fileMsgDialog');
        ...
        function p13findfile() {
            ...
            x += '<div style=margin-top:8px><input id=filefind_dlgCancelButton type=button value=' + "Zatvori" + ' style=float:right;width:80px;margin-left:5px onclick=p13findfileCancel()>';
            x += '<input id=filefind_dlgOkButton type=submit value=' + "Traži" + ' style=float:right;width:80px onclick=p13findfileEx()><br /><br /></div>';
        ...
        function p13setActions() {
            ...
            if (p13filetree == null) {
                ...
                Q('p13SelectAllButton').value = "Označi sve";
                ...
                Q('p13SelectAllButton').value = (cc > 0 ? "Odaberite Ništa" : "Označi sve");
        ...
        function p13zipFiles() {
            ...
            setDialogMode(2, "Zip Ime datoteke", 3, p13zipFilesEx, '<input type=text id=p13renameinput maxlength=64 onkeyup=p13fileNameCheck(event) style=width:100% value="" />', { action: 'zip', path: p13filetreelocation.join('/'), files: inputFiles });
        ...
        function p13downloadfile(x, y, z, tag) {
            ...
            setDialogMode(2, "Preuzmite datoteku", 10, p13downloadFileCancel, '<div>' + gdownloadFile.file + '</div><br /><progress id=d2progressBar style=width:100% value=0 max=' + z + ' />');
        }
        ...
        function d4ToggleWrap(update) {
            ...
            Q('d4WrapButton').value = ["Omotavanje: UKLJUČENO", "Omotavanje: ISKLJUČENO"][d4EditWrapVal];
        ...
        function d4ToggleSize(update) {
            ...
            Q('d4SizeButton').value = ["Veličina: 100%", "Veličina: 125%", "Veličina: 150%", "Veličina: 200%"][d4EditSizeVal];
        ...
        function d4ToggleEncoding(update) {
            ...
            Q('d4EncodingButton').value = ["Kodiranje: RAW","Kodiranje: UTF8"][d4EditEncodingVal];
        ...
        function printFlexDateTime(d) { if (printDate(new Date()) == printDate(d)) { return format("Ističe u {0}", printTime(d)); } else { return format("Ističe {0}", printDateTime(d)); } }
        function getFileSizeStr(size) { if (typeof size != 'number') { size = 0; } if (size == 1) return "1 bajt"; return format("{0} bajtova", size); }
